# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 189 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 191 "Zend/zend_object_handlers.h"
...
# 190 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 1 "Zend/zend_strtod.h" 1
# 191 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod_int.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod_int.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod_int.h" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod_int.h" 2
# 192 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 210 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 211 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 256 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 1 "/usr/include/errno.h" 1 3 4
# 257 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 288 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/float.h" 1 3 4
# 289 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 311 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
typedef union { double d; uint32_t L[2]; } U;
# 495 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
typedef struct BCinfo BCinfo;
 struct
BCinfo { int dp0, dp1, dplen, dsign, e0, inexact, nd, nd0, rounding, scale, uflchk; };
# 537 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 struct
Bigint {
 struct Bigint *next;
...

{
 ...
 if (k <= 7 && (rv = freelist[k]))
  ...
  if (!rv) {
   ;
   zend_error_noreturn((1<<0L), "Balloc() failed to allocate memory");
  }
# 619 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  rv->k = k;
  rv->maxwds = x;
  }
 ;
...

{
 ...
 do {
  ...
  carry = y >> 32;
  *x++ = y & 0xffffffffUL;
# 696 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  }
  while(++i < wds);
 if (carry) {
  if (wds >= b->maxwds) {
...
# 952 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...

{
 ...
 if (!(k >>= 2))
  return b;
 if (!(p5 = p5s)) {
# 986 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  p5 = p5s = i2b(625);
  p5->next = 0;
 ...
 for(;;) {
  ...
  if (!(k >>= 1))
   break;
  if (!(p51 = p5->next)) {
# 1007 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 1068 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 else do
  *x1++ = *x++;
  while(x < xe);
 b1->wds = n1 - 1;
...
# 1198 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 while(!*--xc)
  wa--;
 c->wds = wa;
 return c;
...
# 1224 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  (&u)->L[1] = L;
  (&u)->L[0] = 0;
# 1243 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 return (&u)->d;
 }
...
# 1305 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 ret_d:
...

{
 ...
 int i;
# 1340 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 b = Balloc(1);
...
# 1425 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (de) {
...
# 1481 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (k > 0)
  (&da)->L[1] += k*0x100000;
 else {
  k = -k;
...
# 1563 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 1594 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 static int
match
...
# 1656 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  else {
   do {
    if ( c == ')') {
     *sp = s + 1;
...
# 2162 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 static int
...

{
 ...
 bxe = bx + n;
 q = *bxe / (*sxe + 1);
# 2216 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (q) {
  borrow = 0;
  carry = 0;
  do {
   ...
   borrow = y >> 32 & (uint32_t)1;
   *bx++ = y & 0xffffffffUL;
# 2245 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
   }
   while(sx <= sxe);
  if (!*bxe) {
   bx = b->x;
 ...
 if (cmp(b, S) >= 0) {
  ...
  do {
   ...
   borrow = y >> 32 & (uint32_t)1;
   *bx++ = y & 0xffffffffUL;
# 2286 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
   }
   while(sx <= sxe);
  bx = b->x;
  bxe = bx + n;
...

{
 ...
 i = 53 - bbits;
 if (i > (j = 53 - (-1022) - 1 + p2)) {
# 2383 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  i = j;

  }
# 2395 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  {
  b = lshift(b, ++i);
  b->x[0] |= 1;
  }
 ...
 Bfree(b);
 Bfree(d);
# 2490 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (speccase) {
  if (dd <= 0)
   rv->d = 0.;
  }
...

{
 ...
 int req_bigcomp = 0;
# 2570 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 const char *s2;
 ...
 break2:
 if (*s == '0') {
# 2609 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  nz0 = 1;
  while(*++s == '0') ;
  if (!*s)
   goto ret;
 ...
 if (nd <= 15
  ...
  if (e > 0) {
   if (e <= 22) {
# 2794 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
               (&rv)->d *= tens[e];
    goto ret;
   ...
   i = 15 - nd;
   if (e <= 22 + i) {
# 2810 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
    e -= i;
    (&rv)->d *= tens[i];
# 2824 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
               (&rv)->d *= tens[e];
 ...
 e1 += nd - k;
# 2853 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 bc.scale = 0;
# 2868 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (e1 > 0) {
  if ((i = e1 & 15))
   (&rv)->d *= tens[i];
  if (e1 &= ~15) {
   if (e1 > 308) {
 ovfl:
# 2888 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
    (&rv)->L[1] = 0x7ff00000;
    (&rv)->L[0] = 0;
# 2900 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 range_err:
    if (bd0) {
     Bfree(bb);
     Bfree(bd);
...
# 2972 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
    if (!(&rv)->d) {
 undfl:
     (&rv)->d = 0.;
     goto range_err;
     }
# 2985 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
   }
  }
...
# 3081 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  bb2 += j;
  bd2 += j;
...
# 3128 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
    i = -1;
   }
# 3225 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  if (i < 0) {
 ...
 drop_down:
# 3306 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
    if (bc.scale) {
     L = (&rv)->L[1] & 0x7ff00000;
...
# 3418 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
   if (1 == 0)
    aadj1 += 0.5;
...
# 3519 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
   }
  z = (&rv)->L[1] & 0x7ff00000;
...
# 3575 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (bc.scale) {
...
# 3597 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 ret:
 if (se)
  *se = (char *)s;
...
# 3702 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
{
# 3745 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 ...
 U eps1;
# 3780 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (dtoa_result) {
...
# 3833 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 b = d2b(&u, &be, &bbits);
 ...
 if ((i = (int)((&u)->L[1] >> 20 & (0x7ff00000>>20)))) {
  ...
  (&d2)->L[1] &= 0xfffff;
  (&d2)->L[1] |= 0x3ff00000;
# 3869 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  i -= 1023;
...
# 4207 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 i = dshift(S, s2);
 b2 += i;
 m2 += i;
 s2 += i;
...
# 4361 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 b = lshift(b, 1);
 j = cmp(b, S);
 ...
 ret1:
# 4404 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 Bfree(b);
 *s = 0;
 *decpt = k + 1;
 if (rve)
