# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
# 20 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
...
# 21 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c" 2
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c" 2


static void overriden_ptr_dtor(zval *zv)
{
 do { if (__builtin_constant_p(sizeof(zend_function))) { if (sizeof(zend_function) <= 8) { _efree_8((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 16) { _efree_16((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 24) { _efree_24((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 32) { _efree_32((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 40) { _efree_40((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 48) { _efree_48((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 56) { _efree_56((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 64) { _efree_64((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 80) { _efree_80((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 96) { _efree_96((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 112) { _efree_112((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 128) { _efree_128((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 160) { _efree_160((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 192) { _efree_192((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 224) { _efree_224((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 256) { _efree_256((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 320) { _efree_320((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 384) { _efree_384((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 448) { _efree_448((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 512) { _efree_512((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 640) { _efree_640((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 768) { _efree_768((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 896) { _efree_896((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 1024) { _efree_1024((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 1280) { _efree_1280((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 1536) { _efree_1536((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 1792) { _efree_1792((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 2048) { _efree_2048((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 2560) { _efree_2560((*(zv)).value.ptr); } else if (sizeof(zend_function) <= 3072) { _efree_3072((*(zv)).value.ptr); } else if (sizeof(zend_function) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large((*(zv)).value.ptr, sizeof(zend_function)); } else { _efree_huge((*(zv)).value.ptr, sizeof(zend_function)); } } else { _efree((*(zv)).value.ptr); } } while (0);
}
...
static zend_function *zend_duplicate_function(zend_function *func, zend_class_entry *ce)
{
 ...
 if (__builtin_expect(!!(func->type == 1), 0)) {
  if (__builtin_expect(!!(ce->type & 1), 0)) {
   new_function = ((1)?__zend_malloc(sizeof(zend_internal_function)):(__builtin_constant_p((sizeof(zend_internal_function)) ) ? (((sizeof(zend_internal_function)) <= 8) ? _emalloc_8() : (((sizeof(zend_internal_function)) <= 16) ? _emalloc_16() : (((sizeof(zend_internal_function)) <= 24) ? _emalloc_24() : (((sizeof(zend_internal_function)) <= 32) ? _emalloc_32() : (((sizeof(zend_internal_function)) <= 40) ? _emalloc_40() : (((sizeof(zend_internal_function)) <= 48) ? _emalloc_48() : (((sizeof(zend_internal_function)) <= 56) ? _emalloc_56() : (((sizeof(zend_internal_function)) <= 64) ? _emalloc_64() : (((sizeof(zend_internal_function)) <= 80) ? _emalloc_80() : (((sizeof(zend_internal_function)) <= 96) ? _emalloc_96() : (((sizeof(zend_internal_function)) <= 112) ? _emalloc_112() : (((sizeof(zend_internal_function)) <= 128) ? _emalloc_128() : (((sizeof(zend_internal_function)) <= 160) ? _emalloc_160() : (((sizeof(zend_internal_function)) <= 192) ? _emalloc_192() : (((sizeof(zend_internal_function)) <= 224) ? _emalloc_224() : (((sizeof(zend_internal_function)) <= 256) ? _emalloc_256() : (((sizeof(zend_internal_function)) <= 320) ? _emalloc_320() : (((sizeof(zend_internal_function)) <= 384) ? _emalloc_384() : (((sizeof(zend_internal_function)) <= 448) ? _emalloc_448() : (((sizeof(zend_internal_function)) <= 512) ? _emalloc_512() : (((sizeof(zend_internal_function)) <= 640) ? _emalloc_640() : (((sizeof(zend_internal_function)) <= 768) ? _emalloc_768() : (((sizeof(zend_internal_function)) <= 896) ? _emalloc_896() : (((sizeof(zend_internal_function)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_internal_function)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_internal_function)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_internal_function)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_internal_function)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_internal_function)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_internal_function)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_internal_function)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_internal_function))) : _emalloc_huge((sizeof(zend_internal_function)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_internal_function)) ) ));
   memcpy(new_function, func, sizeof(zend_internal_function));
  } else {
   new_function = zend_arena_alloc(&(compiler_globals.arena), sizeof(zend_internal_function));
   memcpy(new_function, func, sizeof(zend_internal_function));
   new_function->common.fn_flags |= 0x20000000;
  }
  if (__builtin_expect(!!(new_function->common.function_name), 1)) {
  ...
  if (__builtin_expect(!!(!func->op_array.static_variables), 1)) {

   return func;
  }
  if (!((func->op_array.static_variables)->gc.u.v.flags & (1<<1))) {
   (func->op_array.static_variables)->gc.refcount++;
  }
...
{
 do { if (__builtin_expect(!(ce->parent != ((void *)0)), 0)) __builtin_unreachable(); } while (0);


 ce->create_object = ce->parent->create_object;


 if (__builtin_expect(!!(!ce->get_iterator), 1)) {
  ce->get_iterator = ce->parent->get_iterator;
 }
 if (__builtin_expect(!!(!ce->iterator_funcs.funcs), 1)) {
  ce->iterator_funcs.funcs = ce->parent->iterator_funcs.funcs;
 }
 if (__builtin_expect(!!(!ce->__get), 1)) {
  ce->__get = ce->parent->__get;
 }
 if (__builtin_expect(!!(!ce->__set), 1)) {
  ce->__set = ce->parent->__set;
 }
 if (__builtin_expect(!!(!ce->__unset), 1)) {
  ce->__unset = ce->parent->__unset;
 }
 if (__builtin_expect(!!(!ce->__isset), 1)) {
  ce->__isset = ce->parent->__isset;
 }
 if (__builtin_expect(!!(!ce->__call), 1)) {
  ce->__call = ce->parent->__call;
 }
 if (__builtin_expect(!!(!ce->__callstatic), 1)) {
  ce->__callstatic = ce->parent->__callstatic;
 }
 if (__builtin_expect(!!(!ce->__tostring), 1)) {
  ce->__tostring = ce->parent->__tostring;
 }
 if (__builtin_expect(!!(!ce->clone), 1)) {
  ce->clone = ce->parent->clone;
 }
 if (__builtin_expect(!!(!ce->serialize), 1)) {
  ce->serialize = ce->parent->serialize;
 }
 if (__builtin_expect(!!(!ce->unserialize), 1)) {
  ce->unserialize = ce->parent->unserialize;
 }
 if (!ce->destructor) {
  ce->destructor = ce->parent->destructor;
 }
 if (__builtin_expect(!!(!ce->__debugInfo), 1)) {
  ce->__debugInfo = ce->parent->__debugInfo;
 }

 if (ce->constructor) {
  if (ce->parent->constructor && __builtin_expect(!!(ce->parent->constructor->common.fn_flags & 0x04), 0)) {
   zend_error_noreturn((1<<0L), "Cannot override final %s::%s() with %s::%s()",
...
static zend_bool zend_do_perform_implementation_check(const zend_function *fe, const zend_function *proto)
{
 ...
 if ((fe->common.fn_flags & 0x2000)
  && ((proto->common.scope->ce_flags & 0x40) == 0
 ...
 if (proto->common.fn_flags & 0x40000000) {

  if (!(fe->common.fn_flags & 0x40000000)) {
   return 0;
  }
...
static __attribute__((cold)) void zend_append_type_hint(smart_str *str, const zend_function *fptr, zend_arg_info *arg_info, int return_hint)
{
 if (arg_info->class_name) {
  ...
  smart_str_appendl_ex((str), (class_name), (class_name_len), 0);
  if (!return_hint) {
   smart_str_appendc_ex((str), (' '), 0);
  }
 } else if (arg_info->type_hint) {
  if (arg_info->type_hint == 4) {
   smart_str_appendl_ex((str), ("int"), (3), 0);
  } else if (arg_info->type_hint == 13) {
   smart_str_appendl_ex((str), ("bool"), (4), 0);
  } else {
   const char *type_name = zend_get_type_by_const(arg_info->type_hint);
   smart_str_appendl_ex(((str)), ((type_name)), (strlen(type_name)), 0);
  }
  if (!return_hint) {
   smart_str_appendc_ex((str), (' '), 0);
  }
...
static __attribute__((cold)) zend_string *zend_get_function_declaration(const zend_function *fptr)
{
 smart_str str = {0};

 if (fptr->op_array.fn_flags & 0x4000000) {
  smart_str_appendl_ex(((&str)), (("& ")), (strlen("& ")), 0);
 }

 if (fptr->common.scope) {

  smart_str_appendl_ex((&str), ((fptr->common.scope->name)->val), (strlen((fptr->common.scope->name)->val)), 0);
  smart_str_appendl_ex(((&str)), (("::")), (strlen("::")), 0);
 }

 smart_str_append_ex((&str), (fptr->common.function_name), 0);
 smart_str_appendc_ex((&str), ('('), 0);
 ...
 if (fptr->common.arg_info) {
  ...
  for (i = 0; i < num_args;) {
   ...
   if (arg_info->name) {
    if (fptr->type == 1) {
     smart_str_appendl_ex(((&str)), ((((zend_internal_arg_info*)arg_info)->name)), (strlen(((zend_internal_arg_info*)arg_info)->name)), 0);
    } else {
     smart_str_appendl_ex((&str), ((arg_info->name)->val), ((arg_info->name)->len), 0);
    }
   } else {
    smart_str_appendl_ex(((&str)), (("param")), (strlen("param")), 0);
    smart_str_append_unsigned_ex((&str), (i), 0);
   }
   ...
   if (i >= required && !arg_info->is_variadic) {
    ...
    if (fptr->type == 2) {
     ...
     if (precv && precv->opcode == 64 && precv->op2_type != (1<<3)) {
      zval *zv = ((zval*)(((char*)((&fptr->op_array)->literals)) + (precv->op2).constant));

      if (zval_get_type(&(*(zv))) == 11) {
       smart_str_append_ex((&str), ((*(zv)).value.str), 0);
      } else if (zval_get_type(&(*(zv))) == 2) {
       smart_str_appendl_ex(((&str)), (("false")), (strlen("false")), 0);
      } else if (zval_get_type(&(*(zv))) == 3) {
       smart_str_appendl_ex(((&str)), (("true")), (strlen("true")), 0);
      } else if (zval_get_type(&(*(zv))) == 1) {
       smart_str_appendl_ex(((&str)), (("NULL")), (strlen("NULL")), 0);
      } else if (zval_get_type(&(*(zv))) == 6) {
       smart_str_appendc_ex((&str), ('\''), 0);
       smart_str_appendl_ex((&str), (((*(zv)).value.str)->val), ((((((*(zv)).value.str)->len)<(10))?(((*(zv)).value.str)->len):(10))), 0);
       if (((*(zv)).value.str)->len > 10) {
        smart_str_appendl_ex(((&str)), (("...")), (strlen("...")), 0);
       }
       smart_str_appendc_ex((&str), ('\''), 0);
      } else if (zval_get_type(&(*(zv))) == 7) {
       smart_str_appendl_ex(((&str)), (("Array")), (strlen("Array")), 0);
      } else if (zval_get_type(&(*(zv))) == 12) {
       smart_str_appendl_ex(((&str)), (("<expression>")), (strlen("<expression>")), 0);
      } else {
       zend_string *zv_str = _zval_get_string((zv));
       smart_str_append_ex((&str), (zv_str), 0);
 ...
 if (fptr->common.fn_flags & 0x40000000) {
  smart_str_appendl_ex(((&str)), ((": ")), (strlen(": ")), 0);
...
static void do_inheritance_check_on_method(zend_function *child, zend_function *parent)
{
 ...
 if ((parent->common.scope->ce_flags & 0x40) == 0
 ...
 if (__builtin_expect(!!(parent_flags & 0x04), 0)) {
 ...
 if (__builtin_expect(!!((child_flags & 0x01) != (parent_flags & 0x01)), 0)) {
 ...
 if (__builtin_expect(!!((child_flags & 0x02) > (parent_flags & 0x02)), 0)) {
 ...
 if (parent_flags & 0x800) {
  ...
  if (__builtin_expect(!!((child_flags & (0x100 | 0x200 | 0x400)) > (parent_flags & (0x100 | 0x200 | 0x400))), 0)) {
 ...
 } else if (!(parent->common.fn_flags & 0x2000) || (parent->common.prototype && (parent->common.prototype->common.scope->ce_flags & 0x40))) {

  child->common.prototype = parent->common.prototype ? parent->common.prototype : parent;
 }

 if (child->common.prototype && (
  child->common.prototype->common.fn_flags & (0x02 | 0x40000000)
 )) {
  if (__builtin_expect(!!(!zend_do_perform_implementation_check(child, child->common.prototype)), 0)) {
   zend_string *method_prototype = zend_get_function_declaration(child->common.prototype);
   zend_string *child_prototype = zend_get_function_declaration(child);
   zend_error_noreturn((1<<6L), "Declaration of %s must be compatible with %s", (child_prototype)->val, (method_prototype)->val);
  }
 } else if (__builtin_expect(!!(!zend_do_perform_implementation_check(child, parent)), 0)) {
  zend_string *method_prototype = zend_get_function_declaration(parent);
  zend_string *child_prototype = zend_get_function_declaration(child);
  zend_error((1<<1L), "Declaration of %s should be compatible with %s", (child_prototype)->val, (method_prototype)->val);
...
static zend_function *do_inherit_method(zend_string *key, zend_function *parent, zend_class_entry *ce)
{
 ...
 if (child) {
  zend_function *func = (zend_function*)(*(child)).value.ptr;
  ...
  if (func->common.prototype != orig_prototype &&
   ...
   zend_function *new_function = zend_arena_alloc(&(compiler_globals.arena), sizeof(zend_op_array));
   memcpy(new_function, func, sizeof(zend_op_array));
   (*(child)).value.ptr = new_function;
...
static void do_inherit_property(zend_property_info *parent_info, zend_string *key, zend_class_entry *ce)
{
 ...
 if (__builtin_expect(!!(child), 0)) {
  child_info = (*(child)).value.ptr;
  if (__builtin_expect(!!(parent_info->flags & (0x400|0x20000)), 0)) {
   child_info->flags |= 0x800;
  } else {
   if (__builtin_expect(!!((parent_info->flags & 0x01) != (child_info->flags & 0x01)), 0)) {
    zend_error_noreturn((1<<6L), "Cannot redeclare %s%s::$%s as %s%s::$%s",
     (parent_info->flags & 0x01) ? "static " : "non static ", (ce->parent->name)->val, (key)->val,
   ...
   if (__builtin_expect(!!((child_info->flags & (0x100 | 0x200 | 0x400)) > (parent_info->flags & (0x100 | 0x200 | 0x400))), 0)) {
    zend_error_noreturn((1<<6L), "Access level to %s::$%s must be %s (as in class %s)%s", (ce->name)->val, (key)->val, zend_visibility_string(parent_info->flags), (ce->parent->name)->val, (parent_info->flags&0x100) ? "" : " or weaker");
   } else if ((child_info->flags & 0x01) == 0) {
    int parent_num = ((parent_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval));
    int child_num = ((child_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval));

    _zval_ptr_dtor((&(ce->default_properties_table[parent_num])) );
    ce->default_properties_table[parent_num] = ce->default_properties_table[child_num];
    do { (*(&ce->default_properties_table[child_num])).u1.type_info = 0; } while (0);
...
{
 if (!(ce->ce_flags & 0x40) && iface->interface_gets_implemented && iface->interface_gets_implemented(iface, ce) == FAILURE) {
  zend_error_noreturn((1<<4L), "Class %s could not implement interface %s", (ce->name)->val, (iface->name)->val);
 }
 if (__builtin_expect(!!(ce == iface), 0)) {
  zend_error_noreturn((1<<0L), "Interface %s cannot implement itself", (ce->name)->val);
 }
}
...
__attribute__ ((visibility("default"))) void zend_do_inherit_interfaces(zend_class_entry *ce, const zend_class_entry *iface)
{
 ...
 if (ce->type == 1) {
  ...
  ce->interfaces = (zend_class_entry **) _erealloc((ce->interfaces), (sizeof(zend_class_entry *) * (ce_num + if_num)) );
 }
...
static void do_inherit_class_constant(zend_string *name, zend_class_constant *parent_const, zend_class_entry *ce)
{
 ...
 if (c != ((void *)0)) {
  if (__builtin_expect(!!(((c->value).u2.access_flags & (0x100 | 0x200 | 0x400)) > ((parent_const->value).u2.access_flags & (0x100 | 0x200 | 0x400))), 0)) {
   zend_error_noreturn((1<<6L), "Access level to %s::%s must be %s (as in class %s)%s",
    (ce->name)->val, (name)->val, zend_visibility_string((parent_const->value).u2.access_flags), (ce->parent->name)->val, ((parent_const->value).u2.access_flags & 0x100) ? "" : " or weaker");
  }
 } else if (!((parent_const->value).u2.access_flags & 0x400)) {
  if ((((parent_const->value).u1.v.type_flags & (1<<0)) != 0)) {
   ce->ce_flags &= ~0x100000;
  }
  if ((((parent_const->value).u1.v.type_flags & (1<<2)) != 0)) {
   zval_addref_p(&(parent_const->value));
  }
  if (ce->type & 1) {
...
__attribute__ ((visibility("default"))) void zend_do_inheritance(zend_class_entry *ce, zend_class_entry *parent_ce)
{
 ...
 if (parent_ce->default_properties_count) {
  ...
  if (ce->default_properties_count) {
   zval *table = ((ce->type == 1)?__zend_malloc(sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)):(__builtin_constant_p((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) ) ? (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 8) ? _emalloc_8() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 16) ? _emalloc_16() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 24) ? _emalloc_24() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 32) ? _emalloc_32() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 40) ? _emalloc_40() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 48) ? _emalloc_48() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 56) ? _emalloc_56() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 64) ? _emalloc_64() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 80) ? _emalloc_80() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 96) ? _emalloc_96() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 112) ? _emalloc_112() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 128) ? _emalloc_128() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 160) ? _emalloc_160() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 192) ? _emalloc_192() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 224) ? _emalloc_224() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 256) ? _emalloc_256() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 320) ? _emalloc_320() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 384) ? _emalloc_384() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 448) ? _emalloc_448() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 512) ? _emalloc_512() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 640) ? _emalloc_640() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 768) ? _emalloc_768() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 896) ? _emalloc_896() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count))) : _emalloc_huge((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * (ce->default_properties_count + parent_ce->default_properties_count)) ) ));
   ...
   ((ce->type == 1)?free(src):_efree((src) ));
   end = ce->default_properties_table;
  } else {
   end = ((ce->type == 1)?__zend_malloc(sizeof(zval) * parent_ce->default_properties_count):(__builtin_constant_p((sizeof(zval) * parent_ce->default_properties_count) ) ? (((sizeof(zval) * parent_ce->default_properties_count) <= 8) ? _emalloc_8() : (((sizeof(zval) * parent_ce->default_properties_count) <= 16) ? _emalloc_16() : (((sizeof(zval) * parent_ce->default_properties_count) <= 24) ? _emalloc_24() : (((sizeof(zval) * parent_ce->default_properties_count) <= 32) ? _emalloc_32() : (((sizeof(zval) * parent_ce->default_properties_count) <= 40) ? _emalloc_40() : (((sizeof(zval) * parent_ce->default_properties_count) <= 48) ? _emalloc_48() : (((sizeof(zval) * parent_ce->default_properties_count) <= 56) ? _emalloc_56() : (((sizeof(zval) * parent_ce->default_properties_count) <= 64) ? _emalloc_64() : (((sizeof(zval) * parent_ce->default_properties_count) <= 80) ? _emalloc_80() : (((sizeof(zval) * parent_ce->default_properties_count) <= 96) ? _emalloc_96() : (((sizeof(zval) * parent_ce->default_properties_count) <= 112) ? _emalloc_112() : (((sizeof(zval) * parent_ce->default_properties_count) <= 128) ? _emalloc_128() : (((sizeof(zval) * parent_ce->default_properties_count) <= 160) ? _emalloc_160() : (((sizeof(zval) * parent_ce->default_properties_count) <= 192) ? _emalloc_192() : (((sizeof(zval) * parent_ce->default_properties_count) <= 224) ? _emalloc_224() : (((sizeof(zval) * parent_ce->default_properties_count) <= 256) ? _emalloc_256() : (((sizeof(zval) * parent_ce->default_properties_count) <= 320) ? _emalloc_320() : (((sizeof(zval) * parent_ce->default_properties_count) <= 384) ? _emalloc_384() : (((sizeof(zval) * parent_ce->default_properties_count) <= 448) ? _emalloc_448() : (((sizeof(zval) * parent_ce->default_properties_count) <= 512) ? _emalloc_512() : (((sizeof(zval) * parent_ce->default_properties_count) <= 640) ? _emalloc_640() : (((sizeof(zval) * parent_ce->default_properties_count) <= 768) ? _emalloc_768() : (((sizeof(zval) * parent_ce->default_properties_count) <= 896) ? _emalloc_896() : (((sizeof(zval) * parent_ce->default_properties_count) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * parent_ce->default_properties_count) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * parent_ce->default_properties_count) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * parent_ce->default_properties_count) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * parent_ce->default_properties_count) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * parent_ce->default_properties_count) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * parent_ce->default_properties_count) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * parent_ce->default_properties_count) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * parent_ce->default_properties_count)) : _emalloc_huge((sizeof(zval) * parent_ce->default_properties_count))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * parent_ce->default_properties_count) ) ));
  ...
  do {
   dst--;
   src--;
# 807 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
 ...
 if (parent_ce->default_static_members_count) {
  ...
  if (ce->default_static_members_count) {
   zval *table = ((ce->type == 1)?__zend_malloc(sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)):(__builtin_constant_p((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) ) ? (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 8) ? _emalloc_8() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 16) ? _emalloc_16() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 24) ? _emalloc_24() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 32) ? _emalloc_32() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 40) ? _emalloc_40() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 48) ? _emalloc_48() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 56) ? _emalloc_56() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 64) ? _emalloc_64() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 80) ? _emalloc_80() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 96) ? _emalloc_96() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 112) ? _emalloc_112() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 128) ? _emalloc_128() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 160) ? _emalloc_160() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 192) ? _emalloc_192() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 224) ? _emalloc_224() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 256) ? _emalloc_256() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 320) ? _emalloc_320() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 384) ? _emalloc_384() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 448) ? _emalloc_448() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 512) ? _emalloc_512() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 640) ? _emalloc_640() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 768) ? _emalloc_768() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 896) ? _emalloc_896() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count))) : _emalloc_huge((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * (ce->default_static_members_count + parent_ce->default_static_members_count)) ) ));
   ...
   end = ((ce->type == 1)?__zend_malloc(sizeof(zval) * parent_ce->default_static_members_count):(__builtin_constant_p((sizeof(zval) * parent_ce->default_static_members_count) ) ? (((sizeof(zval) * parent_ce->default_static_members_count) <= 8) ? _emalloc_8() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 16) ? _emalloc_16() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 24) ? _emalloc_24() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 32) ? _emalloc_32() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 40) ? _emalloc_40() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 48) ? _emalloc_48() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 56) ? _emalloc_56() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 64) ? _emalloc_64() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 80) ? _emalloc_80() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 96) ? _emalloc_96() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 112) ? _emalloc_112() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 128) ? _emalloc_128() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 160) ? _emalloc_160() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 192) ? _emalloc_192() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 224) ? _emalloc_224() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 256) ? _emalloc_256() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 320) ? _emalloc_320() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 384) ? _emalloc_384() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 448) ? _emalloc_448() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 512) ? _emalloc_512() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 640) ? _emalloc_640() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 768) ? _emalloc_768() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 896) ? _emalloc_896() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * parent_ce->default_static_members_count) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * parent_ce->default_static_members_count) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * parent_ce->default_static_members_count)) : _emalloc_huge((sizeof(zval) * parent_ce->default_static_members_count))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * parent_ce->default_static_members_count) ) ));
 ...
 do { Bucket *_p = (&ce->properties_info)->arData; Bucket *_end = _p + (&ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; property_info = (*(_z)).value.ptr; {
 ...
 if ((&parent_ce->properties_info)->nNumOfElements) {
  zend_hash_extend(&ce->properties_info,
   ...
   (&parent_ce->properties_info)->nNumOfElements, 0);

  do { Bucket *_p = (&parent_ce->properties_info)->arData; Bucket *_end = _p + (&parent_ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; property_info = (*(_z)).value.ptr; {
 ...
 if ((&parent_ce->constants_table)->nNumOfElements) {
  ...
  zend_hash_extend(&ce->constants_table,
   ...
   (&parent_ce->constants_table)->nNumOfElements, 0);

  do { Bucket *_p = (&parent_ce->constants_table)->arData; Bucket *_end = _p + (&parent_ce->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; c = (*(_z)).value.ptr; {
 ...
 if ((&parent_ce->function_table)->nNumOfElements) {
  zend_hash_extend(&ce->function_table,
   ...
   (&parent_ce->function_table)->nNumOfElements, 0);

  do { Bucket *_p = (&parent_ce->function_table)->arData; Bucket *_end = _p + (&parent_ce->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; func = (*(_z)).value.ptr; {
 ...
 ce->ce_flags |= parent_ce->ce_flags & (0x800000 | 0x1000000);
}
...
static zend_bool do_inherit_constant_check(HashTable *child_constants_table, zend_class_constant *parent_constant, zend_string *name, const zend_class_entry *iface)
{
 ...
 if ((old_constant = zend_hash_find_ptr(child_constants_table, name)) != ((void *)0)) {
...
static void do_inherit_iface_constant(zend_string *name, zend_class_constant *c, zend_class_entry *ce, zend_class_entry *iface)
{
 if (do_inherit_constant_check(&ce->constants_table, c, name, iface)) {
  ...
  if ((((c->value).u1.v.type_flags & (1<<2)) != 0)) {
   zval_addref_p(&(c->value));
  }
  if ((((c->value).u1.v.type_flags & (1<<0)) != 0)) {
   ce->ce_flags &= ~0x100000;
  }
  if (ce->type & 1) {
   ct = ((1)?__zend_malloc(sizeof(zend_class_constant)):(__builtin_constant_p((sizeof(zend_class_constant)) ) ? (((sizeof(zend_class_constant)) <= 8) ? _emalloc_8() : (((sizeof(zend_class_constant)) <= 16) ? _emalloc_16() : (((sizeof(zend_class_constant)) <= 24) ? _emalloc_24() : (((sizeof(zend_class_constant)) <= 32) ? _emalloc_32() : (((sizeof(zend_class_constant)) <= 40) ? _emalloc_40() : (((sizeof(zend_class_constant)) <= 48) ? _emalloc_48() : (((sizeof(zend_class_constant)) <= 56) ? _emalloc_56() : (((sizeof(zend_class_constant)) <= 64) ? _emalloc_64() : (((sizeof(zend_class_constant)) <= 80) ? _emalloc_80() : (((sizeof(zend_class_constant)) <= 96) ? _emalloc_96() : (((sizeof(zend_class_constant)) <= 112) ? _emalloc_112() : (((sizeof(zend_class_constant)) <= 128) ? _emalloc_128() : (((sizeof(zend_class_constant)) <= 160) ? _emalloc_160() : (((sizeof(zend_class_constant)) <= 192) ? _emalloc_192() : (((sizeof(zend_class_constant)) <= 224) ? _emalloc_224() : (((sizeof(zend_class_constant)) <= 256) ? _emalloc_256() : (((sizeof(zend_class_constant)) <= 320) ? _emalloc_320() : (((sizeof(zend_class_constant)) <= 384) ? _emalloc_384() : (((sizeof(zend_class_constant)) <= 448) ? _emalloc_448() : (((sizeof(zend_class_constant)) <= 512) ? _emalloc_512() : (((sizeof(zend_class_constant)) <= 640) ? _emalloc_640() : (((sizeof(zend_class_constant)) <= 768) ? _emalloc_768() : (((sizeof(zend_class_constant)) <= 896) ? _emalloc_896() : (((sizeof(zend_class_constant)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_class_constant)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_class_constant)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_class_constant)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_class_constant)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_class_constant)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_class_constant)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_class_constant)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_class_constant))) : _emalloc_huge((sizeof(zend_class_constant)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_class_constant)) ) ));
  } else {
   ct = zend_arena_alloc(&(compiler_globals.arena), sizeof(zend_class_constant));
  }
...
__attribute__ ((visibility("default"))) void zend_do_implement_interface(zend_class_entry *ce, zend_class_entry *iface)
{
 ...
 for (i = 0; i < ce->num_interfaces; i++) {
  if (ce->interfaces[i] == ((void *)0)) {
   ...
   if (__builtin_expect(!!(i < parent_iface_num), 1)) {
    ignore = 1;
   } else {
 ...
 if (ignore) {
  ...
  if (ce->num_interfaces >= current_iface_num) {
   if (ce->type == 1) {
    ...
    ce->interfaces = (zend_class_entry **) _erealloc((ce->interfaces), (sizeof(zend_class_entry *) * (++current_iface_num)) );
   }
  }
  ce->interfaces[ce->num_interfaces++] = iface;

  do { Bucket *_p = (&iface->constants_table)->arData; Bucket *_end = _p + (&iface->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; c = (*(_z)).value.ptr; {
   do_inherit_iface_constant(key, c, ce, iface);
  } } } while (0);

  do { Bucket *_p = (&iface->function_table)->arData; Bucket *_end = _p + (&iface->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; func = (*(_z)).value.ptr; {
   zend_function *new_func = do_inherit_method(key, func, ce);
 ...
 if (!ignore) {
  if (ce->num_traits >= current_trait_num) {
   if (ce->type == 1) {
    ...
    ce->traits = (zend_class_entry **) _erealloc((ce->traits), (sizeof(zend_class_entry *) * (++current_trait_num)) );
   }
  }
...
static zend_bool zend_traits_method_compatibility_check(zend_function *fn, zend_function *other_fn)
{
 ...
 return zend_do_perform_implementation_check(fn, other_fn)
  && ((other_fn->common.scope->ce_flags & 0x40) || zend_do_perform_implementation_check(other_fn, fn))
  && ((fn_flags & (0x04|0x01)) ==
...
{
 if (((mname)->len == sizeof("__clone")-1 && !memcmp((mname)->val, "__clone", sizeof("__clone") - 1))) {
  ce->clone = fe; fe->common.fn_flags |= 0x8000;
 } else if (((mname)->len == sizeof("__construct")-1 && !memcmp((mname)->val, "__construct", sizeof("__construct") - 1))) {
 ...
 } else if (((mname)->len == sizeof("__destruct")-1 && !memcmp((mname)->val, "__destruct", sizeof("__destruct") - 1))) {
  ce->destructor = fe; fe->common.fn_flags |= 0x4000;
 } else if (((mname)->len == sizeof("__get")-1 && !memcmp((mname)->val, "__get", sizeof("__get") - 1))) {
  ce->__get = fe;
  ce->ce_flags |= 0x1000000;
 } else if (((mname)->len == sizeof("__set")-1 && !memcmp((mname)->val, "__set", sizeof("__set") - 1))) {
  ce->__set = fe;
  ce->ce_flags |= 0x1000000;
 } else if (((mname)->len == sizeof("__call")-1 && !memcmp((mname)->val, "__call", sizeof("__call") - 1))) {
  ce->__call = fe;
 } else if (((mname)->len == sizeof("__unset")-1 && !memcmp((mname)->val, "__unset", sizeof("__unset") - 1))) {
  ce->__unset = fe;
  ce->ce_flags |= 0x1000000;
 } else if (((mname)->len == sizeof("__isset")-1 && !memcmp((mname)->val, "__isset", sizeof("__isset") - 1))) {
  ce->__isset = fe;
  ce->ce_flags |= 0x1000000;
 } else if (((mname)->len == sizeof("__callstatic")-1 && !memcmp((mname)->val, "__callstatic", sizeof("__callstatic") - 1))) {
  ce->__callstatic = fe;
 } else if (((mname)->len == sizeof("__tostring")-1 && !memcmp((mname)->val, "__tostring", sizeof("__tostring") - 1))) {
  ce->__tostring = fe;
 } else if (((mname)->len == sizeof("__debuginfo")-1 && !memcmp((mname)->val, "__debuginfo", sizeof("__debuginfo") - 1))) {
  ce->__debugInfo = fe;
...
static void zend_add_trait_method(zend_class_entry *ce, const char *name, zend_string *key, zend_function *fn, HashTable **overriden)
{
 ...
 if ((existing_fn = zend_hash_find_ptr(&ce->function_table, key)) != ((void *)0)) {
  if (existing_fn->common.scope == ce) {
   ...
   if (*overriden) {
    if ((existing_fn = zend_hash_find_ptr(*overriden, key)) != ((void *)0)) {
     if (existing_fn->common.fn_flags & 0x02) {
      ...
      if (__builtin_expect(!!(!zend_traits_method_compatibility_check(fn, existing_fn)), 0)) {
      ...
      if (__builtin_expect(!!(!zend_traits_method_compatibility_check(existing_fn, fn)), 0)) {
       zend_error_noreturn((1<<6L), "Declaration of %s must be compatible with %s",
        (zend_get_function_declaration(fn))->val,
        (zend_get_function_declaration(existing_fn))->val);
      }
   ...
   return;
  } else if (__builtin_expect(!!(existing_fn->common.scope->ce_flags & 0x80), 0)) {
...
{
 if ((fn->common.scope->ce_flags & 0x80) == 0x80) {
  ...
  if (fn->type == 2 && fn->op_array.static_variables) {
...
static int zend_traits_copy_functions(zend_string *fnname, zend_function *fn, zend_class_entry *ce, HashTable **overriden, HashTable *exclude_table)
{
 ...
 if (exclude_table == ((void *)0) || zend_hash_find(exclude_table, fnname) == ((void *)0)) {
  ...
  memcpy(&fn_copy, fn, fn->type == 2? sizeof(zend_op_array) : sizeof(zend_internal_function));
...
static void zend_check_trait_usage(zend_class_entry *ce, zend_class_entry *trait)
{
 ...
 if (__builtin_expect(!!((trait->ce_flags & 0x80) != 0x80), 0)) {
...
static void zend_do_traits_method_binding(zend_class_entry *ce)
{
 ...
 for (i = 0; i < ce->num_traits; i++) {
  if (ce->trait_precedences) {
   ...
   do { Bucket *_p = (&ce->traits[i]->function_table)->arData; Bucket *_end = _p + (&ce->traits[i]->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; fn = (*(_z)).value.ptr; {
 ...
 do { Bucket *_p = (&ce->function_table)->arData; Bucket *_end = _p + (&ce->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; fn = (*(_z)).value.ptr; {
 ...
 if (ce->trait_precedences) {
  ...
  while (ce->trait_precedences[i]) {
   if (ce->trait_precedences[i]->exclude_from_classes) {
    ...
    ce->trait_precedences[i]->exclude_from_classes = ((void *)0);
   }
   i++;
  }
 }
 ...
 if (overriden) {
  ...
  do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(overriden); } else if (sizeof(HashTable) <= 16) { _efree_16(overriden); } else if (sizeof(HashTable) <= 24) { _efree_24(overriden); } else if (sizeof(HashTable) <= 32) { _efree_32(overriden); } else if (sizeof(HashTable) <= 40) { _efree_40(overriden); } else if (sizeof(HashTable) <= 48) { _efree_48(overriden); } else if (sizeof(HashTable) <= 56) { _efree_56(overriden); } else if (sizeof(HashTable) <= 64) { _efree_64(overriden); } else if (sizeof(HashTable) <= 80) { _efree_80(overriden); } else if (sizeof(HashTable) <= 96) { _efree_96(overriden); } else if (sizeof(HashTable) <= 112) { _efree_112(overriden); } else if (sizeof(HashTable) <= 128) { _efree_128(overriden); } else if (sizeof(HashTable) <= 160) { _efree_160(overriden); } else if (sizeof(HashTable) <= 192) { _efree_192(overriden); } else if (sizeof(HashTable) <= 224) { _efree_224(overriden); } else if (sizeof(HashTable) <= 256) { _efree_256(overriden); } else if (sizeof(HashTable) <= 320) { _efree_320(overriden); } else if (sizeof(HashTable) <= 384) { _efree_384(overriden); } else if (sizeof(HashTable) <= 448) { _efree_448(overriden); } else if (sizeof(HashTable) <= 512) { _efree_512(overriden); } else if (sizeof(HashTable) <= 640) { _efree_640(overriden); } else if (sizeof(HashTable) <= 768) { _efree_768(overriden); } else if (sizeof(HashTable) <= 896) { _efree_896(overriden); } else if (sizeof(HashTable) <= 1024) { _efree_1024(overriden); } else if (sizeof(HashTable) <= 1280) { _efree_1280(overriden); } else if (sizeof(HashTable) <= 1536) { _efree_1536(overriden); } else if (sizeof(HashTable) <= 1792) { _efree_1792(overriden); } else if (sizeof(HashTable) <= 2048) { _efree_2048(overriden); } else if (sizeof(HashTable) <= 2560) { _efree_2560(overriden); } else if (sizeof(HashTable) <= 3072) { _efree_3072(overriden); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(overriden, sizeof(HashTable)); } else { _efree_huge(overriden, sizeof(HashTable)); } } else { _efree(overriden); } } while (0);
 }
}
...
static void zend_do_traits_property_binding(zend_class_entry *ce)
{
 ...
 for (i = 0; i < ce->num_traits; i++) {
  do { Bucket *_p = (&ce->traits[i]->properties_info)->arData; Bucket *_end = _p + (&ce->traits[i]->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; property_info = (*(_z)).value.ptr; {
    ...
    if (coliding_prop->flags & 0x20000) {
     ...
     if ((coliding_prop->flags & ((0x100 | 0x200 | 0x400) | 0x01))
      ...
      if (flags & 0x01) {
       ...
       not_compatible = (FAILURE == compare_function(&compare_result,
             &ce->default_properties_table[((coliding_prop->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval))],
             &ce->traits[i]->default_properties_table[((property_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval))]))
          || ((compare_result).value.lval != 0);
      }
     } else {
   ...
   if (flags & 0x01) {
    ...
    prop_value = &ce->traits[i]->default_properties_table[((property_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval))];
   }
   if ((((*(prop_value)).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(prop_value);

   doc_comment = property_info->doc_comment ? zend_string_copy(property_info->doc_comment) : ((void *)0);
...
# 1598 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
...
void zend_check_deprecated_constructor(const zend_class_entry *ce)
{
 if (zend_has_deprecated_constructor(ce)) {
  zend_error((1<<13L), "Methods with the same name as their class will not be constructors in a future version of PHP; %s has a deprecated constructor", (ce->name)->val);
 }
}
