...
# 973 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"

# 1033 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 331 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
...
static __attribute__((cold)) void zend_append_type_hint(smart_str *str, const zend_function *fptr, zend_arg_info *arg_info, int return_hint)
{
 ...
 if (arg_info->type_hint != 0 && arg_info->allow_null) {
...
static void do_inheritance_check_on_method(zend_function *child, zend_function *parent)
{
 ...
 if (child->common.prototype && (
  child->common.prototype->common.fn_flags & 0x02
 )) {
  parent = child->common.prototype;
 }
 if (__builtin_expect(!!(!zend_do_perform_implementation_check(child, parent)), 0)) {
  int error_level;
  ...
  if (child->common.prototype && (
   ...
   error_level = (1<<6L);
   error_verb = "must";
  } else if ((parent->common.fn_flags & 0x40000000) &&
                   (!(child->common.fn_flags & 0x40000000) ||
  ...
  zend_error(error_level, "Declaration of %s %s be compatible with %s", (child_prototype)->val, error_verb, (method_prototype)->val);
 ...
 if (__builtin_expect(!!(child), 0)) {
  ...
  if (__builtin_expect(!!(parent_info->flags & (0x400|0x20000)), 0)) {
   ...
   if (__builtin_expect(!!((child_info->flags & (0x100 | 0x200 | 0x400)) > (parent_info->flags & (0x100 | 0x200 | 0x400))), 0)) {
    ...
    _zval_ptr_dtor_nogc((&(ce->default_properties_table[parent_num])) );
...
__attribute__ ((visibility("default"))) void zend_do_inheritance(zend_class_entry *ce, zend_class_entry *parent_ce)
{
 ...
 if (parent_ce->default_properties_count) {
  ...
  do {
   dst--;
   src--;
# 840 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
...
# 1631 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
