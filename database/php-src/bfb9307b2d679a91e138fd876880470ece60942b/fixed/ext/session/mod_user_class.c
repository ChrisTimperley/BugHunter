# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c" 2
# 43 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c"
void zim_SessionHandler_open(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *save_path = ((void *)0), *session_name = ((void *)0);
 int ret, save_path_len, session_name_len;

 if ((ps_globals.session_status) != php_session_active) { php_error_docref0(((void *)0) , (1<<1L), "Session is not active"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; } if ((ps_globals.default_mod) == ((void *)0)) { php_error_docref0(((void *)0) , (1<<4L), "Cannot call default session handler"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; };

 if (zend_parse_parameters((ht) , "ss", &save_path, &save_path_len, &session_name, &session_name_len) == FAILURE) {
  return;
 }

 (ps_globals.mod_user_is_open) = 1;
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ret =(ps_globals.default_mod)->s_open(&(ps_globals.mod_data), save_path, session_name );
 } } else { (executor_globals.bailout) = __orig_bailout; {
  (ps_globals.session_status) = php_session_none;
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c", 59);
 } } (executor_globals.bailout) = __orig_bailout; };

 do { zval *__z = (return_value); (*__z).value.lval = ((SUCCESS == ret) != 0); (*__z).type = 3; } while (0);
}




void zim_SessionHandler_close(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 int ret;

 if ((ps_globals.session_status) != php_session_active) { php_error_docref0(((void *)0) , (1<<1L), "Session is not active"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; } if ((ps_globals.default_mod) == ((void *)0)) { php_error_docref0(((void *)0) , (1<<4L), "Cannot call default session handler"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; }; if (!(ps_globals.mod_user_is_open)) { php_error_docref0(((void *)0) , (1<<1L), "Parent session handler is not open"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; };



 zend_parse_parameters((ht) , "");

 (ps_globals.mod_user_is_open) = 0;

 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ret = (ps_globals.default_mod)->s_close(&(ps_globals.mod_data) );
 } } else { (executor_globals.bailout) = __orig_bailout; {
  (ps_globals.session_status) = php_session_none;
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c", 84);
 } } (executor_globals.bailout) = __orig_bailout; };
...
void zim_SessionHandler_read(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *key, *val;
 int key_len, val_len;
 ...
 if (zend_parse_parameters((ht) , "s", &key, &key_len) == FAILURE) {
  return;
 }

 if ((ps_globals.default_mod)->s_read(&(ps_globals.mod_data), key, &val, &val_len ) == FAILURE) {
  do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0);
  return;
 }

 do { const char *__s=(val); int __l=val_len; zval *__z = (return_value); (*__z).value.str.len = __l; (*__z).value.str.val = (1?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0);
...
void zim_SessionHandler_write(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *key, *val;
 int key_len, val_len;
 ...
 if (zend_parse_parameters((ht) , "ss", &key, &key_len, &val, &val_len) == FAILURE) {
  return;
 }

 do { zval *__z = (return_value); (*__z).value.lval = ((SUCCESS == (ps_globals.default_mod)->s_write(&(ps_globals.mod_data), key, val, val_len )) != 0); (*__z).type = 3; } while (0);
}




void zim_SessionHandler_destroy(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *key;
 int key_len;
 ...
 do { zval *__z = (return_value); (*__z).value.lval = ((SUCCESS == (ps_globals.default_mod)->s_destroy(&(ps_globals.mod_data), key )) != 0); (*__z).type = 3; } while (0);
}




void zim_SessionHandler_gc(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 long maxlifetime;
 int nrdels;
 ...
 if (zend_parse_parameters((ht) , "l", &maxlifetime) == FAILURE) {
  return;
 }

 do { zval *__z = (return_value); (*__z).value.lval = ((SUCCESS == (ps_globals.default_mod)->s_gc(&(ps_globals.mod_data), maxlifetime, &nrdels )) != 0); (*__z).type = 3; } while (0);
}




void zim_SessionHandler_create_sid(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *id;
 ...
 id = (ps_globals.default_mod)->s_create_sid(&(ps_globals.mod_data), ((void *)0) );

 { do { const char *__s=(id); zval *__z = (return_value); (*__z).value.str.len = strlen(__s); (*__z).value.str.val = (0?_estrndup((__s), ((*__z).value.str.len) ):(char*)__s); (*__z).type = 6; } while (0); return; };
}
