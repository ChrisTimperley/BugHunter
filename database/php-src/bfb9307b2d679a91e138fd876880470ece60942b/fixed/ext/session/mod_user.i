# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c" 2

ps_module ps_mod_user = {
 "user", ps_open_user, ps_close_user, ps_read_user, ps_write_user, ps_delete_user, ps_gc_user, ps_create_sid_user
};
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c"
static zval *ps_call_handler(zval *func, int argc, zval **argv )
{
 ...
 if (call_user_function((executor_globals.function_table), ((void *)0), func, retval, argc, argv ) == FAILURE) {
...
# 79 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c"
int ps_open_user(void **mod_data, const char *save_path, const char *session_name )
{
 zval *args[2];
 zval *retval = ((void *)0); int ret = FAILURE;
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ...
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c", 101);
...
int ps_close_user(void **mod_data )
{
 ...
 if (bailout) {
  ...
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user.c", 131);
 }
...
char *ps_create_sid_user(void **mod_data, int *newlen )
{

 if ((ps_globals.mod_user_names).name.ps_create_sid != ((void *)0)) {
  char *id = ((void *)0);
  zval *retval = ((void *)0);

  retval = ps_call_handler((ps_globals.mod_user_names).name.ps_create_sid, 0, ((void *)0) );

  if (retval) {
   if ((*retval).type == 6) {
    id = _estrndup(((*retval).value.str.val), ((*retval).value.str.len) );
   }
   _zval_ptr_dtor((&retval) );
  }
  else {
   php_error_docref0(((void *)0) , (1<<0L), "No session id returned by function");
   return ((void *)0);
  }

  if (!id) {
   php_error_docref0(((void *)0) , (1<<0L), "Session id must be a string");
   return ((void *)0);
  }
 ...
 return php_session_create_id(mod_data, newlen );
}
