...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_user_class.c"
void zim_SessionHandler_open(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if ((ps_globals.default_mod) == ((void *)0)) { php_error_docref0(((void *)0) , (1<<4L), "Cannot call default session handler"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; };
 ...
 do { zval *__z = (return_value); (*__z).value.lval = ((SUCCESS == (ps_globals.default_mod)->s_open(&(ps_globals.mod_data), save_path, session_name )) != 0); (*__z).type = 3; } while (0);
}
...
void zim_SessionHandler_close(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 do { zval *__z = (return_value); (*__z).value.lval = ((SUCCESS == (ps_globals.default_mod)->s_close(&(ps_globals.mod_data) )) != 0); (*__z).type = 3; } while (0);
}
