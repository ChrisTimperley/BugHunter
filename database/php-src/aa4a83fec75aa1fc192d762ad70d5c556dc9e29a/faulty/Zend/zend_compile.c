...
# 582 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
void zend_stop_lexing(void)
{
...
__attribute__ ((visibility("default"))) void zend_initialize_class_data(zend_class_entry *ce, zend_bool nullify_handlers)
{
 ...
 if (ce->type == 1) {
# 1680 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
# 1802 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
 if (len == 0) {
 ...
 if (end < path) {
# 1834 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
  path[0] = '.';
  path[1] = '\0';
  return 1 + len_adjust;
 ...
 while (def != (compiler_globals.active_op_array)->opcodes) {
  ...
  if (def->result_type == type && def->result.var == var) {
   if (def->opcode == 72 ||
    ...
    zend_start_live_range((compiler_globals.active_op_array),
...
static void zend_emit_return_type_check(znode *expr, zend_arg_info *return_info)
{
 ...
 if (expr && return_info->type_hint == 18) {
