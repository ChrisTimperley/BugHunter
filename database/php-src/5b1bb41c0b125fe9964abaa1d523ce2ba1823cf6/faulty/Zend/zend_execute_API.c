...
__attribute__ ((visibility("default"))) const zend_fcall_info empty_fcall_info = { 0, ((void *)0), {{0}, {{0}}, {0}}, ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0, 0 };
__attribute__ ((visibility("default"))) const zend_fcall_info_cache empty_fcall_info_cache = { 0, ((void *)0), ((void *)0), ((void *)0), ((void *)0) };
# 84 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
void shutdown_executor(void)
{
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
# 272 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
# 312 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 ...
 if ((zval_get_type(&(*(p))) & 0x80)) {
  ...
  if ((*(p)).u1.v.const_flags & 0x080) {
   ...
   if ((executor_globals.scope) && (executor_globals.scope)->name) {
    do { zval *__z = (p); zend_string *__s = ((executor_globals.scope)->name); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
   } else {
   ...
   if (__builtin_expect(!!((executor_globals.exception)), 0)) {
    ...
    if (((*(p)).u1.v.const_flags & 0x010) == 0) {
     if ((save)->val[0] == '\\') {
      zend_throw_error(((void *)0), "Undefined constant '%s'", (save)->val + 1);
     } else {
   ...
   if ((((*(p)).u1.type_info & ((1<<0) << 8)) != 0)) {
    if (__builtin_expect(!!(zval_update_constant_ex(p, 1, ((void *)0)) != SUCCESS), 0)) {
     (*(p)).u1.type_info &= ~0x80;
     return FAILURE;
    }
   }
...
int zend_call_function(zend_fcall_info *fci, zend_fcall_info_cache *fci_cache)
{
 ...
 (call->This).value.obj = fci->object;
 ...
 do { if (__builtin_expect(!(fci->symbol_table == ((void *)0)), 0)) __builtin_unreachable(); } while (0);
...
__attribute__ ((visibility("default"))) int zend_eval_stringl(char *str, size_t str_len, zval *retval_ptr, char *string_name)
{
 ...
 if (new_op_array) {
  ...
  { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
   ...
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c", 1136);
  } } (executor_globals.bailout) = __orig_bailout; };
...
__attribute__ ((visibility("default"))) void zend_timeout(int dummy)
{
 ...
 if (zend_on_timeout) {
# 1201 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
# 1229 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
void zend_set_timeout(zend_long seconds, int reset_signals)
{

 (executor_globals.timeout_seconds) = seconds;
# 1262 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 {
...
{
# 1313 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
check_fetch_type:
 switch (fetch_sub_type) {
  case 1:
   if (__builtin_expect(!!(!(executor_globals.scope)), 0)) {
  ...
  case 2:
   ...
   if (__builtin_expect(!!(!(executor_globals.scope)->parent), 0)) {
...
# 1414 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
