...
{
 int retval = SUCCESS;
# 829 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 php_socket_t fd;
...
# 1384 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 p += request->vpath_len;
 *p = '\0';
 q = p;
 while (q > buf) {
...
# 1454 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 request->sb = sb;
}
...
# 1484 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 p = decoded_vpath;
...
# 1971 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
