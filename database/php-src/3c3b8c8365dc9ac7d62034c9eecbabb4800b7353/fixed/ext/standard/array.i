...
# 86 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
...
# 372 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
...
# 1035 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
...
void zif_end(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array_ht(_arg, &array, 0, 1)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 zend_hash_internal_pointer_end_ex(array, &(array)->nInternalPointer);

 if ((!((execute_data)->prev_execute_data) || !((((execute_data)->prev_execute_data)->func->common.type & 1) == 0) || !(((execute_data)->prev_execute_data)->opline->result_type & (1<<5)))) {
...
static int php_array_walk(HashTable *target_hash, zval *userdata, int recursive)
{
 ...
 while (!(executor_globals.exception) && (zv = zend_hash_get_current_data_ex(target_hash, &(target_hash)->nInternalPointer)) != ((void *)0)) {
  ...
  if (recursive &&
   ...
   do { zval *_zv = (zv); zend_array *_arr = (*(_zv)).value.arr; if ((_arr)->gc.refcount > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { (_arr)->gc.refcount--; } do { zval *__z = (_zv); (*(__z)).value.arr = (zend_array_dup(_arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0); } } while (0);
   thash = (*(zv)).value.arr;
...
void zif_array_walk(zend_execute_data *execute_data, zval *return_value)
{
 ...
 orig_array_walk_fci = (basic_globals.array_walk_fci);
 orig_array_walk_fci_cache = (basic_globals.array_walk_fci_cache);
# 1537 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
...
# 1742 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
    return 0;
   }
...
# 1826 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
 ...
 do { Bucket *_p = ((var_array).value.arr)->arData; Bucket *_end = _p + ((var_array).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; var_name = _p->key; entry = _z; {
  ...
  switch (extract_type) {
   ...
   case 0:
    ...
    if (var_exists && (var_name)->len == sizeof("this")-1 && !strcmp((var_name)->val, "this") && (executor_globals.scope) && ((executor_globals.scope)->name)->len != 0) {
     break;
    }
...
# 2127 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
void zif_range(zend_execute_data *execute_data, zval *return_value)
{
...
void zif_array_multisort(zend_execute_data *execute_data, zval *return_value)
{
 ...
 for (i = 0; i < argc; i++) {
  ...
  do { if (__builtin_expect(!!((zval_get_type(&(*(arg))) == 10)), 0)) { (arg) = &(*(arg)).value.ref->val; } } while (0);
  if (zval_get_type(&(*(arg))) == 7) {
   do { zval *_zv = (arg); zend_array *_arr = (*(_zv)).value.arr; if ((_arr)->gc.refcount > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { (_arr)->gc.refcount--; } do { zval *__z = (_zv); (*(__z)).value.arr = (zend_array_dup(_arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0); } } while (0);
