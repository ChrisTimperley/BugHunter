# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
# 43 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c" 2
...
__attribute__ ((visibility("default"))) const zend_fcall_info empty_fcall_info = { 0, {{0}, {{0}}, {0}}, ((void *)0), ((void *)0), ((void *)0), 0, 0 };
__attribute__ ((visibility("default"))) const zend_fcall_info_cache empty_fcall_info_cache = { 0, ((void *)0), ((void *)0), ((void *)0), ((void *)0) };
# 87 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
void init_executor(void)
{
 ...
 do { (*(&(executor_globals.error_zval))).u1.type_info = 19; } while (0);
 ...
 _zend_hash_init((&(executor_globals.symbol_table)), (64), (_zval_ptr_dtor), (0) );
 ...
 (executor_globals.ht_iterators_count) = sizeof((executor_globals.ht_iterators_slots)) / sizeof(HashTableIterator);
 (executor_globals.ht_iterators_used) = 0;
 (executor_globals.ht_iterators) = (executor_globals.ht_iterators_slots);
 memset((executor_globals.ht_iterators), 0, sizeof((executor_globals.ht_iterators_slots)));
...
void shutdown_destructors(void)
{
 if ((compiler_globals.unclean_shutdown)) {
  (executor_globals.symbol_table).pDestructor = zend_unclean_zval_ptr_dtor;
 }
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  uint32_t symbols;
  do {
   symbols = (&(executor_globals.symbol_table))->nNumOfElements;
   zend_hash_reverse_apply(&(executor_globals.symbol_table), (apply_func_t) zval_call_destructor);
  } while (symbols != (&(executor_globals.symbol_table))->nNumOfElements);
...
void shutdown_executor(void)
{
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
# 274 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ...
  zend_stack_clean(&(executor_globals.user_error_handlers), (void (*)(void *))_zval_ptr_dtor, 1);
  zend_stack_clean(&(executor_globals.user_exception_handlers), (void (*)(void *))_zval_ptr_dtor, 1);
 } } (executor_globals.bailout) = __orig_bailout; };

 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
# 314 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
  if ((executor_globals.full_tables_cleanup)) {
   do { Bucket *_p = ((executor_globals.function_table))->arData; Bucket *_end = _p + ((executor_globals.function_table))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; func = (*(_z)).value.ptr; {
    if (func->type == 2) {
     zend_cleanup_op_array_data((zend_op_array *) func);
    }
   } } } while (0);
   do { uint _idx; for (_idx = ((executor_globals.class_table))->nNumUsed; _idx > 0; _idx--) { Bucket *_p = ((executor_globals.class_table))->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; ce = (*(_z)).value.ptr; {
    if (ce->type == 2) {
   ...
   do { uint _idx; for (_idx = ((executor_globals.function_table))->nNumUsed; _idx > 0; _idx--) { Bucket *_p = ((executor_globals.function_table))->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; func = (*(_z)).value.ptr; {
    if (func->type != 2) {
     break;
    }
    zend_cleanup_op_array_data((zend_op_array *) func);
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ...
  while ((executor_globals.symtable_cache_ptr)>=(executor_globals.symtable_cache)) {
   ...
   do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 16) { _efree_16(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 24) { _efree_24(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 32) { _efree_32(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 40) { _efree_40(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 48) { _efree_48(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 56) { _efree_56(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 64) { _efree_64(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 80) { _efree_80(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 96) { _efree_96(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 112) { _efree_112(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 128) { _efree_128(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 160) { _efree_160(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 192) { _efree_192(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 224) { _efree_224(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 256) { _efree_256(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 320) { _efree_320(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 384) { _efree_384(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 448) { _efree_448(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 512) { _efree_512(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 640) { _efree_640(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 768) { _efree_768(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 896) { _efree_896(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 1024) { _efree_1024(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 1280) { _efree_1280(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 1536) { _efree_1536(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 1792) { _efree_1792(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 2048) { _efree_2048(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 2560) { _efree_2560(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= 3072) { _efree_3072(*(executor_globals.symtable_cache_ptr)); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(*(executor_globals.symtable_cache_ptr), sizeof(HashTable)); } else { _efree_huge(*(executor_globals.symtable_cache_ptr), sizeof(HashTable)); } } else { _efree(*(executor_globals.symtable_cache_ptr)); } } while (0);
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ...
  if ((executor_globals.in_autoload)) {
   ...
   do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 16) { _efree_16((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 24) { _efree_24((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 32) { _efree_32((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 40) { _efree_40((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 48) { _efree_48((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 56) { _efree_56((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 64) { _efree_64((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 80) { _efree_80((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 96) { _efree_96((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 112) { _efree_112((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 128) { _efree_128((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 160) { _efree_160((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 192) { _efree_192((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 224) { _efree_224((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 256) { _efree_256((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 320) { _efree_320((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 384) { _efree_384((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 448) { _efree_448((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 512) { _efree_512((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 640) { _efree_640((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 768) { _efree_768((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 896) { _efree_896((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 1024) { _efree_1024((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 1280) { _efree_1280((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 1536) { _efree_1536((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 1792) { _efree_1792((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 2048) { _efree_2048((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 2560) { _efree_2560((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= 3072) { _efree_3072((executor_globals.in_autoload)); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large((executor_globals.in_autoload), sizeof(HashTable)); } else { _efree_huge((executor_globals.in_autoload), sizeof(HashTable)); } } else { _efree((executor_globals.in_autoload)); } } while (0);
  }
 } } (executor_globals.bailout) = __orig_bailout; };
 ...
 if ((executor_globals.ht_iterators) != (executor_globals.ht_iterators_slots)) {
  _efree(((executor_globals.ht_iterators)) );
 }
...
__attribute__ ((visibility("default"))) zend_class_entry *zend_get_executed_scope(void)
{
 ...
 while (1) {
  if (!ex) {
   return ((void *)0);
  } else if (ex->func && (((ex->func->type & 1) == 0) || ex->func->common.scope)) {
...
__attribute__ ((visibility("default"))) int zval_update_constant_ex(zval *p, zend_class_entry *scope)
{
 zval *const_value;
 char *colon;
 zend_bool inline_change;

 if (zval_get_type(&(*(p))) == 11) {
  if (((*(p)).u1.v.const_flags & 0x020)) {
   zend_throw_error(((void *)0), "Cannot declare self-referencing constant '%s'", ((*(p)).value.str)->val);
   return FAILURE;
  }
  inline_change = ((*(p)).u1.v.type_flags & (1<<1)) == 0;
  do { zval *_zv = (p); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0);
  (*(p)).u1.v.const_flags |= 0x020;
  if ((*(p)).u1.v.const_flags & 0x080) {
   do { if (__builtin_expect(!((executor_globals.current_execute_data)), 0)) __builtin_unreachable(); } while (0);
   if (inline_change) {
    zend_string_release((*(p)).value.str);
   }
   if (scope && scope->name) {
    do { zval *__z = (p); zend_string *__s = (scope->name); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
   } else {
    do { do { zval *__z = (p); zend_string *__s = ((compiler_globals.empty_string)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = 6; } while (0); } while (0);
   }
  } else if (__builtin_expect(!!((const_value = zend_get_constant_ex((*(p)).value.str, scope, (*(p)).u1.v.const_flags)) == ((void *)0)), 0)) {
   char *actual = ((*(p)).value.str)->val;

   if (__builtin_expect(!!((executor_globals.exception)), 0)) {
    (*(p)).u1.v.const_flags &= ~0x020;
    return FAILURE;
   } else if ((colon = (char*)zend_memrchr(((*(p)).value.str)->val, ':', ((*(p)).value.str)->len))) {
    zend_throw_error(((void *)0), "Undefined class constant '%s'", ((*(p)).value.str)->val);
    (*(p)).u1.v.const_flags &= ~0x020;
    return FAILURE;
   } else {
    zend_string *save = (*(p)).value.str;
    char *slash;
    size_t actual_len = ((*(p)).value.str)->len;
    if (((*(p)).u1.v.const_flags & 0x010) && (slash = (char *)zend_memrchr(actual, '\\', actual_len))) {
     ...
     if (inline_change) {
      ...
      (*(p)).value.str = s;
      (*(p)).u1.v.type_flags = (1<<2) | (1<<4);
     }
    }
    if (((*(p)).u1.v.const_flags & 0x010) == 0) {
     zend_throw_error(((void *)0), "Undefined constant '%s'", (save)->val);
     if (inline_change) {
     ...
     if (!inline_change) {
      do { do { zval *__z = (p); zend_string *__s = (zend_string_init(actual, actual_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
     } else {
      (*(p)).u1.type_info = (((*(p)).u1.v.type_flags & (1<<2)) != 0) ?
       (6 | (( (1<<2) | (1<<4)) << 8)) : 6;
   ...
   do { zval *_z1 = (p); const zval *_z2 = (const_value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  ...
  inline_change = ((*(p)).u1.v.type_flags & (1<<1)) == 0;
  if (__builtin_expect(!!(zend_ast_evaluate(&tmp, (*(p)).value.ast->ast, scope) != SUCCESS), 0)) {
   return FAILURE;
  }
  if (inline_change) {
   _zval_ptr_dtor((p) );
  }
  do { zval *_z1 = (p); const zval *_z2 = (&tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }
 return SUCCESS;
}
...
__attribute__ ((visibility("default"))) int zval_update_constant(zval *pp)
{
 return zval_update_constant_ex(pp, (executor_globals.current_execute_data) ? zend_get_executed_scope() : (compiler_globals.active_class_entry));
}
...
int _call_user_function_ex(zval *object, zval *function_name, zval *retval_ptr, uint32_t param_count, zval params[], int no_separation)
{
 ...
 do { zval *_z1 = (&fci.function_name); const zval *_z2 = (function_name); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
int zend_call_function(zend_fcall_info *fci, zend_fcall_info_cache *fci_cache)
{
 ...
 switch (fci->size) {
  case sizeof(zend_fcall_info):
   break;
  default:
   zend_error_noreturn((1<<4L), "Corrupted fcall_info provided to zend_call_function()");
   break;
 }
 ...
 fci->object = (func->common.fn_flags & 0x01) ?
  ((void *)0) : fci_cache->object;

 call = zend_vm_stack_push_call_frame(ZEND_CALL_TOP_FUNCTION | (1 << 9),
 ...
 if (func->common.fn_flags & (0x02|0x40000)) {
  if (func->common.fn_flags & 0x02) {
   zend_throw_error(((void *)0), "Cannot call abstract method %s::%s()", (func->common.scope->name)->val, (func->common.function_name)->val);
   if ((executor_globals.current_execute_data) == &dummy_execute_data) {
    (executor_globals.current_execute_data) = dummy_execute_data.prev_execute_data;
   }
   return FAILURE;
 ...
 for (i=0; i<fci->param_count; i++) {
  ...
  if (zend_check_arg_send_type(func, i + 1, 1|2)) {
   if (__builtin_expect(!!(!(zval_get_type(&(*(arg))) == 10)), 0)) {
    if (fci->no_separation &&
     !zend_check_arg_send_type(func, i + 1, 2)) {
     if (i) {
  ...
  param = (((zval*)(call)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(i+1)) - 1))));
 ...
 if (__builtin_expect(!!(func->op_array.fn_flags & 0x100000), 0)) {
  do { if (__builtin_expect(!(((zend_object*)func->op_array.prototype)->gc.u.v.type == 8), 0)) __builtin_unreachable(); } while (0);
  ((zend_object*)func->op_array.prototype)->gc.refcount++;
  do { do { ((call)->This).u1.type_info |= (((1 << 5)) << 16); } while (0); } while (0);
 }
...
__attribute__ ((visibility("default"))) zend_class_entry *zend_lookup_class_ex(zend_string *name, const zval *key, int use_autoload)
{
 ...
 if (!(executor_globals.autoload_func)) {
  zend_function *func = zend_hash_find_ptr((executor_globals.function_table), (compiler_globals.known_strings)[ZEND_STR_MAGIC_AUTOLOAD]);
  if (func) {
 ...
 if ((name)->val[0] == '\\') {
  do { do { zval *__z = (&args[0]); zend_string *__s = (zend_string_init((name)->val + 1, (name)->len - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 } else {
  do { zval *__z = (&args[0]); zend_string *__s = (name); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
 }

 fcall_info.size = sizeof(fcall_info);
 do { zval *__z = (&fcall_info.function_name); zend_string *__s = ((executor_globals.autoload_func)->common.function_name); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
 ...
 zend_exception_save();
 if ((zend_call_function(&fcall_info, &fcall_cache) == SUCCESS) && !(executor_globals.exception)) {
  ce = zend_hash_find_ptr((executor_globals.class_table), lc_name);
 }
 zend_exception_restore();

 _zval_ptr_dtor((&args[0]) );
 _zval_ptr_dtor_nogc((&fcall_info.function_name) );
...
__attribute__ ((visibility("default"))) zend_class_entry *zend_get_called_scope(zend_execute_data *ex)
{
 while (ex) {
  if (zval_get_type(&(ex->This)) == 8) {
   return ((ex->This).value.obj->ce);
  } else if ((ex->This).value.ce) {
   return (ex->This).value.ce;
  } else if (ex->func) {
   if (ex->func->type != 1 || ex->func->common.scope) {
    return ((void *)0);
   }
  }
  ex = ex->prev_execute_data;
...
__attribute__ ((visibility("default"))) int zend_eval_stringl(char *str, size_t str_len, zval *retval_ptr, char *string_name)
{
 ...
 if (retval_ptr) {
  do { zval *__z = (&pv); zend_string *__s = (zend_string_alloc(str_len + sizeof("return ;")-1, 1)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
  ...
  do { do { zval *__z = (&pv); zend_string *__s = (zend_string_init(str, str_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 }
 ...
 if (new_op_array) {
  ...
  { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
   ...
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c", 1105);
  } } (executor_globals.bailout) = __orig_bailout; };

  if (zval_get_type(&(local_retval)) != 0) {
   if (retval_ptr) {
    do { zval *_z1 = (retval_ptr); const zval *_z2 = (&local_retval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   } else {
    _zval_ptr_dtor((&local_retval) );
   }
  } else {
...
__attribute__ ((visibility("default"))) __attribute__((noreturn)) void zend_timeout(int dummy)
{
# 1175 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 (executor_globals.timed_out) = 0;
 zend_set_timeout_ex(0, 1);


 zend_error_noreturn((1<<0L), "Maximum execution time of " "%" "l" "d" " second%s exceeded", (executor_globals.timeout_seconds), (executor_globals.timeout_seconds) == 1 ? "" : "s");
}
...
static void zend_timeout_handler(int dummy)
{
  ...
  const char *error_filename = ((void *)0);
  uint error_lineno = 0;
  ...
  zend_spprintf(&log_buffer, 0, "\nFatal error: Maximum execution time of " "%" "l" "d" "+" "%" "l" "d" " seconds exceeded (terminated) in %s on line %d\n", (executor_globals.timeout_seconds), (executor_globals.hard_timeout), error_filename, error_lineno);
 ...
 (executor_globals.vm_interrupt) = 1;


 if ((executor_globals.hard_timeout) > 0) {

  zend_set_timeout_ex((executor_globals.hard_timeout), 1);
 }

}
# 1263 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
static void zend_set_timeout_ex(zend_long seconds, int reset_signals)
{
 zend_executor_globals *eg;
# 1293 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 {
...
# 1330 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
  }
 }
...
{
# 1361 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
zend_class_entry *zend_fetch_class(zend_string *class_name, int fetch_type)
{
 ...
 int fetch_sub_type = fetch_type & 0x0f;

check_fetch_type:
 switch (fetch_sub_type) {
  case 1:
   scope = zend_get_executed_scope();
   if (__builtin_expect(!!(!scope), 0)) {
  ...
  case 4: {
    ...
    if (__builtin_expect(!!(fetch_sub_type != 0), 0)) {
 ...
 if (fetch_type & 0x80) {
  return zend_lookup_class_ex(class_name, ((void *)0), 0);
 } else if ((ce = zend_lookup_class_ex(class_name, ((void *)0), 1)) == ((void *)0)) {
  if (!(fetch_type & 0x0100) && !(executor_globals.exception)) {
   if (fetch_sub_type == 5) {
    zend_throw_or_error(fetch_type, ((void *)0), "Interface '%s' not found", (class_name)->val);
   } else if (fetch_sub_type == 6) {
    zend_throw_or_error(fetch_type, ((void *)0), "Trait '%s' not found", (class_name)->val);
   } else {
    zend_throw_or_error(fetch_type, ((void *)0), "Class '%s' not found", (class_name)->val);
   }
  }
  return ((void *)0);
 }
...
zend_class_entry *zend_fetch_class_by_name(zend_string *class_name, const zval *key, int fetch_type)
{
 ...
 } else if ((ce = zend_lookup_class_ex(class_name, key, 1)) == ((void *)0)) {
...
# 1465 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
void zend_verify_abstract_class(zend_class_entry *ce)
{
 ...
 if ((ce->ce_flags & 0x10) && !(ce->ce_flags & (0x80 | 0x20))) {
  ...
  if (ai.cnt) {
   zend_error_noreturn((1<<0L), "Class %s contains %d abstract method%s and must therefore be declared abstract or implement the remaining methods (" "%s%s%s%s" "%s%s%s%s" "%s%s%s%s" ")",
    (ce->name)->val, ai.cnt,
    ai.cnt > 1 ? "s" : "",
...
__attribute__ ((visibility("default"))) int zend_delete_global_variable(zend_string *name)
{
    return zend_hash_del_ind(&(executor_globals.symbol_table), name);
}
...
__attribute__ ((visibility("default"))) zend_array *zend_rebuild_symbol_table(void)
{
 ...
 if ((((ex)->This).u1.type_info >> 16) & (1 << 4)) {
  return ex->symbol_table;
 }

 do { do { ((ex)->This).u1.type_info |= (((1 << 4)) << 16); } while (0); } while (0);
 ...
 if (__builtin_expect(!!(ex->func->op_array.last_var), 1)) {
  zend_string **str = ex->func->op_array.vars;
  zend_string **end = str + ex->func->op_array.last_var;
  zval *var = (((zval*)(ex)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))));
...
__attribute__ ((visibility("default"))) void zend_attach_symbol_table(zend_execute_data *execute_data)
{
 ...
 if (__builtin_expect(!!(op_array->last_var), 1)) {
  zend_string **str = op_array->vars;
  zend_string **end = str + op_array->last_var;
  zval *var = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))));
  ...
  do {
   ...
   if (zv) {
    if (zval_get_type(&(*(zv))) == 15) {
     ...
     do { zval *_z1 = (var); const zval *_z2 = (val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    } else {
     do { zval *_z1 = (var); const zval *_z2 = (zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    }
   } else {
    do { (*(var)).u1.type_info = 0; } while (0);
    zv = _zend_hash_add_new(ht, *str, var );
   }
   do { (*(zv)).value.zv = (var); (*(zv)).u1.type_info = 15; } while (0);
   str++;
   var++;
  } while (str != end);
 }
...
__attribute__ ((visibility("default"))) void zend_detach_symbol_table(zend_execute_data *execute_data)
{
 ...
 if (__builtin_expect(!!(op_array->last_var), 1)) {
  ...
  do {
   if (zval_get_type(&(*(var))) == 0) {
    zend_hash_del(ht, *str);
   } else {
    _zend_hash_update(ht, *str, var );
    do { (*(var)).u1.type_info = 0; } while (0);
   }
   str++;
   var++;
...
__attribute__ ((visibility("default"))) int zend_set_local_var(zend_string *name, zval *value, int force)
{
 ...
 if (execute_data) {
  if (!((((execute_data)->This).u1.type_info >> 16) & (1 << 4))) {
   ...
   if (__builtin_expect(!!(op_array->last_var), 1)) {
    ...
    do {
     if ((*str)->h == h &&
      ...
      zval *var = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(str - op_array->vars))));
      do { zval *_z1 = (var); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
      return SUCCESS;
     }
     str++;
    } while (str != end);
   ...
   if (force) {
    ...
    if (symbol_table) {
     return _zend_hash_update(symbol_table, name, value ) ? SUCCESS : FAILURE;;
    }
   }
  } else {
   return (_zend_hash_update_ind(execute_data->symbol_table, name, value ) != ((void *)0)) ? SUCCESS : FAILURE;
  }
 }
 return FAILURE;
}
 ...
 if (execute_data) {
  if (!((((execute_data)->This).u1.type_info >> 16) & (1 << 4))) {
   ...
   if (force) {
    zend_array *symbol_table = zend_rebuild_symbol_table();
    if (symbol_table) {
     return _zend_hash_str_update(symbol_table, name, len, value ) ? SUCCESS : FAILURE;;
    }
   }
  } else {
   return (_zend_hash_str_update_ind(execute_data->symbol_table, name, len, value ) != ((void *)0)) ? SUCCESS : FAILURE;
  }
 }
 return FAILURE;
}
...
__attribute__ ((visibility("default"))) int zend_forbid_dynamic_call(const char *func_name)
{
 ...
 if ((((ex)->This).u1.type_info >> 16) & (1 << 9)) {
  zend_error((1<<1L), "Cannot call %s dynamically", func_name);
  return FAILURE;
 }
