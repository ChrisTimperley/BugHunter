...
int zm_deactivate_streams(int type, int module_number)
{
 zend_hash_apply(&(executor_globals.persistent_list), forget_persistent_resource_id_numbers);
 return SUCCESS;
}
...
__attribute__ ((visibility("default"))) int php_stream_from_persistent_id(const char *persistent_id, php_stream **stream)
{
 ...
 if ((le = zend_hash_str_find_ptr(&(executor_globals.persistent_list), persistent_id, strlen(persistent_id))) != ((void *)0)) {
  if (le->type == le_pstream) {
   if (stream) {
    zend_resource *regentry = ((void *)0);




    *stream = (php_stream*)le->ptr;
    do { Bucket *_p = (&(executor_globals.regular_list))->arData; Bucket *_end = _p + (&(executor_globals.regular_list))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; regentry = (*(_z)).value.ptr; {
...
void php_stream_display_wrapper_errors(php_stream_wrapper *wrapper, const char *path, const char *caption)
{
 ...
 if (wrapper) {
  ...
  if (err_list) {
   ...
   msg = (__builtin_constant_p((l + 1) ) ? (((l + 1) <= 8) ? _emalloc_8() : (((l + 1) <= 16) ? _emalloc_16() : (((l + 1) <= 24) ? _emalloc_24() : (((l + 1) <= 32) ? _emalloc_32() : (((l + 1) <= 40) ? _emalloc_40() : (((l + 1) <= 48) ? _emalloc_48() : (((l + 1) <= 56) ? _emalloc_56() : (((l + 1) <= 64) ? _emalloc_64() : (((l + 1) <= 80) ? _emalloc_80() : (((l + 1) <= 96) ? _emalloc_96() : (((l + 1) <= 112) ? _emalloc_112() : (((l + 1) <= 128) ? _emalloc_128() : (((l + 1) <= 160) ? _emalloc_160() : (((l + 1) <= 192) ? _emalloc_192() : (((l + 1) <= 224) ? _emalloc_224() : (((l + 1) <= 256) ? _emalloc_256() : (((l + 1) <= 320) ? _emalloc_320() : (((l + 1) <= 384) ? _emalloc_384() : (((l + 1) <= 448) ? _emalloc_448() : (((l + 1) <= 512) ? _emalloc_512() : (((l + 1) <= 640) ? _emalloc_640() : (((l + 1) <= 768) ? _emalloc_768() : (((l + 1) <= 896) ? _emalloc_896() : (((l + 1) <= 1024) ? _emalloc_1024() : (((l + 1) <= 1280) ? _emalloc_1280() : (((l + 1) <= 1536) ? _emalloc_1536() : (((l + 1) <= 1792) ? _emalloc_1792() : (((l + 1) <= 2048) ? _emalloc_2048() : (((l + 1) <= 2560) ? _emalloc_2560() : (((l + 1) <= 3072) ? _emalloc_3072() : (((l + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((l + 1)) : _emalloc_huge((l + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((l + 1) ) );
   msg[0] = '\0';
   for (err_buf_p = zend_llist_get_first_ex(err_list, &pos), i = 0;
     err_buf_p;
     err_buf_p = zend_llist_get_next_ex(err_list, &pos), i++) {
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_alloc(php_stream_ops *ops, void *abstract, const char *persistent_id, const char *mode )
{
 ...
 ret = (php_stream*) (((persistent_id ? 1 : 0))?__zend_malloc((sizeof(php_stream))):(__builtin_constant_p(((sizeof(php_stream))) ) ? ((((sizeof(php_stream))) <= 8) ? _emalloc_8() : ((((sizeof(php_stream))) <= 16) ? _emalloc_16() : ((((sizeof(php_stream))) <= 24) ? _emalloc_24() : ((((sizeof(php_stream))) <= 32) ? _emalloc_32() : ((((sizeof(php_stream))) <= 40) ? _emalloc_40() : ((((sizeof(php_stream))) <= 48) ? _emalloc_48() : ((((sizeof(php_stream))) <= 56) ? _emalloc_56() : ((((sizeof(php_stream))) <= 64) ? _emalloc_64() : ((((sizeof(php_stream))) <= 80) ? _emalloc_80() : ((((sizeof(php_stream))) <= 96) ? _emalloc_96() : ((((sizeof(php_stream))) <= 112) ? _emalloc_112() : ((((sizeof(php_stream))) <= 128) ? _emalloc_128() : ((((sizeof(php_stream))) <= 160) ? _emalloc_160() : ((((sizeof(php_stream))) <= 192) ? _emalloc_192() : ((((sizeof(php_stream))) <= 224) ? _emalloc_224() : ((((sizeof(php_stream))) <= 256) ? _emalloc_256() : ((((sizeof(php_stream))) <= 320) ? _emalloc_320() : ((((sizeof(php_stream))) <= 384) ? _emalloc_384() : ((((sizeof(php_stream))) <= 448) ? _emalloc_448() : ((((sizeof(php_stream))) <= 512) ? _emalloc_512() : ((((sizeof(php_stream))) <= 640) ? _emalloc_640() : ((((sizeof(php_stream))) <= 768) ? _emalloc_768() : ((((sizeof(php_stream))) <= 896) ? _emalloc_896() : ((((sizeof(php_stream))) <= 1024) ? _emalloc_1024() : ((((sizeof(php_stream))) <= 1280) ? _emalloc_1280() : ((((sizeof(php_stream))) <= 1536) ? _emalloc_1536() : ((((sizeof(php_stream))) <= 1792) ? _emalloc_1792() : ((((sizeof(php_stream))) <= 2048) ? _emalloc_2048() : ((((sizeof(php_stream))) <= 2560) ? _emalloc_2560() : ((((sizeof(php_stream))) <= 3072) ? _emalloc_3072() : ((((sizeof(php_stream))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((sizeof(php_stream)))) : _emalloc_huge(((sizeof(php_stream))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((sizeof(php_stream))) ) ));
 ...
 if (persistent_id) {
  ...
  do { zend_resource *_res = (zend_resource *) malloc(sizeof(zend_resource)); zval *__z; (_res)->gc.refcount = 1; (_res)->gc.u.type_info = 9; _res->handle = (-1); _res->type = (le_pstream); _res->ptr = (ret); __z = (&tmp); (*__z).value.res = _res; (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0);

  if (((void *)0) == _zend_hash_str_update(&(executor_globals.persistent_list), persistent_id, strlen(persistent_id), &tmp )
                                 ) {
...
__attribute__ ((visibility("default"))) int _php_stream_free_enclosed(php_stream *stream_enclosed, int close_options)
{
 return _php_stream_free((stream_enclosed), (close_options | 32))
                                                   ;
}
# 354 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
...
# 388 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
 if (stream->in_free) {
 ...
 if ((close_options & 8) &&
  ...
  return _php_stream_free((enclosing_stream), ((close_options | 1) & ~8))
                                                                            ;
 }
 ...
 if (close_options & 2) {
  ...
  if (stream->is_persistent && (close_options & 16)) {
   ...
   zend_hash_apply_with_argument(&(executor_globals.persistent_list), _php_stream_free_persistent, stream);
  }
# 535 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
  if (stream->orig_path) {
...
__attribute__ ((visibility("default"))) void _php_stream_fill_read_buffer(php_stream *stream, size_t size)
{
 ...
 if (stream->readfilters.head) {
  ...
  chunk_buf = (__builtin_constant_p((stream->chunk_size) ) ? (((stream->chunk_size) <= 8) ? _emalloc_8() : (((stream->chunk_size) <= 16) ? _emalloc_16() : (((stream->chunk_size) <= 24) ? _emalloc_24() : (((stream->chunk_size) <= 32) ? _emalloc_32() : (((stream->chunk_size) <= 40) ? _emalloc_40() : (((stream->chunk_size) <= 48) ? _emalloc_48() : (((stream->chunk_size) <= 56) ? _emalloc_56() : (((stream->chunk_size) <= 64) ? _emalloc_64() : (((stream->chunk_size) <= 80) ? _emalloc_80() : (((stream->chunk_size) <= 96) ? _emalloc_96() : (((stream->chunk_size) <= 112) ? _emalloc_112() : (((stream->chunk_size) <= 128) ? _emalloc_128() : (((stream->chunk_size) <= 160) ? _emalloc_160() : (((stream->chunk_size) <= 192) ? _emalloc_192() : (((stream->chunk_size) <= 224) ? _emalloc_224() : (((stream->chunk_size) <= 256) ? _emalloc_256() : (((stream->chunk_size) <= 320) ? _emalloc_320() : (((stream->chunk_size) <= 384) ? _emalloc_384() : (((stream->chunk_size) <= 448) ? _emalloc_448() : (((stream->chunk_size) <= 512) ? _emalloc_512() : (((stream->chunk_size) <= 640) ? _emalloc_640() : (((stream->chunk_size) <= 768) ? _emalloc_768() : (((stream->chunk_size) <= 896) ? _emalloc_896() : (((stream->chunk_size) <= 1024) ? _emalloc_1024() : (((stream->chunk_size) <= 1280) ? _emalloc_1280() : (((stream->chunk_size) <= 1536) ? _emalloc_1536() : (((stream->chunk_size) <= 1792) ? _emalloc_1792() : (((stream->chunk_size) <= 2048) ? _emalloc_2048() : (((stream->chunk_size) <= 2560) ? _emalloc_2560() : (((stream->chunk_size) <= 3072) ? _emalloc_3072() : (((stream->chunk_size) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((stream->chunk_size)) : _emalloc_huge((stream->chunk_size))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((stream->chunk_size) ) );
...
__attribute__ ((visibility("default"))) size_t _php_stream_read(php_stream *stream, char *buf, size_t size)
{
 ...
 while (size > 0) {
  ...
  if (!stream->readfilters.head && (stream->flags & 0x2 || stream->chunk_size == 1)) {
...
# 895 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
 for (;;) {
  avail = stream->writepos - stream->readpos;
  ...
  if (avail > 0) {
   ...
   if (grow_mode) {
    ...
    bufstart = _erealloc((bufstart), (current_buf_size + cpysz + 1) );
...
static size_t _php_stream_write_buffer(php_stream *stream, const char *buf, size_t count)
{
 ...
 if (stream->ops->seek && (stream->flags & 0x1) == 0 && stream->readpos != stream->writepos) {
 ...
 while (count > 0) {
  ...
  if ((int)justwrote > 0) {
   ...
   if (stream->ops->seek && (stream->flags & 0x1) == 0) {
...
__attribute__ ((visibility("default"))) size_t _php_stream_write(php_stream *stream, const char *buf, size_t count)
{
 ...
 if (stream->writefilters.head) {
  bytes = _php_stream_write_filtered(stream, buf, count, 0);
 } else {
 ...
 if (ret == -2) {
  switch(option) {
   case 5:
    ...
    ret = stream->chunk_size > 2147483647 ? 2147483647 : (int)stream->chunk_size;
 ...
 if ((!(((stream))->readfilters.head || ((stream))->writefilters.head) && (_php_stream_set_option(((stream)), 9, PHP_STREAM_MMAP_SUPPORTED, ((void *)0)) == 0 ? 1 : 0))) {
  ...
  if (p) {
   do {
    ...
    if (0 < (b = php_output_write((p + bcount), ((((mapped - bcount)<(2147483647))?(mapped - bcount):(2147483647)))))) {
     bcount += b;
    }
...
{
 ((file_globals.stream_wrappers)) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
 _zend_hash_init(((file_globals.stream_wrappers)), ((&url_stream_wrappers_hash)->nNumOfElements), (((void *)0)), (1) );
  ...
  zend_string **opened_path, php_stream_context *context )
{
 ...
 zend_string *resolved_path = ((void *)0);
 ...
 if (stream && stream->ops->seek && (stream->flags & 0x1) == 0 && strchr(mode, 'a') && stream->position == 0) {
  zend_off_t newpos = 0;
...
__attribute__ ((visibility("default"))) php_stream_context *php_stream_context_set(php_stream *stream, php_stream_context *context)
{
 php_stream_context *oldcontext = ((php_stream_context*) ((stream)->ctx ? ((stream)->ctx->ptr) : ((void *)0)));
  ...
  const char *wrappername, const char *optionname)
{
 ...
 if (((void *)0) == (wrapperhash = zend_hash_str_find((context->options).value.arr, wrappername, strlen(wrappername)))) {
  return ((void *)0);
 }
 return zend_hash_str_find((*(wrapperhash)).value.arr, optionname, strlen(optionname));
}
  ...
  const char *wrappername, const char *optionname, zval *optionvalue)
{
 ...
 wrapperhash = zend_hash_str_find((context->options).value.arr, wrappername, strlen(wrappername));
 if (((void *)0) == wrapperhash) {
  _array_init((&category), 0 );
  wrapperhash = _zend_hash_str_update((context->options).value.arr, (char*)wrappername, strlen(wrappername), &category );
  if (((void *)0) == wrapperhash) {
   return FAILURE;
  }
 }
 do { if (__builtin_expect(!!((zval_get_type(&(*(optionvalue))) == 10)), 0)) { (optionvalue) = &(*(optionvalue)).value.ref->val; } } while (0);
 do { if ((((*((optionvalue))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((optionvalue)); } } while (0);
 return _zend_hash_str_update((*(wrapperhash)).value.arr, optionname, strlen(optionname), optionvalue ) ? SUCCESS : FAILURE;
}
