...
# 202 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
  char buf[40];
...
static double php_asinh(double z)
{
 ...
 return(asinh(z));
# 234 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
}
...
static double php_acosh(double x)
{
 ...
 return(acosh(x));
# 254 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
}
...
# 779 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
void zif_expm1(zend_execute_data *execute_data, zval *return_value)
{
 double num;
...
# 803 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
void zif_log1p(zend_execute_data *execute_data, zval *return_value)
{
 double num;
