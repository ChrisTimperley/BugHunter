# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_multiply.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c" 2


# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/float.h" 1 3 4
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c" 2
...
__attribute__ ((visibility("default"))) double _php_math_round(double value, int places, int mode) {
 ...
 places = places < (-2147483647 - 1)+1 ? (-2147483647 - 1)+1 : places;
 ...
 if (precision_places > places && precision_places - places < 15) {
  int64_t use_precision = precision_places < (-2147483647 - 1)+1 ? (-2147483647 - 1)+1 : precision_places;
  ...
  use_precision = use_precision < (-2147483647 - 1)+1 ? (-2147483647 - 1)+1 : use_precision;
...
# 208 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
  char buf[40];
  ap_php_snprintf(buf, 39, "%15fe%d", tmp_value, -places);
  buf[39] = '\0';
  tmp_value = zend_strtod(buf, ((void *)0));

  if (!(sizeof (tmp_value) == sizeof (float) ? __finitef (tmp_value) : sizeof (tmp_value) == sizeof (double) ? __finite (tmp_value) : __finitel (tmp_value)) || (sizeof (tmp_value) == sizeof (float) ? __isnanf (tmp_value) : sizeof (tmp_value) == sizeof (double) ? __isnan (tmp_value) : __isnanl (tmp_value))) {
   tmp_value = value;
  }
 }
...
static double php_asinh(double z)
{
 ...
 return(asinh(z));
# 240 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
}
...
static double php_acosh(double x)
{
 ...
 return(acosh(x));
# 260 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
}
...
void zif_abs(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zval_get_type(&(*(value)))!=4 && zval_get_type(&(*(value)))!=5) { convert_scalar_to_number(value); };

 if (zval_get_type(&(*(value))) == 5) {
  { { zval *__z = (return_value); (*(__z)).value.dval = fabs((*(value)).value.dval); (*(__z)).u1.type_info = 5; }; return; };
 } else if (zval_get_type(&(*(value))) == 4) {
  if ((*(value)).value.lval == (-9223372036854775807L -1)) {
   { { zval *__z = (return_value); (*(__z)).value.dval = -(double)(-9223372036854775807L -1); (*(__z)).u1.type_info = 5; }; return; };
  } else {
   { { zval *__z = (return_value); (*(__z)).value.lval = (*(value)).value.lval < 0 ? -(*(value)).value.lval : (*(value)).value.lval; (*(__z)).u1.type_info = 4; }; return; };
  }
 }
...
void zif_ceil(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zval_get_type(&(*(value))) == 5) {
  { { zval *__z = (return_value); (*(__z)).value.dval = ceil((*(value)).value.dval); (*(__z)).u1.type_info = 5; }; return; };
 } else if (zval_get_type(&(*(value))) == 4) {
  { { zval *__z = (return_value); (*(__z)).value.dval = _zval_get_double((value)); (*(__z)).u1.type_info = 5; }; return; };
 }
 { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
}
...
void zif_floor(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zval_get_type(&(*(value))) == 5) {
  { { zval *__z = (return_value); (*(__z)).value.dval = floor((*(value)).value.dval); (*(__z)).u1.type_info = 5; }; return; };
 } else if (zval_get_type(&(*(value))) == 4) {
  { { zval *__z = (return_value); (*(__z)).value.dval = _zval_get_double((value)); (*(__z)).u1.type_info = 5; }; return; };
 }
 { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
...
void zif_round(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z|ll", &value, &precision, &mode) == FAILURE) {
  return;
 }
 ...
 if ((execute_data)->This.u2.num_args >= 2) {
  ...
  if (precision >= 0) {
   places = precision > 2147483647 ? 2147483647 : (int)precision;
  } else {
   places = precision <= (-2147483647 - 1) ? (-2147483647 - 1)+1 : (int)precision;
  }
 ...
 switch (zval_get_type(&(*(value)))) {
  case 4:
   ...
   if (places >= 0) {
    { { zval *__z = (return_value); (*(__z)).value.dval = (double) (*(value)).value.lval; (*(__z)).u1.type_info = 5; }; return; };
   }


  case 5:
   return_val = (zval_get_type(&(*(value))) == 4) ? (double)(*(value)).value.lval : (*(value)).value.dval;
   return_val = _php_math_round(return_val, (int)places, (int)mode);
   { { zval *__z = (return_value); (*(__z)).value.dval = return_val; (*(__z)).u1.type_info = 5; }; return; };
   break;
...
void zif_sin(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &num, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);

 { { zval *__z = (return_value); (*(__z)).value.dval = sin(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_cos(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = cos(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_tan(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = tan(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_asin(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = asin(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_acos(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = acos(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_atan(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = atan(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_atan2(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &num1, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &num2, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);

 { { zval *__z = (return_value); (*(__z)).value.dval = atan2(num1, num2); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_sinh(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = sinh(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_cosh(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = cosh(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_tanh(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = tanh(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_asinh(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = php_asinh(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_acosh(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = php_acosh(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_atanh(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = php_atanh(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_pi(zend_execute_data *execute_data, zval *return_value)
{
 { { zval *__z = (return_value); (*(__z)).value.dval = 3.14159265358979323846; (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_is_finite(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &dval, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);

 { do { (*(return_value)).u1.type_info = ((sizeof (dval) == sizeof (float) ? __finitef (dval) : sizeof (dval) == sizeof (double) ? __finite (dval) : __finitel (dval))) ? 3 : 2; } while (0); return; };
}
...
void zif_is_infinite(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { do { (*(return_value)).u1.type_info = ((sizeof (dval) == sizeof (float) ? __isinff (dval) : sizeof (dval) == sizeof (double) ? __isinf (dval) : __isinfl (dval))) ? 3 : 2; } while (0); return; };
}
...
void zif_is_nan(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { do { (*(return_value)).u1.type_info = ((sizeof (dval) == sizeof (float) ? __isnanf (dval) : sizeof (dval) == sizeof (double) ? __isnan (dval) : __isnanl (dval))) ? 3 : 2; } while (0); return; };
}
...
void zif_pow(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z/z/", &zbase, &zexp) == FAILURE) {
  return;
 }
...
void zif_exp(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = exp(num); (*(__z)).u1.type_info = 5; }; return; };
}
# 785 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
void zif_expm1(zend_execute_data *execute_data, zval *return_value)
{
 double num;
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = php_expm1(num); (*(__z)).u1.type_info = 5; }; return; };
}
# 809 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
void zif_log1p(zend_execute_data *execute_data, zval *return_value)
{
 double num;
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = php_log1p(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_log(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &num, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &base, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 if ((execute_data)->This.u2.num_args == 1) {
  { { zval *__z = (return_value); (*(__z)).value.dval = log(num); (*(__z)).u1.type_info = 5; }; return; };
 }
 ...
 if (base == 10.0) {
  { { zval *__z = (return_value); (*(__z)).value.dval = log10(num); (*(__z)).u1.type_info = 5; }; return; };
 }

 if (base == 1.0) {
  { { zval *__z = (return_value); (*(__z)).value.dval = php_get_nan(); (*(__z)).u1.type_info = 5; }; return; };
 }
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = log(num) / log(base); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_sqrt(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = sqrt(num); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_hypot(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = hypot(num1, num2); (*(__z)).u1.type_info = 5; }; return; };
...
void zif_deg2rad(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &deg, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);

 { { zval *__z = (return_value); (*(__z)).value.dval = (deg / 180.0) * 3.14159265358979323846; (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_rad2deg(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &rad, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 { { zval *__z = (return_value); (*(__z)).value.dval = (rad / 3.14159265358979323846) * 180; (*(__z)).u1.type_info = 5; }; return; };
}
...
__attribute__ ((visibility("default"))) zend_long _php_math_basetolong(zval *arg, int base)
{
 ...
 if (zval_get_type(&(*(arg))) != 6 || base < 2 || base > 36) {
  return 0;
 }
...
__attribute__ ((visibility("default"))) int _php_math_basetozval(zval *arg, int base, zval *ret)
{
 ...
 if (mode == 1) {
  { zval *__z = (ret); (*(__z)).value.dval = fnum; (*(__z)).u1.type_info = 5; };
 } else {
  { zval *__z = (ret); (*(__z)).value.lval = num; (*(__z)).u1.type_info = 4; };
 }
 return SUCCESS;
}
...
__attribute__ ((visibility("default"))) zend_string * _php_math_longtobase(zval *arg, int base)
{
 ...
 if (zval_get_type(&(*(arg))) != 4 || base < 2 || base > 36) {
...
__attribute__ ((visibility("default"))) zend_string * _php_math_zvaltobase(zval *arg, int base)
{
 ...
 if ((zval_get_type(&(*(arg))) != 4 && zval_get_type(&(*(arg))) != 5) || base < 2 || base > 36) {
  return (compiler_globals.empty_string);
 }

 if (zval_get_type(&(*(arg))) == 5) {
...
void zif_base_convert(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "zll", &number, &frombase, &tobase) == FAILURE) {
  return;
 }
 if (zval_get_type(&(*(number)))!=6) { if (zval_get_type(&(*(number))) != 6) { _convert_to_string((number) ); }; };

 if (frombase < 2 || frombase > 36) {
  php_error_docref0(((void *)0), (1<<1L), "Invalid `from base' (%pd)", frombase);
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 if (tobase < 2 || tobase > 36) {
  php_error_docref0(((void *)0), (1<<1L), "Invalid `to base' (%pd)", tobase);
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
__attribute__ ((visibility("default"))) zend_string *_php_math_number_format(double d, int dec, char dec_point, char thousand_sep)
{
 return _php_math_number_format_ex(d, dec, &dec_point, 1, &thousand_sep, 1);
}

__attribute__ ((visibility("default"))) zend_string *_php_math_number_format_ex(double d, int dec, char *dec_point,
  size_t dec_point_len, char *thousand_sep, size_t thousand_sep_len)
{
 ...
 if (tmpbuf == ((void *)0)) {
  return ((void *)0);
 } else if (!((*__ctype_b_loc ())[(int) (((int)(tmpbuf)->val[0]))] & (unsigned short int) _ISdigit)) {
  return tmpbuf;
 }
...
void zif_number_format(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (4); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_double(_arg, &num, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_DOUBLE; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &dec, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_string(_arg, &dec_point, &dec_point_len, 1)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_string(_arg, &thousand_sep, &thousand_sep_len, 1)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 switch((execute_data)->This.u2.num_args) {
 case 1:
  { do { zval *__z = (return_value); zend_string *__s = (_php_math_number_format(num, 0, dec_point_chr, thousand_sep_chr)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
  break;
 case 2:
  { do { zval *__z = (return_value); zend_string *__s = (_php_math_number_format(num, (int)dec, dec_point_chr, thousand_sep_chr)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
  break;
 case 4:
  if (dec_point == ((void *)0)) {
  ...
  do { zval *__z = (return_value); zend_string *__s = (_php_math_number_format_ex(num, (int)dec, dec_point, dec_point_len, thousand_sep, thousand_sep_len)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0)
                                                              ;
  break;
 default:
...
void zif_fmod(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { { zval *__z = (return_value); (*(__z)).value.dval = fmod(num1, num2); (*(__z)).u1.type_info = 5; }; return; };
}
...
void zif_intdiv(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "ll", &dividend, &divisor) == FAILURE) {
  return;
 }
 ...
 if (divisor == 0) {
  ...
  return;
 } else if (divisor == -1 && dividend == (-9223372036854775807L -1)) {
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = dividend / divisor; (*(__z)).u1.type_info = 4; }; return; };
}
