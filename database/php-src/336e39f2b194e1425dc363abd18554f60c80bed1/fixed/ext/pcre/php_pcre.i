# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c" 2
# 52 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
enum {
 PHP_PCRE_NO_ERROR = 0,
...
__attribute__ ((visibility("default"))) zend_pcre_globals pcre_globals;
...
static const zend_ini_entry_def ini_entries[] = {
 { "pcre.backtrack_limit", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_pcre_globals*)((void *)0))->backtrack_limit))) - ((char *) ((void *)0)))), (void *) &pcre_globals, ((void *)0), "1000000", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("pcre.backtrack_limit")-1, sizeof("1000000")-1 },
 { "pcre.recursion_limit", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_pcre_globals*)((void *)0))->recursion_limit))) - ((char *) ((void *)0)))), (void *) &pcre_globals, ((void *)0), "100000", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("pcre.recursion_limit")-1, sizeof("100000")-1 },

 { "pcre.jit", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_pcre_globals*)((void *)0))->jit))) - ((char *) ((void *)0)))), (void *) &pcre_globals, ((void *)0), "1", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("pcre.jit")-1, sizeof("1")-1 },
...
static int zm_startup_pcre(int type, int module_number)
{
 ...
 zend_register_long_constant(("PREG_JIT_STACKLIMIT_ERROR"), sizeof("PREG_JIT_STACKLIMIT_ERROR")-1, (PHP_PCRE_JIT_STACKLIMIT_ERROR), ((1<<0) | (1<<1)), module_number);
...
static inline __attribute__((always_inline)) int calculate_unit_length(pcre_cache_entry *pce, char *start)
{
 int unit_len;
...
__attribute__ ((visibility("default"))) pcre_cache_entry* pcre_get_compiled_regex_cache(zend_string *regex)
{
 ...
 if (pce) {
  ...
  if (pce->locale == (basic_globals.locale_string) ||
      (pce->locale && (basic_globals.locale_string) &&
       (pce->locale)->len == ((basic_globals.locale_string))->len &&
       !memcmp((pce->locale)->val, ((basic_globals.locale_string))->val, (pce->locale)->len)) ||
      (!pce->locale &&
       ((basic_globals.locale_string))->len == 1 &&
       ((basic_globals.locale_string))->val[0] == 'C') ||
 ...
 if ((basic_globals.locale_string) &&
     (((basic_globals.locale_string))->len != 1 || ((basic_globals.locale_string))->val[0] != 'C')) {
 ...
 new_entry.locale = (basic_globals.locale_string) ?
  ((((basic_globals.locale_string))->gc.u.v.flags & (1<<0)) ?
   zend_string_copy((basic_globals.locale_string)) :
   zend_string_init(((basic_globals.locale_string))->val, ((basic_globals.locale_string))->len, 1)) :
  ((void *)0);
...
# 519 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
 if (!((regex)->gc.u.v.flags & (1<<1)) || !((regex)->gc.u.v.flags & (1<<2))) {
 ...
 pce = zend_hash_update_mem(&(pcre_globals.pcre_cache), regex, &new_entry, sizeof(pcre_cache_entry));
...
static inline void add_offset_pair(zval *result, char *str, int len, int offset, char *name)
{
 ...
 do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(str, len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 _zend_hash_next_index_insert_new((match_pair).value.arr, &tmp );
 { zval *__z = (&tmp); (*(__z)).value.lval = offset; (*(__z)).u1.type_info = 4; };
 _zend_hash_next_index_insert_new((match_pair).value.arr, &tmp );

 if (name) {
  zval_addref_p(&(match_pair));
  _zend_hash_str_update((*(result)).value.arr, name, strlen(name), &match_pair );
 }
 _zend_hash_next_index_insert((*(result)).value.arr, &match_pair );
}


static void php_do_pcre_match(zend_execute_data *execute_data, zval *return_value, int global)
{
 ...
 if (__builtin_expect(!!(((subject)->len) > (size_t)2147483647), 0)) {
   php_error_docref0(((void *)0), (1<<1L), "Subject is too long");
 ...
 php_pcre_match_impl(pce, (subject)->val, (int)(subject)->len, return_value, subpats,
  global, (execute_data)->This.u2.num_args >= 4, flags, start_offset);
 pce->refcount--;
}
 ...
 zval *subpats, int global, int use_flags, zend_long flags, zend_long start_offset)
{
 ...
 if (size_offsets <= 32) {
  offsets = (int *)((use_heap = (__builtin_expect(!!((size_offsets * sizeof(int)) > ((32 * 1024))), 0))) ? (__builtin_constant_p((size_offsets * sizeof(int)) ) ? (((size_offsets * sizeof(int)) <= 8) ? _emalloc_8() : (((size_offsets * sizeof(int)) <= 16) ? _emalloc_16() : (((size_offsets * sizeof(int)) <= 24) ? _emalloc_24() : (((size_offsets * sizeof(int)) <= 32) ? _emalloc_32() : (((size_offsets * sizeof(int)) <= 40) ? _emalloc_40() : (((size_offsets * sizeof(int)) <= 48) ? _emalloc_48() : (((size_offsets * sizeof(int)) <= 56) ? _emalloc_56() : (((size_offsets * sizeof(int)) <= 64) ? _emalloc_64() : (((size_offsets * sizeof(int)) <= 80) ? _emalloc_80() : (((size_offsets * sizeof(int)) <= 96) ? _emalloc_96() : (((size_offsets * sizeof(int)) <= 112) ? _emalloc_112() : (((size_offsets * sizeof(int)) <= 128) ? _emalloc_128() : (((size_offsets * sizeof(int)) <= 160) ? _emalloc_160() : (((size_offsets * sizeof(int)) <= 192) ? _emalloc_192() : (((size_offsets * sizeof(int)) <= 224) ? _emalloc_224() : (((size_offsets * sizeof(int)) <= 256) ? _emalloc_256() : (((size_offsets * sizeof(int)) <= 320) ? _emalloc_320() : (((size_offsets * sizeof(int)) <= 384) ? _emalloc_384() : (((size_offsets * sizeof(int)) <= 448) ? _emalloc_448() : (((size_offsets * sizeof(int)) <= 512) ? _emalloc_512() : (((size_offsets * sizeof(int)) <= 640) ? _emalloc_640() : (((size_offsets * sizeof(int)) <= 768) ? _emalloc_768() : (((size_offsets * sizeof(int)) <= 896) ? _emalloc_896() : (((size_offsets * sizeof(int)) <= 1024) ? _emalloc_1024() : (((size_offsets * sizeof(int)) <= 1280) ? _emalloc_1280() : (((size_offsets * sizeof(int)) <= 1536) ? _emalloc_1536() : (((size_offsets * sizeof(int)) <= 1792) ? _emalloc_1792() : (((size_offsets * sizeof(int)) <= 2048) ? _emalloc_2048() : (((size_offsets * sizeof(int)) <= 2560) ? _emalloc_2560() : (((size_offsets * sizeof(int)) <= 3072) ? _emalloc_3072() : (((size_offsets * sizeof(int)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((size_offsets * sizeof(int))) : _emalloc_huge((size_offsets * sizeof(int)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((size_offsets * sizeof(int)) ) ) : __builtin_alloca (size_offsets * sizeof(int)));
 } else {
 ...
 do {
  ...
  count = php_pcre_exec(pce->re, extra, subject, (int)subject_len, (int)start_offset,
  ...
  if (count > 0) {
   ...
   if (subpats != ((void *)0)) {
    ...
    if ((offsets[1] - offsets[0] < 0) || php_pcre_get_substring_list(subject, offsets, count, &stringlist) < 0) {
     if (subpat_names) {
      _efree((subpat_names) );
     }
     if (size_offsets <= 32) {
    ...
    if (global) {
     if (subpats && subpats_order == 1) {
      ...
      _zend_hash_next_index_insert((*(subpats)).value.arr, &result_set );
     }
    } else {
  ...
  g_notempty = (offsets[1] == offsets[0])? 0x10000000 | 0x00000010 : 0;
 ...
 if (global && subpats && subpats_order == 1) {
  if (subpat_names) {
   for (i = 0; i < num_subpats; i++) {
    if (subpat_names[i]) {
     _zend_hash_str_update((*(subpats)).value.arr, subpat_names[i], strlen(subpat_names[i]), &match_sets[i] )
                                                  ;
     zval_addref_p(&(match_sets[i]));
    }
    _zend_hash_next_index_insert((*(subpats)).value.arr, &match_sets[i] );
   }
  } else {
   for (i = 0; i < num_subpats; i++) {
    _zend_hash_next_index_insert((*(subpats)).value.arr, &match_sets[i] );
...
static void zif_preg_match(zend_execute_data *execute_data, zval *return_value)
{
 php_do_pcre_match(execute_data, return_value, 0);
}




static void zif_preg_match_all(zend_execute_data *execute_data, zval *return_value)
{
 php_do_pcre_match(execute_data, return_value, 1);
}
...
__attribute__ ((visibility("default"))) zend_string *php_pcre_replace_impl(pcre_cache_entry *pce, zend_string *subject_str, char *subject, int subject_len, zval *replace_val, int is_callable_replace, int limit, int *replace_count)
{
 pcre_extra *extra = pce->extra;
 pcre_extra extra_data;
 int exoptions = 0;
 ...
 if (__builtin_expect(!!(pce->preg_options & (1<<0)), 0)) {
  php_error_docref0(((void *)0), (1<<1L), "The /e modifier is no longer supported, use preg_replace_callback instead");
  return ((void *)0);
 }

 if (!is_callable_replace) {
  replace = ((*(replace_val)).value.str)->val;
  replace_len = (int)((*(replace_val)).value.str)->len;
 ...
 subpat_names = ((void *)0);
 if (__builtin_expect(!!(pce->name_count > 0), 0)) {
  subpat_names = make_subpats_table(num_subpats, pce);
  if (!subpat_names) {
   return ((void *)0);
  }
 ...
 while (1) {
  ...
  if (__builtin_expect(!!(count > 0 && (offsets[1] - offsets[0] >= 0) && limit), 1)) {
   if (__builtin_expect(!!(replace_count), 0)) {
    ++*replace_count;
   }
    ...
    *walkbuf = '\0';
    ...
    do { if (__builtin_expect(!(eval_result), 0)) __builtin_unreachable(); } while (0);
   ...
   if (__builtin_expect(!!(limit), 1)) {
    limit--;
   }
  } else if (count == (-1) || __builtin_expect(!!(limit == 0), 0)) {
 ...
 if (__builtin_expect(!!(subpat_names), 0)) {
  _efree((subpat_names) );
 }
...
static zend_string *php_replace_in_subject(zval *regex, zval *replace, zval *subject, int limit, int is_callable_replace, int *replace_count)
{
 ...
 if (__builtin_expect(!!(((subject_str)->len) > (size_t)2147483647), 0)) {
   php_error_docref0(((void *)0), (1<<1L), "Subject is too long");
   return ((void *)0);
 }
 ...
 if (zval_get_type(&(*(regex))) == 7) {
  ...
  do { Bucket *_p = ((*(regex)).value.arr)->arData; Bucket *_end = _p + ((*(regex)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; regex_entry = _z; {
   zval replace_str;

   zend_string *regex_str = _zval_get_string((regex_entry));

   do { (*(&replace_str)).u1.type_info = 0; } while (0);

   if (zval_get_type(&(*(replace))) == 7 && !is_callable_replace) {

    while (replace_idx < (*(replace)).value.arr->nNumUsed) {
     if (zval_get_type(&((*(replace)).value.arr->arData[replace_idx].val)) != 0) {
      do { zval *_z1 = (&replace_str); const zval *_z2 = (&(*(replace)).value.arr->arData[replace_idx].val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
      break;
     }
     replace_idx++;
    }
    if (!(zval_get_type(&(replace_str)) == 0)) {
     if (!is_callable_replace) {
      if (zval_get_type(&(*(&replace_str))) != 6) { _convert_to_string((&replace_str) ); };
     }
...
static int preg_replace_impl(zval *return_value, zval *regex, zval *replace, zval *subject, zend_long limit_val, int is_callable_replace, int is_filter)
{
 ...
 if (zval_get_type(&(*(regex))) != 7) {
  if (zval_get_type(&(*(regex)))!=6) { if (zval_get_type(&(*(regex))) != 6) { _convert_to_string((regex) ); }; };
 }


 if (zval_get_type(&(*(subject))) == 7) {
  _array_init((return_value), (((*(subject)).value.arr)->nNumOfElements) );
  ...
  do { Bucket *_p = ((*(subject)).value.arr)->arData; Bucket *_end = _p + ((*(subject)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; subject_entry = _z; {
   ...
   if ((result = php_replace_in_subject(regex, replace, subject_entry, limit_val, is_callable_replace, &replace_count)) != ((void *)0)) {
    if (!is_filter || replace_count > old_replace_count) {
     ...
     do { zval *__z = (&zv); zend_string *__s = (result); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
     if (string_key) {
      _zend_hash_add_new((*(return_value)).value.arr, string_key, &zv );
     } else {
      _zend_hash_index_add_new((*(return_value)).value.arr, num_key, &zv );
     }
    } else {
...
static void zif_preg_replace(zend_execute_data *execute_data, zval *return_value)
{
 zval *regex, *replace, *subject, *zcount = ((void *)0);
 zend_long limit = -1;
 int replace_count;
 ...
 do { const int _flags = (0); int _min_num_args = (3); int _max_num_args = (5); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &regex, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &regex, 0); }
 ...
 if (zval_get_type(&(*(replace))) == 7 && zval_get_type(&(*(regex))) != 7) {
...
static void zif_preg_replace_callback(zend_execute_data *execute_data, zval *return_value)
{
 zval *regex, *replace, *subject, *zcount = ((void *)0);
 zend_long limit = -1;
 ...
 if (!zend_is_callable(replace, 0, &callback_name)) {
  ...
  do { zval *_z1 = (return_value); const zval *_z2 = (subject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  return;
 }
 zend_string_release(callback_name);
...
static void zif_preg_replace_callback_array(zend_execute_data *execute_data, zval *return_value)
{
 zval regex, zv, *replace, *subject, *pattern, *zcount = ((void *)0);
 zend_long limit = -1;
 zend_string *str_idx;
 zend_string *callback_name;
 int replace_count = 0;
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (4); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &pattern, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &subject, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &subject, 0); }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &limit, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  if (1) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &zcount, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &zcount, 0); }
 ...
 do { Bucket *_p = ((*(pattern)).value.arr)->arData; Bucket *_end = _p + ((*(pattern)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; str_idx = _p->key; replace = _z; {
  if (str_idx) {
   do { zval *__z = (&regex); zend_string *__s = (str_idx); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
  } else {
   php_error_docref0(((void *)0), (1<<1L), "Delimiter must not be alphanumeric or backslash");
  ...
  if (!zend_is_callable(replace, 0, &callback_name)) {
   php_error_docref0(((void *)0), (1<<1L), "'%s' is not a valid callback", (callback_name)->val);
   zend_string_release(callback_name);
  ...
  if ((zval_get_type(&(*(return_value))) == 1)) {
  ...
  do { zval *_z1 = (return_value); const zval *_z2 = (&zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
static void zif_preg_filter(zend_execute_data *execute_data, zval *return_value)
{
 zval *regex, *replace, *subject, *zcount = ((void *)0);
 zend_long limit = -1;
 int replace_count;
...
static void zif_preg_split(zend_execute_data *execute_data, zval *return_value)
{
 zend_string *regex;
 zend_string *subject;
 zend_long limit_val = -1;
 zend_long flags = 0;
 pcre_cache_entry *pce;
# 1703 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (4); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_str(_arg, &regex, 0)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_str(_arg, &subject, 0)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &limit_val, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &flags, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 zend_long limit_val, zend_long flags)
{
  ...
  if (count > 0 && (offsets[1] - offsets[0] >= 0)) {
   if (!no_empty || &subject[offsets[0]] != last_match) {
    ...
    if (offset_capture) {
     ...
     add_offset_pair(return_value, last_match, (int)(&subject[offsets[0]]-last_match), next_offset, ((void *)0));
    } else {

     do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(last_match, &subject[offsets[0]]-last_match, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
    ...
    for (i = 1; i < count; i++) {
     ...
     if (!no_empty || match_len > 0) {
      if (offset_capture) {
       ...
       do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(&subject[offsets[i<<1]], match_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
       _zend_hash_next_index_insert_new((*(return_value)).value.arr, &tmp );
      }
     }
    }
 ...
 start_offset = (int)(last_match - subject);
 ...
 if (!no_empty || start_offset < subject_len)
 {
  if (offset_capture) {
   ...
   do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(last_match, subject + subject_len - last_match, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
   _zend_hash_next_index_insert_new((*(return_value)).value.arr, &tmp );
  }
 }
...
static void zif_preg_quote(zend_execute_data *execute_data, zval *return_value)
{
 size_t in_str_len;
 char *in_str;
 char *in_str_end;
...
# 1929 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_string(_arg, &in_str, &in_str_len, 0)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_string(_arg, &delim, &delim_len, 0)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 *q = '\0';
 ...
 { do { zval *__z = (return_value); zend_string *__s = (out_str); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}




static void zif_preg_grep(zend_execute_data *execute_data, zval *return_value)
{
 zend_string *regex;
 zval *input;
 zend_long flags = 0;
 pcre_cache_entry *pce;
# 2018 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.c"
...
__attribute__ ((visibility("default"))) void php_pcre_grep_impl(pcre_cache_entry *pce, zval *input, zval *return_value, zend_long flags)
{
 zval *entry;
 pcre_extra *extra = pce->extra;
 pcre_extra extra_data;
 ...
 do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; entry = _z; {
  ...
  if ((count > 0 && !invert) || (count == (-1) && invert)) {
   ...
   if (string_key) {
    _zend_hash_update((*(return_value)).value.arr, string_key, entry );
   } else {
    _zend_hash_index_update((*(return_value)).value.arr, num_key, entry );
   }
  }
...
static void zif_preg_last_error(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (0); int _max_num_args = (0); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);
...
static const zend_internal_arg_info arginfo_preg_match[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
    { "pattern", ((void *)0), 0, 0, 0, 0 },
    { "subject", ((void *)0), 0, 0, 0, 0 },
    { "subpatterns", ((void *)0), 0, 1, 0, 0 },
    { "flags", ((void *)0), 0, 0, 0, 0 },
    { "offset", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_preg_match_all[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
    { "pattern", ((void *)0), 0, 0, 0, 0 },
    { "subject", ((void *)0), 0, 0, 0, 0 },
    { "subpatterns", ((void *)0), 0, 1, 0, 0 },
    { "flags", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_preg_replace[] = { { (const char*)(zend_uintptr_t)(3), ((void *)0), 0, 0, 0, 0 },
    { "regex", ((void *)0), 0, 0, 0, 0 },
    { "replace", ((void *)0), 0, 0, 0, 0 },
    { "subject", ((void *)0), 0, 0, 0, 0 },
    { "limit", ((void *)0), 0, 0, 0, 0 },
    { "count", ((void *)0), 0, 1, 0, 0 },
};

static const zend_internal_arg_info arginfo_preg_replace_callback[] = { { (const char*)(zend_uintptr_t)(3), ((void *)0), 0, 0, 0, 0 },
    { "regex", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_preg_replace_callback_array[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
    { "pattern", ((void *)0), 0, 0, 0, 0 },
    { "subject", ((void *)0), 0, 0, 0, 0 },
    { "limit", ((void *)0), 0, 0, 0, 0 },
    { "count", ((void *)0), 0, 1, 0, 0 },
...
static const zend_internal_arg_info arginfo_preg_split[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
    { "pattern", ((void *)0), 0, 0, 0, 0 },
    { "subject", ((void *)0), 0, 0, 0, 0 },
    { "limit", ((void *)0), 0, 0, 0, 0 },
    { "flags", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_preg_quote[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
    { "str", ((void *)0), 0, 0, 0, 0 },
    { "delim_char", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_preg_grep[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
    { "regex", ((void *)0), 0, 0, 0, 0 },
    { "input", ((void *)0), 0, 0, 0, 0 },
    { "flags", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_preg_last_error[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};


static const zend_function_entry pcre_functions[] = {
 { "preg_match", zif_preg_match, arginfo_preg_match, (uint32_t) (sizeof(arginfo_preg_match)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_match_all", zif_preg_match_all, arginfo_preg_match_all, (uint32_t) (sizeof(arginfo_preg_match_all)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_replace", zif_preg_replace, arginfo_preg_replace, (uint32_t) (sizeof(arginfo_preg_replace)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_replace_callback", zif_preg_replace_callback, arginfo_preg_replace_callback, (uint32_t) (sizeof(arginfo_preg_replace_callback)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_replace_callback_array", zif_preg_replace_callback_array, arginfo_preg_replace_callback_array, (uint32_t) (sizeof(arginfo_preg_replace_callback_array)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_filter", zif_preg_filter, arginfo_preg_replace, (uint32_t) (sizeof(arginfo_preg_replace)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_split", zif_preg_split, arginfo_preg_split, (uint32_t) (sizeof(arginfo_preg_split)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_quote", zif_preg_quote, arginfo_preg_quote, (uint32_t) (sizeof(arginfo_preg_quote)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_grep", zif_preg_grep, arginfo_preg_grep, (uint32_t) (sizeof(arginfo_preg_grep)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "preg_last_error", zif_preg_last_error, arginfo_preg_last_error, (uint32_t) (sizeof(arginfo_preg_last_error)/sizeof(struct _zend_internal_arg_info)-1), 0 },
