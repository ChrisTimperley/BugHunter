# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c" 2


__attribute__ ((visibility("default"))) void zend_objects_store_init(zend_objects_store *objects, uint32_t init_size)
{
 objects->object_buckets = (zend_object **) (__builtin_constant_p((init_size * sizeof(zend_object*)) ) ? (((init_size * sizeof(zend_object*)) <= 8) ? _emalloc_8() : (((init_size * sizeof(zend_object*)) <= 16) ? _emalloc_16() : (((init_size * sizeof(zend_object*)) <= 24) ? _emalloc_24() : (((init_size * sizeof(zend_object*)) <= 32) ? _emalloc_32() : (((init_size * sizeof(zend_object*)) <= 40) ? _emalloc_40() : (((init_size * sizeof(zend_object*)) <= 48) ? _emalloc_48() : (((init_size * sizeof(zend_object*)) <= 56) ? _emalloc_56() : (((init_size * sizeof(zend_object*)) <= 64) ? _emalloc_64() : (((init_size * sizeof(zend_object*)) <= 80) ? _emalloc_80() : (((init_size * sizeof(zend_object*)) <= 96) ? _emalloc_96() : (((init_size * sizeof(zend_object*)) <= 112) ? _emalloc_112() : (((init_size * sizeof(zend_object*)) <= 128) ? _emalloc_128() : (((init_size * sizeof(zend_object*)) <= 160) ? _emalloc_160() : (((init_size * sizeof(zend_object*)) <= 192) ? _emalloc_192() : (((init_size * sizeof(zend_object*)) <= 224) ? _emalloc_224() : (((init_size * sizeof(zend_object*)) <= 256) ? _emalloc_256() : (((init_size * sizeof(zend_object*)) <= 320) ? _emalloc_320() : (((init_size * sizeof(zend_object*)) <= 384) ? _emalloc_384() : (((init_size * sizeof(zend_object*)) <= 448) ? _emalloc_448() : (((init_size * sizeof(zend_object*)) <= 512) ? _emalloc_512() : (((init_size * sizeof(zend_object*)) <= 640) ? _emalloc_640() : (((init_size * sizeof(zend_object*)) <= 768) ? _emalloc_768() : (((init_size * sizeof(zend_object*)) <= 896) ? _emalloc_896() : (((init_size * sizeof(zend_object*)) <= 1024) ? _emalloc_1024() : (((init_size * sizeof(zend_object*)) <= 1280) ? _emalloc_1280() : (((init_size * sizeof(zend_object*)) <= 1536) ? _emalloc_1536() : (((init_size * sizeof(zend_object*)) <= 1792) ? _emalloc_1792() : (((init_size * sizeof(zend_object*)) <= 2048) ? _emalloc_2048() : (((init_size * sizeof(zend_object*)) <= 2560) ? _emalloc_2560() : (((init_size * sizeof(zend_object*)) <= 3072) ? _emalloc_3072() : (((init_size * sizeof(zend_object*)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((init_size * sizeof(zend_object*))) : _emalloc_huge((init_size * sizeof(zend_object*)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((init_size * sizeof(zend_object*)) ) );
 objects->top = 1;
...
__attribute__ ((visibility("default"))) void zend_objects_store_put(zend_object *object)
{
 ...
 if ((executor_globals.objects_store).free_list_head != -1) {
  ...
  if ((executor_globals.objects_store).top == (executor_globals.objects_store).size) {
   ...
   (executor_globals.objects_store).object_buckets = (zend_object **) _erealloc(((executor_globals.objects_store).object_buckets), ((executor_globals.objects_store).size * sizeof(zend_object*)) );
  }
...
__attribute__ ((visibility("default"))) void zend_objects_store_free(zend_object *object)
{
 ...
 do { zend_refcounted *_p = (zend_refcounted*)(object); if ((((_p)->gc.u.v.gc_info) & ~0xc000)) { gc_remove_from_buffer(_p); } } while (0);
 _efree((ptr) );
...
__attribute__ ((visibility("default"))) void zend_objects_store_del(zend_object *object)
{
 ...
 if ((executor_globals.objects_store).object_buckets &&
  ...
  if ((object)->gc.refcount == 0) {
   ...
   if (!((object)->gc.u.v.flags & (1<<3))) {
    (object)->gc.u.v.flags |= (1<<3);
   ...
   if ((object)->gc.refcount == 0) {
    ...
    if (!((object)->gc.u.v.flags & (1<<4))) {
     (object)->gc.u.v.flags |= (1<<4);
   ...
   if (failure) {
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c", 192);
   }
  } else {
   (object)->gc.refcount--;
  }
...
# 208 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects_API.c"
__attribute__ ((visibility("default"))) void zend_object_store_set_object(zval *zobject, zend_object *object)
{
