  ...
  while ((c = php_getopt(argc, argv, OPTIONS, &php_optarg, &php_optind, 0, 2)) != -1) {
   ...
   case 'v':
    php_printf("PHP %s (%s) (built: %s %s) ( %s)\nCopyright (c) 1997-2016 The PHP Group\n%s",
     "7.0.5-dev", cli_sapi_module.name, "Aug  7 2016", "13:54:18",
  ...
  case 7:
   {
    ...
    while (exit_status == SUCCESS && (input=_php_stream_get_line((s_in_process), (((void *)0)), (0), ((void *)0))) != ((void *)0)) {
     ...
     do { do { zval *__z = (&argn); zend_string *__s = (zend_string_init(input, len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
...
# 1210 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli.c"
 signal(13, ((__sighandler_t) 1));
# 1237 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli.c"
 while ((c = php_getopt(argc, argv, OPTIONS, &php_optarg, &php_optind, 0, 2))!=-1) {
  switch (c) {
   case 'c':
...
# 1373 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli.c"
