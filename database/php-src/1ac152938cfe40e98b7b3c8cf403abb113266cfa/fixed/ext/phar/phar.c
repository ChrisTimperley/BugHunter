# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/TSRM/TSRM.h" 1
# 5 "/home/ct584/git/bughunter/repositories/php-src/TSRM/tsrm_strtok_r.h" 2

__attribute__ ((visibility("default"))) char *tsrm_strtok_r(char *s, const char *delim, char **last);
...
# 68 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h" 2
...
# 69 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h" 2
# 135 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h"
...
typedef struct _zend_phar_globals {
 ...
 int request_done;
 int request_ends;
 void (*orig_fopen)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_file_get_contents)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_is_file)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_is_link)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_is_dir)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_opendir)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_file_exists)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_fileperms)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_fileinode)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_filesize)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_fileowner)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_filegroup)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_fileatime)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_filemtime)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_filectime)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_filetype)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_is_writable)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_is_readable)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_is_executable)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_lstat)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_readfile)(zend_execute_data *execute_data, zval *return_value);
 void (*orig_stat)(zend_execute_data *execute_data, zval *return_value);
...
# 211 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h"
...
# 212 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h" 2
...
# 516 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/SAPI.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
...
static int phar_set_writeable_bit(zval *zv, void *argument)
{
 ...
 phar_archive_data *phar = (phar_archive_data *)(*(zv)).value.ptr;
...
int phar_ini_modify_handler(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 zend_bool old, ini;
...
static void phar_split_cache_list(void)
{
 ...
 _zend_hash_init((&(executor_globals.regular_list)), (0), (((void *)0)), (0) );
 (executor_globals.regular_list).nNextFreeElement=1;

 (phar_globals.has_bz2) = zend_hash_str_exists(&module_registry, "bz2", sizeof("bz2")-1);
 (phar_globals.has_zlib) = zend_hash_str_exists(&module_registry, "zlib", sizeof("zlib")-1);

 _zend_hash_init((&cached_phars), (sizeof(phar_archive_data*)), (destroy_phar_data), (1) );
 _zend_hash_init((&cached_alias), (sizeof(phar_archive_data*)), (((void *)0)), (1) );

 _zend_hash_init((&((phar_globals.phar_fname_map))), (sizeof(phar_archive_data*)), (destroy_phar_data), (1) );
 _zend_hash_init((&((phar_globals.phar_alias_map))), (sizeof(phar_archive_data*)), (((void *)0)), (1) );
 (phar_globals.manifest_cached) = 1;
 (phar_globals.persist) = 1;

 for (key = strtok_r(tmp, ds, &lasts);
   key;
   key = strtok_r(((void *)0), ds, &lasts)) {
  end = strchr(key, ':');

  if (end) {
   if (SUCCESS == phar_open_from_filename(key, end - key, ((void *)0), 0, 0, &phar, ((void *)0))) {
finish_up:
    phar->phar_pos = i++;
...
finish_error:
   ...
   if (SUCCESS == phar_open_from_filename(key, strlen(key), ((void *)0), 0, 0, &phar, ((void *)0))) {
    goto finish_up;
   } else {
    goto finish_error;
   }
...
int phar_ini_cache_list(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 (phar_globals.cache_list) = (new_value)->val;
...
static const zend_ini_entry_def ini_entries[] = {
 { "phar.readonly", phar_ini_modify_handler, (void *) ((zend_long) (((char *) (&(((zend_phar_globals*)((void *)0))->readonly))) - ((char *) ((void *)0)))), (void *) &phar_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("phar.readonly")-1, sizeof("1")-1 },
 { "phar.require_hash", phar_ini_modify_handler, (void *) ((zend_long) (((char *) (&(((zend_phar_globals*)((void *)0))->require_hash))) - ((char *) ((void *)0)))), (void *) &phar_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("phar.require_hash")-1, sizeof("1")-1 },
 { "phar.cache_list", phar_ini_cache_list, (void *) ((zend_long) (((char *) (&(((zend_phar_globals*)((void *)0))->cache_list))) - ((char *) ((void *)0)))), (void *) &phar_globals, ((void *)0), "", ((void *)0), (1<<2), sizeof("phar.cache_list")-1, sizeof("")-1 },
...
void phar_destroy_phar_data(phar_archive_data *phar)
{
 ...
 if (zval_get_type(&(phar->metadata)) != 0) {
  ...
  phar->metadata_len = 0;
  do { (*(&phar->metadata)).u1.type_info = 0; } while (0);
 }
...
int phar_archive_delref(phar_archive_data *phar)
{
 ...
 if (--phar->refcount < 0) {
  ...
  if (!(&phar->manifest)->nNumOfElements) {
...
{
 phar_archive_data *phar_data = (phar_archive_data *) (*(zv)).value.ptr;
...
{
 return (*(zv)).value.ptr == argument ? 1<<0 : 0;
}
...
{
 phar_entry_info *entry = (phar_entry_info *) (*(zv)).value.ptr;
...
void destroy_phar_manifest_entry(zval *zv)
{
 phar_entry_info *entry = (*(zv)).value.ptr;
 destroy_phar_manifest_entry_int(entry);
 ((entry->is_persistent)?free(entry):_efree((entry) ));
}
...
# 532 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_open_parsed_phar(char *fname, int fname_len, char *alias, int alias_len, int is_data, int options, phar_archive_data** pphar, char **error)
{
 phar_archive_data *phar;
...
# 553 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
 if (SUCCESS == phar_get_archive(&phar, fname, fname_len, alias, alias_len, error)
  ...
  if (!is_data) {
   ...
   if (!phar->halt_offset && !phar->is_brandnew && (phar->is_tar || phar->is_zip)) {
    if ((phar_globals.readonly) && ((void *)0) == (stub = zend_hash_str_find_ptr(&(phar->manifest), ".phar/stub.php", sizeof(".phar/stub.php")-1))) {
     if (error) {
...
# 607 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_parse_metadata(char **buffer, zval *metadata, php_uint32 zip_metadata_len)
{
 ...
 if (zip_metadata_len) {
  ...
  unsigned char *p_buff = (unsigned char *)_estrndup((*buffer), (zip_metadata_len) );
  p = p_buff;
  do { (*(metadata)).u1.type_info = 1; } while (0);
  ...
  if (!php_var_unserialize(metadata, &p, p + zip_metadata_len, &var_hash)) {
   ...
   do { (*(metadata)).u1.type_info = 0; } while (0);
   return FAILURE;
  }
  _efree((p_buff) );
  do { if ((basic_globals.serialize_lock) || (basic_globals.unserialize).level == 1) { var_destroy(&(var_hash)); _efree(((var_hash)) ); } if (!(basic_globals.serialize_lock) && !--(basic_globals.unserialize).level) { (basic_globals.unserialize).data = ((void *)0); } } while (0);
  ...
  if ((phar_globals.persist)) {
   ...
   _zval_ptr_dtor((metadata) );
   (*(metadata)).value.ptr = ((1)?__zend_malloc(zip_metadata_len):(__builtin_constant_p((zip_metadata_len) ) ? (((zip_metadata_len) <= 8) ? _emalloc_8() : (((zip_metadata_len) <= 16) ? _emalloc_16() : (((zip_metadata_len) <= 24) ? _emalloc_24() : (((zip_metadata_len) <= 32) ? _emalloc_32() : (((zip_metadata_len) <= 40) ? _emalloc_40() : (((zip_metadata_len) <= 48) ? _emalloc_48() : (((zip_metadata_len) <= 56) ? _emalloc_56() : (((zip_metadata_len) <= 64) ? _emalloc_64() : (((zip_metadata_len) <= 80) ? _emalloc_80() : (((zip_metadata_len) <= 96) ? _emalloc_96() : (((zip_metadata_len) <= 112) ? _emalloc_112() : (((zip_metadata_len) <= 128) ? _emalloc_128() : (((zip_metadata_len) <= 160) ? _emalloc_160() : (((zip_metadata_len) <= 192) ? _emalloc_192() : (((zip_metadata_len) <= 224) ? _emalloc_224() : (((zip_metadata_len) <= 256) ? _emalloc_256() : (((zip_metadata_len) <= 320) ? _emalloc_320() : (((zip_metadata_len) <= 384) ? _emalloc_384() : (((zip_metadata_len) <= 448) ? _emalloc_448() : (((zip_metadata_len) <= 512) ? _emalloc_512() : (((zip_metadata_len) <= 640) ? _emalloc_640() : (((zip_metadata_len) <= 768) ? _emalloc_768() : (((zip_metadata_len) <= 896) ? _emalloc_896() : (((zip_metadata_len) <= 1024) ? _emalloc_1024() : (((zip_metadata_len) <= 1280) ? _emalloc_1280() : (((zip_metadata_len) <= 1536) ? _emalloc_1536() : (((zip_metadata_len) <= 1792) ? _emalloc_1792() : (((zip_metadata_len) <= 2048) ? _emalloc_2048() : (((zip_metadata_len) <= 2560) ? _emalloc_2560() : (((zip_metadata_len) <= 3072) ? _emalloc_3072() : (((zip_metadata_len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((zip_metadata_len)) : _emalloc_huge((zip_metadata_len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((zip_metadata_len) ) ));
   memcpy((*(metadata)).value.ptr, *buffer, zip_metadata_len);
   return SUCCESS;
  }
 } else {
  do { (*(metadata)).u1.type_info = 0; } while (0);
...
# 652 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
static int phar_parse_pharfile(php_stream *fp, char *fname, int fname_len, char *alias, int alias_len, zend_long halt_offset, phar_archive_data** pphar, php_uint32 compression, char **error)
{
 ...
 if (-1 == _php_stream_seek((fp), (halt_offset), (0))) {
  if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "cannot seek to __HALT_COMPILER(); location in phar \"%s\"", fname); } return FAILURE;
 }

 buffer = b32;

 if (3 != _php_stream_read((fp), (buffer), (3))) {
  if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (truncated manifest at stub end)", fname); } return FAILURE;
 }
 ...
 if (4 != _php_stream_read((fp), (buffer), (4))) {
  if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (truncated manifest at manifest length)", fname); } return FAILURE;
 }
 ...
 if (manifest_len > 1048576 * 100) {
  ...
  if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "manifest cannot be larger than 100 MB in phar \"%s\"", fname); } return FAILURE;
 }

 buffer = (char *)(__builtin_constant_p((manifest_len) ) ? (((manifest_len) <= 8) ? _emalloc_8() : (((manifest_len) <= 16) ? _emalloc_16() : (((manifest_len) <= 24) ? _emalloc_24() : (((manifest_len) <= 32) ? _emalloc_32() : (((manifest_len) <= 40) ? _emalloc_40() : (((manifest_len) <= 48) ? _emalloc_48() : (((manifest_len) <= 56) ? _emalloc_56() : (((manifest_len) <= 64) ? _emalloc_64() : (((manifest_len) <= 80) ? _emalloc_80() : (((manifest_len) <= 96) ? _emalloc_96() : (((manifest_len) <= 112) ? _emalloc_112() : (((manifest_len) <= 128) ? _emalloc_128() : (((manifest_len) <= 160) ? _emalloc_160() : (((manifest_len) <= 192) ? _emalloc_192() : (((manifest_len) <= 224) ? _emalloc_224() : (((manifest_len) <= 256) ? _emalloc_256() : (((manifest_len) <= 320) ? _emalloc_320() : (((manifest_len) <= 384) ? _emalloc_384() : (((manifest_len) <= 448) ? _emalloc_448() : (((manifest_len) <= 512) ? _emalloc_512() : (((manifest_len) <= 640) ? _emalloc_640() : (((manifest_len) <= 768) ? _emalloc_768() : (((manifest_len) <= 896) ? _emalloc_896() : (((manifest_len) <= 1024) ? _emalloc_1024() : (((manifest_len) <= 1280) ? _emalloc_1280() : (((manifest_len) <= 1536) ? _emalloc_1536() : (((manifest_len) <= 1792) ? _emalloc_1792() : (((manifest_len) <= 2048) ? _emalloc_2048() : (((manifest_len) <= 2560) ? _emalloc_2560() : (((manifest_len) <= 3072) ? _emalloc_3072() : (((manifest_len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((manifest_len)) : _emalloc_huge((manifest_len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((manifest_len) ) );
 savebuf = buffer;
 endbuffer = buffer + manifest_len;

 if (manifest_len < 10 || manifest_len != _php_stream_read((fp), (buffer), (manifest_len))) {
  _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (truncated manifest header)", fname); } return FAILURE;
 }
 ...
 if (manifest_count == 0) {
  _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "in phar \"%s\", manifest claims to have zero entries.  Phars must have at least 1 entry", fname); } return FAILURE;;
 }
 ...
 if (manifest_flags & 0x00010000) {
  ...
  switch(sig_flags) {
   case 0x0010: {
    ...
    sig = (char *) (__builtin_constant_p((signature_len) ) ? (((signature_len) <= 8) ? _emalloc_8() : (((signature_len) <= 16) ? _emalloc_16() : (((signature_len) <= 24) ? _emalloc_24() : (((signature_len) <= 32) ? _emalloc_32() : (((signature_len) <= 40) ? _emalloc_40() : (((signature_len) <= 48) ? _emalloc_48() : (((signature_len) <= 56) ? _emalloc_56() : (((signature_len) <= 64) ? _emalloc_64() : (((signature_len) <= 80) ? _emalloc_80() : (((signature_len) <= 96) ? _emalloc_96() : (((signature_len) <= 112) ? _emalloc_112() : (((signature_len) <= 128) ? _emalloc_128() : (((signature_len) <= 160) ? _emalloc_160() : (((signature_len) <= 192) ? _emalloc_192() : (((signature_len) <= 224) ? _emalloc_224() : (((signature_len) <= 256) ? _emalloc_256() : (((signature_len) <= 320) ? _emalloc_320() : (((signature_len) <= 384) ? _emalloc_384() : (((signature_len) <= 448) ? _emalloc_448() : (((signature_len) <= 512) ? _emalloc_512() : (((signature_len) <= 640) ? _emalloc_640() : (((signature_len) <= 768) ? _emalloc_768() : (((signature_len) <= 896) ? _emalloc_896() : (((signature_len) <= 1024) ? _emalloc_1024() : (((signature_len) <= 1280) ? _emalloc_1280() : (((signature_len) <= 1536) ? _emalloc_1536() : (((signature_len) <= 1792) ? _emalloc_1792() : (((signature_len) <= 2048) ? _emalloc_2048() : (((signature_len) <= 2560) ? _emalloc_2560() : (((signature_len) <= 3072) ? _emalloc_3072() : (((signature_len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((signature_len)) : _emalloc_huge((signature_len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((signature_len) ) );
    ...
    if (FAILURE == phar_verify_signature(fp, end_of_phar, 0x0010, sig, signature_len, fname, &signature, &sig_len, error)) {
     _efree((savebuf) );
     _efree((sig) );
     _php_stream_free((fp), (1 | 2));
     if (error) {
   ...
   case 0x0004: {
    ...
    if (FAILURE == phar_verify_signature(fp, read_len, 0x0004, (char *)digest, 64, fname, &signature, &sig_len, error)) {
     _efree((savebuf) );
     _php_stream_free((fp), (1 | 2));
     if (error) {
      char *save = *error;
   ...
   case 0x0003: {
    ...
    if (FAILURE == phar_verify_signature(fp, read_len, 0x0003, (char *)digest, 32, fname, &signature, &sig_len, error)) {
     _efree((savebuf) );
     _php_stream_free((fp), (1 | 2));
     if (error) {
      char *save = *error;
...
# 894 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
   case 0x0002: {
    ...
    if (FAILURE == phar_verify_signature(fp, read_len, 0x0002, (char *)digest, 20, fname, &signature, &sig_len, error)) {
     _efree((savebuf) );
     _php_stream_free((fp), (1 | 2));
     if (error) {
      char *save = *error;
   ...
   case 0x0001: {
    ...
    if (FAILURE == phar_verify_signature(fp, read_len, 0x0001, (char *)digest, 16, fname, &signature, &sig_len, error)) {
     _efree((savebuf) );
     _php_stream_free((fp), (1 | 2));
     if (error) {
      char *save = *error;
 ...
 if (buffer + tmp_len > endbuffer) {
  _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (buffer overrun)", fname); } return FAILURE;;
 }
 ...
 if (manifest_count > ((manifest_len - 10 - tmp_len) / (5 * 4 + 1))) {
  ...
  _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (too many manifest entries for size of manifest)", fname); } return FAILURE;
 }
 ...
 memcpy(&len, buffer, sizeof(len)); buffer += 4;
 ...
 if(len > endbuffer - buffer) {
  _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (trying to read past buffer end)", fname); } return FAILURE;;
 }
 if (phar_parse_metadata(&buffer, &mydata->metadata, len) == FAILURE) {
  _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to read phar metadata in .phar file \"%s\"", fname); } return FAILURE;;
 }
 buffer += len;


 _zend_hash_init((&mydata->manifest), (manifest_count), (destroy_phar_manifest_entry), ((zend_bool)mydata->is_persistent) )
                                                                                     ;
 _zend_hash_init((&mydata->mounted_dirs), (5), (((void *)0)), ((zend_bool)mydata->is_persistent) )
                                                              ;
 _zend_hash_init((&mydata->virtual_dirs), (manifest_count * 2), (((void *)0)), ((zend_bool)mydata->is_persistent) )
                                                              ;
 ...
 for (manifest_index = 0; manifest_index < manifest_count; ++manifest_index) {
  if (buffer + 4 > endbuffer) {
   _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (truncated manifest entry)", fname); } return FAILURE;
  }

  memcpy(&entry.filename_len, buffer, sizeof(entry.filename_len)); buffer += 4;

  if (entry.filename_len == 0) {
   _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "zero-length filename encountered in phar \"%s\"", fname); } return FAILURE;;
  }
  ...
  if (phar_parse_metadata(&buffer, &entry.metadata, len) == FAILURE) {
   ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
   _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to read file metadata in .phar file \"%s\"", fname); } return FAILURE;;
  }
  buffer += len;
  ...
  switch (entry.flags & 0x0000F000) {
   case 0x00001000:
    if (!(phar_globals.has_zlib)) {
     ...
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "zlib extension is required for gz compressed .phar file \"%s\"", fname); } return FAILURE;;
    }
    break;
   case 0x00002000:
    if (!(phar_globals.has_bz2)) {
     ...
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "bz2 extension is required for bzip2 compressed .phar file \"%s\"", fname); } return FAILURE;;
    }
    break;
   default:
    if (entry.uncompressed_filesize != entry.compressed_filesize) {
     ...
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (compressed and uncompressed size does not match for uncompressed entry)", fname); } return FAILURE;;
    }
    break;
  }
 ...
 if (register_alias) {
  ...
  if (!phar_validate_alias(mydata->alias, mydata->alias_len)) {
   signature = ((void *)0);
   fp = ((void *)0);
   _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "Cannot open archive \"%s\", invalid alias", fname); } return FAILURE;;
  }
  ...
  if (((void *)0) != (fd_ptr = zend_hash_str_find_ptr(&((phar_globals.phar_alias_map)), alias, alias_len))) {
   if (SUCCESS != phar_free_alias(fd_ptr, alias, alias_len)) {
    signature = ((void *)0);
    fp = ((void *)0);
    _efree((savebuf) ); if (mydata) { phar_destroy_phar_data(mydata); } if (signature) { (((phar_globals.persist))?free(signature):_efree((signature) )); } if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "Cannot open archive \"%s\", alias is already in use by existing archive", fname); } return FAILURE;;
   }
  }
...
check_file:
 if (phar_open_parsed_phar(fname, fname_len, alias, alias_len, is_data, options, test, &my_error) == SUCCESS) {
  ...
  if ((phar_globals.readonly) && !(*test)->is_data && ((*test)->is_tar || (*test)->is_zip)) {
   phar_entry_info *stub;
   if (((void *)0) == (stub = zend_hash_str_find_ptr(&((*test)->manifest), ".phar/stub.php", sizeof(".phar/stub.php")-1))) {
    spprintf(error, 0, "'%s' is not a phar archive. Use PharData::__construct() for a standard zip or tar archive", fname);
    return FAILURE;
   }
  }
...
int phar_create_or_parse_filename(char *fname, int fname_len, char *alias, int alias_len, int is_data, int options, phar_archive_data** pphar, char **error)
{
 ...
 _zend_hash_init((&mydata->manifest), (sizeof(phar_entry_info)), (destroy_phar_manifest_entry), (0) )
                                                      ;
 _zend_hash_init((&mydata->mounted_dirs), (sizeof(char *)), (((void *)0)), (0) )
                               ;
 _zend_hash_init((&mydata->virtual_dirs), (sizeof(char *)), (((void *)0)), ((zend_bool)mydata->is_persistent) )
                                                              ;
 mydata->fname_len = fname_len;
 ...
 if (is_data) {
  ...
  if (alias && ((void *)0) != (fd_ptr = zend_hash_str_find_ptr(&((phar_globals.phar_alias_map)), alias, alias_len))) {
   if (SUCCESS != phar_free_alias(fd_ptr, alias, alias_len)) {
    if (error) {
 ...
 if (alias_len && alias) {
  if (((void *)0) == zend_hash_str_add_ptr(&((phar_globals.phar_alias_map)), alias, alias_len, mydata)) {
   if (options & 0x00000008) {
    if (error) {
...
# 1474 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_open_from_filename(char *fname, int fname_len, char *alias, int alias_len, int options, phar_archive_data** pphar, char **error)
{
 php_stream *fp;
 zend_string *actual;
...
static int phar_open_from_fp(php_stream* fp, char *fname, int fname_len, char *alias, int alias_len, int options, phar_archive_data** pphar, int is_data, char **error)
{
 ...
 if (-1 == _php_stream_seek((fp), 0L, 0)) {
  if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "cannot rewind phar \"%s\"", fname); } return FAILURE;
 }
 ...
 while(!_php_stream_eof((fp))) {
  if ((got = _php_stream_read((fp), (buffer+tokenlen), (readsize))) < (size_t) tokenlen) {
   if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (truncated entry)", fname); } return FAILURE;
  }
  ...
  if (!test) {
   ...
   if (!memcmp(pos, gz_magic, 3)) {
    ...
    if (!(phar_globals.has_zlib)) {
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress gzipped phar archive \"%s\" to temporary file, enable zlib extension in php.ini", fname); } return FAILURE;
    }
    ...
    add_assoc_long_ex(&filterparams, "window", sizeof("window") - 1, 15 + 32);


    if (!(temp = _php_stream_fopen_tmpfile(0 ))) {
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to create temporary file for decompression of gzipped phar archive \"%s\"", fname); } return FAILURE;
    }
    ...
    if (!filter) {
     err = 1;
     add_assoc_long_ex(&filterparams, "window", sizeof("window") - 1, 15);
     filter = php_stream_filter_create("zlib.inflate", &filterparams, (fp)->is_persistent);
     _zval_dtor((&filterparams) );

     if (!filter) {
      _php_stream_free((temp), (1 | 2));
      if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress gzipped phar archive \"%s\", ext/zlib is buggy in PHP versions older than 5.2.6", fname); } return FAILURE;
     }
    } else {
     _zval_dtor((&filterparams) );
    }
    ...
    if (SUCCESS != _php_stream_copy_to_stream_ex((fp), (temp), (((size_t)-1)), (((void *)0)) )) {
     if (err) {
      _php_stream_free((temp), (1 | 2));
      if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress gzipped phar archive \"%s\", ext/zlib is buggy in PHP versions older than 5.2.6", fname); } return FAILURE;
     }
     _php_stream_free((temp), (1 | 2));
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress gzipped phar archive \"%s\" to temporary file", fname); } return FAILURE;
    }
    ...
    if (!(phar_globals.has_bz2)) {
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress bzipped phar archive \"%s\" to temporary file, enable bz2 extension in php.ini", fname); } return FAILURE;
    }


    if (!(temp = _php_stream_fopen_tmpfile(0 ))) {
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to create temporary file for decompression of bzipped phar archive \"%s\"", fname); } return FAILURE;
    }
    ...
    if (!filter) {
     _php_stream_free((temp), (1 | 2));
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress bzipped phar archive \"%s\", filter creation failed", fname); } return FAILURE;
    }
    ...
    if (SUCCESS != _php_stream_copy_to_stream_ex((fp), (temp), (((size_t)-1)), (((void *)0)) )) {
     _php_stream_free((temp), (1 | 2));
     if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "unable to decompress bzipped phar archive \"%s\" to temporary file", fname); } return FAILURE;
    }
 ...
 if (fp) { _php_stream_free((fp), (1 | 2)); } if (error) { spprintf(error, 0, "internal corruption of phar \"%s\" (__HALT_COMPILER(); not found)", fname); } return FAILURE;
}
# 1737 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
static int phar_analyze_path(const char *fname, const char *ext, int ext_len, int for_create)
{
 ...
 if ((realpath = expand_filepath(filename, ((void *)0)))) {
  ...
  if ((phar_globals.manifest_cached) && zend_hash_str_exists(&cached_phars, realpath, strlen(realpath))) {
   _efree((realpath) );
   _efree((filename) );
   return SUCCESS;
  }
 ...
 if (SUCCESS == _php_stream_stat_path(((char *) filename), 0, (&ssb), ((void *)0))) {
  ...
  if (SUCCESS != _php_stream_stat_path(((char *) filename), 0, (&ssb), ((void *)0))) {
   if (!slash) {
    ...
    if (SUCCESS != _php_stream_stat_path((realpath), 0, (&ssb), ((void *)0))) {
     _efree((realpath) );
     _efree((filename) );
     return FAILURE;
    }
...
# 1897 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_detect_phar_fname_ext(const char *filename, int filename_len, const char **ext_str, int *ext_len, int executable, int for_create, int is_complete)
{
 ...
 *ext_len = 0;
 ...
 if (pos && pos != filename) {
  ...
  if ((phar_globals.manifest_cached) && zend_hash_str_exists(&cached_alias, (char *) filename, pos - filename)) {
   *ext_str = pos;
   *ext_len = -1;
   return FAILURE;
  }
 ...
 if ((&((phar_globals.phar_fname_map)))->nNumOfElements || (phar_globals.manifest_cached)) {
  phar_archive_data *pphar;

  if (is_complete) {
   if (((void *)0) != (pphar = zend_hash_str_find_ptr(&((phar_globals.phar_fname_map)), (char *) filename, filename_len))) {
...
woohoo:
   ...
   if ((phar_globals.manifest_cached) && ((void *)0) != (pphar = zend_hash_str_find_ptr(&cached_phars, (char *) filename, filename_len))) {
    *ext_str = filename + (filename_len - pphar->ext_len);
    goto woohoo;
   }
  } else {
   ...
   for (zend_hash_internal_pointer_reset_ex(&((phar_globals.phar_fname_map)), &(&((phar_globals.phar_fname_map)))->nInternalPointer);
    3 != zend_hash_get_current_key_ex(&((phar_globals.phar_fname_map)), &str_key, &unused, &(&((phar_globals.phar_fname_map)))->nInternalPointer);
    zend_hash_move_forward_ex(&((phar_globals.phar_fname_map)), &(&((phar_globals.phar_fname_map)))->nInternalPointer)
   ) {
    ...
    if (!memcmp(filename, (str_key)->val, (str_key)->len) && ((uint)filename_len == (str_key)->len
     ...
     if (((void *)0) == (pphar = zend_hash_get_current_data_ptr_ex(&((phar_globals.phar_fname_map)), &(&((phar_globals.phar_fname_map)))->nInternalPointer))) {
      break;
     }
   ...
   if ((phar_globals.manifest_cached)) {
    for (zend_hash_internal_pointer_reset_ex(&cached_phars, &(&cached_phars)->nInternalPointer);
     3 != zend_hash_get_current_key_ex(&cached_phars, &str_key, &unused, &(&cached_phars)->nInternalPointer);
     zend_hash_move_forward_ex(&cached_phars, &(&cached_phars)->nInternalPointer)
    ) {
     if ((str_key)->len > (uint) filename_len) {
      continue;
     }
     ...
     if (!memcmp(filename, (str_key)->val, (str_key)->len) && ((uint)filename_len == (str_key)->len
      || filename[(str_key)->len] == '/' || filename[(str_key)->len] == '\0')) {
      if (((void *)0) == (pphar = zend_hash_get_current_data_ptr_ex(&cached_phars, &(&cached_phars)->nInternalPointer))) {
       break;
      }
      *ext_str = filename + ((str_key)->len - pphar->ext_len);
      goto woohoo;
...
# 2077 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
char *phar_fix_filepath(char *path, int *new_len, int use_cwd)
{
 char *newpath;
 int newpath_len;
 ...
 if ((phar_globals.cwd_len) && use_cwd && path_length > 2 && path[0] == '.' && path[1] == '/') {
  ...
  newpath = (__builtin_constant_p((strlen(path) + newpath_len + 1) ) ? (((strlen(path) + newpath_len + 1) <= 8) ? _emalloc_8() : (((strlen(path) + newpath_len + 1) <= 16) ? _emalloc_16() : (((strlen(path) + newpath_len + 1) <= 24) ? _emalloc_24() : (((strlen(path) + newpath_len + 1) <= 32) ? _emalloc_32() : (((strlen(path) + newpath_len + 1) <= 40) ? _emalloc_40() : (((strlen(path) + newpath_len + 1) <= 48) ? _emalloc_48() : (((strlen(path) + newpath_len + 1) <= 56) ? _emalloc_56() : (((strlen(path) + newpath_len + 1) <= 64) ? _emalloc_64() : (((strlen(path) + newpath_len + 1) <= 80) ? _emalloc_80() : (((strlen(path) + newpath_len + 1) <= 96) ? _emalloc_96() : (((strlen(path) + newpath_len + 1) <= 112) ? _emalloc_112() : (((strlen(path) + newpath_len + 1) <= 128) ? _emalloc_128() : (((strlen(path) + newpath_len + 1) <= 160) ? _emalloc_160() : (((strlen(path) + newpath_len + 1) <= 192) ? _emalloc_192() : (((strlen(path) + newpath_len + 1) <= 224) ? _emalloc_224() : (((strlen(path) + newpath_len + 1) <= 256) ? _emalloc_256() : (((strlen(path) + newpath_len + 1) <= 320) ? _emalloc_320() : (((strlen(path) + newpath_len + 1) <= 384) ? _emalloc_384() : (((strlen(path) + newpath_len + 1) <= 448) ? _emalloc_448() : (((strlen(path) + newpath_len + 1) <= 512) ? _emalloc_512() : (((strlen(path) + newpath_len + 1) <= 640) ? _emalloc_640() : (((strlen(path) + newpath_len + 1) <= 768) ? _emalloc_768() : (((strlen(path) + newpath_len + 1) <= 896) ? _emalloc_896() : (((strlen(path) + newpath_len + 1) <= 1024) ? _emalloc_1024() : (((strlen(path) + newpath_len + 1) <= 1280) ? _emalloc_1280() : (((strlen(path) + newpath_len + 1) <= 1536) ? _emalloc_1536() : (((strlen(path) + newpath_len + 1) <= 1792) ? _emalloc_1792() : (((strlen(path) + newpath_len + 1) <= 2048) ? _emalloc_2048() : (((strlen(path) + newpath_len + 1) <= 2560) ? _emalloc_2560() : (((strlen(path) + newpath_len + 1) <= 3072) ? _emalloc_3072() : (((strlen(path) + newpath_len + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((strlen(path) + newpath_len + 1)) : _emalloc_huge((strlen(path) + newpath_len + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((strlen(path) + newpath_len + 1) ) );
  memcpy(newpath, (phar_globals.cwd), newpath_len);
 } else {
  newpath = (__builtin_constant_p((strlen(path) + 2) ) ? (((strlen(path) + 2) <= 8) ? _emalloc_8() : (((strlen(path) + 2) <= 16) ? _emalloc_16() : (((strlen(path) + 2) <= 24) ? _emalloc_24() : (((strlen(path) + 2) <= 32) ? _emalloc_32() : (((strlen(path) + 2) <= 40) ? _emalloc_40() : (((strlen(path) + 2) <= 48) ? _emalloc_48() : (((strlen(path) + 2) <= 56) ? _emalloc_56() : (((strlen(path) + 2) <= 64) ? _emalloc_64() : (((strlen(path) + 2) <= 80) ? _emalloc_80() : (((strlen(path) + 2) <= 96) ? _emalloc_96() : (((strlen(path) + 2) <= 112) ? _emalloc_112() : (((strlen(path) + 2) <= 128) ? _emalloc_128() : (((strlen(path) + 2) <= 160) ? _emalloc_160() : (((strlen(path) + 2) <= 192) ? _emalloc_192() : (((strlen(path) + 2) <= 224) ? _emalloc_224() : (((strlen(path) + 2) <= 256) ? _emalloc_256() : (((strlen(path) + 2) <= 320) ? _emalloc_320() : (((strlen(path) + 2) <= 384) ? _emalloc_384() : (((strlen(path) + 2) <= 448) ? _emalloc_448() : (((strlen(path) + 2) <= 512) ? _emalloc_512() : (((strlen(path) + 2) <= 640) ? _emalloc_640() : (((strlen(path) + 2) <= 768) ? _emalloc_768() : (((strlen(path) + 2) <= 896) ? _emalloc_896() : (((strlen(path) + 2) <= 1024) ? _emalloc_1024() : (((strlen(path) + 2) <= 1280) ? _emalloc_1280() : (((strlen(path) + 2) <= 1536) ? _emalloc_1536() : (((strlen(path) + 2) <= 1792) ? _emalloc_1792() : (((strlen(path) + 2) <= 2048) ? _emalloc_2048() : (((strlen(path) + 2) <= 2560) ? _emalloc_2560() : (((strlen(path) + 2) <= 3072) ? _emalloc_3072() : (((strlen(path) + 2) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((strlen(path) + 2)) : _emalloc_huge((strlen(path) + 2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((strlen(path) + 2) ) );
  newpath[0] = '/';
  newpath_len = 1;
 }
 ...
 *new_len = newpath_len;
 newpath[newpath_len] = '\0';
 return _erealloc((newpath), (newpath_len + 1) );
}
# 2191 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_split_fname(const char *filename, int filename_len, char **arch, int *arch_len, char **entry, int *entry_len, int executable, int for_create)
{
 const char *ext_str;
...
int phar_open_executed_filename(char *alias, int alias_len, char **error)
{
 ...
 if (phar_open_parsed_phar(fname, fname_len, alias, alias_len, 0, 0x00000008, ((void *)0), 0) == SUCCESS) {
  return SUCCESS;
 }
...
# 2298 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
 if (php_check_open_basedir(fname)) {
  return FAILURE;
 }
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/stub.h" 1
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/stub.h"
...
# 2441 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
...
# 2487 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_flush(phar_archive_data *phar, char *user_stub, zend_long len, int convert, char **error)
{
 ...
 if (!(&phar->manifest)->nNumOfElements && !user_stub) {
  return (-1);
 }
 ...
 if (user_stub) {
  ...
  if (len < 0) {
   ...
   if (!((stubfile) = (php_stream*)zend_fetch_resource2_ex(((zval *)user_stub), "stream", php_file_le_stream(), php_file_le_pstream()))) {
    if (closeoldfile) {
     _php_stream_free((oldfile), (1 | 2));
    }
   ...
   if (!(suser_stub = _php_stream_copy_to_mem((stubfile), (len), (0) ))) {
    if (closeoldfile) {
     _php_stream_free((oldfile), (1 | 2));
    }
    _php_stream_free((newfile), (1 | 2));
  ...
  if (!user_stub && phar->halt_offset && oldfile && !phar->is_brandnew) {
   ...
   newstub = phar_create_default_stub(((void *)0), ((void *)0), ((void *)0));
   phar->halt_offset = (newstub)->len;
   written = _php_stream_write(newfile, ((newstub)->val), (phar->halt_offset));
  }
 ...
 for (zend_hash_internal_pointer_reset_ex(&phar->manifest, &(&phar->manifest)->nInternalPointer);
  ...
  if (SUCCESS != _php_stream_copy_to_stream_ex((file), (entry->cfp), (entry->uncompressed_filesize), (((void *)0)) )) {
   if (closeoldfile) {
    _php_stream_free((oldfile), (1 | 2));
   }
   _php_stream_free((newfile), (1 | 2));
...
# 2851 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
 ...
 if (4 != _php_stream_write(newfile, (manifest), (4)) || ((main_metadata_str.s ? (main_metadata_str.s)->len : 0)
 && (main_metadata_str.s)->len != _php_stream_write(newfile, ((main_metadata_str.s)->val), ((main_metadata_str.s)->len)))) {
...
# 2965 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
  mytime = time(((void *)0));
  ...
  || (entry->metadata_str.s &&
      (entry->metadata_str.s)->len != _php_stream_write(newfile, ((entry->metadata_str.s)->val), ((entry->metadata_str.s)->len)))) {
   if (closeoldfile) {
    _php_stream_free((oldfile), (1 | 2));
   }
 ...
 if(manifest_hack) {
  if(1 != _php_stream_write(newfile, (manifest), (1))) {
   if (closeoldfile) {
    _php_stream_free((oldfile), (1 | 2));
   }
 ...
 for (zend_hash_internal_pointer_reset_ex(&phar->manifest, &(&phar->manifest)->nInternalPointer);
  ...
  entry->offset = entry->offset_abs = offset;
  offset += entry->compressed_filesize;
  if (_php_stream_copy_to_stream_ex((file), (newfile), (entry->compressed_filesize), (&wrote) ) == FAILURE) {
   if (closeoldfile) {
    _php_stream_free((oldfile), (1 | 2));
   }
...
# 3109 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
   default: {
    char *digest = ((void *)0);
    int digest_len;
 ...
 if (phar->donotflush) {
  ...
  if (phar->flags & 0x00100000) {
   ...
   _array_init((&filterparams), 0 );
   add_assoc_long_ex(&filterparams, "window", strlen("window"), 15 +16);
...
# 3241 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
static zend_op_array *phar_compile_file(zend_file_handle *file_handle, int type)
{
 ...
 if (strstr(file_handle->filename, ".phar") && !strstr(file_handle->filename, "://")) {
  if (SUCCESS == phar_open_from_filename((char*)file_handle->filename, strlen(file_handle->filename), ((void *)0), 0, 0, &phar, ((void *)0))) {
   if (phar->is_zip || phar->is_tar) {
    zend_file_handle f = *file_handle;


    spprintf(&name, 4096, "phar://%s/%s", file_handle->filename, ".phar/stub.php");
    if (SUCCESS == zend_stream_open_function((const char *)name, file_handle)) {
     _efree((name) );
     name = ((void *)0);
 ...
 if (failed) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c", 3325);
 }
...
void zm_globals_ctor_phar(zend_phar_globals *phar_globals)
{
 ...
 _zend_hash_init((&phar_globals->mime_types), (0), (mime_type_dtor), (1) );
 ...
 mime.mime = "text/html"; mime.len = sizeof(("text/html"))+1; mime.type = '\1'; zend_hash_str_add_mem(&phar_globals->mime_types, "phps", sizeof("phps")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "c", sizeof("c")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "cc", sizeof("cc")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "cpp", sizeof("cpp")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "c++", sizeof("c++")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "dtd", sizeof("dtd")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "h", sizeof("h")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "log", sizeof("log")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "rng", sizeof("rng")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "txt", sizeof("txt")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/plain"; mime.len = sizeof(("text/plain"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "xsd", sizeof("xsd")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = ""; mime.len = sizeof((""))+1; mime.type = '\0'; zend_hash_str_add_mem(&phar_globals->mime_types, "php", sizeof("php")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = ""; mime.len = sizeof((""))+1; mime.type = '\0'; zend_hash_str_add_mem(&phar_globals->mime_types, "inc", sizeof("inc")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "video/avi"; mime.len = sizeof(("video/avi"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "avi", sizeof("avi")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/bmp"; mime.len = sizeof(("image/bmp"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "bmp", sizeof("bmp")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/css"; mime.len = sizeof(("text/css"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "css", sizeof("css")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/gif"; mime.len = sizeof(("image/gif"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "gif", sizeof("gif")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/html"; mime.len = sizeof(("text/html"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "htm", sizeof("htm")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/html"; mime.len = sizeof(("text/html"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "html", sizeof("html")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/html"; mime.len = sizeof(("text/html"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "htmls", sizeof("htmls")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/x-ico"; mime.len = sizeof(("image/x-ico"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "ico", sizeof("ico")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/jpeg"; mime.len = sizeof(("image/jpeg"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "jpe", sizeof("jpe")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/jpeg"; mime.len = sizeof(("image/jpeg"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "jpg", sizeof("jpg")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/jpeg"; mime.len = sizeof(("image/jpeg"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "jpeg", sizeof("jpeg")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "application/x-javascript"; mime.len = sizeof(("application/x-javascript"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "js", sizeof("js")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "audio/midi"; mime.len = sizeof(("audio/midi"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "midi", sizeof("midi")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "audio/midi"; mime.len = sizeof(("audio/midi"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "mid", sizeof("mid")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "audio/mod"; mime.len = sizeof(("audio/mod"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "mod", sizeof("mod")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "movie/quicktime"; mime.len = sizeof(("movie/quicktime"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "mov", sizeof("mov")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "audio/mp3"; mime.len = sizeof(("audio/mp3"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "mp3", sizeof("mp3")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "video/mpeg"; mime.len = sizeof(("video/mpeg"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "mpg", sizeof("mpg")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "video/mpeg"; mime.len = sizeof(("video/mpeg"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "mpeg", sizeof("mpeg")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "application/pdf"; mime.len = sizeof(("application/pdf"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "pdf", sizeof("pdf")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/png"; mime.len = sizeof(("image/png"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "png", sizeof("png")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "application/shockwave-flash"; mime.len = sizeof(("application/shockwave-flash"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "swf", sizeof("swf")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/tiff"; mime.len = sizeof(("image/tiff"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "tif", sizeof("tif")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/tiff"; mime.len = sizeof(("image/tiff"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "tiff", sizeof("tiff")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "audio/wav"; mime.len = sizeof(("audio/wav"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "wav", sizeof("wav")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "image/xbm"; mime.len = sizeof(("image/xbm"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "xbm", sizeof("xbm")-1, (void *)&mime, sizeof(phar_mime_type));
 mime.mime = "text/xml"; mime.len = sizeof(("text/xml"))+1; mime.type = '\2'; zend_hash_str_add_mem(&phar_globals->mime_types, "xml", sizeof("xml")-1, (void *)&mime, sizeof(phar_mime_type));
...
void phar_request_initialize(void)
{
 if (!(phar_globals.request_init))
 {
  ...
  _zend_hash_init((&((phar_globals.phar_fname_map))), (5), (destroy_phar_data), (0) );
  _zend_hash_init((&((phar_globals.phar_persist_map))), (5), (((void *)0)), (0) );
  _zend_hash_init((&((phar_globals.phar_alias_map))), (5), (((void *)0)), (0) );

  if ((phar_globals.manifest_cached)) {
   phar_archive_data *pphar;
   phar_entry_fp *stuff = (phar_entry_fp *) _ecalloc(((&cached_phars)->nNumOfElements), (sizeof(phar_entry_fp)) );

   for (zend_hash_internal_pointer_reset_ex(&cached_phars, &(&cached_phars)->nInternalPointer);
   (pphar = zend_hash_get_current_data_ptr_ex(&cached_phars, &(&cached_phars)->nInternalPointer)) != ((void *)0);
   zend_hash_move_forward_ex(&cached_phars, &(&cached_phars)->nInternalPointer)) {
    stuff[pphar->phar_pos].manifest = (phar_entry_fp_info *) _ecalloc(((&(pphar->manifest))->nNumOfElements), (sizeof(phar_entry_fp_info)) );
   }
...
int zm_deactivate_phar(int type, int module_number)
{
 ...
 if ((phar_globals.request_init))
 {
  ...
  if ((phar_globals.cached_fp)) {
   for (i = 0; i < (&cached_phars)->nNumOfElements; ++i) {
...
void zm_info_phar(zend_module_entry *zend_module)
{
 ...
 php_info_print_table_row(2, "Phar EXT version", "2.0.2");
 php_info_print_table_row(2, "Phar API version", "1.1.1");
 php_info_print_table_row(2, "SVN revision", "$Id: 18feace9f93cba61f4b49b41ada9438086a54ef4 $");
...
zend_module_entry phar_module_entry = {
 sizeof(zend_module_entry), 20151012, 0, 0, ((void *)0),
 phar_deps,
 "Phar",
 phar_functions,
 zm_startup_phar,
