# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
# 26 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_modules.h" 1
# 30 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2

# 1 "/home/ct584/git/bughunter/repositories/php-src/main/SAPI.h" 1
# 32 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 54 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
...
# 55 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 63 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 67 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 68 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 70 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.h" 1
# 71 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 72 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 73 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.h" 1
# 74 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 86 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 87 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 1
# 88 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 91 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2

# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.h" 1
# 46 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.h"
...
# 93 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c" 2
...
# 187 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
...
{
 user_config_cache_entry *entry = (user_config_cache_entry *)(*(el)).value.ptr;
 zend_hash_destroy(entry->user_config);
 free(entry->user_config);
 free(entry);
}
# 208 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
static php_cgi_globals_struct php_cgi_globals;
# 235 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
static int print_module_info(zval *element)
{
 zend_module_entry *module = (*(element)).value.ptr;
 php_printf("%s\n", module->name);
 return 0;
}
...
static int module_name_cmp(const void *a, const void *b)
{
 ...
 return strcasecmp( ((zend_module_entry *)(f->val).value.ptr)->name,
      ((zend_module_entry *)(s->val).value.ptr)->name);
}
...
static void print_modules(void)
{
 ...
 _zend_hash_init((&sorted_registry), (64), (((void *)0)), (1) );
 zend_hash_copy(&sorted_registry, &module_registry, ((void *)0));
 zend_hash_sort_ex(&sorted_registry, zend_sort, module_name_cmp, 0);
...
static size_t sapi_fcgi_ub_write(const char *str, size_t str_length)
{
 ...
 while (remaining > 0) {
  int to_write = remaining > 2147483647 ? 2147483647 : (int)remaining;
...
static int sapi_cgi_send_headers(sapi_headers_struct *sapi_headers)
{
 ...
 if ((php_cgi_globals.nph) || (sapi_globals.sapi_headers).http_response_code != 200)
 {
  ...
  if ((php_cgi_globals.rfc2616_headers) && (sapi_globals.sapi_headers).http_status_line) {
   ...
   if ((s = strchr((sapi_globals.sapi_headers).http_status_line, ' '))) {
   ...
   if ((sapi_globals.sapi_headers).http_status_line &&
    (s = strchr((sapi_globals.sapi_headers).http_status_line, ' ')) != 0 &&
    ...
    if (!has_status) {
     ...
     if (err->str) {
      len = ap_php_slprintf(buf, sizeof(buf), "Status: %d %s\r\n", (sapi_globals.sapi_headers).http_response_code, err->str);
     } else {
...
static size_t sapi_cgi_read_post(char *buffer, size_t count_bytes)
{
 ...
 remaining_bytes = (size_t)((sapi_globals.request_info).content_length - (sapi_globals.read_post_bytes));

 count_bytes = (((count_bytes)<(remaining_bytes))?(count_bytes):(remaining_bytes));
...
static size_t sapi_fcgi_read_post(char *buffer, size_t count_bytes)
{
 ...
 while (read_bytes < count_bytes) {
  ...
  int to_read = (diff > 2147483647) ? 2147483647 : (int)diff;
...
# 587 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
 return getenv(name);
}
...
static void cgi_php_load_env_var(char *var, unsigned int var_len, char *val, unsigned int val_len, void *arg)
{
 ...
 int filter_arg = ((*(array_ptr)).value.arr == ((core_globals.http_globals)[4]).value.arr)?4:5;
 size_t new_val_len;
...
{
 if (zval_get_type(&((core_globals.http_globals)[4])) == 7 &&
  (*(array_ptr)).value.arr != ((core_globals.http_globals)[4]).value.arr &&
  (((core_globals.http_globals)[4]).value.arr)->nNumOfElements > 0
 ) {
  _zval_dtor((array_ptr) );
  do { zval *_z1 = (array_ptr); const zval *_z2 = (&(core_globals.http_globals)[4]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
  return;
 } else if (zval_get_type(&((core_globals.http_globals)[3])) == 7 &&
  (*(array_ptr)).value.arr != ((core_globals.http_globals)[3]).value.arr &&
  (((core_globals.http_globals)[3]).value.arr)->nNumOfElements > 0
 ) {
  _zval_dtor((array_ptr) );
  do { zval *_z1 = (array_ptr); const zval *_z2 = (&(core_globals.http_globals)[3]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
  return;
 }
 ...
 if ((php_cgi_globals.fix_pathinfo)) {
  ...
  if (path_info) {
   ...
   if (script_name) {
    ...
    php_self = ((use_heap = (__builtin_expect(!!((php_self_len + 1) > ((32 * 1024))), 0))) ? (__builtin_constant_p((php_self_len + 1) ) ? (((php_self_len + 1) <= 8) ? _emalloc_8() : (((php_self_len + 1) <= 16) ? _emalloc_16() : (((php_self_len + 1) <= 24) ? _emalloc_24() : (((php_self_len + 1) <= 32) ? _emalloc_32() : (((php_self_len + 1) <= 40) ? _emalloc_40() : (((php_self_len + 1) <= 48) ? _emalloc_48() : (((php_self_len + 1) <= 56) ? _emalloc_56() : (((php_self_len + 1) <= 64) ? _emalloc_64() : (((php_self_len + 1) <= 80) ? _emalloc_80() : (((php_self_len + 1) <= 96) ? _emalloc_96() : (((php_self_len + 1) <= 112) ? _emalloc_112() : (((php_self_len + 1) <= 128) ? _emalloc_128() : (((php_self_len + 1) <= 160) ? _emalloc_160() : (((php_self_len + 1) <= 192) ? _emalloc_192() : (((php_self_len + 1) <= 224) ? _emalloc_224() : (((php_self_len + 1) <= 256) ? _emalloc_256() : (((php_self_len + 1) <= 320) ? _emalloc_320() : (((php_self_len + 1) <= 384) ? _emalloc_384() : (((php_self_len + 1) <= 448) ? _emalloc_448() : (((php_self_len + 1) <= 512) ? _emalloc_512() : (((php_self_len + 1) <= 640) ? _emalloc_640() : (((php_self_len + 1) <= 768) ? _emalloc_768() : (((php_self_len + 1) <= 896) ? _emalloc_896() : (((php_self_len + 1) <= 1024) ? _emalloc_1024() : (((php_self_len + 1) <= 1280) ? _emalloc_1280() : (((php_self_len + 1) <= 1536) ? _emalloc_1536() : (((php_self_len + 1) <= 1792) ? _emalloc_1792() : (((php_self_len + 1) <= 2048) ? _emalloc_2048() : (((php_self_len + 1) <= 2560) ? _emalloc_2560() : (((php_self_len + 1) <= 3072) ? _emalloc_3072() : (((php_self_len + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((php_self_len + 1)) : _emalloc_huge((php_self_len + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((php_self_len + 1) ) ) : __builtin_alloca (php_self_len + 1));
...
static void php_cgi_ini_activate_user_config(char *path, size_t path_len, const char *doc_root, size_t doc_root_len, int start)
{
 ...
 if ((entry = zend_hash_str_find_ptr(&(php_cgi_globals.user_config_cache), path, path_len)) == ((void *)0)) {
  new_entry = ((1)?__zend_malloc(sizeof(user_config_cache_entry)):(__builtin_constant_p((sizeof(user_config_cache_entry)) ) ? (((sizeof(user_config_cache_entry)) <= 8) ? _emalloc_8() : (((sizeof(user_config_cache_entry)) <= 16) ? _emalloc_16() : (((sizeof(user_config_cache_entry)) <= 24) ? _emalloc_24() : (((sizeof(user_config_cache_entry)) <= 32) ? _emalloc_32() : (((sizeof(user_config_cache_entry)) <= 40) ? _emalloc_40() : (((sizeof(user_config_cache_entry)) <= 48) ? _emalloc_48() : (((sizeof(user_config_cache_entry)) <= 56) ? _emalloc_56() : (((sizeof(user_config_cache_entry)) <= 64) ? _emalloc_64() : (((sizeof(user_config_cache_entry)) <= 80) ? _emalloc_80() : (((sizeof(user_config_cache_entry)) <= 96) ? _emalloc_96() : (((sizeof(user_config_cache_entry)) <= 112) ? _emalloc_112() : (((sizeof(user_config_cache_entry)) <= 128) ? _emalloc_128() : (((sizeof(user_config_cache_entry)) <= 160) ? _emalloc_160() : (((sizeof(user_config_cache_entry)) <= 192) ? _emalloc_192() : (((sizeof(user_config_cache_entry)) <= 224) ? _emalloc_224() : (((sizeof(user_config_cache_entry)) <= 256) ? _emalloc_256() : (((sizeof(user_config_cache_entry)) <= 320) ? _emalloc_320() : (((sizeof(user_config_cache_entry)) <= 384) ? _emalloc_384() : (((sizeof(user_config_cache_entry)) <= 448) ? _emalloc_448() : (((sizeof(user_config_cache_entry)) <= 512) ? _emalloc_512() : (((sizeof(user_config_cache_entry)) <= 640) ? _emalloc_640() : (((sizeof(user_config_cache_entry)) <= 768) ? _emalloc_768() : (((sizeof(user_config_cache_entry)) <= 896) ? _emalloc_896() : (((sizeof(user_config_cache_entry)) <= 1024) ? _emalloc_1024() : (((sizeof(user_config_cache_entry)) <= 1280) ? _emalloc_1280() : (((sizeof(user_config_cache_entry)) <= 1536) ? _emalloc_1536() : (((sizeof(user_config_cache_entry)) <= 1792) ? _emalloc_1792() : (((sizeof(user_config_cache_entry)) <= 2048) ? _emalloc_2048() : (((sizeof(user_config_cache_entry)) <= 2560) ? _emalloc_2560() : (((sizeof(user_config_cache_entry)) <= 3072) ? _emalloc_3072() : (((sizeof(user_config_cache_entry)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(user_config_cache_entry))) : _emalloc_huge((sizeof(user_config_cache_entry)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(user_config_cache_entry)) ) ));
  new_entry->expires = 0;
  new_entry->user_config = (HashTable *) ((1)?__zend_malloc(sizeof(HashTable)):(__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) ));
  _zend_hash_init((new_entry->user_config), (8), ((dtor_func_t) config_zval_dtor), (1) );
  entry = zend_hash_str_update_ptr(&(php_cgi_globals.user_config_cache), path, path_len, new_entry);
 }
...
# 786 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
  if (strncmp(s1, s2, s_len) == 0) {

   ptr = s2 + start;
   while ((ptr = strchr(ptr, '/')) != ((void *)0)) {
    *ptr = 0;
...
static int sapi_cgi_activate(void)
{
 ...
 if (php_ini_has_per_dir_config() ||
  ...
  if (!(((sapi_globals.request_info).path_translated[path_len]) == '/')) {
   path = (__builtin_constant_p((path_len + 2) ) ? (((path_len + 2) <= 8) ? _emalloc_8() : (((path_len + 2) <= 16) ? _emalloc_16() : (((path_len + 2) <= 24) ? _emalloc_24() : (((path_len + 2) <= 32) ? _emalloc_32() : (((path_len + 2) <= 40) ? _emalloc_40() : (((path_len + 2) <= 48) ? _emalloc_48() : (((path_len + 2) <= 56) ? _emalloc_56() : (((path_len + 2) <= 64) ? _emalloc_64() : (((path_len + 2) <= 80) ? _emalloc_80() : (((path_len + 2) <= 96) ? _emalloc_96() : (((path_len + 2) <= 112) ? _emalloc_112() : (((path_len + 2) <= 128) ? _emalloc_128() : (((path_len + 2) <= 160) ? _emalloc_160() : (((path_len + 2) <= 192) ? _emalloc_192() : (((path_len + 2) <= 224) ? _emalloc_224() : (((path_len + 2) <= 256) ? _emalloc_256() : (((path_len + 2) <= 320) ? _emalloc_320() : (((path_len + 2) <= 384) ? _emalloc_384() : (((path_len + 2) <= 448) ? _emalloc_448() : (((path_len + 2) <= 512) ? _emalloc_512() : (((path_len + 2) <= 640) ? _emalloc_640() : (((path_len + 2) <= 768) ? _emalloc_768() : (((path_len + 2) <= 896) ? _emalloc_896() : (((path_len + 2) <= 1024) ? _emalloc_1024() : (((path_len + 2) <= 1280) ? _emalloc_1280() : (((path_len + 2) <= 1536) ? _emalloc_1536() : (((path_len + 2) <= 1792) ? _emalloc_1792() : (((path_len + 2) <= 2048) ? _emalloc_2048() : (((path_len + 2) <= 2560) ? _emalloc_2560() : (((path_len + 2) <= 3072) ? _emalloc_3072() : (((path_len + 2) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((path_len + 2)) : _emalloc_huge((path_len + 2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((path_len + 2) ) );
...
static const zend_internal_arg_info arginfo_dl[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "extension_filename", ((void *)0), 0, 0, 0, 0 },
};


static const zend_function_entry additional_functions[] = {
 { "dl", zif_dl, arginfo_dl, (uint32_t) (sizeof(arginfo_dl)/sizeof(struct _zend_internal_arg_info)-1), 0 },
...
# 1171 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
  if ((php_cgi_globals.fix_pathinfo)) {
   ...
   if (!env_document_root && (core_globals.doc_root)) {
    env_document_root = ((has_env) ? fcgi_quick_putenv(request, "DOCUMENT_ROOT", sizeof("DOCUMENT_ROOT")-1, (__builtin_expect(!!(sizeof("DOCUMENT_ROOT")-1 < 3), 0) ? sizeof("DOCUMENT_ROOT")-1 : (((unsigned int)"DOCUMENT_ROOT"[3]) << 2) + (((unsigned int)"DOCUMENT_ROOT"[sizeof("DOCUMENT_ROOT")-1 -2]) << 4) + (((unsigned int)"DOCUMENT_ROOT"[sizeof("DOCUMENT_ROOT")-1 -1]) << 2) + sizeof("DOCUMENT_ROOT")-1), (core_globals.doc_root)) : _sapi_cgi_putenv("DOCUMENT_ROOT", sizeof("DOCUMENT_ROOT")-1, (core_globals.doc_root)));
...
# 1212 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
   if (script_path_translated &&
...
# 1242 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
      ...
      if (orig_path_info != path_info) {
       if (orig_path_info) {
        ...
        ((has_env) ? fcgi_quick_putenv(request, "ORIG_PATH_INFO", sizeof("ORIG_PATH_INFO")-1, (__builtin_expect(!!(sizeof("ORIG_PATH_INFO")-1 < 3), 0) ? sizeof("ORIG_PATH_INFO")-1 : (((unsigned int)"ORIG_PATH_INFO"[3]) << 2) + (((unsigned int)"ORIG_PATH_INFO"[sizeof("ORIG_PATH_INFO")-1 -2]) << 4) + (((unsigned int)"ORIG_PATH_INFO"[sizeof("ORIG_PATH_INFO")-1 -1]) << 2) + sizeof("ORIG_PATH_INFO")-1), orig_path_info) : _sapi_cgi_putenv("ORIG_PATH_INFO", sizeof("ORIG_PATH_INFO")-1, orig_path_info));
        old = path_info[0];
        path_info[0] = 0;
        if (!orig_script_name ||
         strcmp(orig_script_name, env_path_info) != 0) {
         if (orig_script_name) {
          ((has_env) ? fcgi_quick_putenv(request, "ORIG_SCRIPT_NAME", sizeof("ORIG_SCRIPT_NAME")-1, (__builtin_expect(!!(sizeof("ORIG_SCRIPT_NAME")-1 < 3), 0) ? sizeof("ORIG_SCRIPT_NAME")-1 : (((unsigned int)"ORIG_SCRIPT_NAME"[3]) << 2) + (((unsigned int)"ORIG_SCRIPT_NAME"[sizeof("ORIG_SCRIPT_NAME")-1 -2]) << 4) + (((unsigned int)"ORIG_SCRIPT_NAME"[sizeof("ORIG_SCRIPT_NAME")-1 -1]) << 2) + sizeof("ORIG_SCRIPT_NAME")-1), orig_script_name) : _sapi_cgi_putenv("ORIG_SCRIPT_NAME", sizeof("ORIG_SCRIPT_NAME")-1, orig_script_name));
         }
         (sapi_globals.request_info).request_uri = ((has_env) ? fcgi_quick_putenv(request, "SCRIPT_NAME", sizeof("SCRIPT_NAME")-1, (__builtin_expect(!!(sizeof("SCRIPT_NAME")-1 < 3), 0) ? sizeof("SCRIPT_NAME")-1 : (((unsigned int)"SCRIPT_NAME"[3]) << 2) + (((unsigned int)"SCRIPT_NAME"[sizeof("SCRIPT_NAME")-1 -2]) << 4) + (((unsigned int)"SCRIPT_NAME"[sizeof("SCRIPT_NAME")-1 -1]) << 2) + sizeof("SCRIPT_NAME")-1), env_path_info) : _sapi_cgi_putenv("SCRIPT_NAME", sizeof("SCRIPT_NAME")-1, env_path_info));
        } else {
         (sapi_globals.request_info).request_uri = orig_script_name;
        }
        path_info[0] = old;
       }
       env_path_info = ((has_env) ? fcgi_quick_putenv(request, "PATH_INFO", sizeof("PATH_INFO")-1, (__builtin_expect(!!(sizeof("PATH_INFO")-1 < 3), 0) ? sizeof("PATH_INFO")-1 : (((unsigned int)"PATH_INFO"[3]) << 2) + (((unsigned int)"PATH_INFO"[sizeof("PATH_INFO")-1 -2]) << 4) + (((unsigned int)"PATH_INFO"[sizeof("PATH_INFO")-1 -1]) << 2) + sizeof("PATH_INFO")-1), path_info) : _sapi_cgi_putenv("PATH_INFO", sizeof("PATH_INFO")-1, path_info));
      }
      if (!orig_script_filename ||
       strcmp(orig_script_filename, pt) != 0) {
       if (orig_script_filename) {
        ((has_env) ? fcgi_quick_putenv(request, "ORIG_SCRIPT_FILENAME", sizeof("ORIG_SCRIPT_FILENAME")-1, (__builtin_expect(!!(sizeof("ORIG_SCRIPT_FILENAME")-1 < 3), 0) ? sizeof("ORIG_SCRIPT_FILENAME")-1 : (((unsigned int)"ORIG_SCRIPT_FILENAME"[3]) << 2) + (((unsigned int)"ORIG_SCRIPT_FILENAME"[sizeof("ORIG_SCRIPT_FILENAME")-1 -2]) << 4) + (((unsigned int)"ORIG_SCRIPT_FILENAME"[sizeof("ORIG_SCRIPT_FILENAME")-1 -1]) << 2) + sizeof("ORIG_SCRIPT_FILENAME")-1), orig_script_filename) : _sapi_cgi_putenv("ORIG_SCRIPT_FILENAME", sizeof("ORIG_SCRIPT_FILENAME")-1, orig_script_filename));
       }
       script_path_translated = ((has_env) ? fcgi_quick_putenv(request, "SCRIPT_FILENAME", sizeof("SCRIPT_FILENAME")-1, (__builtin_expect(!!(sizeof("SCRIPT_FILENAME")-1 < 3), 0) ? sizeof("SCRIPT_FILENAME")-1 : (((unsigned int)"SCRIPT_FILENAME"[3]) << 2) + (((unsigned int)"SCRIPT_FILENAME"[sizeof("SCRIPT_FILENAME")-1 -2]) << 4) + (((unsigned int)"SCRIPT_FILENAME"[sizeof("SCRIPT_FILENAME")-1 -1]) << 2) + sizeof("SCRIPT_FILENAME")-1), pt) : _sapi_cgi_putenv("SCRIPT_FILENAME", sizeof("SCRIPT_FILENAME")-1, pt));
      }
      ;
      ...
      if (env_document_root) {
       ...
       path_translated = (char *) (__builtin_constant_p((path_translated_len + 1) ) ? (((path_translated_len + 1) <= 8) ? _emalloc_8() : (((path_translated_len + 1) <= 16) ? _emalloc_16() : (((path_translated_len + 1) <= 24) ? _emalloc_24() : (((path_translated_len + 1) <= 32) ? _emalloc_32() : (((path_translated_len + 1) <= 40) ? _emalloc_40() : (((path_translated_len + 1) <= 48) ? _emalloc_48() : (((path_translated_len + 1) <= 56) ? _emalloc_56() : (((path_translated_len + 1) <= 64) ? _emalloc_64() : (((path_translated_len + 1) <= 80) ? _emalloc_80() : (((path_translated_len + 1) <= 96) ? _emalloc_96() : (((path_translated_len + 1) <= 112) ? _emalloc_112() : (((path_translated_len + 1) <= 128) ? _emalloc_128() : (((path_translated_len + 1) <= 160) ? _emalloc_160() : (((path_translated_len + 1) <= 192) ? _emalloc_192() : (((path_translated_len + 1) <= 224) ? _emalloc_224() : (((path_translated_len + 1) <= 256) ? _emalloc_256() : (((path_translated_len + 1) <= 320) ? _emalloc_320() : (((path_translated_len + 1) <= 384) ? _emalloc_384() : (((path_translated_len + 1) <= 448) ? _emalloc_448() : (((path_translated_len + 1) <= 512) ? _emalloc_512() : (((path_translated_len + 1) <= 640) ? _emalloc_640() : (((path_translated_len + 1) <= 768) ? _emalloc_768() : (((path_translated_len + 1) <= 896) ? _emalloc_896() : (((path_translated_len + 1) <= 1024) ? _emalloc_1024() : (((path_translated_len + 1) <= 1280) ? _emalloc_1280() : (((path_translated_len + 1) <= 1536) ? _emalloc_1536() : (((path_translated_len + 1) <= 1792) ? _emalloc_1792() : (((path_translated_len + 1) <= 2048) ? _emalloc_2048() : (((path_translated_len + 1) <= 2560) ? _emalloc_2560() : (((path_translated_len + 1) <= 3072) ? _emalloc_3072() : (((path_translated_len + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((path_translated_len + 1)) : _emalloc_huge((path_translated_len + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((path_translated_len + 1) ) );
       ...
       if (orig_path_translated) {
        ((has_env) ? fcgi_quick_putenv(request, "ORIG_PATH_TRANSLATED", sizeof("ORIG_PATH_TRANSLATED")-1, (__builtin_expect(!!(sizeof("ORIG_PATH_TRANSLATED")-1 < 3), 0) ? sizeof("ORIG_PATH_TRANSLATED")-1 : (((unsigned int)"ORIG_PATH_TRANSLATED"[3]) << 2) + (((unsigned int)"ORIG_PATH_TRANSLATED"[sizeof("ORIG_PATH_TRANSLATED")-1 -2]) << 4) + (((unsigned int)"ORIG_PATH_TRANSLATED"[sizeof("ORIG_PATH_TRANSLATED")-1 -1]) << 2) + sizeof("ORIG_PATH_TRANSLATED")-1), orig_path_translated) : _sapi_cgi_putenv("ORIG_PATH_TRANSLATED", sizeof("ORIG_PATH_TRANSLATED")-1, orig_path_translated));
       }
       env_path_translated = ((has_env) ? fcgi_quick_putenv(request, "PATH_TRANSLATED", sizeof("PATH_TRANSLATED")-1, (__builtin_expect(!!(sizeof("PATH_TRANSLATED")-1 < 3), 0) ? sizeof("PATH_TRANSLATED")-1 : (((unsigned int)"PATH_TRANSLATED"[3]) << 2) + (((unsigned int)"PATH_TRANSLATED"[sizeof("PATH_TRANSLATED")-1 -2]) << 4) + (((unsigned int)"PATH_TRANSLATED"[sizeof("PATH_TRANSLATED")-1 -1]) << 2) + sizeof("PATH_TRANSLATED")-1), path_translated) : _sapi_cgi_putenv("PATH_TRANSLATED", sizeof("PATH_TRANSLATED")-1, path_translated));
    ...
    if (!ptr) {
     ...
     script_path_translated = ((has_env) ? fcgi_quick_putenv(request, "SCRIPT_FILENAME", sizeof("SCRIPT_FILENAME")-1, (__builtin_expect(!!(sizeof("SCRIPT_FILENAME")-1 < 3), 0) ? sizeof("SCRIPT_FILENAME")-1 : (((unsigned int)"SCRIPT_FILENAME"[3]) << 2) + (((unsigned int)"SCRIPT_FILENAME"[sizeof("SCRIPT_FILENAME")-1 -2]) << 4) + (((unsigned int)"SCRIPT_FILENAME"[sizeof("SCRIPT_FILENAME")-1 -1]) << 2) + sizeof("SCRIPT_FILENAME")-1), ((void *)0)) : _sapi_cgi_putenv("SCRIPT_FILENAME", sizeof("SCRIPT_FILENAME")-1, ((void *)0)));
    ...
    if (!(sapi_globals.request_info).request_uri) {
     if (!orig_script_name ||
      ...
      (sapi_globals.request_info).request_uri = ((has_env) ? fcgi_quick_putenv(request, "SCRIPT_NAME", sizeof("SCRIPT_NAME")-1, (__builtin_expect(!!(sizeof("SCRIPT_NAME")-1 < 3), 0) ? sizeof("SCRIPT_NAME")-1 : (((unsigned int)"SCRIPT_NAME"[3]) << 2) + (((unsigned int)"SCRIPT_NAME"[sizeof("SCRIPT_NAME")-1 -2]) << 4) + (((unsigned int)"SCRIPT_NAME"[sizeof("SCRIPT_NAME")-1 -1]) << 2) + sizeof("SCRIPT_NAME")-1), env_script_name) : _sapi_cgi_putenv("SCRIPT_NAME", sizeof("SCRIPT_NAME")-1, env_script_name));
     } else {
      (sapi_globals.request_info).request_uri = orig_script_name;
     }
    }
    ...
    if (!orig_script_filename ||
     ...
     script_path_translated = ((has_env) ? fcgi_quick_putenv(request, "SCRIPT_FILENAME", sizeof("SCRIPT_FILENAME")-1, (__builtin_expect(!!(sizeof("SCRIPT_FILENAME")-1 < 3), 0) ? sizeof("SCRIPT_FILENAME")-1 : (((unsigned int)"SCRIPT_FILENAME"[3]) << 2) + (((unsigned int)"SCRIPT_FILENAME"[sizeof("SCRIPT_FILENAME")-1 -2]) << 4) + (((unsigned int)"SCRIPT_FILENAME"[sizeof("SCRIPT_FILENAME")-1 -1]) << 2) + sizeof("SCRIPT_FILENAME")-1), script_path_translated) : _sapi_cgi_putenv("SCRIPT_FILENAME", sizeof("SCRIPT_FILENAME")-1, script_path_translated));
    }
    if (env_redirect_url) {
     if (orig_path_info) {
      ((has_env) ? fcgi_quick_putenv(request, "ORIG_PATH_INFO", sizeof("ORIG_PATH_INFO")-1, (__builtin_expect(!!(sizeof("ORIG_PATH_INFO")-1 < 3), 0) ? sizeof("ORIG_PATH_INFO")-1 : (((unsigned int)"ORIG_PATH_INFO"[3]) << 2) + (((unsigned int)"ORIG_PATH_INFO"[sizeof("ORIG_PATH_INFO")-1 -2]) << 4) + (((unsigned int)"ORIG_PATH_INFO"[sizeof("ORIG_PATH_INFO")-1 -1]) << 2) + sizeof("ORIG_PATH_INFO")-1), orig_path_info) : _sapi_cgi_putenv("ORIG_PATH_INFO", sizeof("ORIG_PATH_INFO")-1, orig_path_info));
      ((has_env) ? fcgi_quick_putenv(request, "PATH_INFO", sizeof("PATH_INFO")-1, (__builtin_expect(!!(sizeof("PATH_INFO")-1 < 3), 0) ? sizeof("PATH_INFO")-1 : (((unsigned int)"PATH_INFO"[3]) << 2) + (((unsigned int)"PATH_INFO"[sizeof("PATH_INFO")-1 -2]) << 4) + (((unsigned int)"PATH_INFO"[sizeof("PATH_INFO")-1 -1]) << 2) + sizeof("PATH_INFO")-1), ((void *)0)) : _sapi_cgi_putenv("PATH_INFO", sizeof("PATH_INFO")-1, ((void *)0)));
     }
     if (orig_path_translated) {
      ((has_env) ? fcgi_quick_putenv(request, "ORIG_PATH_TRANSLATED", sizeof("ORIG_PATH_TRANSLATED")-1, (__builtin_expect(!!(sizeof("ORIG_PATH_TRANSLATED")-1 < 3), 0) ? sizeof("ORIG_PATH_TRANSLATED")-1 : (((unsigned int)"ORIG_PATH_TRANSLATED"[3]) << 2) + (((unsigned int)"ORIG_PATH_TRANSLATED"[sizeof("ORIG_PATH_TRANSLATED")-1 -2]) << 4) + (((unsigned int)"ORIG_PATH_TRANSLATED"[sizeof("ORIG_PATH_TRANSLATED")-1 -1]) << 2) + sizeof("ORIG_PATH_TRANSLATED")-1), orig_path_translated) : _sapi_cgi_putenv("ORIG_PATH_TRANSLATED", sizeof("ORIG_PATH_TRANSLATED")-1, orig_path_translated));
      ((has_env) ? fcgi_quick_putenv(request, "PATH_TRANSLATED", sizeof("PATH_TRANSLATED")-1, (__builtin_expect(!!(sizeof("PATH_TRANSLATED")-1 < 3), 0) ? sizeof("PATH_TRANSLATED")-1 : (((unsigned int)"PATH_TRANSLATED"[3]) << 2) + (((unsigned int)"PATH_TRANSLATED"[sizeof("PATH_TRANSLATED")-1 -2]) << 4) + (((unsigned int)"PATH_TRANSLATED"[sizeof("PATH_TRANSLATED")-1 -1]) << 2) + sizeof("PATH_TRANSLATED")-1), ((void *)0)) : _sapi_cgi_putenv("PATH_TRANSLATED", sizeof("PATH_TRANSLATED")-1, ((void *)0)));
     }
    }
...
static const zend_ini_entry_def ini_entries[] = {
 { "cgi.rfc2616_headers", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->rfc2616_headers))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "0", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("cgi.rfc2616_headers")-1, sizeof("0")-1 },
 { "cgi.nph", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->nph))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "0", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("cgi.nph")-1, sizeof("0")-1 },
 { "cgi.check_shebang_line", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->check_shebang_line))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("cgi.check_shebang_line")-1, sizeof("1")-1 },
 { "cgi.force_redirect", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->force_redirect))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("cgi.force_redirect")-1, sizeof("1")-1 },
 { "cgi.redirect_status_env", OnUpdateString, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->redirect_status_env))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), ((void *)0), ((void *)0), (1<<2), sizeof("cgi.redirect_status_env")-1, sizeof(((void *)0))-1 },
 { "cgi.fix_pathinfo", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->fix_pathinfo))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("cgi.fix_pathinfo")-1, sizeof("1")-1 },
 { "cgi.discard_path", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->discard_path))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "0", ((void *)0), (1<<2), sizeof("cgi.discard_path")-1, sizeof("0")-1 },
 { "fastcgi.logging", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((php_cgi_globals_struct*)((void *)0))->fcgi_logging))) - ((char *) ((void *)0)))), (void *) &php_cgi_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("fastcgi.logging")-1, sizeof("1")-1 },
...
static void php_cgi_globals_ctor(php_cgi_globals_struct *php_cgi_globals)
{
 ...
 _zend_hash_init((&php_cgi_globals->user_config_cache), (8), (user_config_cache_entry_dtor), (1) );
}
...
void zif_apache_child_terminate(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, ""))) {
  return;
 }
 if (fcgi_is_fastcgi()) {
  fcgi_terminate();
...
const zend_function_entry cgi_functions[] = {
 { "apache_child_terminate", zif_apache_child_terminate, arginfo_no_args, (uint32_t) (sizeof(arginfo_no_args)/sizeof(struct _zend_internal_arg_info)-1), 0 },
...
int main(int argc, char *argv[])
{
 ...
 int skip_getopt = 0;
# 1760 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
 signal(13, ((__sighandler_t) 1));
# 1782 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
...
# 1796 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
 if (!fastcgi) {
 ...
 if((query_string = getenv("QUERY_STRING")) != ((void *)0) && strchr(query_string, '=') == ((void *)0)) {
...
# 1942 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
   return FAILURE;
  }
 }
 ...
 if (fastcgi) {
  ...
  request = fcgi_init_request(fcgi_fd, ((void *)0), ((void *)0), ((void *)0));
 ...
 (executor_globals.bailout)=((void *)0); { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  ...
  php_optind = orig_optind;
  php_optarg = orig_optarg;
# 2133 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
    ...
    while ((c = php_getopt(argc, argv, OPTIONS, &php_optarg, &php_optind, 0, 2)) != -1) {
     switch (c) {
      ...
      case 'v':
       ...
       php_printf("PHP %s (%s) (built: %s %s)\nCopyright (c) 1997-2016 The PHP Group\n%s", "7.0.5-dev", sapi_module.name, "Aug  7 2016", "13:50:19", get_zend_version());
...
# 2273 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
    if (!(sapi_globals.request_info).query_string && argc > php_optind) {
     size_t slen = strlen((core_globals.arg_separator).input);
     len = 0;
   ...
   if (cgi || fastcgi || (sapi_globals.request_info).path_translated) {
    if (php_fopen_primary_script(&file_handle) == FAILURE) {
     ...
     if ((sapi_globals.request_info).path_translated) {
      _efree(((sapi_globals.request_info).path_translated) );
      (sapi_globals.request_info).path_translated = ((void *)0);
     }
      ...
      if (c == '#') {
       ...
       if (c == '\r') {
        if (fgetc(file_handle.handle.fp) != '\n') {
         zend_long pos = ftell(file_handle.handle.fp);
      ...
      if (c == '#') {
       ...
       if (c == '\r') {
        if (_php_stream_getc(((php_stream*)file_handle.handle.stream.handle)) != '\n') {
         zend_off_t pos = _php_stream_tell(((php_stream*)file_handle.handle.stream.handle));
...
parent_out:
 ...
 php_module_shutdown();
 sapi_shutdown();
# 2603 "/home/ct584/git/bughunter/repositories/php-src/sapi/cgi/cgi_main.c"
 return exit_status;
}
