# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.h" 1
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c" 2
...
__attribute__ ((visibility("default"))) void pdo_handle_error(pdo_dbh_t *dbh, pdo_stmt_t *stmt)
{
 ...
 if (dbh->methods->fetch_err) {
  ...
  if (dbh->methods->fetch_err(dbh, stmt, &info)) {
   ...
   if ((item = zend_hash_index_find((info).value.arr, 1)) != ((void *)0)) {
    native_code = (*(item)).value.lval;
   }

   if ((item = zend_hash_index_find((info).value.arr, 2)) != ((void *)0)) {
...
static void zim_PDO_dbh_constructor(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (FAILURE == zend_parse_parameters_throw((execute_data)->This.u2.num_args,
 ...
 if (options) {
  ...
  if ((v = zend_hash_index_find((*(options)).value.arr, PDO_ATTR_PERSISTENT)) != ((void *)0)) {
   if (zval_get_type(&(*(v))) == 6 &&
    ...
    is_persistent = _zval_get_long((v)) ? 1 : 0;
  ...
  if (is_persistent) {
   ...
   if (pdbh) {
    ...
    pdbh->persistent_id = ((1)?__zend_malloc(plen + 1):(__builtin_constant_p((plen + 1) ) ? (((plen + 1) <= 8) ? _emalloc_8() : (((plen + 1) <= 16) ? _emalloc_16() : (((plen + 1) <= 24) ? _emalloc_24() : (((plen + 1) <= 32) ? _emalloc_32() : (((plen + 1) <= 40) ? _emalloc_40() : (((plen + 1) <= 48) ? _emalloc_48() : (((plen + 1) <= 56) ? _emalloc_56() : (((plen + 1) <= 64) ? _emalloc_64() : (((plen + 1) <= 80) ? _emalloc_80() : (((plen + 1) <= 96) ? _emalloc_96() : (((plen + 1) <= 112) ? _emalloc_112() : (((plen + 1) <= 128) ? _emalloc_128() : (((plen + 1) <= 160) ? _emalloc_160() : (((plen + 1) <= 192) ? _emalloc_192() : (((plen + 1) <= 224) ? _emalloc_224() : (((plen + 1) <= 256) ? _emalloc_256() : (((plen + 1) <= 320) ? _emalloc_320() : (((plen + 1) <= 384) ? _emalloc_384() : (((plen + 1) <= 448) ? _emalloc_448() : (((plen + 1) <= 512) ? _emalloc_512() : (((plen + 1) <= 640) ? _emalloc_640() : (((plen + 1) <= 768) ? _emalloc_768() : (((plen + 1) <= 896) ? _emalloc_896() : (((plen + 1) <= 1024) ? _emalloc_1024() : (((plen + 1) <= 1280) ? _emalloc_1280() : (((plen + 1) <= 1536) ? _emalloc_1536() : (((plen + 1) <= 1792) ? _emalloc_1792() : (((plen + 1) <= 2048) ? _emalloc_2048() : (((plen + 1) <= 2560) ? _emalloc_2560() : (((plen + 1) <= 3072) ? _emalloc_3072() : (((plen + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((plen + 1)) : _emalloc_huge((plen + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((plen + 1) ) ));
 ...
 if (call_factory) {
  ...
  dbh->data_source = (const char*)((is_persistent)?strdup(colon + 1):_estrdup((colon + 1) ));
  dbh->username = username ? ((is_persistent)?strdup(username):_estrdup((username) )) : ((void *)0);
  dbh->password = password ? ((is_persistent)?strdup(password):_estrdup((password) )) : ((void *)0);
...
options:
  if (options) {
   ...
   do { Bucket *_p = ((*(options)).value.arr)->arData; Bucket *_end = _p + ((*(options)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; long_key = _p->h; str_key = _p->key; attr_value = _z; {
    if (str_key) {
     continue;
    }
...
static zval *pdo_stmt_instantiate(pdo_dbh_t *dbh, zval *object, zend_class_entry *dbstmt_ce, zval *ctor_args)
{
 ...
 if (__builtin_expect(!!(_object_init_ex((object), (dbstmt_ce) ) != SUCCESS), 0)) {
  return ((void *)0);
 }
...
static void pdo_stmt_construct(zend_execute_data *execute_data, pdo_stmt_t *stmt, zval *object, zend_class_entry *dbstmt_ce, zval *ctor_args)
{
 ...
 do { do { zval *__z = (&query_string); zend_string *__s = (zend_string_init(stmt->query_string, stmt->query_stringlen, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 do { do { zval *__z = (&z_key); zend_string *__s = (zend_string_init("queryString", sizeof("queryString") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 std_object_handlers.write_property(object, &z_key, &query_string, ((void *)0));
...
static void zim_PDO_prepare(zend_execute_data *execute_data, zval *return_value)
{
 pdo_stmt_t *stmt;
 char *statement;
 ...
 pdo_dbh_object_t *dbh_obj = php_pdo_dbh_fetch_object((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 pdo_dbh_t *dbh = dbh_obj->inner;

 if (FAILURE == zend_parse_parameters((execute_data)->This.u2.num_args, "s|a", &statement,
 ...
 if ((execute_data)->This.u2.num_args > 1 && (opt = zend_hash_index_find((*(options)).value.arr, PDO_ATTR_STATEMENT_CLASS)) != ((void *)0)) {
  if (zval_get_type(&(*(opt))) != 7 || (item = zend_hash_index_find((*(opt)).value.arr, 0)) == ((void *)0)
   ...
   if (strcmp(dbh->error_code, "00000")) { pdo_handle_error(dbh, ((void *)0)); };
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
  dbstmt_ce = pce;
  ...
  if ((item = zend_hash_index_find((*(opt)).value.arr, 1)) != ((void *)0)) {
   ...
   do { zval *_z1 = (&ctor_args); const zval *_z2 = (item); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  } else {
   do { (*(&ctor_args)).u1.type_info = 0; } while (0);
  }
 } else {
  dbstmt_ce = dbh->def_stmt_ce;
  do { zval *_z1 = (&ctor_args); const zval *_z2 = (&dbh->def_stmt_ctor_args); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }
 ...
 do { zval *__z = (&stmt->database_object_handle); (*(__z)).value.obj = (&dbh_obj->std); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
...
static void zim_PDO_beginTransaction(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
static void zim_PDO_commit(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
static void zim_PDO_rollBack(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
static void zim_PDO_inTransaction(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
{
 zend_long lval;
# 679 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
 switch (attr) {
  case PDO_ATTR_ERRMODE:
   if (zval_get_type(&(*(value))) != 4 && zval_get_type(&(*(value))) != 6 && zval_get_type(&(*(value))) != 2 && zval_get_type(&(*(value))) != 3) { pdo_raise_impl_error(dbh, ((void *)0), "HY000", "attribute value must be an integer"); if (strcmp(dbh->error_code, "00000")) { pdo_handle_error(dbh, ((void *)0)); }; return FAILURE; };
   lval = _zval_get_long((value));
   switch (lval) {
  ...
  case PDO_ATTR_ORACLE_NULLS:
   if (zval_get_type(&(*(value))) != 4 && zval_get_type(&(*(value))) != 6 && zval_get_type(&(*(value))) != 2 && zval_get_type(&(*(value))) != 3) { pdo_raise_impl_error(dbh, ((void *)0), "HY000", "attribute value must be an integer"); if (strcmp(dbh->error_code, "00000")) { pdo_handle_error(dbh, ((void *)0)); }; return FAILURE; };
   dbh->oracle_nulls = _zval_get_long((value));
   return SUCCESS;

  case PDO_ATTR_DEFAULT_FETCH_MODE:
   if (zval_get_type(&(*(value))) == 7) {
    zval *tmp;
    if ((tmp = zend_hash_index_find((*(value)).value.arr, 0)) != ((void *)0) && zval_get_type(&(*(tmp))) == 4) {
  ...
  case PDO_ATTR_STRINGIFY_FETCHES:
   if (zval_get_type(&(*(value))) != 4 && zval_get_type(&(*(value))) != 6 && zval_get_type(&(*(value))) != 2 && zval_get_type(&(*(value))) != 3) { pdo_raise_impl_error(dbh, ((void *)0), "HY000", "attribute value must be an integer"); if (strcmp(dbh->error_code, "00000")) { pdo_handle_error(dbh, ((void *)0)); }; return FAILURE; };
   dbh->stringify = _zval_get_long((value)) ? 1 : 0;
   return SUCCESS;
  ...
  case PDO_ATTR_STATEMENT_CLASS: {
   ...
   if (zval_get_type(&(*(value))) != 7
    || (item = zend_hash_index_find((*(value)).value.arr, 0)) == ((void *)0)
    || zval_get_type(&(*(item))) != 6
    || (pce = zend_lookup_class((*(item)).value.str)) == ((void *)0)
   ) {
    pdo_raise_impl_error(dbh, ((void *)0), "HY000",
   ...
   if ((item = zend_hash_index_find((*(value)).value.arr, 1)) != ((void *)0)) {
    if (zval_get_type(&(*(item))) != 7) {
     pdo_raise_impl_error(dbh, ((void *)0), "HY000",
      "PDO::ATTR_STATEMENT_CLASS requires format array(classname, array(ctor_args)); "
      "ctor_args must be an array"
    ...
    do { zval *_z1 = (&dbh->def_stmt_ctor_args); const zval *_z2 = (item); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   }
   return SUCCESS;
  }
...
static void zim_PDO_setAttribute(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_long attr;
 zval *value;
...
static void zim_PDO_getAttribute(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_long attr;
 ...
 switch (attr) {
  ...
  case PDO_ATTR_DRIVER_NAME:
   { do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init((char*)dbh->driver->driver_name, dbh->driver->driver_name_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); return; };

  case PDO_ATTR_STATEMENT_CLASS:
   _array_init((return_value), 0 );
   add_next_index_str(return_value, zend_string_copy(dbh->def_stmt_ce->name));
   if (!(zval_get_type(&(dbh->def_stmt_ctor_args)) == 0)) {
    if ((((dbh->def_stmt_ctor_args).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(&(dbh->def_stmt_ctor_args));
...
static void zim_PDO_exec(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 char *statement;
 size_t statement_len;
 ...
 if (FAILURE == zend_parse_parameters((execute_data)->This.u2.num_args, "s", &statement, &statement_len)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
static void zim_PDO_lastInsertId(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 char *name = ((void *)0);
 size_t namelen;

 if (FAILURE == zend_parse_parameters((execute_data)->This.u2.num_args, "|s!", &name, &namelen)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if (!dbh->methods->last_id) {
  ...
  if (!id) {
   ...
   do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(id, id_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
   _efree((id) );
  }
 }
}
...
static void zim_PDO_errorCode(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 if (dbh->query_stmt) {
  { do { const char *_s = (dbh->query_stmt->error_code); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 }
 ...
 { do { const char *_s = (dbh->error_code); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
}




static void zim_PDO_errorInfo(zend_execute_data *execute_data, zval *return_value)
{
 int error_count;
 ...
 if (dbh->query_stmt) {
  ...
  if(!strncmp(dbh->query_stmt->error_code, "00000", sizeof("00000"))) goto fill_array;
 } else {
  add_next_index_string(return_value, dbh->error_code);
  if(!strncmp(dbh->error_code, "00000", sizeof("00000"))) goto fill_array;
 }
...
static void zim_PDO_query(zend_execute_data *execute_data, zval *return_value)
{
 pdo_stmt_t *stmt;
 char *statement;
 size_t statement_len;
 ...
 if (dbh->methods->preparer(dbh, statement, statement_len, stmt, ((void *)0))) {
  ...
  if ((execute_data)->This.u2.num_args == 1 || SUCCESS == pdo_stmt_setup_fetch_mode(execute_data, return_value, stmt, 1)) {
  ...
  dbh->query_stmt = stmt;
  do { zval *_z1 = (&dbh->query_stmt_zval); const zval *_z2 = (return_value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  zval_delref_p(&(stmt->database_object_handle));
  do { (*(&stmt->database_object_handle)).u1.type_info = 0; } while (0);
...
static void zim_PDO_quote(zend_execute_data *execute_data, zval *return_value)
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 char *str;
 size_t str_len;
 ...
 if (FAILURE == zend_parse_parameters((execute_data)->This.u2.num_args, "s|l", &str, &str_len, &paramtype)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if (dbh->methods->quoter(dbh, str, str_len, &qstr, &qlen, paramtype)) {
  do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(qstr, qlen, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
  _efree((qstr) );
  return;
 }
 if (strcmp(dbh->error_code, "00000")) { pdo_handle_error(dbh, ((void *)0)); };
...
static void zim_PDO___wakeup(zend_execute_data *execute_data, zval *return_value)
{
...
static void zim_PDO___sleep(zend_execute_data *execute_data, zval *return_value)
{
 zend_throw_exception_ex(php_pdo_get_exception(), 0, "You cannot serialize or unserialize PDO instances");
}
...
static void zim_PDO_getAvailableDrivers(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { Bucket *_p = (&pdo_driver_hash)->arData; Bucket *_end = _p + (&pdo_driver_hash)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; pdriver = (*(_z)).value.ptr; {
...
static const zend_internal_arg_info arginfo_pdo___construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "dsn", ((void *)0), 0, 0, 0, 0 },
 { "username", ((void *)0), 0, 0, 0, 0 },
 { "passwd", ((void *)0), 0, 0, 0, 0 },
 { "options", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo_prepare[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "statement", ((void *)0), 0, 0, 0, 0 },
 { "options", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo_setattribute[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "attribute", ((void *)0), 0, 0, 0, 0 },
 { "value", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo_getattribute[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "attribute", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo_exec[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "query", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo_lastinsertid[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "seqname", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo_quote[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "string", ((void *)0), 0, 0, 0, 0 },
 { "paramtype", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_pdo__void[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};


const zend_function_entry pdo_dbh_functions[] = {
 { "__construct", zim_PDO_dbh_constructor, arginfo_pdo___construct, (uint32_t) (sizeof(arginfo_pdo___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "prepare", zim_PDO_prepare, arginfo_pdo_prepare, (uint32_t) (sizeof(arginfo_pdo_prepare)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "beginTransaction", zim_PDO_beginTransaction, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "commit", zim_PDO_commit, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rollBack", zim_PDO_rollBack, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "inTransaction", zim_PDO_inTransaction, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setAttribute", zim_PDO_setAttribute, arginfo_pdo_setattribute, (uint32_t) (sizeof(arginfo_pdo_setattribute)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "exec", zim_PDO_exec, arginfo_pdo_exec, (uint32_t) (sizeof(arginfo_pdo_exec)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "query", zim_PDO_query, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "lastInsertId", zim_PDO_lastInsertId, arginfo_pdo_lastinsertid, (uint32_t) (sizeof(arginfo_pdo_lastinsertid)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "errorCode", zim_PDO_errorCode, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "errorInfo", zim_PDO_errorInfo, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getAttribute", zim_PDO_getAttribute, arginfo_pdo_getattribute, (uint32_t) (sizeof(arginfo_pdo_getattribute)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "quote", zim_PDO_quote, arginfo_pdo_quote, (uint32_t) (sizeof(arginfo_pdo_quote)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__wakeup", zim_PDO___wakeup, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "__sleep", zim_PDO___sleep, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getAvailableDrivers", zim_PDO_getAvailableDrivers, arginfo_pdo__void, (uint32_t) (sizeof(arginfo_pdo__void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
...
int pdo_hash_methods(pdo_dbh_object_t *dbh_obj, int kind)
{
 ...
 while (funcs->fname) {
  ...
  func.prototype = ((void *)0);
  if (funcs->flags) {
   func.fn_flags = funcs->flags | 0x400000;
  } else {
   func.fn_flags = 0x100 | 0x400000;
  }
  if (funcs->arg_info) {
   ...
   if (info->return_reference) {
    func.fn_flags |= 0x4000000;
   }
   if (funcs->arg_info[funcs->num_args].is_variadic) {
    func.fn_flags |= 0x1000000;
  ...
  lc_name = (__builtin_constant_p((namelen+1) ) ? (((namelen+1) <= 8) ? _emalloc_8() : (((namelen+1) <= 16) ? _emalloc_16() : (((namelen+1) <= 24) ? _emalloc_24() : (((namelen+1) <= 32) ? _emalloc_32() : (((namelen+1) <= 40) ? _emalloc_40() : (((namelen+1) <= 48) ? _emalloc_48() : (((namelen+1) <= 56) ? _emalloc_56() : (((namelen+1) <= 64) ? _emalloc_64() : (((namelen+1) <= 80) ? _emalloc_80() : (((namelen+1) <= 96) ? _emalloc_96() : (((namelen+1) <= 112) ? _emalloc_112() : (((namelen+1) <= 128) ? _emalloc_128() : (((namelen+1) <= 160) ? _emalloc_160() : (((namelen+1) <= 192) ? _emalloc_192() : (((namelen+1) <= 224) ? _emalloc_224() : (((namelen+1) <= 256) ? _emalloc_256() : (((namelen+1) <= 320) ? _emalloc_320() : (((namelen+1) <= 384) ? _emalloc_384() : (((namelen+1) <= 448) ? _emalloc_448() : (((namelen+1) <= 512) ? _emalloc_512() : (((namelen+1) <= 640) ? _emalloc_640() : (((namelen+1) <= 768) ? _emalloc_768() : (((namelen+1) <= 896) ? _emalloc_896() : (((namelen+1) <= 1024) ? _emalloc_1024() : (((namelen+1) <= 1280) ? _emalloc_1280() : (((namelen+1) <= 1536) ? _emalloc_1536() : (((namelen+1) <= 1792) ? _emalloc_1792() : (((namelen+1) <= 2048) ? _emalloc_2048() : (((namelen+1) <= 2560) ? _emalloc_2560() : (((namelen+1) <= 3072) ? _emalloc_3072() : (((namelen+1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((namelen+1)) : _emalloc_huge((namelen+1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((namelen+1) ) );
...
{
 pdo_dbh_t *dbh = php_pdo_dbh_fetch_inner((*((object))).value.obj);
...
void pdo_dbh_init(void)
{
 ...
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_BOOL", sizeof("PARAM_BOOL")-1, (zend_long)(zend_long)PDO_PARAM_BOOL);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_NULL", sizeof("PARAM_NULL")-1, (zend_long)(zend_long)PDO_PARAM_NULL);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_INT", sizeof("PARAM_INT")-1, (zend_long)(zend_long)PDO_PARAM_INT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_STR", sizeof("PARAM_STR")-1, (zend_long)(zend_long)PDO_PARAM_STR);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_LOB", sizeof("PARAM_LOB")-1, (zend_long)(zend_long)PDO_PARAM_LOB);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_STMT", sizeof("PARAM_STMT")-1, (zend_long)(zend_long)PDO_PARAM_STMT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_INPUT_OUTPUT", sizeof("PARAM_INPUT_OUTPUT")-1, (zend_long)(zend_long)PDO_PARAM_INPUT_OUTPUT);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_ALLOC", sizeof("PARAM_EVT_ALLOC")-1, (zend_long)(zend_long)PDO_PARAM_EVT_ALLOC);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_FREE", sizeof("PARAM_EVT_FREE")-1, (zend_long)(zend_long)PDO_PARAM_EVT_FREE);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_EXEC_PRE", sizeof("PARAM_EVT_EXEC_PRE")-1, (zend_long)(zend_long)PDO_PARAM_EVT_EXEC_PRE);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_EXEC_POST", sizeof("PARAM_EVT_EXEC_POST")-1, (zend_long)(zend_long)PDO_PARAM_EVT_EXEC_POST);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_FETCH_PRE", sizeof("PARAM_EVT_FETCH_PRE")-1, (zend_long)(zend_long)PDO_PARAM_EVT_FETCH_PRE);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_FETCH_POST", sizeof("PARAM_EVT_FETCH_POST")-1, (zend_long)(zend_long)PDO_PARAM_EVT_FETCH_POST);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "PARAM_EVT_NORMALIZE", sizeof("PARAM_EVT_NORMALIZE")-1, (zend_long)(zend_long)PDO_PARAM_EVT_NORMALIZE);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_LAZY", sizeof("FETCH_LAZY")-1, (zend_long)(zend_long)PDO_FETCH_LAZY);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ASSOC", sizeof("FETCH_ASSOC")-1, (zend_long)(zend_long)PDO_FETCH_ASSOC);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_NUM", sizeof("FETCH_NUM")-1, (zend_long)(zend_long)PDO_FETCH_NUM);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_BOTH", sizeof("FETCH_BOTH")-1, (zend_long)(zend_long)PDO_FETCH_BOTH);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_OBJ", sizeof("FETCH_OBJ")-1, (zend_long)(zend_long)PDO_FETCH_OBJ);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_BOUND", sizeof("FETCH_BOUND")-1, (zend_long)(zend_long)PDO_FETCH_BOUND);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_COLUMN", sizeof("FETCH_COLUMN")-1, (zend_long)(zend_long)PDO_FETCH_COLUMN);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_CLASS", sizeof("FETCH_CLASS")-1, (zend_long)(zend_long)PDO_FETCH_CLASS);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_INTO", sizeof("FETCH_INTO")-1, (zend_long)(zend_long)PDO_FETCH_INTO);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_FUNC", sizeof("FETCH_FUNC")-1, (zend_long)(zend_long)PDO_FETCH_FUNC);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_GROUP", sizeof("FETCH_GROUP")-1, (zend_long)(zend_long)0x00010000);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_UNIQUE", sizeof("FETCH_UNIQUE")-1, (zend_long)(zend_long)0x00030000);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_KEY_PAIR", sizeof("FETCH_KEY_PAIR")-1, (zend_long)(zend_long)PDO_FETCH_KEY_PAIR);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_CLASSTYPE", sizeof("FETCH_CLASSTYPE")-1, (zend_long)(zend_long)0x00040000);;


 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_SERIALIZE", sizeof("FETCH_SERIALIZE")-1, (zend_long)(zend_long)0x00080000);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_PROPS_LATE", sizeof("FETCH_PROPS_LATE")-1, (zend_long)(zend_long)0x00100000);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_NAMED", sizeof("FETCH_NAMED")-1, (zend_long)(zend_long)PDO_FETCH_NAMED);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_AUTOCOMMIT", sizeof("ATTR_AUTOCOMMIT")-1, (zend_long)(zend_long)PDO_ATTR_AUTOCOMMIT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_PREFETCH", sizeof("ATTR_PREFETCH")-1, (zend_long)(zend_long)PDO_ATTR_PREFETCH);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_TIMEOUT", sizeof("ATTR_TIMEOUT")-1, (zend_long)(zend_long)PDO_ATTR_TIMEOUT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_ERRMODE", sizeof("ATTR_ERRMODE")-1, (zend_long)(zend_long)PDO_ATTR_ERRMODE);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_SERVER_VERSION", sizeof("ATTR_SERVER_VERSION")-1, (zend_long)(zend_long)PDO_ATTR_SERVER_VERSION);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_CLIENT_VERSION", sizeof("ATTR_CLIENT_VERSION")-1, (zend_long)(zend_long)PDO_ATTR_CLIENT_VERSION);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_SERVER_INFO", sizeof("ATTR_SERVER_INFO")-1, (zend_long)(zend_long)PDO_ATTR_SERVER_INFO);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_CONNECTION_STATUS", sizeof("ATTR_CONNECTION_STATUS")-1, (zend_long)(zend_long)PDO_ATTR_CONNECTION_STATUS);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_CASE", sizeof("ATTR_CASE")-1, (zend_long)(zend_long)PDO_ATTR_CASE);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_CURSOR_NAME", sizeof("ATTR_CURSOR_NAME")-1, (zend_long)(zend_long)PDO_ATTR_CURSOR_NAME);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_CURSOR", sizeof("ATTR_CURSOR")-1, (zend_long)(zend_long)PDO_ATTR_CURSOR);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_ORACLE_NULLS", sizeof("ATTR_ORACLE_NULLS")-1, (zend_long)(zend_long)PDO_ATTR_ORACLE_NULLS);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_PERSISTENT", sizeof("ATTR_PERSISTENT")-1, (zend_long)(zend_long)PDO_ATTR_PERSISTENT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_STATEMENT_CLASS", sizeof("ATTR_STATEMENT_CLASS")-1, (zend_long)(zend_long)PDO_ATTR_STATEMENT_CLASS);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_FETCH_TABLE_NAMES", sizeof("ATTR_FETCH_TABLE_NAMES")-1, (zend_long)(zend_long)PDO_ATTR_FETCH_TABLE_NAMES);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_FETCH_CATALOG_NAMES", sizeof("ATTR_FETCH_CATALOG_NAMES")-1, (zend_long)(zend_long)PDO_ATTR_FETCH_CATALOG_NAMES);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_DRIVER_NAME", sizeof("ATTR_DRIVER_NAME")-1, (zend_long)(zend_long)PDO_ATTR_DRIVER_NAME);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_STRINGIFY_FETCHES", sizeof("ATTR_STRINGIFY_FETCHES")-1, (zend_long)(zend_long)PDO_ATTR_STRINGIFY_FETCHES);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_MAX_COLUMN_LEN", sizeof("ATTR_MAX_COLUMN_LEN")-1, (zend_long)(zend_long)PDO_ATTR_MAX_COLUMN_LEN);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_EMULATE_PREPARES", sizeof("ATTR_EMULATE_PREPARES")-1, (zend_long)(zend_long)PDO_ATTR_EMULATE_PREPARES);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ATTR_DEFAULT_FETCH_MODE", sizeof("ATTR_DEFAULT_FETCH_MODE")-1, (zend_long)(zend_long)PDO_ATTR_DEFAULT_FETCH_MODE);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ERRMODE_SILENT", sizeof("ERRMODE_SILENT")-1, (zend_long)(zend_long)PDO_ERRMODE_SILENT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ERRMODE_WARNING", sizeof("ERRMODE_WARNING")-1, (zend_long)(zend_long)PDO_ERRMODE_WARNING);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "ERRMODE_EXCEPTION", sizeof("ERRMODE_EXCEPTION")-1, (zend_long)(zend_long)PDO_ERRMODE_EXCEPTION);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "CASE_NATURAL", sizeof("CASE_NATURAL")-1, (zend_long)(zend_long)PDO_CASE_NATURAL);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "CASE_LOWER", sizeof("CASE_LOWER")-1, (zend_long)(zend_long)PDO_CASE_LOWER);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "CASE_UPPER", sizeof("CASE_UPPER")-1, (zend_long)(zend_long)PDO_CASE_UPPER);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "NULL_NATURAL", sizeof("NULL_NATURAL")-1, (zend_long)(zend_long)PDO_NULL_NATURAL);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "NULL_EMPTY_STRING", sizeof("NULL_EMPTY_STRING")-1, (zend_long)(zend_long)PDO_NULL_EMPTY_STRING);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "NULL_TO_STRING", sizeof("NULL_TO_STRING")-1, (zend_long)(zend_long)PDO_NULL_TO_STRING);;

 zend_declare_class_constant_stringl(php_pdo_get_dbh_ce(), "ERR_NONE", sizeof("ERR_NONE")-1, "00000", sizeof("00000")-1);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ORI_NEXT", sizeof("FETCH_ORI_NEXT")-1, (zend_long)(zend_long)PDO_FETCH_ORI_NEXT);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ORI_PRIOR", sizeof("FETCH_ORI_PRIOR")-1, (zend_long)(zend_long)PDO_FETCH_ORI_PRIOR);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ORI_FIRST", sizeof("FETCH_ORI_FIRST")-1, (zend_long)(zend_long)PDO_FETCH_ORI_FIRST);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ORI_LAST", sizeof("FETCH_ORI_LAST")-1, (zend_long)(zend_long)PDO_FETCH_ORI_LAST);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ORI_ABS", sizeof("FETCH_ORI_ABS")-1, (zend_long)(zend_long)PDO_FETCH_ORI_ABS);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "FETCH_ORI_REL", sizeof("FETCH_ORI_REL")-1, (zend_long)(zend_long)PDO_FETCH_ORI_REL);;

 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "CURSOR_FWDONLY", sizeof("CURSOR_FWDONLY")-1, (zend_long)(zend_long)PDO_CURSOR_FWDONLY);;
 zend_declare_class_constant_long(php_pdo_get_dbh_ce(), "CURSOR_SCROLL", sizeof("CURSOR_SCROLL")-1, (zend_long)(zend_long)PDO_CURSOR_SCROLL);;
# 1500 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
}
...
zend_object *pdo_dbh_new(zend_class_entry *ce)
{
 ...
 dbh = _ecalloc((1), (sizeof(pdo_dbh_object_t) + zend_object_properties_size(ce)) );
