...
# 2526 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h"
...
# 2527 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h" 2
# 2542 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h"
...
# 2543 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h" 2
# 2553 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h"
...
# 2554 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h" 2
...
# 54 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
...
# 115 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
...
static void _default_get_entry(zval *object, char *name, int name_len, zval *return_value )
{
 ...
 if (zend_hash_find(((*object)).value.obj.handlers->get_properties(&(*object) ), name, name_len, (void **) &value) == FAILURE) {
...
# 245 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
 ...
 *value = **p;
 if ((*value).type == 4) {
  ...
  _zend_hash_init((ht), (zend_hash_num_elements((*value).value.ht)), ((void (*)(void *)) _zval_ptr_dtor), (0) );
  zend_hash_copy(ht, (*value).value.ht, (copy_ctor_func_t) reflection_zval_deep_copy, ((void *)0), sizeof(zval *));
  (*value).value.ht = ht;
 } else {
   ...
   while (zend_hash_get_current_data_ex(properties, (void **) &prop, &pos) == SUCCESS) {
    ...
    if (zend_hash_get_current_key_ex(properties, &prop_name, &prop_name_size, &index, 1, &pos) == 1) {
     if (prop_name_size && prop_name[0]) {
      if (!zend_hash_quick_exists(&ce->properties_info, prop_name, prop_name_size, zend_hash_func(prop_name, prop_name_size))) {
       count++;
...
static zend_op* _get_recv_op(zend_op_array *op_array, zend_uint offset)
{
 ...
 while (op < end) {
  if ((op->opcode == 63 || op->opcode == 64
      || op->opcode == 164) && op->op1.num == (long)offset)
  {
   return op;
  }
  ++op;
...
static void _parameter_string(string *str, zend_function *fptr, struct _zend_arg_info *arg_info, zend_uint offset, zend_uint required, char* indent )
{
 ...
 if (fptr->type == 2 && offset >= required) {
  ...
  if (precv && precv->opcode == 64 && precv->op2_type != (1<<3)) {
   ...
   string_write(str, " = ", sizeof(" = ")-1);
   if (((((*precv->op2.zv).type) & 0x00f) >= 8 && (((*precv->op2.zv).type) & 0x00f) <= 9)) {
...
static void _property_string(string *str, zend_property_info *prop, char *prop_name, char* indent )
{
 ...
 if (!prop) {
  ...
  zend_unmangle_property_name_ex(prop->name, prop->name_length, &class_name, (const char**)&prop_name, ((void *)0));
...
static void _extension_string(string *str, zend_module_entry *module, char *indent )
{
...

 {
  ...
  while (zend_hash_get_current_data_ex((compiler_globals.function_table), (void **) &fptr, &iterator) == SUCCESS) {
...
static void reflection_method_factory(zend_class_entry *ce, zend_function *method, zval *closure_object, zval *object )
{
 ...
 do { const char *__s=((method->common.scope && method->common.scope->trait_aliases)? zend_resolve_method_name(ce, method) : method->common.function_name); zval *__z = (name); (*__z).value.str.len = strlen(__s); (*__z).value.str.val = (1?_estrndup((__s), ((*__z).value.str.len) ):(char*)__s); (*__z).type = 6; } while (0)
                                                                          ;
...
static void reflection_property_factory(zend_class_entry *ce, zend_property_info *prop, zval *object )
{
 ...
 zend_unmangle_property_name_ex(prop->name, prop->name_length, &class_name, &prop_name, ((void *)0));
...
static void _reflection_export(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , zend_class_entry *ce_ptr, int ctor_argc)
{
 ...
 if (ctor_argc == 1) {
  if (zend_parse_parameters((ht) , "z|b", &argument_ptr, &return_output) == FAILURE) {
   return;
  }
 } else {
  if (zend_parse_parameters((ht) , "zz|b", &argument_ptr, &argument2_ptr, &return_output) == FAILURE) {
   return;
  }
 }
 ...
 if (_object_and_properties_init((reflector_ptr), (ce_ptr), (((void *)0)) ) == FAILURE) {
...
static parameter_reference *_reflection_param_get_default_param(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 reflection_object *intern;
 ...
 if (intern == ((void *)0) || intern->ptr == ((void *)0)) {
  if ((executor_globals.exception) && zend_get_class_entry(&(*(executor_globals.exception)) ) == reflection_exception_ptr) {
   return ((void *)0);
  }
...
static zend_op *_reflection_param_get_default_precv(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , parameter_reference *param)
{
 zend_op *precv;
...
void zim_reflection_export(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "O|b", &object, reflector_ptr, &return_output) == FAILURE) {
  return;
 }
...
void zim_reflection_getModifierNames(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "l", &modifiers) == FAILURE) {
  return;
 }
...
void zim_reflection_function___construct(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters_ex(1<<1, (ht) , "O", &closure, zend_ce_closure) == SUCCESS) {
  fptr = (zend_function*)zend_get_closure_method_def(closure );
  zval_addref_p(closure);
 } else if (zend_parse_parameters((ht) , "s", &name_str, &name_len) == SUCCESS) {
  char *nsname;
  ...
  if (zend_hash_find((executor_globals.function_table), nsname, name_len + 1, (void **)&fptr) == FAILURE) {
   _efree((lcname) );
...
void zim_reflection_function_getClosureThis(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->obj) {
  ...
  if (closure_this) {
   { do { zval *__z = (return_value); zval *__zv = (closure_this); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
  }
 }
}
...
void zim_reflection_function_invoke(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "*", &params, &num_args) == FAILURE) {
  return;
 }
...
void zim_reflection_function_invokeArgs(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "a", &param_array) == FAILURE) {
  return;
 }
...
void zim_reflection_parameter___construct(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "zZ", &reference, &parameter) == FAILURE) {
  return;
 }
 ...
 switch ((*reference).type) {
  case 6: {
    ...
    if (zend_hash_find((executor_globals.function_table), lcname, lcname_len + 1, (void**) &fptr) == FAILURE) {
     _efree((lcname) );
     zend_throw_exception_ex(reflection_exception_ptr, 0 ,
  ...
  case 4: {
    ...
    if ((zend_hash_index_find((*reference).value.ht, 0, (void **) &classref) == FAILURE)
     || (zend_hash_index_find((*reference).value.ht, 1, (void **) &method) == FAILURE))
    {
    ...
    if ((**classref).type == 5) {
     ...
     if (zend_lookup_class((**classref).value.str.val, (**classref).value.str.len, &pce ) == FAILURE) {
      zend_throw_exception_ex(reflection_exception_ptr, 0 ,
  ...
  case 5: {
    ...
    if (instanceof_function(ce, zend_ce_closure )) {
     ...
     is_closure = 1;
    } else if (zend_hash_find(&ce->function_table, "__invoke", sizeof("__invoke"), (void **)&fptr) == FAILURE) {
     zend_throw_exception_ex(reflection_exception_ptr, 0 ,
 ...
 if ((**parameter).type == 1) {
  ...
  for (i = 0; i < fptr->common.num_args; i++) {
   if (arg_info[i].name && strcmp(arg_info[i].name, (**parameter).value.str.val) == 0) {
    position= i;
    break;
   }
  }
...
# 2439 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
  if (0 == zend_binary_strcasecmp(param->arg_info->class_name, param->arg_info->class_name_len, "self", sizeof("self")- 1)) {
   ...
   pce= &ce->parent;
  } else if (zend_lookup_class(param->arg_info->class_name, param->arg_info->class_name_len, &pce ) == FAILURE) {
   zend_throw_exception_ex(reflection_exception_ptr, 0 ,
...
void zim_reflection_parameter_getDefaultValue(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 param = _reflection_param_get_default_param(ht, return_value, return_value_ptr, this_ptr, return_value_used );
 if (!param) {
  return;
 }

 precv = _reflection_param_get_default_precv(ht, return_value, return_value_ptr, this_ptr, return_value_used , param);
 if (!precv) {
  return;
 }
 ...
 *return_value = *precv->op2.zv;
 ...
 if (!((((*return_value).type) & 0x00f) >= 8 && (((*return_value).type) & 0x00f) <= 9)) {
  if ((*return_value).type != 4) {
   ...
   zend_hash_copy(ht, (*return_value).value.ht, (copy_ctor_func_t) reflection_zval_deep_copy, ((void *)0), sizeof(zval *));
...
void zim_reflection_parameter_isDefaultValueConstant(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 zend_op *precv;
 parameter_reference *param;
 ...
 precv = _reflection_param_get_default_precv(ht, return_value, return_value_ptr, this_ptr, return_value_used , param);
 if (precv && ((*precv->op2.zv).type & 0x00f) == 8) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((1) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zim_reflection_parameter_getDefaultValueConstantName(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 zend_op *precv;
 parameter_reference *param;
 ...
 precv = _reflection_param_get_default_precv(ht, return_value, return_value_ptr, this_ptr, return_value_used , param);
 if (precv && ((*precv->op2.zv).type & 0x00f) == 8) {
  { do { const char *__s=((*precv->op2.zv).value.str.val); int __l=(*precv->op2.zv).value.str.len; zval *__z = (return_value); (*__z).value.str.len = __l; (*__z).value.str.val = (1?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0); return; };
 }
}
...
void zim_reflection_parameter_isVariadic(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 reflection_object *intern;
 parameter_reference *param;
 ...
 do { zval *__z = (return_value); (*__z).value.lval = ((param->arg_info->is_variadic) != 0); (*__z).type = 3; } while (0);
}
...
void zim_reflection_method___construct(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters_ex(1<<1, (ht) , "zs", &classname, &name_str, &name_len) == FAILURE) {
  if (zend_parse_parameters((ht) , "s", &name_str, &name_len) == FAILURE) {
   return;
  }
 ...
 switch ((*classname).type) {
  case 6:
   if (zend_lookup_class((*classname).value.str.val, (*classname).value.str.len, &pce ) == FAILURE) {
    zend_throw_exception_ex(reflection_exception_ptr, 0 ,
...
void zim_reflection_method_getClosure(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (mptr->common.fn_flags & 0x01) {
  ...
  {
   { do { zval *__z = (return_value); zval *__zv = (obj); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
  } else {
...
void zim_reflection_method_invokeArgs(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "o!a", &object, &param_array) == FAILURE) {
  return;
 }
...
void zim_reflection_function_isGenerator(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 _function_check_flag(ht, return_value, return_value_ptr, this_ptr, return_value_used , 0x800000);
}




void zim_reflection_function_isVariadic(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 _function_check_flag(ht, return_value, return_value_ptr, this_ptr, return_value_used , 0x1000000);
}
...
void zim_reflection_function_inNamespace(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_hash_find(((*(this_ptr))).value.obj.handlers->get_properties(&(*(this_ptr)) ), "name", sizeof("name"), (void **) &name) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
 if ((**name).type == 6
...
void zim_reflection_function_getNamespaceName(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); (*__z).value.str.len = 0; (*__z).value.str.val = (compiler_globals.interned_empty_string)? (compiler_globals.interned_empty_string) : _estrndup((""), (sizeof("")-1) ); (*__z).type = 6; } while (0); return; };
}
...
void zim_reflection_function_getShortName(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (*name); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
void zim_reflection_method_setAccessible(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "b", &visible) == FAILURE) {
  return;
 }
...
static void reflection_class_object_ctor(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , int is_object)
{
 ...
 if (is_object) {
  if (zend_parse_parameters((ht) , "o", &argument) == FAILURE) {
   return;
  }
 } else {
  if (zend_parse_parameters((ht) , "z/", &argument) == FAILURE) {
   return;
  }
 }
 ...
 if ((*argument).type == 5) {
  ...
  if (zend_lookup_class((*argument).value.str.val, (*argument).value.str.len, &ce ) == FAILURE) {
   if (!(executor_globals.exception)) {
...
static void add_class_vars(zend_class_entry *ce, int statics, zval *return_value )
{
  ...
  *prop_copy = *prop;
  ...
  if (((((*prop_copy).type) & 0x00f) >= 8 && (((*prop_copy).type) & 0x00f) <= 9)) {
...
void zim_reflection_class_getStaticPropertyValue(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|z", &name, &name_len, &def_value) == FAILURE) {
  return;
 }
 ...
 if (!prop) {
  if (def_value) {
   { do { zval *__z = (return_value); zval *__zv = (def_value); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
  } else {
   zend_throw_exception_ex(reflection_exception_ptr, 0 ,
  ...
  { do { zval *__z = (return_value); zval *__zv = (*prop); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
}
...
void zim_reflection_class_setStaticPropertyValue(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sz", &name, &name_len, &value) == FAILURE) {
  return;
 }
...
void zim_reflection_class_getMethod(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
  ...
  && (mptr = zend_get_closure_invoke_method(intern->obj )) != ((void *)0))
 {
  ...
  && memcmp(lc_name, "__invoke", sizeof("__invoke")-1) == 0
  && _object_init_ex((&obj_tmp), (ce) ) == SUCCESS && (mptr = zend_get_closure_invoke_method(&obj_tmp )) != ((void *)0)) {
...
void zim_reflection_class_getProperty(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_hash_find(&ce->properties_info, name, name_len + 1, (void**) &property_info) == SUCCESS) {
  ...
  if (zend_hash_exists((*intern->obj).value.obj.handlers->get_properties(intern->obj ), name, name_len+1)) {
   ...
   property_info_tmp.h = zend_hash_func(name, name_len+1);
 ...
 if ((tmp = strstr(name, "::")) != ((void *)0)) {
  ...
  if (zend_lookup_class(classname, classname_len, &pce ) == FAILURE) {
   if (!(executor_globals.exception)) {
  ...
  if (zend_hash_find(&ce->properties_info, name, name_len + 1, (void**) &property_info) == SUCCESS && (property_info->flags & 0x20000) == 0) {
   reflection_property_factory(ce, property_info, return_value );
   return;
  }
 }
...
void zim_reflection_class_isInstance(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (!this_ptr || !instanceof_function(zend_get_class_entry(&(*this_ptr) ), reflection_class_ptr )) { php_error_docref0(((void *)0) , (1<<0L), "%s() cannot be called statically", get_active_function_name()); return; };
 if (zend_parse_parameters((ht) , "o", &object) == FAILURE) {
  return;
 }
 intern = (reflection_object *) zend_object_store_get_object((this_ptr) ); if (intern == ((void *)0) || intern->ptr == ((void *)0)) { if ((executor_globals.exception) && zend_get_class_entry(&(*(executor_globals.exception)) ) == reflection_exception_ptr) { return; } php_error_docref0(((void *)0) , (1<<0L), "Internal error: Failed to retrieve the reflection object"); } ce = intern->ptr;;
...
void zim_reflection_class_newInstance(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 constructor = (*return_value).value.obj.handlers->get_constructor(return_value );
 (executor_globals.scope) = old_scope;
...
void zim_reflection_class_newInstanceWithoutConstructor(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (ce->create_object != ((void *)0) && ce->ce_flags & 0x40) {
  zend_throw_exception_ex(reflection_exception_ptr, 0 , "Class %s is an internal class marked as final that cannot be instantiated without invoking its constructor", ce->name);
 }
...
void zim_reflection_class_newInstanceArgs(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "|h", &args) == FAILURE) {
  return;
 }
...
void zim_reflection_class_isSubclassOf(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "z", &class_name) == FAILURE) {
  return;
 }

 switch(class_name->type) {
  case 6:
   if (zend_lookup_class((*class_name).value.str.val, (*class_name).value.str.len, &pce ) == FAILURE) {
    zend_throw_exception_ex(reflection_exception_ptr, 0 ,
...
void zim_reflection_class_implementsInterface(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "z", &interface) == FAILURE) {
  return;
 }

 switch(interface->type) {
  case 6:
   if (zend_lookup_class((*interface).value.str.val, (*interface).value.str.len, &pce ) == FAILURE) {
    zend_throw_exception_ex(reflection_exception_ptr, 0 ,
...
void zim_reflection_property___construct(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "zs", &classname, &name_str, &name_len) == FAILURE) {
  return;
 }
 ...
 if (zend_hash_find(&ce->properties_info, name_str, name_len + 1, (void **) &property_info) == FAILURE || (property_info->flags & 0x20000)) {
 ...
 if (dynam_prop == 0) {
  zend_unmangle_property_name_ex(property_info->name, property_info->name_length, &class_name, &prop_name, ((void *)0));
 ...
 if (dynam_prop) {
  ...
  reference->prop.h = zend_hash_func(name_str, name_len+1);
...
void zim_reflection_property_getValue(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
  ...
  *return_value= *((intern->ce)->static_members_table)[ref->prop.offset];
  ...
  zend_unmangle_property_name_ex(ref->prop.name, ref->prop.name_length, &class_name, &prop_name, ((void *)0));
...
void zim_reflection_property_setValue(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if ((ref->prop.flags & 0x01)) {
  if (zend_parse_parameters_ex(1<<1, (ht) , "z", &value) == FAILURE) {
   if (zend_parse_parameters((ht) , "zz", &tmp, &value) == FAILURE) {
    return;
   }
  }
  zend_update_class_constants(intern->ce );
  ...
  if (zend_parse_parameters((ht) , "oz", &object, &value) == FAILURE) {
   return;
  }
  zend_unmangle_property_name_ex(ref->prop.name, ref->prop.name_length, &class_name, &prop_name, ((void *)0));
...
void zim_reflection_property_getDeclaringClass(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_unmangle_property_name_ex(ref->prop.name, ref->prop.name_length, &class_name, &prop_name, ((void *)0)) != SUCCESS) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zim_reflection_extension_getFunctions(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 while (zend_hash_get_current_data_ex((compiler_globals.function_table), (void **) &fptr, &iterator) == SUCCESS) {
  if (fptr->common.type==1
   ...
   add_assoc_zval_ex(return_value, fptr->common.function_name, strlen(fptr->common.function_name)+1, function);
  }
  zend_hash_move_forward_ex((compiler_globals.function_table), &iterator);
 }
}
...
static const zend_arg_info arginfo_reflection__void[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};


static const zend_arg_info arginfo_reflection_getModifierNames[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "modifiers", sizeof("modifiers")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_export[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "reflector", sizeof("reflector")-1, "Reflector", sizeof("Reflector")-1, 5, 0, 0, 0 },
...
static const zend_arg_info arginfo_reflection_function_export[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_function___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_function_invoke[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "args", sizeof("args")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_function_invokeArgs[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "args", sizeof("args")-1, ((void *)0), 0, 4, 0, 0, 0 },
};
...
static const zend_function_entry reflection_function_abstract_functions[] = {
 ...
 { "isGenerator", zim_reflection_function_isGenerator, arginfo_reflection__void, (zend_uint) (sizeof(arginfo_reflection__void)/sizeof(struct _zend_arg_info)-1), 0 },
 { "isVariadic", zim_reflection_function_isVariadic, arginfo_reflection__void, (zend_uint) (sizeof(arginfo_reflection__void)/sizeof(struct _zend_arg_info)-1), 0 },
...
static const zend_arg_info arginfo_reflection_method_export[] = { { ((void *)0), 0, ((void *)0), 2, 0, 0, 0, 0 },
 { "class", sizeof("class")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_method___construct[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "class_or_method", sizeof("class_or_method")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_method_invoke[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "args", sizeof("args")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_method_invokeArgs[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "args", sizeof("args")-1, ((void *)0), 0, 4, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_method_setAccessible[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "value", sizeof("value")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_method_getClosure[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_reflection_class_export[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "argument", sizeof("argument")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "argument", sizeof("argument")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_getStaticPropertyValue[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "default", sizeof("default")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_setStaticPropertyValue[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "value", sizeof("value")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_hasMethod[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_getMethod[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_getMethods[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "filter", sizeof("filter")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_hasProperty[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_getProperty[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_getProperties[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "filter", sizeof("filter")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_hasConstant[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_getConstant[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_isInstance[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_newInstance[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "args", sizeof("args")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_newInstanceWithoutConstructor[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_newInstanceArgs[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "args", sizeof("args")-1, ((void *)0), 0, 4, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_isSubclassOf[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "class", sizeof("class")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_class_implementsInterface[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "interface", sizeof("interface")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_reflection_object_export[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "argument", sizeof("argument")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_object___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "argument", sizeof("argument")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_reflection_property_export[] = { { ((void *)0), 0, ((void *)0), 2, 0, 0, 0, 0 },
 { "class", sizeof("class")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_property___construct[] = { { ((void *)0), 0, ((void *)0), 2, 0, 0, 0, 0 },
 { "class", sizeof("class")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_property_getValue[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_property_setValue[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "value", sizeof("value")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_property_setAccessible[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "visible", sizeof("visible")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_reflection_parameter_export[] = { { ((void *)0), 0, ((void *)0), 2, 0, 0, 0, 0 },
 { "function", sizeof("function")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "parameter", sizeof("parameter")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_parameter___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "function", sizeof("function")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "parameter", sizeof("parameter")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_function_entry reflection_parameter_functions[] = {
 ...
 { "isDefaultValueConstant", zim_reflection_parameter_isDefaultValueConstant, arginfo_reflection__void, (zend_uint) (sizeof(arginfo_reflection__void)/sizeof(struct _zend_arg_info)-1), 0 },
 { "getDefaultValueConstantName", zim_reflection_parameter_getDefaultValueConstantName, arginfo_reflection__void, (zend_uint) (sizeof(arginfo_reflection__void)/sizeof(struct _zend_arg_info)-1), 0 },
 { "isVariadic", zim_reflection_parameter_isVariadic, arginfo_reflection__void, (zend_uint) (sizeof(arginfo_reflection__void)/sizeof(struct _zend_arg_info)-1), 0 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_arg_info arginfo_reflection_extension_export[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "return", sizeof("return")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_reflection_extension___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_reflection_zend_extension___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "name", sizeof("name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_function_entry reflection_zend_extension_functions[] = {
 ...
 { "__construct", zim_reflection_zend_extension___construct, arginfo_reflection_zend_extension___construct, (zend_uint) (sizeof(arginfo_reflection_zend_extension___construct)/sizeof(struct _zend_arg_info)-1), 0 },
