# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c" 2
# 40 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_closures.c"
typedef struct _zend_closure {
 zend_object std;
 zend_function func;
 zval this_ptr;
 zend_class_entry *called_scope;
 void (*orig_internal_handler)(zend_execute_data *execute_data, zval *return_value);
} zend_closure;
...
void zim_Closure___invoke(zend_execute_data *execute_data, zval *return_value)
{
 zend_function *func = ((execute_data)->func);
 zval *arguments;

 arguments = (__builtin_constant_p((sizeof(zval) * (execute_data)->This.u2.num_args) ) ? (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 8) ? _emalloc_8() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 16) ? _emalloc_16() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 24) ? _emalloc_24() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 32) ? _emalloc_32() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 40) ? _emalloc_40() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 48) ? _emalloc_48() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 56) ? _emalloc_56() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 64) ? _emalloc_64() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 80) ? _emalloc_80() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 96) ? _emalloc_96() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 112) ? _emalloc_112() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 128) ? _emalloc_128() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 160) ? _emalloc_160() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 192) ? _emalloc_192() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 224) ? _emalloc_224() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 256) ? _emalloc_256() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 320) ? _emalloc_320() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 384) ? _emalloc_384() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 448) ? _emalloc_448() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 512) ? _emalloc_512() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 640) ? _emalloc_640() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 768) ? _emalloc_768() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 896) ? _emalloc_896() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * (execute_data)->This.u2.num_args) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * (execute_data)->This.u2.num_args)) : _emalloc_huge((sizeof(zval) * (execute_data)->This.u2.num_args))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * (execute_data)->This.u2.num_args) ) );
 if (_zend_get_parameters_array_ex((execute_data)->This.u2.num_args, arguments) == FAILURE) {
  _efree((arguments) );
  zend_throw_error(((void *)0), "Cannot get arguments for calling closure");
  do { (*(return_value)).u1.type_info = 2; } while (0);
 } else if (call_user_function_ex((compiler_globals.function_table), ((void *)0), ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), return_value, (execute_data)->This.u2.num_args, arguments, 1, ((void *)0)) == FAILURE) {
  do { (*(return_value)).u1.type_info = 2; } while (0);
 }
 _efree((arguments) );
  ...
  zend_closure *closure, zval *newthis, zend_class_entry *scope)
{
 ...
 if (newthis) {
  ...
  if (func->type == 1 && func->common.scope &&
    !instanceof_function(((*(newthis)).value.obj->ce), func->common.scope)) {

   zend_error((1<<1L), "Cannot bind internal method %s::%s() to object of class %s",
     (func->common.scope->name)->val,
     (func->common.function_name)->val,
     (((*(newthis)).value.obj->ce)->name)->val);
   return 0;
  }
 } else if (!(func->common.fn_flags & 0x01) && func->common.scope
   && func->type == 1) {
  zend_error((1<<1L), "Cannot unbind $this of internal method");
  return 0;
 }

 if (scope && scope != func->common.scope && scope->type == 1) {

  zend_error((1<<1L), "Cannot bind closure to scope of internal class %s",
    (scope->name)->val);
  return 0;
 }

 if ((func->common.fn_flags & 0x40) && scope != func->common.scope) {
  zend_error((1<<1L), "Cannot rebind scope of closure created by ReflectionFunctionAbstract::getClosure()");
  return 0;
 }
...
void zim_Closure_call(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "o*", &newthis, &my_params, &my_param_count) == FAILURE) {
  return;
 }

 zclosure = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 closure = (zend_closure *) (*(zclosure)).value.obj;

 newobj = (*(newthis)).value.obj;

 if (!zend_valid_closure_binding(closure, newthis, ((*(newthis)).value.obj->ce))) {
  return;
 }


 if (zend_fcall_info_init(zclosure, 0, &fci, &fci_cache, ((void *)0), ((void *)0)) != SUCCESS) {
 ...
 fci_cache.called_scope = ((*(newthis)).value.obj->ce);

 if (fci_cache.function_handler->common.fn_flags & 0x800000) {
  zval new_closure;
  zend_create_closure(&new_closure, fci_cache.function_handler, ((*(newthis)).value.obj->ce), closure->called_scope, newthis);
  closure = (zend_closure *) (new_closure).value.obj;
  fci_cache.function_handler = &closure->func;
 } else {
  memcpy(&my_function, fci_cache.function_handler, fci_cache.function_handler->type == 2 ? sizeof(zend_op_array) : sizeof(zend_internal_function));

  my_function.common.scope = ((*(newthis)).value.obj->ce);
  fci_cache.function_handler = &my_function;


  if (((my_function.type & 1) == 0) && closure->func.common.scope != ((*(newthis)).value.obj->ce)) {
   my_function.op_array.run_time_cache = (__builtin_constant_p((my_function.op_array.cache_size) ) ? (((my_function.op_array.cache_size) <= 8) ? _emalloc_8() : (((my_function.op_array.cache_size) <= 16) ? _emalloc_16() : (((my_function.op_array.cache_size) <= 24) ? _emalloc_24() : (((my_function.op_array.cache_size) <= 32) ? _emalloc_32() : (((my_function.op_array.cache_size) <= 40) ? _emalloc_40() : (((my_function.op_array.cache_size) <= 48) ? _emalloc_48() : (((my_function.op_array.cache_size) <= 56) ? _emalloc_56() : (((my_function.op_array.cache_size) <= 64) ? _emalloc_64() : (((my_function.op_array.cache_size) <= 80) ? _emalloc_80() : (((my_function.op_array.cache_size) <= 96) ? _emalloc_96() : (((my_function.op_array.cache_size) <= 112) ? _emalloc_112() : (((my_function.op_array.cache_size) <= 128) ? _emalloc_128() : (((my_function.op_array.cache_size) <= 160) ? _emalloc_160() : (((my_function.op_array.cache_size) <= 192) ? _emalloc_192() : (((my_function.op_array.cache_size) <= 224) ? _emalloc_224() : (((my_function.op_array.cache_size) <= 256) ? _emalloc_256() : (((my_function.op_array.cache_size) <= 320) ? _emalloc_320() : (((my_function.op_array.cache_size) <= 384) ? _emalloc_384() : (((my_function.op_array.cache_size) <= 448) ? _emalloc_448() : (((my_function.op_array.cache_size) <= 512) ? _emalloc_512() : (((my_function.op_array.cache_size) <= 640) ? _emalloc_640() : (((my_function.op_array.cache_size) <= 768) ? _emalloc_768() : (((my_function.op_array.cache_size) <= 896) ? _emalloc_896() : (((my_function.op_array.cache_size) <= 1024) ? _emalloc_1024() : (((my_function.op_array.cache_size) <= 1280) ? _emalloc_1280() : (((my_function.op_array.cache_size) <= 1536) ? _emalloc_1536() : (((my_function.op_array.cache_size) <= 1792) ? _emalloc_1792() : (((my_function.op_array.cache_size) <= 2048) ? _emalloc_2048() : (((my_function.op_array.cache_size) <= 2560) ? _emalloc_2560() : (((my_function.op_array.cache_size) <= 3072) ? _emalloc_3072() : (((my_function.op_array.cache_size) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((my_function.op_array.cache_size)) : _emalloc_huge((my_function.op_array.cache_size))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((my_function.op_array.cache_size) ) );
   memset(my_function.op_array.run_time_cache, 0, my_function.op_array.cache_size);
  }
 }

 if (zend_call_function(&fci, &fci_cache) == SUCCESS && zval_get_type(&(closure_result)) != 0) {
  do { zval *_z1 = (return_value); const zval *_z2 = (&closure_result); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }

 if (fci_cache.function_handler->common.fn_flags & 0x800000) {

  --(&closure->std)->gc.refcount;
 } else if (((my_function.type & 1) == 0) && closure->func.common.scope != ((*(newthis)).value.obj->ce)) {
  _efree((my_function.op_array.run_time_cache) );
 }
}
...
void zim_Closure_bind(zend_execute_data *execute_data, zval *return_value)
{
 zval *newthis, *zclosure, *scope_arg = ((void *)0);
 zend_closure *closure, *new_closure;
 zend_class_entry *ce, *called_scope;

 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Oo!|z", &zclosure, zend_ce_closure, &newthis, &scope_arg) == FAILURE) {
  return;
 }
 ...
 if (scope_arg != ((void *)0)) {
  if (zval_get_type(&(*(scope_arg))) == 8) {
   ce = ((*(scope_arg)).value.obj->ce);
  } else if (zval_get_type(&(*(scope_arg))) == 1) {
   ce = ((void *)0);
  } else {
   zend_string *class_name = _zval_get_string((scope_arg));
   if (((class_name)->len == sizeof("static")-1 && !memcmp((class_name)->val, "static", sizeof("static") - 1))) {
 ...
 if (newthis) {
  called_scope = ((*(newthis)).value.obj->ce);
 } else {
  called_scope = ce;
 }

 zend_create_closure(return_value, &closure->func, ce, called_scope, newthis);
 new_closure = (zend_closure *) (*(return_value)).value.obj;


 if (((closure->func.type & 1) == 0) && (closure->func.common.scope != new_closure->func.common.scope || (closure->func.op_array.fn_flags & 0x80000))) {
  new_closure->func.op_array.run_time_cache = (__builtin_constant_p((new_closure->func.op_array.cache_size) ) ? (((new_closure->func.op_array.cache_size) <= 8) ? _emalloc_8() : (((new_closure->func.op_array.cache_size) <= 16) ? _emalloc_16() : (((new_closure->func.op_array.cache_size) <= 24) ? _emalloc_24() : (((new_closure->func.op_array.cache_size) <= 32) ? _emalloc_32() : (((new_closure->func.op_array.cache_size) <= 40) ? _emalloc_40() : (((new_closure->func.op_array.cache_size) <= 48) ? _emalloc_48() : (((new_closure->func.op_array.cache_size) <= 56) ? _emalloc_56() : (((new_closure->func.op_array.cache_size) <= 64) ? _emalloc_64() : (((new_closure->func.op_array.cache_size) <= 80) ? _emalloc_80() : (((new_closure->func.op_array.cache_size) <= 96) ? _emalloc_96() : (((new_closure->func.op_array.cache_size) <= 112) ? _emalloc_112() : (((new_closure->func.op_array.cache_size) <= 128) ? _emalloc_128() : (((new_closure->func.op_array.cache_size) <= 160) ? _emalloc_160() : (((new_closure->func.op_array.cache_size) <= 192) ? _emalloc_192() : (((new_closure->func.op_array.cache_size) <= 224) ? _emalloc_224() : (((new_closure->func.op_array.cache_size) <= 256) ? _emalloc_256() : (((new_closure->func.op_array.cache_size) <= 320) ? _emalloc_320() : (((new_closure->func.op_array.cache_size) <= 384) ? _emalloc_384() : (((new_closure->func.op_array.cache_size) <= 448) ? _emalloc_448() : (((new_closure->func.op_array.cache_size) <= 512) ? _emalloc_512() : (((new_closure->func.op_array.cache_size) <= 640) ? _emalloc_640() : (((new_closure->func.op_array.cache_size) <= 768) ? _emalloc_768() : (((new_closure->func.op_array.cache_size) <= 896) ? _emalloc_896() : (((new_closure->func.op_array.cache_size) <= 1024) ? _emalloc_1024() : (((new_closure->func.op_array.cache_size) <= 1280) ? _emalloc_1280() : (((new_closure->func.op_array.cache_size) <= 1536) ? _emalloc_1536() : (((new_closure->func.op_array.cache_size) <= 1792) ? _emalloc_1792() : (((new_closure->func.op_array.cache_size) <= 2048) ? _emalloc_2048() : (((new_closure->func.op_array.cache_size) <= 2560) ? _emalloc_2560() : (((new_closure->func.op_array.cache_size) <= 3072) ? _emalloc_3072() : (((new_closure->func.op_array.cache_size) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((new_closure->func.op_array.cache_size)) : _emalloc_huge((new_closure->func.op_array.cache_size))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((new_closure->func.op_array.cache_size) ) );
  memset(new_closure->func.op_array.run_time_cache, 0, new_closure->func.op_array.cache_size);

  new_closure->func.op_array.fn_flags |= 0x80000;
 }
}


static __attribute__((cold)) zend_function *zend_closure_get_constructor(zend_object *object)
{
 zend_throw_error(((void *)0), "Instantiation of 'Closure' is not allowed");
 return ((void *)0);
}
...
__attribute__ ((visibility("default"))) zend_function *zend_get_closure_invoke_method(zend_object *object)
{
 ...
 invoke->internal_function.fn_flags =
  0x100 | 0x200000 | (closure->func.common.fn_flags & keep_flags);
 if (closure->func.type != 1 || (closure->func.common.fn_flags & 0x80)) {
  invoke->internal_function.fn_flags |=
   0x80;
 }
 ...
 invoke->internal_function.function_name = zend_string_init("__invoke", sizeof("__invoke")-1, 0);
 return invoke;
}
...
__attribute__ ((visibility("default"))) const zend_function *zend_get_closure_method_def(zval *obj)
{
 zend_closure *closure = (zend_closure *)(*(obj)).value.obj;
 return &closure->func;
}
...
{
 if (((method)->len == sizeof("__invoke") - 1 && !zend_binary_strcasecmp((method)->val, (method)->len, ("__invoke"), sizeof("__invoke") - 1))) {
...
{
 zend_throw_error(((void *)0), "Closure object cannot have properties");
...
static void zend_closure_free_storage(zend_object *object)
{
 ...
 if (closure->func.type == 2) {
  if (closure->func.op_array.fn_flags & 0x80000) {
   _efree((closure->func.op_array.run_time_cache) );
   closure->func.op_array.run_time_cache = ((void *)0);
  }
  destroy_op_array(&closure->func.op_array);
 }

 if (zval_get_type(&(closure->this_ptr)) != 0) {
...
static zend_object *zend_closure_new(zend_class_entry *class_type)
{
 ...
 closure = (__builtin_constant_p((sizeof(zend_closure)) ) ? (((sizeof(zend_closure)) <= 8) ? _emalloc_8() : (((sizeof(zend_closure)) <= 16) ? _emalloc_16() : (((sizeof(zend_closure)) <= 24) ? _emalloc_24() : (((sizeof(zend_closure)) <= 32) ? _emalloc_32() : (((sizeof(zend_closure)) <= 40) ? _emalloc_40() : (((sizeof(zend_closure)) <= 48) ? _emalloc_48() : (((sizeof(zend_closure)) <= 56) ? _emalloc_56() : (((sizeof(zend_closure)) <= 64) ? _emalloc_64() : (((sizeof(zend_closure)) <= 80) ? _emalloc_80() : (((sizeof(zend_closure)) <= 96) ? _emalloc_96() : (((sizeof(zend_closure)) <= 112) ? _emalloc_112() : (((sizeof(zend_closure)) <= 128) ? _emalloc_128() : (((sizeof(zend_closure)) <= 160) ? _emalloc_160() : (((sizeof(zend_closure)) <= 192) ? _emalloc_192() : (((sizeof(zend_closure)) <= 224) ? _emalloc_224() : (((sizeof(zend_closure)) <= 256) ? _emalloc_256() : (((sizeof(zend_closure)) <= 320) ? _emalloc_320() : (((sizeof(zend_closure)) <= 384) ? _emalloc_384() : (((sizeof(zend_closure)) <= 448) ? _emalloc_448() : (((sizeof(zend_closure)) <= 512) ? _emalloc_512() : (((sizeof(zend_closure)) <= 640) ? _emalloc_640() : (((sizeof(zend_closure)) <= 768) ? _emalloc_768() : (((sizeof(zend_closure)) <= 896) ? _emalloc_896() : (((sizeof(zend_closure)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_closure)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_closure)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_closure)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_closure)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_closure)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_closure)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_closure)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_closure))) : _emalloc_huge((sizeof(zend_closure)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_closure)) ) );
...
{
 zend_closure *closure = (zend_closure *)(*(zobject)).value.obj;
 zval result;
...
int zend_closure_get_closure(zval *obj, zend_class_entry **ce_ptr, zend_function **fptr_ptr, zend_object **obj_ptr)
{
 ...
 closure = (zend_closure *)(*(obj)).value.obj;
 *fptr_ptr = &closure->func;
 *ce_ptr = closure->called_scope;

 if (obj_ptr) {
  if (zval_get_type(&(closure->this_ptr)) != 0) {
   *obj_ptr = (closure->this_ptr).value.obj;
  } else {
   *obj_ptr = ((void *)0);
  }
 }
...
{
 zend_closure *closure = (zend_closure *)(*(object)).value.obj;
 zval val;
 ...
 *is_temp = 1;
 ...
 _zend_hash_init((debug_info), (8), (_zval_ptr_dtor), (0) );

 if (closure->func.type == 2 && closure->func.op_array.static_variables) {
  HashTable *static_variables = closure->func.op_array.static_variables;
  do { zval *__z = (&val); (*(__z)).value.arr = (zend_array_dup(static_variables)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
  _zend_hash_str_update(debug_info, "static", sizeof("static")-1, &val );
 }

 if (zval_get_type(&(closure->this_ptr)) != 0) {
  zval_addref_p(&(closure->this_ptr));
  _zend_hash_str_update(debug_info, "this", sizeof("this")-1, &closure->this_ptr );
 }

 if (arg_info &&
  (closure->func.common.num_args ||
   (closure->func.common.fn_flags & 0x1000000))) {
  uint32_t i, num_args, required = closure->func.common.required_num_args;

  _array_init((&val), 0 );

  num_args = closure->func.common.num_args;
  if (closure->func.common.fn_flags & 0x1000000) {
   num_args++;
  }
  for (i = 0; i < num_args; i++) {
   ...
   do { zval *__z = (&info); zend_string *__s = (zend_strpprintf(0, "%s", i >= required ? "<optional>" : "<required>")); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
   _zend_hash_update((val).value.arr, name, &info );
   zend_string_release(name);
   arg_info++;
  }
  _zend_hash_str_update(debug_info, "parameter", sizeof("parameter")-1, &val );
 }
 ...
 *table = zval_get_type(&(closure->this_ptr)) != 1 ? &closure->this_ptr : ((void *)0);
 *n = zval_get_type(&(closure->this_ptr)) != 1 ? 1 : 0;
...
__attribute__((cold)) void zim_Closure___construct(zend_execute_data *execute_data, zval *return_value)
{
 zend_throw_error(((void *)0), "Instantiation of 'Closure' is not allowed");
}


static const zend_internal_arg_info arginfo_closure_bindto[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "newthis", ((void *)0), 0, 0, 0, 0 },
 { "newscope", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_closure_bind[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "closure", ((void *)0), 0, 0, 0, 0 },
 { "newthis", ((void *)0), 0, 0, 0, 0 },
 { "newscope", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_closure_call[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "newthis", ((void *)0), 0, 0, 0, 0 },
 { "parameters", ((void *)0), 0, 0, 0, 1 },
};

static const zend_function_entry closure_functions[] = {
 { "__construct", zim_Closure___construct, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x400 },
 { "bind", zim_Closure_bind, arginfo_closure_bind, (uint32_t) (sizeof(arginfo_closure_bind)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "bindTo", zim_Closure_bind, arginfo_closure_bindto, (uint32_t) (sizeof(arginfo_closure_bindto)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "call", zim_Closure_call, arginfo_closure_call, (uint32_t) (sizeof(arginfo_closure_call)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
...
static void zend_closure_internal_handler(zend_execute_data *execute_data, zval *return_value)
{
 zend_closure *closure = (zend_closure*)((execute_data)->func)->common.prototype;
 closure->orig_internal_handler(execute_data, return_value);
 zend_object_release((zend_object*)closure);
 ((execute_data)->func) = ((void *)0);
}


__attribute__ ((visibility("default"))) void zend_create_closure(zval *res, zend_function *func, zend_class_entry *scope, zend_class_entry *called_scope, zval *this_ptr)
{
 zend_closure *closure;

 _object_init_ex((res), (zend_ce_closure) );

 closure = (zend_closure *)(*(res)).value.obj;

 if ((scope == ((void *)0)) && this_ptr && (zval_get_type(&(*(this_ptr))) != 0)) {
 ...
 if (func->type == 2) {
  ...
  closure->func.common.fn_flags |= 0x100000;
  if (closure->func.op_array.static_variables) {
   HashTable *static_variables = closure->func.op_array.static_variables;

   (closure->func.op_array.static_variables) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
   _zend_hash_init((closure->func.op_array.static_variables), ((static_variables)->nNumOfElements), (_zval_ptr_dtor), (0) );
   zend_hash_apply_with_arguments(static_variables, zval_copy_static_var, 1, closure->func.op_array.static_variables);
  }
  if (__builtin_expect(!!(!closure->func.op_array.run_time_cache), 0)) {
   closure->func.op_array.run_time_cache = func->op_array.run_time_cache = zend_arena_alloc(&(compiler_globals.arena), func->op_array.cache_size);
  ...
  if (__builtin_expect(!!(closure->func.internal_function.handler == zend_closure_internal_handler), 0)) {

   zend_closure *nested = (zend_closure*)((char*)func - ((zend_long) (((char *) (&(((zend_closure*)((void *)0))->func))) - ((char *) ((void *)0)))));
   do { if (__builtin_expect(!(nested->std.ce == zend_ce_closure), 0)) __builtin_unreachable(); } while (0);
 ...
 do { (*(&closure->this_ptr)).u1.type_info = 0; } while (0);
 ...
 if (scope) {
  ...
  if (this_ptr && zval_get_type(&(*(this_ptr))) == 8 && (closure->func.common.fn_flags & 0x01) == 0) {
   do { zval *_z1 = (&closure->this_ptr); const zval *_z2 = (this_ptr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
 }
}


__attribute__ ((visibility("default"))) void zend_create_fake_closure(zval *res, zend_function *func, zend_class_entry *scope, zend_class_entry *called_scope, zval *this_ptr)
{
 zend_closure *closure;
 ...
 closure = (zend_closure *)(*(res)).value.obj;
 closure->func.common.fn_flags |= 0x40;
}
