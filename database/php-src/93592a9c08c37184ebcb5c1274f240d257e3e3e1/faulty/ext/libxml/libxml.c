# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2


# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_variables.h" 1
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
typedef void (*xmlEntityReferenceFunc) (xmlEntityPtr ent,
 ...
 void
   xmlHandleEntity (xmlParserCtxtPtr ctxt,
       xmlEntityPtr entity);
# 41 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 43 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
# 1 "/usr/include/libxml2/libxml/xmlerror.h" 1
# 44 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
typedef xmlSaveCtxt *xmlSaveCtxtPtr;
 ...
 int
  xmlSaveSetAttrEscape (xmlSaveCtxtPtr ctxt,
      xmlCharEncodingOutputFunc escape);
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
typedef enum {
 ...
 int
      ...
      xmlDocPtr doc,
      xmlNodePtr elem);
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
typedef xmlSchemaSAXPlugStruct *xmlSchemaSAXPlugPtr;
 ...
 void
      ...
      void *ctxt);
# 48 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
# 51 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c" 2
...
static void zif_libxml_set_streams_context(zend_execute_data *execute_data, zval *return_value);
static void zif_libxml_use_internal_errors(zend_execute_data *execute_data, zval *return_value);
static void zif_libxml_get_last_error(zend_execute_data *execute_data, zval *return_value);
static void zif_libxml_clear_errors(zend_execute_data *execute_data, zval *return_value);
static void zif_libxml_get_errors(zend_execute_data *execute_data, zval *return_value);
static void zif_libxml_set_external_entity_loader(zend_execute_data *execute_data, zval *return_value);
static void zif_libxml_disable_entity_loader(zend_execute_data *execute_data, zval *return_value);

static zend_class_entry *libxmlerror_class_entry;
# 90 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
...
static const zend_internal_arg_info arginfo_libxml_set_streams_context[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "context", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_libxml_use_internal_errors[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "use_errors", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_libxml_get_last_error[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_libxml_get_errors[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_libxml_clear_errors[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_libxml_disable_entity_loader[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "disable", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_libxml_set_external_entity_loader[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "resolver_function", ((void *)0), 0, 0, 0, 0 },
};



static const zend_function_entry libxml_functions[] = {
 { "libxml_set_streams_context", zif_libxml_set_streams_context, arginfo_libxml_set_streams_context, (uint32_t) (sizeof(arginfo_libxml_set_streams_context)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "libxml_use_internal_errors", zif_libxml_use_internal_errors, arginfo_libxml_use_internal_errors, (uint32_t) (sizeof(arginfo_libxml_use_internal_errors)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "libxml_get_last_error", zif_libxml_get_last_error, arginfo_libxml_get_last_error, (uint32_t) (sizeof(arginfo_libxml_get_last_error)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "libxml_clear_errors", zif_libxml_clear_errors, arginfo_libxml_clear_errors, (uint32_t) (sizeof(arginfo_libxml_clear_errors)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "libxml_get_errors", zif_libxml_get_errors, arginfo_libxml_get_errors, (uint32_t) (sizeof(arginfo_libxml_get_errors)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "libxml_disable_entity_loader", zif_libxml_disable_entity_loader, arginfo_libxml_disable_entity_loader, (uint32_t) (sizeof(arginfo_libxml_disable_entity_loader)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "libxml_set_external_entity_loader", zif_libxml_set_external_entity_loader, arginfo_libxml_set_external_entity_loader, (uint32_t) (sizeof(arginfo_libxml_set_external_entity_loader)/sizeof(struct _zend_internal_arg_info)-1), 0 },
...
static void zm_globals_ctor_libxml(zend_libxml_globals *libxml_globals)
{
 ...
 do { (*(&libxml_globals->stream_context)).u1.type_info = 0; } while (0);
 libxml_globals->error_buffer.s = ((void *)0);
 libxml_globals->error_list = ((void *)0);
 do { (*(&libxml_globals->entity_loader.object)).u1.type_info = 0; } while (0);
...
static void *php_libxml_streams_IO_open_wrapper(const char *filename, const char *mode, const int read_only)
{
 ...
 char *resolved_path;
 const char *path_to_open = ((void *)0);
 void *ret_val = ((void *)0);
 int isescaped=0;
 xmlURI *uri;
 ...
 if (uri && (uri->scheme == ((void *)0) ||
  ...
  isescaped = 1;
# 332 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
 } else {
 ...
 context = ( ((zval_get_type(&((libxml_globals.stream_context))) == 0)? ((void *)0) : &(libxml_globals.stream_context)) ? zend_fetch_resource_ex((zval_get_type(&((libxml_globals.stream_context))) == 0)? ((void *)0) : &(libxml_globals.stream_context), "Stream-Context", php_le_stream_context()) : (0) ? ((void *)0) : (file_globals.default_context) ? (file_globals.default_context) : ((file_globals.default_context) = php_stream_context_alloc()) );
...
php_libxml_input_buffer_create_filename(const char *URI, xmlCharEncoding enc)
{
 ...
 if ((libxml_globals.entity_loader_disabled)) {
  return ((void *)0);
 }
...
static void php_libxml_internal_error_handler(int error_type, void *ctx, const char **msg, va_list ap)
{
 ...
 smart_str_appendl_ex((&(libxml_globals.error_buffer)), (buf), (len), 0);

 _efree((buf) );

 if (output == 1) {
  if ((libxml_globals.error_list)) {
   _php_list_set_error_structure(((void *)0), ((libxml_globals.error_buffer).s)->val);
  } else {
   switch (error_type) {
    case 1:
     php_libxml_ctx_error_level((1<<1L), ctx, ((libxml_globals.error_buffer).s)->val);
     break;
    case 2:
     php_libxml_ctx_error_level((1<<3L), ctx, ((libxml_globals.error_buffer).s)->val);
     break;
    default:
     php_error_docref0(((void *)0), (1<<1L), "%s", ((libxml_globals.error_buffer).s)->val);
   }
  }
  smart_str_free(&(libxml_globals.error_buffer));
 }
}
  ...
  const char *ID, xmlParserCtxtPtr context)
{
 ...
 if (ID != ((void *)0)) {
  do { const char *_s = (ID); do { do { zval *__z = (&params[0]); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
 } else {
  do { (*(&params[0])).u1.type_info = 0; } while (0);
 }
 if (URL != ((void *)0)) {
  do { const char *_s = (URL); do { do { zval *__z = (&params[1]); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
 } else {
  do { (*(&params[1])).u1.type_info = 0; } while (0);
 }
 ctxzv = &params[2];
 _array_init((ctxzv), (4) );
# 609 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
 if (context->directory == ((void *)0)) { add_assoc_null_ex(ctxzv, "directory", sizeof("directory") - 1); } else { add_assoc_string_ex(ctxzv, "directory", sizeof("directory") - 1, (char *)context->directory); }
 if (context->intSubName == ((void *)0)) { add_assoc_null_ex(ctxzv, "intSubName", sizeof("intSubName") - 1); } else { add_assoc_string_ex(ctxzv, "intSubName", sizeof("intSubName") - 1, (char *)context->intSubName); }
 if (context->extSubURI == ((void *)0)) { add_assoc_null_ex(ctxzv, "extSubURI", sizeof("extSubURI") - 1); } else { add_assoc_string_ex(ctxzv, "extSubURI", sizeof("extSubURI") - 1, (char *)context->extSubURI); }
 if (context->extSubSystem == ((void *)0)) { add_assoc_null_ex(ctxzv, "extSubSystem", sizeof("extSubSystem") - 1); } else { add_assoc_string_ex(ctxzv, "extSubSystem", sizeof("extSubSystem") - 1, (char *)context->extSubSystem); }
 ...
 status = zend_call_function(fci, &(libxml_globals.entity_loader).fcc);
 if (status != SUCCESS || (zval_get_type(&(retval)) == 0)) {
  php_libxml_ctx_error(context,
    "Call to user entity loader callback '%s' has failed",
    ((fci->function_name).value.str)->val);
 } else {
            ...
            if (zval_get_type(&(retval)) == 6) {
is_string:
   resource = ((retval).value.str)->val;
  } else if (zval_get_type(&(retval)) == 9) {
   php_stream *stream;
   (stream) = (php_stream*)zend_fetch_resource2_ex((&retval), "stream", php_file_le_stream(), php_file_le_pstream());
   if (stream == ((void *)0)) {
    php_libxml_ctx_error(context,
...
static xmlParserInputPtr _php_libxml_pre_ext_ent_loader(const char *URL,
  const char *ID, xmlParserCtxtPtr context)
{
# 705 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
...
__attribute__ ((visibility("default"))) void php_libxml_initialize(void)
{
 if (!_php_libxml_initialized) {
  ...
  _zend_hash_init((&php_libxml_exports), (0), (php_libxml_exports_dtor), (1) );
...
{
 if (oldcontext) {
  do { zval *_z1 = (oldcontext); const zval *_z2 = (&(libxml_globals.stream_context)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }
 if (context) {
  do { zval *_z1 = (&(libxml_globals.stream_context)); const zval *_z2 = (context); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }
}
...
static int zm_startup_libxml(int type, int module_number)
{
 ...
 zend_register_long_constant(("LIBXML_VERSION"), sizeof("LIBXML_VERSION")-1, (20901), ((1<<0) | (1<<1)), module_number);
 zend_register_string_constant(("LIBXML_DOTTED_VERSION"), sizeof("LIBXML_DOTTED_VERSION")-1, ("2.9.1"), ((1<<0) | (1<<1)), module_number);
 zend_register_string_constant(("LIBXML_LOADED_VERSION"), sizeof("LIBXML_LOADED_VERSION")-1, ((char *)(*(__xmlParserVersion()))), ((1<<0) | (1<<1)), module_number);


 zend_register_long_constant(("LIBXML_NOENT"), sizeof("LIBXML_NOENT")-1, (XML_PARSE_NOENT), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_DTDLOAD"), sizeof("LIBXML_DTDLOAD")-1, (XML_PARSE_DTDLOAD), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_DTDATTR"), sizeof("LIBXML_DTDATTR")-1, (XML_PARSE_DTDATTR), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_DTDVALID"), sizeof("LIBXML_DTDVALID")-1, (XML_PARSE_DTDVALID), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NOERROR"), sizeof("LIBXML_NOERROR")-1, (XML_PARSE_NOERROR), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NOWARNING"), sizeof("LIBXML_NOWARNING")-1, (XML_PARSE_NOWARNING), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NOBLANKS"), sizeof("LIBXML_NOBLANKS")-1, (XML_PARSE_NOBLANKS), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_XINCLUDE"), sizeof("LIBXML_XINCLUDE")-1, (XML_PARSE_XINCLUDE), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NSCLEAN"), sizeof("LIBXML_NSCLEAN")-1, (XML_PARSE_NSCLEAN), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NOCDATA"), sizeof("LIBXML_NOCDATA")-1, (XML_PARSE_NOCDATA), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NONET"), sizeof("LIBXML_NONET")-1, (XML_PARSE_NONET), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_PEDANTIC"), sizeof("LIBXML_PEDANTIC")-1, (XML_PARSE_PEDANTIC), ((1<<0) | (1<<1)), module_number);

 zend_register_long_constant(("LIBXML_COMPACT"), sizeof("LIBXML_COMPACT")-1, (XML_PARSE_COMPACT), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_NOXMLDECL"), sizeof("LIBXML_NOXMLDECL")-1, (XML_SAVE_NO_DECL), ((1<<0) | (1<<1)), module_number);


 zend_register_long_constant(("LIBXML_PARSEHUGE"), sizeof("LIBXML_PARSEHUGE")-1, (XML_PARSE_HUGE), ((1<<0) | (1<<1)), module_number);


 zend_register_long_constant(("LIBXML_BIGLINES"), sizeof("LIBXML_BIGLINES")-1, (XML_PARSE_BIG_LINES), ((1<<0) | (1<<1)), module_number);

 zend_register_long_constant(("LIBXML_NOEMPTYTAG"), sizeof("LIBXML_NOEMPTYTAG")-1, (1<<2), ((1<<0) | (1<<1)), module_number);



 zend_register_long_constant(("LIBXML_SCHEMA_CREATE"), sizeof("LIBXML_SCHEMA_CREATE")-1, (XML_SCHEMA_VAL_VC_I_CREATE), ((1<<0) | (1<<1)), module_number);




 zend_register_long_constant(("LIBXML_HTML_NOIMPLIED"), sizeof("LIBXML_HTML_NOIMPLIED")-1, (HTML_PARSE_NOIMPLIED), ((1<<0) | (1<<1)), module_number);



 zend_register_long_constant(("LIBXML_HTML_NODEFDTD"), sizeof("LIBXML_HTML_NODEFDTD")-1, (HTML_PARSE_NODEFDTD), ((1<<0) | (1<<1)), module_number);



 zend_register_long_constant(("LIBXML_ERR_NONE"), sizeof("LIBXML_ERR_NONE")-1, (XML_ERR_NONE), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_ERR_WARNING"), sizeof("LIBXML_ERR_WARNING")-1, (XML_ERR_WARNING), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_ERR_ERROR"), sizeof("LIBXML_ERR_ERROR")-1, (XML_ERR_ERROR), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("LIBXML_ERR_FATAL"), sizeof("LIBXML_ERR_FATAL")-1, (XML_ERR_FATAL), ((1<<0) | (1<<1)), module_number);

 { zend_string *cl_name; cl_name = zend_string_init("LibXMLError", sizeof("LibXMLError")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = ((void *)0); } };
...
static int zm_deactivate_libxml(int type, int module_number)
{
 _php_libxml_destroy_fci(&(libxml_globals.entity_loader).fci, &(libxml_globals.entity_loader).object);
...
static void zm_info_libxml(zend_module_entry *zend_module)
{
 ...
 php_info_print_table_row(2, "libXML Compiled Version", "2.9.1");
...
static void zif_libxml_set_streams_context(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "r", &arg) == FAILURE) {
  return;
 }
 if (!(zval_get_type(&((libxml_globals.stream_context))) == 0)) {
  _zval_ptr_dtor((&(libxml_globals.stream_context)) );
  do { (*(&(libxml_globals.stream_context))).u1.type_info = 0; } while (0);
 }
 do { zval *_z1 = (&(libxml_globals.stream_context)); const zval *_z2 = (arg); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}
...
static void zif_libxml_use_internal_errors(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|b", &use_errors) == FAILURE) {
  return;
 }
...
static void zif_libxml_get_last_error(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (error) {
  ...
  add_property_long_ex(return_value, "level", strlen("level"), error->level);
  add_property_long_ex(return_value, "code", strlen("code"), error->code);
  add_property_long_ex(return_value, "column", strlen("column"), error->int2);
  if (error->message) {
   add_property_string_ex(return_value, "message", strlen("message"), error->message);
  } else {
   add_property_stringl_ex(return_value, "message", strlen("message"), "", 0);
  }
  if (error->file) {
   add_property_string_ex(return_value, "file", strlen("file"), error->file);
  } else {
   add_property_stringl_ex(return_value, "file", strlen("file"), "", 0);
  }
  add_property_long_ex(return_value, "line", strlen("line"), error->line);
 } else {
...
static void zif_libxml_get_errors(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (_array_init((return_value), 0 ) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
__attribute__ ((visibility("default"))) zend_bool php_libxml_disable_entity_loader(zend_bool disable)
{
 zend_bool old = (libxml_globals.entity_loader_disabled);

 (libxml_globals.entity_loader_disabled) = disable;
 return old;
}
...
static void zif_libxml_disable_entity_loader(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|b", &disable) == FAILURE) {
  return;
 }

 { do { (*(return_value)).u1.type_info = (php_libxml_disable_entity_loader(disable)) ? 3 : 2; } while (0); return; };
}
...
static void zif_libxml_set_external_entity_loader(zend_execute_data *execute_data, zval *return_value)
{
 zend_fcall_info fci;
 zend_fcall_info_cache fcc;
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "f!", &fci, &fcc)
   == FAILURE) {
  return;
 }
 ...
 if (fci.size > 0) {
  ...
  if (fci.object != ((void *)0)) {
   do { zval *__z = (&(libxml_globals.entity_loader).object); (*(__z)).value.obj = (fci.object); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
   zval_addref_p(&((libxml_globals.entity_loader).object));
  }
...
__attribute__ ((visibility("default"))) int php_libxml_increment_node_ptr(php_libxml_node_object *object, xmlNodePtr node, void *private_data)
{
 ...
 if (object != ((void *)0) && node != ((void *)0)) {
  ...
  if (node->_private != ((void *)0)) {
   ...
   ret_refcount = 1;
   object->node = (__builtin_constant_p((sizeof(php_libxml_node_ptr)) ) ? (((sizeof(php_libxml_node_ptr)) <= 8) ? _emalloc_8() : (((sizeof(php_libxml_node_ptr)) <= 16) ? _emalloc_16() : (((sizeof(php_libxml_node_ptr)) <= 24) ? _emalloc_24() : (((sizeof(php_libxml_node_ptr)) <= 32) ? _emalloc_32() : (((sizeof(php_libxml_node_ptr)) <= 40) ? _emalloc_40() : (((sizeof(php_libxml_node_ptr)) <= 48) ? _emalloc_48() : (((sizeof(php_libxml_node_ptr)) <= 56) ? _emalloc_56() : (((sizeof(php_libxml_node_ptr)) <= 64) ? _emalloc_64() : (((sizeof(php_libxml_node_ptr)) <= 80) ? _emalloc_80() : (((sizeof(php_libxml_node_ptr)) <= 96) ? _emalloc_96() : (((sizeof(php_libxml_node_ptr)) <= 112) ? _emalloc_112() : (((sizeof(php_libxml_node_ptr)) <= 128) ? _emalloc_128() : (((sizeof(php_libxml_node_ptr)) <= 160) ? _emalloc_160() : (((sizeof(php_libxml_node_ptr)) <= 192) ? _emalloc_192() : (((sizeof(php_libxml_node_ptr)) <= 224) ? _emalloc_224() : (((sizeof(php_libxml_node_ptr)) <= 256) ? _emalloc_256() : (((sizeof(php_libxml_node_ptr)) <= 320) ? _emalloc_320() : (((sizeof(php_libxml_node_ptr)) <= 384) ? _emalloc_384() : (((sizeof(php_libxml_node_ptr)) <= 448) ? _emalloc_448() : (((sizeof(php_libxml_node_ptr)) <= 512) ? _emalloc_512() : (((sizeof(php_libxml_node_ptr)) <= 640) ? _emalloc_640() : (((sizeof(php_libxml_node_ptr)) <= 768) ? _emalloc_768() : (((sizeof(php_libxml_node_ptr)) <= 896) ? _emalloc_896() : (((sizeof(php_libxml_node_ptr)) <= 1024) ? _emalloc_1024() : (((sizeof(php_libxml_node_ptr)) <= 1280) ? _emalloc_1280() : (((sizeof(php_libxml_node_ptr)) <= 1536) ? _emalloc_1536() : (((sizeof(php_libxml_node_ptr)) <= 1792) ? _emalloc_1792() : (((sizeof(php_libxml_node_ptr)) <= 2048) ? _emalloc_2048() : (((sizeof(php_libxml_node_ptr)) <= 2560) ? _emalloc_2560() : (((sizeof(php_libxml_node_ptr)) <= 3072) ? _emalloc_3072() : (((sizeof(php_libxml_node_ptr)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(php_libxml_node_ptr))) : _emalloc_huge((sizeof(php_libxml_node_ptr)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(php_libxml_node_ptr)) ) );
...
__attribute__ ((visibility("default"))) int php_libxml_increment_doc_ref(php_libxml_node_object *object, xmlDocPtr docp)
{
 ...
 if (object->document != ((void *)0)) {
  ...
  ret_refcount = 1;
  object->document = (__builtin_constant_p((sizeof(php_libxml_ref_obj)) ) ? (((sizeof(php_libxml_ref_obj)) <= 8) ? _emalloc_8() : (((sizeof(php_libxml_ref_obj)) <= 16) ? _emalloc_16() : (((sizeof(php_libxml_ref_obj)) <= 24) ? _emalloc_24() : (((sizeof(php_libxml_ref_obj)) <= 32) ? _emalloc_32() : (((sizeof(php_libxml_ref_obj)) <= 40) ? _emalloc_40() : (((sizeof(php_libxml_ref_obj)) <= 48) ? _emalloc_48() : (((sizeof(php_libxml_ref_obj)) <= 56) ? _emalloc_56() : (((sizeof(php_libxml_ref_obj)) <= 64) ? _emalloc_64() : (((sizeof(php_libxml_ref_obj)) <= 80) ? _emalloc_80() : (((sizeof(php_libxml_ref_obj)) <= 96) ? _emalloc_96() : (((sizeof(php_libxml_ref_obj)) <= 112) ? _emalloc_112() : (((sizeof(php_libxml_ref_obj)) <= 128) ? _emalloc_128() : (((sizeof(php_libxml_ref_obj)) <= 160) ? _emalloc_160() : (((sizeof(php_libxml_ref_obj)) <= 192) ? _emalloc_192() : (((sizeof(php_libxml_ref_obj)) <= 224) ? _emalloc_224() : (((sizeof(php_libxml_ref_obj)) <= 256) ? _emalloc_256() : (((sizeof(php_libxml_ref_obj)) <= 320) ? _emalloc_320() : (((sizeof(php_libxml_ref_obj)) <= 384) ? _emalloc_384() : (((sizeof(php_libxml_ref_obj)) <= 448) ? _emalloc_448() : (((sizeof(php_libxml_ref_obj)) <= 512) ? _emalloc_512() : (((sizeof(php_libxml_ref_obj)) <= 640) ? _emalloc_640() : (((sizeof(php_libxml_ref_obj)) <= 768) ? _emalloc_768() : (((sizeof(php_libxml_ref_obj)) <= 896) ? _emalloc_896() : (((sizeof(php_libxml_ref_obj)) <= 1024) ? _emalloc_1024() : (((sizeof(php_libxml_ref_obj)) <= 1280) ? _emalloc_1280() : (((sizeof(php_libxml_ref_obj)) <= 1536) ? _emalloc_1536() : (((sizeof(php_libxml_ref_obj)) <= 1792) ? _emalloc_1792() : (((sizeof(php_libxml_ref_obj)) <= 2048) ? _emalloc_2048() : (((sizeof(php_libxml_ref_obj)) <= 2560) ? _emalloc_2560() : (((sizeof(php_libxml_ref_obj)) <= 3072) ? _emalloc_3072() : (((sizeof(php_libxml_ref_obj)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(php_libxml_ref_obj))) : _emalloc_huge((sizeof(php_libxml_ref_obj)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(php_libxml_ref_obj)) ) );
  ...
  if (ret_refcount == 0) {
   ...
   if (object->document->doc_props != ((void *)0)) {
    if (object->document->doc_props->classmap) {
     ...
     do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 16) { _efree_16(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 24) { _efree_24(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 32) { _efree_32(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 40) { _efree_40(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 48) { _efree_48(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 56) { _efree_56(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 64) { _efree_64(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 80) { _efree_80(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 96) { _efree_96(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 112) { _efree_112(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 128) { _efree_128(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 160) { _efree_160(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 192) { _efree_192(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 224) { _efree_224(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 256) { _efree_256(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 320) { _efree_320(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 384) { _efree_384(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 448) { _efree_448(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 512) { _efree_512(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 640) { _efree_640(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 768) { _efree_768(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 896) { _efree_896(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 1024) { _efree_1024(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 1280) { _efree_1280(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 1536) { _efree_1536(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 1792) { _efree_1792(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 2048) { _efree_2048(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 2560) { _efree_2560(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= 3072) { _efree_3072(object->document->doc_props->classmap); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(object->document->doc_props->classmap, sizeof(HashTable)); } else { _efree_huge(object->document->doc_props->classmap, sizeof(HashTable)); } } else { _efree(object->document->doc_props->classmap); } } while (0);
    }
