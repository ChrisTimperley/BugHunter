# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
# 72 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
...
# 2478 "Zend/../main/php_config.h" 2
# 2493 "Zend/../main/php_config.h"
...
# 2494 "Zend/../main/php_config.h" 2
# 2504 "Zend/../main/php_config.h"
...
# 73 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c" 2
...
# 74 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c" 2
# 90 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
...
# 167 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
static inline __attribute__((always_inline)) void gc_remove_from_roots(gc_root_buffer *root)
{
...
# 210 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
}
...
# 243 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
 (gc_globals.roots).next = &(gc_globals.roots);
 (gc_globals.roots).prev = &(gc_globals.roots);
 ...
 if ((gc_globals.buf)) {
  (gc_globals.unused) = ((void *)0);
  (gc_globals.first_unused) = (gc_globals.buf) + 1;
 } else {
  (gc_globals.unused) = ((void *)0);
...
__attribute__ ((visibility("default"))) void gc_init(void)
{
 if ((gc_globals.buf) == ((void *)0) && (gc_globals.gc_enabled)) {
  (gc_globals.buf) = (gc_root_buffer*) malloc(sizeof(gc_root_buffer) * 10001);
  (gc_globals.last_unused) = &(gc_globals.buf)[10001];
  gc_reset();
 }
}
...
__attribute__ ((visibility("default"))) void gc_possible_root(zend_refcounted *ref)
{
 ...
 if (__builtin_expect(!!((compiler_globals.unclean_shutdown)), 0) || __builtin_expect(!!((gc_globals.gc_active)), 0)) {
  return;
 }

 do { if (__builtin_expect(!((ref)->gc.u.v.type == 7 || (ref)->gc.u.v.type == 8), 0)) __builtin_unreachable(); } while (0);
 do { if (__builtin_expect(!(__builtin_expect(!!((((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) == 0x0000), 1)), 0)) __builtin_unreachable(); } while (0);
 do { if (__builtin_expect(!(!(((ref)->gc.u.v.gc_info) & ~0xc000)), 0)) __builtin_unreachable(); } while (0);
 ...
 if (newRoot) {
  ...
  if (__builtin_expect(!!((ref)->gc.u.v.gc_info), 0)) {
   return;
  }
  newRoot = (gc_globals.unused);
  if (!newRoot) {
 ...
 ;
 (ref)->gc.u.v.gc_info = (newRoot - (gc_globals.buf)) | 0xc000;
 newRoot->ref = ref;
...
__attribute__ ((visibility("default"))) void gc_remove_from_buffer(zend_refcounted *ref)
{
 ...
 do { if (__builtin_expect(!((((ref)->gc.u.v.gc_info) & ~0xc000)), 0)) __builtin_unreachable(); } while (0);
 do { if (__builtin_expect(!((((ref)->gc.u.v.gc_info) & ~0xc000) < 10001), 0)) __builtin_unreachable(); } while (0);

 ;

 root = (gc_globals.buf) + (((ref)->gc.u.v.gc_info) & ~0xc000);
 if ((((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) != 0x0000) {
  ;
 }
 (ref)->gc.u.v.gc_info = 0;
 gc_remove_from_roots((root));


 if ((gc_globals.next_to_free) == root) {
  (gc_globals.next_to_free) = root->next;
 }
}
...
tail_call:
 ht = ((void *)0);
 do { ; do {((ref)->gc.u.v.gc_info) = ((ref)->gc.u.v.gc_info) & ~0xc000;} while (0); } while (0);

 if ((ref)->gc.u.v.type == 8 && !((ref)->gc.u.v.flags & (1<<4))) {
  zend_object_get_gc_t get_gc;
  zend_object *obj = (zend_object*)ref;

  if (__builtin_expect(!!((!(((zend_uintptr_t)((executor_globals.objects_store).object_buckets[obj->handle])) & (1<<0))) && (get_gc = obj->handlers->get_gc) != ((void *)0)), 1)
                                                        ) {
   int n;
   zval *zv, *end;
   zval tmp;

   do { zval *__z = (&tmp); (*(__z)).value.obj = (obj); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
   ht = get_gc(&tmp, &zv, &n);
   end = zv + n;
   if (__builtin_expect(!!(!ht), 1)) {
    if (!n) return;
    while (!(((*(--end)).u1.v.type_flags & (1<<2)) != 0)) {
     if (zv == end) return;
    }
   }
   while (zv != end) {
    if ((((*(zv)).u1.v.type_flags & (1<<2)) != 0)) {
 ...
 } else if ((ref)->gc.u.v.type == 7) {
  if ((zend_array*)ref != &(executor_globals.symbol_table)) {
   ht = (zend_array*)ref;
  } else {
   return;
  }
 } else if ((ref)->gc.u.v.type == 10) {
  if ((((((zend_reference*)ref)->val).u1.v.type_flags & (1<<2)) != 0)) {
   ref = (((zend_reference*)ref)->val).value.counted;
   (ref)->gc.refcount++;
   if ((((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) != 0x0000) {
    goto tail_call;
   }
...
tail_call:
 if ((((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) != 0x4000) {
  ht = ((void *)0);
  ;
  do { ; do {((ref)->gc.u.v.gc_info) = (((ref)->gc.u.v.gc_info) & ~0xc000) | (0x4000);} while (0); } while (0);
  ...
  if ((ref)->gc.u.v.type == 8 && !((ref)->gc.u.v.flags & (1<<4))) {
   ...
   if ((((((zend_reference*)ref)->val).u1.v.type_flags & (1<<2)) != 0)) {
    if (__builtin_expect(!!(!(executor_globals.objects_store).object_buckets), 0) &&
     zval_get_type(&(((zend_reference*)ref)->val)) == 8) {
     (((zend_reference*)ref)->val).u1.type_info = 1;
     return;
    }
    ref = (((zend_reference*)ref)->val).value.counted;
    (ref)->gc.refcount--;
  ...
  while (p != end) {
   ...
   if ((((*(zv)).u1.v.type_flags & (1<<2)) != 0)) {
    if (zval_get_type(&(*(zv))) == 8 &&
        __builtin_expect(!!(!(executor_globals.objects_store).object_buckets), 0)) {
     (*(zv)).u1.type_info = 1;
    } else {
     ref = (*(zv)).value.counted;
     (ref)->gc.refcount--;
...
static void gc_mark_roots(void)
{
 ...
 while (current != &(gc_globals.roots)) {
  if ((((zend_uintptr_t)((current->ref)->gc.u.v.gc_info)) & 0xc000) == 0xc000) {
...
tail_call:
 if ((((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) == 0x4000) {
  if ((ref)->gc.refcount > 0) {
   ...
   do { ; do {((ref)->gc.u.v.gc_info) = (((ref)->gc.u.v.gc_info) & ~0xc000) | (0x8000);} while (0); } while (0);
   if ((ref)->gc.u.v.type == 8 && !((ref)->gc.u.v.flags & (1<<4))) {
    zend_object_get_gc_t get_gc;
    zend_object *obj = (zend_object*)ref;
...
{
 gc_root_buffer *buf = (gc_globals.unused);

 if (buf) {
  (gc_globals.unused) = buf->prev;


  (ref)->gc.u.v.gc_info = buf - (gc_globals.buf);



 } else if ((gc_globals.first_unused) != (gc_globals.last_unused)) {
  buf = (gc_globals.first_unused);
  (gc_globals.first_unused)++;
  ...
  if (!*additional_buffer || (*additional_buffer)->used == ((4096 - 0 - sizeof(void*) * 2) / sizeof(gc_root_buffer))) {
   gc_additional_buffer *new_buffer = (__builtin_constant_p((sizeof(gc_additional_buffer)) ) ? (((sizeof(gc_additional_buffer)) <= 8) ? _emalloc_8() : (((sizeof(gc_additional_buffer)) <= 16) ? _emalloc_16() : (((sizeof(gc_additional_buffer)) <= 24) ? _emalloc_24() : (((sizeof(gc_additional_buffer)) <= 32) ? _emalloc_32() : (((sizeof(gc_additional_buffer)) <= 40) ? _emalloc_40() : (((sizeof(gc_additional_buffer)) <= 48) ? _emalloc_48() : (((sizeof(gc_additional_buffer)) <= 56) ? _emalloc_56() : (((sizeof(gc_additional_buffer)) <= 64) ? _emalloc_64() : (((sizeof(gc_additional_buffer)) <= 80) ? _emalloc_80() : (((sizeof(gc_additional_buffer)) <= 96) ? _emalloc_96() : (((sizeof(gc_additional_buffer)) <= 112) ? _emalloc_112() : (((sizeof(gc_additional_buffer)) <= 128) ? _emalloc_128() : (((sizeof(gc_additional_buffer)) <= 160) ? _emalloc_160() : (((sizeof(gc_additional_buffer)) <= 192) ? _emalloc_192() : (((sizeof(gc_additional_buffer)) <= 224) ? _emalloc_224() : (((sizeof(gc_additional_buffer)) <= 256) ? _emalloc_256() : (((sizeof(gc_additional_buffer)) <= 320) ? _emalloc_320() : (((sizeof(gc_additional_buffer)) <= 384) ? _emalloc_384() : (((sizeof(gc_additional_buffer)) <= 448) ? _emalloc_448() : (((sizeof(gc_additional_buffer)) <= 512) ? _emalloc_512() : (((sizeof(gc_additional_buffer)) <= 640) ? _emalloc_640() : (((sizeof(gc_additional_buffer)) <= 768) ? _emalloc_768() : (((sizeof(gc_additional_buffer)) <= 896) ? _emalloc_896() : (((sizeof(gc_additional_buffer)) <= 1024) ? _emalloc_1024() : (((sizeof(gc_additional_buffer)) <= 1280) ? _emalloc_1280() : (((sizeof(gc_additional_buffer)) <= 1536) ? _emalloc_1536() : (((sizeof(gc_additional_buffer)) <= 1792) ? _emalloc_1792() : (((sizeof(gc_additional_buffer)) <= 2048) ? _emalloc_2048() : (((sizeof(gc_additional_buffer)) <= 2560) ? _emalloc_2560() : (((sizeof(gc_additional_buffer)) <= 3072) ? _emalloc_3072() : (((sizeof(gc_additional_buffer)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(gc_additional_buffer))) : _emalloc_huge((sizeof(gc_additional_buffer)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(gc_additional_buffer)) ) );
   new_buffer->used = 0;
  ...
  (ref)->gc.u.v.gc_info = 10001;




  (ref)->gc.u.v.type |= 0x80;
 }
 if (buf) {
  (ref)->gc.refcount++;
  buf->ref = ref;
  buf->next = (gc_globals.roots).next;
  buf->prev = &(gc_globals.roots);
  (gc_globals.roots).next->prev = buf;
  (gc_globals.roots).next = buf;
 }
}
...
tail_call:
 if ((((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) == 0x8000) {
  ht = ((void *)0);
  do { ; do {((ref)->gc.u.v.gc_info) = ((ref)->gc.u.v.gc_info) & ~0xc000;} while (0); } while (0);


  if ((ref)->gc.u.v.type != 10) {
   count++;
  }
...
static int gc_collect_roots(uint32_t *flags, gc_additional_buffer **additional_buffer)
{
 ...
 while (current != &(gc_globals.roots)) {
  ...
  if ((((zend_uintptr_t)((current->ref)->gc.u.v.gc_info)) & 0xc000) == 0x0000) {
   (current->ref)->gc.u.v.gc_info = 0;
   gc_remove_from_roots((current));
  }
  current = next;
 }

 current = (gc_globals.roots).next;
 while (current != &(gc_globals.roots)) {
  (current->ref)->gc.refcount++;
  if ((((zend_uintptr_t)((current->ref)->gc.u.v.gc_info)) & 0xc000) == 0x8000) {
 ...
 if ((gc_globals.roots).next != &(gc_globals.roots)) {
  if ((gc_globals.to_free).next == &(gc_globals.to_free)) {

   (gc_globals.to_free).next = (gc_globals.roots).next;
   (gc_globals.to_free).prev = (gc_globals.roots).prev;
   (gc_globals.to_free).next->prev = &(gc_globals.to_free);
   (gc_globals.to_free).prev->next = &(gc_globals.to_free);
  } else {

   (gc_globals.to_free).prev->next = (gc_globals.roots).next;
   (gc_globals.roots).next->prev = (gc_globals.to_free).prev;
   (gc_globals.roots).prev->next = &(gc_globals.to_free);
   (gc_globals.to_free).prev = (gc_globals.roots).prev;
  }
...
tail_call:
 if (root ||
     ((((ref)->gc.u.v.gc_info) & ~0xc000) != 0 &&
      (((zend_uintptr_t)((ref)->gc.u.v.gc_info)) & 0xc000) == 0x0000 &&
      (((ref)->gc.u.v.gc_info) & ~0xc000) != 10001)) {
  ;
  (ref)->gc.refcount--;
  if (root) {
   (ref)->gc.u.v.gc_info = 0;
   ...
   do { zend_refcounted *_p = (zend_refcounted*)(ref); if ((((_p)->gc.u.v.gc_info) & ~0xc000)) { gc_remove_from_buffer(_p); } } while (0);
  }
  ...
  if ((ref)->gc.u.v.type == 8 && !((ref)->gc.u.v.flags & (1<<4))) {
   ...
   if (__builtin_expect(!!((!(((zend_uintptr_t)((executor_globals.objects_store).object_buckets[obj->handle])) & (1<<0))) && (get_gc = obj->handlers->get_gc) != ((void *)0)), 1)
    ...
    while (zv != end) {
     if ((((*(zv)).u1.v.type_flags & (1<<2)) != 0)) {
      ref = (*(zv)).value.counted;
      gc_remove_nested_data_from_buffer(ref, ((void *)0));
     }
     zv++;
    }
    if (__builtin_expect(!!(!ht), 1)) {
...
__attribute__ ((visibility("default"))) int zend_gc_collect_cycles(void)
{
 ...
 if ((gc_globals.roots).next != &(gc_globals.roots)) {
  ...
  to_free.next = (gc_globals.to_free).next;
  to_free.prev = (gc_globals.to_free).prev;
  ...
  if (gc_flags & (1<<0)) {
   ...
   if ((executor_globals.objects_store).object_buckets) {
    ...
    while (current != &to_free) {
     current->refcount = (current->ref)->gc.refcount;
     current = current->next;
    }
    ...
    while (current != &to_free) {
     p = current->ref;
     (gc_globals.next_to_free) = current->next;
     if (((p)->gc.u.v.type & 0x7f) == 8) {
      zend_object *obj = (zend_object*)p;

      if ((!(((zend_uintptr_t)((executor_globals.objects_store).object_buckets[obj->handle])) & (1<<0))) &&
       !((obj)->gc.u.v.flags & (1<<3))) {
       ;
       (obj)->gc.u.v.flags |= (1<<3);
       if (obj->handlers->dtor_obj) {
        (obj)->gc.refcount++;
     ...
     current = (gc_globals.next_to_free);
    }
    ...
    while (current != &to_free) {
     (gc_globals.next_to_free) = current->next;
     if ((current->ref)->gc.refcount > current->refcount) {
  ...
  while (current != &to_free) {
   ...
   if (((p)->gc.u.v.type & 0x7f) == 8) {
    ...
    if ((executor_globals.objects_store).object_buckets &&
        (!(((zend_uintptr_t)((executor_globals.objects_store).object_buckets[obj->handle])) & (1<<0)))) {
     (obj)->gc.u.v.type = 1;
     if (!((obj)->gc.u.v.flags & (1<<4))) {
      (obj)->gc.u.v.flags |= (1<<4);
     ...
     do { ((executor_globals.objects_store).object_buckets[obj->handle]) = (zend_object*)((((zend_uintptr_t)((executor_globals.objects_store).free_list_head)) << 1) | (1<<0)); } while (0);
     (executor_globals.objects_store).free_list_head = obj->handle;
     p = current->ref = (zend_refcounted*)(((char*)obj) - obj->handlers->offset);
    }
   } else if (((p)->gc.u.v.type & 0x7f) == 7) {
  ...
  while (current != &to_free) {
   next = current->next;
   p = current->ref;
   if (__builtin_expect(!!(current >= (gc_globals.buf) && current < (gc_globals.buf) + 10001), 1)) {
    current->prev = (gc_globals.unused);
    (gc_globals.unused) = current;
   }
   _efree((p) );
   current = next;
  }

  while (additional_buffer != ((void *)0)) {
   gc_additional_buffer *next = additional_buffer->next;
   _efree((additional_buffer) );
