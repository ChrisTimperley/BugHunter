# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
...
# 1 "/usr/include/errno.h" 1 3 4
# 29 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
# 70 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
# 71 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
...
# 73 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
...
# 75 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
...
# 76 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
# 133 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
# 134 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c" 2
...
static sa_t *allowed_clients = ((void *)0);
...
# 427 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
int fcgi_init(void)
{
 if (!is_initialized) {
  ...
  is_initialized = 1;
# 532 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
  (*__errno_location ()) = 0;
...
# 635 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
int fcgi_listen(const char *path, int backlog)
{
 ...
 if (tcp) {
  ...
  if (!*host || !strncmp(host, "*", sizeof("*")-1)) {
   sa.sa_inet.sin_addr.s_addr = htonl(((in_addr_t) 0x00000000));
  } else {
...
# 735 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
 ...
 if (!tcp) {
  ...
  if (ip) {
   ...
   while (cur) {
    ...
    if (inet_pton(2, cur, &allowed_clients[n].sa_inet.sin_addr)>0) {
     allowed_clients[n].sa.sa_family = 2;
     n++;

    } else if (inet_pton(10, cur, &allowed_clients[n].sa_inet6.sin6_addr)>0) {
     allowed_clients[n].sa.sa_family = 10;
     n++;
...
fcgi_request *fcgi_init_request(int listen_socket, void(*on_accept)(), void(*on_read)(), void(*on_close)())
{
 ...
 req->fd = -1;
 req->id = -1;
# 896 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
static inline ssize_t safe_write(fcgi_request *req, const void *buf, size_t count)
{
 ...
 do {
  ...
  (*__errno_location ()) = 0;
# 941 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
static inline ssize_t safe_read(fcgi_request *req, const void *buf, size_t count)
{
 ...
 do {
  ...
  (*__errno_location ()) = 0;
# 978 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
static int fcgi_read_request(fcgi_request *req)
{
 ...
 if (hdr.type == FCGI_BEGIN_REQUEST && len == sizeof(fcgi_begin_request)) {
  ...
  while (q != ((void *)0)) {
   ...
   zlen = (unsigned int)((*(value)).value.str)->len;
...
# 1294 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
  if (!force) {
   char buf[8];
...
static int fcgi_is_allowed() {
 ...
 if (client_sa.sa.sa_family == 1) {
  return 1;
 }
 if (!allowed_clients) {
  return 1;
 }
 if (client_sa.sa.sa_family == 2) {
  for (i = 0; allowed_clients[i].sa.sa_family ; i++) {
   if (allowed_clients[i].sa.sa_family == 2
 ...
 if (client_sa.sa.sa_family == 10) {
  for (i = 0; allowed_clients[i].sa.sa_family ; i++) {
   if (allowed_clients[i].sa.sa_family == 10
    && !memcmp(&client_sa.sa_inet6.sin6_addr, &allowed_clients[i].sa_inet6.sin6_addr, 12)) {
    return 1;
   }

   if (allowed_clients[i].sa.sa_family == 2
       && (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (&client_sa.sa_inet6.sin6_addr); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == htonl (0xffff); }))
...
# 1392 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
    {
    ...
    if (req->fd >= 0) {
     ...
     fcgi_close(req, 1, 0);
# 1465 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
    }
...
# 1481 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
   return req->fd;
  } else {
   fcgi_close(req, 1, 1);
  }
...
# 1578 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
char* fcgi_putenv(fcgi_request *req, char* var, int var_len, char* val)
{
 ...
 if (val == ((void *)0)) {
  ...
  return fcgi_hash_set(&req->env, (__builtin_expect(!!(var_len < 3), 0) ? var_len : (((unsigned int)var[3]) << 2) + (((unsigned int)var[var_len-2]) << 4) + (((unsigned int)var[var_len-1]) << 2) + var_len), var, var_len, val, (unsigned int)strlen(val));
 }
}
...
# 1721 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
void fcgi_set_mgmt_var(const char * name, size_t name_len, const char * value, size_t value_len)
{
 zval zvalue;
 do { zval *__z = (&zvalue); zend_string *__s = (zend_string_init(value, value_len, 1)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 _zend_hash_str_add(&fcgi_mgmt_vars, name, name_len, &zvalue );
}
...
const char *fcgi_get_last_client_ip()
{
 ...
 if (client_sa.sa.sa_family == 2) {
  return inet_ntop(client_sa.sa.sa_family, &client_sa.sa_inet.sin_addr, str, 46);
 }
 ...
 if (client_sa.sa.sa_family == 10
  && (__extension__ ({ const struct in6_addr *__a = (const struct in6_addr *) (&client_sa.sa_inet6.sin6_addr); __a->__in6_u.__u6_addr32[0] == 0 && __a->__in6_u.__u6_addr32[1] == 0 && __a->__in6_u.__u6_addr32[2] == htonl (0xffff); }))) {
  return inet_ntop(2, ((char *)&client_sa.sa_inet6.sin6_addr)+12, str, 46);
 }


 if (client_sa.sa.sa_family == 10) {
  return inet_ntop(client_sa.sa.sa_family, &client_sa.sa_inet6.sin6_addr, str, 46);
 }
