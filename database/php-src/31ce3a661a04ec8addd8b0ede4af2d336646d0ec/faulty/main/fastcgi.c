...
# 1289 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
  if (!force) {
   char buf[8];
...
# 1387 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
    {
    ...
    if (req->fd >= 0) {
     ...
     fcgi_close(req, 1, 0);
# 1460 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
    }
...
# 1476 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
   return req->fd;
  } else {
   fcgi_close(req, 1, 1);
  }
...
# 1573 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
...
# 1716 "/home/ct584/git/bughunter/repositories/php-src/main/fastcgi.c"
void fcgi_set_mgmt_var(const char * name, size_t name_len, const char * value, size_t value_len)
{
 zval zvalue;
