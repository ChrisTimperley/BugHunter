# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
# 46 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
...
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c" 2
...
# 71 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
 return SUCCESS;
}
# 82 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
__attribute__ ((visibility("default"))) int php_exec(int type, char *cmd, zval *array, zval *return_value)
{
 FILE *fp;
 char *buf;
 ...
 if (type != 3) {
  ...
  while (_php_stream_get_line((stream), (b), (4096), (&bufl))) {
   ...
   if (type == 1) {
    ...
    l = bufl;
    while (l-- > 0 && ((*__ctype_b_loc ())[(int) ((((unsigned char *)buf)[l]))] & (unsigned short int) _ISspace));
    if (l != (bufl - 1)) {
     bufl = l + 1;
     buf[bufl] = '\0';
    }
  ...
  if (bufl) {
   ...
   do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(buf, bufl, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
  } else {
  ...
  while((bufl = _php_stream_read((stream), (buf), (4096))) > 0) {
   php_output_write((buf), (bufl));
  }
 }

 pclose_return = _php_stream_free((stream), (1 | 2));
 _efree((buf) );
...
static void php_exec_ex(zend_execute_data *execute_data, zval *return_value, int mode)
{
 char *cmd;
 size_t cmd_len;
 zval *ret_code=((void *)0), *ret_array=((void *)0);
 int ret;

 if (mode) {
  if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|z/", &cmd, &cmd_len, &ret_code) == FAILURE) {
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
 } else {
  if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|z/z/", &cmd, &cmd_len, &ret_array, &ret_code) == FAILURE) {
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
 }
 if (!cmd_len) {
  php_error_docref0(((void *)0), (1<<1L), "Cannot execute a blank command");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 if (strlen(cmd) != cmd_len) {
  php_error_docref0(((void *)0), (1<<1L), "NULL byte detected. Possible attack");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (!ret_array) {
  ret = php_exec(mode, cmd, ((void *)0), return_value);
 } else {
  if (zval_get_type(&(*(ret_array))) != 7) {
   _zval_dtor((ret_array) );
   _array_init((ret_array), 0 );
  }
  ret = php_exec(2, cmd, ret_array, return_value);
 }
 if (ret_code) {
  _zval_dtor((ret_code) );
  { zval *__z = (ret_code); (*(__z)).value.lval = ret; (*(__z)).u1.type_info = 4; };
 }
}
...
void zif_exec(zend_execute_data *execute_data, zval *return_value)
{
 php_exec_ex(execute_data, return_value, 0);
}
...
void zif_system(zend_execute_data *execute_data, zval *return_value)
{
 php_exec_ex(execute_data, return_value, 1);
}
...
void zif_passthru(zend_execute_data *execute_data, zval *return_value)
{
 php_exec_ex(execute_data, return_value, 3);
}
# 268 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
__attribute__ ((visibility("default"))) zend_string *php_escape_shell_cmd(char *str)
{
 register int x, y;
 size_t l = strlen(str);
 ...
 if (l > cmd_max_len - 2 - 1) {
  php_error_docref0(((void *)0), (1<<0L), "Command exceeds the allowed length of %d bytes", cmd_max_len);
 ...
 for (x = 0, y = 0; x < l; x++) {
  ...
  switch (str[x]) {
   ...
   case '\'':
    ...
    (cmd)->val[y++] = str[x];
    break;
# 321 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
   case '#':
   case '&':
   case ';':
   case '`':
 ...
 if (y - 1 > cmd_max_len) {
  php_error_docref0(((void *)0), (1<<0L), "Escaped command exceeds the allowed length of %d bytes", cmd_max_len);
...
__attribute__ ((visibility("default"))) zend_string *php_escape_shell_arg(char *str)
{
 int x, y = 0;
 size_t l = strlen(str);
 zend_string *cmd;
 ...
 if (l > cmd_max_len - 2 - 1) {
  php_error_docref0(((void *)0), (1<<0L), "Argument exceeds the allowed length of %d bytes", cmd_max_len);
  return (compiler_globals.empty_string);
 }
...
# 438 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
 (cmd)->val[y++] = '\'';

 (cmd)->val[y] = '\0';

 if (y - 1 > cmd_max_len) {
  php_error_docref0(((void *)0), (1<<0L), "Escaped argument exceeds the allowed length of %d bytes", cmd_max_len);
  zend_string_release(cmd);
  return (compiler_globals.empty_string);
 }
...
void zif_escapeshellcmd(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &command, &command_len) == FAILURE) {
  return;
 }

 if (command_len) {
  if (command_len != strlen(command)) {
   php_error_docref0(((void *)0), (1<<0L), "Input string contains NULL bytes");
   return;
  }
  do { zval *__z = (return_value); zend_string *__s = (php_escape_shell_cmd(command)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 } else {
  do { do { zval *__z = (return_value); zend_string *__s = ((compiler_globals.empty_string)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = 6; } while (0); } while (0);
 }
}
...
void zif_escapeshellarg(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &argument, &argument_len) == FAILURE) {
  return;
 }
 ...
 if (argument) {
  ...
  do { zval *__z = (return_value); zend_string *__s = (php_escape_shell_arg(argument)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 }
}
...
void zif_shell_exec(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((in=popen(command, "r"))==((void *)0)) {

  php_error_docref0(((void *)0), (1<<1L), "Unable to execute '%s'", command);
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 stream = _php_stream_fopen_from_pipe((in), ("rb") );
 ret = _php_stream_copy_to_mem((stream), (((size_t)-1)), (0) );
 _php_stream_free((stream), (1 | 2));

 if (ret && (ret)->len > 0) {
  do { zval *__z = (return_value); zend_string *__s = (ret); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 }
}
...
void zif_proc_nice(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &pri) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 (*__errno_location ()) = 0;
 (({ __typeof__ (nice(pri)) __x = (nice(pri)); (void) __x; }));
 if ((*__errno_location ())) {
  php_error_docref0(((void *)0), (1<<1L), "Only a super user may attempt to increase the priority of a process");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
