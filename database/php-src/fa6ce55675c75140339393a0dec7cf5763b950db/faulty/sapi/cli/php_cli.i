  ...
  while ((c = php_getopt(argc, argv, OPTIONS, &php_optarg, &php_optind, 0, 2)) != -1) {
   ...
   case 'v':
    php_printf("PHP %s (%s) (built: %s %s) ( %s)\nCopyright (c) 1997-2016 The PHP Group\n%s",
     "7.1.0-dev", cli_sapi_module.name, "Aug  7 2016", "08:40:12",
...
# 1209 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli.c"
 signal(13, ((__sighandler_t) 1));
# 1236 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli.c"
 while ((c = php_getopt(argc, argv, OPTIONS, &php_optarg, &php_optind, 0, 2))!=-1) {
  switch (c) {
   case 'c':
...
# 1372 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli.c"
