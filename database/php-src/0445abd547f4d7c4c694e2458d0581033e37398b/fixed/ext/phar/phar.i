...
# 1894 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_detect_phar_fname_ext(const char *filename, int filename_len, const char **ext_str, int *ext_len, int executable, int for_create, int is_complete )
{
...
# 2123 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
char *phar_fix_filepath(char *path, int *new_len, int use_cwd )
{
 char *newpath;
 int newpath_len;
...
# 2237 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_split_fname(const char *filename, int filename_len, char **arch, int *arch_len, char **entry, int *entry_len, int executable, int for_create )
{
 const char *ext_str;
...
# 2492 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
...
# 2545 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 2908 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 3022 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
  mytime = time(((void *)0));
...
# 3165 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
   default: {
    char *digest = ((void *)0);
    int digest_len;
...
# 3294 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
static zend_op_array *phar_compile_file(zend_file_handle *file_handle, int type )
{
 ...
 if (failed) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c", 3378);
 }
...
void zm_info_phar(zend_module_entry *zend_module )
{
 ...
 php_info_print_table_row(2, "SVN revision", "$Id: 228dfcaaaff820549b25694996ccd5a99283977e $");
