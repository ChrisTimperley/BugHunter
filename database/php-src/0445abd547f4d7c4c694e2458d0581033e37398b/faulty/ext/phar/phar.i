...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.h"
extern zend_module_entry spl_module_entry;
# 53 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.h"
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/hash/php_hash.h"
...
# 128 "/home/ct584/git/bughunter/repositories/php-src/ext/hash/php_hash.h"
...
# 215 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h"
...
# 216 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h" 2
...
# 528 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h"
...
static void phar_split_cache_list(void)
{
 ...
 if (_zend_hash_init((&(executor_globals.regular_list)), (0), (((void *)0)), (0) ) == SUCCESS) {
...
static const zend_ini_entry ini_entries[] = {
 { 0, ((1<<0)|(1<<1)|(1<<2)), "phar.readonly", sizeof("phar.readonly"), phar_ini_modify_handler, (void *) __builtin_offsetof (zend_phar_globals, readonly), (void *) &phar_globals, ((void *)0), "1", sizeof("1")-1, ((void *)0), 0, 0, 0, zend_ini_boolean_displayer_cb },
 { 0, ((1<<0)|(1<<1)|(1<<2)), "phar.require_hash", sizeof("phar.require_hash"), phar_ini_modify_handler, (void *) __builtin_offsetof (zend_phar_globals, require_hash), (void *) &phar_globals, ((void *)0), "1", sizeof("1")-1, ((void *)0), 0, 0, 0, zend_ini_boolean_displayer_cb },
 { 0, (1<<2), "phar.cache_list", sizeof("phar.cache_list"), phar_ini_cache_list, (void *) __builtin_offsetof (zend_phar_globals, cache_list), (void *) &phar_globals, ((void *)0), "", sizeof("")-1, ((void *)0), 0, 0, 0, ((void *)0) },
...
int phar_archive_delref(phar_archive_data *phar )
{
 ...
 if (--phar->refcount < 0) {
  ...
  || zend_hash_del_key_or_index(&((&phar_globals)->phar_fname_map), phar->fname, phar->fname_len, 0, 0) != SUCCESS) {
...
# 529 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_open_parsed_phar(char *fname, int fname_len, char *alias, int alias_len, int is_data, int options, phar_archive_data** pphar, char **error )
{
 phar_archive_data *phar;
...
# 550 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
 if (SUCCESS == phar_get_archive(&phar, fname, fname_len, alias, alias_len, error )
  ...
  if (!is_data) {
   ...
   if (!phar->halt_offset && !phar->is_brandnew && (phar->is_tar || phar->is_zip)) {
    if ((phar_globals.readonly) && FAILURE == zend_hash_find(&(phar->manifest), ".phar/stub.php", sizeof(".phar/stub.php")-1, (void **)&stub)) {
     if (error) {
...
# 604 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_parse_metadata(char **buffer, zval **metadata, php_uint32 zip_metadata_len )
{
  ...
  **metadata = zval_used_for_init;;
  ...
  if ((phar_globals.persist)) {
   ...
   _zval_ptr_dtor((metadata) );
   *metadata = (zval *) ((1)?__zend_malloc(zip_metadata_len):_emalloc((zip_metadata_len) ));
...
# 650 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 892 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
   case 0x0002: {
...
int phar_create_or_parse_filename(char *fname, int fname_len, char *alias, int alias_len, int is_data, int options, phar_archive_data** pphar, char **error )
{
 ...
 if (alias_len && alias) {
  if (FAILURE == _zend_hash_add_or_update(&((&phar_globals)->phar_alias_map), alias, alias_len, (void*)&mydata, sizeof(phar_archive_data*), ((void *)0), (1<<1) )) {
   if (options & 0x00000008) {
    if (error) {
...
# 1471 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_open_from_filename(char *fname, int fname_len, char *alias, int alias_len, int options, phar_archive_data** pphar, char **error )
{
 php_stream *fp;
 char *actual;
...
# 1734 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 1891 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_detect_phar_fname_ext(const char *filename, int filename_len, const char **ext_str, int *ext_len, int executable, int for_create, int is_complete )
{
...
woohoo:
   ...
   if ((phar_globals.manifest_cached) && SUCCESS == zend_hash_find(&cached_phars, (char *) filename, filename_len, (void **)&pphar)) {
    *ext_str = filename + (filename_len - (*pphar)->ext_len);
    goto woohoo;
   }
  } else {
   ...
   for (zend_hash_internal_pointer_reset_ex(&((&phar_globals)->phar_fname_map), ((void *)0));
    3 != zend_hash_get_current_key_ex(&((&phar_globals)->phar_fname_map), &str_key, &keylen, &unused, 0, ((void *)0));
    ...
    if (!memcmp(filename, str_key, keylen) && ((uint)filename_len == keylen
     ...
     if (FAILURE == zend_hash_get_current_data_ex(&((&phar_globals)->phar_fname_map), (void **) &pphar, ((void *)0))) {
      break;
     }
   ...
   if ((phar_globals.manifest_cached)) {
    for (zend_hash_internal_pointer_reset_ex(&cached_phars, ((void *)0));
     3 != zend_hash_get_current_key_ex(&cached_phars, &str_key, &keylen, &unused, 0, ((void *)0));
     ...
     if (!memcmp(filename, str_key, keylen) && ((uint)filename_len == keylen
      || filename[keylen] == '/' || filename[keylen] == '\0')) {
      if (FAILURE == zend_hash_get_current_data_ex(&cached_phars, (void **) &pphar, ((void *)0))) {
       break;
      }
      *ext_str = filename + (keylen - (*pphar)->ext_len);
      goto woohoo;
...
# 2120 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
char *phar_fix_filepath(char *path, int *new_len, int use_cwd )
{
 char *newpath;
 int newpath_len;
 ...
 if ((phar_globals.cwd_len) && use_cwd && path_length > 2 && path[0] == '.' && path[1] == '/') {
  ...
  newpath = _emalloc((strlen(path) + newpath_len + 1) );
  memcpy(newpath, (phar_globals.cwd), newpath_len);
 } else {
  newpath = _emalloc((strlen(path) + 2) );
  newpath[0] = '/';
  newpath_len = 1;
 }
 ...
 *new_len = newpath_len;
 newpath[newpath_len] = '\0';
 return _erealloc((newpath), (newpath_len + 1), 0 );
}
# 2234 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_split_fname(const char *filename, int filename_len, char **arch, int *arch_len, char **entry, int *entry_len, int executable, int for_create )
{
 const char *ext_str;
...
# 2489 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
...
# 2542 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_flush(phar_archive_data *phar, char *user_stub, long len, int convert, char **error )
{
 ...
 if (phar->metadata) {
  do { if ((basic_globals.serialize_lock) || !(basic_globals.serialize).level) { (metadata_hash) = (HashTable *) _emalloc((sizeof(HashTable)) ); _zend_hash_init(((metadata_hash)), (10), (((void *)0)), (0) ); if (!(basic_globals.serialize_lock)) { (basic_globals.serialize).var_hash = (void *)(metadata_hash); (basic_globals.serialize).level = 1; } } else { (metadata_hash) = (php_serialize_data_t)(basic_globals.serialize).var_hash; ++(basic_globals.serialize).level; } } while(0);
...
# 2905 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 3019 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
  mytime = time(((void *)0));
...
# 3162 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
   default: {
    char *digest = ((void *)0);
    int digest_len;
...
# 3291 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
static zend_op_array *phar_compile_file(zend_file_handle *file_handle, int type )
{
 ...
 if (failed) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c", 3375);
 }
...
void zm_globals_ctor_phar(zend_phar_globals *phar_globals )
{
 ...
 _zend_hash_init((&phar_globals->mime_types), (0), (((void *)0)), (1) );
...
void phar_request_initialize(void)
{
 if (!(&phar_globals)->request_init)
 {
  ...
  if ((phar_globals.manifest_cached)) {
   ...
   for (zend_hash_internal_pointer_reset_ex(&cached_phars, ((void *)0));
   zend_hash_get_current_data_ex(&cached_phars, (void **)&pphar, ((void *)0)) == SUCCESS;
   zend_hash_move_forward_ex(&cached_phars, ((void *)0))) {
...
void zm_info_phar(zend_module_entry *zend_module )
{
 ...
 php_info_print_table_row(2, "SVN revision", "$Id: 02776458f3b53f9c4694356ef19e77b32d03ecd3 $");
...
zend_module_entry phar_module_entry = {
 sizeof(zend_module_entry), 20131226, 0, 0, ((void *)0),
 phar_deps,
 "Phar",
 phar_functions,
 zm_startup_phar,
