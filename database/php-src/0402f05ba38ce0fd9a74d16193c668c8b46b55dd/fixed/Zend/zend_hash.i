# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c" 2
# 93 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c"
static void zend_hash_do_resize(HashTable *ht);

static uint32_t inline __attribute__((always_inline)) zend_hash_check_size(uint32_t nSize)
{
...
static void inline __attribute__((always_inline)) zend_hash_check_init(HashTable *ht, int packed)
{
 ;
 if (__builtin_expect(!!(!((ht)->u.flags & (1<<3))), 0)) {
...
{
 ;
 if (ht->nTableSize >= 0x80000000) {
  zend_error_noreturn((1<<0L), "Possible integer overflow in memory allocation (%zu * %zu + %zu)", ht->nTableSize * 2, sizeof(Bucket), sizeof(Bucket));
 }
 ;
 ht->nTableSize += ht->nTableSize;
 do { (ht)->arData = (Bucket*)(((char*)(((ht->u.flags & (1<<0))?__zend_realloc((((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)))), ((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t))))):_erealloc2(((((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))))), (((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t))))), ((((((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)) + ((size_t)(ht)->nNumUsed * sizeof(Bucket))))) )))) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
 ;
}
...
__attribute__ ((visibility("default"))) void zend_hash_packed_to_hash(HashTable *ht)
{
 void *new_data, *old_data = ((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)));
 Bucket *old_buckets = ht->arData;

 ;
 ;
 ht->u.flags &= ~(1<<2);
 new_data = (((ht)->u.flags & (1<<0))?__zend_malloc((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))):(__builtin_constant_p(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) ) ? ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-ht->nTableSize))) * sizeof(uint32_t)))) ) ));
 ht->nTableMask = -ht->nTableSize;
 do { (ht)->arData = (Bucket*)(((char*)(new_data)) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
 memcpy(ht->arData, old_buckets, sizeof(Bucket) * ht->nNumUsed);
 (((ht)->u.flags & (1<<0))?free(old_data):_efree((old_data) ));
 zend_hash_rehash(ht);
 ;
}
...
__attribute__ ((visibility("default"))) void zend_hash_to_packed(HashTable *ht)
{
 ...
 ;
 ;
 new_data = (((ht)->u.flags & (1<<0))?__zend_malloc((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))):(__builtin_constant_p(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) ) ? ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)((ht->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((((uint32_t) -2)))) * sizeof(uint32_t)))) ) ));
 ht->u.flags |= (1<<2) | (1<<4);
 ht->nTableMask = ((uint32_t) -2);
 do { (ht)->arData = (Bucket*)(((char*)(new_data)) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
 do { ((uint32_t*)((ht)->arData))[(int32_t)(-2)] = ((uint32_t) -1); ((uint32_t*)((ht)->arData))[(int32_t)(-1)] = ((uint32_t) -1); } while (0);
...
__attribute__ ((visibility("default"))) void zend_hash_extend(HashTable *ht, uint32_t nSize, zend_bool packed)
{
 ...
 if (__builtin_expect(!!(!((ht)->u.flags & (1<<3))), 0)) {
  ...
  if (packed) {
   do { if (__builtin_expect(!(ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0);
   if (nSize > ht->nTableSize) {
    ;
    ht->nTableSize = zend_hash_check_size(nSize);
    do { (ht)->arData = (Bucket*)(((char*)(((ht->u.flags & (1<<0))?__zend_realloc((((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)))), ((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t))))):_erealloc2(((((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))))), (((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t))))), ((((((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)) + ((size_t)(ht)->nNumUsed * sizeof(Bucket))))) )))) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
   ...
   if (nSize > ht->nTableSize) {
    ...
    ;
    new_data = ((ht->u.flags & (1<<0))?__zend_malloc((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))):(__builtin_constant_p(((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) ) ? ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)((nSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)((-nSize))) * sizeof(uint32_t)))) ) ));
    ht->nTableSize = nSize;
    ht->nTableMask = -ht->nTableSize;
    do { (ht)->arData = (Bucket*)(((char*)(new_data)) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
    memcpy(ht->arData, old_buckets, sizeof(Bucket) * ht->nNumUsed);
...
static uint32_t zend_array_recalc_elements(HashTable *ht)
{
    ...
    do { Bucket *_p = (ht)->arData; Bucket *_end = _p + (ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; val = _z; {
     if (zval_get_type(&(*(val))) == 0) continue;
     if (zval_get_type(&(*(val))) == 15) {
      if (__builtin_expect(!!(zval_get_type(&(*((*(val)).value.zv))) == 0), 0)) {
       num--;
      }
     }
       } } } while (0);
...
{
 uint32_t num;
 if (__builtin_expect(!!(ht->u.v.flags & (1<<5)), 0)) {
  num = zend_array_recalc_elements(ht);
  if (__builtin_expect(!!(ht->nNumOfElements == num), 0)) {
   ht->u.v.flags &= ~(1<<5);
  }
 } else if (__builtin_expect(!!(ht == &(executor_globals.symbol_table)), 0)) {
  num = zend_array_recalc_elements(ht);
 } else {
...
__attribute__ ((visibility("default"))) uint32_t zend_hash_iterator_add(HashTable *ht, HashPosition pos)
{
 ...
 HashTableIterator *end = iter + (executor_globals.ht_iterators_count);
 uint32_t idx;

 if (__builtin_expect(!!(ht->u.v.nIteratorsCount != 255), 1)) {
 ...
 while (iter != end) {
  if (iter->ht == ((void *)0)) {
   iter->ht = ht;
   iter->pos = pos;
   idx = iter - (executor_globals.ht_iterators);
   if (idx + 1 > (executor_globals.ht_iterators_used)) {
    (executor_globals.ht_iterators_used) = idx + 1;
   }
   return idx;
  }
  iter++;
 }
 if ((executor_globals.ht_iterators) == (executor_globals.ht_iterators_slots)) {
  (executor_globals.ht_iterators) = (__builtin_constant_p((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) ) ? (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 8) ? _emalloc_8() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 16) ? _emalloc_16() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 24) ? _emalloc_24() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 32) ? _emalloc_32() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 40) ? _emalloc_40() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 48) ? _emalloc_48() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 56) ? _emalloc_56() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 64) ? _emalloc_64() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 80) ? _emalloc_80() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 96) ? _emalloc_96() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 112) ? _emalloc_112() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 128) ? _emalloc_128() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 160) ? _emalloc_160() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 192) ? _emalloc_192() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 224) ? _emalloc_224() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 256) ? _emalloc_256() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 320) ? _emalloc_320() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 384) ? _emalloc_384() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 448) ? _emalloc_448() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 512) ? _emalloc_512() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 640) ? _emalloc_640() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 768) ? _emalloc_768() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 896) ? _emalloc_896() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8))) : _emalloc_huge((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) ) );
  memcpy((executor_globals.ht_iterators), (executor_globals.ht_iterators_slots), sizeof(HashTableIterator) * (executor_globals.ht_iterators_count));
 } else {
  (executor_globals.ht_iterators) = _erealloc(((executor_globals.ht_iterators)), (sizeof(HashTableIterator) * ((executor_globals.ht_iterators_count) + 8)) );
 }
 iter = (executor_globals.ht_iterators) + (executor_globals.ht_iterators_count);
 (executor_globals.ht_iterators_count) += 8;
 iter->ht = ht;
 iter->pos = pos;
...
__attribute__ ((visibility("default"))) HashPosition zend_hash_iterator_pos(uint32_t idx, HashTable *ht)
{
 HashTableIterator *iter = (executor_globals.ht_iterators) + idx;

 do { if (__builtin_expect(!(idx != (uint32_t)-1), 0)) __builtin_unreachable(); } while (0);
 if (iter->pos == ((uint32_t) -1)) {
  return ((uint32_t) -1);
 } else if (__builtin_expect(!!(iter->ht != ht), 0)) {
  if (__builtin_expect(!!(iter->ht), 1) && __builtin_expect(!!(iter->ht != ((HashTable *) (intptr_t) -1)), 1)
    && __builtin_expect(!!(iter->ht->u.v.nIteratorsCount != 255), 1)) {
...
__attribute__ ((visibility("default"))) HashPosition zend_hash_iterator_pos_ex(uint32_t idx, zval *array)
{
 ...
 if (iter->pos == ((uint32_t) -1)) {
  ...
  do { zval *_zv = (array); zend_array *_arr = (*(_zv)).value.arr; if ((_arr)->gc.refcount > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { (_arr)->gc.refcount--; } do { zval *__z = (_zv); (*(__z)).value.arr = (zend_array_dup(_arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0); } } while (0);
  ht = (*(array)).value.arr;
  if (__builtin_expect(!!(ht->u.v.nIteratorsCount != 255), 1)) {
   ht->u.v.nIteratorsCount++;
  }
...
__attribute__ ((visibility("default"))) void zend_hash_iterator_del(uint32_t idx)
{
 ...
 if (idx == (executor_globals.ht_iterators_used) - 1) {
  while (idx > 0 && (executor_globals.ht_iterators)[idx - 1].ht == ((void *)0)) {
   idx--;
  }
  (executor_globals.ht_iterators_used) = idx;
 }
}

static __attribute__((noinline)) void _zend_hash_iterators_remove(HashTable *ht)
{
 HashTableIterator *iter = (executor_globals.ht_iterators);
...
static inline __attribute__((always_inline)) void zend_hash_iterators_remove(HashTable *ht)
{
 if (__builtin_expect(!!(ht->u.v.nIteratorsCount), 0)) {
...
static inline __attribute__((always_inline)) Bucket *zend_hash_find_bucket(const HashTable *ht, zend_string *key)
{
 zend_ulong h;
 uint32_t nIndex;
 uint32_t idx;
 ...
 idx = ((uint32_t*)(arData))[(int32_t)(nIndex)];
 while (__builtin_expect(!!(idx != ((uint32_t) -1)), 1)) {
  p = ((arData) + (idx));
  if (__builtin_expect(!!(p->key == key), 1)) {
   return p;
  } else if (__builtin_expect(!!(p->h == h), 1) &&
       __builtin_expect(!!(p->key), 1) &&
       __builtin_expect(!!((p->key)->len == (key)->len), 1) &&
       __builtin_expect(!!(memcmp((p->key)->val, (key)->val, (key)->len) == 0), 1)) {
   return p;
  }
  idx = (p->val).u2.next;
 }
...
static inline __attribute__((always_inline)) Bucket *zend_hash_str_find_bucket(const HashTable *ht, const char *str, size_t len, zend_ulong h)
{
 uint32_t nIndex;
 uint32_t idx;
 Bucket *p, *arData;
 ...
 while (idx != ((uint32_t) -1)) {
  do { if (__builtin_expect(!(idx < (ht->nTableSize)), 0)) __builtin_unreachable(); } while (0);
  p = ((arData) + (idx));
  if ((p->h == h)
    && p->key
    && ((p->key)->len == len)
...
static inline __attribute__((always_inline)) Bucket *zend_hash_index_find_bucket(const HashTable *ht, zend_ulong h)
{
 uint32_t nIndex;
 uint32_t idx;
 Bucket *p, *arData;
...
static inline __attribute__((always_inline)) zval *_zend_hash_add_or_update_i(HashTable *ht, zend_string *key, zval *pData, uint32_t flag )
{
 zend_ulong h;
 uint32_t nIndex;
 uint32_t idx;
 ...
 if (__builtin_expect(!!(!(ht->u.flags & (1<<3))), 0)) {
  zend_hash_check_init(ht, 0);
  goto add_to_hash;
 } else if (ht->u.flags & (1<<2)) {
  ...
  if (p) {
   ...
   do { if (__builtin_expect(!(&p->val != pData), 0)) __builtin_unreachable(); } while (0);
   data = &p->val;
   if ((flag & (1<<2)) && zval_get_type(&(*(data))) == 15) {
    data = (*(data)).value.zv;
   }
   ;
   if (ht->pDestructor) {
   ...
   do { zval *_z1 = (data); const zval *_z2 = (pData); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   ;
   return data;
  }
 }

 if ((ht)->nNumUsed >= (ht)->nTableSize) { zend_hash_do_resize(ht); };

add_to_hash:
 ;
 idx = ht->nNumUsed++;
 ht->nNumOfElements++;
 if (ht->nInternalPointer == ((uint32_t) -1)) {
  ht->nInternalPointer = idx;
 }
 zend_hash_iterators_update(ht, ((uint32_t) -1), idx);
 p = ht->arData + idx;
 p->key = key;
 if (!((key)->gc.u.v.flags & (1<<1))) {
  zend_string_addref(key);
 ...
 p->h = h = (key)->h;
 do { zval *_z1 = (&p->val); const zval *_z2 = (pData); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 nIndex = h | ht->nTableMask;
 (p->val).u2.next = ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)];
 ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)] = (idx);
 ;
...
__attribute__ ((visibility("default"))) zval* _zend_hash_add_or_update(HashTable *ht, zend_string *key, zval *pData, uint32_t flag )
{
 return _zend_hash_add_or_update_i(ht, key, pData, flag );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_add(HashTable *ht, zend_string *key, zval *pData )
{
 return _zend_hash_add_or_update_i(ht, key, pData, (1<<1) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_update(HashTable *ht, zend_string *key, zval *pData )
{
 return _zend_hash_add_or_update_i(ht, key, pData, (1<<0) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_update_ind(HashTable *ht, zend_string *key, zval *pData )
{
 return _zend_hash_add_or_update_i(ht, key, pData, (1<<0) | (1<<2) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_add_new(HashTable *ht, zend_string *key, zval *pData )
{
 return _zend_hash_add_or_update_i(ht, key, pData, (1<<3) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_str_add_or_update(HashTable *ht, const char *str, size_t len, zval *pData, uint32_t flag )
{
 zend_string *key = zend_string_init(str, len, ht->u.flags & (1<<0));
 zval *ret = _zend_hash_add_or_update_i(ht, key, pData, flag );
 zend_string_release(key);
 return ret;
}

__attribute__ ((visibility("default"))) zval* _zend_hash_str_update(HashTable *ht, const char *str, size_t len, zval *pData )
{
 zend_string *key = zend_string_init(str, len, ht->u.flags & (1<<0));
 zval *ret = _zend_hash_add_or_update_i(ht, key, pData, (1<<0) );
 zend_string_release(key);
 return ret;
}

__attribute__ ((visibility("default"))) zval* _zend_hash_str_update_ind(HashTable *ht, const char *str, size_t len, zval *pData )
{
 zend_string *key = zend_string_init(str, len, ht->u.flags & (1<<0));
 zval *ret = _zend_hash_add_or_update_i(ht, key, pData, (1<<0) | (1<<2) );
 zend_string_release(key);
 return ret;
}

__attribute__ ((visibility("default"))) zval* _zend_hash_str_add(HashTable *ht, const char *str, size_t len, zval *pData )
{
 zend_string *key = zend_string_init(str, len, ht->u.flags & (1<<0));
 zval *ret = _zend_hash_add_or_update_i(ht, key, pData, (1<<1) );
 zend_string_release(key);
 return ret;
}

__attribute__ ((visibility("default"))) zval* _zend_hash_str_add_new(HashTable *ht, const char *str, size_t len, zval *pData )
{
 zend_string *key = zend_string_init(str, len, ht->u.flags & (1<<0));
 zval *ret = _zend_hash_add_or_update_i(ht, key, pData, (1<<3) );
...
__attribute__ ((visibility("default"))) zval* zend_hash_index_add_empty_element(HashTable *ht, zend_ulong h)
{
 ...
 return _zend_hash_index_add(ht, h, &dummy );
}
...
__attribute__ ((visibility("default"))) zval* zend_hash_add_empty_element(HashTable *ht, zend_string *key)
{
 ...
 do { (*(&dummy)).u1.type_info = 1; } while (0);
 return _zend_hash_add(ht, key, &dummy );
}

__attribute__ ((visibility("default"))) zval* zend_hash_str_add_empty_element(HashTable *ht, const char *str, size_t len)
{
 zval dummy;

 do { (*(&dummy)).u1.type_info = 1; } while (0);
 return _zend_hash_str_add(ht, str, len, &dummy );
}

static inline __attribute__((always_inline)) zval *_zend_hash_index_add_or_update_i(HashTable *ht, zend_ulong h, zval *pData, uint32_t flag )
{
 uint32_t nIndex;
 uint32_t idx;
 Bucket *p;
 ...
 if (__builtin_expect(!!(!(ht->u.flags & (1<<3))), 0)) {
  zend_hash_check_init(ht, h < ht->nTableSize);
  if (h < ht->nTableSize) {
   p = ht->arData + h;
   goto add_to_packed;
  }
  ...
  } else if (__builtin_expect(!!(h < ht->nTableSize), 1)) {
   p = ht->arData + h;
...
add_to_packed:
  ...
  if ((flag & ((1<<3)|(1<<4))) == ((1<<3)|(1<<4))) {
   ...
   if (h > ht->nNumUsed) {
    ...
    while (q != p) {
     do { (*(&q->val)).u1.type_info = 0; } while (0);
     q++;
    }
   }
   ht->nNumUsed = h + 1;
  ...
  zend_hash_iterators_update(ht, ((uint32_t) -1), h);
  if ((zend_long)h >= (zend_long)ht->nNextFreeElement) {
   ht->nNextFreeElement = h < (9223372036854775807L) ? h + 1 : (9223372036854775807L);
  }
  p->h = h;
...
__attribute__ ((visibility("default"))) zval* _zend_hash_index_add_or_update(HashTable *ht, zend_ulong h, zval *pData, uint32_t flag )
{
 return _zend_hash_index_add_or_update_i(ht, h, pData, flag );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_index_add(HashTable *ht, zend_ulong h, zval *pData )
{
 return _zend_hash_index_add_or_update_i(ht, h, pData, (1<<1) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_index_add_new(HashTable *ht, zend_ulong h, zval *pData )
{
 return _zend_hash_index_add_or_update_i(ht, h, pData, (1<<1) | (1<<3) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_index_update(HashTable *ht, zend_ulong h, zval *pData )
{
 return _zend_hash_index_add_or_update_i(ht, h, pData, (1<<0) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_next_index_insert(HashTable *ht, zval *pData )
{
 return _zend_hash_index_add_or_update_i(ht, ht->nNextFreeElement, pData, (1<<1) | (1<<4) );
}

__attribute__ ((visibility("default"))) zval* _zend_hash_next_index_insert_new(HashTable *ht, zval *pData )
{
 return _zend_hash_index_add_or_update_i(ht, ht->nNextFreeElement, pData, (1<<1) | (1<<3) | (1<<4) );
}
...
static void zend_hash_do_resize(HashTable *ht)
{
 ...
 if (ht->nNumUsed > ht->nNumOfElements + (ht->nNumOfElements >> 5)) {
  ...
  zend_hash_rehash(ht);
  ;
 } else if (ht->nTableSize < 0x80000000) {
  void *new_data, *old_data = ((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)));
  ...
  zend_error_noreturn((1<<0L), "Possible integer overflow in memory allocation (%zu * %zu + %zu)", ht->nTableSize * 2, sizeof(Bucket) + sizeof(uint32_t), sizeof(Bucket));
 }
}
...
__attribute__ ((visibility("default"))) int zend_hash_rehash(HashTable *ht)
{
 ...
 if (ht->nNumUsed == ht->nNumOfElements) {
  do {
   ...
   (p->val).u2.next = ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)];
   ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)] = (i);
   p++;
  } while (++i < ht->nNumUsed);
 } else {
  do {
   if (__builtin_expect(!!(zval_get_type(&(p->val)) == 0), 0)) {
    uint32_t j = i;
    Bucket *q = p;

    if (__builtin_expect(!!(ht->u.v.nIteratorsCount == 0), 1)) {
     while (++i < ht->nNumUsed) {
      p++;
      if (__builtin_expect(!!((p->val).u1.type_info != 0), 1)) {
       ...
       ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)] = (j);
       if (__builtin_expect(!!(ht->nInternalPointer == i), 0)) {
     ...
     while (++i < ht->nNumUsed) {
      ...
      if (__builtin_expect(!!((p->val).u1.type_info != 0), 1)) {
       ...
       if (__builtin_expect(!!(i == iter_pos), 0)) {
...
static inline __attribute__((always_inline)) void _zend_hash_del_el_ex(HashTable *ht, uint32_t idx, Bucket *p, Bucket *prev)
{
 ;
 if (!(ht->u.flags & (1<<2))) {
  if (prev) {
 ...
 if ((ht->nNumUsed - 1) == idx) {
  do {
   ht->nNumUsed--;
  } while (ht->nNumUsed > 0 && (__builtin_expect(!!(zval_get_type(&(ht->arData[ht->nNumUsed-1].val)) == 0), 0)));
 }
 ht->nNumOfElements--;
 if ((ht->nInternalPointer) == idx || __builtin_expect(!!(ht->u.v.nIteratorsCount), 0)) {
  uint32_t new_idx;
  ...
  while (1) {
   ...
   if (new_idx >= ht->nNumUsed) {
    new_idx = ((uint32_t) -1);
    break;
   } else if (zval_get_type(&(ht->arData[new_idx].val)) != 0) {
    break;
   }
  }
 ...
 if (ht->pDestructor) {
  zval tmp;
  do { zval *_z1 = (&tmp); const zval *_z2 = (&p->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
static inline __attribute__((always_inline)) void _zend_hash_del_el(HashTable *ht, uint32_t idx, Bucket *p)
{
 Bucket *prev = ((void *)0);
...
__attribute__ ((visibility("default"))) void zend_hash_del_bucket(HashTable *ht, Bucket *p)
{
 ;
 ;
 _zend_hash_del_el(ht, (p - ht->arData), p);
}
 ...
 while (idx != ((uint32_t) -1)) {
  ...
  if ((p->key == key) ||
   ...
   if (zval_get_type(&(p->val)) == 15) {
    zval *data = (p->val).value.zv;

    if (__builtin_expect(!!(zval_get_type(&(*(data))) == 0), 0)) {
     return FAILURE;
    } else {
     if (ht->pDestructor) {
      zval tmp;
      do { zval *_z1 = (&tmp); const zval *_z2 = (data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
__attribute__ ((visibility("default"))) int zend_hash_str_del_ind(HashTable *ht, const char *str, size_t len)
{
 zend_ulong h;
 uint32_t nIndex;
 uint32_t idx;
...
__attribute__ ((visibility("default"))) int zend_hash_str_del(HashTable *ht, const char *str, size_t len)
{
 zend_ulong h;
 uint32_t nIndex;
 uint32_t idx;
...
__attribute__ ((visibility("default"))) int zend_hash_index_del(HashTable *ht, zend_ulong h)
{
 ...
 if (ht->u.flags & (1<<2)) {
  if (h < ht->nNumUsed) {
   p = ht->arData + h;
   if (zval_get_type(&(p->val)) != 0) {
    _zend_hash_del_el_ex(ht, (h), p, ((void *)0));
    return SUCCESS;
   }
  }
  return FAILURE;
...
__attribute__ ((visibility("default"))) void zend_hash_destroy(HashTable *ht)
{
 ...
 ((ht->u.flags & (1<<0))?free(((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)))):_efree((((char*)((ht)->arData) - (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)))) ));
}
...
__attribute__ ((visibility("default"))) void zend_array_destroy(HashTable *ht)
{
 ...
 do { zend_refcounted *_p = (zend_refcounted*)(ht); if ((((_p)->gc.u.v.gc_info) & ~0xc000)) { gc_remove_from_buffer(_p); } } while (0);
 (ht)->gc.u.type_info = 1 | (0x8000 << 16);

 if (ht->nNumUsed) {

  if (__builtin_expect(!!(ht->pDestructor != _zval_ptr_dtor), 0)) {
...
free_ht:
 do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(ht); } else if (sizeof(HashTable) <= 16) { _efree_16(ht); } else if (sizeof(HashTable) <= 24) { _efree_24(ht); } else if (sizeof(HashTable) <= 32) { _efree_32(ht); } else if (sizeof(HashTable) <= 40) { _efree_40(ht); } else if (sizeof(HashTable) <= 48) { _efree_48(ht); } else if (sizeof(HashTable) <= 56) { _efree_56(ht); } else if (sizeof(HashTable) <= 64) { _efree_64(ht); } else if (sizeof(HashTable) <= 80) { _efree_80(ht); } else if (sizeof(HashTable) <= 96) { _efree_96(ht); } else if (sizeof(HashTable) <= 112) { _efree_112(ht); } else if (sizeof(HashTable) <= 128) { _efree_128(ht); } else if (sizeof(HashTable) <= 160) { _efree_160(ht); } else if (sizeof(HashTable) <= 192) { _efree_192(ht); } else if (sizeof(HashTable) <= 224) { _efree_224(ht); } else if (sizeof(HashTable) <= 256) { _efree_256(ht); } else if (sizeof(HashTable) <= 320) { _efree_320(ht); } else if (sizeof(HashTable) <= 384) { _efree_384(ht); } else if (sizeof(HashTable) <= 448) { _efree_448(ht); } else if (sizeof(HashTable) <= 512) { _efree_512(ht); } else if (sizeof(HashTable) <= 640) { _efree_640(ht); } else if (sizeof(HashTable) <= 768) { _efree_768(ht); } else if (sizeof(HashTable) <= 896) { _efree_896(ht); } else if (sizeof(HashTable) <= 1024) { _efree_1024(ht); } else if (sizeof(HashTable) <= 1280) { _efree_1280(ht); } else if (sizeof(HashTable) <= 1536) { _efree_1536(ht); } else if (sizeof(HashTable) <= 1792) { _efree_1792(ht); } else if (sizeof(HashTable) <= 2048) { _efree_2048(ht); } else if (sizeof(HashTable) <= 2560) { _efree_2560(ht); } else if (sizeof(HashTable) <= 3072) { _efree_3072(ht); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(ht, sizeof(HashTable)); } else { _efree_huge(ht, sizeof(HashTable)); } } else { _efree(ht); } } while (0);
}
...
# 1508 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.c"
__attribute__ ((visibility("default"))) void zend_hash_apply(HashTable *ht, apply_func_t apply_func)
{
 uint32_t idx;
 Bucket *p;
 ...
 if ((ht)->u.flags & (1<<1)) { if (((ht)->u.flags & 0xff00) >= (3 << 8)) { zend_error_noreturn((1<<0L), "Nesting level too deep - recursive dependency?"); } ((ht)->u.flags += (1 << 8)); };
 ...
 if ((ht)->u.flags & (1<<1)) { ((ht)->u.flags -= (1 << 8)); };
}
...
__attribute__ ((visibility("default"))) void zend_hash_copy(HashTable *target, HashTable *source, copy_ctor_func_t pCopyConstructor)
{
 ...
 setTargetPointer = (target->nInternalPointer == ((uint32_t) -1));
 for (idx = 0; idx < source->nNumUsed; idx++) {
  p = source->arData + idx;
  if (__builtin_expect(!!(zval_get_type(&(p->val)) == 0), 0)) continue;

  if (setTargetPointer && source->nInternalPointer == idx) {
   target->nInternalPointer = ((uint32_t) -1);
  }
  ...
  if (p->key) {
   new_entry = _zend_hash_update(target, p->key, data );
  } else {
   new_entry = _zend_hash_index_update(target, p->h, data );
  }
  if (pCopyConstructor) {
   pCopyConstructor(new_entry);
  }
 }
 if (target->nInternalPointer == ((uint32_t) -1) && target->nNumOfElements > 0) {
  idx = 0;
  while (zval_get_type(&(target->arData[idx].val)) == 0) {
   idx++;
  }
...
static inline __attribute__((always_inline)) int zend_array_dup_element(HashTable *source, HashTable *target, uint32_t idx, Bucket *p, Bucket *q, int packed, int static_keys, int with_holes)
{
 zval *data = &p->val;

 if (with_holes) {
  if (!packed && (*(data)).u1.type_info == 15) {
   data = (*(data)).value.zv;
  }
  if (__builtin_expect(!!((*(data)).u1.type_info == 0), 0)) {
   return 0;
  }
 } else if (!packed) {

  if ((*(data)).u1.type_info == 15) {
   data = (*(data)).value.zv;
   if (__builtin_expect(!!((*(data)).u1.type_info == 0), 0)) {
    return 0;
   }
 ...
 do {
  if ((((*(data)).u1.type_info & ((1<<2) << 8)) != 0)) {
   if ((zval_get_type(&(*(data))) == 10) && zval_refcount_p(data) == 1 &&
       (zval_get_type(&(*(&(*(data)).value.ref->val))) != 7 ||
 ...
 do { zval *_z1 = (&q->val); const zval *_z2 = (data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 ...
 if (packed) {
  ...
  (q->val).u2.next = ((uint32_t*)((target)->arData))[(int32_t)(nIndex)];
  ((uint32_t*)((target)->arData))[(int32_t)(nIndex)] = (idx);
 }
 return 1;
}

static inline __attribute__((always_inline)) void zend_array_dup_packed_elements(HashTable *source, HashTable *target, int with_holes)
{
...
static inline __attribute__((always_inline)) uint32_t zend_array_dup_elements(HashTable *source, HashTable *target, int static_keys, int with_holes)
{
    uint32_t idx = 0;
 Bucket *p = source->arData;
 Bucket *q = target->arData;
...
__attribute__ ((visibility("default"))) HashTable* zend_array_dup(HashTable *source)
{
 ...
 (target) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
 (target)->gc.refcount = 1;
 (target)->gc.u.type_info = 7;

 target->nTableSize = source->nTableSize;
 target->pDestructor = source->pDestructor;

 if (source->nNumUsed == 0) {
  target->u.flags = (source->u.flags & ~((1<<3)|(1<<2)|(1<<0))) | (1<<1) | (1<<4);
  target->nTableMask = ((uint32_t) -2);
  target->nNumUsed = 0;
  target->nNumOfElements = 0;
  target->nNextFreeElement = 0;
  target->nInternalPointer = ((uint32_t) -1);
  do { (target)->arData = (Bucket*)(((char*)(&uninitialized_bucket)) + (((size_t)(uint32_t)-(int32_t)((target)->nTableMask)) * sizeof(uint32_t))); } while (0);
 } else if ((source)->gc.u.v.flags & (1<<1)) {
  target->u.flags = (source->u.flags & ~(1<<0)) | (1<<1);
  target->nTableMask = source->nTableMask;
  target->nNumUsed = source->nNumUsed;
  target->nNumOfElements = source->nNumOfElements;
  target->nNextFreeElement = source->nNextFreeElement;
  do { (target)->arData = (Bucket*)(((char*)((__builtin_constant_p(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) ) ? ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) ) ))) + (((size_t)(uint32_t)-(int32_t)((target)->nTableMask)) * sizeof(uint32_t))); } while (0);
  target->nInternalPointer = source->nInternalPointer;
  memcpy(((char*)((target)->arData) - (((size_t)(uint32_t)-(int32_t)((target)->nTableMask)) * sizeof(uint32_t))), ((char*)((source)->arData) - (((size_t)(uint32_t)-(int32_t)((source)->nTableMask)) * sizeof(uint32_t))), ((((size_t)(uint32_t)-(int32_t)((source)->nTableMask)) * sizeof(uint32_t)) + ((size_t)(source)->nNumUsed * sizeof(Bucket))));
  ...
  do { (target)->arData = (Bucket*)(((char*)((__builtin_constant_p(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) ) ? ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) ) ))) + (((size_t)(uint32_t)-(int32_t)((target)->nTableMask)) * sizeof(uint32_t))); } while (0);
  target->nInternalPointer = source->nInternalPointer;
  do { ((uint32_t*)((target)->arData))[(int32_t)(-2)] = ((uint32_t) -1); ((uint32_t*)((target)->arData))[(int32_t)(-1)] = ((uint32_t) -1); } while (0);
  ...
  target->nInternalPointer = ((uint32_t) -1);
  do { (target)->arData = (Bucket*)(((char*)((__builtin_constant_p(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) ) ? ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)(((target)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((target)->nTableMask))) * sizeof(uint32_t)))) ) ))) + (((size_t)(uint32_t)-(int32_t)((target)->nTableMask)) * sizeof(uint32_t))); } while (0);
  memset(&((uint32_t*)((target)->arData))[(int32_t)((target)->nTableMask)], ((uint32_t) -1), (((size_t)(uint32_t)-(int32_t)((target)->nTableMask)) * sizeof(uint32_t)));

  if (target->u.flags & (1<<4)) {
  ...
  if (idx > 0 && target->nInternalPointer == ((uint32_t) -1)) {
...
__attribute__ ((visibility("default"))) void _zend_hash_merge(HashTable *target, HashTable *source, copy_ctor_func_t pCopyConstructor, zend_bool overwrite )
{
 ...
 Bucket *p;
 zval *t;
 uint32_t mode = (overwrite?(1<<0):(1<<1));
 ...
 for (idx = 0; idx < source->nNumUsed; idx++) {
  ...
  if (__builtin_expect(!!(zval_get_type(&(p->val)) == 0), 0)) continue;
  if (p->key) {
   t = _zend_hash_add_or_update(target, p->key, &p->val, mode );
   if (t && pCopyConstructor) {
    pCopyConstructor(t);
   }
  } else {
   if ((mode==(1<<0) || !zend_hash_index_exists(target, p->h))) {
     t = _zend_hash_index_update(target, p->h, &p->val );
     if (t && pCopyConstructor) {
     pCopyConstructor(t);
    }
   }
...
__attribute__ ((visibility("default"))) zval* zend_hash_find(const HashTable *ht, zend_string *key)
{
 ...
 p = zend_hash_find_bucket(ht, key);
 return p ? &p->val : ((void *)0);
}

__attribute__ ((visibility("default"))) zval* zend_hash_str_find(const HashTable *ht, const char *str, size_t len)
{
 zend_ulong h;
 Bucket *p;
...
__attribute__ ((visibility("default"))) zend_bool zend_hash_index_exists(const HashTable *ht, zend_ulong h)
{
 ...
 if (ht->u.flags & (1<<2)) {
  if (h < ht->nNumUsed) {
   if (zval_get_type(&(ht->arData[h].val)) != 0) {
    return 1;
   }
  }
  return 0;
...
__attribute__ ((visibility("default"))) void zend_hash_internal_pointer_reset_ex(HashTable *ht, HashPosition *pos)
{
 ...
 for (idx = 0; idx < ht->nNumUsed; idx++) {
  if (zval_get_type(&(ht->arData[idx].val)) != 0) {
   *pos = idx;
   return;
  }
 }
...
__attribute__ ((visibility("default"))) void zend_hash_get_current_key_zval_ex(const HashTable *ht, zval *key, HashPosition *pos)
{
 ...
 if (idx == ((uint32_t) -1)) {
  ...
  p = ht->arData + idx;
  if (p->key) {
   do { zval *__z = (key); zend_string *__s = (p->key); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
  } else {
   { zval *__z = (key); (*(__z)).value.lval = p->h; (*(__z)).u1.type_info = 4; };
  }
 }
}
...
__attribute__ ((visibility("default"))) void zend_hash_bucket_swap(Bucket *p, Bucket *q)
{
 ...
 do { zval *_z1 = (&val); const zval *_z2 = (&p->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 h = p->h;
 key = p->key;

 do { zval *_z1 = (&p->val); const zval *_z2 = (&q->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 p->h = q->h;
 p->key = q->key;

 do { zval *_z1 = (&q->val); const zval *_z2 = (&val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 q->h = h;
 q->key = key;
}
...
__attribute__ ((visibility("default"))) int zend_hash_sort_ex(HashTable *ht, sort_func_t sort, compare_func_t compar, zend_bool renumber)
{
 Bucket *p;
 uint32_t i, j;
 ...
 sort((void *)ht->arData, i, sizeof(Bucket), compar,
   (swap_func_t)(renumber? zend_hash_bucket_renum_swap :
    ((ht->u.flags & (1<<2)) ? zend_hash_bucket_packed_swap : zend_hash_bucket_swap)));
 ...
 if (ht->u.flags & (1<<2)) {
  ...
  if (renumber) {
   ...
   do { (ht)->arData = (Bucket*)(((char*)(new_data)) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
   memcpy(ht->arData, old_buckets, sizeof(Bucket) * ht->nNumUsed);
   ((ht->u.flags & (1<<0) & (1<<0))?free(old_data):_efree((old_data) ));
   do { ((uint32_t*)((ht)->arData))[(int32_t)(-2)] = ((uint32_t) -1); ((uint32_t*)((ht)->arData))[(int32_t)(-1)] = ((uint32_t) -1); } while (0);
  } else {
   zend_hash_rehash(ht);
  }
...
static inline __attribute__((always_inline)) int zend_hash_compare_impl(HashTable *ht1, HashTable *ht2, compare_func_t compar, zend_bool ordered) {
 uint32_t idx1, idx2;
 ...
 for (idx1 = 0, idx2 = 0; idx1 < ht1->nNumUsed; idx1++) {
  ...
  if (zval_get_type(&(p1->val)) == 0) continue;
  if (ordered) {
   while (1) {
    do { if (__builtin_expect(!(idx2 != ht2->nNumUsed), 0)) __builtin_unreachable(); } while (0);
    p2 = ht2->arData + idx2;
    if (zval_get_type(&(p2->val)) != 0) break;
    idx2++;
   }
   if (p1->key == ((void *)0) && p2->key == ((void *)0)) {
    if (p1->h != p2->h) {
     return p1->h > p2->h ? 1 : -1;
    }
   } else if (p1->key != ((void *)0) && p2->key != ((void *)0)) {
  ...
  pData1 = &p1->val;
  if (zval_get_type(&(*(pData1))) == 15) {
   pData1 = (*(pData1)).value.zv;
  }
  if (zval_get_type(&(*(pData2))) == 15) {
   pData2 = (*(pData2)).value.zv;
  }

  if (zval_get_type(&(*(pData1))) == 0) {
   if (zval_get_type(&(*(pData2))) != 0) {
    return -1;
   }
  } else if (zval_get_type(&(*(pData2))) == 0) {
   return 1;
  } else {
...
__attribute__ ((visibility("default"))) int zend_hash_compare(HashTable *ht1, HashTable *ht2, compare_func_t compar, zend_bool ordered)
{
 ...
 if ((ht1)->u.flags & (1<<1)) { if (((ht1)->u.flags & 0xff00) >= (3 << 8)) { zend_error_noreturn((1<<0L), "Nesting level too deep - recursive dependency?"); } ((ht1)->u.flags += (1 << 8)); };
 if ((ht2)->u.flags & (1<<1)) { if (((ht2)->u.flags & 0xff00) >= (3 << 8)) { zend_error_noreturn((1<<0L), "Nesting level too deep - recursive dependency?"); } ((ht2)->u.flags += (1 << 8)); };
 result = zend_hash_compare_impl(ht1, ht2, compar, ordered);
 if ((ht1)->u.flags & (1<<1)) { ((ht1)->u.flags -= (1 << 8)); };
 if ((ht2)->u.flags & (1<<1)) { ((ht2)->u.flags -= (1 << 8)); };
...
__attribute__ ((visibility("default"))) zval* zend_hash_minmax(const HashTable *ht, compare_func_t compar, uint32_t flag)
{
 ...
 while (1) {
  ...
  if (zval_get_type(&(ht->arData[idx].val)) != 0) break;
  idx++;
 }
 res = ht->arData + idx;
...
__attribute__ ((visibility("default"))) int _zend_handle_numeric_str_ex(const char *key, size_t length, zend_ulong *idx)
{
 ...
 do { if (__builtin_expect(!(*end == '\0'), 0)) __builtin_unreachable(); } while (0);
