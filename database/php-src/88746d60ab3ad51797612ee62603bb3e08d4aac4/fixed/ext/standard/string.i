...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 43 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
# 59 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 1
# 62 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 63 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 65 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 66 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
...
# 72 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c" 2
# 87 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void register_string_constants(int type, int module_number )
{
...
# 105 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 135 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
{
 struct lconv *res;
# 219 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
 res = localeconv();
...
# 256 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_bin2hex(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *result, *data;
 size_t newlen;
...
# 470 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
 zend_register_long_constant(("CRNCYSTR"), sizeof("CRNCYSTR"), (_NL_MONETARY_CRNCYSTR), ((1<<0) | (1<<1)), module_number );
# 515 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 539 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
void zif_nl_langinfo(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 switch(item) {
  ...
  case ALT_DIGITS:
# 647 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
  case _NL_MONETARY_CRNCYSTR:
# 691 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
  case RADIXCHAR:
  ...
  case __NOEXPR:
# 714 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
  case CODESET:
...
# 756 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 805 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) char *php_trim(char *c, int len, char *what, int what_len, zval *return_value, int mode )
{
 register int i;
 int trimmed = 0;
...
# 1143 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_implode(zval *delim, zval *arr, zval *return_value )
{
 zval **tmp;
 HashPosition pos;
...
# 1471 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
    } else {
     if (state == 0) {
      comp = c;
      state = 1;
...
# 1827 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_strpos(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 zval *needle;
 char *haystack;
...
# 2845 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
typedef struct {
 int B;
 int Bp;
 STRLEN m;
...
# 3442 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_stripcslashes(char *str, int *len)
{
...
# 3622 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) int php_char_to_str_ex(char *str, uint len, char from, char *to, int to_len, zval *result, int case_sensitivity, int *replace_count)
{
 int char_count = 0;
 int replaced = 0;
...
# 4530 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
int php_tag_find(char *tag, int len, char *set) {
 char c, *n, *t;
 int state=0, done=0;
 char *norm;
...
# 4611 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) size_t php_strip_tags_ex(char *rbuf, int len, int *stateptr, char *allow, int allow_len, zend_bool allow_tag_spaces)
{
...
# 5179 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 5439 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_str_word_count(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
