...
zend_brk_cont_element *get_next_brk_cont_element(zend_op_array *op_array)
{
 ...
 op_array->brk_cont_array = _erealloc((op_array->brk_cont_array), (sizeof(zend_brk_cont_element)*op_array->last_brk_cont) );
...
static void zend_resolve_fast_call(zend_op_array *op_array, uint32_t op_num)
{
 ...
 if (finally_op_num) {
  ...
  do { if (__builtin_expect(!(op_array->opcodes[finally_op_num - 2].opcode == 162), 0)) __builtin_unreachable(); } while (0);
...
__attribute__ ((visibility("default"))) int pass_two(zend_op_array *op_array)
{
 ...
 while (opline < end) {
  switch (opline->opcode) {
   ...
   case 140:
   case 145:
    opline->extended_value = (uint32_t)(zend_intptr_t)(((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(op_array->last_var + opline->extended_value))));
    break;
   case 254:
   case 255:
    {
