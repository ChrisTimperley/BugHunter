...
void shutdown_executor(void)
{
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
# 273 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
# 313 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
int zend_call_function(zend_fcall_info *fci, zend_fcall_info_cache *fci_cache)
{
 ...
 if (__builtin_expect(!!(func->op_array.fn_flags & 0x100000), 0)) {
  ...
  do { do { ((call)->This).u1.type_info |= (((1 << 5)) << 24); } while (0); } while (0);
 }
...
__attribute__ ((visibility("default"))) int zend_eval_stringl(char *str, size_t str_len, zval *retval_ptr, char *string_name)
{
 ...
 if (new_op_array) {
  ...
  { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
   ...
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c", 1108);
  } } (executor_globals.bailout) = __orig_bailout; };
...
__attribute__ ((visibility("default"))) __attribute__((noreturn)) void zend_timeout(int dummy)
{
 ...
 zend_error_noreturn((1<<0L), "Maximum execution time of %pd second%s exceeded", (executor_globals.timeout_seconds), (executor_globals.timeout_seconds) == 1 ? "" : "s");
}
...
static void zend_timeout_handler(int dummy)
{
 ...
 if (zend_on_timeout) {
# 1212 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
# 1248 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
static void zend_set_timeout_ex(zend_long seconds, int reset_signals)
{
# 1276 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 {
  ...
  if (reset_signals) {
   ...
   act.__sigaction_handler.sa_handler = zend_timeout_handler;
   sigemptyset(&act.sa_mask);
   act.sa_flags = 0x80000000 | 0x40000000;
   sigaction(signo, &act, ((void *)0));
...
{
# 1344 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
# 1448 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
__attribute__ ((visibility("default"))) zend_array *zend_rebuild_symbol_table(void)
{
 ...
 if ((((ex)->This).u1.type_info >> 24) & (1 << 4)) {
  return ex->symbol_table;
 }

 do { do { ((ex)->This).u1.type_info |= (((1 << 4)) << 24); } while (0); } while (0);
...
__attribute__ ((visibility("default"))) int zend_set_local_var(zend_string *name, zval *value, int force)
{
 ...
 if (execute_data) {
  if (!((((execute_data)->This).u1.type_info >> 24) & (1 << 4))) {
