...
# 526 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar_internal.h"
...
static void phar_split_cache_list(void)
{
 ...
 if (_zend_hash_init((&(executor_globals.regular_list)), (0), (((void *)0)), (((void *)0)), (0) ) == SUCCESS) {
...
woohoo:
   ...
   while (FAILURE != (zend_hash_get_current_key_type_ex(&((&phar_globals)->phar_fname_map), ((void *)0)) == 3 ? FAILURE : SUCCESS)) {
   ...
   if ((phar_globals.manifest_cached)) {
    ...
    while (FAILURE != (zend_hash_get_current_key_type_ex(&cached_phars, ((void *)0)) == 3 ? FAILURE : SUCCESS)) {
...
# 2142 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
char *phar_fix_filepath(char *path, int *new_len, int use_cwd )
{
 char *newpath;
 int newpath_len;
...
# 2256 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
int phar_split_fname(char *filename, int filename_len, char **arch, int *arch_len, char **entry, int *entry_len, int executable, int for_create )
{
 const char *ext_str;
...
# 2517 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c" 2
...
# 2570 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 2933 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
# 3047 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
  mytime = time(((void *)0));
...
# 3190 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
   default: {
    char *digest = ((void *)0);
    int digest_len;
...
# 3319 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c"
...
static zend_op_array *phar_compile_file(zend_file_handle *file_handle, int type )
{
 ...
 if (failed) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/phar/phar.c", 3403);
 }
...
zend_module_entry phar_module_entry = {
 sizeof(zend_module_entry), 20121212, 0, 0, ((void *)0),
 phar_deps,
 "Phar",
 phar_functions,
 zm_startup_phar,
