# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c"
# 72 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c"
...
# 73 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c" 2
...
# 74 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c" 2
...
# 78 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c" 2
...
# 81 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c" 2


extern zend_phpdbg_globals phpdbg_globals;

const phpdbg_command_t phpdbg_watch_commands[] = {
 {"array", sizeof("array")-1, "create watchpoint on an array", sizeof("create watchpoint on an array")-1, 'a', phpdbg_do_watch_array, &phpdbg_prompt_commands[24], "s", ((void *)0), 0},
 {"delete", sizeof("delete")-1, "delete watchpoint", sizeof("delete watchpoint")-1, 'd', phpdbg_do_watch_delete, &phpdbg_prompt_commands[24], "s", ((void *)0), 0},
 {"recursive", sizeof("recursive")-1, "create recursive watchpoints", sizeof("create recursive watchpoints")-1, 'r', phpdbg_do_watch_recursive, &phpdbg_prompt_commands[24], "s", ((void *)0), 0},
 {((void *)0), 0, ((void *)0), 0, '\0', ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0}
};
# 99 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c"
typedef struct {
 void *page;
 size_t size;
...
static phpdbg_watchpoint_t *phpdbg_check_for_watchpoint(void *addr) {
 phpdbg_watchpoint_t *watch;
 phpdbg_btree_result *result = phpdbg_btree_find_closest(&(phpdbg_globals.watchpoint_tree), (zend_ulong)phpdbg_get_page_boundary(addr) + phpdbg_pagesize - 1);
...
static inline void phpdbg_activate_watchpoint(phpdbg_watchpoint_t *watch) {
 phpdbg_change_watchpoint_access(watch, 0x1);
}

static inline void phpdbg_deactivate_watchpoint(phpdbg_watchpoint_t *watch) {
 phpdbg_change_watchpoint_access(watch, 0x1 | 0x2);
}

static inline void phpdbg_store_watchpoint(phpdbg_watchpoint_t *watch) {
 phpdbg_btree_insert_or_update(&(phpdbg_globals.watchpoint_tree), (zend_ulong) watch->addr.ptr, watch, 1);
}

static inline void phpdbg_remove_watchpoint(phpdbg_watchpoint_t *watch) {
 phpdbg_btree_delete(&(phpdbg_globals.watchpoint_tree), (zend_ulong) watch->addr.ptr);
}
...
void phpdbg_create_ht_watchpoint(HashTable *ht, phpdbg_watchpoint_t *watch) {
 phpdbg_create_addr_watchpoint(((char *) ht) + (sizeof(zend_refcounted *) + sizeof(uint32_t)), sizeof(HashTable) - (sizeof(zend_refcounted *) + sizeof(uint32_t)), watch);
...
static phpdbg_watchpoint_t *phpdbg_create_refcounted_watchpoint(phpdbg_watchpoint_t *parent, zend_refcounted *ref) {
 phpdbg_watchpoint_t *watch = (__builtin_constant_p((sizeof(phpdbg_watchpoint_t)) ) ? (((sizeof(phpdbg_watchpoint_t)) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_watchpoint_t)) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_watchpoint_t)) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_watchpoint_t)) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_watchpoint_t)) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_watchpoint_t)) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_watchpoint_t)) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_watchpoint_t)) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_watchpoint_t)) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_watchpoint_t)) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_watchpoint_t)) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_watchpoint_t)) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_watchpoint_t)) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_watchpoint_t)) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_watchpoint_t)) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_watchpoint_t)) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_watchpoint_t)) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_watchpoint_t)) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_watchpoint_t)) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_watchpoint_t)) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_watchpoint_t)) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_watchpoint_t)) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_watchpoint_t)) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_watchpoint_t)) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_watchpoint_t)) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_watchpoint_t)) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_watchpoint_t)) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_watchpoint_t)) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_watchpoint_t)) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_watchpoint_t)) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_watchpoint_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_watchpoint_t))) : _emalloc_huge((sizeof(phpdbg_watchpoint_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_watchpoint_t)) ) );
 watch->flags = parent->flags;
 watch->parent = parent;
 watch->str = parent->str;
 ++(parent->str)->gc.refcount;
 phpdbg_create_addr_watchpoint(&(ref)->gc.refcount, sizeof(uint32_t), watch);
...
static void phpdbg_add_watch_collision(phpdbg_watchpoint_t *watch) {
 ...
 do { if (__builtin_expect(!(((watch->flags & 0x02) == 0) ^ ((watch->flags & (0x10 | 0x01)) == 0)), 0)) __builtin_unreachable(); } while (0);

 if ((cur = zend_hash_index_find_ptr(&(phpdbg_globals.watch_collisions), (zend_ulong) watch->addr.ref))) {
  ...
  if ((old = zend_hash_find_ptr(&cur->watches, watch->str)) || (old = zend_hash_find_ptr(&cur->implicit_watches, watch->str))) {
   if (((old->flags ^ watch->flags) & ((0x01 | 0x02)|0x10)) == 0) {
    return;
   }
   ...
   if (flags & 0x02) {
    if (!(watch->flags & 0x02) && !--cur->refs) {
     phpdbg_delete_watchpoints_recursive(watch);
    }
   }
   if (flags & (0x01 | 0x02)) {
    zend_hash_del(&cur->watches, watch->str);
    if ((&cur->watches)->nNumOfElements > 0) {
     cur->watch = (*(zend_hash_get_current_data_ex(&cur->watches, ((void *)0)))).value.ptr;
    } else {
     cur->watch = (*(zend_hash_get_current_data_ex(&cur->implicit_watches, ((void *)0)))).value.ptr;
    }
   }
   if (flags & 0x10) {
  ...
  if (watch->flags & 0x02) {
   if (!(flags & 0x02) && !cur->refs++) {
    phpdbg_create_recursive_zval_watch(watch->parent);
   }
  }
 } else {
  phpdbg_watch_collision coll;
  coll.refs = (watch->flags & 0x02) != 0;
  coll.watch = watch;
  _zend_hash_init((&coll.watches), (8), (((void *)0)), (0) );
  _zend_hash_init((&coll.implicit_watches), (8), (((void *)0)), (0) );
  cur = zend_hash_index_add_mem(&(phpdbg_globals.watch_collisions), (zend_ulong) watch->addr.ref, &coll, sizeof(phpdbg_watch_collision));
...
static void phpdbg_remove_watch_collision(phpdbg_watchpoint_t *watch) {
 phpdbg_watch_collision *cur;
 if ((cur = zend_hash_index_find_ptr(&(phpdbg_globals.watch_collisions), (zend_ulong) (*(watch->addr.zv)).value.counted))) {
  ...
  if ((&cur->watches)->nNumOfElements > 0) {
   cur->watch = (*(zend_hash_get_current_data_ex(&cur->watches, ((void *)0)))).value.ptr;
  } else if ((&cur->implicit_watches)->nNumOfElements > 0) {
   cur->watch = (*(zend_hash_get_current_data_ex(&cur->implicit_watches, ((void *)0)))).value.ptr;
  } else {
   phpdbg_deactivate_watchpoint(cur->watch);
   phpdbg_remove_watchpoint(cur->watch);

   zend_hash_index_del(&(phpdbg_globals.watch_collisions), (zend_ulong) (*(watch->addr.zv)).value.counted);
  }
 }
}
...
static phpdbg_watchpoint_t *phpdbg_create_reference_watch(phpdbg_watchpoint_t *watch) {
 phpdbg_watchpoint_t *ref = (__builtin_constant_p((sizeof(phpdbg_watchpoint_t)) ) ? (((sizeof(phpdbg_watchpoint_t)) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_watchpoint_t)) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_watchpoint_t)) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_watchpoint_t)) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_watchpoint_t)) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_watchpoint_t)) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_watchpoint_t)) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_watchpoint_t)) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_watchpoint_t)) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_watchpoint_t)) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_watchpoint_t)) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_watchpoint_t)) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_watchpoint_t)) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_watchpoint_t)) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_watchpoint_t)) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_watchpoint_t)) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_watchpoint_t)) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_watchpoint_t)) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_watchpoint_t)) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_watchpoint_t)) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_watchpoint_t)) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_watchpoint_t)) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_watchpoint_t)) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_watchpoint_t)) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_watchpoint_t)) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_watchpoint_t)) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_watchpoint_t)) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_watchpoint_t)) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_watchpoint_t)) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_watchpoint_t)) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_watchpoint_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_watchpoint_t))) : _emalloc_huge((sizeof(phpdbg_watchpoint_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_watchpoint_t)) ) );
 watch->reference = ref;
 ref->flags = watch->flags;
 ref->str = watch->str;
 ++(ref->str)->gc.refcount;
 ref->parent = watch;
 ref->parent_container = ((void *)0);
 phpdbg_create_zval_watchpoint(&(*(watch->addr.zv)).value.ref->val, ref);
...
static phpdbg_watchpoint_t *phpdbg_get_refcount_watch(phpdbg_watchpoint_t *parent) {
 ...
 do { if (__builtin_expect(!(parent->type == WATCH_ON_ZVAL), 0)) __builtin_unreachable(); } while (0);
 ref = (*(parent->addr.zv)).value.counted;

 res = phpdbg_btree_find(&(phpdbg_globals.watchpoint_tree), (zend_ulong) ref);
 if (res) {
  return res->ptr;
 }
 return ((void *)0);
...
static phpdbg_watchpoint_t *phpdbg_create_watchpoint(phpdbg_watchpoint_t *watch) {
 ...
 if (watch->type == WATCH_ON_ZVAL) {
  switch (zval_get_type(&(*(watch->addr.zv)))) {
   case 1:
   case 0:
   case 3:
   case 2:
 ...
 if (!watch->parent || watch->parent->type != WATCH_ON_ZVAL || watch->type == WATCH_ON_HASHTABLE) {
  phpdbg_watchpoint_t *old_watch = zend_hash_find_ptr(&(phpdbg_globals.watchpoints), watch->str);

  if (old_watch) {
# 351 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_watch.c"
   if (watch->flags & 0x02) {
    if (old_watch->flags & 0x02) {
     { phpdbg_watchpoint_t *ref = phpdbg_get_refcount_watch(old_watch); if (ref) { phpdbg_add_watch_collision(ref); } if (watch != old_watch) { phpdbg_free_watch(watch); _efree((watch) ); } return (((void *)0)); };
    } else {
     old_watch->flags &= ~(0x01 | 0x10);
     old_watch->flags |= 0x02;
     { phpdbg_watchpoint_t *ref = phpdbg_get_refcount_watch(old_watch); if (ref) { phpdbg_add_watch_collision(ref); } if (watch != old_watch) { phpdbg_free_watch(watch); _efree((watch) ); } return (old_watch); };
    }
   } else {
    if (!(old_watch->flags & 0x02)) {
     old_watch->flags |= watch->flags & (0x10 | 0x01);
    }
    { phpdbg_watchpoint_t *ref = phpdbg_get_refcount_watch(old_watch); if (ref) { phpdbg_add_watch_collision(ref); } if (watch != old_watch) { phpdbg_free_watch(watch); _efree((watch) ); } return (((void *)0)); };
   }
  } else {
   ...
   zend_hash_add_ptr(&(phpdbg_globals.watchpoints), watch->str, watch);
  }
 }

 phpdbg_store_watchpoint(watch);

 if (watch->parent && watch->parent->type == WATCH_ON_ZVAL && (((*(watch->parent->addr.zv)).u1.v.type_flags & (1<<2)) != 0)) {
  phpdbg_add_watch_collision(phpdbg_create_refcounted_watchpoint(watch, (*(watch->parent->addr.zv)).value.counted));
 }
 ...
 if (watch->type == WATCH_ON_ZVAL) {
  if (watch->parent_container) {
   ...
   if (!(find = phpdbg_btree_find(&(phpdbg_globals.watch_HashTables), (zend_ulong) watch->parent_container))) {
    phpdbg_watch_ht_info *hti = (__builtin_constant_p((sizeof(*hti)) ) ? (((sizeof(*hti)) <= 8) ? _emalloc_8() : (((sizeof(*hti)) <= 16) ? _emalloc_16() : (((sizeof(*hti)) <= 24) ? _emalloc_24() : (((sizeof(*hti)) <= 32) ? _emalloc_32() : (((sizeof(*hti)) <= 40) ? _emalloc_40() : (((sizeof(*hti)) <= 48) ? _emalloc_48() : (((sizeof(*hti)) <= 56) ? _emalloc_56() : (((sizeof(*hti)) <= 64) ? _emalloc_64() : (((sizeof(*hti)) <= 80) ? _emalloc_80() : (((sizeof(*hti)) <= 96) ? _emalloc_96() : (((sizeof(*hti)) <= 112) ? _emalloc_112() : (((sizeof(*hti)) <= 128) ? _emalloc_128() : (((sizeof(*hti)) <= 160) ? _emalloc_160() : (((sizeof(*hti)) <= 192) ? _emalloc_192() : (((sizeof(*hti)) <= 224) ? _emalloc_224() : (((sizeof(*hti)) <= 256) ? _emalloc_256() : (((sizeof(*hti)) <= 320) ? _emalloc_320() : (((sizeof(*hti)) <= 384) ? _emalloc_384() : (((sizeof(*hti)) <= 448) ? _emalloc_448() : (((sizeof(*hti)) <= 512) ? _emalloc_512() : (((sizeof(*hti)) <= 640) ? _emalloc_640() : (((sizeof(*hti)) <= 768) ? _emalloc_768() : (((sizeof(*hti)) <= 896) ? _emalloc_896() : (((sizeof(*hti)) <= 1024) ? _emalloc_1024() : (((sizeof(*hti)) <= 1280) ? _emalloc_1280() : (((sizeof(*hti)) <= 1536) ? _emalloc_1536() : (((sizeof(*hti)) <= 1792) ? _emalloc_1792() : (((sizeof(*hti)) <= 2048) ? _emalloc_2048() : (((sizeof(*hti)) <= 2560) ? _emalloc_2560() : (((sizeof(*hti)) <= 3072) ? _emalloc_3072() : (((sizeof(*hti)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(*hti))) : _emalloc_huge((sizeof(*hti)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(*hti)) ) );
    hti->dtor = watch->parent_container->pDestructor;
    ht_watches = &hti->watches;
    _zend_hash_init((ht_watches), (0), (_zval_ptr_dtor), (0) );
    phpdbg_btree_insert_or_update(&(phpdbg_globals.watch_HashTables), (zend_ulong) watch->parent_container, hti, 1);
  ...
  if ((zval_get_type(&(*(watch->addr.zv))) == 10)) {
...
static int phpdbg_create_array_watchpoint(phpdbg_watchpoint_t *zv_watch) {
 ...
 phpdbg_watchpoint_t *watch = (__builtin_constant_p((sizeof(phpdbg_watchpoint_t)) ) ? (((sizeof(phpdbg_watchpoint_t)) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_watchpoint_t)) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_watchpoint_t)) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_watchpoint_t)) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_watchpoint_t)) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_watchpoint_t)) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_watchpoint_t)) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_watchpoint_t)) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_watchpoint_t)) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_watchpoint_t)) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_watchpoint_t)) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_watchpoint_t)) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_watchpoint_t)) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_watchpoint_t)) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_watchpoint_t)) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_watchpoint_t)) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_watchpoint_t)) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_watchpoint_t)) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_watchpoint_t)) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_watchpoint_t)) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_watchpoint_t)) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_watchpoint_t)) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_watchpoint_t)) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_watchpoint_t)) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_watchpoint_t)) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_watchpoint_t)) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_watchpoint_t)) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_watchpoint_t)) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_watchpoint_t)) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_watchpoint_t)) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_watchpoint_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_watchpoint_t))) : _emalloc_huge((sizeof(phpdbg_watchpoint_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_watchpoint_t)) ) );
 HashTable *ht = (zval_get_type(&(*(zv))) == 8 ? ((*(zv))).value.obj->handlers->get_properties(&(*(zv))) : zval_get_type(&(*(zv))) == 7 ? (*(zv)).value.arr : ((void *)0));
 ...
 if (phpdbg_create_watchpoint(watch) == ((void *)0)) {
  return SUCCESS;
 }

 if (zval_get_type(&(*(zv))) == 7) {
  watch->flags |= 0x04;
 } else {
  watch->flags |= 0x08;
 }

 phpdbg_add_watch_collision(phpdbg_create_refcounted_watchpoint(watch, (*(zv)).value.counted));
...
static int phpdbg_create_recursive_ht_watch(phpdbg_watchpoint_t *watch) {
 ...
 do { if (__builtin_expect(!(watch->type == WATCH_ON_HASHTABLE), 0)) __builtin_unreachable(); } while (0);

 do { Bucket *_p = (((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->arData; Bucket *_end = _p + (((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; h = _p->h; key = _p->key; zv = _z; {
  phpdbg_watchpoint_t *new_watch = (__builtin_constant_p((sizeof(phpdbg_watchpoint_t)) ) ? (((sizeof(phpdbg_watchpoint_t)) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_watchpoint_t)) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_watchpoint_t)) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_watchpoint_t)) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_watchpoint_t)) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_watchpoint_t)) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_watchpoint_t)) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_watchpoint_t)) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_watchpoint_t)) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_watchpoint_t)) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_watchpoint_t)) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_watchpoint_t)) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_watchpoint_t)) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_watchpoint_t)) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_watchpoint_t)) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_watchpoint_t)) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_watchpoint_t)) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_watchpoint_t)) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_watchpoint_t)) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_watchpoint_t)) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_watchpoint_t)) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_watchpoint_t)) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_watchpoint_t)) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_watchpoint_t)) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_watchpoint_t)) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_watchpoint_t)) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_watchpoint_t)) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_watchpoint_t)) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_watchpoint_t)) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_watchpoint_t)) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_watchpoint_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_watchpoint_t))) : _emalloc_huge((sizeof(phpdbg_watchpoint_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_watchpoint_t)) ) );

  new_watch->flags = 0x02;
  new_watch->parent = watch;
  new_watch->parent_container = ((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t))));

  if (key) {
   new_watch->name_in_parent = key;
   ++(key)->gc.refcount;
  } else {
   new_watch->name_in_parent = strpprintf(0, "%" "l" "d", h);
  }

  new_watch->str = strpprintf(0, "%.*s%s%s%s", (int) (watch->str)->len - 2, (watch->str)->val, (watch->flags & 0x04) ? "[" : "->", phpdbg_get_property_key((new_watch->name_in_parent)->val), (watch->flags & 0x04) ? "]" : "");

  while (zval_get_type(&(*(zv))) == 15) {
   zv = (*(zv)).value.zv;
  }
...
static int phpdbg_create_recursive_zval_watch(phpdbg_watchpoint_t *watch) {
 ...
 do { if (__builtin_expect(!(watch->type == WATCH_ON_ZVAL), 0)) __builtin_unreachable(); } while (0);

 zvp = watch->addr.zv;
 do { if (__builtin_expect(!!((zval_get_type(&(*(zvp))) == 10)), 0)) { (zvp) = &(*(zvp)).value.ref->val; } } while (0);

 if ((ht = (zval_get_type(&(*(zvp))) == 8 ? ((*(zvp))).value.obj->handlers->get_properties(&(*(zvp))) : zval_get_type(&(*(zvp))) == 7 ? (*(zvp)).value.arr : ((void *)0)))) {
  phpdbg_watchpoint_t *new_watch = (__builtin_constant_p((sizeof(phpdbg_watchpoint_t)) ) ? (((sizeof(phpdbg_watchpoint_t)) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_watchpoint_t)) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_watchpoint_t)) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_watchpoint_t)) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_watchpoint_t)) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_watchpoint_t)) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_watchpoint_t)) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_watchpoint_t)) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_watchpoint_t)) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_watchpoint_t)) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_watchpoint_t)) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_watchpoint_t)) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_watchpoint_t)) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_watchpoint_t)) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_watchpoint_t)) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_watchpoint_t)) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_watchpoint_t)) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_watchpoint_t)) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_watchpoint_t)) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_watchpoint_t)) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_watchpoint_t)) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_watchpoint_t)) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_watchpoint_t)) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_watchpoint_t)) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_watchpoint_t)) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_watchpoint_t)) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_watchpoint_t)) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_watchpoint_t)) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_watchpoint_t)) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_watchpoint_t)) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_watchpoint_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_watchpoint_t))) : _emalloc_huge((sizeof(phpdbg_watchpoint_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_watchpoint_t)) ) );
  ...
  ++(new_watch->name_in_parent)->gc.refcount;
  new_watch->str = strpprintf(0, "%.*s[]", (int) (watch->str)->len, (watch->str)->val);

  if (zval_get_type(&(*(zvp))) == 7) {
   new_watch->flags |= 0x04;
  } else {
   new_watch->flags |= 0x08;
  }
...
static void phpdbg_delete_implicit_parents(phpdbg_watchpoint_t *watch) {
 ...
 do { if (__builtin_expect(!(!(parent->flags & 0x02)), 0)) __builtin_unreachable(); } while (0);
 do { if (__builtin_expect(!(parent->flags & 0x10), 0)) __builtin_unreachable(); } while (0);
 ...
 if (!(parent->flags & 0x01)) {
  if (parent->type == WATCH_ON_ZVAL && (((*(watch->addr.zv)).u1.v.type_flags & (1<<2)) != 0)) {
   phpdbg_remove_watch_collision(parent);
  }
  zend_hash_del(&(phpdbg_globals.watchpoints), parent->str);
 }
}
...
static int phpdbg_delete_watchpoint_recursive(phpdbg_watchpoint_t *watch, zend_bool user_request) {
 if (watch->type == WATCH_ON_HASHTABLE) {
  if (user_request) {
   ...
   ht = (zval_get_type(&(*(watch->addr.zv))) == 8 ? ((*(watch->addr.zv))).value.obj->handlers->get_properties(&(*(watch->addr.zv))) : zval_get_type(&(*(watch->addr.zv))) == 7 ? (*(watch->addr.zv)).value.arr : ((void *)0));

   if ((result = phpdbg_btree_find(&(phpdbg_globals.watchpoint_tree), (zend_ulong) ht))) {
 ...
 return zend_hash_del(&(phpdbg_globals.watchpoints), watch->str);
}
...
static void phpdbg_delete_ht_watchpoints_recursive(phpdbg_watchpoint_t *watch) {
 ...
 do { Bucket *_p = (((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->arData; Bucket *_end = _p + (((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; numkey = _p->h; strkey = _p->key; {
  if (strkey) {
   str = strpprintf(0, "%.*s%s%s%s", (int) (watch->str)->len, (watch->str)->val, (watch->flags & 0x04) ? "[" : "->", phpdbg_get_property_key((strkey)->val), (watch->flags & 0x04) ? "]" : "");
  } else {
   str = strpprintf(0, "%.*s%s" "%" "l" "d" "%s", (int) (watch->str)->len, (watch->str)->val, (watch->flags & 0x04) ? "[" : "->", numkey, (watch->flags & 0x04) ? "]" : "");
  }

  if ((watchpoint = zend_hash_find_ptr(&(phpdbg_globals.watchpoints), str))) {
...
static void phpdbg_delete_zval_watchpoints_recursive(phpdbg_watchpoint_t *watch) {
 if ((((*(watch->addr.zv)).u1.v.type_flags & (1<<2)) != 0)) {
...
static int phpdbg_delete_watchpoint(phpdbg_watchpoint_t *tmp_watch) {
 ...
 if ((result = phpdbg_btree_find(&(phpdbg_globals.watchpoint_tree), (zend_ulong) tmp_watch->addr.ptr)) == ((void *)0)) {
  return FAILURE;
 }

 watch = result->ptr;

 if (!(watch->flags & (0x01 | 0x02)) || (watch->parent && (watch->parent->flags & 0x02))) {
  return FAILURE;
 }
 ...
 if (watch->flags & 0x02) {
  ...
  ret = zend_hash_del(&(phpdbg_globals.watchpoints), watch->str);
 }
...
static int phpdbg_watchpoint_parse_wrapper(char *name, size_t namelen, char *key, size_t keylen, HashTable *parent, zval *zv, int (*callback)(phpdbg_watchpoint_t *)) {
 int ret;
 phpdbg_watchpoint_t *watch = _ecalloc((1), (sizeof(phpdbg_watchpoint_t)) );
 ...
 (phpdbg_globals.watch_tmp) = ((void *)0);

 return ret;
}

__attribute__ ((visibility("default"))) int phpdbg_watchpoint_parse_input(char *input, size_t len, HashTable *parent, size_t i, int (*callback)(phpdbg_watchpoint_t *), zend_bool silent) {
 return phpdbg_parse_variable_with_arg(input, len, parent, i, (phpdbg_parse_var_with_arg_func) phpdbg_watchpoint_parse_wrapper, ((void *)0), 0, callback);
}
...
static int phpdbg_watchpoint_parse_step(char *name, size_t namelen, char *key, size_t keylen, HashTable *parent, zval *zv, int (*callback)(phpdbg_watchpoint_t *)) {
 ...
 if ((watch = zend_hash_str_find_ptr(&(phpdbg_globals.watchpoints), name, namelen))) {
  watch->flags |= 0x10;
  (phpdbg_globals.watch_tmp) = watch;
  return SUCCESS;
 }

 watch = _ecalloc((1), (sizeof(phpdbg_watchpoint_t)) );
 watch->flags = 0x10;
 watch->str = zend_string_init(name, namelen, 0);
 watch->name_in_parent = zend_string_init(key, keylen, 0);
 watch->parent_container = parent;
 watch->parent = (phpdbg_globals.watch_tmp);
 phpdbg_create_zval_watchpoint(zv, watch);
...
static int phpdbg_watchpoint_parse_symtables(char *input, size_t len, int (*callback)(phpdbg_watchpoint_t *)) {
 if ((executor_globals.scope) && len >= 5 && !memcmp("$this", input, 5)) {
  _zend_hash_str_add((executor_globals.current_execute_data)->symbol_table, ("this"), (sizeof("this")-1), &(executor_globals.current_execute_data)->This );
 }

 if (phpdbg_is_auto_global(input, len) && phpdbg_watchpoint_parse_input(input, len, &(executor_globals.symbol_table), 0, callback, 1) != FAILURE) {
  return SUCCESS;
 }

 return phpdbg_parse_variable_with_arg(input, len, (executor_globals.current_execute_data)->symbol_table, 0, (phpdbg_parse_var_with_arg_func) phpdbg_watchpoint_parse_wrapper, (phpdbg_parse_var_with_arg_func) phpdbg_watchpoint_parse_step, 0, callback);
}
 ...
 switch (param->type) {
  case STR_PARAM:
   if (phpdbg_delete_var_watchpoint(param->str, param->len) == FAILURE) {
    phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "watchdelete", "type=\"nowatch\"", "Nothing was deleted, no corresponding watchpoint found");
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watchdelete", "variable=\"%.*s\"", "Removed watchpoint %.*s", (int) param->len, param->str);
   }
   break;
 ...
 switch (param->type) {
  case STR_PARAM:
   if (phpdbg_watchpoint_parse_symtables(param->str, param->len, phpdbg_create_recursive_watchpoint) != FAILURE) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watchrecursive", "variable=\"%.*s\"", "Set recursive watchpoint on %.*s", (int)param->len, param->str);
   }
   break;
 ...
 switch (param->type) {
  case STR_PARAM:
   if (phpdbg_watchpoint_parse_symtables(param->str, param->len, phpdbg_create_array_watchpoint) != FAILURE) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watcharray", "variable=\"%.*s\"", "Set array watchpoint on %.*s", (int)param->len, param->str);
   }
   break;
...
void phpdbg_watch_HashTable_dtor(zval *zv) {
 ...
 if ((result = phpdbg_btree_find(&(phpdbg_globals.watchpoint_tree), (zend_ulong) zv))) {
  phpdbg_watchpoint_t *watch = result->ptr;

  if (watch->flags & (0x01 | 0x02)) {
   (phpdbg_globals.watchpoint_hit) = 1;

   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watchdelete", "variable=\"%.*s\" recursive=\"%s\"", "%.*s was removed, removing watchpoint%s", (int) (watch->str)->len, (watch->str)->val, (watch->flags & 0x02) ? " recursively" : "");
  }

  if ((result = phpdbg_btree_find(&(phpdbg_globals.watch_HashTables), (zend_ulong) watch->parent_container))) {
   phpdbg_watch_ht_info *hti = result->ptr;
   hti->dtor(orig_zv);
   zend_hash_del(&hti->watches, watch->name_in_parent);
   if ((&hti->watches)->nNumOfElements == 0) {
    watch->parent_container->pDestructor = hti->dtor;
    zend_hash_destroy(&hti->watches);
    phpdbg_btree_delete(&(phpdbg_globals.watch_HashTables), (zend_ulong) watch->parent_container);
    _efree((hti) );
   }
  } else {
   _zval_ptr_dtor(orig_zv);
  }

  if (watch->flags & 0x02) {
   phpdbg_delete_watchpoint_recursive(watch, 0);
  } else {
   zend_hash_del(&(phpdbg_globals.watchpoints), watch->str);
  }
 }
}
...
int phpdbg_delete_var_watchpoint(char *input, size_t len) {
 ...
 return phpdbg_watchpoint_parse_input(input, len, (executor_globals.current_execute_data)->symbol_table, 0, phpdbg_delete_watchpoint, 0);
}
...
int phpdbg_watchpoint_segfault_handler(siginfo_t *info, void *context) {
 ...
 mprotect(page, size, 0x1 | 0x2);

 dump = malloc((sizeof(phpdbg_watch_memdump) - sizeof(void *) + (size)));
 dump->page = page;
 dump->size = size;
 ...
 zend_llist_add_element(&(phpdbg_globals.watchlist_mem), &dump);

 return SUCCESS;
}

void phpdbg_watchpoints_clean(void) {
 zend_hash_clean(&(phpdbg_globals.watchpoints));
}


static void phpdbg_watch_dtor(zval *pDest) {
 phpdbg_watchpoint_t *watch = (phpdbg_watchpoint_t *) (*(pDest)).value.ptr;
 ...
 if (watch->flags & 0x10) {
  ...
  if (watch->type == WATCH_ON_ZVAL) {
   ...
   do { Bucket *_p = (&((phpdbg_watch_ht_info *) phpdbg_btree_find(&(phpdbg_globals.watch_HashTables), (zend_ulong) ((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->ptr)->watches)->arData; Bucket *_end = _p + (&((phpdbg_watch_ht_info *) phpdbg_btree_find(&(phpdbg_globals.watch_HashTables), (zend_ulong) ((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->ptr)->watches)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; watchpoint = (*(_z)).value.ptr; {
    phpdbg_delete_watchpoint_recursive(watchpoint, 1);
   } } } while (0);
  }
 }
...
static void phpdbg_watch_mem_dtor(void *llist_data) {
 ...
 if (dump->reenable_writing) {
  mprotect(dump->page, dump->size, 0x1);
 }
...
void phpdbg_setup_watchpoints(void) {
 ...
 phpdbg_pagesize = 4096;


 zend_llist_init(&(phpdbg_globals.watchlist_mem), sizeof(void *), phpdbg_watch_mem_dtor, 1);
 phpdbg_btree_init(&(phpdbg_globals.watchpoint_tree), sizeof(void *) * 8);
 phpdbg_btree_init(&(phpdbg_globals.watch_HashTables), sizeof(void *) * 8);
 _zend_hash_init((&(phpdbg_globals.watchpoints)), (8), (phpdbg_watch_dtor), (0) );
 _zend_hash_init((&(phpdbg_globals.watch_collisions)), (8), (phpdbg_watch_free_ptr_dtor), (0) );
}

static void phpdbg_print_changed_zval(phpdbg_watch_memdump *dump) {

 phpdbg_btree_position pos = phpdbg_btree_find_between(&(phpdbg_globals.watchpoint_tree), (zend_ulong) dump->page, (zend_ulong) dump->page + dump->size);
 phpdbg_btree_result *result;
 int elementDiff;
 void *curTest;
 ...
 while ((result = phpdbg_btree_next(&pos))) {
  ...
  if ((watch->type == WATCH_ON_HASHTABLE || watch->type == WATCH_ON_ZVAL) && watch->parent_container) {
   if ((curTest = zend_symtable_find(watch->parent_container, watch->name_in_parent))) {
    while (zval_get_type(&(*((zval *) curTest))) == 15) {
     curTest = (*((zval *) curTest)).value.zv;
    }

    if (watch->type == WATCH_ON_HASHTABLE) {
     switch (zval_get_type(&(*((zval *) curTest)))) {
      case 7:
       curTest = (void *) (*((zval *) curTest)).value.arr;
       break;
      case 8:
       curTest = (void *) ((*((zval *) curTest))).value.obj->handlers->get_properties(&(*((zval *) curTest)));
       break;
     }
    }
...

  {
   ...
   switch (watch->type) {
    case WATCH_ON_ZVAL:
     do_break = memcmp(oldPtr, watch->addr.zv, sizeof(zend_value) + sizeof(uint32_t) ) != 0;
     if (!do_break) {
      goto end;
     }
     break;
    case WATCH_ON_HASHTABLE:
     do_break = (((HashTable *) (((char *) (oldPtr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->nNumOfElements != (((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->nNumOfElements;
     if (!do_break) {
      goto end;
     }
     break;
    case WATCH_ON_REFCOUNTED:
     do_break = memcmp(oldPtr, watch->addr.ref, sizeof(uint32_t) ) != 0;
     if (!do_break) {
      goto end;
     }
     if (!((phpdbg_globals.flags) & (1ULL<<33))) {
      do_break = 0;
     }
     break;
   }
   ...
   if (do_break) {
    ...
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watchhit", "variable=\"%s\"", "Breaking on watchpoint %.*s", (int) (watch->str)->len, (watch->str)->val);
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<watchdata %r>");
   }

   switch (watch->type) {
    case WATCH_ON_ZVAL: {
     zend_bool show_value = memcmp(oldPtr, watch->addr.zv, sizeof(zend_value) + sizeof(uint32_t) ) != 0;

     if ((watch->flags & (0x01 | 0x02)) && (removed || show_value)) {

      if ((((*((zval *) oldPtr)).u1.v.type_flags & (1<<2)) != 0)) {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchvalue", "type=\"old\" inaccessible=\"inaccessible\"", "Old value inaccessible or destroyed");
      } else {
       phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Old value: ");
       phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<watchvalue %r type=\"old\">");
       zend_print_flat_zval_r((zval *) oldPtr);
       phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</watchvalue>");
     ...
     if (removed) {
      if (watch->flags & (0x01 | 0x02)) {
       phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watchdelete", "variable=\"%.*s\"", "Watchpoint %.*s was unset, removing watchpoint", (int) (watch->str)->len, (watch->str)->val);
      }
      zend_hash_del(&(phpdbg_globals.watchpoints), watch->str);
     ...
     if ((watch->flags & (0x01 | 0x02)) && show_value) {
      phpdbg_out_internal((phpdbg_globals.io)[1].fd, "New value%s: ", (zval_get_type(&(*(watch->addr.zv))) == 10) ? " (reference)" : "");
      phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<watchvalue %r%s type=\"new\">", (zval_get_type(&(*(watch->addr.zv))) == 10) ? " reference=\"reference\"" : "");
     ...
     if ((*(watch->addr.zv)).value.ptr != (*((zval *) oldPtr)).value.ptr || zval_get_type(&(*(watch->addr.zv))) != zval_get_type(&(*((zval *) oldPtr)))) {
      if ((((*((zval *) oldPtr)).u1.v.type_flags & (1<<2)) != 0)) {
      ...
      if ((((*(watch->addr.zv)).u1.v.type_flags & (1<<2)) != 0)) {
       if ((watch->flags & (0x01 | 0x02)) && ((phpdbg_globals.flags) & (1ULL<<33))) {
        phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchrefcount", "type=\"new\" refcount=\"%d\"", "New refcount: %d", zval_refcount_p(watch->addr.zv));
       }
       if (watch->flags & 0x02) {
        phpdbg_create_recursive_watchpoint(watch);
       } else if ((zval_get_type(&(*(watch->addr.zv))) == 10)) {
    ...
    case WATCH_ON_HASHTABLE:
     ...
     elementDiff = (((HashTable *) (((char *) (oldPtr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->nNumOfElements - (((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t)))))->nNumOfElements;
     if ((watch->flags & (0x01 | 0x02)) && elementDiff) {
      if (elementDiff > 0) {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchsize", "removed=\"%d\"", "%d elements were removed from the array", elementDiff);
      } else {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchsize", "added=\"%d\"", "%d elements were added to the array", -elementDiff);
      }
     }
     ...
     if ((watch->flags & (0x01 | 0x02)) && ((HashTable *) (((char *) ((watch)->addr.ptr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t))))->nInternalPointer != ((HashTable *) (((char *) (oldPtr)) - (sizeof(zend_refcounted *) + sizeof(uint32_t))))->nInternalPointer) {
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watcharrayptr", "", "Internal pointer of array was changed");
     }
     break;
    case WATCH_ON_REFCOUNTED: {
     if ((watch->flags & (0x01 | 0x02)) && ((phpdbg_globals.flags) & (1ULL<<33))) {
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchrefcount", "type=\"old\" refcount=\"%d\"", "Old refcount: %d", ((zend_refcounted *) oldPtr)->gc.refcount);
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchrefcount", "type=\"new\" refcount=\"%d\"", "New refcount: %d", (watch->addr.ref)->gc.refcount);
     }
     break;
    }
   }
   ...
   if (do_break) {
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</watchdata>");
   }
  } end:
...
int phpdbg_print_changed_zvals(void) {
 ...
 if (zend_llist_count(&(phpdbg_globals.watchlist_mem)) == 0) {
  return FAILURE;
 }

 dump = (phpdbg_watch_memdump **) zend_llist_get_last_ex(&(phpdbg_globals.watchlist_mem), &pos);

 do {
  phpdbg_print_changed_zval(*dump);
 } while ((dump = (phpdbg_watch_memdump **) zend_llist_get_prev_ex(&(phpdbg_globals.watchlist_mem), &pos)));

 zend_llist_clean(&(phpdbg_globals.watchlist_mem));

 ret = (phpdbg_globals.watchpoint_hit) ? SUCCESS : FAILURE;
 (phpdbg_globals.watchpoint_hit) = 0;
...
void phpdbg_list_watchpoints(void) {
 ...
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<watchlist %r>");

 do { Bucket *_p = (&(phpdbg_globals.watchpoints))->arData; Bucket *_end = _p + (&(phpdbg_globals.watchpoints))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; watch = (*(_z)).value.ptr; {
  if (watch->flags & (0x01 | 0x02)) {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "watchvariable", "variable=\"%.*s\" on=\"%s\" type=\"%s\"", "%.*s (%s, %s)", (int) (watch->str)->len, (watch->str)->val, watch->type == WATCH_ON_HASHTABLE ? "array" : watch->type == WATCH_ON_REFCOUNTED ? "refcount" : "variable", watch->flags == 0x02 ? "recursive" : "simple");
  }
 } } } while (0);

 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</watchlist>");
}

void phpdbg_watch_efree(void *ptr) {
 phpdbg_btree_result *result;

 result = phpdbg_btree_find_closest(&(phpdbg_globals.watchpoint_tree), (zend_ulong) ptr);
 ...
 if (result) {
  ...
  if ((size_t) watch->addr.ptr + watch->size > (size_t) ptr) {
   if (watch->type == WATCH_ON_REFCOUNTED) {
    ...
    if (watch->type == WATCH_ON_HASHTABLE && (watch->flags & 0x01)) {

     phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "watchdelete", "variable=\"%.*s\" recursive=\"%s\"", "Array %.*s was removed, removing watchpoint%s", (int) (watch->str)->len, (watch->str)->val, (watch->flags & 0x02) ? " recursively" : "");
    }
    if (watch->type == WATCH_ON_HASHTABLE || watch->parent == ((void *)0) || watch->parent->type != WATCH_ON_ZVAL) {
     zend_hash_del(&(phpdbg_globals.watchpoints), watch->str);
    }
   }
  }
 ...
 if ((phpdbg_globals.original_free_function)) {
  (phpdbg_globals.original_free_function)(ptr);
 }
}
