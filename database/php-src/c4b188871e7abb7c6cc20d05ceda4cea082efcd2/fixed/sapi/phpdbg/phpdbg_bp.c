# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.h" 1
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c" 2
...
{
 zend_hash_index_update_ptr(&(phpdbg_globals.bp)[10], id, table);
}
# 61 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_bp.c"
static void phpdbg_file_breaks_dtor(zval *data)
{
 phpdbg_breakfile_t *bp = (phpdbg_breakfile_t*) (*(data)).value.ptr;

 _efree(((char*)bp->filename) );
 _efree((bp) );
}

static void phpdbg_class_breaks_dtor(zval *data)
{
 phpdbg_breakmethod_t *bp = (phpdbg_breakmethod_t *) (*(data)).value.ptr;

 _efree(((char*)bp->class_name) );
 _efree(((char*)bp->func_name) );
 _efree((bp) );
}

static void phpdbg_opline_class_breaks_dtor(zval *data)
{
 zend_hash_destroy((*(data)).value.arr);
 _efree(((*(data)).value.arr) );
}

static void phpdbg_opline_breaks_dtor(zval *data)
{
 phpdbg_breakopline_t *bp = (phpdbg_breakopline_t *) (*(data)).value.ptr;
...
__attribute__ ((visibility("default"))) void phpdbg_reset_breakpoints(void)
{
 ...
 do { Bucket *_p = (&(phpdbg_globals.bp)[10])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[10])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; table = (*(_z)).value.ptr; {
  phpdbg_breakbase_t *brake;

  do { Bucket *_p = (table)->arData; Bucket *_end = _p + (table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
   brake->hits = 0;
  } } } while (0);
 } } } while (0);
}
 ...
 *str = "";
 ...
 if ((&(phpdbg_globals.bp)[10])->nNumOfElements) {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "exportbreakpoint", "count=\"%d\"", "Exporting %d breakpoints", (&(phpdbg_globals.bp)[10])->nNumOfElements);


  do { Bucket *_p = (&(phpdbg_globals.bp)[10])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[10])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; id = _p->h; table = (*(_z)).value.ptr; {
   phpdbg_breakbase_t *brake;
   ...
   do { Bucket *_p = (table)->arData; Bucket *_end = _p + (table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
    if (brake->id == id) {
     ...
     switch (brake->type) {
      case 0: {
       _phpdbg_asprintf(&new_str, "%sbreak %s:%lu\n", *str, ((phpdbg_breakfile_t*)brake)->filename, ((phpdbg_breakfile_t*)brake)->line)
      ...
      case 2: {
       _phpdbg_asprintf(&new_str, "%sbreak %s\n", *str, ((phpdbg_breaksymbol_t*)brake)->symbol)

                                               ;
      } break;

      case 4: {
       _phpdbg_asprintf(&new_str, "%sbreak %s::%s\n", *str, ((phpdbg_breakmethod_t*)brake)->class_name, ((phpdbg_breakmethod_t*)brake)->func_name)
      ...
      case 8: {
       _phpdbg_asprintf(&new_str, "%sbreak %s::%s#%llu\n", *str, ((phpdbg_breakopline_t*)brake)->class_name, ((phpdbg_breakopline_t*)brake)->func_name, ((phpdbg_breakopline_t*)brake)->opline_num)
      ...
      case 7: {
       _phpdbg_asprintf(&new_str, "%sbreak %s#%llu\n", *str, ((phpdbg_breakopline_t*)brake)->func_name, ((phpdbg_breakopline_t*)brake)->opline_num)
      ...
      case 9: {
       _phpdbg_asprintf(&new_str, "%sbreak %s:#%llu\n", *str, ((phpdbg_breakopline_t*)brake)->class_name, ((phpdbg_breakopline_t*)brake)->opline_num)
      ...
      case 6: {
       _phpdbg_asprintf(&new_str, "%sbreak %s\n", *str, ((phpdbg_breakop_t*)brake)->name)
      ...
      case 5: {
       ...
       if (conditional->paramed) {
        switch (conditional->param.type) {
         case STR_PARAM:
          _phpdbg_asprintf(&new_str, "%sbreak at %s if %s\n", *str, conditional->param.str, conditional->code)
                                                                                    ;
         break;

         case METHOD_PARAM:
          _phpdbg_asprintf(&new_str, "%sbreak at %s::%s if %s\n", *str, conditional->param.method.class, conditional->param.method.name, conditional->code)
         ...
         case FILE_PARAM:
          _phpdbg_asprintf(&new_str, "%sbreak at %s:%lu if %s\n", *str, conditional->param.file.name, conditional->param.file.line, conditional->code)
        ...
        _phpdbg_asprintf(&new_str, "%sbreak if %s\n", str, conditional->code);
       }
      } break;
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_file(const char *path, long line_num)
{
 ...
 HashTable *broken, *file_breaks = &(phpdbg_globals.bp)[0];
 phpdbg_breakfile_t new_break;
 size_t path_len = 0L;

 if (tsrm_realpath(path, realpath)) {
  path = realpath;
 }
 ...
 if (!zend_hash_str_exists(&(phpdbg_globals.file_sources), path, path_len)) {
  if (_php_stream_stat_path((path), 0, (&ssb), ((void *)0)) == FAILURE) {
   if (original_path[0] == '/') {
    phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"nofile\" add=\"fail\" file=\"%s\"", "Cannot stat %s, it does not exist", original_path);
    return;
   }

   file_breaks = &(phpdbg_globals.bp)[1];
   path = original_path;
   path_len = strlen(path);
   pending = 1;
  } else if (!(ssb.sb.st_mode & (0100000|0120000))) {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"notregular\" add=\"fail\" file=\"%s\"", "Cannot set breakpoint in %s, it is not a regular file", path);
   return;
  } else {
   ;
  }
 ...
 if (!(broken = zend_hash_find_ptr(file_breaks, path_str))) {
  HashTable breaks;
  _zend_hash_init((&breaks), (8), (phpdbg_file_breaks_dtor), (0) );

  broken = zend_hash_add_mem(file_breaks, path_str, &breaks, sizeof(HashTable));
 }

 if (!zend_hash_index_exists(broken, line_num)) {
  do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 0; new_break.disabled = 0; new_break.hits = 0; } while(0);
  new_break.filename = _estrndup((path), (path_len) );
  new_break.line = line_num;

  zend_hash_index_update_mem(broken, line_num, &new_break, sizeof(phpdbg_breakfile_t));

  _phpdbg_break_mapping(new_break.id, broken);

  if (pending) {
   zend_string *file;
   do { Bucket *_p = (&(phpdbg_globals.file_sources))->arData; Bucket *_end = _p + (&(phpdbg_globals.file_sources))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; file = _p->key; {
    HashTable *fileht;

    ;

    if (!(pending = ((fileht = phpdbg_resolve_pending_file_break_ex((file)->val, (file)->len, path_str, broken)) == ((void *)0)))) {
  ...
  if (pending) {
   (phpdbg_globals.flags) |= (1ULL<<2);

   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "add=\"success\" id=\"%d\" file=\"%s\" line=\"%ld\" pending=\"pending\"", "Pending breakpoint #%d added at %s:%ld", new_break.id, new_break.filename, new_break.line);
  } else {
   (phpdbg_globals.flags) |= (1ULL<<1);

   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "add=\"success\" id=\"%d\" file=\"%s\" line=\"%ld\"", "Breakpoint #%d added at %s:%ld", new_break.id, new_break.filename, new_break.line);
  }
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" add=\"fail\" file=\"%s\" line=\"%ld\"", "Breakpoint at %s:%ld exists", path, line_num);
 }
...
__attribute__ ((visibility("default"))) HashTable *phpdbg_resolve_pending_file_break_ex(const char *file, uint filelen, zend_string *cur, HashTable *fileht)
{
 ...
 if ((((cur)->len < filelen && (file[filelen - (cur)->len - 1] == '/' || 0)) || filelen == (cur)->len) && !memcmp(file + filelen - (cur)->len, (cur)->val, (cur)->len)) {
  phpdbg_breakfile_t *brake, new_brake;
  HashTable *master;

  (phpdbg_globals.flags) |= (1ULL<<1);

  if (!(master = zend_hash_str_find_ptr(&(phpdbg_globals.bp)[0], file, filelen))) {
   HashTable new_ht;
   _zend_hash_init((&new_ht), (8), (phpdbg_file_breaks_dtor), (0) );
   master = zend_hash_str_add_mem(&(phpdbg_globals.bp)[0], file, filelen, &new_ht, sizeof(HashTable));
  }

  do { Bucket *_p = (fileht)->arData; Bucket *_end = _p + (fileht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
   new_brake = *brake;
   new_brake.filename = _estrndup((file), (filelen) );
   zend_hash_index_del(&(phpdbg_globals.bp)[10], (brake->id));

   if (zend_hash_index_add_mem(master, brake->line, &new_brake, sizeof(phpdbg_breakfile_t))) {
    _phpdbg_break_mapping(brake->id, master);
   }
  } } } while (0);

  zend_hash_del(&(phpdbg_globals.bp)[1], cur);

  if (!(&(phpdbg_globals.bp)[1])->nNumOfElements) {
   (phpdbg_globals.flags) &= ~(1ULL<<2);
  }
...
__attribute__ ((visibility("default"))) void phpdbg_resolve_pending_file_break(const char *file)
{
 ...
 do { Bucket *_p = (&(phpdbg_globals.bp)[1])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[1])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; cur = _p->key; fileht = (*(_z)).value.ptr; {
  ;
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_symbol(const char *name, size_t name_len)
{
 char *lcname;
 ...
 if (!zend_hash_str_exists(&(phpdbg_globals.bp)[2], name, name_len)) {
  phpdbg_breaksymbol_t new_break;

  (phpdbg_globals.flags) |= (1ULL<<3);

  do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 2; new_break.disabled = 0; new_break.hits = 0; } while(0);
  new_break.symbol = _estrndup((name), (name_len) );

  zend_hash_str_update_mem(&(phpdbg_globals.bp)[2], lcname, name_len, &new_break, sizeof(phpdbg_breaksymbol_t));

  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "add=\"success\" id=\"%d\" function=\"%s\"", "Breakpoint #%d added at %s", new_break.id, new_break.symbol);

  _phpdbg_break_mapping(new_break.id, &(phpdbg_globals.bp)[2]);
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" add=\"fail\" function=\"%s\"", "Breakpoint exists at %s", name);
 }
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_method(const char *class_name, const char *func_name)
{
 ...
 if (!(class_table = zend_hash_str_find_ptr(&(phpdbg_globals.bp)[4], class_lcname, class_len))) {
  _zend_hash_init((&class_breaks), (8), (phpdbg_class_breaks_dtor), (0) );
  class_table = zend_hash_str_update_mem(&(phpdbg_globals.bp)[4], class_lcname, class_len, &class_breaks, sizeof(HashTable));
 }

 if (!zend_hash_str_exists(class_table, func_lcname, func_len)) {
  phpdbg_breakmethod_t new_break;

  (phpdbg_globals.flags) |= (1ULL<<5);

  do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 4; new_break.disabled = 0; new_break.hits = 0; } while(0);
  new_break.class_name = _estrndup((class_name), (class_len) );
  new_break.class_len = class_len;
  new_break.func_name = _estrndup((func_name), (func_len) );
  new_break.func_len = func_len;

  zend_hash_str_update_mem(class_table, func_lcname, func_len, &new_break, sizeof(phpdbg_breakmethod_t));

  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "add=\"success\" id=\"%d\" method=\"%s::%s\"", "Breakpoint #%d added at %s::%s", new_break.id, class_name, func_name);

  _phpdbg_break_mapping(new_break.id, class_table);
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" add=\"fail\" method=\"%s::%s\"", "Breakpoint exists at %s::%s", class_name, func_name);
 }
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_opline(zend_ulong opline)
{
 if (!zend_hash_index_exists(&(phpdbg_globals.bp)[3], opline)) {
  phpdbg_breakline_t new_break;

  (phpdbg_globals.flags) |= (1ULL<<4);

  do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 3; new_break.disabled = 0; new_break.hits = 0; } while(0);
  new_break.name = ((void *)0);
  new_break.opline = opline;
  new_break.base = ((void *)0);

  zend_hash_index_update_mem(&(phpdbg_globals.bp)[3], opline, &new_break, sizeof(phpdbg_breakline_t));

  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "add=\"success\" id=\"%d\" opline=\"%#lx\"", "Breakpoint #%d added at %#lx", new_break.id, new_break.opline);
  _phpdbg_break_mapping(new_break.id, &(phpdbg_globals.bp)[3]);
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" add=\"fail\" opline=\"%#lx\"", "Breakpoint exists at %#lx", opline);
 }
}
...
__attribute__ ((visibility("default"))) int phpdbg_resolve_op_array_break(phpdbg_breakopline_t *brake, zend_op_array *op_array)
{
 ...
 if (op_array->last <= brake->opline_num) {
  if (brake->class_name == ((void *)0)) {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"maxoplines\" add=\"fail\" maxoplinenum=\"%d\" function=\"%s\" usedoplinenum=\"%ld\"", "There are only %d oplines in function %s (breaking at opline %ld impossible)", op_array->last, brake->func_name, brake->opline_num);
  } else if (brake->func_name == ((void *)0)) {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"maxoplines\" add=\"fail\" maxoplinenum=\"%d\" file=\"%s\" usedoplinenum=\"%ld\"", "There are only %d oplines in file %s (breaking at opline %ld impossible)", op_array->last, brake->class_name, brake->opline_num);
  } else {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"maxoplines\" add=\"fail\" maxoplinenum=\"%d\" method=\"%s::%s\" usedoplinenum=\"%ld\"", "There are only %d oplines in method %s::%s (breaking at opline %ld impossible)", op_array->last, brake->class_name, brake->func_name, brake->opline_num);
  }
 ...
 zend_hash_index_update_mem(&(phpdbg_globals.bp)[3], opline_break.opline, &opline_break, sizeof(phpdbg_breakline_t));
...
__attribute__ ((visibility("default"))) void phpdbg_resolve_op_array_breaks(zend_op_array *op_array)
{
 HashTable *func_table = &(phpdbg_globals.bp)[7];
 HashTable *oplines_table;
 phpdbg_breakopline_t *brake;

 if (op_array->scope != ((void *)0) && !(func_table = zend_hash_find_ptr(&(phpdbg_globals.bp)[8], op_array->scope->name))) {
  return;
 }

 if (op_array->function_name == ((void *)0)) {
  if (!(oplines_table = zend_hash_find_ptr(&(phpdbg_globals.bp)[9], op_array->filename))) {
   return;
  }
 ...
 do { Bucket *_p = (oplines_table)->arData; Bucket *_end = _p + (oplines_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
  if (phpdbg_resolve_op_array_break(brake, op_array) == SUCCESS) {
   phpdbg_breakline_t *opline_break;

   zend_hash_internal_pointer_end_ex(&(phpdbg_globals.bp)[3], &(&(phpdbg_globals.bp)[3])->nInternalPointer);
   opline_break = zend_hash_get_current_data_ptr_ex(&(phpdbg_globals.bp)[3], &(&(phpdbg_globals.bp)[3])->nInternalPointer);

   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "add=\"success\" id=\"%d\" symbol=\"%s\" num=\"%ld\" opline=\"%#lx\"", "Breakpoint #%d resolved at %s%s%s#%ld (opline %#lx)", opline_break->id, brake->class_name ? brake->class_name : "", brake->class_name && brake->func_name ? "::" : "", brake->func_name ? brake->func_name : "", brake->opline_num, opline_break->opline)
...
__attribute__ ((visibility("default"))) int phpdbg_resolve_opline_break(phpdbg_breakopline_t *new_break)
{
 HashTable *func_table = (executor_globals.function_table);
 zend_function *func;

 if (new_break->func_name == ((void *)0)) {
  if ((executor_globals.current_execute_data) == ((void *)0)) {
   if ((phpdbg_globals.ops) != ((void *)0) && !memcmp((phpdbg_globals.ops)->filename, new_break->class_name, new_break->class_len)) {
    if (phpdbg_resolve_op_array_break(new_break, (phpdbg_globals.ops)) == SUCCESS) {
     return SUCCESS;
    } else {
     return 2;
    }
   ...
   do {
    if (((execute_data->func->common.type & 1) == 0)) {
     zend_op_array *op_array = &execute_data->func->op_array;
     if (op_array->function_name == ((void *)0) && op_array->scope == ((void *)0) && new_break->class_len == (op_array->filename)->len && !memcmp((op_array->filename)->val, new_break->class_name, new_break->class_len)) {
   ...
   } while ((execute_data = execute_data->prev_execute_data) != ((void *)0));
   return FAILURE;
  }
 }

 if (new_break->class_name != ((void *)0)) {
  zend_class_entry *ce;
  if (!(ce = zend_hash_str_find_ptr((executor_globals.class_table), zend_str_tolower_dup(new_break->class_name, new_break->class_len), new_break->class_len))) {
   return FAILURE;
  }
 ...
 if (!(func = zend_hash_str_find_ptr(func_table, zend_str_tolower_dup(new_break->func_name, new_break->func_len), new_break->func_len))) {
  if (new_break->class_name != ((void *)0) && new_break->func_name != ((void *)0)) {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"nomethod\" method=\"%s::%s\"", "Method %s doesn't exist in class %s", new_break->func_name, new_break->class_name);
   return 2;
  }
  return FAILURE;
 }
 ...
 if (func->type != 2) {
  if (new_break->class_name == ((void *)0)) {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"internalfunction\" function=\"%s\"", "%s is not a user defined function, no oplines exist", new_break->func_name);
  } else {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"internalfunction\" method=\"%s::%s\"", "%s::%s is not a user defined method, no oplines exist", new_break->class_name, new_break->func_name);
  }
  return 2;
 }
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_method_opline(const char *class, const char *method, zend_ulong opline)
{
 ...
 do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 8; new_break.disabled = 0; new_break.hits = 0; } while(0);
 new_break.func_len = strlen(method);
 new_break.func_name = _estrndup((method), (new_break.func_len) );
 new_break.class_len = strlen(class);
 new_break.class_name = _estrndup((class), (new_break.class_len) );
 new_break.opline_num = opline;
 new_break.opline = 0;

 switch (phpdbg_resolve_opline_break(&new_break)) {
  case FAILURE:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "pending=\"pending\" id=\"%d\" method=\"%::%s\" num=\"%ld\"", "Pending breakpoint #%d at %s::%s#%ld", new_break.id, new_break.class_name, new_break.func_name, opline);
   break;

  case SUCCESS:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" method=\"%::%s\" num=\"%ld\"", "Breakpoint #%d added at %s::%s#%ld", new_break.id, new_break.class_name, new_break.func_name, opline);
   break;
 ...
 if (!(class_table = zend_hash_str_find_ptr(&(phpdbg_globals.bp)[8], new_break.class_name, new_break.class_len))) {
  _zend_hash_init((&class_breaks), (8), (phpdbg_opline_class_breaks_dtor), (0) );
  class_table = zend_hash_str_update_mem(&(phpdbg_globals.bp)[8], new_break.class_name, new_break.class_len, &class_breaks, sizeof(HashTable));
 }

 if (!(method_table = zend_hash_str_find_ptr(class_table, new_break.func_name, new_break.func_len))) {
  _zend_hash_init((&method_breaks), (8), (phpdbg_opline_breaks_dtor), (0) );
 ...
 if (zend_hash_index_exists(method_table, opline)) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" method=\"%s\" num=\"%ld\"", "Breakpoint already exists for %s::%s#%ld", new_break.class_name, new_break.func_name, opline);
  _efree(((char*)new_break.func_name) );
  _efree(((char*)new_break.class_name) );
  (phpdbg_globals.bp_count)--;
  return;
 }

 (phpdbg_globals.flags) |= (1ULL<<9);

 _phpdbg_break_mapping(new_break.id, method_table);
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_function_opline(const char *function, zend_ulong opline)
{
 ...
 do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 7; new_break.disabled = 0; new_break.hits = 0; } while(0);
 new_break.func_len = strlen(function);
 new_break.func_name = _estrndup((function), (new_break.func_len) );
 new_break.class_len = 0;
 new_break.class_name = ((void *)0);
 new_break.opline_num = opline;
 new_break.opline = 0;

 switch (phpdbg_resolve_opline_break(&new_break)) {
  case FAILURE:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "pending=\"pending\" id=\"%d\" function=\"%s\" num=\"%ld\"", "Pending breakpoint #%d at %s#%ld", new_break.id, new_break.func_name, opline);
   break;

  case SUCCESS:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" function=\"%s\" num=\"%ld\"", "Breakpoint #%d added at %s#%ld", new_break.id, new_break.func_name, opline);
   break;
 ...
 if (!(func_table = zend_hash_str_find_ptr(&(phpdbg_globals.bp)[7], new_break.func_name, new_break.func_len))) {
  _zend_hash_init((&func_breaks), (8), (phpdbg_opline_breaks_dtor), (0) );
  func_table = zend_hash_str_update_mem(&(phpdbg_globals.bp)[7], new_break.func_name, new_break.func_len, &func_breaks, sizeof(HashTable));
 }

 if (zend_hash_index_exists(func_table, opline)) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" function=\"%s\" num=\"%ld\"", "Breakpoint already exists for %s#%ld", new_break.func_name, opline);
  _efree(((char*)new_break.func_name) );
  (phpdbg_globals.bp_count)--;
  return;
 }

 _phpdbg_break_mapping(new_break.id, func_table);

 (phpdbg_globals.flags) |= (1ULL<<8);
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_file_opline(const char *file, zend_ulong opline)
{
 ...
 do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 9; new_break.disabled = 0; new_break.hits = 0; } while(0);
 new_break.func_len = 0;
 new_break.func_name = ((void *)0);
 new_break.class_len = strlen(file);
 new_break.class_name = _estrndup((file), (new_break.class_len) );
 new_break.opline_num = opline;
 new_break.opline = 0;

 switch (phpdbg_resolve_opline_break(&new_break)) {
  case FAILURE:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "pending=\"pending\" id=\"%d\" file=\"%s\" num=\"%ld\"", "Pending breakpoint #%d at %s:%ld", new_break.id, new_break.class_name, opline);
   break;

  case SUCCESS:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" file=\"%s\" num=\"%ld\"", "Breakpoint #%d added at %s:%ld", new_break.id, new_break.class_name, opline);
   break;
 ...
 if (!(file_table = zend_hash_str_find_ptr(&(phpdbg_globals.bp)[9], new_break.class_name, new_break.class_len))) {
  _zend_hash_init((&file_breaks), (8), (phpdbg_opline_breaks_dtor), (0) );
  file_table = zend_hash_str_update_mem(&(phpdbg_globals.bp)[9], new_break.class_name, new_break.class_len, &file_breaks, sizeof(HashTable));
 }

 if (zend_hash_index_exists(file_table, opline)) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" file=\"%s\" num=\"%d\"", "Breakpoint already exists for %s:%ld", new_break.class_name, opline);
  _efree(((char*)new_break.class_name) );
  (phpdbg_globals.bp_count)--;
  return;
 }

 _phpdbg_break_mapping(new_break.id, file_table);

 (phpdbg_globals.flags) |= (1ULL<<10);

 zend_hash_index_update_mem(file_table, opline, &new_break, sizeof(phpdbg_breakopline_t));
}


__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_opcode(const char *name, size_t name_len)
{
 phpdbg_breakop_t new_break;
 zend_ulong hash = zend_hash_func(name, name_len);

 if (zend_hash_index_exists(&(phpdbg_globals.bp)[6], hash)) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" opcode=\"%s\"", "Breakpoint exists for %s", name);
  return;
 }

 do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 6; new_break.disabled = 0; new_break.hits = 0; } while(0);
 new_break.hash = hash;
 new_break.name = _estrndup((name), (name_len) );

 zend_hash_index_update_mem(&(phpdbg_globals.bp)[6], hash, &new_break, sizeof(phpdbg_breakop_t));

 (phpdbg_globals.flags) |= (1ULL<<7);

 phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" opcode=\"%s\"", "Breakpoint #%d added at %s", new_break.id, name);
 _phpdbg_break_mapping(new_break.id, &(phpdbg_globals.bp)[6]);
}

__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_opline_ex(phpdbg_opline_ptr_t opline)
{
 if (!zend_hash_index_exists(&(phpdbg_globals.bp)[3], (zend_ulong) opline)) {
  phpdbg_breakline_t new_break;
  ...
  zend_hash_index_update_mem(&(phpdbg_globals.bp)[3], (zend_ulong) opline, &new_break, sizeof(phpdbg_breakline_t));

  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" opline=\"%#lx\"", "Breakpoint #%d added at %#lx", new_break.id, new_break.opline);
  _phpdbg_break_mapping(new_break.id, &(phpdbg_globals.bp)[3]);
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" opline=\"%#lx\"", "Breakpoint exists for opline %#lx", (zend_ulong) opline);
 }
}
...
static inline void phpdbg_create_conditional_break(phpdbg_breakcond_t *brake, const phpdbg_param_t *param, const char *expr, size_t expr_len, zend_ulong hash)
{
 ...
 do { new_break.id = (phpdbg_globals.bp_count)++; new_break.type = 5; new_break.disabled = 0; new_break.hits = 0; } while(0);
 new_break.hash = hash;
 ...
 cops = (compiler_globals.compiler_options);

 (compiler_globals.compiler_options) = 0;

 new_break.code = _estrndup((expr), (expr_len) );
 new_break.code_len = expr_len;

 (pv).value.str = zend_string_alloc(expr_len + sizeof("return ;") - 1, 0);
 memcpy(((pv).value.str)->val, "return ", sizeof("return ") - 1);
 memcpy(((pv).value.str)->val + sizeof("return ") - 1, expr, expr_len);
 ...
 if (new_break.ops) {
  brake = zend_hash_index_update_mem(&(phpdbg_globals.bp)[5], hash, &new_break, sizeof(phpdbg_breakcond_t));

  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" expression=\"%s\" ptr=\"%p\"", "Conditional breakpoint #%d added %s/%p", brake->id, brake->code, brake->ops);

  (phpdbg_globals.flags) |= (1ULL<<6);
  _phpdbg_break_mapping(new_break.id, &(phpdbg_globals.bp)[5]);
 } else {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "compile", "expression=\"%s\"", "Failed to compile code for expression %s", expr);
   _efree(((char*)new_break.code) );
   (phpdbg_globals.bp_count)--;
 }
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_expression(const char *expr, size_t expr_len)
{
 zend_ulong expr_hash = zend_inline_hash_func(expr, expr_len);
 phpdbg_breakcond_t new_break;

 if (!zend_hash_index_exists(&(phpdbg_globals.bp)[5], expr_hash)) {
  phpdbg_create_conditional_break(
   &new_break, ((void *)0), expr, expr_len, expr_hash);
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" expression=\"%s\"", "Conditional break %s exists", expr);
 }
}
...
__attribute__ ((visibility("default"))) void phpdbg_set_breakpoint_at(const phpdbg_param_t *param)
{
 ...
 if (param->next) {
  ...
  if (!zend_hash_index_exists(&(phpdbg_globals.bp)[5], hash)) {
   phpdbg_create_conditional_break(&new_break, param, condition->str, condition->len, hash);
  } else {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"exists\" arg=\"%s\"", "Conditional break %s exists at the specified location", condition->str);
  }
 }
...
static inline phpdbg_breakbase_t *phpdbg_find_breakpoint_file(zend_op_array *op_array)
{
 ...
 if (!(breaks = zend_hash_str_find_ptr(&(phpdbg_globals.bp)[0], path, path_len))) {
  return ((void *)0);
 }

 if ((executor_globals.current_execute_data) && (brake = zend_hash_index_find_ptr(breaks, (executor_globals.current_execute_data)->opline->lineno))) {
  return brake;
 }
...
static inline phpdbg_breakbase_t *phpdbg_find_breakpoint_symbol(zend_function *fbc)
{
 ...
 if (ops->function_name) {
  ...
  brake = zend_hash_find_ptr(&(phpdbg_globals.bp)[2], fname);

  zend_string_release(fname);
  return brake;
 } else {
  return zend_hash_str_find_ptr(&(phpdbg_globals.bp)[2], ("main"), (sizeof("main")-1));
 }
}
...
static inline phpdbg_breakbase_t *phpdbg_find_breakpoint_method(zend_op_array *ops)
{
 ...
 if ((class_table = zend_hash_find_ptr(&(phpdbg_globals.bp)[4], class_lcname))) {
...
static inline phpdbg_breakbase_t *phpdbg_find_breakpoint_opline(phpdbg_opline_ptr_t opline)
{
 ...
 if ((brake = zend_hash_index_find_ptr(&(phpdbg_globals.bp)[3], (zend_ulong) opline)) && brake->base) {
...
static inline phpdbg_breakbase_t *phpdbg_find_breakpoint_opcode(zend_uchar opcode)
{
 ...
 return zend_hash_index_find_ptr(&(phpdbg_globals.bp)[6], zend_hash_func(opname, strlen(opname)));
}
...
static inline phpdbg_breakbase_t *phpdbg_find_conditional_breakpoint(zend_execute_data *execute_data)
{
 ...
 do { Bucket *_p = (&(phpdbg_globals.bp)[5])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[5])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; bp = (*(_z)).value.ptr; {
  zval retval;
  const zend_op *orig_opline = (executor_globals.current_execute_data)->opline;
  zend_function *orig_func = (executor_globals.current_execute_data)->func;
  zval *orig_retval = (executor_globals.current_execute_data)->return_value;
  ...
  (executor_globals.no_extensions) = 1;
  (executor_globals.current_execute_data)->opline = orig_opline;
  (executor_globals.current_execute_data)->func = orig_func;
  (executor_globals.current_execute_data)->return_value = orig_retval;
  (phpdbg_globals.flags) &= ~(1ULL<<11);
 ...
 return (breakpoint == SUCCESS) ? ((phpdbg_breakbase_t *) bp) : ((void *)0);
}

__attribute__ ((visibility("default"))) phpdbg_breakbase_t *phpdbg_find_breakpoint(zend_execute_data *execute_data)
{
 phpdbg_breakbase_t *base = ((void *)0);

 if (!((phpdbg_globals.flags) & (1ULL<<29))) {
  return ((void *)0);
 }
 ...
 if (((phpdbg_globals.flags) & (1ULL<<1)) && (base = phpdbg_find_breakpoint_file(&execute_data->func->op_array))) {
  goto result;
 }

 if ((phpdbg_globals.flags) & ((1ULL<<5)|(1ULL<<3))) {
  zend_op_array *op_array = &execute_data->func->op_array;

  if (execute_data->opline == op_array->opcodes + op_array->num_args + !!(op_array->fn_flags & 0x1000000)) {
 ...
 if (((phpdbg_globals.flags) & (1ULL<<4)) && (base = phpdbg_find_breakpoint_opline((phpdbg_opline_ptr_t) execute_data->opline))) {
  goto result;
 }

 if (((phpdbg_globals.flags) & (1ULL<<7)) && (base = phpdbg_find_breakpoint_opcode(execute_data->opline->opcode))) {
  goto result;
 }
...
__attribute__ ((visibility("default"))) void phpdbg_delete_breakpoint(zend_ulong num)
{
 ...
 if ((brake = phpdbg_find_breakbase_ex(num, &table, &numkey, &strkey))) {
  ...
  switch (type) {
   case 0:
   case 4:
    if ((table)->nNumOfElements == 1) {
     name = _estrdup((brake->name) );
     name_len = strlen(name);
     if ((&(phpdbg_globals.bp)[type])->nNumOfElements == 1) {
      (phpdbg_globals.flags) &= ~(1<<(brake->type+1));
     }
    }
   break;
  ...
  switch (type) {
   ...
   case 7:
   case 8:
    if ((&(phpdbg_globals.bp)[3])->nNumOfElements == 1) {
     (phpdbg_globals.flags) &= (1ULL<<4);
    }
    zend_hash_index_del(&(phpdbg_globals.bp)[3], ((phpdbg_breakopline_t *) brake)->opline);
  }
  ...
  switch (type) {
   ...
   case 4:
    if (name) {
     zend_hash_str_del(&(phpdbg_globals.bp)[type], name, name_len);
     _efree((name) );
    }
   break;
  }

  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "deleted=\"success\" id=\"%ld\"", "Deleted breakpoint #%ld", num);
  zend_hash_index_del(&(phpdbg_globals.bp)[10], (num));
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "breakpoint", "type=\"nobreakpoint\" deleted=\"fail\" id=\"%ld\"", "Failed to find breakpoint #%ld", num);
 }
}
...
__attribute__ ((visibility("default"))) void phpdbg_clear_breakpoints(void)
{
 ...
 zend_hash_clean(&(phpdbg_globals.bp)[10]);

 (phpdbg_globals.flags) &= ~((1ULL<<1) | (1ULL<<3) | (1ULL<<5) | (1ULL<<4) | (1ULL<<6) | (1ULL<<7) | (1ULL<<8) | (1ULL<<9) | (1ULL<<10));

 (phpdbg_globals.bp_count) = 0;
}
...
__attribute__ ((visibility("default"))) void phpdbg_print_breakpoint(phpdbg_breakbase_t *brake)
{
 ...
 switch (brake->type) {
  case 0: {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d at %s:%ld, hits: %lu", ((phpdbg_breakfile_t*)brake)->id, ((phpdbg_breakfile_t*)brake)->filename, ((phpdbg_breakfile_t*)brake)->line, ((phpdbg_breakfile_t*)brake)->hits)
  ...
  case 2: {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" function=\"%s\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in %s() at %s:%u, hits: %lu", ((phpdbg_breaksymbol_t*)brake)->id, ((phpdbg_breaksymbol_t*)brake)->symbol, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakfile_t*)brake)->hits)
  ...
  case 3: {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" opline=\"%#lx\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in %#lx at %s:%u, hits: %lu", ((phpdbg_breakline_t*)brake)->id, ((phpdbg_breakline_t*)brake)->opline, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakline_t*)brake)->hits)
  ...
  case 8: {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" method=\"%s::%s\" num=\"%lu\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in %s::%s()#%lu at %s:%u, hits: %lu", ((phpdbg_breakopline_t*)brake)->id, ((phpdbg_breakopline_t*)brake)->class_name, ((phpdbg_breakopline_t*)brake)->func_name, ((phpdbg_breakopline_t*)brake)->opline_num, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakopline_t*)brake)->hits)
  ...
  case 7: {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" num=\"%lu\" function=\"%s\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in %s()#%lu at %s:%u, hits: %lu", ((phpdbg_breakopline_t*)brake)->id, ((phpdbg_breakopline_t*)brake)->func_name, ((phpdbg_breakopline_t*)brake)->opline_num, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakopline_t*)brake)->hits)
  ...
  case 9: {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" num=\"%lu\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in #%lu at %s:%u, hits: %lu", ((phpdbg_breakopline_t*)brake)->id, ((phpdbg_breakopline_t*)brake)->opline_num, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakopline_t*)brake)->hits)
  ...
  case 6: {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" opcode=\"%s\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in %s at %s:%u, hits: %lu", ((phpdbg_breakop_t*)brake)->id, ((phpdbg_breakop_t*)brake)->name, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakop_t*)brake)->hits)
  ...
  case 4: {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" method=\"%s::%s\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Breakpoint #%d in %s::%s() at %s:%u, hits: %lu", ((phpdbg_breakmethod_t*)brake)->id, ((phpdbg_breakmethod_t*)brake)->class_name, ((phpdbg_breakmethod_t*)brake)->func_name, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakmethod_t*)brake)->hits)
  ...
  case 5: {
   if (((phpdbg_breakcond_t*)brake)->paramed) {
    char *param;
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" location=\"%s\" eval=\"%s\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Conditional breakpoint #%d: at %s if %s at %s:%u, hits: %lu", ((phpdbg_breakcond_t*)brake)->id, phpdbg_param_tostring(&((phpdbg_breakcond_t*)brake)->param, &param), ((phpdbg_breakcond_t*)brake)->code, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakcond_t*)brake)->hits)
    ...
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"%d\" eval=\"%s\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Conditional breakpoint #%d: on %s == true at %s:%u, hits: %lu", ((phpdbg_breakcond_t*)brake)->id, ((phpdbg_breakcond_t*)brake)->code, zend_get_executed_filename(), zend_get_executed_lineno(), ((phpdbg_breakcond_t*)brake)->hits)
  ...
  default: {
unknown:
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "breakpoint", "id=\"\" file=\"%s\" line=\"%ld\" hits=\"%lu\"", "Unknown breakpoint at %s:%u", zend_get_executed_filename(), zend_get_executed_lineno())
...
__attribute__ ((visibility("default"))) phpdbg_breakbase_t *phpdbg_find_breakbase_ex(zend_ulong id, HashTable **table, zend_ulong *numkey, zend_string **strkey)
{
 if ((*table = zend_hash_index_find_ptr(&(phpdbg_globals.bp)[10], id))) {
  phpdbg_breakbase_t *brake;

  do { Bucket *_p = (*table)->arData; Bucket *_end = _p + (*table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; *numkey = _p->h; *strkey = _p->key; brake = (*(_z)).value.ptr; {
   if (brake->id == id) {
    return brake;
   }
  } } } while (0);
...
__attribute__ ((visibility("default"))) void phpdbg_print_breakpoints(zend_ulong type)
{
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<breakpoints %r>");

 switch (type) {
  case 2: if (((phpdbg_globals.flags) & (1ULL<<3))) {
   phpdbg_breaksymbol_t *brake;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Function Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[2])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[2])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
    phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "function", "id=\"%d\" name=\"%s\" disabled=\"%s\"", "#%d\t\t%s%s", brake->id, brake->symbol, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                   ;
   } } } while (0);
  } break;

  case 4: if (((phpdbg_globals.flags) & (1ULL<<5))) {
   HashTable *class_table;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Method Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[4])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[4])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; class_table = (*(_z)).value.ptr; {
    phpdbg_breakmethod_t *brake;

    do { Bucket *_p = (class_table)->arData; Bucket *_end = _p + (class_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "method", "id=\"%d\" name=\"%s::%s\" disabled=\"%s\"", "#%d\t\t%s::%s%s", brake->id, brake->class_name, brake->func_name, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 0: if (((phpdbg_globals.flags) & (1ULL<<1))) {
   HashTable *points;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "File Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[0])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[0])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; points = (*(_z)).value.ptr; {
    phpdbg_breakfile_t *brake;

    do { Bucket *_p = (points)->arData; Bucket *_end = _p + (points)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "file", "id=\"%d\" name=\"%s\" line=\"%lu\" disabled=\"%s\"", "#%d\t\t%s:%lu%s", brake->id, brake->filename, brake->line, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                    ;
    } } } while (0);
   } } } while (0);
  } if (((phpdbg_globals.flags) & (1ULL<<2))) {
   HashTable *points;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Pending File Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[1])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[1])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; points = (*(_z)).value.ptr; {
    phpdbg_breakfile_t *brake;

    do { Bucket *_p = (points)->arData; Bucket *_end = _p + (points)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "file", "id=\"%d\" name=\"%s\" line=\"%lu\" disabled=\"%s\" pending=\"pending\"", "#%d\t\t%s:%lu%s", brake->id, brake->filename, brake->line, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 3: if (((phpdbg_globals.flags) & (1ULL<<4))) {
   phpdbg_breakline_t *brake;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Opline Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[3])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[3])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
    const char *type;
    switch (brake->type) {
     case 8:
      type = "method";
     ...
     print_opline: {
      if (brake->type == 8) {
       type = "method";
      } else if (brake->type == 7) {
       type = "function";
      } else if (brake->type == 9) {
       type = "file";
      }

      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "opline", "id=\"%d\" num=\"%#lx\" type=\"%s\" disabled=\"%s\"", "#%d\t\t%#lx\t\t(%s breakpoint)%s", brake->id, brake->opline, type, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                     ;
     } break;

     default:
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "opline", "id=\"%d\" num=\"%#lx\" disabled=\"%s\"", "#%d\t\t%#lx%s", brake->id, brake->opline, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 8: if (((phpdbg_globals.flags) & (1ULL<<9))) {
   HashTable *class_table, *method_table;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Method opline Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[8])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[8])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; class_table = (*(_z)).value.ptr; {
    do { Bucket *_p = (class_table)->arData; Bucket *_end = _p + (class_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; method_table = (*(_z)).value.ptr; {
     phpdbg_breakopline_t *brake;

     do { Bucket *_p = (method_table)->arData; Bucket *_end = _p + (method_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "methodopline", "id=\"%d\" name=\"%s::%s\" num=\"%ld\" disabled=\"%s\"", "#%d\t\t%s::%s opline %ld%s", brake->id, brake->class_name, brake->func_name, brake->opline_num, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 7: if (((phpdbg_globals.flags) & (1ULL<<8))) {
   HashTable *function_table;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Function opline Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[7])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[7])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; function_table = (*(_z)).value.ptr; {
    phpdbg_breakopline_t *brake;

    do { Bucket *_p = (function_table)->arData; Bucket *_end = _p + (function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "functionopline", "id=\"%d\" name=\"%s\" num=\"%ld\" disabled=\"%s\"", "#%d\t\t%s opline %ld%s", brake->id, brake->func_name, brake->opline_num, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 9: if (((phpdbg_globals.flags) & (1ULL<<10))) {
   HashTable *file_table;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "File opline Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[9])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[9])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; file_table = (*(_z)).value.ptr; {
    phpdbg_breakopline_t *brake;

    do { Bucket *_p = (file_table)->arData; Bucket *_end = _p + (file_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "fileopline", "id=\"%d\" name=\"%s\" num=\"%ld\" disabled=\"%s\"", "#%d\t\t%s opline %ld%s", brake->id, brake->class_name, brake->opline_num, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 5: if (((phpdbg_globals.flags) & (1ULL<<6))) {
   phpdbg_breakcond_t *brake;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Conditional Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[5])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[5])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
    if (brake->paramed) {
     switch (brake->param.type) {
      case STR_PARAM:
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "evalfunction", "id=\"%d\" name=\"%s\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tat %s if %s%s", brake->id, brake->param.str, brake->code, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                       ;
      break;

      case NUMERIC_FUNCTION_PARAM:
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "evalfunctionopline", "id=\"%d\" name=\"%s\" num=\"%ld\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tat %s#%ld if %s%s", brake->id, brake->param.str, brake->param.num, brake->code, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                       ;
      break;

      case METHOD_PARAM:
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "evalmethod", "id=\"%d\" name=\"%s::%s\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tat %s::%s if %s%s", brake->id, brake->param.method.class, brake->param.method.name, brake->code, ((phpdbg_breakbase_t*)brake)->disabled ? " [disabled]" : "")

                                                                     ;
      break;

      case NUMERIC_METHOD_PARAM:
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "evalmethodopline", "id=\"%d\" name=\"%s::%s\" num=\"%d\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tat %s::%s#%ld if %s%s", brake->id, brake->param.method.class, brake->param.method.name, brake->param.num, brake->code, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                       ;
      break;

      case FILE_PARAM:
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "evalfile", "id=\"%d\" name=\"%s\" line=\"%d\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tat %s:%lu if %s%s", brake->id, brake->param.file.name, brake->param.file.line, brake->code, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                       ;
      break;

      case ADDR_PARAM:
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "evalopline", "id=\"%d\" opline=\"%#lx\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tat #%lx if %s%s", brake->id, brake->param.addr, brake->code, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")

                                                                       ;
      break;

      default:
       phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "eval", "type=\"invalidparameter\"", "Invalid parameter type for conditional breakpoint");
      return;
     }
    } else {
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "eval", "id=\"%d\" eval=\"%s\" disabled=\"%s\"", "#%d\t\tif %s%s", brake->id, brake->code, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
  ...
  case 6: if ((phpdbg_globals.flags) & (1ULL<<7)) {
   phpdbg_breakop_t *brake;

   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "------------------------------------------------" "\n");
   phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Opcode Breakpoints:\n");
   do { Bucket *_p = (&(phpdbg_globals.bp)[6])->arData; Bucket *_end = _p + (&(phpdbg_globals.bp)[6])->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; brake = (*(_z)).value.ptr; {
    phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "opcode", "id=\"%d\" name=\"%s\" disabled=\"%s\"", "#%d\t\t%s%s", brake->id, brake->name, ((phpdbg_breakbase_t *) brake)->disabled ? " [disabled]" : "")
 ...
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</breakpoints>");
}
