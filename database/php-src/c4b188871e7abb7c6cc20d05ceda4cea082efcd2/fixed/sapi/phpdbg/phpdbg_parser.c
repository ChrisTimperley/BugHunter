# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_parser.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_parser.c"
# 1 "sapi/phpdbg/phpdbg_parser.y"
# 10 "sapi/phpdbg/phpdbg_parser.y"
...
int phpdbg_lex (phpdbg_param_t* phpdbg_lval);
...
# 11 "sapi/phpdbg/phpdbg_parser.y" 2
...
# 15 "sapi/phpdbg/phpdbg_parser.y" 2
...
# 19 "sapi/phpdbg/phpdbg_parser.y" 2
...
# 107 "sapi/phpdbg/phpdbg_parser.c"
# 229 "sapi/phpdbg/phpdbg_parser.c"
# 237 "sapi/phpdbg/phpdbg_parser.c"
...
# 399 "sapi/phpdbg/phpdbg_parser.c"
union yyalloc
{
  yytype_int16 yyss_alloc;
  phpdbg_param_t yyvs_alloc;
};
# 476 "sapi/phpdbg/phpdbg_parser.c"
...
# 547 "sapi/phpdbg/phpdbg_parser.c"
...
# 575 "sapi/phpdbg/phpdbg_parser.c"
...
# 971 "sapi/phpdbg/phpdbg_parser.c"
...
# 1019 "sapi/phpdbg/phpdbg_parser.c"
static int
                ...
                yytype_int16 *yyssp, int yytoken)
{
  ...
  int yycount = 0;
# 1061 "sapi/phpdbg/phpdbg_parser.c"
  if (yytoken != (-2))
    {
      ...
      if (!(!!((yyn) == (-17))))
        {
          ...
          int yychecklim = 50 - yyn + 1;
          int yyxend = yychecklim < 23 ? yychecklim : 23;
          int yyx;
...
# 1158 "sapi/phpdbg/phpdbg_parser.c"
static void
yydestruct (const char *yymsg, int yytype, phpdbg_param_t *yyvaluep)
...
# 1197 "sapi/phpdbg/phpdbg_parser.c"
int
phpdbg_parse (void)
...
int phpdbg_char;
# 1233 "sapi/phpdbg/phpdbg_parser.c"
phpdbg_param_t phpdbg_lval ;
    ...
    int yyerrstatus;
# 1250 "sapi/phpdbg/phpdbg_parser.c"
    yytype_int16 yyssa[200];
    yytype_int16 *yyss;
    yytype_int16 *yyssp;


    phpdbg_param_t yyvsa[200];
    phpdbg_param_t *yyvs;
    phpdbg_param_t *yyvsp;
...
# 1335 "sapi/phpdbg/phpdbg_parser.c"
 ...
 union yyalloc *yyptr =
   (union yyalloc *) malloc (((yystacksize) * (sizeof (yytype_int16) + sizeof (phpdbg_param_t)) + (sizeof (union yyalloc) - 1)));
 if (! yyptr)
   goto yyexhaustedlab;
...
yybackup:
  ...
  if (phpdbg_char == (-2))
    {
      ;
      phpdbg_char = phpdbg_lex (&phpdbg_lval);
    }

  if (phpdbg_char <= 0)
    {
      phpdbg_char = yytoken = 0;
      ;
    }
  else
    {
      yytoken = ((unsigned int) (phpdbg_char) <= 277 ? yytranslate[phpdbg_char] : 2);
      ;
    }
  ...
  yyn += yytoken;
  if (yyn < 0 || 50 < yyn || yycheck[yyn] != yytoken)
    goto yydefault;
  yyn = yytable[yyn];
  if (yyn <= 0)
    {
...
# 1432 "sapi/phpdbg/phpdbg_parser.c"
...
# 1434 "sapi/phpdbg/phpdbg_parser.c"
...
yyreduce:
  ...
  yylen = yyr2[yyn];
# 1464 "sapi/phpdbg/phpdbg_parser.c"
  yyval = yyvsp[1-yylen];
  ...
  switch (yyn)
    {
        case 2:
# 71 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 3:
# 72 "sapi/phpdbg/phpdbg_parser.y"
    { phpdbg_stack_separate((yyvsp[(1) - (3)]).top); (yyval) = (yyvsp[(3) - (3)]); }
    break;

  case 5:
# 77 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval).top = (phpdbg_globals.parser_stack)->top; }
    break;

  case 6:
# 78 "sapi/phpdbg/phpdbg_parser.y"
    { phpdbg_stack_push((phpdbg_globals.parser_stack), &(yyvsp[(1) - (1)])); (yyval).top = (phpdbg_globals.parser_stack)->top; }
    break;

  case 7:
# 82 "sapi/phpdbg/phpdbg_parser.y"
    { phpdbg_stack_push((phpdbg_globals.parser_stack), &(yyvsp[(1) - (1)])); (yyval).top = (phpdbg_globals.parser_stack)->top; }
    break;

  case 8:
# 83 "sapi/phpdbg/phpdbg_parser.y"
    { phpdbg_stack_push((phpdbg_globals.parser_stack), &(yyvsp[(2) - (2)])); (yyval).top = (phpdbg_globals.parser_stack)->top; }
    break;

  case 9:
# 84 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (2)]); }
    break;

  case 10:
# 88 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 11:
# 93 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 12:
# 98 "sapi/phpdbg/phpdbg_parser.y"
    {
  (yyval).type = FILE_PARAM;
  ...
  case 13:
# 108 "sapi/phpdbg/phpdbg_parser.y"
    {
  (yyval).type = NUMERIC_FILE_PARAM;
  ...
  case 14:
# 118 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 15:
# 123 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 16:
# 129 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 17:
# 135 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 18:
# 140 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 19:
# 141 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 20:
# 142 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 21:
# 143 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 22:
# 144 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 23:
# 145 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 24:
# 146 "sapi/phpdbg/phpdbg_parser.y"
    { (yyval) = (yyvsp[(1) - (1)]); }
    break;

  case 25:
# 150 "sapi/phpdbg/phpdbg_parser.y"
    { (phpdbg_globals.req_id) = (yyvsp[(1) - (1)]).num; }
    break;

  case 27:
# 155 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 28:
# 160 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 29:
# 165 "sapi/phpdbg/phpdbg_parser.y"
    {
  ...
  case 30:
# 169 "sapi/phpdbg/phpdbg_parser.y"
    {
  (yyval).type = RUN_PARAM;
  (yyval).str = (yyvsp[(3) - (3)]).str;
  (yyval).len = (yyvsp[(3) - (3)]).len;
    ...
    break;
# 1694 "sapi/phpdbg/phpdbg_parser.c"
      default: break;
    }
# 1707 "sapi/phpdbg/phpdbg_parser.c"
  ;
  ...
  *++yyvsp = yyval;
  ...
  if (0 <= yystate && yystate <= 50 && yycheck[yystate] == *yyssp)
...
yyerrlab:
  ...
  yytoken = phpdbg_char == (-2) ? (-2) : ((unsigned int) (phpdbg_char) <= 277 ? yytranslate[phpdbg_char] : 2);
...
# 1856 "sapi/phpdbg/phpdbg_parser.c"
#pragma GCC diagnostic push
# 1856 "sapi/phpdbg/phpdbg_parser.c"
...
# 1858 "sapi/phpdbg/phpdbg_parser.c"
#pragma GCC diagnostic pop
# 1858 "sapi/phpdbg/phpdbg_parser.c"
...
# 176 "sapi/phpdbg/phpdbg_parser.y"


static int yyerror(const char *msg) {
 phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "command", "type=\"parseerror\" msg=\"%s\"", "Parse Error: %s", msg);

 {
  const phpdbg_param_t *top = (phpdbg_globals.parser_stack);
