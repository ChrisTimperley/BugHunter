# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_eol.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_eol.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_eol.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_eol.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_eol.c" 2

extern zend_phpdbg_globals phpdbg_globals;;


struct phpdbg_eol_rep phpdbg_eol_list[4] = {
 {"CRLF", "\r\n", PHPDBG_EOL_CRLF},
...
int phpdbg_eol_global_update(char *name)
{
 ...
 if (0 == memcmp(name, "CRLF", 4) || 0 == memcmp(name, "crlf", 4) || 0 == memcmp(name, "DOS", 3) || 0 == memcmp(name, "dos", 3)) {
  (phpdbg_globals.eol) = PHPDBG_EOL_CRLF;
  ...
  (phpdbg_globals.eol) = PHPDBG_EOL_CR;
 } else {
  return FAILURE;
 }
...
void phpdbg_eol_convert(char **str, int *len)
{
 ...
 if (((phpdbg_globals.flags) & (1ULL<<30)) != (1ULL<<30)) {
  return;
 }

 out_len = *len;
 if (PHPDBG_EOL_CRLF == (phpdbg_globals.eol)) {
  ...
  out = (char *)(__builtin_constant_p((out_len) ) ? (((out_len) <= 8) ? _emalloc_8() : (((out_len) <= 16) ? _emalloc_16() : (((out_len) <= 24) ? _emalloc_24() : (((out_len) <= 32) ? _emalloc_32() : (((out_len) <= 40) ? _emalloc_40() : (((out_len) <= 48) ? _emalloc_48() : (((out_len) <= 56) ? _emalloc_56() : (((out_len) <= 64) ? _emalloc_64() : (((out_len) <= 80) ? _emalloc_80() : (((out_len) <= 96) ? _emalloc_96() : (((out_len) <= 112) ? _emalloc_112() : (((out_len) <= 128) ? _emalloc_128() : (((out_len) <= 160) ? _emalloc_160() : (((out_len) <= 192) ? _emalloc_192() : (((out_len) <= 224) ? _emalloc_224() : (((out_len) <= 256) ? _emalloc_256() : (((out_len) <= 320) ? _emalloc_320() : (((out_len) <= 384) ? _emalloc_384() : (((out_len) <= 448) ? _emalloc_448() : (((out_len) <= 512) ? _emalloc_512() : (((out_len) <= 640) ? _emalloc_640() : (((out_len) <= 768) ? _emalloc_768() : (((out_len) <= 896) ? _emalloc_896() : (((out_len) <= 1024) ? _emalloc_1024() : (((out_len) <= 1280) ? _emalloc_1280() : (((out_len) <= 1536) ? _emalloc_1536() : (((out_len) <= 1792) ? _emalloc_1792() : (((out_len) <= 2048) ? _emalloc_2048() : (((out_len) <= 2560) ? _emalloc_2560() : (((out_len) <= 3072) ? _emalloc_3072() : (((out_len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((out_len)) : _emalloc_huge((out_len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((out_len) ) );
 ...
 } else if (PHPDBG_EOL_LF == (phpdbg_globals.eol) || PHPDBG_EOL_CR == (phpdbg_globals.eol)) {
  char want, kick;

  if (PHPDBG_EOL_LF == (phpdbg_globals.eol)) {
   want = 0x0a;
   kick = 0x0d;
  } else {
   want = 0x0d;
