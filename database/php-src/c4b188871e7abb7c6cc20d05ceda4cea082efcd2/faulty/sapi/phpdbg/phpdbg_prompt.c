 ...
 if (*cmd && cmd_len > 0L && cmd[0] != '#') {
  ...
  { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
   ...
   if ((phpdbg_globals.flags) & (1ULL<<16)) {
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 294);
   }
...
int phpdbg_compile(void)
{
 ...
 if (php_stream_open_for_zend_ex((phpdbg_globals.exec), &fh, 0x00000001|0x00000080) == SUCCESS && zend_stream_fixup(&fh, &buf, &len) == SUCCESS) {
  ...
  if ((executor_globals.exception)) {
   ...
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 494);
  }
...
int phpdbg_do_finish(const phpdbg_param_t *param)
{
 ...
 phpdbg_seek_to_end();
 if (zend_hash_index_exists(&(phpdbg_globals.seek), (zend_ulong) phpdbg_user_execute_data((executor_globals.current_execute_data))->opline)) {
 ...
 if ((phpdbg_globals.ops) || (phpdbg_globals.exec)) {
  ...
  { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
   ...
   if (!((phpdbg_globals.flags) & ((1ULL<<16) | (1ULL<<18)))) {
    ...
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 743);
   }
  } } (executor_globals.bailout) = __orig_bailout; };
  ...
  if (restore) {
   ...
   { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
    ...
    if ((phpdbg_globals.flags) & ((1ULL<<16) | (1ULL<<18))) {
     _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 761);
    }
   } } (executor_globals.bailout) = __orig_bailout; };
...
__attribute__ ((visibility("default"))) const char *phpdbg_load_module_or_extension(char **path, char **name) {
 ...
 if (!handle) {
# 1058 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c"
...
int phpdbg_interactive(zend_bool allow_async_unsafe)
{
 ...
 while (ret == SUCCESS || ret == FAILURE) {
  if ((phpdbg_globals.flags) & ((1ULL<<16) | (1ULL<<18))) {
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 1353);
  }
...
# 1469 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c"
void phpdbg_execute_ex(zend_execute_data *execute_data)
{
 ...
 if (((phpdbg_globals.flags) & ((1ULL<<16) | (1ULL<<18))) && !((phpdbg_globals.flags) & (1ULL<<19))) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 1474);
 }
 ...
 while (1) {
  ...
  if (exception && (phpdbg_globals.handled_exception) != exception && !((phpdbg_globals.flags) & (1ULL<<12))) {
   ...
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "exception", "name=\"%s\" file=\"%s\" line=\"" "%" "l" "d" "\"", "Uncaught %s in %s on line " "%" "l" "d" ": %.*s", (exception->ce->name)->val, (file)->val, line, (msg)->len < 80 ? (int) (msg)->len : 80, (msg)->val)
...
next:
 ...
 if ((phpdbg_globals.flags) & ((1ULL<<16) | (1ULL<<18))) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_prompt.c", 1681);
 }
}
