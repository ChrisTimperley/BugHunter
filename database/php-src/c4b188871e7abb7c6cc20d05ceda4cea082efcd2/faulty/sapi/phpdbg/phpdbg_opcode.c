...
static inline char *phpdbg_decode_op(zend_op_array *ops, znode_op *op, uint32_t type)
{
 ...
 switch (type) {
  case (1<<4): {
   zend_string *var = ops->vars[(((zval*)(((char*)(((void *)0))) + ((int)(op->var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
  ...
  case (1<<2):
   spprintf(&decode, 0, "@%u", (((zval*)(((char*)(((void *)0))) + ((int)(op->var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))) - ops->last_var);
  break;
  case (1<<1):
   spprintf(&decode, 0, "~%u", (((zval*)(((char*)(((void *)0))) + ((int)(op->var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))) - ops->last_var);
  break;
...
char *phpdbg_decode_opline(zend_op_array *ops, zend_op *op)
{
 ...
 case 163:
  if (op->extended_value != 0) {
   spprintf(&decode[0], 0, "FAST_RET<%s>",
    op->extended_value == 1 ? "TO_CATCH" : "TO_FINALLY");
  }
  break;
 }
 ...
 case 42:
 case 162:
  spprintf(&decode[1], 0, "J%td", ((zend_op*)(((char*)(op)) + (int)(op->op1).jmp_offset)) - ops->opcodes);
  break;
 ...
 case 64:
 case 164:
  spprintf(&decode[1], 0, "%" "u", op->op1.num);
  break;
 ...
 case 45:
  spprintf(&decode[2], 0, "J%td or J%td",
   ((zend_op*)(((char*)(op)) + (int)(op->op2).jmp_offset)) - ops->opcodes,
   ((zend_op*)(((char*)(op)) + (int)op->extended_value)) - ops->opcodes);
  break;
 ...
 case 152:
 case 151:
  spprintf(&decode[2], 0, "J%td", ((zend_op*)(((char*)(op)) + (int)(op->op2).jmp_offset)) - ops->opcodes);
  break;

 case 162:
 case 163:
  if (op->extended_value != 0) {
   spprintf(&decode[2], 0, "J%" "u", op->op2.opline_num);
  }
  break;
 ...
 case 66:
 case 120:
  spprintf(&decode[2], 0, "%" "u", op->op2.num);
  break;
 ...
 switch (op->opcode) {
 case 107:
  spprintf(&decode[3], 0, "%" "u", op->result.num);
  break;
 default:
