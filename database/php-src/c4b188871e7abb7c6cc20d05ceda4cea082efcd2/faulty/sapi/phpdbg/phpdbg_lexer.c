# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_lexer.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_lexer.c"
# 1 "sapi/phpdbg/phpdbg_lexer.l"
...
# 6 "sapi/phpdbg/phpdbg_lexer.l" 2
...
# 9 "sapi/phpdbg/phpdbg_lexer.l" 2
# 29 "sapi/phpdbg/phpdbg_lexer.l"
extern zend_phpdbg_globals phpdbg_globals;;

void phpdbg_init_lexer (phpdbg_param_t *stack, char *input) {
 (phpdbg_globals.parser_stack) = stack;

 ((phpdbg_globals.lexer).state) = 3;;

 ((phpdbg_globals.lexer).text) = ((phpdbg_globals.lexer).cursor) = (unsigned char *) input;
 ((phpdbg_globals.lexer).len) = strlen(input);
}
...
restart:
 ((phpdbg_globals.lexer).text) = ((phpdbg_globals.lexer).cursor);
# 68 "sapi/phpdbg/phpdbg_lexer.c"
{
 unsigned char yych;
 unsigned int yyaccept = 0;
 if (((phpdbg_globals.lexer).state) < 2) {
  if (((phpdbg_globals.lexer).state) < 1) {
   goto yyc_NORMAL;
  } else {
   goto yyc_PRE_RAW;
  }
 } else {
  if (((phpdbg_globals.lexer).state) < 3) {
   goto yyc_RAW;
  } else {
   goto yyc_INITIAL;
  }
...
yyc_INITIAL:
 {
  ...
  ;
  ;
  yych = *((phpdbg_globals.lexer).cursor);
  if (yych <= '#') {
   if (yych <= '\f') {
    if (yych <= 0x08) {
...
yy3:
  ;
  ++((phpdbg_globals.lexer).cursor);
  if (yybm[0+(yych = *((phpdbg_globals.lexer).cursor))] & 128) {
   goto yy5;
  }
yy4:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 206 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 0;;

 ((phpdbg_globals.lexer).cursor) = ((phpdbg_globals.lexer).text);
 goto restart;
}
# 181 "sapi/phpdbg/phpdbg_lexer.c"
yy5:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
  ...
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 175 "sapi/phpdbg/phpdbg_lexer.l"
  {


 goto restart;
}
# 199 "sapi/phpdbg/phpdbg_lexer.c"
yy8:
  ;
  yych = *++((phpdbg_globals.lexer).cursor);
  goto yy4;
...
yy10:
  ;
  yyaccept = 0;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
  if (yych == 'V') goto yy25;
  if (yych == 'v') goto yy25;
  goto yy4;
yy11:
...
yy16:
  ;
  ((phpdbg_globals.lexer).cursor) = ((phpdbg_globals.lexer).marker);
  goto yy4;
yy17:
  ;
  yych = *++((phpdbg_globals.lexer).cursor);
...
yy18:
  ...
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 193 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 1;;
 do{ (yylval)->type = (EMPTY_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 return 259;
}
# 293 "sapi/phpdbg/phpdbg_lexer.c"
yy21:
  ;
  yych = *++((phpdbg_globals.lexer).cursor);
  if (yych <= '\f') {
...
yy22:
  ...
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 187 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 1;;
 do{ (yylval)->type = (EMPTY_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 return 260;
}
# 323 "sapi/phpdbg/phpdbg_lexer.c"
yy25:
  ;
  yych = *++((phpdbg_globals.lexer).cursor);
  if (yych <= '\f') {
...
yy26:
  ...
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 181 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 1;;
 do{ (yylval)->type = (EMPTY_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 return 258;
}
# 353 "sapi/phpdbg/phpdbg_lexer.c"
 }
...
# 490 "sapi/phpdbg/phpdbg_lexer.c"
yy34:
  ;
  ((phpdbg_globals.lexer).ctxmarker) = ((phpdbg_globals.lexer).cursor) + 1;
  yyaccept = 0;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
  if (yych <= '.') {
   if (yych <= ',') goto yy35;
...
yy35:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 110 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 3;;
 return 268;
}
# 512 "sapi/phpdbg/phpdbg_lexer.c"
yy36:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 89 "sapi/phpdbg/phpdbg_lexer.l"
  {
 return 0;
}
# 522 "sapi/phpdbg/phpdbg_lexer.c"
yy38:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy39:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 161 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (STR_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->str = _estrndup((((char*) ((phpdbg_globals.lexer).text))), (((phpdbg_globals.lexer).len) - unescape_string(((char*) ((phpdbg_globals.lexer).text)))) );
 yylval->len = ((phpdbg_globals.lexer).len);
 return 274;
}
# 542 "sapi/phpdbg/phpdbg_lexer.c"
yy40:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy42:
  ;
  yyaccept = 1;
  ((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor);
  ;
  yych = *((phpdbg_globals.lexer).cursor);
yy43:
  ;
...
yy49:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 142 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (NUMERIC_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->num = atoi(((char*) ((phpdbg_globals.lexer).text)));
 return 270;
}
# 649 "sapi/phpdbg/phpdbg_lexer.c"
yy50:
  ;
  yyaccept = 2;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy67:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 123 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (STR_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->str = _estrndup((((char*) ((phpdbg_globals.lexer).text))), (((phpdbg_globals.lexer).len)) );
 yylval->len = ((phpdbg_globals.lexer).len);
 return 269;
}
# 788 "sapi/phpdbg/phpdbg_lexer.c"
yy68:
  ;
  yyaccept = 1;
  ((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor);
...
yy76:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 154 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (OP_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->str = _estrndup((((char*) ((phpdbg_globals.lexer).text))), (((phpdbg_globals.lexer).len)) );
 yylval->len = ((phpdbg_globals.lexer).len);
 return 273;
}
# 878 "sapi/phpdbg/phpdbg_lexer.c"
yy77:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy82:
  ...
  ++((phpdbg_globals.lexer).cursor);
  ;
  ((phpdbg_globals.lexer).cursor) = ((phpdbg_globals.lexer).ctxmarker);
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 130 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (NUMERIC_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->num = 1;
 return 262;
}
# 924 "sapi/phpdbg/phpdbg_lexer.c"
yy84:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy88:
  ...
  ((phpdbg_globals.lexer).cursor) = ((phpdbg_globals.lexer).ctxmarker);
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 136 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (NUMERIC_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->num = 0;
 return 263;
}
# 969 "sapi/phpdbg/phpdbg_lexer.c"
yy90:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy107:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 148 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (ADDR_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->addr = strtoul(((char*) ((phpdbg_globals.lexer).text)), 0, 16);
 return 272;
}
# 1104 "sapi/phpdbg/phpdbg_lexer.c"
yy108:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
...
yy128:
  ...
  ((phpdbg_globals.lexer).cursor) = ((phpdbg_globals.lexer).ctxmarker);
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 119 "sapi/phpdbg/phpdbg_lexer.l"
  {
 return 265;
}
# 1309 "sapi/phpdbg/phpdbg_lexer.c"
yy130:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 115 "sapi/phpdbg/phpdbg_lexer.l"
  {
 return 266;
}
# 1319 "sapi/phpdbg/phpdbg_lexer.c"
yy132:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy133:
  ...
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 100 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 2;;
 do{ (yylval)->type = (EMPTY_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 return 261;
}
# 1350 "sapi/phpdbg/phpdbg_lexer.c"
yy136:
  ;
  yyaccept = 1;
  yych = *(((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor));
...
yy142:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 93 "sapi/phpdbg/phpdbg_lexer.l"
  {
 char *text = ((char*) ((phpdbg_globals.lexer).text)) + 2;
 while (*++text < '0');
 yylval->num = atoi(text);
 return 277;
}
# 1453 "sapi/phpdbg/phpdbg_lexer.c"
yy143:
  ;
  yych = *++((phpdbg_globals.lexer).cursor);
  if (yych == '.') goto yy144;
...
yy149:
  ...
  ((phpdbg_globals.lexer).cursor) = ((phpdbg_globals.lexer).ctxmarker);
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 106 "sapi/phpdbg/phpdbg_lexer.l"
  {
 return 267;
}
# 1493 "sapi/phpdbg/phpdbg_lexer.c"
 }
...
yyc_PRE_RAW:
 {
  ...
  ;
  ++((phpdbg_globals.lexer).cursor);
  if (yybm[0+(yych = *((phpdbg_globals.lexer).cursor))] & 64) {
   goto yy154;
  }
yy153:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 199 "sapi/phpdbg/phpdbg_lexer.l"
  {
 ((phpdbg_globals.lexer).state) = 2;;
...
# 1568 "sapi/phpdbg/phpdbg_lexer.c"
yy154:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
...
# 1586 "sapi/phpdbg/phpdbg_lexer.c"
yy157:
  ;
  yych = *++((phpdbg_globals.lexer).cursor);
  goto yy153;
...
# 1653 "sapi/phpdbg/phpdbg_lexer.c"
 }
...
yy172:
  ;
  ((phpdbg_globals.lexer).len) = (size_t) ((phpdbg_globals.lexer).cursor) - (size_t) ((char*) ((phpdbg_globals.lexer).text));
# 168 "sapi/phpdbg/phpdbg_lexer.l"
  {
 do{ (yylval)->type = (STR_PARAM); (yylval)->addr = 0; (yylval)->num = 0; (yylval)->file.name = ((void *)0); (yylval)->file.line = 0; (yylval)->method.class = ((void *)0); (yylval)->method.name = ((void *)0); (yylval)->str = ((void *)0); (yylval)->len = 0; (yylval)->next = ((void *)0); (yylval)->top = ((void *)0); } while(0);
 yylval->str = _estrndup((((char*) ((phpdbg_globals.lexer).text))), (((phpdbg_globals.lexer).len) - unescape_string(((char*) ((phpdbg_globals.lexer).text)))) );
 yylval->len = ((phpdbg_globals.lexer).len);
...
# 1744 "sapi/phpdbg/phpdbg_lexer.c"
yy173:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
...
# 1755 "sapi/phpdbg/phpdbg_lexer.c"
yy175:
  ;
  ++((phpdbg_globals.lexer).cursor);
  ;
...
# 1765 "sapi/phpdbg/phpdbg_lexer.c"
yy177:
  ;
  yyaccept = 0;
  ((phpdbg_globals.lexer).marker) = ++((phpdbg_globals.lexer).cursor);
