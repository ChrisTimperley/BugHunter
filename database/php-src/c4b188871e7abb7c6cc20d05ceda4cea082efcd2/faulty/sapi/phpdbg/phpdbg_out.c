# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/spprintf.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
...
# 49 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
struct buf_area {
 char *buf_end;
 char *nextb;
};
...
# 119 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
...
# 120 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c" 2
# 132 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
  ...
  if (*fmt != '%') {
   ...
   if (((((int)*fmt) & ~0x7f) == 0) && !((*__ctype_b_loc ())[(int) (((int)*fmt))] & (unsigned short int) _ISlower)) {
    ...
    if (*fmt == '.') {
     ...
     if (precision > 500 && *fmt != 's' && *fmt != 'v' && *fmt != 'b') {
      precision = 500;
     }
    } else
     adjust_precision = NO;
...
# 333 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
   switch (*fmt) {
    case 'Z':
    ...
    case 'o':
     ...
     s = ap_php_conv_p2(ui_num, 3, *fmt, &num_buf[2048], &s_len);
     if ( adjust_precision ) while ( s_len < precision ) { *--s = '0' ; s_len++ ; };
    ...
    case 'X':
     ...
     s = ap_php_conv_p2(ui_num, 4, *fmt, &num_buf[2048], &s_len);
     if ( adjust_precision ) while ( s_len < precision ) { *--s = '0' ; s_len++ ; };
    ...
    case 'v':
     ...
     if (s != ((void *)0)) {
      ...
      if (escape_xml) {
       ...
       char *old_s = s, *s_ptr;
       free_s = s_ptr = s = (__builtin_constant_p((old_slen * 6 + 1) ) ? (((old_slen * 6 + 1) <= 8) ? _emalloc_8() : (((old_slen * 6 + 1) <= 16) ? _emalloc_16() : (((old_slen * 6 + 1) <= 24) ? _emalloc_24() : (((old_slen * 6 + 1) <= 32) ? _emalloc_32() : (((old_slen * 6 + 1) <= 40) ? _emalloc_40() : (((old_slen * 6 + 1) <= 48) ? _emalloc_48() : (((old_slen * 6 + 1) <= 56) ? _emalloc_56() : (((old_slen * 6 + 1) <= 64) ? _emalloc_64() : (((old_slen * 6 + 1) <= 80) ? _emalloc_80() : (((old_slen * 6 + 1) <= 96) ? _emalloc_96() : (((old_slen * 6 + 1) <= 112) ? _emalloc_112() : (((old_slen * 6 + 1) <= 128) ? _emalloc_128() : (((old_slen * 6 + 1) <= 160) ? _emalloc_160() : (((old_slen * 6 + 1) <= 192) ? _emalloc_192() : (((old_slen * 6 + 1) <= 224) ? _emalloc_224() : (((old_slen * 6 + 1) <= 256) ? _emalloc_256() : (((old_slen * 6 + 1) <= 320) ? _emalloc_320() : (((old_slen * 6 + 1) <= 384) ? _emalloc_384() : (((old_slen * 6 + 1) <= 448) ? _emalloc_448() : (((old_slen * 6 + 1) <= 512) ? _emalloc_512() : (((old_slen * 6 + 1) <= 640) ? _emalloc_640() : (((old_slen * 6 + 1) <= 768) ? _emalloc_768() : (((old_slen * 6 + 1) <= 896) ? _emalloc_896() : (((old_slen * 6 + 1) <= 1024) ? _emalloc_1024() : (((old_slen * 6 + 1) <= 1280) ? _emalloc_1280() : (((old_slen * 6 + 1) <= 1536) ? _emalloc_1536() : (((old_slen * 6 + 1) <= 1792) ? _emalloc_1792() : (((old_slen * 6 + 1) <= 2048) ? _emalloc_2048() : (((old_slen * 6 + 1) <= 2560) ? _emalloc_2560() : (((old_slen * 6 + 1) <= 3072) ? _emalloc_3072() : (((old_slen * 6 + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((old_slen * 6 + 1)) : _emalloc_huge((old_slen * 6 + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((old_slen * 6 + 1) ) );
       do {
    ...
    case 'b':
     if (escape_xml) {
      s = (phpdbg_globals.err_buf).xml;
     } else {
      s = (phpdbg_globals.err_buf).msg;
     }

     if (s != ((void *)0)) {
      if (escape_xml) {
       s_len = (phpdbg_globals.err_buf).xmllen;
      } else {
       s_len = (phpdbg_globals.err_buf).msglen;
      }
    ...
    case 'r':
     if ((phpdbg_globals.req_id)) {
      s_len = spprintf(&s, 0, "req=\"%lu\"", (phpdbg_globals.req_id));
      free_s = s;
     } else {
      s = "";
      s_len = 0;
    ...
    case 'H':
     ...
     if (alternate_form && (strchr(s, '.')) == ((void *)0)) {
      s[s_len++] = '.';
     }
     break;
     ...
     *(__builtin_va_arg(ap,int *)) = cc;
     goto skip_output;
# 731 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
    case 'p':
...
# 769 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_out.c"
    default:
     char_buf[0] = '%';
     char_buf[1] = *fmt;
     s = char_buf;
...
__attribute__ ((visibility("default"))) int phpdbg_xml_vasprintf(char **buf, const char *format, zend_bool escape_xml, va_list ap) {
 va_list ap2;
 int cc;

 __builtin_va_copy(ap2,ap);
 cc = phpdbg_xml_vsnprintf(((void *)0), 0, format, escape_xml, ap2);
 __builtin_va_end(ap2);

 *buf = ((void *)0);

 if (cc >= 0) {
  if ((*buf = (__builtin_constant_p((++cc) ) ? (((++cc) <= 8) ? _emalloc_8() : (((++cc) <= 16) ? _emalloc_16() : (((++cc) <= 24) ? _emalloc_24() : (((++cc) <= 32) ? _emalloc_32() : (((++cc) <= 40) ? _emalloc_40() : (((++cc) <= 48) ? _emalloc_48() : (((++cc) <= 56) ? _emalloc_56() : (((++cc) <= 64) ? _emalloc_64() : (((++cc) <= 80) ? _emalloc_80() : (((++cc) <= 96) ? _emalloc_96() : (((++cc) <= 112) ? _emalloc_112() : (((++cc) <= 128) ? _emalloc_128() : (((++cc) <= 160) ? _emalloc_160() : (((++cc) <= 192) ? _emalloc_192() : (((++cc) <= 224) ? _emalloc_224() : (((++cc) <= 256) ? _emalloc_256() : (((++cc) <= 320) ? _emalloc_320() : (((++cc) <= 384) ? _emalloc_384() : (((++cc) <= 448) ? _emalloc_448() : (((++cc) <= 512) ? _emalloc_512() : (((++cc) <= 640) ? _emalloc_640() : (((++cc) <= 768) ? _emalloc_768() : (((++cc) <= 896) ? _emalloc_896() : (((++cc) <= 1024) ? _emalloc_1024() : (((++cc) <= 1280) ? _emalloc_1280() : (((++cc) <= 1536) ? _emalloc_1536() : (((++cc) <= 1792) ? _emalloc_1792() : (((++cc) <= 2048) ? _emalloc_2048() : (((++cc) <= 2560) ? _emalloc_2560() : (((++cc) <= 3072) ? _emalloc_3072() : (((++cc) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((++cc)) : _emalloc_huge((++cc))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((++cc) ) )) != ((void *)0)) {
...
__attribute__ ((visibility("default"))) int _phpdbg_xml_asprintf(char **buf, const char *format, zend_bool escape_xml, ...) {
 ...
 __builtin_va_start(va,escape_xml);
...
static int phpdbg_encode_xml(char **buf, char *msg, int msglen, int from, char *to) {
 ...
 char *tmp = *buf = (__builtin_constant_p((msglen * tolen) ) ? (((msglen * tolen) <= 8) ? _emalloc_8() : (((msglen * tolen) <= 16) ? _emalloc_16() : (((msglen * tolen) <= 24) ? _emalloc_24() : (((msglen * tolen) <= 32) ? _emalloc_32() : (((msglen * tolen) <= 40) ? _emalloc_40() : (((msglen * tolen) <= 48) ? _emalloc_48() : (((msglen * tolen) <= 56) ? _emalloc_56() : (((msglen * tolen) <= 64) ? _emalloc_64() : (((msglen * tolen) <= 80) ? _emalloc_80() : (((msglen * tolen) <= 96) ? _emalloc_96() : (((msglen * tolen) <= 112) ? _emalloc_112() : (((msglen * tolen) <= 128) ? _emalloc_128() : (((msglen * tolen) <= 160) ? _emalloc_160() : (((msglen * tolen) <= 192) ? _emalloc_192() : (((msglen * tolen) <= 224) ? _emalloc_224() : (((msglen * tolen) <= 256) ? _emalloc_256() : (((msglen * tolen) <= 320) ? _emalloc_320() : (((msglen * tolen) <= 384) ? _emalloc_384() : (((msglen * tolen) <= 448) ? _emalloc_448() : (((msglen * tolen) <= 512) ? _emalloc_512() : (((msglen * tolen) <= 640) ? _emalloc_640() : (((msglen * tolen) <= 768) ? _emalloc_768() : (((msglen * tolen) <= 896) ? _emalloc_896() : (((msglen * tolen) <= 1024) ? _emalloc_1024() : (((msglen * tolen) <= 1280) ? _emalloc_1280() : (((msglen * tolen) <= 1536) ? _emalloc_1536() : (((msglen * tolen) <= 1792) ? _emalloc_1792() : (((msglen * tolen) <= 2048) ? _emalloc_2048() : (((msglen * tolen) <= 2560) ? _emalloc_2560() : (((msglen * tolen) <= 3072) ? _emalloc_3072() : (((msglen * tolen) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((msglen * tolen)) : _emalloc_huge((msglen * tolen))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((msglen * tolen) ) );
...
static void phpdbg_encode_ctrl_chars(char **buf, int *buflen) {
 ...
 tmp = tmpptr = (__builtin_constant_p((*buflen * 5) ) ? (((*buflen * 5) <= 8) ? _emalloc_8() : (((*buflen * 5) <= 16) ? _emalloc_16() : (((*buflen * 5) <= 24) ? _emalloc_24() : (((*buflen * 5) <= 32) ? _emalloc_32() : (((*buflen * 5) <= 40) ? _emalloc_40() : (((*buflen * 5) <= 48) ? _emalloc_48() : (((*buflen * 5) <= 56) ? _emalloc_56() : (((*buflen * 5) <= 64) ? _emalloc_64() : (((*buflen * 5) <= 80) ? _emalloc_80() : (((*buflen * 5) <= 96) ? _emalloc_96() : (((*buflen * 5) <= 112) ? _emalloc_112() : (((*buflen * 5) <= 128) ? _emalloc_128() : (((*buflen * 5) <= 160) ? _emalloc_160() : (((*buflen * 5) <= 192) ? _emalloc_192() : (((*buflen * 5) <= 224) ? _emalloc_224() : (((*buflen * 5) <= 256) ? _emalloc_256() : (((*buflen * 5) <= 320) ? _emalloc_320() : (((*buflen * 5) <= 384) ? _emalloc_384() : (((*buflen * 5) <= 448) ? _emalloc_448() : (((*buflen * 5) <= 512) ? _emalloc_512() : (((*buflen * 5) <= 640) ? _emalloc_640() : (((*buflen * 5) <= 768) ? _emalloc_768() : (((*buflen * 5) <= 896) ? _emalloc_896() : (((*buflen * 5) <= 1024) ? _emalloc_1024() : (((*buflen * 5) <= 1280) ? _emalloc_1280() : (((*buflen * 5) <= 1536) ? _emalloc_1536() : (((*buflen * 5) <= 1792) ? _emalloc_1792() : (((*buflen * 5) <= 2048) ? _emalloc_2048() : (((*buflen * 5) <= 2560) ? _emalloc_2560() : (((*buflen * 5) <= 3072) ? _emalloc_3072() : (((*buflen * 5) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((*buflen * 5)) : _emalloc_huge((*buflen * 5))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((*buflen * 5) ) );
 ...
 _efree((*buf) );
 *buf = _erealloc((tmp), (len + 1) );
 *buflen = len;
}

static int phpdbg_process_print(int fd, int type, const char *tag, const char *msg, int msglen, const char *xml, int xmllen) {
 char *msgout = ((void *)0), *buf;
 int msgoutlen, xmloutlen, buflen;
 const char *severity;

 if (((phpdbg_globals.flags) & (1ULL<<32)) && (phpdbg_globals.in_script_xml) && (phpdbg_globals.in_script_xml) != type) {
  phpdbg_mixed_write(fd, ("</stream>"), (sizeof("</stream>")-1));
  (phpdbg_globals.in_script_xml) = 0;
 }

 switch (type) {
  case P_ERROR:
   severity = "error";
   if (!(phpdbg_globals.last_was_newline)) {
    if ((phpdbg_globals.flags) & (1ULL<<32)) {
     phpdbg_mixed_write(fd, ("<phpdbg>\n" "</phpdbg>"), (sizeof("<phpdbg>\n" "</phpdbg>")-1));
    } else {
     phpdbg_mixed_write(fd, ("\n"), (sizeof("\n")-1));
    }
    (phpdbg_globals.last_was_newline) = 1;
   }
   if ((phpdbg_globals.flags) & (1ULL<<17)) {
    msgoutlen = _phpdbg_asprintf(&msgout, "\033[%sm[%.*s]\033[0m\n", (phpdbg_globals.colors)[1]->code, msglen, msg);
   } else {
    msgoutlen = _phpdbg_asprintf(&msgout, "[%.*s]\n", msglen, msg);
   }
   break;
  ...
  case P_NOTICE:
   ...
   if ((phpdbg_globals.flags) & (1ULL<<17)) {
    msgoutlen = _phpdbg_asprintf(&msgout, "\033[%sm[%.*s]\033[0m\n", (phpdbg_globals.colors)[2]->code, msglen, msg);
   } else {
    msgoutlen = _phpdbg_asprintf(&msgout, "[%.*s]\n", msglen, msg);
   }
   break;
  ...
  case P_WRITE:
   severity = "normal";
   if (msg) {
    msgout = _estrndup((msg), (msglen) );
    msgoutlen = msglen;
    (phpdbg_globals.last_was_newline) = msg[msglen - 1] == '\n';
   } else {
    msgoutlen = 0;
    msgout = _estrdup(("") );
   }
  ...
  case P_STDERR:
   if (msg) {
    ...
    if ((phpdbg_globals.flags) & (1ULL<<32)) {
     ...
     if ((phpdbg_globals.in_script_xml) != type) {
      char *stream_buf;
      int stream_buflen = _phpdbg_asprintf(&stream_buf, "<stream type=\"%s\">", type == P_STDERR ? "stderr" : "stdout");
      phpdbg_mixed_write(fd, stream_buf, stream_buflen);
      _efree((stream_buf) );
      (phpdbg_globals.in_script_xml) = type;
     }
     encoded = php_escape_html_entities((unsigned char *) msg, msglen, 0, 0, (core_globals.internal_encoding) && (core_globals.internal_encoding)[0] ? (core_globals.internal_encoding) : ((sapi_globals.default_charset) ? (sapi_globals.default_charset) : "UTF-8"));
     buflen = (encoded)->len;
     memcpy(buf = (__builtin_constant_p((buflen + 1) ) ? (((buflen + 1) <= 8) ? _emalloc_8() : (((buflen + 1) <= 16) ? _emalloc_16() : (((buflen + 1) <= 24) ? _emalloc_24() : (((buflen + 1) <= 32) ? _emalloc_32() : (((buflen + 1) <= 40) ? _emalloc_40() : (((buflen + 1) <= 48) ? _emalloc_48() : (((buflen + 1) <= 56) ? _emalloc_56() : (((buflen + 1) <= 64) ? _emalloc_64() : (((buflen + 1) <= 80) ? _emalloc_80() : (((buflen + 1) <= 96) ? _emalloc_96() : (((buflen + 1) <= 112) ? _emalloc_112() : (((buflen + 1) <= 128) ? _emalloc_128() : (((buflen + 1) <= 160) ? _emalloc_160() : (((buflen + 1) <= 192) ? _emalloc_192() : (((buflen + 1) <= 224) ? _emalloc_224() : (((buflen + 1) <= 256) ? _emalloc_256() : (((buflen + 1) <= 320) ? _emalloc_320() : (((buflen + 1) <= 384) ? _emalloc_384() : (((buflen + 1) <= 448) ? _emalloc_448() : (((buflen + 1) <= 512) ? _emalloc_512() : (((buflen + 1) <= 640) ? _emalloc_640() : (((buflen + 1) <= 768) ? _emalloc_768() : (((buflen + 1) <= 896) ? _emalloc_896() : (((buflen + 1) <= 1024) ? _emalloc_1024() : (((buflen + 1) <= 1280) ? _emalloc_1280() : (((buflen + 1) <= 1536) ? _emalloc_1536() : (((buflen + 1) <= 1792) ? _emalloc_1792() : (((buflen + 1) <= 2048) ? _emalloc_2048() : (((buflen + 1) <= 2560) ? _emalloc_2560() : (((buflen + 1) <= 3072) ? _emalloc_3072() : (((buflen + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((buflen + 1)) : _emalloc_huge((buflen + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((buflen + 1) ) ), (encoded)->val, buflen);
  ...
  case P_LOG:
   ...
   if (msg) {
    ...
    if (gettimeofday(&tp, ((void *)0)) == SUCCESS) {
     msgoutlen = _phpdbg_asprintf(&msgout, "[%ld %.8F]: %.*s\n", tp.tv_sec, tp.tv_usec / 1000000., msglen, msg);
    } else {
     msgoutlen = FAILURE;
    }
   }
 ...
 if ((phpdbg_globals.flags) & (1ULL<<32)) {
  ...
  if ((phpdbg_globals.req_id)) {
   char *xmlbuf = ((void *)0);
   xmllen = _phpdbg_asprintf(&xmlbuf, "req=\"%lu\" %.*s", (phpdbg_globals.req_id), xmllen, xml);
   xml = xmlbuf;
  }
  if (msgout) {
   buflen = phpdbg_encode_xml(&buf, msgout, msgoutlen, '"', "&quot;");
   xmloutlen = _phpdbg_asprintf(&xmlout, "<%s severity=\"%s\" %.*s msgout=\"%.*s\" />", tag, severity, xmllen, xml, buflen, buf);

   _efree((buf) );
  } else {
   xmloutlen = _phpdbg_asprintf(&xmlout, "<%s severity=\"%s\" %.*s msgout=\"\" />", tag, severity, xmllen, xml);
  }
 ...
 if ((phpdbg_globals.req_id) && ((phpdbg_globals.flags) & (1ULL<<32))) {
  _efree(((char *) xml) );
 }
...
__attribute__ ((visibility("default"))) int phpdbg_vprint(int type, int fd, const char *tag, const char *xmlfmt, const char *strfmt, va_list args) {
 char *msg = ((void *)0), *xml = ((void *)0);
 int msglen = 0, xmllen = 0;
 int len;
 va_list argcpy;

 if (strfmt != ((void *)0) && strlen(strfmt) > 0L) {
  __builtin_va_copy(argcpy,args);
  msglen = phpdbg_xml_vasprintf(&msg, strfmt, 0, argcpy);
  __builtin_va_end(argcpy);
 }

 if ((phpdbg_globals.flags) & (1ULL<<32)) {
  if (xmlfmt != ((void *)0) && strlen(xmlfmt) > 0L) {
   __builtin_va_copy(argcpy,args);
 ...
 if ((phpdbg_globals.err_buf).active && type != P_STDOUT && type != P_STDERR) {
  phpdbg_free_err_buf();

  (phpdbg_globals.err_buf).type = type;
  (phpdbg_globals.err_buf).fd = fd;
  (phpdbg_globals.err_buf).tag = _estrdup((tag) );
  (phpdbg_globals.err_buf).msg = msg;
  (phpdbg_globals.err_buf).msglen = msglen;
  if ((phpdbg_globals.flags) & (1ULL<<32)) {
   (phpdbg_globals.err_buf).xml = xml;
   (phpdbg_globals.err_buf).xmllen = xmllen;
  }
...
__attribute__ ((visibility("default"))) void phpdbg_free_err_buf(void) {
 if ((phpdbg_globals.err_buf).type == 0) {
  return;
 }

 (phpdbg_globals.err_buf).type = 0;

 _efree(((phpdbg_globals.err_buf).tag) );
 _efree(((phpdbg_globals.err_buf).msg) );
 if ((phpdbg_globals.flags) & (1ULL<<32)) {
  _efree(((phpdbg_globals.err_buf).xml) );
 }
}

__attribute__ ((visibility("default"))) void phpdbg_activate_err_buf(zend_bool active) {
 (phpdbg_globals.err_buf).active = active;
}

__attribute__ ((visibility("default"))) int phpdbg_output_err_buf(const char *tag, const char *xmlfmt, const char *strfmt, ...) {
 int len;
 va_list args;
 int errbuf_active = (phpdbg_globals.err_buf).active;

 if ((phpdbg_globals.flags) & (1ULL<<35)) {
  return 0;
 }

 (phpdbg_globals.err_buf).active = 0;

 __builtin_va_start(args,strfmt);
 len = phpdbg_vprint((phpdbg_globals.err_buf).type, (phpdbg_globals.err_buf).fd, tag ? tag : (phpdbg_globals.err_buf).tag, xmlfmt, strfmt, args);
 __builtin_va_end(args);

 (phpdbg_globals.err_buf).active = errbuf_active;
 phpdbg_free_err_buf();

 return len;
}

__attribute__ ((visibility("default"))) int phpdbg_print(int type, int fd, const char *tag, const char *xmlfmt, const char *strfmt, ...) {
 va_list args;
 int len;
...
__attribute__ ((visibility("default"))) int phpdbg_xml_internal(int fd, const char *fmt, ...) {
 ...
 if ((phpdbg_globals.flags) & (1ULL<<32)) {
  ...
  if ((phpdbg_globals.in_script_xml)) {
   phpdbg_mixed_write(fd, ("</stream>"), (sizeof("</stream>")-1));
   (phpdbg_globals.in_script_xml) = 0;
  }
...
__attribute__ ((visibility("default"))) int phpdbg_out_internal(int fd, const char *fmt, ...) {
 ...
 if ((phpdbg_globals.flags) & (1ULL<<32)) {
  ...
  msglen = phpdbg_encode_xml(&msg, buffer, buflen, 256, ((void *)0));
  ...
  phpdbg_mixed_write(fd, ("<phpdbg>"), (sizeof("<phpdbg>")-1));
...
__attribute__ ((visibility("default"))) int phpdbg_rlog_internal(int fd, const char *fmt, ...) {
 ...
 if (gettimeofday(&tp, ((void *)0)) == SUCCESS) {
  char friendly[100];
  char *format = ((void *)0), *buffer = ((void *)0), *outbuf = ((void *)0);
  ...
  _phpdbg_asprintf(&buffer, friendly, tp.tv_usec/1000);
  _phpdbg_asprintf(&format, "[%s]: %s\n", buffer, fmt);
