# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c" 2
...
const phpdbg_command_t phpdbg_print_commands[] = {
 {"exec", sizeof("exec")-1, "print out the instructions in the main execution context", sizeof("print out the instructions in the main execution context")-1, 'e', phpdbg_do_print_exec, ((void *)0), 0, &phpdbg_prompt_commands[8], 1},
 {"opline", sizeof("opline")-1, "print out the instruction in the current opline", sizeof("print out the instruction in the current opline")-1, 'o', phpdbg_do_print_opline, ((void *)0), 0, &phpdbg_prompt_commands[8], 1},
 {"class", sizeof("class")-1, "print out the instructions in the specified class", sizeof("print out the instructions in the specified class")-1, 'c', phpdbg_do_print_class, ((void *)0), "s", &phpdbg_prompt_commands[8], 1},
 {"method", sizeof("method")-1, "print out the instructions in the specified method", sizeof("print out the instructions in the specified method")-1, 'm', phpdbg_do_print_method, ((void *)0), "m", &phpdbg_prompt_commands[8], 1},
 {"func", sizeof("func")-1, "print out the instructions in the specified function", sizeof("print out the instructions in the specified function")-1, 'f', phpdbg_do_print_func, ((void *)0), "s", &phpdbg_prompt_commands[8], 1},
 {"stack", sizeof("stack")-1, "print out the instructions in the current stack", sizeof("print out the instructions in the current stack")-1, 's', phpdbg_do_print_stack, ((void *)0), 0, &phpdbg_prompt_commands[8], 1},
 {((void *)0), 0, ((void *)0), 0, '\0', ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0}
};

int phpdbg_do_print_opline(const phpdbg_param_t *param)
{
 if ((phpdbg_globals.in_execution) && (executor_globals.current_execute_data)) {
  phpdbg_print_opline(phpdbg_user_execute_data((executor_globals.current_execute_data)), 1);
 } else {
...
static inline void phpdbg_print_function_helper(zend_function *method)
{
 switch (method->type) {
  case 2: {
   ...
   if (op_array) {
    ...
    if (method->common.scope) {
     ...
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "printoplineinfo", "type=\"User\" startline=\"%d\" endline=\"%d\" function=\"%s\" file=\"%s\" opline=\"%p\"", "L%d-%d %s() %s - %p + %d ops", op_array->line_start, op_array->line_end, method->common.function_name ? (method->common.function_name)->val : "{main}", op_array->filename ? (op_array->filename)->val : "unknown", opline, op_array->last)
    ...
    do {
     ...
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "print", "line=\"%u\" opnum=\"%u\" op=\"%s\"", " L%-4u #%-5u %s", opline->lineno, opcode, decode)
  ...
  default: {
   if (method->common.scope) {
    phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "printoplineinfo", "type=\"Internal\" method=\"%s::%s\"", "\tInternal %s::%s()", (method->common.scope->name)->val, (method->common.function_name)->val);
   } else {
    phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "printoplineinfo", "type=\"Internal\" function=\"%s\"", "\tInternal %s()", (method->common.function_name)->val);
   }
  }
 }
}
...
int phpdbg_do_print_exec(const phpdbg_param_t *param)
{
 if ((phpdbg_globals.exec)) {
  if (!(phpdbg_globals.ops) && !((phpdbg_globals.flags) & (1ULL<<34))) {
   phpdbg_compile();
  }

  if ((phpdbg_globals.ops)) {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "file=\"%s\" num=\"%d\"", "Context %s (%d ops)", (phpdbg_globals.exec), (phpdbg_globals.ops)->last);

   phpdbg_print_function_helper((zend_function*) (phpdbg_globals.ops));
  }
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"nocontext\"", "No execution context set");
 }
...
{
 if ((phpdbg_globals.in_execution) && (executor_globals.current_execute_data)) {
  zend_op_array *ops = &phpdbg_user_execute_data((executor_globals.current_execute_data))->func->op_array;
  if (ops->function_name) {
   if (ops->scope) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "method=\"%s::%s\" num=\"%d\"", "Stack in %s::%s() (%d ops)", (ops->scope->name)->val, (ops->function_name)->val, ops->last);
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "function=\"%s\" num=\"%d\"", "Stack in %s() (%d ops)", (ops->function_name)->val, ops->last);
   }
  } else {
   if (ops->filename) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "file=\"%s\" num=\"%d\"", "Stack in %s (%d ops)", (ops->filename)->val, ops->last);
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "opline=\"%p\" num=\"%d\"", "Stack @ %p (%d ops)", ops, ops->last);
   }
  }
...
int phpdbg_do_print_class(const phpdbg_param_t *param)
{
 ...
 if (phpdbg_safe_class_lookup(param->str, param->len, &ce) == SUCCESS) {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "type=\"%s\" flag=\"%s\" class=\"%s\" num=\"%d\"", "%s %s: %s (%d methods)", (ce->type == 2) ? "User" : "Internal", (ce->ce_flags & 0x40) ? "Interface" : (ce->ce_flags & 0x02) ? "Abstract Class" : "Class", (ce->name)->val, (&ce->function_table)->nNumOfElements)
# 163 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_print.c"
                                               ;

  phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<printmethods %r>");

  if ((&ce->function_table)->nNumOfElements) {
   zend_function *method;

   do { Bucket *_p = (&ce->function_table)->arData; Bucket *_end = _p + (&ce->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; method = (*(_z)).value.ptr; {
    phpdbg_print_function_helper(method);
   } } } while (0);
  }

  phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</printmethods>");
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "print", "type=\"noclass\" class=\"%s\"", "The class %s could not be found", param->str);
 }
...
int phpdbg_do_print_method(const phpdbg_param_t *param)
{
 ...
 if (phpdbg_safe_class_lookup(param->method.class, strlen(param->method.class), &ce) == SUCCESS) {
  ...
  if ((fbc = zend_hash_find_ptr(&ce->function_table, lcname))) {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "type=\"%s\" flags=\"Method\" symbol=\"%s\" num=\"%d\"", "%s Method %s (%d ops)", (fbc->type == 2) ? "User" : "Internal", (fbc->common.function_name)->val, (fbc->type == 2) ? fbc->op_array.last : 0)
   ...
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "print", "type=\"nomethod\" method=\"%s::%s\"", "The method %s::%s could not be found", param->method.class, param->method.name);
  }

  zend_string_release(lcname);
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "print", "type=\"noclass\" class=\"%s\"", "The class %s could not be found", param->method.class);
 }
...
int phpdbg_do_print_func(const phpdbg_param_t *param)
{
 ...
 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  if ((fbc = zend_hash_find_ptr(func_table, lcname))) {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "printinfo", "type=\"%s\" flags=\"%s\" symbol=\"%s\" num=\"%d\"", "%s %s %s (%d ops)", (fbc->type == 2) ? "User" : "Internal", (fbc->common.scope) ? "Method" : "Function", (fbc->common.function_name)->val, (fbc->type == 2) ? fbc->op_array.last : 0)
   ...
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "print", "type=\"nofunction\" function=\"%s\"", "The function %s could not be found", func_name);
  }
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "function=\"%.*s\"", "Couldn't fetch function %.*s, invalid data source", (int) func_name_len, func_name);
...
void phpdbg_print_opcodes_main() {
 phpdbg_out_internal((phpdbg_globals.io)[1].fd, "function name: (null)\n");
 phpdbg_print_function_helper((zend_function *) (phpdbg_globals.ops));
}

void phpdbg_print_opcodes_function(const char *function, size_t len) {
 zend_function *func = zend_hash_str_find_ptr((executor_globals.function_table), function, len);

 if (!func) {
  zend_string *rt_name;
  do { Bucket *_p = ((executor_globals.class_table))->arData; Bucket *_end = _p + ((executor_globals.class_table))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; rt_name = _p->key; func = (*(_z)).value.ptr; {
   if (func->type == 2 && *rt_name->val == '\0') {
 ...
 phpdbg_out_internal((phpdbg_globals.io)[1].fd, "function name: %.*s\n", (int) (func->op_array.function_name)->len, (func->op_array.function_name)->val);
...
static void phpdbg_print_opcodes_method_ce(zend_class_entry *ce, const char *function) {
 ...
 if (ce->type != 2) {
  phpdbg_out_internal((phpdbg_globals.io)[1].fd, "function name: %s::%s (internal)\n", ce->name->val, function);
  return;
 }
 ...
 phpdbg_out_internal((phpdbg_globals.io)[1].fd, "function name: %s::%s\n", ce->name->val, function);
 phpdbg_print_function_helper(func);
}
...
void phpdbg_print_opcodes_method(const char *class, const char *function) {
 ...
 if (phpdbg_safe_class_lookup(class, strlen(class), &ce) != SUCCESS) {
  zend_string *rt_name;
  do { Bucket *_p = ((executor_globals.class_table))->arData; Bucket *_end = _p + ((executor_globals.class_table))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; rt_name = _p->key; ce = (*(_z)).value.ptr; {
   if (ce->type == 2 && *rt_name->val == '\0') {
...
static void phpdbg_print_opcodes_ce(zend_class_entry *ce) {
 ...
 phpdbg_out_internal((phpdbg_globals.io)[1].fd, "%s %s: %s\n", (ce->type == 2) ? "user" : "internal", (ce->ce_flags & 0x40) ? "interface" : (ce->ce_flags & 0x02) ? "abstract Class" : "class", (ce->name)->val)
 ...
 phpdbg_out_internal((phpdbg_globals.io)[1].fd, "%d methods: ", (&ce->function_table)->nNumOfElements);
 do { Bucket *_p = (&ce->function_table)->arData; Bucket *_end = _p + (&ce->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; method = (*(_z)).value.ptr; {
  if (first) {
   first = 0;
  } else {
  ...
  phpdbg_out_internal((phpdbg_globals.io)[1].fd, "%s", (method->common.function_name)->val);
 } } } while (0);
 if (first) {
  phpdbg_out_internal((phpdbg_globals.io)[1].fd, "-");
 }
 ...
 do { Bucket *_p = (&ce->function_table)->arData; Bucket *_end = _p + (&ce->function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; method_name = _p->key; method = (*(_z)).value.ptr; {
  phpdbg_out_internal((phpdbg_globals.io)[1].fd, "\nfunction name: %s\n", (method_name)->val);
  phpdbg_print_function_helper(method);
 } } } while (0);
}
