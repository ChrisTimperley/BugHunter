# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c" 2
...
const phpdbg_command_t phpdbg_help_commands[] = {
 {"aliases", sizeof("aliases")-1, "show alias list", sizeof("show alias list")-1, 'a', phpdbg_do_help_aliases, &phpdbg_prompt_commands[16], 0},
 {"options", sizeof("options")-1, "command line options", sizeof("command line options")-1, 0, ((void *)0), &phpdbg_prompt_commands[16], 0},
 {"overview", sizeof("overview")-1, "help overview", sizeof("help overview")-1, 0, ((void *)0), &phpdbg_prompt_commands[16], 0},
 {"phpdbginit", sizeof("phpdbginit")-1, "phpdbginit file format", sizeof("phpdbginit file format")-1, 0, ((void *)0), &phpdbg_prompt_commands[16], 0},
 {"syntax", sizeof("syntax")-1, "syntax overview", sizeof("syntax overview")-1, 0, ((void *)0), &phpdbg_prompt_commands[16], 0},
...
void pretty_print(char *text)
{
 ...
 unsigned int prompt_len = strlen((phpdbg_globals.prompt)[0]);

 const char *bold_on_escape = (phpdbg_globals.flags) & (1ULL<<17) ? "\033[1m" : "";
 const char *bold_off_escape = (phpdbg_globals.flags) & (1ULL<<17) ? "\033[0m" : "";
 ...
 char *last_new_blank = ((void *)0);
 unsigned int last_blank_count = 0;
 unsigned int line_count = 0;

 if ((phpdbg_globals.flags) & (1ULL<<32)) {
  phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<help %r msg=\"%s\" />", text);
  return;
 }


 for (p = text; *p; p++) {
  if (__builtin_expect(!!(p[0] == '*'), 0) && p[1] == '*') {
   size += bold_escape_len - 2;
   p++;
  } else if (__builtin_expect(!!(p[0] == '$'), 0) && p[1] == 'P') {
   size += prompt_escape_len - 2;
   p++;
  } else if (__builtin_expect(!!(p[0] == '\\'), 0)) {
   p++;
  }
 }
 size += (p-text)+1;

 new = (__builtin_constant_p((size) ) ? (((size) <= 8) ? _emalloc_8() : (((size) <= 16) ? _emalloc_16() : (((size) <= 24) ? _emalloc_24() : (((size) <= 32) ? _emalloc_32() : (((size) <= 40) ? _emalloc_40() : (((size) <= 48) ? _emalloc_48() : (((size) <= 56) ? _emalloc_56() : (((size) <= 64) ? _emalloc_64() : (((size) <= 80) ? _emalloc_80() : (((size) <= 96) ? _emalloc_96() : (((size) <= 112) ? _emalloc_112() : (((size) <= 128) ? _emalloc_128() : (((size) <= 160) ? _emalloc_160() : (((size) <= 192) ? _emalloc_192() : (((size) <= 224) ? _emalloc_224() : (((size) <= 256) ? _emalloc_256() : (((size) <= 320) ? _emalloc_320() : (((size) <= 384) ? _emalloc_384() : (((size) <= 448) ? _emalloc_448() : (((size) <= 512) ? _emalloc_512() : (((size) <= 640) ? _emalloc_640() : (((size) <= 768) ? _emalloc_768() : (((size) <= 896) ? _emalloc_896() : (((size) <= 1024) ? _emalloc_1024() : (((size) <= 1280) ? _emalloc_1280() : (((size) <= 1536) ? _emalloc_1536() : (((size) <= 1792) ? _emalloc_1792() : (((size) <= 2048) ? _emalloc_2048() : (((size) <= 2560) ? _emalloc_2560() : (((size) <= 3072) ? _emalloc_3072() : (((size) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((size)) : _emalloc_huge((size))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((size) ) );
# 95 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c"
 for (p = text, q = new; *p; p++) {
  if (__builtin_expect(!!(*p == ' '), 0)) {
   last_new_blank = q;
   last_blank_count = line_count++;
   *q++ = ' ';
  } else if (__builtin_expect(!!(*p == '\n'), 0)) {
   last_new_blank = ((void *)0);
   *q++ = *p;
   last_blank_count = 0;
   line_count = 0;
  } else if (__builtin_expect(!!(p[0] == '*'), 0) && p[1] == '*') {
   if (bold_escape_len) {
    in_bold = !in_bold;
  ...
  if (__builtin_expect(!!(line_count>=term_width), 0) && last_new_blank) {
   *last_new_blank = '\n';
   last_new_blank = ((void *)0);
 ...
 *q++ = '\0';
 ...
 if ((q-new)>size) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "help", "overrun=\"%lu\"", "Output overrun of %lu bytes", ((q - new) - size));
 }

 phpdbg_out_internal((phpdbg_globals.io)[1].fd, "%s\n", new);
 _efree((new) );
}
...
# 179 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c"
 ...
 if (param && param->type == STR_PARAM) {
  ...
  if (n==1) {
   ...
   if (param->len > 1) {
    ...
    phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "help", "type=\"ambiguousalias\" alias=\"%s\"", "Internal help error, non-unique alias \"%c\"", param->str[0]);
    return FAILURE;
   }
...
int phpdbg_do_help_aliases(const phpdbg_param_t *param)
{
 ...
 phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "help", "", "Below are the aliased, short versions of all supported commands");
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<helpcommands %r>");
 for(c = phpdbg_prompt_commands; c->name; c++) {
  if (c->alias && c->alias != 'h') {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "command", "alias=\"%c\" name=\"%s\" tip=\"%s\"", " %c     %-20s  %s", c->alias, c->name, c->tip);
   if (c->subs) {
    len = 20 - 1 - c->name_len;
    for(c_sub = c->subs; c_sub->alias; c_sub++) {
     if (c_sub->alias) {
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "subcommand", "parent_alias=\"%c\" alias=\"%c\" parent=\"%s\" name=\"%-*s\" tip=\"%s\"", " %c %c   %s %-*s  %s", c->alias, c_sub->alias, c->name, len, c_sub->name, c_sub->tip)
                                                                     ;
     }
    }
   }
 ...
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</helpcommands>");


 get_command("h", 1, &c, phpdbg_prompt_commands);
 phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "aliasinfo", "alias=\"%c\" name=\"%s\" tip=\"%s\"", " %c     %-20s  %s\n", c->alias, c->name, c->tip);

 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<helpaliases>");

 len = 20 - 1 - c->name_len;
 for(c_sub = c->subs; c_sub->alias; c_sub++) {
  if (c_sub->alias) {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "alias", "parent_alias=\"%c\" alias=\"%c\" parent=\"%s\" name=\"%-*s\" tip=\"%s\"", " %c %c   %s %-*s  %s", c->alias, c_sub->alias, c->name, len, c_sub->name, c_sub->tip)
                                                                  ;
  }
 }
...
# 324 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_help.c"
...
"but **help cl** will list the summary for **clean** and **clear**." "\n" "\n"
...
"files and not in interactive sessions." "\n" "\n"
...
"and **register** PHP functions as new commands." "\n" "\n"
...
"is a synomyn for **info break** and **l func** for **list func**, etc." "\n" "\n"
...
"execution, if evaluated as true in a boolean context at the specified target." "\n" "\n"
...
"as they significantly slow execution." "\n" "\n"
...
"been explicitly changed by issuing a **frame** command. " "\n" "\n"
...
"is needed here.  You can even call PHP functions which have breakpoints defined. " "\n" "\n"
...
"This can be used to allowing access to the variables in a higher stack frame than that currently being executed." "\n" "\n"
...
"variables including the return value before it is returned" "\n" "\n"
...
"be stopped when that line is left." "\n" "\n"
...
"will then continue until the next breakpoint or completion of the script" "\n" "\n"
