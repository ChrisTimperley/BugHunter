# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_utils.c" 2
...
const static phpdbg_element_t elements[] = {
 ...
 {"error", sizeof("error")-1, 1},
 {"notice", sizeof("notice")-1, 2},
 {((void *)0), 0L, 0}
};
...
__attribute__ ((visibility("default"))) const zend_function *phpdbg_get_function(const char *fname, const char *cname)
{
 ...
 if (cname) {
  ...
  func = zend_hash_find_ptr((executor_globals.function_table), lfname);
 }
...
__attribute__ ((visibility("default"))) const char *phpdbg_get_prompt(void)
{
 ...
 if (((phpdbg_globals.flags) & (1ULL<<17))) {
  (({ __typeof__ (asprintf(&(phpdbg_globals.prompt)[1], "\033[%sm%s\033[0m ", (phpdbg_globals.colors)[0]->code, (phpdbg_globals.prompt)[0])) __x = (asprintf(&(phpdbg_globals.prompt)[1], "\033[%sm%s\033[0m ", (phpdbg_globals.colors)[0]->code, (phpdbg_globals.prompt)[0])); (void) __x; }))

                        ;
 } else

 {
  (({ __typeof__ (asprintf(&(phpdbg_globals.prompt)[1], "%s ", (phpdbg_globals.prompt)[0])) __x = (asprintf(&(phpdbg_globals.prompt)[1], "%s ", (phpdbg_globals.prompt)[0])); (void) __x; }));
 }
...
__attribute__ ((visibility("default"))) int phpdbg_get_terminal_width(void)
{
 ...
 columns = ioctl(fileno(stdout), 0x5413, &w) == 0 ? w.ws_col : 80;
...
__attribute__ ((visibility("default"))) int phpdbg_get_terminal_height(void)
{
 ...
 lines = ioctl(fileno(stdout), 0x5413, &w) == 0 ? w.ws_row : 40;
...
int phpdbg_safe_class_lookup(const char *name, int name_length, zend_class_entry **ce) {
 if ((phpdbg_globals.flags) & (1ULL<<34)) {
  ...
  lc_free = lc_name = (__builtin_constant_p((name_length + 1) ) ? (((name_length + 1) <= 8) ? _emalloc_8() : (((name_length + 1) <= 16) ? _emalloc_16() : (((name_length + 1) <= 24) ? _emalloc_24() : (((name_length + 1) <= 32) ? _emalloc_32() : (((name_length + 1) <= 40) ? _emalloc_40() : (((name_length + 1) <= 48) ? _emalloc_48() : (((name_length + 1) <= 56) ? _emalloc_56() : (((name_length + 1) <= 64) ? _emalloc_64() : (((name_length + 1) <= 80) ? _emalloc_80() : (((name_length + 1) <= 96) ? _emalloc_96() : (((name_length + 1) <= 112) ? _emalloc_112() : (((name_length + 1) <= 128) ? _emalloc_128() : (((name_length + 1) <= 160) ? _emalloc_160() : (((name_length + 1) <= 192) ? _emalloc_192() : (((name_length + 1) <= 224) ? _emalloc_224() : (((name_length + 1) <= 256) ? _emalloc_256() : (((name_length + 1) <= 320) ? _emalloc_320() : (((name_length + 1) <= 384) ? _emalloc_384() : (((name_length + 1) <= 448) ? _emalloc_448() : (((name_length + 1) <= 512) ? _emalloc_512() : (((name_length + 1) <= 640) ? _emalloc_640() : (((name_length + 1) <= 768) ? _emalloc_768() : (((name_length + 1) <= 896) ? _emalloc_896() : (((name_length + 1) <= 1024) ? _emalloc_1024() : (((name_length + 1) <= 1280) ? _emalloc_1280() : (((name_length + 1) <= 1536) ? _emalloc_1536() : (((name_length + 1) <= 1792) ? _emalloc_1792() : (((name_length + 1) <= 2048) ? _emalloc_2048() : (((name_length + 1) <= 2560) ? _emalloc_2560() : (((name_length + 1) <= 3072) ? _emalloc_3072() : (((name_length + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((name_length + 1)) : _emalloc_huge((name_length + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((name_length + 1) ) );
   ...
   *ce = zend_hash_str_find_ptr((executor_globals.class_table), lc_name, lc_length);
  } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "class=\"%.*s\"", "Could not fetch class %.*s, invalid data source", name_length, name);
...
__attribute__ ((visibility("default"))) int phpdbg_parse_variable(char *input, size_t len, HashTable *parent, size_t i, phpdbg_parse_var_func callback, zend_bool silent) {
 return phpdbg_parse_variable_with_arg(input, len, parent, i, (phpdbg_parse_var_with_arg_func) phpdbg_parse_variable_arg_wrapper, ((void *)0), silent, callback);
}
...
__attribute__ ((visibility("default"))) int phpdbg_parse_variable_with_arg(char *input, size_t len, HashTable *parent, size_t i, phpdbg_parse_var_with_arg_func callback, phpdbg_parse_var_with_arg_func step_cb, zend_bool silent, void *arg) {
 ...
 while (i++ < len) {
  ...
  if (new_index && index_len == 0) {
   zend_ulong numkey;
   zend_string *strkey;
   do { Bucket *_p = (parent)->arData; Bucket *_end = _p + (parent)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; numkey = _p->h; strkey = _p->key; zv = (*(_z)).value.ptr; {
    ...
    if (i == len || (i == len - 1 && input[len - 1] == ']')) {
     ...
     char *name;
     char *keyname = _estrndup((last_index), (index_len) );
     if (strkey) {
      key = (strkey)->val;
      keylen = (strkey)->len;
     } else {
      keylen = spprintf(&key, 0, "%" "l" "u", numkey);
     }
     propkey = phpdbg_get_property_key(key);
     name = (__builtin_constant_p((i + keylen + 2) ) ? (((i + keylen + 2) <= 8) ? _emalloc_8() : (((i + keylen + 2) <= 16) ? _emalloc_16() : (((i + keylen + 2) <= 24) ? _emalloc_24() : (((i + keylen + 2) <= 32) ? _emalloc_32() : (((i + keylen + 2) <= 40) ? _emalloc_40() : (((i + keylen + 2) <= 48) ? _emalloc_48() : (((i + keylen + 2) <= 56) ? _emalloc_56() : (((i + keylen + 2) <= 64) ? _emalloc_64() : (((i + keylen + 2) <= 80) ? _emalloc_80() : (((i + keylen + 2) <= 96) ? _emalloc_96() : (((i + keylen + 2) <= 112) ? _emalloc_112() : (((i + keylen + 2) <= 128) ? _emalloc_128() : (((i + keylen + 2) <= 160) ? _emalloc_160() : (((i + keylen + 2) <= 192) ? _emalloc_192() : (((i + keylen + 2) <= 224) ? _emalloc_224() : (((i + keylen + 2) <= 256) ? _emalloc_256() : (((i + keylen + 2) <= 320) ? _emalloc_320() : (((i + keylen + 2) <= 384) ? _emalloc_384() : (((i + keylen + 2) <= 448) ? _emalloc_448() : (((i + keylen + 2) <= 512) ? _emalloc_512() : (((i + keylen + 2) <= 640) ? _emalloc_640() : (((i + keylen + 2) <= 768) ? _emalloc_768() : (((i + keylen + 2) <= 896) ? _emalloc_896() : (((i + keylen + 2) <= 1024) ? _emalloc_1024() : (((i + keylen + 2) <= 1280) ? _emalloc_1280() : (((i + keylen + 2) <= 1536) ? _emalloc_1536() : (((i + keylen + 2) <= 1792) ? _emalloc_1792() : (((i + keylen + 2) <= 2048) ? _emalloc_2048() : (((i + keylen + 2) <= 2560) ? _emalloc_2560() : (((i + keylen + 2) <= 3072) ? _emalloc_3072() : (((i + keylen + 2) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((i + keylen + 2)) : _emalloc_huge((i + keylen + 2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((i + keylen + 2) ) );
     namelen = php_sprintf(name, "%.*s%.*s%s", (int) i, input, (int) (keylen - (propkey - key)), propkey, input[len - 1] == ']'?"]":"");
     if (!strkey) {
      _efree((key) );
     }

     ret = callback(name, namelen, keyname, index_len, parent, zv, arg) == SUCCESS || ret == SUCCESS?SUCCESS:FAILURE;
    } else retry_ref: if (zval_get_type(&(*(zv))) == 8) {
     if (step_cb) {
      char *name = _estrndup((input), (i) );
      char *keyname = _estrndup((last_index), (index_len) );

      ret = step_cb(name, i, keyname, index_len, parent, zv, arg) == SUCCESS || ret == SUCCESS?SUCCESS:FAILURE;
     }

     phpdbg_parse_variable_with_arg(input, len, ((*(zv))).value.obj->handlers->get_properties(&(*(zv))), i, callback, step_cb, silent, arg);
     ...
     phpdbg_parse_variable_with_arg(input, len, (*(zv)).value.arr, i, callback, step_cb, silent, arg);
    } else if ((zval_get_type(&(*(zv))) == 10)) {
     if (step_cb) {
      char *name = _estrndup((input), (i) );
      char *keyname = _estrndup((last_index), (index_len) );
   ...
   if (!(zv = zend_symtable_str_find(parent, last_index, index_len))) {
    if (!silent) {
     phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "variable", "type=\"undefined\" variable=\"%.*s\"", "%.*s is undefined", (int) i, input);
    }
    return FAILURE;
   }
   while (zval_get_type(&(*(zv))) == 15) {
   ...
   if (i == len) {
   ...
   } else retry_ref_end: if (zval_get_type(&(*(zv))) == 8) {
    if (step_cb) {
     char *name = _estrndup((input), (i) );
     char *keyname = _estrndup((last_index), (index_len) );
    ...
    parent = ((*(zv))).value.obj->handlers->get_properties(&(*(zv)));
   } else if (zval_get_type(&(*(zv))) == 7) {
    if (step_cb) {
     char *name = _estrndup((input), (i) );
     char *keyname = _estrndup((last_index), (index_len) );
    ...
    phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "variable", "type=\"notiterable\" variable=\"%.*s\"", "%.*s is nor an array nor an object", (int) (input[i] == '>' ? i - 1 : i), input);
    return FAILURE;
   }
   index_len = 0;
  }
 ...
 return ret;
 error:
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "variable", "type=\"invalidinput\"", "Malformed input");
  return FAILURE;
}
...
static int phpdbg_xml_array_element_dump(zval *zv, zend_string *key, zend_ulong num) {
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<element");

 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  if (key) {
   phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " name=\"%.*s\"", (int) (key)->len, (key)->val);
  } else {
   phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " name=\"%ld\"", num);
  }
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " severity=\"error\" ></element>");
  return 0;
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };

 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, ">");
...
static int phpdbg_xml_object_property_dump(zval *zv, zend_string *key, zend_ulong num) {
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<property");
 ...
 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  if (key) {
   ...
   if (class_name && unmangle == SUCCESS) {
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " name=\"%s\"", prop_name);
    if (class_name[0] == '*') {
     phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " protection=\"protected\"");
    } else {
     phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " class=\"%s\" protection=\"private\"", class_name);
    }
   } else {
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " name=\"%.*s\" protection=\"public\"", (int) (key)->len, (key)->val);
   }
  } else {
   phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " name=\"%ld\" protection=\"public\"", num);
  }
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_xml_internal((phpdbg_globals.io)[1].fd, " severity=\"error\" ></property>");
  return 0;
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
...
__attribute__ ((visibility("default"))) void phpdbg_xml_var_dump(zval *zv) {
 ...
 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  is_ref = (zval_get_type(&(*(zv))) == 10) && ((*(zv)).value.counted)->gc.refcount > 1;
  do { if (__builtin_expect(!!((zval_get_type(&(*(zv))) == 10)), 0)) { (zv) = &(*(zv)).value.ref->val; } } while (0);

  switch (zval_get_type(&(*(zv)))) {
   case 3:
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<bool refstatus=\"%s\" value=\"true\" />", (is_ref ? "&" : ""));
    break;
   case 2:
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<bool refstatus=\"%s\" value=\"false\" />", (is_ref ? "&" : ""));
    break;
   case 1:
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<null refstatus=\"%s\" />", (is_ref ? "&" : ""));
    break;
   case 4:
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<int refstatus=\"%s\" value=\"" "%" "l" "d" "\" />", (is_ref ? "&" : ""), (*(zv)).value.lval);
    break;
   case 5:
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<float refstatus=\"%s\" value=\"%.*G\" />", (is_ref ? "&" : ""), (int) (executor_globals.precision), (*(zv)).value.dval);
    break;
   case 6:
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<string refstatus=\"%s\" length=\"%zd\" value=\"%.*s\" />", (is_ref ? "&" : ""), ((*(zv)).value.str)->len, (int) ((*(zv)).value.str)->len, ((*(zv)).value.str)->val);
    break;
   case 7:
    myht = (*(zv)).value.arr;
    if (((myht)->u.flags & (1<<1)) && ++myht->u.v.nApplyCount > 1) {
     phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<recursion />");
     --myht->u.v.nApplyCount;
     break;
    }
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<array refstatus=\"%s\" num=\"%d\">", (is_ref ? "&" : ""), (myht)->nNumOfElements);
    element_dump_func = phpdbg_xml_array_element_dump;
    is_temp = 0;
    goto head_done;
   case 8:
    myht = ((((*(zv)))).value.obj->handlers->get_debug_info?(((*(zv)))).value.obj->handlers->get_debug_info(&(*(zv)),&is_temp):(is_temp=0,(((*(zv)))).value.obj->handlers->get_properties?((*(zv))).value.obj->handlers->get_properties(&(*(zv))):((void *)0)));
    ...
    class_name = ((*(zv))).value.obj->handlers->get_class_name((*(zv)).value.obj);
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<object refstatus=\"%s\" class=\"%.*s\" id=\"%d\" num=\"%d\">", (is_ref ? "&" : ""), (int) (class_name)->len, (class_name)->val, (((*(zv))).value.obj)->handle, myht ? (myht)->nNumOfElements : 0);
...
head_done:
    ...
    if (zval_get_type(&(*(zv))) == 7) {
     phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</array>");
    } else {
     phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</object>");
    }
    break;
   case 9: {
    const char *type_name = zend_rsrc_list_get_rsrc_type((*zv).value.res);
    phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<resource refstatus=\"%s\" id=\"%pd\" type=\"%s\" />", (is_ref ? "&" : ""), (*zv).value.res->handle, type_name ? type_name : "unknown");
    break;
   }
   default:
    break;
...
__attribute__ ((visibility("default"))) zend_bool phpdbg_check_caught_ex(zend_execute_data *execute_data, zend_object *exception) {
 const zend_op *op;
 zend_op *cur;
 uint32_t op_num, i;
 zend_op_array *op_array = &execute_data->func->op_array;

 if (execute_data->opline >= (executor_globals.exception_op) && execute_data->opline < (executor_globals.exception_op) + 3) {
  op = (executor_globals.opline_before_exception);
 } else {
 ...
 for (i = 0; i < op_array->last_try_catch && op_array->try_catch_array[i].try_op <= op_num; i++) {
  ...
  if (op_num <= catch || op_num <= finally) {
   ...
   do {
    ...
    if (!(ce = ((void**)((char*)((execute_data)->run_time_cache) + ((*(((zval*)(((char*)(((execute_data)->literals))) + (cur->op1).constant)))).u2.cache_slot)))[0])) {
     ce = zend_fetch_class_by_name((*(((zval*)(((char*)(((execute_data)->literals))) + (cur->op1).constant)))).value.str, ((zval*)(((char*)(((execute_data)->literals))) + (cur->op1).constant)) + 1, 0x80);
     do { ((void**)((char*)((execute_data)->run_time_cache) + ((*(((zval*)(((char*)(((execute_data)->literals))) + (cur->op1).constant)))).u2.cache_slot)))[0] = (ce); } while (0);
    }
...
char *phpdbg_short_zval_print(zval *zv, int maxlen)
{
 ...
 switch (zval_get_type(&(*(zv)))) {
  case 0:
   ...
   break;
  case 1:
   decode = _estrdup(("null") );
   break;
  case 2:
   decode = _estrdup(("false") );
   break;
  case 3:
   decode = _estrdup(("true") );
   break;
  case 4:
   spprintf(&decode, 0, "%" "l" "d", (*(zv)).value.lval);
   break;
  case 5:
   spprintf(&decode, 0, "%.*G", 14, (*(zv)).value.dval);
   break;
  case 6: {
   int i;
   zend_string *str = php_addcslashes((*(zv)).value.str, 0, "\\\"", 2);
   for (i = 0; i < (str)->len; i++) {
    if ((str)->val[i] < 32) {
     (str)->val[i] = ' ';
    }
   ...
   spprintf(&decode, 0, "\"%.*s\"%c",
    (str)->len <= maxlen - 2 ? (int) (str)->len : (maxlen - 3),
    (str)->val, (str)->len <= maxlen - 2 ? 0 : '+');
   zend_string_release(str);
   } break;
  case 9:
   spprintf(&decode, 0, "Rsrc #%d", (*zv).value.res->handle);
   break;
  case 7:
   spprintf(&decode, 0, "array(%d)", ((*(zv)).value.arr)->nNumOfElements);
   break;
  case 8: {
   zend_string *str = ((*(zv)).value.obj->ce)->name;
   spprintf(&decode, 0, "%.*s%c",
    (str)->len <= maxlen ? (int) (str)->len : maxlen - 1,
    (str)->val, (str)->len <= maxlen ? 0 : '+');
   break;
  }
  case 11:
   decode = _estrdup(("<constant>") );
   break;
  case 12:
   decode = _estrdup(("<ast>") );
   break;
  default:
   spprintf(&decode, 0, "unknown type: %d", zval_get_type(&(*(zv))));
   break;
 }
