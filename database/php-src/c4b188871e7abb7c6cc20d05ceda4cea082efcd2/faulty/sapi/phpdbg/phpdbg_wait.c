# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.c"
# 19 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.c"
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.h" 1
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.h"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.h" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.h" 2

int phpdbg_do_wait(const phpdbg_param_t *param);

void phpdbg_webdata_decompress(char *msg, int len);
# 20 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.c" 2
...
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.c" 2
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_wait.c" 2
...
static void phpdbg_rebuild_http_globals_array(int type, const char *name) {
 zval *zvp;
 if (zval_get_type(&((core_globals.http_globals)[type])) != 0) {
  _zval_dtor((&(core_globals.http_globals)[type]) );
 }
 if ((zvp = zend_hash_str_find(&(executor_globals.symbol_table), name, strlen(name)))) {
  zval_addref_p(zvp);
  (core_globals.http_globals)[type] = *zvp;
 }
}
...
static void phpdbg_array_intersect_init(phpdbg_intersect_ptr *info, HashTable *ht1, HashTable *ht2) {
 ...
 zend_hash_sort_ex(info->ht[0], zend_sort, (compare_func_t) phpdbg_array_data_compare, 0);
 zend_hash_sort_ex(info->ht[1], zend_sort, (compare_func_t) phpdbg_array_data_compare, 0);
...
void phpdbg_webdata_decompress(char *msg, int len) {
 ...
 if (!php_var_unserialize(&zv, (const unsigned char **) &msg, (unsigned char *) msg + len, &var_hash)) {
  ...
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "wait", "type=\"invaliddata\" import=\"fail\"", "Malformed serialized was sent to this socket, arborting");
  return;
 }
 do { if ((basic_globals.serialize_lock) || (basic_globals.unserialize).level == 1) { var_destroy(&(var_hash)); _efree(((var_hash)) ); } if (!(basic_globals.serialize_lock) && !--(basic_globals.unserialize).level) { (basic_globals.unserialize).data = ((void *)0); } } while (0);
 ...
 if ((zvp = zend_hash_str_find(ht, ("GLOBALS"), (sizeof("GLOBALS")-1))) && zval_get_type(&(*(zvp))) == 7) {
  {
   zval *srv;
   if ((srv = zend_hash_str_find((*(zvp)).value.arr, ("_SERVER"), (sizeof("_SERVER")-1))) && zval_get_type(&(*(srv))) == 7) {
    zval *script;
    if ((script = zend_hash_str_find((*(srv)).value.arr, ("SCRIPT_FILENAME"), (sizeof("SCRIPT_FILENAME")-1))) && zval_get_type(&(*(script))) == 6) {
     phpdbg_param_t param;
     param.str = ((*(script)).value.str)->val;
     phpdbg_do_exec(&param);
    }
   }
  }

  (core_globals.auto_globals_jit) = 0;
  zend_hash_apply((compiler_globals.auto_globals), (apply_func_t) phpdbg_dearm_autoglobals);

  zend_hash_clean(&(executor_globals.symbol_table));
  (executor_globals.symbol_table) = *(*(zvp)).value.arr;


  phpdbg_rebuild_http_globals_array(0, "_POST");
  phpdbg_rebuild_http_globals_array(1, "_GET");
  phpdbg_rebuild_http_globals_array(2, "_COOKIE");
  phpdbg_rebuild_http_globals_array(3, "_SERVER");
  phpdbg_rebuild_http_globals_array(4, "_ENV");
  phpdbg_rebuild_http_globals_array(5, "_FILES");

  zval_addref_p(zvp);
  free_zv = zvp;
 }

 if ((zvp = zend_hash_str_find(ht, ("input"), (sizeof("input")-1))) && zval_get_type(&(*(zvp))) == 6) {
  if ((sapi_globals.request_info).request_body) {
   _php_stream_free(((sapi_globals.request_info).request_body), (1 | 2));
  }
  (sapi_globals.request_info).request_body = _php_stream_temp_create_ex((0), (0x4000), ((core_globals.upload_tmp_dir)) );
  _php_stream_truncate_set_size(((sapi_globals.request_info).request_body), (0));
  _php_stream_write((sapi_globals.request_info).request_body, (((*(zvp)).value.str)->val), (((*(zvp)).value.str)->len));
 }

 if ((zvp = zend_hash_str_find(ht, ("cwd"), (sizeof("cwd")-1))) && zval_get_type(&(*(zvp))) == 6) {
  if (chdir(((*(zvp)).value.str)->val) == SUCCESS) {
 ...
 if ((zvp = zend_hash_str_find(ht, ("sapi_name"), (sizeof("sapi_name")-1))) && (zval_get_type(&(*(zvp))) == 6 || zval_get_type(&(*(zvp))) == 1)) {
  if ((phpdbg_globals.sapi_name_ptr)) {
   free((phpdbg_globals.sapi_name_ptr));
  }
  if (zval_get_type(&(*(zvp))) == 6) {
   (phpdbg_globals.sapi_name_ptr) = sapi_module.name = strdup(((*(zvp)).value.str)->val);
  } else {
   (phpdbg_globals.sapi_name_ptr) = sapi_module.name = ((void *)0);
  }
 }

 if ((zvp = zend_hash_str_find(ht, ("modules"), (sizeof("modules")-1))) && zval_get_type(&(*(zvp))) == 7) {
  ...
  _zend_hash_init((&zv_registry), ((&module_registry)->nNumOfElements), (_zval_ptr_dtor), (0) );
  do { Bucket *_p = (&module_registry)->arData; Bucket *_end = _p + (&module_registry)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; mod = (*(_z)).value.ptr; {
   if (mod->name) {
    zval value;
    do { zval *__z = (&value); zend_string *__s = (zend_string_init(mod->name, strlen(mod->name), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
    _zend_hash_next_index_insert(&zv_registry, &value );
   }
  } } } while (0);

  phpdbg_array_intersect_init(&pos, &zv_registry, (*(zvp)).value.arr);
  do {
   int mode = phpdbg_array_intersect(&pos, &module);
   if (mode < 0) {

    if (strcmp("phpdbg", ((*(module)).value.str)->val)) {
     zend_hash_del(&module_registry, (*(module)).value.str);
    }
   } else if (mode > 0) {

    if (!sapi_module.name || strcmp(sapi_module.name, ((*(module)).value.str)->val)) {
     phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "wait", "missingmodule=\"%.*s\"", "The module %.*s isn't present in " "phpdbg" ", you still can load via dl /path/to/module/%.*s.so", (int) ((*(module)).value.str)->len, ((*(module)).value.str)->val, (int) ((*(module)).value.str)->len, ((*(module)).value.str)->val);
    }
   }
  } while (module);
 ...
 if ((zvp = zend_hash_str_find(ht, ("extensions"), (sizeof("extensions")-1))) && zval_get_type(&(*(zvp))) == 7) {
  ...
  while (extension) {
   ...
   do { Bucket *_p = ((*(zvp)).value.arr)->arData; Bucket *_end = _p + ((*(zvp)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; strkey = _p->key; name = (*(_z)).value.ptr; {
    if (zval_get_type(&(*(name))) == 6 && !zend_binary_strcmp(extension->name, strlen(extension->name), ((*(name)).value.str)->val, ((*(name)).value.str)->len)) {
     break;
    }
    name = ((void *)0);
   } } } while (0);
   ...
   if (name) {
    ...
    ((zend_extensions.persistent)?free(elm):_efree((elm) ));
    ...
    zend_hash_del((*(zvp)).value.arr, strkey);
   }
  }

  do { Bucket *_p = ((*(zvp)).value.arr)->arData; Bucket *_end = _p + ((*(zvp)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; name = _z; {
   if (zval_get_type(&(*(name))) == 6) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "wait", "missingextension=\"%.*s\"", "The Zend extension %.*s isn't present in " "phpdbg" ", you still can load via dl /path/to/extension.so", (int) ((*(name)).value.str)->len, ((*(name)).value.str)->val);
   }
  } } } while (0);
 }
 ...
 if ((zvp = zend_hash_str_find(ht, ("systemini"), (sizeof("systemini")-1))) && zval_get_type(&(*(zvp))) == 7) {
  zval *ini_entry;
  zend_ini_entry *original_ini;
  zend_string *key;

  do { Bucket *_p = ((*(zvp)).value.arr)->arData; Bucket *_end = _p + ((*(zvp)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; ini_entry = _z; {
   if (key && zval_get_type(&(*(ini_entry))) == 6) {
    if ((original_ini = zend_hash_find_ptr((executor_globals.ini_directives), key))) {
     if (!original_ini->on_modify || original_ini->on_modify(original_ini, (*(ini_entry)).value.str, original_ini->mh_arg1, original_ini->mh_arg2, original_ini->mh_arg3, (1<<2)) == SUCCESS) {
      if (original_ini->modified && original_ini->orig_value != original_ini->value) {
       _efree((original_ini->value) );
      }
      original_ini->value = (*(ini_entry)).value.str;
      zval_addref_p(ini_entry);
     }
    }
   }
  } } } while (0);
 ...
 if ((zvp = zend_hash_str_find(ht, ("userini"), (sizeof("userini")-1))) && zval_get_type(&(*(zvp))) == 7) {
  zval *ini_entry;
  zend_string *key;

  do { Bucket *_p = ((*(zvp)).value.arr)->arData; Bucket *_end = _p + ((*(zvp)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; ini_entry = _z; {
   if (key && zval_get_type(&(*(ini_entry))) == 6) {
    zend_alter_ini_entry_ex(key, (*(ini_entry)).value.str, (1<<1), (1<<5), 1);
   }
  } } } while (0);
 }
...
int phpdbg_do_wait(const phpdbg_param_t *param)
{
 ...
 int rlen, sr, sl;
 unlink((phpdbg_globals.socket_path));
 if ((phpdbg_globals.socket_server_fd) == -1) {
  int len;
  (phpdbg_globals.socket_server_fd) = sl = socket(1, SOCK_STREAM, 0);

  local.sun_family = 1;
  strcpy(local.sun_path, (phpdbg_globals.socket_path));
  len = strlen(local.sun_path) + sizeof(local.sun_family);
  if (bind(sl, (struct sockaddr *)&local, len) == -1) {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "wait", "type=\"nosocket\" import=\"fail\"", "Unable to connect to UNIX domain socket at %s defined by phpdbg.path ini setting", (phpdbg_globals.socket_path));
   return FAILURE;
  }

  chmod((phpdbg_globals.socket_path), 0666);

  listen(sl, 2);
 } else {
  sl = (phpdbg_globals.socket_server_fd);
 }
 ...
 recvd = *(size_t *) msglen;
 char *data = (__builtin_constant_p((recvd) ) ? (((recvd) <= 8) ? _emalloc_8() : (((recvd) <= 16) ? _emalloc_16() : (((recvd) <= 24) ? _emalloc_24() : (((recvd) <= 32) ? _emalloc_32() : (((recvd) <= 40) ? _emalloc_40() : (((recvd) <= 48) ? _emalloc_48() : (((recvd) <= 56) ? _emalloc_56() : (((recvd) <= 64) ? _emalloc_64() : (((recvd) <= 80) ? _emalloc_80() : (((recvd) <= 96) ? _emalloc_96() : (((recvd) <= 112) ? _emalloc_112() : (((recvd) <= 128) ? _emalloc_128() : (((recvd) <= 160) ? _emalloc_160() : (((recvd) <= 192) ? _emalloc_192() : (((recvd) <= 224) ? _emalloc_224() : (((recvd) <= 256) ? _emalloc_256() : (((recvd) <= 320) ? _emalloc_320() : (((recvd) <= 384) ? _emalloc_384() : (((recvd) <= 448) ? _emalloc_448() : (((recvd) <= 512) ? _emalloc_512() : (((recvd) <= 640) ? _emalloc_640() : (((recvd) <= 768) ? _emalloc_768() : (((recvd) <= 896) ? _emalloc_896() : (((recvd) <= 1024) ? _emalloc_1024() : (((recvd) <= 1280) ? _emalloc_1280() : (((recvd) <= 1536) ? _emalloc_1536() : (((recvd) <= 1792) ? _emalloc_1792() : (((recvd) <= 2048) ? _emalloc_2048() : (((recvd) <= 2560) ? _emalloc_2560() : (((recvd) <= 3072) ? _emalloc_3072() : (((recvd) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((recvd)) : _emalloc_huge((recvd))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((recvd) ) );
 ...
 (phpdbg_globals.socket_fd) = sr;

 _efree((data) );

 phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "wait", "import=\"success\"", "Successfully imported request data, stopped before executing");
