# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c" 2
...
const phpdbg_command_t phpdbg_info_commands[] = {
 {"break", sizeof("break")-1, "show breakpoints", sizeof("show breakpoints")-1, 'b', phpdbg_do_info_break, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"files", sizeof("files")-1, "show included files", sizeof("show included files")-1, 'F', phpdbg_do_info_files, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"classes", sizeof("classes")-1, "show loaded classes", sizeof("show loaded classes")-1, 'c', phpdbg_do_info_classes, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"funcs", sizeof("funcs")-1, "show loaded classes", sizeof("show loaded classes")-1, 'f', phpdbg_do_info_funcs, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"error", sizeof("error")-1, "show last error", sizeof("show last error")-1, 'e', phpdbg_do_info_error, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"constants", sizeof("constants")-1, "show user defined constants", sizeof("show user defined constants")-1, 'd', phpdbg_do_info_constants, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"vars", sizeof("vars")-1, "show active variables", sizeof("show active variables")-1, 'v', phpdbg_do_info_vars, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"globals", sizeof("globals")-1, "show superglobals", sizeof("show superglobals")-1, 'g', phpdbg_do_info_globals, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"literal", sizeof("literal")-1, "show active literal constants", sizeof("show active literal constants")-1, 'l', phpdbg_do_info_literal, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {"memory", sizeof("memory")-1, "show memory manager stats", sizeof("show memory manager stats")-1, 'm', phpdbg_do_info_memory, ((void *)0), 0, &phpdbg_prompt_commands[13], 1},
 {((void *)0), 0, ((void *)0), 0, '\0', ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0}
};

int phpdbg_do_info_break(const phpdbg_param_t *param)
{
 phpdbg_print_breakpoints(0);
 phpdbg_print_breakpoints(2);
 phpdbg_print_breakpoints(4);
 phpdbg_print_breakpoints(3);
 phpdbg_print_breakpoints(9);
 phpdbg_print_breakpoints(7);
 phpdbg_print_breakpoints(8);
 phpdbg_print_breakpoints(5);
 phpdbg_print_breakpoints(6);
...
int phpdbg_do_info_files(const phpdbg_param_t *param)
{
 ...
 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "includedfilecount", "num=\"%d\"", "Included files: %d", (&(executor_globals.included_files))->nNumOfElements);
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "", "Could not fetch included file count, invalid data source");
  return SUCCESS;
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };

 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  do { Bucket *_p = (&(executor_globals.included_files))->arData; Bucket *_end = _p + (&(executor_globals.included_files))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; fname = _p->key; {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "includedfile", "name=\"%s\"", "File: %s", (fname)->val);
  } } } while (0);
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "", "Could not fetch file name, invalid data source, aborting included file listing");
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
...
int phpdbg_do_info_error(const phpdbg_param_t *param)
{
 if ((core_globals.last_error_message)) {
  { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "lasterror", "error=\"%s\" file=\"%s\" line=\"%d\"", "Last error: %s at %s line %d", (core_globals.last_error_message), (core_globals.last_error_file), (core_globals.last_error_lineno));
  } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "lasterror", "error=\"\"", "No error found!");
  } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
 } else {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "lasterror", "error=\"\"", "No error found!");
 }
...
int phpdbg_do_info_constants(const phpdbg_param_t *param)
{
 ...
 _zend_hash_init((&consts), (8), (((void *)0)), (0) );

 if ((executor_globals.zend_constants)) {
  { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
   do { Bucket *_p = ((executor_globals.zend_constants))->arData; Bucket *_end = _p + ((executor_globals.zend_constants))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; data = (*(_z)).value.ptr; {
    if (data->module_number == 2147483647) {
     zend_hash_update_ptr(&consts, data->name, data);
    }
   } } } while (0);
  } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "", "Cannot fetch all the constants, invalid data source");
  } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
 }

 phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "constantinfo", "num=\"%d\"", "User-defined constants (%d)", (&consts)->nNumOfElements);

 if ((&consts)->nNumOfElements) {
  phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Address            Refs    Type      Constant\n");
  do { Bucket *_p = (&consts)->arData; Bucket *_end = _p + (&consts)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; data = (*(_z)).value.ptr; {
# 131 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_info.c"
   switch (zval_get_type(&(data->value))) {
    case 6:
     { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "length=\"%zd\" value=\"%.*s\"", "%-18p %-7d %-9s %.*s" "\nstring (%zd) \"%.*s%s\"", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val, ((data->value).value.str)->len, ((data->value).value.str)->len < 255 ? (int) ((data->value).value.str)->len : 255, ((data->value).value.str)->val, ((data->value).value.str)->len > 255 ? "..." : "");
     } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "", "%-18p %-7d %-9s %.*s" "", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val);
     } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
     break;
    case 3:
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "value=\"true\"", "%-18p %-7d %-9s %.*s" "\nbool (true)", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val);
     break;
    case 2:
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "value=\"false\"", "%-18p %-7d %-9s %.*s" "\nbool (false)", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val);
     break;
    case 4:
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "value=\"%ld\"", "%-18p %-7d %-9s %.*s" "\nint (%ld)", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val, (data->value).value.lval);
     break;
    case 5:
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "value=\"%lf\"", "%-18p %-7d %-9s %.*s" "\ndouble (%lf)", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val, (data->value).value.dval);
     break;
    default:
     phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "constant", "address=\"%p\" refcount=\"%d\" type=\"%s\" name=\"%.*s\" " "", "%-18p %-7d %-9s %.*s" "", &data->value, (((data->value).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(&(data->value)) : 1, zend_zval_type_name(&data->value), (int) (data->name)->len, (data->name)->val);
...
static int phpdbg_arm_auto_global(zval *ptrzv) {
 zend_auto_global *auto_global = (*(ptrzv)).value.ptr;

 if (auto_global->armed) {
  if ((phpdbg_globals.flags) & (1ULL<<34)) {
   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "variableinfo", "unreachable=\"%.*s\"", "Cannot show information about superglobal variable %.*s", (int) (auto_global->name)->len, (auto_global->name)->val);
  } else {
...
static int phpdbg_print_symbols(zend_bool show_globals) {
 ...
 if (!(executor_globals.current_execute_data) || !(executor_globals.current_execute_data)->func) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"op_array\"", "No active op array!");
  return SUCCESS;
 }

 if (show_globals) {

  zend_hash_apply((compiler_globals.auto_globals), (apply_func_t) phpdbg_arm_auto_global);
  symtable = &(executor_globals.symbol_table);
 } else if (!(symtable = zend_rebuild_symbol_table())) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"symbol_table\"", "No active symbol table!");
  return SUCCESS;
 }

 _zend_hash_init((&vars), (8), (((void *)0)), (0) );

 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  do { Bucket *_p = (symtable)->arData; Bucket *_end = _p + (symtable)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; var = _p->key; data = _z; {
   if (zend_is_auto_global(var) ^ !show_globals) {
    _zend_hash_update(&vars, var, data );
   }
  } } } while (0);
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "", "Cannot fetch all data from the symbol table, invalid data source");
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };

 if (show_globals) {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "variableinfo", "num=\"%d\"", "Superglobal variables (%d)", (&vars)->nNumOfElements);
 } else {
  zend_op_array *ops = &(executor_globals.current_execute_data)->func->op_array;

  if (ops->function_name) {
   if (ops->scope) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "variableinfo", "method=\"%s::%s\" num=\"%d\"", "Variables in %s::%s() (%d)", ops->scope->name->val, ops->function_name->val, (&vars)->nNumOfElements);
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "variableinfo", "function=\"%s\" num=\"%d\"", "Variables in %s() (%d)", (ops->function_name)->val, (&vars)->nNumOfElements);
   }
  } else {
   if (ops->filename) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "variableinfo", "file=\"%s\" num=\"%d\"", "Variables in %s (%d)", (ops->filename)->val, (&vars)->nNumOfElements);
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "variableinfo", "opline=\"%p\" num=\"%d\"", "Variables @ %p (%d)", ops, (&vars)->nNumOfElements);
   }
  }
 }

 if ((&vars)->nNumOfElements) {
  phpdbg_out_internal((phpdbg_globals.io)[1].fd, "Address            Refs    Type      Variable\n");
  do { Bucket *_p = (&vars)->arData; Bucket *_end = _p + (&vars)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; var = _p->key; data = _z; {
   { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
    const char *isref = "";
...
retry_switch:
    switch (zval_get_type(&(*(data)))) {
     case 9:
      { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
       const char *type = zend_rsrc_list_get_rsrc_type((*data).value.res);
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "type=\"%s\"", "%-18p %-7d %-9s %s$%.*s" "\n|-------(typeof)------> (%s)\n", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val, type ? type : "unknown");
      } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "type=\"unknown\"", "%-18p %-7d %-9s %s$%.*s" "\n|-------(typeof)------> (unknown)\n", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val);
      } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
      break;
     case 8:
      { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "instanceof=\"%s\"", "%-18p %-7d %-9s %s$%.*s" "\n|-----(instanceof)----> (%s)\n", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val, (((*(data)).value.obj->ce)->name)->val);
      } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "instanceof=\"%s\"", "%-18p %-7d %-9s %s$%.*s" "\n|-----(instanceof)----> (unknown)\n", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val);
      } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
      break;
     case 6:
      { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "length=\"%zd\" value=\"%.*s\"", "%-18p %-7d %-9s %s$%.*s" "\nstring (%zd) \"%.*s%s\"", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val, ((*(data)).value.str)->len, ((*(data)).value.str)->len < 255 ? (int) ((*(data)).value.str)->len : 255, ((*(data)).value.str)->val, ((*(data)).value.str)->len > 255 ? "..." : "");
      } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
       phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "", "%-18p %-7d %-9s %s$%.*s" "", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val);
      } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
      break;
     case 3:
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "value=\"true\"", "%-18p %-7d %-9s %s$%.*s" "\nbool (true)", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val);
      break;
     case 2:
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "value=\"false\"", "%-18p %-7d %-9s %s$%.*s" "\nbool (false)", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val);
      break;
     case 4:
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "value=\"%ld\"", "%-18p %-7d %-9s %s$%.*s" "\nint (%ld)", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val, (*(data)).value.lval);
      break;
     case 5:
      phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" refcount=\"%d\" type=\"%s\" refstatus=\"%s\" name=\"%.*s\" " "value=\"%lf\"", "%-18p %-7d %-9s %s$%.*s" "\ndouble (%lf)", data, (((*(data)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(data) : 1, zend_zval_type_name(data), isref, (int) (var)->len, (var)->val, (*(data)).value.dval);
      break;
     case 10:
      isref = "&";
    ...
    phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "variable", "address=\"%p\" name=\"%s\"", "%p\tn/a\tn/a\t$%s", data, (var)->val);
   } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };
  } } } while (0);
 }
...
int phpdbg_do_info_literal(const phpdbg_param_t *param)
{
 ...
 zend_bool in_executor = (phpdbg_globals.in_execution) && (executor_globals.current_execute_data) && (executor_globals.current_execute_data)->func;
 if (in_executor || (phpdbg_globals.ops)) {
  zend_op_array *ops = in_executor ? &(executor_globals.current_execute_data)->func->op_array : (phpdbg_globals.ops);
  int literal = 0, count = ops->last_literal - 1;

  if (ops->function_name) {
   if (ops->scope) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "literalinfo", "method=\"%s::%s\" num=\"%d\"", "Literal Constants in %s::%s() (%d)", ops->scope->name->val, ops->function_name->val, count);
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "literalinfo", "function=\"%s\" num=\"%d\"", "Literal Constants in %s() (%d)", ops->function_name->val, count);
   }
  } else {
   if (ops->filename) {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "literalinfo", "file=\"%s\" num=\"%d\"", "Literal Constants in %s (%d)", (ops->filename)->val, count);
   } else {
    phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "literalinfo", "opline=\"%p\" num=\"%d\"", "Literal Constants @ %p (%d)", ops, count);
   }
  }

  while (literal < ops->last_literal) {
   if (zval_get_type(&(ops->literals[literal])) != 1) {
    phpdbg_print(P_WRITE , (phpdbg_globals.io)[1].fd, "literal", "id=\"%u\"", "|-------- C%u -------> [", literal);
  ...
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"execution\"", "Not executing!");
 }
...
int phpdbg_do_info_memory(const phpdbg_param_t *param)
{
 ...
 if (is_mm) {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "meminfo", "", "Memory Manager Information");
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "current", "", "Current");
  phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "used", "mem=\"%.3f\"", "|-------> Used:\t%.3f kB", (float) (used / 1024));
  phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "real", "mem=\"%.3f\"", "|-------> Real:\t%.3f kB", (float) (real / 1024));
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "peak", "", "Peak");
  phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "used", "mem=\"%.3f\"", "|-------> Used:\t%.3f kB", (float) (peak_used / 1024));
  phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "real", "mem=\"%.3f\"", "|-------> Real:\t%.3f kB", (float) (peak_real / 1024));
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"memory_manager\"", "Memory Manager Disabled!");
 }
 return SUCCESS;
}
...
{
 const char *visibility = ce->type == 2 ? "User" : "Internal";
 const char *type = (ce->ce_flags & 0x40) ? "Interface" : (ce->ce_flags & 0x02) ? "Abstract Class" : "Class";

 phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "class", "type=\"%s\" flags=\"%s\" name=\"%.*s\" methodcount=\"%d\"", "%s %s %.*s (%d)", visibility, type, (int) (ce->name)->len, (ce->name)->val, (&ce->function_table)->nNumOfElements);
}
...
int phpdbg_do_info_classes(const phpdbg_param_t *param)
{
 ...
 _zend_hash_init((&classes), (8), (((void *)0)), (0) );

 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  do { Bucket *_p = ((executor_globals.class_table))->arData; Bucket *_end = _p + ((executor_globals.class_table))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; ce = (*(_z)).value.ptr; {
   if (ce->type == 2) {
    zend_hash_next_index_insert_ptr(&classes, ce);
   }
  } } } while (0);
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "signalsegv", "", "Not all classes could be fetched, possibly invalid data source");
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };

 phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "classinfo", "num=\"%d\"", "User Classes (%d)", (&classes)->nNumOfElements);


 do { Bucket *_p = (&classes)->arData; Bucket *_end = _p + (&classes)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; ce = (*(_z)).value.ptr; {
  phpdbg_print_class_name(ce);

  if (ce->parent) {
   zend_class_entry *pce;
   phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<parents %r>");
   pce = ce->parent;
   do {
    phpdbg_out_internal((phpdbg_globals.io)[1].fd, "|-------- ");
    phpdbg_print_class_name(pce);
   } while ((pce = pce->parent));
   phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</parents>");
  }

  if (ce->info.user.filename) {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "classsource", "file=\"%s\" line=\"%u\"", "|---- in %s on line %u", (ce->info.user.filename)->val, ce->info.user.line_start);
  } else {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "classsource", "", "|---- no source code");
  }
 } } } while (0);
...
int phpdbg_do_info_funcs(const phpdbg_param_t *param)
{
 ...
 _zend_hash_init((&functions), (8), (((void *)0)), (0) );

 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  do { Bucket *_p = ((executor_globals.function_table))->arData; Bucket *_end = _p + ((executor_globals.function_table))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; zf = (*(_z)).value.ptr; {
   if (zf->type == 2) {
    zend_hash_next_index_insert_ptr(&functions, zf);
   }
  } } } while (0);
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "signalsegv", "", "Not all functions could be fetched, possibly invalid data source");
 } } (phpdbg_globals.sigsegv_bailout) = __orig_bailout; };

 phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "functioninfo", "num=\"%d\"", "User Functions (%d)", (&functions)->nNumOfElements);

 do { Bucket *_p = (&functions)->arData; Bucket *_end = _p + (&functions)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; zf = (*(_z)).value.ptr; {
  zend_op_array *op_array = &zf->op_array;

  phpdbg_print(P_WRITE , (phpdbg_globals.io)[1].fd, "function", "name=\"%s\"", "|-------- %s", op_array->function_name ? (op_array->function_name)->val : "{main}");

  if (op_array->filename) {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "functionsource", "file=\"%s\" line=\"%d\"", " in %s on line %d", (op_array->filename)->val, op_array->line_start);
  } else {
   phpdbg_print(P_WRITELN, (phpdbg_globals.io)[1].fd, "functionsource", "", " (no source code)");
  }
 } } } while (0);
