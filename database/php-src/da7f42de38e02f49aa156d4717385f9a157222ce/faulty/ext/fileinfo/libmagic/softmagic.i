...
# 173 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
 ...
 uint8_t type;
 uint8_t in_type;
# 249 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
 uint8_t in_op;
 uint8_t mask_op;
 ...
 uint8_t factor_op;
# 287 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
 uint32_t offset;
...
# 354 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
struct mlist {
 struct magic *magic;
 uint32_t nmagic;
 void *map;
...
# 369 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
struct level_info {
 int32_t off;
 int got_match;
...
typedef unsigned long unichar;
 ...
 int file_buffer(struct magic_set *, php_stream *, const char *, const void *,
    size_t);
 int file_fsmagic(struct magic_set *, const char *, zend_stat_t *, php_stream *);
...
# 510 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
...
static const char rcsid[] __attribute__((__used__)) = "@(#)$File: softmagic.c,v 1.212 2015/01/24 22:11:25 christos Exp $";
...
# 53 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
...
# 80 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
 int
    ...
    uint16_t indir_level, uint16_t *name_count, int mode, int text)
{
 ...
 for (ml = ms->mlist[0]->next; ml != ms->mlist[0]; ml = ml->next)
  if ((rv = match(ms, ml->magic, ml->nmagic, buf, nbytes, 0, mode,
      ...
      &printed_something, &need_separator, ((void *)0))) != 0)
   return rv;

 return 0;
}
# 150 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
static int
...
check_fmt(struct magic_set *ms, struct magic *m)
{
 ...
 if ((pce = pcre_get_compiled_regex(pattern, &re_extra, &re_options)) == ((void *)0)) {
  rv = -1;
 } else {
...
mprint(struct magic_set *ms, struct magic *m)
{
 ...
 union VALUETYPE *p = &ms->ms_value;
  ...
  case -1:
   return -1;
  case 1:
   (void)ap_php_snprintf(buf, sizeof(buf), "%d",
       (unsigned char)v);
  ...
  case -1:
   return -1;
  case 1:
   (void)ap_php_snprintf(buf, sizeof(buf), "%u",
       (unsigned short)v);
   if (file_printf(ms, ((m)->desc), buf) == -1)
    return -1;
   break;
  ...
  case -1:
   return -1;
  case 1:
   (void)ap_php_snprintf(buf, sizeof(buf), "%" "ll" "u",
...
# 856 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
static void
...
# 897 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
static void
...
mconvert(struct magic_set *ms, struct magic *m, int flip)
{
 ...
 case 13: {
  ...
  sz = sizeof(p->s) - sz;
  if (len >= sz) {
# 959 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
   len = sz;
  }
  while (len--)
   *ptr1++ = *ptr2++;
...
{
 (void) fprintf(stderr, "mget/%" "z" "u @%d: ", len, offset);
    ...
    int *printed_something, int *need_separator, int *returnval)
{
 ...
 case 41:
  ...
  if ((pb = file_push_buffer(ms)) == ((void *)0))
   return -1;
  ...
  if (rbuf == ((void *)0) && ms->event_flags & 0x01)
   return -1;
...
convert_libmagic_pattern(zval *pattern, char *val, int len, int options)
{
 ...
 do { zval *__z = (pattern); zend_string *__s = (t); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
}
...
magiccheck(struct magic_set *ms, struct magic *m)
{
 ...
 case 20: {
  ...
  for (idx = 0; m->_u._s._count == 0 || idx < m->_u._s._count; idx++) {
   ...
   if (v == 0) {
    ...
    ms->search.rm_len = m->_u._s._count - idx;
    break;
   }
  }
  break;
 ...
 case 17: {
  ...
  l = v = 0;
  if ((pce = pcre_get_compiled_regex_cache((pattern).value.str)) == ((void *)0)) {
   _zval_ptr_dtor((&pattern) );
   return -1;
  } else {
   ...
   do { (*(&subpats)).u1.type_info = 1; } while (0);
   ...
   if ((retval).value.lval < 0) {
    ...
    _zval_ptr_dtor((&pattern) );
    return -1;
   } else if (((retval).value.lval > 0) && (zval_get_type(&(subpats)) == 7)) {

    zval *pzval;
    HashTable *ht = (subpats).value.arr;
    zval *pattern_match = ((void *)0), *pattern_offset = ((void *)0);
    int first = 1, inner_first;

    do { Bucket *_p = (ht)->arData; Bucket *_end = _p + (ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; pzval = _z; {
     HashTable *inner_ht;
     zval *match, *offset;
     ...
     do { zval *_z1 = (&tmpcopy); const zval *_z2 = (pzval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);

     inner_ht = (tmpcopy).value.arr;
     ...
     inner_first = 1;
     do { Bucket *_p = (inner_ht)->arData; Bucket *_end = _p + (inner_ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; match = _z; {
      if (inner_first) {
       inner_first = 0;
       continue;
      }
      do { zval *_z1 = (&matchcopy); const zval *_z2 = (match); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
      if (zval_get_type(&(*(&matchcopy))) != 6) { _convert_to_string((&matchcopy) ); };
      pattern_match = &matchcopy;
     } } } while (0);

     inner_first = 1;
     do { Bucket *_p = (inner_ht)->arData; Bucket *_end = _p + (inner_ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; offset = _z; {
      if (inner_first) {
       inner_first = 0;
       continue;
      }
      do { zval *_z1 = (&offsetcopy); const zval *_z2 = (offset); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
     ...
     if ((pattern_match != ((void *)0)) && (pattern_offset != ((void *)0))) {
      ms->search.s += (*(pattern_offset)).value.lval;
      ms->search.offset += (*(pattern_offset)).value.lval;
      ms->search.rm_len = ((*(pattern_match)).value.str)->len ;
      v = 0;

      _zval_ptr_dtor((pattern_match) );
      _zval_ptr_dtor((pattern_offset) );
     } else {
      _zval_ptr_dtor((&subpats) );
      _zval_ptr_dtor((&pattern) );
      return -1;
