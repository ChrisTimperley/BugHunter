...
# 2542 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h"
...
# 2543 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h" 2
# 2553 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h"
...
# 2554 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/main/php_streams.h"
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 73 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 1
...
# 98 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
...
# 100 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c" 2
...
# 101 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c" 2
...
size_t php_http_parser_execute(php_http_parser *parser,
                           ...
                           const char *data,
                           size_t len);
# 170 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_http_parser.h"
...
# 107 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c" 2
...
# 109 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c" 2
...
static const char php_cli_server_css[] = "<style>\n"
          ...
          "</style>\n";
# 362 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
...
static void sapi_cli_server_register_variables(zval *track_vars_array )
{
 ...
 {
  char *tmp;
  spprintf(&tmp, 0, "PHP %s Development Server", "5.6.19-dev");
...
{
 int retval = SUCCESS;
# 959 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 php_socket_t fd;
...
# 1495 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 p += request->vpath_len;
 *p = '\0';
 q = p;
 while (q > buf) {
...
# 1565 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 request->sb = sb;
}
...
# 1595 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
 p = decoded_vpath;
...
static int php_cli_server_client_read_request_on_header_value(php_http_parser *parser, const char *at, size_t length)
{
 ...
 }
 {
  ...
  char *orig_header_name = _estrndup((client->current_header_name), (client->current_header_name_len) );
  char *lc_header_name = zend_str_tolower_dup(client->current_header_name, client->current_header_name_len);

  _zend_hash_add_or_update(&client->request.headers, lc_header_name, client->current_header_name_len + 1, &value, sizeof(char *), ((void *)0), (1<<1) );
  _zend_hash_add_or_update(&client->request.headers_original_case, orig_header_name, client->current_header_name_len + 1, &value, sizeof(char *), ((void *)0), (1<<1) );
  _efree((lc_header_name) );
  _efree((orig_header_name) );
 }
...
# 2074 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/php_cli_server.c"
...
int do_cli_server(int argc, char **argv )
{
...

 {
  ...
  printf("PHP %s Development Server started at %s"
    ...
    "5.6.19-dev", buf, server_bind_address, document_root);
 }
