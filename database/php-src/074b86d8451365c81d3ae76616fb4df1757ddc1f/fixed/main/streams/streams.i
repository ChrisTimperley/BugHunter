# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 33 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/php_streams_int.h" 1
# 67 "/home/ct584/git/bughunter/repositories/php-src/main/streams/php_streams_int.h"
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c" 2
...
__attribute__ ((visibility("default"))) int php_stream_from_persistent_id(const char *persistent_id, php_stream **stream )
{
 ...
 if (zend_hash_find(&(executor_globals.persistent_list), (char*)persistent_id, strlen(persistent_id)+1, (void*) &le) == SUCCESS) {
...
__attribute__ ((visibility("default"))) void php_stream_wrapper_log_error(php_stream_wrapper *wrapper, int options , const char *fmt, ...)
{
 ...
 if (options & 0x00000008 || wrapper == ((void *)0)) {
  ...
  if (!(file_globals.wrapper_errors)) {
   ...
   _zend_hash_init(((file_globals.wrapper_errors)), (8), ((dtor_func_t)zend_llist_destroy), (0) )
                                        ;
  } else {
   zend_hash_find((file_globals.wrapper_errors), (const char*)&wrapper,
    sizeof wrapper, (void**)&list);
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_alloc(php_stream_ops *ops, void *abstract, const char *persistent_id, const char *mode )
{
 ...
 if (persistent_id) {
  ...
  if (FAILURE == _zend_hash_add_or_update(&(executor_globals.persistent_list), (char *)persistent_id, strlen(persistent_id) + 1, (void *)&le, sizeof(le), ((void *)0), (1<<0) )
...
# 377 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
...
# 410 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
 if (stream->in_free) {
...
# 461 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
 ...
 if ((close_options & 8) == 0) {
  ...
  while (_zend_list_delete(stream->rsrc_id ) == SUCCESS) {}
 }
...
# 552 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
  if (stream->orig_path) {
...
# 912 "/home/ct584/git/bughunter/repositories/php-src/main/streams/streams.c"
 for (;;) {
  avail = stream->writepos - stream->readpos;
  ...
  if (avail > 0) {
   ...
   _php_stream_fill_read_buffer((stream), (toread) );
...
__attribute__ ((visibility("default"))) char *php_stream_get_record(php_stream *stream, size_t maxlen, size_t *returned_len, const char *delim, size_t delim_len )
{
 ...
 while (!found_delim && buffered_len < maxlen) {
  ...
  _php_stream_fill_read_buffer((stream), (buffered_len + to_read_now) );
...
int php_init_stream_wrappers(int module_number )
{
 ...
 return (
   _zend_hash_init((&url_stream_wrappers_hash), (0), (((void *)0)), (1) ) == SUCCESS
   &&
   _zend_hash_init((php_get_stream_filters_hash_global()), (0), (((void *)0)), (1) ) == SUCCESS
   &&
   _zend_hash_init((php_stream_xport_get_hash()), (0), (((void *)0)), (1) ) == SUCCESS
   &&
   php_stream_xport_register("tcp", php_stream_generic_socket_factory ) == SUCCESS
   &&
...
__attribute__ ((visibility("default"))) int _php_stream_stat_path(const char *path, int flags, php_stream_statbuf *ssb, php_stream_context *context )
{
 ...
 if (!(flags & 4)) {
  ...
  if (flags & 1) {
   if ((basic_globals.CurrentLStatFile) && strcmp(path, (basic_globals.CurrentLStatFile)) == 0) {
    memcpy(ssb, &(basic_globals.lssb), sizeof(php_stream_statbuf));
    return 0;
   }
  } else {
   if ((basic_globals.CurrentStatFile) && strcmp(path, (basic_globals.CurrentStatFile)) == 0) {
  ...
  char **opened_path, php_stream_context *context )
{
 ...
 if (stream) {
  ...
  copy_of_path = ((persistent)?strdup(path):_estrdup((path) ));
 ...
 if (stream != ((void *)0) && (options & 0x00000010)) {
  ...
  switch(_php_stream_make_seekable((stream), (&newstream), ((options & 0x00000020) ? 1 : 0) )
   ...
   case 1:
    ...
    newstream->orig_path = ((persistent)?strdup(path):_estrdup((path) ));
    if (resolved_path) {
     _efree((resolved_path) );
    }
    return newstream;
 ...
 if (stream && stream->ops->seek && (stream->flags & 1) == 0 && strchr(mode, 'a') && stream->position == 0) {
  off_t newpos = 0;
  ...
  const char *wrappername, const char *optionname, zval ***optionvalue)
{
 ...
 if (FAILURE == zend_hash_find((*context->options).value.ht, (char*)wrappername, strlen(wrappername)+1, (void**)&wrapperhash)) {
  return FAILURE;
 }
 ...
 *copied_val = *optionvalue;
 ...
 if (FAILURE == zend_hash_find((*context->options).value.ht, (char*)wrappername, strlen(wrappername)+1, (void**)&wrapperhash)) {
  ...
  if (FAILURE == _zend_hash_add_or_update((*context->options).value.ht, (char*)wrappername, strlen(wrappername)+1, (void**)&category, sizeof(zval *), ((void *)0), (1<<0) )) {
   return FAILURE;
  }
