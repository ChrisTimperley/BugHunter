# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_objects.c" 2
...
__attribute__ ((visibility("default"))) void zend_object_std_init(zend_object *object, zend_class_entry *ce)
{
 ...
 (object)->gc.u.type_info = 8;
 object->ce = ce;
 object->properties = ((void *)0);
 zend_objects_store_put(object);
 p = object->properties_table;
 if (__builtin_expect(!!(ce->default_properties_count != 0), 1)) {
  end = p + ce->default_properties_count;
  do {
   do { (*(p)).u1.type_info = 0; } while (0);
   p++;
  } while (p != end);
 }
 if (__builtin_expect(!!(ce->ce_flags & 0x1000000), 0)) {
  (object)->gc.u.v.flags |= (1<<5);
  do { (*(p)).u1.type_info = 0; } while (0);
 }
}
...
__attribute__ ((visibility("default"))) void zend_object_std_dtor(zend_object *object)
{
 ...
 if (object->properties) {
  if (__builtin_expect(!!(!((object->properties)->gc.u.v.flags & (1<<1))), 1)) {
   if (__builtin_expect(!!(--(object->properties)->gc.refcount == 0), 1)) {
    zend_array_destroy(object->properties);
   }
  }
 }
 p = object->properties_table;
 if (__builtin_expect(!!(object->ce->default_properties_count), 1)) {
 ...
 if (__builtin_expect(!!((object)->gc.u.v.flags & (1<<6)), 0)) {
  if (__builtin_expect(!!(zval_get_type(&(*(p))) == 6), 1)) {
   zend_string_release((*(p)).value.str);
  } else {
   HashTable *guards;

   do { if (__builtin_expect(!(zval_get_type(&(*(p))) == 7), 0)) __builtin_unreachable(); } while (0);
   guards = (*(p)).value.arr;
   do { if (__builtin_expect(!(guards != ((void *)0)), 0)) __builtin_unreachable(); } while (0);
   zend_hash_destroy(guards);
   do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(guards); } else if (sizeof(HashTable) <= 16) { _efree_16(guards); } else if (sizeof(HashTable) <= 24) { _efree_24(guards); } else if (sizeof(HashTable) <= 32) { _efree_32(guards); } else if (sizeof(HashTable) <= 40) { _efree_40(guards); } else if (sizeof(HashTable) <= 48) { _efree_48(guards); } else if (sizeof(HashTable) <= 56) { _efree_56(guards); } else if (sizeof(HashTable) <= 64) { _efree_64(guards); } else if (sizeof(HashTable) <= 80) { _efree_80(guards); } else if (sizeof(HashTable) <= 96) { _efree_96(guards); } else if (sizeof(HashTable) <= 112) { _efree_112(guards); } else if (sizeof(HashTable) <= 128) { _efree_128(guards); } else if (sizeof(HashTable) <= 160) { _efree_160(guards); } else if (sizeof(HashTable) <= 192) { _efree_192(guards); } else if (sizeof(HashTable) <= 224) { _efree_224(guards); } else if (sizeof(HashTable) <= 256) { _efree_256(guards); } else if (sizeof(HashTable) <= 320) { _efree_320(guards); } else if (sizeof(HashTable) <= 384) { _efree_384(guards); } else if (sizeof(HashTable) <= 448) { _efree_448(guards); } else if (sizeof(HashTable) <= 512) { _efree_512(guards); } else if (sizeof(HashTable) <= 640) { _efree_640(guards); } else if (sizeof(HashTable) <= 768) { _efree_768(guards); } else if (sizeof(HashTable) <= 896) { _efree_896(guards); } else if (sizeof(HashTable) <= 1024) { _efree_1024(guards); } else if (sizeof(HashTable) <= 1280) { _efree_1280(guards); } else if (sizeof(HashTable) <= 1536) { _efree_1536(guards); } else if (sizeof(HashTable) <= 1792) { _efree_1792(guards); } else if (sizeof(HashTable) <= 2048) { _efree_2048(guards); } else if (sizeof(HashTable) <= 2560) { _efree_2560(guards); } else if (sizeof(HashTable) <= 3072) { _efree_3072(guards); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(guards, sizeof(HashTable)); } else { _efree_huge(guards, sizeof(HashTable)); } } else { _efree(guards); } } while (0);
  }
 }
}
...
__attribute__ ((visibility("default"))) void zend_objects_destroy_object(zend_object *object)
{
 zend_function *destructor = object ? object->ce->destructor : ((void *)0);

 if (destructor) {
  zend_object *old_exception;
  zval obj;
  zend_class_entry *orig_fake_scope = ((void *)0);

  (executor_globals.fake_scope) = ((void *)0);
  if (destructor->op_array.fn_flags & (0x400|0x200)) {
   if (destructor->op_array.fn_flags & 0x400) {
  ...
  do { zval *__z = (&obj); (*(__z)).value.obj = (object); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
  zval_addref_p(&(obj));
  ...
  zend_call_method(&obj, object->ce, &destructor, "__destruct", sizeof("__destruct")-1, ((void *)0), 0, ((void *)0), ((void *)0));
  if (old_exception) {
   if ((executor_globals.exception)) {
    zend_exception_set_previous((executor_globals.exception), old_exception);
   } else {
...
__attribute__ ((visibility("default"))) zend_object *zend_objects_new(zend_class_entry *ce)
{
 zend_object *object = (__builtin_constant_p((sizeof(zend_object) + zend_object_properties_size(ce)) ) ? (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 8) ? _emalloc_8() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 16) ? _emalloc_16() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 24) ? _emalloc_24() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 32) ? _emalloc_32() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 40) ? _emalloc_40() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 48) ? _emalloc_48() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 56) ? _emalloc_56() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 64) ? _emalloc_64() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 80) ? _emalloc_80() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 96) ? _emalloc_96() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 112) ? _emalloc_112() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 128) ? _emalloc_128() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 160) ? _emalloc_160() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 192) ? _emalloc_192() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 224) ? _emalloc_224() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 256) ? _emalloc_256() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 320) ? _emalloc_320() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 384) ? _emalloc_384() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 448) ? _emalloc_448() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 512) ? _emalloc_512() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 640) ? _emalloc_640() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 768) ? _emalloc_768() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 896) ? _emalloc_896() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_object) + zend_object_properties_size(ce)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_object) + zend_object_properties_size(ce))) : _emalloc_huge((sizeof(zend_object) + zend_object_properties_size(ce)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_object) + zend_object_properties_size(ce)) ) );
...
__attribute__ ((visibility("default"))) void zend_objects_clone_members(zend_object *new_object, zend_object *old_object)
{
 if (old_object->ce->default_properties_count) {
  ...
  if (__builtin_expect(!!(old_object->handlers == &std_object_handlers), 1)) {
   if (__builtin_expect(!!(!((old_object->properties)->gc.u.v.flags & (1<<1))), 1)) {
    (old_object->properties)->gc.refcount++;
   }
 ...
 if (old_object->ce->clone) {
  ...
  do { zval *__z = (&new_obj); (*(__z)).value.obj = (new_object); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
  zval_addref_p(&(new_obj));
  zend_call_method(&new_obj, old_object->ce, &old_object->ce->clone, "__clone", sizeof("__clone")-1, ((void *)0), 0, ((void *)0), ((void *)0));
  _zval_ptr_dtor((&new_obj) );
 }
}

__attribute__ ((visibility("default"))) zend_object *zend_objects_clone_obj(zval *zobject)
{
