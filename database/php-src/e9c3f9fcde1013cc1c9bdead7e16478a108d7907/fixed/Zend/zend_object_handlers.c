# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c" 2
# 73 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c"
__attribute__ ((visibility("default"))) void rebuild_object_properties(zend_object *zobj)
{
 if (!zobj->properties) {
  ...
  if (ce->default_properties_count) {
   ...
   do { Bucket *_p = (&ce->properties_info)->arData; Bucket *_end = _p + (&ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; prop_info = (*(_z)).value.ptr; {
    if (
     ...
     if (__builtin_expect(!!(zval_get_type(&(*(((zval*)((char*)(zobj) + prop_info->offset))))) == 0), 0)) {
      zobj->properties->u.v.flags |= (1<<5);
     }

     _zend_hash_append_ind(zobj->properties, prop_info->name,
      ((zval*)((char*)(zobj) + prop_info->offset)));
    }
   } } } while (0);
   while (ce->parent && ce->parent->default_properties_count) {
    ...
    do { Bucket *_p = (&ce->properties_info)->arData; Bucket *_end = _p + (&ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; prop_info = (*(_z)).value.ptr; {
     if (prop_info->ce == ce &&
      ...
      do { (*(&zv)).value.zv = (((zval*)((char*)(zobj) + prop_info->offset))); (*(&zv)).u1.type_info = 15; } while (0);
...
__attribute__ ((visibility("default"))) HashTable *zend_std_get_debug_info(zval *object, int *is_temp)
{
 zend_class_entry *ce = ((*(object)).value.obj->ce);
 zval retval;
 HashTable *ht;
 ...
 if (zval_get_type(&(retval)) == 7) {
  if ((((retval).u1.v.type_flags & (1<<1)) != 0)) {
   *is_temp = 1;
   return zend_array_dup((retval).value.arr);
   ...
   *is_temp = 0;
   ...
   return (retval).value.arr;
  }
 } else if (zval_get_type(&(retval)) == 1) {
  *is_temp = 1;
  (ht) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
...
{
 zend_class_entry *ce = ((*(object)).value.obj->ce);
 zend_class_entry *orig_fake_scope = (executor_globals.fake_scope);
 ...
 if ((((*(member)).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(member);
...
static inline __attribute__((always_inline)) int zend_verify_property_access(zend_property_info *property_info, zend_class_entry *ce)
{
 ...
 if (property_info->flags & 0x100) {
  return 1;
 } else if (property_info->flags & 0x400) {
  if ((executor_globals.fake_scope)) {
   scope = (executor_globals.fake_scope);
  } else {
   scope = zend_get_executed_scope();
  }
  return (ce == scope || property_info->ce == scope);
 } else if (property_info->flags & 0x200) {
  if ((executor_globals.fake_scope)) {
   scope = (executor_globals.fake_scope);
  } else {
   scope = zend_get_executed_scope();
...
static inline __attribute__((always_inline)) uint32_t zend_get_property_offset(zend_class_entry *ce, zend_string *member, int silent, void **cache_slot)
{
 zval *zv;
 ...
 if (cache_slot && __builtin_expect(!!(ce == (cache_slot)[0]), 1)) {
  return (uint32_t)(intptr_t)(cache_slot + 1)[0];
 }

 if (__builtin_expect(!!((member)->val[0] == '\0'), 0)) {
  if (!silent) {
   if ((member)->len == 0) {
    zend_throw_error(((void *)0), "Cannot access empty property");
   } else {
    zend_throw_error(((void *)0), "Cannot access property started with '\\0'");
   }
  }
  return ((uint32_t)(-2));
 }

 if (__builtin_expect(!!((&ce->properties_info)->nNumOfElements == 0), 0)) {
  goto exit_dynamic;
 }

 zv = zend_hash_find(&ce->properties_info, member);
 if (__builtin_expect(!!(zv != ((void *)0)), 1)) {
  property_info = (zend_property_info*)(*(zv)).value.ptr;
  flags = property_info->flags;
  if (__builtin_expect(!!((flags & 0x20000) != 0), 0)) {

   property_info = ((void *)0);
  } else {
   if (__builtin_expect(!!(zend_verify_property_access(property_info, ce) != 0), 1)) {
    if (__builtin_expect(!!(!(flags & 0x800)), 0)
     || __builtin_expect(!!((flags & 0x400)), 0)) {
     if (__builtin_expect(!!((flags & 0x01) != 0), 0)) {
      if (!silent) {
       zend_error((1<<3L), "Accessing static property %s::$%s as non static", (ce->name)->val, (member)->val);
      }
      return ((uint32_t)(-1));
     }
     goto exit;
 ...
 if (scope != ce
  ...
  && (zv = zend_hash_find(&scope->properties_info, member)) != ((void *)0)
  && ((zend_property_info*)(*(zv)).value.ptr)->flags & 0x400) {
  property_info = (zend_property_info*)(*(zv)).value.ptr;
  if (__builtin_expect(!!((property_info->flags & 0x01) != 0), 0)) {
   return ((uint32_t)(-1));
  }
 } else if (__builtin_expect(!!(property_info == ((void *)0)), 0)) {
exit_dynamic:
  if (cache_slot) {
   do { (cache_slot)[0] = (ce); (cache_slot)[1] = ((void*)(intptr_t)((uint32_t)(-1))); } while (0);
  }
  return ((uint32_t)(-1));
 } else if (__builtin_expect(!!(property_info == ((struct _zend_property_info*)((zend_intptr_t)-1))), 0)) {

  if (!silent) {
   zend_throw_error(((void *)0), "Cannot access %s property %s::$%s", zend_visibility_string(flags), (ce->name)->val, (member)->val);
  }
  return ((uint32_t)(-2));
 }
...
exit:
 if (cache_slot) {
  do { (cache_slot)[0] = (ce); (cache_slot)[1] = ((void*)(intptr_t)property_info->offset); } while (0);
 }
 return property_info->offset;
}


__attribute__ ((visibility("default"))) zend_property_info *zend_get_property_info(zend_class_entry *ce, zend_string *member, int silent)
{
 zval *zv;
 zend_property_info *property_info = ((void *)0);
 uint32_t flags;
 ...
 if (__builtin_expect(!!((member)->val[0] == '\0'), 0)) {
  ...
  return ((struct _zend_property_info*)((zend_intptr_t)-1));
 }
...
__attribute__ ((visibility("default"))) int zend_check_property_access(zend_object *zobj, zend_string *prop_info_name)
{
 ...
 if (property_info == ((void *)0)) {
  ...
  return SUCCESS;
 } else if (property_info == ((struct _zend_property_info*)((zend_intptr_t)-1))) {
  return FAILURE;
 }
 if (class_name && class_name[0] != '*') {
...
static void zend_property_guard_dtor(zval *el) {
 uint32_t *ptr = (uint32_t*)(*(el)).value.ptr;
 if (__builtin_expect(!!(!(((zend_uintptr_t)ptr) & 1)), 1)) {
  do { if (__builtin_constant_p(sizeof(uint32_t))) { if (sizeof(uint32_t) <= 8) { _efree_8(ptr); } else if (sizeof(uint32_t) <= 16) { _efree_16(ptr); } else if (sizeof(uint32_t) <= 24) { _efree_24(ptr); } else if (sizeof(uint32_t) <= 32) { _efree_32(ptr); } else if (sizeof(uint32_t) <= 40) { _efree_40(ptr); } else if (sizeof(uint32_t) <= 48) { _efree_48(ptr); } else if (sizeof(uint32_t) <= 56) { _efree_56(ptr); } else if (sizeof(uint32_t) <= 64) { _efree_64(ptr); } else if (sizeof(uint32_t) <= 80) { _efree_80(ptr); } else if (sizeof(uint32_t) <= 96) { _efree_96(ptr); } else if (sizeof(uint32_t) <= 112) { _efree_112(ptr); } else if (sizeof(uint32_t) <= 128) { _efree_128(ptr); } else if (sizeof(uint32_t) <= 160) { _efree_160(ptr); } else if (sizeof(uint32_t) <= 192) { _efree_192(ptr); } else if (sizeof(uint32_t) <= 224) { _efree_224(ptr); } else if (sizeof(uint32_t) <= 256) { _efree_256(ptr); } else if (sizeof(uint32_t) <= 320) { _efree_320(ptr); } else if (sizeof(uint32_t) <= 384) { _efree_384(ptr); } else if (sizeof(uint32_t) <= 448) { _efree_448(ptr); } else if (sizeof(uint32_t) <= 512) { _efree_512(ptr); } else if (sizeof(uint32_t) <= 640) { _efree_640(ptr); } else if (sizeof(uint32_t) <= 768) { _efree_768(ptr); } else if (sizeof(uint32_t) <= 896) { _efree_896(ptr); } else if (sizeof(uint32_t) <= 1024) { _efree_1024(ptr); } else if (sizeof(uint32_t) <= 1280) { _efree_1280(ptr); } else if (sizeof(uint32_t) <= 1536) { _efree_1536(ptr); } else if (sizeof(uint32_t) <= 1792) { _efree_1792(ptr); } else if (sizeof(uint32_t) <= 2048) { _efree_2048(ptr); } else if (sizeof(uint32_t) <= 2560) { _efree_2560(ptr); } else if (sizeof(uint32_t) <= 3072) { _efree_3072(ptr); } else if (sizeof(uint32_t) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(ptr, sizeof(uint32_t)); } else { _efree_huge(ptr, sizeof(uint32_t)); } } else { _efree(ptr); } } while (0);
 }
}
...
__attribute__ ((visibility("default"))) uint32_t *zend_get_property_guard(zend_object *zobj, zend_string *member)
{
 ...
 do { if (__builtin_expect(!((zobj)->gc.u.v.flags & (1<<5)), 0)) __builtin_unreachable(); } while (0);
 zv = zobj->properties_table + zobj->ce->default_properties_count;
 if (__builtin_expect(!!(zval_get_type(&(*(zv))) == 6), 1)) {
  zend_string *str = (*(zv)).value.str;
  if (__builtin_expect(!!(str == member), 1) ||

      (__builtin_expect(!!((str)->h == (member)->h), 1) &&
       __builtin_expect(!!((str)->len == (member)->len), 1) &&
       __builtin_expect(!!(memcmp((str)->val, (member)->val, (member)->len) == 0), 1))) {
   return &zv->u2.property_guard;
  } else if (__builtin_expect(!!(zv->u2.property_guard == 0), 1)) {
   zend_string_release((*(zv)).value.str);
   do { zval *__z = (zv); zend_string *__s = (member); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
   return &zv->u2.property_guard;
  } else {
   (guards) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
   _zend_hash_init((guards), (8), (zend_property_guard_dtor), (0) );

   zend_hash_add_new_ptr(guards, member,
    (void*)(((zend_uintptr_t)&zv->u2.property_guard) | 1));
   zend_string_release((*(zv)).value.str);
   do { zval *__z = (zv); (*(__z)).value.arr = (guards); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
  }
 } else if (__builtin_expect(!!(zval_get_type(&(*(zv))) == 7), 1)) {
  guards = (*(zv)).value.arr;
  do { if (__builtin_expect(!(guards != ((void *)0)), 0)) __builtin_unreachable(); } while (0);
  zv = zend_hash_find(guards, member);
  if (zv != ((void *)0)) {
   return (uint32_t*)(((zend_uintptr_t)(*(zv)).value.ptr) & ~1);
  }
 } else {
  do { if (__builtin_expect(!(zval_get_type(&(*(zv))) == 0), 0)) __builtin_unreachable(); } while (0);
  (zobj)->gc.u.v.flags |= (1<<6);
  do { zval *__z = (zv); zend_string *__s = (member); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
  zv->u2.property_guard = 0;
  return &zv->u2.property_guard;
 }

 ptr = (uint32_t*)(__builtin_constant_p((sizeof(uint32_t)) ) ? (((sizeof(uint32_t)) <= 8) ? _emalloc_8() : (((sizeof(uint32_t)) <= 16) ? _emalloc_16() : (((sizeof(uint32_t)) <= 24) ? _emalloc_24() : (((sizeof(uint32_t)) <= 32) ? _emalloc_32() : (((sizeof(uint32_t)) <= 40) ? _emalloc_40() : (((sizeof(uint32_t)) <= 48) ? _emalloc_48() : (((sizeof(uint32_t)) <= 56) ? _emalloc_56() : (((sizeof(uint32_t)) <= 64) ? _emalloc_64() : (((sizeof(uint32_t)) <= 80) ? _emalloc_80() : (((sizeof(uint32_t)) <= 96) ? _emalloc_96() : (((sizeof(uint32_t)) <= 112) ? _emalloc_112() : (((sizeof(uint32_t)) <= 128) ? _emalloc_128() : (((sizeof(uint32_t)) <= 160) ? _emalloc_160() : (((sizeof(uint32_t)) <= 192) ? _emalloc_192() : (((sizeof(uint32_t)) <= 224) ? _emalloc_224() : (((sizeof(uint32_t)) <= 256) ? _emalloc_256() : (((sizeof(uint32_t)) <= 320) ? _emalloc_320() : (((sizeof(uint32_t)) <= 384) ? _emalloc_384() : (((sizeof(uint32_t)) <= 448) ? _emalloc_448() : (((sizeof(uint32_t)) <= 512) ? _emalloc_512() : (((sizeof(uint32_t)) <= 640) ? _emalloc_640() : (((sizeof(uint32_t)) <= 768) ? _emalloc_768() : (((sizeof(uint32_t)) <= 896) ? _emalloc_896() : (((sizeof(uint32_t)) <= 1024) ? _emalloc_1024() : (((sizeof(uint32_t)) <= 1280) ? _emalloc_1280() : (((sizeof(uint32_t)) <= 1536) ? _emalloc_1536() : (((sizeof(uint32_t)) <= 1792) ? _emalloc_1792() : (((sizeof(uint32_t)) <= 2048) ? _emalloc_2048() : (((sizeof(uint32_t)) <= 2560) ? _emalloc_2560() : (((sizeof(uint32_t)) <= 3072) ? _emalloc_3072() : (((sizeof(uint32_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(uint32_t))) : _emalloc_huge((sizeof(uint32_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(uint32_t)) ) );
 *ptr = 0;
...
zval *zend_std_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv)
{
 ...
 if (__builtin_expect(!!(zval_get_type(&(*(member))) != 6), 0)) {
  do { zval *__z = (&tmp_member); zend_string *__s = (_zval_get_string((member))); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
  member = &tmp_member;
  cache_slot = ((void *)0);
 }
 ...
 property_offset = zend_get_property_offset(zobj->ce, (*(member)).value.str, (type == 3) || (zobj->ce->__get != ((void *)0)), cache_slot);

 if (__builtin_expect(!!(property_offset != ((uint32_t)(-2))), 1)) {
  if (__builtin_expect(!!(property_offset != ((uint32_t)(-1))), 1)) {
   retval = ((zval*)((char*)(zobj) + property_offset));
   if (__builtin_expect(!!(zval_get_type(&(*(retval))) != 0), 1)) {
    goto exit;
   }
  } else if (__builtin_expect(!!(zobj->properties != ((void *)0)), 1)) {
   retval = zend_hash_find(zobj->properties, (*(member)).value.str);
   if (__builtin_expect(!!(retval), 1)) goto exit;
  }
 } else if (__builtin_expect(!!((executor_globals.exception)), 0)) {
  retval = &(executor_globals.uninitialized_zval);
  goto exit;
 }


 if ((type == 3) && zobj->ce->__isset) {
  zval tmp_object, tmp_result;
  uint32_t *guard = zend_get_property_guard(zobj, (*(member)).value.str);

  if (!((*guard) & (1<<3))) {
   do { zval *_z1 = (&tmp_object); const zval *_z2 = (object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   do { (*(&tmp_result)).u1.type_info = 0; } while (0);
   ...
   *guard &= ~(1<<0);
   ...
   if (zval_get_type(&(*(rv))) != 0) {
    ...
    if (!(zval_get_type(&(*(rv))) == 10) &&
     ...
     do { zval *_zv = (rv); if ((((*(_zv)).u1.v.type_flags & (1<<2)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } else if ((zval_get_type(&(*(_zv))) == 10)) { zval_delref_p(_zv); do { zval *_z1 = (_zv); const zval *_z2 = (&(*(_zv)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0); } } } } while (0);
...
exit:
 if (__builtin_expect(!!((((tmp_member).u1.v.type_flags & (1<<2)) != 0)), 0)) {
...
__attribute__ ((visibility("default"))) void zend_std_write_property(zval *object, zval *member, zval *value, void **cache_slot)
{
 ...
 property_offset = zend_get_property_offset(zobj->ce, (*(member)).value.str, (zobj->ce->__set != ((void *)0)), cache_slot);

 if (__builtin_expect(!!(property_offset != ((uint32_t)(-2))), 1)) {
  if (__builtin_expect(!!(property_offset != ((uint32_t)(-1))), 1)) {
   variable_ptr = ((zval*)((char*)(zobj) + property_offset));
   ...
   if ((variable_ptr = zend_hash_find(zobj->properties, (*(member)).value.str)) != ((void *)0)) {
found:
 ...
 if (zobj->ce->__set) {
  uint32_t *guard = zend_get_property_guard(zobj, (*(member)).value.str);
   ...
   (*guard) &= ~(1<<1);
   _zval_ptr_dtor((&tmp_object) );
  } else if (__builtin_expect(!!(property_offset != ((uint32_t)(-2))), 1)) {
...
write_std_property:
  if ((((*(value)).u1.v.type_flags & (1<<2)) != 0)) {
   if ((zval_get_type(&(*(value))) == 10)) {
    ...
    do { zval *_z1 = (&tmp); const zval *_z2 = (&(*(value)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
    value = &tmp;
   } else {
    zval_addref_p(value);
   }
  ...
  if (__builtin_expect(!!(property_offset != ((uint32_t)(-1))), 1)) {
   do { zval *_z1 = (((zval*)((char*)(zobj) + property_offset))); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  } else {
   if (!zobj->properties) {
    rebuild_object_properties(zobj);
   }
   _zend_hash_add_new(zobj->properties, (*(member)).value.str, value );
  }
 }
...
zval *zend_std_read_dimension(zval *object, zval *offset, int type, zval *rv)
{
 ...
 if (__builtin_expect(!!(instanceof_function_ex(ce, zend_ce_arrayaccess, 1) != 0), 1)) {
  ...
  if (type == 3) {
   zend_call_method(object, ce, ((void *)0), "offsetexists", sizeof("offsetexists")-1, rv, 1, offset, ((void *)0));
  ...
  if (__builtin_expect(!!(zval_get_type(&(*(rv))) == 0), 0)) {
   if (__builtin_expect(!!(!(executor_globals.exception)), 0)) {
    zend_throw_error(((void *)0), "Undefined offset for object of type %s used as array", (ce->name)->val);
   }
   return ((void *)0);
  }
  return rv;
 } else {
  zend_throw_error(((void *)0), "Cannot use object of type %s as array", (ce->name)->val);
  return ((void *)0);
 }
}
...
static zval *zend_std_get_property_ptr_ptr(zval *object, zval *member, int type, void **cache_slot)
{
 ...
 zobj = (*(object)).value.obj;
 if (__builtin_expect(!!(zval_get_type(&(*(member))) == 6), 1)) {
  name = (*(member)).value.str;
 } else {
  name = _zval_get_string((member));
 }
 ...
 property_offset = zend_get_property_offset(zobj->ce, name, (zobj->ce->__get != ((void *)0)), cache_slot);

 if (__builtin_expect(!!(property_offset != ((uint32_t)(-2))), 1)) {
  if (__builtin_expect(!!(property_offset != ((uint32_t)(-1))), 1)) {
   retval = ((zval*)((char*)(zobj) + property_offset));
   if (__builtin_expect(!!(zval_get_type(&(*(retval))) == 0), 0)) {
    if (__builtin_expect(!!(!zobj->ce->__get), 1) ||
        __builtin_expect(!!((*zend_get_property_guard(zobj, name)) & (1<<0)), 0)) {
     do { (*(retval)).u1.type_info = 1; } while (0);


     if (__builtin_expect(!!(type == 2 || type == 0), 0)) {
      zend_error((1<<3L), "Undefined property: %s::$%s", (zobj->ce->name)->val, (name)->val);
     }
    } else {
   ...
   if (__builtin_expect(!!(zobj->properties), 1)) {
    if (__builtin_expect(!!((zobj->properties)->gc.refcount > 1), 0)) {
     if (__builtin_expect(!!(!((zobj->properties)->gc.u.v.flags & (1<<1))), 1)) {
      (zobj->properties)->gc.refcount--;
     }
     zobj->properties = zend_array_dup(zobj->properties);
       ...
       if (__builtin_expect(!!((retval = zend_hash_find(zobj->properties, name)) != ((void *)0)), 1)) {
     if (__builtin_expect(!!(zval_get_type(&(*(member))) != 6), 0)) {
   ...
   if (__builtin_expect(!!(!zobj->ce->__get), 1) ||
       __builtin_expect(!!((*zend_get_property_guard(zobj, name)) & (1<<0)), 0)) {
    if (__builtin_expect(!!(!zobj->properties), 0)) {
     rebuild_object_properties(zobj);
    }
    retval = _zend_hash_update(zobj->properties, name, &(executor_globals.uninitialized_zval) );
...
static void zend_std_unset_property(zval *object, zval *member, void **cache_slot)
{
 ...
 property_offset = zend_get_property_offset(zobj->ce, (*(member)).value.str, (zobj->ce->__unset != ((void *)0)), cache_slot);

 if (__builtin_expect(!!(property_offset != ((uint32_t)(-2))), 1)) {
  if (__builtin_expect(!!(property_offset != ((uint32_t)(-1))), 1)) {
   zval *slot = ((zval*)((char*)(zobj) + property_offset));

   if (zval_get_type(&(*(slot))) != 0) {
    _zval_ptr_dtor((slot) );
    do { (*(slot)).u1.type_info = 0; } while (0);
    if (zobj->properties) {
     zobj->properties->u.v.flags |= (1<<5);
    }
    goto exit;
   ...
   if (__builtin_expect(!!(zend_hash_del(zobj->properties, (*(member)).value.str) != FAILURE), 1)) {
    goto exit;
   }
  }
 } else if (__builtin_expect(!!((executor_globals.exception)), 0)) {
...
__attribute__ ((visibility("default"))) zend_function *zend_get_call_trampoline_func(zend_class_entry *ce, zend_string *method_name, int is_static)
{
 ...
 do { if (__builtin_expect(!(fbc), 0)) __builtin_unreachable(); } while (0);

 if (__builtin_expect(!!((executor_globals.trampoline).common.function_name == ((void *)0)), 1)) {
  func = &(executor_globals.trampoline).op_array;
 } else {
  func = _ecalloc((1), (sizeof(zend_op_array)) );
 }
 ...
 func->arg_flags[1] = 0;
 func->arg_flags[2] = 0;
 func->fn_flags = 0x200000 | 0x100;
 if (is_static) {
  func->fn_flags |= 0x01;
 }
 func->this_var = -1;
 func->opcodes = &(executor_globals.call_trampoline_op);

 func->prototype = fbc;
 func->scope = fbc->common.scope;

 func->T = (fbc->type == 2)? (((fbc->op_array.last_var + fbc->op_array.T)>(2))?(fbc->op_array.last_var + fbc->op_array.T):(2)) : 2;
 func->filename = (fbc->type == 2)? fbc->op_array.filename : (compiler_globals.empty_string);
 func->line_start = (fbc->type == 2)? fbc->op_array.line_start : 0;
 func->line_end = (fbc->type == 2)? fbc->op_array.line_end : 0;



 if (__builtin_expect(!!((mname_len = strlen((method_name)->val)) != (method_name)->len), 0)) {
  func->function_name = zend_string_init((method_name)->val, mname_len, 0);
 } else {
...
static inline __attribute__((always_inline)) zend_function *zend_get_user_call_function(zend_class_entry *ce, zend_string *method_name)
{
...
static union _zend_function *zend_std_get_method(zend_object **obj_ptr, zend_string *method_name, const zval *key)
{
 ...
 if (__builtin_expect(!!(key != ((void *)0)), 1)) {
  ...
  do { (lc_method_name) = (zend_string *)(((use_heap) = (__builtin_expect(!!((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) > ((32 * 1024))), 0))) ? (__builtin_constant_p((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ? (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 8) ? _emalloc_8() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 16) ? _emalloc_16() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 24) ? _emalloc_24() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 32) ? _emalloc_32() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 40) ? _emalloc_40() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 48) ? _emalloc_48() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 56) ? _emalloc_56() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 64) ? _emalloc_64() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 80) ? _emalloc_80() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 96) ? _emalloc_96() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 112) ? _emalloc_112() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 128) ? _emalloc_128() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 160) ? _emalloc_160() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 192) ? _emalloc_192() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 224) ? _emalloc_224() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 256) ? _emalloc_256() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 320) ? _emalloc_320() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 384) ? _emalloc_384() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 448) ? _emalloc_448() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 512) ? _emalloc_512() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 640) ? _emalloc_640() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 768) ? _emalloc_768() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 896) ? _emalloc_896() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1024) ? _emalloc_1024() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1280) ? _emalloc_1280() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1536) ? _emalloc_1536() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1792) ? _emalloc_1792() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2048) ? _emalloc_2048() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2560) ? _emalloc_2560() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 3072) ? _emalloc_3072() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L)))) : _emalloc_huge((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ) : __builtin_alloca (((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (method_name)->len + 1)) + ((8) - 1L)) & ~((8) - 1L)))); (lc_method_name)->gc.refcount = 1; (lc_method_name)->gc.u.type_info = 6; zend_string_forget_hash_val(lc_method_name); (lc_method_name)->len = (method_name)->len; } while (0);
 ...
 if (fbc->op_array.fn_flags & 0x400) {
  ...
  if (__builtin_expect(!!(updated_fbc != ((void *)0)), 1)) {
   ...
   if (zobj->ce->__call) {
    ...
    scope = zend_get_executed_scope();
    zend_throw_error(((void *)0), "Call to %s method %s::%s() from context '%s'", zend_visibility_string(fbc->common.fn_flags), ((fbc) && (fbc)->common.scope ? ((fbc)->common.scope->name)->val : ""), (method_name)->val, scope ? (scope->name)->val : "");
    fbc = ((void *)0);
   }
  }
 } else {
  ...
  if (fbc->op_array.fn_flags & (0x800|0x200)) {
   scope = zend_get_executed_scope();
  }
  if (fbc->op_array.fn_flags & 0x800) {
   if (scope && is_derived_class(fbc->common.scope, scope)) {
    if ((func = zend_hash_find(&scope->function_table, lc_method_name)) != ((void *)0)) {
  ...
  if (fbc->common.fn_flags & 0x200) {
   ...
   if (__builtin_expect(!!(!zend_check_protected(((fbc)->common.prototype ? (fbc)->common.prototype->common.scope : (fbc)->common.scope), scope)), 0)) {
    if (zobj->ce->__call) {
     fbc = zend_get_user_call_function(zobj->ce, method_name);
    } else {
     zend_throw_error(((void *)0), "Call to %s method %s::%s() from context '%s'", zend_visibility_string(fbc->common.fn_flags), ((fbc) && (fbc)->common.scope ? ((fbc)->common.scope->name)->val : ""), (method_name)->val, scope ? (scope->name)->val : "");
...
static inline __attribute__((always_inline)) zend_function *zend_get_user_callstatic_function(zend_class_entry *ce, zend_string *method_name)
{
...
__attribute__ ((visibility("default"))) zend_function *zend_std_get_static_method(zend_class_entry *ce, zend_string *function_name, const zval *key)
{
 ...
 if (__builtin_expect(!!(!fbc), 1)) {
  ...
  if (__builtin_expect(!!(func != ((void *)0)), 1)) {
   ...
   if (ce->__call &&
    (object = zend_get_this_object((executor_globals.current_execute_data))) != ((void *)0) &&
...
# 1353 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c"
 if (fbc->op_array.fn_flags & 0x100) {
  ...
  if (__builtin_expect(!!(updated_fbc != ((void *)0)), 1)) {
   ...
   if (ce->__callstatic) {
    ...
    zend_throw_error(((void *)0), "Call to %s method %s::%s() from context '%s'", zend_visibility_string(fbc->common.fn_flags), ((fbc) && (fbc)->common.scope ? ((fbc)->common.scope->name)->val : ""), (function_name)->val, scope ? (scope->name)->val : "");
    fbc = ((void *)0);
   }
  }
...
__attribute__ ((visibility("default"))) zval *zend_std_get_static_property(zend_class_entry *ce, zend_string *property_name, zend_bool silent)
{
 ...
 if (__builtin_expect(!!(property_info == ((void *)0)), 0)) {
  goto undeclared_property;
 }

 if (__builtin_expect(!!(!zend_verify_property_access(property_info, ce)), 0)) {
  if (!silent) {
   zend_throw_error(((void *)0), "Cannot access %s property %s::$%s", zend_visibility_string(property_info->flags), (ce->name)->val, (property_name)->val);
  }
  return ((void *)0);
 }
 ...
 if (__builtin_expect(!!(!(ce->ce_flags & 0x100000)), 0)) {
  if (__builtin_expect(!!(zend_update_class_constants(ce)), 0) != SUCCESS) {
   return ((void *)0);
  }
 }
 ret = ((ce)->static_members_table) + property_info->offset;


 if (__builtin_expect(!!(((ce)->static_members_table) == ((void *)0)), 0)) {
undeclared_property:
  if (!silent) {
   zend_throw_error(((void *)0), "Access to undeclared static property: %s::$%s", (ce->name)->val, (property_name)->val);
  }
  ret = ((void *)0);
 }
...
__attribute__ ((visibility("default"))) __attribute__((cold)) zend_bool zend_std_unset_static_property(zend_class_entry *ce, zend_string *property_name)
{
 zend_throw_error(((void *)0), "Attempt to unset static property %s::$%s", (ce->name)->val, (property_name)->val);
 return 0;
}
...
__attribute__ ((visibility("default"))) union _zend_function *zend_std_get_constructor(zend_object *zobj)
{
 ...
 if (constructor) {
  if (constructor->op_array.fn_flags & 0x100) {
   ...
   if (__builtin_expect(!!(constructor->common.scope != scope), 0)) {
    if (scope) {
     zend_throw_error(((void *)0), "Call to private %s::%s() from context '%s'", (constructor->common.scope->name)->val, (constructor->common.function_name)->val, (scope->name)->val);
     constructor = ((void *)0);
    } else {
     zend_throw_error(((void *)0), "Call to private %s::%s() from invalid context", (constructor->common.scope->name)->val, (constructor->common.function_name)->val);
     constructor = ((void *)0);
    }
   }
   ...
   if (__builtin_expect(!!(!zend_check_protected(((constructor)->common.prototype ? (constructor)->common.prototype->common.scope : (constructor)->common.scope), scope)), 0)) {
    if (scope) {
     zend_throw_error(((void *)0), "Call to protected %s::%s() from context '%s'", (constructor->common.scope->name)->val, (constructor->common.function_name)->val, (scope->name)->val);
     constructor = ((void *)0);
    } else {
     zend_throw_error(((void *)0), "Call to protected %s::%s() from invalid context", (constructor->common.scope->name)->val, (constructor->common.function_name)->val);
     constructor = ((void *)0);
    }
   }
  }
...
static int zend_std_compare_objects(zval *o1, zval *o2)
{
 ...
 if (!zobj1->properties && !zobj2->properties) {
  ...
  do { if ((((*(o1)).value.counted)->gc.u.v.flags & 0x07) >= 3) { zend_error_noreturn((1<<0L), "Nesting level too deep - recursive dependency?"); } do { ((*(o1)).value.counted)->gc.u.v.flags = (((*(o1)).value.counted)->gc.u.v.flags & ~0x07) | ((((*(o1)).value.counted)->gc.u.v.flags & 0x07) + 1); } while (0); } while (0);
  do { if ((((*(o2)).value.counted)->gc.u.v.flags & 0x07) >= 3) { zend_error_noreturn((1<<0L), "Nesting level too deep - recursive dependency?"); } do { ((*(o2)).value.counted)->gc.u.v.flags = (((*(o2)).value.counted)->gc.u.v.flags & ~0x07) | ((((*(o2)).value.counted)->gc.u.v.flags & 0x07) + 1); } while (0); } while (0);
  do {
   if (zval_get_type(&(*(p1))) != 0) {
    if (zval_get_type(&(*(p2))) != 0) {
     zval result;

     if (compare_function(&result, p1, p2)==FAILURE) {
      do { ((*(o1)).value.counted)->gc.u.v.flags = (((*(o1)).value.counted)->gc.u.v.flags & ~0x07) | ((((*(o1)).value.counted)->gc.u.v.flags & 0x07) - 1); } while (0);
      do { ((*(o2)).value.counted)->gc.u.v.flags = (((*(o2)).value.counted)->gc.u.v.flags & ~0x07) | ((((*(o2)).value.counted)->gc.u.v.flags & 0x07) - 1); } while (0);
      return 1;
     }
...
static int zend_std_has_property(zval *object, zval *member, int has_set_exists, void **cache_slot)
{
 ...
 property_offset = zend_get_property_offset(zobj->ce, (*(member)).value.str, 1, cache_slot);

 if (__builtin_expect(!!(property_offset != ((uint32_t)(-2))), 1)) {
  if (__builtin_expect(!!(property_offset != ((uint32_t)(-1))), 1)) {
   value = ((zval*)((char*)(zobj) + property_offset));
   if (zval_get_type(&(*(value))) != 0) {
    goto found;
   }
  } else if (__builtin_expect(!!(zobj->properties != ((void *)0)), 1) &&
             (value = zend_hash_find(zobj->properties, (*(member)).value.str)) != ((void *)0)) {
found:
...
__attribute__ ((visibility("default"))) int zend_std_cast_object_tostring(zval *readobj, zval *writeobj, int type)
{
 ...
 switch (type) {
  case 6:
   ...
   if (ce->__tostring &&
    ...
    if (__builtin_expect(!!((executor_globals.exception) != ((void *)0)), 0)) {
     zval *msg, ex, rv;
     _zval_ptr_dtor((&retval) );
     do { zval *__z = (&ex); (*(__z)).value.obj = ((executor_globals.exception)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
     (executor_globals.exception) = ((void *)0);
     msg = zend_read_property(((ex).value.obj->ce), &ex, "message", sizeof("message") - 1, 1, &rv);
     if (__builtin_expect(!!(zval_get_type(&(*(msg))) != 6), 0)) {
      do { do { zval *__z = (&rv); zend_string *__s = ((compiler_globals.empty_string)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = 6; } while (0); } while (0);
      msg = &rv;
     }
     zend_error_noreturn((1<<0L),
       "Method %s::__toString() must not throw an exception, caught %s: %s",
       (ce->name)->val, (((ex).value.obj->ce)->name)->val, ((*(msg)).value.str)->val);
     return FAILURE;
    }
    if (__builtin_expect(!!(zval_get_type(&(retval)) == 6), 1)) {
     ...
     do { zval *_z1 = (writeobj); const zval *_z2 = (&retval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
     return SUCCESS;
    } else {
     _zval_ptr_dtor((&retval) );
     if (readobj == writeobj) {
  ...
  case 4:
   ...
   if (readobj == writeobj) {
    _zval_ptr_dtor_nogc((readobj) );
   }
   { zval *__z = (writeobj); (*(__z)).value.lval = 1; (*(__z)).u1.type_info = 4; };
   return SUCCESS;
  case 5:
   ce = ((*(readobj)).value.obj->ce);
   zend_error((1<<3L), "Object of class %s could not be converted to float", (ce->name)->val);
   if (readobj == writeobj) {
    _zval_ptr_dtor_nogc((readobj) );
   }
...
int zend_std_get_closure(zval *obj, zend_class_entry **ce_ptr, zend_function **fptr_ptr, zend_object **obj_ptr)
{
 ...
 if ((func = zend_hash_find(&ce->function_table, (compiler_globals.known_strings)[ZEND_STR_MAGIC_INVOKE])) == ((void *)0)) {
  return FAILURE;
 }
