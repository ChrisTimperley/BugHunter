...
# 121 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
...
# 277 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
...
static void _class_string(string *str, zend_class_entry *ce, zval *obj, char *indent)
{
 ...
 if (count > 0) {
  ...
  do { Bucket *_p = (&ce->constants_table)->arData; Bucket *_end = _p + (&ce->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; value = _z; {
...
static zend_op* _get_recv_op(zend_op_array *op_array, uint32_t offset)
{
 ...
 while (op < end) {
  if ((op->opcode == 63 || op->opcode == 64
      || op->opcode == 164) && op->op1.num == (zend_long)offset)
  {
   return op;
  }
  ++op;
...
static void _parameter_string(string *str, zend_function *fptr, struct _zend_arg_info *arg_info, uint32_t offset, uint32_t required, char* indent)
{
 ...
 if (fptr->type == 2 && offset >= required) {
  ...
  if (precv && precv->opcode == 64 && precv->op2_type != (1<<3)) {
   ...
   (executor_globals.scope) = fptr->common.scope;
   zval_update_constant_ex(&zv, 1, ((void *)0));
...
static void _function_check_flag(zend_execute_data *execute_data, zval *return_value, int mask)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } mptr = intern->ptr;;
...
static void _reflection_export(zend_execute_data *execute_data, zval *return_value, zend_class_entry *ce_ptr, int ctor_argc)
{
 ...
 do { (*(&output)).u1.type_info = (return_output) ? 3 : 2; } while (0);
 ...
 do { zval *_z1 = (&params[1]); const zval *_z2 = (output_ptr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
static parameter_reference *_reflection_param_get_default_param(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 if (intern->ptr == ((void *)0)) {
  if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) {
   return ((void *)0);
  }
  php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object");
 }
...
void zim_reflection_export(zend_execute_data *execute_data, zval *return_value)
{
 ...
 result= call_user_function_ex(((void *)0), object, &fname, &retval, 0, ((void *)0), 0, ((void *)0));
 _zval_dtor((&fname) );
...
void zim_reflection_function___construct(zend_execute_data *execute_data, zval *return_value)
{
 ...
 object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 intern = reflection_object_from_obj((*((object))).value.obj);
...
void zim_reflection_function___toString(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } fptr = intern->ptr;;
 string_init(&str);
...
void zim_reflection_function_getName(zend_execute_data *execute_data, zval *return_value)
{
 ...
 _default_get_entry(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "name", sizeof("name")-1, return_value);
}
...
void zim_reflection_function_getClosureThis(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); };
...
void zim_reflection_function_isDisabled(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (!(((execute_data)->This)).value.obj || !instanceof_function(((((execute_data)->This)).value.obj->ce), reflection_function_ptr)) { php_error_docref0(((void *)0), (1<<0L), "%s() cannot be called statically", get_active_function_name()); return; };
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } fptr = intern->ptr;;
...
void zim_reflection_function_getStaticVariables(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (fptr->type == 2 && fptr->op_array.static_variables != ((void *)0)) {
  ...
  do { Bucket *_p = (fptr->op_array.static_variables)->arData; Bucket *_end = _p + (fptr->op_array.static_variables)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; val = _z; {
   if (__builtin_expect(!!(zval_update_constant_ex(val, 1, fptr->common.scope) != SUCCESS), 0)) {
    return;
   }
  } } } while (0);
...
void zim_reflection_function_returnsReference(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (!(((execute_data)->This)).value.obj || !instanceof_function(((((execute_data)->This)).value.obj->ce), reflection_function_abstract_ptr)) { php_error_docref0(((void *)0), (1<<0L), "%s() cannot be called statically", get_active_function_name()); return; };
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } fptr = intern->ptr;;
...
# 2181 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
void zim_reflection_generator_getTrace(zend_execute_data *execute_data, zval *return_value)
{
 zend_long options = (1<<0);
 zend_generator *generator = (zend_generator *) (reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj)->obj).value.obj;
...
void zim_reflection_parameter___toString(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } param = intern->ptr;;
 string_init(&str);
...
# 2610 "/home/ct584/git/bughunter/repositories/php-src/ext/reflection/php_reflection.c"
  const char *class_name;
...
void zim_reflection_parameter_getDefaultValue(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { zval *_z1 = (return_value); const zval *_z2 = (((zval*)(((char*)((&param->fptr->op_array)->literals)) + (precv->op2).constant))); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 if ((((*(return_value)).u1.v.type_flags & (1<<0)) != 0)) {
  zend_class_entry *old_scope = (executor_globals.scope);

  (executor_globals.scope) = param->fptr->common.scope;
  zval_update_constant_ex(return_value, 0, ((void *)0));
  (executor_globals.scope) = old_scope;
 } else {
...
void zim_reflection_method_getClosure(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (!(((execute_data)->This)).value.obj || !instanceof_function(((((execute_data)->This)).value.obj->ce), reflection_method_ptr)) { php_error_docref0(((void *)0), (1<<0L), "%s() cannot be called statically", get_active_function_name()); return; };
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } mptr = intern->ptr;;
   ...
   && intern->ignore_visibility == 0)
 {
  if (mptr->common.fn_flags & 0x02) {
   ...
   zend_throw_exception_ex(reflection_exception_ptr, 0,
    ...
    (mptr->common.scope->name)->val, (mptr->common.function_name)->val,
    (((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce)->name)->val);
  }
  return;
 }
...
void zim_reflection_function_inNamespace(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((name = _default_load_entry(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "name", sizeof("name")-1)) == ((void *)0)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
static void add_class_vars(zend_class_entry *ce, int statics, zval *return_value)
{
 ...
 do { Bucket *_p = (&ce->properties_info)->arData; Bucket *_end = _p + (&ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; prop_info = (*(_z)).value.ptr; {
  ...
  if ((((prop_copy).u1.v.type_flags & (1<<0)) != 0)) {
   if (__builtin_expect(!!(zval_update_constant_ex(&prop_copy, 1, ((void *)0)) != SUCCESS), 0)) {
    return;
   }
  }
...
void zim_reflection_class_getStaticProperties(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } ce = intern->ptr;;
...
void zim_reflection_class_hasMethod(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (!(((execute_data)->This)).value.obj || !instanceof_function(((((execute_data)->This)).value.obj->ce), reflection_class_ptr)) { php_error_docref0(((void *)0), (1<<0L), "%s() cannot be called statically", get_active_function_name()); return; };
...
void zim_reflection_class_getConstants(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } ce = intern->ptr;;
 _array_init((return_value), 0 );
 do { Bucket *_p = (&ce->constants_table)->arData; Bucket *_end = _p + (&ce->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; val = _z; {
  if (__builtin_expect(!!(zval_update_constant_ex(val, 1, ce) != SUCCESS), 0)) {
   return;
  }
 } } } while (0);
 zend_hash_copy((*(return_value)).value.arr, &ce->constants_table, zval_add_ref_unref);
}
...
void zim_reflection_class_getConstant(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } ce = intern->ptr;;
 do { Bucket *_p = (&ce->constants_table)->arData; Bucket *_end = _p + (&ce->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; value = _z; {
  if (__builtin_expect(!!(zval_update_constant_ex(value, 1, ce) != SUCCESS), 0)) {
   return;
  }
 } } } while (0);
 if ((value = zend_hash_find(&ce->constants_table, name)) == ((void *)0)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 do { zval *_z1 = (return_value); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
}
...
void zim_reflection_property___toString(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } ref = intern->ptr;;
 string_init(&str);
...
void zim_reflection_property_getValue(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (!(((execute_data)->This)).value.obj || !instanceof_function(((((execute_data)->This)).value.obj->ce), reflection_property_ptr)) { php_error_docref0(((void *)0), (1<<0L), "%s() cannot be called statically", get_active_function_name()); return; };
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } ref = intern->ptr;;

 if (!(ref->prop.flags & (0x100 | 0x1000)) && intern->ignore_visibility == 0) {
  name = _default_load_entry(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "name", sizeof("name")-1);
  zend_throw_exception_ex(reflection_exception_ptr, 0,
 ...
 if ((ref->prop.flags & 0x01)) {
  ...
  if (zval_get_type(&(((intern->ce)->static_members_table)[ref->prop.offset])) == 0) {
   php_error_docref0(((void *)0), (1<<0L), "Internal error: Could not find the property %s::%s", (intern->ce->name)->val, (ref->prop.name)->val);

  }
  do { zval *_z1 = (return_value); const zval *_z2 = (&((intern->ce)->static_members_table)[ref->prop.offset]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
 } else {
  const char *class_name, *prop_name;
  size_t prop_name_len;
  zval rv;
...
void zim_reflection_extension___toString(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } module = intern->ptr;;
 string_init(&str);
...
void zim_reflection_zend_extension___toString(zend_execute_data *execute_data, zval *return_value)
{
 ...
 intern = reflection_object_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (intern->ptr == ((void *)0)) { if ((executor_globals.exception) && (executor_globals.exception)->ce == reflection_exception_ptr) { return; } php_error_docref0(((void *)0), (1<<0L), "Internal error: Failed to retrieve the reflection object"); } extension = intern->ptr;;
 string_init(&str);
