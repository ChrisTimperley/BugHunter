...
# 312 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 ...
 if ((executor_globals.ht_iterators_used)) {
  zend_error((1<<1L), "Leaked %" "u" " hashtable iterators", (executor_globals.ht_iterators_used));
 }
...
__attribute__ ((visibility("default"))) int zend_eval_stringl(char *str, size_t str_len, zval *retval_ptr, char *string_name)
{
 ...
 if (new_op_array) {
  ...
  { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
   ...
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c", 1135);
  } } (executor_globals.bailout) = __orig_bailout; };
...
__attribute__ ((visibility("default"))) void zend_timeout(int dummy)
{
 ...
 if (zend_on_timeout) {
# 1200 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
# 1228 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
void zend_set_timeout(zend_long seconds, int reset_signals)
{

 (executor_globals.timeout_seconds) = seconds;
# 1261 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
 {
...
{
# 1312 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
...
# 1413 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute_API.c"
