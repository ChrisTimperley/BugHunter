...
# 4630 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
int php_tag_find(char *tag, size_t len, const char *set) {
 char c, *n, *t;
 int state=0, done=0;
 char *norm;
...
# 4711 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) size_t php_strip_tags_ex(char *rbuf, size_t len, int *stateptr, const char *allow, size_t allow_len, zend_bool allow_tag_spaces)
{
...
# 5256 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 5512 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_str_word_count(zend_execute_data *execute_data, zval *return_value)
{
 zend_string *str;
