# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
# 55 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
...
# 56 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
...
# 62 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
# 74 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
# 1 "/usr/include/errno.h" 1 3 4
# 75 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
...
# 81 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
...
# 82 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
...
# 83 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
...
# 84 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c" 2
# 93 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
typedef struct {
 char *lastkey;
 char *basedir;
 size_t basedir_len;
...
ps_module ps_mod_files = {
 ...
 "files", ps_open_files, ps_close_files, ps_read_files, ps_write_files, ps_delete_files, ps_gc_files, ps_create_sid_files, ps_validate_sid_files, ps_update_timestamp_files
};
...
# 195 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
  if (data->fd != -1) {
...
# 264 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
 if (n != (val)->len) {
  if (n == -1) {
...
static int ps_files_cleanup_dir(const char *dirname, zend_long maxlifetime)
{
 ...
 if (dirname_len >= 4096) {
  php_error_docref0(((void *)0), (1<<3L), "ps_files_cleanup_dir: dirname(%s) is too long", dirname);
  return (0);
 }
 ...
 while (readdir_r(dir, (struct dirent *) dentry, &entry) == 0 && entry) {
  ...
  if (!strncmp(entry->d_name, "sess_", sizeof("sess_") - 1)) {
...
# 363 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_open_files(void **mod_data, const char *save_path, const char *session_name)
{
 ...
 if (argc > 1) {
  (*__errno_location ()) = 0;
  dirdepth = (size_t) strtoll((argv[0]), (((void *)0)), (10));
 ...
 if (argc > 2) {
  (*__errno_location ()) = 0;
  filemode = (int)strtoll((argv[1]), (((void *)0)), (8));
...
# 438 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
...
# 467 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_read_files(void **mod_data, zend_string *key, zend_string **val, zend_long maxlifetime)
{
 zend_long n = 0;
 zend_stat_t sbuf;
 ps_files *data = *mod_data;
 ...
 if (sbuf.st_size == 0) {
  *val = (compiler_globals.empty_string);
  return SUCCESS;
 }
...
# 516 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
...
# 540 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_write_files(void **mod_data, zend_string *key, zend_string *val, zend_long maxlifetime)
{
 ps_files *data = *mod_data;

 return ps_files_write(data, key, val);
}
# 562 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_update_timestamp_files(void **mod_data, zend_string *key, zend_string *val, zend_long maxlifetime)
{
 char buf[4096];
...
# 600 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_delete_files(void **mod_data, zend_string *key)
{
 char buf[4096];
 ps_files *data = *mod_data;
...
# 636 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_gc_files(void **mod_data, zend_long maxlifetime, int *nrdels)
{
 ps_files *data = *mod_data;
...
# 665 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
zend_string *ps_create_sid_files(void **mod_data)
{
 zend_string *sid;
 int maxfail = 3;
 ps_files *data = *mod_data;
...
# 706 "/home/ct584/git/bughunter/repositories/php-src/ext/session/mod_files.c"
int ps_validate_sid_files(void **mod_data, zend_string *key)
{
 ps_files *data = *mod_data;
