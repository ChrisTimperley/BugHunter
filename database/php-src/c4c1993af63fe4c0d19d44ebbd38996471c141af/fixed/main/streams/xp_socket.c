# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c" 2
# 42 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
...
static int php_sockop_close(php_stream *stream, int close_handle )
{
 ...
 if (close_handle) {
  ...
  if (sock->socket != -1) {
# 203 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
   close(sock->socket);
   sock->socket = -1;
  }
  ...
  case 7:
   ...
   switch (xparam->op) {
    ...
    case STREAM_XPORT_OP_RECV:
     ...
     return 0;
# 416 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
...
# 464 "/home/ct584/git/bughunter/repositories/php-src/main/streams/xp_socket.c"
php_stream_ops php_stream_generic_socket_ops = {
...
static inline char *parse_ip_address_ex(const char *str, size_t str_len, int *portno, int get_err, char **err )
{
 char *colon;
 char *host = ((void *)0);
  ...
  php_stream_xport_param *xparam )
{
 ...
 if (stream->ops == &php_stream_unix_socket_ops || stream->ops == &php_stream_unixdg_socket_ops) {
  ...
  return bind(sock->socket, (const struct sockaddr *)&unix_addr,
   (socklen_t) __builtin_offsetof (struct sockaddr_un, sun_path) + xparam->inputs.namelen);
 }
  ...
  php_stream_xport_param *xparam )
{
 ...
 if (stream->ops == &php_stream_unix_socket_ops || stream->ops == &php_stream_unixdg_socket_ops) {
  ...
  ret = php_network_connect_socket(sock->socket,
    (const struct sockaddr *)&unix_addr, (socklen_t) __builtin_offsetof (struct sockaddr_un, sun_path) + xparam->inputs.namelen,
...
__attribute__ ((visibility("default"))) php_stream *php_stream_generic_socket_factory(const char *proto, size_t protolen,
  const char *resourcename, size_t resourcenamelen,
  const char *persistent_id, int options, int flags,
  struct timeval *timeout,
  php_stream_context *context )
