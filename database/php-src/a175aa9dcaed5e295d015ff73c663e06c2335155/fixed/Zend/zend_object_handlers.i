...
static inline __attribute__((always_inline)) int zend_verify_property_access(zend_property_info *property_info, zend_class_entry *ce)
{
 if (property_info->flags & 0x100) {
  ...
  return (ce == (executor_globals.scope) || property_info->ce == (executor_globals.scope));
...
static inline __attribute__((always_inline)) uint32_t zend_get_property_offset(zend_class_entry *ce, zend_string *member, int silent, void **cache_slot)
{
 ...
 if ((executor_globals.scope) != ce
  ...
  && (zv = zend_hash_find(&(executor_globals.scope)->properties_info, member)) != ((void *)0)
...
exit_dynamic:
  if (cache_slot) {
   do { (cache_slot)[0] = (ce); (cache_slot)[1] = ((void*)(intptr_t)(-1)); } while (0);
  }
  return (-1);
...
static void zend_property_guard_dtor(zval *el) {
 do { if (__builtin_constant_p(sizeof(zend_ulong))) { if (sizeof(zend_ulong) <= 8) { _efree_8((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 16) { _efree_16((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 24) { _efree_24((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 32) { _efree_32((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 40) { _efree_40((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 48) { _efree_48((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 56) { _efree_56((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 64) { _efree_64((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 80) { _efree_80((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 96) { _efree_96((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 112) { _efree_112((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 128) { _efree_128((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 160) { _efree_160((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 192) { _efree_192((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 224) { _efree_224((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 256) { _efree_256((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 320) { _efree_320((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 384) { _efree_384((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 448) { _efree_448((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 512) { _efree_512((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 640) { _efree_640((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 768) { _efree_768((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 896) { _efree_896((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 1024) { _efree_1024((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 1280) { _efree_1280((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 1536) { _efree_1536((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 1792) { _efree_1792((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 2048) { _efree_2048((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 2560) { _efree_2560((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= 3072) { _efree_3072((*(el)).value.ptr); } else if (sizeof(zend_ulong) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large((*(el)).value.ptr, sizeof(zend_ulong)); } else { _efree_huge((*(el)).value.ptr, sizeof(zend_ulong)); } } else { _efree((*(el)).value.ptr); } } while (0);
}
...
static zend_long *zend_get_property_guard(zend_object *zobj, zend_string *member)
{
 ...
 if ((zobj)->gc.u.v.flags & (1<<6)) {
  guards = (zobj->properties_table[zobj->ce->default_properties_count]).value.ptr;
  do { if (__builtin_expect(!(guards != ((void *)0)), 0)) __builtin_unreachable(); } while (0);
  if ((guard = (zend_long *)zend_hash_find_ptr(guards, member)) != ((void *)0)) {
   return guard;
  }
 } else {
  (guards) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
  _zend_hash_init((guards), (8), (zend_property_guard_dtor), (0) );
  (zobj->properties_table[zobj->ce->default_properties_count]).value.ptr = guards;
...
zval *zend_std_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv)
{
 ...
 if (__builtin_expect(!!(property_offset != (-2)), 1)) {
  if (__builtin_expect(!!(property_offset != (-1)), 1)) {
 ...
 if (zobj->ce->__get) {
  zend_long *guard = zend_get_property_guard(zobj, (*(member)).value.str);
  if (!((*guard) & (1<<0))) {
   zval tmp_object;
...
found:
 ...
 if (zobj->ce->__set) {
  zend_long *guard = zend_get_property_guard(zobj, (*(member)).value.str);
   ...
   (*guard) &= ~(1<<1);
   _zval_ptr_dtor((&tmp_object) );
  } else if (__builtin_expect(!!(property_offset != (-2)), 1)) {
 ...
 if (fbc->op_array.fn_flags & 0x400) {
  ...
  if (__builtin_expect(!!(updated_fbc != ((void *)0)), 1)) {
   ...
   if (zobj->ce->__call) {
    ...
    zend_throw_error(((void *)0), "Call to %s method %s::%s() from context '%s'", zend_visibility_string(fbc->common.fn_flags), ((fbc) && (fbc)->common.scope ? ((fbc)->common.scope->name)->val : ""), (method_name)->val, (executor_globals.scope) ? ((executor_globals.scope)->name)->val : "");
    fbc = ((void *)0);
   }
  }
 } else {
...
# 1244 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_object_handlers.c"
 if (fbc->op_array.fn_flags & 0x100) {
  ...
  if (__builtin_expect(!!(updated_fbc != ((void *)0)), 1)) {
   ...
   if (ce->__callstatic) {
    ...
    zend_throw_error(((void *)0), "Call to %s method %s::%s() from context '%s'", zend_visibility_string(fbc->common.fn_flags), ((fbc) && (fbc)->common.scope ? ((fbc)->common.scope->name)->val : ""), (function_name)->val, (executor_globals.scope) ? ((executor_globals.scope)->name)->val : "");
    fbc = ((void *)0);
   }
  }
 ...
 if (constructor) {
  if (constructor->op_array.fn_flags & 0x100) {
   ...
   if (__builtin_expect(!!(constructor->common.scope != (executor_globals.scope)), 0)) {
    if ((executor_globals.scope)) {
     zend_throw_error(((void *)0), "Call to private %s::%s() from context '%s'", (constructor->common.scope->name)->val, (constructor->common.function_name)->val, ((executor_globals.scope)->name)->val);
     constructor = ((void *)0);
    } else {
   ...
   if (__builtin_expect(!!(!zend_check_protected(((constructor)->common.prototype ? (constructor)->common.prototype->common.scope : (constructor)->common.scope), (executor_globals.scope))), 0)) {
    if ((executor_globals.scope)) {
     zend_throw_error(((void *)0), "Call to protected %s::%s() from context '%s'", (constructor->common.scope->name)->val, (constructor->common.function_name)->val, ((executor_globals.scope)->name)->val);
     constructor = ((void *)0);
    } else {
