...
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
# 1 "Zend/zend_language_parser.h" 1
# 50 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_language_parser.y"
# 54 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_language_parser.h"
...
# 334 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_language_parser.h"
typedef int YYSTYPE;
# 349 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_language_parser.h"
int zendparse (void);
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c" 2
...
# 2543 "Zend/../main/php_config.h" 2
# 2553 "Zend/../main/php_config.h"
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_virtual_cwd.h" 2
...
# 97 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
static void zend_push_function_call_entry(zend_function *fbc )
{
 ...
 zend_stack_push(&(compiler_globals.function_call_stack), &fcall, sizeof(zend_function_call_entry));
}


static void zend_duplicate_property_info(zend_property_info *property_info)
{
 property_info->name = ((((property_info->name) >= (compiler_globals.interned_strings_start)) && ((property_info->name) < (compiler_globals.interned_strings_end))) ? (property_info->name) : _estrndup(((property_info->name)), ((property_info->name_length)) ));
...
{
 property_info->name = ((((property_info->name) >= (compiler_globals.interned_strings_start)) && ((property_info->name) < (compiler_globals.interned_strings_end))) ? (property_info->name) : zend_strndup((property_info->name), (property_info->name_length)));;
}
...
void zend_init_compiler_data_structures(void)
{
 ...
 _zend_hash_init((&(compiler_globals.const_filenames)), (0), (((void *)0)), (0) );
...
void init_compiler(void)
{
 ...
 zend_init_rsrc_list();
 _zend_hash_init((&(compiler_globals.filenames_table)), (5), ((dtor_func_t) free_estring), (0) );
...
int zend_add_func_name_literal(zend_op_array *op_array, const zval *zv )
{
 ...
 do { zval *c = &((compiler_globals.active_op_array))->literals[lc_literal].constant; (((zend_literal*)(c))->hash_value) = (((((*c).value.str.val) >= (compiler_globals.interned_strings_start)) && (((*c).value.str.val) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)((*c).value.str.val))-sizeof(Bucket)))->h) : zend_hash_func(((*c).value.str.val), ((*c).value.str.len)+1)); } while (0);
...
int zend_add_const_name_literal(zend_op_array *op_array, const zval *zv, int unqualified )
{
 ...
 if (ns_len) {
  ...
  do { zval *c = &((compiler_globals.active_op_array))->literals[tmp_literal].constant; (((zend_literal*)(c))->hash_value) = (((((*c).value.str.val) >= (compiler_globals.interned_strings_start)) && (((*c).value.str.val) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)((*c).value.str.val))-sizeof(Bucket)))->h) : zend_hash_func(((*c).value.str.val), ((*c).value.str.len)+1)); } while (0);
...
# 576 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
void fetch_simple_variable_ex(znode *result, znode *varname, int bp, zend_uchar op )
{
 ...
 if (varname->op_type == (1<<0)) {
  ...
  hash = (((((varname->u.constant).value.str.val) >= (compiler_globals.interned_strings_start)) && (((varname->u.constant).value.str.val) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)((varname->u.constant).value.str.val))-sizeof(Bucket)))->h) : zend_hash_func(((varname->u.constant).value.str.val), ((varname->u.constant).value.str.len)+1));
 ...
 if (varname->op_type == (1<<0)) {
  do { zval *c = &((compiler_globals.active_op_array))->literals[opline_ptr->op1.constant].constant; (((zend_literal*)(c))->hash_value) = (((((*c).value.str.val) >= (compiler_globals.interned_strings_start)) && (((*c).value.str.val) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)((*c).value.str.val))-sizeof(Bucket)))->h) : zend_hash_func(((*c).value.str.val), ((*c).value.str.len)+1)); } while (0);
...
void zend_do_abstract_method(const znode *function_name, znode *modifiers, const znode *body )
{
 ...
 if ((modifiers->u.constant).value.lval & 0x02) {
  if((modifiers->u.constant).value.lval & 0x400) {
   zend_error_noreturn((1<<6L), "%s function %s::%s() cannot be declared private", method_type, (compiler_globals.active_class_entry)->name, (function_name->u.constant).value.str.val);
  }
  if ((body->u.constant).value.lval == 0x02) {
   ...
   zend_error_noreturn((1<<6L), "%s function %s::%s() cannot contain body", method_type, (compiler_globals.active_class_entry)->name, (function_name->u.constant).value.str.val);
  }
 } else {
  if ((body->u.constant).value.lval == 0x02) {
   zend_error_noreturn((1<<6L), "Non-abstract method %s::%s() must contain body", (compiler_globals.active_class_entry)->name, (function_name->u.constant).value.str.val);
  }
 }
}
...
static zend_bool opline_is_fetch_this(const zend_op *opline )
{
 if ((opline->opcode == 83) && (opline->op1_type == (1<<0))
  ...
  && !memcmp((((compiler_globals.active_op_array))->literals[opline->op1.constant].constant).value.str.val, "this", sizeof("this") - 1)) {
  return 1;
 } else {
  return 0;
 }
...
void zend_do_begin_function_declaration(znode *function_token, znode *function_name, int is_method, int return_reference, znode *fn_flags_znode )
{
 ...
 if (is_method) {
  if ((compiler_globals.active_class_entry)->ce_flags & 0x80) {
   if (((fn_flags_znode->u.constant).value.lval & ~(0x01|0x100))) {
    zend_error_noreturn((1<<6L), "Access type for interface method %s::%s() must be omitted", (compiler_globals.active_class_entry)->name, (function_name->u.constant).value.str.val);
   }
 ...
 if (is_method) {
  ...
  hash = ((((lcname) >= (compiler_globals.interned_strings_start)) && ((lcname) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)(lcname))-sizeof(Bucket)))->h) : zend_hash_func((lcname), (name_len)+1));
  if (_zend_hash_quick_add_or_update(&(compiler_globals.active_class_entry)->function_table, lcname, name_len+1, hash, &op_array, sizeof(zend_op_array), (void **) &(compiler_globals.active_op_array), (1<<1) ) == FAILURE) {
   zend_error_noreturn((1<<6L), "Cannot redeclare %s::%s()", (compiler_globals.active_class_entry)->name, name);
  }
  ...
  if ((compiler_globals.active_class_entry)->ce_flags & 0x80) {
   ...
   } else if ((name_len == sizeof("__debuginfo")-1) && (!memcmp(lcname, "__debuginfo", sizeof("__debuginfo")-1))) {
    if (fn_flags & (((0x100 | 0x200 | 0x400) | 0x01) ^ 0x100)) {
  ...
  opline->op2_type = (1<<0);
  do { zval _c; do { const char *__s=(lcname); int __l=name_len; zval *__z = (&_c); (*__z).value.str.len = __l; (*__z).value.str.val = (1?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0); opline->op2.constant = zend_add_literal((compiler_globals.active_op_array), &_c ); } while (0);
  do { zval *c = &((compiler_globals.active_op_array))->literals[opline->op2.constant].constant; (((zend_literal*)(c))->hash_value) = (((((*c).value.str.val) >= (compiler_globals.interned_strings_start)) && (((*c).value.str.val) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)((*c).value.str.val))-sizeof(Bucket)))->h) : zend_hash_func(((*c).value.str.val), ((*c).value.str.len)+1)); } while (0);
   ...
   if (class_type->u.constant.type == 4) {
    ...
    if (op == 64) {
     if ((initialization->u.constant).type == 0 || ((initialization->u.constant).type == 8 && !strcasecmp((initialization->u.constant).value.str.val, "NULL"))) {
      cur_arg_info->allow_null = 1;
     } else if (((((initialization->u.constant).type) & 0x00f) >= 8 && (((initialization->u.constant).type) & 0x00f) <= 9)) {

      cur_arg_info->allow_null = 0;
     } else if ((initialization->u.constant).type != 4) {
...
void zend_do_begin_method_call(znode *left_bracket )
{
 ...
 if (last_op->opcode == 82) {
  if (last_op->op2_type == (1<<0)) {
   ...
   (name).value.str.val = (((((name).value.str.val) >= (compiler_globals.interned_strings_start)) && (((name).value.str.val) < (compiler_globals.interned_strings_end))) ? ((name).value.str.val) : _estrndup((((name).value.str.val)), (((name).value.str.len)) ));
...
void zend_resolve_non_class_name(znode *element_name, zend_bool *check_namespace, zend_bool case_sensitive, HashTable *current_import_sub )
{
 ...
 if ((compiler_globals.current_namespace)) {
  ...
  do { if (!((((element_name->u.constant).value.str.val) >= (compiler_globals.interned_strings_start)) && (((element_name->u.constant).value.str.val) < (compiler_globals.interned_strings_end)))) { _efree(((char*)(element_name->u.constant).value.str.val) ); } } while (0);
  *element_name = tmp;
 }
}
 ...
 switch (lctype) {
  case 1:
   ...
   if (((compiler_globals.active_class_entry)->ce_flags & 0x120) == 0x120) {
    ...
    do { const char *__s=("__CLASS__"); int __l=sizeof("__CLASS__")-1; zval *__z = (&constant_name.u.constant); (*__z).value.str.len = __l; (*__z).value.str.val = (1?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0);
    if (is_static) {
     *result = constant_name;
     result->u.constant.type = 8;
    } else {
     zend_do_fetch_constant(result, ((void *)0), &constant_name, (1<<1), 1 );
    }
    break;
   }
   _zval_dtor((&class_name->u.constant) );
...
void zend_do_label(znode *label )
{
 ...
 if (!(compiler_globals.context).labels) {
  ...
  _zend_hash_init(((compiler_globals.context).labels), (4), (((void *)0)), (0) );
 }
...
void zend_do_build_full_name(znode *result, znode *prefix, znode *name, int is_class_member )
{
 ...
 if (is_class_member) {
  ...
  (result->u.constant).value.str.val = (((((result->u.constant).value.str.val) >= (compiler_globals.interned_strings_start)) && (((result->u.constant).value.str.val) < (compiler_globals.interned_strings_end))) ? _str_erealloc((result->u.constant).value.str.val, length+1, (((Bucket*)(((char*)((result->u.constant).value.str.val))-sizeof(Bucket)))->nKeyLength)) : _erealloc(((result->u.constant).value.str.val), (length+1), 0 ));
  ...
  do { if (!((((name->u.constant).value.str.val) >= (compiler_globals.interned_strings_start)) && (((name->u.constant).value.str.val) < (compiler_globals.interned_strings_end)))) { _efree(((char*)(name->u.constant).value.str.val) ); } } while (0);
...
void zend_do_end_function_call(znode *function_name, znode *result, int is_method, int is_dynamic_fcall )
{
 ...
 zend_stack_top(&(compiler_globals.function_call_stack), (void **) &fcall);
...
void zend_do_pass_param(znode *param, zend_uchar op )
{
 ...
 if (original_op == 67) {
  if (function_ptr &&
      ...
      !((function_ptr)->common.arg_info && (fcall->arg_num <= (function_ptr)->common.num_args ? ((function_ptr)->common.arg_info[fcall->arg_num-1].pass_by_reference & (1|2)) : ((function_ptr)->common.fn_flags & 0x1000000) ? ((function_ptr)->common.arg_info[(function_ptr)->common.num_args-1].pass_by_reference & (1|2)) : 0))) {
   zend_error_noreturn((1<<6L),
 ...
 if (function_ptr) {
  if (((function_ptr)->common.arg_info && (fcall->arg_num <= (function_ptr)->common.num_args ? ((function_ptr)->common.arg_info[fcall->arg_num-1].pass_by_reference & (2)) : ((function_ptr)->common.fn_flags & 0x1000000) ? ((function_ptr)->common.arg_info[(function_ptr)->common.num_args-1].pass_by_reference & (2)) : 0))) {
  ...
  } else if (((function_ptr)->common.arg_info && (fcall->arg_num <= (function_ptr)->common.num_args ? ((function_ptr)->common.arg_info[fcall->arg_num-1].pass_by_reference & (1|2)) : ((function_ptr)->common.fn_flags & 0x1000000) ? ((function_ptr)->common.arg_info[(function_ptr)->common.num_args-1].pass_by_reference & (1|2)) : 0))) {
   send_by_reference = (1<<0);
  }
 }
...
void zend_do_unpack_params(znode *params )
{
 ...
 if (fcall->fbc) {
  ...
  zval func_name;
  do { const char *__s=(fcall->fbc->common.function_name); zval *__z = (&func_name); (*__z).value.str.len = strlen(__s); (*__z).value.str.val = (1?_estrndup((__s), ((*__z).value.str.len) ):(char*)__s); (*__z).type = 6; } while (0);
...
__attribute__ ((visibility("default"))) void function_add_ref(zend_function *function)
{
 if (function->type == 2) {
  ...
  if (op_array->static_variables) {
   ...
   _zend_hash_init((op_array->static_variables), (zend_hash_num_elements(static_variables)), ((void (*)(void *)) _zval_ptr_dtor), (0) );
...
static zend_bool zend_do_perform_implementation_check(const zend_function *fe, const zend_function *proto )
{
 ...
 if (proto->common.fn_flags & 0x400) {
  return 1;
 }
 ...
 for (i = 0; i < num_args; i++) {
  ...
  if (fe_arg_info->class_name) {
   ...
   if (strcasecmp(fe_class_name, proto_class_name)!=0) {
    ...
    if (fe->common.type != 2) {
     return 0;
       } else if (strchr(proto_class_name, '\\') != ((void *)0) ||
...
# 3373 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
static void do_inheritance_check_on_method(zend_function *child, zend_function *parent )
{
 ...
 if (parent_flags & 0x04) {
  zend_error_noreturn((1<<6L), "Cannot override final method %s::%s()", ((parent) && (parent)->common.scope ? (parent)->common.scope->name : ""), child->common.function_name);
 }
 ...
 if ((child_flags & 0x01) != (parent_flags & 0x01)) {
  if (child->common.fn_flags & 0x01) {
   zend_error_noreturn((1<<6L), "Cannot make non static method %s::%s() static in class %s", ((parent) && (parent)->common.scope ? (parent)->common.scope->name : ""), child->common.function_name, ((child) && (child)->common.scope ? (child)->common.scope->name : ""));
  } else {
   zend_error_noreturn((1<<6L), "Cannot make static method %s::%s() non static in class %s", ((parent) && (parent)->common.scope ? (parent)->common.scope->name : ""), child->common.function_name, ((child) && (child)->common.scope ? (child)->common.scope->name : ""));
  }
 }


 if ((child_flags & 0x02) && !(parent_flags & 0x02)) {
  zend_error_noreturn((1<<6L), "Cannot make non abstract method %s::%s() abstract in class %s", ((parent) && (parent)->common.scope ? (parent)->common.scope->name : ""), child->common.function_name, ((child) && (child)->common.scope ? (child)->common.scope->name : ""));
 }
 ...
 if (parent_flags & 0x800) {
  ...
  if ((child_flags & (0x100 | 0x200 | 0x400)) > (parent_flags & (0x100 | 0x200 | 0x400))) {
   zend_error_noreturn((1<<6L), "Access level to %s::%s() must be %s (as in class %s)%s", ((child) && (child)->common.scope ? (child)->common.scope->name : ""), child->common.function_name, zend_visibility_string(parent_flags), ((parent) && (parent)->common.scope ? (parent)->common.scope->name : ""), (parent_flags&0x100) ? "" : " or weaker");
 ...
 if (child->common.prototype && (child->common.prototype->common.fn_flags & 0x02)) {
  if (!zend_do_perform_implementation_check(child, child->common.prototype )) {
   zend_error_noreturn((1<<6L), "Declaration of %s::%s() must be compatible with %s", ((child) && (child)->common.scope ? (child)->common.scope->name : ""), child->common.function_name, zend_get_function_declaration(child->common.prototype ));
  }
...
static zend_bool do_inherit_property_access_check(HashTable *target_ht, zend_property_info *parent_info, const zend_hash_key *hash_key, zend_class_entry *ce)
{
 ...
 if (zend_hash_quick_find(&ce->properties_info, hash_key->arKey, hash_key->nKeyLength, hash_key->h, (void **) &child_info)==SUCCESS) {
  ...
  if ((child_info->flags & (0x100 | 0x200 | 0x400)) > (parent_info->flags & (0x100 | 0x200 | 0x400))) {
   zend_error_noreturn((1<<6L), "Access level to %s::$%s must be %s (as in class %s)%s", ce->name, hash_key->arKey, zend_visibility_string(parent_info->flags), parent_ce->name, (parent_info->flags&0x100) ? "" : " or weaker");
  } else if ((child_info->flags & 0x01) == 0) {

   i_zval_ptr_dtor_nogc(ce->default_properties_table[parent_info->offset] );
...
# 3751 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
__attribute__ ((visibility("default"))) void zend_do_inheritance(zend_class_entry *ce, zend_class_entry *parent_ce )
{
 ...
 if ((ce->ce_flags & 0x80)
  ...
  zend_error_noreturn((1<<6L), "Interface %s may not inherit from class (%s)", ce->name, parent_ce->name);
 }
 if (parent_ce->ce_flags & 0x40) {
  zend_error_noreturn((1<<6L), "Class %s may not inherit from final class (%s)", ce->name, parent_ce->name);
 }
...
# 3799 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
static zend_bool do_inherit_constant_check(HashTable *child_constants_table, const zval **parent_constant, const zend_hash_key *hash_key, const zend_class_entry *iface)
{
 ...
 if (zend_hash_quick_find(child_constants_table, hash_key->arKey, hash_key->nKeyLength, hash_key->h, (void**)&old_constant) == SUCCESS) {
  if (*old_constant != *parent_constant) {
   zend_error_noreturn((1<<6L), "Cannot inherit previously-inherited or override constant %s from interface %s", hash_key->arKey, iface->name);
  }
  return 0;
 }
 return 1;
 ...
 for (i = 0; i < ce->num_interfaces; i++) {
  if (ce->interfaces[i] == ((void *)0)) {
   ...
   if (i < parent_iface_num) {
    ...
    zend_error_noreturn((1<<6L), "Class %s cannot implement previously implemented interface %s", ce->name, iface->name);
   }
  }
 }
 if (ignore) {
...
{
 if (!strncmp(mname, "__clone", mname_len)) {
  ce->clone = fe; fe->common.fn_flags |= 0x8000;
 } else if (!strncmp(mname, "__construct", mname_len)) {
  if (ce->constructor && (!ce->parent || ce->constructor != ce->parent->constructor)) {
   zend_error_noreturn((1<<6L), "%s has colliding constructor definitions coming from traits", ce->name);
  }
  ce->constructor = fe; fe->common.fn_flags |= 0x2000;
 } else if (!strncmp(mname, "__destruct", mname_len)) {
  ce->destructor = fe; fe->common.fn_flags |= 0x4000;
 } else if (!strncmp(mname, "__get", mname_len)) {
  ce->__get = fe;
 } else if (!strncmp(mname, "__set", mname_len)) {
  ce->__set = fe;
 } else if (!strncmp(mname, "__call", mname_len)) {
  ce->__call = fe;
 } else if (!strncmp(mname, "__unset", mname_len)) {
  ce->__unset = fe;
 } else if (!strncmp(mname, "__isset", mname_len)) {
  ce->__isset = fe;
 } else if (!strncmp(mname, "__callstatic", mname_len)) {
  ce->__callstatic = fe;
 } else if (!strncmp(mname, "__tostring", mname_len)) {
  ce->__tostring = fe;
 } else if (!strncmp(mname, "__debuginfo", mname_len)) {
  ce->__debugInfo = fe;
 ...
 if (zend_hash_quick_find(&ce->function_table, arKey, nKeyLength, h, (void**) &existing_fn) == SUCCESS) {
  if (existing_fn->common.scope == ce) {
   ...
   if (*overriden) {
    ...
    _zend_hash_init_ex((*overriden), (2), (((void *)0)), (0), (0) );
   }
   ...
   return;
    ...
    (existing_fn->common.scope->ce_flags & 0x80) == 0) {
...
static void zend_check_trait_usage(zend_class_entry *ce, zend_class_entry *trait )
{
 ...
 if ((trait->ce_flags & 0x120) != 0x120) {
  zend_error_noreturn((1<<6L), "Class %s is not a trait, Only traits may be used in 'as' and 'insteadof' statements", trait->name);
 }
 ...
 zend_error_noreturn((1<<6L), "Required Trait %s wasn't added to %s", trait->name, ce->name);
}
  ...
  while ((cur_precedence = precedences[i])) {
   ...
   if (cur_precedence->exclude_from_classes) {
    ...
    if (!(cur_precedence->trait_method->ce = zend_fetch_class(cur_method_ref->class_name, cur_method_ref->cname_len,
        14|0x80 ))) {
     zend_error_noreturn((1<<6L), "Could not find trait %s", cur_method_ref->class_name);
    }
    ...
    while (cur_precedence->exclude_from_classes[j]) {
     ...
     if (!(cur_precedence->exclude_from_classes[j] = zend_fetch_class(class_name, name_length, 14 |0x80 ))) {
      zend_error_noreturn((1<<6L), "Could not find trait %s", class_name);
     }
 ...
 if (ce->trait_aliases) {
  ...
  while (ce->trait_aliases[i]) {
   ...
   if (ce->trait_aliases[i]->trait_method->class_name) {
    ...
    if (!method_exists) {
     zend_error_noreturn((1<<6L), "An alias was defined for %s::%s but this method does not exist", cur_method_ref->ce->name, cur_method_ref->method_name);
    }
   }
   i++;
  }
   ...
   while (precedences[i]->exclude_from_classes[j]) {
    if (precedences[i]->exclude_from_classes[j] == trait) {
     ...
     if (_zend_hash_add_or_update(exclude_table, lcname, lcname_len, ((void *)0), 0, ((void *)0), (1<<1) ) == FAILURE) {
      _efree((lcname) );
      zend_error_noreturn((1<<6L), "Failed to evaluate a trait precedence (%s). Method of trait %s was defined to be excluded multiple times", precedences[i]->trait_method->method_name, trait->name);
     }
     _efree((lcname) );
    }
    ++j;
...
static void zend_do_traits_method_binding(zend_class_entry *ce )
{
 ...
 for (i = 0; i < ce->num_traits; i++) {
  if (ce->trait_precedences) {
   ...
   _zend_hash_init_ex((&exclude_table), (2), (((void *)0)), (0), (0) );
 ...
 for (i = 0; i < ce->num_traits; i++) {
  for (zend_hash_internal_pointer_reset_ex(&ce->traits[i]->properties_info, ((void *)0));
   ...
   if ((flags & (0x100 | 0x200 | 0x400)) == 0x100) {
    ...
    prop_hash = zend_hash_func(prop_name, prop_name_length + 1);
   }
...
# 4538 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
__attribute__ ((visibility("default"))) zend_class_entry *do_bind_class(const zend_op_array* op_array, const zend_op *opline, HashTable *class_table, zend_bool compile_time )
{
 ...
 if (_zend_hash_quick_add_or_update(class_table, (*op2).value.str.val, (*op2).value.str.len+1, (((zend_literal*)(op2))->hash_value), &ce, sizeof(zend_class_entry *), ((void *)0), (1<<1) )==FAILURE) {
  ...
  if (!compile_time) {
   ...
   zend_error_noreturn((1<<6L), "Cannot redeclare class %s", ce->name);
  }
  return ((void *)0);
 } else {
...
__attribute__ ((visibility("default"))) zend_class_entry *do_bind_inherited_class(const zend_op_array *op_array, const zend_op *opline, HashTable *class_table, zend_class_entry *parent_ce, zend_bool compile_time )
{
 ...
 if (parent_ce->ce_flags & 0x80) {
  zend_error_noreturn((1<<6L), "Class %s cannot extend from interface %s", ce->name, parent_ce->name);
 } else if ((parent_ce->ce_flags & 0x120) == 0x120) {
  zend_error_noreturn((1<<6L), "Class %s cannot extend from trait %s", ce->name, parent_ce->name);
 }
...
void zend_do_begin_class_declaration(const znode *class_token, znode *class_name, const znode *parent_class_name )
{
 ...
 if (doing_inheritance) {
  ...
  if ((new_class_entry->ce_flags & 0x120) == 0x120) {
   zend_error_noreturn((1<<6L), "A trait (%s) cannot extend a class. Traits can only be composed from other traits with the 'use' keyword. Error", new_class_entry->name);
  }
...
void zend_do_end_class_declaration(const znode *class_token, const znode *parent_token )
{
 ...
 if (ce->constructor) {
  ...
  if (ce->constructor->common.fn_flags & 0x01) {
   zend_error_noreturn((1<<6L), "Constructor %s::%s() cannot be static", ce->name, ce->constructor->common.function_name);
  }
 }
 if (ce->destructor) {
  ce->destructor->common.fn_flags |= 0x4000;
  if (ce->destructor->common.fn_flags & 0x01) {
   zend_error_noreturn((1<<6L), "Destructor %s::%s() cannot be static", ce->name, ce->destructor->common.function_name);
  }
 }
 if (ce->clone) {
  ce->clone->common.fn_flags |= 0x8000;
  if (ce->clone->common.fn_flags & 0x01) {
   zend_error_noreturn((1<<6L), "Clone method %s::%s() cannot be static", ce->name, ce->clone->common.function_name);
  }
 }
...
void zend_do_declare_property(const znode *var_name, const znode *value, zend_uint access_type )
{
 ...
 if (zend_hash_find(&(compiler_globals.active_class_entry)->properties_info, (var_name->u.constant).value.str.val, (var_name->u.constant).value.str.len+1, (void **) &existing_property_info)==SUCCESS) {
  zend_error_noreturn((1<<6L), "Cannot redeclare %s::$%s", (compiler_globals.active_class_entry)->name, (var_name->u.constant).value.str.val);
 }
 ...
 *property = value->u.constant;
 ...
 hash = ((((cname) >= (compiler_globals.interned_strings_start)) && ((cname) < (compiler_globals.interned_strings_end))) ? (((Bucket*)(((char*)(cname))-sizeof(Bucket)))->h) : zend_hash_func((cname), ((var_name->u.constant).value.str.len)+1));
 if (_zend_hash_quick_add_or_update(&(compiler_globals.active_class_entry)->constants_table, cname, (var_name->u.constant).value.str.len+1, hash, &property, sizeof(zval *), ((void *)0), (1<<1) ) == FAILURE) {
  ...
  zend_error_noreturn((1<<6L), "Cannot redefine class constant %s::%s", (compiler_globals.active_class_entry)->name, (var_name->u.constant).value.str.val);
 }
...
static zend_constant* zend_get_ct_const(const zval *const_name, int all_internal_constants_substitution )
{
 ...
 if (all_internal_constants_substitution &&
     ...
     !((((c->value).type) & 0x00f) >= 8 && (((c->value).type) & 0x00f) <= 9)) {
  return c;
 }
 return ((void *)0);
}
 ...
 switch (mode) {
  ...
  case (1<<1):
   ...
   if (compound) {
    ...
    if (check_namespace && (compiler_globals.current_namespace)) {
...
void zend_do_add_static_array_element(zval *result, zval *offset, const zval *expr)
{
 if (offset) {
  switch ((*offset).type) {
   case 6:
    zend_symtable_update((*result).value.ht, (*offset).value.str.val, (*offset).value.str.len+1, &expr, sizeof(zval *), ((void *)0));
    _zval_dtor((offset) );
    break;
   case 0:
    zend_symtable_update((*result).value.ht, "", 1, &expr, sizeof(zval *), ((void *)0));
    break;
   case 1:
   case 3:
    _zend_hash_index_update_or_next_insert((*result).value.ht, (*offset).value.lval, &expr, sizeof(zval *), ((void *)0), (1<<0) );
    break;
   case 2:
    _zend_hash_index_update_or_next_insert((*result).value.ht, zend_dval_to_lval((*offset).value.dval), &expr, sizeof(zval *), ((void *)0), (1<<0) );
    break;
   case 4:
  ...
  _zend_hash_index_update_or_next_insert((*result).value.ht, 0, &expr, sizeof(zval *), ((void *)0), (1<<2) );
 }
}
...
void zend_do_fetch_static_variable(znode *varname, const znode *static_assignment, int fetch_type )
{
 ...
 if (!(compiler_globals.active_op_array)->static_variables) {
  ...
  _zend_hash_init(((compiler_globals.active_op_array)->static_variables), (2), ((void (*)(void *)) _zval_ptr_dtor), (0) );
 }
...
zend_bool zend_is_auto_global_quick(const char *name, uint name_len, ulong hash )
{
...
{
 return zend_is_auto_global_quick(name, name_len, zend_hash_func(name, name_len+1) );
}
...
__attribute__ ((visibility("default"))) void zend_initialize_class_data(zend_class_entry *ce, zend_bool nullify_handlers )
{
 ...
 _zend_hash_init_ex((&ce->properties_info), (0), ((dtor_func_t) (persistent_hashes ? zend_destroy_property_info_internal : zend_destroy_property_info)), (persistent_hashes), (0) );
 _zend_hash_init_ex((&ce->constants_table), (0), (zval_ptr_dtor_func), (persistent_hashes), (0) );
 _zend_hash_init_ex((&ce->function_table), (0), ((void (*)(void *)) zend_function_dtor), (persistent_hashes), (0) );

 if (ce->type == 1) {
# 6967 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
void zend_do_use(znode *ns_name, znode *new_name )
{
 ...
 if (!(compiler_globals.current_import)) {
  ...
  _zend_hash_init(((compiler_globals.current_import)), (0), ((void (*)(void *)) _zval_ptr_dtor), (0) );
 }

 do { (ns) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(ns))->u.buffered = ((void *)0); } while (0); (ns)->refcount__gc = 1; (ns)->is_ref__gc = 0;;;
 do { zval *__z = (ns); zval *__zv = (&ns_name->u.constant); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (0) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
 if (new_name) {
  ...
  if (p) {
   ...
   do { zval *__z = (name); zval *__zv = (ns); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
   warn = !(compiler_globals.current_namespace);
  }
 }
 ...
 if (warn) {
  if (!strcmp((*name).value.str.val, "strict")) {
...
void zend_do_use_non_class(znode *ns_name, znode *new_name, int is_function, zend_bool case_sensitive, HashTable *current_import_sub, HashTable *lookup_table )
{
 ...
 if ((compiler_globals.current_namespace)) {
  ...
  if (zend_hash_find(lookup_table, lookup_name, (*name).value.str.len+1, (void **) &function) == SUCCESS && function->type == 2 && strcmp(function->op_array.filename, (compiler_globals.compiled_filename)) == 0) {
   char *c_tmp = zend_str_tolower_dup((*ns).value.str.val, (*ns).value.str.len);
  ...
  if (zend_hash_find(lookup_table, lookup_name, (*name).value.str.len+1, (void **) &filename) == SUCCESS && strcmp(filename, (compiler_globals.compiled_filename)) == 0) {
   char *c_tmp = zend_str_tolower_dup((*ns).value.str.val, (*ns).value.str.len);
...
void zend_do_use_function(znode *ns_name, znode *new_name )
{
 if (!(compiler_globals.current_import_function)) {
  (compiler_globals.current_import_function) = _emalloc((sizeof(HashTable)) );
  _zend_hash_init(((compiler_globals.current_import_function)), (0), ((void (*)(void *)) _zval_ptr_dtor), (0) );
 }

 zend_do_use_non_class(ns_name, new_name, 1, 0, (compiler_globals.current_import_function), (compiler_globals.function_table) );
}


void zend_do_use_const(znode *ns_name, znode *new_name )
{
 if (!(compiler_globals.current_import_const)) {
  (compiler_globals.current_import_const) = _emalloc((sizeof(HashTable)) );
  _zend_hash_init(((compiler_globals.current_import_const)), (0), ((void (*)(void *)) _zval_ptr_dtor), (0) );
 }

 zend_do_use_non_class(ns_name, new_name, 0, 1, (compiler_globals.current_import_const), &(compiler_globals.const_filenames) );
}
...
void zend_do_constant_expression(znode *result, zend_ast *ast )
{
 if (ast->kind == ZEND_CONST) {
  ...
  (result->u.constant).type = 9;
  (result->u.constant).value.ast = ast;
 }
}
...
# 7487 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
 if (len == 0) {
 ...
 if (end < path) {
# 7519 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
  path[0] = '.';
  path[1] = '\0';
  return 1 + len_adjust;
