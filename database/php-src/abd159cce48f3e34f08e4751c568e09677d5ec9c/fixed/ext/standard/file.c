...
# 139 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/file.c"
...
static const zend_ini_entry ini_entries[] = {
 { 0, ((1<<0)|(1<<1)|(1<<2)), "user_agent", sizeof("user_agent"), OnUpdateString, (void *) __builtin_offsetof (php_file_globals, user_agent), (void *) &file_globals, ((void *)0), ((void *)0), sizeof(((void *)0))-1, ((void *)0), 0, 0, 0, ((void *)0) },
 { 0, ((1<<0)|(1<<1)|(1<<2)), "from", sizeof("from"), OnUpdateString, (void *) __builtin_offsetof (php_file_globals, from_address), (void *) &file_globals, ((void *)0), ((void *)0), sizeof(((void *)0))-1, ((void *)0), 0, 0, 0, ((void *)0) },
 { 0, ((1<<0)|(1<<1)|(1<<2)), "default_socket_timeout", sizeof("default_socket_timeout"), OnUpdateLong, (void *) __builtin_offsetof (php_file_globals, default_socket_timeout), (void *) &file_globals, ((void *)0), "60", sizeof("60")-1, ((void *)0), 0, 0, 0, ((void *)0) },
 { 0, ((1<<0)|(1<<1)|(1<<2)), "auto_detect_line_endings", sizeof("auto_detect_line_endings"), OnUpdateLong, (void *) __builtin_offsetof (php_file_globals, auto_detect_line_endings), (void *) &file_globals, ((void *)0), "0", sizeof("0")-1, ((void *)0), 0, 0, 0, ((void *)0) },
...
void zif_flock(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "rl|z", &arg1, &operation, &arg3) == FAILURE) {
  return;
 }
...
void zif_get_meta_tags(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|b", &filename, &filename_len, &use_include_path) == FAILURE) {
  return;
 }
...
void zif_file_get_contents(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|br!ll", &filename, &filename_len, &use_include_path, &zcontext, &offset, &maxlen) == FAILURE) {
  return;
 }
 ...
 if ((len = _php_stream_copy_to_mem((stream), (&contents), (maxlen), (0) )) > 0) {
  if (len > 2147483647) {
   php_error_docref0(((void *)0) , (1<<1L), "content truncated from %ld to %d bytes", len, 2147483647);
   len = 2147483647;
  }
...
void zif_file_put_contents(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "pz/|lr!", &filename, &filename_len, &data, &flags, &zcontext) == FAILURE) {
  return;
 }
 ...
 switch ((*data).type) {
  case 7: {
   ...
   if (_php_stream_copy_to_stream_ex((srcstream), (stream), (((size_t)-1)), (&len) ) != SUCCESS) {
    ...
    if (len > 9223372036854775807L) {
     php_error_docref0(((void *)0) , (1<<1L), "content truncated from %lu to %ld bytes", (unsigned long) len, 9223372036854775807L);
  ...
  case 6:
   if ((*data).value.str.len) {
    ...
    if (numbytes != (*data).value.str.len) {
     php_error_docref0(((void *)0) , (1<<1L), "Only %ld of %d bytes written, possibly out of free disk space", numbytes, (*data).value.str.len);
     numbytes = -1;
    }
   }
   break;
  ...
  case 4:
   if (zend_hash_num_elements((*data).value.ht)) {
    ...
    while (zend_hash_get_current_data_ex((*data).value.ht, (void **) &tmp, &pos) == SUCCESS) {
     if ((**tmp).type != 6) {
   ...
   if ((*data).value.obj.handlers != ((void *)0)) {
    ...
    if (zend_std_cast_object_tostring(data, &out, 6 ) == SUCCESS) {
     ...
     if (numbytes != (out).value.str.len) {
      php_error_docref0(((void *)0) , (1<<1L), "Only %ld of %d bytes written, possibly out of free disk space", numbytes, (out).value.str.len);
      numbytes = -1;
     }
     _zval_dtor((&out) );
     break;
...
void zif_file(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|lr!", &filename, &filename_len, &flags, &zcontext) == FAILURE) {
  return;
 }
...
void zif_tempnam(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "pp", &dir, &dir_len, &prefix, &prefix_len) == FAILURE) {
  return;
 }
...
void php_if_fopen(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ps|br", &filename, &filename_len, &mode, &mode_len, &use_include_path, &zcontext) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
__attribute__ ((visibility("default"))) void zif_fclose(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "r", &arg1) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_popen(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ps", &command, &command_len, &mode, &mode_len) == FAILURE) {
  return;
 }
...
__attribute__ ((visibility("default"))) void zif_fgets(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "r|l", &arg1, &len) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
__attribute__ ((visibility("default"))) void zif_fgetss(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "r|ls", &fd, &bytes, &allowed_tags, &allowed_tags_len) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_fscanf(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "rs*", &file_handle, &format, &format_len, &args, &argc) == FAILURE) {
  return;
 }
...
__attribute__ ((visibility("default"))) void zif_fwrite(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "rs|l", &arg1, &arg2, &arg2len, &arg3) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
__attribute__ ((visibility("default"))) void zif_fseek(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "rl|l", &arg1, &arg2, &whence) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_mkdir(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|lbr", &dir, &dir_len, &mode, &recursive, &zcontext) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_rmdir(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|r", &dir, &dir_len, &zcontext) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_readfile(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|br!", &filename, &filename_len, &use_include_path, &zcontext) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_umask(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "|l", &arg1) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_rename(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "pp|r", &old_name, &old_name_len, &new_name, &new_name_len, &zcontext) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_unlink(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "p|r", &filename, &filename_len, &zcontext) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void php_if_ftruncate(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "rl", &fp, &size) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void php_if_fstat(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "r", &fp) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_copy(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "pp|r", &source, &source_len, &target, &target_len, &zcontext) == FAILURE) {
  return;
 }
...
__attribute__ ((visibility("default"))) void zif_fread(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "rl", &arg1, &len) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_fputcsv(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ra|sss",
...
__attribute__ ((visibility("default"))) int php_fputcsv(php_stream *stream, zval *fields, char delimiter, char enclosure, char escape_char )
{
 ...
 while (zend_hash_get_current_data_ex((*fields).value.ht, (void **) &field_tmp, &pos) == SUCCESS) {
  field = **field_tmp;
...
# 2341 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/file.c"
...
void zif_fnmatch(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "pp|l", &pattern, &pattern_len, &filename, &filename_len, &flags) == FAILURE) {
  return;
 }
