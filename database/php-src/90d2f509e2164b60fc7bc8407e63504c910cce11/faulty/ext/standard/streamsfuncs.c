...
# 1390 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
 t.tv_sec = seconds;
...
# 1525 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
...
# 1642 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
void zif_stream_socket_shutdown(zend_execute_data *execute_data, zval *return_value)
{
 zend_long how;
 zval *zstream;
