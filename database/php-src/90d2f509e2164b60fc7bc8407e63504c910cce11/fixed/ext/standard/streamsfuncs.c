# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c" 2



typedef unsigned long long php_timeout_ull;
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
...
void zif_stream_socket_pair(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (FAILURE == zend_parse_parameters((execute_data)->This.u2.num_args, "lll",
...
void zif_stream_socket_client(zend_execute_data *execute_data, zval *return_value)
{
 ...
 double timeout = (double)(file_globals.default_socket_timeout);
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "S|z/z/dlr", &host, &zerrno, &zerrstr, &timeout, &flags, &zcontext) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if (zerrno) {
  _zval_dtor((zerrno) );
  { zval *__z = (zerrno); (*(__z)).value.lval = 0; (*(__z)).u1.type_info = 4; };
 }
 if (zerrstr) {
  _zval_dtor((zerrstr) );
  do { do { zval *__z = (zerrstr); zend_string *__s = ((compiler_globals.empty_string)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = 6; } while (0); } while (0);
 }

 stream = _php_stream_xport_create((host)->val, (host)->len, 0x00000008, 0 | (flags & 4 ? 2 : 0) | (flags & 2 ? 16 : 0), hashkey, &tv, context, &errstr, &err )
 ...
 if (stream == ((void *)0)) {
  ...
  php_error_docref0(((void *)0), (1<<1L), "unable to connect to %s (%s)", (quoted_host)->val, errstr == ((void *)0) ? "Unknown error" : (errstr)->val);
 ...
 if (stream == ((void *)0)) {
  if (zerrno) {
   _zval_dtor((zerrno) );
   { zval *__z = (zerrno); (*(__z)).value.lval = err; (*(__z)).u1.type_info = 4; };
  }
  if (zerrstr && errstr) {
   _zval_dtor((zerrstr) );
   do { zval *__z = (zerrstr); zend_string *__s = (errstr); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
  } else if (errstr) {
...
void zif_stream_socket_server(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|z/z/lr", &host, &host_len, &zerrno, &zerrstr, &flags, &zcontext) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 stream = _php_stream_xport_create(host, host_len, 0x00000008, 1 | (int)flags, ((void *)0), ((void *)0), context, &errstr, &err )

                                      ;

 if (stream == ((void *)0)) {
  php_error_docref0(((void *)0), (1<<1L), "unable to connect to %s (%s)", host, errstr == ((void *)0) ? "Unknown error" : (errstr)->val);
 }
...
void zif_stream_socket_accept(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 if (zpeername) {
  ...
  do { (*(zpeername)).u1.type_info = 1; } while (0);
 }
 ...
 if (0 == php_stream_xport_accept(stream, &clistream,
  ...
  if (peername) {
   do { zval *__z = (zpeername); zend_string *__s = (peername); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
  }
  { do { zval *__z = (return_value); (*__z).value.res = ((clistream)->res); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0); (clistream)->__exposed++; };
 } else {
  php_error_docref0(((void *)0), (1<<1L), "accept failed: %s", errstr ? (errstr)->val : "Unknown error");
  do { (*(return_value)).u1.type_info = 2; } while (0);
 }
...
void zif_stream_socket_get_name(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { zval *__z = (return_value); zend_string *__s = (name); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
}
...
void zif_stream_socket_sendto(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rs|ls", &zstream, &data, &datalen, &flags, &target_addr, &target_addr_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = php_stream_xport_sendto(stream, data, datalen, (int)flags, target_addr ? &sa : ((void *)0), sl); (*(__z)).u1.type_info = 4; }; return; };
}
...
void zif_stream_socket_recvfrom(zend_execute_data *execute_data, zval *return_value)
{
 ...
 zend_string *remote_addr = ((void *)0);
 zend_long to_read = 0;
 zend_string *read_buf;
 zend_long flags = 0;
 int recvd;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rl|lz/", &zstream, &to_read, &flags, &zremote) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if (zremote) {
  _zval_dtor((zremote) );
  do { (*(zremote)).u1.type_info = 1; } while (0);
 }
 ...
 recvd = php_stream_xport_recvfrom(stream, (read_buf)->val, to_read, (int)flags, ((void *)0), ((void *)0),
   zremote ? &remote_addr : ((void *)0)
   );

 if (recvd >= 0) {
  if (zremote) {
   do { zval *__z = (zremote); zend_string *__s = (remote_addr); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
  }
  (read_buf)->val[recvd] = '\0';
  (read_buf)->len = recvd;
  { do { zval *__z = (return_value); zend_string *__s = (read_buf); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
 }
...
void zif_stream_get_contents(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "r|ll", &zsrc, &maxlen, &desiredpos) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zsrc), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 if ((contents = _php_stream_copy_to_mem((stream), (maxlen), (0) ))) {
  { do { zval *__z = (return_value); zend_string *__s = (contents); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
 } else {
...
void zif_stream_copy_to_stream(zend_execute_data *execute_data, zval *return_value)
{
 php_stream *src, *dest;
 zval *zsrc, *zdest;
 zend_long maxlen = ((size_t)-1), pos = 0;
 size_t len;
 int ret;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rr|ll", &zsrc, &zdest, &maxlen, &pos) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 do { if (((src) = (php_stream*)zend_fetch_resource2_ex((zsrc), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 do { if (((dest) = (php_stream*)zend_fetch_resource2_ex((zdest), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);

 if (pos > 0 && _php_stream_seek((src), (pos), (0)) < 0) {
  php_error_docref0(((void *)0), (1<<1L), "Failed to seek to position " "%" "l" "d" " in the stream", pos);
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = len; (*(__z)).u1.type_info = 4; }; return; };
}
...
void zif_stream_get_meta_data(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (!(zval_get_type(&(stream->wrapperdata)) == 0)) {
  zval_addref_p(&stream->wrapperdata);
  add_assoc_zval_ex(return_value, "wrapper_data", strlen("wrapper_data"), &stream->wrapperdata);
 }
 if (stream->wrapper) {
  add_assoc_string_ex(return_value, "wrapper_type", strlen("wrapper_type"), (char *)stream->wrapper->wops->label);
 }
 add_assoc_string_ex(return_value, "stream_type", strlen("stream_type"), (char *)stream->ops->label);

 add_assoc_string_ex(return_value, "mode", strlen("mode"), stream->mode);
# 536 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
 add_assoc_long_ex(return_value, "unread_bytes", strlen("unread_bytes"), stream->writepos - stream->readpos);

 add_assoc_bool_ex(return_value, "seekable", strlen("seekable"), (stream->ops->seek) && (stream->flags & 0x1) == 0);
 if (stream->orig_path) {
  add_assoc_string_ex(return_value, "uri", strlen("uri"), stream->orig_path);
 }

 if (!(_php_stream_set_option((stream), 11, 0, return_value) == 0 ? 1 : 0)) {
  add_assoc_bool_ex(return_value, "timed_out", strlen("timed_out"), 0);
  add_assoc_bool_ex(return_value, "blocked", strlen("blocked"), 1);
  add_assoc_bool_ex(return_value, "eof", strlen("eof"), _php_stream_eof((stream)));
 }
}
...
void zif_stream_get_transports(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((stream_xport_hash = php_stream_xport_get_hash())) {
  _array_init((return_value), 0 );
  do { Bucket *_p = (stream_xport_hash)->arData; Bucket *_end = _p + (stream_xport_hash)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; stream_xport = _p->key; {
...
void zif_stream_get_wrappers(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((url_stream_wrappers_hash = _php_stream_get_url_stream_wrappers_hash())) {
  _array_init((return_value), 0 );
  do { Bucket *_p = (url_stream_wrappers_hash)->arData; Bucket *_end = _p + (url_stream_wrappers_hash)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; stream_protocol = _p->key; {
   if (stream_protocol) {
...
static int stream_array_to_fd_set(zval *stream_array, fd_set *fds, php_socket_t *max_fd)
{
 ...
 if (zval_get_type(&(*(stream_array))) != 7) {
  return 0;
 }

 do { Bucket *_p = ((*(stream_array)).value.arr)->arData; Bucket *_end = _p + ((*(stream_array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; elem = _z; {



  php_socket_t this_fd;

  (stream) = (php_stream*)zend_fetch_resource2_ex((elem), "stream", php_file_le_stream(), php_file_le_pstream());
  if (stream == ((void *)0)) {
   continue;
  }
  ...
  if (SUCCESS == _php_stream_cast((stream), (3 | 0x20000000), ((void*)&this_fd), (1)) && this_fd != -1) {

   do { if (this_fd < 1024) ((void) (((fds)->fds_bits)[((this_fd) / (8 * (int) sizeof (__fd_mask)))] |= ((__fd_mask) 1 << ((this_fd) % (8 * (int) sizeof (__fd_mask)))))); } while(0);
...
static int stream_array_from_fd_set(zval *stream_array, fd_set *fds)
{
 ...
 do { Bucket *_p = ((*(stream_array)).value.arr)->arData; Bucket *_end = _p + ((*(stream_array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_ind = _p->h; key = _p->key; elem = _z; {
  ...
  if (SUCCESS == _php_stream_cast((stream), (3 | 0x20000000), ((void*)&this_fd), (1)) && this_fd != -1) {
   if (((this_fd < 1024) && ((((fds)->fds_bits)[((this_fd) / (8 * (int) sizeof (__fd_mask)))] & ((__fd_mask) 1 << ((this_fd) % (8 * (int) sizeof (__fd_mask))))) != 0))) {
    if (!key) {
     dest_elem = _zend_hash_index_update((new_array).value.arr, num_ind, elem );
    } else {
     dest_elem = _zend_hash_update((new_array).value.arr, key, elem );
    }
 ...
 zend_array_destroy((*(stream_array)).value.arr);
 (*(stream_array)).value.arr = (new_array).value.arr;
...
static int stream_array_emulate_read_fd_set(zval *stream_array)
{
 ...
 do { Bucket *_p = ((*(stream_array)).value.arr)->arData; Bucket *_end = _p + ((*(stream_array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; elem = _z; {
  ...
  if ((stream->writepos - stream->readpos) > 0) {
   ...
   dest_elem = _zend_hash_next_index_insert((new_array).value.arr, elem );
   if (dest_elem) {
    zval_add_ref(dest_elem);
   }
   ret++;
 ...
 if (ret > 0) {
  ...
  zend_array_destroy((new_array).value.arr);
 }
...
void zif_stream_select(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (4); int _max_num_args = (5); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &r_array, 1, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &w_array, 1, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &e_array, 1, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &sec, &secnull, 1, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &usec, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&rfds)->fds_bits)[0]) : "memory"); } while (0);
 do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&wfds)->fds_bits)[0]) : "memory"); } while (0);
 do { int __d0, __d1; __asm__ __volatile__ ("cld; rep; " "stosq" : "=c" (__d0), "=D" (__d1) : "a" (0), "0" (sizeof (fd_set) / sizeof (__fd_mask)), "1" (&((&efds)->fds_bits)[0]) : "memory"); } while (0);
 ...
 if (r_array != ((void *)0)) {
  ...
  if (retval > 0) {
   if (w_array != ((void *)0)) {
    zend_hash_clean((*(w_array)).value.arr);
   }
   if (e_array != ((void *)0)) {
    zend_hash_clean((*(e_array)).value.arr);
   }
   { { zval *__z = (return_value); (*(__z)).value.lval = retval; (*(__z)).u1.type_info = 4; }; return; };
  }
 }
  ...
  char *xmsg, int xcode, size_t bytes_sofar, size_t bytes_max, void * ptr)
{
 ...
 { zval *__z = (&zvs[0]); (*(__z)).value.lval = notifycode; (*(__z)).u1.type_info = 4; };
 { zval *__z = (&zvs[1]); (*(__z)).value.lval = severity; (*(__z)).u1.type_info = 4; };
 if (xmsg) {
  do { const char *_s = (xmsg); do { do { zval *__z = (&zvs[2]); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
 } else {
  do { (*(&zvs[2])).u1.type_info = 1; } while (0);
 }
 { zval *__z = (&zvs[3]); (*(__z)).value.lval = xcode; (*(__z)).u1.type_info = 4; };
 { zval *__z = (&zvs[4]); (*(__z)).value.lval = bytes_sofar; (*(__z)).u1.type_info = 4; };
 { zval *__z = (&zvs[5]); (*(__z)).value.lval = bytes_max; (*(__z)).u1.type_info = 4; };

 if (FAILURE == call_user_function_ex((executor_globals.function_table), ((void *)0), callback, &retval, 6, zvs, 0, ((void *)0))) {
  php_error_docref0(((void *)0), (1<<1L), "failed to call user notifier");
 }
 for (i = 0; i < 6; i++) {
  _zval_ptr_dtor((&zvs[i]) );
 }
...
{
 if (notifier && zval_get_type(&(notifier->ptr)) != 0) {
  _zval_ptr_dtor((&notifier->ptr) );
  do { (*(&notifier->ptr)).u1.type_info = 0; } while (0);
 }
}
...
static int parse_context_options(php_stream_context *context, zval *options)
{
 ...
 do { Bucket *_p = ((*(options)).value.arr)->arData; Bucket *_end = _p + ((*(options)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; wkey = _p->key; wval = _z; {
  do { if (__builtin_expect(!!((zval_get_type(&(*(wval))) == 10)), 0)) { (wval) = &(*(wval)).value.ref->val; } } while (0);
  if (zval_get_type(&(*(wval))) == 7) {
      do { Bucket *_p = ((*(wval)).value.arr)->arData; Bucket *_end = _p + ((*(wval)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; okey = _p->key; oval = _z; {
    if (okey) {
     do { if (__builtin_expect(!!((zval_get_type(&(*(oval))) == 10)), 0)) { (oval) = &(*(oval)).value.ref->val; } } while (0);
...
static int parse_context_params(php_stream_context *context, zval *params)
{
 ...
 if (((void *)0) != (tmp = zend_hash_str_find((*(params)).value.arr, "notification", sizeof("notification")-1))) {
  ...
  do { zval *_z1 = (&context->notifier->ptr); const zval *_z2 = (tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  context->notifier->dtor = user_space_stream_notifier_dtor;
 }
 if (((void *)0) != (tmp = zend_hash_str_find((*(params)).value.arr, "options", sizeof("options")-1))) {
...
static php_stream_context *decode_context_param(zval *contextresource)
{
 ...
 if (context == ((void *)0)) {
  ...
  if (stream) {
   context = ((php_stream_context*) ((stream)->ctx ? ((stream)->ctx->ptr) : ((void *)0)));
   if (context == ((void *)0)) {
...
void zif_stream_context_get_options(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_resource(_arg, &zcontext, 0)), 0)) { _expected_type = Z_EXPECTED_RESOURCE; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 do { zval *_z1 = (return_value); const zval *_z2 = (&context->options); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}
...
void zif_stream_context_set_option(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((execute_data)->This.u2.num_args == 2) {
  ...
  do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
   ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_resource(_arg, &zcontext, 0)), 0)) { _expected_type = Z_EXPECTED_RESOURCE; error_code = 4; break; }
   ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &options, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
  ...
  { do { (*(return_value)).u1.type_info = (parse_context_options(context, options) == SUCCESS) ? 3 : 2; } while (0); return; };
 } else {
  zval *zvalue;
  ...
  do { const int _flags = (0); int _min_num_args = (4); int _max_num_args = (4); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
   ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_resource(_arg, &zcontext, 0)), 0)) { _expected_type = Z_EXPECTED_RESOURCE; error_code = 4; break; }
   ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_string(_arg, &wrappername, &wrapperlen, 0)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
   ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_string(_arg, &optionname, &optionlen, 0)), 0)) { _expected_type = Z_EXPECTED_STRING; error_code = 4; break; }
   if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &zvalue, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &zvalue, 0); }
  } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
  ...
  { do { (*(return_value)).u1.type_info = (php_stream_context_set_option(context, wrappername, optionname, zvalue) == SUCCESS) ? 3 : 2; } while (0); return; };
 }
}
...
void zif_stream_context_set_params(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { (*(return_value)).u1.type_info = (parse_context_params(context, params) == SUCCESS) ? 3 : 2; } while (0);
}
...
void zif_stream_context_get_params(zend_execute_data *execute_data, zval *return_value)
{
 ...
 _array_init((return_value), 0 );
 if (context->notifier && zval_get_type(&(context->notifier->ptr)) != 0 && context->notifier->func == user_space_stream_notifier) {
  add_assoc_zval_ex(return_value, "notification", sizeof("notification")-1, &context->notifier->ptr);
  if ((((context->notifier->ptr).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(&(context->notifier->ptr));
 }
 if ((((context->options).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(&(context->options));
...
void zif_stream_context_get_default(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|a", &params) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 { do { zval *__z = (return_value); (*__z).value.res = ((context)->res); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0); ((context)->res)->gc.refcount++; };
}
...
void zif_stream_context_create(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|a!a!", &options, &params) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 { do { zval *__z = (return_value); (*__z).value.res = (context->res); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0); return; };
}



static void apply_filter_to_stream(int append, zend_execute_data *execute_data, zval *return_value)
{
 zval *zstream;
 php_stream *stream;
 char *filtername;
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rs|lz", &zstream,
 ...
 if (filter) {
  ...
  { do { zval *__z = (return_value); (*__z).value.res = (filter->res); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
...
void zif_stream_filter_prepend(zend_execute_data *execute_data, zval *return_value)
{
 apply_filter_to_stream(0, execute_data, return_value);
}
...
void zif_stream_filter_append(zend_execute_data *execute_data, zval *return_value)
{
 apply_filter_to_stream(1, execute_data, return_value);
}
...
void zif_stream_filter_remove(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "r", &zfilter) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 filter = zend_fetch_resource((*zfilter).value.res, ((void *)0), php_file_le_stream_filter());
 if (!filter) {
  php_error_docref0(((void *)0), (1<<1L), "Invalid resource given, not a stream filter");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (_php_stream_filter_flush((filter), (1)) == FAILURE) {
  php_error_docref0(((void *)0), (1<<1L), "Unable to flush filter, not removing");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (zend_list_close((*zfilter).value.res) == FAILURE) {
...
void zif_stream_get_line(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rl|s", &zstream, &max_length, &str, &str_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if ((buf = php_stream_get_record(stream, max_length, str, str_len))) {
  { do { zval *__z = (return_value); zend_string *__s = (buf); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
...
void zif_stream_set_blocking(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_resource(_arg, &zstream, 0)), 0)) { _expected_type = Z_EXPECTED_RESOURCE; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_bool(_arg, &block, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_BOOL; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);

 if (_php_stream_set_option((stream), (1), (block), (((void *)0))) == -1) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_stream_set_timeout(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((socket), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
# 1391 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
 t.tv_sec = seconds;
...
void zif_stream_set_write_buffer(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rl", &arg1, &arg2) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((arg1), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = ret == 0 ? 0 : (-1); (*(__z)).u1.type_info = 4; }; return; };
}
...
void zif_stream_set_chunk_size(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rl", &zstream, &csize) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (csize <= 0) {
  php_error_docref0(((void *)0), (1<<1L), "The chunk size must be a positive integer, given " "%" "l" "d", csize);
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = ret > 0 ? (zend_long)ret : (zend_long)(-1); (*(__z)).u1.type_info = 4; }; return; };
}
...
void zif_stream_socket_enable_crypto(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "rb|l!r", &zstream, &enable, &cryptokind, &cryptokindnull, &zsessstream) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
# 1526 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);

 if (enable) {
  if ((execute_data)->This.u2.num_args < 3 || cryptokindnull) {
   zval *val;

   if (!(((php_stream_context*) ((stream)->ctx ? ((stream)->ctx->ptr) : ((void *)0))) && ((void *)0) != (val = php_stream_context_get_option(((php_stream_context*) ((stream)->ctx ? ((stream)->ctx->ptr) : ((void *)0))), "ssl", "crypto_method")))) {
  ...
  if (zsessstream) {
   do { if (((sessstream) = (php_stream*)zend_fetch_resource2_ex((zsessstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
  }
...
void zif_stream_resolve_include_path(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (resolved_path) {
  { do { zval *__z = (return_value); zend_string *__s = (resolved_path); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
 }
 { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
}
...
void zif_stream_is_local(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &zstream) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (zval_get_type(&(*(zstream))) == 9) {
  do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
  if (stream == ((void *)0)) {
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
  ...
  if (zval_get_type(&(*(zstream)))!=6) { if (zval_get_type(&(*(zstream))) != 6) { _convert_to_string((zstream) ); }; };
 ...
 { do { (*(return_value)).u1.type_info = (wrapper->is_url==0) ? 3 : 2; } while (0); return; };
}
...
void zif_stream_supports_lock(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "r", &zsrc) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
# 1643 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/streamsfuncs.c"
void zif_stream_socket_shutdown(zend_execute_data *execute_data, zval *return_value)
{
 zend_long how;
 zval *zstream;
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_paramers_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_resource(_arg, &zstream, 0)), 0)) { _expected_type = Z_EXPECTED_RESOURCE; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &how, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_paramer_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_paramer_type_error(_i, _expected_type, _arg); } } { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);
 ...
 if (how != STREAM_SHUT_RD &&
  ...
  php_error_docref0(((void *)0), (1<<1L), "Second parameter $how needs to be one of STREAM_SHUT_RD, STREAM_SHUT_WR or STREAM_SHUT_RDWR");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((zstream), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);

 { do { (*(return_value)).u1.type_info = (php_stream_xport_shutdown(stream, (stream_shutdown_t)how) == 0) ? 3 : 2; } while (0); return; };
}
