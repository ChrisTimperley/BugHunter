# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/memory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/streams/memory.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/main/streams/memory.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/main/streams/memory.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/main/streams/memory.c" 2

__attribute__ ((visibility("default"))) size_t php_url_decode(char *str, size_t len);
# 39 "/home/ct584/git/bughunter/repositories/php-src/main/streams/memory.c"
typedef struct {
 char *data;
 size_t fpos;
 size_t fsize;
...
static size_t php_stream_memory_write(php_stream *stream, const char *buf, size_t count)
{
 ...
 if (ms->fpos + count > ms->fsize) {
  ...
  if (!ms->data) {
   tmp = (__builtin_constant_p((ms->fpos + count) ) ? (((ms->fpos + count) <= 8) ? _emalloc_8() : (((ms->fpos + count) <= 16) ? _emalloc_16() : (((ms->fpos + count) <= 24) ? _emalloc_24() : (((ms->fpos + count) <= 32) ? _emalloc_32() : (((ms->fpos + count) <= 40) ? _emalloc_40() : (((ms->fpos + count) <= 48) ? _emalloc_48() : (((ms->fpos + count) <= 56) ? _emalloc_56() : (((ms->fpos + count) <= 64) ? _emalloc_64() : (((ms->fpos + count) <= 80) ? _emalloc_80() : (((ms->fpos + count) <= 96) ? _emalloc_96() : (((ms->fpos + count) <= 112) ? _emalloc_112() : (((ms->fpos + count) <= 128) ? _emalloc_128() : (((ms->fpos + count) <= 160) ? _emalloc_160() : (((ms->fpos + count) <= 192) ? _emalloc_192() : (((ms->fpos + count) <= 224) ? _emalloc_224() : (((ms->fpos + count) <= 256) ? _emalloc_256() : (((ms->fpos + count) <= 320) ? _emalloc_320() : (((ms->fpos + count) <= 384) ? _emalloc_384() : (((ms->fpos + count) <= 448) ? _emalloc_448() : (((ms->fpos + count) <= 512) ? _emalloc_512() : (((ms->fpos + count) <= 640) ? _emalloc_640() : (((ms->fpos + count) <= 768) ? _emalloc_768() : (((ms->fpos + count) <= 896) ? _emalloc_896() : (((ms->fpos + count) <= 1024) ? _emalloc_1024() : (((ms->fpos + count) <= 1280) ? _emalloc_1280() : (((ms->fpos + count) <= 1536) ? _emalloc_1536() : (((ms->fpos + count) <= 1792) ? _emalloc_1792() : (((ms->fpos + count) <= 2048) ? _emalloc_2048() : (((ms->fpos + count) <= 2560) ? _emalloc_2560() : (((ms->fpos + count) <= 3072) ? _emalloc_3072() : (((ms->fpos + count) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((ms->fpos + count)) : _emalloc_huge((ms->fpos + count))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((ms->fpos + count) ) );
  } else {
   tmp = _erealloc((ms->data), (ms->fpos + count) );
  }
  if (!tmp) {
...
static int php_stream_memory_close(php_stream *stream, int close_handle)
{
 ...
 if (ms->data && close_handle && ms->mode != 1) {
  _efree((ms->data) );
 }
 _efree((ms) );
 return 0;
...
static int php_stream_memory_stat(php_stream *stream, php_stream_statbuf *ssb)
{
 ...
 ssb->sb.st_mode = ms->mode & 1 ? 0444 : 0666;
 ...
 ssb->sb.st_mtim.tv_sec = timestamp;
 ssb->sb.st_atim.tv_sec = timestamp;
 ssb->sb.st_ctim.tv_sec = timestamp;
   ...
   switch (value) {
    ...
    case 1:
     ...
     if (newsize <= ms->fsize) {
      ...
      ms->data = _erealloc((ms->data), (newsize) );
...
__attribute__ ((visibility("default"))) php_stream_ops php_stream_memory_ops = {
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_memory_create(int mode )
{
 ...
 self = (__builtin_constant_p((sizeof(*self)) ) ? (((sizeof(*self)) <= 8) ? _emalloc_8() : (((sizeof(*self)) <= 16) ? _emalloc_16() : (((sizeof(*self)) <= 24) ? _emalloc_24() : (((sizeof(*self)) <= 32) ? _emalloc_32() : (((sizeof(*self)) <= 40) ? _emalloc_40() : (((sizeof(*self)) <= 48) ? _emalloc_48() : (((sizeof(*self)) <= 56) ? _emalloc_56() : (((sizeof(*self)) <= 64) ? _emalloc_64() : (((sizeof(*self)) <= 80) ? _emalloc_80() : (((sizeof(*self)) <= 96) ? _emalloc_96() : (((sizeof(*self)) <= 112) ? _emalloc_112() : (((sizeof(*self)) <= 128) ? _emalloc_128() : (((sizeof(*self)) <= 160) ? _emalloc_160() : (((sizeof(*self)) <= 192) ? _emalloc_192() : (((sizeof(*self)) <= 224) ? _emalloc_224() : (((sizeof(*self)) <= 256) ? _emalloc_256() : (((sizeof(*self)) <= 320) ? _emalloc_320() : (((sizeof(*self)) <= 384) ? _emalloc_384() : (((sizeof(*self)) <= 448) ? _emalloc_448() : (((sizeof(*self)) <= 512) ? _emalloc_512() : (((sizeof(*self)) <= 640) ? _emalloc_640() : (((sizeof(*self)) <= 768) ? _emalloc_768() : (((sizeof(*self)) <= 896) ? _emalloc_896() : (((sizeof(*self)) <= 1024) ? _emalloc_1024() : (((sizeof(*self)) <= 1280) ? _emalloc_1280() : (((sizeof(*self)) <= 1536) ? _emalloc_1536() : (((sizeof(*self)) <= 1792) ? _emalloc_1792() : (((sizeof(*self)) <= 2048) ? _emalloc_2048() : (((sizeof(*self)) <= 2560) ? _emalloc_2560() : (((sizeof(*self)) <= 3072) ? _emalloc_3072() : (((sizeof(*self)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(*self))) : _emalloc_huge((sizeof(*self)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(*self)) ) );
 self->data = ((void *)0);
 self->fpos = 0;
 self->fsize = 0;
 self->smax = ~0u;
 ...
 stream = _php_stream_alloc((&php_stream_memory_ops), (self), (0), (mode & 1 ? "rb" : "w+b") );
 stream->flags |= 0x2;
 return stream;
}
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_memory_open(int mode, char *buf, size_t length )
{
 ...
 if ((stream = _php_stream_memory_create((mode) )) != ((void *)0)) {
  ...
  if (mode == 1 || mode == 2) {
   ...
   if (length) {
    ((void) (0));
    _php_stream_write(stream, (buf), (length));
   }
  }
 }
 return stream;
...
static size_t php_stream_temp_write(php_stream *stream, const char *buf, size_t count)
{
 ...
 if (((ts->innerstream)->ops == &php_stream_memory_ops)) {
  size_t memsize;
  char *membuf = _php_stream_memory_get_buffer((ts->innerstream), (&memsize) );

  if (memsize + count >= ts->smax) {
   php_stream *file = _php_stream_fopen_temporary_file((ts->tmpdir), ("php"), (((void *)0)) );
   if (file == ((void *)0)) {
    php_error_docref0(((void *)0), (1<<1L), "Unable to create temporary file, Check permissions in temporary files directory.");
    return 0;
   }
   _php_stream_write(file, (membuf), (memsize));
   _php_stream_free_enclosed((ts->innerstream), ((1 | 2)));
   ts->innerstream = file;
   php_stream_encloses(stream, ts->innerstream);
  }
 }
 return _php_stream_write(ts->innerstream, (buf), (count));
}
...
static size_t php_stream_temp_read(php_stream *stream, char *buf, size_t count)
{
 ...
 got = _php_stream_read((ts->innerstream), (buf), (count));
...
static int php_stream_temp_close(php_stream *stream, int close_handle)
{
 ...
 if (ts->innerstream) {
  ret = _php_stream_free_enclosed((ts->innerstream), ((1 | 2) | (close_handle ? 0 : 4)));
 } else {
  ret = 0;
 }

 _zval_ptr_dtor((&ts->meta) );
...
static int php_stream_temp_flush(php_stream *stream)
{
 ...
 return ts->innerstream ? _php_stream_flush((ts->innerstream), 0) : -1;
}
...
static int php_stream_temp_seek(php_stream *stream, zend_off_t offset, int whence, zend_off_t *newoffs)
{
 ...
 ret = _php_stream_seek((ts->innerstream), (offset), (whence));
 *newoffs = _php_stream_tell((ts->innerstream));
 stream->eof = ts->innerstream->eof;
...
static int php_stream_temp_cast(php_stream *stream, int castas, void **ret)
{
 ...
 if (((ts->innerstream)->ops == &php_stream_stdio_ops)) {
  return _php_stream_cast((ts->innerstream), (castas), (ret), (0));
 }
 ...
 membuf = _php_stream_memory_get_buffer((ts->innerstream), (&memsize) );
 file = _php_stream_fopen_tmpfile(0 );
 _php_stream_write(file, (membuf), (memsize));
 pos = _php_stream_tell((ts->innerstream));

 _php_stream_free_enclosed((ts->innerstream), ((1 | 2)));
 ts->innerstream = file;
 php_stream_encloses(stream, ts->innerstream);
 _php_stream_seek((ts->innerstream), (pos), (0));

 return _php_stream_cast((ts->innerstream), (castas), (ret), (1));
}
...
static int php_stream_temp_stat(php_stream *stream, php_stream_statbuf *ssb)
{
 ...
 return _php_stream_stat((ts->innerstream), (ssb));
}
...
static int php_stream_temp_set_option(php_stream *stream, int option, int value, void *ptrparam)
{
 ...
 switch(option) {
  case 11:
   if (zval_get_type(&(ts->meta)) != 0) {
    zend_hash_copy((*((zval*)ptrparam)).value.arr, (ts->meta).value.arr, zval_add_ref);
   }
   return 0;
  default:
   if (ts->innerstream) {
    return _php_stream_set_option((ts->innerstream), (option), (value), (ptrparam));
   }
   return -2;
 }
}
...
__attribute__ ((visibility("default"))) php_stream_ops php_stream_temp_ops = {
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_temp_create_ex(int mode, size_t max_memory_usage, const char *tmpdir )
{
 ...
 self = _ecalloc((1), (sizeof(*self)) );
 self->smax = max_memory_usage;
 self->mode = mode;
 do { (*(&self->meta)).u1.type_info = 0; } while (0);
 if (tmpdir) {
  self->tmpdir = _estrdup((tmpdir) );
 }
 stream = _php_stream_alloc((&php_stream_temp_ops), (self), (0), (mode & 1 ? "rb" : "w+b") );
 stream->flags |= 0x2;
 self->innerstream = _php_stream_memory_create((mode) );
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_temp_create(int mode, size_t max_memory_usage )
{
 return _php_stream_temp_create_ex((mode), (max_memory_usage), (((void *)0)) );
}
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_temp_open(int mode, size_t max_memory_usage, char *buf, size_t length )
{
 ...
 if ((stream = _php_stream_temp_create((mode), (max_memory_usage) )) != ((void *)0)) {
  if (length) {
   ((void) (0));
   php_stream_temp_write(stream, buf, length);
   php_stream_temp_seek(stream, 0, 0, &newoffs);
  }
...
__attribute__ ((visibility("default"))) php_stream_ops php_stream_rfc2397_ops = {
 php_stream_temp_write, php_stream_temp_read,
 php_stream_temp_close, php_stream_temp_flush,
 "RFC2397",
 php_stream_temp_seek,
            ...
            php_stream_context *context )
{
 ...
 zval meta;
 int base64 = 0, ilen;
 zend_string *base64_comma = ((void *)0);

 do { (*(&meta)).u1.type_info = 1; } while (0);
 ...
 if ((comma = memchr(path, ',', dlen)) == ((void *)0)) {
 ...
 if (comma != path) {
  ...
  _array_init((&meta), 0 );
  if (!semi) {
   add_assoc_stringl_ex(&meta, "mediatype", strlen("mediatype"), (char *) path, mlen);
   mlen = 0;
  } else if (sep && sep < semi) {
   plen = semi - path;
   add_assoc_stringl_ex(&meta, "mediatype", strlen("mediatype"), (char *) path, plen);
   mlen -= plen;
   path += plen;
 ...
 add_assoc_bool_ex(&meta, "base64", strlen("base64"), base64);
 ...
 if (base64) {
  ...
  comma = _estrndup((comma), (dlen) );
  dlen = php_url_decode(comma, dlen);
  ilen = (int)dlen;
 }

 if ((stream = _php_stream_temp_create((0), (~0u) )) != ((void *)0)) {
  ...
  ts = (php_stream_temp_data*)stream->abstract;
  ((void) (0));
  ts->mode = mode && mode[0] == 'r' && mode[1] != '+' ? 1 : 0;
  do { zval *_z1 = (&ts->meta); const zval *_z2 = (&meta); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }
 if (base64_comma) {
...
__attribute__ ((visibility("default"))) php_stream_wrapper_ops php_stream_rfc2397_wops = {
...
__attribute__ ((visibility("default"))) php_stream_wrapper php_stream_rfc2397_wrapper = {
