...
# 201 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
  char buf[40];
...
# 639 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
void zif_expm1(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 double num;
...
# 656 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/math.c"
void zif_log1p(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 double num;
