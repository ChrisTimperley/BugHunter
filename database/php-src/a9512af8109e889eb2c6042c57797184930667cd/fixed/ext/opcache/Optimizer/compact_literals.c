# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c" 2


# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 1
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c" 2
# 56 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
...
# 80 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
                                       ...
                                       zend_op_array *op_array)
{
 ...
 if (zval_get_type(&(op_array->literals[constant])) == 6 &&
     op_type == (1<<3)) {
  do { info[constant].flags = (0x2000 | ((1) ? 0x1000 : 0) | ((kind) | ((slots) << 4) | (related))); info[constant].u.num = (uint32_t)-1; } while (0);
 } else {
  do { info[constant].flags = (((0) ? 0x1000 : 0) | ((kind) | ((slots) << 4) | (related))); } while (0);
 }
}
...
{
 if (op_type == (1<<0)) {
  do { info[constant].flags = (0x4000 | ((1) ? 0x1000 : 0) | ((kind) | ((slots) << 4) | (related))); info[constant].u.num = (op.constant); } while (0);
 } else {
  do { info[constant].flags = (((0) ? 0x1000 : 0) | ((kind) | ((slots) << 4) | (related))); } while (0);
 }
}
 ...
 if (op_array->last_literal) {
  ...
  while (opline < end) {
   switch (opline->opcode) {
    case 61:
     do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0200) | ((1) << 4) | (1))); } while (0);
     break;
    case 59:
     do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0200) | ((1) << 4) | (2))); } while (0);
     break;
    case 69:
     do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0200) | ((1) << 4) | (3))); } while (0);
     break;
    case 112:
    ...
    case 113:
     if ((opline)->op1_type == (1<<0)) {
      do { info[opline->op1.constant].flags = (((1) ? 0x1000 : 0) | ((0x0300) | ((1) << 4) | (2))); } while (0);
     }
     if ((opline)->op2_type == (1<<0)) {
      optimizer_literal_class_info(
       ...
       opline->op1,
       opline->op2.constant,
       0x0600, ((opline)->op1_type == (1<<0)) ? 1 : 2, 2,
       op_array);
     }
     break;
    case 107:
     ...
     break;
    case 122:
     do { info[opline->op1.constant].flags = (((1) ? 0x1000 : 0) | ((0x0400) | ((1) << 4) | (2))); } while (0);
     break;
    case 99:
     if ((opline->extended_value & (0x100|0x010)) == (0x100|0x010)) {
      do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0400) | ((1) << 4) | (5))); } while (0);
     } else {
      do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0400) | ((1) << 4) | (3))); } while (0);
     }
     break;
    case 181:
     if ((opline)->op1_type == (1<<0)) {
     ...
     optimizer_literal_class_info(
      ...
      opline->op1,
      opline->op2.constant,
      0x0500, ((opline)->op1_type == (1<<0)) ? 1 : 2, 1,
      op_array);
     break;
    case 173:
    case 174:
    ...
    case 180:
     if ((opline)->op2_type == (1<<0)) {
      do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0300) | ((1) << 4) | (2))); } while (0);
     }
     if ((opline)->op1_type == (1<<0)) {
      optimizer_literal_class_info(
       info,
    ...
    case 33:
     if ((opline)->op2_type == (1<<0)) {
      if (opline->extended_value == 136) {
       ...
       do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0100) | ((0) << 4) | (1))); } while (0);
      }
     }
     break;
    case 168:
     do { info[opline->op2.constant].flags = (((0) ? 0x1000 : 0) | ((0x0A00) | ((1) << 4) | (1))); } while (0);
     break;
    case 64:
     do { info[opline->op2.constant].flags = (((0) ? 0x1000 : 0) | ((0x0100) | ((0) << 4) | (1))); } while (0);
     if ((op_array->literals[opline->op2.constant]).u2.cache_slot != -1) {
      (op_array->literals[opline->op2.constant]).u2.cache_slot = cache_size;
    ...
    case 140:
    case 145:
     do { info[opline->op1.constant].flags = (((1) ? 0x1000 : 0) | ((0x0100) | ((0) << 4) | (2))); } while (0);
     break;
    case 63:
    case 164:
    case 124:
    ...
    default:
     if ((opline)->op1_type == (1<<0)) {
      do { info[opline->op1.constant].flags = (((1) ? 0x1000 : 0) | ((0x0100) | ((0) << 4) | (1))); } while (0);
     }
     if ((opline)->op2_type == (1<<0)) {
      do { info[opline->op2.constant].flags = (((1) ? 0x1000 : 0) | ((0x0100) | ((0) << 4) | (1))); } while (0);
     }
...
# 337 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
  j = 0;
  _zend_hash_init((&hash), (op_array->last_literal), (((void *)0)), (0) );
  map = (int*)zend_arena_alloc(&ctx->arena, op_array->last_literal * sizeof(int));
  memset(map, 0, op_array->last_literal * sizeof(int));
  for (i = 0; i < op_array->last_literal; i++) {
   if (!info[i].flags) {

    _zval_ptr_dtor_nogc((&op_array->literals[i]) );
    continue;
   }
   switch (zval_get_type(&(op_array->literals[i]))) {
    case 1:


     if ((info[i].flags & 0x1000)) {
      if (l_null < 0) {
       l_null = j;
       if (i != j) {
    ...
    case 3:
     ...
     break;
    case 4:
     if ((pos = zend_hash_index_find(&hash, (op_array->literals[i]).value.lval)) != ((void *)0)) {
      map[i] = (*(pos)).value.lval;
     } else {
      map[i] = j;
      { zval *__z = (&zv); (*(__z)).value.lval = j; (*(__z)).u1.type_info = 4; };
      _zend_hash_index_add_new(&hash, (op_array->literals[i]).value.lval, &zv );
      if (i != j) {
       op_array->literals[j] = op_array->literals[i];
       info[j] = info[i];
      }
     ...
     break;
    case 5:
     if ((pos = zend_hash_str_find(&hash, (char*)&(op_array->literals[i]).value.dval, sizeof(double))) != ((void *)0)) {
      map[i] = (*(pos)).value.lval;
     } else {
      map[i] = j;
      { zval *__z = (&zv); (*(__z)).value.lval = j; (*(__z)).u1.type_info = 4; };
      _zend_hash_str_add(&hash, (char*)&(op_array->literals[i]).value.dval, sizeof(double), &zv );
      if (i != j) {
       op_array->literals[j] = op_array->literals[i];
       info[j] = info[i];
      }
    ...
    case 11:
     if (info[i].flags & 0x1000) {
      if (info[i].flags & 0x2000) {
       int key_len = sizeof("$this->") - 1 + ((op_array->literals[i]).value.str)->len;
       key = zend_string_alloc(key_len, 0);
       memcpy((key)->val, "$this->", sizeof("$this->") - 1);
       memcpy((key)->val + sizeof("$this->") - 1, ((op_array->literals[i]).value.str)->val, ((op_array->literals[i]).value.str)->len + 1);
       (key)->len = key_len;
      } else if (info[i].flags & 0x4000) {
       int key_len;
       zval *class_name = &op_array->literals[(info[i].u.num < i) ? map[info[i].u.num] : info[i].u.num];
       key_len = ((*(class_name)).value.str)->len + sizeof("::") - 1 + ((op_array->literals[i]).value.str)->len;
       key = zend_string_alloc(key_len, 0);
       memcpy((key)->val, ((*(class_name)).value.str)->val, ((*(class_name)).value.str)->len);
       memcpy((key)->val + ((*(class_name)).value.str)->len, "::", sizeof("::") - 1);
       memcpy((key)->val + ((*(class_name)).value.str)->len + sizeof("::") - 1,
        ((op_array->literals[i]).value.str)->val,
        ((op_array->literals[i]).value.str)->len + 1);
      } else {
       key = zend_string_init(((op_array->literals[i]).value.str)->val, ((op_array->literals[i]).value.str)->len, 0);
      }
      (key)->h = zend_hash_func((key)->val, (key)->len);
      (key)->h += info[i].flags;
     }
     if ((info[i].flags & 0x1000) &&
      (pos = zend_hash_find(&hash, key)) != ((void *)0) &&
         zval_get_type(&(op_array->literals[i])) == zval_get_type(&(op_array->literals[(*(pos)).value.lval])) &&
      info[i].flags == info[(*(pos)).value.lval].flags) {

      zend_string_release(key);
      map[i] = (*(pos)).value.lval;
      _zval_ptr_dtor_nogc((&op_array->literals[i]) );
      n = (info[i].flags & 0x000f);
      while (n > 1) {
       i++;
       _zval_ptr_dtor_nogc((&op_array->literals[i]) );
       n--;
      ...
      if (info[i].flags & 0x1000) {
       { zval *__z = (&zv); (*(__z)).value.lval = j; (*(__z)).u1.type_info = 4; };
       _zend_hash_add_new(&hash, key, &zv );
       zend_string_release(key);
      }
      if (i != j) {
       op_array->literals[j] = op_array->literals[i];
      ...
      if (((info[i].flags & 0x00f0) >> 4)) {
       (op_array->literals[j]).u2.cache_slot = cache_size;
       cache_size += ((info[i].flags & 0x00f0) >> 4) * sizeof(void*);
      }
      j++;
      n = (info[i].flags & 0x000f);
      while (n > 1) {
...
# 530 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/compact_literals.c"
 }
}
