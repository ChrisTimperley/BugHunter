...
void zif_chr(zend_execute_data *execute_data, zval *return_value)
{
 ...
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } c = 0; } } while (0);
...
# 3769 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_stripcslashes(zend_string *str)
{
...
# 3960 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
void zif_parse_str(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (arrayArg == ((void *)0)) {
  ...
  if (__builtin_expect(!!(zend_hash_del(symbol_table, (compiler_globals.known_strings)[ZEND_STR_THIS]) == SUCCESS), 0)) {
...
# 4643 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
int php_tag_find(char *tag, size_t len, const char *set) {
 char c, *n, *t;
 int state=0, done=0;
 char *norm;
...
# 4724 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) size_t php_strip_tags_ex(char *rbuf, size_t len, int *stateptr, const char *allow, size_t allow_len, zend_bool allow_tag_spaces)
{
...
# 5269 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
void zif_substr_count(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (ac == 4) {
  ...
  if ((length <= 0) || (length > (haystack_len - offset))) {
   php_error_docref0(((void *)0), (1<<1L), "Invalid length value");
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
  endp = p + length;
 }
...
void zif_str_pad(zend_execute_data *execute_data, zval *return_value)
{
 ...
 result = zend_string_safe_alloc(1, (input)->len, num_pad_chars, 0);
 (result)->len = 0;
...
# 5522 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_str_word_count(zend_execute_data *execute_data, zval *return_value)
{
 zend_string *str;
