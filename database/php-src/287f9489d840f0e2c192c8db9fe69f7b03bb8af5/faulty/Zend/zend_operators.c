...
# 282 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_operators.c"
__attribute__ ((visibility("default"))) void convert_to_long(zval *op)
{
     ...
     if (obj_ht) {
      ...
      if (!((*(op)).value.obj->ce)->default_properties_count &&
       ...
       if (__builtin_expect(!!((*(op)).value.obj->handlers == &std_object_handlers), 1)) {
        do { zval *__z = (&arr); (*(__z)).value.arr = (obj_ht); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
        if (__builtin_expect(!!(!(((*(op)).value.obj->properties)->gc.u.v.flags & (1<<1))), 1)) {
         ((*(op)).value.obj->properties)->gc.refcount++;
        }
       } else {
        do { zval *__z = (&arr); (*(__z)).value.arr = (zend_array_dup(obj_ht)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
       }
       _zval_dtor((op) );
       do { zval *_z1 = (op); const zval *_z2 = (&arr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
      } else {
       do { zval *__z = (&arr); (*(__z)).value.arr = (zend_array_dup(obj_ht)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
       _zval_dtor((op) );
       do { zval *_z1 = (op); const zval *_z2 = (&arr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
try_again:
 switch (zval_get_type(&(*(op)))) {
  ...
  case 6:
   return strtoll((((*(op)).value.str)->val), (((void *)0)), (10));
  case 7:
  ...
  switch ((((zval_get_type(&(*(op1)))) << 4) | (zval_get_type(&(*(op2)))))) {
   ...
   default:
    if ((zval_get_type(&(*(op1))) == 10)) {
     ...
     if (op2==result) { if (zval_get_type(&(*(op2))) != 4) { convert_scalar_to_number(op2); } } else { switch (zval_get_type(&(*(op2)))) { case 6: { if (((op2_copy).u1.type_info=is_numeric_string(((*(op2)).value.str)->val, ((*(op2)).value.str)->len, &(op2_copy).value.lval, &(op2_copy).value.dval, 1)) == 0) { { zval *__z = (&(op2_copy)); (*(__z)).value.lval = 0; (*(__z)).u1.type_info = 4; }; } (op2) = &(op2_copy); break; } case 1: case 2: { zval *__z = (&(op2_copy)); (*(__z)).value.lval = 0; (*(__z)).u1.type_info = 4; }; (op2) = &(op2_copy); break; case 3: { zval *__z = (&(op2_copy)); (*(__z)).value.lval = 1; (*(__z)).u1.type_info = 4; }; (op2) = &(op2_copy); break; case 9: { zval *__z = (&(op2_copy)); (*(__z)).value.lval = (*op2).value.res->handle; (*(__z)).u1.type_info = 4; }; (op2) = &(op2_copy); break; case 8: do { zval *_z1 = (&(op2_copy)); const zval *_z2 = (op2); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0); convert_to_long_base(&(op2_copy), 10); if (zval_get_type(&(op2_copy)) == 4) { (op2) = &(op2_copy); } break; } };
     converted = 1;
    } else {
...
__attribute__ ((visibility("default"))) int shift_left_function(zval *result, zval *op1, zval *op2)
{
 ...
 do { if (__builtin_expect(!!(zval_get_type(&(*(op1))) != 4), 0)) { if ((zval_get_type(&(*(op1))) == 10)) { op1 = &(*(op1)).value.ref->val; if (zval_get_type(&(*(op1))) == 4) { op1_lval = (*(op1)).value.lval; break; } } if (__builtin_expect(!!(zval_get_type(&(*(op1))) == 8), 0) && op1 == result && __builtin_expect(!!(((*(op1))).value.obj->handlers->get), 0) && __builtin_expect(!!(((*(op1))).value.obj->handlers->set), 1)) { int ret; zval rv; zval *objval = ((*(op1))).value.obj->handlers->get(op1, &rv); do { if ((((*((objval))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((objval)); } } while (0); ret = shift_left_function(objval, objval, op2); ((*(op1))).value.obj->handlers->set(op1, objval); _zval_ptr_dtor((objval) ); return ret; } else if (__builtin_expect(!!(zval_get_type(&(*(op1))) == 8), 0) && __builtin_expect(!!(((*(op1))).value.obj->handlers->do_operation), 0)) { if (__builtin_expect(!!(SUCCESS == ((*(op1))).value.obj->handlers->do_operation(6, result, op1, op2)), 1)) { return SUCCESS; } }; op1_lval = _zval_get_long_func(op1); } else { op1_lval = (*(op1)).value.lval; } } while (0); do { if (__builtin_expect(!!(zval_get_type(&(*(op2))) != 4), 0)) { if ((zval_get_type(&(*(op2))) == 10)) { op2 = &(*(op2)).value.ref->val; if (zval_get_type(&(*(op2))) == 4) { op2_lval = (*(op2)).value.lval; break; } } if (__builtin_expect(!!(zval_get_type(&(*(op2))) == 8), 0) && __builtin_expect(!!(((*(op2))).value.obj->handlers->do_operation), 0) && __builtin_expect(!!(SUCCESS == ((*(op2))).value.obj->handlers->do_operation(6, result, op1, op2)), 1)) { return SUCCESS; }; op2_lval = _zval_get_long_func(op2); } else { op2_lval = (*(op2)).value.lval; } } while (0);;
...
__attribute__ ((visibility("default"))) int shift_right_function(zval *result, zval *op1, zval *op2)
{
 ...
 do { if (__builtin_expect(!!(zval_get_type(&(*(op1))) != 4), 0)) { if ((zval_get_type(&(*(op1))) == 10)) { op1 = &(*(op1)).value.ref->val; if (zval_get_type(&(*(op1))) == 4) { op1_lval = (*(op1)).value.lval; break; } } if (__builtin_expect(!!(zval_get_type(&(*(op1))) == 8), 0) && op1 == result && __builtin_expect(!!(((*(op1))).value.obj->handlers->get), 0) && __builtin_expect(!!(((*(op1))).value.obj->handlers->set), 1)) { int ret; zval rv; zval *objval = ((*(op1))).value.obj->handlers->get(op1, &rv); do { if ((((*((objval))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((objval)); } } while (0); ret = shift_right_function(objval, objval, op2); ((*(op1))).value.obj->handlers->set(op1, objval); _zval_ptr_dtor((objval) ); return ret; } else if (__builtin_expect(!!(zval_get_type(&(*(op1))) == 8), 0) && __builtin_expect(!!(((*(op1))).value.obj->handlers->do_operation), 0)) { if (__builtin_expect(!!(SUCCESS == ((*(op1))).value.obj->handlers->do_operation(7, result, op1, op2)), 1)) { return SUCCESS; } }; op1_lval = _zval_get_long_func(op1); } else { op1_lval = (*(op1)).value.lval; } } while (0); do { if (__builtin_expect(!!(zval_get_type(&(*(op2))) != 4), 0)) { if ((zval_get_type(&(*(op2))) == 10)) { op2 = &(*(op2)).value.ref->val; if (zval_get_type(&(*(op2))) == 4) { op2_lval = (*(op2)).value.lval; break; } } if (__builtin_expect(!!(zval_get_type(&(*(op2))) == 8), 0) && __builtin_expect(!!(((*(op2))).value.obj->handlers->do_operation), 0) && __builtin_expect(!!(SUCCESS == ((*(op2))).value.obj->handlers->do_operation(7, result, op1, op2)), 1)) { return SUCCESS; }; op2_lval = _zval_get_long_func(op2); } else { op2_lval = (*(op2)).value.lval; } } while (0);;
...
# 2414 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_operators.c"
__attribute__ ((visibility("default"))) char* zend_str_tolower_copy(char *dest, const char *source, size_t length)
{
...
# 2990 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_operators.c"
__attribute__ ((visibility("default"))) zend_long zend_dval_to_lval_slow(double d)
{
