...
# 48 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 154 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
static void print_hash(zend_write_func_t write_func, HashTable *ht, int indent, zend_bool is_object)
{
 ...
 write_func(("(\n"), strlen(("(\n")));
 indent += 4;
 do { Bucket *_p = (ht)->arData; Bucket *_end = _p + (ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; tmp = _z; {
  ...
  if (string_key) {
   ...
   char key[25];
   snprintf(key, sizeof(key), "%" "l" "d", num_key);
...
__attribute__ ((visibility("default"))) void zend_print_zval_r_ex(zend_write_func_t write_func, zval *expr, int indent)
{
 ...
 switch (zval_get_type(&(*(expr)))) {
  case 7:
   ...
   print_hash(write_func, (*(expr)).value.arr, indent, 0);
   if ((((*(expr)).value.arr)->u.flags & (1<<1))) {
    (*(expr)).value.arr->u.v.nApplyCount--;
   }
   break;
...
# 397 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 417 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 602 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 739 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
void zend_post_startup(void)
{
# 812 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 996 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
...
# 1037 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_error(int type, const char *format, ...)
...
# 1152 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
 ...
 if (zval_get_type(&((executor_globals.user_error_handler))) == 0
  ...
  case (1<<7L):
   ...
   break;
  default:
# 1183 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 1302 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_throw_error(zend_class_entry *exception_ce, const char *format, ...)
{
 va_list va;
 char *message = ((void *)0);
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_output_debug_string(zend_bool trigger_break, const char *format, ...)
{
# 1383 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
