...
# 678 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
__attribute__ ((visibility("default"))) zend_string *php_get_uname(char mode)
{
 char *php_uname;
 char tmp_uname[256];
# 740 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
 struct utsname buf;
...
# 768 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
  if (mode == 's') {
...
__attribute__ ((visibility("default"))) void php_print_info(int flag)
{
 ...
 if (flag & (1<<0)) {
  ...
  php_info_print_table_row(2, "Build Date", "Aug  6 2016" " " "16:34:36");
