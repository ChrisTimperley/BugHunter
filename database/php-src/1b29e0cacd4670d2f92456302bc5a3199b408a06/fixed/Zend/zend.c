# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c" 2
# 49 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) zend_class_entry *zend_standard_class_def = ((void *)0);
__attribute__ ((visibility("default"))) size_t (*zend_printf)(const char *format, ...);
__attribute__ ((visibility("default"))) zend_write_func_t zend_write;
__attribute__ ((visibility("default"))) FILE *(*zend_fopen)(const char *filename, zend_string **opened_path);
...
__attribute__ ((visibility("default"))) zend_string *(*zend_resolve_path)(const char *filename, int filename_len);
...
static int OnUpdateErrorReporting(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 if (!new_value) {
  ...
  (executor_globals.error_reporting) = atoi((new_value)->val);
 }
 return SUCCESS;
}


static int OnUpdateGCEnabled(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
...
static int OnUpdateScriptEncoding(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 ...
 return zend_multibyte_set_script_encoding_by_string(new_value ? (new_value)->val : ((void *)0), new_value ? (new_value)->len : 0);
}


static int OnUpdateAssertions(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 zend_long *p, val;
 ...
 if (stage != (1<<0) &&
     ...
     *p != val &&
     (*p < 0 || val < 0)) {
  zend_error((1<<1L), "zend.assertions may be completely enabled or disabled only in php.ini");
  return FAILURE;
 }
...
static const zend_ini_entry_def ini_entries[] = {
 { "error_reporting", OnUpdateErrorReporting, ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("error_reporting")-1, sizeof(((void *)0))-1 },
 { "zend.assertions", OnUpdateAssertions, (void *) ((zend_long) (((char *) (&(((zend_executor_globals*)((void *)0))->assertions))) - ((char *) ((void *)0)))), (void *) &executor_globals, ((void *)0), "1", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("zend.assertions")-1, sizeof("1")-1 },
 { "zend.enable_gc", OnUpdateGCEnabled, (void *) ((zend_long) (((char *) (&(((zend_gc_globals*)((void *)0))->gc_enabled))) - ((char *) ((void *)0)))), (void *) &gc_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("zend.enable_gc")-1, sizeof("1")-1 },
  { "zend.multibyte", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_compiler_globals*)((void *)0))->multibyte))) - ((char *) ((void *)0)))), (void *) &compiler_globals, ((void *)0), "0", zend_ini_boolean_displayer_cb, (1<<1), sizeof("zend.multibyte")-1, sizeof("0")-1 },
  { "zend.script_encoding", OnUpdateScriptEncoding, ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("zend.script_encoding")-1, sizeof(((void *)0))-1 },
  { "zend.detect_unicode", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_compiler_globals*)((void *)0))->detect_unicode))) - ((char *) ((void *)0)))), (void *) &compiler_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("zend.detect_unicode")-1, sizeof("1")-1 },



{ ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0, 0, 0} };
# 155 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
static void print_hash(smart_str *buf, HashTable *ht, int indent, zend_bool is_object)
{
 ...
 smart_str_appendl_ex(((buf)), (("(\n")), (strlen("(\n")), 0);
 indent += 4;
 do { Bucket *_p = (ht)->arData; Bucket *_end = _p + (ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; tmp = _z; {
  for (i = 0; i < indent; i++) {
   smart_str_appendc_ex((buf), (' '), 0);
  }
  smart_str_appendc_ex((buf), ('['), 0);
  if (string_key) {
   if (is_object) {
    ...
    smart_str_appendl_ex((buf), (prop_name), (prop_len), 0);
    if (class_name && mangled == SUCCESS) {
     if (class_name[0] == '*') {
      smart_str_appendl_ex(((buf)), ((":protected")), (strlen(":protected")), 0);
     } else {
      smart_str_appendl_ex(((buf)), ((":")), (strlen(":")), 0);
      smart_str_appendl_ex(((buf)), ((class_name)), (strlen(class_name)), 0);
      smart_str_appendl_ex(((buf)), ((":private")), (strlen(":private")), 0);
     }
    }
   } else {
   ...
   smart_str_append_long_ex((buf), (num_key), 0);
  }
  smart_str_appendl_ex(((buf)), (("] => ")), (strlen("] => ")), 0);
  zend_print_zval_r_to_buf(buf, tmp, indent+4);
  smart_str_appendl_ex(((buf)), (("\n")), (strlen("\n")), 0);
 } } } while (0);
 indent -= 4;
 for (i = 0; i < indent; i++) {
...
__attribute__ ((visibility("default"))) int zend_make_printable_zval(zval *expr, zval *expr_copy)
{
 if (zval_get_type(&(*(expr))) == 6) {
  ...
  do { zval *__z = (expr_copy); zend_string *__s = (_zval_get_string_func(expr)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
  return 1;
 }
}
...
__attribute__ ((visibility("default"))) void zend_print_flat_zval_r(zval *expr)
{
 switch (zval_get_type(&(*(expr)))) {
  case 7:
   ...
   if ((((*(expr)).value.arr)->u.flags & (1<<1)) &&
       ++(*(expr)).value.arr->u.v.nApplyCount>1) {
    zend_write((" *RECURSION*"), strlen((" *RECURSION*")));
    (*(expr)).value.arr->u.v.nApplyCount--;
    return;
   }
   print_flat_hash((*(expr)).value.arr);
   zend_write((")"), strlen((")")));
   if ((((*(expr)).value.arr)->u.flags & (1<<1))) {
    (*(expr)).value.arr->u.v.nApplyCount--;
   }
  ...
  case 8:
  {
   ...
   zend_string *class_name = ((*(expr))).value.obj->handlers->get_class_name((*(expr)).value.obj);
   zend_printf("%s Object (", (class_name)->val);
   zend_string_release(class_name);

   if ((((*(expr)).value.counted)->gc.u.v.flags & 0x07) > 0) {
    zend_write((" *RECURSION*"), strlen((" *RECURSION*")));
    return;
   }
   ...
   if (properties) {
    do { ((*(expr)).value.counted)->gc.u.v.flags = (((*(expr)).value.counted)->gc.u.v.flags & ~0x07) | ((((*(expr)).value.counted)->gc.u.v.flags & 0x07) + 1); } while (0);
...
static void zend_print_zval_r_to_buf(smart_str *buf, zval *expr, int indent)
{
 ...
 switch (zval_get_type(&(*(expr)))) {
  case 7:
   ...
   if ((((*(expr)).value.arr)->u.flags & (1<<1)) &&
       ++(*(expr)).value.arr->u.v.nApplyCount>1) {
    smart_str_appendl_ex(((buf)), ((" *RECURSION*")), (strlen(" *RECURSION*")), 0);
    (*(expr)).value.arr->u.v.nApplyCount--;
    return;
   }
   print_hash(buf, (*(expr)).value.arr, indent, 0);
   if ((((*(expr)).value.arr)->u.flags & (1<<1))) {
    (*(expr)).value.arr->u.v.nApplyCount--;
   }
   break;
  case 8:
   {
    ...
    zend_string *class_name = ((*(expr))).value.obj->handlers->get_class_name((*(expr)).value.obj);
    smart_str_appendl_ex(((buf)), (((class_name)->val)), (strlen((class_name)->val)), 0);
    zend_string_release(class_name);

    smart_str_appendl_ex(((buf)), ((" Object\n")), (strlen(" Object\n")), 0);
    if ((((*(expr)).value.counted)->gc.u.v.flags & 0x07) > 0) {
     smart_str_appendl_ex(((buf)), ((" *RECURSION*")), (strlen(" *RECURSION*")), 0);
     return;
    }
    ...
    if (is_temp) {
     ...
     do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(properties); } else if (sizeof(HashTable) <= 16) { _efree_16(properties); } else if (sizeof(HashTable) <= 24) { _efree_24(properties); } else if (sizeof(HashTable) <= 32) { _efree_32(properties); } else if (sizeof(HashTable) <= 40) { _efree_40(properties); } else if (sizeof(HashTable) <= 48) { _efree_48(properties); } else if (sizeof(HashTable) <= 56) { _efree_56(properties); } else if (sizeof(HashTable) <= 64) { _efree_64(properties); } else if (sizeof(HashTable) <= 80) { _efree_80(properties); } else if (sizeof(HashTable) <= 96) { _efree_96(properties); } else if (sizeof(HashTable) <= 112) { _efree_112(properties); } else if (sizeof(HashTable) <= 128) { _efree_128(properties); } else if (sizeof(HashTable) <= 160) { _efree_160(properties); } else if (sizeof(HashTable) <= 192) { _efree_192(properties); } else if (sizeof(HashTable) <= 224) { _efree_224(properties); } else if (sizeof(HashTable) <= 256) { _efree_256(properties); } else if (sizeof(HashTable) <= 320) { _efree_320(properties); } else if (sizeof(HashTable) <= 384) { _efree_384(properties); } else if (sizeof(HashTable) <= 448) { _efree_448(properties); } else if (sizeof(HashTable) <= 512) { _efree_512(properties); } else if (sizeof(HashTable) <= 640) { _efree_640(properties); } else if (sizeof(HashTable) <= 768) { _efree_768(properties); } else if (sizeof(HashTable) <= 896) { _efree_896(properties); } else if (sizeof(HashTable) <= 1024) { _efree_1024(properties); } else if (sizeof(HashTable) <= 1280) { _efree_1280(properties); } else if (sizeof(HashTable) <= 1536) { _efree_1536(properties); } else if (sizeof(HashTable) <= 1792) { _efree_1792(properties); } else if (sizeof(HashTable) <= 2048) { _efree_2048(properties); } else if (sizeof(HashTable) <= 2560) { _efree_2560(properties); } else if (sizeof(HashTable) <= 3072) { _efree_3072(properties); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(properties, sizeof(HashTable)); } else { _efree_huge(properties, sizeof(HashTable)); } } else { _efree(properties); } } while (0);
    }
    break;
   }
  case 4:
   smart_str_append_long_ex((buf), ((*(expr)).value.lval), 0);
   break;
  default:
   {
    zend_string *str = _zval_get_string((expr));
    smart_str_append_ex((buf), (str), 0);
    zend_string_release(str);
   }
   break;
 }
...
# 404 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 424 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
{
 memset(&(executor_globals.call_trampoline_op), 0, sizeof((executor_globals.call_trampoline_op)));
 (executor_globals.call_trampoline_op).opcode = 158;
 (executor_globals.call_trampoline_op).op1_type = (1<<3);
 (executor_globals.call_trampoline_op).op2_type = (1<<3);
 (executor_globals.call_trampoline_op).result_type = (1<<3);
 zend_vm_set_opcode_handler(&(executor_globals.call_trampoline_op));
}
...
# 609 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
int zend_startup(zend_utility_functions *utility_functions, char **extensions)
{
 ...
 zend_version_info = strdup("Zend Engine v" "3.1.0-dev" ", Copyright (c) 1998-2016 Zend Technologies\n");
 zend_version_info_length = sizeof("Zend Engine v" "3.1.0-dev" ", Copyright (c) 1998-2016 Zend Technologies\n") - 1;
...
# 746 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
void zend_post_startup(void)
{
# 819 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
void zend_shutdown(void)
{
 ...
 if ((executor_globals.active))
 {
  ...
  do { uint _idx; for (_idx = ((compiler_globals.function_table))->nNumUsed; _idx > 0; _idx--) { Bucket *_p = ((compiler_globals.function_table))->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; func = (*(_z)).value.ptr; {
   if (func->type == 2) {
    zend_cleanup_op_array_data((zend_op_array *) func);
   }
  } } } while (0);
  do { uint _idx; for (_idx = ((compiler_globals.class_table))->nNumUsed; _idx > 0; _idx--) { Bucket *_p = ((compiler_globals.class_table))->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; ce = (*(_z)).value.ptr; {
   if (ce->type == 2) {
  ...
  zend_hash_reverse_apply((compiler_globals.function_table), (apply_func_t) clean_non_persistent_function_full);
  zend_hash_reverse_apply((compiler_globals.class_table), (apply_func_t) clean_non_persistent_class_full);
 }
...
# 1003 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
...
# 1044 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_error(int type, const char *format, ...)
...
# 1159 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
 ...
 if (zval_get_type(&((executor_globals.user_error_handler))) == 0
  ...
  case (1<<7L):
   ...
   break;
  default:
# 1190 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
   __builtin_va_copy(usr_copy,args);
   len = (int)zend_vspprintf(&str, 0, format, usr_copy);
   do { zval *__z = (&params[1]); zend_string *__s = (zend_string_init(str, len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
   _efree((str) );
   ...
   if (error_filename) {
    do { const char *_s = (error_filename); do { do { zval *__z = (&params[2]); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
   } else {
   ...
   if (!symbol_table) {
    ...
    do { zval *__z = (&params[4]); (*(__z)).value.arr = (zend_array_dup(symbol_table)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
   }
   ...
   if (in_compilation) {
    ...
    (compiler_globals.active_class_entry) = ((void *)0);
    do { if ((compiler_globals.loop_var_stack).top) { memcpy(&loop_var_stack, &(compiler_globals.loop_var_stack), sizeof(zend_stack)); (compiler_globals.loop_var_stack).top = (compiler_globals.loop_var_stack).max = 0; (compiler_globals.loop_var_stack).elements = ((void *)0); } else { loop_var_stack.top = 0; } } while (0);
    do { if ((compiler_globals.delayed_oplines_stack).top) { memcpy(&delayed_oplines_stack, &(compiler_globals.delayed_oplines_stack), sizeof(zend_stack)); (compiler_globals.delayed_oplines_stack).top = (compiler_globals.delayed_oplines_stack).max = 0; (compiler_globals.delayed_oplines_stack).elements = ((void *)0); } else { delayed_oplines_stack.top = 0; } } while (0);
    (compiler_globals.in_compilation) = 0;
   }

   if (_call_user_function_ex(((void *)0), &orig_user_error_handler, &retval, 5, params, 1) == SUCCESS) {
   ...
   if (in_compilation) {
    ...
    do { if (loop_var_stack.top) { zend_stack_destroy(&(compiler_globals.loop_var_stack)); memcpy(&(compiler_globals.loop_var_stack), &loop_var_stack, sizeof(zend_stack)); } } while (0);
    do { if (delayed_oplines_stack.top) { zend_stack_destroy(&(compiler_globals.delayed_oplines_stack)); memcpy(&(compiler_globals.delayed_oplines_stack), &delayed_oplines_stack, sizeof(zend_stack)); } } while (0);
   ...
   if (zval_get_type(&((executor_globals.user_error_handler))) == 0) {
    do { zval *_z1 = (&(executor_globals.user_error_handler)); const zval *_z2 = (&orig_user_error_handler); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   } else {
...
__attribute__((cold)) void zend_error_noreturn(int type, const char *format, ...) __attribute__ ((alias("zend_error"),noreturn));
# 1309 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_throw_error(zend_class_entry *exception_ce, const char *format, ...)
{
 va_list va;
 char *message = ((void *)0);
 ...
 if (exception_ce) {
  if (!instanceof_function(exception_ce, zend_ce_error)) {
   zend_error((1<<3L), "Error exceptions must be derived from Error");
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_output_debug_string(zend_bool trigger_break, const char *format, ...)
{
# 1390 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
...
__attribute__ ((visibility("default"))) void zend_try_exception_handler()
{
 if ((executor_globals.exception)) {
  if (zval_get_type(&((executor_globals.user_exception_handler))) != 0) {
   ...
   (executor_globals.exception) = ((void *)0);
   do { zval *__z = (&params[0]); (*(__z)).value.obj = (old_exception); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
   do { zval *_z1 = (&orig_user_exception_handler); const zval *_z2 = (&(executor_globals.user_exception_handler)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);

   if (_call_user_function_ex(((void *)0), &orig_user_exception_handler, &retval2, 1, params, 1) == SUCCESS) {
    _zval_ptr_dtor((&retval2) );
    if ((executor_globals.exception)) {
     zend_object_release((executor_globals.exception));
     (executor_globals.exception) = ((void *)0);
    }
    zend_object_release(old_exception);
   } else {
...
__attribute__ ((visibility("default"))) int zend_execute_scripts(int type, zval *retval, int file_count, ...)
{
 ...
 for (i = 0; i < file_count; i++) {
  ...
  if (op_array) {
   ...
   do { if (__builtin_constant_p(sizeof(zend_op_array))) { if (sizeof(zend_op_array) <= 8) { _efree_8(op_array); } else if (sizeof(zend_op_array) <= 16) { _efree_16(op_array); } else if (sizeof(zend_op_array) <= 24) { _efree_24(op_array); } else if (sizeof(zend_op_array) <= 32) { _efree_32(op_array); } else if (sizeof(zend_op_array) <= 40) { _efree_40(op_array); } else if (sizeof(zend_op_array) <= 48) { _efree_48(op_array); } else if (sizeof(zend_op_array) <= 56) { _efree_56(op_array); } else if (sizeof(zend_op_array) <= 64) { _efree_64(op_array); } else if (sizeof(zend_op_array) <= 80) { _efree_80(op_array); } else if (sizeof(zend_op_array) <= 96) { _efree_96(op_array); } else if (sizeof(zend_op_array) <= 112) { _efree_112(op_array); } else if (sizeof(zend_op_array) <= 128) { _efree_128(op_array); } else if (sizeof(zend_op_array) <= 160) { _efree_160(op_array); } else if (sizeof(zend_op_array) <= 192) { _efree_192(op_array); } else if (sizeof(zend_op_array) <= 224) { _efree_224(op_array); } else if (sizeof(zend_op_array) <= 256) { _efree_256(op_array); } else if (sizeof(zend_op_array) <= 320) { _efree_320(op_array); } else if (sizeof(zend_op_array) <= 384) { _efree_384(op_array); } else if (sizeof(zend_op_array) <= 448) { _efree_448(op_array); } else if (sizeof(zend_op_array) <= 512) { _efree_512(op_array); } else if (sizeof(zend_op_array) <= 640) { _efree_640(op_array); } else if (sizeof(zend_op_array) <= 768) { _efree_768(op_array); } else if (sizeof(zend_op_array) <= 896) { _efree_896(op_array); } else if (sizeof(zend_op_array) <= 1024) { _efree_1024(op_array); } else if (sizeof(zend_op_array) <= 1280) { _efree_1280(op_array); } else if (sizeof(zend_op_array) <= 1536) { _efree_1536(op_array); } else if (sizeof(zend_op_array) <= 1792) { _efree_1792(op_array); } else if (sizeof(zend_op_array) <= 2048) { _efree_2048(op_array); } else if (sizeof(zend_op_array) <= 2560) { _efree_2560(op_array); } else if (sizeof(zend_op_array) <= 3072) { _efree_3072(op_array); } else if (sizeof(zend_op_array) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(op_array, sizeof(zend_op_array)); } else { _efree_huge(op_array, sizeof(zend_op_array)); } } else { _efree(op_array); } } while (0);
  } else if (type==(1<<3)) {
