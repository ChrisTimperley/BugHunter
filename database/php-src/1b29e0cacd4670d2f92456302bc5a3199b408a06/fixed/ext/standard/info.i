# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/css.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/css.h"
__attribute__ ((visibility("default"))) void php_info_print_css(void);
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 41 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
...
# 42 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c" 2
# 58 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
...
static int php_info_print_html_esc(const char *str, size_t len)
{
 ...
 new_str = php_escape_html_entities((unsigned char *) str, len, 0, (2 | 1), "utf-8");
...
static void php_info_print_stream_hash(const char *name, HashTable *ht)
{
 ...
 if (ht) {
  if ((ht)->nNumOfElements) {
   ...
   do { Bucket *_p = (ht)->arData; Bucket *_end = _p + (ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; {
    if (key) {
     if (first) {
      first = 0;
     } else {
...
static void php_print_gpcse_array(char *name, uint name_length)
{
 ...
 if ((data = zend_hash_find(&(executor_globals.symbol_table), key)) != ((void *)0) && (zval_get_type(&(*(data))) == 7)) {
  do { Bucket *_p = ((*(data)).value.arr)->arData; Bucket *_end = _p + ((*(data)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; tmp = _z; {
   if (!sapi_module.phpinfo_as_text) {
    php_info_print("<tr>");
   ...
   if (zval_get_type(&(*(tmp))) == 7) {
    if (!sapi_module.phpinfo_as_text) {
     ...
     php_info_print("<pre>");
     php_info_print_html_esc((str)->val, (str)->len);
     php_info_print("</pre>");
    ...
    do { zval *_z1 = (&tmp2); const zval *_z2 = (tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    if (zval_get_type(&(tmp2)) != 6) {
     tmp = ((void *)0);
     _zval_copy_ctor((&tmp2) );
     if (zval_get_type(&(*(&tmp2))) != 6) { _convert_to_string((&tmp2) ); };
    }
...
__attribute__ ((visibility("default"))) zend_string *php_info_html_esc(char *string)
{
 return php_escape_html_entities((unsigned char *) string, strlen(string), 0, (2 | 1), ((void *)0));
}
# 680 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
__attribute__ ((visibility("default"))) zend_string *php_get_uname(char mode)
{
 char *php_uname;
 char tmp_uname[256];
# 742 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
 struct utsname buf;
 if (uname((struct utsname *)&buf) == -1) {
  php_uname = "Linux wv7991 3.16.0-45-generic #60~14.04.1-Ubuntu SMP Fri Jul 24 21:16:23 UTC 2015 x86_64 x86_64 x86_64 GNU/Linux";
 } else {
# 770 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/info.c"
  if (mode == 's') {
...
__attribute__ ((visibility("default"))) void php_print_info(int flag)
{
 ...
 if (flag & (1<<0)) {
  ...
  if (!sapi_module.phpinfo_as_text) {
   ...
   php_info_print_table_row(2, "PHP Version", "7.1.0-dev");
  }
  php_info_print_box_end();
  php_info_print_table_start();
  php_info_print_table_row(2, "System", (php_uname)->val);
  php_info_print_table_row(2, "Build Date", "Aug  6 2016" " " "16:30:33");
  ...
  ap_php_snprintf(temp_api, sizeof(temp_api), "%d", 20151012);
  php_info_print_table_row(2, "PHP API", temp_api);

  ap_php_snprintf(temp_api, sizeof(temp_api), "%d", 20160303);
  php_info_print_table_row(2, "PHP Extension", temp_api);

  ap_php_snprintf(temp_api, sizeof(temp_api), "%d", 320160303);
  php_info_print_table_row(2, "Zend Extension", temp_api);

  php_info_print_table_row(2, "Zend Extension Build", "API" "320160303" ",NTS" );
  php_info_print_table_row(2, "PHP Extension Build", "API" "20160303" ",NTS" );
 ...
 if (flag & (1<<3)) {
  ...
  _zend_hash_init((&sorted_registry), ((&module_registry)->nNumOfElements), (((void *)0)), (1) );
 ...
 if (flag & (1<<5)) {
  ...
  php_info_print_table_start();
  php_info_print_table_header(2, "Variable", "Value");
  if ((data = zend_hash_str_find(&(executor_globals.symbol_table), "PHP_SELF", sizeof("PHP_SELF")-1)) != ((void *)0) && zval_get_type(&(*(data))) == 6) {
   php_info_print_table_row(2, "PHP_SELF", ((*(data)).value.str)->val);
  }
  if ((data = zend_hash_str_find(&(executor_globals.symbol_table), "PHP_AUTH_TYPE", sizeof("PHP_AUTH_TYPE")-1)) != ((void *)0) && zval_get_type(&(*(data))) == 6) {
   php_info_print_table_row(2, "PHP_AUTH_TYPE", ((*(data)).value.str)->val);
  }
  if ((data = zend_hash_str_find(&(executor_globals.symbol_table), "PHP_AUTH_USER", sizeof("PHP_AUTH_USER")-1)) != ((void *)0) && zval_get_type(&(*(data))) == 6) {
   php_info_print_table_row(2, "PHP_AUTH_USER", ((*(data)).value.str)->val);
  }
  if ((data = zend_hash_str_find(&(executor_globals.symbol_table), "PHP_AUTH_PW", sizeof("PHP_AUTH_PW")-1)) != ((void *)0) && zval_get_type(&(*(data))) == 6) {
...
void register_phpinfo_constants(int type, int module_number)
{
 zend_register_long_constant(("INFO_GENERAL"), sizeof("INFO_GENERAL")-1, ((1<<0)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_CREDITS"), sizeof("INFO_CREDITS")-1, ((1<<1)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_CONFIGURATION"), sizeof("INFO_CONFIGURATION")-1, ((1<<2)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_MODULES"), sizeof("INFO_MODULES")-1, ((1<<3)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_ENVIRONMENT"), sizeof("INFO_ENVIRONMENT")-1, ((1<<4)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_VARIABLES"), sizeof("INFO_VARIABLES")-1, ((1<<5)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_LICENSE"), sizeof("INFO_LICENSE")-1, ((1<<6)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("INFO_ALL"), sizeof("INFO_ALL")-1, (0xFFFFFFFF), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_GROUP"), sizeof("CREDITS_GROUP")-1, ((1<<0)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_GENERAL"), sizeof("CREDITS_GENERAL")-1, ((1<<1)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_SAPI"), sizeof("CREDITS_SAPI")-1, ((1<<2)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_MODULES"), sizeof("CREDITS_MODULES")-1, ((1<<3)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_DOCS"), sizeof("CREDITS_DOCS")-1, ((1<<4)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_FULLPAGE"), sizeof("CREDITS_FULLPAGE")-1, ((1<<5)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_QA"), sizeof("CREDITS_QA")-1, ((1<<6)), ((1<<1)|(1<<0)), module_number);
 zend_register_long_constant(("CREDITS_ALL"), sizeof("CREDITS_ALL")-1, (0xFFFFFFFF), ((1<<1)|(1<<0)), module_number);
}
...
void zif_phpinfo(zend_execute_data *execute_data, zval *return_value)
{
 zend_long flag = 0xFFFFFFFF;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|l", &flag) == FAILURE) {
  return;
 }
...
void zif_phpversion(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|s", &ext_name, &ext_name_len) == FAILURE) {
  return;
 }

 if (!ext_name) {
  { do { const char *_s = ("7.1.0-dev"); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 } else {
  const char *version;
  ...
  { do { const char *_s = (version); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 }
}
...
void zif_php_sapi_name(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (sapi_module.name) {
  { do { const char *_s = (sapi_module.name); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
...
void zif_php_uname(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|s", &mode, &modelen) == FAILURE) {
  return;
 }
 { do { zval *__z = (return_value); zend_string *__s = (php_get_uname(*mode)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
void zif_php_ini_scanned_files(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (strlen("") && php_ini_scanned_files) {
  { do { const char *_s = (php_ini_scanned_files); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
...
void zif_php_ini_loaded_file(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (php_ini_opened_path) {
  { do { const char *_s = (php_ini_opened_path); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
