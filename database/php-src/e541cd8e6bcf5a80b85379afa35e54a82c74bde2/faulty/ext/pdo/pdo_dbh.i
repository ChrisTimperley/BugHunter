...
__attribute__ ((visibility("default"))) void pdo_handle_error(pdo_dbh_t *dbh, pdo_stmt_t *stmt )
{
 ...
 if (dbh->methods->fetch_err) {
  ...
  if (dbh->methods->fetch_err(dbh, stmt, info )) {
   ...
   if (SUCCESS == zend_hash_index_find((*info).value.ht, 1, (void**)&item)) {
    native_code = (**item).value.lval;
   }

   if (SUCCESS == zend_hash_index_find((*info).value.ht, 2, (void**)&item)) {
...
static void zim_PDO_dbh_constructor(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (FAILURE == zend_parse_parameters((ht) , "s|s!s!a!", &data_source, &data_source_len,
 ...
 if (options) {
  ...
  if (SUCCESS == zend_hash_index_find((*options).value.ht, PDO_ATTR_PERSISTENT, (void**)&v)) {
   if ((**v).type == 6 && !is_numeric_string((**v).value.str.val, (**v).value.str.len, ((void *)0), ((void *)0), 0) && (**v).value.str.len > 0) {
    ...
    if ((**v).type != 1) {
     ...
     _zval_copy_ctor((&tmp) );
     convert_to_long(&tmp);
     is_persistent = (tmp).value.lval? 1 : 0;
    } else {
  ...
  if (is_persistent) {
   ...
   if (SUCCESS == zend_hash_find(&(executor_globals.persistent_list), hashkey, plen+1, (void*)&le)) {
 ...
 if (driver->db_handle_factory(dbh, options )) {
  ...
  if (is_persistent) {
   ...
   if (FAILURE == _zend_hash_add_or_update(&(executor_globals.persistent_list), (char*)dbh->persistent_id, dbh->persistent_id_len, (void*)&le, sizeof(le), ((void *)0), (1<<0) )
...
options:
  if (options) {
   ...
   while (SUCCESS == zend_hash_get_current_data_ex((*options).value.ht, (void**)&attr_value, ((void *)0))
...
static void zim_PDO_prepare(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (FAILURE == zend_parse_parameters((ht) , "s|a", &statement,
 ...
 if ((ht) > 1 && SUCCESS == zend_hash_index_find((*options).value.ht, PDO_ATTR_STATEMENT_CLASS, (void**)&opt)) {
  if ((**opt).type != 4 || zend_hash_index_find((**opt).value.ht, 0, (void**)&item) == FAILURE
   || (**item).type != 6
   || zend_lookup_class((**item).value.str.val, (**item).value.str.len, &pce ) == FAILURE
  ) {
  ...
  if (zend_hash_index_find((**opt).value.ht, 1, (void**)&item) == SUCCESS) {
   if ((**item).type != 4) {
    pdo_raise_impl_error(dbh, ((void *)0), "HY000",
...
static int pdo_dbh_attribute_set(pdo_dbh_t *dbh, long attr, zval *value )
{
# 714 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
 switch (attr) {
  case PDO_ATTR_ERRMODE:
   if ((*value).type != 1 && (*value).type != 6 && (*value).type != 3) { pdo_raise_impl_error(dbh, ((void *)0), "HY000", "attribute value must be an integer" ); if (strcmp(dbh->error_code, "00000")) { pdo_handle_error(dbh, ((void *)0) ); }; return FAILURE; };
  ...
  case PDO_ATTR_DEFAULT_FETCH_MODE:
   if ((*value).type == 4) {
    zval **tmp;
    if (zend_hash_index_find((*value).value.ht, 0, (void**)&tmp) == SUCCESS && (**tmp).type == 1) {
  ...
  case PDO_ATTR_STATEMENT_CLASS: {
   ...
   if ((*value).type != 4
    || zend_hash_index_find((*value).value.ht, 0, (void**)&item) == FAILURE
    || (**item).type != 6
    || zend_lookup_class((**item).value.str.val, (**item).value.str.len, &pce ) == FAILURE
   ) {
    pdo_raise_impl_error(dbh, ((void *)0), "HY000",
   ...
   if (zend_hash_index_find((*value).value.ht, 1, (void**)&item) == SUCCESS) {
    if ((**item).type != 4) {
     pdo_raise_impl_error(dbh, ((void *)0), "HY000",
      "PDO::ATTR_STATEMENT_CLASS requires format array(classname, array(ctor_args)); "
      "ctor_args must be an array"
...
static void zim_PDO_exec(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (FAILURE == zend_parse_parameters((ht) , "s", &statement, &statement_len)) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
static void zim_PDO_lastInsertId(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (FAILURE == zend_parse_parameters((ht) , "|s!", &name, &namelen)) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
static void zim_PDO_query(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (dbh->methods->preparer(dbh, statement, statement_len, stmt, ((void *)0) )) {
  ...
  if ((ht) == 1 || SUCCESS == pdo_stmt_setup_fetch_mode(ht, return_value, return_value_ptr, this_ptr, return_value_used , stmt, 1)) {
...
static void zim_PDO_quote(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (FAILURE == zend_parse_parameters((ht) , "s|l", &str, &str_len, &paramtype)) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
int pdo_hash_methods(pdo_dbh_t *dbh, int kind )
{
 ...
 _zend_hash_init_ex((dbh->cls_methods[kind]), (8), (((void *)0)), (dbh->is_persistent), (0) );
...
# 1506 "/home/ct584/git/bughunter/repositories/php-src/ext/pdo/pdo_dbh.c"
}
