...
static zend_persistent_script *opcache_compile_file(zend_file_handle *file_handle, int type, char *key, unsigned int key_length, zend_op_array **op_array_p)
{
 ...
 uint32_t orig_compiler_options = 0;
   ...
   *op_array_p = ((void *)0);
   if (type == (1<<3)) {
    ...
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1414);
   } else {
 ...
 if (!op_array) {
  ...
  if (do_bailout) {
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1499);
  }
  return ((void *)0);
 }
...
zend_op_array *file_cache_compile_file(zend_file_handle *file_handle, int type)
{
 ...
 if (!file_handle->opened_path) {
  if (file_handle->type == ZEND_HANDLE_FILENAME &&
   ...
   if (type == (1<<3)) {
    zend_message_dispatcher(2L, file_handle->filename);
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1557);
   } else {
    zend_message_dispatcher(1L, file_handle->filename);
   }
   return ((void *)0);
 ...
 if ((accel_globals.cache_persistent_script) &&
  ...
  if (!persistent_script) {
   ...
   zend_accel_hash_entry *bucket;
    ...
    if (type == (1<<3)) {
     zend_message_dispatcher(2L, file_handle->filename);
     _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1673);
    } else {
     zend_message_dispatcher(1L, file_handle->filename);
    }
    return ((void *)0);
...
# 1821 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
  if (persistent_script->full_path) {
   if (!(executor_globals.current_execute_data) || !(executor_globals.current_execute_data)->opline ||
       !(executor_globals.current_execute_data)->func ||
       !(((executor_globals.current_execute_data)->func->common.type & 1) == 0) ||
...
# 2100 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
...
static void accel_gen_system_id(void)
{
 ...
 PHP_MD5Init(&context);
 PHP_MD5Update(&context, "7.0.4-dev", sizeof("7.0.4-dev")-1);
 ...
 if (strstr("7.0.4-dev", "-dev") != 0) {

  PHP_MD5Update(&context, "Aug  7 2016", sizeof("Aug  7 2016")-1);
  PHP_MD5Update(&context, "17:36:26", sizeof("17:36:26")-1);
 }
...
# 2494 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c" 2
# 2505 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
...
# 2554 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
 }
...
# 2598 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
 ...
 if (!(accel_globals.accel_directives).file_cache_only) {
  ...
  switch (zend_shared_alloc_startup((accel_globals.accel_directives).memory_consumption)) {
   ...
   case 2:
    ...
    return SUCCESS;
    break;
# 2695 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
  }
...
# 2859 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
int accelerator_shm_read_lock(void)
{
 if ((accel_globals.counted)) {
