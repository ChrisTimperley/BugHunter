# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2


# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.h" 1
# 43 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_filestat.h" 1
# 46 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c" 2
...
# 147 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
...
static int spl_filesystem_file_open(spl_filesystem_object *intern, int use_include_path, int silent )
{
 ...
 do { zval *__z = (&intern->u.file.zresource); (*__z).value.lval = ((php_stream *)(intern->u.file.stream))->rsrc_id; (*__z).type = 7; } while (0);
...
# 333 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
 ...
 *is_temp = 1;
 ...
 _zend_hash_init((rv), (zend_hash_num_elements(intern->std.properties) + 3), ((void (*)(void *)) _zval_ptr_dtor), (0) );
...
void zim_spl_DirectoryIterator_current(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = ((this_ptr)); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
# 1129 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
...
# 1172 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
...
void zim_spl_GlobIterator_count(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->u.dir.dirp && ((intern->u.dir.dirp)->ops == &php_glob_stream_ops)) {
 ...
 if (type == 6) {
  ...
  case SPL_FS_FILE:
   if (readobj == writeobj) {
    ...
    _zval_dtor((readobj) );
    do { zval *__z = (writeobj); zval *__zv = (retval_ptr); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (0) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
   } else {
...
static const zend_arg_info arginfo_info___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "file_name", sizeof("file_name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_info_openFile[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "open_mode", sizeof("open_mode")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "use_include_path", sizeof("use_include_path")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "context", sizeof("context")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_info_optinalFileClass[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "class_name", sizeof("class_name")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_optinalSuffix[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "suffix", sizeof("suffix")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_splfileinfo_void[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_dir___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "path", sizeof("path")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_dir_it_seek[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
...
static const zend_arg_info arginfo_r_dir___construct[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "path", sizeof("path")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "flags", sizeof("flags")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_r_dir_hasChildren[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "allow_links", sizeof("allow_links")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_r_dir_setFlags[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "flags", sizeof("flags")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static int spl_filesystem_file_read(spl_filesystem_object *intern, int silent )
{
 ...
 if (intern->u.file.max_line_len > 0) {
  ...
  if (_php_stream_get_line((intern->u.file.stream), (buf), (intern->u.file.max_line_len + 1), (&line_len) ) == ((void *)0)) {
   _efree((buf) );
   buf = ((void *)0);
  } else {
   buf[line_len] = '\0';
...
static int spl_filesystem_file_call(spl_filesystem_object *intern, zend_function *func_ptr, int pass_num_args, zval *return_value, zval *arg2 )
{
 ...
 zval z_fname;
 zval * zresource_ptr = &intern->u.file.zresource, *retval = ((void *)0);
 int result;
 ...
 if (result == FAILURE || retval == ((void *)0)) {
  do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0);
 } else {
  do { zval *__z = (return_value); zval *__zv = (retval); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (1) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
 }

 _efree((params) );
 return result;
}
# 2160 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
static int spl_filesystem_file_read_csv(spl_filesystem_object *intern, char delimiter, char enclosure, char escape, zval *return_value )
{
 ...
 if (ret == SUCCESS) {
  ...
  if (return_value) {
   ...
   do { zval *__z = (return_value); zval *__zv = (intern->u.file.current_zval); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
  }
 }
 return ret;
}
 ...
 if (((intern->flags & 0x00000008) ? 1 : 0) || intern->u.file.func_getCurr->common.scope != spl_ce_SplFileObject) {
  ...
  if (retval) {
   ...
   if ((*retval).type == 6) {
    ...
    do { zval *__z = (intern->u.file.current_zval); zval *__zv = (retval); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
   }
   _zval_ptr_dtor((&retval) );
   return SUCCESS;
  } else {
...
void zim_spl_SplFileObject_current(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->u.file.current_line && (!((intern->flags & 0x00000008) ? 1 : 0) || !intern->u.file.current_zval)) {
  ...
  { do { zval *__z = (return_value); zval *__zv = (intern->u.file.current_zval); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
 { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
}
...
# 2605 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_directory.c"
...
void zim_spl_SplFileObject_fputcsv(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "a|sss", &fields, &delim, &d_len, &enclo, &e_len, &esc, &esc_len) == SUCCESS) {
  switch((ht))
  {
  case 4:
   if (esc_len != 1) {
...
void zim_spl_SplFileObject_ftell(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 ret = _php_stream_tell((intern->u.file.stream) );
...
void zim_spl_SplFileObject_fread(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (length > 2147483647) {
  php_error_docref0(((void *)0) , (1<<1L), "Length parameter must be no more than %d", 2147483647);
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
static const zend_arg_info arginfo_file_object___construct[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "file_name", sizeof("file_name")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "open_mode", sizeof("open_mode")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "use_include_path", sizeof("use_include_path")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "context", sizeof("context")-1, ((void *)0), 0, 0, 0, 0, 0 },
...
static const zend_arg_info arginfo_file_object_setFlags[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "flags", sizeof("flags")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_setMaxLineLen[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "max_len", sizeof("max_len")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_fgetcsv[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
...
static const zend_arg_info arginfo_file_object_fputcsv[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
...
static const zend_arg_info arginfo_file_object_flock[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "operation", sizeof("operation")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "wouldblock", sizeof("wouldblock")-1, ((void *)0), 0, 0, 1, 0, 0 },
};

static const zend_arg_info arginfo_file_object_fseek[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "pos", sizeof("pos")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "whence", sizeof("whence")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_fgetss[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "allowable_tags", sizeof("allowable_tags")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_fscanf[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "format", sizeof("format")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "vars", sizeof("vars")-1, ((void *)0), 0, 0, 1, 0, 1 },
};

static const zend_arg_info arginfo_file_object_fwrite[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "str", sizeof("str")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "length", sizeof("length")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_fread[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "length", sizeof("length")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_ftruncate[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "size", sizeof("size")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_file_object_seek[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "line_pos", sizeof("line_pos")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_temp_file_object___construct[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "max_memory", sizeof("max_memory")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
