...
# 80 "ext/opcache/Optimizer/zend_optimizer.h"
...
# 1 "ext/opcache/Optimizer/zend_ssa.h" 1
# 22 "ext/opcache/Optimizer/zend_ssa.h"
# 1 "ext/opcache/Optimizer/zend_cfg.h" 1
# 43 "ext/opcache/Optimizer/zend_cfg.h"
...
# 84 "ext/opcache/Optimizer/zend_cfg.h"
...
# 113 "ext/opcache/Optimizer/zend_cfg.h"
...
# 23 "ext/opcache/Optimizer/zend_ssa.h" 2
...
static inline __attribute__((always_inline)) int zend_ssa_next_use(zend_ssa_op *ssa_op, int var, int use)
{
 ssa_op += use;
...
static inline __attribute__((always_inline)) zend_ssa_phi* zend_ssa_next_use_phi(zend_ssa *ssa, int var, zend_ssa_phi *p)
{
 if (p->pi >= 0) {
...
# 49 "ext/opcache/Optimizer/zend_optimizer_internal.h"
...
# 79 "ext/opcache/Optimizer/zend_optimizer_internal.h"
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dump.h" 1
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dump.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_ssa.h" 1
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dump.h" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dfg.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dfg.h"
...
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dfg.h"


int zend_build_dfg(const zend_op_array *op_array, const zend_cfg *cfg, zend_dfg *dfg, uint32_t build_flags);


# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_dump.h" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
...
# 89 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
static void strip_leading_nops(zend_op_array *op_array, zend_basic_block *b)
{
 zend_op *opcodes = op_array->opcodes;

 while (opcodes[b->start].opcode == 0 && b->start < b->end) {
  b->start++;
 }
}
...
static void strip_nops(zend_op_array *op_array, zend_basic_block *b)
{
 ...
 i = j = b->start + 1;
 while (i <= b->end) {
  if (op_array->opcodes[i].opcode != 0) {
   if (i != j) {
 ...
 b->end = j - 1;
 while (j < i) {
  do { (op_array->opcodes + j)->op1.num = 0; (op_array->opcodes + j)->op2.num = 0; (op_array->opcodes + j)->result.num = 0; (op_array->opcodes + j)->opcode = 0; (op_array->opcodes + j)->op1_type = (1<<3); (op_array->opcodes + j)->op2_type = (1<<3); (op_array->opcodes + j)->result_type = (1<<3); } while (0);
  j++;
 }
}
...
static void zend_optimize_block(zend_basic_block *block, zend_op_array *op_array, zend_bitset used_ext, zend_cfg *cfg, zend_op **Tsource)
{
 ...
 while (opline < end) {
  ...
  if ((opline->op1_type & ((1<<1)|(1<<2))) &&
      opline->opcode != 70) {
   src = Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
   if (src &&
       src->opcode == 22 &&
       src->op1_type == (1<<0)) {
    ...
    if (zend_optimizer_update_op1_const(op_array, opline, &c)) {
     ...
     Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = ((void *)0);
     do { _zval_dtor((&(op_array)->literals[(src)->op1.constant]) ); do { (*(&(op_array)->literals[(src)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
     do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); } while (0);
    }
   }
  }
  ...
  if (opline->op2_type & ((1<<1)|(1<<2))) {
   src = Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
   if (src &&
       src->opcode == 22 &&
       src->op1_type == (1<<0)) {
    ...
    if (zend_optimizer_update_op2_const(op_array, opline, &c)) {
     ...
     Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = ((void *)0);
     do { _zval_dtor((&(op_array)->literals[(src)->op1.constant]) ); do { (*(&(op_array)->literals[(src)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
     do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); } while (0);
    }
   }
  ...
  if (opline->opcode == 40) {
   if (opline->op1_type & ((1<<1)|(1<<2))) {
    ...
    if (src &&
        src->opcode == 21 &&
        src->extended_value == 6) {

     Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = ((void *)0);
   ...
   if (opline->op1_type == (1<<0)) {
    if (last_op && last_op->opcode == 40 &&
     ...
     ((op_array)->literals[(opline)->op1.constant]).value.str = zend_new_interned_string(((op_array)->literals[(last_op)->op1.constant]).value.str);
     if (!((((op_array)->literals[(opline)->op1.constant]).u1.v.type_flags & (1<<2)) != 0)) {
      ((op_array)->literals[(opline)->op1.constant]).u1.v.type_flags &= ~ ((1<<2) | (1<<4));
     }
     do { (*(&(op_array)->literals[(last_op)->op1.constant])).u1.type_info = 1; } while (0);
     do { (last_op)->op1.num = 0; (last_op)->op2.num = 0; (last_op)->result.num = 0; (last_op)->opcode = 0; (last_op)->op1_type = (1<<3); (last_op)->op2_type = (1<<3); (last_op)->result_type = (1<<3); } while (0);
    }
    last_op = opline;
   } else {
    last_op = ((void *)0);
  ...
  switch (opline->opcode) {
   ...
   case 70:
    if (opline->op1_type == (1<<1)) {
     src = Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
     if (src &&
         (src->opcode == 52 || src->opcode == 13)) {
    ...
    break;
# 330 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
   case 98:
    if (opline->op1_type & ((1<<1)|(1<<2))) {
   ...
   optimize_bool:
    ...
    if (opline->op1_type == (1<<1) &&
        !zend_bitset_in(used_ext, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))))) {
     src = Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
     if (src) {
      switch (src->opcode) {
       case 13:
        ...
        Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = ((void *)0);
        do { opline->op1_type = src->op1_type; opline->op1 = src->op1; } while (0);
        opline->opcode = (opline->opcode == 52) ? 13 : 52;
        do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); } while (0);
        goto optimize_bool;
       case 52:
       ...
       case 17:
        ...
        Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(src->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = src;
        do { (opline)->op1.num = 0; (opline)->op2.num = 0; (opline)->result.num = 0; (opline)->opcode = 0; (opline)->op1_type = (1<<3); (opline)->op2_type = (1<<3); (opline)->result_type = (1<<3); } while (0);
        break;
       case 18:
        if (opline->opcode == 13) {
     ...
     if (src) {
      if (src->opcode == 13 &&
       ...
       if (opline->opcode == 43) {
        ...
        opline->opcode = 44;
       } else if (opline->opcode == 44) {

        opline->opcode = 43;
# 528 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
       } else {

        uint32_t tmp;

        do { if (__builtin_expect(!(opline->opcode == 45), 0)) __builtin_unreachable(); } while (0);
   ...
   case 53:
    ...
    if (opline->op2_type == (1<<0) &&
     ...
     src = Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
      ...
      ((op_array)->literals[(opline)->op2.constant]).value.str = zend_new_interned_string(((op_array)->literals[(src)->op2.constant]).value.str);
      if (!((((op_array)->literals[(opline)->op2.constant]).u1.v.type_flags & (1<<2)) != 0)) {
       ((op_array)->literals[(opline)->op2.constant]).u1.v.type_flags &= ~ ((1<<2) | (1<<4));
      }
    ...
    if (opline->op2_type & ((1<<1)|(1<<2))) {
     ...
     if (src &&
      ...
      zend_op *src = Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
      Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = ((void *)0);
    ...
    if (opline->op1_type == (1<<0) &&
     ...
     opline->op2.var = 0;
               ...
               (opline->op1_type == (1<<0) ||
                (opline->op1_type == (1<<1) &&
                 Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] &&
                 (Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 53 ||
                  Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 56 ||
                  Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 99 ||
                  Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 181))) &&
               (opline->op2_type == (1<<0) ||
                (opline->op2_type == (1<<1) &&
                 Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] &&
                 (Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 53 ||
                  Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 56 ||
                  Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 99 ||
                  Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))]->opcode == 181)))) {
     opline->opcode = 53;
    }
    break;
...
optimize_constant_binary_op:
     binary_op = get_binary_op(opline->opcode);
      ...
      Tsource[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = opline;
                  opline++;
      continue;
...
static void assemble_code_blocks(zend_cfg *cfg, zend_op_array *op_array)
{
 ...
 for (b = blocks; b < end; b++) {
  if (b->flags & (1<<31)) {
   do { if (__builtin_expect(!(b->start <= b->end), 0)) __builtin_unreachable(); } while (0);
   opline = op_array->opcodes + b->end;
   if (opline->opcode == 42) {
    zend_basic_block *next = b + 1;

    while (next < end && (!(next->flags & (1<<31)) || next->start > next->end)) {
     next++;
    }
   ...
   } else if (b->start == b->end && opline->opcode == 0) {
   ...
   for (op = op_array->opcodes + b->start; op <= end; op++) {
    if ((op)->op1_type == (1<<0)) {
     do { _zval_dtor((&(op_array)->literals[(op)->op1.constant]) ); do { (*(&(op_array)->literals[(op)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    }
    if ((op)->op2_type == (1<<0)) {
     do { _zval_dtor((&(op_array)->literals[(op)->op2.constant]) ); do { (*(&(op_array)->literals[(op)->op2.constant])).u1.type_info = 1; } while (0); } while (0);
    }
   }
  }
 }

 new_opcodes = (__builtin_constant_p((len * sizeof(zend_op)) ) ? (((len * sizeof(zend_op)) <= 8) ? _emalloc_8() : (((len * sizeof(zend_op)) <= 16) ? _emalloc_16() : (((len * sizeof(zend_op)) <= 24) ? _emalloc_24() : (((len * sizeof(zend_op)) <= 32) ? _emalloc_32() : (((len * sizeof(zend_op)) <= 40) ? _emalloc_40() : (((len * sizeof(zend_op)) <= 48) ? _emalloc_48() : (((len * sizeof(zend_op)) <= 56) ? _emalloc_56() : (((len * sizeof(zend_op)) <= 64) ? _emalloc_64() : (((len * sizeof(zend_op)) <= 80) ? _emalloc_80() : (((len * sizeof(zend_op)) <= 96) ? _emalloc_96() : (((len * sizeof(zend_op)) <= 112) ? _emalloc_112() : (((len * sizeof(zend_op)) <= 128) ? _emalloc_128() : (((len * sizeof(zend_op)) <= 160) ? _emalloc_160() : (((len * sizeof(zend_op)) <= 192) ? _emalloc_192() : (((len * sizeof(zend_op)) <= 224) ? _emalloc_224() : (((len * sizeof(zend_op)) <= 256) ? _emalloc_256() : (((len * sizeof(zend_op)) <= 320) ? _emalloc_320() : (((len * sizeof(zend_op)) <= 384) ? _emalloc_384() : (((len * sizeof(zend_op)) <= 448) ? _emalloc_448() : (((len * sizeof(zend_op)) <= 512) ? _emalloc_512() : (((len * sizeof(zend_op)) <= 640) ? _emalloc_640() : (((len * sizeof(zend_op)) <= 768) ? _emalloc_768() : (((len * sizeof(zend_op)) <= 896) ? _emalloc_896() : (((len * sizeof(zend_op)) <= 1024) ? _emalloc_1024() : (((len * sizeof(zend_op)) <= 1280) ? _emalloc_1280() : (((len * sizeof(zend_op)) <= 1536) ? _emalloc_1536() : (((len * sizeof(zend_op)) <= 1792) ? _emalloc_1792() : (((len * sizeof(zend_op)) <= 2048) ? _emalloc_2048() : (((len * sizeof(zend_op)) <= 2560) ? _emalloc_2560() : (((len * sizeof(zend_op)) <= 3072) ? _emalloc_3072() : (((len * sizeof(zend_op)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((len * sizeof(zend_op))) : _emalloc_huge((len * sizeof(zend_op)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((len * sizeof(zend_op)) ) );
 opline = new_opcodes;
 ...
 for (b = blocks; b < end; b++) {
  ...
  switch (opline->opcode) {
   case 162:
   case 42:
    do { (opline->op1).jmp_offset = ((char*)(new_opcodes + blocks[b->successors[0]].start) - (char*)(opline)); } while (0);
    break;
   case 45:
    opline->extended_value = ((char*)(new_opcodes + blocks[b->successors[1]].start) - (char*)(opline));
   ...
   case 169:
   case 151:
    do { (opline->op2).jmp_offset = ((char*)(new_opcodes + blocks[b->successors[0]].start) - (char*)(opline)); } while (0);
    break;
   case 107:
    if (!opline->result.var) {
     opline->extended_value = ((char*)(new_opcodes + blocks[b->successors[0]].start) - (char*)(opline));
    }
    break;
   case 171:
   case 172:
 ...
 if (op_array->last_try_catch) {
  ...
  map = (uint32_t *)((use_heap = (__builtin_expect(!!((sizeof(uint32_t) * op_array->last_try_catch) > ((32 * 1024))), 0))) ? (__builtin_constant_p((sizeof(uint32_t) * op_array->last_try_catch) ) ? (((sizeof(uint32_t) * op_array->last_try_catch) <= 8) ? _emalloc_8() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 16) ? _emalloc_16() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 24) ? _emalloc_24() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 32) ? _emalloc_32() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 40) ? _emalloc_40() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 48) ? _emalloc_48() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 56) ? _emalloc_56() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 64) ? _emalloc_64() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 80) ? _emalloc_80() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 96) ? _emalloc_96() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 112) ? _emalloc_112() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 128) ? _emalloc_128() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 160) ? _emalloc_160() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 192) ? _emalloc_192() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 224) ? _emalloc_224() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 256) ? _emalloc_256() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 320) ? _emalloc_320() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 384) ? _emalloc_384() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 448) ? _emalloc_448() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 512) ? _emalloc_512() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 640) ? _emalloc_640() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 768) ? _emalloc_768() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 896) ? _emalloc_896() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 1024) ? _emalloc_1024() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 1280) ? _emalloc_1280() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 1536) ? _emalloc_1536() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 1792) ? _emalloc_1792() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 2048) ? _emalloc_2048() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 2560) ? _emalloc_2560() : (((sizeof(uint32_t) * op_array->last_try_catch) <= 3072) ? _emalloc_3072() : (((sizeof(uint32_t) * op_array->last_try_catch) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(uint32_t) * op_array->last_try_catch)) : _emalloc_huge((sizeof(uint32_t) * op_array->last_try_catch))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(uint32_t) * op_array->last_try_catch) ) ) : __builtin_alloca (sizeof(uint32_t) * op_array->last_try_catch));
  for (i = 0, j = 0; i< op_array->last_try_catch; i++) {
   if (blocks[cfg->map[op_array->try_catch_array[i].try_op]].flags & (1<<31)) {
    map[i] = j;
  ...
  do { if (__builtin_expect(!!(use_heap), 0)) _efree((map) ); } while (0);
 }
 ...
 if (op_array->last_live_range) {
  ...
  map = (uint32_t *)((use_heap = (__builtin_expect(!!((sizeof(uint32_t) * op_array->last_live_range) > ((32 * 1024))), 0))) ? (__builtin_constant_p((sizeof(uint32_t) * op_array->last_live_range) ) ? (((sizeof(uint32_t) * op_array->last_live_range) <= 8) ? _emalloc_8() : (((sizeof(uint32_t) * op_array->last_live_range) <= 16) ? _emalloc_16() : (((sizeof(uint32_t) * op_array->last_live_range) <= 24) ? _emalloc_24() : (((sizeof(uint32_t) * op_array->last_live_range) <= 32) ? _emalloc_32() : (((sizeof(uint32_t) * op_array->last_live_range) <= 40) ? _emalloc_40() : (((sizeof(uint32_t) * op_array->last_live_range) <= 48) ? _emalloc_48() : (((sizeof(uint32_t) * op_array->last_live_range) <= 56) ? _emalloc_56() : (((sizeof(uint32_t) * op_array->last_live_range) <= 64) ? _emalloc_64() : (((sizeof(uint32_t) * op_array->last_live_range) <= 80) ? _emalloc_80() : (((sizeof(uint32_t) * op_array->last_live_range) <= 96) ? _emalloc_96() : (((sizeof(uint32_t) * op_array->last_live_range) <= 112) ? _emalloc_112() : (((sizeof(uint32_t) * op_array->last_live_range) <= 128) ? _emalloc_128() : (((sizeof(uint32_t) * op_array->last_live_range) <= 160) ? _emalloc_160() : (((sizeof(uint32_t) * op_array->last_live_range) <= 192) ? _emalloc_192() : (((sizeof(uint32_t) * op_array->last_live_range) <= 224) ? _emalloc_224() : (((sizeof(uint32_t) * op_array->last_live_range) <= 256) ? _emalloc_256() : (((sizeof(uint32_t) * op_array->last_live_range) <= 320) ? _emalloc_320() : (((sizeof(uint32_t) * op_array->last_live_range) <= 384) ? _emalloc_384() : (((sizeof(uint32_t) * op_array->last_live_range) <= 448) ? _emalloc_448() : (((sizeof(uint32_t) * op_array->last_live_range) <= 512) ? _emalloc_512() : (((sizeof(uint32_t) * op_array->last_live_range) <= 640) ? _emalloc_640() : (((sizeof(uint32_t) * op_array->last_live_range) <= 768) ? _emalloc_768() : (((sizeof(uint32_t) * op_array->last_live_range) <= 896) ? _emalloc_896() : (((sizeof(uint32_t) * op_array->last_live_range) <= 1024) ? _emalloc_1024() : (((sizeof(uint32_t) * op_array->last_live_range) <= 1280) ? _emalloc_1280() : (((sizeof(uint32_t) * op_array->last_live_range) <= 1536) ? _emalloc_1536() : (((sizeof(uint32_t) * op_array->last_live_range) <= 1792) ? _emalloc_1792() : (((sizeof(uint32_t) * op_array->last_live_range) <= 2048) ? _emalloc_2048() : (((sizeof(uint32_t) * op_array->last_live_range) <= 2560) ? _emalloc_2560() : (((sizeof(uint32_t) * op_array->last_live_range) <= 3072) ? _emalloc_3072() : (((sizeof(uint32_t) * op_array->last_live_range) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(uint32_t) * op_array->last_live_range)) : _emalloc_huge((sizeof(uint32_t) * op_array->last_live_range))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(uint32_t) * op_array->last_live_range) ) ) : __builtin_alloca (sizeof(uint32_t) * op_array->last_live_range));
  ...
  for (i = 0, j = 0; i < op_array->last_live_range; i++) {
   ...
   if (!(blocks[cfg->map[op_array->live_range[i].start]].flags & (1<<31))) {
    do { if (__builtin_expect(!(!(blocks[cfg->map[op_array->live_range[i].end]].flags & (1<<31))), 0)) __builtin_unreachable(); } while (0);
   } else {
  ...
  if (i != j) {
   ...
   while (opline != end) {
    if ((opline->opcode == 70 || opline->opcode == 127) &&
        opline->extended_value == (1<<0)) {
     do { if (__builtin_expect(!(opline->op2.num < (uint32_t) i), 0)) __builtin_unreachable(); } while (0);
     opline->op2.num = map[opline->op2.num];
    }
    opline++;
   }
...
static void zend_jmp_optimization(zend_basic_block *block, zend_op_array *op_array, zend_cfg *cfg, zend_uchar *same_t)
{
 ...
 do { if (__builtin_expect(!(block->start <= block->end), 0)) __builtin_unreachable(); } while (0);
  ...
  case 42:
   {
    ...
    while (next < cfg->blocks_count && !(blocks[next].flags & (1<<31))) {
    ...
    if (target->opcode == 42 &&
     ...
     !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {

     *last_op = *target;
     ;
     block->successors[0] = target_block->successors[0];
     ;
    } else if (target->opcode == 45 &&
               !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {
...
# 1116 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
    }
   }
   break;
  ...
  case 44:
   ...
   if (1) {
    ...
    uint32_t same_var = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((last_op->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    zend_op *target;
    zend_op *target_end;
    zend_basic_block *target_block = blocks + block->successors[0];
...
next_target:
    ...
    if (target == target_end) {
     ...
     goto next_target;
       ...
       same_var == ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) &&
       !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))
       ) {
     ;
   ...
   if (last_op->opcode == 43 || last_op->opcode == 44) {
    zend_op *target;
    zend_op *target_end;
    ...
    while (1) {
     ...
     if (target == target_end && !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {
      ;
  ...
  case 46:
   ...
   if (1) {
    ...
    same_t[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((last_op->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] |= (last_op)->op1_type;
    same_t[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((last_op->result).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] |= (last_op)->result_type;
...
next_target_ex:
    ...
    if (target == target_end) {
     ...
     goto next_target_ex;
         ...
         ((target)->op1_type & ((1<<1)|(1<<4))) &&
         (same_t[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] & (target)->op1_type) != 0 &&
         !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {

     ;
     block->successors[0] = target_block->successors[0];
     ;
    } else if (target->opcode == ((last_op->opcode) == 46 ? 44 : 43) &&
            ((target)->op1_type & ((1<<1)|(1<<4))) &&
         (same_t[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] & (target)->op1_type) != 0 &&
         !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {
     ...
     block->successors[0] = target_block->successors[1];
     ;
    } else if (target->opcode == ((last_op->opcode) == 46 ? 47 : 46) &&
            ((target)->op1_type & ((1<<1)|(1<<4))) &&
         (same_t[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] & (target)->op1_type) != 0 &&
         (same_t[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((target->result).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] & (target)->result_type) != 0 &&
         !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {
  ...
  case 45: {
   ...
   if (last_op->opcode == 45) {
    zend_uchar same_type = (last_op)->op1_type;
    zend_uchar same_var = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((last_op->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    zend_op *target;
    zend_op *target_end;
    zend_basic_block *target_block = blocks + block->successors[0];
...
next_target_znz:
    ...
    } else if ((target->opcode == 43 || target->opcode == 45) &&
         ((target)->op1_type & ((1<<1)|(1<<4))) &&
         same_type == (target)->op1_type &&
         same_var == ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) &&
         !(target_block->flags & ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) {
...
static void zend_t_usage(zend_cfg *cfg, zend_op_array *op_array, zend_bitset used_ext, zend_optimizer_ctx *ctx)
{
 ...
 for (n = 1; n < cfg->blocks_count; n++) {
  ...
  while (opline<end) {
   if (opline->op1_type & ((1<<2)|(1<<1))) {
    var_num = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    if (!zend_bitset_in(defined_here, var_num)) {
     zend_bitset_incl(used_ext, var_num);
    }
   }
   if (opline->op2_type == (1<<2)) {
    var_num = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    if (opline->opcode == 78 ||
        opline->opcode == 126) {
   ...
   if (opline->result_type == (1<<2)) {
    var_num = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    zend_bitset_incl(defined_here, var_num);
   } else if (opline->result_type == (1<<1)) {
    var_num = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    switch (opline->opcode) {
     case 72:
     case 55:
 ...
 for (n = cfg->blocks_count; n > 0;) {
  ...
  if (!next_block ||
      !(next_block->flags & (1<<1)) ||
      (next_block->flags & (1<<2))) {
  ...
  while (opline >= end) {
   ...
   if (opline->result_type == (1<<2)) {
    if (!zend_bitset_in(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))))) {
     switch (opline->opcode) {
      case 23:
      case 24:
      case 25:
     ...
     zend_bitset_excl(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))));
    }
   } else if (opline->result_type == (1<<1)) {
    if (!zend_bitset_in(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))))) {
     switch (opline->opcode) {
      ...
      case 72:
      case 55:
       zend_bitset_incl(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))));
       break;
     }
    } else {
     switch (opline->opcode) {
   ...
   if (opline->op2_type == (1<<2)) {
    switch (opline->opcode) {
     case 78:
     case 126:
      zend_bitset_excl(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))));
      break;
     default:
      zend_bitset_incl(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))));
      break;
    }
   } else if (opline->op2_type == (1<<1)) {
    zend_bitset_incl(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))));
   ...
   if (opline->op1_type & ((1<<2)|(1<<1))) {
    zend_bitset_incl(usage, ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))));
   }
...
static void zend_merge_blocks(zend_op_array *op_array, zend_cfg *cfg)
{
 ...
 zend_basic_block *prev = ((void *)0);

 for (i = 0; i < cfg->blocks_count; i++) {
  b = cfg->blocks + i;
  if (b->flags & (1<<31)) {
   if ((b->flags & (1<<1)) &&
       !(b->flags & ((1<<2) | ((1<<4)|(1<<5)|(1<<6)|(1<<7)|(1<<8)|(1<<9)|(1<<10)))) &&
       prev &&
       prev->successors[0] == i && prev->successors[1] == -1) {

    if (op_array->opcodes[prev->end].opcode == 42) {
     do { (op_array->opcodes + prev->end)->op1.num = 0; (op_array->opcodes + prev->end)->op2.num = 0; (op_array->opcodes + prev->end)->result.num = 0; (op_array->opcodes + prev->end)->opcode = 0; (op_array->opcodes + prev->end)->op1_type = (1<<3); (op_array->opcodes + prev->end)->op2_type = (1<<3); (op_array->opcodes + prev->end)->result_type = (1<<3); } while (0);
    }
    ...
    for (bb = prev + 1; bb != b; bb++) {
     ...
     while (op <= end) {
      ...
      do { (op)->op1.num = 0; (op)->op2.num = 0; (op)->result.num = 0; (op)->opcode = 0; (op)->op1_type = (1<<3); (op)->op2_type = (1<<3); (op)->result_type = (1<<3); } while (0);
      op++;
     }
...
void zend_optimize_cfg(zend_op_array *op_array, zend_optimizer_ctx *ctx)
{
 ...
 checkpoint = zend_arena_checkpoint(ctx->arena);
 if (zend_build_cfg(&ctx->arena, op_array, (1<<26), &cfg, ((void *)0)) != SUCCESS) {
  zend_arena_release(&ctx->arena, checkpoint);
  return;
 }

 if (ctx->debug_level & (1<<18)) {
  zend_dump_op_array(op_array, (1<<2), "before block pass", &cfg);
 }
 ...
 if (ctx->debug_level & (1<<19)) {
  zend_dump_op_array(op_array, (1<<2) | (1<<0), "after block pass", &cfg);
 }
