...
# 304 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/tar.c"
  ...
  _zend_hash_add_or_update(&myphar->manifest, entry.filename, entry.filename_len, (void*)&entry, sizeof(phar_entry_info), (void **) &newentry, (1<<0) );
  ;
...
# 1227 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/tar.c"
