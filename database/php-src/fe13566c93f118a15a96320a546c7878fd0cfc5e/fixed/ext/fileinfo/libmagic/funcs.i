# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
...
# 58 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
...
# 61 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c" 2


static const char rcsid[] __attribute__((__used__)) = "@(#)$File: funcs.c,v 1.61 2012/10/30 23:11:51 christos Exp $";


# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/magic.h" 1
# 84 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/magic.h"
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c" 2
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c" 2
# 53 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
extern void convert_libmagic_pattern(zval *pattern, int options);
    ...
    size_t lineno)
{
 ...
 if (lineno != 0) {
  _efree((ms->o.buf) );
  ms->o.buf = ((void *)0);
  file_printf(ms, "line %" "z" "u: ", lineno);
 }
...
{
 file_error(ms, (*__errno_location ()), "cannot allocate %" "z" "u bytes",
     len);
}
...
{
 file_error(ms, (*__errno_location ()), "error seeking");
}

 void
file_badread(struct magic_set *ms)
{
 file_error(ms, (*__errno_location ()), "error reading");
}
...
# 216 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
 ...
 if ((ms->flags & 0x040000) == 0) {
  int fd;
  ;
  if (stream && SUCCESS == _php_stream_cast((stream), (1), ((void **)&fd), (0) )) {
 ...
 if ((ms->flags & 0x004000) == 0)
  if ((m = file_softmagic(ms, ubuf, nb, 0, 0x20,
      looks_text)) != 0) {
   if ((ms->flags & 0x000001) != 0)
    (void)fprintf(stderr, "softmagic %d\n", m);
# 260 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
   goto done;
  }
...
# 335 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
 const char *
file_getbuffer(struct magic_set *ms)
{
 ...
 len = strlen(ms->o.buf);
 if (len > ((18446744073709551615UL) - 1) / 4) {
  return ((void *)0);
 }
 psize = len * 4 + 1;
 if ((ms->o.pbuf = (char *)(_erealloc((ms->o.pbuf), (psize), 0 ))) == ((void *)0)) {
  file_oomem(ms, psize);
  return ((void *)0);
 }
# 400 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/funcs.c"
 for (np = ms->o.pbuf, op = ms->o.buf; *op;) {
  if (((*__ctype_b_loc ())[(int) (((unsigned char)*op))] & (unsigned short int) _ISprint)) {
   *np++ = *op++;
  } else {
...
file_check_mem(struct magic_set *ms, unsigned int level)
{
 ...
 if (level >= ms->c.len) {
  ...
  ms->c.li = (struct level_info *)((ms->c.li == ((void *)0)) ? _emalloc((len) ) : _erealloc((ms->c.li), (len), 0 ))
...
file_replace(struct magic_set *ms, const char *pat, const char *rep)
{
 ...
 do { (patt) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(patt))->u.buffered = ((void *)0); } while (0); (patt)->refcount__gc = 1; (patt)->is_ref__gc = 0;;;
 do { const char *__s=(pat); int __l=strlen(pat); zval *__z = (patt); (*__z).value.str.len = __l; (*__z).value.str.val = (0?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0);
 opts |= 0x00000002;
 convert_libmagic_pattern(patt, opts);
 if ((pce = pcre_get_compiled_regex_cache((*patt).value.str.val, (*patt).value.str.len )) == ((void *)0)) {
  _zval_dtor((patt) );
  do { if (((gc_root_buffer*)(((zend_uintptr_t)(((zval_gc_info*)patt)->u.buffered)) & ~0x03))) { gc_remove_zval_from_buffer(patt ); }; _efree((patt) ); } while (0);
  return -1;
 }

 do { (repl) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(repl))->u.buffered = ((void *)0); } while (0); (repl)->refcount__gc = 1; (repl)->is_ref__gc = 0;;;
 do { const char *__s=(rep); int __l=strlen(rep); zval *__z = (repl); (*__z).value.str.len = __l; (*__z).value.str.val = (0?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0);

 res = php_pcre_replace_impl(pce, ms->o.buf, strlen(ms->o.buf), repl,
   0, &res_len, -1, &rep_cnt );

 do { if (((gc_root_buffer*)(((zend_uintptr_t)(((zval_gc_info*)repl)->u.buffered)) & ~0x03))) { gc_remove_zval_from_buffer(repl ); }; _efree((repl) ); } while (0);
 _zval_dtor((patt) );
 do { if (((gc_root_buffer*)(((zend_uintptr_t)(((zval_gc_info*)patt)->u.buffered)) & ~0x03))) { gc_remove_zval_from_buffer(patt ); }; _efree((patt) ); } while (0);
