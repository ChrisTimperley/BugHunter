...
static php_process_env_t _php_array_to_envp(zval *environment, int is_persistent)
{
 ...
 target_hash = (*(environment)).value.arr;
 if (!target_hash) {
  return env;
 }


 do { Bucket *_p = (target_hash)->arData; Bucket *_end = _p + (target_hash)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; string_key = _p->key; element = _z; {
  zend_string *str = _zval_get_string((element));
...
# 224 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 281 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 349 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 (*__errno_location ()) = 0;
...
# 414 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 458 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 php_process_id_t child;
 struct php_process_handle *proc;
 int is_persistent = 0;
# 471 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 504 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 527 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 555 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 653 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
    descriptors[ndesc].childend = fd;

   } else if (strcmp(((*(ztype)).value.str)->val, "pty") == 0) {
# 678 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 813 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 child = fork();

 if (child == 0) {
# 837 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
  for (i = 0; i < ndesc; i++) {
...
# 856 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
  if (cwd) {
 ...
 _array_init((pipes), 0 );
# 913 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 for (i = 0; i < ndesc; i++) {
...
# 930 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
     case 01:
      mode_string = "w";
      break;
     case 00:
...
# 985 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
