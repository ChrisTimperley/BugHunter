# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_network.h" 1
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
# 46 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
# 55 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 56 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
# 71 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.h"
...
# 72 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c" 2
...
static php_process_env_t _php_array_to_envp(zval *environment, int is_persistent)
{
 ...
 do { Bucket *_p = (env_hash)->arData; Bucket *_end = _p + (env_hash)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; str = (*(_z)).value.ptr; {
  if (key) {
   l = (key)->len + (str)->len + 2;
 ...
 do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(env_hash); } else if (sizeof(HashTable) <= 16) { _efree_16(env_hash); } else if (sizeof(HashTable) <= 24) { _efree_24(env_hash); } else if (sizeof(HashTable) <= 32) { _efree_32(env_hash); } else if (sizeof(HashTable) <= 40) { _efree_40(env_hash); } else if (sizeof(HashTable) <= 48) { _efree_48(env_hash); } else if (sizeof(HashTable) <= 56) { _efree_56(env_hash); } else if (sizeof(HashTable) <= 64) { _efree_64(env_hash); } else if (sizeof(HashTable) <= 80) { _efree_80(env_hash); } else if (sizeof(HashTable) <= 96) { _efree_96(env_hash); } else if (sizeof(HashTable) <= 112) { _efree_112(env_hash); } else if (sizeof(HashTable) <= 128) { _efree_128(env_hash); } else if (sizeof(HashTable) <= 160) { _efree_160(env_hash); } else if (sizeof(HashTable) <= 192) { _efree_192(env_hash); } else if (sizeof(HashTable) <= 224) { _efree_224(env_hash); } else if (sizeof(HashTable) <= 256) { _efree_256(env_hash); } else if (sizeof(HashTable) <= 320) { _efree_320(env_hash); } else if (sizeof(HashTable) <= 384) { _efree_384(env_hash); } else if (sizeof(HashTable) <= 448) { _efree_448(env_hash); } else if (sizeof(HashTable) <= 512) { _efree_512(env_hash); } else if (sizeof(HashTable) <= 640) { _efree_640(env_hash); } else if (sizeof(HashTable) <= 768) { _efree_768(env_hash); } else if (sizeof(HashTable) <= 896) { _efree_896(env_hash); } else if (sizeof(HashTable) <= 1024) { _efree_1024(env_hash); } else if (sizeof(HashTable) <= 1280) { _efree_1280(env_hash); } else if (sizeof(HashTable) <= 1536) { _efree_1536(env_hash); } else if (sizeof(HashTable) <= 1792) { _efree_1792(env_hash); } else if (sizeof(HashTable) <= 2048) { _efree_2048(env_hash); } else if (sizeof(HashTable) <= 2560) { _efree_2560(env_hash); } else if (sizeof(HashTable) <= 3072) { _efree_3072(env_hash); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(env_hash, sizeof(HashTable)); } else { _efree_huge(env_hash, sizeof(HashTable)); } } else { _efree(env_hash); } } while (0);
...
static void proc_open_rsrc_dtor(zend_resource *rsrc)
{
 ...
 for (i = 0; i < proc->npipes; i++) {
  if (proc->pipes[i] != 0) {
   (proc->pipes[i])->gc.refcount--;
   zend_list_close(proc->pipes[i]);
   proc->pipes[i] = 0;
  }
 }
# 213 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 if (!(file_globals.pclose_wait)) {
  waitpid_options = 1;
 }
 do {
 ...
 ((proc->is_persistent)?free(proc->pipes):_efree((proc->pipes) ));
...
void zif_proc_terminate(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "r|l", &zproc, &sig_no) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if ((proc = (struct php_process_handle *)zend_fetch_resource((*zproc).value.res, "process", le_proc_open)) == ((void *)0)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
# 270 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
void zif_proc_close(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "r", &zproc) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 zend_list_close((*zproc).value.res);
...
void zif_proc_get_status(zend_execute_data *execute_data, zval *return_value)
{
 ...
 add_assoc_string_ex(return_value, "command", strlen("command"), proc->command);
 add_assoc_long_ex(return_value, "pid", strlen("pid"), (zend_long) proc->child);
# 338 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 (*__errno_location ()) = 0;
 ...
 add_assoc_bool_ex(return_value, "running", strlen("running"), running);
 add_assoc_bool_ex(return_value, "signaled", strlen("signaled"), signaled);
 add_assoc_bool_ex(return_value, "stopped", strlen("stopped"), stopped);
 add_assoc_long_ex(return_value, "exitcode", strlen("exitcode"), exitcode);
 add_assoc_long_ex(return_value, "termsig", strlen("termsig"), termsig);
 add_assoc_long_ex(return_value, "stopsig", strlen("stopsig"), stopsig);
}
# 403 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
void zif_proc_open(zend_execute_data *execute_data, zval *return_value)
{
 ...
 zend_ulong nindex;
 struct php_proc_open_descriptor_item *descriptors = ((void *)0);
 int ndescriptors_array;
# 447 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 php_process_id_t child;
 struct php_process_handle *proc;
 int is_persistent = 0;
# 460 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "saz/|s!a!a!", &command,
    &command_len, &descriptorspec, &pipes, &cwd, &cwd_len, &environment,
    &other_options) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 command = ((is_persistent)?strdup(command):_estrdup((command) ));
# 493 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 ...
 descriptors = _safe_emalloc((sizeof(struct php_proc_open_descriptor_item)), (ndescriptors_array), (0) );

 memset(descriptors, 0, sizeof(struct php_proc_open_descriptor_item) * ndescriptors_array);
# 516 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 do { Bucket *_p = ((*(descriptorspec)).value.arr)->arData; Bucket *_end = _p + ((*(descriptorspec)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; nindex = _p->h; str_index = _p->key; descitem = _z; {
  zval *ztype;
  ...
  if (zval_get_type(&(*(descitem))) == 9) {

   php_stream *stream;
   php_socket_t fd;

   do { if (((stream) = (php_stream*)zend_fetch_resource2_ex((descitem), "stream", php_file_le_stream(), php_file_le_pstream())) == ((void *)0)) { { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);

   if (FAILURE == _php_stream_cast((stream), (1), ((void **)&fd), (0x00000008))) {
    goto exit_fail;
   }
# 544 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
   descriptors[ndesc].childend = dup(fd);
   if (descriptors[ndesc].childend < 0) {
    php_error_docref0(((void *)0), (1<<1L), "unable to dup File-Handle for descriptor %pd - %s", nindex, strerror((*__errno_location ())));
    goto exit_fail;
   }

   descriptors[ndesc].mode = 2;

  } else if (zval_get_type(&(*(descitem))) != 7) {
   php_error_docref0(((void *)0), (1<<1L), "Descriptor item must be either an array or a File-Handle");
   goto exit_fail;
  } else {

   if ((ztype = zend_hash_index_find((*(descitem)).value.arr, 0)) != ((void *)0)) {
    if (zval_get_type(&(*(ztype)))!=6) { if (zval_get_type(&(*(ztype))) != 6) { _convert_to_string((ztype) ); }; };
   } else {
   ...
   if (strcmp(((*(ztype)).value.str)->val, "pipe") == 0) {
    ...
    if ((zmode = zend_hash_index_find((*(descitem)).value.arr, 1)) != ((void *)0)) {
     if (zval_get_type(&(*(zmode)))!=6) { if (zval_get_type(&(*(zmode))) != 6) { _convert_to_string((zmode) ); }; };
    } else {
    ...
    if ((zfile = zend_hash_index_find((*(descitem)).value.arr, 1)) != ((void *)0)) {
     if (zval_get_type(&(*(zfile)))!=6) { if (zval_get_type(&(*(zfile))) != 6) { _convert_to_string((zfile) ); }; };
    } else {
     php_error_docref0(((void *)0), (1<<1L), "Missing file name parameter for 'file'");
     goto exit_fail;
    }

    if ((zmode = zend_hash_index_find((*(descitem)).value.arr, 2)) != ((void *)0)) {
     if (zval_get_type(&(*(zmode)))!=6) { if (zval_get_type(&(*(zmode))) != 6) { _convert_to_string((zmode) ); }; };
    } else {
    ...
    if (stream == ((void *)0) || FAILURE == _php_stream_cast((stream), (0x40000000|1), ((void **)&fd), (0x00000008))

                                   ) {
     goto exit_fail;
    }
# 642 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
    descriptors[ndesc].childend = fd;

   } else if (strcmp(((*(ztype)).value.str)->val, "pty") == 0) {
# 667 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
...
# 802 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 child = fork();

 if (child == 0) {
# 826 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
  for (i = 0; i < ndesc; i++) {
...
# 845 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
  if (cwd) {
 ...
 proc = (struct php_process_handle*)((is_persistent)?__zend_malloc(sizeof(struct php_process_handle)):(__builtin_constant_p((sizeof(struct php_process_handle)) ) ? (((sizeof(struct php_process_handle)) <= 8) ? _emalloc_8() : (((sizeof(struct php_process_handle)) <= 16) ? _emalloc_16() : (((sizeof(struct php_process_handle)) <= 24) ? _emalloc_24() : (((sizeof(struct php_process_handle)) <= 32) ? _emalloc_32() : (((sizeof(struct php_process_handle)) <= 40) ? _emalloc_40() : (((sizeof(struct php_process_handle)) <= 48) ? _emalloc_48() : (((sizeof(struct php_process_handle)) <= 56) ? _emalloc_56() : (((sizeof(struct php_process_handle)) <= 64) ? _emalloc_64() : (((sizeof(struct php_process_handle)) <= 80) ? _emalloc_80() : (((sizeof(struct php_process_handle)) <= 96) ? _emalloc_96() : (((sizeof(struct php_process_handle)) <= 112) ? _emalloc_112() : (((sizeof(struct php_process_handle)) <= 128) ? _emalloc_128() : (((sizeof(struct php_process_handle)) <= 160) ? _emalloc_160() : (((sizeof(struct php_process_handle)) <= 192) ? _emalloc_192() : (((sizeof(struct php_process_handle)) <= 224) ? _emalloc_224() : (((sizeof(struct php_process_handle)) <= 256) ? _emalloc_256() : (((sizeof(struct php_process_handle)) <= 320) ? _emalloc_320() : (((sizeof(struct php_process_handle)) <= 384) ? _emalloc_384() : (((sizeof(struct php_process_handle)) <= 448) ? _emalloc_448() : (((sizeof(struct php_process_handle)) <= 512) ? _emalloc_512() : (((sizeof(struct php_process_handle)) <= 640) ? _emalloc_640() : (((sizeof(struct php_process_handle)) <= 768) ? _emalloc_768() : (((sizeof(struct php_process_handle)) <= 896) ? _emalloc_896() : (((sizeof(struct php_process_handle)) <= 1024) ? _emalloc_1024() : (((sizeof(struct php_process_handle)) <= 1280) ? _emalloc_1280() : (((sizeof(struct php_process_handle)) <= 1536) ? _emalloc_1536() : (((sizeof(struct php_process_handle)) <= 1792) ? _emalloc_1792() : (((sizeof(struct php_process_handle)) <= 2048) ? _emalloc_2048() : (((sizeof(struct php_process_handle)) <= 2560) ? _emalloc_2560() : (((sizeof(struct php_process_handle)) <= 3072) ? _emalloc_3072() : (((sizeof(struct php_process_handle)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(struct php_process_handle))) : _emalloc_huge((sizeof(struct php_process_handle)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(struct php_process_handle)) ) ));
 proc->is_persistent = is_persistent;
 proc->command = command;
 proc->pipes = ((is_persistent)?__zend_malloc(sizeof(zend_resource *) * ndesc):(__builtin_constant_p((sizeof(zend_resource *) * ndesc) ) ? (((sizeof(zend_resource *) * ndesc) <= 8) ? _emalloc_8() : (((sizeof(zend_resource *) * ndesc) <= 16) ? _emalloc_16() : (((sizeof(zend_resource *) * ndesc) <= 24) ? _emalloc_24() : (((sizeof(zend_resource *) * ndesc) <= 32) ? _emalloc_32() : (((sizeof(zend_resource *) * ndesc) <= 40) ? _emalloc_40() : (((sizeof(zend_resource *) * ndesc) <= 48) ? _emalloc_48() : (((sizeof(zend_resource *) * ndesc) <= 56) ? _emalloc_56() : (((sizeof(zend_resource *) * ndesc) <= 64) ? _emalloc_64() : (((sizeof(zend_resource *) * ndesc) <= 80) ? _emalloc_80() : (((sizeof(zend_resource *) * ndesc) <= 96) ? _emalloc_96() : (((sizeof(zend_resource *) * ndesc) <= 112) ? _emalloc_112() : (((sizeof(zend_resource *) * ndesc) <= 128) ? _emalloc_128() : (((sizeof(zend_resource *) * ndesc) <= 160) ? _emalloc_160() : (((sizeof(zend_resource *) * ndesc) <= 192) ? _emalloc_192() : (((sizeof(zend_resource *) * ndesc) <= 224) ? _emalloc_224() : (((sizeof(zend_resource *) * ndesc) <= 256) ? _emalloc_256() : (((sizeof(zend_resource *) * ndesc) <= 320) ? _emalloc_320() : (((sizeof(zend_resource *) * ndesc) <= 384) ? _emalloc_384() : (((sizeof(zend_resource *) * ndesc) <= 448) ? _emalloc_448() : (((sizeof(zend_resource *) * ndesc) <= 512) ? _emalloc_512() : (((sizeof(zend_resource *) * ndesc) <= 640) ? _emalloc_640() : (((sizeof(zend_resource *) * ndesc) <= 768) ? _emalloc_768() : (((sizeof(zend_resource *) * ndesc) <= 896) ? _emalloc_896() : (((sizeof(zend_resource *) * ndesc) <= 1024) ? _emalloc_1024() : (((sizeof(zend_resource *) * ndesc) <= 1280) ? _emalloc_1280() : (((sizeof(zend_resource *) * ndesc) <= 1536) ? _emalloc_1536() : (((sizeof(zend_resource *) * ndesc) <= 1792) ? _emalloc_1792() : (((sizeof(zend_resource *) * ndesc) <= 2048) ? _emalloc_2048() : (((sizeof(zend_resource *) * ndesc) <= 2560) ? _emalloc_2560() : (((sizeof(zend_resource *) * ndesc) <= 3072) ? _emalloc_3072() : (((sizeof(zend_resource *) * ndesc) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_resource *) * ndesc)) : _emalloc_huge((sizeof(zend_resource *) * ndesc))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_resource *) * ndesc) ) ));
 proc->npipes = ndesc;
 proc->child = child;
 ...
 _array_init((pipes), 0 );
# 902 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 for (i = 0; i < ndesc; i++) {
...
# 919 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
     case 01:
      mode_string = "w";
      break;
     case 00:
    ...
    if (stream) {
     ...
     { do { zval *__z = (&retfp); (*__z).value.res = ((stream)->res); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0); (stream)->__exposed++; };
     add_index_zval(pipes, descriptors[i].index, &retfp);

     proc->pipes[i] = (retfp).value.res;
     zval_addref_p(&(retfp));
    }
    break;
   default:
 ...
 _efree((descriptors) );
 do { zval *__z = (return_value); (*__z).value.res = (zend_register_resource(proc, le_proc_open)); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0);
 return;
...
# 974 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/proc_open.c"
 { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
