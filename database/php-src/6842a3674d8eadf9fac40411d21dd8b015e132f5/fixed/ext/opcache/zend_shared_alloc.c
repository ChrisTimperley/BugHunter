...
# 48 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
...
int lock_file;
static char lockfile_name[sizeof("/tmp") + sizeof(".ZendSem.") + 8];
...
void zend_shared_alloc_create_lock(void)
{
 ...
 sprintf(lockfile_name, "%s/%sXXXXXX", "/tmp", ".ZendSem.");
...
# 305 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
void *zend_shared_alloc(size_t size)
{
 int i;
...
void zend_shared_alloc_lock(void)
{
# 392 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
 while (1) {
