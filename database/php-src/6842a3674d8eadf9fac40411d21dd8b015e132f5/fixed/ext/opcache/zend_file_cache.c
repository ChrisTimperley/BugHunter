...
# 100 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
extern int lock_file;
# 149 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 315 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 343 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 424 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
  ...
  do { if (op_array->brk_cont_array) { do { if (__builtin_expect(!((((char*)(op_array->brk_cont_array) >= (char*)script->mem && (char*)(op_array->brk_cont_array) < (char*)script->mem + script->size) || ((char*)(op_array->brk_cont_array) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->brk_cont_array) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->brk_cont_array) = (void*)((char*)(op_array->brk_cont_array) - (char*)script->mem); } } while (0);
                                      ...
                                      void *buf)
{
 ...
 do { if (new_script->full_path) { if (((char*)(new_script->full_path) >= (accel_shared_globals->interned_strings_start) && (char*)(new_script->full_path) < (accel_shared_globals->interned_strings_end))) { (new_script->full_path) = zend_file_cache_serialize_interned((zend_string*)(new_script->full_path), info); } else { do { if (__builtin_expect(!((((char*)(new_script->full_path) >= (char*)script->mem && (char*)(new_script->full_path) < (char*)script->mem + script->size) || ((char*)(new_script->full_path) >= (accel_shared_globals->interned_strings_start) && (char*)(new_script->full_path) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (new_script->full_path)->gc.u.v.flags |= (1<<1); (new_script->full_path)->gc.u.v.flags &= ~(1<<2); } (new_script->full_path) = (void*)((char*)(new_script->full_path) - (char*)script->mem); } } } while (0);
...
# 702 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 return filename;
}
...
# 796 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 zend_string_release((zend_string*)(accel_globals.mem));
 _efree((mem) );
 if (flock(fd, 8) != 0) {
                                                 ...
                                                 void *buf)
{
 ...
 if (!(((char*)(op_array->opcodes) >= (char*)script->mem && (char*)(op_array->opcodes) < (char*)script->mem + script->size) || ((char*)(op_array->opcodes) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->opcodes) < (accel_shared_globals->interned_strings_end)))) {
  ...
  while (opline < end) {
# 976 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
  ...
  do { if (op_array->brk_cont_array) { do { if (__builtin_expect(!(((char*)(op_array->brk_cont_array) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->brk_cont_array) = (void*)((char*)buf + (size_t)(op_array->brk_cont_array)); } } while (0);
                                              ...
                                              void *buf)
{
 ...
 zend_file_cache_unserialize_hash(&ce->constants_table,
   script, buf, zend_file_cache_unserialize_zval, ((void *)0));
                                        ...
                                        void *buf)
{
 ...
 do { if (script->full_path) { if (((size_t)(script->full_path) & 1UL)) { (script->full_path) = (void*)zend_file_cache_unserialize_interned((zend_string*)(script->full_path), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(script->full_path) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (script->full_path) = (void*)((char*)buf + (size_t)(script->full_path)); if (__builtin_expect(!!(!script->corrupted), 1)) { (script->full_path)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (script->full_path)->gc.u.v.flags |= (1<<1); (script->full_path)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
...
use_process_mem:
 ...
 if (cache_it) {
  ...
  zend_accel_hash_update(&(accel_shared_globals->hash), (script->full_path)->val, (script->full_path)->len, 0, script);
