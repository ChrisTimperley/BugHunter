...
# 342 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 746 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
accel_time_t zend_get_file_handle_timestamp(zend_file_handle *file_handle, size_t *size)
{
 zend_stat_t statbuf;
...
# 774 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
...
static zend_persistent_script *opcache_compile_file(zend_file_handle *file_handle, int type, char *key, unsigned int key_length, zend_op_array **op_array_p)
{
 ...
 uint32_t orig_compiler_options = 0;
   ...
   *op_array_p = ((void *)0);
   if (type == (1<<3)) {
    ...
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1415);
   } else {
 ...
 if (!op_array) {
  ...
  if (do_bailout) {
   _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1500);
  }
  return ((void *)0);
 }
...
zend_op_array *file_cache_compile_file(zend_file_handle *file_handle, int type)
{
 ...
 if (!file_handle->opened_path) {
  if (file_handle->type == ZEND_HANDLE_FILENAME &&
   ...
   if (type == (1<<3)) {
    zend_message_dispatcher(2L, file_handle->filename);
    _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1558);
   } else {
    zend_message_dispatcher(1L, file_handle->filename);
   }
   return ((void *)0);
 ...
 if ((accel_globals.cache_persistent_script) &&
  ...
  if (!persistent_script) {
   ...
   zend_accel_hash_entry *bucket;
    ...
    if (type == (1<<3)) {
     zend_message_dispatcher(2L, file_handle->filename);
     _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c", 1674);
    } else {
     zend_message_dispatcher(1L, file_handle->filename);
    }
    return ((void *)0);
...
# 1822 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
  if (persistent_script->full_path) {
   if (!(executor_globals.current_execute_data) || !(executor_globals.current_execute_data)->opline ||
       !(executor_globals.current_execute_data)->func ||
       !(((executor_globals.current_execute_data)->func->common.type & 1) == 0) ||
...
# 2101 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
...
static void accel_gen_system_id(void)
{
 ...
 if (strstr("7.0.5-dev", "-dev") != 0) {
  ...
  PHP_MD5Update(&context, "17:02:26", sizeof("17:02:26")-1);
 }
...
# 2495 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c" 2
# 2506 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
...
# 2555 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
 }
...
# 2599 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
 ...
 if (!(accel_globals.accel_directives).file_cache_only) {
  ...
  switch (zend_shared_alloc_startup((accel_globals.accel_directives).memory_consumption)) {
   ...
   case 2:
    ...
    return SUCCESS;
    break;
# 2696 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
  }
...
# 2860 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.c"
int accelerator_shm_read_lock(void)
{
 if ((accel_globals.counted)) {
