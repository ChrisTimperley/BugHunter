# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
# 1 "ext/opcache/Optimizer/zend_optimizer.h" 1
# 26 "ext/opcache/Optimizer/zend_optimizer.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 27 "ext/opcache/Optimizer/zend_optimizer.h" 2
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
# 1 "ext/opcache/Optimizer/zend_optimizer_internal.h" 1
# 25 "ext/opcache/Optimizer/zend_optimizer_internal.h"
...
# 100 "ext/opcache/ZendAccelerator.h"
extern int lock_file;
# 149 "ext/opcache/ZendAccelerator.h"
...
# 315 "ext/opcache/ZendAccelerator.h"
...
# 343 "ext/opcache/ZendAccelerator.h"
zend_string *accel_new_interned_string(zend_string *str);
# 26 "ext/opcache/Optimizer/zend_optimizer_internal.h" 2
# 52 "ext/opcache/Optimizer/zend_optimizer_internal.h"
...
# 116 "ext/opcache/Optimizer/zend_optimizer_internal.h"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2


# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c" 2
...
int zend_optimizer_get_persistent_constant(zend_string *name, zval *result, int copy)
{
 ...
 if ((c = zend_hash_find_ptr((executor_globals.zend_constants), name)) == ((void *)0)) {
  lookup_name = ((use_heap = (__builtin_expect(!!(((name)->len + 1) > ((32 * 1024))), 0))) ? (__builtin_constant_p(((name)->len + 1) ) ? ((((name)->len + 1) <= 8) ? _emalloc_8() : ((((name)->len + 1) <= 16) ? _emalloc_16() : ((((name)->len + 1) <= 24) ? _emalloc_24() : ((((name)->len + 1) <= 32) ? _emalloc_32() : ((((name)->len + 1) <= 40) ? _emalloc_40() : ((((name)->len + 1) <= 48) ? _emalloc_48() : ((((name)->len + 1) <= 56) ? _emalloc_56() : ((((name)->len + 1) <= 64) ? _emalloc_64() : ((((name)->len + 1) <= 80) ? _emalloc_80() : ((((name)->len + 1) <= 96) ? _emalloc_96() : ((((name)->len + 1) <= 112) ? _emalloc_112() : ((((name)->len + 1) <= 128) ? _emalloc_128() : ((((name)->len + 1) <= 160) ? _emalloc_160() : ((((name)->len + 1) <= 192) ? _emalloc_192() : ((((name)->len + 1) <= 224) ? _emalloc_224() : ((((name)->len + 1) <= 256) ? _emalloc_256() : ((((name)->len + 1) <= 320) ? _emalloc_320() : ((((name)->len + 1) <= 384) ? _emalloc_384() : ((((name)->len + 1) <= 448) ? _emalloc_448() : ((((name)->len + 1) <= 512) ? _emalloc_512() : ((((name)->len + 1) <= 640) ? _emalloc_640() : ((((name)->len + 1) <= 768) ? _emalloc_768() : ((((name)->len + 1) <= 896) ? _emalloc_896() : ((((name)->len + 1) <= 1024) ? _emalloc_1024() : ((((name)->len + 1) <= 1280) ? _emalloc_1280() : ((((name)->len + 1) <= 1536) ? _emalloc_1536() : ((((name)->len + 1) <= 1792) ? _emalloc_1792() : ((((name)->len + 1) <= 2048) ? _emalloc_2048() : ((((name)->len + 1) <= 2560) ? _emalloc_2560() : ((((name)->len + 1) <= 3072) ? _emalloc_3072() : ((((name)->len + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((name)->len + 1)) : _emalloc_huge(((name)->len + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((name)->len + 1) ) ) : __builtin_alloca ((name)->len + 1));
  memcpy(lookup_name, (name)->val, (name)->len + 1);
  zend_str_tolower(lookup_name, (name)->len);

  if ((c = zend_hash_str_find_ptr((executor_globals.zend_constants), lookup_name, (name)->len)) != ((void *)0)) {
  ...
  do { if (__builtin_expect(!!(use_heap), 0)) _efree((lookup_name) ); } while (0);
 }

 if (retval) {
  if (c->flags & (1<<1)) {
   do { zval *_z1 = (result); const zval *_z2 = (&c->value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   if (copy) {
...
# 113 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
static int find_code_blocks(zend_op_array *op_array, zend_cfg *cfg, zend_optimizer_ctx *ctx)
{
 ...
 while (opline < end) {
  switch((unsigned)opline->opcode) {
   case 162:
    blocks[(opline)->op1.opline_num].start_opline = &op_array->opcodes[(opline)->op1.opline_num]; blocks[(opline)->op1.opline_num].start_opline_no = (opline)->op1.opline_num; blocks[(opline)->op1.opline_num].access = 1;
    if (opline->extended_value) {
     blocks[(opline)->op2.opline_num].start_opline = &op_array->opcodes[(opline)->op2.opline_num]; blocks[(opline)->op2.opline_num].start_opline_no = (opline)->op2.opline_num; blocks[(opline)->op2.opline_num].access = 1;
    }
    blocks[opno + 1].start_opline = &op_array->opcodes[opno + 1]; blocks[opno + 1].start_opline_no = opno + 1; blocks[opno + 1].access = 1;
    break;
   case 163:
    if (opline->extended_value) {
     blocks[(opline)->op2.opline_num].start_opline = &op_array->opcodes[(opline)->op2.opline_num]; blocks[(opline)->op2.opline_num].start_opline_no = (opline)->op2.opline_num; blocks[(opline)->op2.opline_num].access = 1;
   ...
   case 107:
    blocks[opline->extended_value].start_opline = &op_array->opcodes[opline->extended_value]; blocks[opline->extended_value].start_opline_no = opline->extended_value; blocks[opline->extended_value].access = 1;
    blocks[opno + 1].start_opline = &op_array->opcodes[opno + 1]; blocks[opno + 1].start_opline_no = opno + 1; blocks[opno + 1].access = 1;
    break;
   case 45:
    blocks[opline->extended_value].start_opline = &op_array->opcodes[opline->extended_value]; blocks[opline->extended_value].start_opline_no = opline->extended_value; blocks[opline->extended_value].access = 1;
 ...
 if (op_array->last_try_catch) {
  ...
  for (i = 0; i< op_array->last_try_catch; i++) {
   ...
   blocks[op_array->try_catch_array[i].try_op].start_opline = &op_array->opcodes[op_array->try_catch_array[i].try_op]; blocks[op_array->try_catch_array[i].try_op].start_opline_no = op_array->try_catch_array[i].try_op; blocks[op_array->try_catch_array[i].try_op].access = 1;
   blocks[op_array->try_catch_array[i].catch_op].start_opline = &op_array->opcodes[op_array->try_catch_array[i].catch_op]; blocks[op_array->try_catch_array[i].catch_op].start_opline_no = op_array->try_catch_array[i].catch_op; blocks[op_array->try_catch_array[i].catch_op].access = 1;
 ...
 if (op_array->last_brk_cont) {
  ...
  for (i = 0; i< op_array->last_brk_cont; i++) {
   if (op_array->brk_cont_array[i].start >= 0 &&
       (op_array->opcodes[op_array->brk_cont_array[i].brk].opcode == 70 ||
        op_array->opcodes[op_array->brk_cont_array[i].brk].opcode == 127 ||
        op_array->opcodes[op_array->brk_cont_array[i].brk].opcode == 56 ||
        op_array->opcodes[op_array->brk_cont_array[i].brk].opcode == 58)) {
    int parent = op_array->brk_cont_array[i].parent;

    while (parent >= 0 &&
           op_array->brk_cont_array[parent].start < 0 &&
           (op_array->opcodes[op_array->brk_cont_array[parent].brk].opcode != 70 ||
            op_array->opcodes[op_array->brk_cont_array[parent].brk].opcode != 127 ||
          op_array->opcodes[op_array->brk_cont_array[i].brk].opcode != 56 ||
            op_array->opcodes[op_array->brk_cont_array[parent].brk].opcode != 58)) {
  ...
  if (j) {
   ...
   for (i = 0; i< op_array->last_brk_cont; i++) {
    if (op_array->brk_cont_array[i].start >= 0 &&
     ...
     blocks[op_array->brk_cont_array[j].start].start_opline = &op_array->opcodes[op_array->brk_cont_array[j].start]; blocks[op_array->brk_cont_array[j].start].start_opline_no = op_array->brk_cont_array[j].start; blocks[op_array->brk_cont_array[j].start].access = 1;
     blocks[op_array->brk_cont_array[j].cont].start_opline = &op_array->opcodes[op_array->brk_cont_array[j].cont]; blocks[op_array->brk_cont_array[j].cont].start_opline_no = op_array->brk_cont_array[j].cont; blocks[op_array->brk_cont_array[j].cont].access = 1;
     blocks[op_array->brk_cont_array[j].brk].start_opline = &op_array->opcodes[op_array->brk_cont_array[j].brk]; blocks[op_array->brk_cont_array[j].brk].start_opline_no = op_array->brk_cont_array[j].brk; blocks[op_array->brk_cont_array[j].brk].access = 1;
 ...
 for (opno = 1; opno < op_array->last; opno++) {
  if (blocks[opno].start_opline) {
   ...
   switch((unsigned)opline->opcode) {
    ...
    case 162:
     if (opline->extended_value) {
      cur_block->op2_to = &blocks[(opline)->op2.opline_num];
     }
     cur_block->op1_to = &blocks[(opline)->op1.opline_num];
     break;
    case 163:
     if (opline->extended_value) {
      cur_block->op2_to = &blocks[(opline)->op2.opline_num];
...
# 354 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
...
static inline void del_source(zend_code_block *from, zend_code_block *to)
{
 ...
 if (!to->protected && to->sources->next == ((void *)0)) {

  zend_code_block *from_block = to->sources->from;

  if (from_block->access && from_block->follow_to == to &&
      from_block->op1_to == ((void *)0) &&
      from_block->op2_to == ((void *)0) &&
      from_block->ext_to == ((void *)0)) {
 ...
 if (block->follow_to) {
  ...
  while (bs) {
   ...
   if (from_block->op1_to == block) {
    ...
    { zend_block_source *__s = to->sources; while (__s && __s->from != from_block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = to->sources; to->sources = __t; __t->from = from_block; } };
   }
...
static void zend_access_path(zend_code_block *block, zend_optimizer_ctx *ctx)
{
 ...
 if (block->op1_to) {
  ...
  { zend_block_source *__s = block->op1_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->op1_to->sources; block->op1_to->sources = __t; __t->from = block; } };
 }
 if (block->op2_to) {
  zend_access_path(block->op2_to, ctx);
  { zend_block_source *__s = block->op2_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->op2_to->sources; block->op2_to->sources = __t; __t->from = block; } };
 }
 if (block->ext_to) {
  zend_access_path(block->ext_to, ctx);
  { zend_block_source *__s = block->ext_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->ext_to->sources; block->ext_to->sources = __t; __t->from = block; } };
 }
 if (block->follow_to) {
  zend_access_path(block->follow_to, ctx);
  { zend_block_source *__s = block->follow_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->follow_to->sources; block->follow_to->sources = __t; __t->from = block; } };
 }
}
...
static void zend_rebuild_access_path(zend_cfg *cfg, zend_op_array *op_array, int find_start, zend_optimizer_ctx *ctx)
{
 ...
 zend_code_block *start = find_start? ((void *)0) : blocks;
 zend_code_block *b;
...
# 564 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
static void strip_nop(zend_code_block *block, zend_optimizer_ctx *ctx)
{
 ...
 while (block->len > 0 && block->start_opline->opcode == 0) {
  if (block->len == 1) {
 ...
 while (opline < end) {
  ...
  while (opline < end && opline->opcode == 0) {
   opline++;
  }
  src = opline;
...
static void zend_optimize_block(zend_code_block *block, zend_op_array *op_array, zend_bitset used_ext, zend_cfg *cfg, zend_optimizer_ctx *ctx)
{
 ...
 while ((op_array->T) && (opline < end)) {
  ...
  if (((opline)->op1_type & ((1<<1)|(1<<2))) &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 22 &&
   (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))])->op1_type == (1<<0) &&
   opline->opcode != 48 &&
   opline->opcode != 98 &&
   (opline->opcode != 77 || opline->opcode != 125) &&
   opline->opcode != 70
   ) {
   znode_op op1 = opline->op1;
   zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   zval c = (op_array)->literals[(src)->op1.constant];
   _zval_copy_ctor((&c) );
   if (zend_optimizer_update_op1_const(op_array, opline, &c)) {
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = ((void *)0);
    do { _zval_dtor((&(op_array)->literals[(src)->op1.constant]) ); do { (*(&(op_array)->literals[(src)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
   }
  }


  if (((opline)->op2_type & ((1<<1)|(1<<2))) &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 22 &&
   (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))])->op1_type == (1<<0)) {
   znode_op op2 = opline->op2;
   zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   zval c = (op_array)->literals[(src)->op1.constant];
   _zval_copy_ctor((&c) );
   if (zend_optimizer_update_op2_const(op_array, opline, &c)) {
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = ((void *)0);
    do { _zval_dtor((&(op_array)->literals[(src)->op1.constant]) ); do { (*(&(op_array)->literals[(src)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
   }
  }
  ...
  if (opline->opcode == 40 &&
   (opline)->op1_type & ((1<<1)|(1<<2)) &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 21 &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->extended_value == 6) {
   zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   do { opline->op1_type = src->op1_type; opline->op1 = src->op1; } while (0);
   do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
  }
  ...
  if (opline->opcode == 70 &&
   ...
   if (src->opcode == 52) {
    if ((src)->op1_type == (1<<0)) {
     do { _zval_dtor((&(op_array)->literals[(src)->op1.constant]) ); do { (*(&(op_array)->literals[(src)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    } else if ((src)->op1_type == (1<<1)) {
     src->opcode = 70;
    } else {
     do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
    }
    do { (opline)->op1.num = 0; (opline)->op2.num = 0; (opline)->result.num = 0; (opline)->opcode = 0; (opline)->op1_type = (1<<3); (opline)->op2_type = (1<<3); (opline)->result_type = (1<<3); zend_vm_set_opcode_handler(opline); } while (0);
   }
  }
# 771 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
  if (opline->opcode == 17 ||
   opline->opcode == 18 ||

   (opline->opcode == 48 && ((opline)->op1_type & ((1<<0)|(1<<4))))) {
   if ((opline)->op1_type == (1<<0) &&
    (zval_get_type(&((op_array)->literals[(opline)->op1.constant])) == 2 ||
     zval_get_type(&((op_array)->literals[(opline)->op1.constant])) == 3)) {
    ...
    opline->opcode =
     ((opline->opcode != 18) == ((zval_get_type(&((op_array)->literals[(opline)->op1.constant]))) == 3)) ?
     52 : 13;
    do { opline->op1_type = opline->op2_type; opline->op1 = opline->op2; } while (0);
    opline->op2_type = (1<<3);
   } else if ((opline)->op2_type == (1<<0) &&
        (zval_get_type(&((op_array)->literals[(opline)->op2.constant])) == 2 ||
         zval_get_type(&((op_array)->literals[(opline)->op2.constant])) == 3)) {
    ...
    opline->opcode =
     ((opline->opcode != 18) == ((zval_get_type(&((op_array)->literals[(opline)->op2.constant]))) == 3)) ?
     52 : 13;
    opline->op2_type = (1<<3);
   }
  }
  ...
  if ((opline->opcode == 52 ||
   ...
   opline->opcode == 45) &&
   (opline)->op1_type == (1<<1) &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] != ((void *)0) &&
   !zend_bitset_in(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) &&
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 13) {
   ...
   switch (opline->opcode) {
    ...
    case 45:
    {
     ...
     opline->extended_value = (opline)->op2.opline_num;
     (opline)->op2.opline_num = op_t;
   ...
   do { if (opline->op1_type & ((1<<1)|(1<<2))) {Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = ((void *)0);}} while (0);
   do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
   continue;
  } else
# 880 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
  if ((opline->opcode == 52 ||
   opline->opcode == 13 ||
   opline->opcode == 43 ||
   opline->opcode == 46 ||
   ...
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] != ((void *)0) &&
   (!zend_bitset_in(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) ||
   (((opline)->result_type & ((1<<1)|(1<<2))) &&
    (opline)->result.var == (opline)->op1.var)) &&
   (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 52 ||
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 22)) {
   zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   do { opline->op1_type = src->op1_type; opline->op1 = src->op1; } while (0);
   ...
   do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
   continue;
  } else if (last_op && opline->opcode == 40 &&
      last_op->opcode == 40 &&
      (opline)->op1_type == (1<<0) &&
      zval_get_type(&((op_array)->literals[(opline)->op1.constant])) != 5 &&
      (last_op)->op1_type == (1<<0) &&
      zval_get_type(&((op_array)->literals[(last_op)->op1.constant])) != 5) {
   ...
   if (zval_get_type(&((op_array)->literals[(opline)->op1.constant])) != 6) {
    if (zval_get_type(&(*((&(op_array)->literals[(opline)->op1.constant])))) == 1) { do { do { zval *__z = ((&(op_array)->literals[(opline)->op1.constant])); zend_string *__s = (zend_string_init("", 0, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } else { if (zval_get_type(&(*((&(op_array)->literals[(opline)->op1.constant])))) != 6) { _convert_to_string(((&(op_array)->literals[(opline)->op1.constant])) ); }; };
   }
   if (zval_get_type(&((op_array)->literals[(last_op)->op1.constant])) != 6) {
    if (zval_get_type(&(*((&(op_array)->literals[(last_op)->op1.constant])))) == 1) { do { do { zval *__z = ((&(op_array)->literals[(last_op)->op1.constant])); zend_string *__s = (zend_string_init("", 0, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } else { if (zval_get_type(&(*((&(op_array)->literals[(last_op)->op1.constant])))) != 6) { _convert_to_string(((&(op_array)->literals[(last_op)->op1.constant])) ); }; };
   }
   old_len = (((op_array)->literals[(last_op)->op1.constant]).value.str)->len;
   l = old_len + (((op_array)->literals[(opline)->op1.constant]).value.str)->len;
   if (!((((op_array)->literals[(last_op)->op1.constant]).u1.v.type_flags & (1<<2)) != 0)) {
    zend_string *tmp = zend_string_alloc(l, 0);
    memcpy((tmp)->val, (((op_array)->literals[(last_op)->op1.constant]).value.str)->val, old_len);
    ((op_array)->literals[(last_op)->op1.constant]).value.str = tmp;
   } else {
    ((op_array)->literals[(last_op)->op1.constant]).value.str = zend_string_extend(((op_array)->literals[(last_op)->op1.constant]).value.str, l, 0);
   }
   ((op_array)->literals[(last_op)->op1.constant]).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8));
   memcpy((((op_array)->literals[(last_op)->op1.constant]).value.str)->val + old_len, (((op_array)->literals[(opline)->op1.constant]).value.str)->val, (((op_array)->literals[(opline)->op1.constant]).value.str)->len);
   (((op_array)->literals[(last_op)->op1.constant]).value.str)->val[l] = '\0';
   _zval_dtor((&(op_array)->literals[(opline)->op1.constant]) );
   do { zval *__z = (&(op_array)->literals[(opline)->op1.constant]); zend_string *__s = (zend_new_interned_string(((op_array)->literals[(last_op)->op1.constant]).value.str)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
   do { (*(&(op_array)->literals[(last_op)->op1.constant])).u1.type_info = 1; } while (0);
   do { (last_op)->op1.num = 0; (last_op)->op2.num = 0; (last_op)->result.num = 0; (last_op)->opcode = 0; (last_op)->op1_type = (1<<3); (last_op)->op2_type = (1<<3); (last_op)->result_type = (1<<3); zend_vm_set_opcode_handler(last_op); } while (0);
  } else if ((opline->opcode == 8) &&
      (opline)->op2_type == (1<<0) &&
      (opline)->op1_type == (1<<1) &&
      Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
      (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 8 ||
       Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 53) &&
      (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))])->op2_type == (1<<0) &&
      (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))])->result.var == (opline)->op1.var) {

   zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   int l, old_len;

   if (zval_get_type(&((op_array)->literals[(opline)->op2.constant])) != 6) {
    if (zval_get_type(&(*((&(op_array)->literals[(opline)->op2.constant])))) == 1) { do { do { zval *__z = ((&(op_array)->literals[(opline)->op2.constant])); zend_string *__s = (zend_string_init("", 0, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } else { if (zval_get_type(&(*((&(op_array)->literals[(opline)->op2.constant])))) != 6) { _convert_to_string(((&(op_array)->literals[(opline)->op2.constant])) ); }; };
   }
   if (zval_get_type(&((op_array)->literals[(src)->op2.constant])) != 6) {
    if (zval_get_type(&(*((&(op_array)->literals[(src)->op2.constant])))) == 1) { do { do { zval *__z = ((&(op_array)->literals[(src)->op2.constant])); zend_string *__s = (zend_string_init("", 0, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } else { if (zval_get_type(&(*((&(op_array)->literals[(src)->op2.constant])))) != 6) { _convert_to_string(((&(op_array)->literals[(src)->op2.constant])) ); }; };
   }

   do { if (opline->op1_type & ((1<<1)|(1<<2))) {Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = ((void *)0);}} while (0);
   do { opline->op1_type = src->op1_type; opline->op1 = src->op1; } while (0);
   old_len = (((op_array)->literals[(src)->op2.constant]).value.str)->len;
   l = old_len + (((op_array)->literals[(opline)->op2.constant]).value.str)->len;
   if (!((((op_array)->literals[(src)->op2.constant]).u1.v.type_flags & (1<<2)) != 0)) {
    zend_string *tmp = zend_string_alloc(l, 0);
    memcpy((tmp)->val, (((op_array)->literals[(src)->op2.constant]).value.str)->val, old_len);
    ((op_array)->literals[(last_op)->op2.constant]).value.str = tmp;
   } else {
    ((op_array)->literals[(src)->op2.constant]).value.str = zend_string_extend(((op_array)->literals[(src)->op2.constant]).value.str, l, 0);
   }
   ((op_array)->literals[(last_op)->op2.constant]).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8));
   memcpy((((op_array)->literals[(src)->op2.constant]).value.str)->val + old_len, (((op_array)->literals[(opline)->op2.constant]).value.str)->val, (((op_array)->literals[(opline)->op2.constant]).value.str)->len);
   (((op_array)->literals[(src)->op2.constant]).value.str)->val[l] = '\0';
   zend_string_release(((op_array)->literals[(opline)->op2.constant]).value.str);
   do { zval *__z = (&(op_array)->literals[(opline)->op2.constant]); zend_string *__s = (zend_new_interned_string(((op_array)->literals[(src)->op2.constant]).value.str)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
   do { (*(&(op_array)->literals[(src)->op2.constant])).u1.type_info = 1; } while (0);
   do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
  } else if ((opline->opcode == 1 ||
     opline->opcode == 2 ||
     opline->opcode == 3 ||
     opline->opcode == 4 ||
     opline->opcode == 5 ||
   ...
   int er;
            ...
            if ((opline->opcode == 4 || opline->opcode == 5) &&
                _zval_get_long((&(op_array)->literals[(opline)->op2.constant])) == 0) {
    if ((((opline->result_type & (1<<2)) && !(opline->result_type & (1<<5))) || opline->result_type == (1<<1))) {
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = opline;
    }
                opline++;
    continue;
            } else if ((opline->opcode == 6 || opline->opcode == 7) &&
                _zval_get_long((&(op_array)->literals[(opline)->op2.constant])) < 0) {
    if ((((opline->result_type & (1<<2)) && !(opline->result_type & (1<<5))) || opline->result_type == (1<<1))) {
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = opline;
    }
   ...
   if (binary_op(&result, &(op_array)->literals[(opline)->op1.constant], &(op_array)->literals[(opline)->op2.constant]) == SUCCESS) {
    do { _zval_dtor((&(op_array)->literals[(opline)->op1.constant]) ); do { (*(&(op_array)->literals[(opline)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    do { _zval_dtor((&(op_array)->literals[(opline)->op2.constant]) ); do { (*(&(op_array)->literals[(opline)->op2.constant])).u1.type_info = 1; } while (0); } while (0);
    opline->opcode = 22;
    opline->op2_type = (1<<3);
    zend_optimizer_update_op1_const(op_array, opline, &result);
   }
   (executor_globals.error_reporting) = er;
  } else if ((opline->opcode == 52 ||
        opline->opcode == 13 ||
       opline->opcode == 12) && (opline)->op1_type == (1<<0)) {

   unary_op_type unary_op = get_unary_op(opline->opcode);
   zval result;

   if (unary_op) {
    unary_op(&result, &(op_array)->literals[(opline)->op1.constant]);
    do { _zval_dtor((&(op_array)->literals[(opline)->op1.constant]) ); do { (*(&(op_array)->literals[(opline)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
   } else {

    result = (op_array)->literals[(opline)->op1.constant];
    convert_to_boolean(&result);
    do { (*(&(op_array)->literals[(opline)->op1.constant])).u1.type_info = 1; } while (0);
   }
   opline->opcode = 22;
   zend_optimizer_update_op1_const(op_array, opline, &result);
  } else if ((opline->opcode == 62 || opline->opcode == 79) &&
     ((opline)->op1_type & ((1<<1)|(1<<2))) &&
        Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
        Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 22) {
   ...
   do { opline->op1_type = src->op1_type; opline->op1 = src->op1; } while (0);
   do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
  } else if (opline->opcode == 8 || opline->opcode == 53) {
   if (((opline)->op1_type & ((1<<1)|(1<<2))) &&
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 21 &&
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->extended_value == 6) {
   ...
   if (((opline)->op2_type & ((1<<1)|(1<<2))) &&
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 21 &&
    Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->extended_value == 6) {

    zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
    do { if (opline->op2_type & ((1<<1)|(1<<2))) {Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = ((void *)0);}} while (0);
    do { opline->op2_type = src->op1_type; opline->op2 = src->op1; } while (0);
    do { (src)->op1.num = 0; (src)->op2.num = 0; (src)->result.num = 0; (src)->opcode = 0; (src)->op1_type = (1<<3); (src)->op2_type = (1<<3); (src)->result_type = (1<<3); zend_vm_set_opcode_handler(src); } while (0);
   }
   if ((opline)->op1_type == (1<<0) &&
       zval_get_type(&((op_array)->literals[(opline)->op1.constant])) == 6 &&
       (((op_array)->literals[(opline)->op1.constant]).value.str)->len == 0) {
    ...
    opline->op2.var = 0;
              ...
              zval_get_type(&((op_array)->literals[(opline)->op2.constant])) == 6 &&
              (((op_array)->literals[(opline)->op2.constant]).value.str)->len == 0) {
    ...
    opline->op2.var = 0;
              ...
              (opline->op1_type == (1<<0) ||
               (opline->op1_type == (1<<1) &&
                Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
                (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 53 ||
                 Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 56 ||
                 Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 99))) &&
              (opline->op2_type == (1<<0) ||
               (opline->op2_type == (1<<1) &&
                Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
                (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 53 ||
                 Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 56 ||
                 Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 99)))) {
    opline->opcode = 53;
   }
  } else if (opline->opcode == 22 &&
     (opline)->op1_type == (opline)->result_type &&
   ...
   do { (opline)->op1.num = 0; (opline)->op2.num = 0; (opline)->result.num = 0; (opline)->opcode = 0; (opline)->op1_type = (1<<3); (opline)->op2_type = (1<<3); (opline)->result_type = (1<<3); zend_vm_set_opcode_handler(opline); } while (0);
     ...
     (opline)->op1_type == (1<<1) &&
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] &&
     (Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 17 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 18 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 19 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 20 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 52 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 15 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 16 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 114 ||
     Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))]->opcode == 115) &&
     !zend_bitset_in(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))) {

   zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   do { src->result_type = opline->result_type; src->result = opline->result; } while (0);
   Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(src->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] = src;
   do { (opline)->op1.num = 0; (opline)->op2.num = 0; (opline)->result.num = 0; (opline)->opcode = 0; (opline)->op1_type = (1<<3); (opline)->op2_type = (1<<3); (opline)->result_type = (1<<3); zend_vm_set_opcode_handler(opline); } while (0);
  }
...
{
 zend_code_block *blocks = cfg->blocks;
 zend_op *new_opcodes = (__builtin_constant_p((op_array->last * sizeof(zend_op)) ) ? (((op_array->last * sizeof(zend_op)) <= 8) ? _emalloc_8() : (((op_array->last * sizeof(zend_op)) <= 16) ? _emalloc_16() : (((op_array->last * sizeof(zend_op)) <= 24) ? _emalloc_24() : (((op_array->last * sizeof(zend_op)) <= 32) ? _emalloc_32() : (((op_array->last * sizeof(zend_op)) <= 40) ? _emalloc_40() : (((op_array->last * sizeof(zend_op)) <= 48) ? _emalloc_48() : (((op_array->last * sizeof(zend_op)) <= 56) ? _emalloc_56() : (((op_array->last * sizeof(zend_op)) <= 64) ? _emalloc_64() : (((op_array->last * sizeof(zend_op)) <= 80) ? _emalloc_80() : (((op_array->last * sizeof(zend_op)) <= 96) ? _emalloc_96() : (((op_array->last * sizeof(zend_op)) <= 112) ? _emalloc_112() : (((op_array->last * sizeof(zend_op)) <= 128) ? _emalloc_128() : (((op_array->last * sizeof(zend_op)) <= 160) ? _emalloc_160() : (((op_array->last * sizeof(zend_op)) <= 192) ? _emalloc_192() : (((op_array->last * sizeof(zend_op)) <= 224) ? _emalloc_224() : (((op_array->last * sizeof(zend_op)) <= 256) ? _emalloc_256() : (((op_array->last * sizeof(zend_op)) <= 320) ? _emalloc_320() : (((op_array->last * sizeof(zend_op)) <= 384) ? _emalloc_384() : (((op_array->last * sizeof(zend_op)) <= 448) ? _emalloc_448() : (((op_array->last * sizeof(zend_op)) <= 512) ? _emalloc_512() : (((op_array->last * sizeof(zend_op)) <= 640) ? _emalloc_640() : (((op_array->last * sizeof(zend_op)) <= 768) ? _emalloc_768() : (((op_array->last * sizeof(zend_op)) <= 896) ? _emalloc_896() : (((op_array->last * sizeof(zend_op)) <= 1024) ? _emalloc_1024() : (((op_array->last * sizeof(zend_op)) <= 1280) ? _emalloc_1280() : (((op_array->last * sizeof(zend_op)) <= 1536) ? _emalloc_1536() : (((op_array->last * sizeof(zend_op)) <= 1792) ? _emalloc_1792() : (((op_array->last * sizeof(zend_op)) <= 2048) ? _emalloc_2048() : (((op_array->last * sizeof(zend_op)) <= 2560) ? _emalloc_2560() : (((op_array->last * sizeof(zend_op)) <= 3072) ? _emalloc_3072() : (((op_array->last * sizeof(zend_op)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((op_array->last * sizeof(zend_op))) : _emalloc_huge((op_array->last * sizeof(zend_op)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((op_array->last * sizeof(zend_op)) ) );
  ...
  if (cur_block->access) {
   ...
   if ((opline - 1)->opcode == 42) {
    ...
    if (next && next == cur_block->op1_to) {
     ...
     cur_block->op1_to = ((void *)0);
     do { ((opline - 1))->op1.num = 0; ((opline - 1))->op2.num = 0; ((opline - 1))->result.num = 0; ((opline - 1))->opcode = 0; ((opline - 1))->op1_type = (1<<3); ((opline - 1))->op2_type = (1<<3); ((opline - 1))->result_type = (1<<3); zend_vm_set_opcode_handler((opline - 1)); } while (0);
     opline--;
     cur_block->len--;
    }
   }
   ...
   for (_opl = cur_block->start_opline; _opl && _opl < end; _opl++) {
    if ((_opl)->op1_type == (1<<0)) {
     do { _zval_dtor((&(op_array)->literals[(_opl)->op1.constant]) ); do { (*(&(op_array)->literals[(_opl)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    }
    if ((_opl)->op2_type == (1<<0)) {
     do { _zval_dtor((&(op_array)->literals[(_opl)->op2.constant]) ); do { (*(&(op_array)->literals[(_opl)->op2.constant])).u1.type_info = 1; } while (0); } while (0);
    }
   }
  }
  cur_block = cur_block->next;
 ...
 for (cur_block = blocks; cur_block; cur_block = cur_block->next) {
  ...
  if (cur_block->op1_to) {
   (opline)->op1.opline_num = cur_block->op1_to->start_opline - new_opcodes;
  }
  if (cur_block->op2_to) {
   (opline)->op2.opline_num = cur_block->op2_to->start_opline - new_opcodes;
  }
  if (cur_block->ext_to) {
 ...
 op_array->opcodes = _erealloc((new_opcodes), (op_array->last * sizeof(zend_op)) );
  ...
  case 42:
   {
     ...
     *last_op = *target;
     if ((last_op)->op1_type == (1<<0)) {
      zval zv = (op_array)->literals[(last_op)->op1.constant];
      _zval_copy_ctor((&zv) );
     ...
     *last_op = *target;
     ...
     del_source(block, block->op1_to);
     block->op1_to = ((void *)0);
# 1377 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
    }
   }
   break;
  ...
  case 44:
   ...
   if ((last_op)->op1_type == (1<<0)) {
    int should_jmp = zend_is_true(&(op_array)->literals[(last_op)->op1.constant]);

    if (last_op->opcode == 43) {
     should_jmp = !should_jmp;
    }
    do { _zval_dtor((&(op_array)->literals[(last_op)->op1.constant]) ); do { (*(&(op_array)->literals[(last_op)->op1.constant])).u1.type_info = 1; } while (0); } while (0);
    (last_op)->op1_type = (1<<3);
    if (should_jmp) {

     last_op->opcode = 42;
     do { last_op->op1_type = last_op->op2_type; last_op->op1 = last_op->op2; } while (0);
     block->op1_to = block->op2_to;
     del_source(block, block->follow_to);
     block->op2_to = ((void *)0);
     block->follow_to = ((void *)0);
    } else {
   ...
   if (block->op2_to == block->follow_to) {
    ...
    if (last_op->op1_type == (1<<2)) {
     zend_op **Tsource = cfg->Tsource;
     zend_op *src = Tsource[(((zval*)(((char*)(((void *)0))) + ((int)(last_op->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))];
   ...
   if (block->op2_to) {
    ...
    uint32_t same_var = (((zval*)(((char*)(((void *)0))) + ((int)((last_op->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))));
    zend_op *target;
    zend_op *target_end;
...
next_target:
    ...
    while (target < target_end && target->opcode == 0) {
     target++;
    }
    ...
    if (target == target_end) {
     ...
     goto next_target;
    } else if (target->opcode == ((last_op->opcode) == 43 ? 44 : 43) &&

       ((target)->op1_type & ((1<<1)|(1<<4))) &&
       same_type == (target)->op1_type &&
       same_var == (((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))) &&
     ...
     { zend_block_source *__s = block->op2_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->op2_to->sources; block->op2_to->sources = __t; __t->from = block; } };
    } else if (target->opcode == ((last_op->opcode) == 43 ? 47 : 46) &&
       ((target)->op1_type & ((1<<1)|(1<<4))) &&
          same_type == (target)->op1_type &&
          same_var == (((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))) &&
       target_block->follow_to &&
   ...
   if (block->follow_to &&
       (last_op->opcode == 43 || last_op->opcode == 44)) {
    zend_op *target;
    zend_op *target_end;
  ...
  case 46:
   ...
   if (block->op2_to) {
    ...
    same_t[(((zval*)(((char*)(((void *)0))) + ((int)((last_op->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] |= (last_op)->op1_type;
    same_t[(((zval*)(((char*)(((void *)0))) + ((int)((last_op->result).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] |= (last_op)->result_type;
...
next_target_ex:
    ...
    if (target == target_end) {
     ...
     goto next_target_ex;
         ...
         ((target)->op1_type & ((1<<1)|(1<<4))) &&
         (same_t[(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] & (target)->op1_type) != 0 &&
         !target_block->protected) {
     ...
     { zend_block_source *__s = block->op2_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->op2_to->sources; block->op2_to->sources = __t; __t->from = block; } };
         ...
         target->opcode == ((last_op->opcode) == 46 ? 44 : 43) &&
            ((target)->op1_type & ((1<<1)|(1<<4))) &&
         (same_t[(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] & (target)->op1_type) != 0 &&
         !target_block->protected) {
     ...
     { zend_block_source *__s = block->op2_to->sources; while (__s && __s->from != block) __s = __s->next; if (__s == ((void *)0)) { zend_block_source *__t = zend_arena_alloc(&ctx->arena, sizeof(zend_block_source)); __t->next = block->op2_to->sources; block->op2_to->sources = __t; __t->from = block; } };
         ...
         target->opcode == ((last_op->opcode) == 46 ? 47 : 46) &&
            ((target)->op1_type & ((1<<1)|(1<<4))) &&
         (same_t[(((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] & (target)->op1_type) != 0 &&
         (same_t[(((zval*)(((char*)(((void *)0))) + ((int)((target->result).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))] & (target)->result_type) != 0 &&
         !target_block->protected) {
  ...
  case 45: {
   ...
   if ((last_op)->op1_type == (1<<0)) {
    if (!zend_is_true(&(op_array)->literals[(last_op)->op1.constant])) {
   ...
   if (last_op->opcode == 45 && block->op2_to) {
    zend_uchar same_type = (last_op)->op1_type;
    zend_uchar same_var = (((zval*)(((char*)(((void *)0))) + ((int)((last_op->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))));
    zend_op *target;
    zend_op *target_end;
    zend_code_block *target_block = block->op2_to;
...
next_target_znz:
    ...
    if (target == target_end) {
     ...
     goto next_target_znz;
         ...
         (target->opcode == 43 || target->opcode == 45) &&
         ((target)->op1_type & ((1<<1)|(1<<4))) &&
         same_type == (target)->op1_type &&
         same_var == (((zval*)(((char*)(((void *)0))) + ((int)((target->op1).var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))) &&
         !target_block->protected) {
...
# 1790 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
static void zend_t_usage(zend_code_block *block, zend_op_array *op_array, zend_bitset used_ext, zend_optimizer_ctx *ctx)
{
 ...
 usage = zend_arena_alloc(&ctx->arena, bitset_len * sizeof(zend_ulong));
 zend_bitset_clear(usage, bitset_len);
 defined_here = zend_arena_alloc(&ctx->arena, bitset_len * sizeof(zend_ulong));
 ...
 while (next_block) {
  ...
  while (opline<end) {
   do { if ((opline->op1_type & ((1<<2) | (1<<1))) && !zend_bitset_in(defined_here, (((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) && !zend_bitset_in(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))) { zend_bitset_incl(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))); } } while (0);
   if (opline->op2_type & ((1<<2) | (1<<1))) {
    if (opline->opcode == 78 || opline->opcode == 126) {

     zend_bitset_incl(defined_here, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    } else {
     do { if ((opline->op2_type & ((1<<2) | (1<<1))) && !zend_bitset_in(defined_here, (((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) && !zend_bitset_in(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))) { zend_bitset_incl(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)(opline->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))); } } while (0);
    }
   }

   if ((((opline->result_type & (1<<2)) && !(opline->result_type & (1<<5))) || opline->result_type == (1<<1))) {
    if (!zend_bitset_in(defined_here, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) && !zend_bitset_in(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) &&
     opline->opcode == 72) {

     zend_bitset_incl(used_ext, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    }
    zend_bitset_incl(defined_here, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
   }
   opline++;
  }
  next_block = next_block->next;
 }
# 1852 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/block_pass.c"
 while (block) {
  ...
  while (opline >= block->start_opline) {
   ...
   if ((opline->result_type == (1<<3) || ((opline->result_type & ((1<<2) | (1<<1))) && !zend_bitset_in(usage, (((zval*)(((char*)(((void *)0))) + ((int)(opline->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))))) {
    switch (opline->opcode) {
     case 23:
     case 24:
     case 25:
   ...
   if (opline->opcode == 72) {
    if ((opline)->op1_type == (1<<2) || (opline)->op1_type == (1<<1)) {
     zend_bitset_incl(usage, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    }
   } else {
    if ((((opline->result_type & (1<<2)) && !(opline->result_type & (1<<5))) || opline->result_type == (1<<1))) {
     zend_bitset_excl(usage, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
    }
   }

   if ((opline)->op1_type == (1<<2) || (opline)->op1_type == (1<<1)) {
    zend_bitset_incl(usage, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
   }

   if ((opline)->op2_type == (1<<2) || (opline)->op2_type == (1<<1)) {
    zend_bitset_incl(usage, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->op2.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
   }

   if (((opline)->result_type & (1<<2)) &&
                ((opline)->result_type & (1<<5)) &&
                zend_bitset_in(usage, (((zval*)(((char*)(((void *)0))) + ((int)((opline)->result.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))) {
    (opline)->result_type &= ~(1<<5);
    }
...
void optimize_cfg(zend_op_array *op_array, zend_optimizer_ctx *ctx)
{
 ...
 if (op_array->fn_flags & 0x20000000) {
  return;
 }
