# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/basic_functions.h" 1
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c" 2
...
static void php_array_element_dump(zval *zv, zend_ulong index, zend_string *key, int level)
{
 if (key == ((void *)0)) {
  ...
  php_output_write(((key)->val), ((key)->len));
  php_printf("\"]=>\n");
 }
...
static void php_object_property_dump(zval *zv, zend_ulong index, zend_string *key, int level)
{
 ...
 if (key == ((void *)0)) {
  ...
  int unmangle = zend_unmangle_property_name_ex(key, &class_name, &prop_name, ((void *)0));
  php_printf("%*c[", level + 1, ' ');
...
again:
 switch (zval_get_type(&(*(struc)))) {
  ...
  case 7:
   ...
   do { Bucket *_p = (myht)->arData; Bucket *_end = _p + (myht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num = _p->h; key = _p->key; val = _z; {
    php_array_element_dump(val, num, key, level);
   } } } while (0);
   if (level > 1 && ((myht)->u.flags & (1<<1))) {
    --myht->u.v.nApplyCount;
   }
   if (is_temp) {
   ...
   break;
  case 8:
   if ((((*(struc)).value.counted)->gc.u.v.flags & 0x07) > 0) {
    do { const char *__str = ("*RECURSION*\n"); php_output_write(__str, strlen(__str)); } while (0);
    return;
   }
   do { ((*(struc)).value.counted)->gc.u.v.flags = (((*(struc)).value.counted)->gc.u.v.flags & ~0x07) | ((((*(struc)).value.counted)->gc.u.v.flags & 0x07) + 1); } while (0);
   ...
   php_printf("%sobject(%s)#%d (%d) {\n", (is_ref ? "&" : ""), (class_name)->val, (((*(struc))).value.obj)->handle, myht ? zend_array_count(myht) : 0);
...
static void zval_object_property_dump(zval *zv, zend_ulong index, zend_string *key, int level)
{
 ...
 if (key == ((void *)0)) {
  ...
  zend_unmangle_property_name_ex(key, &class_name, &prop_name, ((void *)0));
  php_printf("%*c[", level + 1, ' ');
...
again:
 ...
 case 6:
  php_printf("%sstring(%zd) \"", (is_ref ? "&" : ""), ((*(struc)).value.str)->len);
  php_output_write((((*(struc)).value.str)->val), (((*(struc)).value.str)->len));
  php_printf("\" refcount(%u)\n", (((*(struc)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(struc) : 1);
  break;
 case 7:
  myht = (*(struc)).value.arr;
  if (level > 1 && ((myht)->u.flags & (1<<1)) && myht->u.v.nApplyCount++ > 1) {
  ...
  count = zend_array_count(myht);
  php_printf("%sarray(%d) refcount(%u){\n", (is_ref ? "&" : ""), count, (((*(struc)).u1.v.type_flags & (1<<2)) != 0) ? zval_refcount_p(struc) : 1);
  do { Bucket *_p = (myht)->arData; Bucket *_end = _p + (myht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; index = _p->h; key = _p->key; val = _z; {
 ...
 case 8:
  ...
  class_name = ((*(struc))).value.obj->handlers->get_class_name((*(struc)).value.obj);
  php_printf("%sobject(%s)#%d (%d) refcount(%u){\n", (is_ref ? "&" : ""), (class_name)->val, (((*(struc))).value.obj)->handle, myht ? zend_array_count(myht) : 0, zval_refcount_p(struc));
  zend_string_release(class_name);
  if (myht) {
   do { Bucket *_p = (myht)->arData; Bucket *_end = _p + (myht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; index = _p->h; key = _p->key; val = _z; {
...
# 383 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/var.c"
static void php_array_element_export(zval *zv, zend_ulong index, zend_string *key, int level, smart_str *buf)
{
 if (key == ((void *)0)) {
  do { char *tmp_spaces; size_t tmp_spaces_len; tmp_spaces_len = spprintf(&tmp_spaces, 0,"%*c", level+1, ' '); smart_str_appendl_ex((buf), (tmp_spaces), (tmp_spaces_len), 0); _efree((tmp_spaces) ); } while(0);;
  smart_str_append_long_ex((buf), ((zend_long) index), 0);
  ...
  smart_str_append_ex((buf), (tmp_str), 0);
  smart_str_appendl_ex((buf), ("' => "), (5), 0);
 ...
 smart_str_appendc_ex((buf), (','), 0);
 smart_str_appendc_ex((buf), ('\n'), 0);
}


static void php_object_element_export(zval *zv, zend_ulong index, zend_string *key, int level, smart_str *buf)
{
 do { char *tmp_spaces; size_t tmp_spaces_len; tmp_spaces_len = spprintf(&tmp_spaces, 0,"%*c", level + 2, ' '); smart_str_appendl_ex((buf), (tmp_spaces), (tmp_spaces_len), 0); _efree((tmp_spaces) ); } while(0);;
 if (key != ((void *)0)) {
  ...
  smart_str_appendc_ex((buf), ('\''), 0);
  smart_str_append_ex((buf), (pname_esc), 0);
  smart_str_appendc_ex((buf), ('\''), 0);
...
again:
 switch (zval_get_type(&(*(struc)))) {
  case 2:
   smart_str_appendl_ex((buf), ("false"), (5), 0);
   break;
  case 3:
   smart_str_appendl_ex((buf), ("true"), (4), 0);
   break;
  case 1:
   smart_str_appendl_ex((buf), ("NULL"), (4), 0);
   break;
  case 4:
   smart_str_append_long_ex((buf), ((*(struc)).value.lval), 0);
   break;
  case 5:
   tmp_len = spprintf(&tmp_str, 0,"%.*H", (core_globals.serialize_precision), (*(struc)).value.dval);
   smart_str_appendl_ex((buf), (tmp_str), (tmp_len), 0);
   ...
   if ((sizeof ((*(struc)).value.dval) == sizeof (float) ? __finitef ((*(struc)).value.dval) : sizeof ((*(struc)).value.dval) == sizeof (double) ? __finite ((*(struc)).value.dval) : __finitel ((*(struc)).value.dval)) && ((void *)0) == strchr(tmp_str, '.')) {
    smart_str_appendl_ex((buf), (".0"), (2), 0);
   }
   _efree((tmp_str) );
   break;
  case 6:
   ztmp = php_addcslashes((*(struc)).value.str, 0, "'\\", 2);
   ztmp2 = php_str_to_str((ztmp)->val, (ztmp)->len, "\0", 1, "' . \"\\0\" . '", 12);

   smart_str_appendc_ex((buf), ('\''), 0);
   smart_str_append_ex((buf), (ztmp2), 0);
   smart_str_appendc_ex((buf), ('\''), 0);
  ...
  case 7:
   myht = (*(struc)).value.arr;
   if (((myht)->u.flags & (1<<1)) && myht->u.v.nApplyCount++ > 0) {
    myht->u.v.nApplyCount--;
    smart_str_appendl_ex((buf), ("NULL"), (4), 0);
   ...
   smart_str_appendl_ex((buf), ("array (\n"), (8), 0);
   do { Bucket *_p = (myht)->arData; Bucket *_end = _p + (myht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; index = _p->h; key = _p->key; val = _z; {
  ...
  case 8:
   ...
   smart_str_append_ex((buf), (((*(struc)).value.obj->ce)->name), 0);
   smart_str_appendl_ex((buf), ("::__set_state(array(\n"), (21), 0);
...
void zif_var_export(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z|b", &var, &return_output) == FAILURE) {
  return;
 }
...
static inline zend_long php_add_var_hash(php_serialize_data_t data, zval *var)
{
 zval *zv;
 zend_ulong key;
 zend_bool is_ref = (zval_get_type(&(*(var))) == 10);

 data->n += 1;

 if (!is_ref && zval_get_type(&(*(var))) != 8) {
  return 0;
 }


 if (is_ref && zval_get_type(&(*(&(*(var)).value.ref->val))) == 8) {
  var = &(*(var)).value.ref->val;
 }



 key = (zend_ulong) (zend_uintptr_t) (*(var)).value.counted;
 ...
 if (zv) {
  ...
  zval zv_n;
  { zval *__z = (&zv_n); (*(__z)).value.lval = data->n; (*(__z)).u1.type_info = 4; };
  _zend_hash_index_add_new(&data->ht, key, &zv_n );





  _zend_hash_index_add_new(&data->ht, key + 1, var );
  zval_addref_p(var);
...
{
 smart_str_appendl_ex((buf), ("i:"), (2), 0);
 smart_str_append_long_ex((buf), (val), 0);
 smart_str_appendc_ex((buf), (';'), 0);
}
...
{
 smart_str_appendl_ex((buf), ("s:"), (2), 0);
 smart_str_append_unsigned_ex((buf), (len), 0);
 smart_str_appendl_ex((buf), (":\""), (2), 0);
 smart_str_appendl_ex((buf), (str), (len), 0);
 smart_str_appendl_ex((buf), ("\";"), (2), 0);
}
...
static inline zend_bool php_var_serialize_class_name(smart_str *buf, zval *struc)
{
 ...
 if (((*(struc)).value.obj->ce) == (basic_globals.incomplete_class)) { class_name = php_lookup_class_name(struc); if (!class_name) { class_name = zend_string_init("__PHP_Incomplete_Class", sizeof("__PHP_Incomplete_Class") - 1, 0); } incomplete_class = 1; } else { class_name = zend_string_copy(((*(struc)).value.obj->ce)->name); };
 smart_str_appendl_ex((buf), ("O:"), (2), 0);
 smart_str_append_unsigned_ex((buf), ((class_name)->len), 0);
 smart_str_appendl_ex((buf), (":\""), (2), 0);
 smart_str_append_ex((buf), (class_name), 0);
 smart_str_appendl_ex((buf), ("\":"), (2), 0);
 zend_string_release(class_name);
...
static HashTable *php_var_serialize_collect_names(HashTable *src, uint32_t count, zend_bool incomplete) {
 ...
 _zend_hash_init((ht), (count), (((void *)0)), (0) );
 do { Bucket *_p = (src)->arData; Bucket *_end = _p + (src)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; val = _z; {
  if (incomplete && strcmp((key)->val, "__PHP_Incomplete_Class_Name") == 0) {
   continue;
  }
  ...
  name = _zval_get_string((val));
  if (zend_hash_exists(ht, name)) {
   php_error_docref0(((void *)0), (1<<3L),
     "\"%s\" is returned from __sleep multiple times", (name)->val);
...
static void php_var_serialize_class(smart_str *buf, zval *struc, zval *retval_ptr, php_serialize_data_t var_hash)
{
 ...
 if (zval_get_type(&(*(retval_ptr))) == 7) {
  ht = (*(retval_ptr)).value.arr;
  count = zend_array_count(ht);
 } else if (zval_get_type(&(*(retval_ptr))) == 8) {
  ht = ((*(retval_ptr))).value.obj->handlers->get_properties(&(*(retval_ptr)));
  count = zend_array_count(ht);
  if (incomplete_class) {
   --count;
  }
 ...
 if (count > 0) {
  ...
  smart_str_append_unsigned_ex((buf), ((names)->nNumOfElements), 0);
  smart_str_appendl_ex((buf), (":{"), (2), 0);
  ...
  do { Bucket *_p = (names)->arData; Bucket *_end = _p + (names)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; name = _p->key; {
   if ((d = zend_hash_find(propers, name)) != ((void *)0)) {
    ...
    zend_class_entry *ce = (*(struc)).value.obj->ce;
    if (ce) {
     zend_string *prot_name, *priv_name;

     do {
      priv_name = zend_mangle_property_name(
        (ce->name)->val, (ce->name)->len, (name)->val, (name)->len, ce->type & 1);
  ...
  do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(names); } else if (sizeof(HashTable) <= 16) { _efree_16(names); } else if (sizeof(HashTable) <= 24) { _efree_24(names); } else if (sizeof(HashTable) <= 32) { _efree_32(names); } else if (sizeof(HashTable) <= 40) { _efree_40(names); } else if (sizeof(HashTable) <= 48) { _efree_48(names); } else if (sizeof(HashTable) <= 56) { _efree_56(names); } else if (sizeof(HashTable) <= 64) { _efree_64(names); } else if (sizeof(HashTable) <= 80) { _efree_80(names); } else if (sizeof(HashTable) <= 96) { _efree_96(names); } else if (sizeof(HashTable) <= 112) { _efree_112(names); } else if (sizeof(HashTable) <= 128) { _efree_128(names); } else if (sizeof(HashTable) <= 160) { _efree_160(names); } else if (sizeof(HashTable) <= 192) { _efree_192(names); } else if (sizeof(HashTable) <= 224) { _efree_224(names); } else if (sizeof(HashTable) <= 256) { _efree_256(names); } else if (sizeof(HashTable) <= 320) { _efree_320(names); } else if (sizeof(HashTable) <= 384) { _efree_384(names); } else if (sizeof(HashTable) <= 448) { _efree_448(names); } else if (sizeof(HashTable) <= 512) { _efree_512(names); } else if (sizeof(HashTable) <= 640) { _efree_640(names); } else if (sizeof(HashTable) <= 768) { _efree_768(names); } else if (sizeof(HashTable) <= 896) { _efree_896(names); } else if (sizeof(HashTable) <= 1024) { _efree_1024(names); } else if (sizeof(HashTable) <= 1280) { _efree_1280(names); } else if (sizeof(HashTable) <= 1536) { _efree_1536(names); } else if (sizeof(HashTable) <= 1792) { _efree_1792(names); } else if (sizeof(HashTable) <= 2048) { _efree_2048(names); } else if (sizeof(HashTable) <= 2560) { _efree_2560(names); } else if (sizeof(HashTable) <= 3072) { _efree_3072(names); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(names, sizeof(HashTable)); } else { _efree_huge(names, sizeof(HashTable)); } } else { _efree(names); } } while (0);
 } else {
  smart_str_appendl_ex((buf), ("0:{}"), (4), 0);
 }
}
...
static void php_var_serialize_intern(smart_str *buf, zval *struc, php_serialize_data_t var_hash)
{
 ...
 if (var_hash && (var_already = php_add_var_hash(var_hash, struc))) {
  if ((zval_get_type(&(*(struc))) == 10)) {
   smart_str_appendl_ex((buf), ("R:"), (2), 0);
   smart_str_append_long_ex((buf), (var_already), 0);
   smart_str_appendc_ex((buf), (';'), 0);
   return;
...
again:
 switch (zval_get_type(&(*(struc)))) {
  case 2:
   smart_str_appendl_ex((buf), ("b:0;"), (4), 0);
   return;

  case 3:
   smart_str_appendl_ex((buf), ("b:1;"), (4), 0);
   return;

  case 1:
   smart_str_appendl_ex((buf), ("N;"), (2), 0);
   return;
  ...
  case 5: {
    ...
    smart_str_appendl_ex((buf), ("d:"), (2), 0);
    s = (char *) _safe_emalloc(((core_globals.serialize_precision)), (1), (32 + 1) );
    php_gcvt((*(struc)).value.dval, (int)(core_globals.serialize_precision), '.', 'E', s);
    smart_str_appendl_ex(((buf)), ((s)), (strlen(s)), 0);
    smart_str_appendc_ex((buf), (';'), 0);
    _efree((s) );
    return;
   }
  ...
  case 8: {
    ...
    if (ce->serialize != ((void *)0)) {
     ...
     if (ce->serialize(struc, &serialized_data, &serialized_length, (zend_serialize_data *)var_hash) == SUCCESS) {
      smart_str_appendl_ex((buf), ("C:"), (2), 0);
      smart_str_append_unsigned_ex((buf), ((((*(struc)).value.obj->ce)->name)->len), 0);
      smart_str_appendl_ex((buf), (":\""), (2), 0);
      smart_str_append_ex((buf), (((*(struc)).value.obj->ce)->name), 0);
      smart_str_appendl_ex((buf), ("\":"), (2), 0);

      smart_str_append_unsigned_ex((buf), (serialized_length), 0);
      smart_str_appendl_ex((buf), (":{"), (2), 0);
      smart_str_appendl_ex((buf), ((char *) serialized_data), (serialized_length), 0);
      smart_str_appendc_ex((buf), ('}'), 0);
     } else {
      smart_str_appendl_ex((buf), ("N;"), (2), 0);
     }
    ...
    if (ce != (basic_globals.incomplete_class) && zend_hash_str_exists(&ce->function_table, "__sleep", sizeof("__sleep")-1)) {
     do { do { zval *__z = (&fname); zend_string *__s = (zend_string_init("__sleep", sizeof("__sleep") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
     ...
     if (res == SUCCESS) {
      if (zval_get_type(&(retval)) != 0) {
       if ((zval_get_type(&(*(&retval)))==7 ? (*(&retval)).value.arr : ((zval_get_type(&(*(&retval)))==8 ? (*(&retval)).value.obj->handlers->get_properties((&retval)) : ((void *)0))))) {
  ...
  case 7: {
   ...
   if (zval_get_type(&(*(struc))) == 7) {
    smart_str_appendl_ex((buf), ("a:"), (2), 0);
    myht = (*(struc)).value.arr;
   ...
   smart_str_append_unsigned_ex((buf), (i), 0);
   smart_str_appendl_ex((buf), (":{"), (2), 0);
   if (i > 0) {
    zend_string *key;
    zval *data;
    ...
    do { Bucket *_p = (myht)->arData; Bucket *_end = _p + (myht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; index = _p->h; key = _p->key; data = _z; {

     if (incomplete_class && strcmp((key)->val, "__PHP_Incomplete_Class_Name") == 0) {
      continue;
     }
  ...
  case 10:
   ...
   goto again;
  default:
   smart_str_appendl_ex((buf), ("i:0;"), (4), 0);
   return;
 }
}
...
void zif_serialize(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &struc) == FAILURE) {
  return;
 }
...
void zif_unserialize(zend_execute_data *execute_data, zval *return_value)
{
 ...
 zval *options = ((void *)0), *classes = ((void *)0);
 HashTable *class_hash = ((void *)0);

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|a", &buf, &buf_len, &options) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if(options != ((void *)0)) {
  classes = zend_hash_str_find((*(options)).value.arr, "allowed_classes", sizeof("allowed_classes")-1);
  if(classes && (zval_get_type(&(*(classes))) == 7 || !zend_is_true(classes))) {
   (class_hash) = (HashTable *) (__builtin_constant_p((sizeof(HashTable)) ) ? (((sizeof(HashTable)) <= 8) ? _emalloc_8() : (((sizeof(HashTable)) <= 16) ? _emalloc_16() : (((sizeof(HashTable)) <= 24) ? _emalloc_24() : (((sizeof(HashTable)) <= 32) ? _emalloc_32() : (((sizeof(HashTable)) <= 40) ? _emalloc_40() : (((sizeof(HashTable)) <= 48) ? _emalloc_48() : (((sizeof(HashTable)) <= 56) ? _emalloc_56() : (((sizeof(HashTable)) <= 64) ? _emalloc_64() : (((sizeof(HashTable)) <= 80) ? _emalloc_80() : (((sizeof(HashTable)) <= 96) ? _emalloc_96() : (((sizeof(HashTable)) <= 112) ? _emalloc_112() : (((sizeof(HashTable)) <= 128) ? _emalloc_128() : (((sizeof(HashTable)) <= 160) ? _emalloc_160() : (((sizeof(HashTable)) <= 192) ? _emalloc_192() : (((sizeof(HashTable)) <= 224) ? _emalloc_224() : (((sizeof(HashTable)) <= 256) ? _emalloc_256() : (((sizeof(HashTable)) <= 320) ? _emalloc_320() : (((sizeof(HashTable)) <= 384) ? _emalloc_384() : (((sizeof(HashTable)) <= 448) ? _emalloc_448() : (((sizeof(HashTable)) <= 512) ? _emalloc_512() : (((sizeof(HashTable)) <= 640) ? _emalloc_640() : (((sizeof(HashTable)) <= 768) ? _emalloc_768() : (((sizeof(HashTable)) <= 896) ? _emalloc_896() : (((sizeof(HashTable)) <= 1024) ? _emalloc_1024() : (((sizeof(HashTable)) <= 1280) ? _emalloc_1280() : (((sizeof(HashTable)) <= 1536) ? _emalloc_1536() : (((sizeof(HashTable)) <= 1792) ? _emalloc_1792() : (((sizeof(HashTable)) <= 2048) ? _emalloc_2048() : (((sizeof(HashTable)) <= 2560) ? _emalloc_2560() : (((sizeof(HashTable)) <= 3072) ? _emalloc_3072() : (((sizeof(HashTable)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(HashTable))) : _emalloc_huge((sizeof(HashTable)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(HashTable)) ) );
   _zend_hash_init((class_hash), ((zval_get_type(&(*(classes))) == 7)?((*(classes)).value.arr)->nNumOfElements:0), (((void *)0)), (0) );
  }
  if(class_hash && zval_get_type(&(*(classes))) == 7) {
   zval *entry;
   zend_string *lcname;

   do { Bucket *_p = ((*(classes)).value.arr)->arData; Bucket *_end = _p + ((*(classes)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
    if (zval_get_type(&(*(entry)))!=6) { if (zval_get_type(&(*(entry))) != 6) { _convert_to_string((entry) ); }; };
    lcname = zend_string_tolower((*(entry)).value.str);
 ...
 if (!php_var_unserialize_ex(return_value, &p, p + buf_len, &var_hash, class_hash)) {
  ...
  if (class_hash) {
   ...
   do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(class_hash); } else if (sizeof(HashTable) <= 16) { _efree_16(class_hash); } else if (sizeof(HashTable) <= 24) { _efree_24(class_hash); } else if (sizeof(HashTable) <= 32) { _efree_32(class_hash); } else if (sizeof(HashTable) <= 40) { _efree_40(class_hash); } else if (sizeof(HashTable) <= 48) { _efree_48(class_hash); } else if (sizeof(HashTable) <= 56) { _efree_56(class_hash); } else if (sizeof(HashTable) <= 64) { _efree_64(class_hash); } else if (sizeof(HashTable) <= 80) { _efree_80(class_hash); } else if (sizeof(HashTable) <= 96) { _efree_96(class_hash); } else if (sizeof(HashTable) <= 112) { _efree_112(class_hash); } else if (sizeof(HashTable) <= 128) { _efree_128(class_hash); } else if (sizeof(HashTable) <= 160) { _efree_160(class_hash); } else if (sizeof(HashTable) <= 192) { _efree_192(class_hash); } else if (sizeof(HashTable) <= 224) { _efree_224(class_hash); } else if (sizeof(HashTable) <= 256) { _efree_256(class_hash); } else if (sizeof(HashTable) <= 320) { _efree_320(class_hash); } else if (sizeof(HashTable) <= 384) { _efree_384(class_hash); } else if (sizeof(HashTable) <= 448) { _efree_448(class_hash); } else if (sizeof(HashTable) <= 512) { _efree_512(class_hash); } else if (sizeof(HashTable) <= 640) { _efree_640(class_hash); } else if (sizeof(HashTable) <= 768) { _efree_768(class_hash); } else if (sizeof(HashTable) <= 896) { _efree_896(class_hash); } else if (sizeof(HashTable) <= 1024) { _efree_1024(class_hash); } else if (sizeof(HashTable) <= 1280) { _efree_1280(class_hash); } else if (sizeof(HashTable) <= 1536) { _efree_1536(class_hash); } else if (sizeof(HashTable) <= 1792) { _efree_1792(class_hash); } else if (sizeof(HashTable) <= 2048) { _efree_2048(class_hash); } else if (sizeof(HashTable) <= 2560) { _efree_2560(class_hash); } else if (sizeof(HashTable) <= 3072) { _efree_3072(class_hash); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(class_hash, sizeof(HashTable)); } else { _efree_huge(class_hash, sizeof(HashTable)); } } else { _efree(class_hash); } } while (0);
  }
  _zval_ptr_dtor((return_value) );
  if (!(executor_globals.exception)) {
   php_error_docref0(((void *)0), (1<<3L), "Error at offset " "%" "l" "d" " of %zd bytes",
...
void zif_memory_get_usage(zend_execute_data *execute_data, zval *return_value) {
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|b", &real_usage) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
