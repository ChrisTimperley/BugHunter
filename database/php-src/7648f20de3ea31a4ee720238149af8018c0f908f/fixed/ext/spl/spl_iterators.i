# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_functions.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_functions.h"
typedef zend_object* (*create_object_func_t)(zend_class_entry *class_type);
# 52 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_functions.h"
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
static inline void spl_instantiate_arg_n(zend_class_entry *pce, zval *retval, int argc, zval *argv)
{
 ...
 do { zval *__z = (&fci.function_name); zend_string *__s = (func->common.function_name); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
__attribute__ ((visibility("default"))) char* spl_filesystem_object_get_path(spl_filesystem_object *intern, size_t *len);
...
static inline spl_filesystem_iterator* spl_filesystem_object_to_iterator(spl_filesystem_object *obj)
{
 ...
 it = _ecalloc((1), (sizeof(spl_filesystem_iterator)) );
 it->object = (void *)obj;
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.h"
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c" 2
...
static const zend_internal_arg_info arginfo_recursive_it_void[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

const zend_function_entry spl_funcs_RecursiveIterator[] = {
 { "hasChildren", ((void *)0), arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getChildren", ((void *)0), arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
...
static inline spl_recursive_it_object *spl_recursive_it_from_obj(zend_object *obj) {
 return (spl_recursive_it_object*)((char*)(obj) - ((zend_long) (((char *) (&(((spl_recursive_it_object*)((void *)0))->std))) - ((char *) ((void *)0)))));
}
# 171 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
static void spl_recursive_it_dtor(zend_object_iterator *_iter)
{
 ...
 object->iterators = _erealloc((object->iterators), (sizeof(spl_sub_iterator)) );
 object->level = 0;
...
static void spl_recursive_it_move_forward_ex(spl_recursive_it_object *object, zval *zthis)
{
 ...
 do { if(!(object)->iterators) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (iterator) = (object)->iterators[(object)->level].iterator; } while (0);
  ...
  switch (object->iterators[object->level].state) {
   ...
   case RS_CHILD:
    ...
    if (zval_get_type(&(child)) == 0 || zval_get_type(&(child)) != 8 ||
      !((ce = ((child).value.obj->ce)) && instanceof_function(ce, spl_ce_RecursiveIterator))) {
     _zval_ptr_dtor((&child) );
    ...
    object->iterators = _erealloc((object->iterators), (sizeof(spl_sub_iterator) * (++object->level+1)) );
    sub_iter = ce->get_iterator(ce, &child, 0);
    do { zval *_z1 = (&object->iterators[object->level].zobject); const zval *_z2 = (&child); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
static void spl_recursive_it_rewind_ex(spl_recursive_it_object *object, zval *zthis)
{
 ...
 do { if(!(object)->iterators) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (sub_iter) = (object)->iterators[(object)->level].iterator; } while (0);
...
static zend_object_iterator *spl_recursive_it_get_iterator(zend_class_entry *ce, zval *zobject, int by_ref)
{
 ...
 iterator = (__builtin_constant_p((sizeof(spl_recursive_it_iterator)) ) ? (((sizeof(spl_recursive_it_iterator)) <= 8) ? _emalloc_8() : (((sizeof(spl_recursive_it_iterator)) <= 16) ? _emalloc_16() : (((sizeof(spl_recursive_it_iterator)) <= 24) ? _emalloc_24() : (((sizeof(spl_recursive_it_iterator)) <= 32) ? _emalloc_32() : (((sizeof(spl_recursive_it_iterator)) <= 40) ? _emalloc_40() : (((sizeof(spl_recursive_it_iterator)) <= 48) ? _emalloc_48() : (((sizeof(spl_recursive_it_iterator)) <= 56) ? _emalloc_56() : (((sizeof(spl_recursive_it_iterator)) <= 64) ? _emalloc_64() : (((sizeof(spl_recursive_it_iterator)) <= 80) ? _emalloc_80() : (((sizeof(spl_recursive_it_iterator)) <= 96) ? _emalloc_96() : (((sizeof(spl_recursive_it_iterator)) <= 112) ? _emalloc_112() : (((sizeof(spl_recursive_it_iterator)) <= 128) ? _emalloc_128() : (((sizeof(spl_recursive_it_iterator)) <= 160) ? _emalloc_160() : (((sizeof(spl_recursive_it_iterator)) <= 192) ? _emalloc_192() : (((sizeof(spl_recursive_it_iterator)) <= 224) ? _emalloc_224() : (((sizeof(spl_recursive_it_iterator)) <= 256) ? _emalloc_256() : (((sizeof(spl_recursive_it_iterator)) <= 320) ? _emalloc_320() : (((sizeof(spl_recursive_it_iterator)) <= 384) ? _emalloc_384() : (((sizeof(spl_recursive_it_iterator)) <= 448) ? _emalloc_448() : (((sizeof(spl_recursive_it_iterator)) <= 512) ? _emalloc_512() : (((sizeof(spl_recursive_it_iterator)) <= 640) ? _emalloc_640() : (((sizeof(spl_recursive_it_iterator)) <= 768) ? _emalloc_768() : (((sizeof(spl_recursive_it_iterator)) <= 896) ? _emalloc_896() : (((sizeof(spl_recursive_it_iterator)) <= 1024) ? _emalloc_1024() : (((sizeof(spl_recursive_it_iterator)) <= 1280) ? _emalloc_1280() : (((sizeof(spl_recursive_it_iterator)) <= 1536) ? _emalloc_1536() : (((sizeof(spl_recursive_it_iterator)) <= 1792) ? _emalloc_1792() : (((sizeof(spl_recursive_it_iterator)) <= 2048) ? _emalloc_2048() : (((sizeof(spl_recursive_it_iterator)) <= 2560) ? _emalloc_2560() : (((sizeof(spl_recursive_it_iterator)) <= 3072) ? _emalloc_3072() : (((sizeof(spl_recursive_it_iterator)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(spl_recursive_it_iterator))) : _emalloc_huge((sizeof(spl_recursive_it_iterator)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(spl_recursive_it_iterator)) ) );
 ...
 do { zval *_z1 = (&iterator->intern.data); const zval *_z2 = (zobject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
static void spl_recursive_it_it_construct(zend_execute_data *execute_data, zval *return_value, zend_class_entry *ce_base, zend_class_entry *ce_inner, recursive_it_it_type rit_type)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 ...
 switch (rit_type) {
  case RIT_RecursiveTreeIterator: {
   zval caching_it_flags, *user_caching_it_flags = ((void *)0);
   mode = RIT_SELF_FIRST;
   flags = RTIT_BYPASS_KEY;

   if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "o|lzl", &iterator, &flags, &user_caching_it_flags, &mode) == SUCCESS) {
    if (instanceof_function(((*(iterator)).value.obj->ce), zend_ce_aggregate)) {
     zend_call_method(iterator, ((*(iterator)).value.obj->ce), &((*(iterator)).value.obj->ce)->iterator_funcs.zf_new_iterator, "getiterator", sizeof("getiterator")-1, &aggregate_retval, 0, ((void *)0), ((void *)0));
    ...
    if (user_caching_it_flags) {
     do { zval *_z1 = (&caching_it_flags); const zval *_z2 = (user_caching_it_flags); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
    } else {
  ...
  default: {
   ...
   if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "o|ll", &iterator, &mode, &flags) == SUCCESS) {
    if (instanceof_function(((*(iterator)).value.obj->ce), zend_ce_aggregate)) {
     zend_call_method(iterator, ((*(iterator)).value.obj->ce), &((*(iterator)).value.obj->ce)->iterator_funcs.zf_new_iterator, "getiterator", sizeof("getiterator")-1, &aggregate_retval, 0, ((void *)0), ((void *)0));
     iterator = &aggregate_retval;
    } else {
 ...
 if (!iterator || !instanceof_function(((*(iterator)).value.obj->ce), spl_ce_RecursiveIterator)) {
  if (iterator) {
   _zval_ptr_dtor((iterator) );
  }
 ...
 intern->iterators = (__builtin_constant_p((sizeof(spl_sub_iterator)) ) ? (((sizeof(spl_sub_iterator)) <= 8) ? _emalloc_8() : (((sizeof(spl_sub_iterator)) <= 16) ? _emalloc_16() : (((sizeof(spl_sub_iterator)) <= 24) ? _emalloc_24() : (((sizeof(spl_sub_iterator)) <= 32) ? _emalloc_32() : (((sizeof(spl_sub_iterator)) <= 40) ? _emalloc_40() : (((sizeof(spl_sub_iterator)) <= 48) ? _emalloc_48() : (((sizeof(spl_sub_iterator)) <= 56) ? _emalloc_56() : (((sizeof(spl_sub_iterator)) <= 64) ? _emalloc_64() : (((sizeof(spl_sub_iterator)) <= 80) ? _emalloc_80() : (((sizeof(spl_sub_iterator)) <= 96) ? _emalloc_96() : (((sizeof(spl_sub_iterator)) <= 112) ? _emalloc_112() : (((sizeof(spl_sub_iterator)) <= 128) ? _emalloc_128() : (((sizeof(spl_sub_iterator)) <= 160) ? _emalloc_160() : (((sizeof(spl_sub_iterator)) <= 192) ? _emalloc_192() : (((sizeof(spl_sub_iterator)) <= 224) ? _emalloc_224() : (((sizeof(spl_sub_iterator)) <= 256) ? _emalloc_256() : (((sizeof(spl_sub_iterator)) <= 320) ? _emalloc_320() : (((sizeof(spl_sub_iterator)) <= 384) ? _emalloc_384() : (((sizeof(spl_sub_iterator)) <= 448) ? _emalloc_448() : (((sizeof(spl_sub_iterator)) <= 512) ? _emalloc_512() : (((sizeof(spl_sub_iterator)) <= 640) ? _emalloc_640() : (((sizeof(spl_sub_iterator)) <= 768) ? _emalloc_768() : (((sizeof(spl_sub_iterator)) <= 896) ? _emalloc_896() : (((sizeof(spl_sub_iterator)) <= 1024) ? _emalloc_1024() : (((sizeof(spl_sub_iterator)) <= 1280) ? _emalloc_1280() : (((sizeof(spl_sub_iterator)) <= 1536) ? _emalloc_1536() : (((sizeof(spl_sub_iterator)) <= 1792) ? _emalloc_1792() : (((sizeof(spl_sub_iterator)) <= 2048) ? _emalloc_2048() : (((sizeof(spl_sub_iterator)) <= 2560) ? _emalloc_2560() : (((sizeof(spl_sub_iterator)) <= 3072) ? _emalloc_3072() : (((sizeof(spl_sub_iterator)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(spl_sub_iterator))) : _emalloc_huge((sizeof(spl_sub_iterator)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(spl_sub_iterator)) ) );
 intern->level = 0;
 intern->mode = mode;
 intern->flags = (int)flags;
 intern->max_depth = -1;
 intern->in_iteration = 0;
 intern->ce = ((*(object)).value.obj->ce);
 ...
 do { zval *_z1 = (&intern->iterators[0].zobject); const zval *_z2 = (iterator); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
void zim_spl_RecursiveIteratorIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_it_construct(execute_data, return_value, spl_ce_RecursiveIteratorIterator, zend_ce_iterator, RIT_RecursiveIteratorIterator);
}



void zim_spl_RecursiveIteratorIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 spl_recursive_it_rewind_ex(object, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)));
}



void zim_spl_RecursiveIteratorIterator_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 { do { (*(return_value)).u1.type_info = (spl_recursive_it_valid_ex(object, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))) == SUCCESS) ? 3 : 2; } while (0); return; };
}



void zim_spl_RecursiveIteratorIterator_key(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_object_iterator *iterator;
...
void zim_spl_RecursiveIteratorIterator_current(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_object_iterator *iterator;
 zval *data;
 ...
 if (data) {
  ...
  do { zval *_z1 = (return_value); const zval *_z2 = (data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
}



void zim_spl_RecursiveIteratorIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 spl_recursive_it_move_forward_ex(object, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)));
}



void zim_spl_RecursiveIteratorIterator_getDepth(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_RecursiveIteratorIterator_getSubIterator(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_long level = object->level;
 zval *value;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|l", &level) == FAILURE) {
  return;
 }
 ...
 do { zval *_z1 = (return_value); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}



void zim_spl_RecursiveIteratorIterator_getInnerIterator(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zval *zobject;
 ...
 do { if(!(object)->iterators) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (zobject) = &(object)->iterators[(object)->level].zobject; } while (0);

 do { if (__builtin_expect(!!((zval_get_type(&(*(zobject))) == 10)), 0)) { (zobject) = &(*(zobject)).value.ref->val; } } while (0);
 do { zval *_z1 = (return_value); const zval *_z2 = (zobject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}



void zim_spl_RecursiveIteratorIterator_beginIteration(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_RecursiveIteratorIterator_endIteration(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_RecursiveIteratorIterator_callHasChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_class_entry *ce;
 zval *zobject;
 ...
 do { if(!(object)->iterators) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (ce) = (object)->iterators[(object)->level].ce; } while (0);
...
void zim_spl_RecursiveIteratorIterator_callGetChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_class_entry *ce;
 zval *zobject;
...
void zim_spl_RecursiveIteratorIterator_beginChildren(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_RecursiveIteratorIterator_endChildren(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_RecursiveIteratorIterator_nextElement(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_RecursiveIteratorIterator_setMaxDepth(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_long max_depth = -1;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|l", &max_depth) == FAILURE) {
  return;
 }
 if (max_depth < -1) {
...
void zim_spl_RecursiveIteratorIterator_getMaxDepth(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
static union _zend_function *spl_recursive_it_get_method(zend_object **zobject, zend_string *method, const zval *key)
{
 ...
 if (!object->iterators) {
  php_error_docref0(((void *)0), (1<<0L), "The %s instance wasn't initialized properly", ((*zobject)->ce->name)->val);
 }
 zobj = &object->iterators[level].zobject;

 function_handler = std_object_handlers.get_method(zobject, method, key);
 if (!function_handler) {
  if ((function_handler = zend_hash_find_ptr(&((*(zobj)).value.obj->ce)->function_table, method)) == ((void *)0)) {
...
static zend_object *spl_RecursiveIteratorIterator_new_ex(zend_class_entry *class_type, int init_prefix)
{
 ...
 intern = _ecalloc((1), (sizeof(spl_recursive_it_object) + zend_object_properties_size(class_type)) );

 if (init_prefix) {
  smart_str_appendl_ex((&intern->prefix[0]), (""), (0), 0);
  smart_str_appendl_ex((&intern->prefix[1]), ("| "), (2), 0);
  smart_str_appendl_ex((&intern->prefix[2]), ("  "), (2), 0);
  smart_str_appendl_ex((&intern->prefix[3]), ("|-"), (2), 0);
  smart_str_appendl_ex((&intern->prefix[4]), ("\\-"), (2), 0);
  smart_str_appendl_ex((&intern->prefix[5]), (""), (0), 0);

  smart_str_appendl_ex((&intern->postfix[0]), (""), (0), 0);
 }
...
static const zend_internal_arg_info arginfo_recursive_it___construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Traversable", 8, 0, 0, 0 },
 { "mode", ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_recursive_it_getSubIterator[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "level", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_recursive_it_setMaxDepth[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "max_depth", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_RecursiveIteratorIterator[] = {
 { "__construct", zim_spl_RecursiveIteratorIterator___construct, arginfo_recursive_it___construct, (uint32_t) (sizeof(arginfo_recursive_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_RecursiveIteratorIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_RecursiveIteratorIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_RecursiveIteratorIterator_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_RecursiveIteratorIterator_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_RecursiveIteratorIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getDepth", zim_spl_RecursiveIteratorIterator_getDepth, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getSubIterator", zim_spl_RecursiveIteratorIterator_getSubIterator, arginfo_recursive_it_getSubIterator, (uint32_t) (sizeof(arginfo_recursive_it_getSubIterator)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_RecursiveIteratorIterator_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "beginIteration", zim_spl_RecursiveIteratorIterator_beginIteration, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "endIteration", zim_spl_RecursiveIteratorIterator_endIteration, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "callHasChildren", zim_spl_RecursiveIteratorIterator_callHasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "callGetChildren", zim_spl_RecursiveIteratorIterator_callGetChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "beginChildren", zim_spl_RecursiveIteratorIterator_beginChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "endChildren", zim_spl_RecursiveIteratorIterator_endChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "nextElement", zim_spl_RecursiveIteratorIterator_nextElement, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setMaxDepth", zim_spl_RecursiveIteratorIterator_setMaxDepth, arginfo_recursive_it_setMaxDepth, (uint32_t) (sizeof(arginfo_recursive_it_setMaxDepth)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getMaxDepth", zim_spl_RecursiveIteratorIterator_getMaxDepth, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
static void spl_recursive_tree_iterator_get_prefix(spl_recursive_it_object *object, zval *return_value)
{
 ...
 smart_str_appendl_ex((&str), ((object->prefix[0].s)->val), ((object->prefix[0].s)->len), 0);
 ...
 for (level = 0; level < object->level; ++level) {
  ...
  if (zval_get_type(&(has_next)) != 0) {
   if (zval_get_type(&(has_next)) == 3) {
    smart_str_appendl_ex((&str), ((object->prefix[1].s)->val), ((object->prefix[1].s)->len), 0);
   } else {
    smart_str_appendl_ex((&str), ((object->prefix[2].s)->val), ((object->prefix[2].s)->len), 0);
   }
 ...
 if (zval_get_type(&(has_next)) != 0) {
  if (zval_get_type(&(has_next)) == 3) {
   smart_str_appendl_ex((&str), ((object->prefix[3].s)->val), ((object->prefix[3].s)->len), 0);
  } else {
   smart_str_appendl_ex((&str), ((object->prefix[4].s)->val), ((object->prefix[4].s)->len), 0);
  }
  _zval_ptr_dtor((&has_next) );
 }

 smart_str_appendl_ex((&str), ((object->prefix[5].s)->val), ((object->prefix[5].s)->len), 0);
 smart_str_0(&str);

 { do { zval *__z = (return_value); zend_string *__s = (str.s); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
static void spl_recursive_tree_iterator_get_entry(spl_recursive_it_object *object, zval *return_value)
{
 ...
 if (data) {
  ...
  if (zval_get_type(&(*(data))) == 7) {
   do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init("Array", sizeof("Array")-1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
  } else {
   do { zval *_z1 = (return_value); const zval *_z2 = (data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
{
 do { zval *__z = (return_value); zend_string *__s = (object->postfix[0].s); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 zval_addref_p(return_value);
}



void zim_spl_RecursiveTreeIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_it_construct(execute_data, return_value, spl_ce_RecursiveTreeIterator, zend_ce_iterator, RIT_RecursiveTreeIterator);
}



void zim_spl_RecursiveTreeIterator_setPrefixPart(zend_execute_data *execute_data, zval *return_value)
{
 zend_long part;
 char* prefix;
 size_t prefix_len;
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "ls", &part, &prefix, &prefix_len) == FAILURE) {
  return;
 }
 ...
 smart_str_appendl_ex((&object->prefix[part]), (prefix), (prefix_len), 0);
}



void zim_spl_RecursiveTreeIterator_getPrefix(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_RecursiveTreeIterator_setPostfix(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 char* postfix;
 size_t postfix_len;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &postfix, &postfix_len) == FAILURE) {
  return;
 }

 smart_str_free(&object->postfix[0]);
 smart_str_appendl_ex((&object->postfix[0]), (postfix), (postfix_len), 0);
}



void zim_spl_RecursiveTreeIterator_getEntry(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_RecursiveTreeIterator_getPostfix(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_RecursiveTreeIterator_current(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 str = zend_string_alloc(((prefix).value.str)->len + ((entry).value.str)->len + ((postfix).value.str)->len, 0);
 ptr = (str)->val;
...
void zim_spl_RecursiveTreeIterator_key(zend_execute_data *execute_data, zval *return_value)
{
 spl_recursive_it_object *object = spl_recursive_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zend_object_iterator *iterator;
 ...
 str = zend_string_alloc(((prefix).value.str)->len + ((key).value.str)->len + ((postfix).value.str)->len, 0);
 ptr = (str)->val;
...
static const zend_internal_arg_info arginfo_recursive_tree_it___construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Traversable", 8, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
 { "caching_it_flags", ((void *)0), 0, 0, 0, 0 },
 { "mode", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_recursive_tree_it_setPrefixPart[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "part", ((void *)0), 0, 0, 0, 0 },
 { "value", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_RecursiveTreeIterator[] = {
 { "__construct", zim_spl_RecursiveTreeIterator___construct, arginfo_recursive_tree_it___construct, (uint32_t) (sizeof(arginfo_recursive_tree_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_RecursiveIteratorIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_RecursiveIteratorIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_RecursiveTreeIterator_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_RecursiveTreeIterator_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_RecursiveIteratorIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "beginIteration", zim_spl_RecursiveIteratorIterator_beginIteration, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "endIteration", zim_spl_RecursiveIteratorIterator_endIteration, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "callHasChildren", zim_spl_RecursiveIteratorIterator_callHasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 ...
 { "endChildren", zim_spl_RecursiveIteratorIterator_endChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "nextElement", zim_spl_RecursiveIteratorIterator_nextElement, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getPrefix", zim_spl_RecursiveTreeIterator_getPrefix, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setPrefixPart", zim_spl_RecursiveTreeIterator_setPrefixPart, arginfo_recursive_tree_it_setPrefixPart, (uint32_t) (sizeof(arginfo_recursive_tree_it_setPrefixPart)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getEntry", zim_spl_RecursiveTreeIterator_getEntry, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setPostfix", zim_spl_RecursiveTreeIterator_setPostfix, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getPostfix", zim_spl_RecursiveTreeIterator_getPostfix, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
# 1361 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
...
# 1436 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
...
static spl_dual_it_object* spl_dual_it_construct(zend_execute_data *execute_data, zval *return_value, zend_class_entry *ce_base, zend_class_entry *ce_inner, dual_it_type dit_type)
{
 zval *zobject, retval;
 spl_dual_it_object *intern;
 ...
 intern = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 switch (dit_type) {
  case DIT_LimitIterator: {
   ...
   if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "O|ll", &zobject, ce_inner, &intern->u.limit.offset, &intern->u.limit.count) == FAILURE) {
    return ((void *)0);
   }
  ...
  case DIT_RecursiveCachingIterator: {
   ...
   if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "O|l", &zobject, ce_inner, &flags) == FAILURE) {
    return ((void *)0);
   }
  ...
  case DIT_IteratorIterator: {
   ...
   if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "O|S", &zobject, ce_inner, &class_name) == FAILURE) {
    return ((void *)0);
   }
   ...
   if (!instanceof_function(ce, zend_ce_iterator)) {
    ...
    if (instanceof_function(ce, zend_ce_aggregate)) {
     ...
     if (zval_get_type(&(retval)) != 8 || !instanceof_function(((retval).value.obj->ce), zend_ce_traversable)) {
  ...
  case DIT_RecursiveRegexIterator: {
   ...
   intern->u.regex.use_flags = (execute_data)->This.u2.num_args >= 5;
   intern->u.regex.flags = 0;
   intern->u.regex.preg_flags = 0;
   if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "OS|lll", &zobject, ce_inner, &regex, &mode, &intern->u.regex.flags, &intern->u.regex.preg_flags) == FAILURE) {
    return ((void *)0);
   }
  ...
  case DIT_RecursiveCallbackFilterIterator: {
   _spl_cbfilter_it_intern *cfi = (__builtin_constant_p((sizeof(*cfi)) ) ? (((sizeof(*cfi)) <= 8) ? _emalloc_8() : (((sizeof(*cfi)) <= 16) ? _emalloc_16() : (((sizeof(*cfi)) <= 24) ? _emalloc_24() : (((sizeof(*cfi)) <= 32) ? _emalloc_32() : (((sizeof(*cfi)) <= 40) ? _emalloc_40() : (((sizeof(*cfi)) <= 48) ? _emalloc_48() : (((sizeof(*cfi)) <= 56) ? _emalloc_56() : (((sizeof(*cfi)) <= 64) ? _emalloc_64() : (((sizeof(*cfi)) <= 80) ? _emalloc_80() : (((sizeof(*cfi)) <= 96) ? _emalloc_96() : (((sizeof(*cfi)) <= 112) ? _emalloc_112() : (((sizeof(*cfi)) <= 128) ? _emalloc_128() : (((sizeof(*cfi)) <= 160) ? _emalloc_160() : (((sizeof(*cfi)) <= 192) ? _emalloc_192() : (((sizeof(*cfi)) <= 224) ? _emalloc_224() : (((sizeof(*cfi)) <= 256) ? _emalloc_256() : (((sizeof(*cfi)) <= 320) ? _emalloc_320() : (((sizeof(*cfi)) <= 384) ? _emalloc_384() : (((sizeof(*cfi)) <= 448) ? _emalloc_448() : (((sizeof(*cfi)) <= 512) ? _emalloc_512() : (((sizeof(*cfi)) <= 640) ? _emalloc_640() : (((sizeof(*cfi)) <= 768) ? _emalloc_768() : (((sizeof(*cfi)) <= 896) ? _emalloc_896() : (((sizeof(*cfi)) <= 1024) ? _emalloc_1024() : (((sizeof(*cfi)) <= 1280) ? _emalloc_1280() : (((sizeof(*cfi)) <= 1536) ? _emalloc_1536() : (((sizeof(*cfi)) <= 1792) ? _emalloc_1792() : (((sizeof(*cfi)) <= 2048) ? _emalloc_2048() : (((sizeof(*cfi)) <= 2560) ? _emalloc_2560() : (((sizeof(*cfi)) <= 3072) ? _emalloc_3072() : (((sizeof(*cfi)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(*cfi))) : _emalloc_huge((sizeof(*cfi)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(*cfi)) ) );
   cfi->fci.object = ((void *)0);
   if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "Of", &zobject, ce_inner, &cfi->fci, &cfi->fcc) == FAILURE) {
    _efree((cfi) );
    return ((void *)0);
   }
   if ((((*(&cfi->fci.function_name)).u1.v.type_flags & (1<<2)) != 0)) {
  ...
  default:
   if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "O", &zobject, ce_inner) == FAILURE) {
    return ((void *)0);
   }
   break;
 }
 ...
 if (inc_refcount) {
  do { zval *_z1 = (&intern->inner.zobject); const zval *_z2 = (zobject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 } else {
  do { zval *_z1 = (&intern->inner.zobject); const zval *_z2 = (zobject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }

 intern->inner.ce = dit_type == DIT_IteratorIterator ? ce : ((*(zobject)).value.obj->ce);
...
void zim_spl_FilterIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_FilterIterator, zend_ce_iterator, DIT_FilterIterator);
}



void zim_spl_CallbackFilterIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_CallbackFilterIterator, zend_ce_iterator, DIT_CallbackFilterIterator);
}
...
void zim_spl_dual_it_getInnerIterator(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 do { spl_dual_it_object *it = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (it->dit_type == DIT_Unknown) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (intern) = it; } while (0);
...
static inline int spl_dual_it_fetch(spl_dual_it_object *intern, int check_more)
{
 ...
 if (!check_more || spl_dual_it_valid(intern) == SUCCESS) {
  ...
  if (data) {
   do { zval *_z1 = (&intern->current.data); const zval *_z2 = (data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
...
void zim_spl_dual_it_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_dual_it_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
# 1776 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
void zim_spl_dual_it_key(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
# 1804 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
void zim_spl_dual_it_current(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_dual_it_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_FilterIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 do { spl_dual_it_object *it = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (it->dit_type == DIT_Unknown) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (intern) = it; } while (0);
 spl_filter_it_rewind(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), intern);
}



void zim_spl_FilterIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 do { spl_dual_it_object *it = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (it->dit_type == DIT_Unknown) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (intern) = it; } while (0);
 spl_filter_it_next(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), intern);
}



void zim_spl_RecursiveCallbackFilterIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_RecursiveCallbackFilterIterator, spl_ce_RecursiveIterator, DIT_RecursiveCallbackFilterIterator);
}




void zim_spl_RecursiveFilterIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_RecursiveFilterIterator, spl_ce_RecursiveIterator, DIT_RecursiveFilterIterator);
}



void zim_spl_RecursiveFilterIterator_hasChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval retval;
 ...
 if (zval_get_type(&(retval)) != 0) {
  { do { zval *__z = (return_value); zval *__zv = (&retval); if (__builtin_expect(!!(!(zval_get_type(&(*(__zv))) == 10)), 1)) { if (0 && !1) { do { zval *_z1 = (__z); const zval *_z2 = (__zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0); } else { do { zval *_z1 = (__z); const zval *_z2 = (__zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); } } else { do { zval *_z1 = (__z); const zval *_z2 = (&(*(__zv)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0); if (1 || !0) { _zval_ptr_dtor((__zv) ); } } } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
...
void zim_spl_RecursiveFilterIterator_getChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval retval;
 ...
 if (!(executor_globals.exception) && zval_get_type(&(retval)) != 0) {
  spl_instantiate_arg_ex1(((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce), return_value, &retval);
 }
 _zval_ptr_dtor((&retval) );
}
...
void zim_spl_RecursiveCallbackFilterIterator_getChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval retval;
 ...
 zend_call_method(&intern->inner.zobject, intern->inner.ce, ((void *)0), "getchildren", sizeof("getchildren")-1, &retval, 0, ((void *)0), ((void *)0));
 if (!(executor_globals.exception) && zval_get_type(&(retval)) != 0) {
  spl_instantiate_arg_ex2(((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce), return_value, &retval, &intern->u.cbfilter->fci.function_name);
 }
 _zval_ptr_dtor((&retval) );
}


void zim_spl_ParentIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_ParentIterator, spl_ce_RecursiveIterator, DIT_ParentIterator);
}




void zim_spl_RegexIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_RegexIterator, zend_ce_iterator, DIT_RegexIterator);
}



void zim_spl_CallbackFilterIterator_accept(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 do { zval *_z1 = (&params[0]); const zval *_z2 = (&intern->current.data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (&params[1]); const zval *_z2 = (&intern->current.key); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (&params[2]); const zval *_z2 = (&intern->inner.zobject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 ...
 if (zend_call_function(fci, fcc) != SUCCESS || (zval_get_type(&(*(return_value))) == 0)) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 do { zval *_z1 = (&intern->current.data); const zval *_z2 = (&params[0]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (&intern->current.key); const zval *_z2 = (&params[1]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
}




void zim_spl_RegexIterator_accept(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 if (zval_get_type(&(intern->current.data)) == 0) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 } else if (zval_get_type(&(intern->current.data)) == 7) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (intern->u.regex.flags & REGIT_USE_KEY) {
  subject = _zval_get_string((&intern->current.key));
 } else {
  subject = _zval_get_string((&intern->current.data));
 }
 ...
 switch (intern->u.regex.mode)
 {
  ...
  case REGIT_MODE_MATCH:
   ...
   if (intern->u.regex.pce->extra) {
    intern->u.regex.pce->extra->flags &= ~0x0020;
   }

   count = php_pcre_exec(intern->u.regex.pce->re, intern->u.regex.pce->extra, (subject)->val, (subject)->len, 0, 0, ((void *)0), 0);
  ...
  case REGIT_MODE_GET_MATCH:
   ...
   do { (*(return_value)).u1.type_info = ((zcount).value.lval > 0) ? 3 : 2; } while (0);
   break;
  ...
  case REGIT_MODE_REPLACE:
   replacement = zend_read_property(intern->std.ce, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "replacement", sizeof("replacement")-1, 1, &rv);
   if (zval_get_type(&(*(replacement))) != 6) {
    do { zval *_z1 = (&tmp_replacement); const zval *_z2 = (replacement); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   ...
   if (intern->u.regex.flags & REGIT_USE_KEY) {
    _zval_ptr_dtor((&intern->current.key) );
    do { zval *__z = (&intern->current.key); zend_string *__s = (result); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
   } else {
    _zval_ptr_dtor((&intern->current.data) );
    do { zval *__z = (&intern->current.data); zend_string *__s = (result); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
   }

   if (replacement == &tmp_replacement) {
    _zval_ptr_dtor((replacement) );
   }
   do { (*(return_value)).u1.type_info = (count > 0) ? 3 : 2; } while (0);
 }
...
void zim_spl_RegexIterator_getRegex(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 { do { zval *__z = (return_value); zend_string *__s = (intern->u.regex.regex); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0); return; };
}



void zim_spl_RegexIterator_getMode(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_RegexIterator_setMode(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_long mode;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &mode) == FAILURE) {
  return;
 }
...
void zim_spl_RegexIterator_getFlags(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_RegexIterator_setFlags(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_long flags;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &flags) == FAILURE) {
  return;
 }
...
void zim_spl_RegexIterator_getPregFlags(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_RegexIterator_setPregFlags(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_long preg_flags;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &preg_flags) == FAILURE) {
  return;
 }
...
void zim_spl_RecursiveRegexIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_RecursiveRegexIterator, spl_ce_RecursiveIterator, DIT_RecursiveRegexIterator);
}



void zim_spl_RecursiveRegexIterator_getChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval retval;
 ...
 if (!(executor_globals.exception)) {
  ...
  do { zval *_z1 = (&args[0]); const zval *_z2 = (&retval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  do { zval *__z = (&args[1]); zend_string *__s = (intern->u.regex.regex); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
  { zval *__z = (&args[2]); (*(__z)).value.lval = intern->u.regex.mode; (*(__z)).u1.type_info = 4; };
  { zval *__z = (&args[3]); (*(__z)).value.lval = intern->u.regex.flags; (*(__z)).u1.type_info = 4; };
  { zval *__z = (&args[4]); (*(__z)).value.lval = intern->u.regex.preg_flags; (*(__z)).u1.type_info = 4; };

  spl_instantiate_arg_n(((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce), return_value, 5, args);
...
void zim_spl_RecursiveRegexIterator_accept(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 if (zval_get_type(&(intern->current.data)) == 0) {
  ...
  { do { (*(return_value)).u1.type_info = (((intern->current.data).value.arr)->nNumOfElements > 0) ? 3 : 2; } while (0); return; };
 }

 zend_call_method(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), spl_ce_RegexIterator, ((void *)0), "accept", sizeof("accept")-1, return_value, 0, ((void *)0), ((void *)0));
}
 ...
 if (object->dit_type == DIT_CallbackFilterIterator || object->dit_type == DIT_RecursiveCallbackFilterIterator) {
  if (object->u.cbfilter) {
   ...
   if (cbfilter->fci.object) {
    zend_object_release(cbfilter->fci.object);
   }
   _efree((cbfilter) );
  }
 }
...
static zend_object *spl_dual_it_new(zend_class_entry *class_type)
{
 ...
 intern = _ecalloc((1), (sizeof(spl_dual_it_object) + zend_object_properties_size(class_type)) );
...
static const zend_internal_arg_info arginfo_filter_it___construct[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_FilterIterator[] = {
 { "__construct", zim_spl_FilterIterator___construct, arginfo_filter_it___construct, (uint32_t) (sizeof(arginfo_filter_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_FilterIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_dual_it_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_dual_it_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_dual_it_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_FilterIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_dual_it_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "accept", ((void *)0), arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_internal_arg_info arginfo_callback_filter_it___construct[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
 { "callback", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_CallbackFilterIterator[] = {
 { "__construct", zim_spl_CallbackFilterIterator___construct, arginfo_callback_filter_it___construct, (uint32_t) (sizeof(arginfo_callback_filter_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "accept", zim_spl_CallbackFilterIterator_accept, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_internal_arg_info arginfo_recursive_callback_filter_it___construct[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "RecursiveIterator", 8, 0, 0, 0 },
 { "callback", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_RecursiveCallbackFilterIterator[] = {
 { "__construct", zim_spl_RecursiveCallbackFilterIterator___construct, arginfo_recursive_callback_filter_it___construct, (uint32_t) (sizeof(arginfo_recursive_callback_filter_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "hasChildren", zim_spl_RecursiveFilterIterator_hasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getChildren", zim_spl_RecursiveCallbackFilterIterator_getChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_internal_arg_info arginfo_parent_it___construct[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "RecursiveIterator", 8, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_RecursiveFilterIterator[] = {
 { "__construct", zim_spl_RecursiveFilterIterator___construct, arginfo_parent_it___construct, (uint32_t) (sizeof(arginfo_parent_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "hasChildren", zim_spl_RecursiveFilterIterator_hasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getChildren", zim_spl_RecursiveFilterIterator_getChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_function_entry spl_funcs_ParentIterator[] = {
 { "__construct", zim_spl_ParentIterator___construct, arginfo_parent_it___construct, (uint32_t) (sizeof(arginfo_parent_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "accept", zim_spl_RecursiveFilterIterator_hasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};


static const zend_internal_arg_info arginfo_regex_it___construct[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
 { "regex", ((void *)0), 0, 0, 0, 0 },
 { "mode", ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
 { "preg_flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_regex_it_set_mode[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "mode", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_regex_it_set_flags[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_regex_it_set_preg_flags[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "preg_flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_RegexIterator[] = {
 { "__construct", zim_spl_RegexIterator___construct, arginfo_regex_it___construct, (uint32_t) (sizeof(arginfo_regex_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "accept", zim_spl_RegexIterator_accept, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getMode", zim_spl_RegexIterator_getMode, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setMode", zim_spl_RegexIterator_setMode, arginfo_regex_it_set_mode, (uint32_t) (sizeof(arginfo_regex_it_set_mode)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getFlags", zim_spl_RegexIterator_getFlags, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setFlags", zim_spl_RegexIterator_setFlags, arginfo_regex_it_set_flags, (uint32_t) (sizeof(arginfo_regex_it_set_flags)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getPregFlags", zim_spl_RegexIterator_getPregFlags, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setPregFlags", zim_spl_RegexIterator_setPregFlags, arginfo_regex_it_set_preg_flags, (uint32_t) (sizeof(arginfo_regex_it_set_preg_flags)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getRegex", zim_spl_RegexIterator_getRegex, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_internal_arg_info arginfo_rec_regex_it___construct[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "RecursiveIterator", 8, 0, 0, 0 },
 { "regex", ((void *)0), 0, 0, 0, 0 },
 { "mode", ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
...
static const zend_function_entry spl_funcs_RecursiveRegexIterator[] = {
 { "__construct", zim_spl_RecursiveRegexIterator___construct, arginfo_rec_regex_it___construct, (uint32_t) (sizeof(arginfo_rec_regex_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "accept", zim_spl_RecursiveRegexIterator_accept, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "hasChildren", zim_spl_RecursiveFilterIterator_hasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getChildren", zim_spl_RecursiveRegexIterator_getChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
void zim_spl_LimitIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_LimitIterator, zend_ce_iterator, DIT_LimitIterator);
}



void zim_spl_LimitIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_LimitIterator_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_LimitIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_LimitIterator_seek(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_long pos;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &pos) == FAILURE) {
  return;
 }
...
void zim_spl_LimitIterator_getPosition(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 do { spl_dual_it_object *it = spl_dual_it_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj); if (it->dit_type == DIT_Unknown) { zend_throw_exception_ex(spl_ce_LogicException, 0, "The object is in an invalid state as the parent constructor was not called"); return; } (intern) = it; } while (0);
 { { zval *__z = (return_value); (*(__z)).value.lval = intern->current.pos; (*(__z)).u1.type_info = 4; }; return; };
...
static const zend_internal_arg_info arginfo_seekable_it_seek[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "position", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_SeekableIterator[] = {
 { "seek", ((void *)0), arginfo_seekable_it_seek, (uint32_t) (sizeof(arginfo_seekable_it_seek)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_internal_arg_info arginfo_limit_it___construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
 { "offset", ((void *)0), 0, 0, 0, 0 },
 { "count", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_limit_it_seek[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "position", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_LimitIterator[] = {
 { "__construct", zim_spl_LimitIterator___construct, arginfo_limit_it___construct, (uint32_t) (sizeof(arginfo_limit_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_LimitIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_LimitIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_dual_it_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_dual_it_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_LimitIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "seek", zim_spl_LimitIterator_seek, arginfo_limit_it_seek, (uint32_t) (sizeof(arginfo_limit_it_seek)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getPosition", zim_spl_LimitIterator_getPosition, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_dual_it_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
static inline void spl_caching_it_next(spl_dual_it_object *intern)
{
 if (spl_dual_it_fetch(intern, 1) == SUCCESS) {
  ...
  if (intern->u.caching.flags & CIT_FULL_CACHE) {
   ...
   do { if (__builtin_expect(!!((zval_get_type(&(*(data))) == 10)), 0)) { (data) = &(*(data)).value.ref->val; } } while (0);
   do { if ((((*((data))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((data)); } } while (0);
   array_set_zval_key((intern->u.caching.zcache).value.arr, key, data);
   _zval_ptr_dtor((data) );
  }
  ...
  if (intern->u.caching.flags & (CIT_TOSTRING_USE_INNER|CIT_CALL_TOSTRING)) {
   ...
   if (intern->u.caching.flags & CIT_TOSTRING_USE_INNER) {
    do { zval *_z1 = (&intern->u.caching.zstr); const zval *_z2 = (&intern->inner.zobject); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   } else {
    do { zval *_z1 = (&intern->u.caching.zstr); const zval *_z2 = (&intern->current.data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   }
   use_copy = zend_make_printable_zval(&intern->u.caching.zstr, &expr_copy);
   if (use_copy) {
    do { zval *_z1 = (&intern->u.caching.zstr); const zval *_z2 = (&expr_copy); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
   } else if ((((intern->u.caching.zstr).u1.v.type_flags & (1<<2)) != 0)) {
...
{
 spl_dual_it_rewind(intern);
 zend_hash_clean((intern->u.caching.zcache).value.arr);
 spl_caching_it_next(intern);
}



void zim_spl_CachingIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_CachingIterator, zend_ce_iterator, DIT_CachingIterator);
}



void zim_spl_CachingIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_CachingIterator_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_CachingIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_CachingIterator_hasNext(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_CachingIterator___toString(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 if (!(intern->u.caching.flags & (CIT_CALL_TOSTRING|CIT_TOSTRING_USE_KEY|CIT_TOSTRING_USE_CURRENT|CIT_TOSTRING_USE_INNER))) {
  zend_throw_exception_ex(spl_ce_BadMethodCallException, 0, "%s does not fetch string value (see CachingIterator::__construct)", (((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce)->name)->val);
  return;
 }
 if (intern->u.caching.flags & CIT_TOSTRING_USE_KEY) {
  do { zval *_z1 = (return_value); const zval *_z2 = (&intern->current.key); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  if (zval_get_type(&(*(return_value))) != 6) { _convert_to_string((return_value) ); };
  return;
 } else if (intern->u.caching.flags & CIT_TOSTRING_USE_CURRENT) {
  do { zval *_z1 = (return_value); const zval *_z2 = (&intern->current.data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  if (zval_get_type(&(*(return_value))) != 6) { _convert_to_string((return_value) ); };
  return;
 }
 if (zval_get_type(&(intern->u.caching.zstr)) == 6) {
  { do { zval *__z = (return_value); zend_string *__s = ((*(&intern->u.caching.zstr)).value.str); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 1; } while (0); return;};
 }
}
...
void zim_spl_CachingIterator_offsetSet(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_string *key;
 zval *value;
 ...
 if (!(intern->u.caching.flags & CIT_FULL_CACHE)) {
  zend_throw_exception_ex(spl_ce_BadMethodCallException, 0, "%s does not use a full cache (see CachingIterator::__construct)", (((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce)->name)->val);
  return;
 }

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "Sz", &key, &value) == FAILURE) {
  return;
 }
 ...
 zend_symtable_update((intern->u.caching.zcache).value.arr, key, value);
}




void zim_spl_CachingIterator_offsetGet(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_string *key;
 zval *value;
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "S", &key) == FAILURE) {
  return;
 }

 if ((value = zend_symtable_find((intern->u.caching.zcache).value.arr, key)) == ((void *)0)) {
...
void zim_spl_CachingIterator_offsetUnset(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_string *key;
 ...
 zend_symtable_del((intern->u.caching.zcache).value.arr, key);
}




void zim_spl_CachingIterator_offsetExists(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_string *key;
 ...
 { do { (*(return_value)).u1.type_info = (zend_symtable_exists((intern->u.caching.zcache).value.arr, key)) ? 3 : 2; } while (0); return; };
}




void zim_spl_CachingIterator_getCache(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 if (!(intern->u.caching.flags & CIT_FULL_CACHE)) {
  zend_throw_exception_ex(spl_ce_BadMethodCallException, 0, "%v does not use a full cache (see CachingIterator::__construct)", (((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce)->name)->val);
  return;
 }

 do { zval *_z1 = (return_value); const zval *_z2 = (&intern->u.caching.zcache); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_spl_CachingIterator_getFlags(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_CachingIterator_setFlags(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zend_long flags;
...
void zim_spl_CachingIterator_count(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = ((intern->u.caching.zcache).value.arr)->nNumOfElements; (*(__z)).u1.type_info = 4; }; return; };
}


static const zend_internal_arg_info arginfo_caching_it___construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_caching_it_setFlags[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_caching_it_offsetGet[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "index", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_caching_it_offsetSet[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "index", ((void *)0), 0, 0, 0, 0 },
 { "newval", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_CachingIterator[] = {
 { "__construct", zim_spl_CachingIterator___construct, arginfo_caching_it___construct, (uint32_t) (sizeof(arginfo_caching_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_CachingIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_CachingIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_dual_it_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_dual_it_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_CachingIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "hasNext", zim_spl_CachingIterator_hasNext, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__toString", zim_spl_CachingIterator___toString, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_dual_it_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getFlags", zim_spl_CachingIterator_getFlags, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setFlags", zim_spl_CachingIterator_setFlags, arginfo_caching_it_setFlags, (uint32_t) (sizeof(arginfo_caching_it_setFlags)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetGet", zim_spl_CachingIterator_offsetGet, arginfo_caching_it_offsetGet, (uint32_t) (sizeof(arginfo_caching_it_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetSet", zim_spl_CachingIterator_offsetSet, arginfo_caching_it_offsetSet, (uint32_t) (sizeof(arginfo_caching_it_offsetSet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetUnset", zim_spl_CachingIterator_offsetUnset, arginfo_caching_it_offsetGet, (uint32_t) (sizeof(arginfo_caching_it_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetExists", zim_spl_CachingIterator_offsetExists, arginfo_caching_it_offsetGet, (uint32_t) (sizeof(arginfo_caching_it_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getCache", zim_spl_CachingIterator_getCache, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "count", zim_spl_CachingIterator_count, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};



void zim_spl_RecursiveCachingIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_RecursiveCachingIterator, spl_ce_RecursiveIterator, DIT_RecursiveCachingIterator);
}



void zim_spl_RecursiveCachingIterator_hasChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_RecursiveCachingIterator_getChildren(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
static const zend_internal_arg_info arginfo_caching_rec_it___construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_RecursiveCachingIterator[] = {
 { "__construct", zim_spl_RecursiveCachingIterator___construct, arginfo_caching_rec_it___construct, (uint32_t) (sizeof(arginfo_caching_rec_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "hasChildren", zim_spl_RecursiveCachingIterator_hasChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getChildren", zim_spl_RecursiveCachingIterator_getChildren, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};



void zim_spl_IteratorIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_IteratorIterator, zend_ce_traversable, DIT_IteratorIterator);
}

static const zend_internal_arg_info arginfo_iterator_it___construct[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Traversable", 8, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_IteratorIterator[] = {
 { "__construct", zim_spl_IteratorIterator___construct, arginfo_iterator_it___construct, (uint32_t) (sizeof(arginfo_iterator_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_dual_it_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_dual_it_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_dual_it_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_dual_it_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_dual_it_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_dual_it_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
void zim_spl_NoRewindIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_NoRewindIterator, zend_ce_iterator, DIT_NoRewindIterator);
}



void zim_spl_NoRewindIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_NoRewindIterator_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_NoRewindIterator_key(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_NoRewindIterator_current(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval *data;
...
void zim_spl_NoRewindIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
static const zend_internal_arg_info arginfo_norewind_it___construct[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_NoRewindIterator[] = {
 { "__construct", zim_spl_NoRewindIterator___construct, arginfo_norewind_it___construct, (uint32_t) (sizeof(arginfo_norewind_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_NoRewindIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_NoRewindIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_NoRewindIterator_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_NoRewindIterator_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_NoRewindIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_dual_it_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
void zim_spl_InfiniteIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_InfiniteIterator, zend_ce_iterator, DIT_InfiniteIterator);
}



void zim_spl_InfiniteIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
static const zend_function_entry spl_funcs_InfiniteIterator[] = {
 { "__construct", zim_spl_InfiniteIterator___construct, arginfo_norewind_it___construct, (uint32_t) (sizeof(arginfo_norewind_it___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_InfiniteIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};



void zim_spl_EmptyIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_EmptyIterator_valid(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_EmptyIterator_key(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_EmptyIterator_current(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
void zim_spl_EmptyIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }
...
static const zend_function_entry spl_funcs_EmptyIterator[] = {
 { "rewind", zim_spl_EmptyIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_EmptyIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_EmptyIterator_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_EmptyIterator_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_EmptyIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
int spl_append_it_next_iterator(spl_dual_it_object *intern)
{
 ...
 if (intern->u.append.iterator->funcs->valid(intern->u.append.iterator) == SUCCESS) {
  ...
  do { zval *_z1 = (&intern->inner.zobject); const zval *_z2 = (it); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  intern->inner.ce = ((*(it)).value.obj->ce);
...
void zim_spl_AppendIterator___construct(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_construct(execute_data, return_value, spl_ce_AppendIterator, zend_ce_iterator, DIT_AppendIterator);
}



void zim_spl_AppendIterator_append(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval *it;
 ...
 if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "O", &it, zend_ce_iterator) == FAILURE) {
  return;
 }
...
void zim_spl_AppendIterator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_AppendIterator_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_AppendIterator_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_AppendIterator_getIteratorIndex(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
...
void zim_spl_AppendIterator_getArrayIterator(zend_execute_data *execute_data, zval *return_value)
{
 spl_dual_it_object *intern;
 zval *value;
...
static const zend_internal_arg_info arginfo_append_it_append[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Iterator", 8, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_AppendIterator[] = {
 { "__construct", zim_spl_AppendIterator___construct, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "append", zim_spl_AppendIterator_append, arginfo_append_it_append, (uint32_t) (sizeof(arginfo_append_it_append)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "rewind", zim_spl_AppendIterator_rewind, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_AppendIterator_valid, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_dual_it_key, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_dual_it_current, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_AppendIterator_next, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getInnerIterator", zim_spl_dual_it_getInnerIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getIteratorIndex", zim_spl_AppendIterator_getIteratorIndex, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getArrayIterator", zim_spl_AppendIterator_getArrayIterator, arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
static int spl_iterator_to_array_apply(zend_object_iterator *iter, void *puser)
{
 ...
 if (iter->funcs->get_current_key) {
  ...
  array_set_zval_key((*(return_value)).value.arr, &key, data);
  _zval_ptr_dtor((&key) );
 } else {
  do { if ((((*((data))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((data)); } } while (0);
...
void zif_iterator_to_array(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "O|b", &obj, zend_ce_traversable, &use_keys) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_iterator_count(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "O", &obj, zend_ce_traversable) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_iterator_apply(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "Of|a!", &apply_info.obj, zend_ce_traversable, &apply_info.fci, &apply_info.fcc, &apply_info.args) == FAILURE) {
  return;
 }
...
static const zend_function_entry spl_funcs_OuterIterator[] = {
 { "getInnerIterator", ((void *)0), arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_function_entry spl_funcs_Countable[] = {
 { "count", ((void *)0), arginfo_recursive_it_void, (uint32_t) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
int zm_startup_spl_iterators(int type, int module_number)
{
 ...
 spl_handlers_rec_it_it.offset = ((zend_long) (((char *) (&(((spl_recursive_it_object*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 spl_handlers_dual_it.offset = ((zend_long) (((char *) (&(((spl_dual_it_object*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 zend_declare_class_constant_long(spl_ce_RecursiveIteratorIterator, "LEAVES_ONLY", sizeof("LEAVES_ONLY")-1, (zend_long)RIT_LEAVES_ONLY);;
 zend_declare_class_constant_long(spl_ce_RecursiveIteratorIterator, "SELF_FIRST", sizeof("SELF_FIRST")-1, (zend_long)RIT_SELF_FIRST);;
 zend_declare_class_constant_long(spl_ce_RecursiveIteratorIterator, "CHILD_FIRST", sizeof("CHILD_FIRST")-1, (zend_long)RIT_CHILD_FIRST);;
 zend_declare_class_constant_long(spl_ce_RecursiveIteratorIterator, "CATCH_GET_CHILD", sizeof("CATCH_GET_CHILD")-1, (zend_long)CIT_CATCH_GET_CHILD);;
 ...
 zend_declare_class_constant_long(spl_ce_CachingIterator, "CALL_TOSTRING", sizeof("CALL_TOSTRING")-1, (zend_long)CIT_CALL_TOSTRING);;
 zend_declare_class_constant_long(spl_ce_CachingIterator, "CATCH_GET_CHILD", sizeof("CATCH_GET_CHILD")-1, (zend_long)CIT_CATCH_GET_CHILD);;
 zend_declare_class_constant_long(spl_ce_CachingIterator, "TOSTRING_USE_KEY", sizeof("TOSTRING_USE_KEY")-1, (zend_long)CIT_TOSTRING_USE_KEY);;
 zend_declare_class_constant_long(spl_ce_CachingIterator, "TOSTRING_USE_CURRENT", sizeof("TOSTRING_USE_CURRENT")-1, (zend_long)CIT_TOSTRING_USE_CURRENT);;
 zend_declare_class_constant_long(spl_ce_CachingIterator, "TOSTRING_USE_INNER", sizeof("TOSTRING_USE_INNER")-1, (zend_long)CIT_TOSTRING_USE_INNER);;
 zend_declare_class_constant_long(spl_ce_CachingIterator, "FULL_CACHE", sizeof("FULL_CACHE")-1, (zend_long)CIT_FULL_CACHE);;
 ...
 zend_declare_class_constant_long(spl_ce_RegexIterator, "USE_KEY", sizeof("USE_KEY")-1, (zend_long)REGIT_USE_KEY);;
 zend_declare_class_constant_long(spl_ce_RegexIterator, "INVERT_MATCH", sizeof("INVERT_MATCH")-1, (zend_long)REGIT_INVERTED);;
 zend_declare_class_constant_long(spl_ce_RegexIterator, "MATCH", sizeof("MATCH")-1, (zend_long)REGIT_MODE_MATCH);;
 zend_declare_class_constant_long(spl_ce_RegexIterator, "GET_MATCH", sizeof("GET_MATCH")-1, (zend_long)REGIT_MODE_GET_MATCH);;
 zend_declare_class_constant_long(spl_ce_RegexIterator, "ALL_MATCHES", sizeof("ALL_MATCHES")-1, (zend_long)REGIT_MODE_ALL_MATCHES);;
 zend_declare_class_constant_long(spl_ce_RegexIterator, "SPLIT", sizeof("SPLIT")-1, (zend_long)REGIT_MODE_SPLIT);;
 zend_declare_class_constant_long(spl_ce_RegexIterator, "REPLACE", sizeof("REPLACE")-1, (zend_long)REGIT_MODE_REPLACE);;
 ...
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "BYPASS_CURRENT", sizeof("BYPASS_CURRENT")-1, (zend_long)RTIT_BYPASS_CURRENT);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "BYPASS_KEY", sizeof("BYPASS_KEY")-1, (zend_long)RTIT_BYPASS_KEY);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "PREFIX_LEFT", sizeof("PREFIX_LEFT")-1, (zend_long)0);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "PREFIX_MID_HAS_NEXT", sizeof("PREFIX_MID_HAS_NEXT")-1, (zend_long)1);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "PREFIX_MID_LAST", sizeof("PREFIX_MID_LAST")-1, (zend_long)2);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "PREFIX_END_HAS_NEXT", sizeof("PREFIX_END_HAS_NEXT")-1, (zend_long)3);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "PREFIX_END_LAST", sizeof("PREFIX_END_LAST")-1, (zend_long)4);;
 zend_declare_class_constant_long(spl_ce_RecursiveTreeIterator, "PREFIX_RIGHT", sizeof("PREFIX_RIGHT")-1, (zend_long)5);;
