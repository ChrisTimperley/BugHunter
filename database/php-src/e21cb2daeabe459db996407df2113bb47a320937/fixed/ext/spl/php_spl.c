# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.h"
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_fixedarray.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_fixedarray.h"
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_heap.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_heap.h"
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 41 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
# 43 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_lcg.h" 1
# 44 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/snprintf.h" 1
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c" 2
...
static zend_class_entry * spl_find_ce_by_name(zend_string *name, zend_bool autoload)
{
 ...
 if (!autoload) {
  ...
  if (ce == ((void *)0)) {
  php_error_docref0(((void *)0), (1<<1L), "Class %s does not exist%s", (name)->val, autoload ? " and could not be loaded" : "");
  return ((void *)0);
 }
...
void zif_class_parents(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z|b", &obj, &autoload) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (zval_get_type(&(*(obj))) != 8 && zval_get_type(&(*(obj))) != 6) {
  php_error_docref0(((void *)0), (1<<1L), "object or string expected");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (zval_get_type(&(*(obj))) == 6) {
  if (((void *)0) == (ce = spl_find_ce_by_name((*(obj)).value.str, autoload))) {
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
 } else {
  ce = ((*(obj)).value.obj->ce);
...
void zif_class_implements(zend_execute_data *execute_data, zval *return_value)
{
 ...
 _array_init((return_value), 0 );
 spl_add_interfaces(return_value, ce, 1, 0x40);
}
...
void zif_class_uses(zend_execute_data *execute_data, zval *return_value)
{
 ...
 _array_init((return_value), 0 );
 spl_add_traits(return_value, ce, 1, 0x80);
}
# 240 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c"
void zif_spl_classes(zend_execute_data *execute_data, zval *return_value)
{
 _array_init((return_value), 0 );
...
static int spl_autoload(zend_string *class_name, zend_string *lc_name, const char *ext, int ext_len)
{
 ...
 if (ret == SUCCESS) {
  ...
  if (_zend_hash_add(&(executor_globals.included_files), opened_path, &dummy )) {
  ...
  if (new_op_array) {
   ...
   _efree((class_file) );
   return zend_hash_exists((executor_globals.class_table), lc_name);
  }
 }
 _efree((class_file) );
 return 0;
...
void zif_spl_autoload(zend_execute_data *execute_data, zval *return_value)
{
 int found = 0, pos_len, pos1_len;
 char *pos, *pos1;
 zend_string *class_name, *lc_name, *file_exts = (spl_globals.autoload_extensions);

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "S|S", &class_name, &file_exts) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 if (file_exts == ((void *)0)) {
  pos = ".inc,.php";
  pos_len = sizeof(".inc,.php") - 1;
 } else {
  pos = (file_exts)->val;
 ...
 while (pos && *pos && !(executor_globals.exception)) {
  pos1 = strchr(pos, ',');
  if (pos1) {
 ...
 if (!found && !(spl_globals.autoload_running)) {
  ...
  if (ex &&
      ex->opline->opcode != 109 &&
      ex->opline->opcode != 68) {
   zend_throw_exception_ex(spl_ce_LogicException, 0, "Class %s could not be loaded", (class_name)->val);
  } else {
   php_error_docref0(((void *)0), (1<<0L), "Class %s could not be loaded", (class_name)->val);
  }
 }
}
...
void zif_spl_autoload_extensions(zend_execute_data *execute_data, zval *return_value)
{
 zend_string *file_exts = ((void *)0);

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|S", &file_exts) == FAILURE) {
  return;
 }
 if (file_exts) {
  if ((spl_globals.autoload_extensions)) {
   zend_string_release((spl_globals.autoload_extensions));
  }
  (spl_globals.autoload_extensions) = zend_string_copy(file_exts);
 }

 if ((spl_globals.autoload_extensions) == ((void *)0)) {
  { do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(".inc,.php", sizeof(".inc,.php") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); return; };
 } else {
  zend_string_addref((spl_globals.autoload_extensions));
  { do { zval *__z = (return_value); zend_string *__s = ((spl_globals.autoload_extensions)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
 }
}
...
{
 autoload_func_info *alfi = (autoload_func_info*)(*(element)).value.ptr;
 if (!(zval_get_type(&(alfi->obj)) == 0)) {
  _zval_ptr_dtor((&alfi->obj) );
 }
 if (!(zval_get_type(&(alfi->closure)) == 0)) {
...
void zif_spl_autoload_call(zend_execute_data *execute_data, zval *return_value)
{
 zval *class_name, *retval = ((void *)0);
 zend_string *lc_name, *func_name;
 autoload_func_info *alfi;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &class_name) == FAILURE || zval_get_type(&(*(class_name))) != 6) {
  return;
 }
 ...
 if ((spl_globals.autoload_functions)) {
  ...
  lc_name = zend_string_alloc(((*(class_name)).value.str)->len, 0);
  zend_str_tolower_copy((lc_name)->val, ((*(class_name)).value.str)->val, ((*(class_name)).value.str)->len);
  zend_hash_internal_pointer_reset_ex((spl_globals.autoload_functions), &pos);
  while (zend_hash_get_current_key_ex((spl_globals.autoload_functions), &func_name, &num_idx, &pos) == 1) {
   if ((alfi = zend_hash_get_current_data_ptr_ex((spl_globals.autoload_functions), &pos)) == ((void *)0)) {
    continue;
   }
   zend_call_method((zval_get_type(&(alfi->obj)) == 0)? ((void *)0) : &alfi->obj, alfi->ce, &alfi->func_ptr, (func_name)->val, (func_name)->len, retval, 1, class_name, ((void *)0));
   zend_exception_save();
   if (retval) {
    _zval_ptr_dtor((retval) );
    retval = ((void *)0);
   }
   if (zend_hash_exists((executor_globals.class_table), lc_name)) {
    break;
   }
   zend_hash_move_forward_ex((spl_globals.autoload_functions), &pos);
  }
...
# 462 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.c"
void zif_spl_autoload_register(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "|zbb", &zcallable, &do_throw, &prepend) == FAILURE) {
  return;
 }

 if ((execute_data)->This.u2.num_args) {
  if (!zend_is_callable_ex(zcallable, ((void *)0), ((1<<2)), &func_name, &fcc, &error)) {
   alfi.ce = fcc.calling_scope;
   alfi.func_ptr = fcc.function_handler;
   obj_ptr = fcc.object;
   if (zval_get_type(&(*(zcallable))) == 7) {
    ...
    zend_string_release(func_name);
    { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
   } else if (zval_get_type(&(*(zcallable))) == 6) {
    if (do_throw) {
  ...
  } else if (fcc.function_handler->type == 1 &&
  ...
  if (zval_get_type(&(*(zcallable))) == 8) {
   do { zval *_z1 = (&alfi.closure); const zval *_z2 = (zcallable); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

   lc_name = zend_string_alloc((func_name)->len + sizeof(uint32_t), 0);
   zend_str_tolower_copy((lc_name)->val, (func_name)->val, (func_name)->len);
   memcpy((lc_name)->val + (func_name)->len, &(((*(zcallable))).value.obj)->handle, sizeof(uint32_t));
   (lc_name)->val[(lc_name)->len] = '\0';
  } else {
   do { (*(&alfi.closure)).u1.type_info = 0; } while (0);
   lc_name = zend_string_alloc((func_name)->len, 0);
   zend_str_tolower_copy((lc_name)->val, (func_name)->val, (func_name)->len);
  }
  zend_string_release(func_name);

  if ((spl_globals.autoload_functions) && zend_hash_exists((spl_globals.autoload_functions), lc_name)) {
   if (!(zval_get_type(&(alfi.closure)) == 0)) {
...
skip:
 ...
 if ((spl_globals.autoload_functions)) {
  (executor_globals.autoload_func) = zend_hash_str_find_ptr((executor_globals.function_table), "spl_autoload_call", sizeof("spl_autoload_call") - 1);
 } else {
  (executor_globals.autoload_func) = zend_hash_str_find_ptr((executor_globals.function_table), "spl_autoload", sizeof("spl_autoload") - 1);
 }
...
void zif_spl_autoload_unregister(zend_execute_data *execute_data, zval *return_value)
{
 zend_string *func_name = ((void *)0);
 char *error = ((void *)0);
 zend_string *lc_name;
 zval *zcallable;
 int success = FAILURE;
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &zcallable) == FAILURE) {
  return;
 }

 if (!zend_is_callable_ex(zcallable, ((void *)0), (1<<0), &func_name, &fcc, &error)) {
 ...
 if ((spl_globals.autoload_functions)) {
  if ((lc_name)->len == sizeof("spl_autoload_call") - 1 && !strcmp((lc_name)->val, "spl_autoload_call")) {
   ...
   do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 16) { _efree_16((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 24) { _efree_24((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 32) { _efree_32((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 40) { _efree_40((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 48) { _efree_48((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 56) { _efree_56((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 64) { _efree_64((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 80) { _efree_80((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 96) { _efree_96((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 112) { _efree_112((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 128) { _efree_128((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 160) { _efree_160((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 192) { _efree_192((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 224) { _efree_224((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 256) { _efree_256((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 320) { _efree_320((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 384) { _efree_384((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 448) { _efree_448((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 512) { _efree_512((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 640) { _efree_640((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 768) { _efree_768((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 896) { _efree_896((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 1024) { _efree_1024((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 1280) { _efree_1280((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 1536) { _efree_1536((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 1792) { _efree_1792((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 2048) { _efree_2048((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 2560) { _efree_2560((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= 3072) { _efree_3072((spl_globals.autoload_functions)); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large((spl_globals.autoload_functions), sizeof(HashTable)); } else { _efree_huge((spl_globals.autoload_functions), sizeof(HashTable)); } } else { _efree((spl_globals.autoload_functions)); } } while (0);
   (spl_globals.autoload_functions) = ((void *)0);
   (executor_globals.autoload_func) = ((void *)0);
   success = SUCCESS;
  } else {

   success = zend_hash_del((spl_globals.autoload_functions), lc_name);
 ...
 zend_string_release(lc_name);
 { do { (*(return_value)).u1.type_info = (success == SUCCESS) ? 3 : 2; } while (0); return; };
}



void zif_spl_autoload_functions(zend_execute_data *execute_data, zval *return_value)
{
 zend_function *fptr;
 autoload_func_info *alfi;
 ...
 if (!(executor_globals.autoload_func)) {
  if ((fptr = zend_hash_str_find_ptr((executor_globals.function_table), "__autoload", sizeof("__autoload") - 1))) {
   _array_init((return_value), 0 );
   add_next_index_stringl(return_value, "__autoload", sizeof("__autoload")-1);
   return;
  }
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 fptr = zend_hash_str_find_ptr((executor_globals.function_table), "spl_autoload_call", sizeof("spl_autoload_call") - 1);

 if ((executor_globals.autoload_func) == fptr) {
  zend_string *key;
  _array_init((return_value), 0 );
  do { Bucket *_p = ((spl_globals.autoload_functions))->arData; Bucket *_end = _p + ((spl_globals.autoload_functions))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; alfi = (*(_z)).value.ptr; {
   if (!(zval_get_type(&(alfi->closure)) == 0)) {
 ...
 _array_init((return_value), 0 );
 add_next_index_str(return_value, zend_string_copy((executor_globals.autoload_func)->common.function_name));
}



void zif_spl_object_hash(zend_execute_data *execute_data, zval *return_value)
{
 zval *obj;
...
__attribute__ ((visibility("default"))) zend_string *php_spl_object_hash(zval *obj)
{
 ...
 if (!(spl_globals.hash_mask_init)) {
  if (!(basic_globals.mt_rand_is_seeded)) {
   php_mt_srand((uint32_t)(((zend_long) (time(0) * getpid())) ^ ((zend_long) (1000000.0 * php_combined_lcg()))));
  }
...
void zm_info_spl(zend_module_entry *zend_module)
{
 ...
 _array_init((&list), 0 );
 spl_add_classes(spl_ce_AppendIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_ArrayIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_ArrayObject, &list, 0, 1, 0x40); spl_add_classes(spl_ce_BadFunctionCallException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_BadMethodCallException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_CachingIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_CallbackFilterIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_Countable, &list, 0, 1, 0x40); spl_add_classes(spl_ce_DirectoryIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_DomainException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_EmptyIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_FilesystemIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_FilterIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_GlobIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_InfiniteIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_InvalidArgumentException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_IteratorIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_LengthException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_LimitIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_LogicException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_MultipleIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_NoRewindIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_OuterIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_OutOfBoundsException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_OutOfRangeException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_OverflowException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_ParentIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RangeException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveArrayIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveCachingIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveCallbackFilterIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveDirectoryIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveFilterIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveIteratorIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveRegexIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RecursiveTreeIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RegexIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_RuntimeException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SeekableIterator, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplDoublyLinkedList, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplFileInfo, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplFileObject, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplFixedArray, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplHeap, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplMinHeap, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplMaxHeap, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplObjectStorage, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplObserver, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplPriorityQueue, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplQueue, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplStack, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplSubject, &list, 0, 1, 0x40); spl_add_classes(spl_ce_SplTempFileObject, &list, 0, 1, 0x40); spl_add_classes(spl_ce_UnderflowException, &list, 0, 1, 0x40); spl_add_classes(spl_ce_UnexpectedValueException, &list, 0, 1, 0x40);
 strg = _estrdup(("") );
 zend_hash_apply_with_argument((*(&list)).value.arr, (apply_func_arg_t)spl_build_class_list_string, &strg);
 _zval_dtor((&list) );
...
static const zend_internal_arg_info arginfo_iterator_to_array[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Traversable", 8, 0, 0, 0 },
 { "use_keys", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_iterator[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Traversable", 8, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_iterator_apply[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "iterator", "Traversable", 8, 0, 0, 0 },
 { "function", ((void *)0), 0, 0, 0, 0 },
 { "args", ((void *)0), 7, 0, 1, 0 },
};;

static const zend_internal_arg_info arginfo_class_parents[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "instance", ((void *)0), 0, 0, 0, 0 },
 { "autoload", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_class_implements[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "what", ((void *)0), 0, 0, 0, 0 },
 { "autoload", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_class_uses[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "what", ((void *)0), 0, 0, 0, 0 },
 { "autoload", ((void *)0), 0, 0, 0, 0 },
};


static const zend_internal_arg_info arginfo_spl_classes[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_autoload_functions[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_autoload[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "class_name", ((void *)0), 0, 0, 0, 0 },
 { "file_extensions", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_autoload_extensions[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "file_extensions", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_autoload_call[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "class_name", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_autoload_register[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "autoload_function", ((void *)0), 0, 0, 0, 0 },
 { "throw", ((void *)0), 0, 0, 0, 0 },
 { "prepend", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_autoload_unregister[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "autoload_function", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_spl_object_hash[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "obj", ((void *)0), 0, 0, 0, 0 },
};
...
const zend_function_entry spl_functions[] = {
 { "spl_classes", zif_spl_classes, arginfo_spl_classes, (uint32_t) (sizeof(arginfo_spl_classes)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_autoload", zif_spl_autoload, arginfo_spl_autoload, (uint32_t) (sizeof(arginfo_spl_autoload)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_autoload_extensions", zif_spl_autoload_extensions, arginfo_spl_autoload_extensions, (uint32_t) (sizeof(arginfo_spl_autoload_extensions)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_autoload_register", zif_spl_autoload_register, arginfo_spl_autoload_register, (uint32_t) (sizeof(arginfo_spl_autoload_register)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_autoload_unregister", zif_spl_autoload_unregister, arginfo_spl_autoload_unregister, (uint32_t) (sizeof(arginfo_spl_autoload_unregister)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_autoload_functions", zif_spl_autoload_functions, arginfo_spl_autoload_functions, (uint32_t) (sizeof(arginfo_spl_autoload_functions)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_autoload_call", zif_spl_autoload_call, arginfo_spl_autoload_call, (uint32_t) (sizeof(arginfo_spl_autoload_call)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "class_parents", zif_class_parents, arginfo_class_parents, (uint32_t) (sizeof(arginfo_class_parents)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "class_implements", zif_class_implements, arginfo_class_implements, (uint32_t) (sizeof(arginfo_class_implements)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "class_uses", zif_class_uses, arginfo_class_uses, (uint32_t) (sizeof(arginfo_class_uses)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "spl_object_hash", zif_spl_object_hash, arginfo_spl_object_hash, (uint32_t) (sizeof(arginfo_spl_object_hash)/sizeof(struct _zend_internal_arg_info)-1), 0 },

 { "iterator_to_array", zif_iterator_to_array, arginfo_iterator_to_array, (uint32_t) (sizeof(arginfo_iterator_to_array)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "iterator_count", zif_iterator_count, arginfo_iterator, (uint32_t) (sizeof(arginfo_iterator)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "iterator_apply", zif_iterator_apply, arginfo_iterator_apply, (uint32_t) (sizeof(arginfo_iterator_apply)/sizeof(struct _zend_internal_arg_info)-1), 0 },
