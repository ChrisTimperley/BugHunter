...
__attribute__ ((visibility("default"))) void zend_initialize_class_data(zend_class_entry *ce, zend_bool nullify_handlers)
{
 ...
 if (ce->type == 1) {
# 1646 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
# 1768 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
 if (len == 0) {
 ...
 if (end < path) {
# 1800 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
  path[0] = '.';
  path[1] = '\0';
  return 1 + len_adjust;
...
void zend_compile_assign_ref(znode *result, zend_ast *ast)
{
 ...
 zend_delayed_compile_var(&source_node, source_ast, 6);
 zend_delayed_compile_end(offset);
