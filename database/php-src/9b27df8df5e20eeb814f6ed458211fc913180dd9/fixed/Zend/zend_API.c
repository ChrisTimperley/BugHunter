# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h"
...
# 907 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 976 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"

# 1036 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_execute.h" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_API.c" 2
...
__attribute__ ((visibility("default"))) int zend_get_parameters(int ht, int param_count, ...)
{
 ...
 param_ptr = (((zval*)((executor_globals.current_execute_data))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(1)) - 1))));
 arg_count = ((executor_globals.current_execute_data))->This.u2.num_args;
 ...
 while (param_count-->0) {
  ...
  if (!(zval_get_type(&(*(param_ptr))) == 10) && zval_refcount_p(param_ptr) > 1) {
   ...
   do { zval *_z1 = (&new_tmp); const zval *_z2 = (param_ptr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
   zval_delref_p(param_ptr);
   do { zval *_z1 = (param_ptr); const zval *_z2 = (&new_tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  }
  *param = param_ptr;
  param_ptr++;
 }
...
__attribute__ ((visibility("default"))) int _zend_get_parameters_array_ex(int param_count, zval *argument_array)
{
 ...
 while (param_count-->0) {
  do { zval *_z1 = (argument_array); const zval *_z2 = (param_ptr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  argument_array++;
  param_ptr++;
 }
...
__attribute__ ((visibility("default"))) int zend_copy_parameters_array(int param_count, zval *argument_array)
{
 ...
 while (param_count-->0) {
  if ((((*(param_ptr)).u1.v.type_flags & (1<<2)) != 0)) {
   zval_addref_p(param_ptr);
  }
  _zend_hash_next_index_insert_new((*(argument_array)).value.arr, param_ptr );
  param_ptr++;
 }
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_wrong_param_count(void)
{
 ...
 zend_internal_type_error(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)), "Wrong parameter count for %s%s%s()", class_name, space, get_active_function_name());
}
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_wrong_parameters_count_error(int num_args, int min_num_args, int max_num_args)
{
 ...
 zend_internal_type_error(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)), "%s%s%s() expects %s %d parameter%s, %d given",
  class_name,
  class_name[0] ? "::" : "",
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_wrong_parameter_type_error(int num, zend_expected_type expected_type, zval *arg)
{
 ...
 static const char * const expected_error[] = {
  "integer", "boolean", "string", "array", "valid callback", "resource", "a valid path", "object", "float",
  ((void *)0)
 };

 zend_internal_type_error(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)), "%s%s%s() expects parameter %d to be %s, %s given",
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_wrong_callback_error(int severity, int num, char *error)
{
 ...
 if (severity == (1<<1L)) {
  zend_internal_type_error(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)), "%s%s%s() expects parameter %d to be a valid callback, %s",
   class_name, space, get_active_function_name(), num, error);
 } else if (severity == (1<<0L)) {
 ...
 *pce = zend_lookup_class((*(arg)).value.str);
 if (ce_base) {
  if ((!*pce || !instanceof_function(*pce, ce_base))) {
   ...
   zend_internal_type_error(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)), "%s%s%s() expects parameter %d to be a class name derived from %s, '%s' given",
 ...
 if (!*pce) {
  ...
  zend_internal_type_error(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)), "%s%s%s() expects parameter %d to be a valid class name, '%s' given",
   class_name, space, get_active_function_name(), num,
   ((*(arg)).value.str)->val);
  return 0;
 }
...
__attribute__ ((visibility("default"))) int zend_parse_arg_bool_slow(zval *arg, zend_bool *dest)
{
 if (__builtin_expect(!!(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0))), 0)) {
  return 0;
 }
...
{
 if (__builtin_expect(!!(zval_get_type(&(*(arg))) == 5), 1)) {
  if (__builtin_expect(!!((sizeof ((*(arg)).value.dval) == sizeof (float) ? __isnanf ((*(arg)).value.dval) : sizeof ((*(arg)).value.dval) == sizeof (double) ? __isnan ((*(arg)).value.dval) : __isnanl ((*(arg)).value.dval))), 0)) {
   return 0;
  }
  if (__builtin_expect(!!(!(!(((*(arg)).value.dval) >= (9223372036854775807L) || ((*(arg)).value.dval) < (-9223372036854775807L -1)))), 0)) {
   return 0;
  } else {
  ...
  if (__builtin_expect(!!((type = is_numeric_str_function((*(arg)).value.str, dest, &d)) != 4), 0)) {
   if (__builtin_expect(!!(type != 0), 1)) {
    if (__builtin_expect(!!((sizeof (d) == sizeof (float) ? __isnanf (d) : sizeof (d) == sizeof (double) ? __isnan (d) : __isnanl (d))), 0)) {
     return 0;
    }
    if (__builtin_expect(!!(!(!((d) >= (9223372036854775807L) || (d) < (-9223372036854775807L -1)))), 0)) {
     return 0;
    } else {
...
__attribute__ ((visibility("default"))) int zend_parse_arg_long_cap_weak(zval *arg, zend_long *dest)
{
  ...
  *dest = zend_dval_to_lval_cap((*(arg)).value.dval);
 } else if (__builtin_expect(!!(zval_get_type(&(*(arg))) == 6), 1)) {
  double d;
  int type;
...
__attribute__ ((visibility("default"))) int zend_parse_arg_double_slow(zval *arg, double *dest)
{
  ...
  *dest = (double)(*(arg)).value.lval;
 } else if (__builtin_expect(!!(((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0))), 0)) {
  return 0;
 }
...
__attribute__ ((visibility("default"))) int zend_parse_arg_str_weak(zval *arg, zend_string **dest)
{
  ...
  *dest = (*(arg)).value.str;
  ...
  if (((*(arg))).value.obj->handlers->cast_object) {
   zval obj;
   if (((*(arg))).value.obj->handlers->cast_object(arg, &obj, 6) == SUCCESS) {
    _zval_ptr_dtor((arg) );
    do { zval *_z1 = (arg); const zval *_z2 = (&obj); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    *dest = (*(arg)).value.str;
    return 1;
   }
  } else if (((*(arg))).value.obj->handlers->get) {
   zval rv;
   zval *z = ((*(arg))).value.obj->handlers->get(arg, &rv);

   zval_addref_p(z);
   if (zval_get_type(&(*(z))) != 8) {
    _zval_ptr_dtor_nogc((arg) );
    do { (*(arg)).u1.type_info = 1; } while (0);
    if (!zend_make_printable_zval(z, arg)) {
     do { zval *_z1 = (arg); const zval *_z2 = (z); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    }
    *dest = (*(arg)).value.str;
    return 1;
   }
...
static const char *zend_parse_arg_impl(int arg_num, zval *arg, va_list *va, const char **spec, char **error, int *severity)
{
 ...
 while (1) {
  if (*spec_walk == '/') {
   do { zval *_zv = (arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0);
   real_arg = arg;
  } else if (*spec_walk == '!') {
   check_null = 1;
  } else {
 ...
 switch (c) {
  ...
  case 'L':
   {
    zend_long *p = __builtin_va_arg(*va,zend_long *);
    zend_bool *is_null = ((void *)0);

    if (check_null) {
     is_null = __builtin_va_arg(*va,zend_bool *);
    }
  ...
  case 's':
   {
    ...
    size_t *pl = __builtin_va_arg(*va,size_t *);
  ...
  case 'o':
   {
    ...
    if (!zend_parse_arg_object(arg, p, ((void *)0), check_null)) {
     return "object";
    }
   }
   break;
  ...
  case 'Z':
   ...
   do { if (__builtin_expect(!(c != 'Z'), 0)) __builtin_unreachable(); } while (0);
  default:
   return "unknown";
 }
...
static int zend_parse_arg(int arg_num, zval *arg, va_list *va, const char **spec, int flags)
{
 ...
 if (expected_type) {
  if (!(flags & (1<<1)) && (*expected_type || error)) {
   const char *space;
   const char *class_name = get_active_class_name(&space);
   zend_bool throw_exception =
    ((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)) || (flags & (1<<2));
...
static __attribute__((cold)) void zend_parse_parameters_debug_error(const char *msg) {
 zend_function *active_function = (executor_globals.current_execute_data)->func;
 const char *class_name = active_function->common.scope
  ? (active_function->common.scope->name)->val : "";
 zend_error_noreturn((1<<4L), "%s%s%s(): %s",
...
static int zend_parse_va_args(int num_args, const char *type_spec, va_list *va, int flags)
{
 ...
 if (num_args < min_num_args || (num_args > max_num_args && max_num_args >= 0)) {
  if (!(flags & (1<<1))) {
   zend_function *active_function = (executor_globals.current_execute_data)->func;
   const char *class_name = active_function->common.scope ? (active_function->common.scope->name)->val : "";
   zend_bool throw_exception = ((executor_globals.current_execute_data)->prev_execute_data && (executor_globals.current_execute_data)->prev_execute_data->func && ((((executor_globals.current_execute_data)->prev_execute_data)->func->common.fn_flags & 0x80000000) != 0)) || (flags & (1<<2));
 ...
 while (num_args-- > 0) {
  ...
  if (*type_spec == '*' || *type_spec == '+') {
    ...
    *varargs = (((zval*)((executor_globals.current_execute_data))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(i + 1)) - 1))));
  ...
  arg = (((zval*)((executor_globals.current_execute_data))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(i + 1)) - 1))));
...
__attribute__ ((visibility("default"))) int zend_parse_method_parameters(int num_args, zval *this_ptr, const char *type_spec, ...)
{
  ...
  *object = this_ptr;
  ...
  if (ce && !instanceof_function(((*(this_ptr)).value.obj->ce), ce)) {
   zend_error_noreturn((1<<4L), "%s::%s() must be derived from %s::%s",
    (((*(this_ptr)).value.obj->ce)->name)->val, get_active_function_name(), (ce->name)->val, get_active_function_name());
  }
...
__attribute__ ((visibility("default"))) int zend_parse_method_parameters_ex(int flags, int num_args, zval *this_ptr, const char *type_spec, ...)
{
  ...
  *object = this_ptr;
  ...
  if (ce && !instanceof_function(((*(this_ptr)).value.obj->ce), ce)) {
   if (!(flags & (1<<1))) {
    zend_error_noreturn((1<<4L), "%s::%s() must be derived from %s::%s",
     (ce->name)->val, get_active_function_name(), (((*(this_ptr)).value.obj->ce)->name)->val, get_active_function_name());
   }
   __builtin_va_end(va);
   return FAILURE;
  }
...
__attribute__ ((visibility("default"))) void zend_merge_properties(zval *obj, HashTable *properties)
{
 ...
 zend_class_entry *old_scope = (executor_globals.fake_scope);
 zend_string *key;
 zval *value;

 (executor_globals.fake_scope) = ((*(obj)).value.obj->ce);
 do { Bucket *_p = (properties)->arData; Bucket *_end = _p + (properties)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; value = _z; {
  if (key) {
   zval member;

   do { zval *__z = (&member); zend_string *__s = (key); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
...
__attribute__ ((visibility("default"))) int zend_update_class_constants(zend_class_entry *class_type)
{
 if (!(class_type->ce_flags & 0x100000)) {
  class_type->ce_flags |= 0x100000;

  if (class_type->parent) {
   if (__builtin_expect(!!(zend_update_class_constants(class_type->parent) != SUCCESS), 0)) {
    return FAILURE;
   }
  }
  ...
  if (!((class_type)->static_members_table) && class_type->default_static_members_count) {
   ...
   class_type->static_members_table = (__builtin_constant_p((sizeof(zval) * class_type->default_static_members_count) ) ? (((sizeof(zval) * class_type->default_static_members_count) <= 8) ? _emalloc_8() : (((sizeof(zval) * class_type->default_static_members_count) <= 16) ? _emalloc_16() : (((sizeof(zval) * class_type->default_static_members_count) <= 24) ? _emalloc_24() : (((sizeof(zval) * class_type->default_static_members_count) <= 32) ? _emalloc_32() : (((sizeof(zval) * class_type->default_static_members_count) <= 40) ? _emalloc_40() : (((sizeof(zval) * class_type->default_static_members_count) <= 48) ? _emalloc_48() : (((sizeof(zval) * class_type->default_static_members_count) <= 56) ? _emalloc_56() : (((sizeof(zval) * class_type->default_static_members_count) <= 64) ? _emalloc_64() : (((sizeof(zval) * class_type->default_static_members_count) <= 80) ? _emalloc_80() : (((sizeof(zval) * class_type->default_static_members_count) <= 96) ? _emalloc_96() : (((sizeof(zval) * class_type->default_static_members_count) <= 112) ? _emalloc_112() : (((sizeof(zval) * class_type->default_static_members_count) <= 128) ? _emalloc_128() : (((sizeof(zval) * class_type->default_static_members_count) <= 160) ? _emalloc_160() : (((sizeof(zval) * class_type->default_static_members_count) <= 192) ? _emalloc_192() : (((sizeof(zval) * class_type->default_static_members_count) <= 224) ? _emalloc_224() : (((sizeof(zval) * class_type->default_static_members_count) <= 256) ? _emalloc_256() : (((sizeof(zval) * class_type->default_static_members_count) <= 320) ? _emalloc_320() : (((sizeof(zval) * class_type->default_static_members_count) <= 384) ? _emalloc_384() : (((sizeof(zval) * class_type->default_static_members_count) <= 448) ? _emalloc_448() : (((sizeof(zval) * class_type->default_static_members_count) <= 512) ? _emalloc_512() : (((sizeof(zval) * class_type->default_static_members_count) <= 640) ? _emalloc_640() : (((sizeof(zval) * class_type->default_static_members_count) <= 768) ? _emalloc_768() : (((sizeof(zval) * class_type->default_static_members_count) <= 896) ? _emalloc_896() : (((sizeof(zval) * class_type->default_static_members_count) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * class_type->default_static_members_count) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * class_type->default_static_members_count) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * class_type->default_static_members_count) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * class_type->default_static_members_count) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * class_type->default_static_members_count) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * class_type->default_static_members_count) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * class_type->default_static_members_count) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * class_type->default_static_members_count)) : _emalloc_huge((sizeof(zval) * class_type->default_static_members_count))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * class_type->default_static_members_count) ) );
   ...
   do { Bucket *_p = (&class_type->constants_table)->arData; Bucket *_end = _p + (&class_type->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; c = (*(_z)).value.ptr; {
    val = &c->value;
    if ((((*(val)).u1.v.type_flags & (1<<0)) != 0)) {
     if (__builtin_expect(!!(zval_update_constant_ex(val, class_type) != SUCCESS), 0)) {
      return FAILURE;
     }
    }
   } } } while (0);
   ...
   ce = class_type;
   while (ce) {
    do { Bucket *_p = (&ce->properties_info)->arData; Bucket *_end = _p + (&ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; prop_info = (*(_z)).value.ptr; {
     if (prop_info->ce == ce) {
      if (prop_info->flags & 0x01) {
       val = ((class_type)->static_members_table) + prop_info->offset;
      } else {
       val = (zval*)((char*)class_type->default_properties_table + prop_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)])));
      }
      do { if (__builtin_expect(!!((zval_get_type(&(*(val))) == 10)), 0)) { (val) = &(*(val)).value.ref->val; } } while (0);
      if ((((*(val)).u1.v.type_flags & (1<<0)) != 0)) {
       if (__builtin_expect(!!(zval_update_constant_ex(val, ce) != SUCCESS), 0)) {
        return FAILURE;
       }
      }
     }
...
__attribute__ ((visibility("default"))) void object_properties_init(zend_object *object, zend_class_entry *class_type)
{
 if (class_type->default_properties_count) {
  ...
  do {
   ...
   do { zval *_z1 = (dst); const zval *_z2 = (src); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
__attribute__ ((visibility("default"))) void object_properties_init_ex(zend_object *object, HashTable *properties)
{
 ...
 if (object->ce->default_properties_count) {
  ...
  do { Bucket *_p = (properties)->arData; Bucket *_end = _p + (properties)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; prop = _z; {
   property_info = zend_get_property_info(object->ce, key, 1);
   if (property_info != ((struct _zend_property_info*)((zend_intptr_t)-1)) &&
       property_info &&
       (property_info->flags & 0x01) == 0) {
    zval *slot = ((zval*)((char*)(object) + property_info->offset));
    do { zval *_z1 = (slot); const zval *_z2 = (prop); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    do { (*(prop)).value.zv = (slot); (*(prop)).u1.type_info = 15; } while (0);
   }
  } } } while (0);
 }
}
...
__attribute__ ((visibility("default"))) void object_properties_load(zend_object *object, HashTable *properties)
{
    ...
    do { Bucket *_p = (properties)->arData; Bucket *_end = _p + (properties)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; h = _p->h; key = _p->key; prop = _z; {
  if (key) {
   if ((key)->val[0] == '\0') {
    ...
    if (zend_unmangle_property_name_ex(key, &class_name, &prop_name, &prop_name_len) == SUCCESS) {
     ...
     zend_class_entry *prev_scope = (executor_globals.fake_scope);
     if (class_name && class_name[0] != '*') {
      zend_string *cname = zend_string_init(class_name, strlen(class_name), 0);
      (executor_globals.fake_scope) = zend_lookup_class(cname);
      zend_string_release(cname);
     }
     property_info = zend_get_property_info(object->ce, pname, 1);
     zend_string_release(pname);
     (executor_globals.fake_scope) = prev_scope;
    } else {
     property_info = ((struct _zend_property_info*)((zend_intptr_t)-1));
    }
   } else {
    property_info = zend_get_property_info(object->ce, key, 1);
   }
   if (property_info != ((struct _zend_property_info*)((zend_intptr_t)-1)) &&
    ...
    if (object->properties) {
     do { (*(&tmp)).value.zv = (slot); (*(&tmp)).u1.type_info = 15; } while (0);
     _zend_hash_update(object->properties, key, &tmp );
    }
   } else {
    if (!object->properties) {
   ...
   prop = _zend_hash_index_update(object->properties, h, prop );
   zval_add_ref(prop);
  }
 } } } while (0);
}
...
{
 if (__builtin_expect(!!(class_type->ce_flags & (0x40|0x80|0x10|0x20)), 0)) {
  if (class_type->ce_flags & 0x40) {
   zend_throw_error(((void *)0), "Cannot instantiate interface %s", (class_type->name)->val);
  } else if (class_type->ce_flags & 0x80) {
   zend_throw_error(((void *)0), "Cannot instantiate trait %s", (class_type->name)->val);
  } else {
   zend_throw_error(((void *)0), "Cannot instantiate abstract class %s", (class_type->name)->val);
  }
  do { (*(arg)).u1.type_info = 1; } while (0);
  (*(arg)).value.obj = ((void *)0);
  return FAILURE;
 }

 if (__builtin_expect(!!(!(class_type->ce_flags & 0x100000)), 0)) {
  if (__builtin_expect(!!(zend_update_class_constants(class_type) != SUCCESS), 0)) {
   do { (*(arg)).u1.type_info = 1; } while (0);
   (*(arg)).value.obj = ((void *)0);
   return FAILURE;
  }
 ...
 if (class_type->create_object == ((void *)0)) {
  do { zval *__z = (arg); (*(__z)).value.obj = (zend_objects_new(class_type)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
  if (properties) {
  ...
  do { zval *__z = (arg); (*(__z)).value.obj = (class_type->create_object(class_type)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
 }
 return SUCCESS;
}
...
__attribute__ ((visibility("default"))) int add_assoc_long_ex(zval *arg, const char *key, size_t key_len, zend_long n)
{
 ...
 ret = zend_symtable_str_update((*(arg)).value.arr, key, key_len, &tmp);
...
__attribute__ ((visibility("default"))) int add_assoc_resource_ex(zval *arg, const char *key, size_t key_len, zend_resource *r)
{
 ...
 do { zval *__z = (&tmp); (*__z).value.res = (r); (*(__z)).u1.type_info = (9 | (( (1<<2) ) << 8)); } while (0);
 ret = zend_symtable_str_update((*(arg)).value.arr, key, key_len, &tmp);
 return ret ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) int add_assoc_str_ex(zval *arg, const char *key, size_t key_len, zend_string *str)
{
 ...
 do { zval *__z = (&tmp); zend_string *__s = (str); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 ret = zend_symtable_str_update((*(arg)).value.arr, key, key_len, &tmp);
 return ret ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) int add_assoc_string_ex(zval *arg, const char *key, size_t key_len, char *str)
{
 ...
 do { const char *_s = (str); do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
 ret = zend_symtable_str_update((*(arg)).value.arr, key, key_len, &tmp);
 return ret ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) int add_assoc_stringl_ex(zval *arg, const char *key, size_t key_len, char *str, size_t length)
{
 ...
 do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(str, length, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 ret = zend_symtable_str_update((*(arg)).value.arr, key, key_len, &tmp);
 return ret ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) int add_assoc_zval_ex(zval *arg, const char *key, size_t key_len, zval *value)
{
 ...
 ret = zend_symtable_str_update((*(arg)).value.arr, key, key_len, value);
 return ret ? SUCCESS : FAILURE;
}


__attribute__ ((visibility("default"))) int add_index_long(zval *arg, zend_ulong index, zend_long n)
{
 zval tmp;

 { zval *__z = (&tmp); (*(__z)).value.lval = n; (*(__z)).u1.type_info = 4; };
 return _zend_hash_index_update((*(arg)).value.arr, index, &tmp ) ? SUCCESS : FAILURE;
}


__attribute__ ((visibility("default"))) int add_index_null(zval *arg, zend_ulong index)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_bool(zval *arg, zend_ulong index, int b)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_resource(zval *arg, zend_ulong index, zend_resource *r)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_double(zval *arg, zend_ulong index, double d)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_str(zval *arg, zend_ulong index, zend_string *str)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_string(zval *arg, zend_ulong index, const char *str)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_stringl(zval *arg, zend_ulong index, const char *str, size_t length)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int add_index_zval(zval *arg, zend_ulong index, zval *value)
{
 return _zend_hash_index_update((*(arg)).value.arr, index, value ) ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) int add_next_index_long(zval *arg, zend_long n)
{
 ...
 { zval *__z = (&tmp); (*(__z)).value.lval = n; (*(__z)).u1.type_info = 4; };
 return _zend_hash_next_index_insert((*(arg)).value.arr, &tmp ) ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) int add_next_index_zval(zval *arg, zval *value)
{
 return _zend_hash_next_index_insert((*(arg)).value.arr, value ) ? SUCCESS : FAILURE;
}
...
__attribute__ ((visibility("default"))) zval *add_get_index_long(zval *arg, zend_ulong index, zend_long l)
{
 zval tmp;

 { zval *__z = (&tmp); (*(__z)).value.lval = l; (*(__z)).u1.type_info = 4; };
 return _zend_hash_index_update((*(arg)).value.arr, index, &tmp );
}


__attribute__ ((visibility("default"))) zval *add_get_index_double(zval *arg, zend_ulong index, double d)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) zval *add_get_index_string(zval *arg, zend_ulong index, const char *str)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) zval *add_get_index_stringl(zval *arg, zend_ulong index, const char *str, size_t length)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) int array_set_zval_key(HashTable *ht, zval *key, zval *value)
{
 ...
 switch (zval_get_type(&(*(key)))) {
  ...
  case 1:
   ...
   break;
  case 9:
   zend_error((1<<3L), "Resource ID#%d used as offset, casting to integer (%d)", (*key).value.res->handle, (*key).value.res->handle);
 ...
 if (result) {
  if ((((*(result)).u1.v.type_flags & (1<<2)) != 0)) {
...
__attribute__ ((visibility("default"))) int add_property_long_ex(zval *arg, const char *key, size_t key_len, zend_long n)
{
 zval tmp;
 zval z_key;

 { zval *__z = (&tmp); (*(__z)).value.lval = n; (*(__z)).u1.type_info = 4; };
 do { do { zval *__z = (&z_key); zend_string *__s = (zend_string_init(key, key_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
...
__attribute__ ((visibility("default"))) int zend_startup_module_ex(zend_module_entry *module)
{
 ...
 if (module->module_startup_func) {
  ...
  if (module->module_startup_func(module->type, module->module_number)==FAILURE) {
   zend_error_noreturn((1<<4L),"Unable to start %s module", module->name);
...
__attribute__ ((visibility("default"))) void zend_collect_module_handlers(void)
{
 ...
 do { Bucket *_p = ((compiler_globals.class_table))->arData; Bucket *_end = _p + ((compiler_globals.class_table))->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; ce = (*(_z)).value.ptr; {
  if (ce->type == 1 &&
...
__attribute__ ((visibility("default"))) int zend_startup_modules(void)
{
 zend_hash_sort_ex(&module_registry, zend_sort_modules, ((void *)0), 0);
...
__attribute__ ((visibility("default"))) void zend_check_magic_method_implementation(const zend_class_entry *ce, const zend_function *fptr, int error_type)
{
 ...
 if (name_len == sizeof("__destruct") - 1 && !memcmp(lcname, "__destruct", sizeof("__destruct") - 1) && fptr->common.num_args != 0) {
  ...
  } else if (zend_check_arg_send_type(fptr, 1, 1|2)) {
  ...
  } else if (zend_check_arg_send_type(fptr, 1, 1|2) || zend_check_arg_send_type(fptr, 2, 1|2)) {
...
__attribute__ ((visibility("default"))) int zend_register_functions(zend_class_entry *scope, const zend_function_entry *functions, HashTable *function_table, int type)
{
 ...
 memset(internal_function->reserved, 0, 4 * sizeof(void*));
 ...
 while (ptr->fname) {
  ...
  if (ptr->arg_info) {
   ...
   if (info->type_hint) {
    if (info->class_name) {
     do { if (__builtin_expect(!(info->type_hint == 8), 0)) __builtin_unreachable(); } while (0);
     if (!scope && (!strcasecmp(info->class_name, "self") || !strcasecmp(info->class_name, "parent"))) {
      zend_error_noreturn((1<<4L), "Cannot declare a return type of %s outside of a class scope", info->class_name);
     }
    }

    internal_function->fn_flags |= 0x40000000;
   }
  } else {
  ...
  if (scope) {
   ...
   if ((fname_len == class_name_len) && !ctor && !memcmp((lowercase_name)->val, lc_class_name, class_name_len+1)) {
    ctor = reg_function;
   } else if (((lowercase_name)->len == sizeof("__construct")-1 && !memcmp((lowercase_name)->val, "__construct", sizeof("__construct") - 1))) {
    ctor = reg_function;
   } else if (((lowercase_name)->len == sizeof("__destruct")-1 && !memcmp((lowercase_name)->val, "__destruct", sizeof("__destruct") - 1))) {
    dtor = reg_function;
    if (internal_function->num_args) {
     zend_error(error_type, "Destructor %s::%s() cannot take arguments", (scope->name)->val, ptr->fname);
    }
   } else if (((lowercase_name)->len == sizeof("__clone")-1 && !memcmp((lowercase_name)->val, "__clone", sizeof("__clone") - 1))) {
    clone = reg_function;
   } else if (((lowercase_name)->len == sizeof("__call")-1 && !memcmp((lowercase_name)->val, "__call", sizeof("__call") - 1))) {
    __call = reg_function;
   } else if (((lowercase_name)->len == sizeof("__callstatic")-1 && !memcmp((lowercase_name)->val, "__callstatic", sizeof("__callstatic") - 1))) {
    __callstatic = reg_function;
   } else if (((lowercase_name)->len == sizeof("__tostring")-1 && !memcmp((lowercase_name)->val, "__tostring", sizeof("__tostring") - 1))) {
    __tostring = reg_function;
   } else if (((lowercase_name)->len == sizeof("__get")-1 && !memcmp((lowercase_name)->val, "__get", sizeof("__get") - 1))) {
    __get = reg_function;
    scope->ce_flags |= 0x1000000;
   } else if (((lowercase_name)->len == sizeof("__set")-1 && !memcmp((lowercase_name)->val, "__set", sizeof("__set") - 1))) {
    __set = reg_function;
    scope->ce_flags |= 0x1000000;
   } else if (((lowercase_name)->len == sizeof("__unset")-1 && !memcmp((lowercase_name)->val, "__unset", sizeof("__unset") - 1))) {
    __unset = reg_function;
    scope->ce_flags |= 0x1000000;
   } else if (((lowercase_name)->len == sizeof("__isset")-1 && !memcmp((lowercase_name)->val, "__isset", sizeof("__isset") - 1))) {
    __isset = reg_function;
    scope->ce_flags |= 0x1000000;
   } else if (((lowercase_name)->len == sizeof("__debuginfo")-1 && !memcmp((lowercase_name)->val, "__debuginfo", sizeof("__debuginfo") - 1))) {
 ...
 if (scope) {
  ...
  if (ctor && ctor->common.fn_flags & 0x40000000 && ctor->common.fn_flags & 0x2000) {
   zend_error_noreturn((1<<4L), "Constructor %s::%s() cannot declare a return type", (scope->name)->val, (ctor->common.function_name)->val);
  }

  if (dtor && dtor->common.fn_flags & 0x40000000 && dtor->common.fn_flags & 0x4000) {
   zend_error_noreturn((1<<4L), "Destructor %s::%s() cannot declare a return type", (scope->name)->val, (dtor->common.function_name)->val);
  }

  if (clone && clone->common.fn_flags & 0x40000000 && dtor->common.fn_flags & 0x4000) {
   zend_error_noreturn((1<<4L), "%s::%s() cannot declare a return type", (scope->name)->val, (clone->common.function_name)->val);
  }
  _efree(((char*)lc_class_name) );
 }
 return SUCCESS;
...
__attribute__ ((visibility("default"))) zend_class_entry *zend_register_internal_interface(zend_class_entry *orig_class_entry)
{
 return do_register_internal_class(orig_class_entry, 0x40);
}
...
__attribute__ ((visibility("default"))) int zend_set_hash_symbol(zval *symbol, const char *name, int name_length, zend_bool is_ref, int num_symbol_tables, ...)
{
 ...
 while (num_symbol_tables-- > 0) {
  ...
  if ((((*(symbol)).u1.v.type_flags & (1<<2)) != 0)) {
...
__attribute__ ((visibility("default"))) int zend_disable_function(char *function_name, size_t function_name_length)
{
 ...
 if ((func = zend_hash_str_find_ptr((compiler_globals.function_table), function_name, function_name_length))) {
     func->fn_flags &= ~(0x1000000 | 0x10000000);
  func->num_args = 0;
  func->arg_info = ((void *)0);
  func->handler = zif_display_disabled_function;
  return SUCCESS;
 }
 return FAILURE;
}
...
static int zend_is_callable_check_class(zend_string *name, zend_class_entry *scope, zend_fcall_info_cache *fcc, int *strict_class, char **error)
{
 ...
 do { (lcname) = (zend_string *)(((use_heap) = (__builtin_expect(!!((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) > ((32 * 1024))), 0))) ? (__builtin_constant_p((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ? (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 8) ? _emalloc_8() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 16) ? _emalloc_16() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 24) ? _emalloc_24() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 32) ? _emalloc_32() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 40) ? _emalloc_40() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 48) ? _emalloc_48() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 56) ? _emalloc_56() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 64) ? _emalloc_64() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 80) ? _emalloc_80() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 96) ? _emalloc_96() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 112) ? _emalloc_112() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 128) ? _emalloc_128() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 160) ? _emalloc_160() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 192) ? _emalloc_192() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 224) ? _emalloc_224() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 256) ? _emalloc_256() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 320) ? _emalloc_320() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 384) ? _emalloc_384() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 448) ? _emalloc_448() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 512) ? _emalloc_512() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 640) ? _emalloc_640() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 768) ? _emalloc_768() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 896) ? _emalloc_896() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1024) ? _emalloc_1024() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1280) ? _emalloc_1280() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1536) ? _emalloc_1536() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1792) ? _emalloc_1792() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2048) ? _emalloc_2048() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2560) ? _emalloc_2560() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 3072) ? _emalloc_3072() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L)))) : _emalloc_huge((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ) : __builtin_alloca (((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + name_len + 1)) + ((8) - 1L)) & ~((8) - 1L)))); (lcname)->gc.refcount = 1; (lcname)->gc.u.type_info = 6; zend_string_forget_hash_val(lcname); (lcname)->len = name_len; } while (0);
 ...
 *strict_class = 0;
 if (((lcname)->len == sizeof("self")-1 && !memcmp((lcname)->val, "self", sizeof("self") - 1))) {
  if (!scope) {
   ...
   fcc->called_scope = zend_get_called_scope((executor_globals.current_execute_data));
   fcc->calling_scope = scope;
   if (!fcc->object) {
    fcc->object = zend_get_this_object((executor_globals.current_execute_data));
   }
   ret = 1;
  }
  ...
  zend_class_entry *called_scope = zend_get_called_scope((executor_globals.current_execute_data));
  ...
  if (scope && !fcc->object) {
   zend_object *object = zend_get_this_object((executor_globals.current_execute_data));
...
static int zend_is_callable_check_func(int check_flags, zval *callable, zend_fcall_info_cache *fcc, int strict_class, char **error)
{
 ...
 if (!ce_org) {
  ...
  if (__builtin_expect(!!(((*(callable)).value.str)->val[0] == '\\'), 0)) {
   do { do { (lmname) = (zend_string *)(((use_heap) = (__builtin_expect(!!((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) > ((32 * 1024))), 0))) ? (__builtin_constant_p((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ? (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 8) ? _emalloc_8() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 16) ? _emalloc_16() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 24) ? _emalloc_24() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 32) ? _emalloc_32() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 40) ? _emalloc_40() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 48) ? _emalloc_48() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 56) ? _emalloc_56() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 64) ? _emalloc_64() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 80) ? _emalloc_80() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 96) ? _emalloc_96() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 112) ? _emalloc_112() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 128) ? _emalloc_128() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 160) ? _emalloc_160() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 192) ? _emalloc_192() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 224) ? _emalloc_224() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 256) ? _emalloc_256() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 320) ? _emalloc_320() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 384) ? _emalloc_384() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 448) ? _emalloc_448() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 512) ? _emalloc_512() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 640) ? _emalloc_640() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 768) ? _emalloc_768() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 896) ? _emalloc_896() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1024) ? _emalloc_1024() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1280) ? _emalloc_1280() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1536) ? _emalloc_1536() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1792) ? _emalloc_1792() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2048) ? _emalloc_2048() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2560) ? _emalloc_2560() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 3072) ? _emalloc_3072() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L)))) : _emalloc_huge((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ) : __builtin_alloca (((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len - 1 + 1)) + ((8) - 1L)) & ~((8) - 1L)))); (lmname)->gc.refcount = 1; (lmname)->gc.u.type_info = 6; zend_string_forget_hash_val(lmname); (lmname)->len = ((*(callable)).value.str)->len - 1; } while (0); memcpy((lmname)->val, (((*(callable)).value.str)->val + 1), (((*(callable)).value.str)->len - 1)); (lmname)->val[(((*(callable)).value.str)->len - 1)] = '\0'; } while (0);
  } else {
  ...
  if (__builtin_expect(!!((fcc->function_handler = zend_hash_find_ptr((executor_globals.function_table), lmname)) != ((void *)0)), 1)) {
   ...
   if (lmname == (*(callable)).value.str) {
    do { do { (lmname) = (zend_string *)(((use_heap) = (__builtin_expect(!!((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) > ((32 * 1024))), 0))) ? (__builtin_constant_p((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ? (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 8) ? _emalloc_8() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 16) ? _emalloc_16() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 24) ? _emalloc_24() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 32) ? _emalloc_32() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 40) ? _emalloc_40() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 48) ? _emalloc_48() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 56) ? _emalloc_56() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 64) ? _emalloc_64() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 80) ? _emalloc_80() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 96) ? _emalloc_96() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 112) ? _emalloc_112() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 128) ? _emalloc_128() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 160) ? _emalloc_160() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 192) ? _emalloc_192() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 224) ? _emalloc_224() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 256) ? _emalloc_256() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 320) ? _emalloc_320() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 384) ? _emalloc_384() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 448) ? _emalloc_448() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 512) ? _emalloc_512() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 640) ? _emalloc_640() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 768) ? _emalloc_768() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 896) ? _emalloc_896() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1024) ? _emalloc_1024() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1280) ? _emalloc_1280() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1536) ? _emalloc_1536() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 1792) ? _emalloc_1792() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2048) ? _emalloc_2048() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 2560) ? _emalloc_2560() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= 3072) ? _emalloc_3072() : (((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L)))) : _emalloc_huge((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L))) ) ) : __builtin_alloca (((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(callable)).value.str)->len + 1)) + ((8) - 1L)) & ~((8) - 1L)))); (lmname)->gc.refcount = 1; (lmname)->gc.u.type_info = 6; zend_string_forget_hash_val(lmname); (lmname)->len = ((*(callable)).value.str)->len; } while (0); memcpy((lmname)->val, (((*(callable)).value.str)->val), (((*(callable)).value.str)->len)); (lmname)->val[(((*(callable)).value.str)->len)] = '\0'; } while (0);
   } else {
  ...
  *(colon-1) == ':'
  ...
  cname = zend_string_init(((*(callable)).value.str)->val, clen, 0);
  ...
  mname = zend_string_init(((*(callable)).value.str)->val + clen + 2, mlen, 0);
 } else if (ce_org) {
 ...
 if (strict_class &&
     fcc->calling_scope &&
  ((lmname)->len == sizeof("__construct")-1 && !memcmp((lmname)->val, "__construct", sizeof("__construct") - 1))) {
  ...
  if ((fcc->function_handler->op_array.fn_flags & 0x800) &&
   ...
   if (scope &&
    ...
    if ((priv_fbc = zend_hash_find_ptr(&scope->function_table, lmname)) != ((void *)0)
   ...
   if (strict_class && ce_org->__call) {
    ...
    if (fcc->function_handler) {
     if (strict_class &&
      ...
      if (fcc->function_handler->common.fn_flags & 0x200000) {
       if (fcc->function_handler->type != 3) {
        zend_string_release(fcc->function_handler->common.function_name);
       }
       do { if ((fcc->function_handler) == &(executor_globals.trampoline)) { (executor_globals.trampoline).common.function_name = ((void *)0); } else { _efree((fcc->function_handler) ); } } while (0);
      }
     } else {
      retval = 1;
  ...
  if (fcc->calling_scope && !call_via_handler) {
   if (!fcc->object && (fcc->function_handler->common.fn_flags & 0x02)) {
    if (error) {
     ...
     zend_throw_error(((void *)0), "Cannot call abstract method %s::%s()", (fcc->calling_scope->name)->val, (fcc->function_handler->common.function_name)->val);
     return 0;
    }
    ...
    if (error) {
     ...
     if (severity == (1<<0L)) {
      zend_throw_error(((void *)0), "Non-static method %s::%s() %s be called statically", (fcc->calling_scope->name)->val, (fcc->function_handler->common.function_name)->val, verb);
     } else {
 ...
 switch (zval_get_type(&(*(callable)))) {
  case 6:
   if (object) {
     ...
     *callable_name = zend_string_alloc((fcc->calling_scope->name)->len + ((*(callable)).value.str)->len + sizeof("::") - 1, 0);
    ...
    *callable_name = zend_string_copy((*(callable)).value.str);
   }
   if (check_flags & (1<<0)) {
    fcc->called_scope = fcc->calling_scope;
    return 1;
  ...
  case 7:
   {
    ...
    do {
     ...
     if (zval_get_type(&(*(obj))) == 6) {
       ...
       *callable_name = zend_string_alloc(((*(obj)).value.str)->len + ((*(method)).value.str)->len + sizeof("::") - 1, 0);
       ptr = (*callable_name)->val;
      ...
      if (!zend_is_callable_check_class((*(obj)).value.str, zend_get_executed_scope(), fcc, &strict_class, error)) {
       return 0;
      }
       ...
       *callable_name = zend_string_alloc((fcc->calling_scope->name)->len + ((*(method)).value.str)->len + sizeof("::") - 1, 0);
       ptr = (*callable_name)->val;
       memcpy(ptr, (fcc->calling_scope->name)->val, (fcc->calling_scope->name)->len);
       ptr += (fcc->calling_scope->name)->len;
       memcpy(ptr, "::", sizeof("::") - 1);
  ...
  case 8:
   if (((*(callable))).value.obj->handlers->get_closure && ((*(callable))).value.obj->handlers->get_closure(callable, &fcc->calling_scope, &fcc->function_handler, &fcc->object) == SUCCESS) {
    fcc->called_scope = fcc->calling_scope;
    if (callable_name) {
     zend_class_entry *ce = ((*(callable)).value.obj->ce);
...
__attribute__ ((visibility("default"))) int zend_fcall_info_init(zval *callable, uint check_flags, zend_fcall_info *fci, zend_fcall_info_cache *fcc, zend_string **callable_name, char **error)
{
 ...
 do { zval *_z1 = (&fci->function_name); const zval *_z2 = (callable); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 fci->retval = ((void *)0);
 fci->param_count = 0;
 fci->params = ((void *)0);
 fci->no_separation = 1;
...
__attribute__ ((visibility("default"))) int zend_fcall_info_args_ex(zend_fcall_info *fci, zend_function *func, zval *args)
{
 ...
 fci->param_count = ((*(args)).value.arr)->nNumOfElements;
 fci->params = params = (zval *) _erealloc((fci->params), (fci->param_count * sizeof(zval)) );

 do { Bucket *_p = ((*(args)).value.arr)->arData; Bucket *_end = _p + ((*(args)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; arg = _z; {
  if (func && !(zval_get_type(&(*(arg))) == 10) && zend_check_arg_send_type(func, n, 1|2)) {
   do { zend_reference *_ref = (zend_reference *) (__builtin_constant_p((sizeof(zend_reference)) ) ? (((sizeof(zend_reference)) <= 8) ? _emalloc_8() : (((sizeof(zend_reference)) <= 16) ? _emalloc_16() : (((sizeof(zend_reference)) <= 24) ? _emalloc_24() : (((sizeof(zend_reference)) <= 32) ? _emalloc_32() : (((sizeof(zend_reference)) <= 40) ? _emalloc_40() : (((sizeof(zend_reference)) <= 48) ? _emalloc_48() : (((sizeof(zend_reference)) <= 56) ? _emalloc_56() : (((sizeof(zend_reference)) <= 64) ? _emalloc_64() : (((sizeof(zend_reference)) <= 80) ? _emalloc_80() : (((sizeof(zend_reference)) <= 96) ? _emalloc_96() : (((sizeof(zend_reference)) <= 112) ? _emalloc_112() : (((sizeof(zend_reference)) <= 128) ? _emalloc_128() : (((sizeof(zend_reference)) <= 160) ? _emalloc_160() : (((sizeof(zend_reference)) <= 192) ? _emalloc_192() : (((sizeof(zend_reference)) <= 224) ? _emalloc_224() : (((sizeof(zend_reference)) <= 256) ? _emalloc_256() : (((sizeof(zend_reference)) <= 320) ? _emalloc_320() : (((sizeof(zend_reference)) <= 384) ? _emalloc_384() : (((sizeof(zend_reference)) <= 448) ? _emalloc_448() : (((sizeof(zend_reference)) <= 512) ? _emalloc_512() : (((sizeof(zend_reference)) <= 640) ? _emalloc_640() : (((sizeof(zend_reference)) <= 768) ? _emalloc_768() : (((sizeof(zend_reference)) <= 896) ? _emalloc_896() : (((sizeof(zend_reference)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_reference)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_reference)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_reference)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_reference)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_reference)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_reference)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_reference)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_reference))) : _emalloc_huge((sizeof(zend_reference)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_reference)) ) ); (_ref)->gc.refcount = 1; (_ref)->gc.u.type_info = 10; do { zval *_z1 = (&_ref->val); const zval *_z2 = (arg); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); (*(params)).value.ref = _ref; (*(params)).u1.type_info = (10 | (( (1<<2) ) << 8)); } while (0);
   if ((((*(arg)).u1.v.type_flags & (1<<2)) != 0)) {
    zval_addref_p(arg);
   }
  } else {
   do { zval *_z1 = (params); const zval *_z2 = (arg); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
  params++;
  n++;
 } } } while (0);
...
__attribute__ ((visibility("default"))) int zend_fcall_info_argp(zend_fcall_info *fci, int argc, zval *argv)
{
 ...
 if (argc) {
  ...
  fci->params = (zval *) _erealloc((fci->params), (fci->param_count * sizeof(zval)) );

  for (i = 0; i < argc; ++i) {
   do { zval *_z1 = (&fci->params[i]); const zval *_z2 = (&argv[i]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
 }
...
__attribute__ ((visibility("default"))) int zend_fcall_info_argv(zend_fcall_info *fci, int argc, va_list *argv)
{
 ...
 if (argc) {
  ...
  for (i = 0; i < argc; ++i) {
   ...
   do { zval *_z1 = (&fci->params[i]); const zval *_z2 = (arg); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
 }
...
__attribute__ ((visibility("default"))) int zend_declare_property_ex(zend_class_entry *ce, zend_string *name, zval *property, int access_type, zend_string *doc_comment)
{
 ...
 if (ce->type == 1) {
  property_info = ((1)?__zend_malloc(sizeof(zend_property_info)):(__builtin_constant_p((sizeof(zend_property_info)) ) ? (((sizeof(zend_property_info)) <= 8) ? _emalloc_8() : (((sizeof(zend_property_info)) <= 16) ? _emalloc_16() : (((sizeof(zend_property_info)) <= 24) ? _emalloc_24() : (((sizeof(zend_property_info)) <= 32) ? _emalloc_32() : (((sizeof(zend_property_info)) <= 40) ? _emalloc_40() : (((sizeof(zend_property_info)) <= 48) ? _emalloc_48() : (((sizeof(zend_property_info)) <= 56) ? _emalloc_56() : (((sizeof(zend_property_info)) <= 64) ? _emalloc_64() : (((sizeof(zend_property_info)) <= 80) ? _emalloc_80() : (((sizeof(zend_property_info)) <= 96) ? _emalloc_96() : (((sizeof(zend_property_info)) <= 112) ? _emalloc_112() : (((sizeof(zend_property_info)) <= 128) ? _emalloc_128() : (((sizeof(zend_property_info)) <= 160) ? _emalloc_160() : (((sizeof(zend_property_info)) <= 192) ? _emalloc_192() : (((sizeof(zend_property_info)) <= 224) ? _emalloc_224() : (((sizeof(zend_property_info)) <= 256) ? _emalloc_256() : (((sizeof(zend_property_info)) <= 320) ? _emalloc_320() : (((sizeof(zend_property_info)) <= 384) ? _emalloc_384() : (((sizeof(zend_property_info)) <= 448) ? _emalloc_448() : (((sizeof(zend_property_info)) <= 512) ? _emalloc_512() : (((sizeof(zend_property_info)) <= 640) ? _emalloc_640() : (((sizeof(zend_property_info)) <= 768) ? _emalloc_768() : (((sizeof(zend_property_info)) <= 896) ? _emalloc_896() : (((sizeof(zend_property_info)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_property_info)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_property_info)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_property_info)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_property_info)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_property_info)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_property_info)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_property_info)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_property_info))) : _emalloc_huge((sizeof(zend_property_info)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_property_info)) ) ));
  if ((access_type & 0x01) || (((*(property)).u1.v.type_flags & (1<<0)) != 0)) {
 ...
 if (access_type & 0x01) {
  if ((property_info_ptr = zend_hash_find_ptr(&ce->properties_info, name)) != ((void *)0) &&
   ...
   ce->default_static_members_table = ((ce->type == 1)?__zend_realloc((ce->default_static_members_table), (sizeof(zval) * ce->default_static_members_count)):_erealloc(((ce->default_static_members_table)), ((sizeof(zval) * ce->default_static_members_count)) ));
  }
  do { zval *_z1 = (&ce->default_static_members_table[property_info->offset]); const zval *_z2 = (property); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  if (ce->type == 2) {
  ...
  if ((property_info_ptr = zend_hash_find_ptr(&ce->properties_info, name)) != ((void *)0) &&
      (property_info_ptr->flags & 0x01) == 0) {
   property_info->offset = property_info_ptr->offset;
   _zval_ptr_dtor((&ce->default_properties_table[((property_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval))]) );
   zend_hash_del(&ce->properties_info, name);
  } else {
   property_info->offset = ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(ce->default_properties_count)]));
   ce->default_properties_count++;
   ce->default_properties_table = ((ce->type == 1)?__zend_realloc((ce->default_properties_table), (sizeof(zval) * ce->default_properties_count)):_erealloc(((ce->default_properties_table)), ((sizeof(zval) * ce->default_properties_count)) ));
  }
  do { zval *_z1 = (&ce->default_properties_table[((property_info->offset - ((uint32_t)(zend_uintptr_t)(&(((zend_object*)((void *)0)))->properties_table[(0)]))) / sizeof(zval))]); const zval *_z2 = (property); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 }
 if (ce->type & 1) {
  switch(zval_get_type(&(*(property)))) {
   ...
   case 8:
   case 9:
    zend_error_noreturn((1<<4L), "Internal zval's can't be arrays, objects or resources");
    break;
   default:
    break;
  }
 ...
 } else if (access_type & 0x400) {
  property_info->name = zend_mangle_property_name((ce->name)->val, (ce->name)->len, (name)->val, (name)->len, ce->type & 1);
 } else {
  do { if (__builtin_expect(!(access_type & 0x200), 0)) __builtin_unreachable(); } while (0);
...
__attribute__ ((visibility("default"))) int zend_declare_property(zend_class_entry *ce, const char *name, size_t name_length, zval *property, int access_type)
{
 zend_string *key = zend_string_init(name, name_length, ce->type & 1);
...
__attribute__ ((visibility("default"))) int zend_declare_property_string(zend_class_entry *ce, const char *name, size_t name_length, const char *value, int access_type)
{
 ...
 do { zval *__z = (&property); zend_string *__s = (zend_string_init(value, strlen(value), ce->type & 1)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 return zend_declare_property(ce, name, name_length, &property, access_type);
}
...
__attribute__ ((visibility("default"))) int zend_declare_property_stringl(zend_class_entry *ce, const char *name, size_t name_length, const char *value, size_t value_len, int access_type)
{
 ...
 do { zval *__z = (&property); zend_string *__s = (zend_string_init(value, value_len, ce->type & 1)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 return zend_declare_property(ce, name, name_length, &property, access_type);
}
...
__attribute__ ((visibility("default"))) int zend_declare_class_constant_ex(zend_class_entry *ce, zend_string *name, zval *value, int access_type, zend_string *doc_comment)
{
 ...
 if (ce->ce_flags & 0x40) {
  if (access_type != 0x100) {
   zend_error_noreturn((1<<6L), "Access type for interface constant %s::%s must be public", (ce->name)->val, (name)->val);
  }
 }

 if (((name)->len == sizeof("class") - 1 && !zend_binary_strcasecmp((name)->val, (name)->len, ("class"), sizeof("class") - 1))) {
  zend_error_noreturn(ce->type == 1 ? (1<<4L) : (1<<6L),
    "A class constant must not be called 'class'; it is reserved for class name fetching");
 }

 if (ce->type == 1) {
  c = ((1)?__zend_malloc(sizeof(zend_class_constant)):(__builtin_constant_p((sizeof(zend_class_constant)) ) ? (((sizeof(zend_class_constant)) <= 8) ? _emalloc_8() : (((sizeof(zend_class_constant)) <= 16) ? _emalloc_16() : (((sizeof(zend_class_constant)) <= 24) ? _emalloc_24() : (((sizeof(zend_class_constant)) <= 32) ? _emalloc_32() : (((sizeof(zend_class_constant)) <= 40) ? _emalloc_40() : (((sizeof(zend_class_constant)) <= 48) ? _emalloc_48() : (((sizeof(zend_class_constant)) <= 56) ? _emalloc_56() : (((sizeof(zend_class_constant)) <= 64) ? _emalloc_64() : (((sizeof(zend_class_constant)) <= 80) ? _emalloc_80() : (((sizeof(zend_class_constant)) <= 96) ? _emalloc_96() : (((sizeof(zend_class_constant)) <= 112) ? _emalloc_112() : (((sizeof(zend_class_constant)) <= 128) ? _emalloc_128() : (((sizeof(zend_class_constant)) <= 160) ? _emalloc_160() : (((sizeof(zend_class_constant)) <= 192) ? _emalloc_192() : (((sizeof(zend_class_constant)) <= 224) ? _emalloc_224() : (((sizeof(zend_class_constant)) <= 256) ? _emalloc_256() : (((sizeof(zend_class_constant)) <= 320) ? _emalloc_320() : (((sizeof(zend_class_constant)) <= 384) ? _emalloc_384() : (((sizeof(zend_class_constant)) <= 448) ? _emalloc_448() : (((sizeof(zend_class_constant)) <= 512) ? _emalloc_512() : (((sizeof(zend_class_constant)) <= 640) ? _emalloc_640() : (((sizeof(zend_class_constant)) <= 768) ? _emalloc_768() : (((sizeof(zend_class_constant)) <= 896) ? _emalloc_896() : (((sizeof(zend_class_constant)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_class_constant)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_class_constant)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_class_constant)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_class_constant)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_class_constant)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_class_constant)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_class_constant)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_class_constant))) : _emalloc_huge((sizeof(zend_class_constant)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_class_constant)) ) ));
 } else {
  c = zend_arena_alloc(&(compiler_globals.arena), sizeof(zend_class_constant));
 }
 do { zval *_z1 = (&c->value); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 (c->value).u2.access_flags = access_type;
 ...
 if (!zend_hash_add_ptr(&ce->constants_table, name, c)) {
  zend_error_noreturn(ce->type == 1 ? (1<<4L) : (1<<6L),
   "Cannot redefine class constant %s::%s", (ce->name)->val, (name)->val);
 }
...
__attribute__ ((visibility("default"))) int zend_declare_class_constant(zend_class_entry *ce, const char *name, size_t name_length, zval *value)
{
 ...
 zend_string *key = zend_string_init(name, name_length, ce->type & 1);
 ret = zend_declare_class_constant_ex(ce, key, value, 0x100, ((void *)0));
 zend_string_release(key);
 return ret;
}
...
__attribute__ ((visibility("default"))) int zend_declare_class_constant_stringl(zend_class_entry *ce, const char *name, size_t name_length, const char *value, size_t value_length)
{
 ...
 do { zval *__z = (&constant); zend_string *__s = (zend_string_init(value, value_length, ce->type & 1)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 return zend_declare_class_constant(ce, name, name_length, &constant);
}
...
__attribute__ ((visibility("default"))) void zend_update_property_ex(zend_class_entry *scope, zval *object, zend_string *name, zval *value)
{
 ...
 (executor_globals.fake_scope) = scope;

 if (!(*(object)).value.obj->handlers->write_property) {
  zend_error_noreturn((1<<4L), "Property %s of class %s cannot be updated", name, (((*(object)).value.obj->ce)->name)->val);
 }
 do { zval *__z = (&property); zend_string *__s = (name); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
...
__attribute__ ((visibility("default"))) void zend_update_property(zend_class_entry *scope, zval *object, const char *name, size_t name_length, zval *value)
{
 ...
 do { do { zval *__z = (&property); zend_string *__s = (zend_string_init(name, name_length, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 (*(object)).value.obj->handlers->write_property(object, &property, value, ((void *)0));
...
__attribute__ ((visibility("default"))) void zend_update_property_str(zend_class_entry *scope, zval *object, const char *name, size_t name_length, zend_string *value)
{
 ...
 do { zval *__z = (&tmp); zend_string *__s = (value); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 zend_update_property(scope, object, name, name_length, &tmp);
}
...
__attribute__ ((visibility("default"))) void zend_update_property_stringl(zend_class_entry *scope, zval *object, const char *name, size_t name_length, const char *value, size_t value_len)
{
 zval tmp;

 do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init(value, value_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
 zval_set_refcount_p(&(tmp), 0);
 zend_update_property(scope, object, name, name_length, &tmp);
}
 ...
 if (!property) {
  ...
  if (property != value) {
   if ((zval_get_type(&(*(property))) == 10)) {
    _zval_ptr_dtor_nogc((property) );
    do { zval *_z1 = (property); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    if ((((*(value)).u1.v.type_flags & (1<<2)) != 0) && zval_refcount_p(value) > 0) {
     _zval_opt_copy_ctor((property) );
    }
   } else {
    zval garbage;

    do { zval *_z1 = (&garbage); const zval *_z2 = (property); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    if ((((*(value)).u1.v.type_flags & (1<<2)) != 0)) {
     zval_addref_p(value);
     if ((zval_get_type(&(*(value))) == 10)) {
      do { zval *_zv = (value); if ((((*(_zv)).u1.v.type_flags & (1<<2)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } else if ((zval_get_type(&(*(_zv))) == 10)) { zval_delref_p(_zv); do { zval *_z1 = (_zv); const zval *_z2 = (&(*(_zv)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0); } } } } while (0);
     }
    }
    do { zval *_z1 = (property); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
__attribute__ ((visibility("default"))) int zend_update_static_property_stringl(zend_class_entry *scope, const char *name, size_t name_length, const char *value, size_t value_len)
{
 zval tmp;
...
__attribute__ ((visibility("default"))) zval *zend_read_property_ex(zend_class_entry *scope, zval *object, zend_string *name, zend_bool silent, zval *rv)
{
 ...
 if (!(*(object)).value.obj->handlers->read_property) {
  zend_error_noreturn((1<<4L), "Property %s of class %s cannot be read", name, (((*(object)).value.obj->ce)->name)->val);
 }
...
__attribute__ ((visibility("default"))) void zend_save_error_handling(zend_error_handling *current)
{
 ...
 do { zval *_z1 = (&current->user_handler); const zval *_z2 = (&(executor_globals.user_error_handler)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}
...
__attribute__ ((visibility("default"))) void zend_restore_error_handling(zend_error_handling *saved)
{
 ...
 if (zval_get_type(&(saved->user_handler)) != 0
  ...
  _zval_ptr_dtor((&(executor_globals.user_error_handler)) );
  do { zval *_z1 = (&(executor_globals.user_error_handler)); const zval *_z2 = (&saved->user_handler); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
__attribute__ ((visibility("default"))) zend_string* zend_find_alias_name(zend_class_entry *ce, zend_string *name)
{
 ...
 if ((alias_ptr = ce->trait_aliases)) {
  alias = *alias_ptr;
  while (alias) {
   if (alias->alias && ((alias->alias)->len == (name)->len && !zend_binary_strcasecmp((alias->alias)->val, (alias->alias)->len, (name)->val, (name)->len))) {
    return alias->alias;
   }
   alias_ptr++;
   alias = *alias_ptr;
...
__attribute__ ((visibility("default"))) zend_string *zend_resolve_method_name(zend_class_entry *ce, zend_function *f)
{
 ...
 do { Bucket *_p = (function_table)->arData; Bucket *_end = _p + (function_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; name = _p->key; func = (*(_z)).value.ptr; {
  if (func == f) {
   if (!name) {
    return f->common.function_name;
   }
