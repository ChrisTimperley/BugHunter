...
# 111 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_cfg.h"
   ...
   switch (opline->opcode) {
    ...
    case 74:
     if (opline->extended_value & 0x00800000) {
      ssa_ops[k].op1_def = ssa_vars_count;
      var[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))] = ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(opline->op1.var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))));
      ssa_vars_count++;
     }
     break;
    case 75:
   ...
   if (var1 >= 0) {
    if ((opline-1)->opcode == 17) {
     ...
     if (val2 > (-9223372036854775807L -1)) {
      if (add_pi(arena, op_array, &dfg, ssa, j, bt, var1, -1, var2, (-9223372036854775807L -1), val2-1, 1, 0, 0) != SUCCESS) {
       goto failure;
      }
     }
     if (add_pi(arena, op_array, &dfg, ssa, j, bf, var1, var2, -1, val2, (9223372036854775807L), 0, 1, 0) != SUCCESS) {
      goto failure;
     }
    } else if ((opline-1)->opcode == 20) {
     if (add_pi(arena, op_array, &dfg, ssa, j, bt, var1, -1, var2, (-9223372036854775807L -1), val2, 1, 0, 0) != SUCCESS) {
      goto failure;
     }
     if (val2 < (9223372036854775807L)) {
      if (add_pi(arena, op_array, &dfg, ssa, j, bf, var1, var2, -1, val2+1, (9223372036854775807L), 0, 1, 0) != SUCCESS) {
       goto failure;
      }
     }
    }
   ...
   if (var2 >= 0) {
    if((opline-1)->opcode == 17) {
     ...
     if (val1 < (9223372036854775807L)) {
      if (add_pi(arena, op_array, &dfg, ssa, j, bt, var2, var1, -1, val1+1, (9223372036854775807L), 0, 1, 0) != SUCCESS) {
       goto failure;
      }
     }
     if (add_pi(arena, op_array, &dfg, ssa, j, bf, var2, -1, var1, (-9223372036854775807L -1), val1, 1, 0, 0) != SUCCESS) {
      goto failure;
     }
    } else if ((opline-1)->opcode == 20) {
     if (add_pi(arena, op_array, &dfg, ssa, j, bt, var2, var1, -1, val1, (9223372036854775807L), 0 ,1, 0) != SUCCESS) {
      goto failure;
     }
     if (val1 > (-9223372036854775807L -1)) {
      if (add_pi(arena, op_array, &dfg, ssa, j, bf, var2, -1, var1, (-9223372036854775807L -1), val1-1, 1, 0, 0) != SUCCESS) {
       goto failure;
      }
     }
    }
