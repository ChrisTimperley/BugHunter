# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_streams.h" 1
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_versioning.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_versioning.h"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_versioning.h" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h" 1
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_config.h" 1



# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h" 1
# 5 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_config.h" 2

# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_stdint.h" 1
# 7 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_config.h" 2
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h" 2
# 129 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h"
typedef int64_t timelib_long;
typedef uint64_t timelib_ulong;
# 151 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h"
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.h" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include-fixed/limits.h" 1 3 4
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.h" 2
# 74 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.h"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.h" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_hash.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.h" 2

# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_version.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.h" 2
...
void zif_idate(zend_execute_data *execute_data, zval *return_value);
void zif_gmdate(zend_execute_data *execute_data, zval *return_value);
void zif_strtotime(zend_execute_data *execute_data, zval *return_value);

void zif_mktime(zend_execute_data *execute_data, zval *return_value);
void zif_gmmktime(zend_execute_data *execute_data, zval *return_value);

void zif_checkdate(zend_execute_data *execute_data, zval *return_value);


void zif_strftime(zend_execute_data *execute_data, zval *return_value);
void zif_gmstrftime(zend_execute_data *execute_data, zval *return_value);


void zif_time(zend_execute_data *execute_data, zval *return_value);
void zif_localtime(zend_execute_data *execute_data, zval *return_value);
void zif_getdate(zend_execute_data *execute_data, zval *return_value);


void zim_DateTime___construct(zend_execute_data *execute_data, zval *return_value);
void zim_DateTime___wakeup(zend_execute_data *execute_data, zval *return_value);
void zim_DateTime___set_state(zend_execute_data *execute_data, zval *return_value);
void zif_date_create(zend_execute_data *execute_data, zval *return_value);
void zif_date_create_immutable(zend_execute_data *execute_data, zval *return_value);
void zif_date_create_from_format(zend_execute_data *execute_data, zval *return_value);
void zif_date_create_immutable_from_format(zend_execute_data *execute_data, zval *return_value);
void zif_date_parse(zend_execute_data *execute_data, zval *return_value);
void zif_date_parse_from_format(zend_execute_data *execute_data, zval *return_value);
void zif_date_get_last_errors(zend_execute_data *execute_data, zval *return_value);
void zif_date_format(zend_execute_data *execute_data, zval *return_value);
void zif_date_modify(zend_execute_data *execute_data, zval *return_value);
void zif_date_add(zend_execute_data *execute_data, zval *return_value);
void zif_date_sub(zend_execute_data *execute_data, zval *return_value);
void zif_date_timezone_get(zend_execute_data *execute_data, zval *return_value);
void zif_date_timezone_set(zend_execute_data *execute_data, zval *return_value);
void zif_date_offset_get(zend_execute_data *execute_data, zval *return_value);
void zif_date_diff(zend_execute_data *execute_data, zval *return_value);

void zif_date_time_set(zend_execute_data *execute_data, zval *return_value);
void zif_date_date_set(zend_execute_data *execute_data, zval *return_value);
void zif_date_isodate_set(zend_execute_data *execute_data, zval *return_value);
void zif_date_timestamp_set(zend_execute_data *execute_data, zval *return_value);
void zif_date_timestamp_get(zend_execute_data *execute_data, zval *return_value);

void zim_DateTimeImmutable___construct(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable___set_state(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_modify(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_add(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_sub(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_setTimezone(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_setTime(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_setDate(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_setISODate(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_setTimestamp(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeImmutable_createFromMutable(zend_execute_data *execute_data, zval *return_value);

void zim_DateTimeZone___construct(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeZone___wakeup(zend_execute_data *execute_data, zval *return_value);
void zim_DateTimeZone___set_state(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_open(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_name_get(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_name_from_abbr(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_offset_get(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_transitions_get(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_location_get(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_identifiers_list(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_abbreviations_list(zend_execute_data *execute_data, zval *return_value);
void zif_timezone_version_get(zend_execute_data *execute_data, zval *return_value);

void zim_DateInterval___construct(zend_execute_data *execute_data, zval *return_value);
void zim_DateInterval___wakeup(zend_execute_data *execute_data, zval *return_value);
void zim_DateInterval___set_state(zend_execute_data *execute_data, zval *return_value);
void zif_date_interval_format(zend_execute_data *execute_data, zval *return_value);
void zif_date_interval_create_from_date_string(zend_execute_data *execute_data, zval *return_value);

void zim_DatePeriod___construct(zend_execute_data *execute_data, zval *return_value);
void zim_DatePeriod___wakeup(zend_execute_data *execute_data, zval *return_value);
void zim_DatePeriod___set_state(zend_execute_data *execute_data, zval *return_value);
void zim_DatePeriod_getStartDate(zend_execute_data *execute_data, zval *return_value);
void zim_DatePeriod_getEndDate(zend_execute_data *execute_data, zval *return_value);
void zim_DatePeriod_getDateInterval(zend_execute_data *execute_data, zval *return_value);


void zif_date_default_timezone_set(zend_execute_data *execute_data, zval *return_value);
void zif_date_default_timezone_get(zend_execute_data *execute_data, zval *return_value);


void zif_date_sunrise(zend_execute_data *execute_data, zval *return_value);
void zif_date_sunset(zend_execute_data *execute_data, zval *return_value);
void zif_date_sun_info(zend_execute_data *execute_data, zval *return_value);
...
__attribute__ ((visibility("default"))) void php_mktime(zend_execute_data *execute_data, zval *return_value, int gmt);
__attribute__ ((visibility("default"))) int php_idate(char format, time_t ts, int localtime);


__attribute__ ((visibility("default"))) void php_strftime(zend_execute_data *execute_data, zval *return_value, int gm);

__attribute__ ((visibility("default"))) zend_string *php_format_date(char *format, size_t format_len, time_t ts, int localtime);
...
__attribute__ ((visibility("default"))) int php_date_initialize(php_date_obj *dateobj, char *time_str, size_t time_str_len, char *format, zval *timezone_object, int ctor);
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
static inline long long php_date_llabs( long long i ) { return i >= 0 ? i : -i; }
# 61 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
static const zend_internal_arg_info arginfo_date[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_gmdate[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_idate[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_strtotime[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
 { "now", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_mktime[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "hour", ((void *)0), 0, 0, 0, 0 },
 { "min", ((void *)0), 0, 0, 0, 0 },
 { "sec", ((void *)0), 0, 0, 0, 0 },
 { "mon", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_gmmktime[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "hour", ((void *)0), 0, 0, 0, 0 },
 { "min", ((void *)0), 0, 0, 0, 0 },
 { "sec", ((void *)0), 0, 0, 0, 0 },
 { "mon", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_checkdate[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "month", ((void *)0), 0, 0, 0, 0 },
 { "day", ((void *)0), 0, 0, 0, 0 },
 { "year", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_strftime[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_gmstrftime[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_time[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_localtime[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
 { "associative_array", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_getdate[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "timestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_default_timezone_set[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "timezone_identifier", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_default_timezone_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_sunrise[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "latitude", ((void *)0), 0, 0, 0, 0 },
 { "longitude", ((void *)0), 0, 0, 0, 0 },
 { "zenith", ((void *)0), 0, 0, 0, 0 },
 { "gmt_offset", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_sunset[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "latitude", ((void *)0), 0, 0, 0, 0 },
 { "longitude", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_date_sun_info[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
 { "latitude", ((void *)0), 0, 0, 0, 0 },
 { "longitude", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_create[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_create_from_format[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_parse[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "date", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_parse_from_format[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
 { "date", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_get_last_errors[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_format[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_format[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_modify[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "modify", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_modify[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "modify", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_add[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "interval", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_add[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "interval", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_sub[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "interval", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_sub[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "interval", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_timezone_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_timezone_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_timezone_set[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "timezone", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_timezone_set[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "timezone", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_offset_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_offset_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_diff[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "object2", ((void *)0), 0, 0, 0, 0 },
 { "absolute", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_diff[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "absolute", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_time_set[] = { { (const char*)(zend_uintptr_t)(3), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "hour", ((void *)0), 0, 0, 0, 0 },
 { "minute", ((void *)0), 0, 0, 0, 0 },
 { "second", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_time_set[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "hour", ((void *)0), 0, 0, 0, 0 },
 { "minute", ((void *)0), 0, 0, 0, 0 },
 { "second", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_date_set[] = { { (const char*)(zend_uintptr_t)(4), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "year", ((void *)0), 0, 0, 0, 0 },
 { "month", ((void *)0), 0, 0, 0, 0 },
 { "day", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_date_method_date_set[] = { { (const char*)(zend_uintptr_t)(3), ((void *)0), 0, 0, 0, 0 },
 { "year", ((void *)0), 0, 0, 0, 0 },
 { "month", ((void *)0), 0, 0, 0, 0 },
 { "day", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_isodate_set[] = { { (const char*)(zend_uintptr_t)(3), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "year", ((void *)0), 0, 0, 0, 0 },
 { "week", ((void *)0), 0, 0, 0, 0 },
 { "day", ((void *)0), 0, 0, 0, 0 },
...
static const zend_internal_arg_info arginfo_date_method_isodate_set[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "year", ((void *)0), 0, 0, 0, 0 },
 { "week", ((void *)0), 0, 0, 0, 0 },
 { "day", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_timestamp_set[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "unixtimestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_timestamp_set[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "unixtimestamp", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_timestamp_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_timestamp_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_create_from_mutable[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "DateTime", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_open[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "timezone", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_name_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_method_name_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_name_from_abbr[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "abbr", ((void *)0), 0, 0, 0, 0 },
 { "gmtoffset", ((void *)0), 0, 0, 0, 0 },
 { "isdst", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_offset_get[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", "DateTimeZone", 8, 0, 0, 0 },
 { "datetime", "DateTimeInterface", 8, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_method_offset_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_transitions_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "timestamp_begin", ((void *)0), 0, 0, 0, 0 },
 { "timestamp_end", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_method_transitions_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "timestamp_begin", ((void *)0), 0, 0, 0, 0 },
 { "timestamp_end", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_location_get[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_method_location_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_identifiers_list[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "what", ((void *)0), 0, 0, 0, 0 },
 { "country", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_abbreviations_list[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_timezone_version_get[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_interval_create_from_date_string[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "time", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_interval_format[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "object", ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_method_interval_format[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "format", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_period_construct[] = { { (const char*)(zend_uintptr_t)(3), ((void *)0), 0, 0, 0, 0 },
 { "start", ((void *)0), 0, 0, 0, 0 },
 { "interval", ((void *)0), 0, 0, 0, 0 },
 { "end", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_date_interval_construct[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "interval_spec", ((void *)0), 0, 0, 0, 0 },
};



const zend_function_entry date_functions[] = {
 { "strtotime", zif_strtotime, arginfo_strtotime, (uint32_t) (sizeof(arginfo_strtotime)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date", zif_date, arginfo_date, (uint32_t) (sizeof(arginfo_date)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "idate", zif_idate, arginfo_idate, (uint32_t) (sizeof(arginfo_idate)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "gmdate", zif_gmdate, arginfo_gmdate, (uint32_t) (sizeof(arginfo_gmdate)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "mktime", zif_mktime, arginfo_mktime, (uint32_t) (sizeof(arginfo_mktime)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "gmmktime", zif_gmmktime, arginfo_gmmktime, (uint32_t) (sizeof(arginfo_gmmktime)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "checkdate", zif_checkdate, arginfo_checkdate, (uint32_t) (sizeof(arginfo_checkdate)/sizeof(struct _zend_internal_arg_info)-1), 0 },


 { "strftime", zif_strftime, arginfo_strftime, (uint32_t) (sizeof(arginfo_strftime)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "gmstrftime", zif_gmstrftime, arginfo_gmstrftime, (uint32_t) (sizeof(arginfo_gmstrftime)/sizeof(struct _zend_internal_arg_info)-1), 0 },


 { "time", zif_time, arginfo_time, (uint32_t) (sizeof(arginfo_time)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "localtime", zif_localtime, arginfo_localtime, (uint32_t) (sizeof(arginfo_localtime)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getdate", zif_getdate, arginfo_getdate, (uint32_t) (sizeof(arginfo_getdate)/sizeof(struct _zend_internal_arg_info)-1), 0 },


 { "date_create", zif_date_create, arginfo_date_create, (uint32_t) (sizeof(arginfo_date_create)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_create_immutable", zif_date_create_immutable, arginfo_date_create, (uint32_t) (sizeof(arginfo_date_create)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_create_from_format", zif_date_create_from_format, arginfo_date_create_from_format, (uint32_t) (sizeof(arginfo_date_create_from_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_create_immutable_from_format", zif_date_create_immutable_from_format, arginfo_date_create_from_format, (uint32_t) (sizeof(arginfo_date_create_from_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_parse", zif_date_parse, arginfo_date_parse, (uint32_t) (sizeof(arginfo_date_parse)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_parse_from_format", zif_date_parse_from_format, arginfo_date_parse_from_format, (uint32_t) (sizeof(arginfo_date_parse_from_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_get_last_errors", zif_date_get_last_errors, arginfo_date_get_last_errors, (uint32_t) (sizeof(arginfo_date_get_last_errors)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_format", zif_date_format, arginfo_date_format, (uint32_t) (sizeof(arginfo_date_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_modify", zif_date_modify, arginfo_date_modify, (uint32_t) (sizeof(arginfo_date_modify)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_add", zif_date_add, arginfo_date_add, (uint32_t) (sizeof(arginfo_date_add)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_sub", zif_date_sub, arginfo_date_sub, (uint32_t) (sizeof(arginfo_date_sub)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_timezone_get", zif_date_timezone_get, arginfo_date_timezone_get, (uint32_t) (sizeof(arginfo_date_timezone_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_timezone_set", zif_date_timezone_set, arginfo_date_timezone_set, (uint32_t) (sizeof(arginfo_date_timezone_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_offset_get", zif_date_offset_get, arginfo_date_offset_get, (uint32_t) (sizeof(arginfo_date_offset_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_diff", zif_date_diff, arginfo_date_diff, (uint32_t) (sizeof(arginfo_date_diff)/sizeof(struct _zend_internal_arg_info)-1), 0 },

 { "date_time_set", zif_date_time_set, arginfo_date_time_set, (uint32_t) (sizeof(arginfo_date_time_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_date_set", zif_date_date_set, arginfo_date_date_set, (uint32_t) (sizeof(arginfo_date_date_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_isodate_set", zif_date_isodate_set, arginfo_date_isodate_set, (uint32_t) (sizeof(arginfo_date_isodate_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_timestamp_set", zif_date_timestamp_set, arginfo_date_timestamp_set, (uint32_t) (sizeof(arginfo_date_timestamp_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_timestamp_get", zif_date_timestamp_get, arginfo_date_timestamp_get, (uint32_t) (sizeof(arginfo_date_timestamp_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },

 { "timezone_open", zif_timezone_open, arginfo_timezone_open, (uint32_t) (sizeof(arginfo_timezone_open)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_name_get", zif_timezone_name_get, arginfo_timezone_name_get, (uint32_t) (sizeof(arginfo_timezone_name_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_name_from_abbr", zif_timezone_name_from_abbr, arginfo_timezone_name_from_abbr, (uint32_t) (sizeof(arginfo_timezone_name_from_abbr)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_offset_get", zif_timezone_offset_get, arginfo_timezone_offset_get, (uint32_t) (sizeof(arginfo_timezone_offset_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_transitions_get", zif_timezone_transitions_get, arginfo_timezone_transitions_get, (uint32_t) (sizeof(arginfo_timezone_transitions_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_location_get", zif_timezone_location_get, arginfo_timezone_location_get, (uint32_t) (sizeof(arginfo_timezone_location_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_identifiers_list", zif_timezone_identifiers_list, arginfo_timezone_identifiers_list, (uint32_t) (sizeof(arginfo_timezone_identifiers_list)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_abbreviations_list", zif_timezone_abbreviations_list, arginfo_timezone_abbreviations_list, (uint32_t) (sizeof(arginfo_timezone_abbreviations_list)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "timezone_version_get", zif_timezone_version_get, arginfo_timezone_version_get, (uint32_t) (sizeof(arginfo_timezone_version_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },

 { "date_interval_create_from_date_string", zif_date_interval_create_from_date_string, arginfo_date_interval_create_from_date_string, (uint32_t) (sizeof(arginfo_date_interval_create_from_date_string)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_interval_format", zif_date_interval_format, arginfo_date_interval_format, (uint32_t) (sizeof(arginfo_date_interval_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },


 { "date_default_timezone_set", zif_date_default_timezone_set, arginfo_date_default_timezone_set, (uint32_t) (sizeof(arginfo_date_default_timezone_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_default_timezone_get", zif_date_default_timezone_get, arginfo_date_default_timezone_get, (uint32_t) (sizeof(arginfo_date_default_timezone_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },


 { "date_sunrise", zif_date_sunrise, arginfo_date_sunrise, (uint32_t) (sizeof(arginfo_date_sunrise)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_sunset", zif_date_sunset, arginfo_date_sunset, (uint32_t) (sizeof(arginfo_date_sunset)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "date_sun_info", zif_date_sun_info, arginfo_date_sun_info, (uint32_t) (sizeof(arginfo_date_sun_info)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_function_entry date_funcs_interface[] = {
 { "format", ((void *)0), arginfo_date_method_format, (uint32_t) (sizeof(arginfo_date_method_format)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getTimezone", ((void *)0), arginfo_date_method_timezone_get, (uint32_t) (sizeof(arginfo_date_method_timezone_get)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getOffset", ((void *)0), arginfo_date_method_offset_get, (uint32_t) (sizeof(arginfo_date_method_offset_get)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getTimestamp", ((void *)0), arginfo_date_method_timestamp_get, (uint32_t) (sizeof(arginfo_date_method_timestamp_get)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "diff", ((void *)0), arginfo_date_method_diff, (uint32_t) (sizeof(arginfo_date_method_diff)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "__wakeup", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

const zend_function_entry date_funcs_date[] = {
 { "__construct", zim_DateTime___construct, arginfo_date_create, (uint32_t) (sizeof(arginfo_date_create)/sizeof(struct _zend_internal_arg_info)-1), 0x2000|0x100 },
 { "__wakeup", zim_DateTime___wakeup, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__set_state", zim_DateTime___set_state, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "createFromFormat", zif_date_create_from_format, arginfo_date_create_from_format, (uint32_t) (sizeof(arginfo_date_create_from_format)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "getLastErrors", zif_date_get_last_errors, arginfo_date_get_last_errors, (uint32_t) (sizeof(arginfo_date_get_last_errors)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "format", zif_date_format, arginfo_date_method_format, (uint32_t) (sizeof(arginfo_date_method_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "modify", zif_date_modify, arginfo_date_method_modify, (uint32_t) (sizeof(arginfo_date_method_modify)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "add", zif_date_add, arginfo_date_method_add, (uint32_t) (sizeof(arginfo_date_method_add)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "sub", zif_date_sub, arginfo_date_method_sub, (uint32_t) (sizeof(arginfo_date_method_sub)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getTimezone", zif_date_timezone_get, arginfo_date_method_timezone_get, (uint32_t) (sizeof(arginfo_date_method_timezone_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setTimezone", zif_date_timezone_set, arginfo_date_method_timezone_set, (uint32_t) (sizeof(arginfo_date_method_timezone_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getOffset", zif_date_offset_get, arginfo_date_method_offset_get, (uint32_t) (sizeof(arginfo_date_method_offset_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setTime", zif_date_time_set, arginfo_date_method_time_set, (uint32_t) (sizeof(arginfo_date_method_time_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setDate", zif_date_date_set, arginfo_date_method_date_set, (uint32_t) (sizeof(arginfo_date_method_date_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setISODate", zif_date_isodate_set, arginfo_date_method_isodate_set, (uint32_t) (sizeof(arginfo_date_method_isodate_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setTimestamp", zif_date_timestamp_set, arginfo_date_method_timestamp_set, (uint32_t) (sizeof(arginfo_date_method_timestamp_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getTimestamp", zif_date_timestamp_get, arginfo_date_method_timestamp_get, (uint32_t) (sizeof(arginfo_date_method_timestamp_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "diff", zif_date_diff, arginfo_date_method_diff, (uint32_t) (sizeof(arginfo_date_method_diff)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

const zend_function_entry date_funcs_immutable[] = {
 { "__construct", zim_DateTimeImmutable___construct, arginfo_date_create, (uint32_t) (sizeof(arginfo_date_create)/sizeof(struct _zend_internal_arg_info)-1), 0x2000|0x100 },
 { "__wakeup", zim_DateTime___wakeup, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__set_state", zim_DateTimeImmutable___set_state, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "createFromFormat", zif_date_create_immutable_from_format, arginfo_date_create_from_format, (uint32_t) (sizeof(arginfo_date_create_from_format)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "getLastErrors", zif_date_get_last_errors, arginfo_date_get_last_errors, (uint32_t) (sizeof(arginfo_date_get_last_errors)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "format", zif_date_format, arginfo_date_method_format, (uint32_t) (sizeof(arginfo_date_method_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getTimezone", zif_date_timezone_get, arginfo_date_method_timezone_get, (uint32_t) (sizeof(arginfo_date_method_timezone_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getOffset", zif_date_offset_get, arginfo_date_method_offset_get, (uint32_t) (sizeof(arginfo_date_method_offset_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getTimestamp", zif_date_timestamp_get, arginfo_date_method_timestamp_get, (uint32_t) (sizeof(arginfo_date_method_timestamp_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "diff", zif_date_diff, arginfo_date_method_diff, (uint32_t) (sizeof(arginfo_date_method_diff)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "modify", zim_DateTimeImmutable_modify, arginfo_date_method_modify, (uint32_t) (sizeof(arginfo_date_method_modify)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "add", zim_DateTimeImmutable_add, arginfo_date_method_add, (uint32_t) (sizeof(arginfo_date_method_add)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "sub", zim_DateTimeImmutable_sub, arginfo_date_method_sub, (uint32_t) (sizeof(arginfo_date_method_sub)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setTimezone", zim_DateTimeImmutable_setTimezone, arginfo_date_method_timezone_set, (uint32_t) (sizeof(arginfo_date_method_timezone_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setTime", zim_DateTimeImmutable_setTime, arginfo_date_method_time_set, (uint32_t) (sizeof(arginfo_date_method_time_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setDate", zim_DateTimeImmutable_setDate, arginfo_date_method_date_set, (uint32_t) (sizeof(arginfo_date_method_date_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setISODate", zim_DateTimeImmutable_setISODate, arginfo_date_method_isodate_set, (uint32_t) (sizeof(arginfo_date_method_isodate_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "setTimestamp", zim_DateTimeImmutable_setTimestamp, arginfo_date_method_timestamp_set, (uint32_t) (sizeof(arginfo_date_method_timestamp_set)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "createFromMutable", zim_DateTimeImmutable_createFromMutable, arginfo_date_method_create_from_mutable, (uint32_t) (sizeof(arginfo_date_method_create_from_mutable)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

const zend_function_entry date_funcs_timezone[] = {
 { "__construct", zim_DateTimeZone___construct, arginfo_timezone_open, (uint32_t) (sizeof(arginfo_timezone_open)/sizeof(struct _zend_internal_arg_info)-1), 0x2000|0x100 },
 { "__wakeup", zim_DateTimeZone___wakeup, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__set_state", zim_DateTimeZone___set_state, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "getName", zif_timezone_name_get, arginfo_timezone_method_name_get, (uint32_t) (sizeof(arginfo_timezone_method_name_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getOffset", zif_timezone_offset_get, arginfo_timezone_method_offset_get, (uint32_t) (sizeof(arginfo_timezone_method_offset_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getTransitions", zif_timezone_transitions_get, arginfo_timezone_method_transitions_get, (uint32_t) (sizeof(arginfo_timezone_method_transitions_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "getLocation", zif_timezone_location_get, arginfo_timezone_method_location_get, (uint32_t) (sizeof(arginfo_timezone_method_location_get)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "listAbbreviations", zif_timezone_abbreviations_list, arginfo_timezone_abbreviations_list, (uint32_t) (sizeof(arginfo_timezone_abbreviations_list)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "listIdentifiers", zif_timezone_identifiers_list, arginfo_timezone_identifiers_list, (uint32_t) (sizeof(arginfo_timezone_identifiers_list)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

const zend_function_entry date_funcs_interval[] = {
 { "__construct", zim_DateInterval___construct, arginfo_date_interval_construct, (uint32_t) (sizeof(arginfo_date_interval_construct)/sizeof(struct _zend_internal_arg_info)-1), 0x2000|0x100 },
 { "__wakeup", zim_DateInterval___wakeup, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__set_state", zim_DateInterval___set_state, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "format", zif_date_interval_format, arginfo_date_method_interval_format, (uint32_t) (sizeof(arginfo_date_method_interval_format)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "createFromDateString", zif_date_interval_create_from_date_string, arginfo_date_interval_create_from_date_string, (uint32_t) (sizeof(arginfo_date_interval_create_from_date_string)/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

const zend_function_entry date_funcs_period[] = {
 { "__construct", zim_DatePeriod___construct, arginfo_date_period_construct, (uint32_t) (sizeof(arginfo_date_period_construct)/sizeof(struct _zend_internal_arg_info)-1), 0x2000|0x100 },
 { "__wakeup", zim_DatePeriod___wakeup, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__set_state", zim_DatePeriod___set_state, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x01 },
 { "getStartDate", zim_DatePeriod_getStartDate, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getEndDate", zim_DatePeriod_getEndDate, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getDateInterval", zim_DatePeriod_getDateInterval, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
# 562 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
static int OnUpdate_date_timezone(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage);


static const zend_ini_entry_def ini_entries[] = {
 { "date.timezone", OnUpdate_date_timezone, (void *) ((zend_long) (((char *) (&(((zend_date_globals*)((void *)0))->default_timezone))) - ((char *) ((void *)0)))), (void *) &date_globals, ((void *)0), "", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("date.timezone")-1, sizeof("")-1 },
 { "date.default_latitude", ((void *)0), ((void *)0), ((void *)0), ((void *)0), "31.7667", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("date.default_latitude")-1, sizeof("31.7667")-1 },
 { "date.default_longitude", ((void *)0), ((void *)0), ((void *)0), ((void *)0), "35.2333", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("date.default_longitude")-1, sizeof("35.2333")-1 },
 { "date.sunset_zenith", ((void *)0), ((void *)0), ((void *)0), ((void *)0), "90.583333", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("date.sunset_zenith")-1, sizeof("90.583333")-1 },
 { "date.sunrise_zenith", ((void *)0), ((void *)0), ((void *)0), ((void *)0), "90.583333", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("date.sunrise_zenith")-1, sizeof("90.583333")-1 },
...
# 623 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
...
int zm_deactivate_date(int type, int module_number)
{
 ...
 if((date_globals.tzcache)) {
  ...
  do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8((date_globals.tzcache)); } else if (sizeof(HashTable) <= 16) { _efree_16((date_globals.tzcache)); } else if (sizeof(HashTable) <= 24) { _efree_24((date_globals.tzcache)); } else if (sizeof(HashTable) <= 32) { _efree_32((date_globals.tzcache)); } else if (sizeof(HashTable) <= 40) { _efree_40((date_globals.tzcache)); } else if (sizeof(HashTable) <= 48) { _efree_48((date_globals.tzcache)); } else if (sizeof(HashTable) <= 56) { _efree_56((date_globals.tzcache)); } else if (sizeof(HashTable) <= 64) { _efree_64((date_globals.tzcache)); } else if (sizeof(HashTable) <= 80) { _efree_80((date_globals.tzcache)); } else if (sizeof(HashTable) <= 96) { _efree_96((date_globals.tzcache)); } else if (sizeof(HashTable) <= 112) { _efree_112((date_globals.tzcache)); } else if (sizeof(HashTable) <= 128) { _efree_128((date_globals.tzcache)); } else if (sizeof(HashTable) <= 160) { _efree_160((date_globals.tzcache)); } else if (sizeof(HashTable) <= 192) { _efree_192((date_globals.tzcache)); } else if (sizeof(HashTable) <= 224) { _efree_224((date_globals.tzcache)); } else if (sizeof(HashTable) <= 256) { _efree_256((date_globals.tzcache)); } else if (sizeof(HashTable) <= 320) { _efree_320((date_globals.tzcache)); } else if (sizeof(HashTable) <= 384) { _efree_384((date_globals.tzcache)); } else if (sizeof(HashTable) <= 448) { _efree_448((date_globals.tzcache)); } else if (sizeof(HashTable) <= 512) { _efree_512((date_globals.tzcache)); } else if (sizeof(HashTable) <= 640) { _efree_640((date_globals.tzcache)); } else if (sizeof(HashTable) <= 768) { _efree_768((date_globals.tzcache)); } else if (sizeof(HashTable) <= 896) { _efree_896((date_globals.tzcache)); } else if (sizeof(HashTable) <= 1024) { _efree_1024((date_globals.tzcache)); } else if (sizeof(HashTable) <= 1280) { _efree_1280((date_globals.tzcache)); } else if (sizeof(HashTable) <= 1536) { _efree_1536((date_globals.tzcache)); } else if (sizeof(HashTable) <= 1792) { _efree_1792((date_globals.tzcache)); } else if (sizeof(HashTable) <= 2048) { _efree_2048((date_globals.tzcache)); } else if (sizeof(HashTable) <= 2560) { _efree_2560((date_globals.tzcache)); } else if (sizeof(HashTable) <= 3072) { _efree_3072((date_globals.tzcache)); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large((date_globals.tzcache), sizeof(HashTable)); } else { _efree_huge((date_globals.tzcache), sizeof(HashTable)); } } else { _efree((date_globals.tzcache)); } } while (0);
  (date_globals.tzcache) = ((void *)0);
 }
...
# 835 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
int zm_startup_date(int type, int module_number)
{
 ...
 zend_register_string_constant(("DATE_RFC3339_EXTENDED"), sizeof("DATE_RFC3339_EXTENDED")-1, ("Y-m-d\\TH:i:s.vP"), ((1<<0) | (1<<1)), module_number);
...
static int OnUpdate_date_timezone(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 ...
 if (stage == (1<<4)) {
  if (!timelib_timezone_id_is_valid((date_globals.default_timezone), php_date_global_timezone_db ? php_date_global_timezone_db : timelib_builtin_db())) {
   if ((date_globals.default_timezone) && *(date_globals.default_timezone)) {
...
static char* guess_timezone(const timelib_tzdb *tzdb)
{
 ...
 if (!(date_globals.default_timezone)) {
  ...
  if (((void *)0) != (ztz = cfg_get_entry("date.timezone", sizeof("date.timezone")))
...
# 1016 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
...
static zend_string *date_format(char *format, size_t format_len, timelib_time *t, int localtime)
{
 ...
 if (localtime) {
  if (t->zone_type == 2) {
   ...
   offset->leap_secs = 0;
   offset->is_dst = t->dst;
   offset->abbr = _estrdup((t->tz_abbr) );
  } else if (t->zone_type == 1) {
   offset = timelib_time_offset_ctor();
   offset->offset = (t->z) * -60;
   offset->leap_secs = 0;
   offset->is_dst = 0;
   offset->abbr = (__builtin_constant_p((9) ) ? (((9) <= 8) ? _emalloc_8() : (((9) <= 16) ? _emalloc_16() : (((9) <= 24) ? _emalloc_24() : (((9) <= 32) ? _emalloc_32() : (((9) <= 40) ? _emalloc_40() : (((9) <= 48) ? _emalloc_48() : (((9) <= 56) ? _emalloc_56() : (((9) <= 64) ? _emalloc_64() : (((9) <= 80) ? _emalloc_80() : (((9) <= 96) ? _emalloc_96() : (((9) <= 112) ? _emalloc_112() : (((9) <= 128) ? _emalloc_128() : (((9) <= 160) ? _emalloc_160() : (((9) <= 192) ? _emalloc_192() : (((9) <= 224) ? _emalloc_224() : (((9) <= 256) ? _emalloc_256() : (((9) <= 320) ? _emalloc_320() : (((9) <= 384) ? _emalloc_384() : (((9) <= 448) ? _emalloc_448() : (((9) <= 512) ? _emalloc_512() : (((9) <= 640) ? _emalloc_640() : (((9) <= 768) ? _emalloc_768() : (((9) <= 896) ? _emalloc_896() : (((9) <= 1024) ? _emalloc_1024() : (((9) <= 1280) ? _emalloc_1280() : (((9) <= 1536) ? _emalloc_1536() : (((9) <= 1792) ? _emalloc_1792() : (((9) <= 2048) ? _emalloc_2048() : (((9) <= 2560) ? _emalloc_2560() : (((9) <= 3072) ? _emalloc_3072() : (((9) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((9)) : _emalloc_huge((9))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((9) ) );
 ...
 for (i = 0; i < format_len; i++) {
  ...
  switch (format[i]) {
   ...
   case 'v': length = ap_php_slprintf(buffer, 32, "%03d", (int) floor(t->f * 1000 + 0.5)); break;
  ...
  smart_str_appendl_ex((&string), (buffer), (length), 0);
 }
...
static void php_date(zend_execute_data *execute_data, zval *return_value, int localtime)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|l", &format, &format_len, &ts) == FAILURE) {
 ...
 { do { zval *__z = (return_value); zend_string *__s = (php_format_date(format, format_len, ts, localtime)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
void zif_gmdate(zend_execute_data *execute_data, zval *return_value)
{
 php_date(execute_data, return_value, 0);
}
...
void zif_strtotime(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|l", &times, &time_len, &preset_ts) == FAILURE || !time_len) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 timelib_unixtime2local(now,
  ((execute_data)->This.u2.num_args == 2) ? (timelib_sll) preset_ts : (timelib_sll) time(((void *)0)));
...
__attribute__ ((visibility("default"))) void php_mktime(zend_execute_data *execute_data, zval *return_value, int gmt)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|llllll", &hou, &min, &sec, &mon, &day, &yea) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 switch ((execute_data)->This.u2.num_args) {
  ...
  case 1:
   ...
   break;
  default:
   php_error_docref0(((void *)0), (1<<13L), "You should be using the time() function instead");
 }
...
void zif_mktime(zend_execute_data *execute_data, zval *return_value)
{
 php_mktime(execute_data, return_value, 0);
}
...
void zif_gmmktime(zend_execute_data *execute_data, zval *return_value)
{
 php_mktime(execute_data, return_value, 1);
}
...
void zif_checkdate(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "lll", &m, &d, &y) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
__attribute__ ((visibility("default"))) void php_strftime(zend_execute_data *execute_data, zval *return_value, int gmt)
{
 char *format;
 size_t format_len;
 ...
 timestamp = (zend_long) time(((void *)0));

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|l", &format, &format_len, &timestamp) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
# 1681 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
...
void zif_strftime(zend_execute_data *execute_data, zval *return_value)
{
 php_strftime(execute_data, return_value, 0);
}
...
void zif_gmstrftime(zend_execute_data *execute_data, zval *return_value)
{
 php_strftime(execute_data, return_value, 1);
}
...
void zif_time(zend_execute_data *execute_data, zval *return_value)
{
 { { zval *__z = (return_value); (*(__z)).value.lval = (zend_long)time(((void *)0)); (*(__z)).u1.type_info = 4; }; return; };
}
...
void zif_localtime(zend_execute_data *execute_data, zval *return_value)
{
 zend_long timestamp = (zend_long)time(((void *)0));
 zend_bool associative = 0;
 timelib_tzinfo *tzi;
 timelib_time *ts;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|lb", &timestamp, &associative) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_getdate(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|l", &timestamp) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
# 1822 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
typedef struct {
 ...
 *newdateobj->time = *it_time;
 if (it_time->tz_abbr) {
  newdateobj->time->tz_abbr = _estrdup((it_time->tz_abbr) );
 }
 if (it_time->tz_info) {
...
{
 date_period_it *iterator = (__builtin_constant_p((sizeof(date_period_it)) ) ? (((sizeof(date_period_it)) <= 8) ? _emalloc_8() : (((sizeof(date_period_it)) <= 16) ? _emalloc_16() : (((sizeof(date_period_it)) <= 24) ? _emalloc_24() : (((sizeof(date_period_it)) <= 32) ? _emalloc_32() : (((sizeof(date_period_it)) <= 40) ? _emalloc_40() : (((sizeof(date_period_it)) <= 48) ? _emalloc_48() : (((sizeof(date_period_it)) <= 56) ? _emalloc_56() : (((sizeof(date_period_it)) <= 64) ? _emalloc_64() : (((sizeof(date_period_it)) <= 80) ? _emalloc_80() : (((sizeof(date_period_it)) <= 96) ? _emalloc_96() : (((sizeof(date_period_it)) <= 112) ? _emalloc_112() : (((sizeof(date_period_it)) <= 128) ? _emalloc_128() : (((sizeof(date_period_it)) <= 160) ? _emalloc_160() : (((sizeof(date_period_it)) <= 192) ? _emalloc_192() : (((sizeof(date_period_it)) <= 224) ? _emalloc_224() : (((sizeof(date_period_it)) <= 256) ? _emalloc_256() : (((sizeof(date_period_it)) <= 320) ? _emalloc_320() : (((sizeof(date_period_it)) <= 384) ? _emalloc_384() : (((sizeof(date_period_it)) <= 448) ? _emalloc_448() : (((sizeof(date_period_it)) <= 512) ? _emalloc_512() : (((sizeof(date_period_it)) <= 640) ? _emalloc_640() : (((sizeof(date_period_it)) <= 768) ? _emalloc_768() : (((sizeof(date_period_it)) <= 896) ? _emalloc_896() : (((sizeof(date_period_it)) <= 1024) ? _emalloc_1024() : (((sizeof(date_period_it)) <= 1280) ? _emalloc_1280() : (((sizeof(date_period_it)) <= 1536) ? _emalloc_1536() : (((sizeof(date_period_it)) <= 1792) ? _emalloc_1792() : (((sizeof(date_period_it)) <= 2048) ? _emalloc_2048() : (((sizeof(date_period_it)) <= 2560) ? _emalloc_2560() : (((sizeof(date_period_it)) <= 3072) ? _emalloc_3072() : (((sizeof(date_period_it)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(date_period_it))) : _emalloc_huge((sizeof(date_period_it)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(date_period_it)) ) );
 ...
 do { zval *_z1 = (&iterator->intern.data); const zval *_z2 = (object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
static void date_register_classes(void)
{
 ...
 date_object_handlers_date.offset = ((zend_long) (((char *) (&(((php_date_obj*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 zend_declare_class_constant_stringl(date_ce_date, "RFC3339_EXTENDED", sizeof("RFC3339_EXTENDED")-1, "Y-m-d\\TH:i:s.vP", sizeof("Y-m-d\\TH:i:s.vP")-1);;
 ...
 date_object_handlers_timezone.offset = ((zend_long) (((char *) (&(((php_timezone_obj*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 date_object_handlers_interval.offset = ((zend_long) (((char *) (&(((php_interval_obj*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 date_object_handlers_period.offset = ((zend_long) (((char *) (&(((php_period_obj*)((void *)0))->std))) - ((char *) ((void *)0))));
...
static inline zend_object *date_object_new_date_ex(zend_class_entry *class_type, int init_props)
{
 ...
 intern = _ecalloc((1), (sizeof(php_date_obj) + zend_object_properties_size(class_type)) );
 ...
 *new_obj->time = *old_obj->time;
 if (old_obj->time->tz_abbr) {
  new_obj->time->tz_abbr = _estrdup((old_obj->time->tz_abbr) );
 }
...
{
 do { zval *__z = (new_object); (*(__z)).value.obj = (date_object_clone_date(object)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
}
...
static HashTable *date_object_get_properties(zval *object)
{
 ...
 do { zval *__z = (&zv); zend_string *__s = (date_format("Y-m-d H:i:s.u", sizeof("Y-m-d H:i:s.u")-1, dateobj->time, 1)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
 ...
 if (dateobj->time->is_localtime) {
  ...
  switch (dateobj->time->zone_type) {
   case 3:
    do { const char *_s = (dateobj->time->tz_info->name); do { do { zval *__z = (&zv); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 1: {
    ...
    do { zval *__z = (&zv); zend_string *__s = (tmpstr); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
    }
    break;
   case 2:
    do { const char *_s = (dateobj->time->tz_abbr); do { do { zval *__z = (&zv); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
  }
...
static inline zend_object *date_object_new_timezone_ex(zend_class_entry *class_type, int init_props)
{
 ...
 intern = _ecalloc((1), (sizeof(php_timezone_obj) + zend_object_properties_size(class_type)) );
...
static zend_object *date_object_clone_timezone(zval *this_ptr)
{
 ...
 switch (new_obj->type) {
  ...
  case 2:
   ...
   new_obj->tzi.z.abbr = _estrdup((old_obj->tzi.z.abbr) );
   break;
 }
...
static HashTable *date_object_get_properties_timezone(zval *object)
{
 ...
 switch (tzobj->type) {
  case 3:
   do { const char *_s = (tzobj->tzi.tz->name); do { do { zval *__z = (&zv); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
   break;
  case 1: {
   zend_string *tmpstr = zend_string_alloc(sizeof("UTC+05:00")-1, 0);
   ...
   break;
  case 2:
   do { const char *_s = (tzobj->tzi.z.abbr); do { do { zval *__z = (&zv); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
   break;
 }
 _zend_hash_str_update(props, "timezone", sizeof("timezone")-1, &zv );
...
static inline zend_object *date_object_new_interval_ex(zend_class_entry *class_type, int init_props)
{
 ...
 intern = _ecalloc((1), (sizeof(php_interval_obj) + zend_object_properties_size(class_type)) );
...
static HashTable *date_object_get_properties_interval(zval *object)
{
 ...
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->y; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "y", sizeof("y")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->m; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "m", sizeof("m")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->d; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "d", sizeof("d")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->h; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "h", sizeof("h")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->i; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "i", sizeof("i")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->s; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "s", sizeof("s")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->weekday; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "weekday", sizeof("weekday")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->weekday_behavior; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "weekday_behavior", sizeof("weekday_behavior")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->first_last_day_of; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "first_last_day_of", sizeof("first_last_day_of")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->invert; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "invert", sizeof("invert")-1, &zv );;
 if (intervalobj->diff->days != -99999) {
  { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->days; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "days", sizeof("days")-1, &zv );;
 } else {
  do { (*(&zv)).u1.type_info = 2; } while (0);
  _zend_hash_str_update(props, "days", sizeof("days")-1, &zv );
 }
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->special.type; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "special_type", sizeof("special_type")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->special.amount; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "special_amount", sizeof("special_amount")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->have_weekday_relative; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "have_weekday_relative", sizeof("have_weekday_relative")-1, &zv );;
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long)intervalobj->diff->have_special_relative; (*(__z)).u1.type_info = 4; }; _zend_hash_str_update(props, "have_special_relative", sizeof("have_special_relative")-1, &zv );;
...
static inline zend_object *date_object_new_period_ex(zend_class_entry *class_type, int init_props)
{
 ...
 intern = _ecalloc((1), (sizeof(php_period_obj) + zend_object_properties_size(class_type)) );
 ...
 if (timezone_object) {
  ...
  switch (tzobj->type) {
   ...
   case 2:
    ...
    new_abbr = _estrdup((tzobj->tzi.z.abbr) );
    break;
  }
  type = tzobj->type;
...
void zif_date_create(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|sO!", &time_str, &time_str_len, &timezone_object, date_ce_timezone) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_create_from_format(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "ss|O!", &format_str, &format_str_len, &time_str, &time_str_len, &timezone_object, date_ce_timezone) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTime___construct(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (FAILURE == zend_parse_parameters_throw((execute_data)->This.u2.num_args, "|sO!", &time_str, &time_str_len, &timezone_object, date_ce_timezone)) {
  return;
 }

 zend_replace_error_handling(EH_THROW, ((void *)0), &error_handling);
 php_date_initialize(php_date_obj_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj), time_str, time_str_len, ((void *)0), timezone_object, 1);
...
void zim_DateTimeImmutable_createFromMutable(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "O", &datetime_object, date_ce_date) == FAILURE) {
  return;
 }
...
static int php_date_initialize_from_hash(php_date_obj **dateobj, HashTable *myht)
{
 ...
 if (z_date && zval_get_type(&(*(z_date))) == 6) {
  z_timezone_type = zend_hash_str_find(myht, "timezone_type", sizeof("timezone_type")-1);
  if (z_timezone_type && zval_get_type(&(*(z_timezone_type))) == 4) {
   z_timezone = zend_hash_str_find(myht, "timezone", sizeof("timezone")-1);
   if (z_timezone && zval_get_type(&(*(z_timezone))) == 6) {
    switch ((*(z_timezone_type)).value.lval) {
     case 1:
     case 2: {
      char *tmp = (__builtin_constant_p((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) ) ? (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 8) ? _emalloc_8() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 16) ? _emalloc_16() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 24) ? _emalloc_24() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 32) ? _emalloc_32() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 40) ? _emalloc_40() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 48) ? _emalloc_48() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 56) ? _emalloc_56() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 64) ? _emalloc_64() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 80) ? _emalloc_80() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 96) ? _emalloc_96() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 112) ? _emalloc_112() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 128) ? _emalloc_128() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 160) ? _emalloc_160() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 192) ? _emalloc_192() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 224) ? _emalloc_224() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 256) ? _emalloc_256() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 320) ? _emalloc_320() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 384) ? _emalloc_384() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 448) ? _emalloc_448() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 512) ? _emalloc_512() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 640) ? _emalloc_640() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 768) ? _emalloc_768() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 896) ? _emalloc_896() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 1024) ? _emalloc_1024() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 1280) ? _emalloc_1280() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 1536) ? _emalloc_1536() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 1792) ? _emalloc_1792() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 2048) ? _emalloc_2048() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 2560) ? _emalloc_2560() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= 3072) ? _emalloc_3072() : (((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2)) : _emalloc_huge((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((((*(z_date)).value.str)->len + ((*(z_timezone)).value.str)->len + 2) ) );
      int ret;
...
void php_date_do_return_parsed_time(zend_execute_data *execute_data, zval *return_value, timelib_time *parsed_time, struct timelib_error_container *error)
{
 zval element;
 ...
 if (parsed_time->have_relative) {
  ...
  if (parsed_time->relative.first_last_day_of) {
   add_assoc_bool_ex(&element, parsed_time->relative.first_last_day_of == 0x01 ? "first_day_of_month" : "last_day_of_month", strlen(parsed_time->relative.first_last_day_of == 0x01 ? "first_day_of_month" : "last_day_of_month"), 1);
  }
...
void zif_date_parse(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &date, &date_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 php_date_do_return_parsed_time(execute_data, return_value, parsed_time, error);
}
...
void zif_date_parse_from_format(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "ss", &format, &format_len, &date, &date_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_format(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Os", &object, date_ce_interface, &format, &format_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 dateobj = php_date_obj_from_obj((*((object))).value.obj);
 if (!(dateobj->time)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTime" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
 { do { zval *__z = (return_value); zend_string *__s = (date_format(format, format_len, dateobj->time, dateobj->time->is_localtime)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
void zif_date_modify(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Os", &object, date_ce_date, &modify, &modify_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 do { zval *_z1 = (return_value); const zval *_z2 = (object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
}
...
void zim_DateTimeImmutable_modify(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Os", &object, date_ce_immutable, &modify, &modify_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 do { zval *_z1 = (return_value); const zval *_z2 = (&new_object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
}
...
static void php_date_add(zval *object, zval *interval, zval *return_value)
{
 ...
 if (!(intobj->initialized)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateInterval" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
...
void zif_date_add(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "OO", &object, date_ce_date, &interval, date_ce_interval) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeImmutable_add(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "OO", &object, date_ce_immutable, &interval, date_ce_interval) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
static void set_timezone_from_timelib_time(php_timezone_obj *tzobj, timelib_time *t)
{
       ...
       switch (t->zone_type) {
               ...
               case 2:
                       ...
                       tzobj->tzi.z.abbr = _estrdup((t->tz_abbr) );
                       break;
       }
}
...
void zif_date_timezone_get(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "O", &object, date_ce_interface) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 dateobj = php_date_obj_from_obj((*((object))).value.obj);
 if (!(dateobj->time)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTime" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
...
void zif_date_timezone_set(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "OO", &object, date_ce_date, &timezone_object, date_ce_timezone) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeImmutable_setTimezone(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "OO", &object, date_ce_immutable, &timezone_object, date_ce_timezone) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_time_set(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Oll|l", &object, date_ce_date, &h, &i, &s) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeImmutable_setTime(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Oll|l", &object, date_ce_immutable, &h, &i, &s) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_date_set(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Olll", &object, date_ce_date, &y, &m, &d) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeImmutable_setDate(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Olll", &object, date_ce_immutable, &y, &m, &d) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_isodate_set(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Oll|l", &object, date_ce_date, &y, &w, &d) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeImmutable_setISODate(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Oll|l", &object, date_ce_immutable, &y, &w, &d) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_timestamp_set(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Ol", &object, date_ce_date, &timestamp) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeImmutable_setTimestamp(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Ol", &object, date_ce_immutable, &timestamp) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_diff(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "OO|b", &object1, date_ce_interface, &object2, date_ce_interface, &absolute) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 dateobj1 = php_date_obj_from_obj((*((object1))).value.obj);
 dateobj2 = php_date_obj_from_obj((*((object2))).value.obj);
 if (!(dateobj1->time)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTimeInterface" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
 if (!(dateobj2->time)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTimeInterface" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
...
static int timezone_initialize(php_timezone_obj *tzobj, char *tz, size_t tz_len)
{
 ...
 if (strlen(tz) != tz_len) {
  php_error_docref0(((void *)0), (1<<1L), "Timezone must not contain null bytes");
  return FAILURE;
 }
...
void zif_timezone_open(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &tz, &tz_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zim_DateTimeZone___construct(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (FAILURE == zend_parse_parameters_throw((execute_data)->This.u2.num_args, "s", &tz, &tz_len)) {
  return;
 }

 zend_replace_error_handling(EH_THROW, ((void *)0), &error_handling);
 tzobj = php_timezone_obj_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
static int php_date_timezone_initialize_from_hash(zval **return_value, php_timezone_obj **tzobj, HashTable *myht)
{
 ...
 if ((z_timezone_type = zend_hash_str_find(myht, "timezone_type", sizeof("timezone_type") - 1)) != ((void *)0)) {
  if ((z_timezone = zend_hash_str_find(myht, "timezone", sizeof("timezone") - 1)) != ((void *)0)) {
   if (zval_get_type(&(*(z_timezone_type))) != 4) {
    return FAILURE;
   }
   if (zval_get_type(&(*(z_timezone))) != 6) {
    return FAILURE;
   }
   if (SUCCESS == timezone_initialize(*tzobj, ((*(z_timezone)).value.str)->val, ((*(z_timezone)).value.str)->len)) {
    return SUCCESS;
   }
  }
 }
...
void zim_DateTimeZone___set_state(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if(php_date_timezone_initialize_from_hash(&return_value, &tzobj, myht) != SUCCESS) {
  php_error_docref0(((void *)0), (1<<0L), "Timezone initialization failed");
 }
}
...
void zif_timezone_name_get(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "O", &object, date_ce_timezone) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 tzobj = php_timezone_obj_from_obj((*((object))).value.obj);
 if (!(tzobj->initialized)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTimeZone" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };

 switch (tzobj->type) {
  case 3:
   { do { const char *_s = (tzobj->tzi.tz->name); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
   break;
  case 1: {
   zend_string *tmpstr = zend_string_alloc(sizeof("UTC+05:00")-1, 0);
   ...
   { do { zval *__z = (return_value); zend_string *__s = (tmpstr); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
   }
   break;
  case 2:
   { do { const char *_s = (tzobj->tzi.z.abbr); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
   break;
 }
}
...
void zif_timezone_name_from_abbr(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|ll", &abbr, &abbr_len, &gmtoffset, &isdst) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 tzid = timelib_timezone_id_from_abbr(abbr, gmtoffset, isdst);

 if (tzid) {
  { do { const char *_s = (tzid); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
 } else {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
}
...
void zif_timezone_offset_get(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "OO", &object, date_ce_timezone, &dateobject, date_ce_interface) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 tzobj = php_timezone_obj_from_obj((*((object))).value.obj);
 if (!(tzobj->initialized)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTimeZone" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
 dateobj = php_date_obj_from_obj((*((dateobject))).value.obj);
 if (!(dateobj->time)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTimeInterface" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
...
void zif_timezone_transitions_get(zend_execute_data *execute_data, zval *return_value)
{
 ...
 zend_long timestamp_begin = (-9223372036854775807L -1), timestamp_end = (9223372036854775807L);

 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "O|ll", &object, date_ce_timezone, &timestamp_begin, &timestamp_end) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 tzobj = php_timezone_obj_from_obj((*((object))).value.obj);
 if (!(tzobj->initialized)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateTimeZone" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };
...
# 3864 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
 _array_init((return_value), 0 );

 if (timestamp_begin == (-9223372036854775807L -1)) {
...
static int date_interval_initialize(timelib_rel_time **rt, char *format, size_t format_length)
{
...
zval *date_interval_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv)
{
 ...
 do {
  if (strcmp(((*(member)).value.str)->val, "y") == 0) { value = obj->diff->y; break; };
  if (strcmp(((*(member)).value.str)->val, "m") == 0) { value = obj->diff->m; break; };
  if (strcmp(((*(member)).value.str)->val, "d") == 0) { value = obj->diff->d; break; };
  if (strcmp(((*(member)).value.str)->val, "h") == 0) { value = obj->diff->h; break; };
  if (strcmp(((*(member)).value.str)->val, "i") == 0) { value = obj->diff->i; break; };
  if (strcmp(((*(member)).value.str)->val, "s") == 0) { value = obj->diff->s; break; };
  if (strcmp(((*(member)).value.str)->val, "invert") == 0) { value = obj->diff->invert; break; };
  if (strcmp(((*(member)).value.str)->val, "days") == 0) { value = obj->diff->days; break; };
...
void date_interval_write_property(zval *object, zval *member, zval *value, void **cache_slot)
{
 ...
 do {
  if (strcmp(((*(member)).value.str)->val, "y") == 0) { obj->diff->y = _zval_get_long((value)); break; };
  if (strcmp(((*(member)).value.str)->val, "m") == 0) { obj->diff->m = _zval_get_long((value)); break; };
  if (strcmp(((*(member)).value.str)->val, "d") == 0) { obj->diff->d = _zval_get_long((value)); break; };
  if (strcmp(((*(member)).value.str)->val, "h") == 0) { obj->diff->h = _zval_get_long((value)); break; };
  if (strcmp(((*(member)).value.str)->val, "i") == 0) { obj->diff->i = _zval_get_long((value)); break; };
  if (strcmp(((*(member)).value.str)->val, "s") == 0) { obj->diff->s = _zval_get_long((value)); break; };
  if (strcmp(((*(member)).value.str)->val, "invert") == 0) { obj->diff->invert = _zval_get_long((value)); break; };
...
void zim_DateInterval___construct(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "s", &interval_string, &interval_string_length) == FAILURE) {
  return;
 }

 zend_replace_error_handling(EH_THROW, ((void *)0), &error_handling);
 if (date_interval_initialize(&reltime, interval_string, interval_string_length) == SUCCESS) {
  diobj = php_interval_obj_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
  diobj->diff = reltime;
  diobj->initialized = 1;
 }
 zend_restore_error_handling(&error_handling);
...
# 4132 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
 ...
 do { zval *z_arg = zend_hash_str_find(myht, "days", sizeof("days") - 1); if (z_arg) { zend_string *str = _zval_get_string((z_arg)); (*intobj)->diff->days = atoll((str)->val); zend_string_release(str); } else { (*intobj)->diff->days = -1LL; } } while (0);;
 ...
 do { zval *z_arg = zend_hash_str_find(myht, "special_amount", sizeof("special_amount") - 1); if (z_arg) { zend_string *str = _zval_get_string((z_arg)); (*intobj)->diff->special.amount = atoll((str)->val); zend_string_release(str); } else { (*intobj)->diff->special.amount = -1LL; } } while (0);;
...
void zif_date_interval_create_from_date_string(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &time_str, &time_str_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 for (i = 0; i < format_len; i++) {
  if (have_format_spec) {
   switch (format[i]) {
    ...
    case 'S': length = ap_php_slprintf(buffer, 32, "%02" "l" "d", (zend_long) t->s); break;
    case 's': length = ap_php_slprintf(buffer, 32, "%" "l" "d", (zend_long) t->s); break;
   ...
   if (format[i] == '%') {
    ...
    smart_str_appendc_ex((&string), (format[i]), 0);
   }
  }
 }
...
void zif_date_interval_format(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_method_parameters((execute_data)->This.u2.num_args, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), "Os", &object, date_ce_interval, &format, &format_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 diobj = php_interval_obj_from_obj((*((object))).value.obj);
 if (!(diobj->initialized)) { php_error_docref0(((void *)0), (1<<1L), "The " "DateInterval" " object has not been correctly initialized by its constructor"); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; };

 { do { zval *__z = (return_value); zend_string *__s = (date_interval_format(format, format_len, diobj->diff)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}


static int date_period_initialize(timelib_time **st, timelib_time **et, timelib_rel_time **d, zend_long *recurrences, char *format, size_t format_length)
{
 timelib_time *b = ((void *)0), *e = ((void *)0);
 timelib_rel_time *p = ((void *)0);
 int r = 0;
...
void zim_DatePeriod___construct(zend_execute_data *execute_data, zval *return_value)
{
 ...
 zend_replace_error_handling(EH_THROW, ((void *)0), &error_handling);
 if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "OOl|l", &start, date_ce_interface, &interval, date_ce_interval, &recurrences, &options) == FAILURE) {
  if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "OOO|l", &start, date_ce_interface, &interval, date_ce_interval, &end, date_ce_interface, &options) == FAILURE) {
   if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "s|l", &isostr, &isostr_len, &options) == FAILURE) {
 ...
 dpobj = php_period_obj_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 if (isostr) {
  ...
  if (dateobj->time->tz_abbr) {
   clone->tz_abbr = _estrdup((dateobj->time->tz_abbr) );
  }
  if (dateobj->time->tz_info) {
   clone->tz_info = dateobj->time->tz_info;
  }
  dpobj->start = clone;
  dpobj->start_ce = ((*(start)).value.obj->ce);
 ...
 *dateobj->time = *dpobj->start;
 if (dpobj->start->tz_abbr) {
  dateobj->time->tz_abbr = _estrdup((dpobj->start->tz_abbr) );
 }
...
void zim_DatePeriod_getEndDate(zend_execute_data *execute_data, zval *return_value)
{
        ...
        *dateobj->time = *dpobj->end;
        if (dpobj->end->tz_abbr) {
                dateobj->time->tz_abbr = _estrdup((dpobj->end->tz_abbr) );
        }
...
void zif_timezone_identifiers_list(zend_execute_data *execute_data, zval *return_value)
{
 ...
 int i, item_count;
 zend_long what = 0x07FF;
 char *option = ((void *)0);
 size_t option_len = 0;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|ls", &what, &option, &option_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_timezone_version_get(zend_execute_data *execute_data, zval *return_value)
{
 ...
 tzdb = php_date_global_timezone_db ? php_date_global_timezone_db : timelib_builtin_db();
 { do { const char *_s = (tzdb->version); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
}
...
void zif_timezone_abbreviations_list(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do {
  ...
  abbr_array_p = zend_hash_str_find((*(return_value)).value.arr, entry->name, strlen(entry->name));
  if (!abbr_array_p) {
   _array_init((&abbr_array), 0 );
   add_assoc_zval_ex(return_value, entry->name, strlen(entry->name), &abbr_array);
  } else {
   do { zval *_z1 = (&abbr_array); const zval *_z2 = (abbr_array_p); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  }
...
void zif_date_default_timezone_set(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &zone, &zone_len) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_date_default_timezone_get(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const char *_s = (default_tz->name); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
}
...
static void php_do_date_sunrise_sunset(zend_execute_data *execute_data, zval *return_value, int calc_sunset)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l|ldddd", &time, &retformat, &latitude, &longitude, &zenith, &gmt_offset) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if ((execute_data)->This.u2.num_args <= 5) {
 ...
 switch (retformat) {
  case 1:
   ...
   { do { zval *__z = (return_value); zend_string *__s = (retstr); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
   break;
  case 2:
...
void zif_date_sunrise(zend_execute_data *execute_data, zval *return_value)
{
 php_do_date_sunrise_sunset(execute_data, return_value, 0);
}
...
void zif_date_sunset(zend_execute_data *execute_data, zval *return_value)
{
 php_do_date_sunrise_sunset(execute_data, return_value, 1);
}
...
void zif_date_sun_info(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "ldd", &time, &latitude, &longitude) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
static HashTable *date_object_get_properties_period(zval *object)
{
 ...
 { zval *__z = (&zv); (*(__z)).value.lval = (zend_long) period_obj->recurrences; (*(__z)).u1.type_info = 4; };
...
static int php_date_period_initialize_from_hash(php_period_obj *period_obj, HashTable *myht)
{
 ...
 if (ht_entry) {
  if (zval_get_type(&(*(ht_entry))) == 8 && ((*(ht_entry)).value.obj->ce) == date_ce_date) {
   php_date_obj *date_obj;
   date_obj = php_date_obj_from_obj((*((ht_entry))).value.obj);
   period_obj->start = timelib_time_clone(date_obj->time);
   period_obj->start_ce = ((*(ht_entry)).value.obj->ce);
 ...
 if (ht_entry) {
  if (zval_get_type(&(*(ht_entry))) == 8 && ((*(ht_entry)).value.obj->ce) == date_ce_interval) {
   php_interval_obj *interval_obj;
...
static zval *date_period_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv)
{
 ...
 if (zval_get_type(&(*(zv))) == 8 && ((*(zv))).value.obj->handlers->clone_obj) {
  ...
  do { zval *__z = (zv); (*(__z)).value.obj = (((*(zv))).value.obj->handlers->clone_obj(zv)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
 }
