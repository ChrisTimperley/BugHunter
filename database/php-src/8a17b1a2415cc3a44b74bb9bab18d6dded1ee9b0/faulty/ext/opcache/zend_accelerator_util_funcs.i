# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_modules.h"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_modules.h" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.h"
...
# 46 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 51 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 87 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 88 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 318 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 346 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
zend_string *accel_new_interned_string(zend_string *str);
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.h" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist.h"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2
# 40 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c"
...
static void zend_accel_destroy_zend_function(zval *zv)
{
 ...
 if (function->type == 2) {
  if (function->op_array.static_variables) {
   if (!((function->op_array.static_variables)->gc.u.v.flags & (1<<1))) {
    if (--(function->op_array.static_variables)->gc.refcount == 0) {
     do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8(function->op_array.static_variables); } else if (sizeof(HashTable) <= 16) { _efree_16(function->op_array.static_variables); } else if (sizeof(HashTable) <= 24) { _efree_24(function->op_array.static_variables); } else if (sizeof(HashTable) <= 32) { _efree_32(function->op_array.static_variables); } else if (sizeof(HashTable) <= 40) { _efree_40(function->op_array.static_variables); } else if (sizeof(HashTable) <= 48) { _efree_48(function->op_array.static_variables); } else if (sizeof(HashTable) <= 56) { _efree_56(function->op_array.static_variables); } else if (sizeof(HashTable) <= 64) { _efree_64(function->op_array.static_variables); } else if (sizeof(HashTable) <= 80) { _efree_80(function->op_array.static_variables); } else if (sizeof(HashTable) <= 96) { _efree_96(function->op_array.static_variables); } else if (sizeof(HashTable) <= 112) { _efree_112(function->op_array.static_variables); } else if (sizeof(HashTable) <= 128) { _efree_128(function->op_array.static_variables); } else if (sizeof(HashTable) <= 160) { _efree_160(function->op_array.static_variables); } else if (sizeof(HashTable) <= 192) { _efree_192(function->op_array.static_variables); } else if (sizeof(HashTable) <= 224) { _efree_224(function->op_array.static_variables); } else if (sizeof(HashTable) <= 256) { _efree_256(function->op_array.static_variables); } else if (sizeof(HashTable) <= 320) { _efree_320(function->op_array.static_variables); } else if (sizeof(HashTable) <= 384) { _efree_384(function->op_array.static_variables); } else if (sizeof(HashTable) <= 448) { _efree_448(function->op_array.static_variables); } else if (sizeof(HashTable) <= 512) { _efree_512(function->op_array.static_variables); } else if (sizeof(HashTable) <= 640) { _efree_640(function->op_array.static_variables); } else if (sizeof(HashTable) <= 768) { _efree_768(function->op_array.static_variables); } else if (sizeof(HashTable) <= 896) { _efree_896(function->op_array.static_variables); } else if (sizeof(HashTable) <= 1024) { _efree_1024(function->op_array.static_variables); } else if (sizeof(HashTable) <= 1280) { _efree_1280(function->op_array.static_variables); } else if (sizeof(HashTable) <= 1536) { _efree_1536(function->op_array.static_variables); } else if (sizeof(HashTable) <= 1792) { _efree_1792(function->op_array.static_variables); } else if (sizeof(HashTable) <= 2048) { _efree_2048(function->op_array.static_variables); } else if (sizeof(HashTable) <= 2560) { _efree_2560(function->op_array.static_variables); } else if (sizeof(HashTable) <= 3072) { _efree_3072(function->op_array.static_variables); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(function->op_array.static_variables, sizeof(HashTable)); } else { _efree_huge(function->op_array.static_variables, sizeof(HashTable)); } } else { _efree(function->op_array.static_variables); } } while (0);
    }
   }
...
zend_persistent_script* create_persistent_script(void)
{
 zend_persistent_script *persistent_script = (zend_persistent_script *) (__builtin_constant_p((sizeof(zend_persistent_script)) ) ? (((sizeof(zend_persistent_script)) <= 8) ? _emalloc_8() : (((sizeof(zend_persistent_script)) <= 16) ? _emalloc_16() : (((sizeof(zend_persistent_script)) <= 24) ? _emalloc_24() : (((sizeof(zend_persistent_script)) <= 32) ? _emalloc_32() : (((sizeof(zend_persistent_script)) <= 40) ? _emalloc_40() : (((sizeof(zend_persistent_script)) <= 48) ? _emalloc_48() : (((sizeof(zend_persistent_script)) <= 56) ? _emalloc_56() : (((sizeof(zend_persistent_script)) <= 64) ? _emalloc_64() : (((sizeof(zend_persistent_script)) <= 80) ? _emalloc_80() : (((sizeof(zend_persistent_script)) <= 96) ? _emalloc_96() : (((sizeof(zend_persistent_script)) <= 112) ? _emalloc_112() : (((sizeof(zend_persistent_script)) <= 128) ? _emalloc_128() : (((sizeof(zend_persistent_script)) <= 160) ? _emalloc_160() : (((sizeof(zend_persistent_script)) <= 192) ? _emalloc_192() : (((sizeof(zend_persistent_script)) <= 224) ? _emalloc_224() : (((sizeof(zend_persistent_script)) <= 256) ? _emalloc_256() : (((sizeof(zend_persistent_script)) <= 320) ? _emalloc_320() : (((sizeof(zend_persistent_script)) <= 384) ? _emalloc_384() : (((sizeof(zend_persistent_script)) <= 448) ? _emalloc_448() : (((sizeof(zend_persistent_script)) <= 512) ? _emalloc_512() : (((sizeof(zend_persistent_script)) <= 640) ? _emalloc_640() : (((sizeof(zend_persistent_script)) <= 768) ? _emalloc_768() : (((sizeof(zend_persistent_script)) <= 896) ? _emalloc_896() : (((sizeof(zend_persistent_script)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_persistent_script)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_persistent_script)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_persistent_script)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_persistent_script)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_persistent_script)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_persistent_script)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_persistent_script)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_persistent_script))) : _emalloc_huge((sizeof(zend_persistent_script)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_persistent_script)) ) );
 memset(persistent_script, 0, sizeof(zend_persistent_script));

 _zend_hash_init((&persistent_script->function_table), (128), (zend_function_dtor), (0) );




 _zend_hash_init((&persistent_script->class_table), (16), (destroy_zend_class), (0) );
...
void zend_accel_move_user_functions(HashTable *src, HashTable *dst)
{
 ...
 do { uint _idx; for (_idx = (src)->nNumUsed; _idx > 0; _idx--) { Bucket *_p = (src)->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; p = _p; {
  zend_function *function = (p->val).value.ptr;

  if (__builtin_expect(!!(function->type == 2), 1)) {
...
{
 zend_internal_function *function = (*(zv)).value.ptr;
 if (function->type == 1) {
...
void zend_accel_copy_internal_functions(void)
{
 ...
 (accel_globals.internal_functions_count) = (&(accel_globals.function_table))->nNumOfElements;
}
...
static zend_ast *zend_ast_clone(zend_ast *ast)
{
 ...
 if (ast->kind == ZEND_AST_ZVAL) {
  zend_ast_zval *copy = (__builtin_constant_p((sizeof(zend_ast_zval)) ) ? (((sizeof(zend_ast_zval)) <= 8) ? _emalloc_8() : (((sizeof(zend_ast_zval)) <= 16) ? _emalloc_16() : (((sizeof(zend_ast_zval)) <= 24) ? _emalloc_24() : (((sizeof(zend_ast_zval)) <= 32) ? _emalloc_32() : (((sizeof(zend_ast_zval)) <= 40) ? _emalloc_40() : (((sizeof(zend_ast_zval)) <= 48) ? _emalloc_48() : (((sizeof(zend_ast_zval)) <= 56) ? _emalloc_56() : (((sizeof(zend_ast_zval)) <= 64) ? _emalloc_64() : (((sizeof(zend_ast_zval)) <= 80) ? _emalloc_80() : (((sizeof(zend_ast_zval)) <= 96) ? _emalloc_96() : (((sizeof(zend_ast_zval)) <= 112) ? _emalloc_112() : (((sizeof(zend_ast_zval)) <= 128) ? _emalloc_128() : (((sizeof(zend_ast_zval)) <= 160) ? _emalloc_160() : (((sizeof(zend_ast_zval)) <= 192) ? _emalloc_192() : (((sizeof(zend_ast_zval)) <= 224) ? _emalloc_224() : (((sizeof(zend_ast_zval)) <= 256) ? _emalloc_256() : (((sizeof(zend_ast_zval)) <= 320) ? _emalloc_320() : (((sizeof(zend_ast_zval)) <= 384) ? _emalloc_384() : (((sizeof(zend_ast_zval)) <= 448) ? _emalloc_448() : (((sizeof(zend_ast_zval)) <= 512) ? _emalloc_512() : (((sizeof(zend_ast_zval)) <= 640) ? _emalloc_640() : (((sizeof(zend_ast_zval)) <= 768) ? _emalloc_768() : (((sizeof(zend_ast_zval)) <= 896) ? _emalloc_896() : (((sizeof(zend_ast_zval)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_ast_zval)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_ast_zval)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_ast_zval)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_ast_zval)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_ast_zval)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_ast_zval)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_ast_zval)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_ast_zval))) : _emalloc_huge((sizeof(zend_ast_zval)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_ast_zval)) ) );
  copy->kind = ZEND_AST_ZVAL;
  copy->attr = ast->attr;
  do { zval *_z1 = (&copy->val); const zval *_z2 = (zend_ast_get_zval(ast)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  return (zend_ast *) copy;
 } else if (zend_ast_is_list(ast)) {
  zend_ast_list *list = zend_ast_get_list(ast);
  zend_ast_list *copy = (__builtin_constant_p((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) ) ? (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 8) ? _emalloc_8() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 16) ? _emalloc_16() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 24) ? _emalloc_24() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 32) ? _emalloc_32() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 40) ? _emalloc_40() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 48) ? _emalloc_48() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 56) ? _emalloc_56() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 64) ? _emalloc_64() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 80) ? _emalloc_80() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 96) ? _emalloc_96() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 112) ? _emalloc_112() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 128) ? _emalloc_128() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 160) ? _emalloc_160() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 192) ? _emalloc_192() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 224) ? _emalloc_224() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 256) ? _emalloc_256() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 320) ? _emalloc_320() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 384) ? _emalloc_384() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 448) ? _emalloc_448() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 512) ? _emalloc_512() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 640) ? _emalloc_640() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 768) ? _emalloc_768() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 896) ? _emalloc_896() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 1024) ? _emalloc_1024() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 1280) ? _emalloc_1280() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 1536) ? _emalloc_1536() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 1792) ? _emalloc_1792() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 2048) ? _emalloc_2048() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 2560) ? _emalloc_2560() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= 3072) ? _emalloc_3072() : (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children)) : _emalloc_huge((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) ) )
                                                                                    ;
  copy->kind = list->kind;
  copy->attr = list->attr;
  ...
  zend_ast *copy = (__builtin_constant_p((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) ) ? (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 8) ? _emalloc_8() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 16) ? _emalloc_16() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 24) ? _emalloc_24() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 32) ? _emalloc_32() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 40) ? _emalloc_40() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 48) ? _emalloc_48() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 56) ? _emalloc_56() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 64) ? _emalloc_64() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 80) ? _emalloc_80() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 96) ? _emalloc_96() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 112) ? _emalloc_112() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 128) ? _emalloc_128() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 160) ? _emalloc_160() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 192) ? _emalloc_192() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 224) ? _emalloc_224() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 256) ? _emalloc_256() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 320) ? _emalloc_320() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 384) ? _emalloc_384() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 448) ? _emalloc_448() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 512) ? _emalloc_512() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 640) ? _emalloc_640() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 768) ? _emalloc_768() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 896) ? _emalloc_896() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 1024) ? _emalloc_1024() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 1280) ? _emalloc_1280() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 1536) ? _emalloc_1536() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 1792) ? _emalloc_1792() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 2048) ? _emalloc_2048() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 2560) ? _emalloc_2560() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= 3072) ? _emalloc_3072() : (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children)) : _emalloc_huge((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) ) );
  copy->kind = ast->kind;
  copy->attr = ast->attr;
...
static void zend_hash_clone_constants(HashTable *ht, HashTable *source)
{
 ...
 ht->pDestructor = _zval_ptr_dtor;
 ht->u.flags = (source->u.flags & (1<<3)) | (1<<1);
 ht->nInternalPointer = source->nNumOfElements ? 0 : ((uint32_t) -1);
 ...
 do { if (__builtin_expect(!((source->u.flags & (1<<2)) == 0), 0)) __builtin_unreachable(); } while (0);
 do { (ht)->arData = (Bucket*)(((char*)((__builtin_constant_p(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) ) ? ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) ) ))) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
 memset(&((uint32_t*)((ht)->arData))[(int32_t)((ht)->nTableMask)], ((uint32_t) -1), (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)));

 p = source->arData;
 end = p + source->nNumUsed;
 for (; p != end; p++) {
  if (__builtin_expect(!!(zval_get_type(&(p->val)) == 0), 0)) continue;
  nIndex = p->h | ht->nTableMask;


  q = ht->arData + ht->nNumUsed;
  (q->val).u2.next = ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)];
  ((uint32_t*)((ht)->arData))[(int32_t)(nIndex)] = (ht->nNumUsed++);
...
static void zend_hash_clone_methods(HashTable *ht, HashTable *source, zend_class_entry *old_ce, zend_class_entry *ce)
{
 ...
 do { if (__builtin_expect(!(!(source->u.flags & (1<<2))), 0)) __builtin_unreachable(); } while (0);
 do { (ht)->arData = (Bucket*)(((char*)((__builtin_constant_p(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) ) ? ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 8) ? _emalloc_8() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 16) ? _emalloc_16() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 24) ? _emalloc_24() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 32) ? _emalloc_32() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 40) ? _emalloc_40() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 48) ? _emalloc_48() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 56) ? _emalloc_56() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 64) ? _emalloc_64() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 80) ? _emalloc_80() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 96) ? _emalloc_96() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 112) ? _emalloc_112() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 128) ? _emalloc_128() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 160) ? _emalloc_160() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 192) ? _emalloc_192() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 224) ? _emalloc_224() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 256) ? _emalloc_256() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 320) ? _emalloc_320() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 384) ? _emalloc_384() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 448) ? _emalloc_448() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 512) ? _emalloc_512() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 640) ? _emalloc_640() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 768) ? _emalloc_768() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 896) ? _emalloc_896() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1024) ? _emalloc_1024() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1280) ? _emalloc_1280() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1536) ? _emalloc_1536() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 1792) ? _emalloc_1792() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 2048) ? _emalloc_2048() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 2560) ? _emalloc_2560() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= 3072) ? _emalloc_3072() : ((((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t))))) : _emalloc_huge(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((((size_t)(((ht)->nTableSize)) * sizeof(Bucket)) + (((size_t)(uint32_t)-(int32_t)(((ht)->nTableMask))) * sizeof(uint32_t)))) ) ))) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
 memset(&((uint32_t*)((ht)->arData))[(int32_t)((ht)->nTableMask)], ((uint32_t) -1), (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)));
 ...
 for (; p != end; p++) {
  ...
  q->h = p->h;
  do { if (__builtin_expect(!(p->key != ((void *)0)), 0)) __builtin_unreachable(); } while (0);
  q->key = p->key;


  do { (*(&q->val)).value.ptr = ((void*)(((char*)((p->val).value.ptr)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem))); (*(&q->val)).u1.type_info = 17; } while (0);
  new_entry = (zend_op_array*)(q->val).value.ptr;

  if ((void*)new_entry->scope >= (accel_globals.current_persistent_script)->arena_mem &&
      (void*)new_entry->scope < (void*)((char*)(accel_globals.current_persistent_script)->arena_mem + (accel_globals.current_persistent_script)->arena_size)) {

   new_entry->scope = (void*)(((char*)(new_entry->scope)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem));


   if (new_entry->prototype) {
    new_entry->prototype = (void*)(((char*)(new_entry->prototype)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem));
   }
  }
 }
}
...
static void zend_hash_clone_prop_info(HashTable *ht, HashTable *source, zend_class_entry *old_ce)
{
 ...
 for (; p != end; p++) {
  ...
  prop_info = (void*)(((char*)((p->val).value.ptr)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem));
  do { (*(&q->val)).value.ptr = (prop_info); (*(&q->val)).u1.type_info = 17; } while (0);

  if ((void*)prop_info->ce >= (accel_globals.current_persistent_script)->arena_mem &&
      (void*)prop_info->ce < (void*)((char*)(accel_globals.current_persistent_script)->arena_mem + (accel_globals.current_persistent_script)->arena_size)) {
   prop_info->ce = (void*)(((char*)(prop_info->ce)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem));
  }
 }
}
# 391 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c"
 ...
 *pce = ce = (void*)(((char*)(old_ce)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem));
 ce->refcount = 1;

 if (old_ce->default_properties_table) {
  ce->default_properties_table = (__builtin_constant_p((sizeof(zval) * old_ce->default_properties_count) ) ? (((sizeof(zval) * old_ce->default_properties_count) <= 8) ? _emalloc_8() : (((sizeof(zval) * old_ce->default_properties_count) <= 16) ? _emalloc_16() : (((sizeof(zval) * old_ce->default_properties_count) <= 24) ? _emalloc_24() : (((sizeof(zval) * old_ce->default_properties_count) <= 32) ? _emalloc_32() : (((sizeof(zval) * old_ce->default_properties_count) <= 40) ? _emalloc_40() : (((sizeof(zval) * old_ce->default_properties_count) <= 48) ? _emalloc_48() : (((sizeof(zval) * old_ce->default_properties_count) <= 56) ? _emalloc_56() : (((sizeof(zval) * old_ce->default_properties_count) <= 64) ? _emalloc_64() : (((sizeof(zval) * old_ce->default_properties_count) <= 80) ? _emalloc_80() : (((sizeof(zval) * old_ce->default_properties_count) <= 96) ? _emalloc_96() : (((sizeof(zval) * old_ce->default_properties_count) <= 112) ? _emalloc_112() : (((sizeof(zval) * old_ce->default_properties_count) <= 128) ? _emalloc_128() : (((sizeof(zval) * old_ce->default_properties_count) <= 160) ? _emalloc_160() : (((sizeof(zval) * old_ce->default_properties_count) <= 192) ? _emalloc_192() : (((sizeof(zval) * old_ce->default_properties_count) <= 224) ? _emalloc_224() : (((sizeof(zval) * old_ce->default_properties_count) <= 256) ? _emalloc_256() : (((sizeof(zval) * old_ce->default_properties_count) <= 320) ? _emalloc_320() : (((sizeof(zval) * old_ce->default_properties_count) <= 384) ? _emalloc_384() : (((sizeof(zval) * old_ce->default_properties_count) <= 448) ? _emalloc_448() : (((sizeof(zval) * old_ce->default_properties_count) <= 512) ? _emalloc_512() : (((sizeof(zval) * old_ce->default_properties_count) <= 640) ? _emalloc_640() : (((sizeof(zval) * old_ce->default_properties_count) <= 768) ? _emalloc_768() : (((sizeof(zval) * old_ce->default_properties_count) <= 896) ? _emalloc_896() : (((sizeof(zval) * old_ce->default_properties_count) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * old_ce->default_properties_count) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * old_ce->default_properties_count) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * old_ce->default_properties_count) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * old_ce->default_properties_count) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * old_ce->default_properties_count) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * old_ce->default_properties_count) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * old_ce->default_properties_count) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * old_ce->default_properties_count)) : _emalloc_huge((sizeof(zval) * old_ce->default_properties_count))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * old_ce->default_properties_count) ) );
 ...
 if (old_ce->default_static_members_table) {
  ce->default_static_members_table = (__builtin_constant_p((sizeof(zval) * old_ce->default_static_members_count) ) ? (((sizeof(zval) * old_ce->default_static_members_count) <= 8) ? _emalloc_8() : (((sizeof(zval) * old_ce->default_static_members_count) <= 16) ? _emalloc_16() : (((sizeof(zval) * old_ce->default_static_members_count) <= 24) ? _emalloc_24() : (((sizeof(zval) * old_ce->default_static_members_count) <= 32) ? _emalloc_32() : (((sizeof(zval) * old_ce->default_static_members_count) <= 40) ? _emalloc_40() : (((sizeof(zval) * old_ce->default_static_members_count) <= 48) ? _emalloc_48() : (((sizeof(zval) * old_ce->default_static_members_count) <= 56) ? _emalloc_56() : (((sizeof(zval) * old_ce->default_static_members_count) <= 64) ? _emalloc_64() : (((sizeof(zval) * old_ce->default_static_members_count) <= 80) ? _emalloc_80() : (((sizeof(zval) * old_ce->default_static_members_count) <= 96) ? _emalloc_96() : (((sizeof(zval) * old_ce->default_static_members_count) <= 112) ? _emalloc_112() : (((sizeof(zval) * old_ce->default_static_members_count) <= 128) ? _emalloc_128() : (((sizeof(zval) * old_ce->default_static_members_count) <= 160) ? _emalloc_160() : (((sizeof(zval) * old_ce->default_static_members_count) <= 192) ? _emalloc_192() : (((sizeof(zval) * old_ce->default_static_members_count) <= 224) ? _emalloc_224() : (((sizeof(zval) * old_ce->default_static_members_count) <= 256) ? _emalloc_256() : (((sizeof(zval) * old_ce->default_static_members_count) <= 320) ? _emalloc_320() : (((sizeof(zval) * old_ce->default_static_members_count) <= 384) ? _emalloc_384() : (((sizeof(zval) * old_ce->default_static_members_count) <= 448) ? _emalloc_448() : (((sizeof(zval) * old_ce->default_static_members_count) <= 512) ? _emalloc_512() : (((sizeof(zval) * old_ce->default_static_members_count) <= 640) ? _emalloc_640() : (((sizeof(zval) * old_ce->default_static_members_count) <= 768) ? _emalloc_768() : (((sizeof(zval) * old_ce->default_static_members_count) <= 896) ? _emalloc_896() : (((sizeof(zval) * old_ce->default_static_members_count) <= 1024) ? _emalloc_1024() : (((sizeof(zval) * old_ce->default_static_members_count) <= 1280) ? _emalloc_1280() : (((sizeof(zval) * old_ce->default_static_members_count) <= 1536) ? _emalloc_1536() : (((sizeof(zval) * old_ce->default_static_members_count) <= 1792) ? _emalloc_1792() : (((sizeof(zval) * old_ce->default_static_members_count) <= 2048) ? _emalloc_2048() : (((sizeof(zval) * old_ce->default_static_members_count) <= 2560) ? _emalloc_2560() : (((sizeof(zval) * old_ce->default_static_members_count) <= 3072) ? _emalloc_3072() : (((sizeof(zval) * old_ce->default_static_members_count) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zval) * old_ce->default_static_members_count)) : _emalloc_huge((sizeof(zval) * old_ce->default_static_members_count))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zval) * old_ce->default_static_members_count) ) );
 ...
 ce->constants_table.u.flags &= ~(1<<1);


 if (ce->num_interfaces) {
  ce->interfaces = (__builtin_constant_p((sizeof(zend_class_entry *) * ce->num_interfaces) ) ? (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 8) ? _emalloc_8() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 16) ? _emalloc_16() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 24) ? _emalloc_24() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 32) ? _emalloc_32() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 40) ? _emalloc_40() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 48) ? _emalloc_48() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 56) ? _emalloc_56() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 64) ? _emalloc_64() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 80) ? _emalloc_80() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 96) ? _emalloc_96() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 112) ? _emalloc_112() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 128) ? _emalloc_128() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 160) ? _emalloc_160() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 192) ? _emalloc_192() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 224) ? _emalloc_224() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 256) ? _emalloc_256() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 320) ? _emalloc_320() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 384) ? _emalloc_384() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 448) ? _emalloc_448() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 512) ? _emalloc_512() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 640) ? _emalloc_640() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 768) ? _emalloc_768() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 896) ? _emalloc_896() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 1024) ? _emalloc_1024() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 1280) ? _emalloc_1280() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 1536) ? _emalloc_1536() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 1792) ? _emalloc_1792() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 2048) ? _emalloc_2048() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 2560) ? _emalloc_2560() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= 3072) ? _emalloc_3072() : (((sizeof(zend_class_entry *) * ce->num_interfaces) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_class_entry *) * ce->num_interfaces)) : _emalloc_huge((sizeof(zend_class_entry *) * ce->num_interfaces))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_class_entry *) * ce->num_interfaces) ) );
 ...
 if (ce->parent) {
  ce->parent = (void*)(((char*)(ce->parent)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem));
 }

 { if (ce->constructor != ((void *)0)) { ce->constructor = (void*)(((char*)(ce->constructor)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->destructor != ((void *)0)) { ce->destructor = (void*)(((char*)(ce->destructor)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->clone != ((void *)0)) { ce->clone = (void*)(((char*)(ce->clone)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->__get != ((void *)0)) { ce->__get = (void*)(((char*)(ce->__get)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->__set != ((void *)0)) { ce->__set = (void*)(((char*)(ce->__set)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->__call != ((void *)0)) { ce->__call = (void*)(((char*)(ce->__call)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };

 { if (ce->serialize_func != ((void *)0)) { ce->serialize_func = (void*)(((char*)(ce->serialize_func)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->unserialize_func != ((void *)0)) { ce->unserialize_func = (void*)(((char*)(ce->unserialize_func)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->__isset != ((void *)0)) { ce->__isset = (void*)(((char*)(ce->__isset)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->__unset != ((void *)0)) { ce->__unset = (void*)(((char*)(ce->__unset)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };

 { if (ce->__tostring != ((void *)0)) { ce->__tostring = (void*)(((char*)(ce->__tostring)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };


 { if (ce->__callstatic != ((void *)0)) { ce->__callstatic = (void*)(((char*)(ce->__callstatic)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 { if (ce->__debugInfo != ((void *)0)) { ce->__debugInfo = (void*)(((char*)(ce->__debugInfo)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)); } };
 ...
 if (ce->trait_precedences) {
  ...
  trait_precedences = (__builtin_constant_p((sizeof(zend_trait_precedence*) * (i + 1)) ) ? (((sizeof(zend_trait_precedence*) * (i + 1)) <= 8) ? _emalloc_8() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 16) ? _emalloc_16() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 24) ? _emalloc_24() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 32) ? _emalloc_32() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 40) ? _emalloc_40() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 48) ? _emalloc_48() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 56) ? _emalloc_56() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 64) ? _emalloc_64() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 80) ? _emalloc_80() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 96) ? _emalloc_96() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 112) ? _emalloc_112() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 128) ? _emalloc_128() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 160) ? _emalloc_160() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 192) ? _emalloc_192() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 224) ? _emalloc_224() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 256) ? _emalloc_256() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 320) ? _emalloc_320() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 384) ? _emalloc_384() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 448) ? _emalloc_448() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 512) ? _emalloc_512() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 640) ? _emalloc_640() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 768) ? _emalloc_768() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 896) ? _emalloc_896() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_trait_precedence*) * (i + 1)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_trait_precedence*) * (i + 1))) : _emalloc_huge((sizeof(zend_trait_precedence*) * (i + 1)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_trait_precedence*) * (i + 1)) ) );
  i = 0;
  while (ce->trait_precedences[i]) {
   trait_precedences[i] = (__builtin_constant_p((sizeof(zend_trait_precedence)) ) ? (((sizeof(zend_trait_precedence)) <= 8) ? _emalloc_8() : (((sizeof(zend_trait_precedence)) <= 16) ? _emalloc_16() : (((sizeof(zend_trait_precedence)) <= 24) ? _emalloc_24() : (((sizeof(zend_trait_precedence)) <= 32) ? _emalloc_32() : (((sizeof(zend_trait_precedence)) <= 40) ? _emalloc_40() : (((sizeof(zend_trait_precedence)) <= 48) ? _emalloc_48() : (((sizeof(zend_trait_precedence)) <= 56) ? _emalloc_56() : (((sizeof(zend_trait_precedence)) <= 64) ? _emalloc_64() : (((sizeof(zend_trait_precedence)) <= 80) ? _emalloc_80() : (((sizeof(zend_trait_precedence)) <= 96) ? _emalloc_96() : (((sizeof(zend_trait_precedence)) <= 112) ? _emalloc_112() : (((sizeof(zend_trait_precedence)) <= 128) ? _emalloc_128() : (((sizeof(zend_trait_precedence)) <= 160) ? _emalloc_160() : (((sizeof(zend_trait_precedence)) <= 192) ? _emalloc_192() : (((sizeof(zend_trait_precedence)) <= 224) ? _emalloc_224() : (((sizeof(zend_trait_precedence)) <= 256) ? _emalloc_256() : (((sizeof(zend_trait_precedence)) <= 320) ? _emalloc_320() : (((sizeof(zend_trait_precedence)) <= 384) ? _emalloc_384() : (((sizeof(zend_trait_precedence)) <= 448) ? _emalloc_448() : (((sizeof(zend_trait_precedence)) <= 512) ? _emalloc_512() : (((sizeof(zend_trait_precedence)) <= 640) ? _emalloc_640() : (((sizeof(zend_trait_precedence)) <= 768) ? _emalloc_768() : (((sizeof(zend_trait_precedence)) <= 896) ? _emalloc_896() : (((sizeof(zend_trait_precedence)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_trait_precedence)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_trait_precedence)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_trait_precedence)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_trait_precedence)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_trait_precedence)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_trait_precedence)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_trait_precedence)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_trait_precedence))) : _emalloc_huge((sizeof(zend_trait_precedence)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_trait_precedence)) ) );
   memcpy(trait_precedences[i], ce->trait_precedences[i], sizeof(zend_trait_precedence));
   trait_precedences[i]->trait_method = (__builtin_constant_p((sizeof(zend_trait_method_reference)) ) ? (((sizeof(zend_trait_method_reference)) <= 8) ? _emalloc_8() : (((sizeof(zend_trait_method_reference)) <= 16) ? _emalloc_16() : (((sizeof(zend_trait_method_reference)) <= 24) ? _emalloc_24() : (((sizeof(zend_trait_method_reference)) <= 32) ? _emalloc_32() : (((sizeof(zend_trait_method_reference)) <= 40) ? _emalloc_40() : (((sizeof(zend_trait_method_reference)) <= 48) ? _emalloc_48() : (((sizeof(zend_trait_method_reference)) <= 56) ? _emalloc_56() : (((sizeof(zend_trait_method_reference)) <= 64) ? _emalloc_64() : (((sizeof(zend_trait_method_reference)) <= 80) ? _emalloc_80() : (((sizeof(zend_trait_method_reference)) <= 96) ? _emalloc_96() : (((sizeof(zend_trait_method_reference)) <= 112) ? _emalloc_112() : (((sizeof(zend_trait_method_reference)) <= 128) ? _emalloc_128() : (((sizeof(zend_trait_method_reference)) <= 160) ? _emalloc_160() : (((sizeof(zend_trait_method_reference)) <= 192) ? _emalloc_192() : (((sizeof(zend_trait_method_reference)) <= 224) ? _emalloc_224() : (((sizeof(zend_trait_method_reference)) <= 256) ? _emalloc_256() : (((sizeof(zend_trait_method_reference)) <= 320) ? _emalloc_320() : (((sizeof(zend_trait_method_reference)) <= 384) ? _emalloc_384() : (((sizeof(zend_trait_method_reference)) <= 448) ? _emalloc_448() : (((sizeof(zend_trait_method_reference)) <= 512) ? _emalloc_512() : (((sizeof(zend_trait_method_reference)) <= 640) ? _emalloc_640() : (((sizeof(zend_trait_method_reference)) <= 768) ? _emalloc_768() : (((sizeof(zend_trait_method_reference)) <= 896) ? _emalloc_896() : (((sizeof(zend_trait_method_reference)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_trait_method_reference)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_trait_method_reference)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_trait_method_reference)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_trait_method_reference)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_trait_method_reference)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_trait_method_reference)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_trait_method_reference)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_trait_method_reference))) : _emalloc_huge((sizeof(zend_trait_method_reference)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_trait_method_reference)) ) );
   ...
   if (trait_precedences[i]->exclude_from_classes) {
    ...
    exclude_from_classes = (__builtin_constant_p((sizeof(zend_string*) * (j + 1)) ) ? (((sizeof(zend_string*) * (j + 1)) <= 8) ? _emalloc_8() : (((sizeof(zend_string*) * (j + 1)) <= 16) ? _emalloc_16() : (((sizeof(zend_string*) * (j + 1)) <= 24) ? _emalloc_24() : (((sizeof(zend_string*) * (j + 1)) <= 32) ? _emalloc_32() : (((sizeof(zend_string*) * (j + 1)) <= 40) ? _emalloc_40() : (((sizeof(zend_string*) * (j + 1)) <= 48) ? _emalloc_48() : (((sizeof(zend_string*) * (j + 1)) <= 56) ? _emalloc_56() : (((sizeof(zend_string*) * (j + 1)) <= 64) ? _emalloc_64() : (((sizeof(zend_string*) * (j + 1)) <= 80) ? _emalloc_80() : (((sizeof(zend_string*) * (j + 1)) <= 96) ? _emalloc_96() : (((sizeof(zend_string*) * (j + 1)) <= 112) ? _emalloc_112() : (((sizeof(zend_string*) * (j + 1)) <= 128) ? _emalloc_128() : (((sizeof(zend_string*) * (j + 1)) <= 160) ? _emalloc_160() : (((sizeof(zend_string*) * (j + 1)) <= 192) ? _emalloc_192() : (((sizeof(zend_string*) * (j + 1)) <= 224) ? _emalloc_224() : (((sizeof(zend_string*) * (j + 1)) <= 256) ? _emalloc_256() : (((sizeof(zend_string*) * (j + 1)) <= 320) ? _emalloc_320() : (((sizeof(zend_string*) * (j + 1)) <= 384) ? _emalloc_384() : (((sizeof(zend_string*) * (j + 1)) <= 448) ? _emalloc_448() : (((sizeof(zend_string*) * (j + 1)) <= 512) ? _emalloc_512() : (((sizeof(zend_string*) * (j + 1)) <= 640) ? _emalloc_640() : (((sizeof(zend_string*) * (j + 1)) <= 768) ? _emalloc_768() : (((sizeof(zend_string*) * (j + 1)) <= 896) ? _emalloc_896() : (((sizeof(zend_string*) * (j + 1)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_string*) * (j + 1)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_string*) * (j + 1)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_string*) * (j + 1)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_string*) * (j + 1)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_string*) * (j + 1)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_string*) * (j + 1)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_string*) * (j + 1)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_string*) * (j + 1))) : _emalloc_huge((sizeof(zend_string*) * (j + 1)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_string*) * (j + 1)) ) );
    j = 0;
    while (trait_precedences[i]->exclude_from_classes[j].class_name) {
...
static void zend_accel_function_hash_copy(HashTable *target, HashTable *source)
{
 ...
 for (; p != end; p++) {
  if (__builtin_expect(!!(zval_get_type(&(p->val)) == 0), 0)) continue;
  do { if (__builtin_expect(!(p->key), 0)) __builtin_unreachable(); } while (0);
  t = zend_hash_find(target, p->key);
  if (__builtin_expect(!!(t != ((void *)0)), 0)) {
   if (__builtin_expect(!!((p->key)->len > 0), 1) && __builtin_expect(!!((p->key)->val[0] == 0), 1)) {

    t = _zend_hash_update(target, p->key, &p->val );
   } else {
    goto failure;
   }
  } else {
   _zend_hash_append_ptr(target, p->key, (p->val).value.ptr);
  }
 }
 target->nInternalPointer = target->nNumOfElements ? 0 : ((uint32_t) -1);
 return;

failure:
 function1 = (p->val).value.ptr;
 function2 = (*(t)).value.ptr;
 ...
 if (function2->type == 2
  ...
  zend_error((1<<0L), "Cannot redeclare %s()", (function1->common.function_name)->val);
 }
}
 ...
 for (; p != end; p++) {
  ...
  if (__builtin_expect(!!(t != ((void *)0)), 0)) {
   if (__builtin_expect(!!((p->key)->len > 0), 1) && __builtin_expect(!!((p->key)->val[0] == 0), 1)) {
    ...
    zend_hash_update_ptr(target, p->key, (void*)(((char*)((p->val).value.ptr)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)));
   } else {
    goto failure;
   }
  } else {
   _zend_hash_append_ptr(target, p->key, (void*)(((char*)((p->val).value.ptr)) + ((char*)(accel_globals.arena_mem) - (char*)(accel_globals.current_persistent_script)->arena_mem)));
  }
 }
 target->nInternalPointer = target->nNumOfElements ? 0 : ((uint32_t) -1);
 return;
 ...
 for (; p != end; p++) {
  ...
  if (__builtin_expect(!!(t != ((void *)0)), 0)) {
   if (__builtin_expect(!!((p->key)->len > 0), 1) && __builtin_expect(!!((p->key)->val[0] == 0), 1)) {
    ...
    continue;
   } else if (__builtin_expect(!!(!(accel_globals.accel_directives).ignore_dups), 0)) {
    goto failure;
   }
  } else {
   t = _zend_hash_append_ptr(target, p->key, (p->val).value.ptr);
   if (pCopyConstructor) {
    pCopyConstructor(&(*(t)).value.ptr);
   }
  }
 }
 target->nInternalPointer = target->nNumOfElements ? 0 : ((uint32_t) -1);
...
failure:
 ...
 (compiler_globals.zend_lineno) = ce1->info.user.line_start;
 zend_error((1<<0L), "Cannot declare %s %s, because the name is already in use", zend_get_object_type(ce1), (ce1->name)->val);
}
...
# 651 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2
...
# 652 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c" 2

static inline __attribute__((always_inline)) void fast_memcpy(void *dest, const void *src, size_t size)
{
 ...
 do {
  __builtin_prefetch ((dqsrc + 4), 0, (_MM_HINT_NTA));
  __builtin_prefetch ((dqdest + 4), 0, (_MM_HINT_T0));
 ...
 *op_array = persistent_script->main_op_array;
 ...
 if (__builtin_expect(!!(from_shared_memory), 1)) {
  ...
  if ((&persistent_script->class_table)->nNumOfElements > 0) {
  ...
  if ((&persistent_script->function_table)->nNumOfElements > 0) {
   zend_accel_function_hash_copy_from_shm((compiler_globals.function_table), &persistent_script->function_table);
  }
  ...
  if (persistent_script->compiler_halt_offset != 0 &&
   ...
   if (!zend_hash_exists((executor_globals.zend_constants), name)) {
    zend_register_long_constant((name)->val, (name)->len, persistent_script->compiler_halt_offset, (1<<0), 0);
   }
   zend_string_release(name);
  }

  zend_hash_destroy(&(accel_globals.bind_hash));
  (accel_globals.current_persistent_script) = ((void *)0);
 } else {
  if ((&persistent_script->function_table)->nNumOfElements > 0) {
   zend_accel_function_hash_copy((compiler_globals.function_table), &persistent_script->function_table);
  }
  if ((&persistent_script->class_table)->nNumOfElements > 0) {
 ...
 if (op_array->early_binding != (uint32_t)-1) {
  zend_string *orig_compiled_filename = (compiler_globals.compiled_filename);
 ...
 if (__builtin_expect(!!(!from_shared_memory), 0)) {
  free_persistent_script(persistent_script, 0);
 }

 return op_array;
}
# 786 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.c"
unsigned int zend_adler32(unsigned int checksum, signed char *buf, uint len)
{
