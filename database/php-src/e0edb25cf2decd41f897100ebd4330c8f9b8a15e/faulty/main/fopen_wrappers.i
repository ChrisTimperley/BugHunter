# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2



# 1 "/usr/include/errno.h" 1 3 4
# 31 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
# 42 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
...
# 43 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
...
# 79 "main/php_network.h" 2
# 100 "main/php_network.h"
typedef int php_socket_t;
# 124 "main/php_network.h"
...
# 125 "main/php_network.h" 2
typedef struct pollfd php_pollfd;
# 156 "main/php_network.h"
...
# 44 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 45 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_network.h" 1
# 46 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
# 64 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
...
# 65 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
# 73 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
...
# 74 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c" 2
...
__attribute__ ((visibility("default"))) int OnUpdateBaseDir(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
  ...
  *p = new_value ? (new_value)->val : ((void *)0);
  return SUCCESS;
 }
 ...
 ptr = pathbuf = _estrdup(((new_value)->val) );
 while (ptr && *ptr) {
  end = strchr(ptr, ':');
  if (end != ((void *)0)) {
   *end = '\0';
...
__attribute__ ((visibility("default"))) int php_check_specific_open_basedir(const char *basedir, const char *path)
{
 ...
 if (strcmp(basedir, ".") || !getcwd(local_open_basedir, 4096)) {
...
# 193 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
...
# 211 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
...
static FILE *php_fopen_and_set_opened_path(const char *path, const char *mode, zend_string **opened_path)
{
 ...
 if (fp && opened_path) {
  ...
  char *tmp = expand_filepath_with_mode(path, ((void *)0), ((void *)0), 0, 0);
  if (tmp) {
...
__attribute__ ((visibility("default"))) int php_fopen_primary_script(zend_file_handle *file_handle)
{
 ...
 if ((core_globals.user_dir) && *(core_globals.user_dir) && path_info && '/' == path_info[0] && '~' == path_info[1]) {
  ...
  if (s) {
   char user[32];
   struct passwd *pw;
# 382 "/home/ct584/git/bughunter/repositories/php-src/main/fopen_wrappers.c"
 ...
 if ((core_globals.doc_root) && path_info && (length = (int)strlen((core_globals.doc_root))) &&
  ((((core_globals.doc_root)[0]) == '/'))) {
  int path_len = (int)strlen(path_info);
  filename = (__builtin_constant_p((length + path_len + 2) ) ? (((length + path_len + 2) <= 8) ? _emalloc_8() : (((length + path_len + 2) <= 16) ? _emalloc_16() : (((length + path_len + 2) <= 24) ? _emalloc_24() : (((length + path_len + 2) <= 32) ? _emalloc_32() : (((length + path_len + 2) <= 40) ? _emalloc_40() : (((length + path_len + 2) <= 48) ? _emalloc_48() : (((length + path_len + 2) <= 56) ? _emalloc_56() : (((length + path_len + 2) <= 64) ? _emalloc_64() : (((length + path_len + 2) <= 80) ? _emalloc_80() : (((length + path_len + 2) <= 96) ? _emalloc_96() : (((length + path_len + 2) <= 112) ? _emalloc_112() : (((length + path_len + 2) <= 128) ? _emalloc_128() : (((length + path_len + 2) <= 160) ? _emalloc_160() : (((length + path_len + 2) <= 192) ? _emalloc_192() : (((length + path_len + 2) <= 224) ? _emalloc_224() : (((length + path_len + 2) <= 256) ? _emalloc_256() : (((length + path_len + 2) <= 320) ? _emalloc_320() : (((length + path_len + 2) <= 384) ? _emalloc_384() : (((length + path_len + 2) <= 448) ? _emalloc_448() : (((length + path_len + 2) <= 512) ? _emalloc_512() : (((length + path_len + 2) <= 640) ? _emalloc_640() : (((length + path_len + 2) <= 768) ? _emalloc_768() : (((length + path_len + 2) <= 896) ? _emalloc_896() : (((length + path_len + 2) <= 1024) ? _emalloc_1024() : (((length + path_len + 2) <= 1280) ? _emalloc_1280() : (((length + path_len + 2) <= 1536) ? _emalloc_1536() : (((length + path_len + 2) <= 1792) ? _emalloc_1792() : (((length + path_len + 2) <= 2048) ? _emalloc_2048() : (((length + path_len + 2) <= 2560) ? _emalloc_2560() : (((length + path_len + 2) <= 3072) ? _emalloc_3072() : (((length + path_len + 2) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((length + path_len + 2)) : _emalloc_huge((length + path_len + 2))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((length + path_len + 2) ) );
  if (filename) {
...
__attribute__ ((visibility("default"))) zend_string *php_resolve_path(const char *filename, int filename_length, const char *path)
{
  ...
  if (is_stream_wrapper) {
   ...
   if (!wrapper) {
    ...
    if (wrapper->wops->url_stat) {
     ...
     if (SUCCESS == wrapper->wops->url_stat(wrapper, trypath, 0, &ssb, ((void *)0))) {
 ...
 if (zend_is_executing() &&
     (exec_filename = zend_get_executed_filename_ex()) != ((void *)0)) {
  const char *exec_fname = (exec_filename)->val;
  size_t exec_fname_length = (exec_filename)->len;

  while ((--exec_fname_length < (18446744073709551615UL)) && !((exec_fname[exec_fname_length]) == '/'));
...
__attribute__ ((visibility("default"))) FILE *php_fopen_with_path(const char *filename, const char *mode, const char *path, zend_string **opened_path)
{
 ...
 if (zend_is_executing() &&
  ...
  if ((exec_fname && exec_fname[0] == '[') || exec_fname_length <= 0) {
   ...
   pathbuf = (char *) (__builtin_constant_p((exec_fname_length + path_length + 1 + 1) ) ? (((exec_fname_length + path_length + 1 + 1) <= 8) ? _emalloc_8() : (((exec_fname_length + path_length + 1 + 1) <= 16) ? _emalloc_16() : (((exec_fname_length + path_length + 1 + 1) <= 24) ? _emalloc_24() : (((exec_fname_length + path_length + 1 + 1) <= 32) ? _emalloc_32() : (((exec_fname_length + path_length + 1 + 1) <= 40) ? _emalloc_40() : (((exec_fname_length + path_length + 1 + 1) <= 48) ? _emalloc_48() : (((exec_fname_length + path_length + 1 + 1) <= 56) ? _emalloc_56() : (((exec_fname_length + path_length + 1 + 1) <= 64) ? _emalloc_64() : (((exec_fname_length + path_length + 1 + 1) <= 80) ? _emalloc_80() : (((exec_fname_length + path_length + 1 + 1) <= 96) ? _emalloc_96() : (((exec_fname_length + path_length + 1 + 1) <= 112) ? _emalloc_112() : (((exec_fname_length + path_length + 1 + 1) <= 128) ? _emalloc_128() : (((exec_fname_length + path_length + 1 + 1) <= 160) ? _emalloc_160() : (((exec_fname_length + path_length + 1 + 1) <= 192) ? _emalloc_192() : (((exec_fname_length + path_length + 1 + 1) <= 224) ? _emalloc_224() : (((exec_fname_length + path_length + 1 + 1) <= 256) ? _emalloc_256() : (((exec_fname_length + path_length + 1 + 1) <= 320) ? _emalloc_320() : (((exec_fname_length + path_length + 1 + 1) <= 384) ? _emalloc_384() : (((exec_fname_length + path_length + 1 + 1) <= 448) ? _emalloc_448() : (((exec_fname_length + path_length + 1 + 1) <= 512) ? _emalloc_512() : (((exec_fname_length + path_length + 1 + 1) <= 640) ? _emalloc_640() : (((exec_fname_length + path_length + 1 + 1) <= 768) ? _emalloc_768() : (((exec_fname_length + path_length + 1 + 1) <= 896) ? _emalloc_896() : (((exec_fname_length + path_length + 1 + 1) <= 1024) ? _emalloc_1024() : (((exec_fname_length + path_length + 1 + 1) <= 1280) ? _emalloc_1280() : (((exec_fname_length + path_length + 1 + 1) <= 1536) ? _emalloc_1536() : (((exec_fname_length + path_length + 1 + 1) <= 1792) ? _emalloc_1792() : (((exec_fname_length + path_length + 1 + 1) <= 2048) ? _emalloc_2048() : (((exec_fname_length + path_length + 1 + 1) <= 2560) ? _emalloc_2560() : (((exec_fname_length + path_length + 1 + 1) <= 3072) ? _emalloc_3072() : (((exec_fname_length + path_length + 1 + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((exec_fname_length + path_length + 1 + 1)) : _emalloc_huge((exec_fname_length + path_length + 1 + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((exec_fname_length + path_length + 1 + 1) ) );
 ...
 if ((((filepath[0]) == '/'))) {
  ...
  if (!result && (iam != filepath)) {
   ...
   if (fdtest != -1) {
    ...
    copy_len = path_len > 4096 - 1 ? 4096 - 1 : path_len;
    if (real_path) {
