# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_generators.c" 2

__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_generator;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_ClosedGeneratorException;
...
static void zend_generator_cleanup_unfinished_execution(zend_generator *generator)
{
 ...
 if (execute_data->opline != execute_data->func->op_array.opcodes) {
  ...
  (executor_globals.vm_stack_top) = generator->stack->top;
  (executor_globals.vm_stack_end) = generator->stack->end;
  (executor_globals.vm_stack) = generator->stack;

  zend_cleanup_unfinished_execution(execute_data, op_num, 0);

  generator->stack = (executor_globals.vm_stack);
  generator->stack->top = (executor_globals.vm_stack_top);
...
__attribute__ ((visibility("default"))) void zend_generator_close(zend_generator *generator, zend_bool finished_execution)
{
 if (__builtin_expect(!!(zval_get_type(&(generator->values)) != 0), 0)) {
  _zval_ptr_dtor((&generator->values) );
  do { (*(&generator->values)).u1.type_info = 0; } while (0);
 }

 if (__builtin_expect(!!(generator->execute_data), 1)) {
  zend_execute_data *execute_data = generator->execute_data;
  ...
  if ((execute_data->This).value.obj) {
   zend_object_release((execute_data->This).value.obj);
  }



  if (__builtin_expect(!!((compiler_globals.unclean_shutdown)), 0)) {
  ...
  if (__builtin_expect(!!(!finished_execution), 0)) {
   zend_generator_cleanup_unfinished_execution(generator);
  }


  if ((((execute_data)->This).u1.type_info >> 24) & (1 << 5)) {
   zend_object_release((zend_object *) ((execute_data)->func)->common.prototype);
  }


  if (generator->gc_buffer) {
   _efree((generator->gc_buffer) );
   generator->gc_buffer = ((void *)0);
  }
...
static void zend_generator_dtor_storage(zend_object *object)
{
 ...
 if (__builtin_expect(!!(!ex), 1) || __builtin_expect(!!(!(ex->func->op_array.fn_flags & 0x20000000)), 1)) {
  return;
 }
 ...
 if (finally_op_num) {
  zval *fast_call = ((zval*)(((char*)(ex)) + ((int)(ex->func->op_array.opcodes[finally_op_end].op1.var))));
...
static void zend_generator_free_storage(zend_object *object)
{
 ...
 if (__builtin_expect(!!(!(zval_get_type(&(generator->retval)) == 0)), 1)) {
  _zval_ptr_dtor((&generator->retval) );
 }

 if (__builtin_expect(!!(generator->node.children > 4), 0)) {
 ...
 if (__builtin_expect(!!(generator->node.children == 0), 1)) {
  zend_generator *root = generator->node.ptr.root, *next;
  while (__builtin_expect(!!(root != generator), 0)) {
   next = zend_generator_get_child(&root->node, generator);
   zend_object_release(&root->std);
   root = next;
  }
 }
}
...
static uint32_t calc_gc_buffer_size(zend_generator *generator)
{
 ...
 if (generator->execute_data) {
  ...
  if ((((execute_data)->This).u1.type_info >> 24) & (1 << 2)) {
   size += (execute_data)->This.u2.num_args - op_array->num_args;
  }
  size += (execute_data->This).value.obj != ((void *)0);
  size += ((((execute_data)->This).u1.type_info >> 24) & (1 << 5)) != 0;
...
{
 zend_generator *generator = (zend_generator*) (*(object)).value.obj;
 zend_execute_data *execute_data = generator->execute_data;
 zend_op_array *op_array;
 zval *gc_buffer;
 uint32_t gc_buffer_size;
 ...
 if (generator->gc_buffer_size < gc_buffer_size) {
  generator->gc_buffer = _safe_erealloc((generator->gc_buffer), (sizeof(zval)), (gc_buffer_size), (0) );
 ...
 *table = gc_buffer = generator->gc_buffer;
 ...
 do { zval *_z1 = (gc_buffer++); const zval *_z2 = (&generator->value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (gc_buffer++); const zval *_z2 = (&generator->key); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (gc_buffer++); const zval *_z2 = (&generator->retval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (gc_buffer++); const zval *_z2 = (&generator->values); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);

 if (!execute_data->symbol_table) {
  uint32_t i, num_cvs = ((execute_data)->func)->op_array.last_var;
  for (i = 0; i < num_cvs; i++) {
   do { zval *_z1 = (gc_buffer++); const zval *_z2 = ((((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(i))))); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  }
 }

 if ((((execute_data)->This).u1.type_info >> 24) & (1 << 2)) {
  zval *zv = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(op_array->last_var + op_array->T))));
  zval *end = zv + ((execute_data)->This.u2.num_args - op_array->num_args);
  while (zv != end) {
   do { zval *_z1 = (gc_buffer++); const zval *_z2 = (zv++); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  }
 }

 if ((execute_data->This).value.obj) {
  do { zval *__z = (gc_buffer++); (*(__z)).value.obj = ((execute_data->This).value.obj); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
 }
 if ((((execute_data)->This).u1.type_info >> 24) & (1 << 5)) {
  do { zval *__z = (gc_buffer++); (*(__z)).value.obj = ((zend_object *) ((execute_data)->func)->common.prototype); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
 }

 if (generator->node.children == 0) {
  zend_generator *root = generator->node.ptr.root;
  while (root != generator) {
   do { zval *__z = (gc_buffer++); (*(__z)).value.obj = (&root->std); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
   root = zend_generator_get_child(&root->node, generator);
  }
 }
...
static zend_object *zend_generator_create(zend_class_entry *class_type)
{
 ...
 generator = (__builtin_constant_p((sizeof(zend_generator)) ) ? (((sizeof(zend_generator)) <= 8) ? _emalloc_8() : (((sizeof(zend_generator)) <= 16) ? _emalloc_16() : (((sizeof(zend_generator)) <= 24) ? _emalloc_24() : (((sizeof(zend_generator)) <= 32) ? _emalloc_32() : (((sizeof(zend_generator)) <= 40) ? _emalloc_40() : (((sizeof(zend_generator)) <= 48) ? _emalloc_48() : (((sizeof(zend_generator)) <= 56) ? _emalloc_56() : (((sizeof(zend_generator)) <= 64) ? _emalloc_64() : (((sizeof(zend_generator)) <= 80) ? _emalloc_80() : (((sizeof(zend_generator)) <= 96) ? _emalloc_96() : (((sizeof(zend_generator)) <= 112) ? _emalloc_112() : (((sizeof(zend_generator)) <= 128) ? _emalloc_128() : (((sizeof(zend_generator)) <= 160) ? _emalloc_160() : (((sizeof(zend_generator)) <= 192) ? _emalloc_192() : (((sizeof(zend_generator)) <= 224) ? _emalloc_224() : (((sizeof(zend_generator)) <= 256) ? _emalloc_256() : (((sizeof(zend_generator)) <= 320) ? _emalloc_320() : (((sizeof(zend_generator)) <= 384) ? _emalloc_384() : (((sizeof(zend_generator)) <= 448) ? _emalloc_448() : (((sizeof(zend_generator)) <= 512) ? _emalloc_512() : (((sizeof(zend_generator)) <= 640) ? _emalloc_640() : (((sizeof(zend_generator)) <= 768) ? _emalloc_768() : (((sizeof(zend_generator)) <= 896) ? _emalloc_896() : (((sizeof(zend_generator)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_generator)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_generator)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_generator)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_generator)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_generator)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_generator)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_generator)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_generator))) : _emalloc_huge((sizeof(zend_generator)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_generator)) ) );
 memset(generator, 0, sizeof(zend_generator));


 generator->largest_used_integer_key = -1;

 do { (*(&generator->retval)).u1.type_info = 0; } while (0);
 do { (*(&generator->values)).u1.type_info = 0; } while (0);
...
__attribute__ ((visibility("default"))) void zend_generator_create_zval(zend_execute_data *call, zend_op_array *op_array, zval *return_value)
{
 ...
 zend_execute_data *execute_data;
 zend_vm_stack current_stack = (executor_globals.vm_stack);

 current_stack->top = (executor_globals.vm_stack_top);
 ...
 if ((call->This).value.obj) {
  zval_addref_p(&(call->This));
 }


 generator = (zend_generator *) (*(return_value)).value.obj;
 generator->execute_data = execute_data;
 generator->stack = (executor_globals.vm_stack);
 generator->stack->top = (executor_globals.vm_stack_top);
 (executor_globals.vm_stack_top) = current_stack->top;
 (executor_globals.vm_stack_end) = current_stack->end;
 (executor_globals.vm_stack) = current_stack;


 execute_data->return_value = (zval*)generator;

 memset(&generator->execute_fake, 0, sizeof(zend_execute_data));
 (generator->execute_fake.This).value.obj = (zend_object *) generator;
}


static __attribute__((cold)) zend_function *zend_generator_get_constructor(zend_object *object)
{
 zend_throw_error(((void *)0), "The \"Generator\" class is reserved for internal use and cannot be manually instantiated");
...
__attribute__ ((visibility("default"))) zend_execute_data *zend_generator_check_placeholder_frame(zend_execute_data *ptr)
{
 if (!ptr->func && (ptr->This).value.obj) {
  if (((ptr->This).value.obj->ce) == zend_ce_generator) {
   zend_generator *generator = (zend_generator *) (ptr->This).value.obj;
...
static zend_generator *zend_generator_get_child(zend_generator_node *node, zend_generator *leaf)
{
 switch (node->children) {
  ...
  case 4:
   if (node->child.array[3].leaf == leaf) { return node->child.array[3].child; }
  case 3:
   if (node->child.array[2].leaf == leaf) { return node->child.array[2].child; }
  case 2:
   if (node->child.array[1].leaf == leaf) { return node->child.array[1].child; }
   if (node->child.array[0].leaf == leaf) { return node->child.array[0].child; }
...
static zend_generator_node *zend_generator_search_multi_children_node(zend_generator_node *node)
{
 ...
 return node->children > 1 ? node : ((void *)0);
}
...
static void zend_generator_add_single_child(zend_generator_node *node, zend_generator *child, zend_generator *leaf)
{
 if (node->children < 4) {
  ...
  _zend_hash_init((&node->child.ht), (5), (((void *)0)), (0) );
  for (i = 0; i < 4; i++) {
...
static void zend_generator_merge_child_nodes(zend_generator_node *dest, zend_generator_node *src, zend_generator *child)
{
 if (src->children <= 4) {
  ...
  zend_ulong leaf;
  do { Bucket *_p = (&src->child.ht)->arData; Bucket *_end = _p + (&src->child.ht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; leaf = _p->h; {
   ...
   if (next->node.children > 1) {
    if (next->node.children > 4) {
     ...
     switch (next->node.children) {
      ...
      case 4:
       if (next->node.child.array[3].leaf == generator) { next->node.child.array[3].leaf = leaf; break; }
      case 3:
       if (next->node.child.array[2].leaf == generator) { next->node.child.array[2].leaf = leaf; break; }
      case 2:
       if (next->node.child.array[1].leaf == generator) { next->node.child.array[1].leaf = leaf; break; }
       if (next->node.child.array[0].leaf == generator) { next->node.child.array[0].leaf = leaf; break; }
       do { if (__builtin_expect(!(0), 0)) __builtin_unreachable(); } while (0);
     }
    }
   }
...
__attribute__ ((visibility("default"))) zend_generator *zend_generator_update_current(zend_generator *generator, zend_generator *leaf)
{
 ...
 while (!root->execute_data && root != generator) {
  zend_object_release(&old_root->std);
  old_root = root;
 ...
 if (root->node.parent) {
  if (root->node.parent->execute_data == ((void *)0)) {
   if (__builtin_expect(!!((executor_globals.exception) == ((void *)0)), 1)) {
    zend_op *yield_from = (zend_op *) root->execute_data->opline - 1;

    if (yield_from->opcode == 142) {
     if ((zval_get_type(&(root->node.parent->retval)) == 0)) {

      zend_execute_data *original_execute_data = (executor_globals.current_execute_data);
      (executor_globals.current_execute_data) = root->execute_data;
      ...
      _zval_ptr_dtor((&root->value) );
      do { zval *_z1 = (&root->value); const zval *_z2 = (&root->node.parent->value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
      do { zval *_z1 = (((zval*)(((char*)(root->execute_data)) + ((int)(yield_from->result.var))))); const zval *_z2 = (&root->node.parent->retval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
     }
    }
   }
...
{
 zval *value;
 if (zval_get_type(&(generator->values)) == 7) {
  HashTable *ht = (generator->values).value.arr;
  HashPosition pos = (generator->values).u2.fe_pos;

  Bucket *p;
  do {
   if (__builtin_expect(!!(pos >= ht->nNumUsed), 0)) {
   ...
   p = &ht->arData[pos];
   value = &p->val;
   if (zval_get_type(&(*(value))) == 15) {
    value = (*(value)).value.zv;
   }
   pos++;
  } while ((zval_get_type(&(*(value))) == 0));

  _zval_ptr_dtor((&generator->value) );
  do { zval *_z1 = (&generator->value); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

  _zval_ptr_dtor((&generator->key) );
  if (p->key) {
   do { zval *__z = (&generator->key); zend_string *__s = (p->key); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
  } else {
   { zval *__z = (&generator->key); (*(__z)).value.lval = p->h; (*(__z)).u1.type_info = 4; };
  }

  (generator->values).u2.fe_pos = pos;
 } else {
  zend_object_iterator *iter = (zend_object_iterator *) (generator->values).value.obj;
  ...
  if (__builtin_expect(!!((executor_globals.exception) != ((void *)0)), 0)) {
   goto exception;
  } else if (__builtin_expect(!!(!value), 0)) {
   goto failure;
  }
  ...
  if (iter->funcs->get_current_key) {
   ...
   if (__builtin_expect(!!((executor_globals.exception) != ((void *)0)), 0)) {
    do { (*(&generator->key)).u1.type_info = 0; } while (0);
    goto exception;
   }
  } else {
   { zval *__z = (&generator->key); (*(__z)).value.lval = iter->index; (*(__z)).u1.type_info = 4; };
  }
 }
 return SUCCESS;
...
__attribute__ ((visibility("default"))) void zend_generator_resume(zend_generator *orig_generator)
{
 zend_generator *generator;


 if (__builtin_expect(!!(!orig_generator->execute_data), 0)) {
  return;
 }
...
try_again:
 if (generator->flags & ZEND_GENERATOR_CURRENTLY_RUNNING) {
  zend_throw_error(((void *)0), "Cannot resume an already running generator");
  return;
 }

 if (__builtin_expect(!!((orig_generator->flags & ZEND_GENERATOR_DO_INIT) != 0 && !(zval_get_type(&(generator->value)) == 0)), 0)) {

  return;
 }

 if (__builtin_expect(!!(!(zval_get_type(&(generator->values)) == 0)), 0)) {
  if (__builtin_expect(!!(zend_generator_get_next_delegated_value(generator) == SUCCESS), 1)) {
   return;
  }
...

 {
  ...
  (executor_globals.current_execute_data) = generator->execute_data;
  (executor_globals.scope) = generator->execute_data->func->common.scope;
  (executor_globals.vm_stack_top) = generator->stack->top;
  (executor_globals.vm_stack_end) = generator->stack->end;
  (executor_globals.vm_stack) = generator->stack;
  ...
  if (__builtin_expect(!!((executor_globals.exception) != ((void *)0)), 0)) {
   if (generator == orig_generator) {
    ...
    generator = zend_generator_get_current(orig_generator);
    zend_generator_throw_exception(generator, ((void *)0));
    goto try_again;
   }
  }


  if (__builtin_expect(!!((generator != orig_generator && !(zval_get_type(&(generator->retval)) == 0)) || (generator->execute_data && (generator->execute_data->opline - 1)->opcode == 142)), 0)) {
   generator = zend_generator_get_current(orig_generator);
   goto try_again;
  }
 }
...
{
 if (__builtin_expect(!!(zval_get_type(&(generator->value)) == 0), 0) && __builtin_expect(!!(generator->execute_data), 1) && __builtin_expect(!!(generator->node.parent == ((void *)0)), 1)) {
...
void zim_Generator_rewind(zend_execute_data *execute_data, zval *return_value)
{
 zend_generator *generator;
 ...
 generator = (zend_generator *) (*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj;
...
void zim_Generator_valid(zend_execute_data *execute_data, zval *return_value)
{
 zend_generator *generator;
 ...
 { do { (*(return_value)).u1.type_info = (__builtin_expect(!!(generator->execute_data != ((void *)0)), 1)) ? 3 : 2; } while (0); return; };
}




void zim_Generator_current(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (__builtin_expect(!!(generator->execute_data != ((void *)0) && zval_get_type(&(root->value)) != 0), 1)) {
...
void zim_Generator_key(zend_execute_data *execute_data, zval *return_value)
{
 zend_generator *generator, *root;
 ...
 root = zend_generator_get_current(generator);
 if (__builtin_expect(!!(generator->execute_data != ((void *)0) && zval_get_type(&(root->key)) != 0), 1)) {
  zval *key = &root->key;

  do { if (__builtin_expect(!!((zval_get_type(&(*(key))) == 10)), 0)) { (key) = &(*(key)).value.ref->val; } } while (0);
  do { zval *_z1 = (return_value); const zval *_z2 = (key); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
}
...
void zim_Generator_next(zend_execute_data *execute_data, zval *return_value)
{
 zend_generator *generator;
...
void zim_Generator_send(zend_execute_data *execute_data, zval *return_value)
{
 zval *value;
 zend_generator *generator, *root;
 ...
 if (__builtin_expect(!!(!generator->execute_data), 0)) {
  return;
 }
 ...
 if (root->send_target) {
  do { zval *_z1 = (root->send_target); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
...
void zim_Generator_throw(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &exception, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &exception, 0); }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 do { zval *_z1 = (&exception_copy); const zval *_z2 = (exception); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
...
void zim_Generator_getReturn(zend_execute_data *execute_data, zval *return_value)
{
 zend_generator *generator;
 ...
 if ((zval_get_type(&(generator->retval)) == 0)) {

  zend_throw_exception(((void *)0),
   "Cannot get return value of a generator that hasn't returned", 0);
  return;
 }

 do { zval *_z1 = (return_value); const zval *_z2 = (&generator->retval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_Generator___wakeup(zend_execute_data *execute_data, zval *return_value)
{
...
{
 zend_generator *generator = (zend_generator*)(iterator->data).value.obj;
 generator->iterator = ((void *)0);
 _zval_ptr_dtor((&iterator->data) );
...
{
 zend_generator *generator = (zend_generator*)(iterator->data).value.obj, *root;
...
static void zend_generator_iterator_get_key(zend_object_iterator *iterator, zval *key)
{
 ...
 if (__builtin_expect(!!(zval_get_type(&(root->key)) != 0), 1)) {
  zval *zv = &root->key;

  do { if (__builtin_expect(!!((zval_get_type(&(*(zv))) == 10)), 0)) { (zv) = &(*(zv)).value.ref->val; } } while (0);
  do { zval *_z1 = (key); const zval *_z2 = (zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 } else {
...
zend_object_iterator *zend_generator_get_iterator(zend_class_entry *ce, zval *object, int by_ref)
{
 ...
 if (__builtin_expect(!!(by_ref), 0) && !(generator->execute_data->func->op_array.fn_flags & 0x4000000)) {
  zend_throw_exception(((void *)0), "You can only iterate a generator by-reference if it declared that it yields by-reference", 0);
  return ((void *)0);
 }

 iterator = generator->iterator = (__builtin_constant_p((sizeof(zend_object_iterator)) ) ? (((sizeof(zend_object_iterator)) <= 8) ? _emalloc_8() : (((sizeof(zend_object_iterator)) <= 16) ? _emalloc_16() : (((sizeof(zend_object_iterator)) <= 24) ? _emalloc_24() : (((sizeof(zend_object_iterator)) <= 32) ? _emalloc_32() : (((sizeof(zend_object_iterator)) <= 40) ? _emalloc_40() : (((sizeof(zend_object_iterator)) <= 48) ? _emalloc_48() : (((sizeof(zend_object_iterator)) <= 56) ? _emalloc_56() : (((sizeof(zend_object_iterator)) <= 64) ? _emalloc_64() : (((sizeof(zend_object_iterator)) <= 80) ? _emalloc_80() : (((sizeof(zend_object_iterator)) <= 96) ? _emalloc_96() : (((sizeof(zend_object_iterator)) <= 112) ? _emalloc_112() : (((sizeof(zend_object_iterator)) <= 128) ? _emalloc_128() : (((sizeof(zend_object_iterator)) <= 160) ? _emalloc_160() : (((sizeof(zend_object_iterator)) <= 192) ? _emalloc_192() : (((sizeof(zend_object_iterator)) <= 224) ? _emalloc_224() : (((sizeof(zend_object_iterator)) <= 256) ? _emalloc_256() : (((sizeof(zend_object_iterator)) <= 320) ? _emalloc_320() : (((sizeof(zend_object_iterator)) <= 384) ? _emalloc_384() : (((sizeof(zend_object_iterator)) <= 448) ? _emalloc_448() : (((sizeof(zend_object_iterator)) <= 512) ? _emalloc_512() : (((sizeof(zend_object_iterator)) <= 640) ? _emalloc_640() : (((sizeof(zend_object_iterator)) <= 768) ? _emalloc_768() : (((sizeof(zend_object_iterator)) <= 896) ? _emalloc_896() : (((sizeof(zend_object_iterator)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_object_iterator)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_object_iterator)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_object_iterator)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_object_iterator)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_object_iterator)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_object_iterator)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_object_iterator)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_object_iterator))) : _emalloc_huge((sizeof(zend_object_iterator)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_object_iterator)) ) );

 zend_iterator_init(iterator);

 iterator->funcs = &zend_generator_iterator_functions;
 do { zval *_z1 = (&iterator->data); const zval *_z2 = (object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

 return iterator;
}


static const zend_internal_arg_info arginfo_generator_void[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_generator_send[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "value", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_generator_throw[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "exception", ((void *)0), 0, 0, 0, 0 },
};

static const zend_function_entry generator_functions[] = {
 { "rewind", zim_Generator_rewind, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_Generator_valid, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_Generator_current, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_Generator_key, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_Generator_next, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "send", zim_Generator_send, arginfo_generator_send, (uint32_t) (sizeof(arginfo_generator_send)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "throw", zim_Generator_throw, arginfo_generator_throw, (uint32_t) (sizeof(arginfo_generator_throw)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getReturn", zim_Generator_getReturn, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__wakeup", zim_Generator___wakeup, arginfo_generator_void, (uint32_t) (sizeof(arginfo_generator_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
...
void zend_register_generator_ce(void)
{
 ...
 { zend_string *cl_name; cl_name = zend_string_init("ClosedGeneratorException", sizeof("ClosedGeneratorException")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = ((void *)0); } };
