# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
# 42 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
...
# 43 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 44 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
...
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
...
# 46 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
...
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_rand.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_rand.h"
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_rand.h" 2
...
# 48 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
...
# 49 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
...
# 50 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.h"
extern zend_module_entry spl_module_entry;
# 55 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/php_spl.h"
...
void zif_spl_classes(zend_execute_data *execute_data, zval *return_value);
void zif_class_parents(zend_execute_data *execute_data, zval *return_value);
void zif_class_implements(zend_execute_data *execute_data, zval *return_value);
void zif_class_uses(zend_execute_data *execute_data, zval *return_value);
...
__attribute__ ((visibility("default"))) zend_string *php_pcre_replace(zend_string *regex, zend_string *subject_str, char *subject, int subject_len, zval *replace_val, int is_callable_replace, int limit, int *replace_count);
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_version.h" 1
# 44 "/home/ct584/git/bughunter/repositories/php-src/ext/pcre/php_pcre.h" 2
...
__attribute__ ((visibility("default"))) zend_string *php_pcre_replace_impl(pcre_cache_entry *pce, zend_string *subject_str, char *subject, int subject_len, zval *return_value,
...
__attribute__ ((visibility("default"))) extern zend_pcre_globals pcre_globals;
...
void zif_iterator_to_array(zend_execute_data *execute_data, zval *return_value);
void zif_iterator_count(zend_execute_data *execute_data, zval *return_value);
void zif_iterator_apply(zend_execute_data *execute_data, zval *return_value);
...
# 51 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c" 2
# 85 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
 ...
 if (f->key == ((void *)0)) {
  if (s->key == ((void *)0)) {
   ...
   if (t == 4) {
    ...
    return (((double)l1 - d) ? ((((double)l1 - d)>0) ? 1 : -1) : 0);
   } else {
    l2 = 0;
   }
  }
  ...
  if (s->key) {
   ...
   if (t == 4) {
    ...
    return ((d - (double)l2) ? (((d - (double)l2)>0) ? 1 : -1) : 0);
   } else {
    l1 = 0;
   }
  }
...
# 371 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
static int php_array_data_compare(const void *a, const void *b)
{
 ...
 if (__builtin_expect(!!(zval_get_type(&(*(first))) == 15), 0)) {
  first = (*(first)).value.zv;
 }
 if (__builtin_expect(!!(zval_get_type(&(*(second))) == 15), 0)) {
 ...
 do { if (__builtin_expect(!(zval_get_type(&(result)) == 4), 0)) __builtin_unreachable(); } while (0);
...
void zif_krsort(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &array, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &sort_type, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } } while (0);


 cmp = php_get_key_compare_func(sort_type, 1);

 if (zend_hash_sort_ex((*(array)).value.arr, zend_sort, cmp, 0) == FAILURE) {
...
__attribute__ ((visibility("default"))) zend_long php_count_recursive(zval *array, zend_long mode)
{
 ...
 if (zval_get_type(&(*(array))) == 7) {
  if ((*(array)).value.arr->u.v.nApplyCount > 1) {
   php_error_docref0(((void *)0), (1<<1L), "recursion detected");
   return 0;
  }

  cnt = zend_array_count((*(array)).value.arr);
  if (mode == 1) {
      if ((((*(array)).value.arr)->u.flags & (1<<1))) {
    (*(array)).value.arr->u.v.nApplyCount++;
   }
   do { Bucket *_p = ((*(array)).value.arr)->arData; Bucket *_end = _p + ((*(array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; element = _z; {
...
void zif_count(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &array, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &array, 0); }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &mode, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
 ...
 switch (zval_get_type(&(*(array)))) {
  ...
  case 7:
   ...
   { { zval *__z = (return_value); (*(__z)).value.lval = cnt; (*(__z)).u1.type_info = 4; }; return; };
   break;
  case 8: {
   zval retval;
   ...
   if (instanceof_function(((*(array)).value.obj->ce), spl_ce_Countable)) {
...
static void php_natsort(zend_execute_data *execute_data, zval *return_value, int fold_case)
{
 zval *array;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a/", &array) == FAILURE) {
  return;
 }

 if (fold_case) {
  if (zend_hash_sort_ex((*(array)).value.arr, zend_sort, php_array_natural_case_compare, 0) == FAILURE) {
   return;
  }
 } else {
  if (zend_hash_sort_ex((*(array)).value.arr, zend_sort, php_array_natural_compare, 0) == FAILURE) {
   return;
  }
 }
...
void zif_natsort(zend_execute_data *execute_data, zval *return_value)
{
 php_natsort(execute_data, return_value, 0);
}
...
void zif_natcasesort(zend_execute_data *execute_data, zval *return_value)
{
 php_natsort(execute_data, return_value, 1);
}
...
void zif_asort(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a/|l", &array, &sort_type) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
...
void zif_sort(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_hash_sort_ex((*(array)).value.arr, zend_sort, cmp, 1) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
}
...
static int php_array_user_compare(const void *a, const void *b)
{
 ...
 do { zval *_z1 = (&args[0]); const zval *_z2 = (&f->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 do { zval *_z1 = (&args[1]); const zval *_z2 = (&s->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 ...
 if (zend_call_function(&(basic_globals.user_compare_fci), &(basic_globals.user_compare_fci_cache)) == SUCCESS && zval_get_type(&(retval)) != 0) {
  zend_long ret = _zval_get_long((&retval));
  _zval_ptr_dtor((&retval) );
...
# 1030 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
static void php_usort(zend_execute_data *execute_data, zval *return_value, compare_func_t compare_func, zend_bool renumber)
{
 zval *array;
 zend_array *arr;
 zend_bool retval;
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "af", &array, &(basic_globals.user_compare_fci), &(basic_globals.user_compare_fci_cache)) == FAILURE) {
 ...
 retval = zend_hash_sort_ex(arr, zend_sort, compare_func, renumber) != FAILURE;

 _zval_ptr_dtor((array) );
 do { zval *__z = (array); (*(__z)).value.arr = (arr); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
...
void zif_usort(zend_execute_data *execute_data, zval *return_value)
{
 php_usort(execute_data, return_value, php_array_user_compare, 1);
}
...
void zif_uasort(zend_execute_data *execute_data, zval *return_value)
{
 php_usort(execute_data, return_value, php_array_user_compare, 0);
}
...
static int php_array_user_key_compare(const void *a, const void *b)
{
 ...
 if (f->key == ((void *)0)) {
  ...
  do { zval *__z = (&args[0]); zend_string *__s = (f->key); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
 }
 if (s->key == ((void *)0)) {
  { zval *__z = (&args[1]); (*(__z)).value.lval = s->h; (*(__z)).u1.type_info = 4; };
 } else {
  do { zval *__z = (&args[1]); zend_string *__s = (s->key); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
 }
...
void zif_uksort(zend_execute_data *execute_data, zval *return_value)
{
 php_usort(execute_data, return_value, php_array_user_key_compare, 0);
}
...
void zif_end(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array_ht(_arg, &array, 0, 1, 1)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 zend_hash_internal_pointer_end_ex(array, &(array)->nInternalPointer);

 if ((!((execute_data)->prev_execute_data) || !((((execute_data)->prev_execute_data)->func->common.type & 1) == 0) || (((execute_data)->prev_execute_data)->opline->result_type != (1<<3)))) {
  ...
  do { zval *_z1 = (return_value); const zval *_z2 = (entry); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
}
...
void zif_current(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array_ht(_arg, &array, 0, 1, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
...
void zif_min(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "+", &args, &argc) == FAILURE) {
  return;
 }
 ...
 if (argc == 1) {
  ...
  if (zval_get_type(&(args[0])) != 7) {
   ...
   if ((result = zend_hash_minmax((args[0]).value.arr, php_array_data_compare, 0)) != ((void *)0)) {
    do { if (__builtin_expect(!!((zval_get_type(&(*(result))) == 10)), 0)) { (result) = &(*(result)).value.ref->val; } } while (0);
    do { zval *_z1 = (return_value); const zval *_z2 = (result); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   } else {
  ...
  do { if (__builtin_expect(!!((zval_get_type(&(*(min))) == 10)), 0)) { (min) = &(*(min)).value.ref->val; } } while (0);
  do { zval *_z1 = (return_value); const zval *_z2 = (min); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
}
...
void zif_max(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (argc == 1) {
  ...
  if (zval_get_type(&(args[0])) != 7) {
   ...
   if ((result = zend_hash_minmax((args[0]).value.arr, php_array_data_compare, 1)) != ((void *)0)) {
    do { if (__builtin_expect(!!((zval_get_type(&(*(result))) == 10)), 0)) { (result) = &(*(result)).value.ref->val; } } while (0);
    do { zval *_z1 = (return_value); const zval *_z2 = (result); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   } else {
    php_error_docref0(((void *)0), (1<<1L), "Array must contain at least one element");
  ...
  do { if (__builtin_expect(!!((zval_get_type(&(*(max))) == 10)), 0)) { (max) = &(*(max)).value.ref->val; } } while (0);
  do { zval *_z1 = (return_value); const zval *_z2 = (max); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
}
...
static int php_array_walk(zval *array, zval *userdata, int recursive)
{
 zval args[3],
   retval,
   *zv;
 HashTable *target_hash = (zval_get_type(&(*(array)))==7 ? (*(array)).value.arr : ((zval_get_type(&(*(array)))==8 ? (*(array)).value.obj->handlers->get_properties((array)) : ((void *)0))));
 HashPosition pos;
 uint32_t ht_iter;
 int result = SUCCESS;
 ...
 if (userdata) {
  do { zval *_z1 = (&args[2]); const zval *_z2 = (userdata); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 }
 ...
 do {
  ...
  (executor_globals.ht_iterators)[ht_iter].pos = pos;

  if (recursive && zval_get_type(&(*(&(*(zv)).value.ref->val))) == 7) {
   HashTable *thash;
   zend_fcall_info orig_array_walk_fci;
   zend_fcall_info_cache orig_array_walk_fci_cache;
   zval ref;
   do { zval *_z1 = (&ref); const zval *_z2 = (zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);

   do { if (__builtin_expect(!!((zval_get_type(&(*(zv))) == 10)), 0)) { (zv) = &(*(zv)).value.ref->val; } } while (0);
   do { zval *_zv = (zv); zend_array *_arr = (*(_zv)).value.arr; if (__builtin_expect(!!((_arr)->gc.refcount > 1), 0)) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { (_arr)->gc.refcount--; } do { zval *__z = (_zv); (*(__z)).value.arr = (zend_array_dup(_arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0); } } while (0);
   thash = (*(zv)).value.arr;
   ...
   if (zval_get_type(&(*(&(ref).value.ref->val))) == 7 && thash == (*(&(ref).value.ref->val)).value.arr) {
   ...
   do { zval *_z1 = (&args[0]); const zval *_z2 = (zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);


   result = zend_call_function(&(basic_globals.array_walk_fci), &(basic_globals.array_walk_fci_cache));
   if (result == SUCCESS) {
    _zval_ptr_dtor((&retval) );
   }
  ...
  } else if (zval_get_type(&(*(array))) == 8) {
   target_hash = ((*(array))).value.obj->handlers->get_properties(&(*(array)));
   pos = zend_hash_iterator_pos(ht_iter, target_hash);
  } else {
   php_error_docref0(((void *)0), (1<<1L), "Iterated value is no longer an array or object");
   result = FAILURE;
   break;
  }
...
void zif_array_walk(zend_execute_data *execute_data, zval *return_value)
{
 ...
 orig_array_walk_fci = (basic_globals.array_walk_fci);
 orig_array_walk_fci_cache = (basic_globals.array_walk_fci_cache);
# 1559 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (3); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &array, 0, 1)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_func(_arg, &(basic_globals.array_walk_fci), &(basic_globals.array_walk_fci_cache), 0, &_error)), 0)) { if (!_error) { _expected_type = Z_EXPECTED_FUNC; error_code = 4; break; } else { error_code = 2; break; } } else if (__builtin_expect(!!(_error != ((void *)0)), 0)) { zend_wrong_callback_error((1<<13L), _i, _error); }
  _optional = 1;
  if (1) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &userdata, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &userdata, 0); }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } (basic_globals.array_walk_fci) = orig_array_walk_fci; (basic_globals.array_walk_fci_cache) = orig_array_walk_fci_cache; return; } } while (0)
...
void zif_array_walk_recursive(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "A/f|z/", &array, &(basic_globals.array_walk_fci), &(basic_globals.array_walk_fci_cache), &userdata) == FAILURE) {
  (basic_globals.array_walk_fci) = orig_array_walk_fci;
  (basic_globals.array_walk_fci_cache) = orig_array_walk_fci_cache;
  return;
 }
...
static inline void php_search_array(zend_execute_data *execute_data, zval *return_value, int behavior)
{
 zval *value,
   *array,
   *entry;
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (3); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &value, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &value, 0); }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &array, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_bool(_arg, &strict, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_BOOL; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 if (strict) {
  do { Bucket *_p = ((*(array)).value.arr)->arData; Bucket *_end = _p + ((*(array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_idx = _p->h; str_idx = _p->key; entry = _z; {
   do { if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10)), 0)) { (entry) = &(*(entry)).value.ref->val; } } while (0);
   if (fast_is_identical_function(value, entry)) {
    if (behavior == 0) {
     ...
     if (str_idx) {
      do { zval *__z = (return_value); zend_string *__s = (str_idx); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
     } else {
...
void zif_in_array(zend_execute_data *execute_data, zval *return_value)
{
 php_search_array(execute_data, return_value, 0);
}
...
void zif_array_search(zend_execute_data *execute_data, zval *return_value)
{
 php_search_array(execute_data, return_value, 1);
}


static inline __attribute__((always_inline)) int php_valid_var_name(char *var_name, size_t var_name_len)
{
 ...
 if (__builtin_expect(!!(!var_name_len), 0)) {
  return 0;
 }
 ...
 if (__builtin_expect(!!(!(charset[ch >> 5] & (1 << (ch & 0x1f)))), 0)) {
 ...
 if (var_name_len > 1) {
  ...
  do {
   ...
   if (__builtin_expect(!!(!(charset[8 + (ch >> 5)] & (1 << (ch & 0x1f)))), 0)) {
# 1763 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
    return 0;
   }
...
__attribute__ ((visibility("default"))) int php_prefix_varname(zval *result, zval *prefix, char *var_name, size_t var_name_len, zend_bool add_underscore)
{
 do { zval *__z = (result); zend_string *__s = (zend_string_alloc(((*(prefix)).value.str)->len + (add_underscore ? 1 : 0) + var_name_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0);
...
void zif_extract(zend_execute_data *execute_data, zval *return_value)
{
 zval *var_array_param, *prefix = ((void *)0);
 zend_long extract_type = 0;
 zval *entry;
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (3); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &var_array_param, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  _optional = 1;
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &extract_type, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  if (1) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &prefix, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &prefix, 0); }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 extract_refs = (extract_type & 0x100);
 if (extract_refs) {
  do { zval *_zv = (var_array_param); if ((((*(_zv)).u1.v.type_flags & (1<<2)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } else if ((zval_get_type(&(*(_zv))) == 10)) { zval_delref_p(_zv); do { zval *_z1 = (_zv); const zval *_z2 = (&(*(_zv)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0); } } } } while (0);
 }
 extract_type &= 0xff;
...
# 1852 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
 do { zval *_z1 = (&var_array); const zval *_z2 = (var_array_param); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

 do { Bucket *_p = ((var_array).value.arr)->arData; Bucket *_end = _p + ((var_array).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; var_name = _p->key; entry = _z; {
  zval final_name;
  ...
  switch (extract_type) {
   ...
   case 0:
    ...
    do { zval *__z = (&final_name); zend_string *__s = (var_name); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
    break;
  ...
  if (zval_get_type(&(final_name)) == 6 && php_valid_var_name(((final_name).value.str)->val, ((final_name).value.str)->len)) {
   zval *orig_var;

   if (((final_name).value.str)->len == sizeof("this")-1 && !strcmp(((final_name).value.str)->val, "this")) {
    if (!exception_thrown) {
     exception_thrown = 1;
     zend_throw_error(((void *)0), "Cannot re-assign $this");
    }
    _zval_ptr_dtor_nogc((&final_name) );
    continue;
   }
   if (extract_refs) {

    do { zval *__zv = (entry); if (!(zval_get_type(&(*(__zv))) == 10)) { do { zend_reference *_ref = (zend_reference *) (__builtin_constant_p((sizeof(zend_reference)) ) ? (((sizeof(zend_reference)) <= 8) ? _emalloc_8() : (((sizeof(zend_reference)) <= 16) ? _emalloc_16() : (((sizeof(zend_reference)) <= 24) ? _emalloc_24() : (((sizeof(zend_reference)) <= 32) ? _emalloc_32() : (((sizeof(zend_reference)) <= 40) ? _emalloc_40() : (((sizeof(zend_reference)) <= 48) ? _emalloc_48() : (((sizeof(zend_reference)) <= 56) ? _emalloc_56() : (((sizeof(zend_reference)) <= 64) ? _emalloc_64() : (((sizeof(zend_reference)) <= 80) ? _emalloc_80() : (((sizeof(zend_reference)) <= 96) ? _emalloc_96() : (((sizeof(zend_reference)) <= 112) ? _emalloc_112() : (((sizeof(zend_reference)) <= 128) ? _emalloc_128() : (((sizeof(zend_reference)) <= 160) ? _emalloc_160() : (((sizeof(zend_reference)) <= 192) ? _emalloc_192() : (((sizeof(zend_reference)) <= 224) ? _emalloc_224() : (((sizeof(zend_reference)) <= 256) ? _emalloc_256() : (((sizeof(zend_reference)) <= 320) ? _emalloc_320() : (((sizeof(zend_reference)) <= 384) ? _emalloc_384() : (((sizeof(zend_reference)) <= 448) ? _emalloc_448() : (((sizeof(zend_reference)) <= 512) ? _emalloc_512() : (((sizeof(zend_reference)) <= 640) ? _emalloc_640() : (((sizeof(zend_reference)) <= 768) ? _emalloc_768() : (((sizeof(zend_reference)) <= 896) ? _emalloc_896() : (((sizeof(zend_reference)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_reference)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_reference)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_reference)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_reference)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_reference)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_reference)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_reference)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_reference))) : _emalloc_huge((sizeof(zend_reference)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_reference)) ) ); (_ref)->gc.refcount = 1; (_ref)->gc.u.type_info = 10; do { zval *_z1 = (&_ref->val); const zval *_z2 = (__zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); (*(__zv)).value.ref = _ref; (*(__zv)).u1.type_info = (10 | (( (1<<2) ) << 8)); } while (0); } } while (0);
    zval_addref_p(entry);

    if ((orig_var = zend_hash_find(symbol_table, (final_name).value.str)) != ((void *)0)) {
     if (zval_get_type(&(*(orig_var))) == 15) {
      orig_var = (*(orig_var)).value.zv;
     }
     _zval_ptr_dtor((orig_var) );
     do { zval *_z1 = (orig_var); const zval *_z2 = (entry); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    } else {
     _zend_hash_update(symbol_table, (final_name).value.str, entry );
    }
   } else {
    do { if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10)), 0)) { (entry) = &(*(entry)).value.ref->val; } } while (0);
    if ((((*(entry)).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(entry);
    if ((orig_var = zend_hash_find(symbol_table, (final_name).value.str)) != ((void *)0)) {
     if (zval_get_type(&(*(orig_var))) == 15) {
      orig_var = (*(orig_var)).value.zv;
     }
     do { if (__builtin_expect(!!((zval_get_type(&(*(orig_var))) == 10)), 0)) { (orig_var) = &(*(orig_var)).value.ref->val; } } while (0);
     _zval_ptr_dtor((orig_var) );
     do { zval *_z1 = (orig_var); const zval *_z2 = (entry); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    } else {
     _zend_hash_update(symbol_table, (final_name).value.str, entry );
...
static void php_compact_var(HashTable *eg_active_symbol_table, zval *return_value, zval *entry)
{
 ...
 if (zval_get_type(&(*(entry))) == 6) {
  if ((value_ptr = zend_hash_find_ind(eg_active_symbol_table, (*(entry)).value.str)) != ((void *)0)) {
   do { if (__builtin_expect(!!((zval_get_type(&(*(value_ptr))) == 10)), 0)) { (value_ptr) = &(*(value_ptr)).value.ref->val; } } while (0);
   do { zval *_z1 = (&data); const zval *_z2 = (value_ptr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   _zend_hash_update((*(return_value)).value.arr, (*(entry)).value.str, &data );
  }
 } else if (zval_get_type(&(*(entry))) == 7) {
  if (((*(entry)).value.arr->u.v.nApplyCount > 1)) {
   php_error_docref0(((void *)0), (1<<1L), "recursion detected");
   return;
  }

     if ((((*(entry)).value.arr)->u.flags & (1<<1))) {
   (*(entry)).value.arr->u.v.nApplyCount++;
  }
  do { Bucket *_p = ((*(entry)).value.arr)->arData; Bucket *_end = _p + ((*(entry)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; value_ptr = _z; {
...
void zif_compact(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "+", &args, &num_args) == FAILURE) {
  return;
 }
 ...
 symbol_table = zend_rebuild_symbol_table();
 if (__builtin_expect(!!(symbol_table == ((void *)0)), 0)) {
  return;
 }
 ...
 if ((execute_data)->This.u2.num_args == 1 && zval_get_type(&(args[0])) == 7) {
  _array_init((return_value), (((args[0]).value.arr)->nNumOfElements) );
 } else {
  _array_init((return_value), ((execute_data)->This.u2.num_args) );
 }

 for (i=0; i<(execute_data)->This.u2.num_args; i++) {
...
void zif_array_fill(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (3); int _max_num_args = (3); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &start_key, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_long(_arg, &num, &_dummy, 0, 0)), 0)) { _expected_type = Z_EXPECTED_LONG; error_code = 4; break; }
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &val, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &val, 0); }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);


 if (__builtin_expect(!!(num > 0), 1)) {
  if (sizeof(num) > 4 && __builtin_expect(!!(__builtin_expect(!!(num > 0x7fffffff), 1)), 0)) {
   php_error_docref0(((void *)0), (1<<1L), "Too many elements");
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  } else if (__builtin_expect(!!(start_key > (9223372036854775807L) - num + 1), 0)) {
   php_error_docref0(((void *)0), (1<<1L), "Cannot add element to the array as the next element is already occupied");
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  } else if (__builtin_expect(!!(start_key >= 0), 1) && __builtin_expect(!!(start_key < num), 1)) {

   Bucket *p;
   zend_long n;

   _array_init((return_value), ((uint32_t)(start_key + num)) );
   zend_hash_real_init((*(return_value)).value.arr, 1);
   (*(return_value)).value.arr->nNumUsed = start_key + num;
   (*(return_value)).value.arr->nNumOfElements = num;
   (*(return_value)).value.arr->nInternalPointer = start_key;
   (*(return_value)).value.arr->nNextFreeElement = start_key + num;

   if ((((*(val)).u1.v.type_flags & (1<<2)) != 0)) {
    ((*(val)).value.counted)->gc.refcount += num;
   }
   ...
   while (start_key--) {
    do { (*(&p->val)).u1.type_info = 0; } while (0);
    p++;
   }
   while (num--) {
    do { zval *_z1 = (&p->val); const zval *_z2 = (val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
    p->h = n++;
    p->key = ((void *)0);
    p++;
   }
   ...
   _array_init((return_value), ((uint32_t)num) );
   zend_hash_real_init((*(return_value)).value.arr, 0);
   if ((((*(val)).u1.v.type_flags & (1<<2)) != 0)) {
    ((*(val)).value.counted)->gc.refcount += num;
   }
   _zend_hash_index_add_new((*(return_value)).value.arr, start_key, val );
   while (--num) {
    _zend_hash_next_index_insert_new((*(return_value)).value.arr, val );
    start_key++;
   }
  }
 } else if (__builtin_expect(!!(num == 0), 1)) {
...
void zif_array_fill_keys(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "az", &keys, &val) == FAILURE) {
  return;
 }


 _array_init((return_value), (((*(keys)).value.arr)->nNumOfElements) );

 do { Bucket *_p = ((*(keys)).value.arr)->arData; Bucket *_end = _p + ((*(keys)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
  do { if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10)), 0)) { (entry) = &(*(entry)).value.ref->val; } } while (0);
  do { if ((((*((val))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((val)); } } while (0);
  if (zval_get_type(&(*(entry))) == 4) {
   _zend_hash_index_update((*(return_value)).value.arr, (*(entry)).value.lval, val );
  } else {
   zend_string *key = _zval_get_string((entry));
   zend_symtable_update((*(return_value)).value.arr, key, val);
   zend_string_release(key);
  }
 } } } while (0);
}
# 2162 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/array.c"
void zif_range(zend_execute_data *execute_data, zval *return_value)
{
 zval *zlow, *zhigh, *zstep = ((void *)0), tmp;
 int err = 0, is_step_double = 0;
 double step = 1.0;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "zz|z", &zlow, &zhigh, &zstep) == FAILURE) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 ...
 if (zval_get_type(&(*(zlow))) == 6 && zval_get_type(&(*(zhigh))) == 6 && ((*(zlow)).value.str)->len >= 1 && ((*(zhigh)).value.str)->len >= 1) {
  ...
  low = (unsigned char)((*(zlow)).value.str)->val[0];
  high = (unsigned char)((*(zhigh)).value.str)->val[0];
  ...
  if (low > high) {
   ...
   _array_init((return_value), ((uint32_t)(((low - high) / lstep) + 1)) );
   zend_hash_real_init((*(return_value)).value.arr, 1);
   do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
    for (; low >= high; low -= (unsigned int)lstep) {
     if ((compiler_globals.one_char_string)[low]) {
      do { zval *__z = (&tmp); zend_string *__s = ((compiler_globals.one_char_string)[low]); (*(__z)).value.str = __s; (*(__z)).u1.type_info = 6; } while (0);
     } else {
      do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init((char*)&low, 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
     }
     do { do { zval *_z1 = (&__fill_bkt->val); const zval *_z2 = (&tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); __fill_bkt->h = (__fill_idx); __fill_bkt->key = ((void *)0); __fill_bkt++; __fill_idx++; } while (0);
   ...
   _array_init((return_value), ((uint32_t)(((high - low) / lstep) + 1)) );
   zend_hash_real_init((*(return_value)).value.arr, 1);
   do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
    for (; low <= high; low += (unsigned int)lstep) {
     if ((compiler_globals.one_char_string)[low]) {
...
double_str:
  ...
  if ((sizeof (high) == sizeof (float) ? __isinff (high) : sizeof (high) == sizeof (double) ? __isinf (high) : __isinfl (high)) || (sizeof (low) == sizeof (float) ? __isinff (low) : sizeof (low) == sizeof (double) ? __isinf (low) : __isinfl (low))) {
   php_error_docref0(((void *)0), (1<<1L), "Invalid range supplied: start=%0.0f end=%0.0f", low, high);
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
  ...
  if (low > high) {
   ...
   do { double __calc_size = ((low - high) / step) + 1; if (__calc_size >= (double)0x80000000) { php_error_docref0(((void *)0), (1<<1L), "The supplied range exceeds the maximum array size: start=%0.0f end=%0.0f", high, low); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } size = (uint32_t)round(__calc_size); _array_init((return_value), (size) ); zend_hash_real_init((*(return_value)).value.arr, 1); } while (0);

   do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
    for (i = 0, element = low; i < size && element >= high; ++i, element = low - (i * step)) {
     (tmp).value.dval = element;
     do { do { zval *_z1 = (&__fill_bkt->val); const zval *_z2 = (&tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); __fill_bkt->h = (__fill_idx); __fill_bkt->key = ((void *)0); __fill_bkt++; __fill_idx++; } while (0);
    }
   } __fill_ht->nNumUsed = __fill_idx; __fill_ht->nNumOfElements = __fill_idx; __fill_ht->nNextFreeElement = __fill_idx; __fill_ht->nInternalPointer = __fill_idx ? 0 : ((uint32_t) -1); } while (0);
  } else if (high > low) {
   ...
   do { double __calc_size = ((high - low) / step) + 1; if (__calc_size >= (double)0x80000000) { php_error_docref0(((void *)0), (1<<1L), "The supplied range exceeds the maximum array size: start=%0.0f end=%0.0f", low, high); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } size = (uint32_t)round(__calc_size); _array_init((return_value), (size) ); zend_hash_real_init((*(return_value)).value.arr, 1); } while (0);
  ...
  uint32_t i, size;
long_str:
  low = _zval_get_long((zlow));
  high = _zval_get_long((zhigh));
  ...
  if (low > high) {
   ...
   do { zend_ulong __calc_size = (low - high) / lstep; if (__calc_size >= 0x80000000 - 1) { php_error_docref0(((void *)0), (1<<1L), "The supplied range exceeds the maximum array size: start=" "%" "l" "d" " end=" "%" "l" "d", high, low); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } size = (uint32_t)(__calc_size + 1); _array_init((return_value), (size) ); zend_hash_real_init((*(return_value)).value.arr, 1); } while (0);

   do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
    for (i = 0; i < size; ++i) {
     (tmp).value.lval = low - (i * lstep);
     do { do { zval *_z1 = (&__fill_bkt->val); const zval *_z2 = (&tmp); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); __fill_bkt->h = (__fill_idx); __fill_bkt->key = ((void *)0); __fill_bkt++; __fill_idx++; } while (0);
    }
   } __fill_ht->nNumUsed = __fill_idx; __fill_ht->nNumOfElements = __fill_idx; __fill_ht->nNextFreeElement = __fill_idx; __fill_ht->nInternalPointer = __fill_idx ? 0 : ((uint32_t) -1); } while (0);
  } else if (high > low) {
   ...
   do { zend_ulong __calc_size = (high - low) / lstep; if (__calc_size >= 0x80000000 - 1) { php_error_docref0(((void *)0), (1<<1L), "The supplied range exceeds the maximum array size: start=" "%" "l" "d" " end=" "%" "l" "d", low, high); { do { (*(return_value)).u1.type_info = 2; } while (0); return; }; } size = (uint32_t)(__calc_size + 1); _array_init((return_value), (size) ); zend_hash_real_init((*(return_value)).value.arr, 1); } while (0);
...
static void php_array_data_shuffle(zval *array)
{
 ...
 if (__builtin_expect(!!(hash->u.v.nIteratorsCount == 0), 1)) {
...
static void php_splice(HashTable *in_hash, zend_long offset, zend_long length, HashTable *replace, HashTable *removed)
{
 ...
 _zend_hash_init((&out_hash), ((length > 0 ? num_in - length : 0) + (replace ? (replace)->nNumOfElements : 0)), (_zval_ptr_dtor), (0) );
 ...
 for (pos = 0, idx = 0; pos < offset && idx < in_hash->nNumUsed; idx++) {
  ...
  if (p->key == ((void *)0)) {
   _zend_hash_next_index_insert_new(&out_hash, entry );
  } else {
   _zend_hash_add_new(&out_hash, p->key, entry );
  }
  if (idx == iter_pos) {
 ...
 if (removed != ((void *)0)) {
  for ( ; pos < offset + length && idx < in_hash->nNumUsed; idx++) {
   ...
   pos++;
   entry = &p->val;
   if ((((*(entry)).u1.v.type_flags & (1<<2)) != 0)) {
    zval_addref_p(entry);
   }
   if (p->key == ((void *)0)) {
    _zend_hash_next_index_insert_new(removed, entry );
    zend_hash_index_del(in_hash, p->h);
   } else {
    _zend_hash_add_new(removed, p->key, entry );
    if (in_hash == &(executor_globals.symbol_table)) {
 ...
 if (replace) {
  do { Bucket *_p = (replace)->arData; Bucket *_end = _p + (replace)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
   if ((((*(entry)).u1.v.type_flags & (1<<2)) != 0)) zval_addref_p(entry);
   _zend_hash_next_index_insert_new(&out_hash, entry );
   pos++;
  } } } while (0);
 ...
 zend_hash_internal_pointer_reset_ex(in_hash, &(in_hash)->nInternalPointer);
}
...
void zif_array_push(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a/+", &stack, &args, &argc) == FAILURE) {
  return;
 }


 for (i = 0; i < argc; i++) {
  do { zval *_z1 = (&new_var); const zval *_z2 = (&args[i]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

  if (_zend_hash_next_index_insert((*(stack)).value.arr, &new_var ) == ((void *)0)) {
   if ((((new_var).u1.v.type_flags & (1<<2)) != 0)) zval_delref_p(&(new_var));
   php_error_docref0(((void *)0), (1<<1L), "Cannot add element to the array as the next element is already occupied");
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  }
 }
 ...
 { zval *__z = (return_value); (*(__z)).value.lval = ((*(stack)).value.arr)->nNumOfElements; (*(__z)).u1.type_info = 4; };
}
...
void zif_array_pop(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (1) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &stack, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 do { if (__builtin_expect(!!((zval_get_type(&(*(val))) == 10)), 0)) { (val) = &(*(val)).value.ref->val; } } while (0);
 do { zval *_z1 = (return_value); const zval *_z2 = (val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

 if (!p->key && (*(stack)).value.arr->nNextFreeElement > 0 && p->h >= (zend_ulong)((*(stack)).value.arr->nNextFreeElement - 1)) {
  (*(stack)).value.arr->nNextFreeElement = (*(stack)).value.arr->nNextFreeElement - 1;
 }


 if (p->key) {
  if ((*(stack)).value.arr == &(executor_globals.symbol_table)) {
   zend_delete_global_variable(p->key);
  } else {
   zend_hash_del((*(stack)).value.arr, p->key);
  }
 } else {
  zend_hash_index_del((*(stack)).value.arr, p->h);
 }

 zend_hash_internal_pointer_reset_ex((*(stack)).value.arr, &((*(stack)).value.arr)->nInternalPointer);
}
...
void zif_array_shift(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((*(stack)).value.arr->u.flags & (1<<2)) {
  uint32_t k = 0;

  if (__builtin_expect(!!((*(stack)).value.arr->u.v.nIteratorsCount == 0), 1)) {
   for (idx = 0; idx < (*(stack)).value.arr->nNumUsed; idx++) {
    p = (*(stack)).value.arr->arData + idx;
    if (zval_get_type(&(p->val)) == 0) continue;
    if (idx != k) {
     Bucket *q = (*(stack)).value.arr->arData + k;
     q->h = k;
     q->key = ((void *)0);
     do { zval *_z1 = (&q->val); const zval *_z2 = (&p->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
     do { (*(&p->val)).u1.type_info = 0; } while (0);
    }
    k++;
   }
  } else {
   uint32_t iter_pos = zend_hash_iterators_lower_pos((*(stack)).value.arr, 0);
   ...
   for (idx = 0; idx < (*(stack)).value.arr->nNumUsed; idx++) {
    ...
    if (idx != k) {
     ...
     do { (*(&p->val)).u1.type_info = 0; } while (0);
     if (idx == iter_pos) {
      zend_hash_iterators_update((*(stack)).value.arr, idx, k);
      iter_pos = zend_hash_iterators_lower_pos((*(stack)).value.arr, iter_pos + 1);
     }
    }
    k++;
   }
  ...
  (*(stack)).value.arr->nNextFreeElement = k;
  if (should_rehash) {
   zend_hash_rehash((*(stack)).value.arr);
  }
 }
...
void zif_array_unshift(zend_execute_data *execute_data, zval *return_value)
{
 ...
 _zend_hash_init((&new_hash), (((*(stack)).value.arr)->nNumOfElements + argc), (_zval_ptr_dtor), (0) );
 for (i = 0; i < argc; i++) {
  if ((((args[i]).u1.v.type_flags & (1<<2)) != 0)) {
   zval_addref_p(&(args[i]));
  }
  _zend_hash_next_index_insert_new(&new_hash, &args[i] );
 }
 if (__builtin_expect(!!((*(stack)).value.arr->u.v.nIteratorsCount == 0), 1)) {
  do { Bucket *_p = ((*(stack)).value.arr)->arData; Bucket *_end = _p + ((*(stack)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; value = _z; {
   if (key) {
    _zend_hash_add_new(&new_hash, key, value );
   } else {
    _zend_hash_next_index_insert_new(&new_hash, value );
   }
  } } } while (0);
 } else {
  uint32_t old_idx;
  ...
  do { Bucket *_p = ((*(stack)).value.arr)->arData; Bucket *_end = _p + ((*(stack)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; value = _z; {
   ...
   old_idx = (Bucket*)value - (*(stack)).value.arr->arData;
   if (old_idx == iter_pos) {
    zend_hash_iterators_update((*(stack)).value.arr, old_idx, new_idx);
    iter_pos = zend_hash_iterators_lower_pos((*(stack)).value.arr, iter_pos + 1);
   }
   new_idx++;
  } } } while (0);
 ...
 (*(stack)).value.arr->pDestructor = ((void *)0);
 zend_hash_destroy((*(stack)).value.arr);

 (*(stack)).value.arr->u.v.flags = new_hash.u.v.flags;
...
void zif_array_splice(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a/l|lz/", &array, &offset, &length, &repl_array) == FAILURE) {
  return;
 }
 ...
 if ((execute_data)->This.u2.num_args == 4) {
  ...
  if (zval_get_type(&(*(repl_array)))!=7) { convert_to_array(repl_array); };
 }
 ...
 if ((!((execute_data)->prev_execute_data) || !((((execute_data)->prev_execute_data)->func->common.type & 1) == 0) || (((execute_data)->prev_execute_data)->opline->result_type != (1<<3)))) {
  ...
  _array_init((return_value), (size > 0 ? (uint32_t)size : 0) );
  rem_hash = (*(return_value)).value.arr;
 }


 php_splice((*(array)).value.arr, offset, length, repl_array ? (*(repl_array)).value.arr : ((void *)0), rem_hash);
}
...
void zif_array_slice(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (4); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &input, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  ...
  _optional = 1;
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &z_length, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &z_length, 0); }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_bool(_arg, &preserve_keys, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_BOOL; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 if ((execute_data)->This.u2.num_args < 3 || zval_get_type(&(*(z_length))) == 1) {
  length = num_in;
 } else {
 ...
 _array_init((return_value), ((uint32_t)length) );


 pos = 0;
 if (((*(input)).value.arr->u.flags & (1<<2)) && !preserve_keys) {
  zend_hash_real_init((*(return_value)).value.arr, 1);
  do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
   do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
    pos++;
    if (pos <= offset) {
     continue;
    }
    ...
    do { do { zval *_z1 = (&__fill_bkt->val); const zval *_z2 = (entry); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); __fill_bkt->h = (__fill_idx); __fill_bkt->key = ((void *)0); __fill_bkt++; __fill_idx++; } while (0);
    do { if ((((*((entry))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((entry)); } } while (0);
   } } } while (0);
  } __fill_ht->nNumUsed = __fill_idx; __fill_ht->nNumOfElements = __fill_idx; __fill_ht->nNextFreeElement = __fill_idx; __fill_ht->nInternalPointer = __fill_idx ? 0 : ((uint32_t) -1); } while (0);
 } else {
  do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; entry = _z; {
   pos++;
   if (pos <= offset) {
    continue;
   }
   ...
   if (string_key) {
    entry = _zend_hash_add_new((*(return_value)).value.arr, string_key, entry );
   } else {
    if (preserve_keys) {
     entry = _zend_hash_index_add_new((*(return_value)).value.arr, num_key, entry );
    } else {
     entry = _zend_hash_next_index_insert_new((*(return_value)).value.arr, entry );
    }
   }
   do { if ((((*((entry))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((entry)); } } while (0);
  } } } while (0);
...
__attribute__ ((visibility("default"))) int php_array_merge_recursive(HashTable *dest, HashTable *src)
{
 ...
 do { Bucket *_p = (src)->arData; Bucket *_end = _p + (src)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; string_key = _p->key; src_entry = _z; {
  if (string_key) {
   if ((dest_entry = zend_hash_find(dest, string_key)) != ((void *)0)) {
    ...
    thash = zval_get_type(&(*(dest_zval))) == 7 ? (*(dest_zval)).value.arr : ((void *)0);
    ...
    if ((zval_get_type(&(*(dest_entry))) == 10)) {
     if (zval_refcount_p(dest_entry) == 1) {
      do { zval *_z = (dest_entry); zend_reference *ref; do { if (__builtin_expect(!((zval_get_type(&(*(_z))) == 10)), 0)) __builtin_unreachable(); } while (0); ref = (*(_z)).value.ref; do { zval *_z1 = (_z); const zval *_z2 = (&ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); do { if (__builtin_constant_p(sizeof(zend_reference))) { if (sizeof(zend_reference) <= 8) { _efree_8(ref); } else if (sizeof(zend_reference) <= 16) { _efree_16(ref); } else if (sizeof(zend_reference) <= 24) { _efree_24(ref); } else if (sizeof(zend_reference) <= 32) { _efree_32(ref); } else if (sizeof(zend_reference) <= 40) { _efree_40(ref); } else if (sizeof(zend_reference) <= 48) { _efree_48(ref); } else if (sizeof(zend_reference) <= 56) { _efree_56(ref); } else if (sizeof(zend_reference) <= 64) { _efree_64(ref); } else if (sizeof(zend_reference) <= 80) { _efree_80(ref); } else if (sizeof(zend_reference) <= 96) { _efree_96(ref); } else if (sizeof(zend_reference) <= 112) { _efree_112(ref); } else if (sizeof(zend_reference) <= 128) { _efree_128(ref); } else if (sizeof(zend_reference) <= 160) { _efree_160(ref); } else if (sizeof(zend_reference) <= 192) { _efree_192(ref); } else if (sizeof(zend_reference) <= 224) { _efree_224(ref); } else if (sizeof(zend_reference) <= 256) { _efree_256(ref); } else if (sizeof(zend_reference) <= 320) { _efree_320(ref); } else if (sizeof(zend_reference) <= 384) { _efree_384(ref); } else if (sizeof(zend_reference) <= 448) { _efree_448(ref); } else if (sizeof(zend_reference) <= 512) { _efree_512(ref); } else if (sizeof(zend_reference) <= 640) { _efree_640(ref); } else if (sizeof(zend_reference) <= 768) { _efree_768(ref); } else if (sizeof(zend_reference) <= 896) { _efree_896(ref); } else if (sizeof(zend_reference) <= 1024) { _efree_1024(ref); } else if (sizeof(zend_reference) <= 1280) { _efree_1280(ref); } else if (sizeof(zend_reference) <= 1536) { _efree_1536(ref); } else if (sizeof(zend_reference) <= 1792) { _efree_1792(ref); } else if (sizeof(zend_reference) <= 2048) { _efree_2048(ref); } else if (sizeof(zend_reference) <= 2560) { _efree_2560(ref); } else if (sizeof(zend_reference) <= 3072) { _efree_3072(ref); } else if (sizeof(zend_reference) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(ref, sizeof(zend_reference)); } else { _efree_huge(ref, sizeof(zend_reference)); } } else { _efree(ref); } } while (0); } while (0);
     } else {
      zval_delref_p(dest_entry);
      do { zval *_z1 = (dest_entry); const zval *_z2 = (dest_zval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
     }
     dest_zval = dest_entry;
    } else {
     do { zval *_zv = (dest_zval); if ((((*(_zv)).u1.v.type_flags & (1<<2)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } else if ((zval_get_type(&(*(_zv))) == 10)) { zval_delref_p(_zv); do { zval *_z1 = (_zv); const zval *_z2 = (&(*(_zv)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0); } } } } while (0);
    }
    if (zval_get_type(&(*(dest_zval))) == 1) {
     if (zval_get_type(&(*(dest_zval)))!=7) { convert_to_array(dest_zval); };
     add_next_index_null(dest_zval);
    } else if (zval_get_type(&(*(dest_zval))) == 7) {
     if (__builtin_expect(!!((*(dest_zval)).value.arr->nNextFreeElement > (zend_long)(*(dest_zval)).value.arr->nNumUsed), 0)) {
      (*(dest_zval)).value.arr->nNextFreeElement = (*(dest_zval)).value.arr->nNumUsed;
     }
    } else {
     if (zval_get_type(&(*(dest_zval)))!=7) { convert_to_array(dest_zval); };
    }
    ...
    if (zval_get_type(&(*(src_zval))) == 8) {
     do { zval *_z1 = (&tmp); const zval *_z2 = (src_zval); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
     convert_to_array(&tmp);
     src_zval = &tmp;
    }
    if (zval_get_type(&(*(src_zval))) == 7) {
     if (thash && ((thash)->u.flags & (1<<1))) {
      thash->u.v.nApplyCount++;
     }
     ret = php_array_merge_recursive((*(dest_zval)).value.arr, (*(src_zval)).value.arr);
     if (thash && ((thash)->u.flags & (1<<1))) {
      thash->u.v.nApplyCount--;
     }
     if (!ret) {
     ...
     _zend_hash_next_index_insert((*(dest_zval)).value.arr, src_zval );
    }
    _zval_ptr_dtor((&tmp) );
   } else {
    zval *zv = _zend_hash_add_new(dest, string_key, src_entry );
    zval_add_ref(zv);
   }
  } else {
   zval *zv = _zend_hash_next_index_insert_new(dest, src_entry );
   zval_add_ref(zv);
  }
 } } } while (0);
 return 1;
...
__attribute__ ((visibility("default"))) int php_array_merge(HashTable *dest, HashTable *src)
{
 ...
 do { Bucket *_p = (src)->arData; Bucket *_end = _p + (src)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; string_key = _p->key; src_entry = _z; {
  if ((((*(src_entry)).u1.v.type_flags & (1<<2)) != 0)) {
   if (__builtin_expect(!!((zval_get_type(&(*(src_entry))) == 10)), 0)
    && __builtin_expect(!!(zval_refcount_p(src_entry) == 1), 0)) {
    do { zval *_z = (src_entry); zend_reference *ref; do { if (__builtin_expect(!((zval_get_type(&(*(_z))) == 10)), 0)) __builtin_unreachable(); } while (0); ref = (*(_z)).value.ref; do { zval *_z1 = (_z); const zval *_z2 = (&ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); do { if (__builtin_constant_p(sizeof(zend_reference))) { if (sizeof(zend_reference) <= 8) { _efree_8(ref); } else if (sizeof(zend_reference) <= 16) { _efree_16(ref); } else if (sizeof(zend_reference) <= 24) { _efree_24(ref); } else if (sizeof(zend_reference) <= 32) { _efree_32(ref); } else if (sizeof(zend_reference) <= 40) { _efree_40(ref); } else if (sizeof(zend_reference) <= 48) { _efree_48(ref); } else if (sizeof(zend_reference) <= 56) { _efree_56(ref); } else if (sizeof(zend_reference) <= 64) { _efree_64(ref); } else if (sizeof(zend_reference) <= 80) { _efree_80(ref); } else if (sizeof(zend_reference) <= 96) { _efree_96(ref); } else if (sizeof(zend_reference) <= 112) { _efree_112(ref); } else if (sizeof(zend_reference) <= 128) { _efree_128(ref); } else if (sizeof(zend_reference) <= 160) { _efree_160(ref); } else if (sizeof(zend_reference) <= 192) { _efree_192(ref); } else if (sizeof(zend_reference) <= 224) { _efree_224(ref); } else if (sizeof(zend_reference) <= 256) { _efree_256(ref); } else if (sizeof(zend_reference) <= 320) { _efree_320(ref); } else if (sizeof(zend_reference) <= 384) { _efree_384(ref); } else if (sizeof(zend_reference) <= 448) { _efree_448(ref); } else if (sizeof(zend_reference) <= 512) { _efree_512(ref); } else if (sizeof(zend_reference) <= 640) { _efree_640(ref); } else if (sizeof(zend_reference) <= 768) { _efree_768(ref); } else if (sizeof(zend_reference) <= 896) { _efree_896(ref); } else if (sizeof(zend_reference) <= 1024) { _efree_1024(ref); } else if (sizeof(zend_reference) <= 1280) { _efree_1280(ref); } else if (sizeof(zend_reference) <= 1536) { _efree_1536(ref); } else if (sizeof(zend_reference) <= 1792) { _efree_1792(ref); } else if (sizeof(zend_reference) <= 2048) { _efree_2048(ref); } else if (sizeof(zend_reference) <= 2560) { _efree_2560(ref); } else if (sizeof(zend_reference) <= 3072) { _efree_3072(ref); } else if (sizeof(zend_reference) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(ref, sizeof(zend_reference)); } else { _efree_huge(ref, sizeof(zend_reference)); } } else { _efree(ref); } } while (0); } while (0);
    if ((((*(src_entry)).u1.v.type_flags & (1<<2)) != 0)) {
     zval_addref_p(src_entry);
    }
   } else {
  ...
  if (string_key) {
   ...
   _zend_hash_next_index_insert_new(dest, src_entry );
  }
 } } } while (0);
 return 1;
}
 ...
 do { Bucket *_p = (src)->arData; Bucket *_end = _p + (src)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; src_entry = _z; {
  ...
  if (string_key) {
   if (zval_get_type(&(*(src_zval))) != 7 ||
    ...
    zval *zv = _zend_hash_update(dest, string_key, src_entry );
    zval_add_ref(zv);
    continue;
   }
  } else {
   if (zval_get_type(&(*(src_zval))) != 7 ||
    ...
    zval *zv = _zend_hash_index_update(dest, num_key, src_entry );
    zval_add_ref(zv);
    continue;
   }
  }
  ...
  dest_zval = dest_entry;
  do { if (__builtin_expect(!!((zval_get_type(&(*(dest_zval))) == 10)), 0)) { (dest_zval) = &(*(dest_zval)).value.ref->val; } } while (0);
  if ((*(dest_zval)).value.arr->u.v.nApplyCount > 1 ||
      (*(src_zval)).value.arr->u.v.nApplyCount > 1 ||
  ...
  if ((((*(dest_zval)).value.arr)->u.flags & (1<<1))) {
   (*(dest_zval)).value.arr->u.v.nApplyCount++;
  }
  if ((((*(src_zval)).value.arr)->u.flags & (1<<1))) {
   (*(src_zval)).value.arr->u.v.nApplyCount++;
  }

  ret = php_array_replace_recursive((*(dest_zval)).value.arr, (*(src_zval)).value.arr);
...
static inline void php_array_merge_or_replace_wrapper(zend_execute_data *execute_data, zval *return_value, int recursive, int replace)
{
 zval *args = ((void *)0);
 zval *arg;
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (-1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  do { int _num_varargs = _num_args - _i - (0); if (__builtin_expect(!!(_num_varargs > 0), 1)) { args = _real_arg + 1; argc = _num_varargs; _i += _num_varargs; _real_arg += _num_varargs; } else { args = ((void *)0); argc = 0; } } while (0);
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 for (i = 0; i < argc; i++) {
  ...
  if (zval_get_type(&(*(arg))) != 7) {
   ...
   int num = ((*(arg)).value.arr)->nNumOfElements;
 ...
 if (replace) {
  ...
  do { Bucket *_p = (src)->arData; Bucket *_end = _p + (src)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; idx = _p->h; string_key = _p->key; src_entry = _z; {
   if ((((*(src_entry)).u1.v.type_flags & (1<<2)) != 0)) {
    if (__builtin_expect(!!((zval_get_type(&(*(src_entry))) == 10) && zval_refcount_p(src_entry) == 1), 0)) {
   ...
   if (string_key) {
    _zend_hash_add_new(dest, string_key, src_entry );
   } else {
    _zend_hash_index_add_new(dest, idx, src_entry );
   }
  } } } while (0);
  ...
  if (recursive) {
   for (i = 1; i < argc; i++) {
    arg = args + i;
    do { if (__builtin_expect(!!((zval_get_type(&(*(arg))) == 10)), 0)) { (arg) = &(*(arg)).value.ref->val; } } while (0);
    php_array_replace_recursive((*(return_value)).value.arr, (*(arg)).value.arr);
   }
  } else {
   for (i = 1; i < argc; i++) {
    arg = args + i;
    do { if (__builtin_expect(!!((zval_get_type(&(*(arg))) == 10)), 0)) { (arg) = &(*(arg)).value.ref->val; } } while (0);
    _zend_hash_merge((*(return_value)).value.arr, (*(arg)).value.arr, zval_add_ref, 1 );
   }
  }
 } else {
  zend_string *string_key;
  ...
  if (recursive) {
   for (i = 1; i < argc; i++) {
    arg = args + i;
    do { if (__builtin_expect(!!((zval_get_type(&(*(arg))) == 10)), 0)) { (arg) = &(*(arg)).value.ref->val; } } while (0);
    php_array_merge_recursive((*(return_value)).value.arr, (*(arg)).value.arr);
   }
  } else {
   for (i = 1; i < argc; i++) {
    arg = args + i;
    do { if (__builtin_expect(!!((zval_get_type(&(*(arg))) == 10)), 0)) { (arg) = &(*(arg)).value.ref->val; } } while (0);
    php_array_merge((*(return_value)).value.arr, (*(arg)).value.arr);
   }
  }
 }
}
...
void zif_array_merge(zend_execute_data *execute_data, zval *return_value)
{
 php_array_merge_or_replace_wrapper(execute_data, return_value, 0, 0);
}
...
void zif_array_merge_recursive(zend_execute_data *execute_data, zval *return_value)
{
 php_array_merge_or_replace_wrapper(execute_data, return_value, 1, 0);
}
...
void zif_array_replace(zend_execute_data *execute_data, zval *return_value)
{
 php_array_merge_or_replace_wrapper(execute_data, return_value, 0, 1);
}
...
void zif_array_replace_recursive(zend_execute_data *execute_data, zval *return_value)
{
 php_array_merge_or_replace_wrapper(execute_data, return_value, 1, 1);
}
...
void zif_array_keys(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (1); int _max_num_args = (3); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array(_arg, &input, 0, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
  _optional = 1;
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &search_value, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &search_value, 0); }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_bool(_arg, &strict, &_dummy, 0)), 0)) { _expected_type = Z_EXPECTED_BOOL; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 if (search_value != ((void *)0)) {
  ...
  if (strict) {
   do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_idx = _p->h; str_idx = _p->key; entry = _z; {
    do { if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10)), 0)) { (entry) = &(*(entry)).value.ref->val; } } while (0);
    if (fast_is_identical_function(search_value, entry)) {
     if (str_idx) {
      do { zval *__z = (&new_val); zend_string *__s = (str_idx); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
     } else {
      { zval *__z = (&new_val); (*(__z)).value.lval = num_idx; (*(__z)).u1.type_info = 4; };
     }
     _zend_hash_next_index_insert_new((*(return_value)).value.arr, &new_val );
    }
   } } } while (0);
  } else {
   do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_idx = _p->h; str_idx = _p->key; entry = _z; {
  ...
  _array_init((return_value), (((*(input)).value.arr)->nNumOfElements) );
  if (!((*(input)).value.arr)->nNumOfElements) {
   return;
  }
  zend_hash_real_init((*(return_value)).value.arr, 1);
  do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
   ...
   do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_idx = _p->h; str_idx = _p->key; entry = _z; {
    ...
    do { do { zval *_z1 = (&__fill_bkt->val); const zval *_z2 = (&new_val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); __fill_bkt->h = (__fill_idx); __fill_bkt->key = ((void *)0); __fill_bkt++; __fill_idx++; } while (0);
   } } } while (0);
  } __fill_ht->nNumUsed = __fill_idx; __fill_ht->nNumOfElements = __fill_idx; __fill_ht->nNextFreeElement = __fill_idx; __fill_ht->nInternalPointer = __fill_idx ? 0 : ((uint32_t) -1); } while (0);
 }
}
...
void zif_array_values(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
  do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
   if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10) && zval_refcount_p(entry) == 1), 0)) {
...
void zif_array_count_values(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a", &input) == FAILURE) {
  return;
 }
 ...
 do { Bucket *_p = (myht)->arData; Bucket *_end = _p + (myht)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
  do { if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10)), 0)) { (entry) = &(*(entry)).value.ref->val; } } while (0);
  if (zval_get_type(&(*(entry))) == 4) {
   if ((tmp = zend_hash_index_find((*(return_value)).value.arr, (*(entry)).value.lval)) == ((void *)0)) {
    zval data;
    { zval *__z = (&data); (*(__z)).value.lval = 1; (*(__z)).u1.type_info = 4; };
    _zend_hash_index_update((*(return_value)).value.arr, (*(entry)).value.lval, &data );
   } else {
    (*(tmp)).value.lval++;
   }
  } else if (zval_get_type(&(*(entry))) == 6) {
   if ((tmp = zend_symtable_find((*(return_value)).value.arr, (*(entry)).value.str)) == ((void *)0)) {
    zval data;
    { zval *__z = (&data); (*(__z)).value.lval = 1; (*(__z)).u1.type_info = 4; };
    zend_symtable_update((*(return_value)).value.arr, (*(entry)).value.str, &data);
   } else {
    (*(tmp)).value.lval++;
   }
  } else {
...
zend_bool array_column_param_helper(zval *param,
 ...
 switch (zval_get_type(&(*(param)))) {
  case 5:
   if (zval_get_type(&(*(param)))!=4) { convert_to_long(param); };

  case 4:
   return 1;

  case 8:
   if (zval_get_type(&(*(param)))!=6) { if (zval_get_type(&(*(param))) != 6) { _convert_to_string((param) ); }; };
...
static inline zval *array_column_fetch_prop(zval *data, zval *name, zval *rv)
{
 ...
 if (zval_get_type(&(*(data))) == 8) {
  if (!((*(data))).value.obj->handlers->has_property || !((*(data))).value.obj->handlers->read_property) {
   return ((void *)0);
  }
  ...
  if (((*(data))).value.obj->handlers->has_property(data, name, 2, ((void *)0))
    || ((*(data))).value.obj->handlers->has_property(data, name, 0, ((void *)0))) {
   prop = ((*(data))).value.obj->handlers->read_property(data, name, 0, ((void *)0), rv);
  }
 } else if (zval_get_type(&(*(data))) == 7) {
  if (zval_get_type(&(*(name))) == 6) {
   prop = zend_symtable_find((*(data)).value.arr, (*(name)).value.str);
  } else if (zval_get_type(&(*(name))) == 4) {
   prop = zend_hash_index_find((*(data)).value.arr, (*(name)).value.lval);
  }
 }
...
void zif_array_column(zend_execute_data *execute_data, zval *return_value)
{
 ...
 HashTable *arr_hash;
 zval *zcolval = ((void *)0), *zkeyval = ((void *)0), rvc, rvk;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "hz!|z!", &arr_hash, &zcolumn, &zkey) == FAILURE) {
  return;
 }
 ...
 _array_init((return_value), 0 );
 do { Bucket *_p = (arr_hash)->arData; Bucket *_end = _p + (arr_hash)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; data = _z; {
  do { if (__builtin_expect(!!((zval_get_type(&(*(data))) == 10)), 0)) { (data) = &(*(data)).value.ref->val; } } while (0);

  if (!zcolumn) {
   zcolval = data;
  } else if ((zcolval = array_column_fetch_prop(data, zcolumn, &rvc)) == ((void *)0)) {
   continue;
  }
  ...
  do { if ((((*((zcolval))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((zcolval)); } } while (0);
  if (zkeyval && zval_get_type(&(*(zkeyval))) == 6) {
   zend_symtable_update((*(return_value)).value.arr, (*(zkeyval)).value.str, zcolval);
   ...
   zend_string *key = _zval_get_string((zkeyval));
   zend_symtable_update((*(return_value)).value.arr, key, zcolval);
   zend_string_release(key);
  } else {
...
void zif_array_reverse(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a|b", &input, &preserve_keys) == FAILURE) {
  return;
 }
 ...
 if (((*(input)).value.arr->u.flags & (1<<2)) && !preserve_keys) {
  zend_hash_real_init((*(return_value)).value.arr, 1);
  do { HashTable *__fill_ht = ((*(return_value)).value.arr); Bucket *__fill_bkt = __fill_ht->arData + __fill_ht->nNumUsed; uint32_t __fill_idx = __fill_ht->nNumUsed; do { if (__builtin_expect(!(__fill_ht->u.flags & (1<<2)), 0)) __builtin_unreachable(); } while (0); {
   do { uint _idx; for (_idx = ((*(input)).value.arr)->nNumUsed; _idx > 0; _idx--) { Bucket *_p = ((*(input)).value.arr)->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
    do { do { zval *_z1 = (&__fill_bkt->val); const zval *_z2 = (entry); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); __fill_bkt->h = (__fill_idx); __fill_bkt->key = ((void *)0); __fill_bkt++; __fill_idx++; } while (0);
    do { if ((((*((entry))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((entry)); } } while (0);
   } } } while (0);
  } __fill_ht->nNumUsed = __fill_idx; __fill_ht->nNumOfElements = __fill_idx; __fill_ht->nNextFreeElement = __fill_idx; __fill_ht->nInternalPointer = __fill_idx ? 0 : ((uint32_t) -1); } while (0);
 } else {
  do { uint _idx; for (_idx = ((*(input)).value.arr)->nNumUsed; _idx > 0; _idx--) { Bucket *_p = ((*(input)).value.arr)->arData + _idx - 1; zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; entry = _z; {
   if (string_key) {
    entry = _zend_hash_add_new((*(return_value)).value.arr, string_key, entry );
   } else {
    if (preserve_keys) {
...
void zif_array_pad(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "alz", &input, &pad_size, &pad_value) == FAILURE) {
  return;
 }
 ...
 if (pad_size_abs < 0 || pad_size_abs - input_size > 1048576L) {
 ...
 if (input_size >= pad_size_abs) {
  ...
  do { zval *_z1 = (return_value); const zval *_z2 = (input); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  return;
 }

 num_pads = pad_size_abs - input_size;
 _array_init((return_value), (pad_size_abs) );
 if ((((*(pad_value)).u1.v.type_flags & (1<<2)) != 0)) {
  ((*(pad_value)).value.counted)->gc.refcount += num_pads;
 }

 if (pad_size < 0) {
  for (i = 0; i < num_pads; i++) {
   _zend_hash_next_index_insert_new((*(return_value)).value.arr, pad_value );
  }
 }

 do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; key = _p->key; value = _z; {
  if ((((*(value)).u1.v.type_flags & (1<<2)) != 0)) {
   zval_addref_p(value);
  }
  if (key) {
   _zend_hash_add_new((*(return_value)).value.arr, key, value );
  } else {
   _zend_hash_next_index_insert_new((*(return_value)).value.arr, value );
  }
 } } } while (0);
...
void zif_array_flip(zend_execute_data *execute_data, zval *return_value)
{
 ...
 _array_init((return_value), (((*(array)).value.arr)->nNumOfElements) );

 do { Bucket *_p = ((*(array)).value.arr)->arData; Bucket *_end = _p + ((*(array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_idx = _p->h; str_idx = _p->key; entry = _z; {
  do { if (__builtin_expect(!!((zval_get_type(&(*(entry))) == 10)), 0)) { (entry) = &(*(entry)).value.ref->val; } } while (0);
  if (zval_get_type(&(*(entry))) == 4) {
   if (str_idx) {
    do { zval *__z = (&data); zend_string *__s = (str_idx); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
   } else {
...
void zif_array_change_key_case(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a|l", &array, &change_to_upper) == FAILURE) {
  return;
 }

 _array_init((return_value), (((*(array)).value.arr)->nNumOfElements) );

 do { Bucket *_p = ((*(array)).value.arr)->arData; Bucket *_end = _p + ((*(array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; entry = _z; {
  if (!string_key) {
   entry = _zend_hash_index_update((*(return_value)).value.arr, num_key, entry );
  } else {
   if (change_to_upper) {
   ...
   entry = _zend_hash_update((*(return_value)).value.arr, new_key, entry );
...
void zif_array_unique(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((*(array)).value.arr->nNumOfElements <= 1) {
  do { zval *_z1 = (return_value); const zval *_z2 = (array); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  return;
 }

 do { zval *__z = (return_value); (*(__z)).value.arr = (zend_array_dup((*(array)).value.arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);


 arTmp = (struct bucketindex *) (((*(array)).value.arr->u.flags & (1<<0))?__zend_malloc(((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)):(__builtin_constant_p((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) ) ? (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 8) ? _emalloc_8() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 16) ? _emalloc_16() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 24) ? _emalloc_24() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 32) ? _emalloc_32() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 40) ? _emalloc_40() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 48) ? _emalloc_48() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 56) ? _emalloc_56() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 64) ? _emalloc_64() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 80) ? _emalloc_80() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 96) ? _emalloc_96() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 112) ? _emalloc_112() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 128) ? _emalloc_128() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 160) ? _emalloc_160() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 192) ? _emalloc_192() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 224) ? _emalloc_224() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 256) ? _emalloc_256() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 320) ? _emalloc_320() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 384) ? _emalloc_384() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 448) ? _emalloc_448() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 512) ? _emalloc_512() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 640) ? _emalloc_640() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 768) ? _emalloc_768() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 896) ? _emalloc_896() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 1024) ? _emalloc_1024() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 1280) ? _emalloc_1280() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 1536) ? _emalloc_1536() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 1792) ? _emalloc_1792() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 2048) ? _emalloc_2048() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 2560) ? _emalloc_2560() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= 3072) ? _emalloc_3072() : (((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex))) : _emalloc_huge((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((((*(array)).value.arr->nNumOfElements + 1) * sizeof(struct bucketindex)) ) ));
 if (!arTmp) {
  _zval_ptr_dtor_nogc((return_value) );
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 for (i = 0, idx = 0; idx < (*(array)).value.arr->nNumUsed; idx++) {
 ...
 for (cmpdata = arTmp + 1; zval_get_type(&(cmpdata->b.val)) != 0; cmpdata++) {
  if (cmp(lastkept, cmpdata)) {
   ...
   if (p->key == ((void *)0)) {
    zend_hash_index_del((*(return_value)).value.arr, p->h);
   } else {
    if ((*(return_value)).value.arr == &(executor_globals.symbol_table)) {
     zend_delete_global_variable(p->key);
    } else {
     zend_hash_del((*(return_value)).value.arr, p->key);
    }
   }
  }
 }
 (((*(array)).value.arr->u.flags & (1<<0))?free(arTmp):_efree((arTmp) ));
}
...
static int zval_user_compare(zval *a, zval *b)
{
 ...
 do { zval *_z1 = (&args[0]); const zval *_z2 = (a); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
 do { zval *_z1 = (&args[1]); const zval *_z2 = (b); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
static void php_array_intersect_key(zend_execute_data *execute_data, zval *return_value, int data_compare_type)
{
    uint idx;
 Bucket *p;
 int argc, i;
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, param_spec, &args, &argc, &(basic_globals.user_compare_fci), &(basic_globals.user_compare_fci_cache)) == FAILURE) {
  return;
 }
 ...
 for (idx = 0; idx < (args[0]).value.arr->nNumUsed; idx++) {
  ...
  val = &p->val;
  if (zval_get_type(&(*(val))) == 0) continue;
  if (__builtin_expect(!!(zval_get_type(&(*(val))) == 15), 0)) {
   val = (*(val)).value.zv;
   if (zval_get_type(&(*(val))) == 0) continue;
  }
  if ((zval_get_type(&(*(val))) == 10) && zval_refcount_p(val) == 1) {
   do { zval *_z = (val); zend_reference *ref; do { if (__builtin_expect(!((zval_get_type(&(*(_z))) == 10)), 0)) __builtin_unreachable(); } while (0); ref = (*(_z)).value.ref; do { zval *_z1 = (_z); const zval *_z2 = (&ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); do { if (__builtin_constant_p(sizeof(zend_reference))) { if (sizeof(zend_reference) <= 8) { _efree_8(ref); } else if (sizeof(zend_reference) <= 16) { _efree_16(ref); } else if (sizeof(zend_reference) <= 24) { _efree_24(ref); } else if (sizeof(zend_reference) <= 32) { _efree_32(ref); } else if (sizeof(zend_reference) <= 40) { _efree_40(ref); } else if (sizeof(zend_reference) <= 48) { _efree_48(ref); } else if (sizeof(zend_reference) <= 56) { _efree_56(ref); } else if (sizeof(zend_reference) <= 64) { _efree_64(ref); } else if (sizeof(zend_reference) <= 80) { _efree_80(ref); } else if (sizeof(zend_reference) <= 96) { _efree_96(ref); } else if (sizeof(zend_reference) <= 112) { _efree_112(ref); } else if (sizeof(zend_reference) <= 128) { _efree_128(ref); } else if (sizeof(zend_reference) <= 160) { _efree_160(ref); } else if (sizeof(zend_reference) <= 192) { _efree_192(ref); } else if (sizeof(zend_reference) <= 224) { _efree_224(ref); } else if (sizeof(zend_reference) <= 256) { _efree_256(ref); } else if (sizeof(zend_reference) <= 320) { _efree_320(ref); } else if (sizeof(zend_reference) <= 384) { _efree_384(ref); } else if (sizeof(zend_reference) <= 448) { _efree_448(ref); } else if (sizeof(zend_reference) <= 512) { _efree_512(ref); } else if (sizeof(zend_reference) <= 640) { _efree_640(ref); } else if (sizeof(zend_reference) <= 768) { _efree_768(ref); } else if (sizeof(zend_reference) <= 896) { _efree_896(ref); } else if (sizeof(zend_reference) <= 1024) { _efree_1024(ref); } else if (sizeof(zend_reference) <= 1280) { _efree_1280(ref); } else if (sizeof(zend_reference) <= 1536) { _efree_1536(ref); } else if (sizeof(zend_reference) <= 1792) { _efree_1792(ref); } else if (sizeof(zend_reference) <= 2048) { _efree_2048(ref); } else if (sizeof(zend_reference) <= 2560) { _efree_2560(ref); } else if (sizeof(zend_reference) <= 3072) { _efree_3072(ref); } else if (sizeof(zend_reference) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(ref, sizeof(zend_reference)); } else { _efree_huge(ref, sizeof(zend_reference)); } } else { _efree(ref); } } while (0); } while (0);
  }
  if (p->key == ((void *)0)) {
   ok = 1;
   for (i = 1; i < argc; i++) {
    if ((data = zend_hash_index_find((args[i]).value.arr, p->h)) == ((void *)0) ||
   ...
   if (ok) {
    ...
    _zend_hash_index_update((*(return_value)).value.arr, p->h, val );
   }
  } else {
   ok = 1;
   for (i = 1; i < argc; i++) {
    if ((data = zend_hash_find_ind((args[i]).value.arr, p->key)) == ((void *)0) ||
     (intersect_data_compare_func &&
     intersect_data_compare_func(val, data) != 0)
    ) {
     ok = 0;
   ...
   if (ok) {
    ...
    _zend_hash_update((*(return_value)).value.arr, p->key, val );
   }
  }
 }
}
...
static void php_array_intersect(zend_execute_data *execute_data, zval *return_value, int behavior, int data_compare_type, int key_compare_type)
{
 zval *args = ((void *)0);
 HashTable *hash;
 int arr_argc, i, c = 0;
 ...
 if (behavior == 1) {
  ...
  if ((execute_data)->This.u2.num_args < req_args) {
   php_error_docref0(((void *)0), (1<<1L), "at least %d parameters are required, %d given", req_args, (execute_data)->This.u2.num_args);
   return;
  }

  if (zend_parse_parameters((execute_data)->This.u2.num_args, param_spec, &args, &arr_argc, &fci1, &fci1_cache) == FAILURE) {
   return;
  }
  fci_data = &fci1;
  ...
  if (zend_parse_parameters((execute_data)->This.u2.num_args, param_spec, &args, &arr_argc, &fci1, &fci1_cache, &fci2, &fci2_cache) == FAILURE) {
   return;
  }
 ...
 for (i = 0; i < arr_argc; i++) {
  ...
  list = (Bucket *) ((hash->u.flags & (1<<0))?__zend_malloc((hash->nNumOfElements + 1) * sizeof(Bucket)):(__builtin_constant_p(((hash->nNumOfElements + 1) * sizeof(Bucket)) ) ? ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 8) ? _emalloc_8() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 16) ? _emalloc_16() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 24) ? _emalloc_24() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 32) ? _emalloc_32() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 40) ? _emalloc_40() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 48) ? _emalloc_48() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 56) ? _emalloc_56() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 64) ? _emalloc_64() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 80) ? _emalloc_80() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 96) ? _emalloc_96() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 112) ? _emalloc_112() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 128) ? _emalloc_128() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 160) ? _emalloc_160() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 192) ? _emalloc_192() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 224) ? _emalloc_224() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 256) ? _emalloc_256() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 320) ? _emalloc_320() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 384) ? _emalloc_384() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 448) ? _emalloc_448() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 512) ? _emalloc_512() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 640) ? _emalloc_640() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 768) ? _emalloc_768() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 896) ? _emalloc_896() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 1024) ? _emalloc_1024() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 1280) ? _emalloc_1280() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 1536) ? _emalloc_1536() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 1792) ? _emalloc_1792() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 2048) ? _emalloc_2048() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 2560) ? _emalloc_2560() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= 3072) ? _emalloc_3072() : ((((hash->nNumOfElements + 1) * sizeof(Bucket)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((hash->nNumOfElements + 1) * sizeof(Bucket))) : _emalloc_huge(((hash->nNumOfElements + 1) * sizeof(Bucket)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((hash->nNumOfElements + 1) * sizeof(Bucket)) ) ));
  if (!list) {
   (basic_globals.user_compare_fci) = old_user_compare_fci; (basic_globals.user_compare_fci_cache) = old_user_compare_fci_cache;;
 ...
 do { zval *__z = (return_value); (*(__z)).value.arr = (zend_array_dup((args[0]).value.arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
...
void zif_array_intersect_key(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect_key(execute_data, return_value, -1);
}
...
void zif_array_intersect_ukey(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect(execute_data, return_value, 2, 0, 1);
}
...
void zif_array_intersect(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect(execute_data, return_value, 1, 0, 0);
}
...
void zif_array_uintersect(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect(execute_data, return_value, 1, 1, 0);
}
...
void zif_array_intersect_assoc(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect_key(execute_data, return_value, 0);
}
...
void zif_array_intersect_uassoc(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect(execute_data, return_value, 6, 0, 1);
}
...
void zif_array_uintersect_uassoc(zend_execute_data *execute_data, zval *return_value)
{
 php_array_intersect(execute_data, return_value, 6, 1, 1);
}


static void php_array_diff_key(zend_execute_data *execute_data, zval *return_value, int data_compare_type)
{
    uint idx;
 Bucket *p;
 int argc, i;
 ...
 if (data_compare_type == 1) {
  if (argc < 3) {
   php_error_docref0(((void *)0), (1<<1L), "at least 3 parameters are required, %d given", (execute_data)->This.u2.num_args);
   return;
  }
  if (zend_parse_parameters((execute_data)->This.u2.num_args, "+f", &args, &argc, &(basic_globals.user_compare_fci), &(basic_globals.user_compare_fci_cache)) == FAILURE) {
   return;
  }
  diff_data_compare_func = zval_user_compare;
 } else {
  if (argc < 2) {
   php_error_docref0(((void *)0), (1<<1L), "at least 2 parameters are required, %d given", (execute_data)->This.u2.num_args);
   return;
  }
  if (zend_parse_parameters((execute_data)->This.u2.num_args, "+", &args, &argc) == FAILURE) {
   return;
...
static void php_array_diff(zend_execute_data *execute_data, zval *return_value, int behavior, int data_compare_type, int key_compare_type)
{
 zval *args = ((void *)0);
 HashTable *hash;
 int arr_argc, i, c;
...
void zif_array_diff_key(zend_execute_data *execute_data, zval *return_value)
{
 php_array_diff_key(execute_data, return_value, -1);
}
...
void zif_array_diff_ukey(zend_execute_data *execute_data, zval *return_value)
{
 php_array_diff(execute_data, return_value, 2, 0, 1);
}
...
void zif_array_diff(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zval_get_type(&(args[0])) != 7) {
  php_error_docref0(((void *)0), (1<<1L), "Argument #1 is not an array");
  { do { (*(return_value)).u1.type_info = 1; } while (0); return;};
 }
 ...
 if (num == 0) {
  do { zval *_z1 = (return_value); const zval *_z2 = (&args[0]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  return;
 }

 do { (*(&dummy)).u1.type_info = 1; } while (0);

 _zend_hash_init((&exclude), (num), (((void *)0)), (0) );
 for (i = 1; i < argc; i++) {
  do { Bucket *_p = ((args[i]).value.arr)->arData; Bucket *_end = _p + ((args[i]).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; value = _z; {
   str = _zval_get_string((value));
   _zend_hash_add(&exclude, str, &dummy );
   zend_string_release(str);
  } } } while (0);
 }
 ...
 _array_init((return_value), (((args[0]).value.arr)->nNumOfElements) );
 do { Bucket *_p = ((args[0]).value.arr)->arData; Bucket *_end = _p + ((args[0]).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; idx = _p->h; key = _p->key; value = _z; {
  str = _zval_get_string((value));
  if (!zend_hash_exists(&exclude, str)) {
   if (key) {
    value = _zend_hash_add_new((*(return_value)).value.arr, key, value );
   } else {
    value = _zend_hash_index_add_new((*(return_value)).value.arr, idx, value );
   }
   zval_add_ref(value);
  }
  zend_string_release(str);
...
void zif_array_udiff(zend_execute_data *execute_data, zval *return_value)
{
 php_array_diff(execute_data, return_value, 1, 1, 0);
}
...
void zif_array_diff_assoc(zend_execute_data *execute_data, zval *return_value)
{
 php_array_diff_key(execute_data, return_value, 0);
}
...
void zif_array_diff_uassoc(zend_execute_data *execute_data, zval *return_value)
{
 php_array_diff(execute_data, return_value, 6, 0, 1);
}
...
void zif_array_udiff_uassoc(zend_execute_data *execute_data, zval *return_value)
{
 php_array_diff(execute_data, return_value, 6, 1, 1);
}
...
__attribute__ ((visibility("default"))) int php_multisort_compare(const void *a, const void *b)
{
 ...
 r = 0;
 do {
  result = (array_globals.multisort_func)[r](&ab[r], &bb[r]);
  if (result != 0) {
   return result > 0 ? 1 : -1;
  }
  r++;
...
void zif_array_multisort(zend_execute_data *execute_data, zval *return_value)
{
 ...
 (array_globals.multisort_func) = (compare_func_t*)_ecalloc((argc), (sizeof(compare_func_t)) );
 ...
 for (i = 0; i < argc; i++) {
  ...
  do { if (__builtin_expect(!!((zval_get_type(&(*(arg))) == 10)), 0)) { (arg) = &(*(arg)).value.ref->val; } } while (0);
  if (zval_get_type(&(*(arg))) == 7) {
   do { zval *_zv = (arg); zend_array *_arr = (*(_zv)).value.arr; if (__builtin_expect(!!((_arr)->gc.refcount > 1), 0)) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { (_arr)->gc.refcount--; } do { zval *__z = (_zv); (*(__z)).value.arr = (zend_array_dup(_arr)); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0); } } while (0);


   if (i > 0) {
    (array_globals.multisort_func)[num_arrays - 1] = php_get_data_compare_func(sort_type, sort_order != 4);
    sort_order = 4;
    sort_type = 0;
   }
   ...
   switch ((*(arg)).value.lval & ~8) {
    ...
    case 3:
     ...
     if (parse_state[0] == 1) {
      ...
      sort_order = (*(arg)).value.lval == 3 ? 3 : 4;
      parse_state[0] = 0;
     } else {
      ...
      _efree(((array_globals.multisort_func)) ); _efree((arrays) ); { do { (*(return_value)).u1.type_info = 2; } while (0); return; };;
     }
     break;
 ...
 for (i = 0; i < num_arrays; i++) {
  if (((*(arrays[i])).value.arr)->nNumOfElements != (uint32_t)array_size) {
 ...
 if (array_size < 1) {
  _efree(((array_globals.multisort_func)) );
  _efree((arrays) );
  { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
 }
...
void zif_array_rand(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a|l", &input, &num_req) == FAILURE) {
  return;
 }
 ...
 if (num_avail == 0) {
  php_error_docref0(((void *)0), (1<<1L), "Array is empty");
  return;
 }

 if (num_req == 1) {
  HashTable *ht = (*(input)).value.arr;
  ...
  do {
   ...
   if (!(zval_get_type(&(bucket->val)) == 0)) {
    if (bucket->key) {
     { do { zval *__z = (return_value); zend_string *__s = (bucket->key); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0); return; };
    } else {
     { { zval *__z = (return_value); (*(__z)).value.lval = bucket->h; (*(__z)).u1.type_info = 4; }; return; };
    }
   }
  } while (1);
 }
 ...
 _array_init((return_value), ((uint32_t)num_req) );
 ...
 bitset = (zend_bitset)((use_heap = (__builtin_expect(!!(((bitset_len) * sizeof(zend_ulong)) > ((32 * 1024))), 0))) ? (__builtin_constant_p(((bitset_len) * sizeof(zend_ulong)) ) ? ((((bitset_len) * sizeof(zend_ulong)) <= 8) ? _emalloc_8() : ((((bitset_len) * sizeof(zend_ulong)) <= 16) ? _emalloc_16() : ((((bitset_len) * sizeof(zend_ulong)) <= 24) ? _emalloc_24() : ((((bitset_len) * sizeof(zend_ulong)) <= 32) ? _emalloc_32() : ((((bitset_len) * sizeof(zend_ulong)) <= 40) ? _emalloc_40() : ((((bitset_len) * sizeof(zend_ulong)) <= 48) ? _emalloc_48() : ((((bitset_len) * sizeof(zend_ulong)) <= 56) ? _emalloc_56() : ((((bitset_len) * sizeof(zend_ulong)) <= 64) ? _emalloc_64() : ((((bitset_len) * sizeof(zend_ulong)) <= 80) ? _emalloc_80() : ((((bitset_len) * sizeof(zend_ulong)) <= 96) ? _emalloc_96() : ((((bitset_len) * sizeof(zend_ulong)) <= 112) ? _emalloc_112() : ((((bitset_len) * sizeof(zend_ulong)) <= 128) ? _emalloc_128() : ((((bitset_len) * sizeof(zend_ulong)) <= 160) ? _emalloc_160() : ((((bitset_len) * sizeof(zend_ulong)) <= 192) ? _emalloc_192() : ((((bitset_len) * sizeof(zend_ulong)) <= 224) ? _emalloc_224() : ((((bitset_len) * sizeof(zend_ulong)) <= 256) ? _emalloc_256() : ((((bitset_len) * sizeof(zend_ulong)) <= 320) ? _emalloc_320() : ((((bitset_len) * sizeof(zend_ulong)) <= 384) ? _emalloc_384() : ((((bitset_len) * sizeof(zend_ulong)) <= 448) ? _emalloc_448() : ((((bitset_len) * sizeof(zend_ulong)) <= 512) ? _emalloc_512() : ((((bitset_len) * sizeof(zend_ulong)) <= 640) ? _emalloc_640() : ((((bitset_len) * sizeof(zend_ulong)) <= 768) ? _emalloc_768() : ((((bitset_len) * sizeof(zend_ulong)) <= 896) ? _emalloc_896() : ((((bitset_len) * sizeof(zend_ulong)) <= 1024) ? _emalloc_1024() : ((((bitset_len) * sizeof(zend_ulong)) <= 1280) ? _emalloc_1280() : ((((bitset_len) * sizeof(zend_ulong)) <= 1536) ? _emalloc_1536() : ((((bitset_len) * sizeof(zend_ulong)) <= 1792) ? _emalloc_1792() : ((((bitset_len) * sizeof(zend_ulong)) <= 2048) ? _emalloc_2048() : ((((bitset_len) * sizeof(zend_ulong)) <= 2560) ? _emalloc_2560() : ((((bitset_len) * sizeof(zend_ulong)) <= 3072) ? _emalloc_3072() : ((((bitset_len) * sizeof(zend_ulong)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large(((bitset_len) * sizeof(zend_ulong))) : _emalloc_huge(((bitset_len) * sizeof(zend_ulong)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc(((bitset_len) * sizeof(zend_ulong)) ) ) : __builtin_alloca ((bitset_len) * sizeof(zend_ulong)));
 ...
 i = 0;
 do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; {
 ...
 do { if (__builtin_expect(!!(use_heap), 0)) _efree((bitset) ); } while (0);
}
...
void zif_array_sum(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
  ...
  do { zval *_z1 = (&entry_n); const zval *_z2 = (entry); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
void zif_array_product(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry = _z; {
  ...
  if (zval_get_type(&(entry_n)) == 4 && zval_get_type(&(*(return_value))) == 4) {
   ...
   if ( (double)(-9223372036854775807L -1) <= dval && dval <= (double)(9223372036854775807L) ) {
...
void zif_array_reduce(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "af|z", &input, &fci, &fci_cache, &initial) == FAILURE) {
  return;
 }


 if ((execute_data)->This.u2.num_args > 2) {
  do { zval *_z1 = (&result); const zval *_z2 = (initial); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
 } else {
 ...
 if ((htbl)->nNumOfElements == 0) {
  do { zval *_z1 = (return_value); const zval *_z2 = (&result); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  return;
 }
 ...
 do { Bucket *_p = (htbl)->arData; Bucket *_end = _p + (htbl)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; operand = _z; {
  do { zval *_z1 = (&args[0]); const zval *_z2 = (&result); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  do { zval *_z1 = (&args[1]); const zval *_z2 = (operand); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  fci.params = args;
 ...
 do { zval *__z = (return_value); zval *__zv = (&result); if (__builtin_expect(!!(!(zval_get_type(&(*(__zv))) == 10)), 1)) { if (1 && !1) { do { zval *_z1 = (__z); const zval *_z2 = (__zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0); } else { do { zval *_z1 = (__z); const zval *_z2 = (__zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0); } } else { do { zval *_z1 = (__z); const zval *_z2 = (&(*(__zv)).value.ref->val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0); if (1 || !1) { _zval_ptr_dtor((__zv) ); } } } while (0);
}
...
void zif_array_filter(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "a|fl", &array, &fci, &fci_cache, &use_type) == FAILURE) {
  return;
 }
 ...
 do { Bucket *_p = ((*(array)).value.arr)->arData; Bucket *_end = _p + ((*(array)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (1 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; string_key = _p->key; operand = _z; {
  if (have_callback) {
   if (use_type) {

    if (!string_key) {
     { zval *__z = (key); (*(__z)).value.lval = num_key; (*(__z)).u1.type_info = 4; };
    } else {
     do { zval *__z = (key); zend_string *__s = (string_key); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
    }
   }
   if (use_type != 2) {
    do { zval *_z1 = (&args[0]); const zval *_z2 = (operand); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   }
   fci.params = args;
  ...
  if (string_key) {
   operand = _zend_hash_update((*(return_value)).value.arr, string_key, operand );
  } else {
   operand = _zend_hash_index_update((*(return_value)).value.arr, num_key, operand );
  }
...
void zif_array_map(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (-1); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_func(_arg, &fci, &fci_cache, 1, &_error)), 0)) { if (!_error) { _expected_type = Z_EXPECTED_FUNC; error_code = 4; break; } else { error_code = 2; break; } } else if (__builtin_expect(!!(_error != ((void *)0)), 0)) { zend_wrong_callback_error((1<<13L), _i, _error); }
  do { int _num_varargs = _num_args - _i - (0); if (__builtin_expect(!!(_num_varargs > 0), 1)) { arrays = _real_arg + 1; n_arrays = _num_varargs; _i += _num_varargs; _real_arg += _num_varargs; } else { arrays = ((void *)0); n_arrays = 0; } } while (0);
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 if (n_arrays == 1) {
  ...
  if (zval_get_type(&(arrays[0])) != 7) {
   php_error_docref0(((void *)0), (1<<1L), "Argument #%d should be an array", 2);
   return;
  }
  ...
  if (!((fci).size != 0)) {
   do { zval *_z1 = (return_value); const zval *_z2 = (&arrays[0]); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   return;
  }

  _array_init((return_value), (maxlen) );

  do { Bucket *_p = ((arrays[0]).value.arr)->arData; Bucket *_end = _p + ((arrays[0]).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; str_key = _p->key; zv = _z; {
   fci.retval = &result;
   fci.param_count = 1;
   fci.params = &arg;
   fci.no_separation = 0;

   do { zval *_z1 = (&arg); const zval *_z2 = (zv); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   ...
   if (str_key) {
    _zend_hash_add_new((*(return_value)).value.arr, str_key, &result );
   } else {
    _zend_hash_index_add_new((*(return_value)).value.arr, num_key, &result );
   }
  } } } while (0);
 } else {
  uint32_t *array_pos = (HashPosition *)_ecalloc((n_arrays), (sizeof(HashPosition)) );
    ...
    for (i = 0; i < n_arrays; i++) {
     ...
     while (1) {
      if (pos >= (arrays[i]).value.arr->nNumUsed) {
       ...
       break;
      } else if (zval_get_type(&((arrays[i]).value.arr->arData[pos].val)) != 0) {
       do { zval *_z1 = (&zv); const zval *_z2 = (&(arrays[i]).value.arr->arData[pos].val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
       array_pos[i] = pos + 1;
       break;
      }
      pos++;
     ...
     _zend_hash_next_index_insert_new((result).value.arr, &zv );
    }

    _zend_hash_next_index_insert_new((*(return_value)).value.arr, &result );
   }
  } else {
   zval *params = (zval *)_safe_emalloc((n_arrays), (sizeof(zval)), (0) );
    ...
    for (i = 0; i < n_arrays; i++) {
     ...
     while (1) {
      if (pos >= (arrays[i]).value.arr->nNumUsed) {
       ...
       do { zval *_z1 = (&params[i]); const zval *_z2 = (&(arrays[i]).value.arr->arData[pos].val); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
       array_pos[i] = pos + 1;
       break;
      }
      pos++;
...
void zif_array_key_exists(zend_execute_data *execute_data, zval *return_value)
{
 ...
 do { const int _flags = (0); int _min_num_args = (2); int _max_num_args = (2); int _num_args = (execute_data)->This.u2.num_args; int _i; zval *_real_arg, *_arg = ((void *)0); zend_expected_type _expected_type = 0; char *_error = ((void *)0); zend_bool _dummy; zend_bool _optional = 0; int error_code = 0; ((void)_i); ((void)_real_arg); ((void)_arg); ((void)_expected_type); ((void)_error); ((void)_dummy); ((void)_optional); do { if (__builtin_expect(!!(_num_args < _min_num_args), 0) || (__builtin_expect(!!(_num_args > _max_num_args), 0) && __builtin_expect(!!(_max_num_args >= 0), 1))) { if (!(_flags & (1<<1))) { zend_wrong_parameters_count_error(_num_args, _min_num_args, _max_num_args); } error_code = 1; break; } _i = 0; _real_arg = (((zval*)(execute_data)) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(((int)(0)) - 1))));
  if (0) { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; zend_parse_arg_zval_deref(_arg, &key, 0); } else { ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional && __builtin_expect(!!(_i >_num_args), 0)) break; _real_arg++; zend_parse_arg_zval(_real_arg, &key, 0); }
  ++_i; do { if (__builtin_expect(!(_i <= _min_num_args || _optional==1), 0)) __builtin_unreachable(); } while (0); do { if (__builtin_expect(!(_i > _min_num_args || _optional==0), 0)) __builtin_unreachable(); } while (0); if (_optional) { if (__builtin_expect(!!(_i >_num_args), 0)) break; } _real_arg++; _arg = _real_arg; do { if (__builtin_expect(!!((zval_get_type(&(*(_arg))) == 10)), 0)) { (_arg) = &(*(_arg)).value.ref->val; } } while (0); if (0) { do { zval *_zv = (_arg); do { if (__builtin_expect(!(zval_get_type(&(*(_zv))) != 10), 0)) __builtin_unreachable(); } while (0); if ((((*(_zv)).u1.v.type_flags & (1<<4)) != 0) || (((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { if (zval_refcount_p(_zv) > 1) { if (!(((*(_zv)).u1.v.type_flags & (1<<1)) != 0)) { zval_delref_p(_zv); } _zval_copy_ctor_func(_zv ); } } } while (0); }; if (__builtin_expect(!!(!zend_parse_arg_array_ht(_arg, &array, 0, 1, 0)), 0)) { _expected_type = Z_EXPECTED_ARRAY; error_code = 4; break; }
 } while (0); if (__builtin_expect(!!(error_code != 0), 0)) { if (!(_flags & (1<<1))) { if (error_code == 2) { zend_wrong_callback_error((1<<1L), _i, _error); } else if (error_code == 3) { zend_wrong_parameter_class_error(_i, _error, _arg); } else if (error_code == 4) { zend_wrong_parameter_type_error(_i, _expected_type, _arg); } } return; } } while (0);
 ...
 switch (zval_get_type(&(*(key)))) {
  case 6:
   if (zend_symtable_exists_ind(array, (*(key)).value.str)) {
    { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
   }
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  case 4:
   ...
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
  case 1:
   if (zend_hash_exists_ind(array, (compiler_globals.empty_string))) {
    { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
   }
   { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
...
void zif_array_chunk(zend_execute_data *execute_data, zval *return_value)
{
 int argc = (execute_data)->This.u2.num_args, num_in;
 ...
 _array_init((return_value), ((uint32_t)(((num_in - 1) / size) + 1)) );

 do { (*(&chunk)).u1.type_info = 0; } while (0);

 do { Bucket *_p = ((*(input)).value.arr)->arData; Bucket *_end = _p + ((*(input)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; num_key = _p->h; str_key = _p->key; entry = _z; {

  if (zval_get_type(&(chunk)) == 0) {
   _array_init((&chunk), ((uint32_t)size) );
  }


  if (preserve_keys) {
   if (str_key) {
    entry = _zend_hash_update((chunk).value.arr, str_key, entry );
   } else {
    entry = _zend_hash_index_update((chunk).value.arr, num_key, entry );
   }
  } else {
   entry = _zend_hash_next_index_insert((chunk).value.arr, entry );
  }
  zval_add_ref(entry);
...
void zif_array_combine(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "hh", &keys, &values) == FAILURE) {
  return;
 }
 ...
 do { Bucket *_p = (keys)->arData; Bucket *_end = _p + (keys)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; entry_keys = _z; {
  while (1) {
   if (pos_values >= values->nNumUsed) {
    break;
   } else if (zval_get_type(&(values->arData[pos_values].val)) != 0) {
    entry_values = &values->arData[pos_values].val;
    if (zval_get_type(&(*(entry_keys))) == 4) {
     entry_values = _zend_hash_index_update((*(return_value)).value.arr, (*(entry_keys)).value.lval, entry_values )
                                         ;
    } else {
     zend_string *key = _zval_get_string((entry_keys));
     entry_values = zend_symtable_update((*(return_value)).value.arr,
      key, entry_values);
     zend_string_release(key);
    }
