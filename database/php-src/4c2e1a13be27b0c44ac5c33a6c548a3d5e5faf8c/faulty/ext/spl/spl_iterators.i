...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_str.h"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_str.h" 2
# 156 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_str.h"
...
# 155 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
  ...
  case RIT_RecursiveTreeIterator: {
   ...
   if (zend_parse_parameters_ex(1<<1, (ht) , "o|lzl", &iterator, &flags, &user_caching_it_flags, &mode) == SUCCESS) {
    ...
    if (user_caching_it_flags) {
     do { zval *__z = (caching_it_flags); zval *__zv = (user_caching_it_flags); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
    } else {
...
void zim_spl_RecursiveIteratorIterator_current(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (data && *data) {
  { do { zval *__z = (return_value); zval *__zv = (*data); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
}
...
void zim_spl_RecursiveIteratorIterator_getSubIterator(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (object->iterators[level].zobject); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
void zim_spl_RecursiveIteratorIterator_getInnerIterator(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (zobject); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
void zim_spl_RecursiveIteratorIterator_callHasChildren(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (!zobject) {
  ...
  zend_call_method(&zobject, ce, ((void *)0), "haschildren", sizeof("haschildren")-1, &retval, 0, ((void *)0), ((void *)0) );
  if (retval) {
   { do { zval *__z = (return_value); zval *__zv = (retval); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (1) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
  } else {
   { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
  }
 }
...
static const zend_arg_info arginfo_recursive_it___construct[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "iterator", sizeof("iterator")-1, "Traversable", sizeof("Traversable")-1, 5, 0, 0, 0 },
...
static void spl_recursive_tree_iterator_get_entry(spl_recursive_it_object * object, zval * return_value )
{
 ...
 if (data && *data) {
  do { zval *__z = (return_value); zval *__zv = (*data); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
...
void zim_spl_RecursiveTreeIterator_key(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (object->flags & RTIT_BYPASS_KEY) {
  zval *key_ptr = &key;
  do { zval *__z = (return_value); zval *__zv = (key_ptr); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
  _zval_dtor((&key) );
  return;
 }
...
# 1354 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
...
# 1429 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
...
void zim_spl_dual_it_getInnerIterator(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->inner.zobject) {
  do { zval *__z = (return_value); zval *__zv = (intern->inner.zobject); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
 } else {
  { { (*return_value).type = 0; }; return;};
 }
}
...
# 1787 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
void zim_spl_dual_it_key(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->current.key) {
  { do { zval *__z = (return_value); zval *__zv = (intern->current.key); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
 { { (*return_value).type = 0; }; return;};
}
# 1811 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_iterators.c"
void zim_spl_dual_it_current(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->current.data) {
  do { zval *__z = (return_value); zval *__zv = (intern->current.data); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
 } else {
  { { (*return_value).type = 0; }; return;};
 }
}
...
void zim_spl_CallbackFilterIterator_accept(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (result); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (1) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
void zim_spl_RegexIterator_accept(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->current.data == ((void *)0)) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 } else if ((*intern->current.data).type == 4) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
 ...
 case REGIT_MODE_GET_MATCH:
  ...
  do { zval *__z = (return_value); (*__z).value.lval = (((zcount).value.lval > 0) != 0); (*__z).type = 3; } while (0);
  break;
 ...
 if (use_copy) {
  do { if (!(((subject) >= (compiler_globals.interned_strings_start)) && ((subject) < (compiler_globals.interned_strings_end)))) { _efree(((char*)subject) ); } } while (0);
 }
}
...
void zim_spl_RecursiveRegexIterator_getChildren(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (!(executor_globals.exception)) {
  ...
  do { (object) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(object))->u.buffered = ((void *)0); } while (0); (object)->refcount__gc = 1; (object)->is_ref__gc = 0;;;
  ...
  do { (mode) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(mode))->u.buffered = ((void *)0); } while (0); (mode)->refcount__gc = 1; (mode)->is_ref__gc = 0;;;
  ...
  do { (preg_flags) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(preg_flags))->u.buffered = ((void *)0); } while (0); (preg_flags)->refcount__gc = 1; (preg_flags)->is_ref__gc = 0;;;

  do { do { (object)->value = (*(&retval))->value; (*object).type = (**(&retval)).type; } while (0); zval_set_refcount_p(object, 1); zval_unset_isref_p(object); } while (0); _zval_copy_ctor(((object)) );;
  ...
  { zval *__z = (mode); (*__z).value.lval = intern->u.regex.mode; (*__z).type = 1; };
  { zval *__z = (flags); (*__z).value.lval = intern->u.regex.flags; (*__z).type = 1; };
  { zval *__z = (preg_flags); (*__z).value.lval = intern->u.regex.preg_flags; (*__z).type = 1; };
  ...
  spl_instantiate_arg_n(zend_get_class_entry(&(*(this_ptr)) ), &return_value, 5, args );

  _zval_ptr_dtor((&object) );
  _zval_ptr_dtor((&regex) );
  _zval_ptr_dtor((&mode) );
  _zval_ptr_dtor((&flags) );
  _zval_ptr_dtor((&preg_flags) );
 }
 if (retval) {
  _zval_ptr_dtor((&retval) );
 }
...
void zim_spl_RecursiveRegexIterator_accept(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 spl_dual_it_object *intern;
 zval *rv;
 ...
 if (intern->current.data == ((void *)0)) {
  ...
  { do { zval *__z = (return_value); (*__z).value.lval = ((zend_hash_num_elements((*intern->current.data).value.ht) > 0) != 0); (*__z).type = 3; } while (0); return; };
 }

 zend_call_method(&((this_ptr)), spl_ce_RegexIterator, ((void *)0), "accept", sizeof("accept")-1, &rv, 0, ((void *)0), ((void *)0) );

 { do { zval *__z = (return_value); zval *__zv = (rv); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (1) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
static const zend_arg_info arginfo_filter_it___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "iterator", sizeof("iterator")-1, "Iterator", sizeof("Iterator")-1, 5, 0, 0, 0 },
};;
...
static const zend_arg_info arginfo_recursive_callback_filter_it___construct[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "iterator", sizeof("iterator")-1, "RecursiveIterator", sizeof("RecursiveIterator")-1, 5, 0, 0, 0 },
 { "callback", sizeof("callback")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;
...
static const zend_function_entry spl_funcs_RecursiveRegexIterator[] = {
 ...
 { "accept", zim_spl_RecursiveRegexIterator_accept, arginfo_recursive_it_void, (zend_uint) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_arg_info)-1), 0x100 },
 { "hasChildren", zim_spl_RecursiveFilterIterator_hasChildren, arginfo_recursive_it_void, (zend_uint) (sizeof(arginfo_recursive_it_void)/sizeof(struct _zend_arg_info)-1), 0x100 },
...
static inline void spl_caching_it_next(spl_dual_it_object *intern )
{
 if (spl_dual_it_fetch(intern, 1 ) == SUCCESS) {
  ...
  if (intern->u.caching.flags & CIT_FULL_CACHE) {
   ...
   do { zval *__z = (zcacheval); zval *__zv = (intern->current.data); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
...
void zim_spl_CachingIterator_offsetGet(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (*value); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
void zim_spl_CachingIterator_getCache(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (intern->u.caching.zcache); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
...
void zim_spl_RecursiveCachingIterator_getChildren(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (intern->u.caching.zchildren) {
  { do { zval *__z = (return_value); zval *__zv = (intern->u.caching.zchildren); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 } else {
  { { (*return_value).type = 0; }; return;};
 }
}
...
void zim_spl_AppendIterator_getArrayIterator(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); zval *__zv = (intern->u.append.zarrayit); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
}
