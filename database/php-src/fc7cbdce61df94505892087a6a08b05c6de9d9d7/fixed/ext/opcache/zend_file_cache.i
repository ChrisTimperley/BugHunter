...
# 425 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
...
# 725 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 return filename;
}
...
# 819 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 zend_string_release((zend_string*)(accel_globals.mem));
 _efree((mem) );
 if (flock(fd, 8) != 0) {
                                                 ...
                                                 void *buf)
{
 ...
 if (!(((char*)(op_array->opcodes) >= (char*)script->mem && (char*)(op_array->opcodes) < (char*)script->mem + script->size) || ((char*)(op_array->opcodes) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->opcodes) < (accel_shared_globals->interned_strings_end)))) {
  ...
  while (opline < end) {
# 999 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
