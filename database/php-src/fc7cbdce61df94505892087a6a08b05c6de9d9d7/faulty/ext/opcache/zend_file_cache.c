...
# 686 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 687 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 2
...
# 818 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 2
# 917 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 986 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 149 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.h"
...
# 424 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
...
# 724 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 return filename;
}
...
# 818 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 zend_string_release((zend_string*)(accel_globals.mem));
 _efree((mem) );
 if (flock(fd, 8) != 0) {
                                                 ...
                                                 void *buf)
{
 ...
 if (!(((char*)(op_array->opcodes) >= (char*)script->mem && (char*)(op_array->opcodes) < (char*)script->mem + script->size) || ((char*)(op_array->opcodes) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->opcodes) < (accel_shared_globals->interned_strings_end)))) {
  ...
  while (opline < end) {
# 998 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
...
zend_persistent_script *zend_file_cache_script_load(zend_file_handle *file_handle)
{
 ...
 if (!(accel_globals.accel_directives).file_cache_only &&
     !(accel_shared_globals->restart_in_progress) &&
...
use_process_mem:
 ...
 if (cache_it) {
  ...
  script->dynamic_members.last_used = (accel_globals.request_time);
