...
# 735 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_optimizer.c"
int zend_optimize_script(zend_script *script, zend_long optimization_level, zend_long debug_level)
{
 zend_class_entry *ce;
 zend_op_array *op_array;
...
# 821 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_optimizer.c"
