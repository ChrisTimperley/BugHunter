# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
# 31 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c" 2
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c" 2
...
# 40 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c" 2
...
# 47 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c" 2
extern char** environ;
# 115 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
...
# 145 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
char** save_ps_args(int argc, char** argv)
{
...

    {
        ...
        for (i = 0; (non_contiguous_area == 0) && (environ[i] != ((void *)0)); i++)
        {
        ...
        new_environ[i] = ((void *)0);
        environ = new_environ;
        memcpy((char *)frozen_environ, (char *)new_environ, sizeof(char *) * (i + 1));

    }
# 217 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    {
        char** new_argv;
        int i;
...
# 242 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
        argv = new_argv;
...
# 335 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
...
# 365 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    if (ps_buffer_cur_len < ps_buffer_size)
    {
        memset(ps_buffer + ps_buffer_cur_len, '\0',
               ps_buffer_size - ps_buffer_cur_len);
    }
# 393 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    return 0;
}
...
int get_ps_title(int *displen, const char** string)
{
    ...
    if (rc != 0)
        return rc;
# 428 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    *displen = (int)ps_buffer_cur_len;
    *string = ps_buffer;
    return 0;
}
# 440 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
void cleanup_ps_args(char **argv)
{
    ...
    if (save_argv)
    {
        ...
        {
            int i;
            for (i = 0; frozen_environ[i] != ((void *)0); i++)
