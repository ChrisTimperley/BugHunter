...
# 240 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
        argv = new_argv;
...
# 333 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
...
# 363 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    if (ps_buffer_cur_len < ps_buffer_size)
    {
        memset(ps_buffer + ps_buffer_cur_len, '\0',
               ps_buffer_size - ps_buffer_cur_len);
    }
# 391 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    return 0;
}
...
int get_ps_title(int *displen, const char** string)
{
    ...
    if (rc != 0)
        return rc;
# 426 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
    *displen = (int)ps_buffer_cur_len;
    *string = ps_buffer;
    return 0;
}
# 438 "/home/ct584/git/bughunter/repositories/php-src/sapi/cli/ps_title.c"
