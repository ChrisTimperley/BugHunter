...
# 50 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c"
...
static void zend_persist_op_array_calc_ex(zend_op_array *op_array)
{
 ...
 if (op_array->function_name) {
  ...
  if (new_name) {
   ...
   do { if (!((char*)(op_array->function_name) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->function_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(op_array->function_name); if (tmp != (op_array->function_name)) { if (0) { } (op_array->function_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->function_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->function_name)->len + 1)); } } } while (0);
 ...
 if (op_array->arg_info) {
  ...
  for (i = 0; i < num_args; i++) {
   if (arg_info[i].name) {
    do { if (!((char*)(arg_info[i].name) >= (accel_shared_globals->interned_strings_start) && (char*)(arg_info[i].name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(arg_info[i].name); if (tmp != (arg_info[i].name)) { if (1) { } (arg_info[i].name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(arg_info[i].name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (arg_info[i].name)->len + 1)); } } } while (0);
   }
   if (arg_info[i].class_name) {
    do { if (!((char*)(arg_info[i].class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(arg_info[i].class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(arg_info[i].class_name); if (tmp != (arg_info[i].class_name)) { if (1) { } (arg_info[i].class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(arg_info[i].class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (arg_info[i].class_name)->len + 1)); } } } while (0);
   }
  }
 }
...
static void zend_persist_property_info_calc(zval *zv)
{
 ...
 if (!zend_shared_alloc_get_xlat_entry(prop)) {
  ...
  do { if (!((char*)(prop->name) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(prop->name); if (tmp != (prop->name)) { if (0) { } (prop->name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(prop->name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (prop->name)->len + 1)); } } } while (0);
...
static void zend_persist_class_entry_calc(zval *zv)
{
 ...
 if (ce->type == 2) {
  ...
  do { if (!((char*)(ce->name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->name); if (tmp != (ce->name)) { if (0) { } (ce->name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->name)->len + 1)); } } } while (0);
   ...
   while (ce->trait_aliases[i]) {
    if (ce->trait_aliases[i]->trait_method) {
     if (ce->trait_aliases[i]->trait_method->method_name) {
      do { if (!((char*)(ce->trait_aliases[i]->trait_method->method_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases[i]->trait_method->method_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_aliases[i]->trait_method->method_name); if (tmp != (ce->trait_aliases[i]->trait_method->method_name)) { if (0) { } (ce->trait_aliases[i]->trait_method->method_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->trait_method->method_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->trait_method->method_name)->len + 1)); } } } while (0);
     }
     if (ce->trait_aliases[i]->trait_method->class_name) {
      do { if (!((char*)(ce->trait_aliases[i]->trait_method->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases[i]->trait_method->class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_aliases[i]->trait_method->class_name); if (tmp != (ce->trait_aliases[i]->trait_method->class_name)) { if (0) { } (ce->trait_aliases[i]->trait_method->class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->trait_method->class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->trait_method->class_name)->len + 1)); } } } while (0);
     }
    ...
    if (ce->trait_aliases[i]->alias) {
     do { if (!((char*)(ce->trait_aliases[i]->alias) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases[i]->alias) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_aliases[i]->alias); if (tmp != (ce->trait_aliases[i]->alias)) { if (0) { } (ce->trait_aliases[i]->alias) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->alias), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->alias)->len + 1)); } } } while (0);
    }
  ...
  if (ce->trait_precedences) {
   ...
   while (ce->trait_precedences[i]) {
    do { if (!((char*)(ce->trait_precedences[i]->trait_method->method_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences[i]->trait_method->method_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_precedences[i]->trait_method->method_name); if (tmp != (ce->trait_precedences[i]->trait_method->method_name)) { if (0) { } (ce->trait_precedences[i]->trait_method->method_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->trait_method->method_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->trait_method->method_name)->len + 1)); } } } while (0);
    do { if (!((char*)(ce->trait_precedences[i]->trait_method->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences[i]->trait_method->class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_precedences[i]->trait_method->class_name); if (tmp != (ce->trait_precedences[i]->trait_method->class_name)) { if (0) { } (ce->trait_precedences[i]->trait_method->class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->trait_method->class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->trait_method->class_name)->len + 1)); } } } while (0);
    (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_method_reference)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    ...
    if (ce->trait_precedences[i]->exclude_from_classes) {
     ...
     while (ce->trait_precedences[i]->exclude_from_classes[j].class_name) {
      do { if (!((char*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_precedences[i]->exclude_from_classes[j].class_name); if (tmp != (ce->trait_precedences[i]->exclude_from_classes[j].class_name)) { if (0) { } (ce->trait_precedences[i]->exclude_from_classes[j].class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->exclude_from_classes[j].class_name)->len + 1)); } } } while (0);
      j++;
     }
