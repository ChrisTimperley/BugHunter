# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_extensions.h"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_extensions.h" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_operators.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c" 2
# 52 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_persist_calc.c"
...
static void zend_hash_persist_calc(HashTable *ht, void (*pPersistElement)(zval *pElement))
{
 ...
 if (!(ht->u.flags & (1<<3)) || ht->nNumUsed == 0) {
  return;
 }

 if (!(ht->u.flags & (1<<2)) && ht->nNumUsed < -(int32_t)ht->nTableMask / 2) {
  ...
  (accel_globals.current_persistent_script)->size += (((hash_size * sizeof(uint32_t) + ht->nNumUsed * sizeof(Bucket)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
 } else {
  (accel_globals.current_persistent_script)->size += (((((((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t)) + ((size_t)(ht)->nNumUsed * sizeof(Bucket)))) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
 }
 ...
 for (idx = 0; idx < ht->nNumUsed; idx++) {
  ...
  if (p->key) {
   zend_uchar flags = (p->key)->gc.u.v.flags & ~ ((1<<0) | (1<<1) | (1<<2));
   do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(p->key), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (p->key)->len + 1)); } else if (!((char*)(p->key) >= (accel_shared_globals->interned_strings_start) && (char*)(p->key) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(p->key); if (tmp != (p->key)) { if (1) { } (p->key) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(p->key), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (p->key)->len + 1)); } } } while (0);
...
static void zend_persist_ast_calc(zend_ast *ast)
{
 ...
 if (ast->kind == ZEND_AST_ZVAL) {
  (accel_globals.current_persistent_script)->size += (((sizeof(zend_ast_zval)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  zend_persist_zval_calc(zend_ast_get_zval(ast));
 } else if (zend_ast_is_list(ast)) {
  zend_ast_list *list = zend_ast_get_list(ast);
  (accel_globals.current_persistent_script)->size += (((sizeof(zend_ast_list) - sizeof(zend_ast *) + sizeof(zend_ast *) * list->children) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  ...
  (accel_globals.current_persistent_script)->size += (((sizeof(zend_ast) - sizeof(zend_ast *) + sizeof(zend_ast *) * children) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
...
static void zend_persist_zval_calc(zval *z)
{
 ...
 switch (zval_get_type(&(*(z)))) {
  case 6:
  case 11:
   flags = ((*(z)).value.counted)->gc.u.v.flags & ~ ((1<<0) | (1<<1) | (1<<2));
   do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)((*(z)).value.str), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(z)).value.str)->len + 1)); } else if (!((char*)((*(z)).value.str) >= (accel_shared_globals->interned_strings_start) && (char*)((*(z)).value.str) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string((*(z)).value.str); if (tmp != ((*(z)).value.str)) { if (0) { } ((*(z)).value.str) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)((*(z)).value.str), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((*(z)).value.str)->len + 1)); } } } while (0);
   if ((((*(z)).value.str)->gc.u.v.flags & (1<<1))) {
    (*(z)).u1.v.type_flags &= ~ ((1<<2) | (1<<4));
   }
   ((*(z)).value.counted)->gc.u.v.flags |= flags;
   break;
  case 7:
   size = zend_shared_memdup_size((*(z)).value.arr, sizeof(zend_array));
   if (size) {
    (accel_globals.current_persistent_script)->size += (((size) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    zend_hash_persist_calc((*(z)).value.arr, zend_persist_zval_calc);
   }
   break;
  case 10:
   size = zend_shared_memdup_size((*(z)).value.ref, sizeof(zend_reference));
   if (size) {
    (accel_globals.current_persistent_script)->size += (((size) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    zend_persist_zval_calc(&(*(z)).value.ref->val);
   }
   break;
  case 12:
   size = zend_shared_memdup_size((*(z)).value.ast, sizeof(zend_ast_ref));
   if (size) {
    (accel_globals.current_persistent_script)->size += (((size) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    zend_persist_ast_calc((*(z)).value.ast->ast);
   }
   break;
 }
}
...
static void zend_persist_op_array_calc_ex(zend_op_array *op_array)
{
 ...
 if (op_array->static_variables) {
  if (!zend_shared_alloc_get_xlat_entry(op_array->static_variables)) {
   ...
   (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)op_array->static_variables, sizeof(HashTable));
 ...
 if (zend_shared_alloc_get_xlat_entry(op_array->opcodes)) {
  ...
  if (op_array->function_name) {
   ...
   if (((char*)(new_name) >= (accel_shared_globals->interned_strings_start) && (char*)(new_name) < (accel_shared_globals->interned_strings_end))) {
 ...
 if (op_array->literals) {
  ...
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)op_array->literals, sizeof(zval) * op_array->last_literal);
  while (p < end) {
 ...
 (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)op_array->opcodes, sizeof(zend_op) * op_array->last);
 ...
 if (op_array->function_name) {
  ...
  if (new_name) {
   ...
   do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->function_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->function_name)->len + 1)); } else if (!((char*)(op_array->function_name) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->function_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(op_array->function_name); if (tmp != (op_array->function_name)) { if (0) { } (op_array->function_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->function_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->function_name)->len + 1)); } } } while (0);
   zend_shared_alloc_register_xlat_entry(old_name, op_array->function_name);
  }
    }

 if (op_array->filename) {
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->filename), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->filename)->len + 1));
 }
 ...
 if (op_array->arg_info) {
  ...
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)arg_info, sizeof(zend_arg_info) * num_args);
  for (i = 0; i < num_args; i++) {
   if (arg_info[i].name) {
    do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(arg_info[i].name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (arg_info[i].name)->len + 1)); } else if (!((char*)(arg_info[i].name) >= (accel_shared_globals->interned_strings_start) && (char*)(arg_info[i].name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(arg_info[i].name); if (tmp != (arg_info[i].name)) { if (1) { } (arg_info[i].name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(arg_info[i].name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (arg_info[i].name)->len + 1)); } } } while (0);
   }
   if (arg_info[i].class_name) {
    do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(arg_info[i].class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (arg_info[i].class_name)->len + 1)); } else if (!((char*)(arg_info[i].class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(arg_info[i].class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(arg_info[i].class_name); if (tmp != (arg_info[i].class_name)) { if (1) { } (arg_info[i].class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(arg_info[i].class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (arg_info[i].class_name)->len + 1)); } } } while (0);
   }
  }
 }

 if (op_array->brk_cont_array) {
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)op_array->brk_cont_array, sizeof(zend_brk_cont_element) * op_array->last_brk_cont);
 }

 if ((accel_globals.accel_directives).save_comments && op_array->doc_comment) {
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->doc_comment), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->doc_comment)->len + 1));
 }

 if (op_array->try_catch_array) {
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)op_array->try_catch_array, sizeof(zend_try_catch_element) * op_array->last_try_catch);
 }

 if (op_array->vars) {
  int i;

  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)op_array->vars, sizeof(zend_string*) * op_array->last_var);
  for (i = 0; i < op_array->last_var; i++) {
   do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->vars[i]), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->vars[i])->len + 1)); } else if (!((char*)(op_array->vars[i]) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->vars[i]) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(op_array->vars[i]); if (tmp != (op_array->vars[i])) { if (0) { } (op_array->vars[i]) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(op_array->vars[i]), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (op_array->vars[i])->len + 1)); } } } while (0);
  }
 }

 (accel_globals.current_persistent_script)->size += ((((((zend_extensions_op_array_persist_calc(op_array)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L))) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
}

static void zend_persist_op_array_calc(zval *zv)
{
 zend_op_array *op_array = (*(zv)).value.ptr;

 if (op_array->type == 2
                                                         ) {
  zend_op_array *old_op_array = zend_shared_alloc_get_xlat_entry(op_array);
  if (old_op_array) {
   (*(zv)).value.ptr = old_op_array;
  } else {
   (accel_globals.current_persistent_script)->arena_size += (((sizeof(zend_op_array)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
   zend_persist_op_array_calc_ex((*(zv)).value.ptr);
   zend_shared_alloc_register_xlat_entry(op_array, (*(zv)).value.ptr);
  }
 } else {
  (accel_globals.current_persistent_script)->arena_size += (((sizeof(zend_op_array)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  zend_persist_op_array_calc_ex((*(zv)).value.ptr);
...
{
 zend_property_info *prop = (*(zv)).value.ptr;

 if (!zend_shared_alloc_get_xlat_entry(prop)) {
  zend_shared_alloc_register_xlat_entry(prop, prop);
  (accel_globals.current_persistent_script)->arena_size += (((sizeof(zend_property_info)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(prop->name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (prop->name)->len + 1)); } else if (!((char*)(prop->name) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(prop->name); if (tmp != (prop->name)) { if (0) { } (prop->name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(prop->name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (prop->name)->len + 1)); } } } while (0);
  if ((accel_globals.accel_directives).save_comments && prop->doc_comment) {
   (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(prop->doc_comment), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (prop->doc_comment)->len + 1));
  }
 }
}
...
static void zend_persist_class_entry_calc(zval *zv)
{
 ...
 if (ce->type == 2) {
  (accel_globals.current_persistent_script)->arena_size += (((sizeof(zend_class_entry)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->name)->len + 1)); } else if (!((char*)(ce->name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->name); if (tmp != (ce->name)) { if (0) { } (ce->name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->name)->len + 1)); } } } while (0);
  zend_hash_persist_calc(&ce->function_table, zend_persist_op_array_calc);
  if (ce->default_properties_table) {
      int i;

   (accel_globals.current_persistent_script)->size += (((sizeof(zval) * ce->default_properties_count) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  ...
  if (ce->default_static_members_table) {
   ...
   (accel_globals.current_persistent_script)->size += (((sizeof(zval) * ce->default_static_members_count) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  ...
  if ((ce)->info.user.filename) {
   (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)((ce)->info.user.filename), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((ce)->info.user.filename)->len + 1));
  }
  if ((accel_globals.accel_directives).save_comments && (ce)->info.user.doc_comment) {
   (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)((ce)->info.user.doc_comment), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + ((ce)->info.user.doc_comment)->len + 1));
  }
   ...
   while (ce->trait_aliases[i]) {
    if (ce->trait_aliases[i]->trait_method) {
     if (ce->trait_aliases[i]->trait_method->method_name) {
      do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->trait_method->method_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->trait_method->method_name)->len + 1)); } else if (!((char*)(ce->trait_aliases[i]->trait_method->method_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases[i]->trait_method->method_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_aliases[i]->trait_method->method_name); if (tmp != (ce->trait_aliases[i]->trait_method->method_name)) { if (0) { } (ce->trait_aliases[i]->trait_method->method_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->trait_method->method_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->trait_method->method_name)->len + 1)); } } } while (0);
     }
     if (ce->trait_aliases[i]->trait_method->class_name) {
      do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->trait_method->class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->trait_method->class_name)->len + 1)); } else if (!((char*)(ce->trait_aliases[i]->trait_method->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases[i]->trait_method->class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_aliases[i]->trait_method->class_name); if (tmp != (ce->trait_aliases[i]->trait_method->class_name)) { if (0) { } (ce->trait_aliases[i]->trait_method->class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->trait_method->class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->trait_method->class_name)->len + 1)); } } } while (0);
     }
     (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_method_reference)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    }

    if (ce->trait_aliases[i]->alias) {
     do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->alias), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->alias)->len + 1)); } else if (!((char*)(ce->trait_aliases[i]->alias) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases[i]->alias) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_aliases[i]->alias); if (tmp != (ce->trait_aliases[i]->alias)) { if (0) { } (ce->trait_aliases[i]->alias) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_aliases[i]->alias), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_aliases[i]->alias)->len + 1)); } } } while (0);
    }
    (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_alias)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    i++;
   }
   (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_alias*) * (i + 1)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  }
  ...
  if (ce->trait_precedences) {
   ...
   while (ce->trait_precedences[i]) {
    do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->trait_method->method_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->trait_method->method_name)->len + 1)); } else if (!((char*)(ce->trait_precedences[i]->trait_method->method_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences[i]->trait_method->method_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_precedences[i]->trait_method->method_name); if (tmp != (ce->trait_precedences[i]->trait_method->method_name)) { if (0) { } (ce->trait_precedences[i]->trait_method->method_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->trait_method->method_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->trait_method->method_name)->len + 1)); } } } while (0);
    do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->trait_method->class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->trait_method->class_name)->len + 1)); } else if (!((char*)(ce->trait_precedences[i]->trait_method->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences[i]->trait_method->class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_precedences[i]->trait_method->class_name); if (tmp != (ce->trait_precedences[i]->trait_method->class_name)) { if (0) { } (ce->trait_precedences[i]->trait_method->class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->trait_method->class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->trait_method->class_name)->len + 1)); } } } while (0);
    (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_method_reference)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    ...
    if (ce->trait_precedences[i]->exclude_from_classes) {
     ...
     while (ce->trait_precedences[i]->exclude_from_classes[j].class_name) {
      do { if ((accel_globals.current_persistent_script)->corrupted) { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->exclude_from_classes[j].class_name)->len + 1)); } else if (!((char*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name) < (accel_shared_globals->interned_strings_end))) { zend_string *tmp = accel_new_interned_string(ce->trait_precedences[i]->exclude_from_classes[j].class_name); if (tmp != (ce->trait_precedences[i]->exclude_from_classes[j].class_name)) { if (0) { } (ce->trait_precedences[i]->exclude_from_classes[j].class_name) = tmp; } else { (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(ce->trait_precedences[i]->exclude_from_classes[j].class_name), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (ce->trait_precedences[i]->exclude_from_classes[j].class_name)->len + 1)); } } } while (0);
      j++;
     }
     (accel_globals.current_persistent_script)->size += (((sizeof(zend_class_entry*) * (j + 1)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    }
    (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_precedence)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
    i++;
   }
   (accel_globals.current_persistent_script)->size += (((sizeof(zend_trait_precedence*) * (i + 1)) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
  }
 }
}
...
{
 new_persistent_script->mem = ((void *)0);
 new_persistent_script->size = 0;
 new_persistent_script->arena_mem = ((void *)0);
 new_persistent_script->arena_size = 0;
 new_persistent_script->corrupted = 0;
 (accel_globals.current_persistent_script) = new_persistent_script;

 (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)new_persistent_script, sizeof(zend_persistent_script));
 if (key) {
  (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)key, key_length + 1);
 } else {

  new_persistent_script->corrupted = 1;
 }
 (accel_globals.current_persistent_script)->size += zend_shared_memdup_size((void*)(new_persistent_script->full_path), (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (new_persistent_script->full_path)->len + 1));
