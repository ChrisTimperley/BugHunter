# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_globals.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_streams.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2



# 1 "/usr/include/errno.h" 1 3 4
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 46 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
...
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 59 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
...
# 60 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
...
# 62 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 70 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
...
# 71 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
...
# 74 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c" 2
# 88 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
  ...
  php_stream_context *context, int redirect_max, int flags )
{
 ...
 int use_proxy = 0;
 char *scratch = ((void *)0);
 zend_string *tmp = ((void *)0);
 char *ua_str = ((void *)0);
 zval *ua_zval = ((void *)0), *tmpzval = ((void *)0), ssl_proxy_peer_name;
 size_t scratch_len = 0;
 int body = 0;
 char location[1024];
 zval response_header;
 int reqok = 0;
 char *http_header_line = ((void *)0);
 char tmp_line[128];
 ...
 struct timeval timeout;
 char *user_headers = ((void *)0);
 int header_init = ((flags & 1) != 0);
 int redirected = ((flags & 2) != 0);
 zend_bool follow_location = 1;
 php_stream_filter *transfer_encoding = ((void *)0);
 int response_code;
 zend_array *symbol_table;

 do { (*(&response_header)).u1.type_info = 0; } while (0);
 tmp_line[0] = '\0';
 ...
 if (strncasecmp(resource->scheme, "http", sizeof("http")) && strncasecmp(resource->scheme, "https", sizeof("https"))) {
  if (!context ||
   (tmpzval = php_stream_context_get_option(context, wrapper->wops->label, "proxy")) == ((void *)0) ||
   zval_get_type(&(*(tmpzval))) != 6 ||
   ((*(tmpzval)).value.str)->len <= 0) {
   php_url_free(resource);
   return _php_stream_open_wrapper_ex((path), (mode), (0x00000008), (((void *)0)), (context) );
  }
  ...
  transport_len = ((*(tmpzval)).value.str)->len;
  transport_string = _estrndup((((*(tmpzval)).value.str)->val), (((*(tmpzval)).value.str)->len) );
 } else {
 ...
 if (context && (tmpzval = php_stream_context_get_option(context, wrapper->wops->label, "timeout")) != ((void *)0)) {
  double d = _zval_get_double((tmpzval));
 ...
 stream = _php_stream_xport_create(transport_string, transport_len, options, 0 | 2, ((void *)0), &timeout, context, &errstr, ((void *)0) )

                                          ;

 if (stream) {
  _php_stream_set_option((stream), (4), (0), (&timeout));
 }
 ...
 _efree((transport_string) );

 if (stream && use_proxy && use_ssl) {
  smart_str header = {0};


  if (!context || (tmpzval = php_stream_context_get_option(context, "ssl", "peer_name")) == ((void *)0)) {
   do { const char *_s = (resource->host); do { do { zval *__z = (&ssl_proxy_peer_name); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
   php_stream_context_set_option(((php_stream_context*) ((stream)->ctx ? ((stream)->ctx->ptr) : ((void *)0))), "ssl", "peer_name", &ssl_proxy_peer_name);
   _zval_ptr_dtor((&ssl_proxy_peer_name) );
  }

  smart_str_appendl_ex((&header), ("CONNECT "), (sizeof("CONNECT ")-1), 0);
  smart_str_appendl_ex(((&header)), ((resource->host)), (strlen(resource->host)), 0);
  smart_str_appendc_ex((&header), (':'), 0);
  smart_str_append_unsigned_ex((&header), (resource->port), 0);
  smart_str_appendl_ex((&header), (" HTTP/1.0\r\n"), (sizeof(" HTTP/1.0\r\n")-1), 0);


  if (context && (tmpzval = php_stream_context_get_option(context, "http", "header")) != ((void *)0)) {
   char *s, *p;

   if (zval_get_type(&(*(tmpzval))) == 7) {
    zval *tmpheader = ((void *)0);

    do { Bucket *_p = ((*(tmpzval)).value.arr)->arData; Bucket *_end = _p + ((*(tmpzval)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; tmpheader = _z; {
     if (zval_get_type(&(*(tmpheader))) == 6) {
      ...
      do {
       ...
       if (*p == ':') {
        ...
        if (p - s == sizeof("Proxy-Authorization:") - 1 &&
         ...
         while (*p != 0 && *p != '\r' && *p !='\n') p++;
         smart_str_appendl_ex((&header), (s), (p - s), 0);
         smart_str_appendl_ex((&header), ("\r\n"), (sizeof("\r\n")-1), 0);
         goto finish;
        } else {
         while (*p != 0 && *p != '\r' && *p !='\n') p++;
        }
   ...
   } else if (zval_get_type(&(*(tmpzval))) == 6 && ((*(tmpzval)).value.str)->len) {
...
finish:
  ...
  if (_php_stream_write(stream, ((header.s)->val), ((header.s)->len)) != (header.s)->len) {
   ...
   while (_php_stream_get_line((stream), (header_line), (1024 -1), ((void *)0)) != ((void *)0)) {
    if (header_line[0] == '\n' ||
        header_line[0] == '\r' ||
        header_line[0] == '\0') {
      break;
  ...
  if (stream) {
   if (php_stream_xport_crypto_setup(stream, STREAM_CRYPTO_METHOD_SSLv23_CLIENT, ((void *)0)) < 0 ||
 ...
 if (options & 0x00000020)
  chunk_size = _php_stream_set_option((stream), 5, (1), ((void *)0));
 ...
 if (header_init && context && (tmpzval = php_stream_context_get_option(context, "http", "max_redirects")) != ((void *)0)) {
  redirect_max = (int)_zval_get_long((tmpzval));
 }

 if (context && (tmpzval = php_stream_context_get_option(context, "http", "method")) != ((void *)0)) {
  if (zval_get_type(&(*(tmpzval))) == 6 && ((*(tmpzval)).value.str)->len > 0) {


   if (!redirected
    || (((*(tmpzval)).value.str)->len == 3 && memcmp("GET", ((*(tmpzval)).value.str)->val, 3) == 0)
    || (((*(tmpzval)).value.str)->len == 4 && memcmp("HEAD",((*(tmpzval)).value.str)->val, 4) == 0)
   ) {
    scratch_len = strlen(path) + 29 + ((*(tmpzval)).value.str)->len;
    scratch = (__builtin_constant_p((scratch_len) ) ? (((scratch_len) <= 8) ? _emalloc_8() : (((scratch_len) <= 16) ? _emalloc_16() : (((scratch_len) <= 24) ? _emalloc_24() : (((scratch_len) <= 32) ? _emalloc_32() : (((scratch_len) <= 40) ? _emalloc_40() : (((scratch_len) <= 48) ? _emalloc_48() : (((scratch_len) <= 56) ? _emalloc_56() : (((scratch_len) <= 64) ? _emalloc_64() : (((scratch_len) <= 80) ? _emalloc_80() : (((scratch_len) <= 96) ? _emalloc_96() : (((scratch_len) <= 112) ? _emalloc_112() : (((scratch_len) <= 128) ? _emalloc_128() : (((scratch_len) <= 160) ? _emalloc_160() : (((scratch_len) <= 192) ? _emalloc_192() : (((scratch_len) <= 224) ? _emalloc_224() : (((scratch_len) <= 256) ? _emalloc_256() : (((scratch_len) <= 320) ? _emalloc_320() : (((scratch_len) <= 384) ? _emalloc_384() : (((scratch_len) <= 448) ? _emalloc_448() : (((scratch_len) <= 512) ? _emalloc_512() : (((scratch_len) <= 640) ? _emalloc_640() : (((scratch_len) <= 768) ? _emalloc_768() : (((scratch_len) <= 896) ? _emalloc_896() : (((scratch_len) <= 1024) ? _emalloc_1024() : (((scratch_len) <= 1280) ? _emalloc_1280() : (((scratch_len) <= 1536) ? _emalloc_1536() : (((scratch_len) <= 1792) ? _emalloc_1792() : (((scratch_len) <= 2048) ? _emalloc_2048() : (((scratch_len) <= 2560) ? _emalloc_2560() : (((scratch_len) <= 3072) ? _emalloc_3072() : (((scratch_len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((scratch_len)) : _emalloc_huge((scratch_len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((scratch_len) ) );
    php_strlcpy(scratch, ((*(tmpzval)).value.str)->val, ((*(tmpzval)).value.str)->len + 1);
    strncat(scratch, " ", 1);
   }
  }
 }

 if (context && (tmpzval = php_stream_context_get_option(context, "http", "protocol_version")) != ((void *)0)) {
  protocol_version_len = (int)spprintf(&protocol_version, 0, "%.1F", _zval_get_double((tmpzval)));
 }
 ...
 if (!request_fulluri && context &&
  (tmpzval = php_stream_context_get_option(context, "http", "request_fulluri")) != ((void *)0)) {
 ...
 if (request_fulluri) {
  ...
  if (resource->path && *resource->path) {
   php_strlcat(scratch, resource->path, scratch_len);
  } else {
   php_strlcat(scratch, "/", scratch_len);
  }


  if (resource->query) {
   php_strlcat(scratch, "?", scratch_len);
   php_strlcat(scratch, resource->query, scratch_len);
  }
 }


 if (protocol_version) {
  php_strlcat(scratch, " HTTP/", scratch_len);
  php_strlcat(scratch, protocol_version, scratch_len);
  php_strlcat(scratch, "\r\n", scratch_len);
 } else {
  php_strlcat(scratch, " HTTP/1.0\r\n", scratch_len);
 }


 _php_stream_write(stream, (scratch), (strlen(scratch)));
 ...
 if (context && (tmpzval = php_stream_context_get_option(context, "http", "header")) != ((void *)0)) {
  ...
  if (zval_get_type(&(*(tmpzval))) == 7) {
   ...
   do { Bucket *_p = ((*(tmpzval)).value.arr)->arData; Bucket *_end = _p + ((*(tmpzval)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; tmpheader = _z; {
    if (zval_get_type(&(*(tmpheader))) == 6) {
     smart_str_append_ex((&tmpstr), ((*(tmpheader)).value.str), 0);
     smart_str_appendl_ex((&tmpstr), ("\r\n"), (sizeof("\r\n") - 1), 0);
    }
   } } } while (0);
   smart_str_0(&tmpstr);

   if (tmpstr.s) {
    tmp = php_trim(tmpstr.s, ((void *)0), 0, 3);
    smart_str_free(&tmpstr);
   }
  } else if (zval_get_type(&(*(tmpzval))) == 6 && ((*(tmpzval)).value.str)->len) {

   tmp = php_trim((*(tmpzval)).value.str, ((void *)0), 0, 3);
  }
  if (tmp && (tmp)->len) {
   char *s;
   char *t;

   user_headers = _estrndup(((tmp)->val), ((tmp)->len) );

   if (((tmp)->gc.u.v.flags & (1<<1))) {
    tmp = zend_string_init((tmp)->val, (tmp)->len, 0);
   } else if ((tmp)->gc.refcount > 1) {
    (tmp)->gc.refcount--;
    tmp = zend_string_init((tmp)->val, (tmp)->len, 0);
   }
 ...
 if (((have_header & 4) == 0) && resource->user) {
  zend_string *stmp;
  ...
  if (ap_php_snprintf(scratch, scratch_len, "Authorization: Basic %s\r\n", (stmp)->val) > 0) {
   _php_stream_write(stream, (scratch), (strlen(scratch)));
   do { if ((context) && (context)->notifier) { php_stream_notification_notify((context), (3), 0, (((void *)0)), (0), 0, 0, ((void *)0)); } } while (0);
  }
 ...
 if (((have_header & 8) == 0) && (file_globals.from_address)) {
  if (ap_php_snprintf(scratch, scratch_len, "From: %s\r\n", (file_globals.from_address)) > 0)
   _php_stream_write(stream, (scratch), (strlen(scratch)));
 }
 ...
 if ((have_header & 2) == 0) {
  if ((use_ssl && resource->port != 443 && resource->port != 0) ||
   ...
   if (ap_php_snprintf(scratch, scratch_len, "Host: %s:%i\r\n", resource->host, resource->port) > 0)
    _php_stream_write(stream, (scratch), (strlen(scratch)));
  } else {
   if (ap_php_snprintf(scratch, scratch_len, "Host: %s\r\n", resource->host) > 0) {
    _php_stream_write(stream, (scratch), (strlen(scratch)));
   }
  }
 }
 ...
 if ((have_header & 64) == 0) {
  _php_stream_write(stream, "Connection: close\r\n", strlen("Connection: close\r\n"));
 }

 if (context &&
     (ua_zval = php_stream_context_get_option(context, "http", "user_agent")) != ((void *)0) &&
  zval_get_type(&(*(ua_zval))) == 6) {
  ua_str = ((*(ua_zval)).value.str)->val;
 } else if ((file_globals.user_agent)) {
  ua_str = (file_globals.user_agent);
 }

 if (((have_header & 1) == 0) && ua_str) {

  char *ua;
  size_t ua_len;

  ua_len = sizeof("User-Agent: %s\r\n") + strlen(ua_str);


  if (ua_len > sizeof("User-Agent: %s\r\n")) {
   ua = (__builtin_constant_p((ua_len + 1) ) ? (((ua_len + 1) <= 8) ? _emalloc_8() : (((ua_len + 1) <= 16) ? _emalloc_16() : (((ua_len + 1) <= 24) ? _emalloc_24() : (((ua_len + 1) <= 32) ? _emalloc_32() : (((ua_len + 1) <= 40) ? _emalloc_40() : (((ua_len + 1) <= 48) ? _emalloc_48() : (((ua_len + 1) <= 56) ? _emalloc_56() : (((ua_len + 1) <= 64) ? _emalloc_64() : (((ua_len + 1) <= 80) ? _emalloc_80() : (((ua_len + 1) <= 96) ? _emalloc_96() : (((ua_len + 1) <= 112) ? _emalloc_112() : (((ua_len + 1) <= 128) ? _emalloc_128() : (((ua_len + 1) <= 160) ? _emalloc_160() : (((ua_len + 1) <= 192) ? _emalloc_192() : (((ua_len + 1) <= 224) ? _emalloc_224() : (((ua_len + 1) <= 256) ? _emalloc_256() : (((ua_len + 1) <= 320) ? _emalloc_320() : (((ua_len + 1) <= 384) ? _emalloc_384() : (((ua_len + 1) <= 448) ? _emalloc_448() : (((ua_len + 1) <= 512) ? _emalloc_512() : (((ua_len + 1) <= 640) ? _emalloc_640() : (((ua_len + 1) <= 768) ? _emalloc_768() : (((ua_len + 1) <= 896) ? _emalloc_896() : (((ua_len + 1) <= 1024) ? _emalloc_1024() : (((ua_len + 1) <= 1280) ? _emalloc_1280() : (((ua_len + 1) <= 1536) ? _emalloc_1536() : (((ua_len + 1) <= 1792) ? _emalloc_1792() : (((ua_len + 1) <= 2048) ? _emalloc_2048() : (((ua_len + 1) <= 2560) ? _emalloc_2560() : (((ua_len + 1) <= 3072) ? _emalloc_3072() : (((ua_len + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((ua_len + 1)) : _emalloc_huge((ua_len + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((ua_len + 1) ) );
   if ((ua_len = ap_php_slprintf(ua, ua_len, "User-Agent: %s\r\n", ua_str)) > 0) {
    ua[ua_len] = 0;
    _php_stream_write(stream, (ua), (ua_len));
   } else {
    php_error_docref0(((void *)0), (1<<1L), "Cannot construct User-agent header");
   }
   _efree((ua) );
  }
 }
 ...
 if (user_headers) {
  ...
  if (
    ...
    context &&
    !(have_header & 16) &&
    (tmpzval = php_stream_context_get_option(context, "http", "content")) != ((void *)0) &&
    zval_get_type(&(*(tmpzval))) == 6 && ((*(tmpzval)).value.str)->len > 0
  ) {
   scratch_len = ap_php_slprintf(scratch, scratch_len, "Content-Length: %d\r\n", ((*(tmpzval)).value.str)->len);
   _php_stream_write(stream, (scratch), (scratch_len));
   have_header |= 16;
  }

  _php_stream_write(stream, (user_headers), (strlen(user_headers)));
  _php_stream_write(stream, ("\r\n"), (sizeof("\r\n")-1));
  _efree((user_headers) );
 }
 ...
 if (header_init && context &&
  ...
  if (!(have_header & 32)) {
   _php_stream_write(stream, ("Content-Type: application/x-www-form-urlencoded\r\n"), (sizeof("Content-Type: application/x-www-form-urlencoded\r\n") - 1))
                                                                      ;
   php_error_docref0(((void *)0), (1<<3L), "Content-type not specified assuming application/x-www-form-urlencoded");
  }
  _php_stream_write(stream, ("\r\n"), (sizeof("\r\n")-1));
  _php_stream_write(stream, (((*(tmpzval)).value.str)->val), (((*(tmpzval)).value.str)->len));
 } else {
  _php_stream_write(stream, ("\r\n"), (sizeof("\r\n")-1));
 }
...

 {
  ...
  if (!response_header_ptr || zval_get_type(&(*(response_header_ptr))) != 7) {
   do { (*(&response_header)).u1.type_info = 0; } while (0);
   goto out;
  } else {
   do { zval *_z1 = (&response_header); const zval *_z2 = (response_header_ptr); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
 }
 ...
 if (!_php_stream_eof((stream))) {
  ...
  if (_php_stream_get_line((stream), (tmp_line), (sizeof(tmp_line) - 1), (&tmp_line_len)) != ((void *)0)) {
   zval http_response;
   ...
   if (context && ((void *)0) != (tmpzval = php_stream_context_get_option(context, "http", "ignore_errors"))) {
    ignore_errors = zend_is_true(tmpzval);
   }

   if ((options & 0x00000200) || ignore_errors) {
    reqok = 1;
   }
   ...
   if (response_code >= 200 && response_code < 400) {
    ...
    switch(response_code) {
     case 403:
      do { if ((context) && (context)->notifier) { php_stream_notification_notify((context), (10), 2, (tmp_line), (response_code), 0, 0, ((void *)0)); } } while(0)
                                ;
      break;
     default:
      ...
      do { if ((context) && (context)->notifier) { php_stream_notification_notify((context), (9), 2, (tmp_line), (response_code), 0, 0, ((void *)0)); } } while(0)
                                ;
    }
   }
   ...
   do { do { zval *__z = (&http_response); zend_string *__s = (zend_string_init(tmp_line, tmp_line_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);
   _zend_hash_next_index_insert((response_header).value.arr, &http_response );
  }
 } else {
 ...
 http_header_line = (__builtin_constant_p((1024) ) ? (((1024) <= 8) ? _emalloc_8() : (((1024) <= 16) ? _emalloc_16() : (((1024) <= 24) ? _emalloc_24() : (((1024) <= 32) ? _emalloc_32() : (((1024) <= 40) ? _emalloc_40() : (((1024) <= 48) ? _emalloc_48() : (((1024) <= 56) ? _emalloc_56() : (((1024) <= 64) ? _emalloc_64() : (((1024) <= 80) ? _emalloc_80() : (((1024) <= 96) ? _emalloc_96() : (((1024) <= 112) ? _emalloc_112() : (((1024) <= 128) ? _emalloc_128() : (((1024) <= 160) ? _emalloc_160() : (((1024) <= 192) ? _emalloc_192() : (((1024) <= 224) ? _emalloc_224() : (((1024) <= 256) ? _emalloc_256() : (((1024) <= 320) ? _emalloc_320() : (((1024) <= 384) ? _emalloc_384() : (((1024) <= 448) ? _emalloc_448() : (((1024) <= 512) ? _emalloc_512() : (((1024) <= 640) ? _emalloc_640() : (((1024) <= 768) ? _emalloc_768() : (((1024) <= 896) ? _emalloc_896() : (((1024) <= 1024) ? _emalloc_1024() : (((1024) <= 1280) ? _emalloc_1280() : (((1024) <= 1536) ? _emalloc_1536() : (((1024) <= 1792) ? _emalloc_1792() : (((1024) <= 2048) ? _emalloc_2048() : (((1024) <= 2560) ? _emalloc_2560() : (((1024) <= 3072) ? _emalloc_3072() : (((1024) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((1024)) : _emalloc_huge((1024))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((1024) ) );

 while (!body && !_php_stream_eof((stream))) {
  size_t http_header_line_length;
  if (_php_stream_get_line((stream), (http_header_line), (1024), (&http_header_line_length)) && *http_header_line != '\n' && *http_header_line != '\r') {
   char *e = http_header_line + http_header_line_length - 1;
   if (*e != '\n') {
    do {
     if (_php_stream_get_line((stream), (http_header_line), (1024), (&http_header_line_length)) == ((void *)0)) {
   ...
   if (!strncasecmp(http_header_line, "Location: ", 10)) {
    if (context && (tmpzval = php_stream_context_get_option(context, "http", "follow_location")) != ((void *)0)) {
     follow_location = zend_is_true(tmpzval);
    ...
    php_strlcpy(location, http_header_line + 10, sizeof(location));
   } else if (!strncasecmp(http_header_line, "Content-Type: ", 14)) {
    do { if ((context) && (context)->notifier) { php_stream_notification_notify((context), (4), 0, (http_header_line + 14), (0), 0, 0, ((void *)0)); } } while (0);
   } else if (!strncasecmp(http_header_line, "Content-Length: ", 16)) {
    file_size = atoi(http_header_line + 16);
    do { if ((context) && (context)->notifier) { php_stream_notification_notify((context), 5, 0, (http_header_line), (0), 0, (file_size), ((void *)0)); } } while(0);
    ...
    if (!(options & 0x00000200)) {
     ...
     if (context && (tmpzval = php_stream_context_get_option(context, "http", "auto_decode")) != ((void *)0)) {
      decode = zend_is_true(tmpzval);
     }
     if (decode) {
      transfer_encoding = php_stream_filter_create("dechunk", ((void *)0), (stream)->is_persistent);
   ...
   if (http_header_line[0] == '\0') {
    ...
    do { do { zval *__z = (&http_header); zend_string *__s = (zend_string_init(http_header_line, http_header_line_length, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);

    _zend_hash_next_index_insert((response_header).value.arr, &http_header );
   }
  } else {
   break;
  }
 ...
 if (!reqok || (location[0] != '\0' && follow_location)) {
  if (!follow_location || (((options & 0x00000200) || ignore_errors) && redirect_max <= 1)) {
   goto out;
  }

  if (location[0] != '\0')
   do { if ((context) && (context)->notifier) { php_stream_notification_notify((context), (6), 0, (location), (0), 0, 0, ((void *)0)); } } while (0);
    ...
    if (*location != '/') {
     if (*(location+1) != '\0' && resource->path) {
      ...
      if (resource->path && *(resource->path) == '/' && *(resource->path + 1) == '\0') {
       ap_php_snprintf(loc_path, sizeof(loc_path) - 1, "%s%s", resource->path, location);
      } else {
       ap_php_snprintf(loc_path, sizeof(loc_path) - 1, "%s/%s", resource->path, location);
      }
     } else {
      ap_php_snprintf(loc_path, sizeof(loc_path) - 1, "/%s", location);
     }
    } else {
     php_strlcpy(loc_path, location, sizeof(loc_path));
    }
    if ((use_ssl && resource->port != 443) || (!use_ssl && resource->port != 80)) {
     ap_php_snprintf(new_path, sizeof(new_path) - 1, "%s://%s:%d%s", resource->scheme, resource->host, resource->port, loc_path);
    } else {
     ap_php_snprintf(new_path, sizeof(new_path) - 1, "%s://%s%s", resource->scheme, resource->host, loc_path);
    }
   } else {
    php_strlcpy(new_path, location, sizeof(new_path));
   }

   php_url_free(resource);

   if ((resource = php_url_parse(new_path)) == ((void *)0)) {
    php_stream_wrapper_log_error(wrapper, options, "Invalid redirect URL! %s", new_path);
    goto out;
   }
# 885 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/http_fopen_wrapper.c"
   if (strncasecmp(new_path, "http://", sizeof("http://") - 1) || strncasecmp(new_path, "https://", sizeof("https://") - 1)) {
    { if (resource->user) { unsigned char *s, *e; size_t l; l = php_url_decode(resource->user, strlen(resource->user)); s = (unsigned char*)resource->user; e = s + l; while (s < e) { if (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _IScntrl)) { php_stream_wrapper_log_error(wrapper, options, "Invalid redirect URL! %s", new_path); goto out; } s++; } } }
    { if (resource->pass) { unsigned char *s, *e; size_t l; l = php_url_decode(resource->pass, strlen(resource->pass)); s = (unsigned char*)resource->pass; e = s + l; while (s < e) { if (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _IScntrl)) { php_stream_wrapper_log_error(wrapper, options, "Invalid redirect URL! %s", new_path); goto out; } s++; } } }
    { if (resource->path) { unsigned char *s, *e; size_t l; l = php_url_decode(resource->path, strlen(resource->path)); s = (unsigned char*)resource->path; e = s + l; while (s < e) { if (((*__ctype_b_loc ())[(int) ((*s))] & (unsigned short int) _IScntrl)) { php_stream_wrapper_log_error(wrapper, options, "Invalid redirect URL! %s", new_path); goto out; } s++; } } }
   }
   stream = php_stream_url_wrap_http_ex(wrapper, new_path, mode, options, opened_path, context, --redirect_max, 2 );
  } else {
...
out:
 if (protocol_version) {
  _efree((protocol_version) );
 }

 if (http_header_line) {
  _efree((http_header_line) );
 }
 ...
 if (stream) {
  if (header_init) {
   do { zval *_z1 = (&stream->wrapperdata); const zval *_z2 = (&response_header); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
  ...
  if (options & 0x00000020)
   _php_stream_set_option((stream), 5, ((int)chunk_size), ((void *)0));
  ...
  php_strlcpy(stream->mode, mode, sizeof(stream->mode));

  if (transfer_encoding) {
   _php_stream_filter_append((&stream->readfilters), (transfer_encoding));
  }
 } else {
  if (transfer_encoding) {
 ...
 _zval_ptr_dtor((&response_header) );
...
php_stream *php_stream_url_wrap_http(php_stream_wrapper *wrapper, const char *path, const char *mode, int options, zend_string **opened_path, php_stream_context *context )
{
 return php_stream_url_wrap_http_ex(wrapper, path, mode, options, opened_path, context, 20, 1 );
}
...
__attribute__ ((visibility("default"))) php_stream_wrapper php_stream_http_wrapper = {
 &http_stream_wops,
 ((void *)0),
 1
};
