# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/uuencode.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/uuencode.c"
# 57 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/uuencode.c"
...
# 58 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/uuencode.c" 2
...
# 60 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/uuencode.c" 2
...
# 61 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/uuencode.c" 2
...
void zif_convert_uuencode(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "S", &src) == FAILURE || (src)->len < 1) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 { do { zval *__z = (return_value); zend_string *__s = (php_uuencode((src)->val, (src)->len)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
void zif_convert_uudecode(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if ((dest = php_uudecode((src)->val, (src)->len)) == ((void *)0)) {
  php_error_docref0(((void *)0), (1<<1L), "The given parameter is not a valid uuencoded string");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 { do { zval *__z = (return_value); zend_string *__s = (dest); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
