# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_engine.h" 1
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_engine.h"
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_engine.h" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.h"
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c" 2
...
# 64 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_dllist.c"
...
static inline spl_dllist_object *spl_dllist_from_obj(zend_object *obj) {
 return (spl_dllist_object*)((char*)(obj) - ((zend_long) (((char *) (&(((spl_dllist_object*)((void *)0))->std))) - ((char *) ((void *)0)))));
}
...
static void spl_ptr_llist_zval_dtor(spl_ptr_llist_element *elem) {
 if (!(zval_get_type(&(elem->data)) == 0)) {
  _zval_ptr_dtor((&elem->data) );
  do { (*(&elem->data)).u1.type_info = 0; } while (0);
 }
}


static void spl_ptr_llist_zval_ctor(spl_ptr_llist_element *elem) {
 if ((((elem->data).u1.v.type_flags & (1<<2)) != 0)) {
  zval_addref_p(&(elem->data));
 }
}
...
{
 spl_ptr_llist *llist = (__builtin_constant_p((sizeof(spl_ptr_llist)) ) ? (((sizeof(spl_ptr_llist)) <= 8) ? _emalloc_8() : (((sizeof(spl_ptr_llist)) <= 16) ? _emalloc_16() : (((sizeof(spl_ptr_llist)) <= 24) ? _emalloc_24() : (((sizeof(spl_ptr_llist)) <= 32) ? _emalloc_32() : (((sizeof(spl_ptr_llist)) <= 40) ? _emalloc_40() : (((sizeof(spl_ptr_llist)) <= 48) ? _emalloc_48() : (((sizeof(spl_ptr_llist)) <= 56) ? _emalloc_56() : (((sizeof(spl_ptr_llist)) <= 64) ? _emalloc_64() : (((sizeof(spl_ptr_llist)) <= 80) ? _emalloc_80() : (((sizeof(spl_ptr_llist)) <= 96) ? _emalloc_96() : (((sizeof(spl_ptr_llist)) <= 112) ? _emalloc_112() : (((sizeof(spl_ptr_llist)) <= 128) ? _emalloc_128() : (((sizeof(spl_ptr_llist)) <= 160) ? _emalloc_160() : (((sizeof(spl_ptr_llist)) <= 192) ? _emalloc_192() : (((sizeof(spl_ptr_llist)) <= 224) ? _emalloc_224() : (((sizeof(spl_ptr_llist)) <= 256) ? _emalloc_256() : (((sizeof(spl_ptr_llist)) <= 320) ? _emalloc_320() : (((sizeof(spl_ptr_llist)) <= 384) ? _emalloc_384() : (((sizeof(spl_ptr_llist)) <= 448) ? _emalloc_448() : (((sizeof(spl_ptr_llist)) <= 512) ? _emalloc_512() : (((sizeof(spl_ptr_llist)) <= 640) ? _emalloc_640() : (((sizeof(spl_ptr_llist)) <= 768) ? _emalloc_768() : (((sizeof(spl_ptr_llist)) <= 896) ? _emalloc_896() : (((sizeof(spl_ptr_llist)) <= 1024) ? _emalloc_1024() : (((sizeof(spl_ptr_llist)) <= 1280) ? _emalloc_1280() : (((sizeof(spl_ptr_llist)) <= 1536) ? _emalloc_1536() : (((sizeof(spl_ptr_llist)) <= 1792) ? _emalloc_1792() : (((sizeof(spl_ptr_llist)) <= 2048) ? _emalloc_2048() : (((sizeof(spl_ptr_llist)) <= 2560) ? _emalloc_2560() : (((sizeof(spl_ptr_llist)) <= 3072) ? _emalloc_3072() : (((sizeof(spl_ptr_llist)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(spl_ptr_llist))) : _emalloc_huge((sizeof(spl_ptr_llist)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(spl_ptr_llist)) ) );
...
{
 spl_ptr_llist_element *elem = (__builtin_constant_p((sizeof(spl_ptr_llist_element)) ) ? (((sizeof(spl_ptr_llist_element)) <= 8) ? _emalloc_8() : (((sizeof(spl_ptr_llist_element)) <= 16) ? _emalloc_16() : (((sizeof(spl_ptr_llist_element)) <= 24) ? _emalloc_24() : (((sizeof(spl_ptr_llist_element)) <= 32) ? _emalloc_32() : (((sizeof(spl_ptr_llist_element)) <= 40) ? _emalloc_40() : (((sizeof(spl_ptr_llist_element)) <= 48) ? _emalloc_48() : (((sizeof(spl_ptr_llist_element)) <= 56) ? _emalloc_56() : (((sizeof(spl_ptr_llist_element)) <= 64) ? _emalloc_64() : (((sizeof(spl_ptr_llist_element)) <= 80) ? _emalloc_80() : (((sizeof(spl_ptr_llist_element)) <= 96) ? _emalloc_96() : (((sizeof(spl_ptr_llist_element)) <= 112) ? _emalloc_112() : (((sizeof(spl_ptr_llist_element)) <= 128) ? _emalloc_128() : (((sizeof(spl_ptr_llist_element)) <= 160) ? _emalloc_160() : (((sizeof(spl_ptr_llist_element)) <= 192) ? _emalloc_192() : (((sizeof(spl_ptr_llist_element)) <= 224) ? _emalloc_224() : (((sizeof(spl_ptr_llist_element)) <= 256) ? _emalloc_256() : (((sizeof(spl_ptr_llist_element)) <= 320) ? _emalloc_320() : (((sizeof(spl_ptr_llist_element)) <= 384) ? _emalloc_384() : (((sizeof(spl_ptr_llist_element)) <= 448) ? _emalloc_448() : (((sizeof(spl_ptr_llist_element)) <= 512) ? _emalloc_512() : (((sizeof(spl_ptr_llist_element)) <= 640) ? _emalloc_640() : (((sizeof(spl_ptr_llist_element)) <= 768) ? _emalloc_768() : (((sizeof(spl_ptr_llist_element)) <= 896) ? _emalloc_896() : (((sizeof(spl_ptr_llist_element)) <= 1024) ? _emalloc_1024() : (((sizeof(spl_ptr_llist_element)) <= 1280) ? _emalloc_1280() : (((sizeof(spl_ptr_llist_element)) <= 1536) ? _emalloc_1536() : (((sizeof(spl_ptr_llist_element)) <= 1792) ? _emalloc_1792() : (((sizeof(spl_ptr_llist_element)) <= 2048) ? _emalloc_2048() : (((sizeof(spl_ptr_llist_element)) <= 2560) ? _emalloc_2560() : (((sizeof(spl_ptr_llist_element)) <= 3072) ? _emalloc_3072() : (((sizeof(spl_ptr_llist_element)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(spl_ptr_llist_element))) : _emalloc_huge((sizeof(spl_ptr_llist_element)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(spl_ptr_llist_element)) ) );

 elem->rc = 1;
 elem->prev = ((void *)0);
 elem->next = llist->head;
 do { zval *_z1 = (&elem->data); const zval *_z2 = (data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
static void spl_ptr_llist_pop(spl_ptr_llist *llist, zval *ret)
{
 ...
 llist->count--;
 do { zval *_z1 = (ret); const zval *_z2 = (&tail->data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

 if (llist->dtor) {
  llist->dtor(tail);
 }

 do { (*(&tail->data)).u1.type_info = 0; } while (0);

 if(!--(tail)->rc) { _efree((tail) ); };
}
...
static void spl_ptr_llist_shift(spl_ptr_llist *llist, zval *ret)
{
 ...
 llist->count--;
 do { zval *_z1 = (ret); const zval *_z2 = (&head->data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);

 if (llist->dtor) {
  llist->dtor(head);
 }
 do { (*(&head->data)).u1.type_info = 0; } while (0);

 if(!--(head)->rc) { _efree((head) ); };
}
...
static void spl_dllist_object_free_storage(zend_object *object)
{
 ...
 if (intern->gc_data != ((void *)0)) {
  _efree((intern->gc_data) );
 };

 spl_ptr_llist_destroy(intern->llist);
 if((intern->traverse_pointer) && !--(intern->traverse_pointer)->rc) { _efree((intern->traverse_pointer) ); };
}
...
static zend_object *spl_dllist_object_new_ex(zend_class_entry *class_type, zval *orig, int clone_orig)
{
 ...
 intern = _ecalloc((1), (sizeof(spl_dllist_object) + zend_object_properties_size(parent)) );
 ...
 if (orig) {
  spl_dllist_object *other = spl_dllist_from_obj((*((orig))).value.obj);
...
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((object))).value.obj);
...
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((obj))).value.obj);
 ...
 *is_temp = 1;
 ...
 _zend_hash_init((debug_info), (1), (_zval_ptr_dtor), (0) );
 zend_hash_copy(debug_info, intern->std.properties, (copy_ctor_func_t) zval_add_ref);

 pnstr = spl_gen_private_prop_name(spl_ce_SplDoublyLinkedList, "flags", sizeof("flags")-1);
 { zval *__z = (&tmp); (*(__z)).value.lval = intern->flags; (*(__z)).u1.type_info = 4; };
 _zend_hash_add(debug_info, pnstr, &tmp );
 ...
 while (current) {
  ...
  if ((((current->data).u1.v.type_flags & (1<<2)) != 0)) {
 ...
 _zend_hash_add(debug_info, pnstr, &dllist_array );
 zend_string_release(pnstr);
...
static HashTable *spl_dllist_object_get_gc(zval *obj, zval **gc_data, int *gc_data_count)
{
 ...
 if (intern->gc_data_count < intern->llist->count) {
  ...
  intern->gc_data = _safe_erealloc((intern->gc_data), (intern->gc_data_count), (sizeof(zval)), (0) );
 }

 while (current) {
  do { zval *_z1 = (&intern->gc_data[i++]); const zval *_z2 = (&current->data); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  current = current->next;
 }
...
void zim_spl_SplDoublyLinkedList_push(zend_execute_data *execute_data, zval *return_value)
{
 zval *value;
 spl_dllist_object *intern;
 ...
 intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_SplDoublyLinkedList_unshift(zend_execute_data *execute_data, zval *return_value)
{
 zval *value;
 spl_dllist_object *intern;
...
void zim_spl_SplDoublyLinkedList_pop(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern;
...
void zim_spl_SplDoublyLinkedList_shift(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern;
...
void zim_spl_SplDoublyLinkedList_top(zend_execute_data *execute_data, zval *return_value)
{
 zval *value;
 spl_dllist_object *intern;
 ...
 if (value == ((void *)0) || (zval_get_type(&(*(value))) == 0)) {
...
void zim_spl_SplDoublyLinkedList_bottom(zend_execute_data *execute_data, zval *return_value)
{
 zval *value;
 spl_dllist_object *intern;
...
void zim_spl_SplDoublyLinkedList_count(zend_execute_data *execute_data, zval *return_value)
{
 zend_long count;
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_SplDoublyLinkedList_isEmpty(zend_execute_data *execute_data, zval *return_value)
{
 zend_long count;
 ...
 spl_dllist_object_count_elements(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), &count);
 { do { (*(return_value)).u1.type_info = (count == 0) ? 3 : 2; } while (0); return; };
}




void zim_spl_SplDoublyLinkedList_setIteratorMode(zend_execute_data *execute_data, zval *return_value)
{
 zend_long value;
 spl_dllist_object *intern;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &value) == FAILURE) {
  return;
 }
...
void zim_spl_SplDoublyLinkedList_getIteratorMode(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern;
...
void zim_spl_SplDoublyLinkedList_offsetExists(zend_execute_data *execute_data, zval *return_value)
{
 zval *zindex;
 spl_dllist_object *intern;
 zend_long index;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &zindex) == FAILURE) {
  return;
 }
 ...
 { do { (*(return_value)).u1.type_info = (index >= 0 && index < intern->llist->count) ? 3 : 2; } while (0); return; };
}



void zim_spl_SplDoublyLinkedList_offsetGet(zend_execute_data *execute_data, zval *return_value)
{
 zval *zindex;
 zend_long index;
 spl_dllist_object *intern;
...
void zim_spl_SplDoublyLinkedList_offsetSet(zend_execute_data *execute_data, zval *return_value)
{
 zval *zindex, *value;
 spl_dllist_object *intern;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "zz", &zindex, &value) == FAILURE) {
  return;
 }

 intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);

 if (zval_get_type(&(*(zindex))) == 1) {
  ...
  if (element != ((void *)0)) {
   ...
   _zval_ptr_dtor((&element->data) );
   do { zval *_z1 = (&element->data); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
...
void zim_spl_SplDoublyLinkedList_offsetUnset(zend_execute_data *execute_data, zval *return_value)
{
 zval *zindex;
 zend_long index;
 spl_dllist_object *intern;
 ...
 if (element != ((void *)0)) {
  ...
  if (intern->traverse_pointer == element) {
   if(!--(element)->rc) { _efree((element) ); };
   intern->traverse_pointer = ((void *)0);
  }
  _zval_ptr_dtor((&element->data) );
  do { (*(&element->data)).u1.type_info = 0; } while (0);
...
static void spl_dllist_it_dtor(zend_object_iterator *iter)
{
 ...
 if((iterator->traverse_pointer) && !--(iterator->traverse_pointer)->rc) { _efree((iterator->traverse_pointer) ); };

 zend_user_it_invalidate_current(iter);
 _zval_ptr_dtor((&iterator->intern.it.data) );
}
...
{
 if((*traverse_pointer_ptr) && !--(*traverse_pointer_ptr)->rc) { _efree((*traverse_pointer_ptr) ); };
...
{
 spl_dllist_it *iterator = (spl_dllist_it *)iter;
 spl_dllist_object *object = spl_dllist_from_obj((*((&iter->data))).value.obj);
...
static zval *spl_dllist_it_get_current_data(zend_object_iterator *iter)
{
 ...
 if (element == ((void *)0) || (zval_get_type(&(element->data)) == 0)) {
  return ((void *)0);
 }
...
static void spl_dllist_it_get_current_key(zend_object_iterator *iter, zval *key)
{
 ...
 { zval *__z = (key); (*(__z)).value.lval = iterator->traverse_position; (*(__z)).u1.type_info = 4; };
}
...
void zim_spl_SplDoublyLinkedList_key(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 { { zval *__z = (return_value); (*(__z)).value.lval = intern->traverse_position; (*(__z)).u1.type_info = 4; }; return; };
}




void zim_spl_SplDoublyLinkedList_prev(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_SplDoublyLinkedList_next(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_SplDoublyLinkedList_valid(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 { do { (*(return_value)).u1.type_info = (intern->traverse_pointer != ((void *)0)) ? 3 : 2; } while (0); return; };
}




void zim_spl_SplDoublyLinkedList_rewind(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_SplDoublyLinkedList_current(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
void zim_spl_SplDoublyLinkedList_serialize(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 smart_str buf = {0};
 spl_ptr_llist_element *current = intern->llist->head, *next;
 ...
 { zval *__z = (&flags); (*(__z)).value.lval = intern->flags; (*(__z)).u1.type_info = 4; };
...
void zim_spl_SplDoublyLinkedList_unserialize(zend_execute_data *execute_data, zval *return_value)
{
 spl_dllist_object *intern = spl_dllist_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 zval *flags, *elem;
 char *buf;
 ...
 if (!php_var_unserialize(flags, &p, s + buf_len, &var_hash) || zval_get_type(&(*(flags))) != 4) {
  goto error;
 }

 intern->flags = (int)(*(flags)).value.lval;
...
void zim_spl_SplDoublyLinkedList_add(zend_execute_data *execute_data, zval *return_value)
{
 zval *zindex, *value;
 spl_dllist_object *intern;
 spl_ptr_llist_element *element;
 ...
 if (index == intern->llist->count) {
  ...
  do { zval *_z1 = (&elem->data); const zval *_z2 = (value); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  elem->rc = 1;
...
zend_object_iterator *spl_dllist_get_iterator(zend_class_entry *ce, zval *object, int by_ref)
{
 ...
 spl_dllist_object *dllist_object = spl_dllist_from_obj((*((object))).value.obj);
 ...
 iterator = (__builtin_constant_p((sizeof(spl_dllist_it)) ) ? (((sizeof(spl_dllist_it)) <= 8) ? _emalloc_8() : (((sizeof(spl_dllist_it)) <= 16) ? _emalloc_16() : (((sizeof(spl_dllist_it)) <= 24) ? _emalloc_24() : (((sizeof(spl_dllist_it)) <= 32) ? _emalloc_32() : (((sizeof(spl_dllist_it)) <= 40) ? _emalloc_40() : (((sizeof(spl_dllist_it)) <= 48) ? _emalloc_48() : (((sizeof(spl_dllist_it)) <= 56) ? _emalloc_56() : (((sizeof(spl_dllist_it)) <= 64) ? _emalloc_64() : (((sizeof(spl_dllist_it)) <= 80) ? _emalloc_80() : (((sizeof(spl_dllist_it)) <= 96) ? _emalloc_96() : (((sizeof(spl_dllist_it)) <= 112) ? _emalloc_112() : (((sizeof(spl_dllist_it)) <= 128) ? _emalloc_128() : (((sizeof(spl_dllist_it)) <= 160) ? _emalloc_160() : (((sizeof(spl_dllist_it)) <= 192) ? _emalloc_192() : (((sizeof(spl_dllist_it)) <= 224) ? _emalloc_224() : (((sizeof(spl_dllist_it)) <= 256) ? _emalloc_256() : (((sizeof(spl_dllist_it)) <= 320) ? _emalloc_320() : (((sizeof(spl_dllist_it)) <= 384) ? _emalloc_384() : (((sizeof(spl_dllist_it)) <= 448) ? _emalloc_448() : (((sizeof(spl_dllist_it)) <= 512) ? _emalloc_512() : (((sizeof(spl_dllist_it)) <= 640) ? _emalloc_640() : (((sizeof(spl_dllist_it)) <= 768) ? _emalloc_768() : (((sizeof(spl_dllist_it)) <= 896) ? _emalloc_896() : (((sizeof(spl_dllist_it)) <= 1024) ? _emalloc_1024() : (((sizeof(spl_dllist_it)) <= 1280) ? _emalloc_1280() : (((sizeof(spl_dllist_it)) <= 1536) ? _emalloc_1536() : (((sizeof(spl_dllist_it)) <= 1792) ? _emalloc_1792() : (((sizeof(spl_dllist_it)) <= 2048) ? _emalloc_2048() : (((sizeof(spl_dllist_it)) <= 2560) ? _emalloc_2560() : (((sizeof(spl_dllist_it)) <= 3072) ? _emalloc_3072() : (((sizeof(spl_dllist_it)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(spl_dllist_it))) : _emalloc_huge((sizeof(spl_dllist_it)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(spl_dllist_it)) ) );

 zend_iterator_init((zend_object_iterator*)iterator);

 do { zval *_z1 = (&iterator->intern.it.data); const zval *_z2 = (object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
 ...
 do { (*(&iterator->intern.value)).u1.type_info = 0; } while (0);
...
static const zend_internal_arg_info arginfo_dllist_setiteratormode[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_dllist_push[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "value", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_dllist_offsetGet[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "index", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_dllist_offsetSet[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "index", ((void *)0), 0, 0, 0, 0 },
 { "newval", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_dllist_void[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_dllist_serialized[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "serialized", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_function_entry spl_funcs_SplQueue[] = {
 { "enqueue", zim_spl_SplDoublyLinkedList_push, arginfo_dllist_push, (uint32_t) (sizeof(arginfo_dllist_push)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "dequeue", zim_spl_SplDoublyLinkedList_shift, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_function_entry spl_funcs_SplDoublyLinkedList[] = {
 { "pop", zim_spl_SplDoublyLinkedList_pop, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "shift", zim_spl_SplDoublyLinkedList_shift, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "push", zim_spl_SplDoublyLinkedList_push, arginfo_dllist_push, (uint32_t) (sizeof(arginfo_dllist_push)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "unshift", zim_spl_SplDoublyLinkedList_unshift, arginfo_dllist_push, (uint32_t) (sizeof(arginfo_dllist_push)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "top", zim_spl_SplDoublyLinkedList_top, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "bottom", zim_spl_SplDoublyLinkedList_bottom, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "isEmpty", zim_spl_SplDoublyLinkedList_isEmpty, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setIteratorMode", zim_spl_SplDoublyLinkedList_setIteratorMode, arginfo_dllist_setiteratormode, (uint32_t) (sizeof(arginfo_dllist_setiteratormode)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getIteratorMode", zim_spl_SplDoublyLinkedList_getIteratorMode, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },

 { "count", zim_spl_SplDoublyLinkedList_count, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },

 { "offsetExists", zim_spl_SplDoublyLinkedList_offsetExists, arginfo_dllist_offsetGet, (uint32_t) (sizeof(arginfo_dllist_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetGet", zim_spl_SplDoublyLinkedList_offsetGet, arginfo_dllist_offsetGet, (uint32_t) (sizeof(arginfo_dllist_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetSet", zim_spl_SplDoublyLinkedList_offsetSet, arginfo_dllist_offsetSet, (uint32_t) (sizeof(arginfo_dllist_offsetSet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetUnset", zim_spl_SplDoublyLinkedList_offsetUnset, arginfo_dllist_offsetGet, (uint32_t) (sizeof(arginfo_dllist_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },

 { "add", zim_spl_SplDoublyLinkedList_add, arginfo_dllist_offsetSet, (uint32_t) (sizeof(arginfo_dllist_offsetSet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },


 { "rewind", zim_spl_SplDoublyLinkedList_rewind, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_SplDoublyLinkedList_current, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_SplDoublyLinkedList_key, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_SplDoublyLinkedList_next, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "prev", zim_spl_SplDoublyLinkedList_prev, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_SplDoublyLinkedList_valid, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },

 { "unserialize", zim_spl_SplDoublyLinkedList_unserialize, arginfo_dllist_serialized, (uint32_t) (sizeof(arginfo_dllist_serialized)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "serialize", zim_spl_SplDoublyLinkedList_serialize, arginfo_dllist_void, (uint32_t) (sizeof(arginfo_dllist_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
int zm_startup_spl_dllist(int type, int module_number)
{
 ...
 spl_handler_SplDoublyLinkedList.offset = ((zend_long) (((char *) (&(((spl_dllist_object*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 zend_declare_class_constant_long(spl_ce_SplDoublyLinkedList, "IT_MODE_LIFO", sizeof("IT_MODE_LIFO")-1, (zend_long)0x00000002);;
 zend_declare_class_constant_long(spl_ce_SplDoublyLinkedList, "IT_MODE_FIFO", sizeof("IT_MODE_FIFO")-1, (zend_long)0);;
 zend_declare_class_constant_long(spl_ce_SplDoublyLinkedList, "IT_MODE_DELETE", sizeof("IT_MODE_DELETE")-1, (zend_long)0x00000001);;
 zend_declare_class_constant_long(spl_ce_SplDoublyLinkedList, "IT_MODE_KEEP", sizeof("IT_MODE_KEEP")-1, (zend_long)0);;
