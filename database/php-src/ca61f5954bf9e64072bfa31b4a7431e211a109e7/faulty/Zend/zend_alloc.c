...
{
 void *ptr;
# 1361 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
 if (size <= 3072) {
  ptr = zend_mm_alloc_small(heap, size, zend_mm_small_size_to_bin(size) );
# 1371 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
  return ptr;
 } else if (size <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) {
  ptr = zend_mm_alloc_large(heap, size );
# 1382 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
  return ptr;
 } else {
...
# 1476 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
...
# 1561 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
    return ptr;
   }
  } else {
   do { if (__builtin_expect(!!(!((((size_t)(page_offset)) & (((4 * 1024)) - 1)) == 0)), 0)) { zend_mm_panic("zend_mm_heap corrupted"); } } while (0);
   ...
   if (size > 3072 && size <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) {
    ...
    if (new_size == old_size) {
# 1577 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
     return ptr;
    } else if (new_size < old_size) {
...
# 1597 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
     return ptr;
    } else {
     int new_pages_count = (int)(new_size / (4 * 1024));
     ...
     if (page_num + new_pages_count <= ((2 * 1024 * 1024) / (4 * 1024)) &&
      ...
      chunk->map[page_num] = (0x40000000 | ((new_pages_count) << 0));
# 1624 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
      return ptr;
     }
    }
   }
...
# 1658 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
...
# 2177 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
...
# 2202 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
 list = heap->huge_list;
 heap->huge_list = ((void *)0);
 while (list) {
...
# 2365 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
...
# 2407 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
...
# 2662 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
__attribute__ ((visibility("default"))) void start_memory_manager(void)
{
...
# 2757 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_alloc.c"
__attribute__ ((visibility("default"))) zend_mm_storage *zend_mm_get_storage(zend_mm_heap *heap)
{
