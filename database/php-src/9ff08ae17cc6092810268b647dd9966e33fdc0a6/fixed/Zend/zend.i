...
int zend_startup(zend_utility_functions *utility_functions, char **extensions)
{
 ...
 zend_version_info = strdup("Zend Engine v" "3.0.0" ", Copyright (c) 1998-2016 Zend Technologies\n");
 zend_version_info_length = sizeof("Zend Engine v" "3.0.0" ", Copyright (c) 1998-2016 Zend Technologies\n") - 1;
...
# 991 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
