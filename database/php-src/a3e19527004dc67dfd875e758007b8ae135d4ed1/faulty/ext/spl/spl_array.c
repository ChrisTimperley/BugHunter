# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c" 2
...
# 64 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c"
...
static inline spl_array_object *spl_array_from_obj(zend_object *obj) {
 return (spl_array_object*)((char*)(obj) - ((zend_long) (((char *) (&(((spl_array_object*)((void *)0))->std))) - ((char *) ((void *)0)))));
}
...
static inline HashTable *spl_array_get_hash_table(spl_array_object* intern, int check_std_props) {
 if (intern->ar_flags & 0x01000000
  || (check_std_props && (intern->ar_flags & 0x00000001))
 ) {
  if (!intern->std.properties) {
   rebuild_object_properties(&intern->std);
  }
  return intern->std.properties;
 } else if (intern->ar_flags & 0x02000000) {
  spl_array_object *other = spl_array_from_obj((*((&intern->array))).value.obj);
  return spl_array_get_hash_table(other, check_std_props);
 } else {
  return (zval_get_type(&(*(&intern->array)))==7 ? (*(&intern->array)).value.arr : ((zval_get_type(&(*(&intern->array)))==8 ? (*(&intern->array)).value.obj->handlers->get_properties((&intern->array)) : ((void *)0))));
 }
}

static inline zend_bool spl_array_is_object(spl_array_object *intern)
{
 while (intern->ar_flags & 0x02000000) {
  intern = spl_array_from_obj((*((&intern->array))).value.obj);
 }
 return (intern->ar_flags & 0x01000000) || zval_get_type(&(intern->array)) == 8;
}


static int spl_array_skip_protected(spl_array_object *intern, HashTable *aht);

static __attribute__((noinline)) void spl_array_create_ht_iter(HashTable *ht, spl_array_object* intern)
{
 intern->ht_iter = zend_hash_iterator_add(ht, ht->nInternalPointer);
 zend_hash_internal_pointer_reset_ex(ht, &(executor_globals.ht_iterators)[intern->ht_iter].pos);
 spl_array_skip_protected(intern, ht);
}


static inline __attribute__((always_inline)) uint32_t *spl_array_get_pos_ptr(HashTable *ht, spl_array_object* intern)
{
 if (__builtin_expect(!!(intern->ht_iter == (uint32_t)-1), 0)) {
  spl_array_create_ht_iter(ht, intern);
 }
 return &(executor_globals.ht_iterators)[intern->ht_iter].pos;
}
...
static zend_object *spl_array_object_new_ex(zend_class_entry *class_type, zval *orig, int clone_orig)
{
 ...
 intern = _ecalloc((1), (sizeof(spl_array_object) + zend_object_properties_size(parent)) );
 ...
 if (orig) {
  ...
  intern->ar_flags &= ~ 0x0100FFFF;
  intern->ar_flags |= (other->ar_flags & 0x0100FFFF);
  intern->ce_get_iterator = other->ce_get_iterator;
  if (clone_orig) {
   if (other->ar_flags & 0x01000000) {
    do { (*(&intern->array)).u1.type_info = 0; } while (0);
   } else if ((*(orig)).value.obj->handlers == &spl_handler_ArrayObject) {
    do { zval *__z = (&intern->array); (*(__z)).value.arr = (zend_array_dup((zval_get_type(&(*(&other->array)))==7 ? (*(&other->array)).value.arr : ((zval_get_type(&(*(&other->array)))==8 ? (*(&other->array)).value.obj->handlers->get_properties((&other->array)) : ((void *)0)))))); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
   } else {
    do { if (__builtin_expect(!((*(orig)).value.obj->handlers == &spl_handler_ArrayIterator), 0)) __builtin_unreachable(); } while (0);
    do { zval *_z1 = (&intern->array); const zval *_z2 = (&other->array); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   }
  } else {
   do { zval *_z1 = (&intern->array); const zval *_z2 = (orig); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
fetch_dim_string:
  ...
  return retval;
 case 9:
  zend_error((1<<3L), "Resource ID#%pd used as offset, casting to integer (%pd)", (*offset).value.res->handle, (*offset).value.res->handle);
...
num_index:
  if ((retval = zend_hash_index_find(ht, index)) == ((void *)0)) {
   switch (type) {
    case 0:
     zend_error((1<<3L), "Undefined offset: %pd", index);
    case 5:
    case 3:
     retval = &(executor_globals.uninitialized_zval);
     break;
 ...
 if (check_inherited) {
  ...
  if (intern->fptr_offset_get) {
   ...
   if (!offset) {
    ...
    do { do { if (__builtin_expect(!!((zval_get_type(&(*(offset))) == 10)), 0)) { (offset) = &(*(offset)).value.ref->val; } } while (0); if ((((*(offset)).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p(offset); } } while (0);
   }
   zend_call_method(object, ((*(object)).value.obj->ce), &intern->fptr_offset_get, "offsetGet", sizeof("offsetGet")-1, rv, 1, offset, ((void *)0));
...
static void spl_array_write_dimension_ex(int check_inherited, zval *object, zval *offset, zval *value)
{
 ...
 if (check_inherited && intern->fptr_offset_set) {
  ...
  zend_call_method(object, ((*(object)).value.obj->ce), &intern->fptr_offset_set, "offsetSet", sizeof("offsetSet")-1, ((void *)0), 2, offset, value);
  _zval_ptr_dtor((offset) );
  return;
 }
...
static void spl_array_unset_dimension_ex(int check_inherited, zval *object, zval *offset)
{
 ...
 if (check_inherited && intern->fptr_offset_del) {
  do { do { if (__builtin_expect(!!((zval_get_type(&(*(offset))) == 10)), 0)) { (offset) = &(*(offset)).value.ref->val; } } while (0); if ((((*(offset)).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p(offset); } } while (0);
  zend_call_method(object, ((*(object)).value.obj->ce), &intern->fptr_offset_del, "offsetUnset", sizeof("offsetUnset")-1, ((void *)0), 1, offset, ((void *)0));
  _zval_ptr_dtor((offset) );
  return;
 }
...
static int spl_array_has_dimension_ex(int check_inherited, zval *object, zval *offset, int check_empty)
{
 ...
 if (check_inherited && intern->fptr_offset_has) {
  do { do { if (__builtin_expect(!!((zval_get_type(&(*(offset))) == 10)), 0)) { (offset) = &(*(offset)).value.ref->val; } } while (0); if ((((*(offset)).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p(offset); } } while (0);
  zend_call_method(object, ((*(object)).value.obj->ce), &intern->fptr_offset_has, "offsetExists", sizeof("offsetExists")-1, &rv, 1, offset, ((void *)0));
  _zval_ptr_dtor((offset) );
...
num_index:
 ...
 {
  zend_bool result = check_empty ? zend_is_true(value) : zval_get_type(&(*(value))) != 1;
  if (value == &rv) {
   _zval_ptr_dtor((&rv) );
  }
  return result;
...
void zim_spl_Array_offsetExists(zend_execute_data *execute_data, zval *return_value)
{
 zval *index;
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &index) == FAILURE) {
  return;
 }
 { do { (*(return_value)).u1.type_info = (spl_array_has_dimension_ex(0, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), index, 2)) ? 3 : 2; } while (0); return; };
}




void zim_spl_Array_offsetGet(zend_execute_data *execute_data, zval *return_value)
{
 zval *value, *index;
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &index) == FAILURE) {
  return;
 }
 value = spl_array_read_dimension_ex(0, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), index, 0, return_value);
...
void zim_spl_Array_offsetSet(zend_execute_data *execute_data, zval *return_value)
{
 zval *index, *value;
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "zz", &index, &value) == FAILURE) {
  return;
 }
 spl_array_write_dimension_ex(0, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), index, value);
}
...
void spl_array_iterator_append(zval *object, zval *append_value)
{
 ...
 if (spl_array_is_object(intern)) {
  php_error_docref0(((void *)0), (1<<12L), "Cannot append properties to objects, use %s::offsetSet() instead", (((*(object)).value.obj->ce)->name)->val);
  return;
 }
...
void zim_spl_Array_append(zend_execute_data *execute_data, zval *return_value)
{
 zval *value;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &value) == FAILURE) {
  return;
 }
 spl_array_iterator_append(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), value);
}




void zim_spl_Array_offsetUnset(zend_execute_data *execute_data, zval *return_value)
{
 zval *index;
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "z", &index) == FAILURE) {
  return;
 }
 spl_array_unset_dimension_ex(0, ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), index);
}




void zim_spl_Array_getArrayCopy(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);

 { do { zval *__z = (return_value); (*(__z)).value.arr = (zend_array_dup(spl_array_get_hash_table(intern, 0))); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0); return; };
}
...
static HashTable* spl_array_get_debug_info(zval *obj, int *is_temp)
{
  ...
  *is_temp = 1;
  ...
  _zend_hash_init((debug_info), ((intern->std.properties)->nNumOfElements + 1), (_zval_ptr_dtor), (0) );
  zend_hash_copy(debug_info, intern->std.properties, (copy_ctor_func_t) zval_add_ref);

  storage = &intern->array;
  do { if ((((*((storage))).u1.v.type_flags & (1<<2)) != 0)) { zval_addref_p((storage)); } } while (0);

  base = (*(obj)).value.obj->handlers == &spl_handler_ArrayIterator
...
static zval *spl_array_read_property(zval *object, zval *member, int type, void **cache_slot, zval *rv)
{
 ...
 if ((intern->ar_flags & 0x00000002) != 0
  && !std_object_handlers.has_property(object, member, 2, ((void *)0))) {
...
static int spl_array_skip_protected(spl_array_object *intern, HashTable *aht)
{
 ...
 if (spl_array_is_object(intern)) {
  ...
  do {
   if (zend_hash_get_current_key_ex(aht, &string_key, &num_key, pos_ptr) == 1) {
   ...
   if ((zend_hash_get_current_key_type_ex(aht, pos_ptr) == 3 ? FAILURE : SUCCESS) != SUCCESS) {
    return FAILURE;
   }
...
static int spl_array_next_ex(spl_array_object *intern, HashTable *aht)
{
 ...
 if (spl_array_is_object(intern)) {
  ...
  return (zend_hash_get_current_key_type_ex(aht, pos_ptr) == 3 ? FAILURE : SUCCESS);
 }
}
...
static int spl_array_it_valid(zend_object_iterator *iter)
{
 ...
 if (object->ar_flags & 0x00020000) {
  ...
  return (zend_hash_get_current_key_type_ex(aht, spl_array_get_pos_ptr(aht, object)) == 3 ? FAILURE : SUCCESS);
 }
}
...
static void spl_array_set_array(zval *object, spl_array_object *intern, zval *array, zend_long ar_flags, int just_array) {
 ...
 if (zval_get_type(&(*(array))) == 7) {
  ...
  do { zval *_z1 = (&intern->array); const zval *_z2 = (array); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & (((1<<2)|(1<<1)) << 8)) != 0) { if ((_t & (((1<<4)|(1<<1)) << 8)) != 0) { _zval_copy_ctor_func(_z1 ); } else { (_gc)->gc.refcount++; } } } while (0);
 } else {
  if ((*(array)).value.obj->handlers == &spl_handler_ArrayObject || (*(array)).value.obj->handlers == &spl_handler_ArrayIterator) {
   ...
   if ((*(object)).value.obj == (*(array)).value.obj) {
    ...
    ar_flags |= 0x02000000;
    do { zval *_z1 = (&intern->array); const zval *_z2 = (array); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
   }
  } else {
   ...
   if (handler != std_object_handlers.get_properties
    ...
    do { (*(&intern->array)).u1.type_info = 0; } while (0);
    zend_throw_exception_ex(spl_ce_InvalidArgumentException, 0, "Overloaded object of type %s is not compatible with %s", ((*(array)).value.obj->ce)->name, intern->std.ce->name);
   }

   if ((*(array)).value.obj->properties && ((*(array)).value.obj->properties)->gc.refcount > 1) {
    if (__builtin_expect(!!(!(((*(array)).value.obj->properties)->gc.u.v.flags & (1<<1))), 1)) {
     ((*(array)).value.obj->properties)->gc.refcount--;
    }
    (*(array)).value.obj->properties = zend_array_dup((*(array)).value.obj->properties);
   }
   do { zval *_z1 = (&intern->array); const zval *_z2 = (array); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
  }
 }

 intern->ar_flags &= ~0x01000000 & ~0x02000000;
...
zend_object_iterator *spl_array_get_iterator(zend_class_entry *ce, zval *object, int by_ref)
{
 ...
 iterator = (__builtin_constant_p((sizeof(zend_user_iterator)) ) ? (((sizeof(zend_user_iterator)) <= 8) ? _emalloc_8() : (((sizeof(zend_user_iterator)) <= 16) ? _emalloc_16() : (((sizeof(zend_user_iterator)) <= 24) ? _emalloc_24() : (((sizeof(zend_user_iterator)) <= 32) ? _emalloc_32() : (((sizeof(zend_user_iterator)) <= 40) ? _emalloc_40() : (((sizeof(zend_user_iterator)) <= 48) ? _emalloc_48() : (((sizeof(zend_user_iterator)) <= 56) ? _emalloc_56() : (((sizeof(zend_user_iterator)) <= 64) ? _emalloc_64() : (((sizeof(zend_user_iterator)) <= 80) ? _emalloc_80() : (((sizeof(zend_user_iterator)) <= 96) ? _emalloc_96() : (((sizeof(zend_user_iterator)) <= 112) ? _emalloc_112() : (((sizeof(zend_user_iterator)) <= 128) ? _emalloc_128() : (((sizeof(zend_user_iterator)) <= 160) ? _emalloc_160() : (((sizeof(zend_user_iterator)) <= 192) ? _emalloc_192() : (((sizeof(zend_user_iterator)) <= 224) ? _emalloc_224() : (((sizeof(zend_user_iterator)) <= 256) ? _emalloc_256() : (((sizeof(zend_user_iterator)) <= 320) ? _emalloc_320() : (((sizeof(zend_user_iterator)) <= 384) ? _emalloc_384() : (((sizeof(zend_user_iterator)) <= 448) ? _emalloc_448() : (((sizeof(zend_user_iterator)) <= 512) ? _emalloc_512() : (((sizeof(zend_user_iterator)) <= 640) ? _emalloc_640() : (((sizeof(zend_user_iterator)) <= 768) ? _emalloc_768() : (((sizeof(zend_user_iterator)) <= 896) ? _emalloc_896() : (((sizeof(zend_user_iterator)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_user_iterator)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_user_iterator)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_user_iterator)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_user_iterator)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_user_iterator)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_user_iterator)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_user_iterator)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_user_iterator))) : _emalloc_huge((sizeof(zend_user_iterator)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_user_iterator)) ) );

 zend_iterator_init(&iterator->it);

 do { zval *_z1 = (&iterator->it.data); const zval *_z2 = (object); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
...
void zim_spl_Array___construct(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern;
 zval *array;
 ...
 if (zend_parse_parameters_throw((execute_data)->This.u2.num_args, "z|lC", &array, &ar_flags, &ce_get_iterator) == FAILURE) {
  return;
 }
 ...
 spl_array_set_array(object, intern, array, ar_flags, (execute_data)->This.u2.num_args == 1);
}




void zim_spl_Array_setIteratorClass(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 zend_class_entry * ce_get_iterator = zend_ce_iterator;
...
void zim_spl_Array_getIteratorClass(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 ...
 { do { zval *__z = (return_value); zend_string *__s = (intern->ce_get_iterator->name); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}




void zim_spl_Array_getFlags(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
...
void zim_spl_Array_setFlags(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 zend_long ar_flags = 0;

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &ar_flags) == FAILURE) {
  return;
 }
...
void zim_spl_Array_exchangeArray(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), *array;
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 ...
 do { zval *__z = (return_value); (*(__z)).value.arr = (zend_array_dup(spl_array_get_hash_table(intern, 0))); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
...
void zim_spl_Array_getIterator(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
 ...
 do { zval *__z = (return_value); (*(__z)).value.obj = (spl_array_object_new_ex(intern->ce_get_iterator, object, 0)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
}




void zim_spl_Array_rewind(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
...
void zim_spl_Array_seek(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "l", &position) == FAILURE) {
  return;
 }
 ...
 if (position >= 0) {
  ...
  if (result == SUCCESS && (zend_hash_get_current_key_type_ex(aht, spl_array_get_pos_ptr(aht, intern)) == 3 ? FAILURE : SUCCESS) == SUCCESS) {
   return;
  }
 }
...
int static spl_array_object_count_elements_helper(spl_array_object *intern, zend_long *count)
{
  ...
  *count = 0;
  spl_array_rewind(intern);
  while (*pos_ptr != ((uint32_t) -1) && spl_array_next(intern) == SUCCESS) {
   (*count)++;
  }
  *pos_ptr = pos;
  return SUCCESS;
...
void zim_spl_Array_count(zend_execute_data *execute_data, zval *return_value)
{
 zend_long count;
 spl_array_object *intern = spl_array_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
...
static void spl_array_method(zend_execute_data *execute_data, zval *return_value, char *fname, int fname_len, int use_arg)
{
 spl_array_object *intern = spl_array_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
 zval function_name, params[2], *arg = ((void *)0);
 uint32_t old_refcount;

 do { do { zval *__z = (&function_name); zend_string *__s = (zend_string_init(fname, fname_len, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);



 old_refcount = (aht)->gc.refcount;
 (aht)->gc.refcount = 1;
 do { zend_reference *_ref = (zend_reference *) (__builtin_constant_p((sizeof(zend_reference)) ) ? (((sizeof(zend_reference)) <= 8) ? _emalloc_8() : (((sizeof(zend_reference)) <= 16) ? _emalloc_16() : (((sizeof(zend_reference)) <= 24) ? _emalloc_24() : (((sizeof(zend_reference)) <= 32) ? _emalloc_32() : (((sizeof(zend_reference)) <= 40) ? _emalloc_40() : (((sizeof(zend_reference)) <= 48) ? _emalloc_48() : (((sizeof(zend_reference)) <= 56) ? _emalloc_56() : (((sizeof(zend_reference)) <= 64) ? _emalloc_64() : (((sizeof(zend_reference)) <= 80) ? _emalloc_80() : (((sizeof(zend_reference)) <= 96) ? _emalloc_96() : (((sizeof(zend_reference)) <= 112) ? _emalloc_112() : (((sizeof(zend_reference)) <= 128) ? _emalloc_128() : (((sizeof(zend_reference)) <= 160) ? _emalloc_160() : (((sizeof(zend_reference)) <= 192) ? _emalloc_192() : (((sizeof(zend_reference)) <= 224) ? _emalloc_224() : (((sizeof(zend_reference)) <= 256) ? _emalloc_256() : (((sizeof(zend_reference)) <= 320) ? _emalloc_320() : (((sizeof(zend_reference)) <= 384) ? _emalloc_384() : (((sizeof(zend_reference)) <= 448) ? _emalloc_448() : (((sizeof(zend_reference)) <= 512) ? _emalloc_512() : (((sizeof(zend_reference)) <= 640) ? _emalloc_640() : (((sizeof(zend_reference)) <= 768) ? _emalloc_768() : (((sizeof(zend_reference)) <= 896) ? _emalloc_896() : (((sizeof(zend_reference)) <= 1024) ? _emalloc_1024() : (((sizeof(zend_reference)) <= 1280) ? _emalloc_1280() : (((sizeof(zend_reference)) <= 1536) ? _emalloc_1536() : (((sizeof(zend_reference)) <= 1792) ? _emalloc_1792() : (((sizeof(zend_reference)) <= 2048) ? _emalloc_2048() : (((sizeof(zend_reference)) <= 2560) ? _emalloc_2560() : (((sizeof(zend_reference)) <= 3072) ? _emalloc_3072() : (((sizeof(zend_reference)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(zend_reference))) : _emalloc_huge((sizeof(zend_reference)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(zend_reference)) ) ); (_ref)->gc.refcount = 1; (_ref)->gc.u.type_info = 10; (*(&params[0])).value.ref = _ref; (*(&params[0])).u1.type_info = (10 | (( (1<<2) ) << 8)); } while (0);
 do { zval *__z = (&(params[0]).value.ref->val); (*(__z)).value.arr = (aht); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);

 if (!use_arg) {
  aht->u.v.nApplyCount++;
  call_user_function_ex((executor_globals.function_table), ((void *)0), &function_name, return_value, 1, params, 1, ((void *)0));
  aht->u.v.nApplyCount--;
 } else if (use_arg == 2) {
  if (zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "|z", &arg) == FAILURE) {
   zend_throw_exception(spl_ce_BadMethodCallException, "Function expects one argument at most", 0);
   goto exit;
  }
  if (arg) {
   do { zval *_z1 = (&params[1]); const zval *_z2 = (arg); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  }
  aht->u.v.nApplyCount++;
  call_user_function_ex((executor_globals.function_table), ((void *)0), &function_name, return_value, arg ? 2 : 1, params, 1, ((void *)0));
  aht->u.v.nApplyCount--;
 } else {
  if ((execute_data)->This.u2.num_args != 1 || zend_parse_parameters_ex((1<<1), (execute_data)->This.u2.num_args, "z", &arg) == FAILURE) {
   zend_throw_exception(spl_ce_BadMethodCallException, "Function expects exactly one argument", 0);
   goto exit;
  }
  do { zval *_z1 = (&params[1]); const zval *_z2 = (arg); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  aht->u.v.nApplyCount++;
  call_user_function_ex((executor_globals.function_table), ((void *)0), &function_name, return_value, 2, params, 1, ((void *)0));
  aht->u.v.nApplyCount--;
 }

exit:

 (aht)->gc.refcount = old_refcount;
 _efree(((params[0]).value.ref) );
 zend_string_free((function_name).value.str);
}
# 1480 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_array.c"
void zim_spl_Array_asort(zend_execute_data *execute_data, zval *return_value) { spl_array_method(execute_data, return_value, "asort", sizeof("asort")-1, 2); }




void zim_spl_Array_ksort(zend_execute_data *execute_data, zval *return_value) { spl_array_method(execute_data, return_value, "ksort", sizeof("ksort")-1, 2); }




void zim_spl_Array_uasort(zend_execute_data *execute_data, zval *return_value) { spl_array_method(execute_data, return_value, "uasort", sizeof("uasort")-1, 1); }




void zim_spl_Array_uksort(zend_execute_data *execute_data, zval *return_value) { spl_array_method(execute_data, return_value, "uksort", sizeof("uksort")-1, 1); }




void zim_spl_Array_natsort(zend_execute_data *execute_data, zval *return_value) { spl_array_method(execute_data, return_value, "natsort", sizeof("natsort")-1, 0); }




void zim_spl_Array_natcasesort(zend_execute_data *execute_data, zval *return_value) { spl_array_method(execute_data, return_value, "natcasesort", sizeof("natcasesort")-1, 0); }



void zim_spl_Array_current(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 zval *entry;
 ...
 if ((entry = zend_hash_get_current_data_ex(aht, spl_array_get_pos_ptr(aht, intern))) == ((void *)0)) {
  return;
 }
...
void zim_spl_Array_key(zend_execute_data *execute_data, zval *return_value)
{
 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) {
  return;
 }

 spl_array_iterator_key(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), return_value);
}
...
void zim_spl_Array_next(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
...
void zim_spl_Array_valid(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
 ...
 if (spl_array_object_verify_pos(intern, aht) == FAILURE) {
  ...
  { do { (*(return_value)).u1.type_info = ((zend_hash_get_current_key_type_ex(aht, spl_array_get_pos_ptr(aht, intern)) == 3 ? FAILURE : SUCCESS) == SUCCESS) ? 3 : 2; } while (0); return; };
 }
}
...
void zim_spl_Array_hasChildren(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), *entry;
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
...
void zim_spl_Array_getChildren(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)), *entry, flags;
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
 ...
 if (zval_get_type(&(*(entry))) == 8) {
  ...
  if (instanceof_function(((*(entry)).value.obj->ce), ((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce))) {
   do { zval *__z = (return_value); (*(__z)).value.obj = ((*(entry)).value.obj); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
   zval_addref_p(return_value);
   return;
  }
 }

 { zval *__z = (&flags); (*(__z)).value.lval = intern->ar_flags; (*(__z)).u1.type_info = 4; };
 spl_instantiate_arg_ex2(((*(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0)))).value.obj->ce), return_value, entry, &flags);
}




void zim_spl_Array_serialize(zend_execute_data *execute_data, zval *return_value)
{
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 spl_array_object *intern = spl_array_from_obj((*((object))).value.obj);
 HashTable *aht = spl_array_get_hash_table(intern, 0);
 ...
 { zval *__z = (&flags); (*(__z)).value.lval = (intern->ar_flags & 0x0100FFFF); (*(__z)).u1.type_info = 4; };
 ...
 do { zval *__z = (&members); (*(__z)).value.arr = (intern->std.properties); (*(__z)).u1.type_info = (7 | (( (1<<2) | (1<<3) | (1<<4)) << 8)); } while (0);
...
void zim_spl_Array_unserialize(zend_execute_data *execute_data, zval *return_value)
{
 spl_array_object *intern = spl_array_from_obj((*((((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))))).value.obj);
 ...
 if (*p!='m') {
  ...
  intern->ar_flags &= ~0x0100FFFF;
  intern->ar_flags |= flags & 0x0100FFFF;
  _zval_ptr_dtor((&intern->array) );
 ...
 if (!php_var_unserialize(members, &p, s + buf_len, &var_hash) || zval_get_type(&(*(members))) != 7) {
  goto outexcept;
 }


 object_properties_load(&intern->std, (*(members)).value.arr);
...
static const zend_internal_arg_info arginfo_array___construct[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "array", ((void *)0), 0, 0, 0, 0 },
 { "ar_flags", ((void *)0), 0, 0, 0, 0 },
 { "iterator_class", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_offsetGet[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "index", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_offsetSet[] = { { (const char*)(zend_uintptr_t)(2), ((void *)0), 0, 0, 0, 0 },
 { "index", ((void *)0), 0, 0, 0, 0 },
 { "newval", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_append[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "value", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_seek[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "position", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_exchangeArray[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "array", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_setFlags[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "flags", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_setIteratorClass[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "iteratorClass", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_array_uXsort[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "cmp_function", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_array_unserialize[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
 { "serialized", ((void *)0), 0, 0, 0, 0 },
};;

static const zend_internal_arg_info arginfo_array_void[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_function_entry spl_funcs_ArrayObject[] = {
 { "__construct", zim_spl_Array___construct, arginfo_array___construct, (uint32_t) (sizeof(arginfo_array___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetExists", zim_spl_Array_offsetExists, arginfo_array_offsetGet, (uint32_t) (sizeof(arginfo_array_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetGet", zim_spl_Array_offsetGet, arginfo_array_offsetGet, (uint32_t) (sizeof(arginfo_array_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetSet", zim_spl_Array_offsetSet, arginfo_array_offsetSet, (uint32_t) (sizeof(arginfo_array_offsetSet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "offsetUnset", zim_spl_Array_offsetUnset, arginfo_array_offsetGet, (uint32_t) (sizeof(arginfo_array_offsetGet)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "append", zim_spl_Array_append, arginfo_array_append, (uint32_t) (sizeof(arginfo_array_append)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getArrayCopy", zim_spl_Array_getArrayCopy, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "count", zim_spl_Array_count, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getFlags", zim_spl_Array_getFlags, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setFlags", zim_spl_Array_setFlags, arginfo_array_setFlags, (uint32_t) (sizeof(arginfo_array_setFlags)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "asort", zim_spl_Array_asort, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "ksort", zim_spl_Array_ksort, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "uasort", zim_spl_Array_uasort, arginfo_array_uXsort, (uint32_t) (sizeof(arginfo_array_uXsort)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "uksort", zim_spl_Array_uksort, arginfo_array_uXsort, (uint32_t) (sizeof(arginfo_array_uXsort)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "natsort", zim_spl_Array_natsort, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "natcasesort", zim_spl_Array_natcasesort, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "unserialize", zim_spl_Array_unserialize, arginfo_array_unserialize, (uint32_t) (sizeof(arginfo_array_unserialize)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "serialize", zim_spl_Array_serialize, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },

 { "getIterator", zim_spl_Array_getIterator, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "exchangeArray", zim_spl_Array_exchangeArray, arginfo_array_exchangeArray, (uint32_t) (sizeof(arginfo_array_exchangeArray)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "setIteratorClass", zim_spl_Array_setIteratorClass, arginfo_array_setIteratorClass, (uint32_t) (sizeof(arginfo_array_setIteratorClass)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getIteratorClass", zim_spl_Array_getIteratorClass, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
...
static const zend_function_entry spl_funcs_ArrayIterator[] = {
 ...
 { "rewind", zim_spl_Array_rewind, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "current", zim_spl_Array_current, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "key", zim_spl_Array_key, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "next", zim_spl_Array_next, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "valid", zim_spl_Array_valid, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "seek", zim_spl_Array_seek, arginfo_array_seek, (uint32_t) (sizeof(arginfo_array_seek)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_function_entry spl_funcs_RecursiveArrayIterator[] = {
 { "hasChildren", zim_spl_Array_hasChildren, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getChildren", zim_spl_Array_getChildren, arginfo_array_void, (uint32_t) (sizeof(arginfo_array_void)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
int zm_startup_spl_array(int type, int module_number)
{
 ...
 spl_handler_ArrayObject.offset = ((zend_long) (((char *) (&(((spl_array_object*)((void *)0))->std))) - ((char *) ((void *)0))));
 ...
 zend_declare_class_constant_long(spl_ce_ArrayObject, "STD_PROP_LIST", sizeof("STD_PROP_LIST")-1, (zend_long)0x00000001);;
 zend_declare_class_constant_long(spl_ce_ArrayObject, "ARRAY_AS_PROPS", sizeof("ARRAY_AS_PROPS")-1, (zend_long)0x00000002);;

 zend_declare_class_constant_long(spl_ce_ArrayIterator, "STD_PROP_LIST", sizeof("STD_PROP_LIST")-1, (zend_long)0x00000001);;
 zend_declare_class_constant_long(spl_ce_ArrayIterator, "ARRAY_AS_PROPS", sizeof("ARRAY_AS_PROPS")-1, (zend_long)0x00000002);;

 zend_declare_class_constant_long(spl_ce_RecursiveArrayIterator, "CHILD_ARRAYS_ONLY", sizeof("CHILD_ARRAYS_ONLY")-1, (zend_long)0x00000004);;
