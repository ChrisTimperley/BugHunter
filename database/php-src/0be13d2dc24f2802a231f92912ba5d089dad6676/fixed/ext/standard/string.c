...
# 75 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stdarg.h" 1 3 4
...
# 130 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
static char *php_bin2hex(const unsigned char *old, const size_t oldlen, size_t *newlen)
{
 register unsigned char *result = ((void *)0);
 size_t i, j;

 if (__builtin_expect(oldlen * 2 * sizeof(char) > 2147483647, 0)) {
...
__attribute__ ((visibility("default"))) struct lconv *localeconv_r(struct lconv *out)
{
# 213 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
 *out = *localeconv();
...
# 248 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_bin2hex(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *result, *data;
 size_t newlen;
 ...
 if (zend_parse_parameters((ht) , "s", &data, &datalen) == FAILURE) {
  return;
 }
...
# 462 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
 zend_register_long_constant(("CRNCYSTR"), sizeof("CRNCYSTR"), (_NL_MONETARY_CRNCYSTR), ((1<<0) | (1<<1)), module_number );
# 507 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 531 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
void zif_nl_langinfo(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "l", &item) == FAILURE) {
  return;
 }
 ...
 switch(item) {
  ...
  case ALT_DIGITS:
# 639 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
  case _NL_MONETARY_CRNCYSTR:
# 683 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
  case RADIXCHAR:
  ...
  case __NOEXPR:
# 706 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
  case CODESET:
...
void zif_strcoll(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ss", &s1, &s1len, &s2, &s2len) == FAILURE) {
  return;
 }
...
# 748 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 797 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) char *php_trim(char *c, int len, char *what, int what_len, zval *return_value, int mode )
{
 register int i;
 int trimmed = 0;
...
static void php_do_trim(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , int mode)
{
 ...
 if (zend_parse_parameters((ht) , "s|s", &str, &str_len, &what, &what_len) == FAILURE) {
  return;
 }
...
void zif_wordwrap(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|lsb", &text, &textlen, &linelength, &breakchar, &breakcharlen, &docut) == FAILURE) {
  return;
 }
...
void zif_explode(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ss|l", &delim, &delim_len, &str, &str_len, &limit) == FAILURE) {
  return;
 }
...
# 1135 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_implode(zval *delim, zval *arr, zval *return_value )
{
 zval **tmp;
 HashPosition pos;
...
void zif_implode(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "Z|Z", &arg1, &arg2) == FAILURE) {
  return;
 }
...
void zif_strtok(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|s", &str, &str_len, &tok, &tok_len) == FAILURE) {
  return;
 }
...
void zif_strtoupper(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s", &arg, &arglen) == FAILURE) {
  return;
 }
...
void zif_strtolower(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s", &str, &arglen) == FAILURE) {
  return;
 }
...
# 1463 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
    } else {
     if (state == 0) {
      comp = c;
      state = 1;
...
void zif_basename(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|s", &string, &string_len, &suffix, &suffix_len) == FAILURE) {
  return;
 }
...
void zif_pathinfo(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|l", &path, &path_len, &opt) == FAILURE) {
  return;
 }
 ...
 if (opt == (1 | 2 | 4 | 8)) {
  { do { zval *__z = (return_value); zval *__zv = (tmp); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (1) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 } else {
  zval **element;
  if (zend_hash_get_current_data_ex((*tmp).value.ht, (void **) &element, ((void *)0)) == SUCCESS) {
   do { zval *__z = (return_value); zval *__zv = (*element); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
  } else {
...
void zif_stristr(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sz|b", &haystack, &haystack_len, &needle, &part) == FAILURE) {
  return;
 }
...
# 1819 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_strpos(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 zval *needle;
 char *haystack;
 ...
 if (zend_parse_parameters((ht) , "sz|l", &haystack, &haystack_len, &needle, &offset) == FAILURE) {
  return;
 }
...
void zif_strrpos(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sz|l", &haystack, &haystack_len, &zneedle, &offset) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_strrchr(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sz", &haystack, &haystack_len, &needle) == FAILURE) {
  return;
 }
...
void zif_chunk_split(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|ls", &str, &str_len, &chunklen, &end, &endlen) == FAILURE) {
  return;
 }
...
void zif_substr(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sl|l", &str, &str_len, &f, &l) == FAILURE) {
  return;
 }
...
void zif_substr_replace(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ZZZ|Z", &str, &repl, &from, &len) == FAILURE) {
  return;
 }
 ...
 if ((**str).type != 4) {
  if ((**from).type != 4) {
   ...
   if ((**repl).type == 4) {
    ...
    if (SUCCESS == zend_hash_get_current_data_ex((**repl).value.ht, (void **) &tmp_repl, &pos_repl)) {
  ...
  while (zend_hash_get_current_data_ex((**str).value.ht, (void **) &tmp_str, &pos_str) == SUCCESS) {
   zval *orig_str;
   zval dummy;
   ulong refcount;
   int was_ref;
   ...
   if ((**from).type == 4) {
    if (SUCCESS == zend_hash_get_current_data_ex((**from).value.ht, (void **) &tmp_from, &pos_from)) {
     if((**tmp_from).type != 1) {
      zval dummy = **tmp_from;
   ...
   if (argc > 3 && (**len).type == 4) {
    if (SUCCESS == zend_hash_get_current_data_ex((**len).value.ht, (void **) &tmp_len, &pos_len)) {
     if((**tmp_len).type != 1) {
      zval dummy = **tmp_len;
      _zval_copy_ctor((&dummy) );
      convert_to_long(&dummy);
...
void zif_quotemeta(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s", &old, &old_len) == FAILURE) {
  return;
 }
 ...
 *q = 0;
 new_len = q - str;
 if (__builtin_expect(new_len > 2147483647, 0)) {
  _efree((str) );
  zend_error((1<<0L), "String size overflow");
 }

 { do { const char *__s=(_erealloc((str), (new_len + 1), 0 )); int __l=new_len; zval *__z = (return_value); (*__z).value.str.len = __l; (*__z).value.str.val = (0?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0); return; };
}
...
void zif_chr(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters_ex(1<<1, (ht) , "l", &c) == FAILURE) {
  c = 0;
 }
...
void zif_ucwords(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|s", &str, &str_len, &delims, &delims_len) == FAILURE) {
  return;
 }
...
# 2837 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
typedef struct {
 int B;
 int Bp;
 STRLEN m;
...
{
 if (*(char**)strp) { do { if (!(((*(char**)strp) >= (compiler_globals.interned_strings_start)) && ((*(char**)strp) < (compiler_globals.interned_strings_end)))) { _efree(((char*)*(char**)strp) ); } } while (0); };
}
...
void zif_strtr(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sZ|s", &str, &str_len, &from, &to, &to_len) == FAILURE) {
  return;
 }
...
void zif_similar_text(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ss|Z", &t1, &t1_len, &t2, &t2_len, &percent) == FAILURE) {
  return;
 }
...
void zif_addcslashes(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ss", &str, &str_len, &what, &what_len) == FAILURE) {
  return;
 }
...
# 3434 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_stripcslashes(char *str, int *len)
{
 ...
 *target = 0;
 ...
 if (__builtin_expect(newlen > 2147483647, 0)) {
  _efree((new_str) );
  zend_error((1<<0L), "String size overflow");
 }
 ...
 if (should_free) {
  if ((char*)str) { do { if (!((((char*)str) >= (compiler_globals.interned_strings_start)) && (((char*)str) < (compiler_globals.interned_strings_end)))) { _efree(((char*)(char*)str) ); } } while (0); };
 }
 return new_str;
}
 ...
 *new_length = target - new_str;
 ...
 if (should_free) {
  if (str) { do { if (!(((str) >= (compiler_globals.interned_strings_start)) && ((str) < (compiler_globals.interned_strings_end)))) { _efree(((char*)str) ); } } while (0); };
 }
 new_str = (char *) _erealloc((new_str), (*new_length + 1), 0 );
 return new_str;
}
# 3614 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) int php_char_to_str_ex(char *str, uint len, char from, char *to, int to_len, zval *result, int case_sensitivity, int *replace_count)
{
 int char_count = 0;
 int replaced = 0;
...
static void php_str_replace_in_subject(zval *search, zval *replace, zval **subject, zval *result, int case_sensitivity, int *replace_count)
{
 ...
 if ((*search).type == 4) {
  ...
  while (zend_hash_get_current_data_ex((*search).value.ht, (void **) &search_entry, ((void *)0)) == SUCCESS) {
   ...
   if ((*replace).type == 4) {
    ...
    if (zend_hash_get_current_data_ex((*replace).value.ht, (void **)&replace_entry, ((void *)0)) == SUCCESS) {
...
static void php_str_replace_common(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , int case_sensitivity)
{
 ...
 if (zend_parse_parameters((ht) , "ZZZ|Z", &search, &replace, &subject, &zcount) == FAILURE) {
  return;
 }
 ...
 if ((**subject).type == 4) {
  ...
  while (zend_hash_get_current_data_ex((**subject).value.ht, (void **)&subject_entry, ((void *)0)) == SUCCESS) {
...
static void php_hebrev(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , int convert_newlines)
{
 ...
 if (zend_parse_parameters((ht) , "s|l", &str, &str_len, &max_chars) == FAILURE) {
  return;
 }
...
void zif_nl2br(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|b", &str, &str_len, &is_xhtml) == FAILURE) {
  return;
 }
...

 {
  ...
  if (__builtin_expect(new_length > 2147483647, 0)) {
   zend_error((1<<0L), "String size overflow");
  }
...
void zif_strip_tags(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|Z", &str, &str_len, &allow) == FAILURE) {
  return;
 }
...
void zif_setlocale(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "Z+", &pcategory, &args, &num_args) == FAILURE) {
  return;
 }
 ...
 while (1) {
  ...
  if (!strcmp ("0", (**plocale).value.str.val)) {
   loc = ((void *)0);
  } else {
  ...
  if ((**args[0]).type == 4) {
   if (zend_hash_move_forward_ex((**args[0]).value.ht, ((void *)0)) == FAILURE) break;
  } else {
   if (++i >= num_args) break;
  }
 }
...
void zif_parse_str(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|z", &arg, &arglen, &arrayArg) == FAILURE) {
  return;
 }
...
# 4525 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
int php_tag_find(char *tag, int len, char *set) {
 char c, *n, *t;
 int state=0, done=0;
 char *norm;
...
# 4606 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) size_t php_strip_tags_ex(char *rbuf, int len, int *stateptr, char *allow, int allow_len, zend_bool allow_tag_spaces)
{
...
void zif_str_repeat(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sl", &input_str, &input_len, &mult) == FAILURE) {
  return;
 }
 ...
 if(result_len > 2147483647) {
  php_error_docref0(((void *)0) , (1<<1L), "Result is too big, maximum %d allowed", 2147483647);
  { do { zval *__z = (return_value); (*__z).value.str.len = 0; (*__z).value.str.val = (compiler_globals.interned_empty_string)? (compiler_globals.interned_empty_string) : _estrndup((""), (sizeof("")-1) ); (*__z).type = 6; } while (0); return; };
 }
...
void zif_count_chars(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|l", &input, &len, &mymode) == FAILURE) {
  return;
 }
...
# 5178 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
void zif_substr_count(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ss|ll", &haystack, &haystack_len, &needle, &needle_len, &offset, &length) == FAILURE) {
  return;
 }
...
# 5438 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_str_word_count(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|ls", &str, &str_len, &type, &char_list, &char_list_len) == FAILURE) {
  return;
 }
...
void zif_money_format(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "sd", &format, &format_len, &value) == FAILURE) {
  return;
 }
...
void zif_str_split(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "s|l", &str, &str_len, &split_length) == FAILURE) {
  return;
 }
...
void zif_strpbrk(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ss", &haystack, &haystack_len, &char_list, &char_list_len) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
...
void zif_substr_compare(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "ssl|lb", &s1, &s1_len, &s2, &s2_len, &offset, &len, &cs) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }

 if ((ht) >= 4 && len <= 0) {
  if (len == 0) {
   { { zval *__z = (return_value); (*__z).value.lval = 0L; (*__z).type = 1; }; return; };
  } else {
