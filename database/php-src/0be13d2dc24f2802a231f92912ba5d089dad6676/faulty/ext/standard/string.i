...
{
 struct lconv *res;
# 214 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
 res = localeconv();
...
# 251 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_bin2hex(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 char *result, *data;
 size_t newlen;
...
# 751 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 800 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) char *php_trim(char *c, int len, char *what, int what_len, zval *return_value, int mode )
{
 register int i;
 int trimmed = 0;
...
# 1138 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_implode(zval *delim, zval *arr, zval *return_value )
{
 zval **tmp;
 HashPosition pos;
...
# 1466 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
    } else {
     if (state == 0) {
      comp = c;
      state = 1;
...
# 1822 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_strpos(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 zval *needle;
 char *haystack;
...
# 2840 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
typedef struct {
 int B;
 int Bp;
 STRLEN m;
...
# 3437 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) void php_stripcslashes(char *str, int *len)
{
...
# 3617 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) int php_char_to_str_ex(char *str, uint len, char from, char *to, int to_len, zval *result, int case_sensitivity, int *replace_count)
{
 int char_count = 0;
 int replaced = 0;
...
# 4528 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
int php_tag_find(char *tag, int len, char *set) {
 char c, *n, *t;
 int state=0, done=0;
 char *norm;
...
# 4609 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
__attribute__ ((visibility("default"))) size_t php_strip_tags_ex(char *rbuf, int len, int *stateptr, char *allow, int allow_len, zend_bool allow_tag_spaces)
{
...
# 5181 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
...
# 5441 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/string.c"
void zif_str_word_count(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
