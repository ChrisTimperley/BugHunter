# 1 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c"
# 28 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c"
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
...
# 2493 "main/../main/php_config.h" 2
# 2508 "main/../main/php_config.h"
...
# 2509 "main/../main/php_config.h" 2
# 2519 "main/../main/php_config.h"
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
...
# 36 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_string.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_string.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_string_public.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_string_public.h"
typedef struct {
 char *c;
 size_t len;
 size_t a;
} smart_string;
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_smart_string.h" 2
# 37 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c" 2
# 45 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c"
...
# 80 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c"
void php_rfc1867_register_constants(void)
{
 zend_register_long_constant(("UPLOAD_ERR_OK"), sizeof("UPLOAD_ERR_OK")-1, (0), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_INI_SIZE"), sizeof("UPLOAD_ERR_INI_SIZE")-1, (1), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_FORM_SIZE"), sizeof("UPLOAD_ERR_FORM_SIZE")-1, (2), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_PARTIAL"), sizeof("UPLOAD_ERR_PARTIAL")-1, (3), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_NO_FILE"), sizeof("UPLOAD_ERR_NO_FILE")-1, (4), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_NO_TMP_DIR"), sizeof("UPLOAD_ERR_NO_TMP_DIR")-1, (6), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_CANT_WRITE"), sizeof("UPLOAD_ERR_CANT_WRITE")-1, (7), ((1<<0) | (1<<1)), 0);
 zend_register_long_constant(("UPLOAD_ERR_EXTENSION"), sizeof("UPLOAD_ERR_EXTENSION")-1, (8), ((1<<0) | (1<<1)), 0);
}
...
static void add_protected_variable(char *varname)
{
 ...
 zend_hash_str_add_empty_element(&(core_globals.rfc1867_protected_variables), varname, strlen(varname));
}
...
{
 normalize_protected_variable(varname);
 return zend_hash_str_exists(&(core_globals.rfc1867_protected_variables), varname, strlen(varname));
}
...
{
 zend_string *filename = (*(el)).value.str;
 unlink((filename)->val);
 return 0;
}
...
__attribute__ ((visibility("default"))) void destroy_uploaded_files_hash(void)
{
 zend_hash_apply((sapi_globals.rfc1867_uploaded_files), unlink_filename);
 zend_hash_destroy((sapi_globals.rfc1867_uploaded_files));
 do { if (__builtin_constant_p(sizeof(HashTable))) { if (sizeof(HashTable) <= 8) { _efree_8((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 16) { _efree_16((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 24) { _efree_24((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 32) { _efree_32((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 40) { _efree_40((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 48) { _efree_48((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 56) { _efree_56((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 64) { _efree_64((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 80) { _efree_80((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 96) { _efree_96((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 112) { _efree_112((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 128) { _efree_128((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 160) { _efree_160((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 192) { _efree_192((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 224) { _efree_224((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 256) { _efree_256((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 320) { _efree_320((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 384) { _efree_384((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 448) { _efree_448((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 512) { _efree_512((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 640) { _efree_640((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 768) { _efree_768((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 896) { _efree_896((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 1024) { _efree_1024((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 1280) { _efree_1280((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 1536) { _efree_1536((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 1792) { _efree_1792((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 2048) { _efree_2048((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 2560) { _efree_2560((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= 3072) { _efree_3072((sapi_globals.rfc1867_uploaded_files)); } else if (sizeof(HashTable) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large((sapi_globals.rfc1867_uploaded_files), sizeof(HashTable)); } else { _efree_huge((sapi_globals.rfc1867_uploaded_files), sizeof(HashTable)); } } else { _efree((sapi_globals.rfc1867_uploaded_files)); } } while (0);
}
...
# 332 "/home/ct584/git/bughunter/repositories/php-src/main/rfc1867.c"
 ...
 while ((line = get_line(self)) && line[0] != '\0') {
  ...
  if (value) {
   if (buf_value.c && key) {
    ...
    do { if ((&buf_value)->c) { (&buf_value)->c[(&buf_value)->len] = '\0'; } } while (0);
    entry.key = key;
   ...
   *value = '\0';
   ...
   key = _estrdup((line) );
   do { register size_t __nl; smart_string *__dest = (smart_string *) (((&buf_value))); do { if (!(__dest)->c) { (__dest)->len = 0; __nl = (((strlen(value)))); (__dest)->a = __nl < 78 ? 78 : __nl + 128; (__dest)->c = (((((0))))?__zend_realloc((((__dest)->c)), (((__dest)->a + 1))):_erealloc(((((__dest)->c))), ((((__dest)->a + 1))) )); } else { __nl = (__dest)->len + (((strlen(value)))); if (__nl >= (__dest)->a) { (__dest)->a = __nl + 128; (__dest)->c = (((((0))))?__zend_realloc((((__dest)->c)), (((__dest)->a + 1))):_erealloc(((((__dest)->c))), ((((__dest)->a + 1))) )); } } } while (0); memcpy(__dest->c + __dest->len, (((value))), ((strlen(value)))); __dest->len = __nl; } while (0);
  } else if (buf_value.c) {
   do { register size_t __nl; smart_string *__dest = (smart_string *) (((&buf_value))); do { if (!(__dest)->c) { (__dest)->len = 0; __nl = (((strlen(line)))); (__dest)->a = __nl < 78 ? 78 : __nl + 128; (__dest)->c = (((((0))))?__zend_realloc((((__dest)->c)), (((__dest)->a + 1))):_erealloc(((((__dest)->c))), ((((__dest)->a + 1))) )); } else { __nl = (__dest)->len + (((strlen(line)))); if (__nl >= (__dest)->a) { (__dest)->a = __nl + 128; (__dest)->c = (((((0))))?__zend_realloc((((__dest)->c)), (((__dest)->a + 1))):_erealloc(((((__dest)->c))), ((((__dest)->a + 1))) )); } } } while (0); memcpy(__dest->c + __dest->len, (((line))), ((strlen(line)))); __dest->len = __nl; } while (0);
  } else {
   continue;
  }
 }
...
static char *multipart_buffer_read_body(multipart_buffer *self, size_t *len)
{
 ...
 while((read_bytes = multipart_buffer_read(self, buf, sizeof(buf), ((void *)0)))) {
  out = _erealloc((out), (total_bytes + read_bytes + 1) );
...
__attribute__ ((visibility("default"))) void rfc1867_post_handler(char *content_type_dup, void *arg)
{
 ...
 char *lbuf = ((void *)0), *abuf = ((void *)0);
 zend_string *temp_filename = ((void *)0);
 ...
 unsigned int llen = 0;
 int upload_cnt = zend_ini_long(("max_file_uploads"), sizeof("max_file_uploads")-1, 0);
 ...
 if ((sapi_globals.post_max_size) > 0 && (sapi_globals.request_info).content_length > (sapi_globals.post_max_size)) {
  sapi_module.sapi_error((1<<1L), "POST Content-Length of " "%" "l" "d" " bytes exceeds the limit of " "%" "l" "d" " bytes", (sapi_globals.request_info).content_length, (sapi_globals.post_max_size));
  return;
 }
 ...
 if (php_rfc1867_callback != ((void *)0)) {
  ...
  if (php_rfc1867_callback(0, &event_start, &event_extra_data) == FAILURE) {
 ...
 while (!multipart_buffer_eof(mbuff))
 {
  ...
  if ((cd = php_mime_get_hdr_value(header, "Content-Disposition"))) {
   ...
   if (!filename && param) {
    ...
    if (++count <= (core_globals.max_input_vars) && sapi_module.input_filter(0, param, &value, value_len, &new_val_len)) {
     if (php_rfc1867_callback != ((void *)0)) {
      ...
      if (php_rfc1867_callback(1, &event_formdata, &event_extra_data) == FAILURE) {
       _efree((param) );
       _efree((value) );
       continue;
      }
     ...
     if (count == (core_globals.max_input_vars) + 1) {
   ...
   if (!param) {
    is_anonymous = 1;
    param = (__builtin_constant_p((33) ) ? (((33) <= 8) ? _emalloc_8() : (((33) <= 16) ? _emalloc_16() : (((33) <= 24) ? _emalloc_24() : (((33) <= 32) ? _emalloc_32() : (((33) <= 40) ? _emalloc_40() : (((33) <= 48) ? _emalloc_48() : (((33) <= 56) ? _emalloc_56() : (((33) <= 64) ? _emalloc_64() : (((33) <= 80) ? _emalloc_80() : (((33) <= 96) ? _emalloc_96() : (((33) <= 112) ? _emalloc_112() : (((33) <= 128) ? _emalloc_128() : (((33) <= 160) ? _emalloc_160() : (((33) <= 192) ? _emalloc_192() : (((33) <= 224) ? _emalloc_224() : (((33) <= 256) ? _emalloc_256() : (((33) <= 320) ? _emalloc_320() : (((33) <= 384) ? _emalloc_384() : (((33) <= 448) ? _emalloc_448() : (((33) <= 512) ? _emalloc_512() : (((33) <= 640) ? _emalloc_640() : (((33) <= 768) ? _emalloc_768() : (((33) <= 896) ? _emalloc_896() : (((33) <= 1024) ? _emalloc_1024() : (((33) <= 1280) ? _emalloc_1280() : (((33) <= 1536) ? _emalloc_1536() : (((33) <= 1792) ? _emalloc_1792() : (((33) <= 2048) ? _emalloc_2048() : (((33) <= 2560) ? _emalloc_2560() : (((33) <= 3072) ? _emalloc_3072() : (((33) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((33)) : _emalloc_huge((33))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((33) ) );
   ...
   if (!skip_upload && php_rfc1867_callback != ((void *)0)) {
    ...
    if (php_rfc1867_callback(2, &event_file_start, &event_extra_data) == FAILURE) {
     temp_filename = ((void *)0);
     _efree((param) );
     _efree((filename) );
     continue;
   ...
   while (!cancel_upload && (blen > 0))
   {
    if (php_rfc1867_callback != ((void *)0)) {
     ...
     if (php_rfc1867_callback(3, &event_file_data, &event_extra_data) == FAILURE) {
      cancel_upload = 8;
      continue;
     }
    }

    if ((core_globals.upload_max_filesize) > 0 && (zend_long)(total_bytes+blen) > (core_globals.upload_max_filesize)) {
   ...
   if (php_rfc1867_callback != ((void *)0)) {
    ...
    event_file_end.temp_filename = temp_filename ? (temp_filename)->val : ((void *)0);
    event_file_end.cancel_upload = cancel_upload;
    if (php_rfc1867_callback(4, &event_file_end, &event_extra_data) == FAILURE) {
     cancel_upload = 8;
    }
   }
   ...
   if (cancel_upload) {
    ...
    zend_hash_add_ptr((sapi_globals.rfc1867_uploaded_files), temp_filename, temp_filename);
   }
   ...
   register_http_post_files_variable(lbuf, s, &(core_globals.http_globals)[5], 0);
   _efree((filename) );
   s = ((void *)0);
   ...
   register_http_post_files_variable(lbuf, cd, &(core_globals.http_globals)[5], 0);
...

   {
    ...
    if (!is_anonymous) {
     if (temp_filename) {
      do { zval *__z = (&zfilename); zend_string *__s = (temp_filename); (*(__z)).value.str = __s; if (((__s)->gc.u.v.flags & (1<<1))) { (*(__z)).u1.type_info = 6; } else { (__s)->gc.refcount++; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } } while (0);
     } else {
      do { do { zval *__z = (&zfilename); zend_string *__s = ((compiler_globals.empty_string)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = 6; } while (0); } while (0);
     }
    ...
    register_http_post_files_variable_ex(lbuf, &zfilename, &(core_globals.http_globals)[5], 1);
   }

   {
    ...
    { zval *__z = (&error_type); (*(__z)).value.lval = cancel_upload; (*(__z)).u1.type_info = 4; };


    if (cancel_upload) {
     { zval *__z = (&file_size); (*(__z)).value.lval = 0; (*(__z)).u1.type_info = 4; };
    } else {
     if (total_bytes > (9223372036854775807L)) {
      ...
      {
       int __len = ap_php_snprintf(file_size_buf, 65, "%lld", total_bytes);
      ...
      { zval *__z = (&file_size); (*(__z)).value.lval = total_bytes; (*(__z)).u1.type_info = 4; };
     }
    }
    ...
    register_http_post_files_variable_ex(lbuf, &error_type, &(core_globals.http_globals)[5], 0);
    ...
    if (!is_anonymous) {
     if (size_overflow) {
      do { const char *_s = (file_size_buf); do { do { zval *__z = (&file_size); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
     }
     safe_php_register_variable_ex(lbuf, &file_size, ((void *)0), size_overflow);
    }
    ...
    register_http_post_files_variable_ex(lbuf, &file_size, &(core_globals.http_globals)[5], size_overflow);
   }
   _efree((param) );
  }
 }
