# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c" 2
...
# 44 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 49 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 2
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 53 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 85 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 86 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c" 2
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c" 2
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
static const zend_shared_memory_handlers *g_shared_alloc_handler = ((void *)0);
...
int lock_file;
static char lockfile_name[4096];
...
void zend_shared_alloc_create_lock(char *lockfile_path)
{
 ...
 snprintf(lockfile_name, sizeof(lockfile_name), "%s/%sXXXXXX", lockfile_path, ".ZendSem.");
 lock_file = mkstemp(lockfile_name);
 fchmod(lock_file, 0666);

 if (lock_file == -1) {
  zend_accel_error(0, "Unable to create lock file: %s (%d)", strerror((*__errno_location ())), (*__errno_location ()));
 }
 val = fcntl(lock_file, 1, 0);
 val |= 1;
 fcntl(lock_file, 2, val);
...
{
 zend_accel_error(0, "Unable to allocate shared memory segment of %ld bytes: %s: %s (%d)", allocate_size, error?error:"unknown", strerror((*__errno_location ())), (*__errno_location ()) );
}
...
static int zend_shared_alloc_try(const zend_shared_memory_handler_entry *he, size_t requested_size, zend_shared_segment ***shared_segments_p, int *shared_segments_count, char **error_in)
{
 ...
 (smm_shared_globals->shared_segments) = ((void *)0);
 (smm_shared_globals->shared_segments_count) = 0;

 res = g_shared_alloc_handler->create_segments(requested_size, shared_segments_p, shared_segments_count, error_in);
 ...
 if (*shared_segments_p) {
  ...
  for (i = 0; i < *shared_segments_count; i++) {
   if ((*shared_segments_p)[i]->p && (*shared_segments_p)[i]->p != (void *)-1) {
    g_shared_alloc_handler->detach_segment((*shared_segments_p)[i]);
   }
  }
  free(*shared_segments_p);
  *shared_segments_p = ((void *)0);
 }
 g_shared_alloc_handler = ((void *)0);
 return 0;
}
...
int zend_shared_alloc_startup(size_t requested_size)
{
 ...
 (smm_shared_globals->shared_free) = requested_size;


 zend_shared_alloc_create_lock((accel_globals.accel_directives).lockfile_path);




 if ((accel_globals.accel_directives).memory_model && (accel_globals.accel_directives).memory_model[0]) {
  char *model = (accel_globals.accel_directives).memory_model;

  if (strncmp((accel_globals.accel_directives).memory_model, "cgi", sizeof("cgi")) == 0) {
   model = "shm";
  }

  for (he = handler_table; he->name; he++) {
   if (strcmp(model, he->name) == 0) {
    res = zend_shared_alloc_try(he, requested_size, &(smm_shared_globals->shared_segments), &(smm_shared_globals->shared_segments_count), &error_in);
    if (res) {
 ...
 shared_segments_array_size = (smm_shared_globals->shared_segments_count) * g_shared_alloc_handler->segment_type_size();


 (accel_globals.locked) = 1;
 ...
 tmp_shared_segments = zend_shared_alloc(shared_segments_array_size + (smm_shared_globals->shared_segments_count) * sizeof(void *));
 if (!tmp_shared_segments) {
  zend_accel_error(0, "Insufficient shared memory!");
  return 0;;
 }

 copy_shared_segments(tmp_shared_segments, (smm_shared_globals->shared_segments)[0], (smm_shared_globals->shared_segments_count), g_shared_alloc_handler->segment_type_size());

 *p_tmp_shared_globals = tmp_shared_globals;
 smm_shared_globals = p_tmp_shared_globals;

 free((smm_shared_globals->shared_segments));
 (smm_shared_globals->shared_segments) = tmp_shared_segments;

 (smm_shared_globals->shared_memory_state).positions = (int *)zend_shared_alloc(sizeof(int) * (smm_shared_globals->shared_segments_count));
 if (!(smm_shared_globals->shared_memory_state).positions) {
  zend_accel_error(0, "Insufficient shared memory!");
  return 0;;
 }

 (accel_globals.locked) = 0;
...
void zend_shared_alloc_shutdown(void)
{
 ...
 smm_shared_globals = &tmp_shared_globals;
 shared_segments_array_size = (smm_shared_globals->shared_segments_count) * (g_shared_alloc_handler->segment_type_size() + sizeof(void *));
 tmp_shared_segments = (__builtin_constant_p((shared_segments_array_size) ) ? (((shared_segments_array_size) <= 8) ? _emalloc_8() : (((shared_segments_array_size) <= 16) ? _emalloc_16() : (((shared_segments_array_size) <= 24) ? _emalloc_24() : (((shared_segments_array_size) <= 32) ? _emalloc_32() : (((shared_segments_array_size) <= 40) ? _emalloc_40() : (((shared_segments_array_size) <= 48) ? _emalloc_48() : (((shared_segments_array_size) <= 56) ? _emalloc_56() : (((shared_segments_array_size) <= 64) ? _emalloc_64() : (((shared_segments_array_size) <= 80) ? _emalloc_80() : (((shared_segments_array_size) <= 96) ? _emalloc_96() : (((shared_segments_array_size) <= 112) ? _emalloc_112() : (((shared_segments_array_size) <= 128) ? _emalloc_128() : (((shared_segments_array_size) <= 160) ? _emalloc_160() : (((shared_segments_array_size) <= 192) ? _emalloc_192() : (((shared_segments_array_size) <= 224) ? _emalloc_224() : (((shared_segments_array_size) <= 256) ? _emalloc_256() : (((shared_segments_array_size) <= 320) ? _emalloc_320() : (((shared_segments_array_size) <= 384) ? _emalloc_384() : (((shared_segments_array_size) <= 448) ? _emalloc_448() : (((shared_segments_array_size) <= 512) ? _emalloc_512() : (((shared_segments_array_size) <= 640) ? _emalloc_640() : (((shared_segments_array_size) <= 768) ? _emalloc_768() : (((shared_segments_array_size) <= 896) ? _emalloc_896() : (((shared_segments_array_size) <= 1024) ? _emalloc_1024() : (((shared_segments_array_size) <= 1280) ? _emalloc_1280() : (((shared_segments_array_size) <= 1536) ? _emalloc_1536() : (((shared_segments_array_size) <= 1792) ? _emalloc_1792() : (((shared_segments_array_size) <= 2048) ? _emalloc_2048() : (((shared_segments_array_size) <= 2560) ? _emalloc_2560() : (((shared_segments_array_size) <= 3072) ? _emalloc_3072() : (((shared_segments_array_size) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((shared_segments_array_size)) : _emalloc_huge((shared_segments_array_size))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((shared_segments_array_size) ) );
 copy_shared_segments(tmp_shared_segments, (smm_shared_globals->shared_segments)[0], (smm_shared_globals->shared_segments_count), g_shared_alloc_handler->segment_type_size());
 (smm_shared_globals->shared_segments) = tmp_shared_segments;

 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  g_shared_alloc_handler->detach_segment((smm_shared_globals->shared_segments)[i]);
 }
 _efree(((smm_shared_globals->shared_segments)) );
 (smm_shared_globals->shared_segments) = ((void *)0);
 g_shared_alloc_handler = ((void *)0);
...
static size_t zend_shared_alloc_get_largest_free_block(void)
{
 ...
 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  size_t block_size = (smm_shared_globals->shared_segments)[i]->size - (smm_shared_globals->shared_segments)[i]->pos;
...
# 308 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
void *zend_shared_alloc(size_t size)
{
 int i;
 unsigned int block_size = (((size) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));


 if (!(accel_globals.locked)) {
  zend_accel_error(1, "Shared memory lock not obtained");
 }

 if (block_size > (smm_shared_globals->shared_free)) {
  do { zend_accel_error(2, "Not enough free shared space to allocate ""%" "l" "d"" bytes (""%" "l" "d"" bytes free)", (zend_long)size, (zend_long)(smm_shared_globals->shared_free)); if (zend_shared_alloc_get_largest_free_block() < 64*1024) { (smm_shared_globals->memory_exhausted) = 1; } } while (0);
  return ((void *)0);
 }
 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  if ((smm_shared_globals->shared_segments)[i]->size - (smm_shared_globals->shared_segments)[i]->pos >= block_size) {
   void *retval = (void *) (((char *) (smm_shared_globals->shared_segments)[i]->p) + (smm_shared_globals->shared_segments)[i]->pos);

   (smm_shared_globals->shared_segments)[i]->pos += block_size;
   (smm_shared_globals->shared_free) -= block_size;
   memset(retval, 0, block_size);
   do { if (__builtin_expect(!(((zend_uintptr_t)retval & 0x7) == 0), 0)) __builtin_unreachable(); } while (0);
   return retval;
  }
 }
 do { zend_accel_error(2, "Not enough free shared space to allocate ""%" "l" "d"" bytes (""%" "l" "d"" bytes free)", (zend_long)size, (zend_long)(smm_shared_globals->shared_free)); if (zend_shared_alloc_get_largest_free_block() < 64*1024) { (smm_shared_globals->memory_exhausted) = 1; } } while (0);
...
int zend_shared_memdup_size(void *source, size_t size)
{
 ...
 if ((old_p = zend_hash_index_find_ptr(&(accel_globals.xlat_table), (zend_ulong)source)) != ((void *)0)) {

  return 0;
 }
 zend_shared_alloc_register_xlat_entry(source, source);
 return (((size) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L));
}
...
void *_zend_shared_memdup(void *source, size_t size, zend_bool free_source)
{
 ...
 retval = (accel_globals.mem);
 (accel_globals.mem) = (void*)(((char*)(accel_globals.mem)) + (((size) + (((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)) & ~(((__alignof__(align_test) < 8 ? 8 : __alignof__(align_test))) - 1L)));
...
static struct flock mem_write_lock = {1, 0, 0, 1, 0};
static struct flock mem_write_unlock = {2, 0, 0, 1, 0};


void zend_shared_alloc_lock(void)
{
# 395 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.c"
 while (1) {
  if (fcntl(lock_file, 7, &mem_write_lock) == -1) {
   if ((*__errno_location ()) == 4) {
    continue;
   }
   zend_accel_error(1, "Cannot create lock - %s (%d)", strerror((*__errno_location ())), (*__errno_location ()));
  }
  break;
 }
...
void zend_shared_alloc_unlock(void)
{
 ...
 if (fcntl(lock_file, 6, &mem_write_unlock) == -1) {
  zend_accel_error(1, "Cannot remove lock - %s (%d)", strerror((*__errno_location ())), (*__errno_location ()));
 }
...
void zend_shared_alloc_init_xlat_table(void)
{
 ...
 _zend_hash_init((&(accel_globals.xlat_table)), (128), (((void *)0)), (1) );
}

void zend_shared_alloc_destroy_xlat_table(void)
{

 zend_hash_destroy(&(accel_globals.xlat_table));
}

void zend_shared_alloc_clear_xlat_table(void)
{
 zend_hash_clean(&(accel_globals.xlat_table));
}

void zend_shared_alloc_register_xlat_entry(const void *old, const void *new)
{
 zend_hash_index_add_new_ptr(&(accel_globals.xlat_table), (zend_ulong)old, (void*)new);
}
...
void *zend_shared_alloc_get_xlat_entry(const void *old)
{
 ...
 if ((retval = zend_hash_index_find_ptr(&(accel_globals.xlat_table), (zend_ulong)old)) == ((void *)0)) {
  return ((void *)0);
 }
 return retval;
}
...
size_t zend_shared_alloc_get_free_memory(void)
{
 return (smm_shared_globals->shared_free);
}
...
void zend_shared_alloc_save_state(void)
{
 ...
 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  (smm_shared_globals->shared_memory_state).positions[i] = (smm_shared_globals->shared_segments)[i]->pos;
 }
 (smm_shared_globals->shared_memory_state).shared_free = (smm_shared_globals->shared_free);
}
...
void zend_shared_alloc_restore_state(void)
{
 ...
 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  (smm_shared_globals->shared_segments)[i]->pos = (smm_shared_globals->shared_memory_state).positions[i];
 }
 (smm_shared_globals->shared_free) = (smm_shared_globals->shared_memory_state).shared_free;
...
void zend_accel_shared_protect(int mode)
{
 ...
 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  mprotect((smm_shared_globals->shared_segments)[i]->p, (smm_shared_globals->shared_segments)[i]->size, mode);
 }
...
int zend_accel_in_shm(void *ptr)
{
 ...
 for (i = 0; i < (smm_shared_globals->shared_segments_count); i++) {
  if ((char*)ptr >= (char*)(smm_shared_globals->shared_segments)[i]->p &&
      (char*)ptr < (char*)(smm_shared_globals->shared_segments)[i]->p + (smm_shared_globals->shared_segments)[i]->size) {
   return 1;
  }
 }
 return 0;
