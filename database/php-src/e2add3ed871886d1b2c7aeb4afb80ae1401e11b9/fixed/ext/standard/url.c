# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c"
# 20 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c"
...
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c" 2
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c" 2
...
# 301 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.h"
typedef enum {
 EH_NORMAL = 0,
 EH_SUPPRESS,
 EH_THROW
...
# 166 "/home/ct584/git/bughunter/repositories/php-src/main/php.h"
...
# 269 "/home/ct584/git/bughunter/repositories/php-src/main/php.h"
extern char **environ;
# 280 "/home/ct584/git/bughunter/repositories/php-src/main/php.h"
...
# 288 "/home/ct584/git/bughunter/repositories/php-src/main/php.h" 2
...
# 333 "/home/ct584/git/bughunter/repositories/php-src/main/php.h"
...
# 394 "/home/ct584/git/bughunter/repositories/php-src/main/php.h"
...
# 413 "/home/ct584/git/bughunter/repositories/php-src/main/php.h" 2
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c" 2
# 42 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c"
__attribute__ ((visibility("default"))) void php_url_free(php_url *theurl)
{
 if (theurl->scheme)
...
__attribute__ ((visibility("default"))) php_url *php_url_parse_ex(char const *str, size_t length)
{
 ...
 if ((e = memchr(s, ':', length)) && (e - s)) {
  ...
  if (pp - p > 0 && pp - p < 6 && (*pp == '/' || *pp == '\0')) {
   ...
   port_buf[pp - p] = '\0';
   port = strtoll((port_buf), (((void *)0)), (10));
 ...
 if ((p = zend_memrchr(s, '@', (e-s)))) {
  ...
  while (pp < p) {
   ...
   if (!((*__ctype_b_loc ())[(int) ((*pp))] & (unsigned short int) _ISalnum) && !strchr(search_rfc3986, *pp)) {
    if (ret->scheme) {
     _efree((ret->scheme) );
    }
    _efree((ret) );
...
void zif_parse_url(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|l", &str, &str_len, &key) == FAILURE) {
  return;
 }
 ...
 if (key > -1) {
  switch (key) {
   case 0:
    if (resource->scheme != ((void *)0)) do { const char *_s = (resource->scheme); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 1:
    if (resource->host != ((void *)0)) do { const char *_s = (resource->host); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 2:
    if (resource->port != 0) { zval *__z = (return_value); (*(__z)).value.lval = resource->port; (*(__z)).u1.type_info = 4; };
    break;
   case 3:
    if (resource->user != ((void *)0)) do { const char *_s = (resource->user); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 4:
    if (resource->pass != ((void *)0)) do { const char *_s = (resource->pass); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 5:
    if (resource->path != ((void *)0)) do { const char *_s = (resource->path); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 6:
    if (resource->query != ((void *)0)) do { const char *_s = (resource->query); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   case 7:
    if (resource->fragment != ((void *)0)) do { const char *_s = (resource->fragment); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0);
    break;
   default:
    php_error_docref0(((void *)0), (1<<1L), "Invalid URL component identifier " "%" "l" "d", key);
 ...
 if (resource->scheme != ((void *)0))
  add_assoc_string_ex(return_value, "scheme", strlen("scheme"), resource->scheme);
 if (resource->host != ((void *)0))
  add_assoc_string_ex(return_value, "host", strlen("host"), resource->host);
 if (resource->port != 0)
  add_assoc_long_ex(return_value, "port", strlen("port"), resource->port);
 if (resource->user != ((void *)0))
  add_assoc_string_ex(return_value, "user", strlen("user"), resource->user);
 if (resource->pass != ((void *)0))
  add_assoc_string_ex(return_value, "pass", strlen("pass"), resource->pass);
 if (resource->path != ((void *)0))
  add_assoc_string_ex(return_value, "path", strlen("path"), resource->path);
 if (resource->query != ((void *)0))
  add_assoc_string_ex(return_value, "query", strlen("query"), resource->query);
 if (resource->fragment != ((void *)0))
  add_assoc_string_ex(return_value, "fragment", strlen("fragment"), resource->fragment);
done:
...
# 498 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c"
...
__attribute__ ((visibility("default"))) zend_string *php_url_encode(char const *s, size_t len)
{
 ...
 while (from < end) {
   ...
   *to++ = '+';
   ...
   to[2] = hexchars[c & 15];
   to += 3;
# 536 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/url.c"
  } else {
   *to++ = c;
  }
 }
...
void zif_urlencode(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { do { zval *__z = (return_value); zend_string *__s = (php_url_encode((in_str)->val, (in_str)->len)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
void zif_rawurlencode(zend_execute_data *execute_data, zval *return_value)
{
 ...
 { do { zval *__z = (return_value); zend_string *__s = (php_raw_url_encode((in_str)->val, (in_str)->len)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}
...
void zif_get_headers(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|lr!", &url, &url_len, &format, &zcontext) == FAILURE) {
  return;
 }
 ...
 if (zval_get_type(&(stream->wrapperdata)) != 7) {
 ...
 if ((h = zend_hash_str_find((zval_get_type(&(*(&stream->wrapperdata)))==7 ? (*(&stream->wrapperdata)).value.arr : ((zval_get_type(&(*(&stream->wrapperdata)))==8 ? (*(&stream->wrapperdata)).value.obj->handlers->get_properties((&stream->wrapperdata)) : ((void *)0)))), "headers", sizeof("headers")-1)) != ((void *)0) && zval_get_type(&(*(h))) == 7) {

  if (!(*(h)).value.arr->nNumOfElements) {
   _php_stream_getc((stream));
  }
  h = zend_hash_str_find((zval_get_type(&(*(&stream->wrapperdata)))==7 ? (*(&stream->wrapperdata)).value.arr : ((zval_get_type(&(*(&stream->wrapperdata)))==8 ? (*(&stream->wrapperdata)).value.obj->handlers->get_properties((&stream->wrapperdata)) : ((void *)0)))), "headers", sizeof("headers")-1);
  hashT = (*(h)).value.arr;
 } else {
  hashT = (zval_get_type(&(*(&stream->wrapperdata)))==7 ? (*(&stream->wrapperdata)).value.arr : ((zval_get_type(&(*(&stream->wrapperdata)))==8 ? (*(&stream->wrapperdata)).value.obj->handlers->get_properties((&stream->wrapperdata)) : ((void *)0))));
 }

 do { Bucket *_p = (hashT)->arData; Bucket *_end = _p + (hashT)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; hdr = _z; {
  if (zval_get_type(&(*(hdr))) != 6) {
   continue;
  }
  if (!format) {
no_name_header:
   add_next_index_str(return_value, zend_string_copy((*(hdr)).value.str));
  } else {
   char c;
   char *s, *p;

   if ((p = strchr(((*(hdr)).value.str)->val, ':'))) {
    c = *p;
    *p = '\0';
    s = p + 1;
    ...
    if ((prev_val = zend_hash_str_find((*(return_value)).value.arr, ((*(hdr)).value.str)->val, (p - ((*(hdr)).value.str)->val))) == ((void *)0)) {
     add_assoc_stringl_ex(return_value, ((*(hdr)).value.str)->val, (p - ((*(hdr)).value.str)->val), s, (((*(hdr)).value.str)->len - (s - ((*(hdr)).value.str)->val)));
    } else {
     convert_to_array(prev_val);
     add_next_index_stringl(prev_val, s, (((*(hdr)).value.str)->len - (s - ((*(hdr)).value.str)->val)));
    }
