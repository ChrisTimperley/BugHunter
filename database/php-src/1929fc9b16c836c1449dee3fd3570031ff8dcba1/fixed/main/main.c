...
{
 int retval = SUCCESS;
# 1579 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  (core_globals.in_error_log) = 0;
  (core_globals.during_request_startup) = 1;
  ...
  if ((core_globals.expose_php)) {
   sapi_add_header_ex(("X-Powered-By: PHP/" "7.0.6-dev"),(sizeof("X-Powered-By: PHP/" "7.0.6-dev")-1),(1),1);
  }
...
# 1672 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 1874 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
}
...
# 1911 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
void zm_info_php_core(zend_module_entry *zend_module) {
 ...
 php_info_print_table_row(2, "PHP Version", "7.0.6-dev");
...
# 1965 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 2011 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 2035 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 php_os = "Linux";
# 2046 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 module_shutdown = 0;
 module_startup = 1;
 ...
 php_output_startup();
# 2066 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 php_startup_ticks();
 ...
 tzset();
# 2104 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 le_index_ptr = zend_register_list_destructors_ex(((void *)0), ((void *)0), "index pointer", 0);


 zend_register_stringl_constant(("PHP_VERSION"), sizeof("PHP_VERSION")-1, ("7.0.6-dev"), (sizeof("7.0.6-dev")-1), ((1<<1) | (1<<0)), 0);
 ...
 zend_register_long_constant(("PHP_RELEASE_VERSION"), sizeof("PHP_RELEASE_VERSION")-1, (6), ((1<<1) | (1<<0)), 0);
 zend_register_stringl_constant(("PHP_EXTRA_VERSION"), sizeof("PHP_EXTRA_VERSION")-1, ("-dev"), (sizeof("-dev") - 1), ((1<<1) | (1<<0)), 0);
 zend_register_long_constant(("PHP_VERSION_ID"), sizeof("PHP_VERSION_ID")-1, (70006), ((1<<1) | (1<<0)), 0);
...
# 2157 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 php_binary_init();
 if ((core_globals.php_binary)) {
...
# 2216 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 2360 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 sapi_flush();
 ...
 gc_globals_dtor();
# 2395 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
}
...
__attribute__ ((visibility("default"))) void php_handle_aborted_connection(void)
{
 ...
 if (!(core_globals.ignore_user_abort)) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/main/main.c", 2565);
 }
}
