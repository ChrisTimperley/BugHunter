# 1 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2

# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 27 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
# 1 "/usr/include/errno.h" 1 3 4
# 28 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
# 48 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
...
# 49 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
...
# 56 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
# 69 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
...
# 70 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
...
# 71 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
...
# 73 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/main/php_network.h"
# 1 "main/php.h" 1
# 25 "/home/ct584/git/bughunter/repositories/php-src/main/php_network.h" 2
...
# 125 "/home/ct584/git/bughunter/repositories/php-src/main/php_network.h"
...
# 81 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
...
# 88 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
...
# 91 "/home/ct584/git/bughunter/repositories/php-src/main/network.c" 2
# 154 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
__attribute__ ((visibility("default"))) void php_network_freeaddresses(struct sockaddr **sal)
{
 struct sockaddr **sap;
...
# 199 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
 if (ipv6_borked == -1) {
  int s;
 ...
 if ((n = getaddrinfo(host, ((void *)0), &hints, &res))) {
  if (error_string) {
   *error_string = strpprintf(0, "php_network_getaddresses: getaddrinfo failed: %s", (gai_strerror(n)));
   php_error_docref0(((void *)0), (1<<1L), "%s", (*error_string)->val);
  } else {
  ...
  if (error_string) {
   *error_string = strpprintf(0, "php_network_getaddresses: getaddrinfo failed (null result pointer) errno=%d", (*__errno_location ()));
   php_error_docref0(((void *)0), (1<<1L), "%s", (*error_string)->val);
  } else {
 ...
 *sal = _safe_emalloc(((n + 1)), (sizeof(*sal)), (0) );
 ...
 do {
  *sap = (__builtin_constant_p((sai->ai_addrlen) ) ? (((sai->ai_addrlen) <= 8) ? _emalloc_8() : (((sai->ai_addrlen) <= 16) ? _emalloc_16() : (((sai->ai_addrlen) <= 24) ? _emalloc_24() : (((sai->ai_addrlen) <= 32) ? _emalloc_32() : (((sai->ai_addrlen) <= 40) ? _emalloc_40() : (((sai->ai_addrlen) <= 48) ? _emalloc_48() : (((sai->ai_addrlen) <= 56) ? _emalloc_56() : (((sai->ai_addrlen) <= 64) ? _emalloc_64() : (((sai->ai_addrlen) <= 80) ? _emalloc_80() : (((sai->ai_addrlen) <= 96) ? _emalloc_96() : (((sai->ai_addrlen) <= 112) ? _emalloc_112() : (((sai->ai_addrlen) <= 128) ? _emalloc_128() : (((sai->ai_addrlen) <= 160) ? _emalloc_160() : (((sai->ai_addrlen) <= 192) ? _emalloc_192() : (((sai->ai_addrlen) <= 224) ? _emalloc_224() : (((sai->ai_addrlen) <= 256) ? _emalloc_256() : (((sai->ai_addrlen) <= 320) ? _emalloc_320() : (((sai->ai_addrlen) <= 384) ? _emalloc_384() : (((sai->ai_addrlen) <= 448) ? _emalloc_448() : (((sai->ai_addrlen) <= 512) ? _emalloc_512() : (((sai->ai_addrlen) <= 640) ? _emalloc_640() : (((sai->ai_addrlen) <= 768) ? _emalloc_768() : (((sai->ai_addrlen) <= 896) ? _emalloc_896() : (((sai->ai_addrlen) <= 1024) ? _emalloc_1024() : (((sai->ai_addrlen) <= 1280) ? _emalloc_1280() : (((sai->ai_addrlen) <= 1536) ? _emalloc_1536() : (((sai->ai_addrlen) <= 1792) ? _emalloc_1792() : (((sai->ai_addrlen) <= 2048) ? _emalloc_2048() : (((sai->ai_addrlen) <= 2560) ? _emalloc_2560() : (((sai->ai_addrlen) <= 3072) ? _emalloc_3072() : (((sai->ai_addrlen) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sai->ai_addrlen)) : _emalloc_huge((sai->ai_addrlen))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sai->ai_addrlen) ) );
  memcpy(*sap, sai->ai_addr, sai->ai_addrlen);
  sap++;
 } while ((sai = sai->ai_next) != ((void *)0));

 freeaddrinfo(res);
# 275 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
 *sap = ((void *)0);
 return n;
}
# 293 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
typedef int php_non_blocking_flags_t;
# 307 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
__attribute__ ((visibility("default"))) int php_network_connect_socket(php_socket_t sockfd,
  const struct sockaddr *addr,
  socklen_t addrlen,
  int asynchronous,
...
# 357 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
  ...
  )
{
 ...
 for (sal = psal; *sal != ((void *)0); sal++) {
  ...
  if (sa) {
   ...
   setsockopt(sock, 1, 2, (char*)&sockoptval, sizeof(sockoptval));


   if (sockopts & (1 << 3)) {
    int ipv6_val = !!(sockopts & (1 << 4));
    setsockopt(sock, IPPROTO_IPV6, 26, (char*)&ipv6_val, sizeof(sockoptval));
   }


   if (sockopts & (1 << 1)) {
    setsockopt(sock, 1, 15, (char*)&sockoptval, sizeof(sockoptval));
   }


   if (sockopts & (1 << 2)) {
    setsockopt(sock, 1, 6, (char*)&sockoptval, sizeof(sockoptval));
   }
...
__attribute__ ((visibility("default"))) int php_network_parse_network_address_with_port(const char *addr, zend_long addrlen, struct sockaddr *sa, socklen_t *sl)
{
 char *colon;
 char *tmp;
 int ret = FAILURE;
 ...
 if (n == 0) {
  if (errstr) {
   php_error_docref0(((void *)0), (1<<1L), "Failed to resolve `%s': %s", tmp, (errstr)->val);
...
{
 if (addr) {
  *addr = (__builtin_constant_p((sl) ) ? (((sl) <= 8) ? _emalloc_8() : (((sl) <= 16) ? _emalloc_16() : (((sl) <= 24) ? _emalloc_24() : (((sl) <= 32) ? _emalloc_32() : (((sl) <= 40) ? _emalloc_40() : (((sl) <= 48) ? _emalloc_48() : (((sl) <= 56) ? _emalloc_56() : (((sl) <= 64) ? _emalloc_64() : (((sl) <= 80) ? _emalloc_80() : (((sl) <= 96) ? _emalloc_96() : (((sl) <= 112) ? _emalloc_112() : (((sl) <= 128) ? _emalloc_128() : (((sl) <= 160) ? _emalloc_160() : (((sl) <= 192) ? _emalloc_192() : (((sl) <= 224) ? _emalloc_224() : (((sl) <= 256) ? _emalloc_256() : (((sl) <= 320) ? _emalloc_320() : (((sl) <= 384) ? _emalloc_384() : (((sl) <= 448) ? _emalloc_448() : (((sl) <= 512) ? _emalloc_512() : (((sl) <= 640) ? _emalloc_640() : (((sl) <= 768) ? _emalloc_768() : (((sl) <= 896) ? _emalloc_896() : (((sl) <= 1024) ? _emalloc_1024() : (((sl) <= 1280) ? _emalloc_1280() : (((sl) <= 1536) ? _emalloc_1536() : (((sl) <= 1792) ? _emalloc_1792() : (((sl) <= 2048) ? _emalloc_2048() : (((sl) <= 2560) ? _emalloc_2560() : (((sl) <= 3072) ? _emalloc_3072() : (((sl) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sl)) : _emalloc_huge((sl))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sl) ) );
  memcpy(*addr, sa, sl);
  *addrlen = sl;
 }
...
# 723 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
__attribute__ ((visibility("default"))) php_socket_t php_network_accept_incoming(php_socket_t srvsock,
  zend_string **textaddr,
  struct sockaddr **addr,
  socklen_t *addrlen,
...
# 778 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
...
skip_bind:
...

   {
    int val = 1;
    if (sockopts & (1 << 2)) {
     setsockopt(sock, 1, 6, (char*)&val, sizeof(val));
    }
   }
...
# 940 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
  }
...
# 1009 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
__attribute__ ((visibility("default"))) char *php_socket_strerror(long err, char *buf, size_t bufsize)
{
 ...
 return buf;
# 1053 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
}
...
# 1091 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
}
...
__attribute__ ((visibility("default"))) php_stream *_php_stream_sock_open_from_socket(php_socket_t socket, const char *persistent_id )
{
 ...
 sock = ((persistent_id ? 1 : 0)?__zend_malloc(sizeof(php_netstream_data_t)):(__builtin_constant_p((sizeof(php_netstream_data_t)) ) ? (((sizeof(php_netstream_data_t)) <= 8) ? _emalloc_8() : (((sizeof(php_netstream_data_t)) <= 16) ? _emalloc_16() : (((sizeof(php_netstream_data_t)) <= 24) ? _emalloc_24() : (((sizeof(php_netstream_data_t)) <= 32) ? _emalloc_32() : (((sizeof(php_netstream_data_t)) <= 40) ? _emalloc_40() : (((sizeof(php_netstream_data_t)) <= 48) ? _emalloc_48() : (((sizeof(php_netstream_data_t)) <= 56) ? _emalloc_56() : (((sizeof(php_netstream_data_t)) <= 64) ? _emalloc_64() : (((sizeof(php_netstream_data_t)) <= 80) ? _emalloc_80() : (((sizeof(php_netstream_data_t)) <= 96) ? _emalloc_96() : (((sizeof(php_netstream_data_t)) <= 112) ? _emalloc_112() : (((sizeof(php_netstream_data_t)) <= 128) ? _emalloc_128() : (((sizeof(php_netstream_data_t)) <= 160) ? _emalloc_160() : (((sizeof(php_netstream_data_t)) <= 192) ? _emalloc_192() : (((sizeof(php_netstream_data_t)) <= 224) ? _emalloc_224() : (((sizeof(php_netstream_data_t)) <= 256) ? _emalloc_256() : (((sizeof(php_netstream_data_t)) <= 320) ? _emalloc_320() : (((sizeof(php_netstream_data_t)) <= 384) ? _emalloc_384() : (((sizeof(php_netstream_data_t)) <= 448) ? _emalloc_448() : (((sizeof(php_netstream_data_t)) <= 512) ? _emalloc_512() : (((sizeof(php_netstream_data_t)) <= 640) ? _emalloc_640() : (((sizeof(php_netstream_data_t)) <= 768) ? _emalloc_768() : (((sizeof(php_netstream_data_t)) <= 896) ? _emalloc_896() : (((sizeof(php_netstream_data_t)) <= 1024) ? _emalloc_1024() : (((sizeof(php_netstream_data_t)) <= 1280) ? _emalloc_1280() : (((sizeof(php_netstream_data_t)) <= 1536) ? _emalloc_1536() : (((sizeof(php_netstream_data_t)) <= 1792) ? _emalloc_1792() : (((sizeof(php_netstream_data_t)) <= 2048) ? _emalloc_2048() : (((sizeof(php_netstream_data_t)) <= 2560) ? _emalloc_2560() : (((sizeof(php_netstream_data_t)) <= 3072) ? _emalloc_3072() : (((sizeof(php_netstream_data_t)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(php_netstream_data_t))) : _emalloc_huge((sizeof(php_netstream_data_t)))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(php_netstream_data_t)) ) ));
...
{
 int ret = SUCCESS;
# 1149 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
 int myflag = 0;
...
__attribute__ ((visibility("default"))) void _php_emit_fd_setsize_warning(int max_fd)
{
# 1183 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
...
# 1263 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
...
# 1332 "/home/ct584/git/bughunter/repositories/php-src/main/network.c"
__attribute__ ((visibility("default"))) struct hostent* php_network_gethostbyname(char *name) {



 if ((file_globals.tmp_host_buf)) {
  free((file_globals.tmp_host_buf));
 }

 (file_globals.tmp_host_buf) = ((void *)0);
 (file_globals.tmp_host_buf_len) = 0;

 memset(&(file_globals.tmp_host_info), 0, sizeof(struct hostent));

 return gethostname_re(name, &(file_globals.tmp_host_info), &(file_globals.tmp_host_buf), &(file_globals.tmp_host_buf_len));
