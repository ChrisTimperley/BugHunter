...
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 94 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 95 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 1 "Zend/zend_strtod.h" 1
# 96 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
...
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/stddef.h" 1 3 4
# 102 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
...
# 104 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
...
# 111 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
...
# 119 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 204 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 1 "/usr/include/errno.h" 1 3 4
# 205 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
# 246 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/4.8/include/float.h" 1 3 4
# 247 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c" 2
...
# 273 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 typedef union {
      double d;
       uint32_t ul[2];
 } _double;
# 418 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
struct Bigint {
 struct Bigint *next;
...
# 453 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
__attribute__ ((visibility("default"))) int zend_startup_strtod(void)
{
...
# 749 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 879 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 else do
  *x1++ = *x++;
 while(x < xe);
 b1->wds = n1 - 1;
...
# 984 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 while(!*--xc) {
  wa--;
 }
 c->wds = wa;
...
# 1084 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
ret_d:
...
static Bigint * d2b(double _d, int *e, int *bits)
{
 ...
 ((d).d) = _d;
# 1116 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 b = Balloc(1);
...
# 1195 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (de) {
...
# 1245 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 if (k > 0) {
  ((da).ul[1]) += k*0x100000;
 } else {
  k = -k;
...
# 1282 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 1333 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  }
  while(sx <= sxe);
  if (!*bxe) {
   bx = b->x;
 ...
 if (cmp(b, S) >= 0) {
  ...
  do {
   ...
   ;
   (((unsigned short *)bx)[1] = (unsigned short)z, ((unsigned short *)bx)[0] = (unsigned short)y, bx++);
# 1369 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  }
  while(sx <= sxe);
  bx = b->x;
  bxe = bx + n;
...
# 1442 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
__attribute__ ((visibility("default"))) char * zend_dtoa(double _d, int mode, int ndigits, int *decpt, int *sign, char **rve)
{
# 1478 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 ...
 if ((i = (int)(((d).ul[1]) >> 20 & (0x7ff00000>>20)))) {
  ...
  ((d2).ul[1]) &= 0xfffff;
  ((d2).ul[1]) |= 0x3ff00000;
# 1561 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
  i -= 1023;
...
# 1870 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
 ...
 if (nd <= 15
  ...
  if (e > 0) {
   ...
   if (e <= 22 + i) {
    ...
    e -= i;
    ((rv).d) *= tens[i];
# 2212 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
                      ((rv).d) *= tens[e]
              ;
...
# 2249 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
    if (bd0)
     goto retfree;
    goto ret;
   }
...
drop_down:
# 2415 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
...
# 2477 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
   if (1 == 0)
    aadj1 += 0.5;
...
# 2536 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_strtod.c"
