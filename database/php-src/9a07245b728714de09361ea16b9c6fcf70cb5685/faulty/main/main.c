...
# 952 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 1137 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 }
  ...
  case (1<<8L):
   ...
   if (module_initialized) {
    ...
    if (type == (1<<2L)) {
     ...
     _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/main/main.c", 1172);
     return;
    }
   }
   break;
...
# 1233 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
  struct passwd *pwd;
# 1254 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
static __attribute__((cold)) void php_message_handler_for_zend(zend_long message, const void *data)
{
 switch (message) {
  ...
  case 4L:
  case 5L:
# 1450 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
   break;
  case 7L:
# 1464 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
   break;
  case 6L: {
    struct tm *ta, tmbuf;
    time_t curtime;
...
# 1516 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
{
 int retval = SUCCESS;
# 1563 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  (core_globals.in_error_log) = 0;
  (core_globals.during_request_startup) = 1;
...
# 1656 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 1851 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
}
...
# 1888 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 1942 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 1988 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 2012 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 php_os = "Linux";
# 2023 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 module_shutdown = 0;
 module_startup = 1;
 ...
 php_output_startup();
# 2043 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 php_startup_ticks();
 ...
 tzset();
# 2081 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 2134 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 php_binary_init();
 if ((core_globals.php_binary)) {
...
# 2193 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
...
# 2337 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
 sapi_flush();
 ...
 gc_globals_dtor();
# 2372 "/home/ct584/git/bughunter/repositories/php-src/main/main.c"
}
...
__attribute__ ((visibility("default"))) void php_handle_aborted_connection(void)
{
 ...
 if (!(core_globals.ignore_user_abort)) {
  _zend_bailout("/home/ct584/git/bughunter/repositories/php-src/main/main.c", 2542);
 }
}
