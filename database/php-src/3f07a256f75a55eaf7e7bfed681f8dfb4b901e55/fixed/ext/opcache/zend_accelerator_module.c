# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_ini.h" 1
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
# 34 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_module.c" 2
...
static void (*orig_file_exists)(zend_execute_data *execute_data, zval *return_value) = ((void *)0);
static void (*orig_is_file)(zend_execute_data *execute_data, zval *return_value) = ((void *)0);
static void (*orig_is_readable)(zend_execute_data *execute_data, zval *return_value) = ((void *)0);

static const zend_internal_arg_info arginfo_opcache_none[] = { { (const char*)(zend_uintptr_t)(-1), ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_opcache_get_status[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "fetch_scripts", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_opcache_compile_file[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "file", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_opcache_invalidate[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "script", ((void *)0), 0, 0, 0, 0 },
 { "force", ((void *)0), 0, 0, 0, 0 },
};

static const zend_internal_arg_info arginfo_opcache_is_script_cached[] = { { (const char*)(zend_uintptr_t)(1), ((void *)0), 0, 0, 0, 0 },
 { "script", ((void *)0), 0, 0, 0, 0 },
};


static void zif_opcache_reset(zend_execute_data *execute_data, zval *return_value);
static void zif_opcache_invalidate(zend_execute_data *execute_data, zval *return_value);
static void zif_opcache_is_script_cached(zend_execute_data *execute_data, zval *return_value);


static void zif_opcache_get_status(zend_execute_data *execute_data, zval *return_value);
static void zif_opcache_compile_file(zend_execute_data *execute_data, zval *return_value);
static void zif_opcache_get_configuration(zend_execute_data *execute_data, zval *return_value);

static zend_function_entry accel_functions[] = {

 { "opcache_reset", zif_opcache_reset, arginfo_opcache_none, (uint32_t) (sizeof(arginfo_opcache_none)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "opcache_invalidate", zif_opcache_invalidate, arginfo_opcache_invalidate, (uint32_t) (sizeof(arginfo_opcache_invalidate)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "opcache_compile_file", zif_opcache_compile_file, arginfo_opcache_compile_file, (uint32_t) (sizeof(arginfo_opcache_compile_file)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "opcache_is_script_cached", zif_opcache_is_script_cached, arginfo_opcache_is_script_cached, (uint32_t) (sizeof(arginfo_opcache_is_script_cached)/sizeof(struct _zend_internal_arg_info)-1), 0 },

 { "opcache_get_configuration", zif_opcache_get_configuration, arginfo_opcache_none, (uint32_t) (sizeof(arginfo_opcache_none)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { "opcache_get_status", zif_opcache_get_status, arginfo_opcache_get_status, (uint32_t) (sizeof(arginfo_opcache_get_status)/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static int validate_api_restriction(void)
{
 if ((accel_globals.accel_directives).restrict_api && *(accel_globals.accel_directives).restrict_api) {
  int len = strlen((accel_globals.accel_directives).restrict_api);

  if (!(sapi_globals.request_info).path_translated ||
      strlen((sapi_globals.request_info).path_translated) < len ||
      memcmp((sapi_globals.request_info).path_translated, (accel_globals.accel_directives).restrict_api, len) != 0) {
   zend_error((1<<1L), "Zend OPcache" " API is restricted by \"restrict_api\" configuration directive");
   return 0;
  }
 }
 return 1;
...
static int OnUpdateMemoryConsumption(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 zend_long *p;
 zend_long memsize;
 ...
 if (memsize < 8) {
  ...
  if ((ini_entry = zend_hash_str_find_ptr((executor_globals.ini_directives),
     "opcache.memory_consumption",
     sizeof("opcache.memory_consumption")-1)) == ((void *)0)) {
   return FAILURE;
  }
...
static int OnUpdateMaxAcceleratedFiles(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 zend_long *p;
 zend_long size;
 ...
 if (size < 200 || size > 1000000) {
  ...
  if ((ini_entry = zend_hash_str_find_ptr((executor_globals.ini_directives),
     ...
     sizeof("opcache.max_accelerated_files")-1)) == ((void *)0)) {
   return FAILURE;
  }
...
static int OnUpdateMaxWastedPercentage(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 double *p;
 ...
 if (percentage <= 0 || percentage > 50) {
  ...
  if ((ini_entry = zend_hash_str_find_ptr((executor_globals.ini_directives),
     ...
     sizeof("opcache.max_wasted_percentage")-1)) == ((void *)0)) {
   return FAILURE;
  }
  ini_entry->value = zend_string_init(new_new_value, strlen(new_new_value), 1);
 }
...
static int OnEnable(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 if (stage == (1<<0) ||
     stage == (1<<1) ||
     stage == (1<<3)) {
...
static int OnUpdateFileCache(zend_ini_entry *entry, zend_string *new_value, void *mh_arg1, void *mh_arg2, void *mh_arg3, int stage)
{
 if (new_value) {
  if (!(new_value)->len) {
   new_value = ((void *)0);
   ...
   zend_stat_t buf;
    ...
    access((new_value)->val, 4 | 2 | 1) != 0) {



    zend_accel_error(2, "opcache.file_cache must be a full path of accessable directory.\n");
    new_value = ((void *)0);
   }
  }
 }
...
static const zend_ini_entry_def ini_entries[] = {
 { "opcache.enable", OnEnable, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->enabled))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.enable")-1, sizeof("1")-1 },
 { "opcache.use_cwd", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.use_cwd))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, (1<<2), sizeof("opcache.use_cwd")-1, sizeof("1")-1 },
 { "opcache.validate_timestamps", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.validate_timestamps))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.validate_timestamps")-1, sizeof("1")-1 },
 { "opcache.inherited_hack", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.inherited_hack))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", zend_ini_boolean_displayer_cb, (1<<2), sizeof("opcache.inherited_hack")-1, sizeof("1")-1 },
 { "opcache.dups_fix", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.ignore_dups))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.dups_fix")-1, sizeof("0")-1 },
 { "opcache.revalidate_path", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.revalidate_path))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", zend_ini_boolean_displayer_cb, ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.revalidate_path")-1, sizeof("0")-1 },

 { "opcache.log_verbosity_level", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.log_verbosity_level))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("opcache.log_verbosity_level")-1, sizeof("1")-1 },
 { "opcache.memory_consumption", OnUpdateMemoryConsumption, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.memory_consumption))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "64", ((void *)0), (1<<2), sizeof("opcache.memory_consumption")-1, sizeof("64")-1 },
 { "opcache.interned_strings_buffer", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.interned_strings_buffer))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "4", ((void *)0), (1<<2), sizeof("opcache.interned_strings_buffer")-1, sizeof("4")-1 },
 { "opcache.max_accelerated_files", OnUpdateMaxAcceleratedFiles, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.max_accelerated_files))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "2000", ((void *)0), (1<<2), sizeof("opcache.max_accelerated_files")-1, sizeof("2000")-1 },
 { "opcache.max_wasted_percentage", OnUpdateMaxWastedPercentage, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.max_wasted_percentage))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "5", ((void *)0), (1<<2), sizeof("opcache.max_wasted_percentage")-1, sizeof("5")-1 },
 { "opcache.consistency_checks", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.consistency_checks))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.consistency_checks")-1, sizeof("0")-1 },
 { "opcache.force_restart_timeout", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.force_restart_timeout))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "180", ((void *)0), (1<<2), sizeof("opcache.force_restart_timeout")-1, sizeof("180")-1 },
 { "opcache.revalidate_freq", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.revalidate_freq))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "2", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.revalidate_freq")-1, sizeof("2")-1 },
 { "opcache.file_update_protection", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.file_update_protection))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "2", ((void *)0), ((1<<0)|(1<<1)|(1<<2)), sizeof("opcache.file_update_protection")-1, sizeof("2")-1 },
 { "opcache.preferred_memory_model", OnUpdateStringUnempty, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.memory_model))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "", ((void *)0), (1<<2), sizeof("opcache.preferred_memory_model")-1, sizeof("")-1 },
 { "opcache.blacklist_filename", OnUpdateString, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.user_blacklist_filename))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "", ((void *)0), (1<<2), sizeof("opcache.blacklist_filename")-1, sizeof("")-1 },
 { "opcache.max_file_size", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.max_file_size))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", ((void *)0), (1<<2), sizeof("opcache.max_file_size")-1, sizeof("0")-1 },

 { "opcache.protect_memory", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.protect_memory))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", ((void *)0), (1<<2), sizeof("opcache.protect_memory")-1, sizeof("0")-1 },
 { "opcache.save_comments", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.save_comments))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("opcache.save_comments")-1, sizeof("1")-1 },
 { "opcache.fast_shutdown", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.fast_shutdown))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", ((void *)0), (1<<2), sizeof("opcache.fast_shutdown")-1, sizeof("0")-1 },

 { "opcache.optimization_level", OnUpdateLong, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.optimization_level))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0x7FFFBFFF", ((void *)0), (1<<2), sizeof("opcache.optimization_level")-1, sizeof("0x7FFFBFFF")-1 },
 { "opcache.enable_file_override", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.file_override_enabled))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", zend_ini_boolean_displayer_cb, (1<<2), sizeof("opcache.enable_file_override")-1, sizeof("0")-1 },
 { "opcache.enable_cli", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.enable_cli))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", zend_ini_boolean_displayer_cb, (1<<2), sizeof("opcache.enable_cli")-1, sizeof("0")-1 },
 { "opcache.error_log", OnUpdateString, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.error_log))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "", ((void *)0), (1<<2), sizeof("opcache.error_log")-1, sizeof("")-1 },
 { "opcache.restrict_api", OnUpdateString, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.restrict_api))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "", ((void *)0), (1<<2), sizeof("opcache.restrict_api")-1, sizeof("")-1 },
 ...
 { "opcache.file_cache", OnUpdateFileCache, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.file_cache))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), ((void *)0), ((void *)0), (1<<2), sizeof("opcache.file_cache")-1, sizeof(((void *)0))-1 },
 { "opcache.file_cache_only", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.file_cache_only))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", ((void *)0), (1<<2), sizeof("opcache.file_cache_only")-1, sizeof("0")-1 },
 { "opcache.file_cache_consistency_checks", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.file_cache_consistency_checks))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "1", ((void *)0), (1<<2), sizeof("opcache.file_cache_consistency_checks")-1, sizeof("1")-1 },





 { "opcache.huge_code_pages", OnUpdateBool, (void *) ((zend_long) (((char *) (&(((zend_accel_globals*)((void *)0))->accel_directives.huge_code_pages))) - ((char *) ((void *)0)))), (void *) &accel_globals, ((void *)0), "0", zend_ini_boolean_displayer_cb, (1<<2), sizeof("opcache.huge_code_pages")-1, sizeof("0")-1 },
...
static int filename_is_in_cache(zend_string *filename)
{
 ...
 if (key != ((void *)0)) {
  zend_persistent_script *persistent_script = zend_accel_hash_str_find(&(accel_shared_globals->hash), key, key_length);
  if (persistent_script && !persistent_script->corrupted) {
   zend_file_handle handle = {{0}, ((void *)0), ((void *)0), 0, 0};
...
static int accel_file_in_cache(zend_execute_data *execute_data, zval *return_value)
{
 zval zfilename;

 if ((execute_data)->This.u2.num_args != 1 ||
     _zend_get_parameters_array_ex(1, &zfilename) == FAILURE ||
     zval_get_type(&(zfilename)) != 6 ||
     ((zfilename).value.str)->len == 0) {
  return 0;
 }
 return filename_is_in_cache((zfilename).value.str);
}

static void accel_file_exists(zend_execute_data *execute_data, zval *return_value)
{
 if (accel_file_in_cache(execute_data, return_value)) {
  { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
 } else {
  orig_file_exists(execute_data, return_value);
 }
}

static void accel_is_file(zend_execute_data *execute_data, zval *return_value)
{
 if (accel_file_in_cache(execute_data, return_value)) {
  { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
 } else {
  orig_is_file(execute_data, return_value);
 }
}

static void accel_is_readable(zend_execute_data *execute_data, zval *return_value)
{
 if (accel_file_in_cache(execute_data, return_value)) {
  { do { (*(return_value)).u1.type_info = 3; } while (0); return; };
 } else {
  orig_is_readable(execute_data, return_value);
 }
}
...
void zend_accel_override_file_functions(void)
{
 ...
 if ((accel_globals.enabled) && accel_startup_ok && (accel_globals.accel_directives).file_override_enabled) {
  ...
  if ((accel_globals.accel_directives).file_cache_only) {
   zend_accel_error(2, "file_override_enabled has no effect when file_cache_only is set");
   return;
  }


  if ((old_function = zend_hash_str_find_ptr((compiler_globals.function_table), "file_exists", sizeof("file_exists")-1)) != ((void *)0)) {
   orig_file_exists = old_function->internal_function.handler;
   old_function->internal_function.handler = accel_file_exists;
  }
  if ((old_function = zend_hash_str_find_ptr((compiler_globals.function_table), "is_file", sizeof("is_file")-1)) != ((void *)0)) {
   orig_is_file = old_function->internal_function.handler;
   old_function->internal_function.handler = accel_is_file;
  }
  if ((old_function = zend_hash_str_find_ptr((compiler_globals.function_table), "is_readable", sizeof("is_readable")-1)) != ((void *)0)) {
...
void zend_accel_info(zend_module_entry *zend_module)
{
 ...
 if ((accel_globals.enabled) && accel_startup_ok &&
  ...
  (((accel_globals.counted) || (accel_shared_globals->accelerator_enabled)) || (accel_globals.accel_directives).file_cache_only)
 ...
 if ((accel_globals.enabled) && accel_startup_ok && (accel_globals.accel_directives).optimization_level) {
 ...
 if ((accel_globals.enabled)) {
  if (!accel_startup_ok || zps_api_failure_reason) {
   ...
   ap_php_snprintf(buf, sizeof(buf), "%pd", (zend_ulong)(accel_shared_globals->hits));
   php_info_print_table_row(2, "Cache hits", buf);
   ap_php_snprintf(buf, sizeof(buf), "%pd", (smm_shared_globals->memory_exhausted)?(accel_shared_globals->misses):(accel_shared_globals->misses)-(accel_shared_globals->blacklist_misses));
   php_info_print_table_row(2, "Cache misses", buf);
   ap_php_snprintf(buf, sizeof(buf), "%" "l" "d", (accel_globals.accel_directives).memory_consumption-zend_shared_alloc_get_free_memory()-(smm_shared_globals->wasted_shared_memory));
   php_info_print_table_row(2, "Used memory", buf);
   ap_php_snprintf(buf, sizeof(buf), "%pd", zend_shared_alloc_get_free_memory());
   php_info_print_table_row(2, "Free memory", buf);
   ap_php_snprintf(buf, sizeof(buf), "%pd", (smm_shared_globals->wasted_shared_memory));
   php_info_print_table_row(2, "Wasted memory", buf);
   if ((accel_shared_globals->interned_strings_start) && (accel_shared_globals->interned_strings_end) && (accel_shared_globals->interned_strings_top)) {
    ap_php_snprintf(buf, sizeof(buf), "%pd", (accel_shared_globals->interned_strings_top) - (accel_shared_globals->interned_strings_start));
    php_info_print_table_row(2, "Interned Strings Used memory", buf);
    ap_php_snprintf(buf, sizeof(buf), "%pd", (accel_shared_globals->interned_strings_end) - (accel_shared_globals->interned_strings_top));
   ...
   ap_php_snprintf(buf, sizeof(buf), "%pd", (accel_shared_globals->hash).max_num_entries);
   php_info_print_table_row(2, "Max keys", buf);
   ap_php_snprintf(buf, sizeof(buf), "%pd", (accel_shared_globals->oom_restarts));
   php_info_print_table_row(2, "OOM restarts", buf);
   ap_php_snprintf(buf, sizeof(buf), "%pd", (accel_shared_globals->hash_restarts));
   php_info_print_table_row(2, "Hash keys restarts", buf);
   ap_php_snprintf(buf, sizeof(buf), "%pd", (accel_shared_globals->manual_restarts));
...
static int accelerator_get_scripts(zval *return_value)
{
 ...
 for (i = 0; i<(accel_shared_globals->hash).max_num_entries; i++) {
  for (cache_entry = (accel_shared_globals->hash).hash_table[i]; cache_entry; cache_entry = cache_entry->next) {
   ...
   add_assoc_str_ex(&persistent_script_report, "full_path", strlen("full_path"), zend_string_dup(script->full_path, 0));
   add_assoc_long_ex(&persistent_script_report, "hits", strlen("hits"), (zend_long)script->dynamic_members.hits);
   add_assoc_long_ex(&persistent_script_report, "memory_consumption", strlen("memory_consumption"), script->dynamic_members.memory_consumption);
   ta = localtime(&script->dynamic_members.last_used);
   str = asctime(ta);
   len = strlen(str);
   if (len > 0 && str[len - 1] == '\n') len--;
   add_assoc_stringl_ex(&persistent_script_report, "last_used", strlen("last_used"), str, len);
   add_assoc_long_ex(&persistent_script_report, "last_used_timestamp", strlen("last_used_timestamp"), script->dynamic_members.last_used);
   if ((accel_globals.accel_directives).validate_timestamps) {
    add_assoc_long_ex(&persistent_script_report, "timestamp", strlen("timestamp"), (zend_long)script->timestamp);
   }
   ((&exec_time)->tv_sec = (&exec_time)->tv_usec = 0);
   ((&fetch_time)->tv_sec = (&fetch_time)->tv_usec = 0);

   _zend_hash_str_update((*(return_value)).value.arr, cache_entry->key, cache_entry->key_length, &persistent_script_report );
  }
 }
...
static void zif_opcache_get_status(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "|b", &fetch_scripts) == FAILURE) {
  return;
 }
 ...
 add_assoc_bool_ex(return_value, "opcache_enabled", strlen("opcache_enabled"), (accel_globals.enabled) && ((accel_globals.counted) || (accel_shared_globals->accelerator_enabled)));


 if ((accel_globals.accel_directives).file_cache) {
  add_assoc_string_ex(return_value, "file_cache", strlen("file_cache"), (accel_globals.accel_directives).file_cache);
 }
 if ((accel_globals.accel_directives).file_cache_only) {
  add_assoc_bool_ex(return_value, "file_cache_only", strlen("file_cache_only"), 1);
  return;
 }


 add_assoc_bool_ex(return_value, "cache_full", strlen("cache_full"), (smm_shared_globals->memory_exhausted));
 add_assoc_bool_ex(return_value, "restart_pending", strlen("restart_pending"), (accel_shared_globals->restart_pending));
 add_assoc_bool_ex(return_value, "restart_in_progress", strlen("restart_in_progress"), (accel_shared_globals->restart_in_progress));


 _array_init((&memory_usage), 0 );
 add_assoc_long_ex(&memory_usage, "used_memory", strlen("used_memory"), (accel_globals.accel_directives).memory_consumption-zend_shared_alloc_get_free_memory()-(smm_shared_globals->wasted_shared_memory));
 add_assoc_long_ex(&memory_usage, "free_memory", strlen("free_memory"), zend_shared_alloc_get_free_memory());
 add_assoc_long_ex(&memory_usage, "wasted_memory", strlen("wasted_memory"), (smm_shared_globals->wasted_shared_memory));
 add_assoc_double_ex(&memory_usage, "current_wasted_percentage", strlen("current_wasted_percentage"), (((double) (smm_shared_globals->wasted_shared_memory))/(accel_globals.accel_directives).memory_consumption)*100.0);
 add_assoc_zval_ex(return_value, "memory_usage", strlen("memory_usage"), &memory_usage);

 if ((accel_shared_globals->interned_strings_start) && (accel_shared_globals->interned_strings_end) && (accel_shared_globals->interned_strings_top)) {
  zval interned_strings_usage;

  _array_init((&interned_strings_usage), 0 );
  add_assoc_long_ex(&interned_strings_usage, "buffer_size", strlen("buffer_size"), (accel_shared_globals->interned_strings_end) - (accel_shared_globals->interned_strings_start));
  add_assoc_long_ex(&interned_strings_usage, "used_memory", strlen("used_memory"), (accel_shared_globals->interned_strings_top) - (accel_shared_globals->interned_strings_start));
  add_assoc_long_ex(&interned_strings_usage, "free_memory", strlen("free_memory"), (accel_shared_globals->interned_strings_end) - (accel_shared_globals->interned_strings_top));
  add_assoc_long_ex(&interned_strings_usage, "number_of_strings", strlen("number_of_strings"), (accel_shared_globals->interned_strings).nNumOfElements);
  add_assoc_zval_ex(return_value, "interned_strings_usage", strlen("interned_strings_usage"), &interned_strings_usage);
 }


 _array_init((&statistics), 0 );
 add_assoc_long_ex(&statistics, "num_cached_scripts", strlen("num_cached_scripts"), (accel_shared_globals->hash).num_direct_entries);
 add_assoc_long_ex(&statistics, "num_cached_keys", strlen("num_cached_keys"), (accel_shared_globals->hash).num_entries);
 add_assoc_long_ex(&statistics, "max_cached_keys", strlen("max_cached_keys"), (accel_shared_globals->hash).max_num_entries);
 add_assoc_long_ex(&statistics, "hits", strlen("hits"), (zend_long)(accel_shared_globals->hits));
 add_assoc_long_ex(&statistics, "start_time", strlen("start_time"), (accel_shared_globals->start_time));
 add_assoc_long_ex(&statistics, "last_restart_time", strlen("last_restart_time"), (accel_shared_globals->last_restart_time));
 add_assoc_long_ex(&statistics, "oom_restarts", strlen("oom_restarts"), (accel_shared_globals->oom_restarts));
 add_assoc_long_ex(&statistics, "hash_restarts", strlen("hash_restarts"), (accel_shared_globals->hash_restarts));
 add_assoc_long_ex(&statistics, "manual_restarts", strlen("manual_restarts"), (accel_shared_globals->manual_restarts));
 add_assoc_long_ex(&statistics, "misses", strlen("misses"), (smm_shared_globals->memory_exhausted)?(accel_shared_globals->misses):(accel_shared_globals->misses)-(accel_shared_globals->blacklist_misses));
 add_assoc_long_ex(&statistics, "blacklist_misses", strlen("blacklist_misses"), (accel_shared_globals->blacklist_misses));
 reqs = (accel_shared_globals->hits)+(accel_shared_globals->misses);
 add_assoc_double_ex(&statistics, "blacklist_miss_ratio", strlen("blacklist_miss_ratio"), reqs?(((double) (accel_shared_globals->blacklist_misses))/reqs)*100.0:0);
 add_assoc_double_ex(&statistics, "opcache_hit_rate", strlen("opcache_hit_rate"), reqs?(((double) (accel_shared_globals->hits))/reqs)*100.0:0);
 add_assoc_zval_ex(return_value, "opcache_statistics", strlen("opcache_statistics"), &statistics);

 if (fetch_scripts) {

  if (accelerator_get_scripts(&scripts)) {
   add_assoc_zval_ex(return_value, "scripts", strlen("scripts"), &scripts);
  }
 }
}
...
static void zif_opcache_get_configuration(zend_execute_data *execute_data, zval *return_value)
{
 ...
 add_assoc_bool_ex(&directives, "opcache.enable", strlen("opcache.enable"), (accel_globals.enabled));
 add_assoc_bool_ex(&directives, "opcache.enable_cli", strlen("opcache.enable_cli"), (accel_globals.accel_directives).enable_cli);
 add_assoc_bool_ex(&directives, "opcache.use_cwd", strlen("opcache.use_cwd"), (accel_globals.accel_directives).use_cwd);
 add_assoc_bool_ex(&directives, "opcache.validate_timestamps", strlen("opcache.validate_timestamps"), (accel_globals.accel_directives).validate_timestamps);
 add_assoc_bool_ex(&directives, "opcache.inherited_hack", strlen("opcache.inherited_hack"), (accel_globals.accel_directives).inherited_hack);
 add_assoc_bool_ex(&directives, "opcache.dups_fix", strlen("opcache.dups_fix"), (accel_globals.accel_directives).ignore_dups);
 add_assoc_bool_ex(&directives, "opcache.revalidate_path", strlen("opcache.revalidate_path"), (accel_globals.accel_directives).revalidate_path);

 add_assoc_long_ex(&directives, "opcache.log_verbosity_level", strlen("opcache.log_verbosity_level"), (accel_globals.accel_directives).log_verbosity_level);
 add_assoc_long_ex(&directives, "opcache.memory_consumption", strlen("opcache.memory_consumption"), (accel_globals.accel_directives).memory_consumption);
 add_assoc_long_ex(&directives, "opcache.interned_strings_buffer", strlen("opcache.interned_strings_buffer"), (accel_globals.accel_directives).interned_strings_buffer);
 add_assoc_long_ex(&directives, "opcache.max_accelerated_files", strlen("opcache.max_accelerated_files"), (accel_globals.accel_directives).max_accelerated_files);
 add_assoc_double_ex(&directives, "opcache.max_wasted_percentage", strlen("opcache.max_wasted_percentage"), (accel_globals.accel_directives).max_wasted_percentage);
 add_assoc_long_ex(&directives, "opcache.consistency_checks", strlen("opcache.consistency_checks"), (accel_globals.accel_directives).consistency_checks);
 add_assoc_long_ex(&directives, "opcache.force_restart_timeout", strlen("opcache.force_restart_timeout"), (accel_globals.accel_directives).force_restart_timeout);
 add_assoc_long_ex(&directives, "opcache.revalidate_freq", strlen("opcache.revalidate_freq"), (accel_globals.accel_directives).revalidate_freq);
 add_assoc_string_ex(&directives, "opcache.preferred_memory_model", strlen("opcache.preferred_memory_model"), (((void *)0) == ((accel_globals.accel_directives).memory_model)?"":(accel_globals.accel_directives).memory_model));
 add_assoc_string_ex(&directives, "opcache.blacklist_filename", strlen("opcache.blacklist_filename"), (((void *)0) == ((accel_globals.accel_directives).user_blacklist_filename)?"":(accel_globals.accel_directives).user_blacklist_filename));
 add_assoc_long_ex(&directives, "opcache.max_file_size", strlen("opcache.max_file_size"), (accel_globals.accel_directives).max_file_size);
 add_assoc_string_ex(&directives, "opcache.error_log", strlen("opcache.error_log"), (((void *)0) == ((accel_globals.accel_directives).error_log)?"":(accel_globals.accel_directives).error_log));

 add_assoc_bool_ex(&directives, "opcache.protect_memory", strlen("opcache.protect_memory"), (accel_globals.accel_directives).protect_memory);
 add_assoc_bool_ex(&directives, "opcache.save_comments", strlen("opcache.save_comments"), (accel_globals.accel_directives).save_comments);
 add_assoc_bool_ex(&directives, "opcache.fast_shutdown", strlen("opcache.fast_shutdown"), (accel_globals.accel_directives).fast_shutdown);
 add_assoc_bool_ex(&directives, "opcache.enable_file_override", strlen("opcache.enable_file_override"), (accel_globals.accel_directives).file_override_enabled);
 add_assoc_long_ex(&directives, "opcache.optimization_level", strlen("opcache.optimization_level"), (accel_globals.accel_directives).optimization_level);


 add_assoc_string_ex(&directives, "opcache.file_cache", strlen("opcache.file_cache"), (accel_globals.accel_directives).file_cache ? (accel_globals.accel_directives).file_cache : "");
 add_assoc_bool_ex(&directives, "opcache.file_cache_only", strlen("opcache.file_cache_only"), (accel_globals.accel_directives).file_cache_only);
 add_assoc_bool_ex(&directives, "opcache.file_cache_consistency_checks", strlen("opcache.file_cache_consistency_checks"), (accel_globals.accel_directives).file_cache_consistency_checks);


 add_assoc_zval_ex(return_value, "directives", strlen("directives"), &directives);


 _array_init((&version), 0 );
 add_assoc_string_ex(&version, "version", strlen("version"), "7.0.6-dev");
 add_assoc_string_ex(&version, "opcache_product_name", strlen("opcache_product_name"), "Zend OPcache");
 add_assoc_zval_ex(return_value, "version", strlen("version"), &version);


 _array_init((&blacklist), 0 );
 zend_accel_blacklist_apply(&accel_blacklist, add_blacklist_path, &blacklist);
 add_assoc_zval_ex(return_value, "blacklist", strlen("blacklist"), &blacklist);
}
...
static void zif_opcache_invalidate(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|b", &script_name, &script_name_len, &force) == FAILURE) {
  return;
 }
...
static void zif_opcache_compile_file(zend_execute_data *execute_data, zval *return_value)
{
 ...
 zend_execute_data *orig_execute_data = ((void *)0);

 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s", &script_name, &script_name_len) == FAILURE) {
  return;
 }

 if (!(accel_globals.enabled) || !accel_startup_ok || !(accel_shared_globals->accelerator_enabled)) {
  zend_error((1<<3L), "Zend OPcache" " seems to be disabled, can't compile file");
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }

 handle.filename = script_name;
 handle.free_filename = 0;
 handle.opened_path = ((void *)0);
 handle.type = ZEND_HANDLE_FILENAME;

 orig_execute_data = (executor_globals.current_execute_data);
 ...
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  op_array = persistent_compile_file(&handle, (1<<1));
 } } else { (executor_globals.bailout) = __orig_bailout; {
  (executor_globals.current_execute_data) = orig_execute_data;
  zend_error((1<<1L), "Zend OPcache" " could not compile file %s", handle.filename);
...
static void zif_opcache_is_script_cached(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "S", &script_name) == FAILURE) {
  return;
 }

 { do { (*(return_value)).u1.type_info = (filename_is_in_cache(script_name)) ? 3 : 2; } while (0); return; };
}
