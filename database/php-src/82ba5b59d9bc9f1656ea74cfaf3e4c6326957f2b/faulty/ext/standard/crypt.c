# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c" 2





# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_crypt_r.h" 1
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_crypt_r.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt_freesec.h" 1
# 12 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt_freesec.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_stdint.h" 1
# 13 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt_freesec.h" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_crypt_r.h" 2
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_crypt_r.h"
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt_blowfish.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt_blowfish.h"
extern char *php_crypt_blowfish_rn(const char *key, const char *setting,
 char *output, int size);
# 50 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/php_crypt_r.h" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c" 2
# 57 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c"
...
# 58 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c" 2
...
# 59 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c" 2
# 69 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c"
int zm_startup_crypt(int type, int module_number)
{
 zend_register_long_constant(("CRYPT_SALT_LENGTH"), sizeof("CRYPT_SALT_LENGTH")-1, (123), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("CRYPT_STD_DES"), sizeof("CRYPT_STD_DES")-1, (1), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("CRYPT_EXT_DES"), sizeof("CRYPT_EXT_DES")-1, (1), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("CRYPT_MD5"), sizeof("CRYPT_MD5")-1, (1), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("CRYPT_BLOWFISH"), sizeof("CRYPT_BLOWFISH")-1, (1), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("CRYPT_SHA256"), sizeof("CRYPT_SHA256")-1, (1), ((1<<0) | (1<<1)), module_number);
 zend_register_long_constant(("CRYPT_SHA512"), sizeof("CRYPT_SHA512")-1, (1), ((1<<0) | (1<<1)), module_number);
...
__attribute__ ((visibility("default"))) zend_string *php_crypt(const char *password, const int pass_len, const char *salt, int salt_len, zend_bool quiet)
{
...

 {
  ...
  if (salt[0]=='$' && salt[1]=='1' && salt[2]=='$') {
   ...
   char *output;
   output = (__builtin_constant_p((123) ) ? (((123) <= 8) ? _emalloc_8() : (((123) <= 16) ? _emalloc_16() : (((123) <= 24) ? _emalloc_24() : (((123) <= 32) ? _emalloc_32() : (((123) <= 40) ? _emalloc_40() : (((123) <= 48) ? _emalloc_48() : (((123) <= 56) ? _emalloc_56() : (((123) <= 64) ? _emalloc_64() : (((123) <= 80) ? _emalloc_80() : (((123) <= 96) ? _emalloc_96() : (((123) <= 112) ? _emalloc_112() : (((123) <= 128) ? _emalloc_128() : (((123) <= 160) ? _emalloc_160() : (((123) <= 192) ? _emalloc_192() : (((123) <= 224) ? _emalloc_224() : (((123) <= 256) ? _emalloc_256() : (((123) <= 320) ? _emalloc_320() : (((123) <= 384) ? _emalloc_384() : (((123) <= 448) ? _emalloc_448() : (((123) <= 512) ? _emalloc_512() : (((123) <= 640) ? _emalloc_640() : (((123) <= 768) ? _emalloc_768() : (((123) <= 896) ? _emalloc_896() : (((123) <= 1024) ? _emalloc_1024() : (((123) <= 1280) ? _emalloc_1280() : (((123) <= 1536) ? _emalloc_1536() : (((123) <= 1792) ? _emalloc_1792() : (((123) <= 2048) ? _emalloc_2048() : (((123) <= 2560) ? _emalloc_2560() : (((123) <= 3072) ? _emalloc_3072() : (((123) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((123)) : _emalloc_huge((123))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((123) ) );
   ...
   if (salt[0] != '_') {
    ...
    if (!(((salt[0]) >= '.' && (salt[0]) <= '9') || ((salt[0]) >= 'A' && (salt[0]) <= 'Z') || ((salt[0]) >= 'a' && (salt[0]) <= 'z')) || !(((salt[1]) >= '.' && (salt[1]) <= '9') || ((salt[1]) >= 'A' && (salt[1]) <= 'Z') || ((salt[1]) >= 'a' && (salt[1]) <= 'z'))) {
     if (!quiet) {
      ...
      php_error_docref0(((void *)0), (1<<13L), "Supplied salt is not valid for DES. Possible bug in provided salt format.");
     }
    }
   }
...
# 228 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/crypt.c"
 if (!crypt_res || (salt[0] == '*' && salt[1] == '0')) {
  return ((void *)0);
 } else {
  result = zend_string_init(crypt_res, strlen(crypt_res), 0);
...
void zif_crypt(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters((execute_data)->This.u2.num_args, "s|s", &str, &str_len, &salt_in, &salt_in_len) == FAILURE) {
  return;
 }
 ...
 if ((result = php_crypt(str, (int)str_len, salt, (int)salt_in_len, 0)) == ((void *)0)) {
  if (salt[0] == '*' && salt[1] == '0') {
   { do { const char *_s = ("*1"); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
  } else {
   { do { const char *_s = ("*0"); do { do { zval *__z = (return_value); zend_string *__s = (zend_string_init(_s, strlen(_s), 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); } while (0); return; };
  }
 }
