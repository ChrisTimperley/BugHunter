...
static const zend_arg_info arginfo_mktime[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 ...
 { "is_dst", sizeof("is_dst")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static const zend_arg_info arginfo_date_interval_construct[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
...
const zend_function_entry date_funcs_period[] = {
 ...
 { "getStartDate", zim_DatePeriod_getStartDate, ((void *)0), (zend_uint) (sizeof(((void *)0))/sizeof(struct _zend_arg_info)-1), 0x100 },
 { "getEndDate", zim_DatePeriod_getEndDate, ((void *)0), (zend_uint) (sizeof(((void *)0))/sizeof(struct _zend_arg_info)-1), 0x100 },
 { "getDateInterval", zim_DatePeriod_getDateInterval, ((void *)0), (zend_uint) (sizeof(((void *)0))/sizeof(struct _zend_arg_info)-1), 0x100 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
# 564 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
...
# 625 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
...
# 834 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
int zm_startup_date(int type, int module_number )
{
...
# 1012 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c" 2
...
# 1716 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
...
# 1857 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
typedef struct {
...
void zif_date_create(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (!php_date_initialize(zend_object_store_get_object(&datetime_object ), time_str, time_str_len, ((void *)0), timezone_object, 0 )) {
  _zval_dtor((&datetime_object) );
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
 do { zval *__z = (return_value); zval *__zv = (&datetime_object); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (0) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
}
...
void zif_date_create_from_format(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 php_date_instantiate(date_ce_date, &datetime_object );
 if (!php_date_initialize(zend_object_store_get_object(&datetime_object ), time_str, time_str_len, format_str, timezone_object, 0 )) {
  _zval_dtor((&datetime_object) );
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
 do { zval *__z = (return_value); zval *__zv = (&datetime_object); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (0) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
...
void zim_DateTimeImmutable_createFromMutable(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "O", &datetime_object, date_ce_date) == FAILURE) {
  return;
 }

 php_date_instantiate(date_ce_immutable, return_value );
 old_obj = (php_date_obj *) zend_object_store_get_object(datetime_object );
 new_obj = (php_date_obj *) zend_object_store_get_object(return_value );
...
static int php_date_initialize_from_hash(php_date_obj **dateobj, HashTable *myht )
{
 ...
 if (zend_hash_find(myht, "date", 5, (void**) &z_date) == SUCCESS && (**z_date).type == 6) {
  if (zend_hash_find(myht, "timezone_type", 14, (void**) &z_timezone_type) == SUCCESS && (**z_timezone_type).type == 1) {
   if (zend_hash_find(myht, "timezone", 9, (void**) &z_timezone) == SUCCESS && (**z_timezone).type == 6) {
...
void php_date_do_return_parsed_time(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used , timelib_time *parsed_time, struct timelib_error_container *error)
{
 ...
 if (parsed_time->have_relative) {
  ...
  if (parsed_time->relative.first_last_day_of) {
   add_assoc_bool_ex(element, parsed_time->relative.first_last_day_of == 0x01 ? "first_day_of_month" : "last_day_of_month", strlen(parsed_time->relative.first_last_day_of == 0x01 ? "first_day_of_month" : "last_day_of_month")+1, 1);
  }
...
void zif_date_modify(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (php_date_modify(object, modify, modify_len )) {
  { do { zval *__z = (return_value); zval *__zv = (object); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
...
void zim_DateTimeImmutable_modify(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (php_date_modify(new_object, modify, modify_len )) {
  { do { zval *__z = (return_value); zval *__zv = (new_object); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (0) { _zval_copy_ctor((__z) ); } if (1) { if (!0) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
...
void zim_DateTimeZone___construct(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (SUCCESS == zend_parse_parameters((ht) , "s", &tz, &tz_len)) {
  ...
  if (FAILURE == timezone_initialize(tzobj, tz, tz_len )) {
   { (*(this_ptr)).type = 0; };
  }
 }
 zend_restore_error_handling(&error_handling );
...
void zif_timezone_offset_get(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_method_parameters((ht) , (this_ptr), "OO", &object, date_ce_timezone, &dateobject, date_ce_interface) == FAILURE) {
  { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; };
 }
 tzobj = (php_timezone_obj *) zend_object_store_get_object(object );
 if (!(tzobj->initialized)) { php_error_docref0(((void *)0) , (1<<1L), "The " "DateTimeZone" " object has not been correctly initialized by its constructor"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; };
 dateobj = (php_date_obj *) zend_object_store_get_object(dateobject );
 if (!(dateobj->time)) { php_error_docref0(((void *)0) , (1<<1L), "The " "DateTimeInterface" " object has not been correctly initialized by its constructor"); { do { zval *__z = (return_value); (*__z).value.lval = ((0) != 0); (*__z).type = 3; } while (0); return; }; };
...
# 3940 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
 _array_init((return_value), 0 );
...
# 4145 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
 do {
  if (strcmp((*member).value.str.val, "y") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->y = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
  if (strcmp((*member).value.str.val, "m") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->m = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
  if (strcmp((*member).value.str.val, "d") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->d = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
  if (strcmp((*member).value.str.val, "h") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->h = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
  if (strcmp((*member).value.str.val, "i") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->i = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
  if (strcmp((*member).value.str.val, "s") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->s = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
  if (strcmp((*member).value.str.val, "invert") == 0) { if (value->type != 1) { tmp_value = *value; _zval_copy_ctor((&tmp_value) ); convert_to_long(&tmp_value); value = &tmp_value; } obj->diff->invert = (*value).value.lval; if (value == &tmp_value) { _zval_dtor((value) ); } break; };
...
# 4222 "/home/ct584/git/bughunter/repositories/php-src/ext/date/php_date.c"
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "y", strlen("y") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->y = (timelib_sll)(**z_arg).value.lval; } else { (*intobj)->diff->y = (timelib_sll)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "m", strlen("m") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->m = (timelib_sll)(**z_arg).value.lval; } else { (*intobj)->diff->m = (timelib_sll)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "d", strlen("d") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->d = (timelib_sll)(**z_arg).value.lval; } else { (*intobj)->diff->d = (timelib_sll)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "h", strlen("h") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->h = (timelib_sll)(**z_arg).value.lval; } else { (*intobj)->diff->h = (timelib_sll)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "i", strlen("i") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->i = (timelib_sll)(**z_arg).value.lval; } else { (*intobj)->diff->i = (timelib_sll)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "s", strlen("s") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->s = (timelib_sll)(**z_arg).value.lval; } else { (*intobj)->diff->s = (timelib_sll)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "weekday", strlen("weekday") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->weekday = (int)(**z_arg).value.lval; } else { (*intobj)->diff->weekday = (int)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "weekday_behavior", strlen("weekday_behavior") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->weekday_behavior = (int)(**z_arg).value.lval; } else { (*intobj)->diff->weekday_behavior = (int)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "first_last_day_of", strlen("first_last_day_of") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->first_last_day_of = (int)(**z_arg).value.lval; } else { (*intobj)->diff->first_last_day_of = (int)-1; } } while (0);
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "invert", strlen("invert") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->invert = (int)(**z_arg).value.lval; } else { (*intobj)->diff->invert = (int)0; } } while (0);;
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "days", strlen("days") + 1, (void**) &z_arg) == SUCCESS) { if ((**z_arg).type == 6) { (*intobj)->diff->days = atoll((**z_arg).value.str.val); } else if ((**z_arg).type == 1 || (**z_arg).type == 3) { (*intobj)->diff->days = (timelib_sll)(**z_arg).value.lval; } else if ((**z_arg).type == 2) { (*intobj)->diff->days = (timelib_sll)(**z_arg).value.dval; } else { (*intobj)->diff->days = -1LL; } } else { (*intobj)->diff->days = -1LL; } } while (0);;
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "special_type", strlen("special_type") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->special.type = (unsigned int)(**z_arg).value.lval; } else { (*intobj)->diff->special.type = (unsigned int)0; } } while (0);;
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "special_amount", strlen("special_amount") + 1, (void**) &z_arg) == SUCCESS) { if ((**z_arg).type == 6) { (*intobj)->diff->special.amount = atoll((**z_arg).value.str.val); } else if ((**z_arg).type == 1 || (**z_arg).type == 3) { (*intobj)->diff->special.amount = (timelib_sll)(**z_arg).value.lval; } else if ((**z_arg).type == 2) { (*intobj)->diff->special.amount = (timelib_sll)(**z_arg).value.dval; } else { (*intobj)->diff->special.amount = -1LL; } } else { (*intobj)->diff->special.amount = -1LL; } } while (0);;
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "have_weekday_relative", strlen("have_weekday_relative") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->have_weekday_relative = (unsigned int)(**z_arg).value.lval; } else { (*intobj)->diff->have_weekday_relative = (unsigned int)0; } } while (0);;
 do { zval **z_arg = ((void *)0); if (zend_hash_find(myht, "have_special_relative", strlen("have_special_relative") + 1, (void**) &z_arg) == SUCCESS && (**z_arg).type == 1) { (*intobj)->diff->have_special_relative = (unsigned int)(**z_arg).value.lval; } else { (*intobj)->diff->have_special_relative = (unsigned int)0; } } while (0);;
...
void zim_DatePeriod_getStartDate(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 dpobj = (php_period_obj *)zend_object_store_get_object((this_ptr) );
