...
# 597 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 734 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
void zend_post_startup(void)
{
# 807 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 988 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  zend_ini_deactivate();
 } } (executor_globals.bailout) = __orig_bailout; };
}
...
# 1032 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_error(int type, const char *format, ...)
...
# 1147 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
 ...
 if (zval_get_type(&((executor_globals.user_error_handler))) == 0
  ...
  case (1<<7L):
   ...
   break;
  default:
# 1178 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 1297 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_throw_error(zend_class_entry *exception_ce, const char *format, ...)
{
 va_list va;
 char *message = ((void *)0);
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_output_debug_string(zend_bool trigger_break, const char *format, ...)
{
# 1378 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
