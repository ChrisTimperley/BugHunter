...
{
 zend_auto_global *ag = (*(zv)).value.ptr;

 zend_string_release(ag->name);

 free(ag);
}
# 601 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
int zend_startup(zend_utility_functions *utility_functions, char **extensions)
{
 ...
 zend_version_info = strdup("Zend Engine v" "3.0.0" ", Copyright (c) 1998-2015 Zend Technologies\n");
 zend_version_info_length = sizeof("Zend Engine v" "3.0.0" ", Copyright (c) 1998-2015 Zend Technologies\n") - 1;
...
# 738 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
void zend_post_startup(void)
{
# 811 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 992 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
 { jmp_buf *__orig_bailout = (executor_globals.bailout); jmp_buf __bailout; (executor_globals.bailout) = &__bailout; if (_setjmp (__bailout)==0) { {
  zend_ini_deactivate();
 } } (executor_globals.bailout) = __orig_bailout; };
}
...
# 1036 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_error(int type, const char *format, ...)
...
# 1151 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
 ...
 if (zval_get_type(&((executor_globals.user_error_handler))) == 0
  ...
  case (1<<7L):
   ...
   break;
  default:
# 1182 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
...
# 1301 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_throw_error(zend_class_entry *exception_ce, const char *format, ...)
{
 va_list va;
 char *message = ((void *)0);
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_output_debug_string(zend_bool trigger_break, const char *format, ...)
{
# 1382 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend.c"
}
