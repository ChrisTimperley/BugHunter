# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
# 19 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
...
# 809 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_types.h"
...
# 20 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
...
# 21 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
...
# 919 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"
...
# 988 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h"

# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2



# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 1
# 44 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_config.h" 1
# 1 "/home/ct584/git/bughunter/repositories/php-src/include/../main/php_config.h" 1
# 2 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_config.h" 2
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 47 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 54 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
...
# 57 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_hash.h" 1
# 45 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_hash.h"
...
# 58 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_debug.h" 1
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_debug.h"
void zend_accel_error(int type, const char *format, ...);
# 59 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h" 2
# 92 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
extern int lock_file;
# 129 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 293 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/ZendAccelerator.h"
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.h" 1
# 22 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.h"
int zend_file_cache_script_store(zend_persistent_script *script, int in_shm);
zend_persistent_script *zend_file_cache_script_load(zend_file_handle *file_handle);
void zend_file_cache_invalidate(zend_string *full_path);
# 31 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.h" 1
# 73 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.h"
...
# 147 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_shared_alloc.h"
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.h" 1
# 28 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_accelerator_util_funcs.h"
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
# 48 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
...
# 49 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c" 2
# 146 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
...
static int zend_file_cache_mkdir(char *filename, size_t start)
{
 ...
 while (*s) {
  if (((*s) == '/')) {
   char old = *s;
   *s = '\000';
   if (mkdir(filename, (0400|0200|0100)) < 0 && (*__errno_location ()) != 17) {
    *s = old;
    return FAILURE;
   }
   *s = old;
                                                ...
                                                zend_file_cache_metainfo *info)
{
 ...
 len = ((((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + (str)->len + 1)) + 8 - 1L) & ~(8 - 1L));
 ret = (void*)(info->str_size | 1UL);
 zend_shared_alloc_register_xlat_entry(str, ret);
 if (info->str_size + len > ((zend_string*)(accel_globals.mem))->len) {
  size_t new_len = info->str_size + len;
  (accel_globals.mem) = (void*)zend_string_realloc(
   (zend_string*)(accel_globals.mem),
   ((((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + 1 + new_len + 4095) & ~0xfff) - (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + 1),
   0);
 }
 memcpy(((zend_string*)(accel_globals.mem))->val + info->str_size, str, len);
 info->str_size += len;
 return ret;
}
...
static void *zend_file_cache_unserialize_interned(zend_string *str, int in_shm)
{
 ...
 str = (zend_string*)((char*)(accel_globals.mem) + ((size_t)(str) & ~1UL));
 ret = accel_new_interned_string(str);
 if (ret == str) {

  if (in_shm) {
   (ret)->gc.u.v.flags |= (1<<1) | (1<<2);
  } else {
   (ret)->gc.u.v.flags |= (1<<1);
   (ret)->gc.u.v.flags &= ~(1<<2);
  }
 }
 return ret;
}
                                           ...
                                           serialize_callback_t func)
{
 ...
 if (((char*)(ht->arData) < (char*)script->size)) {
  return;
 }
 do { if (ht->arData) { do { if (__builtin_expect(!((((char*)(ht->arData) >= (char*)script->mem && (char*)(ht->arData) < (char*)script->mem + script->size) || ((char*)(ht->arData) >= (accel_shared_globals->interned_strings_start) && (char*)(ht->arData) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ht->arData) = (void*)((char*)(ht->arData) - (char*)script->mem); } } while (0);
 p = ht->arData;
 do { if (p) { do { if (__builtin_expect(!(((char*)(p) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p) = (void*)((char*)buf + (size_t)(p)); } } while (0);
 end = p + ht->nNumUsed;
 while (p < end) {
  if (zval_get_type(&(p->val)) != 0) {
   do { if (p->key) { if (((char*)(p->key) >= (accel_shared_globals->interned_strings_start) && (char*)(p->key) < (accel_shared_globals->interned_strings_end))) { (p->key) = zend_file_cache_serialize_interned((zend_string*)(p->key), info); } else { do { if (__builtin_expect(!((((char*)(p->key) >= (char*)script->mem && (char*)(p->key) < (char*)script->mem + script->size) || ((char*)(p->key) >= (accel_shared_globals->interned_strings_start) && (char*)(p->key) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (p->key)->gc.u.v.flags |= (1<<1); (p->key)->gc.u.v.flags &= ~(1<<2); } (p->key) = (void*)((char*)(p->key) - (char*)script->mem); } } } while (0);
                                               ...
                                               void *buf)
{
 ...
 do { if (ast) { do { if (__builtin_expect(!((((char*)(ast) >= (char*)script->mem && (char*)(ast) < (char*)script->mem + script->size) || ((char*)(ast) >= (accel_shared_globals->interned_strings_start) && (char*)(ast) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ast) = (void*)((char*)(ast) - (char*)script->mem); } } while (0);
 ret = ast;
 do { if (ast) { do { if (__builtin_expect(!(((char*)(ast) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ast) = (void*)((char*)buf + (size_t)(ast)); } } while (0);
...
static void zend_file_cache_serialize_zval(zval *zv,
                                           ...
                                           void *buf)
{
 switch (zval_get_type(&(*(zv)))) {
  case 6:
  case 11:
   if (!((char*)((*(zv)).value.str) < (char*)script->size)) {
    do { if ((*(zv)).value.str) { if (((char*)((*(zv)).value.str) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.str) < (accel_shared_globals->interned_strings_end))) { ((*(zv)).value.str) = zend_file_cache_serialize_interned((zend_string*)((*(zv)).value.str), info); } else { do { if (__builtin_expect(!((((char*)((*(zv)).value.str) >= (char*)script->mem && (char*)((*(zv)).value.str) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.str) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.str) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { ((*(zv)).value.str)->gc.u.v.flags |= (1<<1); ((*(zv)).value.str)->gc.u.v.flags &= ~(1<<2); } ((*(zv)).value.str) = (void*)((char*)((*(zv)).value.str) - (char*)script->mem); } } } while (0);
   }
   break;
  case 7:
   if (!((char*)((*(zv)).value.arr) < (char*)script->size)) {
    HashTable *ht;

    do { if ((*(zv)).value.arr) { do { if (__builtin_expect(!((((char*)((*(zv)).value.arr) >= (char*)script->mem && (char*)((*(zv)).value.arr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.arr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.arr) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.arr) = (void*)((char*)((*(zv)).value.arr) - (char*)script->mem); } } while (0);
    ht = (*(zv)).value.arr;
    do { if (ht) { do { if (__builtin_expect(!(((char*)(ht) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ht) = (void*)((char*)buf + (size_t)(ht)); } } while (0);
    zend_file_cache_serialize_hash(ht, script, info, buf, zend_file_cache_serialize_zval);
   }
   break;
  case 10:
   if (!((char*)((*(zv)).value.ref) < (char*)script->size)) {
    zend_reference *ref;

    do { if ((*(zv)).value.ref) { do { if (__builtin_expect(!((((char*)((*(zv)).value.ref) >= (char*)script->mem && (char*)((*(zv)).value.ref) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ref) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ref) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ref) = (void*)((char*)((*(zv)).value.ref) - (char*)script->mem); } } while (0);
    ref = (*(zv)).value.ref;
    do { if (ref) { do { if (__builtin_expect(!(((char*)(ref) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ref) = (void*)((char*)buf + (size_t)(ref)); } } while (0);
    zend_file_cache_serialize_zval(&ref->val, script, info, buf);
   }
   break;
  case 12:
   if (!((char*)((*(zv)).value.ast) < (char*)script->size)) {
    zend_ast_ref *ast;

    do { if ((*(zv)).value.ast) { do { if (__builtin_expect(!((((char*)((*(zv)).value.ast) >= (char*)script->mem && (char*)((*(zv)).value.ast) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ast) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ast) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ast) = (void*)((char*)((*(zv)).value.ast) - (char*)script->mem); } } while (0);
    ast = (*(zv)).value.ast;
    do { if (ast) { do { if (__builtin_expect(!(((char*)(ast) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ast) = (void*)((char*)buf + (size_t)(ast)); } } while (0);
    if (!((char*)(ast->ast) < (char*)script->size)) {
...
static void zend_file_cache_serialize_op_array(zend_op_array *op_array,
                                               ...
                                               void *buf)
{
 if (op_array->static_variables && !((char*)(op_array->static_variables) < (char*)script->size)) {
  HashTable *ht;

  do { if (op_array->static_variables) { do { if (__builtin_expect(!((((char*)(op_array->static_variables) >= (char*)script->mem && (char*)(op_array->static_variables) < (char*)script->mem + script->size) || ((char*)(op_array->static_variables) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->static_variables) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->static_variables) = (void*)((char*)(op_array->static_variables) - (char*)script->mem); } } while (0);
  ht = op_array->static_variables;
  do { if (ht) { do { if (__builtin_expect(!(((char*)(ht) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ht) = (void*)((char*)buf + (size_t)(ht)); } } while (0);
  zend_file_cache_serialize_hash(ht, script, info, buf, zend_file_cache_serialize_zval);
 }

 if (op_array->literals && !((char*)(op_array->literals) < (char*)script->size)) {
  zval *p, *end;

  do { if (op_array->literals) { do { if (__builtin_expect(!((((char*)(op_array->literals) >= (char*)script->mem && (char*)(op_array->literals) < (char*)script->mem + script->size) || ((char*)(op_array->literals) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->literals) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->literals) = (void*)((char*)(op_array->literals) - (char*)script->mem); } } while (0);
  p = op_array->literals;
  do { if (p) { do { if (__builtin_expect(!(((char*)(p) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p) = (void*)((char*)buf + (size_t)(p)); } } while (0);
 ...
 if (!((char*)(op_array->opcodes) < (char*)script->size)) {
# 423 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
  do { if (op_array->opcodes) { do { if (__builtin_expect(!((((char*)(op_array->opcodes) >= (char*)script->mem && (char*)(op_array->opcodes) < (char*)script->mem + script->size) || ((char*)(op_array->opcodes) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->opcodes) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->opcodes) = (void*)((char*)(op_array->opcodes) - (char*)script->mem); } } while (0);


  if (op_array->arg_info) {
   zend_arg_info *p, *end;
   do { if (op_array->arg_info) { do { if (__builtin_expect(!((((char*)(op_array->arg_info) >= (char*)script->mem && (char*)(op_array->arg_info) < (char*)script->mem + script->size) || ((char*)(op_array->arg_info) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->arg_info) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->arg_info) = (void*)((char*)(op_array->arg_info) - (char*)script->mem); } } while (0);
   p = op_array->arg_info;
   do { if (p) { do { if (__builtin_expect(!(((char*)(p) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p) = (void*)((char*)buf + (size_t)(p)); } } while (0);
   ...
   while (p < end) {
    if (!((char*)(p->name) < (char*)script->size)) {
     do { if (p->name) { if (((char*)(p->name) >= (accel_shared_globals->interned_strings_start) && (char*)(p->name) < (accel_shared_globals->interned_strings_end))) { (p->name) = zend_file_cache_serialize_interned((zend_string*)(p->name), info); } else { do { if (__builtin_expect(!((((char*)(p->name) >= (char*)script->mem && (char*)(p->name) < (char*)script->mem + script->size) || ((char*)(p->name) >= (accel_shared_globals->interned_strings_start) && (char*)(p->name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (p->name)->gc.u.v.flags |= (1<<1); (p->name)->gc.u.v.flags &= ~(1<<2); } (p->name) = (void*)((char*)(p->name) - (char*)script->mem); } } } while (0);
    }
    if (!((char*)(p->class_name) < (char*)script->size)) {
     do { if (p->class_name) { if (((char*)(p->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(p->class_name) < (accel_shared_globals->interned_strings_end))) { (p->class_name) = zend_file_cache_serialize_interned((zend_string*)(p->class_name), info); } else { do { if (__builtin_expect(!((((char*)(p->class_name) >= (char*)script->mem && (char*)(p->class_name) < (char*)script->mem + script->size) || ((char*)(p->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(p->class_name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (p->class_name)->gc.u.v.flags |= (1<<1); (p->class_name)->gc.u.v.flags &= ~(1<<2); } (p->class_name) = (void*)((char*)(p->class_name) - (char*)script->mem); } } } while (0);
    }
    p++;
   }
  }
  ...
  if (op_array->vars) {
   ...
   do { if (op_array->vars) { do { if (__builtin_expect(!((((char*)(op_array->vars) >= (char*)script->mem && (char*)(op_array->vars) < (char*)script->mem + script->size) || ((char*)(op_array->vars) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->vars) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->vars) = (void*)((char*)(op_array->vars) - (char*)script->mem); } } while (0);
   p = op_array->vars;
   do { if (p) { do { if (__builtin_expect(!(((char*)(p) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p) = (void*)((char*)buf + (size_t)(p)); } } while (0);
   end = p + op_array->last_var;
   while (p < end) {
    if (!((char*)(*p) < (char*)script->size)) {
     do { if (*p) { if (((char*)(*p) >= (accel_shared_globals->interned_strings_start) && (char*)(*p) < (accel_shared_globals->interned_strings_end))) { (*p) = zend_file_cache_serialize_interned((zend_string*)(*p), info); } else { do { if (__builtin_expect(!((((char*)(*p) >= (char*)script->mem && (char*)(*p) < (char*)script->mem + script->size) || ((char*)(*p) >= (accel_shared_globals->interned_strings_start) && (char*)(*p) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (*p)->gc.u.v.flags |= (1<<1); (*p)->gc.u.v.flags &= ~(1<<2); } (*p) = (void*)((char*)(*p) - (char*)script->mem); } } } while (0);
    }
    p++;
   }
  }

  do { if (op_array->function_name) { if (((char*)(op_array->function_name) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->function_name) < (accel_shared_globals->interned_strings_end))) { (op_array->function_name) = zend_file_cache_serialize_interned((zend_string*)(op_array->function_name), info); } else { do { if (__builtin_expect(!((((char*)(op_array->function_name) >= (char*)script->mem && (char*)(op_array->function_name) < (char*)script->mem + script->size) || ((char*)(op_array->function_name) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->function_name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (op_array->function_name)->gc.u.v.flags |= (1<<1); (op_array->function_name)->gc.u.v.flags &= ~(1<<2); } (op_array->function_name) = (void*)((char*)(op_array->function_name) - (char*)script->mem); } } } while (0);
  do { if (op_array->filename) { if (((char*)(op_array->filename) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->filename) < (accel_shared_globals->interned_strings_end))) { (op_array->filename) = zend_file_cache_serialize_interned((zend_string*)(op_array->filename), info); } else { do { if (__builtin_expect(!((((char*)(op_array->filename) >= (char*)script->mem && (char*)(op_array->filename) < (char*)script->mem + script->size) || ((char*)(op_array->filename) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->filename) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (op_array->filename)->gc.u.v.flags |= (1<<1); (op_array->filename)->gc.u.v.flags &= ~(1<<2); } (op_array->filename) = (void*)((char*)(op_array->filename) - (char*)script->mem); } } } while (0);
  do { if (op_array->live_range) { do { if (__builtin_expect(!((((char*)(op_array->live_range) >= (char*)script->mem && (char*)(op_array->live_range) < (char*)script->mem + script->size) || ((char*)(op_array->live_range) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->live_range) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->live_range) = (void*)((char*)(op_array->live_range) - (char*)script->mem); } } while (0);
  do { if (op_array->scope) { do { if (__builtin_expect(!((((char*)(op_array->scope) >= (char*)script->mem && (char*)(op_array->scope) < (char*)script->mem + script->size) || ((char*)(op_array->scope) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->scope) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->scope) = (void*)((char*)(op_array->scope) - (char*)script->mem); } } while (0);
  do { if (op_array->doc_comment) { if (((char*)(op_array->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->doc_comment) < (accel_shared_globals->interned_strings_end))) { (op_array->doc_comment) = zend_file_cache_serialize_interned((zend_string*)(op_array->doc_comment), info); } else { do { if (__builtin_expect(!((((char*)(op_array->doc_comment) >= (char*)script->mem && (char*)(op_array->doc_comment) < (char*)script->mem + script->size) || ((char*)(op_array->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->doc_comment) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (op_array->doc_comment)->gc.u.v.flags |= (1<<1); (op_array->doc_comment)->gc.u.v.flags &= ~(1<<2); } (op_array->doc_comment) = (void*)((char*)(op_array->doc_comment) - (char*)script->mem); } } } while (0);
  do { if (op_array->try_catch_array) { do { if (__builtin_expect(!((((char*)(op_array->try_catch_array) >= (char*)script->mem && (char*)(op_array->try_catch_array) < (char*)script->mem + script->size) || ((char*)(op_array->try_catch_array) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->try_catch_array) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->try_catch_array) = (void*)((char*)(op_array->try_catch_array) - (char*)script->mem); } } while (0);
  do { if (op_array->prototype) { do { if (__builtin_expect(!((((char*)(op_array->prototype) >= (char*)script->mem && (char*)(op_array->prototype) < (char*)script->mem + script->size) || ((char*)(op_array->prototype) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->prototype) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (op_array->prototype) = (void*)((char*)(op_array->prototype) - (char*)script->mem); } } while (0);
 }
}
                                           ...
                                           void *buf)
{
 ...
 do { if ((*(zv)).value.ptr) { do { if (__builtin_expect(!((((char*)((*(zv)).value.ptr) >= (char*)script->mem && (char*)((*(zv)).value.ptr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ptr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ptr) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ptr) = (void*)((char*)((*(zv)).value.ptr) - (char*)script->mem); } } while (0);
 op_array = (*(zv)).value.ptr;
 do { if (op_array) { do { if (__builtin_expect(!(((char*)(op_array) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array) = (void*)((char*)buf + (size_t)(op_array)); } } while (0);
...
static void zend_file_cache_serialize_prop_info(zval *zv,
                                                ...
                                                void *buf)
{
 if (!((char*)((*(zv)).value.ptr) < (char*)script->size)) {
  zend_property_info *prop;

  do { if ((*(zv)).value.ptr) { do { if (__builtin_expect(!((((char*)((*(zv)).value.ptr) >= (char*)script->mem && (char*)((*(zv)).value.ptr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ptr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ptr) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ptr) = (void*)((char*)((*(zv)).value.ptr) - (char*)script->mem); } } while (0);
  prop = (*(zv)).value.ptr;
  do { if (prop) { do { if (__builtin_expect(!(((char*)(prop) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (prop) = (void*)((char*)buf + (size_t)(prop)); } } while (0);

  if (prop->ce && !((char*)(prop->ce) < (char*)script->size)) {
   do { if (prop->ce) { do { if (__builtin_expect(!((((char*)(prop->ce) >= (char*)script->mem && (char*)(prop->ce) < (char*)script->mem + script->size) || ((char*)(prop->ce) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->ce) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (prop->ce) = (void*)((char*)(prop->ce) - (char*)script->mem); } } while (0);
  }
  if (prop->name && !((char*)(prop->name) < (char*)script->size)) {
   do { if (prop->name) { if (((char*)(prop->name) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->name) < (accel_shared_globals->interned_strings_end))) { (prop->name) = zend_file_cache_serialize_interned((zend_string*)(prop->name), info); } else { do { if (__builtin_expect(!((((char*)(prop->name) >= (char*)script->mem && (char*)(prop->name) < (char*)script->mem + script->size) || ((char*)(prop->name) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (prop->name)->gc.u.v.flags |= (1<<1); (prop->name)->gc.u.v.flags &= ~(1<<2); } (prop->name) = (void*)((char*)(prop->name) - (char*)script->mem); } } } while (0);
  }
  if (prop->doc_comment && !((char*)(prop->doc_comment) < (char*)script->size)) {
   do { if (prop->doc_comment) { if (((char*)(prop->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->doc_comment) < (accel_shared_globals->interned_strings_end))) { (prop->doc_comment) = zend_file_cache_serialize_interned((zend_string*)(prop->doc_comment), info); } else { do { if (__builtin_expect(!((((char*)(prop->doc_comment) >= (char*)script->mem && (char*)(prop->doc_comment) < (char*)script->mem + script->size) || ((char*)(prop->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->doc_comment) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (prop->doc_comment)->gc.u.v.flags |= (1<<1); (prop->doc_comment)->gc.u.v.flags &= ~(1<<2); } (prop->doc_comment) = (void*)((char*)(prop->doc_comment) - (char*)script->mem); } } } while (0);
  }
 }
}
                                                     ...
                                                     void *buf)
{
 if (!((char*)((*(zv)).value.ptr) < (char*)script->size)) {
  ...
  do { if ((*(zv)).value.ptr) { do { if (__builtin_expect(!((((char*)((*(zv)).value.ptr) >= (char*)script->mem && (char*)((*(zv)).value.ptr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ptr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ptr) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ptr) = (void*)((char*)((*(zv)).value.ptr) - (char*)script->mem); } } while (0);
  c = (*(zv)).value.ptr;
  do { if (c) { do { if (__builtin_expect(!(((char*)(c) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (c) = (void*)((char*)buf + (size_t)(c)); } } while (0);

  zend_file_cache_serialize_zval(&c->value, script, info, buf);
  if (c->ce && !((char*)(c->ce) < (char*)script->size)) {
   do { if (c->ce) { do { if (__builtin_expect(!((((char*)(c->ce) >= (char*)script->mem && (char*)(c->ce) < (char*)script->mem + script->size) || ((char*)(c->ce) >= (accel_shared_globals->interned_strings_start) && (char*)(c->ce) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (c->ce) = (void*)((char*)(c->ce) - (char*)script->mem); } } while (0);
  }
  if (c->doc_comment && !((char*)(c->doc_comment) < (char*)script->size)) {
   do { if (c->doc_comment) { if (((char*)(c->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(c->doc_comment) < (accel_shared_globals->interned_strings_end))) { (c->doc_comment) = zend_file_cache_serialize_interned((zend_string*)(c->doc_comment), info); } else { do { if (__builtin_expect(!((((char*)(c->doc_comment) >= (char*)script->mem && (char*)(c->doc_comment) < (char*)script->mem + script->size) || ((char*)(c->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(c->doc_comment) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (c->doc_comment)->gc.u.v.flags |= (1<<1); (c->doc_comment)->gc.u.v.flags &= ~(1<<2); } (c->doc_comment) = (void*)((char*)(c->doc_comment) - (char*)script->mem); } } } while (0);
  }
 }
}
                                            ...
                                            void *buf)
{
 ...
 do { if ((*(zv)).value.ptr) { do { if (__builtin_expect(!((((char*)((*(zv)).value.ptr) >= (char*)script->mem && (char*)((*(zv)).value.ptr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ptr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ptr) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ptr) = (void*)((char*)((*(zv)).value.ptr) - (char*)script->mem); } } while (0);
 ce = (*(zv)).value.ptr;
 do { if (ce) { do { if (__builtin_expect(!(((char*)(ce) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce) = (void*)((char*)buf + (size_t)(ce)); } } while (0);

 do { if (ce->name) { if (((char*)(ce->name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->name) < (accel_shared_globals->interned_strings_end))) { (ce->name) = zend_file_cache_serialize_interned((zend_string*)(ce->name), info); } else { do { if (__builtin_expect(!((((char*)(ce->name) >= (char*)script->mem && (char*)(ce->name) < (char*)script->mem + script->size) || ((char*)(ce->name) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (ce->name)->gc.u.v.flags |= (1<<1); (ce->name)->gc.u.v.flags &= ~(1<<2); } (ce->name) = (void*)((char*)(ce->name) - (char*)script->mem); } } } while (0);
 zend_file_cache_serialize_hash(&ce->function_table, script, info, buf, zend_file_cache_serialize_func);
 if (ce->default_properties_table) {
  zval *p, *end;

  do { if (ce->default_properties_table) { do { if (__builtin_expect(!((((char*)(ce->default_properties_table) >= (char*)script->mem && (char*)(ce->default_properties_table) < (char*)script->mem + script->size) || ((char*)(ce->default_properties_table) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->default_properties_table) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->default_properties_table) = (void*)((char*)(ce->default_properties_table) - (char*)script->mem); } } while (0);
 ...
 if (ce->default_static_members_table) {
  ...
  do { if (ce->default_static_members_table) { do { if (__builtin_expect(!((((char*)(ce->default_static_members_table) >= (char*)script->mem && (char*)(ce->default_static_members_table) < (char*)script->mem + script->size) || ((char*)(ce->default_static_members_table) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->default_static_members_table) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->default_static_members_table) = (void*)((char*)(ce->default_static_members_table) - (char*)script->mem); } } while (0);
 ...
 do { if (ce->info.user.filename) { if (((char*)(ce->info.user.filename) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->info.user.filename) < (accel_shared_globals->interned_strings_end))) { (ce->info.user.filename) = zend_file_cache_serialize_interned((zend_string*)(ce->info.user.filename), info); } else { do { if (__builtin_expect(!((((char*)(ce->info.user.filename) >= (char*)script->mem && (char*)(ce->info.user.filename) < (char*)script->mem + script->size) || ((char*)(ce->info.user.filename) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->info.user.filename) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (ce->info.user.filename)->gc.u.v.flags |= (1<<1); (ce->info.user.filename)->gc.u.v.flags &= ~(1<<2); } (ce->info.user.filename) = (void*)((char*)(ce->info.user.filename) - (char*)script->mem); } } } while (0);
 do { if (ce->info.user.doc_comment) { if (((char*)(ce->info.user.doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->info.user.doc_comment) < (accel_shared_globals->interned_strings_end))) { (ce->info.user.doc_comment) = zend_file_cache_serialize_interned((zend_string*)(ce->info.user.doc_comment), info); } else { do { if (__builtin_expect(!((((char*)(ce->info.user.doc_comment) >= (char*)script->mem && (char*)(ce->info.user.doc_comment) < (char*)script->mem + script->size) || ((char*)(ce->info.user.doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->info.user.doc_comment) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (ce->info.user.doc_comment)->gc.u.v.flags |= (1<<1); (ce->info.user.doc_comment)->gc.u.v.flags &= ~(1<<2); } (ce->info.user.doc_comment) = (void*)((char*)(ce->info.user.doc_comment) - (char*)script->mem); } } } while (0);
 zend_file_cache_serialize_hash(&ce->properties_info, script, info, buf, zend_file_cache_serialize_prop_info);

 if (ce->trait_aliases) {
  zend_trait_alias **p, *q;

  do { if (ce->trait_aliases) { do { if (__builtin_expect(!((((char*)(ce->trait_aliases) >= (char*)script->mem && (char*)(ce->trait_aliases) < (char*)script->mem + script->size) || ((char*)(ce->trait_aliases) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_aliases) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->trait_aliases) = (void*)((char*)(ce->trait_aliases) - (char*)script->mem); } } while (0);
  p = ce->trait_aliases;
  do { if (p) { do { if (__builtin_expect(!(((char*)(p) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p) = (void*)((char*)buf + (size_t)(p)); } } while (0);

  while (*p) {
   do { if (*p) { do { if (__builtin_expect(!((((char*)(*p) >= (char*)script->mem && (char*)(*p) < (char*)script->mem + script->size) || ((char*)(*p) >= (accel_shared_globals->interned_strings_start) && (char*)(*p) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (*p) = (void*)((char*)(*p) - (char*)script->mem); } } while (0);
   q = *p;
   do { if (q) { do { if (__builtin_expect(!(((char*)(q) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (q) = (void*)((char*)buf + (size_t)(q)); } } while (0);

   if (q->trait_method) {
    zend_trait_method_reference *m;

    do { if (q->trait_method) { do { if (__builtin_expect(!((((char*)(q->trait_method) >= (char*)script->mem && (char*)(q->trait_method) < (char*)script->mem + script->size) || ((char*)(q->trait_method) >= (accel_shared_globals->interned_strings_start) && (char*)(q->trait_method) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (q->trait_method) = (void*)((char*)(q->trait_method) - (char*)script->mem); } } while (0);
    m = q->trait_method;
    do { if (m) { do { if (__builtin_expect(!(((char*)(m) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (m) = (void*)((char*)buf + (size_t)(m)); } } while (0);

    if (m->method_name) {
     do { if (m->method_name) { if (((char*)(m->method_name) >= (accel_shared_globals->interned_strings_start) && (char*)(m->method_name) < (accel_shared_globals->interned_strings_end))) { (m->method_name) = zend_file_cache_serialize_interned((zend_string*)(m->method_name), info); } else { do { if (__builtin_expect(!((((char*)(m->method_name) >= (char*)script->mem && (char*)(m->method_name) < (char*)script->mem + script->size) || ((char*)(m->method_name) >= (accel_shared_globals->interned_strings_start) && (char*)(m->method_name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (m->method_name)->gc.u.v.flags |= (1<<1); (m->method_name)->gc.u.v.flags &= ~(1<<2); } (m->method_name) = (void*)((char*)(m->method_name) - (char*)script->mem); } } } while (0);
    }
    if (m->class_name) {
     do { if (m->class_name) { if (((char*)(m->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(m->class_name) < (accel_shared_globals->interned_strings_end))) { (m->class_name) = zend_file_cache_serialize_interned((zend_string*)(m->class_name), info); } else { do { if (__builtin_expect(!((((char*)(m->class_name) >= (char*)script->mem && (char*)(m->class_name) < (char*)script->mem + script->size) || ((char*)(m->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(m->class_name) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (m->class_name)->gc.u.v.flags |= (1<<1); (m->class_name)->gc.u.v.flags &= ~(1<<2); } (m->class_name) = (void*)((char*)(m->class_name) - (char*)script->mem); } } } while (0);
    }
   }

   if (q->alias) {
    do { if (q->alias) { if (((char*)(q->alias) >= (accel_shared_globals->interned_strings_start) && (char*)(q->alias) < (accel_shared_globals->interned_strings_end))) { (q->alias) = zend_file_cache_serialize_interned((zend_string*)(q->alias), info); } else { do { if (__builtin_expect(!((((char*)(q->alias) >= (char*)script->mem && (char*)(q->alias) < (char*)script->mem + script->size) || ((char*)(q->alias) >= (accel_shared_globals->interned_strings_start) && (char*)(q->alias) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (q->alias)->gc.u.v.flags |= (1<<1); (q->alias)->gc.u.v.flags &= ~(1<<2); } (q->alias) = (void*)((char*)(q->alias) - (char*)script->mem); } } } while (0);
   }
   p++;
  }
 }
 ...
 if (ce->trait_precedences) {
  ...
  do { if (ce->trait_precedences) { do { if (__builtin_expect(!((((char*)(ce->trait_precedences) >= (char*)script->mem && (char*)(ce->trait_precedences) < (char*)script->mem + script->size) || ((char*)(ce->trait_precedences) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->trait_precedences) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->trait_precedences) = (void*)((char*)(ce->trait_precedences) - (char*)script->mem); } } while (0);
  ...
  while (*p) {
   ...
   if (q->exclude_from_classes) {
    ...
    do { if (q->exclude_from_classes) { do { if (__builtin_expect(!((((char*)(q->exclude_from_classes) >= (char*)script->mem && (char*)(q->exclude_from_classes) < (char*)script->mem + script->size) || ((char*)(q->exclude_from_classes) >= (accel_shared_globals->interned_strings_start) && (char*)(q->exclude_from_classes) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (q->exclude_from_classes) = (void*)((char*)(q->exclude_from_classes) - (char*)script->mem); } } while (0);
    s = (zend_string**)q->exclude_from_classes;
    do { if (s) { do { if (__builtin_expect(!(((char*)(s) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (s) = (void*)((char*)buf + (size_t)(s)); } } while (0);

    while (*s) {
     do { if (*s) { if (((char*)(*s) >= (accel_shared_globals->interned_strings_start) && (char*)(*s) < (accel_shared_globals->interned_strings_end))) { (*s) = zend_file_cache_serialize_interned((zend_string*)(*s), info); } else { do { if (__builtin_expect(!((((char*)(*s) >= (char*)script->mem && (char*)(*s) < (char*)script->mem + script->size) || ((char*)(*s) >= (accel_shared_globals->interned_strings_start) && (char*)(*s) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (*s)->gc.u.v.flags |= (1<<1); (*s)->gc.u.v.flags &= ~(1<<2); } (*s) = (void*)((char*)(*s) - (char*)script->mem); } } } while (0);
     s++;
    }
   }
   p++;
 ...
 do { if (ce->parent) { do { if (__builtin_expect(!((((char*)(ce->parent) >= (char*)script->mem && (char*)(ce->parent) < (char*)script->mem + script->size) || ((char*)(ce->parent) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->parent) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->parent) = (void*)((char*)(ce->parent) - (char*)script->mem); } } while (0);
 do { if (ce->constructor) { do { if (__builtin_expect(!((((char*)(ce->constructor) >= (char*)script->mem && (char*)(ce->constructor) < (char*)script->mem + script->size) || ((char*)(ce->constructor) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->constructor) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->constructor) = (void*)((char*)(ce->constructor) - (char*)script->mem); } } while (0);
 do { if (ce->destructor) { do { if (__builtin_expect(!((((char*)(ce->destructor) >= (char*)script->mem && (char*)(ce->destructor) < (char*)script->mem + script->size) || ((char*)(ce->destructor) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->destructor) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->destructor) = (void*)((char*)(ce->destructor) - (char*)script->mem); } } while (0);
 do { if (ce->clone) { do { if (__builtin_expect(!((((char*)(ce->clone) >= (char*)script->mem && (char*)(ce->clone) < (char*)script->mem + script->size) || ((char*)(ce->clone) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->clone) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->clone) = (void*)((char*)(ce->clone) - (char*)script->mem); } } while (0);
 do { if (ce->__get) { do { if (__builtin_expect(!((((char*)(ce->__get) >= (char*)script->mem && (char*)(ce->__get) < (char*)script->mem + script->size) || ((char*)(ce->__get) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__get) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__get) = (void*)((char*)(ce->__get) - (char*)script->mem); } } while (0);
 do { if (ce->__set) { do { if (__builtin_expect(!((((char*)(ce->__set) >= (char*)script->mem && (char*)(ce->__set) < (char*)script->mem + script->size) || ((char*)(ce->__set) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__set) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__set) = (void*)((char*)(ce->__set) - (char*)script->mem); } } while (0);
 do { if (ce->__call) { do { if (__builtin_expect(!((((char*)(ce->__call) >= (char*)script->mem && (char*)(ce->__call) < (char*)script->mem + script->size) || ((char*)(ce->__call) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__call) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__call) = (void*)((char*)(ce->__call) - (char*)script->mem); } } while (0);
 do { if (ce->serialize_func) { do { if (__builtin_expect(!((((char*)(ce->serialize_func) >= (char*)script->mem && (char*)(ce->serialize_func) < (char*)script->mem + script->size) || ((char*)(ce->serialize_func) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->serialize_func) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->serialize_func) = (void*)((char*)(ce->serialize_func) - (char*)script->mem); } } while (0);
 do { if (ce->unserialize_func) { do { if (__builtin_expect(!((((char*)(ce->unserialize_func) >= (char*)script->mem && (char*)(ce->unserialize_func) < (char*)script->mem + script->size) || ((char*)(ce->unserialize_func) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->unserialize_func) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->unserialize_func) = (void*)((char*)(ce->unserialize_func) - (char*)script->mem); } } while (0);
 do { if (ce->__isset) { do { if (__builtin_expect(!((((char*)(ce->__isset) >= (char*)script->mem && (char*)(ce->__isset) < (char*)script->mem + script->size) || ((char*)(ce->__isset) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__isset) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__isset) = (void*)((char*)(ce->__isset) - (char*)script->mem); } } while (0);
 do { if (ce->__unset) { do { if (__builtin_expect(!((((char*)(ce->__unset) >= (char*)script->mem && (char*)(ce->__unset) < (char*)script->mem + script->size) || ((char*)(ce->__unset) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__unset) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__unset) = (void*)((char*)(ce->__unset) - (char*)script->mem); } } while (0);
 do { if (ce->__tostring) { do { if (__builtin_expect(!((((char*)(ce->__tostring) >= (char*)script->mem && (char*)(ce->__tostring) < (char*)script->mem + script->size) || ((char*)(ce->__tostring) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__tostring) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__tostring) = (void*)((char*)(ce->__tostring) - (char*)script->mem); } } while (0);
 do { if (ce->__callstatic) { do { if (__builtin_expect(!((((char*)(ce->__callstatic) >= (char*)script->mem && (char*)(ce->__callstatic) < (char*)script->mem + script->size) || ((char*)(ce->__callstatic) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__callstatic) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__callstatic) = (void*)((char*)(ce->__callstatic) - (char*)script->mem); } } while (0);
 do { if (ce->__debugInfo) { do { if (__builtin_expect(!((((char*)(ce->__debugInfo) >= (char*)script->mem && (char*)(ce->__debugInfo) < (char*)script->mem + script->size) || ((char*)(ce->__debugInfo) >= (accel_shared_globals->interned_strings_start) && (char*)(ce->__debugInfo) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (ce->__debugInfo) = (void*)((char*)(ce->__debugInfo) - (char*)script->mem); } } while (0);
}
                                      ...
                                      void *buf)
{
 ...
 memcpy(info->system_id, (accel_globals.system_id), 32);
 ...
 do { if (new_script->script.filename) { if (((char*)(new_script->script.filename) >= (accel_shared_globals->interned_strings_start) && (char*)(new_script->script.filename) < (accel_shared_globals->interned_strings_end))) { (new_script->script.filename) = zend_file_cache_serialize_interned((zend_string*)(new_script->script.filename), info); } else { do { if (__builtin_expect(!((((char*)(new_script->script.filename) >= (char*)script->mem && (char*)(new_script->script.filename) < (char*)script->mem + script->size) || ((char*)(new_script->script.filename) >= (accel_shared_globals->interned_strings_start) && (char*)(new_script->script.filename) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); if (__builtin_expect(!!(script->corrupted), 1)) { (new_script->script.filename)->gc.u.v.flags |= (1<<1); (new_script->script.filename)->gc.u.v.flags &= ~(1<<2); } (new_script->script.filename) = (void*)((char*)(new_script->script.filename) - (char*)script->mem); } } } while (0);
 ...
 do { if (new_script->arena_mem) { do { if (__builtin_expect(!((((char*)(new_script->arena_mem) >= (char*)script->mem && (char*)(new_script->arena_mem) < (char*)script->mem + script->size) || ((char*)(new_script->arena_mem) >= (accel_shared_globals->interned_strings_start) && (char*)(new_script->arena_mem) < (accel_shared_globals->interned_strings_end)))), 0)) __builtin_unreachable(); } while (0); (new_script->arena_mem) = (void*)((char*)(new_script->arena_mem) - (char*)script->mem); } } while (0);
...
static char *zend_file_cache_get_bin_file_path(zend_string *script_path)
{
 ...
 len = strlen((accel_globals.accel_directives).file_cache);
 filename = (__builtin_constant_p((len + 33 + (script_path)->len + sizeof(".bin")) ) ? (((len + 33 + (script_path)->len + sizeof(".bin")) <= 8) ? _emalloc_8() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 16) ? _emalloc_16() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 24) ? _emalloc_24() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 32) ? _emalloc_32() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 40) ? _emalloc_40() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 48) ? _emalloc_48() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 56) ? _emalloc_56() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 64) ? _emalloc_64() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 80) ? _emalloc_80() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 96) ? _emalloc_96() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 112) ? _emalloc_112() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 128) ? _emalloc_128() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 160) ? _emalloc_160() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 192) ? _emalloc_192() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 224) ? _emalloc_224() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 256) ? _emalloc_256() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 320) ? _emalloc_320() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 384) ? _emalloc_384() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 448) ? _emalloc_448() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 512) ? _emalloc_512() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 640) ? _emalloc_640() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 768) ? _emalloc_768() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 896) ? _emalloc_896() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 1024) ? _emalloc_1024() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 1280) ? _emalloc_1280() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 1536) ? _emalloc_1536() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 1792) ? _emalloc_1792() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 2048) ? _emalloc_2048() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 2560) ? _emalloc_2560() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= 3072) ? _emalloc_3072() : (((len + 33 + (script_path)->len + sizeof(".bin")) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((len + 33 + (script_path)->len + sizeof(".bin"))) : _emalloc_huge((len + 33 + (script_path)->len + sizeof(".bin")))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((len + 33 + (script_path)->len + sizeof(".bin")) ) );
 memcpy(filename, (accel_globals.accel_directives).file_cache, len);

 filename[len] = '/';
 memcpy(filename + len + 1, (accel_globals.system_id), 32);
 memcpy(filename + len + 33, (script_path)->val, (script_path)->len);
 memcpy(filename + len + 33 + (script_path)->len, ".bin", sizeof(".bin"));
# 723 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 return filename;
}
...
int zend_file_cache_script_store(zend_persistent_script *script, int in_shm)
{
 ...
 if (zend_file_cache_mkdir(filename, strlen((accel_globals.accel_directives).file_cache)) != SUCCESS) {
  zend_accel_error(2, "opcache cannot create directory for file '%s'\n", filename);
  _efree((filename) );
  return FAILURE;
 }


 fd = open(filename, 0100 | 0200 | 02 | 0, 0400 | 0200);



 if (fd < 0) {
  if ((*__errno_location ()) != 17) {
   zend_accel_error(2, "opcache cannot create file '%s'\n", filename);
  }
  _efree((filename) );
  return FAILURE;
 }
 ...
 mem = (__builtin_constant_p((script->size + 64) ) ? (((script->size + 64) <= 8) ? _emalloc_8() : (((script->size + 64) <= 16) ? _emalloc_16() : (((script->size + 64) <= 24) ? _emalloc_24() : (((script->size + 64) <= 32) ? _emalloc_32() : (((script->size + 64) <= 40) ? _emalloc_40() : (((script->size + 64) <= 48) ? _emalloc_48() : (((script->size + 64) <= 56) ? _emalloc_56() : (((script->size + 64) <= 64) ? _emalloc_64() : (((script->size + 64) <= 80) ? _emalloc_80() : (((script->size + 64) <= 96) ? _emalloc_96() : (((script->size + 64) <= 112) ? _emalloc_112() : (((script->size + 64) <= 128) ? _emalloc_128() : (((script->size + 64) <= 160) ? _emalloc_160() : (((script->size + 64) <= 192) ? _emalloc_192() : (((script->size + 64) <= 224) ? _emalloc_224() : (((script->size + 64) <= 256) ? _emalloc_256() : (((script->size + 64) <= 320) ? _emalloc_320() : (((script->size + 64) <= 384) ? _emalloc_384() : (((script->size + 64) <= 448) ? _emalloc_448() : (((script->size + 64) <= 512) ? _emalloc_512() : (((script->size + 64) <= 640) ? _emalloc_640() : (((script->size + 64) <= 768) ? _emalloc_768() : (((script->size + 64) <= 896) ? _emalloc_896() : (((script->size + 64) <= 1024) ? _emalloc_1024() : (((script->size + 64) <= 1280) ? _emalloc_1280() : (((script->size + 64) <= 1536) ? _emalloc_1536() : (((script->size + 64) <= 1792) ? _emalloc_1792() : (((script->size + 64) <= 2048) ? _emalloc_2048() : (((script->size + 64) <= 2560) ? _emalloc_2560() : (((script->size + 64) <= 3072) ? _emalloc_3072() : (((script->size + 64) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((script->size + 64)) : _emalloc_huge((script->size + 64))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((script->size + 64) ) );
 buf = (void*)(((zend_uintptr_t)mem + 63L) & ~63L);




 (accel_globals.mem) = zend_string_alloc(4096 - (((zend_long) (((char *) (&(((zend_string*)((void *)0))->val))) - ((char *) ((void *)0)))) + 1), 0);
 ...
 info.checksum = zend_adler32(1, buf, script->size);
 info.checksum = zend_adler32(info.checksum, (signed char*)((zend_string*)(accel_globals.mem))->val, info.str_size);
 ...
 vec[2].iov_base = ((zend_string*)(accel_globals.mem))->val;
 vec[2].iov_len = info.str_size;

 if (writev(fd, vec, 3) != (ssize_t)(sizeof(info) + script->size + info.str_size)) {
  zend_accel_error(2, "opcache cannot write to file '%s'\n", filename);
  zend_string_release((zend_string*)(accel_globals.mem));
  _efree((mem) );
  unlink(filename);
  _efree((filename) );
  return FAILURE;
 }
# 817 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
 zend_string_release((zend_string*)(accel_globals.mem));
 _efree((mem) );
 if (flock(fd, 8) != 0) {
  zend_accel_error(2, "opcache cannot unlock file '%s'\n", filename);
 }
 close(fd);
 _efree((filename) );
                                             ...
                                             dtor_func_t dtor)
{
 ...
 ht->pDestructor = dtor;
 if (!(ht->u.flags & (1<<3))) {
  do { (ht)->arData = (Bucket*)(((char*)(&uninitialized_bucket)) + (((size_t)(uint32_t)-(int32_t)((ht)->nTableMask)) * sizeof(uint32_t))); } while (0);
  return;
 }
 if ((((char*)(ht->arData) >= (char*)script->mem && (char*)(ht->arData) < (char*)script->mem + script->size) || ((char*)(ht->arData) >= (accel_shared_globals->interned_strings_start) && (char*)(ht->arData) < (accel_shared_globals->interned_strings_end)))) {
  return;
 }
 do { if (ht->arData) { do { if (__builtin_expect(!(((char*)(ht->arData) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ht->arData) = (void*)((char*)buf + (size_t)(ht->arData)); } } while (0);
 p = ht->arData;
 end = p + ht->nNumUsed;
 while (p < end) {
  if (zval_get_type(&(p->val)) != 0) {
   do { if (p->key) { if (((size_t)(p->key) & 1UL)) { (p->key) = (void*)zend_file_cache_unserialize_interned((zend_string*)(p->key), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(p->key) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p->key) = (void*)((char*)buf + (size_t)(p->key)); if (__builtin_expect(!!(!script->corrupted), 1)) { (p->key)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (p->key)->gc.u.v.flags |= (1<<1); (p->key)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
                                             ...
                                             void *buf)
{
 switch (zval_get_type(&(*(zv)))) {
  case 6:
  case 11:
   if (!(((char*)((*(zv)).value.str) >= (char*)script->mem && (char*)((*(zv)).value.str) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.str) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.str) < (accel_shared_globals->interned_strings_end)))) {
    do { if ((*(zv)).value.str) { if (((size_t)((*(zv)).value.str) & 1UL)) { ((*(zv)).value.str) = (void*)zend_file_cache_unserialize_interned((zend_string*)((*(zv)).value.str), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)((*(zv)).value.str) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.str) = (void*)((char*)buf + (size_t)((*(zv)).value.str)); if (__builtin_expect(!!(!script->corrupted), 1)) { ((*(zv)).value.str)->gc.u.v.flags |= (1<<1) | (1<<2); } else { ((*(zv)).value.str)->gc.u.v.flags |= (1<<1); ((*(zv)).value.str)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
   }
   break;
  case 7:
   if (!(((char*)((*(zv)).value.arr) >= (char*)script->mem && (char*)((*(zv)).value.arr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.arr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.arr) < (accel_shared_globals->interned_strings_end)))) {
    HashTable *ht;

    do { if ((*(zv)).value.arr) { do { if (__builtin_expect(!(((char*)((*(zv)).value.arr) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.arr) = (void*)((char*)buf + (size_t)((*(zv)).value.arr)); } } while (0);
    ht = (*(zv)).value.arr;
    zend_file_cache_unserialize_hash(ht,
      script, buf, zend_file_cache_unserialize_zval, _zval_ptr_dtor);
   }
   break;
  case 10:
   if (!(((char*)((*(zv)).value.ref) >= (char*)script->mem && (char*)((*(zv)).value.ref) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ref) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ref) < (accel_shared_globals->interned_strings_end)))) {
    zend_reference *ref;

    do { if ((*(zv)).value.ref) { do { if (__builtin_expect(!(((char*)((*(zv)).value.ref) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ref) = (void*)((char*)buf + (size_t)((*(zv)).value.ref)); } } while (0);
    ref = (*(zv)).value.ref;
    zend_file_cache_unserialize_zval(&ref->val, script, buf);
   }
   break;
  case 12:
   if (!(((char*)((*(zv)).value.ast) >= (char*)script->mem && (char*)((*(zv)).value.ast) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ast) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ast) < (accel_shared_globals->interned_strings_end)))) {
    zend_ast_ref *ast;

    do { if ((*(zv)).value.ast) { do { if (__builtin_expect(!(((char*)((*(zv)).value.ast) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ast) = (void*)((char*)buf + (size_t)((*(zv)).value.ast)); } } while (0);
    ast = (*(zv)).value.ast;
    if (!(((char*)(ast->ast) >= (char*)script->mem && (char*)(ast->ast) < (char*)script->mem + script->size) || ((char*)(ast->ast) >= (accel_shared_globals->interned_strings_start) && (char*)(ast->ast) < (accel_shared_globals->interned_strings_end)))) {
...
static void zend_file_cache_unserialize_op_array(zend_op_array *op_array,
                                                 ...
                                                 void *buf)
{
 if (op_array->static_variables && !(((char*)(op_array->static_variables) >= (char*)script->mem && (char*)(op_array->static_variables) < (char*)script->mem + script->size) || ((char*)(op_array->static_variables) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->static_variables) < (accel_shared_globals->interned_strings_end)))) {
  HashTable *ht;

  do { if (op_array->static_variables) { do { if (__builtin_expect(!(((char*)(op_array->static_variables) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->static_variables) = (void*)((char*)buf + (size_t)(op_array->static_variables)); } } while (0);
  ht = op_array->static_variables;
  zend_file_cache_unserialize_hash(ht,
    script, buf, zend_file_cache_unserialize_zval, _zval_ptr_dtor);
 }

 if (op_array->literals && !(((char*)(op_array->literals) >= (char*)script->mem && (char*)(op_array->literals) < (char*)script->mem + script->size) || ((char*)(op_array->literals) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->literals) < (accel_shared_globals->interned_strings_end)))) {
  zval *p, *end;

  do { if (op_array->literals) { do { if (__builtin_expect(!(((char*)(op_array->literals) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->literals) = (void*)((char*)buf + (size_t)(op_array->literals)); } } while (0);
  p = op_array->literals;
  end = p + op_array->last_literal;
  while (p < end) {
 ...
 if (!(((char*)(op_array->opcodes) >= (char*)script->mem && (char*)(op_array->opcodes) < (char*)script->mem + script->size) || ((char*)(op_array->opcodes) >= (accel_shared_globals->interned_strings_start) && (char*)(op_array->opcodes) < (accel_shared_globals->interned_strings_end)))) {
  zend_op *opline, *end;

  do { if (op_array->opcodes) { do { if (__builtin_expect(!(((char*)(op_array->opcodes) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->opcodes) = (void*)((char*)buf + (size_t)(op_array->opcodes)); } } while (0);
  opline = op_array->opcodes;
  end = opline + op_array->last;
  while (opline < end) {
# 997 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/zend_file_cache.c"
  ...
  if (op_array->arg_info) {
   zend_arg_info *p, *end;
   do { if (op_array->arg_info) { do { if (__builtin_expect(!(((char*)(op_array->arg_info) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->arg_info) = (void*)((char*)buf + (size_t)(op_array->arg_info)); } } while (0);
   p = op_array->arg_info;
   end = p + op_array->num_args;
   if (op_array->fn_flags & 0x40000000) {
    p--;
   ...
   while (p < end) {
    if (!(((char*)(p->name) >= (char*)script->mem && (char*)(p->name) < (char*)script->mem + script->size) || ((char*)(p->name) >= (accel_shared_globals->interned_strings_start) && (char*)(p->name) < (accel_shared_globals->interned_strings_end)))) {
     do { if (p->name) { if (((size_t)(p->name) & 1UL)) { (p->name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(p->name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(p->name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p->name) = (void*)((char*)buf + (size_t)(p->name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (p->name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (p->name)->gc.u.v.flags |= (1<<1); (p->name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
    }
    if (!(((char*)(p->class_name) >= (char*)script->mem && (char*)(p->class_name) < (char*)script->mem + script->size) || ((char*)(p->class_name) >= (accel_shared_globals->interned_strings_start) && (char*)(p->class_name) < (accel_shared_globals->interned_strings_end)))) {
     do { if (p->class_name) { if (((size_t)(p->class_name) & 1UL)) { (p->class_name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(p->class_name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(p->class_name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (p->class_name) = (void*)((char*)buf + (size_t)(p->class_name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (p->class_name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (p->class_name)->gc.u.v.flags |= (1<<1); (p->class_name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
    }
    p++;
   }
  }
  ...
  if (op_array->vars) {
   ...
   do { if (op_array->vars) { do { if (__builtin_expect(!(((char*)(op_array->vars) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->vars) = (void*)((char*)buf + (size_t)(op_array->vars)); } } while (0);
   p = op_array->vars;
   end = p + op_array->last_var;
   while (p < end) {
    if (!(((char*)(*p) >= (char*)script->mem && (char*)(*p) < (char*)script->mem + script->size) || ((char*)(*p) >= (accel_shared_globals->interned_strings_start) && (char*)(*p) < (accel_shared_globals->interned_strings_end)))) {
     do { if (*p) { if (((size_t)(*p) & 1UL)) { (*p) = (void*)zend_file_cache_unserialize_interned((zend_string*)(*p), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(*p) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (*p) = (void*)((char*)buf + (size_t)(*p)); if (__builtin_expect(!!(!script->corrupted), 1)) { (*p)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (*p)->gc.u.v.flags |= (1<<1); (*p)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
    }
    p++;
   }
  }

  do { if (op_array->function_name) { if (((size_t)(op_array->function_name) & 1UL)) { (op_array->function_name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(op_array->function_name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(op_array->function_name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->function_name) = (void*)((char*)buf + (size_t)(op_array->function_name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (op_array->function_name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (op_array->function_name)->gc.u.v.flags |= (1<<1); (op_array->function_name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
  do { if (op_array->filename) { if (((size_t)(op_array->filename) & 1UL)) { (op_array->filename) = (void*)zend_file_cache_unserialize_interned((zend_string*)(op_array->filename), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(op_array->filename) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->filename) = (void*)((char*)buf + (size_t)(op_array->filename)); if (__builtin_expect(!!(!script->corrupted), 1)) { (op_array->filename)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (op_array->filename)->gc.u.v.flags |= (1<<1); (op_array->filename)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
  do { if (op_array->live_range) { do { if (__builtin_expect(!(((char*)(op_array->live_range) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->live_range) = (void*)((char*)buf + (size_t)(op_array->live_range)); } } while (0);
  do { if (op_array->scope) { do { if (__builtin_expect(!(((char*)(op_array->scope) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->scope) = (void*)((char*)buf + (size_t)(op_array->scope)); } } while (0);
  do { if (op_array->doc_comment) { if (((size_t)(op_array->doc_comment) & 1UL)) { (op_array->doc_comment) = (void*)zend_file_cache_unserialize_interned((zend_string*)(op_array->doc_comment), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(op_array->doc_comment) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->doc_comment) = (void*)((char*)buf + (size_t)(op_array->doc_comment)); if (__builtin_expect(!!(!script->corrupted), 1)) { (op_array->doc_comment)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (op_array->doc_comment)->gc.u.v.flags |= (1<<1); (op_array->doc_comment)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
  do { if (op_array->try_catch_array) { do { if (__builtin_expect(!(((char*)(op_array->try_catch_array) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->try_catch_array) = (void*)((char*)buf + (size_t)(op_array->try_catch_array)); } } while (0);
  do { if (op_array->prototype) { do { if (__builtin_expect(!(((char*)(op_array->prototype) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (op_array->prototype) = (void*)((char*)buf + (size_t)(op_array->prototype)); } } while (0);
 }
}
                                             ...
                                             void *buf)
{
 ...
 do { if ((*(zv)).value.ptr) { do { if (__builtin_expect(!(((char*)((*(zv)).value.ptr) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ptr) = (void*)((char*)buf + (size_t)((*(zv)).value.ptr)); } } while (0);
 op_array = (*(zv)).value.ptr;
...
static void zend_file_cache_unserialize_prop_info(zval *zv,
                                                  ...
                                                  void *buf)
{
 if (!(((char*)((*(zv)).value.ptr) >= (char*)script->mem && (char*)((*(zv)).value.ptr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ptr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ptr) < (accel_shared_globals->interned_strings_end)))) {
  zend_property_info *prop;

  do { if ((*(zv)).value.ptr) { do { if (__builtin_expect(!(((char*)((*(zv)).value.ptr) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); ((*(zv)).value.ptr) = (void*)((char*)buf + (size_t)((*(zv)).value.ptr)); } } while (0);
  prop = (*(zv)).value.ptr;

  if (prop->ce && !(((char*)(prop->ce) >= (char*)script->mem && (char*)(prop->ce) < (char*)script->mem + script->size) || ((char*)(prop->ce) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->ce) < (accel_shared_globals->interned_strings_end)))) {
   do { if (prop->ce) { do { if (__builtin_expect(!(((char*)(prop->ce) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (prop->ce) = (void*)((char*)buf + (size_t)(prop->ce)); } } while (0);
  }
  if (prop->name && !(((char*)(prop->name) >= (char*)script->mem && (char*)(prop->name) < (char*)script->mem + script->size) || ((char*)(prop->name) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->name) < (accel_shared_globals->interned_strings_end)))) {
   do { if (prop->name) { if (((size_t)(prop->name) & 1UL)) { (prop->name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(prop->name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(prop->name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (prop->name) = (void*)((char*)buf + (size_t)(prop->name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (prop->name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (prop->name)->gc.u.v.flags |= (1<<1); (prop->name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
  }
  if (prop->doc_comment && !(((char*)(prop->doc_comment) >= (char*)script->mem && (char*)(prop->doc_comment) < (char*)script->mem + script->size) || ((char*)(prop->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(prop->doc_comment) < (accel_shared_globals->interned_strings_end)))) {
   do { if (prop->doc_comment) { if (((size_t)(prop->doc_comment) & 1UL)) { (prop->doc_comment) = (void*)zend_file_cache_unserialize_interned((zend_string*)(prop->doc_comment), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(prop->doc_comment) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (prop->doc_comment) = (void*)((char*)buf + (size_t)(prop->doc_comment)); if (__builtin_expect(!!(!script->corrupted), 1)) { (prop->doc_comment)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (prop->doc_comment)->gc.u.v.flags |= (1<<1); (prop->doc_comment)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
  }
 }
}
                                                       ...
                                                       void *buf)
{
 if (!(((char*)((*(zv)).value.ptr) >= (char*)script->mem && (char*)((*(zv)).value.ptr) < (char*)script->mem + script->size) || ((char*)((*(zv)).value.ptr) >= (accel_shared_globals->interned_strings_start) && (char*)((*(zv)).value.ptr) < (accel_shared_globals->interned_strings_end)))) {
  ...
  if (c->ce && !(((char*)(c->ce) >= (char*)script->mem && (char*)(c->ce) < (char*)script->mem + script->size) || ((char*)(c->ce) >= (accel_shared_globals->interned_strings_start) && (char*)(c->ce) < (accel_shared_globals->interned_strings_end)))) {
   do { if (c->ce) { do { if (__builtin_expect(!(((char*)(c->ce) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (c->ce) = (void*)((char*)buf + (size_t)(c->ce)); } } while (0);
  }
  if (c->doc_comment && !(((char*)(c->doc_comment) >= (char*)script->mem && (char*)(c->doc_comment) < (char*)script->mem + script->size) || ((char*)(c->doc_comment) >= (accel_shared_globals->interned_strings_start) && (char*)(c->doc_comment) < (accel_shared_globals->interned_strings_end)))) {
   do { if (c->doc_comment) { if (((size_t)(c->doc_comment) & 1UL)) { (c->doc_comment) = (void*)zend_file_cache_unserialize_interned((zend_string*)(c->doc_comment), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(c->doc_comment) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (c->doc_comment) = (void*)((char*)buf + (size_t)(c->doc_comment)); if (__builtin_expect(!!(!script->corrupted), 1)) { (c->doc_comment)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (c->doc_comment)->gc.u.v.flags |= (1<<1); (c->doc_comment)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
  }
 }
}
                                              ...
                                              void *buf)
{
 ...
 do { if (ce->name) { if (((size_t)(ce->name) & 1UL)) { (ce->name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(ce->name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(ce->name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->name) = (void*)((char*)buf + (size_t)(ce->name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (ce->name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (ce->name)->gc.u.v.flags |= (1<<1); (ce->name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
 zend_file_cache_unserialize_hash(&ce->function_table,
   script, buf, zend_file_cache_unserialize_func, zend_function_dtor);
 if (ce->default_properties_table) {
  zval *p, *end;

  do { if (ce->default_properties_table) { do { if (__builtin_expect(!(((char*)(ce->default_properties_table) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->default_properties_table) = (void*)((char*)buf + (size_t)(ce->default_properties_table)); } } while (0);
  p = ce->default_properties_table;
  end = p + ce->default_properties_count;
  while (p < end) {
   zend_file_cache_unserialize_zval(p, script, buf);
 ...
 if (ce->default_static_members_table) {
  ...
  do { if (ce->default_static_members_table) { do { if (__builtin_expect(!(((char*)(ce->default_static_members_table) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->default_static_members_table) = (void*)((char*)buf + (size_t)(ce->default_static_members_table)); } } while (0);
  p = ce->default_static_members_table;
  end = p + ce->default_static_members_count;
  while (p < end) {
   zend_file_cache_unserialize_zval(p, script, buf);
 ...
 do { if (ce->info.user.filename) { if (((size_t)(ce->info.user.filename) & 1UL)) { (ce->info.user.filename) = (void*)zend_file_cache_unserialize_interned((zend_string*)(ce->info.user.filename), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(ce->info.user.filename) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->info.user.filename) = (void*)((char*)buf + (size_t)(ce->info.user.filename)); if (__builtin_expect(!!(!script->corrupted), 1)) { (ce->info.user.filename)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (ce->info.user.filename)->gc.u.v.flags |= (1<<1); (ce->info.user.filename)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
 do { if (ce->info.user.doc_comment) { if (((size_t)(ce->info.user.doc_comment) & 1UL)) { (ce->info.user.doc_comment) = (void*)zend_file_cache_unserialize_interned((zend_string*)(ce->info.user.doc_comment), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(ce->info.user.doc_comment) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->info.user.doc_comment) = (void*)((char*)buf + (size_t)(ce->info.user.doc_comment)); if (__builtin_expect(!!(!script->corrupted), 1)) { (ce->info.user.doc_comment)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (ce->info.user.doc_comment)->gc.u.v.flags |= (1<<1); (ce->info.user.doc_comment)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
 zend_file_cache_unserialize_hash(&ce->properties_info,
   script, buf, zend_file_cache_unserialize_prop_info, _zval_ptr_dtor);

 if (ce->trait_aliases) {
  zend_trait_alias **p, *q;

  do { if (ce->trait_aliases) { do { if (__builtin_expect(!(((char*)(ce->trait_aliases) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->trait_aliases) = (void*)((char*)buf + (size_t)(ce->trait_aliases)); } } while (0);
  p = ce->trait_aliases;
  ...
  while (*p) {
   ...
   if (q->trait_method) {
    ...
    do { if (q->trait_method) { do { if (__builtin_expect(!(((char*)(q->trait_method) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (q->trait_method) = (void*)((char*)buf + (size_t)(q->trait_method)); } } while (0);
    m = q->trait_method;

    if (m->method_name) {
     do { if (m->method_name) { if (((size_t)(m->method_name) & 1UL)) { (m->method_name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(m->method_name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(m->method_name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (m->method_name) = (void*)((char*)buf + (size_t)(m->method_name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (m->method_name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (m->method_name)->gc.u.v.flags |= (1<<1); (m->method_name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
    }
    if (m->class_name) {
     do { if (m->class_name) { if (((size_t)(m->class_name) & 1UL)) { (m->class_name) = (void*)zend_file_cache_unserialize_interned((zend_string*)(m->class_name), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(m->class_name) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (m->class_name) = (void*)((char*)buf + (size_t)(m->class_name)); if (__builtin_expect(!!(!script->corrupted), 1)) { (m->class_name)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (m->class_name)->gc.u.v.flags |= (1<<1); (m->class_name)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
    }
   }

   if (q->alias) {
    do { if (q->alias) { if (((size_t)(q->alias) & 1UL)) { (q->alias) = (void*)zend_file_cache_unserialize_interned((zend_string*)(q->alias), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(q->alias) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (q->alias) = (void*)((char*)buf + (size_t)(q->alias)); if (__builtin_expect(!!(!script->corrupted), 1)) { (q->alias)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (q->alias)->gc.u.v.flags |= (1<<1); (q->alias)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
   }
   p++;
  }
 }
 ...
 if (ce->trait_precedences) {
  ...
  do { if (ce->trait_precedences) { do { if (__builtin_expect(!(((char*)(ce->trait_precedences) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->trait_precedences) = (void*)((char*)buf + (size_t)(ce->trait_precedences)); } } while (0);
  p = ce->trait_precedences;
  ...
  while (*p) {
   ...
   if (q->exclude_from_classes) {
    ...
    do { if (q->exclude_from_classes) { do { if (__builtin_expect(!(((char*)(q->exclude_from_classes) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (q->exclude_from_classes) = (void*)((char*)buf + (size_t)(q->exclude_from_classes)); } } while (0);
    s = (zend_string**)q->exclude_from_classes;

    while (*s) {
     do { if (*s) { if (((size_t)(*s) & 1UL)) { (*s) = (void*)zend_file_cache_unserialize_interned((zend_string*)(*s), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(*s) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (*s) = (void*)((char*)buf + (size_t)(*s)); if (__builtin_expect(!!(!script->corrupted), 1)) { (*s)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (*s)->gc.u.v.flags |= (1<<1); (*s)->gc.u.v.flags &= ~(1<<2); } } } } while (0);
     s++;
    }
   }
   p++;
 ...
 do { if (ce->parent) { do { if (__builtin_expect(!(((char*)(ce->parent) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->parent) = (void*)((char*)buf + (size_t)(ce->parent)); } } while (0);
 do { if (ce->constructor) { do { if (__builtin_expect(!(((char*)(ce->constructor) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->constructor) = (void*)((char*)buf + (size_t)(ce->constructor)); } } while (0);
 do { if (ce->destructor) { do { if (__builtin_expect(!(((char*)(ce->destructor) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->destructor) = (void*)((char*)buf + (size_t)(ce->destructor)); } } while (0);
 do { if (ce->clone) { do { if (__builtin_expect(!(((char*)(ce->clone) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->clone) = (void*)((char*)buf + (size_t)(ce->clone)); } } while (0);
 do { if (ce->__get) { do { if (__builtin_expect(!(((char*)(ce->__get) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__get) = (void*)((char*)buf + (size_t)(ce->__get)); } } while (0);
 do { if (ce->__set) { do { if (__builtin_expect(!(((char*)(ce->__set) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__set) = (void*)((char*)buf + (size_t)(ce->__set)); } } while (0);
 do { if (ce->__call) { do { if (__builtin_expect(!(((char*)(ce->__call) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__call) = (void*)((char*)buf + (size_t)(ce->__call)); } } while (0);
 do { if (ce->serialize_func) { do { if (__builtin_expect(!(((char*)(ce->serialize_func) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->serialize_func) = (void*)((char*)buf + (size_t)(ce->serialize_func)); } } while (0);
 do { if (ce->unserialize_func) { do { if (__builtin_expect(!(((char*)(ce->unserialize_func) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->unserialize_func) = (void*)((char*)buf + (size_t)(ce->unserialize_func)); } } while (0);
 do { if (ce->__isset) { do { if (__builtin_expect(!(((char*)(ce->__isset) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__isset) = (void*)((char*)buf + (size_t)(ce->__isset)); } } while (0);
 do { if (ce->__unset) { do { if (__builtin_expect(!(((char*)(ce->__unset) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__unset) = (void*)((char*)buf + (size_t)(ce->__unset)); } } while (0);
 do { if (ce->__tostring) { do { if (__builtin_expect(!(((char*)(ce->__tostring) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__tostring) = (void*)((char*)buf + (size_t)(ce->__tostring)); } } while (0);
 do { if (ce->__callstatic) { do { if (__builtin_expect(!(((char*)(ce->__callstatic) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__callstatic) = (void*)((char*)buf + (size_t)(ce->__callstatic)); } } while (0);
 do { if (ce->__debugInfo) { do { if (__builtin_expect(!(((char*)(ce->__debugInfo) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (ce->__debugInfo) = (void*)((char*)buf + (size_t)(ce->__debugInfo)); } } while (0);

 if (__builtin_expect(!!((ce->ce_flags & 0x100)), 0)) {
                                        ...
                                        void *buf)
{
 ...
 do { if (script->script.filename) { if (((size_t)(script->script.filename) & 1UL)) { (script->script.filename) = (void*)zend_file_cache_unserialize_interned((zend_string*)(script->script.filename), !script->corrupted); } else { do { if (__builtin_expect(!(((char*)(script->script.filename) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (script->script.filename) = (void*)((char*)buf + (size_t)(script->script.filename)); if (__builtin_expect(!!(!script->corrupted), 1)) { (script->script.filename)->gc.u.v.flags |= (1<<1) | (1<<2); } else { (script->script.filename)->gc.u.v.flags |= (1<<1); (script->script.filename)->gc.u.v.flags &= ~(1<<2); } } } } while (0);

 zend_file_cache_unserialize_hash(&script->script.class_table,
   script, buf, zend_file_cache_unserialize_class, destroy_zend_class);
 ...
 do { if (script->arena_mem) { do { if (__builtin_expect(!(((char*)(script->arena_mem) < (char*)script->size)), 0)) __builtin_unreachable(); } while (0); (script->arena_mem) = (void*)((char*)buf + (size_t)(script->arena_mem)); } } while (0);
}
...
zend_persistent_script *zend_file_cache_script_load(zend_file_handle *file_handle)
{
 ...
 if (read(fd, &info, sizeof(info)) != sizeof(info)) {
  zend_accel_error(2, "opcache cannot read from file '%s'\n", filename);
  flock(fd, 8);
  close(fd);
  unlink(filename);
  _efree((filename) );
 ...
 if (memcmp(info.magic, "OPCACHE", 8) != 0) {
  zend_accel_error(2, "opcache cannot read from file '%s' (wrong header)\n", filename);
  flock(fd, 8);
  close(fd);
  unlink(filename);
  _efree((filename) );
 ...
 if (memcmp(info.system_id, (accel_globals.system_id), 32) != 0) {
  zend_accel_error(2, "opcache cannot read from file '%s' (wrong \"system_id\")\n", filename);
  flock(fd, 8);
  close(fd);
  unlink(filename);
  _efree((filename) );
 ...
 if ((accel_globals.accel_directives).validate_timestamps &&
     zend_get_file_handle_timestamp(file_handle, ((void *)0)) != info.timestamp) {
  if (flock(fd, 8) != 0) {
   zend_accel_error(2, "opcache cannot unlock file '%s'\n", filename);
  }
  close(fd);
 ...
 checkpoint = zend_arena_checkpoint((compiler_globals.arena));


 mem = zend_arena_alloc(&(compiler_globals.arena), info.mem_size + info.str_size + 64);
 ...
 if (read(fd, mem, info.mem_size + info.str_size) != (ssize_t)(info.mem_size + info.str_size)) {
  ...
  close(fd);
  unlink(filename);
  zend_arena_release(&(compiler_globals.arena), checkpoint);
  _efree((filename) );
  return ((void *)0);
 }
 if (flock(fd, 8) != 0) {
 ...
 if ((accel_globals.accel_directives).file_cache_consistency_checks &&
     zend_adler32(1, mem, info.mem_size + info.str_size) != info.checksum) {
  zend_accel_error(2, "corrupted file '%s'\n", filename);
  unlink(filename);
  zend_arena_release(&(compiler_globals.arena), checkpoint);
  _efree((filename) );
  return ((void *)0);
 ...
 if (!(accel_globals.accel_directives).file_cache_only) {
  ...
  bucket = zend_accel_hash_find_entry(&(accel_shared_globals->hash), full_path);
  if (bucket) {
  ...
  if (zend_accel_hash_is_full(&(accel_shared_globals->hash))) {
   zend_accel_error(4, "No more entries in hash table!");
   (smm_shared_globals->memory_exhausted) = 1;
...
use_process_mem:
 ...
 (accel_globals.mem) = ((char*)mem + info.mem_size);
 script = (zend_persistent_script*)((char*)buf + info.script_offset);
 script->corrupted = !cache_it;
 ...
 if (cache_it) {
  ...
  zend_accel_hash_update(&(accel_shared_globals->hash), (script->script.filename)->val, (script->script.filename)->len, 0, script);
