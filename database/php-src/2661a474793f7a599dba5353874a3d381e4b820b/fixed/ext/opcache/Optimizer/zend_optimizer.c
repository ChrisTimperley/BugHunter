...
# 162 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_optimizer.c"
int zend_optimizer_update_op1_const(zend_op_array *op_array,
                                    zend_op *opline,
                                    zval *val)
{
...
# 614 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_optimizer.c"
 ...
 if (func_info) {
  ...
  while (call_info) {
   ...
   if (opline && call_info->callee_func) {
    do { if (__builtin_expect(!(opline->opcode == 61), 0)) __builtin_unreachable(); } while (0);
...
# 818 "/home/ct584/git/bughunter/repositories/php-src/ext/opcache/Optimizer/zend_optimizer.c"
