# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
# 32 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 1
# 36 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/config.h" 1
...
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/config.h" 2
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
# 51 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
# 1 "/usr/include/errno.h" 1 3 4
# 52 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
...
# 53 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
# 67 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
...
# 68 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
...
# 69 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h" 2
# 146 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
union VALUETYPE {
 uint8_t b;
 uint16_t h;
 uint32_t l;
...
struct magic {
 ...
 uint16_t cont_level;
 uint8_t flag;
# 173 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
 uint8_t factor;
 ...
 uint8_t type;
 uint8_t in_type;
# 248 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
 uint8_t in_op;
 uint8_t mask_op;
 ...
 uint8_t factor_op;
# 286 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
 uint32_t offset;
...
# 350 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
struct mlist {
 struct magic *magic;
 uint32_t nmagic;
 void *map;
...
# 365 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
struct level_info {
 int32_t off;
 int got_match;
...
# 486 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/file.h"
char *strcasestr(const char *, const char *);


ssize_t getline(char **, size_t *, FILE *);
ssize_t getdelim(char **, size_t *, int, FILE *);
# 33 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c" 2


static const char rcsid[] __attribute__((__used__)) = "@(#)$File: softmagic.c,v 1.174 2014/02/12 23:20:53 christos Exp $";


# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/magic.h" 1
# 85 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/magic.h"
...
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c" 2
# 59 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
...
# 86 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
 int
...
# 128 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
static int
    ...
    int *returnval)
{
 ...
 for (magindex = 0; magindex < nmagic; magindex++) {
  ...
  if (m->type != 45)
  if ((((m->type) == 5 || (m->type) == 13 || (m->type) == 18 || (m->type) == 19 || (m->type) == 17 || (m->type) == 20 || (m->type) == 45 || (m->type) == 46) &&
...
check_fmt(struct magic_set *ms, struct magic *m)
{
 ...
 if ((pce = pcre_get_compiled_regex("~%[-0-9.]*s~", &re_extra, &re_options )) == ((void *)0)) {
  rv = -1;
   ...
   rv = !php_pcre_exec(pce, re_extra, m->desc, strlen(m->desc), 0, re_options, ((void *)0), 0);
 }
 (void)setlocale(0, "");
 return rv;
}
...
mprint(struct magic_set *ms, struct magic *m)
{
 ...
 union VALUETYPE *p = &ms->ms_value;
  ...
  case -1:
   return -1;
  case 1:
   (void)ap_php_snprintf(buf, sizeof(buf), "%llu",
...
# 829 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
static void
...
# 870 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
static void
...
mconvert(struct magic_set *ms, struct magic *m, int flip)
{
 ...
 case 13: {
  ...
  sz = sizeof(p->s) - sz;
  if (len >= sz) {
# 931 "/home/ct584/git/bughunter/repositories/php-src/ext/fileinfo/libmagic/softmagic.c"
   len = sz;
  }
  while (len--)
   *ptr1++ = *ptr2++;
    ...
    int *need_separator, int *returnval)
{
 ...
 case 17:
  if (((nbytes) < (offset) || (0) > ((nbytes) - (offset))))
   return 0;
  break;
...
magiccheck(struct magic_set *ms, struct magic *m)
{
 ...
 case 17: {
  ...
  if ((pce = pcre_get_compiled_regex_cache((*pattern).value.str.val, (*pattern).value.str.len )) == ((void *)0)) {
   ...
   php_pcre_match_impl(pce, haystack, ms->search.s_len, retval, subpats, 0, 1, (1<<8), 0 );
   ...
   if ((*retval).value.lval < 0) {
    ...
    if (zend_hash_index_find(ht, 0, (void **)&ppzval) == SUCCESS) {
     ...
     if (zend_hash_index_find((**ppzval).value.ht, 0, (void **)&match) == SUCCESS
       && zend_hash_index_find((**ppzval).value.ht, 1, (void **)&offset) == SUCCESS) {
      if ((**match).type != 6 || (**offset).type != 1) {
       goto error_out;
      }
      ms->search.s += (int)(**offset).value.lval;
      ms->search.offset += (size_t)(**offset).value.lval;
      ms->search.rm_len = (**match).value.str.len ;
      v = 0;
     } else {
      goto error_out;
     }
