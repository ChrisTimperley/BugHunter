# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_vm_opcodes.h" 1
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.h" 1
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_opcode.c" 2
  ...
  zend_op_array *ops, const znode_op *op, uint32_t type)
{
 ...
 switch (type) {
  case (1<<4): {
   zend_string *var = ops->vars[((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(op->var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0))))))];
   spprintf(&decode, 0, "$%.*s%c",
    (var)->len <= 19 ? (int) (var)->len : 18,
    (var)->val, (var)->len <= 19 ? 0 : '+');
  } break;

  case (1<<2):
   spprintf(&decode, 0, "@%u", ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(op->var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) - ops->last_var);
  break;
  case (1<<1):
   spprintf(&decode, 0, "~%u", ((uint32_t)(((zval*)(((char*)(((void *)0))) + ((int)(op->var)))) - (((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(0)))))) - ops->last_var);
  break;
  case (1<<0): {
   zval *literal = ((zval*)(((char*)((ops)->literals)) + (*op).constant));
...
char *phpdbg_decode_opline(zend_op_array *ops, zend_op *opline)
{
 ...
 char *result, *decode[4] = {((void *)0), ((void *)0), ((void *)0), ((void *)0)};


 switch (opline->opcode) {
 case 162:
  if (opline->extended_value == 1) {
   decode[0] = _estrdup(("FAST_CALL<FROM_FINALLY>") );
  }
  break;
 case 163:
  if (opline->extended_value != 0) {
   spprintf(&decode[0], 0, "FAST_RET<%s>",
    opline->extended_value == 1 ? "TO_CATCH" : "TO_FINALLY");
  }
  break;
 }
 ...
 decode[1] = phpdbg_decode_input_op(
  ops, opline, opline->op1, opline->op1_type, (flags & 0xff));


 decode[2] = phpdbg_decode_input_op(
  ops, opline, opline->op2, opline->op2_type, ((flags >> 8) & 0xff));


 switch (opline->opcode) {
 case 107:
  spprintf(&decode[3], 0, "%" "u", opline->result.num);
  break;
 default:
...
void phpdbg_print_opline_ex(zend_execute_data *execute_data, zend_bool ignore_flags)
{
 ...
 if (ignore_flags ||
  ...
  if (ignore_flags || (!((phpdbg_globals.flags) & (1ULL<<15)) || ((phpdbg_globals.flags) & (1ULL<<13)))) {

   phpdbg_print(P_NOTICE , (phpdbg_globals.io)[1].fd, "opline", "line=\"%u\" opline=\"%p\" op=\"%s\" file=\"%s\"", "L%-5u %16p %s %s", opline->lineno, opline, decode, execute_data->func->op_array.filename ? (execute_data->func->op_array.filename)->val : "unknown")
  ...
  if (!ignore_flags && (phpdbg_globals.oplog)) {
   phpdbg_log_internal(fileno((phpdbg_globals.oplog)), "L%-5u %16p %s %s\n", opline->lineno, opline, decode, execute_data->func->op_array.filename ? (execute_data->func->op_array.filename)->val : "unknown")
 ...
 if ((phpdbg_globals.oplog_list)) {
  phpdbg_oplog_entry *cur = zend_arena_alloc(&(phpdbg_globals.oplog_arena), sizeof(phpdbg_oplog_entry));
  ...
  cur->next = ((void *)0);
  (phpdbg_globals.oplog_cur)->next = cur;
  (phpdbg_globals.oplog_cur) = cur;
 }
}
