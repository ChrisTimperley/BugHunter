# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c"
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c"
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_opcode.c" 2
...
{
 op_array->opcodes = _erealloc((op_array->opcodes), (size * sizeof(zend_op)) );
}
...
__attribute__ ((visibility("default"))) void destroy_zend_function(zend_function *function)
{
 if (function->type == 2) {
  ...
  do { if (__builtin_expect(!(function->type == 1), 0)) __builtin_unreachable(); } while (0);
  do { if (__builtin_expect(!(function->common.function_name), 0)) __builtin_unreachable(); } while (0);
...
__attribute__ ((visibility("default"))) void zend_function_dtor(zval *zv)
{
 ...
 if (function->type == 2) {
  ...
  do { if (__builtin_expect(!(function->common.function_name), 0)) __builtin_unreachable(); } while (0);
  zend_string_release(function->common.function_name);
  if (!(function->common.fn_flags & 0x20000000)) {
   ((1)?free(function):_efree((function) ));
  }
 }
}
...
__attribute__ ((visibility("default"))) void zend_cleanup_op_array_data(zend_op_array *op_array)
{
 if (op_array->static_variables &&
     !((op_array->static_variables)->gc.u.v.flags & (1<<1))) {
...
__attribute__ ((visibility("default"))) void zend_cleanup_user_class_data(zend_class_entry *ce)
{
 ...
 if (ce->static_members_table) {
  ...
  ce->default_static_members_table = ce->static_members_table = ((void *)0);
  while (p != end) {
   i_zval_ptr_dtor(p );
   p++;
  }
 ...
 switch (ce->type) {
  case 2:
   ...
   do { Bucket *_p = (&ce->properties_info)->arData; Bucket *_end = _p + (&ce->properties_info)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; prop_info = (*(_z)).value.ptr; {
    if (prop_info->ce == ce || (prop_info->flags & 0x20000)) {
  ...
  case 1:
   ...
   if ((&ce->constants_table)->nNumOfElements) {
    ...
    do { Bucket *_p = (&ce->constants_table)->arData; Bucket *_end = _p + (&ce->constants_table)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; c = (*(_z)).value.ptr; {
     _zval_internal_ptr_dtor((&c->value) );
...
__attribute__ ((visibility("default"))) void destroy_op_array(zend_op_array *op_array)
{
 ...
 if (op_array->static_variables &&
     !((op_array->static_variables)->gc.u.v.flags & (1<<1))) {
  if (--(op_array->static_variables)->gc.refcount == 0) {
 ...
 do { if (__builtin_constant_p(sizeof(*(op_array->refcount)))) { if (sizeof(*(op_array->refcount)) <= 8) { _efree_8(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 16) { _efree_16(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 24) { _efree_24(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 32) { _efree_32(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 40) { _efree_40(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 48) { _efree_48(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 56) { _efree_56(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 64) { _efree_64(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 80) { _efree_80(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 96) { _efree_96(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 112) { _efree_112(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 128) { _efree_128(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 160) { _efree_160(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 192) { _efree_192(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 224) { _efree_224(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 256) { _efree_256(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 320) { _efree_320(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 384) { _efree_384(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 448) { _efree_448(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 512) { _efree_512(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 640) { _efree_640(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 768) { _efree_768(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 896) { _efree_896(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 1024) { _efree_1024(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 1280) { _efree_1280(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 1536) { _efree_1536(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 1792) { _efree_1792(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 2048) { _efree_2048(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 2560) { _efree_2560(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= 3072) { _efree_3072(op_array->refcount); } else if (sizeof(*(op_array->refcount)) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) { _efree_large(op_array->refcount, sizeof(*(op_array->refcount))); } else { _efree_huge(op_array->refcount, sizeof(*(op_array->refcount))); } } else { _efree(op_array->refcount); } } while (0);
...
zend_brk_cont_element *get_next_brk_cont_element(void)
{
 (compiler_globals.context).last_brk_cont++;
 (compiler_globals.context).brk_cont_array = _erealloc(((compiler_globals.context).brk_cont_array), (sizeof(zend_brk_cont_element) * (compiler_globals.context).last_brk_cont) );
 return &(compiler_globals.context).brk_cont_array[(compiler_globals.context).last_brk_cont-1];
}
...
static void zend_resolve_fast_call(zend_op_array *op_array, uint32_t op_num)
{
 ...
 if (finally_num != (uint32_t)-1) {
  ...
  do { if (__builtin_expect(!(op_array->opcodes[op_array->try_catch_array[finally_num].finally_op - 2].opcode == 162), 0)) __builtin_unreachable(); } while (0);
...
static uint32_t zend_get_brk_cont_target(const zend_op_array *op_array, const zend_op *opline) {
 ...
 do {
  jmp_to = &(compiler_globals.context).brk_cont_array[array_offset];
  if (nest_levels > 1) {
   array_offset = jmp_to->parent;
  }
 } while (--nest_levels > 0);

 return opline->opcode == 254 ? jmp_to->brk : jmp_to->cont;
}
...
__attribute__ ((visibility("default"))) int pass_two(zend_op_array *op_array)
{
 ...
 if ((compiler_globals.compiler_options) & (1<<1)) {
  if (zend_extension_flags & (1<<2)) {
   zend_llist_apply_with_argument(&zend_extensions, (llist_apply_with_arg_func_t) zend_extension_op_array_handler, op_array);
  }
 }

 if ((compiler_globals.context).vars_size != op_array->last_var) {
  op_array->vars = (zend_string**) _erealloc((op_array->vars), (sizeof(zend_string*)*op_array->last_var) );
  (compiler_globals.context).vars_size = op_array->last_var;
 }
 if ((compiler_globals.context).opcodes_size != op_array->last) {
  op_array->opcodes = (zend_op *) _erealloc((op_array->opcodes), (sizeof(zend_op)*op_array->last) );
  (compiler_globals.context).opcodes_size = op_array->last;
 }
 if ((compiler_globals.context).literals_size != op_array->last_literal) {
  op_array->literals = (zval*)_erealloc((op_array->literals), (sizeof(zval) * op_array->last_literal) );
 ...
 while (opline < end) {
  switch (opline->opcode) {
   case 162:
    ...
    do { (opline->op1).jmp_offset = ((char*)&(op_array)->opcodes[(opline->op1).opline_num] - (char*)(opline)); } while (0);
    break;
   case 163:
   ...
   case 77:
   case 125:
    do { (opline->op2).jmp_offset = ((char*)&(op_array)->opcodes[(opline->op2).opline_num] - (char*)(opline)); } while (0);
    break;
   case 151:
   {
  ...
  if (opline->op1_type == (1<<0)) {
   ...
   opline->op1.var = (uint32_t)(zend_intptr_t)(((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(op_array->last_var + opline->op1.var))));
  }
  if (opline->op2_type == (1<<0)) {
   do { (opline->op2).constant *= sizeof(zval); } while (0);
  } else if (opline->op2_type & ((1<<2)|(1<<1))) {
   opline->op2.var = (uint32_t)(zend_intptr_t)(((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(op_array->last_var + opline->op2.var))));
  }
  if (opline->result_type & ((1<<2)|(1<<1))) {
   opline->result.var = (uint32_t)(zend_intptr_t)(((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(op_array->last_var + opline->result.var))));
  }
 ...
 if (op_array->live_range) {
  ...
  for (i = 0; i < op_array->last_live_range; i++) {
   op_array->live_range[i].var =
    (uint32_t)(zend_intptr_t)(((zval*)(((void *)0))) + (((int)(((((sizeof(zend_execute_data)) + 8 - 1L) & ~(8 - 1L)) + (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)) - 1) / (((sizeof(zval)) + 8 - 1L) & ~(8 - 1L)))) + ((int)(op_array->last_var + (op_array->live_range[i].var / sizeof(zval)))))) |
    (op_array->live_range[i].var & 3);
  }
 }
