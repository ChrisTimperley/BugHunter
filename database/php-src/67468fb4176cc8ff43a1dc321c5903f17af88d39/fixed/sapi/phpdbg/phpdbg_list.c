# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c"
# 21 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c"
...
# 22 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 82 "/usr/include/x86_64-linux-gnu/sys/stat.h" 3 4
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 33 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/main/php_streams.h" 1
# 34 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
# 35 "/home/ct584/git/bughunter/repositories/php-src/sapi/phpdbg/phpdbg_list.c" 2
...
const phpdbg_command_t phpdbg_list_commands[] = {
 {"lines", sizeof("lines")-1, "lists the specified lines", sizeof("lists the specified lines")-1, 'l', phpdbg_do_list_lines, ((void *)0), "l", &phpdbg_prompt_commands[12], 1},
 {"class", sizeof("class")-1, "lists the specified class", sizeof("lists the specified class")-1, 'c', phpdbg_do_list_class, ((void *)0), "s", &phpdbg_prompt_commands[12], 1},
 {"method", sizeof("method")-1, "lists the specified method", sizeof("lists the specified method")-1, 'm', phpdbg_do_list_method, ((void *)0), "m", &phpdbg_prompt_commands[12], 1},
 {"func", sizeof("func")-1, "lists the specified function", sizeof("lists the specified function")-1, 'f', phpdbg_do_list_func, ((void *)0), "s", &phpdbg_prompt_commands[12], 1},
 {((void *)0), 0, ((void *)0), 0, '\0', ((void *)0), ((void *)0), ((void *)0), ((void *)0), 0}
};

int phpdbg_do_list_lines(const phpdbg_param_t *param)
{
 if (!(phpdbg_globals.exec) && !zend_is_executing()) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"execution\"", "Not executing, and execution context not set");
  return SUCCESS;
 }
...
int phpdbg_do_list_method(const phpdbg_param_t *param)
{
 ...
 if (phpdbg_safe_class_lookup(param->method.class, strlen(param->method.class), &ce) == SUCCESS) {
  ...
  if ((function = zend_hash_str_find_ptr(&ce->function_table, lcname, strlen(lcname)))) {
   ...
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"notfound\" method=\"%s::%s\"", "Could not find %s::%s", param->method.class, param->method.name);
  }

  _efree((lcname) );
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"notfound\" class=\"%s\"", "Could not find the class %s", param->method.class);
 }
 ...
 if (phpdbg_safe_class_lookup(param->str, param->len, &ce) == SUCCESS) {
  if (ce->type == 2) {
   if (ce->info.user.filename) {
    ...
    phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"nosource\" class=\"%s\"", "The source of the requested class (%s) cannot be found", (ce->name)->val);
   }
  } else {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"internalclass\" class=\"%s\"", "The class requested (%s) is not user defined", (ce->name)->val);
  }
 } else {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"notfound\" class=\"%s\"", "The requested class (%s) could not be found", param->str);
 }
...
void phpdbg_list_file(zend_string *filename, uint count, int offset, uint highlight)
{
 ...
 char resolved_path_buf[4096];
 const char *abspath;

 if (tsrm_realpath((filename)->val, resolved_path_buf)) {
  abspath = resolved_path_buf;
 } else {
  abspath = (filename)->val;
 }

 if (!(data = zend_hash_str_find_ptr(&(phpdbg_globals.file_sources), abspath, strlen(abspath)))) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"unknownfile\"", "Could not find information about included file...");
  return;
 }
 ...
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "<list %r file=\"%s\">", (filename)->val);
 ...
 for (line = offset; line < lastline;) {
  ...
  if (!highlight) {
   phpdbg_print(P_WRITE , (phpdbg_globals.io)[1].fd, "line", "line=\"%u\" code=\"%.*s\"", " %05u: %.*s", line, linelen, buffer);
  } else {
   if (highlight != line) {
    phpdbg_print(P_WRITE , (phpdbg_globals.io)[1].fd, "line", "line=\"%u\" code=\"%.*s\"", " %05u: %.*s", line, linelen, buffer);
   } else {
    phpdbg_print(P_WRITE , (phpdbg_globals.io)[1].fd, "line", "line=\"%u\" code=\"%.*s\" current=\"current\"", ">%05u: %.*s", line, linelen, buffer);
   }
  }
 ...
 phpdbg_xml_internal((phpdbg_globals.io)[1].fd, "</list>");
}
...
void phpdbg_list_function(const zend_function *fbc)
{
 ...
 if (fbc->type != 2) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"internalfunction\" function=\"%s\"", "The function requested (%s) is not user defined", (fbc->common.function_name)->val);
  return;
 }
...
void phpdbg_list_function_byname(const char *str, size_t len)
{
 ...
 if (func_name[0] == '.') {
  if ((executor_globals.scope)) {
   ...
   func_table = &(executor_globals.scope)->function_table;
  } else {
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"noclasses\"", "No active class");
   return;
  }
 } else if (!(executor_globals.function_table)) {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "inactive", "type=\"function_table\"", "No function table loaded");
  return;
 } else {
  func_table = (executor_globals.function_table);
 }
 ...
 { jmp_buf *__orig_bailout = (phpdbg_globals.sigsegv_bailout); jmp_buf __bailout; (phpdbg_globals.sigsegv_bailout) = &__bailout; if (_setjmp (__bailout) == 0) { {
  if ((fbc = zend_hash_str_find_ptr(func_table, func_name, func_name_len))) {
   ...
   phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "list", "type=\"nofunction\" function=\"%s\"", "Function %s not found", func_name);
  }
 } } else { (phpdbg_globals.sigsegv_bailout) = __orig_bailout; {
  phpdbg_print(P_ERROR , (phpdbg_globals.io)[1].fd, "signalsegv", "function=\"%s\"", "Could not list function %s, invalid data source", func_name);
...
zend_op_array *phpdbg_compile_file(zend_file_handle *file, int type) {
 ...
 if (zend_stream_fixup(file, &bufptr, &data.len) == FAILURE) {
  return (phpdbg_globals.compile_file)(file, type);
 }

 data.buf = (__builtin_constant_p((data.len + 32 + 1) ) ? (((data.len + 32 + 1) <= 8) ? _emalloc_8() : (((data.len + 32 + 1) <= 16) ? _emalloc_16() : (((data.len + 32 + 1) <= 24) ? _emalloc_24() : (((data.len + 32 + 1) <= 32) ? _emalloc_32() : (((data.len + 32 + 1) <= 40) ? _emalloc_40() : (((data.len + 32 + 1) <= 48) ? _emalloc_48() : (((data.len + 32 + 1) <= 56) ? _emalloc_56() : (((data.len + 32 + 1) <= 64) ? _emalloc_64() : (((data.len + 32 + 1) <= 80) ? _emalloc_80() : (((data.len + 32 + 1) <= 96) ? _emalloc_96() : (((data.len + 32 + 1) <= 112) ? _emalloc_112() : (((data.len + 32 + 1) <= 128) ? _emalloc_128() : (((data.len + 32 + 1) <= 160) ? _emalloc_160() : (((data.len + 32 + 1) <= 192) ? _emalloc_192() : (((data.len + 32 + 1) <= 224) ? _emalloc_224() : (((data.len + 32 + 1) <= 256) ? _emalloc_256() : (((data.len + 32 + 1) <= 320) ? _emalloc_320() : (((data.len + 32 + 1) <= 384) ? _emalloc_384() : (((data.len + 32 + 1) <= 448) ? _emalloc_448() : (((data.len + 32 + 1) <= 512) ? _emalloc_512() : (((data.len + 32 + 1) <= 640) ? _emalloc_640() : (((data.len + 32 + 1) <= 768) ? _emalloc_768() : (((data.len + 32 + 1) <= 896) ? _emalloc_896() : (((data.len + 32 + 1) <= 1024) ? _emalloc_1024() : (((data.len + 32 + 1) <= 1280) ? _emalloc_1280() : (((data.len + 32 + 1) <= 1536) ? _emalloc_1536() : (((data.len + 32 + 1) <= 1792) ? _emalloc_1792() : (((data.len + 32 + 1) <= 2048) ? _emalloc_2048() : (((data.len + 32 + 1) <= 2560) ? _emalloc_2560() : (((data.len + 32 + 1) <= 3072) ? _emalloc_3072() : (((data.len + 32 + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((data.len + 32 + 1)) : _emalloc_huge((data.len + 32 + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((data.len + 32 + 1) ) );
 if (data.len > 0) {
  memcpy(data.buf, bufptr, data.len);
 }
 memset(data.buf + data.len, 0, 32 + 1);
 ...
 *(dataptr = (__builtin_constant_p((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) ) ? (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_file_source) + sizeof(uint) * data.len)) : _emalloc_huge((sizeof(phpdbg_file_source) + sizeof(uint) * data.len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_file_source) + sizeof(uint) * data.len) ) )) = data;
 if (tsrm_realpath(filename, resolved_path_buf)) {
 ...
 ret = (phpdbg_globals.compile_file)(&fake, type);

 if (ret == ((void *)0)) {
  _efree((data.buf) );
  _efree((dataptr) );

  fake.opened_path = ((void *)0);
  zend_file_handle_dtor(&fake);

  return ((void *)0);
 }

 dataptr = _erealloc((dataptr), (sizeof(phpdbg_file_source) + sizeof(uint) * line) );
 zend_hash_str_add_ptr(&(phpdbg_globals.file_sources), filename, strlen(filename), dataptr);
...
zend_op_array *phpdbg_init_compile_file(zend_file_handle *file, int type) {
 ...
 op_array = (phpdbg_globals.init_compile_file)(file, type);

 if (op_array == ((void *)0)) {
  return ((void *)0);
 }

 dataptr = zend_hash_str_find_ptr(&(phpdbg_globals.file_sources), filename, strlen(filename));
 do { if (__builtin_expect(!(dataptr != ((void *)0)), 0)) __builtin_unreachable(); } while (0);
...
zend_op_array *phpdbg_compile_string(zval *source_string, char *filename) {
 ...
 if ((phpdbg_globals.flags) & (1ULL<<12)) {
  return (phpdbg_globals.compile_string)(source_string, filename);
 }

 dataptr = (__builtin_constant_p((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) ) ? (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 8) ? _emalloc_8() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 16) ? _emalloc_16() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 24) ? _emalloc_24() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 32) ? _emalloc_32() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 40) ? _emalloc_40() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 48) ? _emalloc_48() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 56) ? _emalloc_56() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 64) ? _emalloc_64() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 80) ? _emalloc_80() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 96) ? _emalloc_96() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 112) ? _emalloc_112() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 128) ? _emalloc_128() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 160) ? _emalloc_160() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 192) ? _emalloc_192() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 224) ? _emalloc_224() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 256) ? _emalloc_256() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 320) ? _emalloc_320() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 384) ? _emalloc_384() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 448) ? _emalloc_448() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 512) ? _emalloc_512() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 640) ? _emalloc_640() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 768) ? _emalloc_768() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 896) ? _emalloc_896() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 1024) ? _emalloc_1024() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 1280) ? _emalloc_1280() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 1536) ? _emalloc_1536() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 1792) ? _emalloc_1792() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 2048) ? _emalloc_2048() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 2560) ? _emalloc_2560() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= 3072) ? _emalloc_3072() : (((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len)) : _emalloc_huge((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((sizeof(phpdbg_file_source) + sizeof(uint) * ((*(source_string)).value.str)->len) ) );
 dataptr->buf = _estrndup((((*(source_string)).value.str)->val), (((*(source_string)).value.str)->len) );
 dataptr->len = ((*(source_string)).value.str)->len;
 dataptr->line[0] = 0;
 ...
 op_array = (phpdbg_globals.compile_string)(source_string, filename);
 ...
 dataptr = _erealloc((dataptr), (sizeof(phpdbg_file_source) + sizeof(uint) * line) );
 zend_hash_add_ptr(&(phpdbg_globals.file_sources), fake_name, dataptr);

 dataptr->filename = _estrndup(((fake_name)->val), ((fake_name)->len) );
...
void phpdbg_free_file_source(zval *zv) {
 phpdbg_file_source *data = (*(zv)).value.ptr;
...
void phpdbg_init_list(void) {
 (phpdbg_globals.compile_file) = zend_compile_file;
 (phpdbg_globals.compile_string) = zend_compile_string;
 _zend_hash_init((&(phpdbg_globals.file_sources)), (1), ((dtor_func_t) phpdbg_free_file_source), (0) );
 zend_compile_file = phpdbg_compile_file;
 zend_compile_string = phpdbg_compile_string;
}

void phpdbg_list_update(void) {
 (phpdbg_globals.init_compile_file) = zend_compile_file;
