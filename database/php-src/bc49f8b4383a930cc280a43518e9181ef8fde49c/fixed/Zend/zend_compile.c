...
__attribute__ ((visibility("default"))) void zend_initialize_class_data(zend_class_entry *ce, zend_bool nullify_handlers)
{
 ...
 if (ce->type == 1) {
# 1750 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
...
# 1872 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
 if (len == 0) {
 ...
 if (end < path) {
# 1904 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_compile.c"
  path[0] = '.';
  path[1] = '\0';
  return 1 + len_adjust;
...
void zend_compile_static_call(znode *result, zend_ast *ast, uint32_t type)
{
 ...
 if (opline->op2_type == (1<<0)) {
  ...
  } else if (opline->op1_type == (1<<3) && (opline->op1.num & 1)
    && zend_is_scope_known()) {
   ce = (compiler_globals.active_class_entry);
  }
  if (ce) {
