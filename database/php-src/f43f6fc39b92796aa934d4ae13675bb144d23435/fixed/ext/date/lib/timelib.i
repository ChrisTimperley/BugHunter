# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.c"
...
# 2526 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h"
...
# 2527 "/home/ct584/git/bughunter/repositories/php-src/main/php_config.h" 2
...
# 116 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h"
...
# 117 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib_structs.h" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.c" 2
# 39 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/timelib.c"
timelib_time* timelib_time_ctor(void)
{
 timelib_time *t;
...
void timelib_time_tz_abbr_update(timelib_time* tm, char* tz_abbr)
{
 ...
 if (tm->tz_abbr) { free(tm->tz_abbr); tm->tz_abbr = ((void *)0); };
...
void timelib_time_dtor(timelib_time* t)
{
 if (t->tz_abbr) { free(t->tz_abbr); t->tz_abbr = ((void *)0); };
 if (t) { free(t); t = ((void *)0); };
}
...
void timelib_time_offset_dtor(timelib_time_offset* t)
{
 if (t->abbr) { free(t->abbr); t->abbr = ((void *)0); };
 if (t) { free(t); t = ((void *)0); };
}
...
void timelib_tzinfo_dtor(timelib_tzinfo *tz)
{
 if (tz->name) { free(tz->name); tz->name = ((void *)0); };
 if (tz->trans) { free(tz->trans); tz->trans = ((void *)0); };
 if (tz->trans_idx) { free(tz->trans_idx); tz->trans_idx = ((void *)0); };
 if (tz->type) { free(tz->type); tz->type = ((void *)0); };
 if (tz->timezone_abbr) { free(tz->timezone_abbr); tz->timezone_abbr = ((void *)0); };
 if (tz->leap_times) { free(tz->leap_times); tz->leap_times = ((void *)0); };
 if (tz->location.comments) { free(tz->location.comments); tz->location.comments = ((void *)0); };
 if (tz) { free(tz); tz = ((void *)0); };
 tz = ((void *)0);
}
...
timelib_long timelib_date_to_int(timelib_time *d, int *error)
{
 ...
 if (ts < (-9223372036854775807L -1) || ts > (9223372036854775807L)) {
  if (error) {
   *error = 1;
  }
  return 0;
...
void timelib_dump_date(timelib_time *d, int options)
{
 ...
 printf("TS: %lld | %s%04lld-%02lld-%02lld %02lld:%02lld:%02lld",
  d->sse, d->y < 0 ? "-" : "", (d->y < 0 ? (d->y * -1) : d->y), d->m, d->d, d->h, d->i, d->s);
 if (d->f > +0.0) {
  printf(" %.5f", d->f);
 }
