# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/tm2unixtime.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/tm2unixtime.c"
# 25 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/tm2unixtime.c"
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/ext/date/lib/tm2unixtime.c" 2
...
{
 if (time->s != -99999) do_range_limit(0, 60, 60, &time->s, &time->i);
 if (time->s != -99999) do_range_limit(0, 60, 60, &time->i, &time->h);
 if (time->s != -99999) do_range_limit(0, 24, 24, &time->h, &time->d);
