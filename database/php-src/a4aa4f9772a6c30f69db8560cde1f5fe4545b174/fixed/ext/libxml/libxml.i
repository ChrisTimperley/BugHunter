...
# 37 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/php_libxml.h"
...
# 38 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/php_libxml.h" 2
...
# 87 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
...
static const zend_arg_info arginfo_libxml_set_streams_context[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "context", sizeof("context")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_libxml_use_internal_errors[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "use_errors", sizeof("use_errors")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_libxml_get_last_error[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_libxml_get_errors[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_libxml_clear_errors[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_libxml_disable_entity_loader[] = { { ((void *)0), 0, ((void *)0), 0, 0, 0, 0, 0 },
 { "disable", sizeof("disable")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_libxml_set_external_entity_loader[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "resolver_function", sizeof("resolver_function")-1, ((void *)0), 0, 0, 0, 0, 0 },
};
...
static void *php_libxml_streams_IO_open_wrapper(const char *filename, const char *mode, const int read_only)
{
 ...
 if (uri && (uri->scheme == ((void *)0) ||
  ...
  isescaped = 1;
# 324 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
 } else {
...
# 609 "/home/ct584/git/bughunter/repositories/php-src/ext/libxml/libxml.c"
 ...
 if (retval != SUCCESS || fci->retval_ptr_ptr == ((void *)0)) {
...
__attribute__ ((visibility("default"))) void php_libxml_initialize(void)
{
 if (!_php_libxml_initialized) {
  ...
  _zend_hash_init((&php_libxml_exports), (0), (((void *)0)), (1) );
...
static int zm_startup_libxml(int type, int module_number )
{
 ...
 zend_register_long_constant(("LIBXML_VERSION"), sizeof("LIBXML_VERSION"), (20901), ((1<<0) | (1<<1)), module_number );
 zend_register_string_constant(("LIBXML_DOTTED_VERSION"), sizeof("LIBXML_DOTTED_VERSION"), ("2.9.1"), ((1<<0) | (1<<1)), module_number );
 ...
 zend_register_long_constant(("LIBXML_SCHEMA_CREATE"), sizeof("LIBXML_SCHEMA_CREATE"), (XML_SCHEMA_VAL_VC_I_CREATE), ((1<<0) | (1<<1)), module_number );




 zend_register_long_constant(("LIBXML_HTML_NOIMPLIED"), sizeof("LIBXML_HTML_NOIMPLIED"), (HTML_PARSE_NOIMPLIED), ((1<<0) | (1<<1)), module_number );



 zend_register_long_constant(("LIBXML_HTML_NODEFDTD"), sizeof("LIBXML_HTML_NODEFDTD"), (HTML_PARSE_NODEFDTD), ((1<<0) | (1<<1)), module_number );
...
static void zif_libxml_set_streams_context(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "r", &arg) == FAILURE) {
  return;
 }
 if ((libxml_globals.stream_context)) {
...
static void zif_libxml_use_internal_errors(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "|b", &use_errors) == FAILURE) {
  return;
 }
...
static void zif_libxml_disable_entity_loader(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "|b", &disable) == FAILURE) {
  return;
 }

 { do { zval *__z = (return_value); (*__z).value.lval = ((php_libxml_disable_entity_loader(disable )) != 0); (*__z).type = 3; } while (0); return; };
}
