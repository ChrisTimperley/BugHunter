...
# 302 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
void zim_exception___wakeup(zend_execute_data *execute_data, zval *return_value)
{
 ...
 pvalue = zend_read_property(i_get_exception_base(object), (object), "message", sizeof("message") - 1, 1, &value); if (zval_get_type(&(*(pvalue))) != 1 && zval_get_type(&(*(pvalue))) != 6) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("message", sizeof("message") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 pvalue = zend_read_property(i_get_exception_base(object), (object), "string", sizeof("string") - 1, 1, &value); if (zval_get_type(&(*(pvalue))) != 1 && zval_get_type(&(*(pvalue))) != 6) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("string", sizeof("string") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 pvalue = zend_read_property(i_get_exception_base(object), (object), "code", sizeof("code") - 1, 1, &value); if (zval_get_type(&(*(pvalue))) != 1 && zval_get_type(&(*(pvalue))) != 4) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("code", sizeof("code") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 pvalue = zend_read_property(i_get_exception_base(object), (object), "file", sizeof("file") - 1, 1, &value); if (zval_get_type(&(*(pvalue))) != 1 && zval_get_type(&(*(pvalue))) != 6) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("file", sizeof("file") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 pvalue = zend_read_property(i_get_exception_base(object), (object), "line", sizeof("line") - 1, 1, &value); if (zval_get_type(&(*(pvalue))) != 1 && zval_get_type(&(*(pvalue))) != 4) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("line", sizeof("line") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 pvalue = zend_read_property(i_get_exception_base(object), (object), "trace", sizeof("trace") - 1, 1, &value); if (zval_get_type(&(*(pvalue))) != 1 && zval_get_type(&(*(pvalue))) != 7) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("trace", sizeof("trace") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
...
# 376 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
...
# 463 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
...
# 812 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
