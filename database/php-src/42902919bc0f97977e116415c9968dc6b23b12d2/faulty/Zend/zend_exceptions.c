# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
...
# 25 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 26 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 27 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 28 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 29 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 30 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 31 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2
...
# 32 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c" 2

__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_throwable;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_exception;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_error_exception;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_error;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_parse_error;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_type_error;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_arithmetic_error;
__attribute__ ((visibility("default"))) zend_class_entry *zend_ce_division_by_zero_error;
...
static int zend_implement_throwable(zend_class_entry *interface, zend_class_entry *class_type)
{
 ...
 zend_error_noreturn((1<<0L), "Class %s cannot implement interface %s, extend %s or %s instead",
  (class_type->name)->val,
  (interface->name)->val,
  (zend_ce_exception->name)->val,
  (zend_ce_error->name)->val);
 return FAILURE;
}
...
{
 return instanceof_function(((*(object)).value.obj->ce), zend_ce_exception) ? zend_ce_exception : zend_ce_error;
}
...
void zend_exception_set_previous(zend_object *exception, zend_object *add_previous)
{
 ...
 do { zval *__z = (&pv); (*(__z)).value.obj = (add_previous); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
 if (!instanceof_function(((pv).value.obj->ce), zend_ce_throwable)) {
  zend_error_noreturn((1<<4L), "Previous exception must implement Throwable");
  return;
 }
 ...
 do {
  ...
  while (zval_get_type(&(*(ancestor))) == 8) {
   if ((*(ancestor)).value.obj == (*(ex)).value.obj) {
    zend_object_release(add_previous);
    return;
   }
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_throw_exception_internal(zval *exception)
{
# 144 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
 if (exception != ((void *)0)) {
 ...
 if (!(executor_globals.current_execute_data)) {
  if (exception && ((*(exception)).value.obj->ce) == zend_ce_parse_error) {
   return;
  }
  if((executor_globals.exception)) {
   zend_exception_error((executor_globals.exception), (1<<0L));
  }
  zend_error_noreturn((1<<4L), "Exception thrown without a stack frame");
 }
 ...
 if (!(executor_globals.current_execute_data)->func ||
     !(((executor_globals.current_execute_data)->func->common.type & 1) == 0) ||
     (executor_globals.current_execute_data)->opline->opcode == 149) {
...
__attribute__ ((visibility("default"))) void zend_clear_exception(void)
{
 ...
 zend_object_release((executor_globals.exception));
 (executor_globals.exception) = ((void *)0);
...
static zend_object *zend_default_exception_new_ex(zend_class_entry *class_type, int skip_top_traces)
{
 ...
 if (__builtin_expect(!!(class_type != zend_ce_parse_error || !(filename = zend_get_compiled_filename())), 1)) {
...
__attribute__((cold)) void zim_exception___clone(zend_execute_data *execute_data, zval *return_value)
{
...
void zim_exception___construct(zend_execute_data *execute_data, zval *return_value)
{
 ...
 if (zend_parse_parameters_ex((1<<1), argc, "|SlO!", &message, &code, &previous, zend_ce_throwable) == FAILURE) {
  zend_class_entry *ce;
  ...
  zend_throw_error(((void *)0), "Wrong parameters for %s([string $message [, long $code [, Throwable $previous = NULL]]])", (ce->name)->val);
  return;
 }
...
# 303 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
void zim_exception___wakeup(zend_execute_data *execute_data, zval *return_value)
{
 zval value, *pvalue;
 zval *object = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "message", sizeof("message") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 6) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("message", sizeof("message") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "string", sizeof("string") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 6) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("string", sizeof("string") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "code", sizeof("code") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 4) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("code", sizeof("code") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "file", sizeof("file") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 6) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("file", sizeof("file") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "line", sizeof("line") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 4) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("line", sizeof("line") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "trace", sizeof("trace") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 7) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("trace", sizeof("trace") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
 do { (*(&value)).u1.type_info = 0; } while (0); pvalue = zend_read_property(i_get_exception_base(object), (object), "previous", sizeof("previous") - 1, 1, &value); if(zval_get_type(&(*(pvalue))) != 0 && zval_get_type(&(*(pvalue))) != 8) { zval tmp; do { do { zval *__z = (&tmp); zend_string *__s = (zend_string_init("previous", sizeof("previous") - 1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0); ((*(object))).value.obj->handlers->unset_property(object, &tmp, ((void *)0)); _zval_ptr_dtor((&tmp) ); };
}




void zim_error_exception___construct(zend_execute_data *execute_data, zval *return_value)
{
 char *message = ((void *)0), *filename = ((void *)0);
 zend_long code = 0, severity = (1<<0L), lineno;
 zval *object, *previous = ((void *)0);
 int argc = (execute_data)->This.u2.num_args;
 size_t message_len, filename_len;

 if (zend_parse_parameters_ex((1<<1), argc, "|sllslO!", &message, &message_len, &code, &severity, &filename, &filename_len, &lineno, &previous, zend_ce_throwable) == FAILURE) {
  zend_class_entry *ce;
  ...
  zend_throw_error(((void *)0), "Wrong parameters for %s([string $message [, long $code, [ long $severity, [ string $filename, [ long $lineno  [, Throwable $previous = NULL]]]]]])", (ce->name)->val);
  return;
 }
...
# 377 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
void zim_exception_getFile(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "file", sizeof("file") - 1, 0, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_exception_getLine(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "line", sizeof("line") - 1, 0, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_exception_getMessage(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "message", sizeof("message") - 1, 0, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_exception_getCode(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "code", sizeof("code") - 1, 0, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_exception_getTrace(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "trace", sizeof("trace") - 1, 0, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}




void zim_error_exception_getSeverity(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "severity", sizeof("severity") - 1, 0, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}
# 464 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
...
static void _build_trace_args(zval *arg, smart_str *str)
{
 ...
 switch (zval_get_type(&(*(arg)))) {
  ...
  case 6:
   ...
   smart_str_append_escaped(str, ((*(arg)).value.str)->val, (((((*(arg)).value.str)->len)<(15))?(((*(arg)).value.str)->len):(15)));
  ...
  case 3:
   ...
   break;
  case 9:
   smart_str_appendl_ex(((str)), (("Resource id #")), (strlen("Resource id #")), 0);
   smart_str_append_long_ex((str), ((*arg).value.res->handle), 0);
   smart_str_appendl_ex(((str)), ((", ")), (strlen(", ")), 0);
   break;
  case 4:
   smart_str_append_long_ex((str), ((*(arg)).value.lval), 0);
   smart_str_appendl_ex(((str)), ((", ")), (strlen(", ")), 0);
   break;
  case 5: {
   double dval = (*(arg)).value.dval;
   char *s_tmp = (__builtin_constant_p((32 + (executor_globals.precision) + 1) ) ? (((32 + (executor_globals.precision) + 1) <= 8) ? _emalloc_8() : (((32 + (executor_globals.precision) + 1) <= 16) ? _emalloc_16() : (((32 + (executor_globals.precision) + 1) <= 24) ? _emalloc_24() : (((32 + (executor_globals.precision) + 1) <= 32) ? _emalloc_32() : (((32 + (executor_globals.precision) + 1) <= 40) ? _emalloc_40() : (((32 + (executor_globals.precision) + 1) <= 48) ? _emalloc_48() : (((32 + (executor_globals.precision) + 1) <= 56) ? _emalloc_56() : (((32 + (executor_globals.precision) + 1) <= 64) ? _emalloc_64() : (((32 + (executor_globals.precision) + 1) <= 80) ? _emalloc_80() : (((32 + (executor_globals.precision) + 1) <= 96) ? _emalloc_96() : (((32 + (executor_globals.precision) + 1) <= 112) ? _emalloc_112() : (((32 + (executor_globals.precision) + 1) <= 128) ? _emalloc_128() : (((32 + (executor_globals.precision) + 1) <= 160) ? _emalloc_160() : (((32 + (executor_globals.precision) + 1) <= 192) ? _emalloc_192() : (((32 + (executor_globals.precision) + 1) <= 224) ? _emalloc_224() : (((32 + (executor_globals.precision) + 1) <= 256) ? _emalloc_256() : (((32 + (executor_globals.precision) + 1) <= 320) ? _emalloc_320() : (((32 + (executor_globals.precision) + 1) <= 384) ? _emalloc_384() : (((32 + (executor_globals.precision) + 1) <= 448) ? _emalloc_448() : (((32 + (executor_globals.precision) + 1) <= 512) ? _emalloc_512() : (((32 + (executor_globals.precision) + 1) <= 640) ? _emalloc_640() : (((32 + (executor_globals.precision) + 1) <= 768) ? _emalloc_768() : (((32 + (executor_globals.precision) + 1) <= 896) ? _emalloc_896() : (((32 + (executor_globals.precision) + 1) <= 1024) ? _emalloc_1024() : (((32 + (executor_globals.precision) + 1) <= 1280) ? _emalloc_1280() : (((32 + (executor_globals.precision) + 1) <= 1536) ? _emalloc_1536() : (((32 + (executor_globals.precision) + 1) <= 1792) ? _emalloc_1792() : (((32 + (executor_globals.precision) + 1) <= 2048) ? _emalloc_2048() : (((32 + (executor_globals.precision) + 1) <= 2560) ? _emalloc_2560() : (((32 + (executor_globals.precision) + 1) <= 3072) ? _emalloc_3072() : (((32 + (executor_globals.precision) + 1) <= ((2 * 1024 * 1024) - ((4 * 1024) * (1)))) ? _emalloc_large((32 + (executor_globals.precision) + 1)) : _emalloc_huge((32 + (executor_globals.precision) + 1))) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) ) : _emalloc((32 + (executor_globals.precision) + 1) ) );
   int l_tmp = sprintf(s_tmp, "%.*G", (int) (executor_globals.precision), dval);
   smart_str_appendl_ex((str), (s_tmp), (l_tmp), 0);
   smart_str_appendl_ex(((str)), ((", ")), (strlen(", ")), 0);
   _efree((s_tmp) );
   break;
  }
  case 7:
   ...
   break;
  case 8: {
   zend_string *class_name = ((*(arg))).value.obj->handlers->get_class_name((*(arg)).value.obj);
   smart_str_appendl_ex(((str)), (("Object(")), (strlen("Object(")), 0);
   smart_str_appendl_ex(((str)), (((class_name)->val)), (strlen((class_name)->val)), 0);
   smart_str_appendl_ex(((str)), (("), ")), (strlen("), ")), 0);
   break;
  }
 }
...
static void _build_trace_string(smart_str *str, HashTable *ht, uint32_t num)
{
 ...
 smart_str_appendc_ex((str), ('#'), 0);
 smart_str_append_long_ex((str), (num), 0);
 smart_str_appendc_ex((str), (' '), 0);
 ...
 if (file) {
  if (zval_get_type(&(*(file))) != 6) {
   ...
   smart_str_appendl_ex(((str)), (("[unknown function]")), (strlen("[unknown function]")), 0);
  } else{
   zend_long line;
   ...
   smart_str_append_ex((str), ((*(file)).value.str), 0);
   smart_str_appendc_ex((str), ('('), 0);
   smart_str_append_long_ex((str), (line), 0);
   smart_str_appendl_ex(((str)), (("): ")), (strlen("): ")), 0);
  }
 } else {
  smart_str_appendl_ex(((str)), (("[internal function]: ")), (strlen("[internal function]: ")), 0);
 }
 do { tmp = zend_hash_str_find(ht, "class", sizeof("class")-1); if (tmp) { if (zval_get_type(&(*(tmp))) != 6) { zend_error((1<<1L), "Value for %s is no string", "class"); smart_str_appendl_ex(((str)), (("[unknown]")), (strlen("[unknown]")), 0); } else { smart_str_appendl_ex(((str)), ((((*(tmp)).value.str)->val)), (strlen(((*(tmp)).value.str)->val)), 0); } } } while (0);
 do { tmp = zend_hash_str_find(ht, "type", sizeof("type")-1); if (tmp) { if (zval_get_type(&(*(tmp))) != 6) { zend_error((1<<1L), "Value for %s is no string", "type"); smart_str_appendl_ex(((str)), (("[unknown]")), (strlen("[unknown]")), 0); } else { smart_str_appendl_ex(((str)), ((((*(tmp)).value.str)->val)), (strlen(((*(tmp)).value.str)->val)), 0); } } } while (0);
 do { tmp = zend_hash_str_find(ht, "function", sizeof("function")-1); if (tmp) { if (zval_get_type(&(*(tmp))) != 6) { zend_error((1<<1L), "Value for %s is no string", "function"); smart_str_appendl_ex(((str)), (("[unknown]")), (strlen("[unknown]")), 0); } else { smart_str_appendl_ex(((str)), ((((*(tmp)).value.str)->val)), (strlen(((*(tmp)).value.str)->val)), 0); } } } while (0);
 smart_str_appendc_ex((str), ('('), 0);
 ...
 if (tmp) {
  if (zval_get_type(&(*(tmp))) == 7) {
   ...
   do { Bucket *_p = ((*(tmp)).value.arr)->arData; Bucket *_end = _p + ((*(tmp)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; arg = _z; {
...
void zim_exception_getTraceAsString(zend_execute_data *execute_data, zval *return_value)
{
 zval *trace, *frame, rv;
 zend_ulong index;
 zval *object;
 ...
 if (zval_get_type(&(*(trace))) != 7) {
  { do { (*(return_value)).u1.type_info = 2; } while (0); return; };
 }
 do { Bucket *_p = ((*(trace)).value.arr)->arData; Bucket *_end = _p + ((*(trace)).value.arr)->nNumUsed; for (; _p != _end; _p++) { zval *_z = &_p->val; if (0 && zval_get_type(&(*(_z))) == 15) { _z = (*(_z)).value.zv; } if (__builtin_expect(!!(zval_get_type(&(*(_z))) == 0), 0)) continue;; index = _p->h; frame = _z; {
  if (zval_get_type(&(*(frame))) != 7) {
   zend_error((1<<1L), "Expected array for frame %pu", index);
   continue;
  }

  _build_trace_string(&str, (*(frame)).value.arr, num++);
 } } } while (0);

 smart_str_appendc_ex((&str), ('#'), 0);
 smart_str_append_long_ex((&str), (num), 0);
 smart_str_appendl_ex(((&str)), ((" {main}")), (strlen(" {main}")), 0);
 smart_str_0(&str);
...
void zim_exception_getPrevious(zend_execute_data *execute_data, zval *return_value)
{
 zval rv;

 if ((__builtin_expect(!!((execute_data)->This.u2.num_args == 0), 1) ? SUCCESS : zend_parse_parameters((execute_data)->This.u2.num_args, "")) == FAILURE) { return; };

 do { zval *_z1 = (return_value); const zval *_z2 = (zend_read_property(i_get_exception_base(((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), (((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0))), "previous", sizeof("previous") - 1, 1, &rv)); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); if ((_t & ((1<<2) << 8)) != 0) { (_gc)->gc.refcount++; } } while (0);
}
...
void zim_exception___toString(zend_execute_data *execute_data, zval *return_value)
{
 ...
 exception = ((((execute_data)->This)).value.obj ? &((execute_data)->This) : ((void *)0));
 do { do { zval *__z = (&fname); zend_string *__s = (zend_string_init("gettraceasstring", sizeof("gettraceasstring")-1, 0)); (*(__z)).value.str = __s; (*(__z)).u1.type_info = (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); } while (0);

 while (exception && zval_get_type(&(*(exception))) == 8 && instanceof_function(((*(exception)).value.obj->ce), zend_ce_throwable)) {
  zend_string *prev_str = str;
  zend_string *message = _zval_get_string((zend_read_property(i_get_exception_base(exception), (exception), "message", sizeof("message") - 1, 0, &rv)));
  zend_string *file = _zval_get_string((zend_read_property(i_get_exception_base(exception), (exception), "file", sizeof("file") - 1, 0, &rv)));
  zend_long line = _zval_get_long((zend_read_property(i_get_exception_base(exception), (exception), "line", sizeof("line") - 1, 0, &rv)));

  fci.size = sizeof(fci);
  fci.function_table = &((*(exception)).value.obj->ce)->function_table;
  do { zval *_z1 = (&fci.function_name); const zval *_z2 = (&fname); zend_refcounted *_gc = (*(_z2)).value.counted; uint32_t _t = (*(_z2)).u1.type_info; do { (*(_z1)).value.counted = _gc; (*(_z1)).u1.type_info = _t; } while (0); } while (0);
  ...
  if (((*(exception)).value.obj->ce) == zend_ce_type_error && strstr((message)->val, ", called in ")) {
  ...
  if ((message)->len > 0) {
   str = zend_strpprintf(0, "%s: %s in %s:" "%" "l" "d"
     "\nStack trace:\n%s%s%s",
     (((*(exception)).value.obj->ce)->name)->val, (message)->val, (file)->val, line,
     (zval_get_type(&(trace)) == 6 && ((trace).value.str)->len) ? ((trace).value.str)->val : "#0 {main}\n",
     (prev_str)->len ? "\n\nNext " : "", (prev_str)->val);
  } else {
   str = zend_strpprintf(0, "%s in %s:" "%" "l" "d"
     "\nStack trace:\n%s%s%s",
     (((*(exception)).value.obj->ce)->name)->val, (file)->val, line,
     (zval_get_type(&(trace)) == 6 && ((trace).value.str)->len) ? ((trace).value.str)->val : "#0 {main}\n",
     (prev_str)->len ? "\n\nNext " : "", (prev_str)->val);
  }
  ...
  exception = zend_read_property(i_get_exception_base(exception), (exception), "previous", sizeof("previous") - 1, 0, &rv);
 }
 _zval_dtor((&fname) );
 ...
 { do { zval *__z = (return_value); zend_string *__s = (str); (*(__z)).value.str = __s; (*(__z)).u1.type_info = ((__s)->gc.u.v.flags & (1<<1)) ? 6 : (6 | (( (1<<2) | (1<<4)) << 8)); } while (0); return; };
}



const zend_function_entry zend_funcs_throwable[] = {
 { "getMessage", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getCode", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getFile", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getLine", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getTrace", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getPrevious", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "getTraceAsString", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { "__toString", ((void *)0), ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x02 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
# 813 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_exceptions.c"
static const zend_internal_arg_info arginfo_exception___construct[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "message", ((void *)0), 0, 0, 0, 0 },
 { "code", ((void *)0), 0, 0, 0, 0 },
 { "previous", ((void *)0), 0, 0, 0, 0 },
};

static const zend_function_entry default_exception_functions[] = {
 { "__clone", zim_exception___clone, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x400|0x04 },
 { "__construct", zim_exception___construct, arginfo_exception___construct, (uint32_t) (sizeof(arginfo_exception___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "__wakeup", zim_exception___wakeup, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getMessage", zim_exception_getMessage, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getCode", zim_exception_getCode, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getFile", zim_exception_getFile, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getLine", zim_exception_getLine, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getTrace", zim_exception_getTrace, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getPrevious", zim_exception_getPrevious, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "getTraceAsString", zim_exception_getTraceAsString, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { "__toString", zim_exception___toString, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};

static const zend_internal_arg_info arginfo_error_exception___construct[] = { { (const char*)(zend_uintptr_t)(0), ((void *)0), 0, 0, 0, 0 },
 { "message", ((void *)0), 0, 0, 0, 0 },
 { "code", ((void *)0), 0, 0, 0, 0 },
 { "severity", ((void *)0), 0, 0, 0, 0 },
 { "filename", ((void *)0), 0, 0, 0, 0 },
 { "lineno", ((void *)0), 0, 0, 0, 0 },
 { "previous", ((void *)0), 0, 0, 0, 0 },
};

static const zend_function_entry error_exception_functions[] = {
 { "__construct", zim_error_exception___construct, arginfo_error_exception___construct, (uint32_t) (sizeof(arginfo_error_exception___construct)/sizeof(struct _zend_internal_arg_info)-1), 0x100 },
 { "getSeverity", zim_error_exception_getSeverity, ((void *)0), (uint32_t) (sizeof(((void *)0))/sizeof(struct _zend_internal_arg_info)-1), 0x100|0x04 },
 { ((void *)0), ((void *)0), ((void *)0), 0, 0 }
};
...
void zend_register_default_exception(void)
{
 ...
 zend_declare_property_string(zend_ce_exception, "message", sizeof("message")-1, "", 0x200);
 zend_declare_property_string(zend_ce_exception, "string", sizeof("string")-1, "", 0x400);
 zend_declare_property_long(zend_ce_exception, "code", sizeof("code")-1, 0, 0x200);
 zend_declare_property_null(zend_ce_exception, "file", sizeof("file")-1, 0x200);
 zend_declare_property_null(zend_ce_exception, "line", sizeof("line")-1, 0x200);
 zend_declare_property_null(zend_ce_exception, "trace", sizeof("trace")-1, 0x400);
 zend_declare_property_null(zend_ce_exception, "previous", sizeof("previous")-1, 0x400);

 { zend_string *cl_name; cl_name = zend_string_init("ErrorException", sizeof("ErrorException")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = error_exception_functions; } };
 ...
 zend_declare_property_long(zend_ce_error_exception, "severity", sizeof("severity")-1, (1<<0L), 0x200);

 { zend_string *cl_name; cl_name = zend_string_init("Error", sizeof("Error")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = default_exception_functions; } };
 zend_ce_error = zend_register_internal_class_ex(&ce, ((void *)0));
 zend_ce_error->create_object = zend_default_exception_new;
 zend_class_implements(zend_ce_error, 1, zend_ce_throwable);

 zend_declare_property_string(zend_ce_error, "message", sizeof("message")-1, "", 0x200);
 zend_declare_property_string(zend_ce_error, "string", sizeof("string")-1, "", 0x400);
 zend_declare_property_long(zend_ce_error, "code", sizeof("code")-1, 0, 0x200);
 zend_declare_property_null(zend_ce_error, "file", sizeof("file")-1, 0x200);
 zend_declare_property_null(zend_ce_error, "line", sizeof("line")-1, 0x200);
 zend_declare_property_null(zend_ce_error, "trace", sizeof("trace")-1, 0x400);
 zend_declare_property_null(zend_ce_error, "previous", sizeof("previous")-1, 0x400);

 { zend_string *cl_name; cl_name = zend_string_init("ParseError", sizeof("ParseError")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = ((void *)0); } };
 ...
 { zend_string *cl_name; cl_name = zend_string_init("TypeError", sizeof("TypeError")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = ((void *)0); } };
 ...
 { zend_string *cl_name; cl_name = zend_string_init("ArithmeticError", sizeof("ArithmeticError")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = ((void *)0); } };
 zend_ce_arithmetic_error = zend_register_internal_class_ex(&ce, zend_ce_error);
 zend_ce_arithmetic_error->create_object = zend_default_exception_new;

 { zend_string *cl_name; cl_name = zend_string_init("DivisionByZeroError", sizeof("DivisionByZeroError")-1, 1); ce.name = zend_new_interned_string(cl_name); { ce.constructor = ((void *)0); ce.destructor = ((void *)0); ce.clone = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.create_object = ((void *)0); ce.interface_gets_implemented = ((void *)0); ce.get_static_method = ((void *)0); ce.__call = ((void *)0); ce.__callstatic = ((void *)0); ce.__tostring = ((void *)0); ce.__get = ((void *)0); ce.__set = ((void *)0); ce.__unset = ((void *)0); ce.__isset = ((void *)0); ce.__debugInfo = ((void *)0); ce.serialize_func = ((void *)0); ce.unserialize_func = ((void *)0); ce.serialize = ((void *)0); ce.unserialize = ((void *)0); ce.parent = ((void *)0); ce.num_interfaces = 0; ce.traits = ((void *)0); ce.num_traits = 0; ce.trait_aliases = ((void *)0); ce.trait_precedences = ((void *)0); ce.interfaces = ((void *)0); ce.get_iterator = ((void *)0); ce.iterator_funcs.funcs = ((void *)0); ce.info.internal.module = ((void *)0); ce.info.internal.builtin_functions = ((void *)0); } };
...
__attribute__ ((visibility("default"))) __attribute__((cold)) zend_object *zend_throw_exception(zend_class_entry *exception_ce, const char *message, zend_long code)
{
 ...
 if (exception_ce) {
  if (!instanceof_function(exception_ce, zend_ce_throwable)) {
   zend_error((1<<3L), "Exceptions must implement Throwable");
...
__attribute__ ((visibility("default"))) __attribute__((cold)) zend_object *zend_throw_error_exception(zend_class_entry *exception_ce, const char *message, zend_long code, int severity)
{
 zval ex;
 zend_object *obj = zend_throw_exception(exception_ce, message, code);
 do { zval *__z = (&ex); (*(__z)).value.obj = (obj); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_exception_error(zend_object *ex, int severity)
{
 zval exception, rv;
 zend_class_entry *ce_exception;

 do { zval *__z = (&exception); (*(__z)).value.obj = (ex); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);
 ce_exception = ((exception).value.obj->ce);
 (executor_globals.exception) = ((void *)0);
 if (ce_exception == zend_ce_parse_error) {
  zend_string *message = _zval_get_string((zend_read_property(i_get_exception_base(&exception), (&exception), "message", sizeof("message") - 1, 0, &rv)));
  zend_string *file = _zval_get_string((zend_read_property(i_get_exception_base(&exception), (&exception), "file", sizeof("file") - 1, 1, &rv)));
  zend_long line = _zval_get_long((zend_read_property(i_get_exception_base(&exception), (&exception), "line", sizeof("line") - 1, 1, &rv)));

  zend_error_helper((1<<2L), (file)->val, line, "%s", (message)->val);

  zend_string_release(file);
  zend_string_release(message);
 } else if (instanceof_function(ce_exception, zend_ce_throwable)) {
  zval tmp, rv;
  zend_string *str, *file = ((void *)0);
  zend_long line = 0;
  ...
  if ((executor_globals.exception)) {
   ...
   do { zval *__z = (&zv); (*(__z)).value.obj = ((executor_globals.exception)); (*(__z)).u1.type_info = (8 | (( (1<<2) | (1<<3) ) << 8)); } while (0);

   if (instanceof_function(ce_exception, zend_ce_exception) || instanceof_function(ce_exception, zend_ce_error)) {
    file = _zval_get_string((zend_read_property(i_get_exception_base(&zv), (&zv), "file", sizeof("file") - 1, 1, &rv)));
    line = _zval_get_long((zend_read_property(i_get_exception_base(&zv), (&zv), "line", sizeof("line") - 1, 1, &rv)));
   }

   zend_error_va((1<<1L), (file && (file)->len > 0) ? (file)->val : ((void *)0), line,
    "Uncaught %s in exception handling during call to %s::__tostring()",
    (((zv).value.obj->ce)->name)->val, (ce_exception->name)->val);
  ...
  str = _zval_get_string((zend_read_property(i_get_exception_base(&exception), (&exception), "string", sizeof("string") - 1, 1, &rv)));
  file = _zval_get_string((zend_read_property(i_get_exception_base(&exception), (&exception), "file", sizeof("file") - 1, 1, &rv)));
  line = _zval_get_long((zend_read_property(i_get_exception_base(&exception), (&exception), "line", sizeof("line") - 1, 1, &rv)));

  zend_error_va(severity, (file && (file)->len > 0) ? (file)->val : ((void *)0), line,
   "Uncaught %s\n  thrown", (str)->val);
...
__attribute__ ((visibility("default"))) __attribute__((cold)) void zend_throw_exception_object(zval *exception)
{
 ...
 if (exception == ((void *)0) || zval_get_type(&(*(exception))) != 8) {
  zend_error_noreturn((1<<4L), "Need to supply an object when throwing an exception");
 }

 exception_ce = ((*(exception)).value.obj->ce);

 if (!exception_ce || !instanceof_function(exception_ce, zend_ce_throwable)) {
  zend_throw_error(((void *)0), "Cannot throw objects that do not implement Throwable");
  return;
 }
