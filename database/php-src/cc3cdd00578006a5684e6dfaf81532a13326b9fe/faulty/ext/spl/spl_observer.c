...
static const zend_arg_info arginfo_SplObserver_update[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "SplSubject", sizeof("SplSubject")-1, "SplSubject", sizeof("SplSubject")-1, 5, 0, 0, 0 },
};;
...
static const zend_arg_info arginfo_SplSubject_attach[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "SplObserver", sizeof("SplObserver")-1, "SplObserver", sizeof("SplObserver")-1, 5, 0, 0, 0 },
};;

static const zend_arg_info arginfo_SplSubject_void[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};;
 ...
 if (intern->fptr_get_hash) {
  ...
  if (rv) {
   if ((*rv).type == 6) {
    ...
    strncpy(hash, (*rv).value.str.val, hash_len);
    hash[hash_len] = 0;
...
# 156 "/home/ct584/git/bughunter/repositories/php-src/ext/spl/spl_observer.c"
 ...
 *obj = intern;
 ...
 _zend_hash_init((&intern->storage), (0), ((void (*)(void *))spl_object_storage_dtor), (0) );
 ...
 *is_temp = 0;
 ...
 if (intern->debug_info == ((void *)0)) {
  ...
  _zend_hash_init((intern->debug_info), (zend_hash_num_elements(props) + 1), ((void (*)(void *)) _zval_ptr_dtor), (0) );
 }
...
static HashTable *spl_object_storage_get_gc(zval *obj, zval ***table, int *n )
{
 ...
 if (intern->storage.nNumOfElements * 2 > intern->gcdata_num) {
  ...
  intern->gcdata = (zval**)_erealloc((intern->gcdata), (sizeof(zval*) * intern->gcdata_num), 0 );
 }
...
static int spl_object_storage_compare_info(spl_SplObjectStorageElement *e1, spl_SplObjectStorageElement *e2 )
{
 ...
 if (compare_function(&result, e1->inf, e2->inf ) == FAILURE) {
  return 1;
 }
...
void zim_spl_SplObjectStorage_attach(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "o|z!", &obj, &inf) == FAILURE) {
  return;
 }
...
void zim_spl_SplObjectStorage_offsetGet(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (!element) {
  ...
  { do { zval *__z = (return_value); zval *__zv = (element->inf); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0); return; };
 }
}
...
void zim_spl_SplObjectStorage_addAll(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "O", &obj, spl_ce_SplObjectStorage) == FAILURE) {
  return;
 }
...
void zim_spl_SplObjectStorage_removeAll(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 while (zend_hash_get_current_data_ex(&other->storage, (void **)&element, ((void *)0)) == SUCCESS) {
  if (spl_object_storage_detach(intern, (this_ptr), element->obj ) == FAILURE) {
...
void zim_spl_SplObjectStorage_removeAllExcept(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 while (zend_hash_get_current_data_ex(&intern->storage, (void **)&element, ((void *)0)) == SUCCESS) {
...
void zim_spl_SplObjectStorage_valid(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 { do { zval *__z = (return_value); (*__z).value.lval = (((zend_hash_get_current_key_type_ex(&intern->storage, &intern->pos) == 3 ? FAILURE : SUCCESS) == SUCCESS) != 0); (*__z).type = 3; } while (0); return; };
}
...
void zim_spl_SplObjectStorage_current(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 do { zval *__z = (return_value); zval *__zv = (element->obj); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
}
...
void zim_spl_SplObjectStorage_getInfo(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 do { zval *__z = (return_value); zval *__zv = (element->inf); do { (__z)->value = (__zv)->value; (*__z).type = (*__zv).type; } while (0); if (1) { _zval_copy_ctor((__z) ); } if (0) { if (!1) { { (*__zv).type = 0; }; } _zval_ptr_dtor((&__zv) ); } } while (0);
}
...
void zim_spl_SplObjectStorage_setInfo(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "z", &inf) == FAILURE) {
  return;
 }
...
void zim_spl_SplObjectStorage_unserialize(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (!php_var_unserialize(&pmembers, &p, s + buf_len, &var_hash ) || (*pmembers).type != 4) {
...
static const zend_arg_info arginfo_Object[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;

static const zend_arg_info arginfo_attach[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
 { "inf", sizeof("inf")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;

static const zend_arg_info arginfo_Serialized[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "serialized", sizeof("serialized")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;

static const zend_arg_info arginfo_setInfo[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "info", sizeof("info")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;

static const zend_arg_info arginfo_getHash[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;

static const zend_arg_info arginfo_offsetGet[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "object", sizeof("object")-1, ((void *)0), 0, 0, 0, 0, 0 },
};

static const zend_arg_info arginfo_splobject_void[] = { { ((void *)0), 0, ((void *)0), -1, 0, 0, 0, 0 },
};
...
void zim_spl_MultipleIterator_attachIterator(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 if (zend_parse_parameters((ht) , "O|z!", &iterator, zend_ce_iterator, &info) == FAILURE) {
  return;
 }
...
void zim_spl_MultipleIterator_rewind(int ht, zval *return_value, zval **return_value_ptr, zval *this_ptr, int return_value_used )
{
 ...
 zend_hash_internal_pointer_reset_ex(&intern->storage, &intern->pos);
 while (zend_hash_get_current_data_ex(&intern->storage, (void**)&element, &intern->pos) == SUCCESS && !(executor_globals.exception)) {
  it = element->obj;
...
static const zend_arg_info arginfo_MultipleIterator_attachIterator[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "iterator", sizeof("iterator")-1, "Iterator", sizeof("Iterator")-1, 5, 0, 0, 0 },
 { "infos", sizeof("infos")-1, ((void *)0), 0, 0, 0, 0, 0 },
};;

static const zend_arg_info arginfo_MultipleIterator_detachIterator[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "iterator", sizeof("iterator")-1, "Iterator", sizeof("Iterator")-1, 5, 0, 0, 0 },
};;

static const zend_arg_info arginfo_MultipleIterator_containsIterator[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
 { "iterator", sizeof("iterator")-1, "Iterator", sizeof("Iterator")-1, 5, 0, 0, 0 },
};;

static const zend_arg_info arginfo_MultipleIterator_setflags[] = { { ((void *)0), 0, ((void *)0), 1, 0, 0, 0, 0 },
