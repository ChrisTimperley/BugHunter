# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c"
# 19 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c"
...
# 20 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c" 2
...
static int phar_zip_process_extra(php_stream *fp, phar_entry_info *entry, unsigned short len )
{
 union {
 ...
 do {
  if (sizeof(h.header) != _php_stream_read((fp), ((char *) &h.header), (sizeof(h.header)) )) {
   return FAILURE;
  }

  if (h.header.tag[0] != 'n' || h.header.tag[1] != 'u') {

   _php_stream_seek((fp), (((unsigned short)((((unsigned short)h.header.size[0]) & 0xff) | (((unsigned short)h.header.size[1]) & 0xff) << 8))), (1) );
   len -= ((unsigned short)((((unsigned short)h.header.size[0]) & 0xff) | (((unsigned short)h.header.size[1]) & 0xff) << 8)) + 4;
   continue;
  }


  read = _php_stream_read((fp), ((char *) &(h.unix3.crc32)), (sizeof(h.unix3) - sizeof(h.header)) );
  len -= read + 4;
  ...
  if (((unsigned short)((((unsigned short)h.unix3.size[0]) & 0xff) | (((unsigned short)h.unix3.size[1]) & 0xff) << 8)) > sizeof(h.unix3) - 4) {

   _php_stream_seek((fp), (((unsigned short)((((unsigned short)h.unix3.size[0]) & 0xff) | (((unsigned short)h.unix3.size[1]) & 0xff) << 8)) - sizeof(h.unix3.size)), (1) );
  }
  ...
  if (entry->is_dir) {
   entry->flags |= ((unsigned short)((((unsigned short)h.unix3.perms[0]) & 0xff) | (((unsigned short)h.unix3.perms[1]) & 0xff) << 8)) & 0x000001FF;
  } else {
   entry->flags |= ((unsigned short)((((unsigned short)h.unix3.perms[0]) & 0xff) | (((unsigned short)h.unix3.perms[1]) & 0xff) << 8)) & 0x000001FF;
  }
...
# 123 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c"
static time_t phar_zip_d2u_time(char *cdtime, char *cddate)
{
 int dtime = ((unsigned short)((((unsigned short)cdtime[0]) & 0xff) | (((unsigned short)cdtime[1]) & 0xff) << 8)), ddate = ((unsigned short)((((unsigned short)cddate[0]) & 0xff) | (((unsigned short)cddate[1]) & 0xff) << 8));
 struct tm *tm, tmbuf;
 time_t now;
...
static void phar_zip_u2d_time(time_t time, char *dtime, char *ddate)
{
 ...
 phar_write_16(dtime, (unsigned short) (ctime));;
 phar_write_16(ddate, (unsigned short) (cdate));;
}
# 166 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c"
int phar_parse_zipfile(php_stream *fp, char *fname, int fname_len, char *alias, int alias_len, phar_archive_data** pphar, char **error )
{
 ...
 char *p = buf, *ext, *actual_alias = ((void *)0);
 char *metadata = ((void *)0);

 size = _php_stream_tell((fp) );

 if (size > sizeof(locator) + 65536) {

  size = sizeof(locator) + 65536;
  if (FAILURE == _php_stream_seek((fp), (-size), (2) )) {
 ...
 if (!_php_stream_read((fp), (buf), (size) )) {
  _php_stream_free((fp), (1 | 2) );
  if (error) {
 ...
 while ((p=(char *) memchr(p + 1, 'P', (size_t) (size - (p + 1 - buf)))) != ((void *)0)) {
  if ((p - buf) + sizeof(locator) <= size && !memcmp(p + 1, "K\5\6", 3)) {
   memcpy((void *)&locator, (void *) p, sizeof(locator));
   if (((unsigned short)((((unsigned short)locator.centraldisk[0]) & 0xff) | (((unsigned short)locator.centraldisk[1]) & 0xff) << 8)) != 0 || ((unsigned short)((((unsigned short)locator.disknumber[0]) & 0xff) | (((unsigned short)locator.disknumber[1]) & 0xff) << 8)) != 0) {
   ...
   if (((unsigned short)((((unsigned short)locator.counthere[0]) & 0xff) | (((unsigned short)locator.counthere[1]) & 0xff) << 8)) != ((unsigned short)((((unsigned short)locator.count[0]) & 0xff) | (((unsigned short)locator.count[1]) & 0xff) << 8))) {
    if (error) {
   ...
   if (((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8))) {

    metadata = p + sizeof(locator);

    if (((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8)) != size - (metadata - buf)) {
     if (error) {
      spprintf(error, 4096, "phar error: corrupt zip archive, zip file comment truncated in zip-based phar \"%s\"", fname);
     }
     _php_stream_free((fp), (1 | 2) );
     ((mydata->is_persistent)?free(mydata):_efree((mydata) ));
     return FAILURE;
    }

    mydata->metadata_len = ((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8));

    if (phar_parse_metadata(&metadata, &mydata->metadata, ((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8)) ) == FAILURE) {
     mydata->metadata_len = 0;


     if (entry.is_persistent) {
      do { (mydata->metadata) = (zval*)malloc(sizeof(zval_gc_info)); ((zval_gc_info*)(mydata->metadata))->u.buffered = ((void *)0); } while (0);
     } else {
      do { (mydata->metadata) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(mydata->metadata))->u.buffered = ((void *)0); } while (0);
     }

     *mydata->metadata = zval_used_for_init;;
     metadata = ((mydata->is_persistent)?zend_strndup((metadata),(((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8)))):_estrndup(((metadata)), ((((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8)))) ));
     do { const char *__s=(metadata); int __l=((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8)); zval *__z = (mydata->metadata); (*__z).value.str.len = __l; (*__z).value.str.val = (0?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0);
    }
   } else {
    mydata->metadata = ((void *)0);
   }
...
foundit:
 ...
 _php_stream_seek((fp), (((php_uint32)((((php_uint32)locator.cdir_offset[0]) & 0xff) | (((php_uint32)locator.cdir_offset[1]) & 0xff) << 8 | (((php_uint32)locator.cdir_offset[2]) & 0xff) << 16 | (((php_uint32)locator.cdir_offset[3]) & 0xff) << 24))), (0) );

 _zend_hash_init((&mydata->manifest), (((unsigned short)((((unsigned short)locator.count[0]) & 0xff) | (((unsigned short)locator.count[1]) & 0xff) << 8))), (zend_get_hash_value), (destroy_phar_manifest_entry), ((zend_bool)mydata->is_persistent) )
                                                                                     ;
 _zend_hash_init((&mydata->mounted_dirs), (5), (zend_get_hash_value), (((void *)0)), ((zend_bool)mydata->is_persistent) )
                                                              ;
 _zend_hash_init((&mydata->virtual_dirs), (((unsigned short)((((unsigned short)locator.count[0]) & 0xff) | (((unsigned short)locator.count[1]) & 0xff) << 8)) * 2), (zend_get_hash_value), (((void *)0)), ((zend_bool)mydata->is_persistent) )
                                                              ;
 entry.phar = mydata;
 entry.is_zip = 1;
 entry.fp_type = PHAR_FP;
 entry.is_persistent = mydata->is_persistent;
# 351 "/home/ct584/git/bughunter/repositories/php-src/ext/phar/zip.c"
 for (i = 0; i < ((unsigned short)((((unsigned short)locator.count[0]) & 0xff) | (((unsigned short)locator.count[1]) & 0xff) << 8)); ++i) {
  phar_zip_central_dir_file zipentry;
  off_t beforeus = _php_stream_tell((fp) );

  if (sizeof(zipentry) != _php_stream_read((fp), ((char *) &zipentry), (sizeof(zipentry)) )) {
   zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unable to read central directory entry, truncated", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
  }


  if (memcmp("PK\1\2", zipentry.signature, 4)) {

   zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "corrupted central directory entry, no magic signature", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
  }
  ...
  entry.compressed_filesize = ((php_uint32)((((php_uint32)zipentry.compsize[0]) & 0xff) | (((php_uint32)zipentry.compsize[1]) & 0xff) << 8 | (((php_uint32)zipentry.compsize[2]) & 0xff) << 16 | (((php_uint32)zipentry.compsize[3]) & 0xff) << 24));
  entry.uncompressed_filesize = ((php_uint32)((((php_uint32)zipentry.uncompsize[0]) & 0xff) | (((php_uint32)zipentry.uncompsize[1]) & 0xff) << 8 | (((php_uint32)zipentry.uncompsize[2]) & 0xff) << 16 | (((php_uint32)zipentry.uncompsize[3]) & 0xff) << 24));
  entry.crc32 = ((php_uint32)((((php_uint32)zipentry.crc32[0]) & 0xff) | (((php_uint32)zipentry.crc32[1]) & 0xff) << 8 | (((php_uint32)zipentry.crc32[2]) & 0xff) << 16 | (((php_uint32)zipentry.crc32[3]) & 0xff) << 24));

  entry.timestamp = phar_zip_d2u_time(zipentry.timestamp, zipentry.datestamp);
  entry.flags = 0x000001B6;
  entry.header_offset = ((php_uint32)((((php_uint32)zipentry.offset[0]) & 0xff) | (((php_uint32)zipentry.offset[1]) & 0xff) << 8 | (((php_uint32)zipentry.offset[2]) & 0xff) << 16 | (((php_uint32)zipentry.offset[3]) & 0xff) << 24));
  entry.offset = entry.offset_abs = ((php_uint32)((((php_uint32)zipentry.offset[0]) & 0xff) | (((php_uint32)zipentry.offset[1]) & 0xff) << 8 | (((php_uint32)zipentry.offset[2]) & 0xff) << 16 | (((php_uint32)zipentry.offset[3]) & 0xff) << 24)) + sizeof(phar_zip_file_header) + ((unsigned short)((((unsigned short)zipentry.filename_len[0]) & 0xff) | (((unsigned short)zipentry.filename_len[1]) & 0xff) << 8)) +
   ((unsigned short)((((unsigned short)zipentry.extra_len[0]) & 0xff) | (((unsigned short)zipentry.extra_len[1]) & 0xff) << 8));

  if (((unsigned short)((((unsigned short)zipentry.flags[0]) & 0xff) | (((unsigned short)zipentry.flags[1]) & 0xff) << 8)) & 0x0001) {
   zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "Cannot process encrypted zip files", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
  }

  if (!((unsigned short)((((unsigned short)zipentry.filename_len[0]) & 0xff) | (((unsigned short)zipentry.filename_len[1]) & 0xff) << 8))) {
   zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "Cannot process zips created from stdin (zero-length filename)", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
  }

  entry.filename_len = ((unsigned short)((((unsigned short)zipentry.filename_len[0]) & 0xff) | (((unsigned short)zipentry.filename_len[1]) & 0xff) << 8));
  entry.filename = (char *) ((entry.is_persistent)?__zend_malloc(entry.filename_len + 1):_emalloc((entry.filename_len + 1) ));

  if (entry.filename_len != _php_stream_read((fp), (entry.filename), (entry.filename_len) )) {
   ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
   zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unable to read in filename from central directory, truncated", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
  }
  ...
  if (entry.filename_len == sizeof(".phar/signature.bin")-1 && !strncmp(entry.filename, ".phar/signature.bin", sizeof(".phar/signature.bin")-1)) {
   ...
   now = _php_stream_tell((fp) );
   ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
   sigfile = _php_stream_fopen_tmpfile(0 );
   if (!sigfile) {
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "couldn't open temporary file", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }

   _php_stream_seek((fp), (0), (0) );

   _php_stream_copy_to_stream_ex((fp), (sigfile), (entry.header_offset), (((void *)0)) );

   _php_stream_seek((fp), (((php_uint32)((((php_uint32)locator.cdir_offset[0]) & 0xff) | (((php_uint32)locator.cdir_offset[1]) & 0xff) << 8 | (((php_uint32)locator.cdir_offset[2]) & 0xff) << 16 | (((php_uint32)locator.cdir_offset[3]) & 0xff) << 24))), (0) );

   _php_stream_copy_to_stream_ex((fp), (sigfile), (beforeus - ((php_uint32)((((php_uint32)locator.cdir_offset[0]) & 0xff) | (((php_uint32)locator.cdir_offset[1]) & 0xff) << 8 | (((php_uint32)locator.cdir_offset[2]) & 0xff) << 16 | (((php_uint32)locator.cdir_offset[3]) & 0xff) << 24))), (((void *)0)) );
   if (metadata) {
    _php_stream_write(sigfile, (metadata), (((unsigned short)((((unsigned short)locator.comment_len[0]) & 0xff) | (((unsigned short)locator.comment_len[1]) & 0xff) << 8))) );
   }
   _php_stream_seek((fp), (sizeof(phar_zip_file_header) + entry.header_offset + entry.filename_len + ((unsigned short)((((unsigned short)zipentry.extra_len[0]) & 0xff) | (((unsigned short)zipentry.extra_len[1]) & 0xff) << 8))), (0) );
   sig = (char *) _emalloc((entry.uncompressed_filesize) );
   read = _php_stream_read((fp), (sig), (entry.uncompressed_filesize) );
   if (read != entry.uncompressed_filesize) {
    _php_stream_free((sigfile), (1 | 2) );
    _efree((sig) );
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "signature cannot be read", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }
   mydata->sig_flags = ((php_uint32)((((php_uint32)sig[0]) & 0xff) | (((php_uint32)sig[1]) & 0xff) << 8 | (((php_uint32)sig[2]) & 0xff) << 16 | (((php_uint32)sig[3]) & 0xff) << 24));
   if (FAILURE == phar_verify_signature(sigfile, _php_stream_tell((sigfile) ), mydata->sig_flags, sig + 8, entry.uncompressed_filesize - 8, fname, &mydata->signature, &mydata->sig_len, error )) {
    _efree((sig) );
    if (error) {
     char *save;
     _php_stream_free((sigfile), (1 | 2) );
     ...
     _efree((*error) );
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", save, mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); _efree((save) ); return FAILURE;;
    } else {
     _php_stream_free((sigfile), (1 | 2) );
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "signature cannot be verified", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
    }
   }
   _php_stream_free((sigfile), (1 | 2) );
   _efree((sig) );

   if (i != ((unsigned short)((((unsigned short)locator.count[0]) & 0xff) | (((unsigned short)locator.count[1]) & 0xff) << 8)) - 1) {
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "entries exist after signature, invalid phar", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }
  ...
  if (((unsigned short)((((unsigned short)zipentry.extra_len[0]) & 0xff) | (((unsigned short)zipentry.extra_len[1]) & 0xff) << 8))) {
   off_t loc = _php_stream_tell((fp) );
   if (FAILURE == phar_zip_process_extra(fp, &entry, ((unsigned short)((((unsigned short)zipentry.extra_len[0]) & 0xff) | (((unsigned short)zipentry.extra_len[1]) & 0xff) << 8)) )) {
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "Unable to process extra field header for file in central directory", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }
   _php_stream_seek((fp), (loc + ((unsigned short)((((unsigned short)zipentry.extra_len[0]) & 0xff) | (((unsigned short)zipentry.extra_len[1]) & 0xff) << 8))), (0) );
  }

  switch (((unsigned short)((((unsigned short)zipentry.compressed[0]) & 0xff) | (((unsigned short)zipentry.compressed[1]) & 0xff) << 8))) {
   case 0 :

    break;
   case 8 :
    entry.flags |= 0x00001000;
    if (!(phar_globals.has_zlib)) {
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "zlib extension is required", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
    }
    break;
   case 12 :
    entry.flags |= 0x00002000;
    if (!(phar_globals.has_bz2)) {
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "bzip2 extension is required", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
    }
    break;
   case 1 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (Shrunk) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 2 :
   case 3 :
   case 4 :
   case 5 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (Reduce) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 6 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (Implode) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 7 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (Tokenize) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 9 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (Deflate64) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 10 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (PKWare Implode/old IBM TERSE) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 14 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (LZMA) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 18 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (IBM TERSE) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 19 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (IBM LZ77) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 97 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (WavPack) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   case 98 :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (PPMd) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   default :
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unsupported compression method (unknown) used in this zip", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
  }


  if (((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8))) {
   if (((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8)) != _php_stream_read((fp), (buf), (((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8))) )) {
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unable to read in file comment, truncated", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }

   p = buf;
   entry.metadata_len = ((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8));

   if (phar_parse_metadata(&p, &(entry.metadata), ((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8)) ) == FAILURE) {
    entry.metadata_len = 0;


    if (entry.is_persistent) {
     do { (entry.metadata) = (zval*)malloc(sizeof(zval_gc_info)); ((zval_gc_info*)(entry.metadata))->u.buffered = ((void *)0); } while (0);
    } else {
     do { (entry.metadata) = (zval*)_emalloc((sizeof(zval_gc_info)) ); ((zval_gc_info*)(entry.metadata))->u.buffered = ((void *)0); } while (0);
    }

    *entry.metadata = zval_used_for_init;;
    do { const char *__s=(((entry.is_persistent)?zend_strndup((buf),(((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8)))):_estrndup(((buf)), ((((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8)))) ))); int __l=((unsigned short)((((unsigned short)zipentry.comment_len[0]) & 0xff) | (((unsigned short)zipentry.comment_len[1]) & 0xff) << 8)); zval *__z = (entry.metadata); (*__z).value.str.len = __l; (*__z).value.str.val = (0?_estrndup((__s), (__l) ):(char*)__s); (*__z).type = 6; } while (0);
   }
  } else {
  ...
  if (!actual_alias && entry.filename_len == sizeof(".phar/alias.txt")-1 && !strncmp(entry.filename, ".phar/alias.txt", sizeof(".phar/alias.txt")-1)) {
   ...
   saveloc = _php_stream_tell((fp) );
   _php_stream_seek((fp), (((php_uint32)((((php_uint32)zipentry.offset[0]) & 0xff) | (((php_uint32)zipentry.offset[1]) & 0xff) << 8 | (((php_uint32)zipentry.offset[2]) & 0xff) << 16 | (((php_uint32)zipentry.offset[3]) & 0xff) << 24))), (0) );

   if (sizeof(local) != _php_stream_read((fp), ((char *) &local), (sizeof(local)) )) {
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "phar error: internal corruption of zip-based phar (cannot read local file header for alias)", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }
   ...
   if (entry.filename_len != ((unsigned short)((((unsigned short)local.filename_len[0]) & 0xff) | (((unsigned short)local.filename_len[1]) & 0xff) << 8)) || entry.crc32 != ((php_uint32)((((php_uint32)local.crc32[0]) & 0xff) | (((php_uint32)local.crc32[1]) & 0xff) << 8 | (((php_uint32)local.crc32[2]) & 0xff) << 16 | (((php_uint32)local.crc32[3]) & 0xff) << 24)) || entry.uncompressed_filesize != ((php_uint32)((((php_uint32)local.uncompsize[0]) & 0xff) | (((php_uint32)local.uncompsize[1]) & 0xff) << 8 | (((php_uint32)local.uncompsize[2]) & 0xff) << 16 | (((php_uint32)local.uncompsize[3]) & 0xff) << 24)) || entry.compressed_filesize != ((php_uint32)((((php_uint32)local.compsize[0]) & 0xff) | (((php_uint32)local.compsize[1]) & 0xff) << 8 | (((php_uint32)local.compsize[2]) & 0xff) << 16 | (((php_uint32)local.compsize[3]) & 0xff) << 24))) {
    ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
    zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "phar error: internal corruption of zip-based phar (local header of alias does not match central directory)", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
   }
   ...
   _php_stream_seek((fp), (entry.offset), (0) );
   ...
   if (entry.flags & 0x00001000) {
    filter = php_stream_filter_create("zlib.inflate", ((void *)0), (fp)->is_persistent );

    if (!filter) {
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unable to decompress alias, zlib filter creation failed", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
    }

    _php_stream_filter_append((&fp->readfilters), (filter) );

    if (!(entry.uncompressed_filesize = _php_stream_copy_to_mem((fp), (&actual_alias), (entry.uncompressed_filesize), (0) )) || !actual_alias) {
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unable to read in alias, truncated", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
    }

    _php_stream_filter_flush((filter), (1) );
    php_stream_filter_remove(filter, 1 );

   } else if (entry.flags & 0x00002000) {
    filter = php_stream_filter_create("bzip2.decompress", ((void *)0), (fp)->is_persistent );

    if (!filter) {
     ((entry.is_persistent)?free(entry.filename):_efree((entry.filename) ));
     zend_hash_destroy(&mydata->manifest); mydata->manifest.arBuckets = 0; zend_hash_destroy(&mydata->mounted_dirs); mydata->mounted_dirs.arBuckets = 0; zend_hash_destroy(&mydata->virtual_dirs); mydata->virtual_dirs.arBuckets = 0; _php_stream_free((fp), (1 | 2) ); if (mydata->metadata) { _zval_dtor((mydata->metadata) ); } if (mydata->signature) { _efree((mydata->signature) ); } if (error) { spprintf(error, 4096, "phar error: %s in zip-based phar \"%s\"", "unable to read in alias, bzip2 filter creation failed", mydata->fname); } ((mydata->is_persistent)?free(mydata->fname):_efree((mydata->fname) )); if (mydata->alias) { ((mydata->is_persistent)?free(mydata->alias):_efree((mydata->alias) )); } ((mydata->is_persistent)?free(mydata):_efree((mydata) )); return FAILURE;;
    }
 ...
 if (actual_alias) {
  ...
  mydata->alias = entry.is_persistent ? ((1)?zend_strndup((actual_alias),(mydata->alias_len)):_estrndup(((actual_alias)), ((mydata->alias_len)) )) : actual_alias;

  if (entry.is_persistent) {
   _efree((actual_alias) );
  }

  _zend_hash_add_or_update(&((&phar_globals)->phar_alias_map), actual_alias, mydata->alias_len, (void*)&mydata, sizeof(phar_archive_data*), ((void *)0), (1<<1) );
 } else {
  phar_archive_data **fd_ptr;
  ...
  if (alias_len) {
   ...
   _zend_hash_add_or_update(&((&phar_globals)->phar_alias_map), actual_alias, mydata->alias_len, (void*)&mydata, sizeof(phar_archive_data*), ((void *)0), (1<<1) );
   mydata->alias = ((mydata->is_persistent)?zend_strndup((alias),(alias_len)):_estrndup(((alias)), ((alias_len)) ));
   mydata->alias_len = alias_len;
  } else {
   mydata->alias = ((mydata->is_persistent)?zend_strndup((mydata->fname),(fname_len)):_estrndup(((mydata->fname)), ((fname_len)) ));
...
static int phar_zip_changed_apply(void *data, void *arg )
{
 phar_entry_info *entry;
 phar_zip_file_header local;
 ...
 phar_write_16(central.extra_len, (unsigned short) (sizeof(perms)));;
 phar_write_16(local.extra_len, (unsigned short) (sizeof(perms)));;
 perms.tag[0] = 'n';
 perms.tag[1] = 'u';
 phar_write_16(perms.size, (unsigned short) (sizeof(perms) - 4));;
 phar_write_16(perms.perms, (unsigned short) (entry->flags & 0x000001FF));;
 {
  php_uint32 crc = (php_uint32) ~0;
  (crc = (crc >> 8) ^ crc32tab[(crc ^ (perms.perms[0])) & 0xff]);
  (crc = (crc >> 8) ^ crc32tab[(crc ^ (perms.perms[1])) & 0xff]);
  phar_write_32(perms.crc32, (php_uint32) (~crc));;
 }

 if (entry->flags & 0x00001000) {
  phar_write_16(central.compressed, (unsigned short) (8));;
  phar_write_16(local.compressed, (unsigned short) (8));;
 }

 if (entry->flags & 0x00002000) {
  phar_write_16(central.compressed, (unsigned short) (12));;
  phar_write_16(local.compressed, (unsigned short) (12));;
 }
 ...
 phar_write_16(central.filename_len, (unsigned short) (entry->filename_len + (entry->is_dir ? 1 : 0)));;
 phar_write_16(local.filename_len, (unsigned short) (entry->filename_len + (entry->is_dir ? 1 : 0)));;
 phar_write_32(central.offset, (php_uint32) (_php_stream_tell((p->filefp) )));;
 ...
 if (entry->is_modified) {
  ...
  if (entry->flags & 0x0000F000 && (entry->old_flags == entry->flags || !entry->old_flags)) {
  ...
  for (loc = 0;loc < entry->uncompressed_filesize; ++loc) {
   (newcrc32 = (newcrc32 >> 8) ^ crc32tab[(newcrc32 ^ (_php_stream_getc((efp) ))) & 0xff]);
  }

  entry->crc32 = ~newcrc32;
  phar_write_32(central.uncompsize, (php_uint32) (entry->uncompressed_filesize));;
  phar_write_32(local.uncompsize, (php_uint32) (entry->uncompressed_filesize));;

  if (!(entry->flags & 0x0000F000)) {

   entry->compressed_filesize = entry->uncompressed_filesize;
   phar_write_32(central.compsize, (php_uint32) (entry->uncompressed_filesize));;
   phar_write_32(local.compsize, (php_uint32) (entry->uncompressed_filesize));;
   goto not_compressed;
  }
  ...
  if (SUCCESS != _php_stream_copy_to_stream_ex((efp), (entry->cfp), (entry->uncompressed_filesize), (((void *)0)) )) {
  ...
  phar_write_32(central.compsize, (php_uint32) (entry->compressed_filesize));;
  phar_write_32(local.compsize, (php_uint32) (entry->compressed_filesize));;
...
is_compressed:
  ...
  phar_write_32(local.compsize, (php_uint32) (entry->compressed_filesize));;
  if (p->old) {
   if (-1 == _php_stream_seek((p->old), (entry->offset_abs), (0) )) {
...
not_compressed:
 phar_write_32(central.crc32, (php_uint32) (entry->crc32));;
 phar_write_32(local.crc32, (php_uint32) (entry->crc32));;
continue_dir:
 ...
 if (entry->metadata) {
  ...
  phar_write_16(central.comment_len, (unsigned short) (entry->metadata_str.len));;
 }

 entry->header_offset = _php_stream_tell((p->filefp) );
 offset = entry->header_offset + sizeof(local) + entry->filename_len + (entry->is_dir ? 1 : 0) + sizeof(perms);

 if (sizeof(local) != _php_stream_write(p->filefp, ((char *)&local), (sizeof(local)) )) {
  spprintf(p->error, 0, "unable to write local file header of file \"%s\" to zip-based phar \"%s\"", entry->filename, entry->phar->fname);
  return 1<<1;
 }

 if (sizeof(central) != _php_stream_write(p->centralfp, ((char *)&central), (sizeof(central)) )) {
 ...
 if (entry->is_dir) {
  if (entry->filename_len != _php_stream_write(p->filefp, (entry->filename), (entry->filename_len) )) {
  ...
  if (1 != _php_stream_write(p->filefp, ("/"), (1) )) {
   spprintf(p->error, 0, "unable to write filename to local directory entry for directory \"%s\" while creating zip-based phar \"%s\"", entry->filename, entry->phar->fname);
   return 1<<1;
  }

  if (entry->filename_len != _php_stream_write(p->centralfp, (entry->filename), (entry->filename_len) )) {
  ...
  if (1 != _php_stream_write(p->centralfp, ("/"), (1) )) {
   spprintf(p->error, 0, "unable to write filename to central directory entry for directory \"%s\" while creating zip-based phar \"%s\"", entry->filename, entry->phar->fname);
   return 1<<1;
  }
 } else {
 ...
 if (sizeof(perms) != _php_stream_write(p->filefp, ((char *)&perms), (sizeof(perms)) )) {
 ...
 if (sizeof(perms) != _php_stream_write(p->centralfp, ((char *)&perms), (sizeof(perms)) )) {
 ...
 if (!not_really_modified && entry->is_modified) {
  if (entry->cfp) {
   if (SUCCESS != _php_stream_copy_to_stream_ex((entry->cfp), (p->filefp), (entry->compressed_filesize), (((void *)0)) )) {
   ...
   phar_seek_efp(entry, 0, 0, 0, 0 );

   if (SUCCESS != _php_stream_copy_to_stream_ex((phar_get_efp(entry, 0 )), (p->filefp), (entry->uncompressed_filesize), (((void *)0)) )) {
  ...
  if (!entry->is_dir && entry->compressed_filesize && SUCCESS != _php_stream_copy_to_stream_ex((p->old), (p->filefp), (entry->compressed_filesize), (((void *)0)) )) {
 ...
 if (entry->metadata_str.c) {
  if (entry->metadata_str.len != _php_stream_write(p->centralfp, (entry->metadata_str.c), (entry->metadata_str.len) )) {
       ...
       smart_str *metadata )
{
 ...
 if (!phar->is_data || phar->sig_flags) {
  ...
  st = tell = _php_stream_tell((pass->filefp) );

  _php_stream_seek((pass->filefp), (0), (0) );
  _php_stream_copy_to_stream_ex((pass->filefp), (newfile), (tell), (((void *)0)) );
  tell = _php_stream_tell((pass->centralfp) );
  _php_stream_seek((pass->centralfp), (0), (0) );
  _php_stream_copy_to_stream_ex((pass->centralfp), (newfile), (tell), (((void *)0)) );
  if (metadata->c) {
   _php_stream_write(newfile, (metadata->c), (metadata->len) );
  }
  ...
  phar_write_32(sigbuf, (php_uint32) (phar->sig_flags));;
  phar_write_32(sigbuf + 4, (php_uint32) (signature_length));;
  ...
  phar_zip_changed_apply((void *)&entry, (void *)pass );
  _php_stream_free((newfile), (1 | 2) );
...
int phar_zip_flush(phar_archive_data *phar, char *user_stub, long len, int defaultstub, char **error )
{
 char *pos;
...
nostub:
 ...
 pass.old = oldfile;
 pass.filefp = _php_stream_fopen_tmpfile(0 );
...
fperror:
 ...
 pass.centralfp = _php_stream_fopen_tmpfile(0 );
 ...
 if (phar->sig_flags) {
  phar_write_16(eocd.counthere, (unsigned short) (zend_hash_num_elements(&phar->manifest) + 1));;
  phar_write_16(eocd.count, (unsigned short) (zend_hash_num_elements(&phar->manifest) + 1));;
 } else {
  phar_write_16(eocd.counthere, (unsigned short) (zend_hash_num_elements(&phar->manifest)));;
  phar_write_16(eocd.count, (unsigned short) (zend_hash_num_elements(&phar->manifest)));;
 }
...
nocentralerror:
 ...
 cdir_size = _php_stream_tell((pass.centralfp) );
 cdir_offset = _php_stream_tell((pass.filefp) );
 phar_write_32(eocd.cdir_size, (php_uint32) (cdir_size));;
 phar_write_32(eocd.cdir_offset, (php_uint32) (cdir_offset));;
 _php_stream_seek((pass.centralfp), (0), (0) );

 {
  size_t clen;
  int ret = _php_stream_copy_to_stream_ex((pass.centralfp), (pass.filefp), (((size_t)-1)), (&clen) );
 ...
 if (phar->metadata) {
  ...
  phar_write_16(eocd.comment_len, (unsigned short) (main_metadata_str.len));;

  if (sizeof(eocd) != _php_stream_write(pass.filefp, ((char *)&eocd), (sizeof(eocd)) )) {
   if (error) {
  ...
  if (main_metadata_str.len != _php_stream_write(pass.filefp, (main_metadata_str.c), (main_metadata_str.len) )) {
   if (error) {
 ...
 if (phar->donotflush) {
  ...
  _php_stream_seek((pass.filefp), 0L, 0 );
  _php_stream_copy_to_stream_ex((pass.filefp), (phar->fp), (((size_t)-1)), (((void *)0)) );
