...
# 1 "<command-line>" 2
# 1 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
# 22 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
...
# 23 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c" 2
...
# 24 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c" 2
# 40 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
...
# 117 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
...
# 160 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
}
...
# 193 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_gc.c"
 (gc_globals.roots).next = &(gc_globals.roots);
 (gc_globals.roots).prev = &(gc_globals.roots);
  ...
  while (current != &to_free) {
   ...
   if (((p)->gc.u.v.type & 0x7f) == 8) {
    ...
    if ((executor_globals.objects_store).object_buckets &&
     ...
     (executor_globals.objects_store).object_buckets[obj->handle] = ((zend_object*)((((zend_uintptr_t)(obj)) | (1<<0))));
     (obj)->gc.u.v.type = 1;
