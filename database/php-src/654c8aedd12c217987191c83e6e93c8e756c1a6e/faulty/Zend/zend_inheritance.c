...
{
 if (!strncmp((mname)->val, "__clone", (mname)->len)) {
  ce->clone = fe; fe->common.fn_flags |= 0x8000;
 } else if (!strncmp((mname)->val, "__construct", (mname)->len)) {
 ...
 } else if (!strncmp((mname)->val, "__destruct", (mname)->len)) {
  ce->destructor = fe; fe->common.fn_flags |= 0x4000;
 } else if (!strncmp((mname)->val, "__get", (mname)->len)) {
  ce->__get = fe;
  ce->ce_flags |= 0x1000000;
 } else if (!strncmp((mname)->val, "__set", (mname)->len)) {
  ce->__set = fe;
  ce->ce_flags |= 0x1000000;
 } else if (!strncmp((mname)->val, "__call", (mname)->len)) {
  ce->__call = fe;
 } else if (!strncmp((mname)->val, "__unset", (mname)->len)) {
  ce->__unset = fe;
  ce->ce_flags |= 0x1000000;
 } else if (!strncmp((mname)->val, "__isset", (mname)->len)) {
  ce->__isset = fe;
  ce->ce_flags |= 0x1000000;
 } else if (!strncmp((mname)->val, "__callstatic", (mname)->len)) {
  ce->__callstatic = fe;
 } else if (!strncmp((mname)->val, "__tostring", (mname)->len)) {
  ce->__tostring = fe;
 } else if (!strncmp((mname)->val, "__debuginfo", (mname)->len)) {
  ce->__debugInfo = fe;
