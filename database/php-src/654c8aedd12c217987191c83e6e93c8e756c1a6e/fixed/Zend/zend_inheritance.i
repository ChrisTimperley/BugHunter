...
static zend_function *do_inherit_method(zend_string *key, zend_function *parent, zend_class_entry *ce)
{
 ...
 if (child) {
  do_inheritance_check_on_method((zend_function*)(*(child)).value.ptr, parent);
  return ((void *)0);
 }
...
__attribute__ ((visibility("default"))) void zend_do_inheritance(zend_class_entry *ce, zend_class_entry *parent_ce)
{
 ...
 if (parent_ce->default_properties_count) {
  ...
  do {
   dst--;
   src--;
# 787 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
...
# 1576 "/home/ct584/git/bughunter/repositories/php-src/Zend/zend_inheritance.c"
