...
# 60 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
__attribute__ ((visibility("default"))) int php_exec(int type, char *cmd, zval *array, zval *return_value)
{
 FILE *fp;
 char *buf;
...
# 80 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
 fp = popen(cmd, "r");
...
# 246 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
 ...
 for (x = 0, y = 0; x < l; x++) {
  ...
  switch (str[x]) {
   ...
   case '\'':
    ...
    (cmd)->val[y++] = str[x];
    break;
# 293 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
   case '#':
   case '&':
   case ';':
   case '`':
...
# 398 "/home/ct584/git/bughunter/repositories/php-src/ext/standard/exec.c"
 (cmd)->val[y++] = '\'';
