...
int hashTypeSet(robj *o, sds field, sds value, int flags) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",267),_exit(1);
    }
...
int hashTypeDelete(robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",305),_exit(1);
    }
    return deleted;
}
...
unsigned long hashTypeLength(robj *o) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",319),_exit(1);
    }
    return length;
}
...
hashTypeIterator *hashTypeInitIterator(robj *subject) {
    ...
    if (hi->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",335),_exit(1);
    }
    return hi;
}
...
int hashTypeNext(hashTypeIterator *hi) {
    if (hi->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",378),_exit(1);
    }
    return 0;
}
...
void hashTypeCurrentObject(hashTypeIterator *hi, int what, unsigned char **vstr, unsigned int *vlen, long long *vll) {
    if (hi->encoding == 5) {
        ...
        *vlen = sdslen(ele);
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",435),_exit(1);
    }
}
    ...
    if (enc == 5) {
        ...
        while (hashTypeNext(hi) != -1) {
            ...
            if (ret != 0) {
                ...
                _serverPanic("\"Ziplist corruption detected\"","t_hash.c",488),_exit(1);
            }
        }
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",496),_exit(1);
    }
}
...
void hashTypeConvert(robj *o, int enc) {
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Not implemented\"","t_hash.c",504),_exit(1);
    } else {
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",506),_exit(1);
    }
}
...
void hsetCommand(client *c) {
    ...
    update = hashTypeSet(o,c->argv[2]->ptr,c->argv[3]->ptr,0);
...
void hmsetCommand(client *c) {
    ...
    for (i = 2; i < c->argc; i += 2) {
        hashTypeSet(o,c->argv[i]->ptr,c->argv[i+1]->ptr,0);
    }
...
static void addHashFieldToReply(client *c, robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",675),_exit(1);
    }
}
...
static void addHashIteratorCursorToReply(client *c, hashTypeIterator *hi, int what) {
    if (hi->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",766),_exit(1);
    }
}
...
void genericHgetallCommand(client *c, int flags) {
    ...
    hashTypeReleaseIterator(hi);
    ((count == length)?(void)0 : (_serverAssert("count == length","t_hash.c",798),_exit(1)));
}
