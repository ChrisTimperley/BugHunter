...
int hashTypeGetValue(robj *o, sds field, unsigned char **vstr, unsigned int *vlen, long long *vll) {
    if (o->encoding == 5) {
        *vstr = ((void *)0);
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",122),_exit(1);
    }
    return -1;
}
...
size_t hashTypeGetValueLength(robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",159),_exit(1);
    }
    return len;
}
...
int hashTypeExists(robj *o, sds field) {
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",176),_exit(1);
    }
    return 0;
}
    ...
    if (o->encoding == 5) {
        ...
        if (fptr != ((void *)0)) {
            ...
            if (fptr != ((void *)0)) {
                ...
                vptr = ziplistNext(zl, fptr);
                ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",197),_exit(1)));
                update = 1;
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",231),_exit(1);
    }
    return update;
}
...
int hashTypeDelete(robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",264),_exit(1);
    }
    return deleted;
}
...
unsigned long hashTypeLength(robj *o) {
    unsigned long length = (9223372036854775807L * 2UL + 1UL);

    if (o->encoding == 5) {
        length = ziplistLen(o->ptr) / 2;
    } else if (o->encoding == 2) {
        length = (((dict*)o->ptr)->ht[0].used+((dict*)o->ptr)->ht[1].used);
    } else {
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",278),_exit(1);
    }
    return length;
}
...
hashTypeIterator *hashTypeInitIterator(robj *subject) {
    ...
    if (hi->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",294),_exit(1);
    }
    return hi;
}
...
int hashTypeNext(hashTypeIterator *hi) {
    if (hi->encoding == 5) {
        ...
        if (fptr == ((void *)0)) {
            ...
            ((vptr == ((void *)0))?(void)0 : (_serverAssert("vptr == NULL","t_hash.c",318),_exit(1)));
            fptr = ziplistIndex(zl, 0);
        } else {

            ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",322),_exit(1)));
        ...
        vptr = ziplistNext(zl, fptr);
        ((vptr != ((void *)0))?(void)0 : (_serverAssert("vptr != NULL","t_hash.c",329),_exit(1)));
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",337),_exit(1);
    }
    return 0;
}
                                ...
                                long long *vll)
{
    ...
    ((hi->encoding == 5)?(void)0 : (_serverAssert("hi->encoding == OBJ_ENCODING_ZIPLIST","t_hash.c",351),_exit(1)));

    if (what & 1) {
        ret = ziplistGet(hi->fptr, vstr, vlen, vll);
        ((ret)?(void)0 : (_serverAssert("ret","t_hash.c",355),_exit(1)));
    } else {
        ret = ziplistGet(hi->vptr, vstr, vlen, vll);
        ((ret)?(void)0 : (_serverAssert("ret","t_hash.c",358),_exit(1)));
    }
}
...
sds hashTypeCurrentFromHashTable(hashTypeIterator *hi, int what) {
    ((hi->encoding == 2)?(void)0 : (_serverAssert("hi->encoding == OBJ_ENCODING_HT","t_hash.c",366),_exit(1)));
...
void hashTypeCurrentObject(hashTypeIterator *hi, int what, unsigned char **vstr, unsigned int *vlen, long long *vll) {
    if (hi->encoding == 5) {
        ...
        *vlen = sdslen(ele);
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",394),_exit(1);
    }
}
...
void hashTypeConvertZiplist(robj *o, int enc) {
    ((o->encoding == 5)?(void)0 : (_serverAssert("o->encoding == OBJ_ENCODING_ZIPLIST","t_hash.c",425),_exit(1)));
    ...
    if (enc == 5) {
        ...
        while (hashTypeNext(hi) != -1) {
            ...
            if (ret != 0) {
                ...
                _serverPanic("\"Ziplist corruption detected\"","t_hash.c",447),_exit(1);
            }
        }
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",455),_exit(1);
    }
}
...
void hashTypeConvert(robj *o, int enc) {
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Not implemented\"","t_hash.c",463),_exit(1);
    } else {
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",465),_exit(1);
    }
}
...
void hincrbyCommand(client *c) {
    ...
    oldvalue = value;
    if ((incr < 0 && oldvalue < 0 && incr < ((-9223372036854775807LL - 1LL)-oldvalue)) ||
        (incr > 0 && oldvalue > 0 && incr > (9223372036854775807LL -oldvalue))) {
...
void hincrbyfloatCommand(client *c) {
    ...
    if (getDoubleFromObjectOrReply(c,c->argv[3],&incr,((void *)0)) != 0) return;
    if ((o = hashTypeLookupWriteOrCreate(c,c->argv[1])) == ((void *)0)) return;
...
static void addHashFieldToReply(client *c, robj *o, sds field) {
    ...
    if (o->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",634),_exit(1);
    }
}
...
void hgetCommand(client *c) {
    ...
    if ((o = lookupKeyReadOrReply(c,c->argv[1],shared.nullbulk)) == ((void *)0) ||
...
static void addHashIteratorCursorToReply(client *c, hashTypeIterator *hi, int what) {
    if (hi->encoding == 5) {
        ...
        _serverPanic("\"Unknown hash encoding\"","t_hash.c",725),_exit(1);
    }
}
...
void genericHgetallCommand(client *c, int flags) {
    ...
    if (flags & 1) multiplier++;
    if (flags & 2) multiplier++;
    ...
    hashTypeReleaseIterator(hi);
    ((count == length)?(void)0 : (_serverAssert("count == length","t_hash.c",757),_exit(1)));
}
