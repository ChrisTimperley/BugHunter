...
void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",477),_exit(1)));
    ...
    if (c->flags & 32) {
        ((server.ds_enabled)?(void)0 : (_redisAssert("server.ds_enabled","networking.c",489),_exit(1)));
        if (((c->io_keys)->len) == 0) {
            ln = listSearchKey(server.io_ready_clients,c);



            ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",495),_exit(1)));
    ...
    if (c->flags & 1) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",513),_exit(1)));
        listDelNode(l,ln);
    }
...
int processMultibulkBuffer(redisClient *c) {
    ...
    if (c->multibulklen == 0) {
        ...
        ((c->argc == 0)?(void)0 : (_redisAssert("c->argc == 0","networking.c",699),_exit(1)));
        ...
        ((c->querybuf[0] == '*')?(void)0 : (_redisAssert("c->querybuf[0] == '*'","networking.c",708),_exit(1)));
    ...
    ((c->multibulklen > 0)?(void)0 : (_redisAssert("c->multibulklen > 0","networking.c",728),_exit(1)));
...
void processInputBuffer(redisClient *c) {
    ...
    while(sdslen(c->querybuf)) {
        ...
        if (c->reqtype == 1) {
            ...
            _redisPanic("\"Unknown request type\"","networking.c",806),_exit(1);
        }
