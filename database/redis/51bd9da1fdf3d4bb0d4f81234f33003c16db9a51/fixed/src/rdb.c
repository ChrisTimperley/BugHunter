...
int rdbSaveObjectType(rio *rdb, robj *o) {
    ...
    case 1:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",440),_exit(1);
    case 2:
        if (o->encoding == 6)
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",447),_exit(1);
    case 3:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",454),_exit(1);
    case 4:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",461),_exit(1);
    default:
        _redisPanic("\"Unknown object type\"","rdb.c",463),_exit(1);
    }
    return -1;
}
...
int rdbSaveObject(rio *rdb, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 2) {
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",531),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",559),_exit(1);
        }
    } else if (o->type == 4) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",588),_exit(1);
        }

    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",592),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    ...
    ((len != -1)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"len != -1","rdb.c",603),_exit(1)));
    return len;
}
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while (o->encoding == 5 && len > 0) {
            ...
            (((field->encoding == 0 || field->encoding == 8))?(void)0 : (_redisAssert("sdsEncodedObject(field)","rdb.c",906),_exit(1)));
            value = rdbLoadStringObject(rdb);
            if (value == ((void *)0)) return ((void *)0);
            (((value->encoding == 0 || value->encoding == 8))?(void)0 : (_redisAssert("sdsEncodedObject(value)","rdb.c",909),_exit(1)));
        ...
        while (o->encoding == 2 && len > 0) {
            ...
            ((ret == 0)?(void)0 : (_redisAssert("ret == REDIS_OK","rdb.c",943),_exit(1)));
        }


        ((len == 0)?(void)0 : (_redisAssert("len == 0","rdb.c",947),_exit(1)));
               ...
               rdbtype == 13)
    {
        ...
        switch(rdbtype) {
            ...
            case 13:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",1024),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",1028),_exit(1);
    }
    return o;
}
