...
int luaCreateFunction(redisClient *c, lua_State *lua, char *funcname, robj *body) {
...

    {
        ...
        ((retval == 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"retval == DICT_OK","scripting.c",817),_exit(1)));
        incrRefCount(body);
    }
    return 0;
}
...
# 841 "scripting.c"
    ...
    if ((lua_type(lua, (-1)) == 0)) {
        ...
        lua_getfield(lua, (-10002), (funcname));
        ((!(lua_type(lua, (-1)) == 0))?(void)0 : (_redisAssert("!lua_isnil(lua,-1)","scripting.c",896),_exit(1)));
    }
...
# 958 "scripting.c"
    if (evalsha) {
        if (!replicationScriptCacheExists(c->argv[1]->ptr)) {
            ...
            ((script != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,((void *)0),"script != NULL","scripting.c",966),_exit(1)));
