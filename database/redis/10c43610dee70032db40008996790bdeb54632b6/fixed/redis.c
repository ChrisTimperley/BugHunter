...
static void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 956, __PRETTY_FUNCTION__));
    listDelNode(server.clients,ln);
    if (c->flags & 2) {
        list *l = (c->flags & 8) ? server.monitors : server.slaves;
        ln = listSearchKey(l,c);
        ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 961, __PRETTY_FUNCTION__));
        listDelNode(l,ln);
    }
    if (c->flags & 4) {
        server.master = ((void *)0);
...
static void decrRefCount(void *obj) {
    ...
    if (--(o->refcount) == 0) {
        ...
        default: ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1425, __PRETTY_FUNCTION__)); break;
        }
...
static robj *tryObjectSharing(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1440, __PRETTY_FUNCTION__));
    ...
    if (de) {
        ...
        if (((server.sharingpool)->used) >=
            ...
            ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 1458, __PRETTY_FUNCTION__));
            c = ((unsigned long) ((de)->val))-1;
            ((de)->val) = (void*) c;
            if (c == 0) {
        ...
        if (c == 0) {
            ...
            ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1471, __PRETTY_FUNCTION__));
            incrRefCount(o);
        }
        return o;
    }
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1580, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
...
static int rdbLoad(char *filename) {
    ...
    while(1) {
        ...
        if (type == 254) {
            if ((dbid = rdbLoadLen(fp,rdbver)) == (2147483647 * 2U + 1U)) goto eoferr;
        ...
        if (type == 0) {
            ...
            if ((listlen = rdbLoadLen(fp,rdbver)) == (2147483647 * 2U + 1U))
                goto eoferr;
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1744, __PRETTY_FUNCTION__));
        }
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 2832, __PRETTY_FUNCTION__));
...
int main(int argc, char **argv) {
    ...
    redisLog(1,"Server started, Redis version " "0.08");
    if (rdbLoad(server.dbfilename) == 0)
