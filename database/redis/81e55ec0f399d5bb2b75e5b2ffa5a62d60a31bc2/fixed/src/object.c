...
int compareStringObjectsWithFlags(robj *a, robj *b, int flags) {
    ((a->type == 0 && b->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),a,"a->type == REDIS_STRING && b->type == REDIS_STRING","object.c",347),_exit(1)));
...
size_t stringObjectLen(robj *o) {
    ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",404),_exit(1)));
    if (o->encoding == 0) {
        return sdslen(o->ptr);
    } else {
        char buf[32];
...
int getDoubleFromObject(robj *o, double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",421),_exit(1)));
        if (o->encoding == 0) {
            (*__errno_location ()) = 0;
            ...
            _redisPanic("\"Unknown string encoding\"","object.c",431),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongDoubleFromObject(robj *o, long double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",459),_exit(1)));
        if (o->encoding == 0) {
            (*__errno_location ()) = 0;
            ...
            _redisPanic("\"Unknown string encoding\"","object.c",469),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongLongFromObject(robj *o, long long *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",497),_exit(1)));
        if (o->encoding == 0) {
            (*__errno_location ()) = 0;
            ...
            _redisPanic("\"Unknown string encoding\"","object.c",507),_exit(1);
        }
    }
