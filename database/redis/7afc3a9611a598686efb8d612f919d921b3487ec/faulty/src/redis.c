...
struct redisCommand redisCommandTable[] = {
    ...
    {"brpop",brpopCommand,-3,"w",0,((void *)0),1,1,1,0,0},
    {"brpoplpush",brpoplpushCommand,4,"wm",0,((void *)0),1,2,1,0,0},
    {"blpop",blpopCommand,-3,"w",0,((void *)0),1,-2,1,0,0},
    ...
    {"sinter",sinterCommand,-2,"r",0,((void *)0),1,-1,1,0,0},
    {"sinterstore",sinterstoreCommand,-3,"wm",0,((void *)0),2,-1,1,0,0},
    {"sunion",sunionCommand,-2,"r",0,((void *)0),1,-1,1,0,0},
    {"sunionstore",sunionstoreCommand,-3,"wm",0,((void *)0),2,-1,1,0,0},
    {"sdiff",sdiffCommand,-2,"r",0,((void *)0),1,-1,1,0,0},
    {"sdiffstore",sdiffstoreCommand,-3,"wm",0,((void *)0),2,-1,1,0,0},
    {"smembers",sinterCommand,2,"r",0,((void *)0),1,1,1,0,0},
    ...
    {"hkeys",hkeysCommand,2,"r",0,((void *)0),1,1,1,0,0},
    {"hvals",hvalsCommand,2,"r",0,((void *)0),1,1,1,0,0},
    ...
    {"select",selectCommand,2,"r",0,((void *)0),0,0,0,0,0},
    ...
    {"keys",keysCommand,2,"r",0,((void *)0),0,0,0,0,0},
    {"dbsize",dbsizeCommand,1,"r",0,((void *)0),0,0,0,0,0},
    {"auth",authCommand,2,"r",0,((void *)0),0,0,0,0,0},
    {"ping",pingCommand,1,"r",0,((void *)0),0,0,0,0,0},
    {"echo",echoCommand,2,"r",0,((void *)0),0,0,0,0,0},
    {"save",saveCommand,1,"ar",0,((void *)0),0,0,0,0,0},
    {"bgsave",bgsaveCommand,1,"ar",0,((void *)0),0,0,0,0,0},
    {"bgrewriteaof",bgrewriteaofCommand,1,"ar",0,((void *)0),0,0,0,0,0},
    {"shutdown",shutdownCommand,1,"ar",0,((void *)0),0,0,0,0,0},
    {"lastsave",lastsaveCommand,1,"r",0,((void *)0),0,0,0,0,0},
    {"type",typeCommand,2,"r",0,((void *)0),1,1,1,0,0},
    {"multi",multiCommand,1,"rs",0,((void *)0),0,0,0,0,0},
    {"exec",execCommand,1,"wms",0,((void *)0),0,0,0,0,0},
    ...
    {"info",infoCommand,-1,"r",0,((void *)0),0,0,0,0,0},
    ...
    {"slaveof",slaveofCommand,3,"aws",0,((void *)0),0,0,0,0,0},
    {"debug",debugCommand,-2,"aw",0,((void *)0),0,0,0,0,0},
    {"config",configCommand,-2,"ar",0,((void *)0),0,0,0,0,0},
    {"subscribe",subscribeCommand,-2,"rps",0,((void *)0),0,0,0,0,0},
    {"unsubscribe",unsubscribeCommand,-1,"rps",0,((void *)0),0,0,0,0,0},
    {"psubscribe",psubscribeCommand,-2,"rps",0,((void *)0),0,0,0,0,0},
    {"punsubscribe",punsubscribeCommand,-1,"rps",0,((void *)0),0,0,0,0,0},
    {"publish",publishCommand,3,"rpf",0,((void *)0),0,0,0,0,0},
    {"watch",watchCommand,-2,"rs",0,noPreloadGetKeys,1,-1,1,0,0},
    {"unwatch",unwatchCommand,1,"rs",0,((void *)0),0,0,0,0,0},
    {"cluster",clusterCommand,-2,"ar",0,((void *)0),0,0,0,0,0},
    {"restore",restoreCommand,4,"awm",0,((void *)0),0,0,0,0,0},
    {"migrate",migrateCommand,6,"aw",0,((void *)0),0,0,0,0,0},
    {"dump",dumpCommand,2,"ar",0,((void *)0),0,0,0,0,0},
    {"object",objectCommand,-2,"r",0,((void *)0),0,0,0,0,0},
...
void beforeSleep(struct aeEventLoop *eventLoop) {
    ...
    while (((server.unblocked_clients)->len)) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","redis.c",749),_exit(1)));
        c = ln->value;
...
void populateCommandTable(void) {
    ...
    for (j = 0; j < numcommands; j++) {
        ...
        while(*f != '\0') {
            ...
            case 'f': c->flags |= 8; break;
            case 's': c->flags |= 64; break;
            case 'R': c->flags |= 128; break;
            default: _redisPanic("\"Unsupported command flag\"","redis.c",1019),_exit(1); break;
            }
            f++;
        }

        retval = dictAdd(server.commands, sdsnew(c->name), c);
        ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1025, __PRETTY_FUNCTION__));
    }
}
