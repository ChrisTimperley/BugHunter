...
int loadAppendOnlyFile(char *filename) {
    ...
    while(1) {
        ...
        ((fakeClient->bufpos == 0 && ((fakeClient->reply)->len) == 0)?(void)0 : (_redisAssert("fakeClient->bufpos == 0 && listLength(fakeClient->reply) == 0","aof.c",285),_exit(1)));
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                if (o->encoding == 5) {
                    ...
                    _redisPanic("\"Unknown list encoding\"","aof.c",403),_exit(1);
                }
            } else if (o->type == 2) {
                char cmd[]="*3\r\n$4\r\nSADD\r\n";
                ...
                if (o->encoding == 6) {
                    ...
                    _redisPanic("\"Unknown set encoding\"","aof.c",428),_exit(1);
                }
            } else if (o->type == 3) {
                ...
                _redisPanic("\"Unknown object type\"","aof.c",480),_exit(1);
            }
