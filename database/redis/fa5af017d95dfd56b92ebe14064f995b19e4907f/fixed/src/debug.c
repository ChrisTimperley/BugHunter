        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                if (o->encoding == 5) {
                    ...
                    ((eptr != ((void *)0))?(void)0 : (_redisAssert("eptr != NULL","debug.c",141),_exit(1)));
                    sptr = ziplistNext(zl,eptr);
                    ((sptr != ((void *)0))?(void)0 : (_redisAssert("sptr != NULL","debug.c",143),_exit(1)));

                    while (eptr != ((void *)0)) {
                        ((ziplistGet(eptr,&vstr,&vlen,&vll))?(void)0 : (_redisAssert("ziplistGet(eptr,&vstr,&vlen,&vll)","debug.c",146),_exit(1)));
                    ...
                    _redisPanic("\"Unknown sorted set encoding\"","debug.c",179),_exit(1);
                }
            } else if (o->type == 4) {
                hashTypeIterator *hi;
                robj *obj;
                ...
                _redisPanic("\"Unknown object type\"","debug.c",200),_exit(1);
            }
...
void debugCommand(redisClient *c) {
    if (!strcasecmp(c->argv[1]->ptr,"segfault")) {
        *((char*)-1) = 'x';
        ...
        ((1 == 2)?(void)0 : (_redisAssertWithInfo(c,c->argv[0],"1 == 2","debug.c",217),_exit(1)));
