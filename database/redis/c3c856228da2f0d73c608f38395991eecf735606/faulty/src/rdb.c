...
robj *rdbLoadIntegerObject(rio *rdb, int enctype, int encode) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        _redisPanic("\"Unknown RDB integer encoding type\"","rdb.c",157),_exit(1);
    }
    if (encode)
...
int rdbSaveLongLongAsStringObject(rio *rdb, long long value) {
    ...
    if (enclen > 0) {
        ...
        ((enclen < 32)?(void)0 : (_redisAssert("enclen < 32","rdb.c",284),_exit(1)));
...
int rdbSaveStringObject(rio *rdb, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        ((obj->encoding == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),obj,"obj->encoding == REDIS_ENCODING_RAW","rdb.c",300),_exit(1)));
...
robj *rdbGenericLoadStringObject(rio *rdb, int encode) {
    ...
    if (isencoded) {
        ...
        default:
            _redisPanic("\"Unknown RDB encoding type\"","rdb.c",320),_exit(1);
        }
    }
...
int rdbSaveObjectType(rio *rdb, robj *o) {
    ...
    case 1:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",412),_exit(1);
    case 2:
        if (o->encoding == 6)
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",419),_exit(1);
    case 3:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",426),_exit(1);
    case 4:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",433),_exit(1);
    default:
        _redisPanic("\"Unknown object type\"","rdb.c",435),_exit(1);
    }
    return -1;
}
...
int rdbSaveObject(rio *rdb, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",478),_exit(1);
        }
    } else if (o->type == 2) {
        ...
        if (o->encoding == 2) {
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",502),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",530),_exit(1);
        }
    } else if (o->type == 4) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",559),_exit(1);
        }

    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",563),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    ...
    ((len != -1)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"len != -1","rdb.c",574),_exit(1)));
    return len;
}
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while (o->encoding == 5 && len-- > 0) {
            ...
            ((field->encoding == 0)?(void)0 : (_redisAssert("field->encoding == REDIS_ENCODING_RAW","rdb.c",853),_exit(1)));
            value = rdbLoadStringObject(rdb);
            if (value == ((void *)0)) return ((void *)0);
            ((field->encoding == 0)?(void)0 : (_redisAssert("field->encoding == REDIS_ENCODING_RAW","rdb.c",856),_exit(1)));
        ...
        while (o->encoding == 2 && len-- > 0) {
            ...
            ((ret == 0)?(void)0 : (_redisAssert("ret == REDIS_OK","rdb.c",886),_exit(1)));
        }


        ((len == 0)?(void)0 : (_redisAssert("len == 0","rdb.c",890),_exit(1)));
               ...
               rdbtype == 13)
    {
        ...
        switch(rdbtype) {
            ...
            case 13:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",967),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",971),_exit(1);
    }
    return o;
}
