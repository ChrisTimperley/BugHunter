...
int setTypeAdd(robj *subject, robj *value) {
    ...
    if (subject->encoding == 2) {
        ...
        if (isObjectRepresentableAsLongLong(value,&llval) == 0) {
            ...
            ((dictAdd(subject->ptr,value,((void *)0)) == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),value,"dictAdd(subject->ptr,value,NULL) == DICT_OK","t_set.c",40),_exit(1)));
            incrRefCount(value);
            return 1;
        }
    } else {
...
# 192 "t_set.c"
    ...
    if (enc == 2) {
        ...
        while (setTypeNext(si,((void *)0),&intele) != -1) {
            ...
            ((dictAdd(d,element,((void *)0)) == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),element,"dictAdd(d,element,NULL) == DICT_OK","t_set.c",207),_exit(1)));
        }
