...
int rdbLoadType(rio *rdb) {
    unsigned char type;
    if (((rdb)->read((rdb),(&type),(1))) == 0) return -1;
    return type;
}

time_t rdbLoadTime(rio *rdb) {
    int32_t t32;
    if (((rdb)->read((rdb),(&t32),(4))) == 0) return -1;
    return (time_t)t32;
}
...
long long rdbLoadMillisecondTime(rio *rdb) {
    int64_t t64;
    if (((rdb)->read((rdb),(&t64),(8))) == 0) return -1;
...
uint32_t rdbLoadLen(rio *rdb, int *isencoded) {
    ...
    if (((rdb)->read((rdb),(buf),(1))) == 0) return (2147483647 * 2U + 1U);
    type = (buf[0]&0xC0)>>6;
    if (type == 3) {
        ...
        if (((rdb)->read((rdb),(buf+1),(1))) == 0) return (2147483647 * 2U + 1U);
        return ((buf[0]&0x3F)<<8)|buf[1];
    } else {

        if (((rdb)->read((rdb),(&len),(4))) == 0) return (2147483647 * 2U + 1U);
        return ntohl(len);
    }
}
...
robj *rdbLoadIntegerObject(rio *rdb, int enctype, int encode) {
    ...
    if (enctype == 0) {
        if (((rdb)->read((rdb),(enc),(1))) == 0) return ((void *)0);
        val = (signed char)enc[0];
    } else if (enctype == 1) {
        uint16_t v;
        if (((rdb)->read((rdb),(enc),(2))) == 0) return ((void *)0);
        v = enc[0]|(enc[1]<<8);
        val = (int16_t)v;
    } else if (enctype == 2) {
        uint32_t v;
        if (((rdb)->read((rdb),(enc),(4))) == 0) return ((void *)0);
        v = enc[0]|(enc[1]<<8)|(enc[2]<<16)|(enc[3]<<24);
        val = (int32_t)v;
    } else {
        val = 0;
        _redisPanic("\"Unknown RDB integer encoding type\"","rdb.c",152),_exit(1);
    }
    if (encode)
...
robj *rdbLoadLzfStringObject(rio *rdb) {
    ...
    if (((rdb)->read((rdb),(c),(clen))) == 0) goto err;
...
int rdbSaveLongLongAsStringObject(rio *rdb, long long value) {
    ...
    if (enclen > 0) {
        ...
        ((enclen < 32)?(void)0 : (_redisAssert("enclen < 32","rdb.c",279),_exit(1)));
...
int rdbSaveStringObject(rio *rdb, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        ((obj->encoding == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),obj,"obj->encoding == REDIS_ENCODING_RAW","rdb.c",295),_exit(1)));
...
robj *rdbGenericLoadStringObject(rio *rdb, int encode) {
    ...
    if (isencoded) {
        ...
        default:
            _redisPanic("\"Unknown RDB encoding type\"","rdb.c",315),_exit(1);
        }
    }

    if (len == (2147483647 * 2U + 1U)) return ((void *)0);
    val = sdsnewlen(((void *)0),len);
    if (len && ((rdb)->read((rdb),(val),(len))) == 0) {
        sdsfree(val);
        return ((void *)0);
    }
    return createObject(0,val);
...
int rdbLoadDoubleValue(rio *rdb, double *val) {
    ...
    if (((rdb)->read((rdb),(&len),(1))) == 0) return -1;
    switch(len) {
    case 255: *val = R_NegInf; return 0;
    case 254: *val = R_PosInf; return 0;
    case 253: *val = R_Nan; return 0;
    default:
        if (((rdb)->read((rdb),(buf),(len))) == 0) return -1;
        buf[len] = '\0';
        sscanf(buf, "%lg", val);
        return 0;
    }
...
int rdbSaveObjectType(rio *rdb, robj *o) {
    ...
    case 1:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",407),_exit(1);
    case 2:
        if (o->encoding == 6)
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",414),_exit(1);
    case 3:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",421),_exit(1);
    case 4:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",428),_exit(1);
    default:
        _redisPanic("\"Unknown object type\"","rdb.c",430),_exit(1);
    }
    return -1;
}
...
int rdbLoadObjectType(rio *rdb) {
    ...
    if (!((type >= 0 && type <= 4) || (type >= 9 && type <= 12))) return -1;
    return type;
}
...
int rdbSaveObject(rio *rdb, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",473),_exit(1);
        }
    } else if (o->type == 2) {
        ...
        if (o->encoding == 2) {
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",497),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",525),_exit(1);
        }
    } else if (o->type == 4) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",554),_exit(1);
        }

    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",558),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    ...
    ((len != -1)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"len != -1","rdb.c",569),_exit(1)));
    return len;
}
...
int rdbSave(char *filename) {
    ...
    snprintf(magic,sizeof(magic),"REDIS%04d",4);
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while (o->encoding == 5 && len > 0) {
            ...
            ((field->encoding == 0)?(void)0 : (_redisAssert("field->encoding == REDIS_ENCODING_RAW","rdb.c",851),_exit(1)));
            value = rdbLoadStringObject(rdb);
            if (value == ((void *)0)) return ((void *)0);
            ((field->encoding == 0)?(void)0 : (_redisAssert("field->encoding == REDIS_ENCODING_RAW","rdb.c",854),_exit(1)));
        ...
        while (o->encoding == 2 && len > 0) {
            ...
            ((ret == 0)?(void)0 : (_redisAssert("ret == REDIS_OK","rdb.c",888),_exit(1)));
        }


        ((len == 0)?(void)0 : (_redisAssert("len == 0","rdb.c",892),_exit(1)));
               ...
               rdbtype == 13)
    {
        ...
        switch(rdbtype) {
            ...
            case 13:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",969),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",973),_exit(1);
    }
    return o;
}
...
int rdbLoad(char *filename) {
    ...
    rioInitWithFile(&rdb,fp);
    if (((&rdb)->read((&rdb),(buf),(9))) == 0) goto eoferr;
    buf[9] = '\0';
