...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while (o->encoding == 2 && len > 0) {
            ...
            ((ret == 0)?(void)0 : (_redisAssert("ret == REDIS_OK","rdb.c",891),_exit(1)));
        }


        ((len == 0)?(void)0 : (_redisAssert("len == 0","rdb.c",895),_exit(1)));
               ...
               rdbtype == 13)
    {
        ...
        switch(rdbtype) {
            ...
            case 13:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",972),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",976),_exit(1);
    }
    return o;
}
