...
static struct redisCommand cmdTable[] = {
    ...
    {"sunion",sunionCommand,-2,2},
    {"sunionstore",sunionstoreCommand,-3,2},
    {"sdiff",sdiffCommand,-2,2},
    {"sdiffstore",sdiffstoreCommand,-3,2},
    {"smembers",sinterCommand,2,2},
    {"incrby",incrbyCommand,3,2},
    {"decrby",decrbyCommand,3,2},
    {"getset",getSetCommand,3,1},
...
int serverCron(struct aeEventLoop *eventLoop, long long id, void *clientData) {
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        if (!(loops % 5) && used > 0) {
            redisLog(0,"DB %d: %d keys (%d volatile) in %d slots HT.",j,used,vkeys,size);
    ...
    if (!(loops % 5)) {
        redisLog(0,"%d clients connected (%d slaves), %zu bytes in use",
    ...
    if (server.bgsaveinprogress) {
        ...
        if (wait4(-1,&statloc,1,((void *)0))) {
            ...
            updateSalvesWaitingBgsave(exitcode == 0 ? 0 : -1);
        }
    } else {
...
static void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1079, __PRETTY_FUNCTION__));
    ...
    if (c->flags & 2) {
        ...
        ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1086, __PRETTY_FUNCTION__));
        listDelNode(l,ln);
    }
    if (c->flags & 4) {
        server.master = ((void *)0);
...
static void decrRefCount(void *obj) {
    ...
    if (--(o->refcount) == 0) {
        ...
        default: ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1592, __PRETTY_FUNCTION__)); break;
        }
...
static robj *tryObjectSharing(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1607, __PRETTY_FUNCTION__));
    ...
    if (de) {
        ...
        if (((server.sharingpool)->used) >=
            ...
            ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 1625, __PRETTY_FUNCTION__));
            c = ((unsigned long) ((de)->val))-1;
            ((de)->val) = (void*) c;
            if (c == 0) {
        ...
        if (c == 0) {
            ...
            ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1638, __PRETTY_FUNCTION__));
            incrRefCount(o);
        }
        return o;
    }
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1885, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
...
static robj *rdbLoadIntegerObject(FILE *fp, int enctype) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2012, __PRETTY_FUNCTION__));
    }
...
static robj *rdbLoadStringObject(FILE*fp, int rdbver) {
    ...
    if (isencoded) {
        ...
        default:
            ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2051, __PRETTY_FUNCTION__));
        }
    }
...
static int rdbLoad(char *filename) {
    ...
    while(1) {
        ...
        if (type == 0) {
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2139, __PRETTY_FUNCTION__));
        }
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 3398, __PRETTY_FUNCTION__));
...
void linuxOvercommitMemoryWarning(void) {
    if (linuxOvercommitMemoryValue() == 0) {
        redisLog(2,"WARNING overcommit_memory is set to 0! Background save may fail under low condition memory. To fix this issue add 'echo 1 > /proc/sys/vm/overcommit_memory' in your init scripts.");
    }
}
...
int main(int argc, char **argv) {
    ...
    redisLog(1,"Server started, Redis version " "0.100");
    if (rdbLoad(server.dbfilename) == 0)
