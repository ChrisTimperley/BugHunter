...
int luaRedisGenericCommand(lua_State *lua, int raise_error) {
    ...
    if (cmd->flags & 1 && server.lua_random_dirty) {
        luaPushError(lua,
...
int luaCreateFunction(redisClient *c, lua_State *lua, char *funcname, robj *body) {
...

    {
        ...
        ((retval == 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"retval == DICT_OK","scripting.c",566),_exit(1)));
        incrRefCount(body);
    }
    return 0;
}
...
# 589 "scripting.c"
    ...
    if ((lua_type(lua, (1)) == 0)) {
        ...
        lua_getfield(lua, (-10002), (funcname));
        ((!(lua_type(lua, (1)) == 0))?(void)0 : (_redisAssert("!lua_isnil(lua,1)","scripting.c",631),_exit(1)));
    }
...
# 690 "scripting.c"
    if (evalsha) {
        ...
        ((script != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,((void *)0),"script != NULL","scripting.c",693),_exit(1)));
