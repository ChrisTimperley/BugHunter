...
void zunionInterGenericCommand(redisClient *c, robj *dstkey, int op) {
    ...
    if (op == 2) {
        ...
        _redisPanic("\"Unknown operator\"","t_zset.c",1585),_exit(1);
    }
...
void zrangeGenericCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssert("eptr != NULL","t_zset.c",1673),_exit(1)));
        sptr = ziplistNext(zl,eptr);

        while (rangelen--) {
            ((eptr != ((void *)0) && sptr != ((void *)0))?(void)0 : (_redisAssert("eptr != NULL && sptr != NULL","t_zset.c",1677),_exit(1)));
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssert("ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1678),_exit(1)));
            if (vstr == ((void *)0))
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","t_zset.c",1711),_exit(1)));
            ele = ln->obj;
            addReplyBulk(c,ele);
            if (withscores)
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1719),_exit(1);
    }
}
...
void genericZrangebyscoreCommand(redisClient *c, int reverse, int justcount) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssert("eptr != NULL","t_zset.c",1804),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ...
        while (eptr && limit--) {
            ...
            rangelen++;
            if (!justcount) {
                ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssert("ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1834),_exit(1)));
                if (vstr == ((void *)0))
                    addReplyBulkLongLong(c,vlong);
                else
                    addReplyBulkCBuffer(c,vstr,vlen);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1898),_exit(1);
    }
...
void zscoreCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1957),_exit(1);
    }
}
...
void zrankGenericCommand(redisClient *c, int reverse) {
    ...
    ((ele->encoding == 0)?(void)0 : (_redisAssert("ele->encoding == REDIS_ENCODING_RAW","t_zset.c",1972),_exit(1)));
    if (zobj->encoding == 5) {
        unsigned char *zl = zobj->ptr;
        unsigned char *eptr, *sptr;

        eptr = ziplistIndex(zl,0);
        ((eptr != ((void *)0))?(void)0 : (_redisAssert("eptr != NULL","t_zset.c",1978),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssert("sptr != NULL","t_zset.c",1980),_exit(1)));
        ...
        if (de != ((void *)0)) {
            ...
            ((rank)?(void)0 : (_redisAssert("rank","t_zset.c",2009),_exit(1)));
            if (reverse)
                addReplyLongLong(c,llen-rank);
            else
                addReplyLongLong(c,rank-1);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2018),_exit(1);
    }
}
