...
zskiplist *zslCreate(void) {
    ...
    zsl->level = 1;
    zsl->length = 0;
    zsl->header = zslCreateNode(32,0,((void *)0));
    for (j = 0; j < 32; j++) {
...
zskiplistNode *zslInsert(zskiplist *zsl, double score, robj *obj) {
    ...
    ((!(sizeof (score) == sizeof (float) ? __isnanf (score) : sizeof (score) == sizeof (double) ? __isnan (score) : __isnanl (score)))?(void)0 : (_redisAssert("!isnan(score)","t_zset.c",112),_exit(1)));
    x = zsl->header;
...
zskiplistNode *zslFirstInRange(zskiplist *zsl, zrangespec range) {
    ...
    x = x->level[0].forward;
    ((x != ((void *)0))?(void)0 : (_redisAssert("x != NULL","t_zset.c",255),_exit(1)));
...
zskiplistNode *zslLastInRange(zskiplist *zsl, zrangespec range) {
    ...
    ((x != ((void *)0))?(void)0 : (_redisAssert("x != NULL","t_zset.c",280),_exit(1)));
...
static int zslParseRange(robj *min, robj *max, zrangespec *spec) {
    ...
    if (min->encoding == 1) {
        ...
        if (((char*)min->ptr)[0] == '(') {
            ...
            if (eptr[0] != '\0' || (sizeof (spec->min) == sizeof (float) ? __isnanf (spec->min) : sizeof (spec->min) == sizeof (double) ? __isnan (spec->min) : __isnanl (spec->min))) return -1;
            spec->minex = 1;
        } else {
    ...
    if (max->encoding == 1) {
        ...
        if (((char*)max->ptr)[0] == '(') {
            ...
            if (eptr[0] != '\0' || (sizeof (spec->max) == sizeof (float) ? __isnanf (spec->max) : sizeof (spec->max) == sizeof (double) ? __isnan (spec->max) : __isnanl (spec->max))) return -1;
            spec->maxex = 1;
        } else {
...
double zzlGetScore(unsigned char *sptr) {
    ...
    ((sptr != ((void *)0))?(void)0 : (_redisAssert("sptr != NULL","t_zset.c",445),_exit(1)));
    ((ziplistGet(sptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssert("ziplistGet(sptr,&vstr,&vlen,&vlong)","t_zset.c",446),_exit(1)));
...
int zzlCompareElements(unsigned char *eptr, unsigned char *cstr, unsigned int clen) {
    ...
    ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssert("ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",467),_exit(1)));
    if (vstr == ((void *)0)) {
...
void zzlNext(unsigned char *zl, unsigned char **eptr, unsigned char **sptr) {
    ...
    ((*eptr != ((void *)0) && *sptr != ((void *)0))?(void)0 : (_redisAssert("*eptr != NULL && *sptr != NULL","t_zset.c",488),_exit(1)));

    _eptr = ziplistNext(zl,*sptr);
    if (_eptr != ((void *)0)) {
        _sptr = ziplistNext(zl,_eptr);
        ((_sptr != ((void *)0))?(void)0 : (_redisAssert("_sptr != NULL","t_zset.c",493),_exit(1)));
    } else {
...
void zzlPrev(unsigned char *zl, unsigned char **eptr, unsigned char **sptr) {
    unsigned char *_eptr, *_sptr;
    ((*eptr != ((void *)0) && *sptr != ((void *)0))?(void)0 : (_redisAssert("*eptr != NULL && *sptr != NULL","t_zset.c",507),_exit(1)));

    _sptr = ziplistPrev(zl,*eptr);
    if (_sptr != ((void *)0)) {
        _eptr = ziplistPrev(zl,_sptr);
        ((_eptr != ((void *)0))?(void)0 : (_redisAssert("_eptr != NULL","t_zset.c",512),_exit(1)));
    } else {
...
int zzlIsInRange(unsigned char *zl, zrangespec *range) {
    ...
    p = ziplistIndex(zl,1);
    ((p != ((void *)0))?(void)0 : (_redisAssert("p != NULL","t_zset.c",540),_exit(1)));
    score = zzlGetScore(p);
...
unsigned char *zzlFirstInRange(unsigned char *zl, zrangespec range) {
    ...
    while (eptr != ((void *)0)) {
        ...
        ((sptr != ((void *)0))?(void)0 : (_redisAssert("sptr != NULL","t_zset.c",559),_exit(1)));
...
unsigned char *zzlLastInRange(unsigned char *zl, zrangespec range) {
    ...
    while (eptr != ((void *)0)) {
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssert("sptr != NULL","t_zset.c",587),_exit(1)));
        ...
        if (sptr != ((void *)0))
            (((eptr = ziplistPrev(zl,sptr)) != ((void *)0))?(void)0 : (_redisAssert("(eptr = ziplistPrev(zl,sptr)) != NULL","t_zset.c",601),_exit(1)));
        else
            eptr = ((void *)0);
    }
...
unsigned char *zzlFind(unsigned char *zl, robj *ele, double *score) {
    ...
    while (eptr != ((void *)0)) {
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),ele,"sptr != NULL","t_zset.c",615),_exit(1)));
...
unsigned char *zzlInsertAt(unsigned char *zl, unsigned char *eptr, robj *ele, double score) {
    ...
    ((ele->encoding == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),ele,"ele->encoding == REDIS_ENCODING_RAW","t_zset.c",649),_exit(1)));
    scorelen = d2string(scorebuf,sizeof(scorebuf),score);
    if (eptr == ((void *)0)) {
        zl = ziplistPush(zl,ele->ptr,sdslen(ele->ptr),1);
        ...
        (((sptr = ziplistNext(zl,eptr)) != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),ele,"(sptr = ziplistNext(zl,eptr)) != NULL","t_zset.c",661),_exit(1)));
...
unsigned char *zzlInsert(unsigned char *zl, robj *ele, double score) {
    ...
    while (eptr != ((void *)0)) {
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),ele,"sptr != NULL","t_zset.c",677),_exit(1)));
        s = zzlGetScore(sptr);
...
unsigned int zsetLength(robj *zobj) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",755),_exit(1);
    }
    return length;
}
...
void zsetConvert(robj *zobj, int encoding) {
    ...
    if (zobj->encoding == 5) {
        ...
        if (encoding != 7)
            _redisPanic("\"Unknown target encoding\"","t_zset.c",775),_exit(1);
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),zobj,"eptr != NULL","t_zset.c",782),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),zobj,"sptr != NULL","t_zset.c",784),_exit(1)));

        while (eptr != ((void *)0)) {
            score = zzlGetScore(sptr);
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(((void *)0),zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",788),_exit(1)));
            if (vstr == ((void *)0))
            ...
            ((dictAdd(zs->dict,ele,&node->score) == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),zobj,"dictAdd(zs->dict,ele,&node->score) == DICT_OK","t_zset.c",796),_exit(1)));
            incrRefCount(ele);
        ...
        if (encoding != 5)
            _redisPanic("\"Unknown target encoding\"","t_zset.c",808),_exit(1);
        ...
        while (node) {
            ...
            zl = zzlInsertAt(zl,((void *)0),ele,node->score);
            decrRefCount(ele);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",832),_exit(1);
    }
}
...
void zaddGenericCommand(redisClient *c, int incr) {
    ...
    robj *zobj;
    robj *curobj;
    double score = 0, *scores = ((void *)0), curscore = 0.0;
    ...
    for (j = 0; j < elements; j++) {
        if (getDoubleFromObjectOrReply(c,c->argv[2+j*2],&scores[j],((void *)0))
            != 0) goto cleanup;
    }
    ...
    for (j = 0; j < elements; j++) {
        ...
        if (zobj->encoding == 5) {
            ...
            if ((eptr = zzlFind(zobj->ptr,ele,&curscore)) != ((void *)0)) {
                if (incr) {
                    score += curscore;
                    if ((sizeof (score) == sizeof (float) ? __isnanf (score) : sizeof (score) == sizeof (double) ? __isnan (score) : __isnanl (score))) {
            ...
            if (de != ((void *)0)) {
                ...
                if (score != curscore) {
                    ((zslDelete(zs->zsl,curscore,curobj))?(void)0 : (_redisAssertWithInfo(c,curobj,"zslDelete(zs->zsl,curscore,curobj)","t_zset.c",943),_exit(1)));
                ...
                incrRefCount(ele);
                ((dictAdd(zs->dict,ele,&znode->score) == 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"dictAdd(zs->dict,ele,&znode->score) == DICT_OK","t_zset.c",953),_exit(1)));
                incrRefCount(ele);
                server.dirty++;
                added++;
            }
        } else {
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",959),_exit(1);
        }
    }
    if (incr)
...
void zremCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        for (j = 2; j < c->argc; j++) {
            if ((eptr = zzlFind(zobj->ptr,c->argv[j],((void *)0))) != ((void *)0)) {
                deleted++;
                zobj->ptr = zzlDelete(zobj->ptr,eptr);
        ...
        for (j = 2; j < c->argc; j++) {
            ...
            if (de != ((void *)0)) {
                ...
                ((zslDelete(zs->zsl,score,c->argv[j]))?(void)0 : (_redisAssertWithInfo(c,c->argv[j],"zslDelete(zs->zsl,score,c->argv[j])","t_zset.c",1017),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1029),_exit(1);
    }
...
void zremrangebyscoreCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1073),_exit(1);
    }

    if (deleted) {
        signalModifiedKey(c->db,key);
        notifyKeyspaceEvent((1<<7),"zrembyscore",key,c->db->id);
        if (keyremoved)
            notifyKeyspaceEvent((1<<2),"del",key,c->db->id);
    }
    server.dirty += deleted;
...
void zremrangebyrankCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1133),_exit(1);
    }

    if (deleted) {
        signalModifiedKey(c->db,key);
        notifyKeyspaceEvent((1<<7),"zrembyrank",key,c->db->id);
        if (keyremoved)
            notifyKeyspaceEvent((1<<2),"del",key,c->db->id);
    }
    server.dirty += deleted;
...
void zuiInitIterator(zsetopsrc *op) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1219),_exit(1);
        }
    } else if (op->type == 3) {
        ...
        if (op->encoding == 5) {
            ...
            if (it->zl.eptr != ((void *)0)) {
                ...
                ((it->zl.sptr != ((void *)0))?(void)0 : (_redisAssert("it->zl.sptr != NULL","t_zset.c",1228),_exit(1)));
            }
        } else if (op->encoding == 7) {
            it->sl.zs = op->subject->ptr;
            it->sl.node = it->sl.zs->zsl->header->level[0].forward;
        } else {
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1234),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1237),_exit(1);
    }
}
...
void zuiClearIterator(zsetopsrc *op) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1252),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        if (op->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1261),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1264),_exit(1);
    }
}
...
int zuiLength(zsetopsrc *op) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            return ((it->ht.dict)->ht[0].used+(it->ht.dict)->ht[1].used);
        } else {
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1279),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        if (op->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1288),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1291),_exit(1);
    }
}
...
int zuiNext(zsetopsrc *op, zsetopval *val) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1328),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        if (op->encoding == 5) {
            ...
            if (it->zl.eptr == ((void *)0) || it->zl.sptr == ((void *)0))
                return 0;
            ((ziplistGet(it->zl.eptr,&val->estr,&val->elen,&val->ell))?(void)0 : (_redisAssert("ziplistGet(it->zl.eptr,&val->estr,&val->elen,&val->ell)","t_zset.c",1336),_exit(1)));
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1350),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1353),_exit(1);
    }
    return 1;
}
...
int zuiLongLongFromValue(zsetopval *val) {
    if (!(val->flags & 2)) {
        ...
        if (val->ele != ((void *)0)) {
            if (val->ele->encoding == 1) {
                val->ell = (long)val->ele->ptr;
                val->flags |= 4;
            } else if (val->ele->encoding == 0) {
                if (string2ll(val->ele->ptr,sdslen(val->ele->ptr),&val->ell))
                    val->flags |= 4;
            } else {
                _redisPanic("\"Unsupported element encoding\"","t_zset.c",1370),_exit(1);
            }
    ...
    if (val->estr == ((void *)0)) {
        if (val->ele != ((void *)0)) {
            if (val->ele->encoding == 1) {
                ...
                _redisPanic("\"Unsupported element encoding\"","t_zset.c",1405),_exit(1);
            }
        } else {
...
int zuiFind(zsetopsrc *op, zsetopval *val, double *score) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            if (dictFind(it->ht.dict,val->ele) != ((void *)0)) {
                *score = 1.0;
                return 1;
            } else {
                return 0;
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1440),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        zuiObjectFromValue(val);
        ...
        if (op->encoding == 5) {
            if (zzlFind(it->zl.zl,val->ele,score) != ((void *)0)) {
            ...
            dictEntry *de;
            if ((de = dictFind(it->sl.zs->dict,val->ele)) != ((void *)0)) {
                *score = *(double*)((de)->v.val);
                return 1;
            } else {
                return 0;
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1462),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1465),_exit(1);
    }
}
...
inline static void zunionInterAggregate(double *target, double val, int aggregate) {
    if (aggregate == 1) {
        *target = *target + val;
        ...
        if ((sizeof (*target) == sizeof (float) ? __isnanf (*target) : sizeof (*target) == sizeof (double) ? __isnan (*target) : __isnanl (*target))) *target = 0.0;
    } else if (aggregate == 2) {
        ...
        *target = val > *target ? val : *target;
        ...
        _redisPanic("\"Unknown ZUNION/INTER aggregate type\"","t_zset.c",1491),_exit(1);
    }
}
    ...
    if (op == 2) {
        ...
        if (zuiLength(&src[0]) > 0) {
            ...
            while (zuiNext(&src[0],&zval)) {
                ...
                if ((sizeof (score) == sizeof (float) ? __isnanf (score) : sizeof (score) == sizeof (double) ? __isnan (score) : __isnanl (score))) score = 0;
        ...
        for (i = 0; i < setnum; i++) {
            ...
            while (zuiNext(&src[i],&zval)) {
                ...
                if (dictFind(dstzset->dict,zuiObjectFromValue(&zval)) != ((void *)0))
                    continue;
        ...
        _redisPanic("\"Unknown operator\"","t_zset.c",1675),_exit(1);
    }
...
void zrangeGenericCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1768),_exit(1)));
        sptr = ziplistNext(zl,eptr);

        while (rangelen--) {
            ((eptr != ((void *)0) && sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL && sptr != NULL","t_zset.c",1772),_exit(1)));
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1773),_exit(1)));
            if (vstr == ((void *)0))
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"ln != NULL","t_zset.c",1806),_exit(1)));
            ele = ln->obj;
            addReplyBulk(c,ele);
            if (withscores)
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1814),_exit(1);
    }
}
...
void genericZrangebyscoreCommand(redisClient *c, int reverse) {
        ...
        while (remaining) {
            if (remaining >= 1 && !strcasecmp(c->argv[pos]->ptr,"withscores")) {
                ...
                if ((getLongFromObjectOrReply(c, c->argv[pos+1], &offset, ((void *)0)) != 0) ||
                    (getLongFromObjectOrReply(c, c->argv[pos+2], &limit, ((void *)0)) != 0)) return;
                pos += 3; remaining -= 3;
            } else {
                addReply(c,shared.syntaxerr);
                return;
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1898),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ...
        while (eptr && limit--) {
            ...
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1927),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2003),_exit(1);
    }
...
void zcountCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        sptr = ziplistNext(zl,eptr);
        score = zzlGetScore(sptr);
        ((zslValueLteMax(score,&range))?(void)0 : (_redisAssertWithInfo(c,zobj,"zslValueLteMax(score,&range)","t_zset.c",2054),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2092),_exit(1);
    }
...
void zscoreCommand(redisClient *c) {
    ...
    if ((zobj = lookupKeyReadOrReply(c,key,shared.nullbulk)) == ((void *)0) ||
        checkType(c,zobj,3)) return;

    if (zobj->encoding == 5) {
        if (zzlFind(zobj->ptr,c->argv[2],&score) != ((void *)0))
            addReplyDouble(c,score);
        else
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2134),_exit(1);
    }
}
...
void zrankGenericCommand(redisClient *c, int reverse) {
    ...
    ((ele->encoding == 0)?(void)0 : (_redisAssertWithInfo(c,ele,"ele->encoding == REDIS_ENCODING_RAW","t_zset.c",2149),_exit(1)));
    if (zobj->encoding == 5) {
        unsigned char *zl = zobj->ptr;
        unsigned char *eptr, *sptr;

        eptr = ziplistIndex(zl,0);
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",2155),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"sptr != NULL","t_zset.c",2157),_exit(1)));
        ...
        if (de != ((void *)0)) {
            ...
            ((rank)?(void)0 : (_redisAssertWithInfo(c,ele,"rank","t_zset.c",2186),_exit(1)));
            if (reverse)
                addReplyLongLong(c,llen-rank);
            else
                addReplyLongLong(c,rank-1);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2195),_exit(1);
    }
}
