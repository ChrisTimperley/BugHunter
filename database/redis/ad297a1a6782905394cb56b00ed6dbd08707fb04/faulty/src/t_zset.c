...
void zrangeGenericCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1767),_exit(1)));
        sptr = ziplistNext(zl,eptr);

        while (rangelen--) {
            ((eptr != ((void *)0) && sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL && sptr != NULL","t_zset.c",1771),_exit(1)));
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1772),_exit(1)));
            if (vstr == ((void *)0))
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"ln != NULL","t_zset.c",1805),_exit(1)));
            ele = ln->obj;
            addReplyBulk(c,ele);
            if (withscores)
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1813),_exit(1);
    }
}
...
void genericZrangebyscoreCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1897),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ...
        while (eptr && limit--) {
            ...
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1926),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2002),_exit(1);
    }
...
void zcountCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        sptr = ziplistNext(zl,eptr);
        score = zzlGetScore(sptr);
        ((zslValueLteMax(score,&range))?(void)0 : (_redisAssertWithInfo(c,zobj,"zslValueLteMax(score,&range)","t_zset.c",2053),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2091),_exit(1);
    }
...
void zscoreCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2133),_exit(1);
    }
}
...
void zrankGenericCommand(redisClient *c, int reverse) {
    ...
    ((ele->encoding == 0)?(void)0 : (_redisAssertWithInfo(c,ele,"ele->encoding == REDIS_ENCODING_RAW","t_zset.c",2148),_exit(1)));
    if (zobj->encoding == 5) {
        unsigned char *zl = zobj->ptr;
        unsigned char *eptr, *sptr;

        eptr = ziplistIndex(zl,0);
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",2154),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"sptr != NULL","t_zset.c",2156),_exit(1)));
        ...
        if (de != ((void *)0)) {
            ...
            ((rank)?(void)0 : (_redisAssertWithInfo(c,ele,"rank","t_zset.c",2185),_exit(1)));
            if (reverse)
                addReplyLongLong(c,llen-rank);
            else
                addReplyLongLong(c,rank-1);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2194),_exit(1);
    }
}
