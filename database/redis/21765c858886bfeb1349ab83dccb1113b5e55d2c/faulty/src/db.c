...
void dbAdd(redisDb *db, robj *key, robj *val) {
    ...
    ((retval == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),key,"retval == REDIS_OK","db.c",97),_exit(1)));
...
void dbOverwrite(redisDb *db, robj *key, robj *val) {
    ...
    ((de != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"de != NULL","db.c",109),_exit(1)));
...
void scanCallback(void *privdata, const dictEntry *de) {
    ...
    if (o == ((void *)0)) {
        ...
        key = ((de)->key);
        incrRefCount(key);
        val = createStringObjectFromLongDouble(*(double*)((de)->v.val));
    } else {
        _redisPanic("\"Type not handled in SCAN callback.\"","db.c",346),_exit(1);
    }
...
void scanGenericCommand(redisClient *c, robj *o, unsigned long cursor) {
    ...
    ((o == ((void *)0) || o->type == 2 || o->type == 4 || o->type == 3)?(void)0 : (_redisAssert("o == NULL || o->type == REDIS_SET || o->type == REDIS_HASH || o->type == REDIS_ZSET",
 "db.c"
# 396 "db.c"
    ,
 397
...
# 442 "db.c"
    ...
    if (ht) {
        ...
        _redisPanic("\"Not handled encoding in SCAN.\"","db.c",489),_exit(1);
    }
    ...
    while (node) {
        ...
        if (!filter && use_pattern) {
            if ((kobj->encoding == 0 || kobj->encoding == 8)) {
                ...
                ((kobj->encoding == 1)?(void)0 : (_redisAssert("kobj->encoding == REDIS_ENCODING_INT","db.c",508),_exit(1)));
    ...
    ((rv < sizeof(buf))?(void)0 : (_redisAssert("rv < sizeof(buf)","db.c",541),_exit(1)));
...
int removeExpire(redisDb *db, robj *key) {
    ...
    ((dictFind(db->dict,key->ptr) != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"dictFind(db->dict,key->ptr) != NULL","db.c",721),_exit(1)));
...
void setExpire(redisDb *db, robj *key, long long when) {
    ...
    ((kde != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"kde != NULL","db.c",730),_exit(1)));
...
long long getExpire(redisDb *db, robj *key) {
    ...
    ((dictFind(db->dict,key->ptr) != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"dictFind(db->dict,key->ptr) != NULL","db.c",746),_exit(1)));
    return ((de)->v.s64);
}
# 758 "db.c"
void propagateExpire(redisDb *db, robj *key) {
...
void expireGenericCommand(redisClient *c, long long basetime, int unit) {
    ...
    if (when <= mstime() && !server.loading && !server.masterhost) {
        ...
        ((dbDelete(c->db,key))?(void)0 : (_redisAssertWithInfo(c,key,"dbDelete(c->db,key)","db.c",846),_exit(1)));
        server.dirty++;
...
int *getKeysUsingCommandTable(struct redisCommand *cmd,robj **argv, int argc, int *numkeys) {
    ...
    for (j = cmd->firstkey; j <= last; j += cmd->keystep) {
        ((j < argc)?(void)0 : (_redisAssert("j < argc","db.c",947),_exit(1)));
        keys[i++] = j;
    }
    *numkeys = i;
    return keys;
