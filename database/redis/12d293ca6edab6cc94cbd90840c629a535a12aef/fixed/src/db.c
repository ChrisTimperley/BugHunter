...
void dbAdd(redisDb *db, robj *key, robj *val) {
    ...
    ((retval == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),key,"retval == REDIS_OK","db.c",83),_exit(1)));
...
void dbOverwrite(redisDb *db, robj *key, robj *val) {
    ...
    ((de != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"de != NULL","db.c",95),_exit(1)));
...
int removeExpire(redisDb *db, robj *key) {
    ...
    ((dictFind(db->dict,key->ptr) != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"dictFind(db->dict,key->ptr) != NULL","db.c",432),_exit(1)));
...
void setExpire(redisDb *db, robj *key, long long when) {
    ...
    ((kde != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"kde != NULL","db.c",441),_exit(1)));
...
long long getExpire(redisDb *db, robj *key) {
    ...
    ((dictFind(db->dict,key->ptr) != ((void *)0))?(void)0 : (_redisAssertWithInfo(((void *)0),key,"dictFind(db->dict,key->ptr) != NULL","db.c",457),_exit(1)));
    return ((de)->v.s64);
}
# 469 "db.c"
void propagateExpire(redisDb *db, robj *key) {
...
void expireGenericCommand(redisClient *c, long long offset, int unit) {
    ...
    if (getLongLongFromObjectOrReply(c, param, &milliseconds, ((void *)0)) != 0)
        return;
    ...
    if (milliseconds <= 0 && !server.loading && !server.masterhost) {
        ...
        ((dbDelete(c->db,key))?(void)0 : (_redisAssertWithInfo(c,key,"dbDelete(c->db,key)","db.c",550),_exit(1)));
        server.dirty++;
...
int *getKeysUsingCommandTable(struct redisCommand *cmd,robj **argv, int argc, int *numkeys) {
    ...
    for (j = cmd->firstkey; j <= last; j += cmd->keystep) {
        ((j < argc)?(void)0 : (_redisAssert("j < argc","db.c",641),_exit(1)));
        keys[i++] = j;
    }
    *numkeys = i;
    return keys;
