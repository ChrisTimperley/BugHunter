...
static void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 916, __PRETTY_FUNCTION__));
    listDelNode(server.clients,ln);
    if (c->flags & 2) {
        ln = listSearchKey(server.slaves,c);
        ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 920, __PRETTY_FUNCTION__));
...
static void decrRefCount(void *obj) {
    ...
    if (--(o->refcount) == 0) {
        ...
        default: ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1376, __PRETTY_FUNCTION__)); break;
        }
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1470, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
...
static int loadDb(char *filename) {
    ...
    while(1) {
        ...
        if (type == 0) {
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1613, __PRETTY_FUNCTION__));
        }
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 2683, __PRETTY_FUNCTION__));
