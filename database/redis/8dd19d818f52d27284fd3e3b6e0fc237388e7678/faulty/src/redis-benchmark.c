...
static void freeClient(client c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis-benchmark.c", 121, __PRETTY_FUNCTION__));
...
static client createClient(const char *cmd, size_t len) {
    ...
    if (config.randomkeys) {
        ...
        while ((p = strstr(p,":rand:")) != ((void *)0)) {
            newline = strstr(p,"\r\n");
            ((newline-(p+6) == 12) ? (void) (0) : __assert_fail ("newline-(p+6) == 12", "redis-benchmark.c", 263, __PRETTY_FUNCTION__));
            ((c->randlen < (signed)(sizeof(c->randptr)/sizeof(char*))) ? (void) (0) : __assert_fail ("c->randlen < (signed)(sizeof(c->randptr)/sizeof(char*))", "redis-benchmark.c", 264, __PRETTY_FUNCTION__));
            c->randptr[c->randlen++] = p+6;
            p = newline+2;
        }
    }

    redisSetReplyObjectFunctions(c->context,((void *)0));
    aeCreateFileEvent(config.el,c->context->fd,2,writeHandler,c);
