...
typedef struct aeEventLoop {
    ...
    aeFileEvent events[(1024*10)];
    aeFiredEvent fired[(1024*10)];
...
struct redisCommand redisCommandTable[] = {
    {"get",getCommand,2,0,((void *)0),1,1,1,0,0},
    {"set",setCommand,3,4,noPreloadGetKeys,1,1,1,0,0},
    {"setnx",setnxCommand,3,4,noPreloadGetKeys,1,1,1,0,0},
    {"setex",setexCommand,4,4,noPreloadGetKeys,2,2,1,0,0},
    {"append",appendCommand,3,4,((void *)0),1,1,1,0,0},
    {"strlen",strlenCommand,2,0,((void *)0),1,1,1,0,0},
    {"del",delCommand,-2,0,noPreloadGetKeys,1,-1,1,0,0},
    {"exists",existsCommand,2,0,((void *)0),1,1,1,0,0},
    {"setbit",setbitCommand,4,4,((void *)0),1,1,1,0,0},
    {"getbit",getbitCommand,3,0,((void *)0),1,1,1,0,0},
    {"setrange",setrangeCommand,4,4,((void *)0),1,1,1,0,0},
    {"getrange",getrangeCommand,4,0,((void *)0),1,1,1,0,0},
    {"substr",getrangeCommand,4,0,((void *)0),1,1,1,0,0},
    {"incr",incrCommand,2,4,((void *)0),1,1,1,0,0},
    {"decr",decrCommand,2,4,((void *)0),1,1,1,0,0},
    {"mget",mgetCommand,-2,0,((void *)0),1,-1,1,0,0},
    {"rpush",rpushCommand,-3,4,((void *)0),1,1,1,0,0},
    {"lpush",lpushCommand,-3,4,((void *)0),1,1,1,0,0},
    {"rpushx",rpushxCommand,3,4,((void *)0),1,1,1,0,0},
    {"lpushx",lpushxCommand,3,4,((void *)0),1,1,1,0,0},
    {"linsert",linsertCommand,5,4,((void *)0),1,1,1,0,0},
    {"rpop",rpopCommand,2,0,((void *)0),1,1,1,0,0},
    {"lpop",lpopCommand,2,0,((void *)0),1,1,1,0,0},
    {"brpop",brpopCommand,-3,0,((void *)0),1,1,1,0,0},
    {"brpoplpush",brpoplpushCommand,4,4,((void *)0),1,2,1,0,0},
    {"blpop",blpopCommand,-3,0,((void *)0),1,-2,1,0,0},
    {"llen",llenCommand,2,0,((void *)0),1,1,1,0,0},
    {"lindex",lindexCommand,3,0,((void *)0),1,1,1,0,0},
    {"lset",lsetCommand,4,4,((void *)0),1,1,1,0,0},
    {"lrange",lrangeCommand,4,0,((void *)0),1,1,1,0,0},
    {"ltrim",ltrimCommand,4,0,((void *)0),1,1,1,0,0},
    {"lrem",lremCommand,4,0,((void *)0),1,1,1,0,0},
    {"rpoplpush",rpoplpushCommand,3,4,((void *)0),1,2,1,0,0},
    {"sadd",saddCommand,-3,4,((void *)0),1,1,1,0,0},
    {"srem",sremCommand,-3,0,((void *)0),1,1,1,0,0},
    {"smove",smoveCommand,4,0,((void *)0),1,2,1,0,0},
    {"sismember",sismemberCommand,3,0,((void *)0),1,1,1,0,0},
    {"scard",scardCommand,2,0,((void *)0),1,1,1,0,0},
    {"spop",spopCommand,2,0,((void *)0),1,1,1,0,0},
    {"srandmember",srandmemberCommand,2,0,((void *)0),1,1,1,0,0},
    {"sinter",sinterCommand,-2,4,((void *)0),1,-1,1,0,0},
    {"sinterstore",sinterstoreCommand,-3,4,((void *)0),2,-1,1,0,0},
    {"sunion",sunionCommand,-2,4,((void *)0),1,-1,1,0,0},
    {"sunionstore",sunionstoreCommand,-3,4,((void *)0),2,-1,1,0,0},
    {"sdiff",sdiffCommand,-2,4,((void *)0),1,-1,1,0,0},
    {"sdiffstore",sdiffstoreCommand,-3,4,((void *)0),2,-1,1,0,0},
    {"smembers",sinterCommand,2,0,((void *)0),1,1,1,0,0},
    {"zadd",zaddCommand,-4,4,((void *)0),1,1,1,0,0},
    {"zincrby",zincrbyCommand,4,4,((void *)0),1,1,1,0,0},
    {"zrem",zremCommand,-3,0,((void *)0),1,1,1,0,0},
    {"zremrangebyscore",zremrangebyscoreCommand,4,0,((void *)0),1,1,1,0,0},
    {"zremrangebyrank",zremrangebyrankCommand,4,0,((void *)0),1,1,1,0,0},
    {"zunionstore",zunionstoreCommand,-4,4,zunionInterGetKeys,0,0,0,0,0},
    {"zinterstore",zinterstoreCommand,-4,4,zunionInterGetKeys,0,0,0,0,0},
    {"zrange",zrangeCommand,-4,0,((void *)0),1,1,1,0,0},
    {"zrangebyscore",zrangebyscoreCommand,-4,0,((void *)0),1,1,1,0,0},
    {"zrevrangebyscore",zrevrangebyscoreCommand,-4,0,((void *)0),1,1,1,0,0},
    {"zcount",zcountCommand,4,0,((void *)0),1,1,1,0,0},
    {"zrevrange",zrevrangeCommand,-4,0,((void *)0),1,1,1,0,0},
    {"zcard",zcardCommand,2,0,((void *)0),1,1,1,0,0},
    {"zscore",zscoreCommand,3,0,((void *)0),1,1,1,0,0},
    {"zrank",zrankCommand,3,0,((void *)0),1,1,1,0,0},
    {"zrevrank",zrevrankCommand,3,0,((void *)0),1,1,1,0,0},
    {"hset",hsetCommand,4,4,((void *)0),1,1,1,0,0},
    {"hsetnx",hsetnxCommand,4,4,((void *)0),1,1,1,0,0},
    {"hget",hgetCommand,3,0,((void *)0),1,1,1,0,0},
    {"hmset",hmsetCommand,-4,4,((void *)0),1,1,1,0,0},
    {"hmget",hmgetCommand,-3,0,((void *)0),1,1,1,0,0},
    {"hincrby",hincrbyCommand,4,4,((void *)0),1,1,1,0,0},
    {"hdel",hdelCommand,-3,0,((void *)0),1,1,1,0,0},
    {"hlen",hlenCommand,2,0,((void *)0),1,1,1,0,0},
    {"hkeys",hkeysCommand,2,0,((void *)0),1,1,1,0,0},
    {"hvals",hvalsCommand,2,0,((void *)0),1,1,1,0,0},
    {"hgetall",hgetallCommand,2,0,((void *)0),1,1,1,0,0},
    {"hexists",hexistsCommand,3,0,((void *)0),1,1,1,0,0},
    {"incrby",incrbyCommand,3,4,((void *)0),1,1,1,0,0},
    {"decrby",decrbyCommand,3,4,((void *)0),1,1,1,0,0},
    {"getset",getsetCommand,3,4,((void *)0),1,1,1,0,0},
    {"mset",msetCommand,-3,4,((void *)0),1,-1,2,0,0},
    {"msetnx",msetnxCommand,-3,4,((void *)0),1,-1,2,0,0},
    {"randomkey",randomkeyCommand,1,0,((void *)0),0,0,0,0,0},
    {"select",selectCommand,2,0,((void *)0),0,0,0,0,0},
    {"move",moveCommand,3,0,((void *)0),1,1,1,0,0},
    {"rename",renameCommand,3,0,renameGetKeys,1,2,1,0,0},
    {"renamenx",renamenxCommand,3,0,renameGetKeys,1,2,1,0,0},
    {"expire",expireCommand,3,0,((void *)0),1,1,1,0,0},
    {"expireat",expireatCommand,3,0,((void *)0),1,1,1,0,0},
    {"keys",keysCommand,2,0,((void *)0),0,0,0,0,0},
    {"dbsize",dbsizeCommand,1,0,((void *)0),0,0,0,0,0},
    {"auth",authCommand,2,0,((void *)0),0,0,0,0,0},
    {"ping",pingCommand,1,0,((void *)0),0,0,0,0,0},
    {"echo",echoCommand,2,0,((void *)0),0,0,0,0,0},
    {"save",saveCommand,1,0,((void *)0),0,0,0,0,0},
    {"bgsave",bgsaveCommand,1,0,((void *)0),0,0,0,0,0},
    {"bgrewriteaof",bgrewriteaofCommand,1,0,((void *)0),0,0,0,0,0},
    {"shutdown",shutdownCommand,1,0,((void *)0),0,0,0,0,0},
    {"lastsave",lastsaveCommand,1,0,((void *)0),0,0,0,0,0},
    {"type",typeCommand,2,0,((void *)0),1,1,1,0,0},
    {"multi",multiCommand,1,0,((void *)0),0,0,0,0,0},
    {"exec",execCommand,1,4,((void *)0),0,0,0,0,0},
    {"discard",discardCommand,1,0,((void *)0),0,0,0,0,0},
    {"sync",syncCommand,1,0,((void *)0),0,0,0,0,0},
    {"flushdb",flushdbCommand,1,0,((void *)0),0,0,0,0,0},
    {"flushall",flushallCommand,1,0,((void *)0),0,0,0,0,0},
    {"sort",sortCommand,-2,4,((void *)0),1,1,1,0,0},
    {"info",infoCommand,-1,0,((void *)0),0,0,0,0,0},
    {"monitor",monitorCommand,1,0,((void *)0),0,0,0,0,0},
    {"ttl",ttlCommand,2,0,((void *)0),1,1,1,0,0},
    {"persist",persistCommand,2,0,((void *)0),1,1,1,0,0},
    {"slaveof",slaveofCommand,3,0,((void *)0),0,0,0,0,0},
    {"debug",debugCommand,-2,0,((void *)0),0,0,0,0,0},
    {"config",configCommand,-2,0,((void *)0),0,0,0,0,0},
    ...
    {"publish",publishCommand,3,8,((void *)0),0,0,0,0,0},
    {"watch",watchCommand,-2,0,noPreloadGetKeys,1,-1,1,0,0},
    {"unwatch",unwatchCommand,1,0,((void *)0),0,0,0,0,0},
    {"cluster",clusterCommand,-2,0,((void *)0),0,0,0,0,0},
    {"restore",restoreCommand,4,0,((void *)0),0,0,0,0,0},
    {"migrate",migrateCommand,6,0,((void *)0),0,0,0,0,0},
    {"dump",dumpCommand,2,0,((void *)0),0,0,0,0,0},
    {"object",objectCommand,-2,0,((void *)0),0,0,0,0,0},
    {"client",clientCommand,-2,0,((void *)0),0,0,0,0,0}
};
...
void activeExpireCycle(void) {
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        do {
            long num = ((db->expires)->ht[0].used+(db->expires)->ht[1].used);
            time_t now = time(((void *)0));
...
void updateLRUClock(void) {
    server.lruclock = (time(((void *)0))/10) &
                                                ((1<<21)-1);
}
...
# 587 "redis.c"
    ...
    if (server.shutdown_asap) {
        if (prepareForShutdown() == 0) exit(0);
    ...
    if (!(loops % 50)) {
        redisLog(1,"%d clients connected (%d slaves), %zu bytes in use",
        ...
        if (server.bgsavethread != (pthread_t) -1) {
             ...
             server.appendonly_current_size > server.auto_aofrewrite_min_size)
         {
            ...
            if (growth >= server.auto_aofrewrite_perc) {
                redisLog(2,"Starting automatic rewriting of AOF on %d growth",growth);
                rewriteAppendOnlyFileBackground();
            }
         }
    }
    ...
    if (server.masterhost == ((void *)0)) activeExpireCycle();
...
void beforeSleep(struct aeEventLoop *eventLoop) {
    ...
    if (server.ds_enabled && ((server.io_ready_clients)->len)) {
        listIter li;
        ...
        while((ln = listNext(&li))) {
            ...
            aeCreateFileEvent(server.el, c->fd, 1,
                readQueryFromClient, c);
            cmd = lookupCommand(c->argv[0]->ptr);
            ((cmd != ((void *)0))?(void)0 : (_redisAssert("cmd != NULL","redis.c",752),_exit(1)));
            call(c,cmd);
            resetClient(c);
    ...
    while (((server.unblocked_clients)->len)) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","redis.c",764),_exit(1)));
        c = ln->value;
...
void initServerConfig() {
    ...
    server.auto_aofrewrite_perc = 100;
    server.auto_aofrewrite_min_size = (1024*1024);
    server.auto_aofrewrite_base_size = 0;
    server.aofrewrite_scheduled = 0;
    server.lastfsync = time(((void *)0));
    server.appendfd = -1;
    ...
    server.cache_max_memory = 64LL*1024*1024;
    server.cache_blocked_clients = 0;
    server.hash_max_zipmap_entries = 512;
    server.hash_max_zipmap_value = 64;
...
void initServer() {
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        if (server.ds_enabled) {
            ...
            server.db[j].io_negcache = dictCreate(&setDictType,((void *)0));
            server.db[j].io_queued = dictCreate(&setDictType,((void *)0));
        }
        server.db[j].id = j;
    }
    ...
    server.unixtime = time(((void *)0));
    aeCreateTimeEvent(server.el, 1, serverCron, ((void *)0), ((void *)0));
    if (server.ipfd > 0 && aeCreateFileEvent(server.el,server.ipfd,1,
        acceptTcpHandler,((void *)0)) == -1) oom("creating file event");
    if (server.sofd > 0 && aeCreateFileEvent(server.el,server.sofd,1,
        acceptUnixHandler,((void *)0)) == -1) oom("creating file event");

    if (server.appendonly) {
        server.appendfd = open(server.appendfilename,01|02000|0100,0644);
...
void populateCommandTable(void) {
    ...
    for (j = 0; j < numcommands; j++) {
        ...
        ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1026, __PRETTY_FUNCTION__));
    }
}
...
int processCommand(redisClient *c) {
    ...
    if (server.cluster_enabled &&
                !(cmd->getkeys_proc == ((void *)0) && cmd->firstkey == 0)) {
        int hashslot;
    ...
    if (server.masterhost && server.replstate != 4 &&
    ...
    if (allsections || defsections || !strcasecmp(section,"diskstore")) {
        ...
        if (server.ds_enabled) {
            ...
            info = sdscatprintf(info,
                ...
                (unsigned long) ((server.cache_io_queue)->len),
                (unsigned long) ((server.io_newjobs)->len),
                (unsigned long) ((server.io_processing)->len),
                (unsigned long) ((server.io_processed)->len),
                (unsigned long) ((server.io_ready_clients)->len)
            );
            unlockThreadedIO();
        }
    }
        ...
        if (server.masterhost) {
            info = sdscatprintf(info,
                ...
                (server.replstate == 4) ?
                    "up" : "down",
                server.master ?
                ((int)(time(((void *)0))-server.master->lastinteraction)) : -1,
                server.replstate == 3
            );

            if (server.replstate == 3) {
                info = sdscatprintf(info,
                    "master_sync_left_bytes:%ld\r\n"
                    "master_sync_last_io_seconds_ago:%d\r\n"
                    ,(long)server.repl_transfer_left,
                    (int)(time(((void *)0))-server.repl_transfer_lastio)
                );
            }
        }
        info = sdscatprintf(info,
...
void freeMemoryIfNeeded(void) {
    ...
    if (server.maxmemory_policy == 5) return;
...
int main(int argc, char **argv) {
    ...
    redisAsciiArt();
    redisLog(2,"Server started, Redis version " "2.9.0");

    linuxOvercommitMemoryWarning();

    start = ustime();
    if (server.ds_enabled) {
        redisLog(2,"DB not loaded (running with disk back end)");
    } else if (server.appendonly) {
        if (loadAppendOnlyFile(server.appendfilename) == 0)
            redisLog(2,"DB loaded from append only file: %.3f seconds",(float)(ustime()-start)/1000000);
    } else {
        if (rdbLoad(server.dbfilename) == 0)
            redisLog(2,"DB loaded from disk: %.3f seconds",(float)(ustime()-start)/1000000);
    }
    if (server.ipfd > 0)
...
static void sigsegvHandler(int sig, siginfo_t *info, void *secret) {
    ...
    redisLog(3,
        "======= Ooops! Redis %s got signal: -%d- =======", "2.9.0", sig);
    infostring = genRedisInfoString("all");
    redisLogRaw(3, infostring);
...
static void sigtermHandler(int sig) {
    ...
    redisLog(3,"Received SIGTERM, scheduling shutdown...");
