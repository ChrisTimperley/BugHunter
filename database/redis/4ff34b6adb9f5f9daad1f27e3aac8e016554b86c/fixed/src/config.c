    ...
    while(fgets(buf,1024 +1,fp) != ((void *)0)) {
        ...
        if (!strcasecmp(argv[0],"timeout") && argc == 2) {
         ...
         server.masterauth = zstrdup(argv[1]);
            ...
            redisLog(3, "Deprecated configuration directive: \"%s\"", argv[0]);
                   ...
                   argc == 2)
        {
            ...
            if (server.auto_aofrewrite_perc < 0) {
                ...
                goto loaderr;
                   ...
                   argc == 2)
        {
            server.auto_aofrewrite_min_size = memtoll(argv[1],((void *)0));
            ...
            server.cache_max_memory = memtoll(argv[1],((void *)0));
            ...
            server.hash_max_zipmap_entries = memtoll(argv[1], ((void *)0));
        } else if (!strcasecmp(argv[0],"hash-max-zipmap-value") && argc == 2) {
            server.hash_max_zipmap_value = memtoll(argv[1], ((void *)0));
            ...
            ((retval == 0)?(void)0 : (_redisAssert("retval == DICT_OK","config.c",292),_exit(1)));
...
void configSetCommand(redisClient *c) {
    robj *o;
    long long ll;
    ((c->argv[2]->encoding == 0)?(void)0 : (_redisAssert("c->argv[2]->encoding == REDIS_ENCODING_RAW","config.c",337),_exit(1)));
    ((c->argv[3]->encoding == 0)?(void)0 : (_redisAssert("c->argv[3]->encoding == REDIS_ENCODING_RAW","config.c",338),_exit(1)));
    o = c->argv[3];
...
void configGetCommand(redisClient *c) {
    ...
    char buf[128];
    int matches = 0;
    ((o->encoding == 0)?(void)0 : (_redisAssert("o->encoding == REDIS_ENCODING_RAW","config.c",495),_exit(1)));
