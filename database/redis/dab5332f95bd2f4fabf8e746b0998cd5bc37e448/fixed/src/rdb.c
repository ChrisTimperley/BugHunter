...
robj *rdbLoadIntegerObject(rio *rdb, int enctype, int encode) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        _redisPanic("\"Unknown RDB integer encoding type\"","rdb.c",156),_exit(1);
    }
    if (encode)
...
int rdbSaveLongLongAsStringObject(rio *rdb, long long value) {
    ...
    if (enclen > 0) {
        ...
        ((enclen < 32)?(void)0 : (_redisAssert("enclen < 32","rdb.c",283),_exit(1)));
...
int rdbSaveStringObject(rio *rdb, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        ((obj->encoding == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),obj,"obj->encoding == REDIS_ENCODING_RAW","rdb.c",299),_exit(1)));
...
robj *rdbGenericLoadStringObject(rio *rdb, int encode) {
    ...
    if (isencoded) {
        ...
        default:
            _redisPanic("\"Unknown RDB encoding type\"","rdb.c",319),_exit(1);
        }
    }
...
int rdbSaveObjectType(rio *rdb, robj *o) {
    ...
    case 1:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",411),_exit(1);
    case 2:
        if (o->encoding == 6)
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",418),_exit(1);
    case 3:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",425),_exit(1);
    case 4:
        if (o->encoding == 3)
            return rdbSaveType(rdb,9);
        else if (o->encoding == 2)
            return rdbSaveType(rdb,4);
        else
            _redisPanic("\"Unknown hash encoding\"","rdb.c",432),_exit(1);
    default:
        _redisPanic("\"Unknown object type\"","rdb.c",434),_exit(1);
    }
    return -1;
}
...
int rdbSaveObject(rio *rdb, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",477),_exit(1);
        }
    } else if (o->type == 2) {
        ...
        if (o->encoding == 2) {
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",501),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",529),_exit(1);
        }
    } else if (o->type == 4) {
        ...
        _redisPanic("\"Unknown object type\"","rdb.c",557),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    ...
    ((len != -1)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"len != -1","rdb.c",568),_exit(1)));
    return len;
}
...
int rdbSaveBackground(char *filename) {
    ...
    if (server.bgsavechildpid != -1) return -1;
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        if ((hashlen = rdbLoadLen(rdb,((void *)0))) == (2147483647 * 2U + 1U)) return ((void *)0);
        o = createHashObject();
        ...
        while(hashlen--) {
            ...
            if ((key = rdbLoadEncodedStringObject(rdb)) == ((void *)0)) return ((void *)0);
            if ((val = rdbLoadEncodedStringObject(rdb)) == ((void *)0)) return ((void *)0);
            ...
            if (o->encoding == 3) {
                ...
                zm = zipmapSet(zm,deckey->ptr,sdslen(deckey->ptr),
                                  decval->ptr,sdslen(decval->ptr),((void *)0));
                o->ptr = zm;
                decrRefCount(deckey);
                decrRefCount(decval);
                decrRefCount(key);
               ...
               rdbtype == 12)
    {
        ...
        switch(rdbtype) {
            ...
            case 12:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",917),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",921),_exit(1);
    }
    return o;
}
...
void bgsaveCommand(redisClient *c) {
    ...
    } else if (rdbSaveBackground(server.dbfilename) == 0) {
