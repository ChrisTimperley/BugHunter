...
void *rdbLoadIntegerObject(rio *rdb, int enctype, int flags) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        _redisPanic("\"Unknown RDB integer encoding type\"","rdb.c",191),_exit(1);
    }
    if (plain) {
        char buf[21], *p;
...
int rdbSaveLongLongAsStringObject(rio *rdb, long long value) {
    ...
    if (enclen > 0) {
        ...
        ((enclen < 32)?(void)0 : (_redisAssert("enclen < 32","rdb.c",350),_exit(1)));
...
int rdbSaveStringObject(rio *rdb, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        (((obj->encoding == 0 || obj->encoding == 8))?(void)0 : (_redisAssertWithInfo(((void *)0),obj,"sdsEncodedObject(obj)","rdb.c",366),_exit(1)));
...
void *rdbGenericLoadStringObject(rio *rdb, int flags) {
    ...
    if (isencoded) {
        ...
        default:
            _redisPanic("\"Unknown RDB encoding type\"","rdb.c",397),_exit(1);
        }
    }
...
int rdbSaveObjectType(rio *rdb, robj *o) {
    ...
    case 1:
        if (o->encoding == 9)
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",497),_exit(1);
    case 2:
        if (o->encoding == 6)
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",504),_exit(1);
    case 3:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",511),_exit(1);
    case 4:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",518),_exit(1);
    default:
        _redisPanic("\"Unknown object type\"","rdb.c",520),_exit(1);
    }
    return -1;
}
...
int rdbSaveObject(rio *rdb, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 9) {
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",563),_exit(1);
        }
    } else if (o->type == 2) {
        ...
        if (o->encoding == 2) {
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",587),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",615),_exit(1);
        }
    } else if (o->type == 4) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",644),_exit(1);
        }

    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",648),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    int len = rdbSaveObject(((void *)0),o);
    ((len != -1)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"len != -1","rdb.c",659),_exit(1)));
    return len;
}
...
int rdbSaveInfoAuxFields(rio *rdb) {
    ...
    if (rdbSaveAuxFieldStrStr(rdb,"redis-ver","2.9.999") == -1) return -1;
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while (o->encoding == 5 && len > 0) {
            ...
            (((field->encoding == 0 || field->encoding == 8))?(void)0 : (_redisAssert("sdsEncodedObject(field)","rdb.c",1044),_exit(1)));
            value = rdbLoadStringObject(rdb);
            if (value == ((void *)0)) return ((void *)0);
            (((value->encoding == 0 || value->encoding == 8))?(void)0 : (_redisAssert("sdsEncodedObject(value)","rdb.c",1047),_exit(1)));
        ...
        while (o->encoding == 2 && len > 0) {
            ...
            ((ret == 0)?(void)0 : (_redisAssert("ret == DICT_OK","rdb.c",1081),_exit(1)));
        }


        ((len == 0)?(void)0 : (_redisAssert("len == 0","rdb.c",1085),_exit(1)));
    } else if (rdbtype == 14) {
        if ((len = rdbLoadLen(rdb,((void *)0))) == (2147483647 * 2U + 1U)) return ((void *)0);
        o = createQuicklistObject();
        quicklistSetOptions(o->ptr, server.list_max_ziplist_size,
               ...
               rdbtype == 13)
    {
        ...
        switch(rdbtype) {
            ...
            case 13:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",1167),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",1171),_exit(1);
    }
    return o;
}
    ...
    while(1) {
        ...
        if (type == 253) {
            ...
            if (((char*)auxkey->ptr)[0] == '%') {
                ...
                redisLog(2,"RDB '%s': %s", auxkey->ptr, auxval->ptr);
            } else {
...
void backgroundSaveDoneHandler(int exitcode, int bysignal) {
    ...
    case 2:
        ...
        break;
    default:
        _redisPanic("\"Unknown RDB child type.\"","rdb.c",1518),_exit(1);
        break;
    }
}
