...
static int tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1875, __PRETTY_FUNCTION__));
...
static robj *getDecodedObject(const robj *o) {
    ...
    ((o->encoding != 0) ? (void) (0) : __assert_fail ("o->encoding != 0", "redis.c", 1891, __PRETTY_FUNCTION__));
    if (o->type == 0 && o->encoding == 1) {
        ...
        ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 1899, __PRETTY_FUNCTION__));
    }
}

static int compareStringObjects(robj *a, robj *b) {
    ((a->type == 0 && b->type == 0) ? (void) (0) : __assert_fail ("a->type == 0 && b->type == 0", "redis.c", 1904, __PRETTY_FUNCTION__));
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2149, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
...
static robj *rdbLoadIntegerObject(FILE *fp, int enctype) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2284, __PRETTY_FUNCTION__));
    }
...
static robj *rdbLoadStringObject(FILE*fp, int rdbver) {
    ...
    if (isencoded) {
        ...
        default:
            ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2323, __PRETTY_FUNCTION__));
        }
    }
    ...
    if (o == ((void *)0)) {
        ...
        if (o->type != 0) {
            ...
            if (o->encoding == 0)
                ...
                ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 2560, __PRETTY_FUNCTION__));
        }
    }
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 3737, __PRETTY_FUNCTION__));
                ...
                if (alpha) {
                    ...
                    if (byval->encoding == 0) {
                        ...
                        if (byval->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 3761, __PRETTY_FUNCTION__));
                    }
                }
            } else {
                if (!alpha) {
                    if (vector[j].obj->encoding == 0)
                        ...
                        if (vector[j].obj->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 3772, __PRETTY_FUNCTION__));
                    }
                }
            }
        }
