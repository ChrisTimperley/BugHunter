...
static void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1185, __PRETTY_FUNCTION__));
    ...
    if (c->flags & 2) {
        ...
        ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1192, __PRETTY_FUNCTION__));
        listDelNode(l,ln);
    }
    if (c->flags & 4) {
        server.master = ((void *)0);
...
static void decrRefCount(void *obj) {
    ...
    if (--(o->refcount) == 0) {
        ...
        default: ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1758, __PRETTY_FUNCTION__)); break;
        }
...
static robj *tryObjectSharing(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1803, __PRETTY_FUNCTION__));
    ...
    if (de) {
        ...
        if (((server.sharingpool)->used) >=
            ...
            ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 1821, __PRETTY_FUNCTION__));
            c = ((unsigned long) ((de)->val))-1;
            ((de)->val) = (void*) c;
            if (c == 0) {
        ...
        if (c == 0) {
            ...
            ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1834, __PRETTY_FUNCTION__));
            incrRefCount(o);
        }
        return o;
    }
...
static int tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1877, __PRETTY_FUNCTION__));
...
static robj *getDecodedObject(const robj *o) {
    ...
    ((o->encoding != 0) ? (void) (0) : __assert_fail ("o->encoding != 0", "redis.c", 1893, __PRETTY_FUNCTION__));
    if (o->type == 0 && o->encoding == 1) {
        ...
        ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 1901, __PRETTY_FUNCTION__));
    }
}

static int compareStringObjects(robj *a, robj *b) {
    ((a->type == 0 && b->type == 0) ? (void) (0) : __assert_fail ("a->type == 0 && b->type == 0", "redis.c", 1906, __PRETTY_FUNCTION__));
...
static size_t stringObjectLen(robj *o) {
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1925, __PRETTY_FUNCTION__));
    if (o->encoding == 0) {
        return sdslen(o->ptr);
    } else {
        char buf[32];
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2162, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
...
static robj *rdbLoadIntegerObject(FILE *fp, int enctype) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2297, __PRETTY_FUNCTION__));
    }
...
static robj *rdbLoadStringObject(FILE*fp, int rdbver) {
    ...
    if (isencoded) {
        ...
        default:
            ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2336, __PRETTY_FUNCTION__));
        }
    }
...
static int rdbLoad(char *filename) {
    ...
    while(1) {
        ...
        if (type == 0) {
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2426, __PRETTY_FUNCTION__));
        }
    ...
    if (o == ((void *)0)) {
        ...
        if (o->type != 0) {
            ...
            if (o->encoding == 0)
                ...
                ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 2573, __PRETTY_FUNCTION__));
        }
    }
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 3752, __PRETTY_FUNCTION__));
                ...
                if (alpha) {
                    ...
                    if (byval->encoding == 0) {
                        ...
                        if (byval->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 3776, __PRETTY_FUNCTION__));
                    }
                }
            } else {
                if (!alpha) {
                    if (vector[j].obj->encoding == 0)
                        ...
                        if (vector[j].obj->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 3787, __PRETTY_FUNCTION__));
                    }
                }
            }
        }
