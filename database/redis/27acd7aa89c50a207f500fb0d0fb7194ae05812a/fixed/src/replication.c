...
void replicationAbortSyncTransfer(void) {
    ((server.replstate == 3)?(void)0 : (_redisAssert("server.replstate == REDIS_REPL_TRANSFER","replication.c",268),_exit(1)));
...
void undoConnectWithMaster(void) {
    ...
    ((server.replstate == 2)?(void)0 : (_redisAssert("server.replstate == REDIS_REPL_CONNECTING","replication.c",485),_exit(1)));
    aeDeleteFileEvent(server.el,fd,1|2);
    close(fd);
