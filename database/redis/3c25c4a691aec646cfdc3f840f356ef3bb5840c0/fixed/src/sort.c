...
void sortCommand(redisClient *c) {
    ...
    default: vectorlen = 0; _redisPanic("\"Bad SORT type\"","sort.c",234),_exit(1);
    }
    ...
    if (sortval->type == 1) {
        ...
        _redisPanic("\"Unknown type\"","sort.c",272),_exit(1);
    }
    ((j == vectorlen)?(void)0 : (_redisAssertWithInfo(c,sortval,"j == vectorlen","sort.c",274),_exit(1)));
        ...
        for (j = 0; j < vectorlen; j++) {
            ...
            if (alpha) {
                ...
                if (byval->encoding == 0) {
                    ...
                    ((1 != 1)?(void)0 : (_redisAssertWithInfo(c,sortval,"1 != 1","sort.c",307),_exit(1)));
                }
            }
        ...
        for (j = start; j <= end; j++) {
            ...
            while((ln = listNext(&li))) {
                ...
                if (sop->type == 0) {
                    ...
                    ((sop->type == 0)?(void)0 : (_redisAssertWithInfo(c,sortval,"sop->type == REDIS_SORT_GET","sort.c",368),_exit(1)));
                }
            }
        }
    } else {
            ...
            if (!getop) {
                ...
                while((ln = listNext(&li))) {
                    ...
                    if (sop->type == 0) {
                        ...
                        ((sop->type == 0)?(void)0 : (_redisAssertWithInfo(c,sortval,"sop->type == REDIS_SORT_GET","sort.c",399),_exit(1)));
                    }
                }
            }
        }
