...
robj *dupLastObjectIfNeeded(list *reply) {
    robj *new, *cur;
    listNode *ln;
    ((((reply)->len) > 0)?(void)0 : (_redisAssert("listLength(reply) > 0","networking.c",100),_exit(1)));
    ln = ((reply)->tail);
    cur = ((ln)->value);
    if (cur->refcount > 1) {
...
# 227 "networking.c"
    if (obj->encoding == 0) {
        ...
        _redisPanic("\"Wrong obj->encoding in addReply()\"","networking.c",249),_exit(1);
    }
}
...
void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",548),_exit(1)));
    listDelNode(server.clients,ln);


    if (c->flags & 256) {
        ln = listSearchKey(server.unblocked_clients,c);
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",554),_exit(1)));
    ...
    if (c->flags & 1) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",565),_exit(1)));
        listDelNode(l,ln);
    }
...
# 583 "networking.c"
    ...
    if (c->flags & 2048) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",595),_exit(1)));
...
int processMultibulkBuffer(redisClient *c) {
    ...
    if (c->multibulklen == 0) {
        ...
        ((c->argc == 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->argc == 0","networking.c",801),_exit(1)));
        ...
        ((c->querybuf[0] == '*')?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->querybuf[0] == '*'","networking.c",819),_exit(1)));
    ...
    ((c->multibulklen > 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->multibulklen > 0","networking.c",840),_exit(1)));
...
void processInputBuffer(redisClient *c) {
    ...
    while(sdslen(c->querybuf)) {
        ...
        if (c->reqtype == 1) {
            ...
            _redisPanic("\"Unknown request type\"","networking.c",951),_exit(1);
        }
...
void rewriteClientCommandVector(redisClient *c, int argc, ...) {
    ...
    ((c->cmd != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->cmd != NULL","networking.c",1172),_exit(1)));
    __builtin_va_end(ap);
}
...
void rewriteClientCommandArgument(redisClient *c, int i, robj *newval) {
    ...
    ((i < c->argc)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"i < c->argc","networking.c",1181),_exit(1)));
    oldval = c->argv[i];
    c->argv[i] = newval;
    incrRefCount(newval);
    decrRefCount(oldval);
    ...
    if (i == 0) {
        c->cmd = lookupCommand(c->argv[0]->ptr);
        ((c->cmd != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->cmd != NULL","networking.c",1190),_exit(1)));
    }
}
# 1207 "networking.c"
unsigned long getClientOutputBufferMemoryUsage(redisClient *c) {
...
int getClientLimitClassByName(char *name) {
    ...
    else if (!strcasecmp(name,"pubsub")) return 1;
    else return -1;
}
