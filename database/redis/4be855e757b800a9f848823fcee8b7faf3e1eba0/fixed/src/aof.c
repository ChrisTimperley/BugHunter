...
int loadAppendOnlyFile(char *filename) {
    ...
    while(1) {
        ...
        ((fakeClient->bufpos == 0 && ((fakeClient->reply)->len) == 0)?(void)0 : (_redisAssert("fakeClient->bufpos == 0 && listLength(fakeClient->reply) == 0","aof.c",376),_exit(1)));

        (((fakeClient->flags & 16) == 0)?(void)0 : (_redisAssert("(fakeClient->flags & REDIS_BLOCKED) == 0","aof.c",378),_exit(1)));
...
int rioWriteBulkObject(rio *r, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        _redisPanic("\"Unknown string encoding\"","aof.c",421),_exit(1);
    }
}
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                if (o->encoding == 5) {
                    ...
                    _redisPanic("\"Unknown list encoding\"","aof.c",517),_exit(1);
                }
            } else if (o->type == 2) {
                char cmd[]="*3\r\n$4\r\nSADD\r\n";
                ...
                if (o->encoding == 6) {
                    ...
                    _redisPanic("\"Unknown set encoding\"","aof.c",542),_exit(1);
                }
            } else if (o->type == 3) {
                ...
                if (o->encoding == 5) {
                    ...
                    ((eptr != ((void *)0))?(void)0 : (_redisAssert("eptr != NULL","aof.c",557),_exit(1)));
                    sptr = ziplistNext(zl,eptr);
                    ((sptr != ((void *)0))?(void)0 : (_redisAssert("sptr != NULL","aof.c",559),_exit(1)));

                    while (eptr != ((void *)0)) {
                        ((ziplistGet(eptr,&vstr,&vlen,&vll))?(void)0 : (_redisAssert("ziplistGet(eptr,&vstr,&vlen,&vll)","aof.c",562),_exit(1)));
                    ...
                    _redisPanic("\"Unknown sorted set encoding\"","aof.c",593),_exit(1);
                }
            } else if (o->type == 4) {
                char cmd[]="*4\r\n$4\r\nHSET\r\n";
                ...
                _redisPanic("\"Unknown object type\"","aof.c",628),_exit(1);
            }
