...
void memtest_fill_random(unsigned long *l, size_t bytes) {
    ...
    (((bytes & 4095) == 0) ? (void) (0) : __assert_fail ("(bytes & 4095) == 0", "memtest.c", 96, __PRETTY_FUNCTION__));
                        ...
                        unsigned long v2, char sym)
{
    ...
    (((bytes & 4095) == 0) ? (void) (0) : __assert_fail ("(bytes & 4095) == 0", "memtest.c", 128, __PRETTY_FUNCTION__));
    for (off = 0; off < step; off++) {
        l1 = l+off;
        l2 = l1+words;
        v = (off & 1) ? v2 : v1;
...
void memtest_compare(unsigned long *l, size_t bytes) {
    ...
    (((bytes & 4095) == 0) ? (void) (0) : __assert_fail ("(bytes & 4095) == 0", "memtest.c", 155, __PRETTY_FUNCTION__));
    l1 = l;
    l2 = l1+words;
    for (w = 0; w < words; w++) {
        if (*l1 != *l2) {
