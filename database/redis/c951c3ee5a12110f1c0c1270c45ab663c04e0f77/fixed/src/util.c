        ...
        case '[':
        {
            ...
            while(1) {
                if (pattern[0] == '\\') {
                    ...
                    if (nocase) {
                        start = (__extension__ ({ int __res; if (sizeof (start) > 1) { if (__builtin_constant_p (start)) { int __c = (start); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (start); } else __res = (*__ctype_tolower_loc ())[(int) (start)]; __res; }));
                        end = (__extension__ ({ int __res; if (sizeof (end) > 1) { if (__builtin_constant_p (end)) { int __c = (end); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (end); } else __res = (*__ctype_tolower_loc ())[(int) (end)]; __res; }));
                    ...
                    if (!nocase) {
                        ...
                        if ((__extension__ ({ int __res; if (sizeof ((int)pattern[0]) > 1) { if (__builtin_constant_p ((int)pattern[0])) { int __c = ((int)pattern[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)pattern[0]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)pattern[0])]; __res; })) == (__extension__ ({ int __res; if (sizeof ((int)string[0]) > 1) { if (__builtin_constant_p ((int)string[0])) { int __c = ((int)string[0]); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower ((int)string[0]); } else __res = (*__ctype_tolower_loc ())[(int) ((int)string[0])]; __res; })))
                            match = 1;
                    }
                }
                pattern++;
...
long long memtoll(const char *p, int *err) {
    ...
    u = p;
    if (*u == '-') u++;
    while(*u && ((*__ctype_b_loc ())[(int) ((*u))] & (unsigned short int) _ISdigit)) u++;
...
int ll2string(char* dst, size_t dstlen, long long svalue) {
    ...
    if (svalue < 0) {
        if (svalue != (-9223372036854775807LL - 1LL)) {
            value = -svalue;
        } else {
            value = ((unsigned long long) 9223372036854775807LL)+1;
        }
        negative = 1;
    } else {
        value = svalue;
...
int string2ll(const char *s, size_t slen, long long *value) {
    ...
    while (plen < slen && p[0] >= '0' && p[0] <= '9') {
        if (v > ((9223372036854775807LL * 2ULL + 1ULL) / 10))
            return 0;
        v *= 10;

        if (v > ((9223372036854775807LL * 2ULL + 1ULL) - (p[0]-'0')))
            return 0;
        v += p[0]-'0';
    ...
    if (negative) {
        if (v > ((unsigned long long)(-((-9223372036854775807LL - 1LL)+1))+1))
            return 0;
        if (value != ((void *)0)) *value = -v;
    } else {
        if (v > 9223372036854775807LL)
            return 0;
        if (value != ((void *)0)) *value = v;
    }
    return 1;
...
int string2l(const char *s, size_t slen, long *lval) {
    ...
    if (llval < (-9223372036854775807L - 1L) || llval > 9223372036854775807L)
        return 0;
...
int d2string(char *buf, size_t len, double value) {
    if ((sizeof (value) == sizeof (float) ? __isnanf (value) : sizeof (value) == sizeof (double) ? __isnan (value) : __isnanl (value))) {
        len = snprintf(buf,len,"nan");
    } else if ((sizeof (value) == sizeof (float) ? __isinff (value) : sizeof (value) == sizeof (double) ? __isinf (value) : __isinfl (value))) {
        if (value < 0)
...
void getRandomHexChars(char *p, unsigned int len) {
    ...
    if (fp == ((void *)0) || fread(p,len,1,fp) == 0) {
...
int pathIsBaseName(char *path) {
    return (__extension__ (__builtin_constant_p ('/') && !__builtin_constant_p (path) && ('/') == '\0' ? (char *) __rawmemchr (path, '/') : __builtin_strchr (path, '/'))) == ((void *)0) && (__extension__ (__builtin_constant_p ('\\') && !__builtin_constant_p (path) && ('\\') == '\0' ? (char *) __rawmemchr (path, '\\') : __builtin_strchr (path, '\\'))) == ((void *)0);
}
