...
robj *rdbLoadIntegerObject(rio *rdb, int enctype, int encode) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        _redisPanic("\"Unknown RDB integer encoding type\"","rdb.c",185),_exit(1);
    }
    if (encode)
...
int rdbSaveLongLongAsStringObject(rio *rdb, long long value) {
    ...
    if (enclen > 0) {
        ...
        ((enclen < 32)?(void)0 : (_redisAssert("enclen < 32","rdb.c",312),_exit(1)));
...
int rdbSaveStringObject(rio *rdb, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        (((obj->encoding == 0 || obj->encoding == 8))?(void)0 : (_redisAssertWithInfo(((void *)0),obj,"sdsEncodedObject(obj)","rdb.c",328),_exit(1)));
...
robj *rdbGenericLoadStringObject(rio *rdb, int encode) {
    ...
    if (isencoded) {
        ...
        default:
            _redisPanic("\"Unknown RDB encoding type\"","rdb.c",348),_exit(1);
        }
    }

    if (len == (2147483647 * 2U + 1U)) return ((void *)0);
    o = encode ? createStringObject(((void *)0),len) :
...
int rdbSaveObjectType(rio *rdb, robj *o) {
    ...
    case 1:
        if (o->encoding == 5)
            return rdbSaveType(rdb,10);
        else if (o->encoding == 4)
            return rdbSaveType(rdb,1);
        else
            _redisPanic("\"Unknown list encoding\"","rdb.c",441),_exit(1);
    case 2:
        if (o->encoding == 6)
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",448),_exit(1);
    case 3:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",455),_exit(1);
    case 4:
        if (o->encoding == 5)
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",462),_exit(1);
    default:
        _redisPanic("\"Unknown object type\"","rdb.c",464),_exit(1);
    }
    return -1;
}
...
int rdbLoadObjectType(rio *rdb) {
    ...
    if (!((type >= 0 && type <= 4) || (type >= 9 && type <= 13))) return -1;
    return type;
}
...
int rdbSaveObject(rio *rdb, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 5) {
            ...
            if ((n = rdbSaveLen(rdb,((list)->len))) == -1) return -1;
            nwritten += n;
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",508),_exit(1);
        }
    } else if (o->type == 2) {
        ...
        if (o->encoding == 2) {
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",532),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","rdb.c",560),_exit(1);
        }
    } else if (o->type == 4) {
        ...
        if (o->encoding == 5) {
            ...
            _redisPanic("\"Unknown hash encoding\"","rdb.c",589),_exit(1);
        }

    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",593),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    ...
    ((len != -1)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"len != -1","rdb.c",604),_exit(1)));
    return len;
}
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while(len--) {
            ...
            if (o->encoding == 5 &&
                (ele->encoding == 0 || ele->encoding == 8) &&
                sdslen(ele->ptr) > server.list_max_ziplist_value)
                    listTypeConvert(o,4);

            if (o->encoding == 5) {
                dec = getDecodedObject(ele);
                o->ptr = ziplistPush(o->ptr,dec->ptr,sdslen(dec->ptr),1);
                decrRefCount(dec);
                decrRefCount(ele);
            } else {
        ...
        while (o->encoding == 5 && len > 0) {
            ...
            (((field->encoding == 0 || field->encoding == 8))?(void)0 : (_redisAssert("sdsEncodedObject(field)","rdb.c",955),_exit(1)));
            value = rdbLoadStringObject(rdb);
            if (value == ((void *)0)) return ((void *)0);
            (((value->encoding == 0 || value->encoding == 8))?(void)0 : (_redisAssert("sdsEncodedObject(value)","rdb.c",958),_exit(1)));
        ...
        while (o->encoding == 2 && len > 0) {
            ...
            ((ret == 0)?(void)0 : (_redisAssert("ret == DICT_OK","rdb.c",992),_exit(1)));
        }


        ((len == 0)?(void)0 : (_redisAssert("len == 0","rdb.c",996),_exit(1)));
               ...
               rdbtype == 13)
    {
        ...
        switch(rdbtype) {
            ...
            case 13:
                ...
                break;
            default:
                _redisPanic("\"Unknown encoding\"","rdb.c",1073),_exit(1);
                break;
        }
    } else {
        _redisPanic("\"Unknown object type\"","rdb.c",1077),_exit(1);
    }
    return o;
}
...
void backgroundSaveDoneHandler(int exitcode, int bysignal) {
    ...
    case 2:
        ...
        break;
    default:
        _redisPanic("\"Unknown RDB child type.\"","rdb.c",1380),_exit(1);
        break;
    }
}
