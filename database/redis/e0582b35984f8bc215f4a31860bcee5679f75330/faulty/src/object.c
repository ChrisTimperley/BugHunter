...
# 67 "object.c"
robj *makeObjectShared(robj *o) {
    ((o->refcount == 1)?(void)0 : (_serverAssert("o->refcount == 1","object.c",68),_exit(1)));
...
robj *dupStringObject(const robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_serverAssert("o->type == OBJ_STRING","object.c",162),_exit(1)));
    ...
    case 1:
        ...
        return d;
    default:
        _serverPanic("\"Wrong encoding.\"","object.c",175),_exit(1);
        break;
    }
}
...
void freeListObject(robj *o) {
    ...
    case 9:
        ...
        break;
    default:
        _serverPanic("\"Unknown list encoding type\"","object.c",252),_exit(1);
    }
}
...
void freeSetObject(robj *o) {
    ...
    case 6:
        ...
        break;
    default:
        _serverPanic("\"Unknown set encoding type\"","object.c",265),_exit(1);
    }
}
...
void freeZsetObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _serverPanic("\"Unknown sorted set encoding\"","object.c",282),_exit(1);
    }
}
...
void freeHashObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _serverPanic("\"Unknown hash encoding type\"","object.c",295),_exit(1);
        break;
    }
}
...
void decrRefCount(robj *o) {
    if (o->refcount == 1) {
        ...
        default: _serverPanic("\"Unknown object type\"","object.c",319),_exit(1); break;
        }
        zfree(o);
    } else {
        if (o->refcount <= 0) _serverPanic("\"decrRefCount against refcount <= 0\"","object.c",323),_exit(1);
        if (o->refcount != 2147483647) o->refcount--;
    }
}
...
int isObjectRepresentableAsLongLong(robj *o, long long *llval) {
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",365),_exit(1)));
    if (o->encoding == 1) {
...
robj *tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",384),_exit(1)));
...
robj *getDecodedObject(robj *o) {
    ...
    if (o->type == 0 && o->encoding == 1) {
        ...
        _serverPanic("\"Unknown encoding type\"","object.c",469),_exit(1);
    }
}
# 484 "object.c"
int compareStringObjectsWithFlags(robj *a, robj *b, int flags) {
    ((a->type == 0 && b->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),a,"a->type == OBJ_STRING && b->type == OBJ_STRING","object.c",485),_exit(1)));
...
size_t stringObjectLen(robj *o) {
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",542),_exit(1)));
    if ((o->encoding == 0 || o->encoding == 8)) {
        return sdslen(o->ptr);
    } else {
...
int getDoubleFromObject(const robj *o, double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",557),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            ...
            _serverPanic("\"Unknown string encoding\"","object.c",571),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongDoubleFromObject(robj *o, long double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",599),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            ...
            _serverPanic("\"Unknown string encoding\"","object.c",609),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongLongFromObject(robj *o, long long *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",636),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            if (string2ll(o->ptr,sdslen(o->ptr),&value) == 0) return -1;
        } else if (o->encoding == 1) {
            value = (long)o->ptr;
        } else {
            _serverPanic("\"Unknown string encoding\"","object.c",642),_exit(1);
        }
    }
