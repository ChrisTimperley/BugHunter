...
# 275 "sort.c"
    ...
    default: vectorlen = 0; _redisPanic("\"Bad SORT type\"","sort.c",293),_exit(1);
    }
...
# 315 "sort.c"
    ...
    if (sortval->type == 1) {
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,sortval,"ln != NULL","sort.c",374),_exit(1)));
            ele = ln->obj;
            vector[j].obj = ele;
            vector[j].u.score = 0;
            vector[j].u.cmpobj = ((void *)0);
        ...
        _redisPanic("\"Unknown type\"","sort.c",401),_exit(1);
    }
    ((j == vectorlen)?(void)0 : (_redisAssertWithInfo(c,sortval,"j == vectorlen","sort.c",403),_exit(1)));
        ...
        for (j = 0; j < vectorlen; j++) {
            ...
            if (alpha) {
                ...
                if ((byval->encoding == 0 || byval->encoding == 8)) {
                    ...
                    ((1 != 1)?(void)0 : (_redisAssertWithInfo(c,sortval,"1 != 1","sort.c",436),_exit(1)));
                }
            }
        ...
        for (j = start; j <= end; j++) {
            ...
            while((ln = listNext(&li))) {
                ...
                if (sop->type == 0) {
                    ...
                    ((sop->type == 0)?(void)0 : (_redisAssertWithInfo(c,sortval,"sop->type == REDIS_SORT_GET","sort.c",487),_exit(1)));
                }
            }
        }
    } else {
            ...
            if (!getop) {
                ...
                while((ln = listNext(&li))) {
                    ...
                    if (sop->type == 0) {
                        ...
                        ((sop->type == 0)?(void)0 : (_redisAssertWithInfo(c,sortval,"sop->type == REDIS_SORT_GET","sort.c",518),_exit(1)));
                    }
                }
            }
        }
