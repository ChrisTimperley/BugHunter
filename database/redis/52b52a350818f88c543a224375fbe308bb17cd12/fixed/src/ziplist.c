...
# 39 "../deps/jemalloc/include/jemalloc/jemalloc.h"
...
__attribute__((visibility("default"))) size_t je_malloc_usable_size(const void *ptr);
...
static unsigned int zipIntSize(unsigned char encoding) {
    switch(encoding) {
    case 0xfe: return 1;
    case (0xc0 | 0<<4): return 2;
    case (0xc0 | 3<<4): return 3;
    case (0xc0 | 1<<4): return 4;
    case (0xc0 | 2<<4): return 8;
    default: return 0;
    }
    ((((void *)0)) ? (void) (0) : __assert_fail ("((void *)0)", "ziplist.c", 182, __PRETTY_FUNCTION__));
    return 0;
}
...
static int zipPrevLenByteDiff(unsigned char *p, unsigned int len) {
    ...
    do { if ((p)[0] < 254) { (prevlensize) = 1; } else { (prevlensize) = 5; } } while(0);;
    return zipPrevEncodeLength(((void *)0), len) - prevlensize;
}
...
static unsigned int zipRawEntryLength(unsigned char *p) {
    ...
    do { if ((p)[0] < 254) { (prevlensize) = 1; } else { (prevlensize) = 5; } } while(0);;
    do { do { ((encoding)) = ((p + prevlensize)[0]); if (((encoding)) < 0xc0) ((encoding)) &= 0xc0; } while(0); if ((encoding) < 0xc0) { if ((encoding) == (0 << 6)) { (lensize) = 1; (len) = (p + prevlensize)[0] & 0x3f; } else if ((encoding) == (1 << 6)) { (lensize) = 2; (len) = (((p + prevlensize)[0] & 0x3f) << 8) | (p + prevlensize)[1]; } else if (encoding == (2 << 6)) { (lensize) = 5; (len) = ((p + prevlensize)[1] << 24) | ((p + prevlensize)[2] << 16) | ((p + prevlensize)[3] << 8) | ((p + prevlensize)[4]); } else { ((((void *)0)) ? (void) (0) : __assert_fail ("((void *)0)", "ziplist.c", 312, __PRETTY_FUNCTION__)); } } else { (lensize) = 1; (len) = zipIntSize(encoding); } } while(0);;
...
static int zipTryEncoding(unsigned char *entry, unsigned int entrylen, long long *v, unsigned char *encoding) {
    ...
    if (string2ll((char*)entry,entrylen,&value)) {
        ...
        if (value >= 0 && value <= 12) {
            ...
            *encoding = 0xfe;
        } else if (value >= (-32767-1) && value <= (32767)) {
            *encoding = (0xc0 | 0<<4);
        } else if (value >= (-0x7fffff - 1) && value <= 0x7fffff) {
            *encoding = (0xc0 | 3<<4);
...
static void zipSaveInteger(unsigned char *p, int64_t value, unsigned char encoding) {
    ...
    if (encoding == 0xfe) {
    ...
    } else if (encoding == (0xc0 | 0<<4)) {
        i16 = value;
        memcpy(p,&i16,sizeof(i16));
        ;
    } else if (encoding == (0xc0 | 3<<4)) {
        i32 = value<<8;
        ;
        memcpy(p,((uint8_t*)&i32)+1,sizeof(i32)-sizeof(uint8_t));
    } else if (encoding == (0xc0 | 1<<4)) {
        i32 = value;
        memcpy(p,&i32,sizeof(i32));
        ;
    } else if (encoding == (0xc0 | 2<<4)) {
        i64 = value;
        ...
        ((((void *)0)) ? (void) (0) : __assert_fail ("((void *)0)", "ziplist.c", 370, __PRETTY_FUNCTION__));
    }
}
...
static int64_t zipLoadInteger(unsigned char *p, unsigned char encoding) {
    ...
    if (encoding == 0xfe) {
        ...
        ((((void *)0)) ? (void) (0) : __assert_fail ("((void *)0)", "ziplist.c", 401, __PRETTY_FUNCTION__));
    }
    return ret;
}
...
static zlentry zipEntry(unsigned char *p) {
    ...
    do { do { if ((p)[0] < 254) { (e.prevrawlensize) = 1; } else { (e.prevrawlensize) = 5; } } while(0);; if ((e.prevrawlensize) == 1) { (e.prevrawlen) = (p)[0]; } else if ((e.prevrawlensize) == 5) { ((sizeof((e.prevrawlensize)) == 4) ? (void) (0) : __assert_fail ("sizeof((e.prevrawlensize)) == 4", "ziplist.c", 410, __PRETTY_FUNCTION__)); memcpy(&(e.prevrawlen), ((char*)(p)) + 1, 4); ; } } while(0);;
    do { do { ((e.encoding)) = ((p + e.prevrawlensize)[0]); if (((e.encoding)) < 0xc0) ((e.encoding)) &= 0xc0; } while(0); if ((e.encoding) < 0xc0) { if ((e.encoding) == (0 << 6)) { (e.lensize) = 1; (e.len) = (p + e.prevrawlensize)[0] & 0x3f; } else if ((e.encoding) == (1 << 6)) { (e.lensize) = 2; (e.len) = (((p + e.prevrawlensize)[0] & 0x3f) << 8) | (p + e.prevrawlensize)[1]; } else if (e.encoding == (2 << 6)) { (e.lensize) = 5; (e.len) = ((p + e.prevrawlensize)[1] << 24) | ((p + e.prevrawlensize)[2] << 16) | ((p + e.prevrawlensize)[3] << 8) | ((p + e.prevrawlensize)[4]); } else { ((((void *)0)) ? (void) (0) : __assert_fail ("((void *)0)", "ziplist.c", 411, __PRETTY_FUNCTION__)); } } else { (e.lensize) = 1; (e.len) = zipIntSize(e.encoding); } } while(0);;
...
unsigned char *ziplistNew(void) {
    unsigned int bytes = (sizeof(uint32_t)*2+sizeof(uint16_t))+1;
...
static unsigned char *__ziplistCascadeUpdate(unsigned char *zl, unsigned char *p) {
    size_t curlen = ((*((uint32_t*)(zl)))), rawlen, rawlensize;
    ...
    while (p[0] != 255) {
        ...
        rawlensize = zipPrevEncodeLength(((void *)0),rawlen);


        if (p[rawlen] == 255) break;
        ...
        if (next.prevrawlensize < rawlensize) {
            ...
            if ((zl+((*((uint32_t*)((zl)+sizeof(uint32_t)))))) != np) {
                (*((uint32_t*)((zl)+sizeof(uint32_t)))) =
                    (((*((uint32_t*)((zl)+sizeof(uint32_t)))))+extra);
            }
...
static unsigned char *__ziplistDelete(unsigned char *zl, unsigned char *p, unsigned int num) {
    ...
    if (totlen > 0) {
        if (p[0] != 255) {
            ...
            (*((uint32_t*)((zl)+sizeof(uint32_t)))) =
                (((*((uint32_t*)((zl)+sizeof(uint32_t)))))-totlen);




            tail = zipEntry(p);
            if (p[tail.headersize+tail.len] != 255) {
                (*((uint32_t*)((zl)+sizeof(uint32_t)))) =
                   (((*((uint32_t*)((zl)+sizeof(uint32_t)))))+nextdiff);
            }
        ...
        offset = first.p-zl;
        zl = ziplistResize(zl, ((*((uint32_t*)(zl))))-totlen+nextdiff);
        { if ((*((uint16_t*)((zl)+sizeof(uint32_t)*2))) < (65535)) (*((uint16_t*)((zl)+sizeof(uint32_t)*2))) = (((*((uint16_t*)((zl)+sizeof(uint32_t)*2))))+-deleted); };
        p = zl+offset;
...
static unsigned char *__ziplistInsert(unsigned char *zl, unsigned char *p, unsigned char *s, unsigned int slen) {
    size_t curlen = ((*((uint32_t*)(zl)))), reqlen, prevlen = 0;
    size_t offset;
    int nextdiff = 0;
    ...
    if (p[0] != 255) {
        ...
        unsigned char *ptail = ((zl)+((*((uint32_t*)((zl)+sizeof(uint32_t))))));
        if (ptail[0] != 255) {
    ...
    reqlen += zipPrevEncodeLength(((void *)0),prevlen);
    reqlen += zipEncodeLength(((void *)0),encoding,slen);




    nextdiff = (p[0] != 255) ? zipPrevLenByteDiff(p,reqlen) : 0;
    ...
    if (p[0] != 255) {
        ...
        (*((uint32_t*)((zl)+sizeof(uint32_t)))) =
            (((*((uint32_t*)((zl)+sizeof(uint32_t)))))+reqlen);




        tail = zipEntry(p+reqlen);
        if (p[reqlen+tail.headersize+tail.len] != 255) {
            (*((uint32_t*)((zl)+sizeof(uint32_t)))) =
                (((*((uint32_t*)((zl)+sizeof(uint32_t)))))+nextdiff);
        }
    } else {

        (*((uint32_t*)((zl)+sizeof(uint32_t)))) = (p-zl);
    }
    ...
    { if ((*((uint16_t*)((zl)+sizeof(uint32_t)*2))) < (65535)) (*((uint16_t*)((zl)+sizeof(uint32_t)*2))) = (((*((uint16_t*)((zl)+sizeof(uint32_t)*2))))+1); };
    return zl;
}

unsigned char *ziplistPush(unsigned char *zl, unsigned char *s, unsigned int slen, int where) {
    unsigned char *p;
    p = (where == 0) ? ((zl)+(sizeof(uint32_t)*2+sizeof(uint16_t))) : ((zl)+((*((uint32_t*)(zl))))-1);
...
unsigned char *ziplistIndex(unsigned char *zl, int index) {
    ...
    if (index < 0) {
        ...
        p = ((zl)+(sizeof(uint32_t)*2+sizeof(uint16_t)));
        while (p[0] != 255 && index--) {
            p += zipRawEntryLength(p);
        }
    }
    return (p[0] == 255 || index > 0) ? ((void *)0) : p;
}
...
unsigned char *ziplistPrev(unsigned char *zl, unsigned char *p) {
    ...
    if (p[0] == 255) {
        p = ((zl)+((*((uint32_t*)((zl)+sizeof(uint32_t))))));
        return (p[0] == 255) ? ((void *)0) : p;
    } else if (p == ((zl)+(sizeof(uint32_t)*2+sizeof(uint16_t)))) {
        return ((void *)0);
    } else {
        entry = zipEntry(p);
        ((entry.prevrawlen > 0) ? (void) (0) : __assert_fail ("entry.prevrawlen > 0", "ziplist.c", 737, __PRETTY_FUNCTION__));
...
unsigned int ziplistGet(unsigned char *p, unsigned char **sstr, unsigned int *slen, long long *sval) {
    zlentry entry;
    if (p == ((void *)0) || p[0] == 255) return 0;
    if (sstr) *sstr = ((void *)0);

    entry = zipEntry(p);
    if ((((entry.encoding) & 0xc0) < 0xc0)) {
        if (sstr) {
            *slen = entry.len;
...
unsigned char *ziplistFind(unsigned char *p, unsigned char *vstr, unsigned int vlen, unsigned int skip) {
    ...
    while (p[0] != 255) {
        ...
        do { if ((p)[0] < 254) { (prevlensize) = 1; } else { (prevlensize) = 5; } } while(0);;
        do { do { ((encoding)) = ((p + prevlensize)[0]); if (((encoding)) < 0xc0) ((encoding)) &= 0xc0; } while(0); if ((encoding) < 0xc0) { if ((encoding) == (0 << 6)) { (lensize) = 1; (len) = (p + prevlensize)[0] & 0x3f; } else if ((encoding) == (1 << 6)) { (lensize) = 2; (len) = (((p + prevlensize)[0] & 0x3f) << 8) | (p + prevlensize)[1]; } else if (encoding == (2 << 6)) { (lensize) = 5; (len) = ((p + prevlensize)[1] << 24) | ((p + prevlensize)[2] << 16) | ((p + prevlensize)[3] << 8) | ((p + prevlensize)[4]); } else { ((((void *)0)) ? (void) (0) : __assert_fail ("((void *)0)", "ziplist.c", 829, __PRETTY_FUNCTION__)); } } else { (lensize) = 1; (len) = zipIntSize(encoding); } } while(0);;
        ...
        if (skipcnt == 0) {
            ...
            if ((((encoding) & 0xc0) < 0xc0)) {
                ...
                if (vencoding == 0) {
                    ...
                    ((vencoding) ? (void) (0) : __assert_fail ("vencoding", "ziplist.c", 850, __PRETTY_FUNCTION__));
                }




                if (vencoding != (127 * 2 + 1)) {
...
unsigned int ziplistLen(unsigned char *zl) {
    unsigned int len = 0;
    if (((*((uint16_t*)((zl)+sizeof(uint32_t)*2)))) < (65535)) {
        len = ((*((uint16_t*)((zl)+sizeof(uint32_t)*2))));
    } else {
        unsigned char *p = zl+(sizeof(uint32_t)*2+sizeof(uint16_t));
        while (*p != 255) {
            p += zipRawEntryLength(p);
            len++;
        }
        ...
        if (len < (65535)) (*((uint16_t*)((zl)+sizeof(uint32_t)*2))) = (len);
    }
    return len;
}
