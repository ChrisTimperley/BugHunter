...
void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",498),_exit(1)));
    listDelNode(server.clients,ln);


    if (c->flags & 256) {
        ln = listSearchKey(server.unblocked_clients,c);
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",504),_exit(1)));
    ...
    if (c->flags & 1) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","networking.c",515),_exit(1)));
        listDelNode(l,ln);
    }
...
int processMultibulkBuffer(redisClient *c) {
    ...
    if (c->multibulklen == 0) {
        ...
        ((c->argc == 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->argc == 0","networking.c",715),_exit(1)));
        ...
        ((c->querybuf[0] == '*')?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->querybuf[0] == '*'","networking.c",728),_exit(1)));
    ...
    ((c->multibulklen > 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->multibulklen > 0","networking.c",749),_exit(1)));
...
void processInputBuffer(redisClient *c) {
    ...
    while(sdslen(c->querybuf)) {
        ...
        if (c->reqtype == 1) {
            ...
            _redisPanic("\"Unknown request type\"","networking.c",855),_exit(1);
        }
...
void rewriteClientCommandVector(redisClient *c, int argc, ...) {
    ...
    ((c->cmd != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->cmd != NULL","networking.c",1071),_exit(1)));
    __builtin_va_end(ap);
}
...
void rewriteClientCommandArgument(redisClient *c, int i, robj *newval) {
    ...
    ((i < c->argc)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"i < c->argc","networking.c",1080),_exit(1)));
    oldval = c->argv[i];
    c->argv[i] = newval;
    incrRefCount(newval);
    decrRefCount(oldval);
    ...
    if (i == 0) {
        c->cmd = lookupCommand(c->argv[0]->ptr);
        ((c->cmd != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,((void *)0),"c->cmd != NULL","networking.c",1089),_exit(1)));
    }
}
