...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 3827, __PRETTY_FUNCTION__));
                ...
                if (alpha) {
                    ...
                    if (byval->encoding == 0) {
                        ...
                        if (byval->encoding == 1) {
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 3851, __PRETTY_FUNCTION__));
                    }
                }
            } else {
                if (!alpha) {
                    if (vector[j].obj->encoding == 0)
                        ...
                        if (vector[j].obj->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 3862, __PRETTY_FUNCTION__));
                    }
                }
            }
        }
