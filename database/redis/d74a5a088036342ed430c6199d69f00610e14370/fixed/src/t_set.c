...
robj *setTypeCreate(robj *value) {
    if (isObjectRepresentableAsLongLong(value,((void *)0)) == 0)
...
int setTypeAdd(robj *subject, robj *value) {
    ...
    if (subject->encoding == 2) {
        if (dictAdd(subject->ptr,value,((void *)0)) == 0) {
            incrRefCount(value);
            return 1;
        }
    } else if (subject->encoding == 6) {
        if (isObjectRepresentableAsLongLong(value,&llval) == 0) {
            uint8_t success = 0;
            ...
            ((dictAdd(subject->ptr,value,((void *)0)) == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),value,"dictAdd(subject->ptr,value,NULL) == DICT_OK",
 "t_set.c"
# 72 "t_set.c"
            ,
 73
# 72 "t_set.c"
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",78),_exit(1);
    }
    return 0;
}
...
int setTypeRemove(robj *setobj, robj *value) {
    ...
    if (setobj->encoding == 2) {
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",97),_exit(1);
    }
    return 0;
}
...
int setTypeIsMember(robj *subject, robj *value) {
    ...
    if (subject->encoding == 2) {
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",111),_exit(1);
    }
    return 0;
}
...
setTypeIterator *setTypeInitIterator(robj *subject) {
    ...
    if (si->encoding == 2) {
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",125),_exit(1);
    }
    return si;
}
...
robj *setTypeNextObject(setTypeIterator *si) {
    ...
    switch(encoding) {
        ...
        case 2:
            ...
            return objele;
        default:
            _redisPanic("\"Unsupported encoding\"","t_set.c",180),_exit(1);
    }
    return ((void *)0);
}
# 198 "t_set.c"
int setTypeRandomElement(robj *setobj, robj **objele, int64_t *llele) {
    if (setobj->encoding == 2) {
        ...
        *llele = intsetRandom(setobj->ptr);
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",205),_exit(1);
    }
...
# 252 "t_set.c"
    if (set->encoding == 2) {
        ...
        ((elements_copied == elements_to_return)?(void)0 : (_redisAssert("elements_copied == elements_to_return","t_set.c",260),_exit(1)));
        ...
        ((elements_copied == elements_to_return)?(void)0 : (_redisAssert("elements_copied == elements_to_return","t_set.c",284),_exit(1)));
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",302),_exit(1);
    }
...
unsigned long setTypeSize(robj *subject) {
    if (subject->encoding == 2) {
        ...
        _redisPanic("\"Unknown set encoding\"","t_set.c",316),_exit(1);
    }
}
...
void setTypeConvert(robj *setobj, int enc) {
    setTypeIterator *si;
    ((setobj->type == 2 && setobj->encoding == 6)?(void)0 : (_redisAssertWithInfo(((void *)0),setobj,"setobj->type == REDIS_SET && setobj->encoding == REDIS_ENCODING_INTSET",
 "t_set.c"
# 325 "t_set.c"
    ,
 326
# 325 "t_set.c"
    ...
    if (enc == 2) {
        ...
        while (setTypeNext(si,((void *)0),&intele) != -1) {
            element = createStringObjectFromLongLong(intele);
            ((dictAdd(d,element,((void *)0)) == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),element,"dictAdd(d,element,NULL) == DICT_OK",
 "t_set.c"
# 340 "t_set.c"
            ,
 341
# 340 "t_set.c"
        ...
        _redisPanic("\"Unsupported set conversion\"","t_set.c",349),_exit(1);
    }
}
...
void spopWithCountCommand(redisClient *c) {
    ...
    ((elements_returned == count)?(void)0 : (_redisAssert("elements_returned == count","t_set.c",554),_exit(1)));

    {
        ...
        while ((element_encoding = setTypeNext(si, &objele, &llele)) != -1) {
            if (element_encoding == 2) {
                ...
                _redisPanic("\"Unknown set encoding\"","t_set.c",590),_exit(1);
            }
        }
        setTypeReleaseIterator(si);
...
void spopCommand(redisClient *c) {
    ...
    if ((set = lookupKeyWriteOrReply(c,c->argv[1],shared.nullbulk)) == ((void *)0) ||
        checkType(c,set,2)) return;
...
void srandmemberWithCountCommand(redisClient *c) {
    ...
    d = dictCreate(&setDictType,((void *)0));
# 729 "t_set.c"
    if (count*3 > size) {
        setTypeIterator *si;
        ...
        while((encoding = setTypeNext(si,&ele,&llele)) != -1) {
            ...
            if (encoding == 6) {
                ...
                retval = dictAdd(d,dupStringObject(ele),((void *)0));
            }
            ((retval == 0)?(void)0 : (_redisAssert("retval == DICT_OK","t_set.c",742),_exit(1)));
        }
        setTypeReleaseIterator(si);
        ((((d)->ht[0].used+(d)->ht[1].used) == size)?(void)0 : (_redisAssert("dictSize(d) == size","t_set.c",745),_exit(1)));
...
void srandmemberCommand(redisClient *c) {
    ...
    if ((set = lookupKeyReadOrReply(c,c->argv[1],shared.nullbulk)) == ((void *)0) ||
        checkType(c,set,2)) return;
