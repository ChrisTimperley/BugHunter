...
{
    int yes = 1;
    if (setsockopt(fd, IPPROTO_TCP, 1, &yes, sizeof(yes)) == -1)
    {
...
static int anetCreateSocket(char *err, int domain) {
    ...
    if (setsockopt(s, 1, 2, &on, sizeof(on)) == -1) {
...
static int anetTcpGenericConnect(char *err, char *addr, int port, int flags)
{
    ...
    if ((s = anetCreateSocket(err,2)) == -1)
        return -1;

    sa.sin_family = 2;
    sa.sin_port = (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (port); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));
...
int anetTcpServer(char *err, int port, char *bindaddr)
{
    ...
    sa.sin_family = 2;
    sa.sin_port = (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (port); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));
    sa.sin_addr.s_addr = __bswap_32 (((in_addr_t) 0x00000000));
...
int anetTcpAccept(char *err, int s, char *ip, int *port) {
    ...
    if (port) *port = (__extension__ ({ unsigned short int __v, __x = (unsigned short int) (sa.sin_port); if (__builtin_constant_p (__x)) __v = ((unsigned short int) ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8))); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));
    return fd;
}
