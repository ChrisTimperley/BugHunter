...
int rdbSaveStringObject(rio *rdb, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        ((obj->encoding == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),obj,"obj->encoding == REDIS_ENCODING_RAW","rdb.c",328),_exit(1)));
...
robj *rdbLoadObject(int rdbtype, rio *rdb) {
    ...
    if (rdbtype == 0) {
        ...
        while (o->encoding == 5 && len > 0) {
            ...
            ((field->encoding == 0)?(void)0 : (_redisAssert("field->encoding == REDIS_ENCODING_RAW","rdb.c",906),_exit(1)));
            value = rdbLoadStringObject(rdb);
            if (value == ((void *)0)) return ((void *)0);
            ((field->encoding == 0)?(void)0 : (_redisAssert("field->encoding == REDIS_ENCODING_RAW","rdb.c",909),_exit(1)));
