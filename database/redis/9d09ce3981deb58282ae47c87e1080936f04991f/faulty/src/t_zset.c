    ...
    for (j = 0; j < elements; j++) {
        ...
        if (zobj->encoding == 5) {
            ...
            if (de != ((void *)0)) {
                ...
                if (score != curscore) {
                    ((zslDelete(zs->zsl,curscore,curobj))?(void)0 : (_redisAssertWithInfo(c,curobj,"zslDelete(zs->zsl,curscore,curobj)","t_zset.c",955),_exit(1)));
                ...
                incrRefCount(ele);
                ((dictAdd(zs->dict,ele,&znode->score) == 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"dictAdd(zs->dict,ele,&znode->score) == DICT_OK","t_zset.c",966),_exit(1)));
                incrRefCount(ele);
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",974),_exit(1);
        }
    }
    zfree(scores);
    if (incr)
    ...
    if (zobj->encoding == 5) {
        ...
        for (j = 2; j < c->argc; j++) {
            ...
            if (de != ((void *)0)) {
                ...
                ((zslDelete(zs->zsl,score,c->argv[j]))?(void)0 : (_redisAssertWithInfo(c,c->argv[j],"zslDelete(zs->zsl,score,c->argv[j])","t_zset.c",1025),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1037),_exit(1);
    }
...
void zremrangebyscoreCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1071),_exit(1);
    }
...
void zremrangebyrankCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1119),_exit(1);
    }
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 5) {
            ...
            if (it->zl.eptr != ((void *)0)) {
                ...
                ((it->zl.sptr != ((void *)0))?(void)0 : (_redisAssert("it->zl.sptr != NULL","t_zset.c",1209),_exit(1)));
            }
        } else if (op->encoding == 7) {
            it->sl.zs = op->subject->ptr;
            it->sl.node = it->sl.zs->zsl->header->level[0].forward;
        } else {
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1215),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1218),_exit(1);
    }
}
...
void zuiClearIterator(zsetopsrc *op) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1233),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        if (op->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1242),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1245),_exit(1);
    }
}
...
int zuiLength(zsetopsrc *op) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1260),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        if (op->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1269),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1272),_exit(1);
    }
}
...
int zuiNext(zsetopsrc *op, zsetopval *val) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1309),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        if (op->encoding == 5) {
            ...
            if (it->zl.eptr == ((void *)0) || it->zl.sptr == ((void *)0))
                return 0;
            ((ziplistGet(it->zl.eptr,&val->estr,&val->elen,&val->ell))?(void)0 : (_redisAssert("ziplistGet(it->zl.eptr,&val->estr,&val->elen,&val->ell)","t_zset.c",1317),_exit(1)));
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1331),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1334),_exit(1);
    }
    return 1;
}
    ...
    if (!(val->flags & 2)) {
        ...
        if (val->ele != ((void *)0)) {
            if (val->ele->encoding == 1) {
                ...
                _redisPanic("\"Unsupported element encoding\"","t_zset.c",1351),_exit(1);
            }
    ...
    if (val->estr == ((void *)0)) {
        if (val->ele != ((void *)0)) {
            if (val->ele->encoding == 1) {
                ...
                _redisPanic("\"Unsupported element encoding\"","t_zset.c",1386),_exit(1);
            }
        } else {
...
int zuiFind(zsetopsrc *op, zsetopval *val, double *score) {
    ...
    if (op->type == 2) {
        ...
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1421),_exit(1);
        }
    } else if (op->type == 3) {
        iterzset *it = &op->iter.zset;
        zuiObjectFromValue(val);
        ...
        if (op->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1443),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1446),_exit(1);
    }
}
...
inline static void zunionInterAggregate(double *target, double val, int aggregate) {
    if (aggregate == 1) {
        ...
        *target = val > *target ? val : *target;
        ...
        _redisPanic("\"Unknown ZUNION/INTER aggregate type\"","t_zset.c",1472),_exit(1);
    }
}
...
void zunionInterGenericCommand(redisClient *c, robj *dstkey, int op) {
    ...
    if (op == 2) {
        ...
        _redisPanic("\"Unknown operator\"","t_zset.c",1656),_exit(1);
    }
...
void zrangeGenericCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1744),_exit(1)));
        sptr = ziplistNext(zl,eptr);

        while (rangelen--) {
            ((eptr != ((void *)0) && sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL && sptr != NULL","t_zset.c",1748),_exit(1)));
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1749),_exit(1)));
            if (vstr == ((void *)0))
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"ln != NULL","t_zset.c",1782),_exit(1)));
            ele = ln->obj;
            addReplyBulk(c,ele);
            if (withscores)
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1790),_exit(1);
    }
}
...
void genericZrangebyscoreCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1874),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ...
        while (eptr && limit--) {
            ...
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1903),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1979),_exit(1);
    }
...
void zcountCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        sptr = ziplistNext(zl,eptr);
        score = zzlGetScore(sptr);
        ((zslValueLteMax(score,&range))?(void)0 : (_redisAssertWithInfo(c,zobj,"zslValueLteMax(score,&range)","t_zset.c",2030),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2068),_exit(1);
    }
...
void zscoreCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2110),_exit(1);
    }
}
...
void zrankGenericCommand(redisClient *c, int reverse) {
    ...
    ((ele->encoding == 0)?(void)0 : (_redisAssertWithInfo(c,ele,"ele->encoding == REDIS_ENCODING_RAW","t_zset.c",2125),_exit(1)));
    if (zobj->encoding == 5) {
        unsigned char *zl = zobj->ptr;
        unsigned char *eptr, *sptr;

        eptr = ziplistIndex(zl,0);
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",2131),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"sptr != NULL","t_zset.c",2133),_exit(1)));
        ...
        if (de != ((void *)0)) {
            ...
            ((rank)?(void)0 : (_redisAssertWithInfo(c,ele,"rank","t_zset.c",2162),_exit(1)));
            if (reverse)
                addReplyLongLong(c,llen-rank);
            else
                addReplyLongLong(c,rank-1);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2171),_exit(1);
    }
}
