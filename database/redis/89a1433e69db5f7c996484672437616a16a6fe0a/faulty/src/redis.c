...
struct redisCommand readonlyCommandTable[] = {
    {"get",getCommand,2,0,((void *)0),1,1,1},
    {"set",setCommand,3,4,((void *)0),0,0,0},
    {"setnx",setnxCommand,3,4,((void *)0),0,0,0},
    {"setex",setexCommand,4,4,((void *)0),0,0,0},
    {"append",appendCommand,3,4,((void *)0),1,1,1},
    {"strlen",strlenCommand,2,0,((void *)0),1,1,1},
    {"del",delCommand,-2,0,((void *)0),0,0,0},
    {"exists",existsCommand,2,0,((void *)0),1,1,1},
    {"setbit",setbitCommand,4,4,((void *)0),1,1,1},
    {"getbit",getbitCommand,3,0,((void *)0),1,1,1},
    {"setrange",setrangeCommand,4,4,((void *)0),1,1,1},
    {"getrange",getrangeCommand,4,0,((void *)0),1,1,1},
    {"substr",getrangeCommand,4,0,((void *)0),1,1,1},
    {"incr",incrCommand,2,4,((void *)0),1,1,1},
    {"decr",decrCommand,2,4,((void *)0),1,1,1},
    {"mget",mgetCommand,-2,0,((void *)0),1,-1,1},
    {"rpush",rpushCommand,3,4,((void *)0),1,1,1},
    {"lpush",lpushCommand,3,4,((void *)0),1,1,1},
    {"rpushx",rpushxCommand,3,4,((void *)0),1,1,1},
    {"lpushx",lpushxCommand,3,4,((void *)0),1,1,1},
    {"linsert",linsertCommand,5,4,((void *)0),1,1,1},
    {"rpop",rpopCommand,2,0,((void *)0),1,1,1},
    {"lpop",lpopCommand,2,0,((void *)0),1,1,1},
    {"brpop",brpopCommand,-3,0,((void *)0),1,1,1},
    {"brpoplpush",brpoplpushCommand,4,4,((void *)0),1,2,1},
    {"blpop",blpopCommand,-3,0,((void *)0),1,1,1},
    {"llen",llenCommand,2,0,((void *)0),1,1,1},
    {"lindex",lindexCommand,3,0,((void *)0),1,1,1},
    {"lset",lsetCommand,4,4,((void *)0),1,1,1},
    {"lrange",lrangeCommand,4,0,((void *)0),1,1,1},
    {"ltrim",ltrimCommand,4,0,((void *)0),1,1,1},
    {"lrem",lremCommand,4,0,((void *)0),1,1,1},
    {"rpoplpush",rpoplpushCommand,3,4,((void *)0),1,2,1},
    {"sadd",saddCommand,3,4,((void *)0),1,1,1},
    {"srem",sremCommand,3,0,((void *)0),1,1,1},
    {"smove",smoveCommand,4,0,((void *)0),1,2,1},
    {"sismember",sismemberCommand,3,0,((void *)0),1,1,1},
    {"scard",scardCommand,2,0,((void *)0),1,1,1},
    {"spop",spopCommand,2,0,((void *)0),1,1,1},
    {"srandmember",srandmemberCommand,2,0,((void *)0),1,1,1},
    {"sinter",sinterCommand,-2,4,((void *)0),1,-1,1},
    {"sinterstore",sinterstoreCommand,-3,4,((void *)0),2,-1,1},
    {"sunion",sunionCommand,-2,4,((void *)0),1,-1,1},
    {"sunionstore",sunionstoreCommand,-3,4,((void *)0),2,-1,1},
    {"sdiff",sdiffCommand,-2,4,((void *)0),1,-1,1},
    {"sdiffstore",sdiffstoreCommand,-3,4,((void *)0),2,-1,1},
    {"smembers",sinterCommand,2,0,((void *)0),1,1,1},
    {"zadd",zaddCommand,4,4,((void *)0),1,1,1},
    {"zincrby",zincrbyCommand,4,4,((void *)0),1,1,1},
    {"zrem",zremCommand,3,0,((void *)0),1,1,1},
    {"zremrangebyscore",zremrangebyscoreCommand,4,0,((void *)0),1,1,1},
    {"zremrangebyrank",zremrangebyrankCommand,4,0,((void *)0),1,1,1},
    {"zunionstore",zunionstoreCommand,-4,4,zunionInterBlockClientOnSwappedKeys,0,0,0},
    {"zinterstore",zinterstoreCommand,-4,4,zunionInterBlockClientOnSwappedKeys,0,0,0},
    {"zrange",zrangeCommand,-4,0,((void *)0),1,1,1},
    {"zrangebyscore",zrangebyscoreCommand,-4,0,((void *)0),1,1,1},
    {"zrevrangebyscore",zrevrangebyscoreCommand,-4,0,((void *)0),1,1,1},
    {"zcount",zcountCommand,4,0,((void *)0),1,1,1},
    {"zrevrange",zrevrangeCommand,-4,0,((void *)0),1,1,1},
    {"zcard",zcardCommand,2,0,((void *)0),1,1,1},
    {"zscore",zscoreCommand,3,0,((void *)0),1,1,1},
    {"zrank",zrankCommand,3,0,((void *)0),1,1,1},
    {"zrevrank",zrevrankCommand,3,0,((void *)0),1,1,1},
    {"hset",hsetCommand,4,4,((void *)0),1,1,1},
    {"hsetnx",hsetnxCommand,4,4,((void *)0),1,1,1},
    {"hget",hgetCommand,3,0,((void *)0),1,1,1},
    {"hmset",hmsetCommand,-4,4,((void *)0),1,1,1},
    {"hmget",hmgetCommand,-3,0,((void *)0),1,1,1},
    {"hincrby",hincrbyCommand,4,4,((void *)0),1,1,1},
    {"hdel",hdelCommand,3,0,((void *)0),1,1,1},
    {"hlen",hlenCommand,2,0,((void *)0),1,1,1},
    {"hkeys",hkeysCommand,2,0,((void *)0),1,1,1},
    {"hvals",hvalsCommand,2,0,((void *)0),1,1,1},
    {"hgetall",hgetallCommand,2,0,((void *)0),1,1,1},
    {"hexists",hexistsCommand,3,0,((void *)0),1,1,1},
    {"incrby",incrbyCommand,3,4,((void *)0),1,1,1},
    {"decrby",decrbyCommand,3,4,((void *)0),1,1,1},
    {"getset",getsetCommand,3,4,((void *)0),1,1,1},
    {"mset",msetCommand,-3,4,((void *)0),1,-1,2},
    {"msetnx",msetnxCommand,-3,4,((void *)0),1,-1,2},
    {"randomkey",randomkeyCommand,1,0,((void *)0),0,0,0},
    {"select",selectCommand,2,0,((void *)0),0,0,0},
    {"move",moveCommand,3,0,((void *)0),1,1,1},
    {"rename",renameCommand,3,0,((void *)0),1,1,1},
    {"renamenx",renamenxCommand,3,0,((void *)0),1,1,1},
    {"expire",expireCommand,3,0,((void *)0),0,0,0},
    {"expireat",expireatCommand,3,0,((void *)0),0,0,0},
    {"keys",keysCommand,2,0,((void *)0),0,0,0},
    {"dbsize",dbsizeCommand,1,0,((void *)0),0,0,0},
    {"auth",authCommand,2,0,((void *)0),0,0,0},
    {"ping",pingCommand,1,0,((void *)0),0,0,0},
    {"echo",echoCommand,2,0,((void *)0),0,0,0},
    {"save",saveCommand,1,0,((void *)0),0,0,0},
    {"bgsave",bgsaveCommand,1,0,((void *)0),0,0,0},
    {"bgrewriteaof",bgrewriteaofCommand,1,0,((void *)0),0,0,0},
    {"shutdown",shutdownCommand,1,0,((void *)0),0,0,0},
    {"lastsave",lastsaveCommand,1,0,((void *)0),0,0,0},
    {"type",typeCommand,2,0,((void *)0),1,1,1},
    {"multi",multiCommand,1,0,((void *)0),0,0,0},
    {"exec",execCommand,1,4,execBlockClientOnSwappedKeys,0,0,0},
    {"discard",discardCommand,1,0,((void *)0),0,0,0},
    {"sync",syncCommand,1,0,((void *)0),0,0,0},
    {"flushdb",flushdbCommand,1,0,((void *)0),0,0,0},
    {"flushall",flushallCommand,1,0,((void *)0),0,0,0},
    {"sort",sortCommand,-2,4,((void *)0),1,1,1},
    {"info",infoCommand,1,0,((void *)0),0,0,0},
    {"monitor",monitorCommand,1,0,((void *)0),0,0,0},
    {"ttl",ttlCommand,2,0,((void *)0),1,1,1},
    {"persist",persistCommand,2,0,((void *)0),1,1,1},
    {"slaveof",slaveofCommand,3,0,((void *)0),0,0,0},
    {"debug",debugCommand,-2,0,((void *)0),0,0,0},
    {"config",configCommand,-2,0,((void *)0),0,0,0},
    {"subscribe",subscribeCommand,-2,0,((void *)0),0,0,0},
    {"unsubscribe",unsubscribeCommand,-1,0,((void *)0),0,0,0},
    {"psubscribe",psubscribeCommand,-2,0,((void *)0),0,0,0},
    {"punsubscribe",punsubscribeCommand,-1,0,((void *)0),0,0,0},
    {"publish",publishCommand,3,8,((void *)0),0,0,0},
    {"watch",watchCommand,-2,0,((void *)0),0,0,0},
    {"unwatch",unwatchCommand,1,0,((void *)0),0,0,0}
};
...
void beforeSleep(struct aeEventLoop *eventLoop) {
    ...
    if (server.ds_enabled && ((server.io_ready_clients)->len)) {
        ...
        while((ln = listNext(&li))) {
            ...
            ((cmd != ((void *)0))?(void)0 : (_redisAssert("cmd != NULL","redis.c",676),_exit(1)));
            call(c,cmd);
            resetClient(c);
    ...
    while (((server.unblocked_clients)->len)) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","redis.c",688),_exit(1)));
        c = ln->value;
...
void populateCommandTable(void) {
    ...
    for (j = 0; j < numcommands; j++) {
        ...
        ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 934, __PRETTY_FUNCTION__));
    }
}
...
sds genRedisInfoString(void) {
    ...
    if (server.masterhost) {
        info = sdscatprintf(info,
            ...
            (server.replstate == 3) ?
                "up" : "down",
            server.master ? ((int)(time(((void *)0))-server.master->lastinteraction)) : -1,
            server.replstate == 2
        );
...
int main(int argc, char **argv) {
    ...
    if (server.ds_enabled) {
        ...
        if (loadAppendOnlyFile(server.appendfilename) == 0)
            redisLog(2,"DB loaded from append only file: %ld seconds",time(((void *)0))-start);
    } else {
        if (rdbLoad(server.dbfilename) == 0)
            redisLog(2,"DB loaded from disk: %ld seconds",time(((void *)0))-start);
    }
    if (server.ipfd > 0)
...
void sigtermHandler(int sig) {
    ...
    redisLog(3,"SIGTERM received, scheduling shutting down...");
