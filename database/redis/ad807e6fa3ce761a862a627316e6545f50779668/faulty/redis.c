...
static struct redisCommand cmdTable[] = {
    ...
    {"srandmember",srandmemberCommand,2,2},
    ...
    {"zadd",zaddCommand,4,1|4},
    {"zrem",zremCommand,3,1},
    {"zrange",zrangeCommand,4,2},
    {"zrevrange",zrevrangeCommand,4,2},
    {"zlen",zlenCommand,2,2},
    {"incrby",incrbyCommand,3,2|4},
    {"decrby",decrbyCommand,3,2|4},
    {"getset",getsetCommand,3,1|4},
    {"mset",msetCommand,-3,1|4},
    {"msetnx",msetnxCommand,-3,1|4},
...
static void loadServerConfig(char *filename) {
    ...
    while(fgets(buf,1024 +1,fp) != ((void *)0)) {
        ...
        if (!strcasecmp(argv[0],"timeout") && argc == 2) {
            ...
            server.maxmemory = strtoll(argv[1], ((void *)0), 10);
...
static void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1246, __PRETTY_FUNCTION__));
    ...
    if (c->flags & 2) {
        ...
        ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1253, __PRETTY_FUNCTION__));
        listDelNode(l,ln);
    }
    if (c->flags & 4) {
        server.master = ((void *)0);
...
static void decrRefCount(void *obj) {
    ...
    if (--(o->refcount) == 0) {
        ...
        default: ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1912, __PRETTY_FUNCTION__)); break;
        }
...
static robj *tryObjectSharing(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1957, __PRETTY_FUNCTION__));
    ...
    if (de) {
        ...
        if (((server.sharingpool)->used) >=
            ...
            ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 1975, __PRETTY_FUNCTION__));
            c = ((unsigned long) ((de)->val))-1;
            ((de)->val) = (void*) c;
            if (c == 0) {
        ...
        if (c == 0) {
            ...
            ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1988, __PRETTY_FUNCTION__));
            incrRefCount(o);
        }
        return o;
    }
...
static int isStringRepresentableAsLong(sds s, long *longval) {
    ...
    if (sdslen(s) != (unsigned)slen || memcmp(buf,s,slen)) return -1;
...
static int tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 2031, __PRETTY_FUNCTION__));


    if (isStringRepresentableAsLong(s,&value) == -1) return -1;
...
static robj *getDecodedObject(const robj *o) {
    ...
    ((o->encoding != 0) ? (void) (0) : __assert_fail ("o->encoding != 0", "redis.c", 2047, __PRETTY_FUNCTION__));
    if (o->type == 0 && o->encoding == 1) {
        ...
        ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 2055, __PRETTY_FUNCTION__));
    }
}

static int compareStringObjects(robj *a, robj *b) {
    ((a->type == 0 && b->type == 0) ? (void) (0) : __assert_fail ("a->type == 0 && b->type == 0", "redis.c", 2060, __PRETTY_FUNCTION__));

    if (a == b) return 0;
    if (a->encoding == 1 && b->encoding == 1){
        ...
        incrRefCount(a);
        incrRefCount(b);
        if (a->encoding != 0) a = getDecodedObject(a);
        if (b->encoding != 0) b = getDecodedObject(a);
...
static size_t stringObjectLen(robj *o) {
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 2080, __PRETTY_FUNCTION__));
    if (o->encoding == 0) {
        return sdslen(o->ptr);
    } else {
        char buf[32];
...
static int rdbSave(char *filename) {
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2316, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
    ...
    if (rename(tmpfile,filename) == -1) {
        redisLog(2,"Error moving temp DB file on the final destination: %s", strerror((*__errno_location ())));
        unlink(tmpfile);
        return -1;
    }
...
static robj *rdbLoadIntegerObject(FILE *fp, int enctype) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2451, __PRETTY_FUNCTION__));
    }
...
static robj *rdbLoadStringObject(FILE*fp, int rdbver) {
    ...
    if (isencoded) {
        ...
        default:
            ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2490, __PRETTY_FUNCTION__));
        }
    }
...
static int rdbLoad(char *filename) {
    ...
    while(1) {
        ...
        if (type == 0) {
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2578, __PRETTY_FUNCTION__));
        }
    ...
    if (o == ((void *)0)) {
        ...
        if (o->type != 0) {
            ...
            if (o->encoding == 0)
                ...
                ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 2725, __PRETTY_FUNCTION__));
        }
    }
...
static int zslDelete(zskiplist *zsl, double score, robj *obj) {
    ...
    while(x->score == score) {
        if (compareStringObjects(x->obj,obj) == 0) {
            ...
            zslFreeNode(x);
            while(zsl->level > 1 && zsl->header->forward[zsl->level-1] == ((void *)0))
                zsl->level--;
            zsl->length--;
            return 1;
        } else {
...
static void zaddCommand(redisClient *c) {
    ...
    *score = strtod(c->argv[2]->ptr,((void *)0));
    zs = zsetobj->ptr;
    if (dictAdd(zs->dict,c->argv[3],score) == 0) {
        ...
        ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 3859, __PRETTY_FUNCTION__));
        oldscore = ((de)->val);
        if (*score != *oldscore) {
            int deleted;

            deleted = zslDelete(zs->zsl,*oldscore,c->argv[3]);
            ((deleted != 0) ? (void) (0) : __assert_fail ("deleted != 0", "redis.c", 3865, __PRETTY_FUNCTION__));
            zslInsert(zs->zsl,*score,c->argv[3]);
            incrRefCount(c->argv[3]);
            server.dirty++;
        }
...
static void zremCommand(redisClient *c) {
    ...
    if (zsetobj == ((void *)0)) {
        ...
        ((deleted != 0) ? (void) (0) : __assert_fail ("deleted != 0", "redis.c", 3899, __PRETTY_FUNCTION__));
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 4224, __PRETTY_FUNCTION__));
                ...
                if (alpha) {
                    ...
                    if (byval->encoding == 0) {
                        ...
                        if (byval->encoding == 1) {
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 4248, __PRETTY_FUNCTION__));
                    }
                }
            } else {
                if (!alpha) {
                    if (vector[j].obj->encoding == 0)
                        ...
                        if (vector[j].obj->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 4259, __PRETTY_FUNCTION__));
                    }
                }
            }
        }
...
static void msetGenericCommand(redisClient *c, int nx) {
    ...
    if (nx) {
        for (j = 1; j < c->argc; j += 2) {
            if (dictFind(c->db->dict,c->argv[j]) != ((void *)0)) {
                addReply(c, shared.czero);
                return;
            }
        }
...
static void segvHandler(int sig, siginfo_t *info, void *secret) {
    ...
    redisLog(2,
        "======= Ooops! Redis %s got signal: -%d- =======", "1.050", sig);
...
int main(int argc, char **argv) {
    ...
    redisLog(1,"Server started, Redis version " "1.050");
