...
static void zaddCommand(redisClient *c) {
    ...
    *score = strtod(c->argv[2]->ptr,((void *)0));
    ...
    if (dictAdd(zs->dict,c->argv[3],score) == 0) {
        ...
        ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 3863, __PRETTY_FUNCTION__));
        oldscore = ((de)->val);
        if (*score != *oldscore) {
            int deleted;

            deleted = zslDelete(zs->zsl,*oldscore,c->argv[3]);
            ((deleted != 0) ? (void) (0) : __assert_fail ("deleted != 0", "redis.c", 3869, __PRETTY_FUNCTION__));
            zslInsert(zs->zsl,*score,c->argv[3]);
            incrRefCount(c->argv[3]);
            server.dirty++;
        }
...
static void zremCommand(redisClient *c) {
    ...
    if (zsetobj == ((void *)0)) {
        ...
        ((deleted != 0) ? (void) (0) : __assert_fail ("deleted != 0", "redis.c", 3903, __PRETTY_FUNCTION__));
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 4228, __PRETTY_FUNCTION__));
                ...
                if (alpha) {
                    ...
                    if (byval->encoding == 0) {
                        ...
                        if (byval->encoding == 1) {
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 4252, __PRETTY_FUNCTION__));
                    }
                }
            } else {
                if (!alpha) {
                    if (vector[j].obj->encoding == 0)
                        ...
                        if (vector[j].obj->encoding == 1)
                            ...
                            ((1 != 1) ? (void) (0) : __assert_fail ("1 != 1", "redis.c", 4263, __PRETTY_FUNCTION__));
                    }
                }
            }
        }
