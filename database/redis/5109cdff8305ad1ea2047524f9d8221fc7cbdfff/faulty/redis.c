...
static void freeClient(redisClient *c) {
    ...
    ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1067, __PRETTY_FUNCTION__));
    ...
    if (c->flags & 2) {
        ...
        ((ln != ((void *)0)) ? (void) (0) : __assert_fail ("ln != ((void *)0)", "redis.c", 1074, __PRETTY_FUNCTION__));
        listDelNode(l,ln);
    }
    if (c->flags & 4) {
        server.master = ((void *)0);
...
static void decrRefCount(void *obj) {
    ...
    if (--(o->refcount) == 0) {
        ...
        default: ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1579, __PRETTY_FUNCTION__)); break;
        }
...
static robj *tryObjectSharing(robj *o) {
    ...
    ((o->type == 0) ? (void) (0) : __assert_fail ("o->type == 0", "redis.c", 1594, __PRETTY_FUNCTION__));
    ...
    if (de) {
        ...
        if (((server.sharingpool)->used) >=
            ...
            ((de != ((void *)0)) ? (void) (0) : __assert_fail ("de != ((void *)0)", "redis.c", 1612, __PRETTY_FUNCTION__));
            c = ((unsigned long) ((de)->val))-1;
            ((de)->val) = (void*) c;
            if (c == 0) {
        ...
        if (c == 0) {
            ...
            ((retval == 0) ? (void) (0) : __assert_fail ("retval == 0", "redis.c", 1625, __PRETTY_FUNCTION__));
            incrRefCount(o);
        }
        return o;
    }
    ...
    for (j = 0; j < server.dbnum; j++) {
        ...
        while((de = dictNext(di)) != ((void *)0)) {
            ...
            if (o->type == 0) {
                ...
                ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 1872, __PRETTY_FUNCTION__));
            }
        }
        dictReleaseIterator(di);
    }
...
static robj *rdbLoadIntegerObject(FILE *fp, int enctype) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 1999, __PRETTY_FUNCTION__));
    }
...
static robj *rdbLoadStringObject(FILE*fp, int rdbver) {
    ...
    if (isencoded) {
        ...
        default:
            ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2037, __PRETTY_FUNCTION__));
        }
    }
...
static int rdbLoad(char *filename) {
    ...
    while(1) {
        ...
        if (type == 0) {
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2125, __PRETTY_FUNCTION__));
        }
...
static void sunionCommand(redisClient *c) {
    sunionGenericCommand(c,c->argv+1,c->argc-1,((void *)0));
}
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 3346, __PRETTY_FUNCTION__));
