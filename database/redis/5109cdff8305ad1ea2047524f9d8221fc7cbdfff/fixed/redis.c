...
static robj *rdbLoadStringObject(FILE*fp, int rdbver) {
    ...
    if (isencoded) {
        ...
        default:
            ((0!=0) ? (void) (0) : __assert_fail ("0!=0", "redis.c", 2038, __PRETTY_FUNCTION__));
        }
    }
...
static int rdbLoad(char *filename) {
    ...
    while(1) {
        ...
        if (type == 0) {
            ...
            ((0 != 0) ? (void) (0) : __assert_fail ("0 != 0", "redis.c", 2126, __PRETTY_FUNCTION__));
        }
...
static void sortCommand(redisClient *c) {
    ...
    ((j == vectorlen) ? (void) (0) : __assert_fail ("j == vectorlen", "redis.c", 3360, __PRETTY_FUNCTION__));
