...
robj *createObject(int type, void *ptr) {
    ...
    o->lru = ((1000/server.hz <= 1000) ? server.lruclock : getLRUClock());
    return o;
}
# 62 "object.c"
robj *makeObjectShared(robj *o) {
    ((o->refcount == 1)?(void)0 : (_serverAssert("o->refcount == 1","object.c",63),_exit(1)));
    o->refcount = 2147483647;
    return o;
}
...
robj *dupStringObject(const robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_serverAssert("o->type == OBJ_STRING","object.c",153),_exit(1)));
    ...
    case 1:
        ...
        return d;
    default:
        _serverPanic("\"Wrong encoding.\"","object.c",166),_exit(1);
        break;
    }
}
...
void freeListObject(robj *o) {
    ...
    case 9:
        ...
        break;
    default:
        _serverPanic("\"Unknown list encoding type\"","object.c",243),_exit(1);
    }
}
...
void freeSetObject(robj *o) {
    ...
    case 6:
        ...
        break;
    default:
        _serverPanic("\"Unknown set encoding type\"","object.c",256),_exit(1);
    }
}
...
void freeZsetObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _serverPanic("\"Unknown sorted set encoding\"","object.c",273),_exit(1);
    }
}
...
void freeHashObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _serverPanic("\"Unknown hash encoding type\"","object.c",286),_exit(1);
        break;
    }
}
...
void incrRefCount(robj *o) {
    if (o->refcount != 2147483647) o->refcount++;
}
...
void decrRefCount(robj *o) {
    if (o->refcount == 1) {
        ...
        default: _serverPanic("\"Unknown object type\"","object.c",310),_exit(1); break;
        }
        zfree(o);
    } else {
        if (o->refcount <= 0) _serverPanic("\"decrRefCount against refcount <= 0\"","object.c",314),_exit(1);
        if (o->refcount != 2147483647) o->refcount--;
    }
}
...
int isObjectRepresentableAsLongLong(robj *o, long long *llval) {
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",356),_exit(1)));
    if (o->encoding == 1) {
...
robj *tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",375),_exit(1)));
...
robj *getDecodedObject(robj *o) {
    ...
    if (o->type == 0 && o->encoding == 1) {
        ...
        _serverPanic("\"Unknown encoding type\"","object.c",461),_exit(1);
    }
}
# 476 "object.c"
int compareStringObjectsWithFlags(robj *a, robj *b, int flags) {
    ((a->type == 0 && b->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),a,"a->type == OBJ_STRING && b->type == OBJ_STRING","object.c",477),_exit(1)));
...
size_t stringObjectLen(robj *o) {
    ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",534),_exit(1)));
    if ((o->encoding == 0 || o->encoding == 8)) {
        return sdslen(o->ptr);
    } else {
...
int getDoubleFromObject(const robj *o, double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",549),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            value = strtod(o->ptr, &eptr);
            if (((*__ctype_b_loc ())[(int) ((((const char*)o->ptr)[0]))] & (unsigned short int) _ISspace) ||
                eptr[0] != '\0' ||
                ((*__errno_location ()) == 34 &&
                    (value == (__builtin_huge_val()) || value == -(__builtin_huge_val()) || value == 0)) ||
                (*__errno_location ()) == 22 ||
                (sizeof (value) == sizeof (float) ? __isnanf (value) : sizeof (value) == sizeof (double) ? __isnan (value) : __isnanl (value)))
                return -1;
        } else if (o->encoding == 1) {
            value = (long)o->ptr;
        } else {
            _serverPanic("\"Unknown string encoding\"","object.c",563),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongDoubleFromObject(robj *o, long double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",591),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            ...
            _serverPanic("\"Unknown string encoding\"","object.c",601),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongLongFromObject(robj *o, long long *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_serverAssertWithInfo(((void *)0),o,"o->type == OBJ_STRING","object.c",628),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            if (string2ll(o->ptr,sdslen(o->ptr),&value) == 0) return -1;
        } else if (o->encoding == 1) {
            value = (long)o->ptr;
        } else {
            _serverPanic("\"Unknown string encoding\"","object.c",634),_exit(1);
        }
    }
...
unsigned long long estimateObjectIdleTime(robj *o) {
    unsigned long long lruclock = ((1000/server.hz <= 1000) ? server.lruclock : getLRUClock());
    if (lruclock >= o->lru) {
