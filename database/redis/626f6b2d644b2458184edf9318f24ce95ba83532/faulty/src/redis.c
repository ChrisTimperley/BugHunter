...
struct redisCommand redisCommandTable[] = {
    ...
    {"restore",restoreCommand,3,0,((void *)0),0,0,0,0,0},
...
void beforeSleep(struct aeEventLoop *eventLoop) {
    ...
    if (server.ds_enabled && ((server.io_ready_clients)->len)) {
        ...
        while((ln = listNext(&li))) {
            ...
            ((cmd != ((void *)0))?(void)0 : (_redisAssert("cmd != NULL","redis.c",717),_exit(1)));
            call(c,cmd);
            resetClient(c);
    ...
    while (((server.unblocked_clients)->len)) {
        ...
        ((ln != ((void *)0))?(void)0 : (_redisAssert("ln != NULL","redis.c",729),_exit(1)));
        c = ln->value;
