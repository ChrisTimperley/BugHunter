...
unsigned char *zzlInsertAt(unsigned char *zl, unsigned char *eptr, robj *ele, double score) {
    ...
    (((ele->encoding == 0 || ele->encoding == 8))?(void)0 : (_redisAssertWithInfo(((void *)0),ele,"sdsEncodedObject(ele)","t_zset.c",649),_exit(1)));
    ...
    if (!(val->flags & 2)) {
        ...
        if (val->ele != ((void *)0)) {
            if (val->ele->encoding == 1) {
                ...
                val->flags |= 4;
            } else if ((val->ele->encoding == 0 || val->ele->encoding == 8)) {
...
int zuiFind(zsetopsrc *op, zsetopval *val, double *score) {
    ...
    if (op->type == 2) {
        if (op->encoding == 6) {
            ...
            _redisPanic("\"Unknown set encoding\"","t_zset.c",1441),_exit(1);
        }
    } else if (op->type == 3) {
        zuiObjectFromValue(val);
        ...
        if (op->encoding == 5) {
            ...
            _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1463),_exit(1);
        }
    } else {
        _redisPanic("\"Unsupported type\"","t_zset.c",1466),_exit(1);
    }
}
...
inline static void zunionInterAggregate(double *target, double val, int aggregate) {
    if (aggregate == 1) {
        ...
        *target = val > *target ? val : *target;
        ...
        _redisPanic("\"Unknown ZUNION/INTER aggregate type\"","t_zset.c",1492),_exit(1);
    }
}
...
void zunionInterGenericCommand(redisClient *c, robj *dstkey, int op) {
    ...
    if (op == 2) {
        ...
        if (zuiLength(&src[0]) > 0) {
            ...
            while (zuiNext(&src[0],&zval)) {
                ...
                if (j == setnum) {
                    ...
                    if ((tmp->encoding == 0 || tmp->encoding == 8)) {
        ...
        _redisPanic("\"Unknown operator\"","t_zset.c",1681),_exit(1);
    }
...
void zrangeGenericCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1771),_exit(1)));
        sptr = ziplistNext(zl,eptr);

        while (rangelen--) {
            ((eptr != ((void *)0) && sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL && sptr != NULL","t_zset.c",1775),_exit(1)));
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1776),_exit(1)));
            if (vstr == ((void *)0))
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"ln != NULL","t_zset.c",1809),_exit(1)));
            ele = ln->obj;
            addReplyBulk(c,ele);
            if (withscores)
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",1817),_exit(1);
    }
}
...
void genericZrangebyscoreCommand(redisClient *c, int reverse) {
    ...
    if (zobj->encoding == 5) {
        ...
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",1901),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ...
        while (eptr && limit--) {
            ...
            ((ziplistGet(eptr,&vstr,&vlen,&vlong))?(void)0 : (_redisAssertWithInfo(c,zobj,"ziplistGet(eptr,&vstr,&vlen,&vlong)","t_zset.c",1930),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2006),_exit(1);
    }
...
void zcountCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        sptr = ziplistNext(zl,eptr);
        score = zzlGetScore(sptr);
        ((zslValueLteMax(score,&range))?(void)0 : (_redisAssertWithInfo(c,zobj,"zslValueLteMax(score,&range)","t_zset.c",2057),_exit(1)));
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2095),_exit(1);
    }
...
void zscoreCommand(redisClient *c) {
    ...
    if (zobj->encoding == 5) {
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2137),_exit(1);
    }
}
...
void zrankGenericCommand(redisClient *c, int reverse) {
    ...
    (((ele->encoding == 0 || ele->encoding == 8))?(void)0 : (_redisAssertWithInfo(c,ele,"sdsEncodedObject(ele)","t_zset.c",2152),_exit(1)));
    ...
    if (zobj->encoding == 5) {
        ...
        eptr = ziplistIndex(zl,0);
        ((eptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"eptr != NULL","t_zset.c",2159),_exit(1)));
        sptr = ziplistNext(zl,eptr);
        ((sptr != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,zobj,"sptr != NULL","t_zset.c",2161),_exit(1)));
        ...
        if (de != ((void *)0)) {
            ...
            ((rank)?(void)0 : (_redisAssertWithInfo(c,ele,"rank","t_zset.c",2190),_exit(1)));
            if (reverse)
                addReplyLongLong(c,llen-rank);
            else
                addReplyLongLong(c,rank-1);
        ...
        _redisPanic("\"Unknown sorted set encoding\"","t_zset.c",2199),_exit(1);
    }
}
