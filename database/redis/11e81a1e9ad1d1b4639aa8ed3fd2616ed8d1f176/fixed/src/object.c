...
robj *dupStringObject(robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_redisAssert("o->type == REDIS_STRING","object.c",140),_exit(1)));
    ...
    case 1:
        ...
        return d;
    default:
        _redisPanic("\"Wrong encoding.\"","object.c",153),_exit(1);
        break;
    }
}
...
void freeListObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _redisPanic("\"Unknown list encoding type\"","object.c",227),_exit(1);
    }
}
...
void freeSetObject(robj *o) {
    ...
    case 6:
        ...
        break;
    default:
        _redisPanic("\"Unknown set encoding type\"","object.c",240),_exit(1);
    }
}
...
void freeZsetObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _redisPanic("\"Unknown sorted set encoding\"","object.c",257),_exit(1);
    }
}
...
void freeHashObject(robj *o) {
    ...
    case 5:
        ...
        break;
    default:
        _redisPanic("\"Unknown hash encoding type\"","object.c",270),_exit(1);
        break;
    }
}
...
void decrRefCount(robj *o) {
    if (o->refcount <= 0) _redisPanic("\"decrRefCount against refcount <= 0\"","object.c",280),_exit(1);
    if (o->refcount == 1) {
        switch(o->type) {
        ...
        default: _redisPanic("\"Unknown object type\"","object.c",288),_exit(1); break;
        }
        zfree(o);
    } else {
        o->refcount--;
...
int isObjectRepresentableAsLongLong(robj *o, long long *llval) {
    ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",329),_exit(1)));
    if (o->encoding == 1) {
...
robj *tryObjectEncoding(robj *o) {
    ...
    ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",353),_exit(1)));
...
robj *getDecodedObject(robj *o) {
    ...
    if (o->type == 0 && o->encoding == 1) {
        ...
        _redisPanic("\"Unknown encoding type\"","object.c",420),_exit(1);
    }
}
# 435 "object.c"
int compareStringObjectsWithFlags(robj *a, robj *b, int flags) {
    ((a->type == 0 && b->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),a,"a->type == REDIS_STRING && b->type == REDIS_STRING","object.c",436),_exit(1)));
...
size_t stringObjectLen(robj *o) {
    ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",493),_exit(1)));
    if ((o->encoding == 0 || o->encoding == 8)) {
        return sdslen(o->ptr);
    } else {
        char buf[32];
...
int getDoubleFromObject(robj *o, double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",510),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            value = strtod(o->ptr, &eptr);
            if (((*__ctype_b_loc ())[(int) ((((char*)o->ptr)[0]))] & (unsigned short int) _ISspace) ||
                eptr[0] != '\0' ||
                ((*__errno_location ()) == 34 &&
            ...
            _redisPanic("\"Unknown string encoding\"","object.c",524),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongDoubleFromObject(robj *o, long double *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",552),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            ...
            _redisPanic("\"Unknown string encoding\"","object.c",562),_exit(1);
        }
    }
    *target = value;
    return 0;
...
int getLongLongFromObject(robj *o, long long *target) {
    ...
    if (o == ((void *)0)) {
        ...
        ((o->type == 0)?(void)0 : (_redisAssertWithInfo(((void *)0),o,"o->type == REDIS_STRING","object.c",590),_exit(1)));
        if ((o->encoding == 0 || o->encoding == 8)) {
            (*__errno_location ()) = 0;
            ...
            _redisPanic("\"Unknown string encoding\"","object.c",600),_exit(1);
        }
    }
