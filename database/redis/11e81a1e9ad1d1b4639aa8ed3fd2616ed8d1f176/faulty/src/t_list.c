...
void listTypeTryConversion(robj *subject, robj *value) {
    ...
    if ((value->encoding == 0 || value->encoding == 8) &&
...
int listTypeEqual(listTypeEntry *entry, robj *o) {
    listTypeIterator *li = entry->li;
    if (li->encoding == 5) {
        (((o->encoding == 0 || o->encoding == 8))?(void)0 : (_redisAssertWithInfo(((void *)0),o,"sdsEncodedObject(o)","t_list.c",237),_exit(1)));
...
void lindexCommand(redisClient *c) {
    ...
    if (o->encoding == 5) {
        ...
        _redisPanic("\"Unknown list encoding\"","t_list.c",452),_exit(1);
    }
}
...
void lsetCommand(redisClient *c) {
    ...
    if (o->encoding == 5) {
        ...
        _redisPanic("\"Unknown list encoding\"","t_list.c",495),_exit(1);
    }
}
...
void lrangeCommand(redisClient *c) {
    ...
    if (o->encoding == 5) {
        ...
        _redisPanic("\"List encoding is not LINKEDLIST nor ZIPLIST!\"","t_list.c",585),_exit(1);
    }
}
...
void ltrimCommand(redisClient *c) {
    ...
    if (o->encoding == 5) {
        ...
        _redisPanic("\"Unknown list encoding\"","t_list.c",634),_exit(1);
    }
...
void blockForKeys(redisClient *c, robj **keys, int numkeys, mstime_t timeout, robj *target) {
    ...
    for (j = 0; j < numkeys; j++) {
        ...
        if (de == ((void *)0)) {
            ...
            incrRefCount(keys[j]);
            ((retval == 0)?(void)0 : (_redisAssertWithInfo(c,keys[j],"retval == DICT_OK","t_list.c",805),_exit(1)));
        } else {
            l = ((de)->v.val);
        }
        listAddNodeTail(l,c);
...
void unblockClientWaitingData(redisClient *c) {
    ...
    ((((c->bpop.keys)->ht[0].used+(c->bpop.keys)->ht[1].used) != 0)?(void)0 : (_redisAssertWithInfo(c,((void *)0),"dictSize(c->bpop.keys) != 0","t_list.c",821),_exit(1)));
    ...
    while((de = dictNext(di)) != ((void *)0)) {
        ...
        ((l != ((void *)0))?(void)0 : (_redisAssertWithInfo(c,key,"l != NULL","t_list.c",829),_exit(1)));
...
void signalListAsReady(redisClient *c, robj *key) {
    ...
    incrRefCount(key);
    ((dictAdd(c->db->ready_keys,key,((void *)0)) == 0)?(void)0 : (_redisAssert("dictAdd(c->db->ready_keys,key,NULL) == DICT_OK","t_list.c",872),_exit(1)));
}
# 894 "t_list.c"
        ...
        if (o != ((void *)0)) {
            if (o->type != 1) {
                ...
                if (listTypeLength(o) != 0) {
                    ...
                    char *event = (where == 0) ? "lpop" : "rpop";
                    robj *value = listTypePop(o,where);
                    ((value != ((void *)0))?(void)0 : (_redisAssert("value != NULL","t_list.c",1053),_exit(1)));
...
void brpoplpushCommand(redisClient *c) {
    ...
    if (key == ((void *)0)) {
        ...
        if (key->type != 1) {
            ...
            ((listTypeLength(key) > 0)?(void)0 : (_redisAssertWithInfo(c,key,"listTypeLength(key) > 0","t_list.c",1121),_exit(1)));
            rpoplpushCommand(c);
        }
    }
}
