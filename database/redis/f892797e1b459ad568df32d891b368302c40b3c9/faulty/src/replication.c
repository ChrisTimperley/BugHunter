...
void replicationAbortSyncTransfer(void) {
    ((server.repl_state == 3)?(void)0 : (_redisAssert("server.repl_state == REDIS_REPL_TRANSFER","replication.c",273),_exit(1)));
...
void undoConnectWithMaster(void) {
    ...
    ((server.repl_state == 2)?(void)0 : (_redisAssert("server.repl_state == REDIS_REPL_CONNECTING","replication.c",504),_exit(1)));
    aeDeleteFileEvent(server.el,fd,1|2);
    close(fd);
