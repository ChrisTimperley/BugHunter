...
void sortCommand(client *c) {
    ...
    while(j < c->argc) {
        ...
        if (!strcasecmp(c->argv[j]->ptr,"asc")) {
            ...
            if ((__extension__ (__builtin_constant_p ('*') && !__builtin_constant_p (c->argv[j+1]->ptr) && ('*') == '\0' ? (char *) __rawmemchr (c->argv[j+1]->ptr, '*') : __builtin_strchr (c->argv[j+1]->ptr, '*'))) == ((void *)0)) {
                dontsort = 1;
            } else {
    ...
    default: vectorlen = 0; _serverPanic("\"Bad SORT type\"","sort.c",313),_exit(1);
    }
...
# 335 "sort.c"
    ...
    if (sortval->type == 1 && dontsort) {
        ...
        while(rangelen--) {
            ((ln != ((void *)0))?(void)0 : (_serverAssertWithInfo(c,sortval,"ln != NULL","sort.c",419),_exit(1)));
            sdsele = ln->ele;
        ...
        _serverPanic("\"Unknown type\"","sort.c",445),_exit(1);
    }
    ((j == vectorlen)?(void)0 : (_serverAssertWithInfo(c,sortval,"j == vectorlen","sort.c",447),_exit(1)));
        ...
        for (j = 0; j < vectorlen; j++) {
            ...
            if (alpha) {
                ...
                if ((byval->encoding == 0 || byval->encoding == 8)) {
                    ...
                    ((1 != 1)?(void)0 : (_serverAssertWithInfo(c,sortval,"1 != 1","sort.c",480),_exit(1)));
                }
            }
        ...
        for (j = start; j <= end; j++) {
            ...
            while((ln = listNext(&li))) {
                ...
                if (sop->type == 0) {
                    ...
                    ((sop->type == 0)?(void)0 : (_serverAssertWithInfo(c,sortval,"sop->type == SORT_OP_GET","sort.c",531),_exit(1)));
                }
            }
        }
    } else {
            ...
            if (!getop) {
                ...
                while((ln = listNext(&li))) {
                    ...
                    if (sop->type == 0) {
                        ...
                        ((sop->type == 0)?(void)0 : (_serverAssertWithInfo(c,sortval,"sop->type == SORT_OP_GET","sort.c",562),_exit(1)));
                    }
                }
            }
        }
