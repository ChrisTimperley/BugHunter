...
static int rdbWriteRaw(FILE *fp, void *p, size_t len) {
    if (fp != ((void *)0) && fwrite(p,len,1,fp) == 0) return -1;
    return len;
}
...
int rdbSaveLongLongAsStringObject(FILE *fp, long long value) {
    ...
    if (enclen > 0) {
        ...
        ((enclen < 32)?(void)0 : (_redisAssert("enclen < 32","rdb.c",185),_exit(1)));
...
int rdbSaveStringObject(FILE *fp, robj *obj) {
    ...
    if (obj->encoding == 1) {
        ...
        ((obj->encoding == 0)?(void)0 : (_redisAssert("obj->encoding == REDIS_ENCODING_RAW","rdb.c",201),_exit(1)));
...
int rdbSaveObject(FILE *fp, robj *o) {
    ...
    if (o->type == 0) {
        ...
        if (o->encoding == 5) {
            ...
            if ((n = rdbSaveLen(fp,((list)->len))) == -1) return -1;
            nwritten += n;
            ...
            _redisPanic("\"Unknown list encoding\"","rdb.c",295),_exit(1);
        }
    } else if (o->type == 2) {
        ...
        if (o->encoding == 2) {
            ...
            if ((n = rdbSaveLen(fp,((set)->ht[0].used+(set)->ht[1].used))) == -1) return -1;
            nwritten += n;
            ...
            _redisPanic("\"Unknown set encoding\"","rdb.c",326),_exit(1);
        }
    } else if (o->type == 3) {
        ...
        if ((n = rdbSaveLen(fp,((zs->dict)->ht[0].used+(zs->dict)->ht[1].used))) == -1) return -1;
        nwritten += n;
        ...
        if (o->encoding == 3) {
            ...
            while((p = zipmapNext(p,&key,&klen,&val,&vlen)) != ((void *)0)) {
            ...
            if ((n = rdbSaveLen(fp,(((dict*)o->ptr)->ht[0].used+((dict*)o->ptr)->ht[1].used))) == -1) return -1;
            nwritten += n;
        ...
        _redisPanic("\"Unknown object type\"","rdb.c",383),_exit(1);
    }
    return nwritten;
}
...
off_t rdbSavedObjectLen(robj *o) {
    ...
    ((len != -1)?(void)0 : (_redisAssert("len != -1","rdb.c",394),_exit(1)));
    return len;
}
                        ...
                        time_t expiretime, time_t now)
{
    ...
    if (expiretime != -1) {
        ...
        if (rdbSaveType(fp,253) == -1) return -1;
...
int rdbSaveBackground(char *filename) {
    ...
    if (server.bgsavechildpid != -1 ||
        server.bgsavethread != (pthread_t) -1) return -1;
...
robj *rdbLoadIntegerObject(FILE *fp, int enctype, int encode) {
    ...
    if (enctype == 0) {
        ...
        val = 0;
        _redisPanic("\"Unknown RDB integer encoding type\"","rdb.c",604),_exit(1);
    }
    if (encode)
...
robj *rdbLoadLzfStringObject(FILE*fp) {
    ...
    if ((clen = rdbLoadLen(fp,((void *)0))) == (2147483647 * 2U + 1U)) return ((void *)0);
    if ((len = rdbLoadLen(fp,((void *)0))) == (2147483647 * 2U + 1U)) return ((void *)0);
...
robj *rdbGenericLoadStringObject(FILE*fp, int encode) {
    ...
    if (isencoded) {
        ...
        default:
            _redisPanic("\"Unknown RDB encoding type\"","rdb.c",646),_exit(1);
        }
    }
...
robj *rdbLoadObject(int type, FILE *fp) {
    ...
    if (type == 0) {
        ...
        if ((o = rdbLoadEncodedStringObject(fp)) == ((void *)0)) return ((void *)0);
        ...
        while(len--) {
            if ((ele = rdbLoadEncodedStringObject(fp)) == ((void *)0)) return ((void *)0);
        ...
        if ((zsetlen = rdbLoadLen(fp,((void *)0))) == (2147483647 * 2U + 1U)) return ((void *)0);
        o = createZsetObject();
        zs = o->ptr;
        ...
        while(zsetlen--) {
            ...
            if ((ele = rdbLoadEncodedStringObject(fp)) == ((void *)0)) return ((void *)0);
            ele = tryObjectEncoding(ele);
            if (rdbLoadDoubleValue(fp,&score) == -1) return ((void *)0);
        ...
        if ((hashlen = rdbLoadLen(fp,((void *)0))) == (2147483647 * 2U + 1U)) return ((void *)0);
        o = createHashObject();
        ...
        while(hashlen--) {
            ...
            if ((key = rdbLoadEncodedStringObject(fp)) == ((void *)0)) return ((void *)0);
            if ((val = rdbLoadEncodedStringObject(fp)) == ((void *)0)) return ((void *)0);
        ...
        _redisPanic("\"Unknown object type\"","rdb.c",836),_exit(1);
    }
    return o;
}
...
int rdbLoad(char *filename) {
    ...
    char buf[1024];
    time_t expiretime, now = time(((void *)0));
    long loops = 0;
    ...
    while(1) {
        ...
        if (type == 254) {
            if ((dbid = rdbLoadLen(fp,((void *)0))) == (2147483647 * 2U + 1U))
                goto eoferr;
        ...
        if ((key = rdbLoadStringObject(fp)) == ((void *)0)) goto eoferr;

        if ((val = rdbLoadObject(type,fp)) == ((void *)0)) goto eoferr;
        ...
        if (retval == -1) {
            redisLog(3,"Loading DB, duplicated key (%s) found! Unrecoverable error, exiting now.", key->ptr);
            exit(1);
        }
